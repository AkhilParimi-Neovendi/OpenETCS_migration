  ...
  outC_establishSession_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  ...
  /* SM1: */
  static _2_SSM_ST_SM1 SM1_state_nxt_partial;
  /* SM1: */
  static kcg_bool SM1_reset_nxt_partial;
  /* SM1: */
  static _3_SSM_TR_SM1 SM1_fired_partial;
  /* p42_establishSessionCmd/ */
  static p42_sessionManagement_T_RCM_MsgTypes_Pkg _2_p42_establishSessionCmd_partial;
  /* send_m155_initiationOfACommunicationSession/ */
  static kcg_bool _3_send_m155_initiationOfACommunicationSession_partial;
  /* send_m159_sessionEstablishedReport/ */
  ...
  /* terminateCommunicationSession/ */
  static kcg_bool _7_terminateCommunicationSession_partial;
  /* infomDriverNoCompatibleVersionSupported/ */
  static kcg_bool _8_infomDriverNoCompatibleVersionSupported_partial;
  /* established/ */
  static kcg_bool _9_established_partial;
  /* sessionStatus/ */
  static sessionStatus_T_RCM_Session_Types_Pkg _10_sessionStatus_partial;
  /* SM1: */
  static _2_SSM_ST_SM1 _11_SM1_state_nxt_partial;
  /* SM1: */
  static kcg_bool _12_SM1_reset_nxt_partial;
  /* SM1: */
  static _3_SSM_TR_SM1 _13_SM1_fired_partial;
  /* p42_establishSessionCmd/ */
  static p42_sessionManagement_T_RCM_MsgTypes_Pkg _14_p42_establishSessionCmd_partial;
  /* send_m155_initiationOfACommunicationSession/ */
  static kcg_bool _15_send_m155_initiationOfACommunicationSession_partial;
  /* send_m159_sessionEstablishedReport/ */
  static kcg_bool _16_send_m159_sessionEstablishedReport_partial;
  /* send_m154_noCompatibleVersionSupported/ */
  static kcg_bool _17_send_m154_noCompatibleVersionSupported_partial;
  /* requestSafeRadioConnectionSetup/ */
  static kcg_bool _18_requestSafeRadioConnectionSetup_partial;
  /* terminateCommunicationSession/ */
  static kcg_bool _19_terminateCommunicationSession_partial;
  /* infomDriverNoCompatibleVersionSupported/ */
  static kcg_bool _20_infomDriverNoCompatibleVersionSupported_partial;
  /* established/ */
  static kcg_bool _21_established_partial;
  /* sessionStatus/ */
  static sessionStatus_T_RCM_Session_Types_Pkg _22_sessionStatus_partial;
  /* SM1: */
  static _2_SSM_ST_SM1 _23_SM1_state_nxt_partial;
  /* SM1: */
  static kcg_bool _24_SM1_reset_nxt_partial;
  /* SM1: */
  static _3_SSM_TR_SM1 _25_SM1_fired_partial;
  /* SM1: */
  static _2_SSM_ST_SM1 SM1_state_act_partial;
  /* SM1: */
  static kcg_bool SM1_reset_act_partial;
  /* SM1: */
  static _3_SSM_TR_SM1 SM1_fired_strong_partial;
  /* SM1:idle:<2> */
  static kcg_bool tr_2_guard_idle_SM1;
  /* SM1:idle:<1> */
  static kcg_bool tr_1_guard_idle_SM1;
  /* SM1: */
  static _2_SSM_ST_SM1 _26_SM1_state_act_partial;
  /* SM1: */
  static kcg_bool _27_SM1_reset_act_partial;
  /* SM1: */
  static _3_SSM_TR_SM1 _28_SM1_fired_strong_partial;
  /* SM1:establishingByOBU:<1> */
  static kcg_bool tr_1_guard_establishingByOBU_SM1;
  /* SM1: */
  static _2_SSM_ST_SM1 _29_SM1_state_act_partial;
  /* SM1: */
  static kcg_bool _30_SM1_reset_act_partial;
  /* SM1: */
  static _3_SSM_TR_SM1 _31_SM1_fired_strong_partial;
  ...
  switch (outC->SM1_state_sel) {
    case SSM_st_establishingByRBC_SM1 :
      tr_1_guard_establishingByRBC_SM1 = reset1;
      if (tr_1_guard_establishingByRBC_SM1) {
        _29_SM1_state_act_partial = _12_SSM_st_idle_SM1;
      }
      else {
        _29_SM1_state_act_partial = SSM_st_establishingByRBC_SM1;
      }
      break;
    case SSM_st_establishingByOBU_SM1 :
      tr_1_guard_establishingByOBU_SM1 = reset1;
      if (tr_1_guard_establishingByOBU_SM1) {
        _26_SM1_state_act_partial = _12_SSM_st_idle_SM1;
      }
      else {
        _26_SM1_state_act_partial = SSM_st_establishingByOBU_SM1;
      }
      break;
  ...
  switch (outC->SM1_state_sel) {
    case SSM_st_establishingByRBC_SM1 :
      ...
      if (tr_1_guard_establishingByRBC_SM1) {
        _31_SM1_fired_strong_partial =
          SSM_TR_establishingByRBC_idle_1_establishingByRBC_SM1;
      }
      else {
        _31_SM1_fired_strong_partial = _13_SSM_TR_no_trans_SM1;
      }
    ...
    case SSM_st_establishingByOBU_SM1 :
      ...
      if (tr_1_guard_establishingByOBU_SM1) {
        _28_SM1_fired_strong_partial =
          SSM_TR_establishingByOBU_idle_1_establishingByOBU_SM1;
      }
      else {
        _28_SM1_fired_strong_partial = _13_SSM_TR_no_trans_SM1;
      }
    ...
    case _12_SSM_st_idle_SM1 :
      ...
      if (tr_1_guard_idle_SM1) {
        ...
        SM1_state_act_partial = _12_SSM_st_idle_SM1;
      }
      ...
      if (tr_1_guard_idle_SM1) {
        ...
        SM1_fired_strong_partial = _13_SSM_TR_no_trans_SM1;
      }
  ...
  switch (outC->SM1_state_act) {
    case SSM_st_establishingByRBC_SM1 :
      ...
      _23_SM1_state_nxt_partial = SSM_st_establishingByRBC_SM1;
      ...
      kcg_copy_mobileConnectionContext_T_RCM_Types_Pkg(
        ...
        connectionStatus);
      outC->_L6_establishingByRBC_SM1 = reset1;
      break;
    default :
  ...
  switch (outC->SM1_state_sel) {
    case SSM_st_establishingByRBC_SM1 :
      _30_SM1_reset_act_partial = tr_1_guard_establishingByRBC_SM1;
      outC->SM1_reset_act = _30_SM1_reset_act_partial;
      break;
    case SSM_st_establishingByOBU_SM1 :
      _27_SM1_reset_act_partial = tr_1_guard_establishingByOBU_SM1;
  ...
  switch (outC->SM1_state_act) {
    case SSM_st_establishingByRBC_SM1 :
      ...
      _21_established_partial = outC->_L9_establishingByRBC_SM1;
      ...
      _17_send_m154_noCompatibleVersionSupported_partial =
        outC->_L7_establishingByRBC_SM1;
      _19_terminateCommunicationSession_partial = outC->_L7_establishingByRBC_SM1;
      kcg_copy_sessionStatus_T_RCM_Session_Types_Pkg(
        &_22_sessionStatus_partial,
        &outC->_L3_establishingByRBC_SM1);
      _15_send_m155_initiationOfACommunicationSession_partial =
        outC->_L7_establishingByRBC_SM1;
      _16_send_m159_sessionEstablishedReport_partial =
        outC->_L2_establishingByRBC_SM1;
      kcg_copy_p42_sessionManagement_T_RCM_MsgTypes_Pkg(
        &_14_p42_establishSessionCmd_partial,
        &outC->_L8_establishingByRBC_SM1);
      _20_infomDriverNoCompatibleVersionSupported_partial =
        outC->_L7_establishingByRBC_SM1;
      _18_requestSafeRadioConnectionSetup_partial = outC->_L7_establishingByRBC_SM1;
      kcg_copy_p42_sessionManagement_T_RCM_MsgTypes_Pkg(
      ...
      outC->requestSafeRadioConnectionSetup =
        _18_requestSafeRadioConnectionSetup_partial;
      outC->terminateCommunicationSession = _19_terminateCommunicationSession_partial;
      outC->infomDriverNoCompatibleVersionSupported =
        _20_infomDriverNoCompatibleVersionSupported_partial;
      outC->established = _21_established_partial;
      kcg_copy_sessionStatus_T_RCM_Session_Types_Pkg(
        &outC->sessionStatus,
        &_22_sessionStatus_partial);
    ...
    case SSM_st_establishingByOBU_SM1 :
      ...
      _11_SM1_state_nxt_partial = SSM_st_establishingByOBU_SM1;
      kcg_copy_sessionCmd_T_RCM_Session_Types_Pkg(
      ...
      kcg_copy_mobileConnectionContext_T_RCM_Types_Pkg(
        ...
        connectionStatus);
      outC->_L13_establishingByOBU_SM1 = reset1;
      if (outC->SM1_reset_act) {
      ...
      _9_established_partial = outC->_L14_establishingByOBU_SM1;
      kcg_copy_sessionStatus_T_RCM_Session_Types_Pkg(
        &_10_sessionStatus_partial,
        &outC->_L9_establishingByOBU_SM1);
      _8_infomDriverNoCompatibleVersionSupported_partial =
        outC->_L8_establishingByOBU_SM1;
      _7_terminateCommunicationSession_partial = outC->_L7_establishingByOBU_SM1;
      _6_requestSafeRadioConnectionSetup_partial = outC->_L6_establishingByOBU_SM1;
      _5_send_m154_noCompatibleVersionSupported_partial =
        outC->_L5_establishingByOBU_SM1;
      _4_send_m159_sessionEstablishedReport_partial = outC->_L4_establishingByOBU_SM1;
      _3_send_m155_initiationOfACommunicationSession_partial =
        outC->_L3_establishingByOBU_SM1;
      kcg_copy_p42_sessionManagement_T_RCM_MsgTypes_Pkg(
        &_2_p42_establishSessionCmd_partial,
        &outC->_L2_establishingByOBU_SM1);
      kcg_copy_p42_sessionManagement_T_RCM_MsgTypes_Pkg(
        &outC->p42_establishSessionCmd,
        &_2_p42_establishSessionCmd_partial);
      ...
      outC->terminateCommunicationSession = _7_terminateCommunicationSession_partial;
      outC->infomDriverNoCompatibleVersionSupported =
        _8_infomDriverNoCompatibleVersionSupported_partial;
      outC->established = _9_established_partial;
      kcg_copy_sessionStatus_T_RCM_Session_Types_Pkg(
        &outC->sessionStatus,
        &_10_sessionStatus_partial);
    ...
    case _12_SSM_st_idle_SM1 :
      ...
      SM1_state_nxt_partial = _12_SSM_st_idle_SM1;
  ...
  outC_establishSession_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  ...
  outC->SM1_fired = _13_SSM_TR_no_trans_SM1;
  outC->SM1_fired_strong = _13_SSM_TR_no_trans_SM1;
  outC->SM1_state_act = _12_SSM_st_idle_SM1;
  outC->SM1_state_sel = _12_SSM_st_idle_SM1;
