#ifndef MORC_TYPES_CONVERSION
#define MORC_TYPES_CONVERSION
 ...
 ** struct_18831 
 ****************************************************************/
extern int struct_18831_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int check_struct_18831_string(const char *str, char **endptr);
extern int string_to_struct_18831(const char *str, void *pValue, char **endptr);
extern int is_struct_18831_double_conversion_allowed();
extern int struct_18831_to_double(const void *pValue, double *nValue);
extern int is_struct_18831_long_conversion_allowed();
extern int struct_18831_to_long(const void *pValue, long *nValue);
extern void compare_struct_18831(int *nStatus, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths);
extern int get_struct_18831_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int init_struct_18831(void *pValue);
extern int release_struct_18831(void *pValue);
extern int copy_struct_18831(void *pToValue, const void *pFromValue);
extern SimTypeUtils _Type_struct_18831_Utils;

/****************************************************************
 ** struct_19159 
 ****************************************************************/
extern int struct_19159_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int check_struct_19159_string(const char *str, char **endptr);
extern int string_to_struct_19159(const char *str, void *pValue, char **endptr);
extern int is_struct_19159_double_conversion_allowed();
extern int struct_19159_to_double(const void *pValue, double *nValue);
extern int is_struct_19159_long_conversion_allowed();
extern int struct_19159_to_long(const void *pValue, long *nValue);
extern void compare_struct_19159(int *nStatus, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths);
extern int get_struct_19159_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int init_struct_19159(void *pValue);
extern int release_struct_19159(void *pValue);
extern int copy_struct_19159(void *pToValue, const void *pFromValue);
extern SimTypeUtils _Type_struct_19159_Utils;
