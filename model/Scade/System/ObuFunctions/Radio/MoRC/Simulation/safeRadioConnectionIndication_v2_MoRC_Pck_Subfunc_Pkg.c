...
void safeRadioConnectionIndication_v2_MoRC_Pck_Subfunc_Pkg(
  ...
  /* currentTime/ */
  T_internal_Type_Obu_BasicTypes_Pkg _2_currentTime,
  /* reset/ */
  kcg_bool reset3,
  ...
  outC_safeRadioConnectionIndication_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  ...
  /* indicator_l/ */
  static safeRadioConnnectionIndicator_T_RCM_Session_Types_Pkg _4_indicator_l_partial;
  /* connectionStatus_SM: */
  static SSM_ST_connectionStatus_SM _5_connectionStatus_SM_state_nxt_partial;
  /* connectionStatus_SM: */
  static kcg_bool _6_connectionStatus_SM_reset_nxt_partial;
  /* connectionStatus_SM: */
  static SSM_TR_connectionStatus_SM _7_connectionStatus_SM_fired_partial;
  /* indicator_l/ */
  static safeRadioConnnectionIndicator_T_RCM_Session_Types_Pkg _8_indicator_l_partial;
  /* connectionStatus_SM: */
  static SSM_ST_connectionStatus_SM _9_connectionStatus_SM_state_nxt_partial;
  /* connectionStatus_SM: */
  static kcg_bool _10_connectionStatus_SM_reset_nxt_partial;
  /* connectionStatus_SM: */
  static SSM_TR_connectionStatus_SM _11_connectionStatus_SM_fired_partial;
  /* connectionStatus_SM: */
  ...
  /* connectionStatus_SM: */
  static SSM_ST_connectionStatus_SM _15_connectionStatus_SM_state_act_partial;
  /* connectionStatus_SM: */
  static kcg_bool _16_connectionStatus_SM_reset_act_partial;
  /* connectionStatus_SM: */
  static SSM_TR_connectionStatus_SM _17_connectionStatus_SM_fired_strong_partial;
  ...
  switch (outC->connectionStatus_SM_state_sel) {
    case SSM_st_ConnectionUp_connectionStatus_SM :
      tr_1_guard_ConnectionUp_connectionStatus_SM = outC->condition_ID_5 |
        outC->condition_ID_6 | outC->condition_ID_7 | reset3;
      if (tr_1_guard_ConnectionUp_connectionStatus_SM) {
        _15_connectionStatus_SM_state_act_partial =
  ...
  switch (outC->connectionStatus_SM_state_sel) {
    case SSM_st_ConnectionUp_connectionStatus_SM :
      outC->connectionStatus_SM_state_act = _15_connectionStatus_SM_state_act_partial;
      break;
    case SSM_st_ConnectionLost_SetupFailed_connectionStatus_SM :
  ...
  switch (outC->connectionStatus_SM_state_act) {
    case SSM_st_ConnectionUp_connectionStatus_SM :
      ...
      _8_indicator_l_partial = outC->_L1_ConnectionUp_connectionStatus_SM;
      outC->indicator_l = _8_indicator_l_partial;
      break;
    case SSM_st_ConnectionLost_SetupFailed_connectionStatus_SM :
      outC->_L1_ConnectionLost_SetupFailed_connectionStatus_SM =
        srci_connectionLost_setupFailed_RCM_Session_Types_Pkg;
      _4_indicator_l_partial =
        outC->_L1_ConnectionLost_SetupFailed_connectionStatus_SM;
      outC->indicator_l = _4_indicator_l_partial;
      break;
    case SSM_st_NoConnection_connectionStatus_SM :
  ...
  switch (outC->connectionStatus_SM_state_sel) {
    case SSM_st_ConnectionUp_connectionStatus_SM :
      if (tr_1_guard_ConnectionUp_connectionStatus_SM) {
        _17_connectionStatus_SM_fired_strong_partial =
  ...
  switch (outC->connectionStatus_SM_state_act) {
    case SSM_st_ConnectionUp_connectionStatus_SM :
      _11_connectionStatus_SM_fired_partial = outC->connectionStatus_SM_fired_strong;
      _10_connectionStatus_SM_reset_nxt_partial = kcg_false;
      _9_connectionStatus_SM_state_nxt_partial =
        SSM_st_ConnectionUp_connectionStatus_SM;
      outC->connectionStatus_SM_state_nxt = _9_connectionStatus_SM_state_nxt_partial;
      break;
    case SSM_st_ConnectionLost_SetupFailed_connectionStatus_SM :
      _7_connectionStatus_SM_fired_partial = outC->connectionStatus_SM_fired_strong;
      _6_connectionStatus_SM_reset_nxt_partial = kcg_false;
      _5_connectionStatus_SM_state_nxt_partial =
        SSM_st_ConnectionLost_SetupFailed_connectionStatus_SM;
      outC->connectionStatus_SM_state_nxt = _5_connectionStatus_SM_state_nxt_partial;
      break;
    case SSM_st_NoConnection_connectionStatus_SM :
  ...
  switch (outC->connectionStatus_SM_state_act) {
    case SSM_st_ConnectionUp_connectionStatus_SM :
      outC->connectionStatus_SM_reset_nxt = _10_connectionStatus_SM_reset_nxt_partial;
      outC->connectionStatus_SM_fired = _11_connectionStatus_SM_fired_partial;
      break;
    case SSM_st_ConnectionLost_SetupFailed_connectionStatus_SM :
      outC->connectionStatus_SM_reset_nxt = _6_connectionStatus_SM_reset_nxt_partial;
      outC->connectionStatus_SM_fired = _7_connectionStatus_SM_fired_partial;
      break;
    case SSM_st_NoConnection_connectionStatus_SM :
  ...
  switch (outC->connectionStatus_SM_state_sel) {
    case SSM_st_ConnectionUp_connectionStatus_SM :
      if (tr_1_guard_ConnectionUp_connectionStatus_SM) {
        _16_connectionStatus_SM_reset_act_partial = kcg_true;
      }
      else {
        _16_connectionStatus_SM_reset_act_partial =
  ...
  switch (outC->connectionStatus_SM_state_sel) {
    case SSM_st_ConnectionUp_connectionStatus_SM :
      outC->connectionStatus_SM_reset_act = _16_connectionStatus_SM_reset_act_partial;
      break;
    case SSM_st_ConnectionLost_SetupFailed_connectionStatus_SM :
