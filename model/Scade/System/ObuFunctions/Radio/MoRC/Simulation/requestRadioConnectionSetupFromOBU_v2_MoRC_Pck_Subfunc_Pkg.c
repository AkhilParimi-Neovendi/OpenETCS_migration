  ...
  outC_requestRadioConnectionSetupFromOBU_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  ...
  /* connectionCmd/ */
  static mobileConnectionCmd_T_RCM_Types_Pkg _8_connectionCmd_partial;
  /* connectionCmd/ */
  static mobileConnectionCmd_T_RCM_Types_Pkg _9_connectionCmd_partial;
  /* connectionCmd/ */
  static mobileConnectionCmd_T_RCM_Types_Pkg _10_connectionCmd_partial;
  /* repeat_SM: */
  ...
  /* repeat_SM: */
  static SSM_ST_repeat_SM _14_repeat_SM_state_nxt_partial;
  /* repeat_SM: */
  static kcg_bool _15_repeat_SM_reset_nxt_partial;
  /* repeat_SM: */
  static SSM_TR_repeat_SM _16_repeat_SM_fired_partial;
  /* repeat_SM: */
  ...
  /* repeat_SM: */
  static SSM_ST_repeat_SM _20_repeat_SM_state_act_partial;
  /* repeat_SM: */
  static kcg_bool _21_repeat_SM_reset_act_partial;
  /* repeat_SM: */
  static SSM_TR_repeat_SM _22_repeat_SM_fired_strong_partial;
  ...
  switch (outC->repeat_SM_state_sel) {
    case SSM_st_rep_repeatUntilSuccessfulOrADefinedNumberOfTimes_repeat_SM :
      tr_1_guard_rep_repeatUntilSuccessfulOrADefinedNumberOfTimes_repeat_SM =
        outC->successfullyConnected | reset3;
  ...
  switch (outC->repeat_SM_state_sel) {
    case SSM_st_rep_repeatUntilStopConditionMet_repeat_SM :
      tr_1_guard_rep_repeatUntilStopConditionMet_repeat_SM =
        outC->repeatStopCondition | reset3;
  ...
  switch (outC->repeat_SM_state_sel) {
    case SSM_st_rep_repeatUntilStopConditionMet_repeat_SM :
      if (tr_1_guard_rep_repeatUntilStopConditionMet_repeat_SM) {
        _20_repeat_SM_state_act_partial = SSM_st_rep_inactive_repeat_SM;
      }
      else {
        _20_repeat_SM_state_act_partial =
          SSM_st_rep_repeatUntilStopConditionMet_repeat_SM;
      }
      outC->repeat_SM_state_act = _20_repeat_SM_state_act_partial;
      if (tr_1_guard_rep_repeatUntilStopConditionMet_repeat_SM) {
        _22_repeat_SM_fired_strong_partial =
        ...
        _22_repeat_SM_fired_strong_partial = SSM_TR_no_trans_repeat_SM;
      }
      outC->repeat_SM_fired_strong = _22_repeat_SM_fired_strong_partial;
      break;
    case SSM_st_rep_repeatUntilSuccessfulOrADefinedNumberOfTimes_repeat_SM :
  ...
  switch (outC->repeat_SM_state_act) {
    case SSM_st_rep_repeatUntilStopConditionMet_repeat_SM :
      _16_repeat_SM_fired_partial = outC->repeat_SM_fired_strong;
      _15_repeat_SM_reset_nxt_partial = kcg_false;
      _14_repeat_SM_state_nxt_partial =
        SSM_st_rep_repeatUntilStopConditionMet_repeat_SM;
      outC->repeat_SM_state_nxt = _14_repeat_SM_state_nxt_partial;
      break;
    case SSM_st_rep_repeatUntilSuccessfulOrADefinedNumberOfTimes_repeat_SM :
  ...
  switch (outC->repeat_SM_state_act) {
    case SSM_st_rep_repeatUntilStopConditionMet_repeat_SM :
      outC->repeat_SM_reset_nxt = _15_repeat_SM_reset_nxt_partial;
      outC->repeat_SM_fired = _16_repeat_SM_fired_partial;
      break;
    case SSM_st_rep_repeatUntilSuccessfulOrADefinedNumberOfTimes_repeat_SM :
  ...
  switch (outC->repeat_SM_state_sel) {
    case SSM_st_rep_repeatUntilStopConditionMet_repeat_SM :
      if (tr_1_guard_rep_repeatUntilStopConditionMet_repeat_SM) {
        _21_repeat_SM_reset_act_partial = kcg_true;
      }
      else {
        _21_repeat_SM_reset_act_partial =
          tr_2_guard_rep_repeatUntilStopConditionMet_repeat_SM;
      }
      break;
    case SSM_st_rep_repeatUntilSuccessfulOrADefinedNumberOfTimes_repeat_SM :
  ...
  switch (outC->repeat_SM_state_sel) {
    case SSM_st_rep_repeatUntilStopConditionMet_repeat_SM :
      outC->repeat_SM_reset_act = _21_repeat_SM_reset_act_partial;
      break;
    case SSM_st_rep_repeatUntilSuccessfulOrADefinedNumberOfTimes_repeat_SM :
