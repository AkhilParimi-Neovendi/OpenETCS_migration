...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P45_RadioNetworkRegistration_T_Packet_Types_Pkg /* P045_onboard/ */ P045_onboard;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  Q_DIR /* _L11/ */ _L11;
  P45_RadioNetworkRegistration_T_Packet_Types_Pkg /* _L10/ */ _L10;
...
extern void C_P045_compr_onboard_init_TM_conversions(
  outC_C_P045_compr_onboard_TM_conversions *outC);
