...
void C_P045_compr_onboard_init_TM_conversions(
  outC_C_P045_compr_onboard_TM_conversions *outC)
{
  static kcg_size idx;
  ...
  outC->_L10.nid_mn = kcg_lit_int32(0);
  ...
  outC->P045_onboard.valid = kcg_true;
  outC->P045_onboard.q_dir = Q_DIR_Reverse;
  outC->P045_onboard.nid_mn = kcg_lit_int32(0);
  /* _L4=(TM_conversions::CAST_Int_to_NID_MN#1)/ */
...
/*
  Expanded instances for: TM_conversions::C_P045_compr_onboard/
