  ...
  outC_dec_m32_RCM_Utils_Pkg_decoders *outC)
{
  ...
  kcg_copy_msgFromTrack_T_RCM_MsgTypes_Pkg(&outC->_L114, _1_msg_in);
  ...
  outC_dec_m32_RCM_Utils_Pkg_decoders *outC)
{
  ...
  outC->_L115.rbc_id = kcg_lit_int32(0);
  outC->_L115.device_id = kcg_lit_int32(0);
  ...
  outC->_L114.BG_Common_Header.m_mcount = kcg_lit_int32(0);
  outC->_L114.BG_Common_Header.nid_c = kcg_lit_int32(0);
  outC->_L114.BG_Common_Header.nid_bg = kcg_lit_int32(0);
  outC->_L114.BG_Common_Header.q_link = Q_LINK_Unlinked;
  outC->_L114.BG_Common_Header.bgPosition.valid = kcg_true;
  outC->_L114.BG_Common_Header.bgPosition.timestamp = kcg_lit_int32(0);
  outC->_L114.BG_Common_Header.bgPosition.odo.o_nominal = kcg_lit_int32(0);
  outC->_L114.BG_Common_Header.bgPosition.odo.o_min = kcg_lit_int32(0);
  outC->_L114.BG_Common_Header.bgPosition.odo.o_max = kcg_lit_int32(0);
  outC->_L114.BG_Common_Header.bgPosition.speed.v_safeNominal = kcg_lit_int32(0);
  outC->_L114.BG_Common_Header.bgPosition.speed.v_rawNominal = kcg_lit_int32(0);
  outC->_L114.BG_Common_Header.bgPosition.speed.v_lower = kcg_lit_int32(0);
  outC->_L114.BG_Common_Header.bgPosition.speed.v_upper = kcg_lit_int32(0);
  outC->_L114.BG_Common_Header.bgPosition.acceleration = kcg_lit_int32(0);
  ...
  outC->_L114.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int32(0);
  outC->_L114.BG_Common_Header.q_nvlocacc = kcg_lit_int32(0);
  ...
  outC->_L114.Radio_Common_Header.radioDevice = kcg_lit_int32(0);
  outC->_L114.Radio_Common_Header.receivedSystemTime = kcg_lit_int32(0);
  outC->_L114.Radio_Common_Header.nid_message = kcg_lit_int32(0);
  outC->_L114.Radio_Common_Header.t_train = kcg_lit_int32(0);
  outC->_L114.Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_required;
  outC->_L114.Radio_Common_Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L114.Radio_Common_Header.t_train_reference = kcg_lit_int32(0);
  outC->_L114.Radio_Common_Header.nid_em = kcg_lit_int32(0);
  outC->_L114.Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L114.Radio_Common_Header.d_sr = kcg_lit_int32(0);
  outC->_L114.Radio_Common_Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L114.Radio_Common_Header.d_ref = kcg_lit_int32(0);
  outC->_L114.Radio_Common_Header.q_dir = Q_DIR_Reverse;
  outC->_L114.Radio_Common_Header.d_emergencystop = kcg_lit_int32(0);
  outC->_L114.Radio_Common_Header.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  for (idx = 0; idx < 30; idx++) {
    outC->_L114.packets.PacketHeaders[idx].nid_packet = kcg_lit_int32(0);
    outC->_L114.packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L114.packets.PacketHeaders[idx].valid = kcg_true;
    outC->_L114.packets.PacketHeaders[idx].startAddress = kcg_lit_int32(0);
    outC->_L114.packets.PacketHeaders[idx].endAddress = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L114.packets.PacketData[idx1] = kcg_lit_int32(0);
  }
  outC->_L114.sendingRBC.valid = kcg_true;
  outC->_L114.sendingRBC.nid_c = kcg_lit_int32(0);
  outC->_L114.sendingRBC.rbc_id = kcg_lit_int32(0);
  outC->_L114.sendingRBC.device_id = kcg_lit_int32(0);
  ...
  outC->_L112.origin.nid_c = kcg_lit_int32(0);
  outC->_L112.origin.rbc_id = kcg_lit_int32(0);
  outC->_L112.origin.device_id = kcg_lit_int32(0);
  outC->_L112.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L111 = kcg_true;
  outC->_L109 = kcg_lit_int32(0);
  outC->_L93.radioDevice = kcg_lit_int32(0);
  outC->_L93.receivedSystemTime = kcg_lit_int32(0);
  outC->_L93.nid_message = kcg_lit_int32(0);
  outC->_L93.t_train = kcg_lit_int32(0);
  outC->_L93.m_ack = M_ACK_No_acknowledgement_required;
  outC->_L93.nid_lrbg = kcg_lit_int32(0);
  outC->_L93.t_train_reference = kcg_lit_int32(0);
  outC->_L93.nid_em = kcg_lit_int32(0);
  outC->_L93.q_scale = Q_SCALE_10_cm_scale;
  outC->_L93.d_sr = kcg_lit_int32(0);
  outC->_L93.t_sh_rqst = kcg_lit_int32(0);
  outC->_L93.d_ref = kcg_lit_int32(0);
  outC->_L93.q_dir = Q_DIR_Reverse;
  outC->_L93.d_emergencystop = kcg_lit_int32(0);
  outC->_L93.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  ...
  outC->m32_RBC_or_RIU_System_Version.origin.nid_c = kcg_lit_int32(0);
  outC->m32_RBC_or_RIU_System_Version.origin.rbc_id = kcg_lit_int32(0);
  outC->m32_RBC_or_RIU_System_Version.origin.device_id = kcg_lit_int32(0);
