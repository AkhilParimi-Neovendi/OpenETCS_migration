...
void kcg_save_SV_countUp_CalculateTrainPosition_Pkg_gp_functions_Pkg(
...
void kcg_load_SV_countUp_CalculateTrainPosition_Pkg_gp_functions_Pkg(
  outC_countUp_CalculateTrainPosition_Pkg_gp_functions_Pkg *outC,
  SV_countUp_CalculateTrainPosition_Pkg_gp_functions_Pkg *SV)
{
