...
typedef struct {
  ...
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_RadioTrackTrainHeader__Get_M_ACK_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* GENERAL_MESSAGE_SM:SEND_GENERAL_MESSAGE:_L33=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_M_ACK#2)/ */ Context_RadioTrackTrainHeader__Get_M_ACK_2;
  outC_RadioTrackTrainMessage__GetHeader_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* GENERAL_MESSAGE_SM:SEND_GENERAL_MESSAGE:_L34=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__GetHeader#10)/ */ Context_RadioTrackTrainMessage__GetHeader_10;
  outC_RadioTrackTrainHeader__Get_NID_MESSAGE_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* GENERAL_MESSAGE_SM:AWAIT_ACKNOWLEDGEMENT:_L6=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_NID_MESSAGE#3)/ */ Context_RadioTrackTrainHeader__Get_NID_MESSAGE_3;
  outC_RadioTrackTrainHeader__Get_T_TRAIN_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* GENERAL_MESSAGE_SM:AWAIT_ACKNOWLEDGEMENT:_L8=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_T_TRAIN#2)/ */ Context_RadioTrackTrainHeader__Get_T_TRAIN_2;
  outC_RadioTrackTrainMessage__GetHeader_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* GENERAL_MESSAGE_SM:AWAIT_ACKNOWLEDGEMENT:_L3=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__GetHeader#4)/ */ Context_RadioTrackTrainMessage__GetHeader_4;
  outC_RadioTrainTrackHeader__Get_T_TRAIN_Ref_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* GENERAL_MESSAGE_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L16=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__Get_T_TRAIN_Ref#2)/ */ Context_RadioTrainTrackHeader__Get_T_TRAIN_Ref_2;
  outC_RadioTrainTrackMessage__GetHeader_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* GENERAL_MESSAGE_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L14=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__GetHeader#5)/ */ Context_RadioTrainTrackMessage__GetHeader_5;
  outC_RadioTrackTrainHeader__Get_T_TRAIN_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* GENERAL_MESSAGE_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L20=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_T_TRAIN#3)/ */ Context_RadioTrackTrainHeader__Get_T_TRAIN_3;
  outC_RadioTrackTrainHeader__Get_NID_MESSAGE_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* GENERAL_MESSAGE_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L22=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_NID_MESSAGE#4)/ */ Context_RadioTrackTrainHeader__Get_NID_MESSAGE_4;
  outC_RadioTrackTrainMessage__GetHeader_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* GENERAL_MESSAGE_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L23=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__GetHeader#5)/ */ Context_RadioTrackTrainMessage__GetHeader_5;
  outC_RadioTrackTrainMessageQueue__TryPut_RBC_Collections_Pkg /* GENERAL_MESSAGE_SM:SEND_GENERAL_MESSAGE:_L20=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__TryPut#1)/ */ Context_RadioTrackTrainMessageQueue__TryPut_1;
  outC_RadioTrackTrainMessageQueueEntry__Create_RBC_Collections_Pkg /* GENERAL_MESSAGE_SM:SEND_GENERAL_MESSAGE:_L22=(RBC_Collections_Pkg::RadioTrackTrainMessageQueueEntry__Create#1)/ */ Context_RadioTrackTrainMessageQueueEntry__Create_1;
  outC_RadioTrackTrainHeader__Get_NID_MESSAGE_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* _L60=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_NID_MESSAGE#5)/ */ Context_RadioTrackTrainHeader__Get_NID_MESSAGE_5;
  outC_RadioTrackTrainMessage__GetHeader_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* _L61=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__GetHeader#7)/ */ Context_RadioTrackTrainMessage__GetHeader_7;
  ...
  outC_RadioTrainTrackMessage__GetHeader_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* _L68=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__GetHeader#6)/ */ Context_RadioTrainTrackMessage__GetHeader_6;
  ...
  RadioTrackTrainMessageQueue_T /* GENERAL_MESSAGE_SM:IDLE:_L5/ */ _L5_IDLE_GENERAL_MESSAGE_SM;
  RadioTrackTrainMessageQueue_T /* GENERAL_MESSAGE_SM:SEND_GENERAL_MESSAGE:_L46/ */ _L46_SEND_GENERAL_MESSAGE_GENERAL_MESSAGE_SM;
  ...
  RadioTrackTrainMessageQueue_T /* GENERAL_MESSAGE_SM:SEND_GENERAL_MESSAGE:_L20/ */ _L20_SEND_GENERAL_MESSAGE_GENERAL_MESSAGE_SM;
  ...
  RadioTrackTrainMessageQueue_T /* GENERAL_MESSAGE_SM:AWAIT_ACKNOWLEDGEMENT:_L14/ */ _L14_AWAIT_ACKNOWLEDGEMENT_GENERAL_MESSAGE_SM;
  ...
  RadioTrackTrainMessageQueue_T /* GENERAL_MESSAGE_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L27/ */ _L27_TRY_PROCESS_ACKNOWLEDGEMENT_GENERAL_MESSAGE_SM;
  ...
  RadioTrackTrainMessageQueue_T /* _L81/ */ _L81;
...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  T_TRAIN /* radioTrackTrainMessageWasSentTimestamp/ */ Context_radioTrackTrainMessageWasSentTimestamp;
  kcg_bool /* ackRequired/ */ Context_ackRequired;
  kcg_bool /* GENERAL_MESSAGE_SM: */ Context_GENERAL_MESSAGE_SM_reset_nxt;
  kcg_bool /* GENERAL_MESSAGE_SM: */ Context_GENERAL_MESSAGE_SM_reset_act;
  SSM_ST_GENERAL_MESSAGE_SM /* GENERAL_MESSAGE_SM: */ Context_GENERAL_MESSAGE_SM_state_nxt;
  kcg_bool /* validAck/ */ Context_validAck;
  kcg_bool /* invalidAck/ */ Context_invalidAck;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
} SV_RBC__ProcessGeneralMessage_RBC_Model_Pkg;

extern void kcg_save_SV_RBC__ProcessGeneralMessage_RBC_Model_Pkg(
  SV_RBC__ProcessGeneralMessage_RBC_Model_Pkg *SV,
  outC_RBC__ProcessGeneralMessage_RBC_Model_Pkg *outC);
extern void kcg_load_SV_RBC__ProcessGeneralMessage_RBC_Model_Pkg(
  outC_RBC__ProcessGeneralMessage_RBC_Model_Pkg *outC,
  SV_RBC__ProcessGeneralMessage_RBC_Model_Pkg *SV);
