...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P004_TrainTrack_int_TM_TrainToTrack /* P004_int/ */ P004_int;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_CAST_L_PACKET_to_int_TM_conversions /* _L70=(TM_conversions::CAST_L_PACKET_to_int#1)/ */ Context_CAST_L_PACKET_to_int_1;
  outC_CAST_M_ERROR_to_int_TM_conversions /* _L71=(TM_conversions::CAST_M_ERROR_to_int#1)/ */ Context_CAST_M_ERROR_to_int_1;
...
extern void C_P004_train_compr_init_TM_TrainToTrack(
  outC_C_P004_train_compr_TM_TrainToTrack *outC);
