...
void Write_DMI_Display_Control_to_int_DATA_Packets_EVC_to_DMI(
...
{
  static DMI_Display_Control_int_array_T_DATA op_call;
  ...
  if (outC->every) {
    ...
    CAST_DMI_Display_Control_to_int1_DATA_Packets_EVC_to_DMI(
      &outC->_L1,
...
void Write_DMI_Display_Control_to_int_init_DATA_Packets_EVC_to_DMI(
  outC_Write_DMI_Display_Control_to_int_DATA_Packets_EVC_to_DMI *outC)
{
  static kcg_size idx;
...
void Write_DMI_Display_Control_to_int_reset_DATA_Packets_EVC_to_DMI(
  outC_Write_DMI_Display_Control_to_int_DATA_Packets_EVC_to_DMI *outC)
{
  /* _L8=(DATA::Packets::EVC_to_DMI::CAST_DMI_Display_Control_to_int1#1)/ */
  CAST_DMI_Display_Control_to_int1_reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_CAST_DMI_Display_Control_to_int1_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Write_DMI_Display_Control_to_int_DATA_Packets_EVC_to_DMI.c
** Generation date: 2023-11-05T09:07:00
*************************************************************$ */
