  ...
  outC_RadioTrackTrainMessageQueue__SetEntries_RBC_Collections_Pkg *outC)
{
  ...
  kcg_copy_RadioTrackTrainMessageQueueEntries_T(
    &outC->_L1,
    inRadioTrackTrainMessageQueueEntries);
  kcg_copy_RadioTrackTrainMessageQueue_T(&outC->_L3, &outC->_L5);
  if (kcg_true) {
    kcg_copy_RadioTrackTrainMessageQueueEntries_T(&outC->_L3.m_Entries, &outC->_L1);
  }
  kcg_copy_RadioTrackTrainMessageQueue_T(
...
void RadioTrackTrainMessageQueue__SetEntries_init_RBC_Collections_Pkg(
  outC_RadioTrackTrainMessageQueue__SetEntries_RBC_Collections_Pkg *outC)
{
  static kcg_size idx;
  ...
  for (idx2 = 0; idx2 < 8; idx2++) {
    ...
    outC->_L5.m_Entries[idx2].m_Entry.Header.radioDevice = kcg_lit_int64(0);
    outC->_L5.m_Entries[idx2].m_Entry.Header.receivedSystemTime = kcg_lit_int64(0);
    outC->_L5.m_Entries[idx2].m_Entry.Header.nid_message = kcg_lit_int64(0);
    outC->_L5.m_Entries[idx2].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L5.m_Entries[idx2].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L5.m_Entries[idx2].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L5.m_Entries[idx2].m_Entry.Header.t_train_reference = kcg_lit_int64(0);
    outC->_L5.m_Entries[idx2].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L5.m_Entries[idx2].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L5.m_Entries[idx2].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L5.m_Entries[idx2].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L5.m_Entries[idx2].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L5.m_Entries[idx2].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L5.m_Entries[idx2].m_Entry.Header.d_emergencystop = kcg_lit_int64(0);
    outC->_L5.m_Entries[idx2].m_Entry.Header.m_version = kcg_lit_int64(0);
    ...
    for (idx1 = 0; idx1 < 500; idx1++) {
      outC->_L5.m_Entries[idx2].m_Entry.Messages.PacketData[idx1] = kcg_lit_int64(0);
    }
  }
  for (idx5 = 0; idx5 < 8; idx5++) {
    outC->_L3.m_Entries[idx5].m_IsValid = kcg_true;
    outC->_L3.m_Entries[idx5].m_Entry.Header.radioDevice = kcg_lit_int64(0);
    outC->_L3.m_Entries[idx5].m_Entry.Header.receivedSystemTime = kcg_lit_int64(0);
    outC->_L3.m_Entries[idx5].m_Entry.Header.nid_message = kcg_lit_int64(0);
    outC->_L3.m_Entries[idx5].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L3.m_Entries[idx5].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L3.m_Entries[idx5].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L3.m_Entries[idx5].m_Entry.Header.t_train_reference = kcg_lit_int64(0);
    outC->_L3.m_Entries[idx5].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L3.m_Entries[idx5].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L3.m_Entries[idx5].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L3.m_Entries[idx5].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L3.m_Entries[idx5].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L3.m_Entries[idx5].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L3.m_Entries[idx5].m_Entry.Header.d_emergencystop = kcg_lit_int64(0);
    outC->_L3.m_Entries[idx5].m_Entry.Header.m_version = kcg_lit_int64(0);
    ...
    for (idx4 = 0; idx4 < 500; idx4++) {
      outC->_L3.m_Entries[idx5].m_Entry.Messages.PacketData[idx4] = kcg_lit_int64(0);
    }
  }
  for (idx8 = 0; idx8 < 8; idx8++) {
    outC->_L1[idx8].m_IsValid = kcg_true;
    outC->_L1[idx8].m_Entry.Header.radioDevice = kcg_lit_int64(0);
    outC->_L1[idx8].m_Entry.Header.receivedSystemTime = kcg_lit_int64(0);
    outC->_L1[idx8].m_Entry.Header.nid_message = kcg_lit_int64(0);
    outC->_L1[idx8].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L1[idx8].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L1[idx8].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L1[idx8].m_Entry.Header.t_train_reference = kcg_lit_int64(0);
    outC->_L1[idx8].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L1[idx8].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L1[idx8].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L1[idx8].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L1[idx8].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L1[idx8].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L1[idx8].m_Entry.Header.d_emergencystop = kcg_lit_int64(0);
    outC->_L1[idx8].m_Entry.Header.m_version = kcg_lit_int64(0);
    ...
    for (idx7 = 0; idx7 < 500; idx7++) {
      outC->_L1[idx8].m_Entry.Messages.PacketData[idx7] = kcg_lit_int64(0);
    }
  }
...
void RadioTrackTrainMessageQueue__SetEntries_reset_RBC_Collections_Pkg(
  outC_RadioTrackTrainMessageQueue__SetEntries_RBC_Collections_Pkg *outC)
{
}
