...
void kcg_save_SV_locReachedOrPassed_BasicLocationFunctions_Pkg(
  SV_locReachedOrPassed_BasicLocationFunctions_Pkg *SV,
  outC_locReachedOrPassed_BasicLocationFunctions_Pkg *outC)
{
  kcg_save_SV_signChanged_BasicLocationFunctions_Pkg(
    &SV->Context_signChanged_2,
    &outC->Context_signChanged_2);
  kcg_save_SV_signChanged_BasicLocationFunctions_Pkg(
    &SV->Context_signChanged_1,
    &outC->Context_signChanged_1);
...
void kcg_load_SV_locReachedOrPassed_BasicLocationFunctions_Pkg(
  outC_locReachedOrPassed_BasicLocationFunctions_Pkg *outC,
  SV_locReachedOrPassed_BasicLocationFunctions_Pkg *SV)
{
  kcg_load_SV_signChanged_BasicLocationFunctions_Pkg(
    &outC->Context_signChanged_2,
    &SV->Context_signChanged_2);
  kcg_load_SV_signChanged_BasicLocationFunctions_Pkg(
    &outC->Context_signChanged_1,
