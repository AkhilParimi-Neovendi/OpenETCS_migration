...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  RBC_Data_T_RBC_DataBus_Pkg /* dataBus/ */ Context_dataBus;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_ToOldRadioTrainTrackMsg_RBC_Model_Pkg_TrainTrackMsgConversion Context_ToOldRadioTrainTrackMsg_1;
  SV_DataBusFactory_RBC_DataBus_Pkg Context_DataBusFactory_1;
  SV_RadioTrainTrackInputHandler_RBC_Messaging_Pkg Context_RadioTrainTrackInputHandler_1;
  SV_RBC__ProcessController_RBC_Model_Pkg Context_RBC__ProcessController_1;
} SV_RBC_New_RBC_Model_Pkg;

extern void kcg_save_SV_RBC_New_RBC_Model_Pkg(
  SV_RBC_New_RBC_Model_Pkg *SV,
  outC_RBC_New_RBC_Model_Pkg *outC);
extern void kcg_load_SV_RBC_New_RBC_Model_Pkg(
  outC_RBC_New_RBC_Model_Pkg *outC,
  SV_RBC_New_RBC_Model_Pkg *SV);
