  ...
  outC_CAST_int_to_DMI_Icons1_DATA_Packets_EVC_to_DMI *outC)
{
  ...
  outC->_L11.DMI_m_icon_flashing_freq = kcg_lit_float32(0.0);
  outC->_L11.DMI_nid_icon_group = level_symbol_DMI_Types_Pkg;
  outC->_L11.DMI_nid_icon_rank = kcg_lit_int32(0);
  outC->_L11.DMI_nid_area_group = A_DMI_Types_Pkg;
  outC->_L11.DMI_nid_area_rank = kcg_lit_int32(0);
  outC->_L11.DMI_nid_icon_identifier = kcg_lit_int32(0);
