...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_mergeMsgToBus_RCM_Utils_Pkg_encoders Context_mergeMsgToBus_1;
  SV_mergeMsgToBus_RCM_Utils_Pkg_encoders Context_mergeMsgToBus_4;
  SV_genMsgToBus_RCM_Utils_Pkg_encoders Context_genMsgToBus_1;
  SV_mergeMsgToBus_RCM_Utils_Pkg_encoders Context_mergeMsgToBus_7;
  SV_genMsgToBus_RCM_Utils_Pkg_encoders Context_genMsgToBus_2;
  SV_mergeMsgToBus_RCM_Utils_Pkg_encoders Context_mergeMsgToBus_5;
  SV_genMsgToBus_RCM_Utils_Pkg_encoders Context_genMsgToBus_3;
} SV_mobileBusRouter_out_Handover_Pkg_handoverUtils_Pkg;

extern void kcg_save_SV_mobileBusRouter_out_Handover_Pkg_handoverUtils_Pkg(
  SV_mobileBusRouter_out_Handover_Pkg_handoverUtils_Pkg *SV,
  outC_mobileBusRouter_out_Handover_Pkg_handoverUtils_Pkg *outC);
extern void kcg_load_SV_mobileBusRouter_out_Handover_Pkg_handoverUtils_Pkg(
  outC_mobileBusRouter_out_Handover_Pkg_handoverUtils_Pkg *outC,
  SV_mobileBusRouter_out_Handover_Pkg_handoverUtils_Pkg *SV);
