  ...
  outC_Msg154ConsistencyChecker__HasConsistentPackets_RBC_Messaging_Pkg_RBC_Consistency_Pkg *outC)
{
  ...
  outC->_L11.packet1.NID_PACKET = kcg_lit_int64(0);
  outC->_L11.packet1.L_PACKET = kcg_lit_int64(0);
  outC->_L11.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L11.packet1.NID_LRBG = kcg_lit_int64(0);
  outC->_L11.packet1.NID_PRVLRBG = kcg_lit_int64(0);
  outC->_L11.packet1.D_LRBG = kcg_lit_int64(0);
  outC->_L11.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L11.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L11.packet1.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L11.packet1.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L11.packet1.length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L11.packet1.L_TRAININT = kcg_lit_int64(0);
  outC->_L11.packet1.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L11.packet1.NID_NTC = kcg_lit_int64(0);
  outC->_L12 = kcg_true;
  outC->_L13 = kcg_true;
  outC->_L14 = kcg_true;
  outC->_L15 = kcg_true;
  outC->_L16.p0.valid = kcg_true;
  outC->_L16.p0.packet0.NID_PACKET = kcg_lit_int64(0);
  outC->_L16.p0.packet0.L_PACKET = kcg_lit_int64(0);
  outC->_L16.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L16.p0.packet0.NID_LRBG = kcg_lit_int64(0);
  outC->_L16.p0.packet0.D_LRBG = kcg_lit_int64(0);
  outC->_L16.p0.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L16.p0.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->_L16.p0.packet0.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L16.p0.packet0.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L16.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L16.p0.packet0.L_TRAININT = kcg_lit_int64(0);
  outC->_L16.p0.packet0.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L16.p0.packet0.NID_NTC = kcg_lit_int64(0);
  outC->_L16.p1.valid = kcg_true;
  outC->_L16.p1.packet1.NID_PACKET = kcg_lit_int64(0);
  outC->_L16.p1.packet1.L_PACKET = kcg_lit_int64(0);
  outC->_L16.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L16.p1.packet1.NID_LRBG = kcg_lit_int64(0);
  outC->_L16.p1.packet1.NID_PRVLRBG = kcg_lit_int64(0);
  outC->_L16.p1.packet1.D_LRBG = kcg_lit_int64(0);
  outC->_L16.p1.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L16.p1.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L16.p1.packet1.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L16.p1.packet1.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L16.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L16.p1.packet1.L_TRAININT = kcg_lit_int64(0);
  outC->_L16.p1.packet1.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L16.p1.packet1.NID_NTC = kcg_lit_int64(0);
  outC->_L16.p3.valid = kcg_true;
  outC->_L16.p3.number = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 1; idx3++) {
    outC->_L16.p3.aNID_RADIO[idx3].valid = kcg_true;
    for (idx2 = 0; idx2 < 15; idx2++) {
      outC->_L16.p3.aNID_RADIO[idx3].telephoneNumber[idx2] = kcg_lit_int64(0);
    }
  }
  ...
  outC->_L16.p5.TrainRunningNumber = kcg_lit_int64(0);
  outC->_L16.p9.valid = kcg_true;
  outC->_L16.p9.transitionInformation = kcg_lit_int64(0);
  outC->_L16.p11.valid = kcg_true;
  outC->_L16.p11.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L16.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L16.p11.l_train = kcg_lit_int64(0);
  outC->_L16.p11.v_maxtrain = kcg_lit_int64(0);
  outC->_L16.p11.m_loadinggoage =
    M_LOADINGGAUGE_The_train_does_not_fit_to_any_of_the_interoperable_loading_gauge_profiles;
  outC->_L16.p11.m_axleloadcat = M_AXLELOADCAT_A;
  outC->_L16.p11.m_airtight = M_AIRTIGHT_Not_fitted;
  outC->_L16.p11.n_axle = kcg_lit_int64(0);
  outC->_L16.p11.nIter_tractionIdentity = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 4; idx4++) {
    outC->_L16.p11.tractionIdentity[idx4].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L16.p11.tractionIdentity[idx4].nid_ctraction = kcg_lit_int64(0);
  }
  outC->_L16.p11.nIter_ntc = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 5; idx5++) {
    outC->_L16.p11.nid_ntc[idx5] = kcg_lit_int64(0);
  }
  outC->_L17 = kcg_true;
  ...
  for (idx7 = 0; idx7 < 1; idx7++) {
    ...
    for (idx6 = 0; idx6 < 15; idx6++) {
      outC->_L18.aNID_RADIO[idx7].telephoneNumber[idx6] = kcg_lit_int64(0);
    }
  }
  outC->_L20 = kcg_true;
  outC->_L21.valid = kcg_true;
  outC->_L21.packet0.NID_PACKET = kcg_lit_int64(0);
  outC->_L21.packet0.L_PACKET = kcg_lit_int64(0);
  outC->_L21.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L21.packet0.NID_LRBG = kcg_lit_int64(0);
  outC->_L21.packet0.D_LRBG = kcg_lit_int64(0);
  outC->_L21.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L21.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->_L21.packet0.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L21.packet0.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L21.packet0.length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L21.packet0.L_TRAININT = kcg_lit_int64(0);
  outC->_L21.packet0.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L21.packet0.NID_NTC = kcg_lit_int64(0);
  outC->_L22 = kcg_true;
