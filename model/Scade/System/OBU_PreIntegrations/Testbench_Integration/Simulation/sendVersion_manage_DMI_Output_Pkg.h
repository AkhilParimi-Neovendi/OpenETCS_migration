...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* versionSent/ */ Context_versionSent;
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
} SV_sendVersion_manage_DMI_Output_Pkg;

extern void kcg_save_SV_sendVersion_manage_DMI_Output_Pkg(
  SV_sendVersion_manage_DMI_Output_Pkg *SV,
  outC_sendVersion_manage_DMI_Output_Pkg *outC);
extern void kcg_load_SV_sendVersion_manage_DMI_Output_Pkg(
  outC_sendVersion_manage_DMI_Output_Pkg *outC,
  SV_sendVersion_manage_DMI_Output_Pkg *SV);
