  ...
  outC_ConvertMA_SDM_Input_Wrappers *outC)
{
  ...
  TransformV_intToV_real_SDM_Types_Pkg(
    outC->_L134,
    &outC->Context_TransformV_intToV_real_3);
  outC->_L187 = outC->Context_TransformV_intToV_real_3.v_real;
  ...
  TransformL_intToL_real_SDM_Types_Pkg(
    outC->_L200,
    &outC->Context_TransformL_intToL_real_2);
  outC->_L21 = outC->Context_TransformL_intToL_real_2.loc_real;
  /* _L23=(SDM_Types_Pkg::TransformV_intToV_real#2)/ */
  TransformV_intToV_real_SDM_Types_Pkg(
    outC->_L125,
    &outC->Context_TransformV_intToV_real_2);
  outC->_L23 = outC->Context_TransformV_intToV_real_2.v_real;
  ...
  outC->_L19 = outC->Context_TransformL_intToL_real_1.loc_real;
