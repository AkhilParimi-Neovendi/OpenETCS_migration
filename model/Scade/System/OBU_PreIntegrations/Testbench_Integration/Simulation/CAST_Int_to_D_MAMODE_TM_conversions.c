...
void CAST_Int_to_D_MAMODE_TM_conversions(
  /* d_mamode_int/ */
  kcg_int32 d_mamode_int,
  ...
  outC_CAST_Int_to_D_MAMODE_TM_conversions *outC)
{
  ...
  outC->d_mamode = kcg_lit_int32(0);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void CAST_Int_to_D_MAMODE_reset_TM_conversions(
  outC_CAST_Int_to_D_MAMODE_TM_conversions *outC)
{
}
