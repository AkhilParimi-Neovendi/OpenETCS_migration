...
void Write_P005_TM_trackside(
  /* Packet05/ */
  P005_trackside_int_T_TM *Packet05,
  /* Packets/ */
  CompressedPackets_T_Common_Types_Pkg *Packets,
  outC_Write_P005_TM_trackside *outC)
{
  kcg_copy_P005_trackside_int_T_TM(&outC->_L1, Packet05);
  /* _L43=(TM_conversions::C_P005_tracksim_compr#1)/ */
  C_P005_tracksim_compr_TM_conversions(
    &outC->_L1,
    &outC->Context_C_P005_tracksim_compr_1);
  kcg_copy_MetadataElement_T_Common_Types_Pkg(
    &outC->_L43,
    &outC->Context_C_P005_tracksim_compr_1.Header);
  kcg_copy_CompressedPacketData_T_Common_Types_Pkg(
    &outC->_L44,
    &outC->Context_C_P005_tracksim_compr_1.P005_compressed);
...
void Write_P005_init_TM_trackside(outC_Write_P005_TM_trackside *outC)
{
  static kcg_size idx;
  ...
  for (idx9 = 0; idx9 < 32; idx9++) {
    outC->_L1.SECTIONS[idx9].D_LINK = kcg_lit_int32(0);
    outC->_L1.SECTIONS[idx9].Q_NEWCOUNTRY = kcg_lit_int32(0);
    outC->_L1.SECTIONS[idx9].NID_C = kcg_lit_int32(0);
    outC->_L1.SECTIONS[idx9].NID_BG = kcg_lit_int32(0);
    outC->_L1.SECTIONS[idx9].Q_LINKORIENTATION = kcg_lit_int32(0);
    outC->_L1.SECTIONS[idx9].Q_LINKREACTION = kcg_lit_int32(0);
    outC->_L1.SECTIONS[idx9].Q_LOCACC = kcg_lit_int32(0);
  }
  ...
  SEND_WriteBaliseMessageHeader_init_TM_lib_internal(
    &outC->Context_SEND_WriteBaliseMessageHeader_1);
  /* _L43=(TM_conversions::C_P005_tracksim_compr#1)/ */
  C_P005_tracksim_compr_init_TM_conversions(
    &outC->Context_C_P005_tracksim_compr_1);
}
...
void Write_P005_reset_TM_trackside(outC_Write_P005_TM_trackside *outC)
{
  ...
  SEND_WriteBaliseMessageHeader_reset_TM_lib_internal(
    &outC->Context_SEND_WriteBaliseMessageHeader_1);
  /* _L43=(TM_conversions::C_P005_tracksim_compr#1)/ */
  C_P005_tracksim_compr_reset_TM_conversions(
    &outC->Context_C_P005_tracksim_compr_1);
}
