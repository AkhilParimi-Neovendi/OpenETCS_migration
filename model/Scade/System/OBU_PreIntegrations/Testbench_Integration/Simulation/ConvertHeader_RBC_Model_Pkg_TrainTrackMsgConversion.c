...
{
  /* nid_textmessage/ */
  static NID_TEXTMESSAGE nid_textmessage_partial;
  /* nid_textmessage/ */
  static NID_TEXTMESSAGE _1_nid_textmessage_partial;
  /* nid_em/ */
  static NID_EM nid_em_partial;
  /* q_emergencystop/ */
  static Q_EMERGENCYSTOP q_emergencystop_partial;
  /* nid_em/ */
  static NID_EM _2_nid_em_partial;
  /* q_emergencystop/ */
  static Q_EMERGENCYSTOP _3_q_emergencystop_partial;
  /* xt_train/ */
  static T_TRAIN xt_train_partial;
  /* xt_train/ */
  static T_TRAIN _4_xt_train_partial;
  /* q_marqstreason/ */
