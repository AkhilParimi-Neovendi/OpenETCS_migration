...
typedef struct {
  ...
  kcg_bool /* _L35/ */ _L35;
  kcg_bool /* _L34/ */ _L34;
} outC_validateDataDirectionForSinglePacket_ValidateDataDirectionGeneral_Pkg_Subfunctions;
...
extern void validateDataDirectionForSinglePacket_reset_ValidateDataDirectionGeneral_Pkg_Subfunctions(
  outC_validateDataDirectionForSinglePacket_ValidateDataDirectionGeneral_Pkg_Subfunctions *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void validateDataDirectionForSinglePacket_init_ValidateDataDirectionGeneral_Pkg_Subfunctions(
  outC_validateDataDirectionForSinglePacket_ValidateDataDirectionGeneral_Pkg_Subfunctions *outC);
