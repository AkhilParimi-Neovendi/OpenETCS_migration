  ...
  outC_checkTelegram_Receive_TrackSide_Msg_Pkg *outC)
{
  ...
  for (idx2 = 0; idx2 < 8; idx2++) {
    ...
    outC->_L94[idx2].telegramheader.m_mcount = kcg_lit_int64(0);
    outC->_L94[idx2].telegramheader.nid_c = kcg_lit_int64(0);
    outC->_L94[idx2].telegramheader.nid_bg = kcg_lit_int64(0);
    outC->_L94[idx2].telegramheader.q_link = Q_LINK_Unlinked;
    for (idx = 0; idx < 30; idx++) {
      outC->_L94[idx2].packets.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
      outC->_L94[idx2].packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
      outC->_L94[idx2].packets.PacketHeaders[idx].valid = kcg_true;
      outC->_L94[idx2].packets.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
      outC->_L94[idx2].packets.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
    }
    for (idx1 = 0; idx1 < 500; idx1++) {
      outC->_L94[idx2].packets.PacketData[idx1] = kcg_lit_int64(0);
    }
  }
  outC->_L93.badBaliseFlag = kcg_true;
  outC->_L93.BGMessageSent = kcg_true;
  outC->_L93.C_ID = kcg_lit_int64(0);
  outC->_L93.BG_ID = kcg_lit_int64(0);
  outC->_L93.balisePosition.odometerOfBaliseDetection.valid = kcg_true;
  outC->_L93.balisePosition.odometerOfBaliseDetection.timestamp = kcg_lit_int64(
      0);
  outC->_L93.balisePosition.odometerOfBaliseDetection.odo.o_nominal =
    kcg_lit_int64(0);
  outC->_L93.balisePosition.odometerOfBaliseDetection.odo.o_min = kcg_lit_int64(
      0);
  outC->_L93.balisePosition.odometerOfBaliseDetection.odo.o_max = kcg_lit_int64(
      0);
  ...
  outC->_L93.positionFirstContact.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L93.collectedTelegrams = kcg_lit_int64(0);
  outC->_L93.totalTelegrams = kcg_lit_int64(0);
  outC->_L92.badBaliseFlag = kcg_true;
  outC->_L92.BGMessageSent = kcg_true;
  outC->_L92.C_ID = kcg_lit_int64(0);
  outC->_L92.BG_ID = kcg_lit_int64(0);
  outC->_L92.balisePosition.odometerOfBaliseDetection.valid = kcg_true;
  outC->_L92.balisePosition.odometerOfBaliseDetection.timestamp = kcg_lit_int64(
      0);
  outC->_L92.balisePosition.odometerOfBaliseDetection.odo.o_nominal =
    kcg_lit_int64(0);
  outC->_L92.balisePosition.odometerOfBaliseDetection.odo.o_min = kcg_lit_int64(
      0);
  outC->_L92.balisePosition.odometerOfBaliseDetection.odo.o_max = kcg_lit_int64(
      0);
  ...
  outC->_L92.positionFirstContact.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L92.collectedTelegrams = kcg_lit_int64(0);
  outC->_L92.totalTelegrams = kcg_lit_int64(0);
  outC->_L88 = kcg_true;
  outC->_L87 = kcg_true;
  outC->_L86 = kcg_true;
  outC->_L74.badBaliseFlag = kcg_true;
  outC->_L74.BGMessageSent = kcg_true;
  outC->_L74.C_ID = kcg_lit_int64(0);
  outC->_L74.BG_ID = kcg_lit_int64(0);
  outC->_L74.balisePosition.odometerOfBaliseDetection.valid = kcg_true;
  outC->_L74.balisePosition.odometerOfBaliseDetection.timestamp = kcg_lit_int64(
      0);
  outC->_L74.balisePosition.odometerOfBaliseDetection.odo.o_nominal =
    kcg_lit_int64(0);
  outC->_L74.balisePosition.odometerOfBaliseDetection.odo.o_min = kcg_lit_int64(
      0);
  outC->_L74.balisePosition.odometerOfBaliseDetection.odo.o_max = kcg_lit_int64(
      0);
  ...
  outC->_L74.positionFirstContact.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L74.collectedTelegrams = kcg_lit_int64(0);
  outC->_L74.totalTelegrams = kcg_lit_int64(0);
  outC->_L72.badBaliseFlag = kcg_true;
  outC->_L72.BGMessageSent = kcg_true;
  outC->_L72.C_ID = kcg_lit_int64(0);
  outC->_L72.BG_ID = kcg_lit_int64(0);
  outC->_L72.balisePosition.odometerOfBaliseDetection.valid = kcg_true;
  outC->_L72.balisePosition.odometerOfBaliseDetection.timestamp = kcg_lit_int64(
      0);
  outC->_L72.balisePosition.odometerOfBaliseDetection.odo.o_nominal =
    kcg_lit_int64(0);
  outC->_L72.balisePosition.odometerOfBaliseDetection.odo.o_min = kcg_lit_int64(
      0);
  outC->_L72.balisePosition.odometerOfBaliseDetection.odo.o_max = kcg_lit_int64(
      0);
  ...
  outC->_L72.positionFirstContact.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L72.collectedTelegrams = kcg_lit_int64(0);
  outC->_L72.totalTelegrams = kcg_lit_int64(0);
  outC->_L73 = kcg_true;
  outC->_L70 = kcg_true;
  for (idx5 = 0; idx5 < 8; idx5++) {
    ...
    outC->_L69[idx5].telegramheader.m_mcount = kcg_lit_int64(0);
    outC->_L69[idx5].telegramheader.nid_c = kcg_lit_int64(0);
    outC->_L69[idx5].telegramheader.nid_bg = kcg_lit_int64(0);
    outC->_L69[idx5].telegramheader.q_link = Q_LINK_Unlinked;
    for (idx3 = 0; idx3 < 30; idx3++) {
      outC->_L69[idx5].packets.PacketHeaders[idx3].nid_packet = kcg_lit_int64(0);
      outC->_L69[idx5].packets.PacketHeaders[idx3].q_dir = Q_DIR_Reverse;
      outC->_L69[idx5].packets.PacketHeaders[idx3].valid = kcg_true;
      outC->_L69[idx5].packets.PacketHeaders[idx3].startAddress = kcg_lit_int64(0);
      outC->_L69[idx5].packets.PacketHeaders[idx3].endAddress = kcg_lit_int64(0);
    }
    for (idx4 = 0; idx4 < 500; idx4++) {
      outC->_L69[idx5].packets.PacketData[idx4] = kcg_lit_int64(0);
    }
  }
  outC->_L68 = kcg_true;
  outC->_L67 = kcg_true;
  ...
  outC->_L56.C_ID = kcg_lit_int64(0);
  outC->_L56.BG_ID = kcg_lit_int64(0);
  outC->_L56.balisePosition.odometerOfBaliseDetection.valid = kcg_true;
  outC->_L56.balisePosition.odometerOfBaliseDetection.timestamp = kcg_lit_int64(
      0);
  outC->_L56.balisePosition.odometerOfBaliseDetection.odo.o_nominal =
    kcg_lit_int64(0);
  outC->_L56.balisePosition.odometerOfBaliseDetection.odo.o_min = kcg_lit_int64(
      0);
  outC->_L56.balisePosition.odometerOfBaliseDetection.odo.o_max = kcg_lit_int64(
      0);
  ...
  outC->_L56.positionFirstContact.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L56.collectedTelegrams = kcg_lit_int64(0);
  outC->_L56.totalTelegrams = kcg_lit_int64(0);
  ...
  for (idx8 = 0; idx8 < 8; idx8++) {
    ...
    outC->_L40[idx8].telegramheader.m_mcount = kcg_lit_int64(0);
    outC->_L40[idx8].telegramheader.nid_c = kcg_lit_int64(0);
    outC->_L40[idx8].telegramheader.nid_bg = kcg_lit_int64(0);
    outC->_L40[idx8].telegramheader.q_link = Q_LINK_Unlinked;
    for (idx6 = 0; idx6 < 30; idx6++) {
      outC->_L40[idx8].packets.PacketHeaders[idx6].nid_packet = kcg_lit_int64(0);
      outC->_L40[idx8].packets.PacketHeaders[idx6].q_dir = Q_DIR_Reverse;
      outC->_L40[idx8].packets.PacketHeaders[idx6].valid = kcg_true;
      outC->_L40[idx8].packets.PacketHeaders[idx6].startAddress = kcg_lit_int64(0);
      outC->_L40[idx8].packets.PacketHeaders[idx6].endAddress = kcg_lit_int64(0);
    }
    for (idx7 = 0; idx7 < 500; idx7++) {
      outC->_L40[idx8].packets.PacketData[idx7] = kcg_lit_int64(0);
    }
  }
  outC->_L36 = kcg_true;
  ...
  for (idx9 = 0; idx9 < 30; idx9++) {
    outC->_L2.packets.PacketHeaders[idx9].nid_packet = kcg_lit_int64(0);
    outC->_L2.packets.PacketHeaders[idx9].q_dir = Q_DIR_Reverse;
    outC->_L2.packets.PacketHeaders[idx9].valid = kcg_true;
    outC->_L2.packets.PacketHeaders[idx9].startAddress = kcg_lit_int64(0);
    outC->_L2.packets.PacketHeaders[idx9].endAddress = kcg_lit_int64(0);
  }
  for (idx10 = 0; idx10 < 500; idx10++) {
    outC->_L2.packets.PacketData[idx10] = kcg_lit_int64(0);
  }
