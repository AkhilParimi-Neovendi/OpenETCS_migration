...
typedef struct {
  ...
  P041_OBU_T_TM /* P041_OBU_out/ */ P041_OBU_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P041_compr_onboard_TM_conversions /* _L166=(TM_conversions::C_P041_compr_onboard#1)/ */ Context_C_P041_compr_onboard_1;
...
extern void Read_P041_init_TM(outC_Read_P041_TM *outC);
