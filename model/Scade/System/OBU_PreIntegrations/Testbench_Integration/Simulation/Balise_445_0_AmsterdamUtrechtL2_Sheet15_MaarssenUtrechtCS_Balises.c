...
void Balise_445_0_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
  ...
  /* PIG_nom/ */
  kcg_int64 PIG_nom,
  outC_Balise_445_0_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet15_MaarssenUtrechtCS_Balises::Packets_BG445#1)/ */
    Packets_BG445_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG445_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG445_1.Balise_data_out);
...
void Balise_445_0_init_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
  outC_Balise_445_0_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises *outC)
{
  static kcg_size idx;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet15_MaarssenUtrechtCS_Balises::Packets_BG445#1)/ */
  Packets_BG445_init_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
    &outC->Context_Packets_BG445_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_445_0_reset_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
  outC_Balise_445_0_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet15_MaarssenUtrechtCS_Balises::Packets_BG445#1)/ */
  Packets_BG445_reset_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
    &outC->Context_Packets_BG445_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
