...
void kcg_save_SV_isSendingNeeded_manage_DMI_Output_Pkg(
  SV_isSendingNeeded_manage_DMI_Output_Pkg *SV,
  outC_isSendingNeeded_manage_DMI_Output_Pkg *outC)
{
  SV->Context_lastDMI_Update = outC->lastDMI_Update;
}

void kcg_load_SV_isSendingNeeded_manage_DMI_Output_Pkg(
  outC_isSendingNeeded_manage_DMI_Output_Pkg *outC,
  SV_isSendingNeeded_manage_DMI_Output_Pkg *SV)
{
  outC->lastDMI_Update = SV->Context_lastDMI_Update;
}
