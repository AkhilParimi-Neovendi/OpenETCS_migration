  ...
  outC_CAST_int_to_DMI_trackCondition_DATA_Variables *outC)
{
  ...
  kcg_copy_array_int32_32(&outC->_L16, (array_int32_32 *) &outC->_L11[33]);
  kcg_copy_array_int32_32(&outC->_L15, (array_int32_32 *) &outC->_L11[1]);
  /* _L14= */
  ...
  outC_CAST_int_to_DMI_trackCondition_DATA_Variables *outC)
{
  ...
  for (idx3 = 0; idx3 < 32; idx3++) {
    outC->_L14[idx3].d_trackcond = kcg_lit_int32(0);
    outC->_L14[idx3].m_trackcond =
      M_TRACKCOND_Non_stopping_area_Initial_state_is_stopping_permitted;
  }
  outC->_L13 = kcg_lit_int32(0);
  outC->_L12.nIter = kcg_lit_int32(0);
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->_L12.trackCondition[idx4].d_trackcond = kcg_lit_int32(0);
    outC->_L12.trackCondition[idx4].m_trackcond =
      M_TRACKCOND_Non_stopping_area_Initial_state_is_stopping_permitted;
  }
  for (idx5 = 0; idx5 < 65; idx5++) {
    outC->_L11[idx5] = kcg_lit_int32(0);
  }
  outC->dmi_trackCondition_ct.nIter = kcg_lit_int32(0);
  for (idx6 = 0; idx6 < 32; idx6++) {
    outC->dmi_trackCondition_ct.trackCondition[idx6].d_trackcond = kcg_lit_int32(0);
