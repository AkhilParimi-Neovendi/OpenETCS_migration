  ...
  outC_indexOfBG_onTrack_itr_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  ...
  outC->_L30.nid_bg = kcg_lit_int64(0);
  outC->_L30.q_link = Q_LINK_Unlinked;
  outC->_L30.location.nominal = kcg_lit_int64(0);
  outC->_L30.location.d_min = kcg_lit_int64(0);
  outC->_L30.location.d_max = kcg_lit_int64(0);
  outC->_L30.seqNoOnTrack = kcg_lit_int64(0);
  outC->_L30.infoFromLinking.valid = kcg_true;
  outC->_L30.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L30.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->_L30.infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
  outC->_L30.infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
  outC->_L30.infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
  outC->_L30.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L30.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L30.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->_L30.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->_L30.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  ...
  outC->_L30.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L30.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L30.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L30.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L30.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->_L30.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L30.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L30.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  outC->_L30.infoFromPassing.BG_Header.q_link = Q_LINK_Unlinked;
  outC->_L30.infoFromPassing.BG_Header.bgPosition.valid = kcg_true;
  outC->_L30.infoFromPassing.BG_Header.bgPosition.timestamp = kcg_lit_int64(0);
  outC->_L30.infoFromPassing.BG_Header.bgPosition.odo.o_nominal = kcg_lit_int64(
      0);
  outC->_L30.infoFromPassing.BG_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->_L30.infoFromPassing.BG_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
  ...
  outC->_L30.infoFromPassing.BG_Header.bgPosition.speed.v_rawNominal =
    kcg_lit_int64(0);
  outC->_L30.infoFromPassing.BG_Header.bgPosition.speed.v_lower = kcg_lit_int64(
      0);
  outC->_L30.infoFromPassing.BG_Header.bgPosition.speed.v_upper = kcg_lit_int64(
      0);
  outC->_L30.infoFromPassing.BG_Header.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->_L30.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L30.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx = 0; idx < 33; idx++) {
    ...
    outC->_L30.infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L30.infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int64(0);
    outC->_L30.infoFromPassing.linkedBGs[idx].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L30.infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int64(0);
    outC->_L30.infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int64(0);
    outC->_L30.infoFromPassing.linkedBGs[idx].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L30.infoFromPassing.linkedBGs[idx].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L30.infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L28.infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L28.infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int64(0);
    outC->_L28.infoFromPassing.linkedBGs[idx1].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L28.infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int64(0);
    outC->_L28.infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int64(0);
    outC->_L28.infoFromPassing.linkedBGs[idx1].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L28.infoFromPassing.linkedBGs[idx1].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L28.infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx2 = 0; idx2 < 33; idx2++) {
    ...
    outC->_L19.infoFromPassing.linkedBGs[idx2].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L19.infoFromPassing.linkedBGs[idx2].d_link = kcg_lit_int64(0);
    outC->_L19.infoFromPassing.linkedBGs[idx2].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L19.infoFromPassing.linkedBGs[idx2].nid_c = kcg_lit_int64(0);
    outC->_L19.infoFromPassing.linkedBGs[idx2].nid_bg = kcg_lit_int64(0);
    outC->_L19.infoFromPassing.linkedBGs[idx2].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L19.infoFromPassing.linkedBGs[idx2].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L19.infoFromPassing.linkedBGs[idx2].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx3 = 0; idx3 < 33; idx3++) {
    ...
    outC->_L21.infoFromPassing.linkedBGs[idx3].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L21.infoFromPassing.linkedBGs[idx3].d_link = kcg_lit_int64(0);
    outC->_L21.infoFromPassing.linkedBGs[idx3].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L21.infoFromPassing.linkedBGs[idx3].nid_c = kcg_lit_int64(0);
    outC->_L21.infoFromPassing.linkedBGs[idx3].nid_bg = kcg_lit_int64(0);
    outC->_L21.infoFromPassing.linkedBGs[idx3].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L21.infoFromPassing.linkedBGs[idx3].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L21.infoFromPassing.linkedBGs[idx3].q_locacc = kcg_lit_int64(0);
  }
