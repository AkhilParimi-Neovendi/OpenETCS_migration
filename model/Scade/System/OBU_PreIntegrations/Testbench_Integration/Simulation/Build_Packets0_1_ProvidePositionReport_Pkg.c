  ...
  outC_Build_Packets0_1_ProvidePositionReport_Pkg *outC)
{
  ...
  for (idx = 0; idx < 33; idx++) {
    ...
    outC->_L24.infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L24.infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int64(0);
    outC->_L24.infoFromPassing.linkedBGs[idx].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L24.infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int64(0);
    outC->_L24.infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int64(0);
    outC->_L24.infoFromPassing.linkedBGs[idx].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L24.infoFromPassing.linkedBGs[idx].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L24.infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx4 = 0; idx4 < 41; idx4++) {
    ...
    outC->_L5[idx4].nid_c = kcg_lit_int64(0);
    outC->_L5[idx4].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L5[idx4].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L5[idx4].infoFromLinking.valid = kcg_true;
    outC->_L5[idx4].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L5[idx4].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L5[idx4].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L5[idx4].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L5[idx4].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L5[idx4].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L5[idx4].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L5[idx4].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L5[idx4].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L5[idx4].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L5[idx4].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L5[idx4].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L5[idx4].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L5[idx4].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    outC->_L5[idx4].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L5[idx4].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L5[idx4].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L5[idx4].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L5[idx4].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L5[idx4].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L5[idx4].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L5[idx4].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L5[idx4].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx3 = 0; idx3 < 33; idx3++) {
      ...
      outC->_L5[idx4].infoFromPassing.linkedBGs[idx3].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L5[idx4].infoFromPassing.linkedBGs[idx3].d_link = kcg_lit_int64(0);
      outC->_L5[idx4].infoFromPassing.linkedBGs[idx3].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L5[idx4].infoFromPassing.linkedBGs[idx3].nid_c = kcg_lit_int64(0);
      outC->_L5[idx4].infoFromPassing.linkedBGs[idx3].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L5[idx4].infoFromPassing.linkedBGs[idx3].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L5[idx4].infoFromPassing.linkedBGs[idx3].q_locacc = kcg_lit_int64(0);
    }
  ...
  outC->_L14.nid_engine = kcg_lit_int64(0);
  outC->_L14.nid_operational = kcg_lit_int64(0);
  outC->_L14.l_train = kcg_lit_int64(0);
  outC->_L14.d_baliseAntenna_2_frontend.nominal = kcg_lit_int64(0);
  outC->_L14.d_baliseAntenna_2_frontend.d_min = kcg_lit_int64(0);
  outC->_L14.d_baliseAntenna_2_frontend.d_max = kcg_lit_int64(0);
  outC->_L14.d_frontend_2_rearend.nominal = kcg_lit_int64(0);
  outC->_L14.d_frontend_2_rearend.d_min = kcg_lit_int64(0);
  outC->_L14.d_frontend_2_rearend.d_max = kcg_lit_int64(0);
  outC->_L14.locationAccuracy_DefaultValue.nominal = kcg_lit_int64(0);
  outC->_L14.locationAccuracy_DefaultValue.d_min = kcg_lit_int64(0);
  outC->_L14.locationAccuracy_DefaultValue.d_max = kcg_lit_int64(0);
  outC->_L14.centerDetectionAcc_DefaultValue.nominal = kcg_lit_int64(0);
  outC->_L14.centerDetectionAcc_DefaultValue.d_min = kcg_lit_int64(0);
  outC->_L14.centerDetectionAcc_DefaultValue.d_max = kcg_lit_int64(0);
  ...
  outC->_L21.packet1.NID_PACKET = kcg_lit_int64(0);
  outC->_L21.packet1.L_PACKET = kcg_lit_int64(0);
  outC->_L21.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L21.packet1.NID_LRBG = kcg_lit_int64(0);
  outC->_L21.packet1.NID_PRVLRBG = kcg_lit_int64(0);
  outC->_L21.packet1.D_LRBG = kcg_lit_int64(0);
  outC->_L21.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L21.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L21.packet1.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L21.packet1.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L21.packet1.length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L21.packet1.L_TRAININT = kcg_lit_int64(0);
  outC->_L21.packet1.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L21.packet1.NID_NTC = kcg_lit_int64(0);
  outC->init = kcg_true;
...
void kcg_save_SV_Build_Packets0_1_ProvidePositionReport_Pkg(
  SV_Build_Packets0_1_ProvidePositionReport_Pkg *SV,
  outC_Build_Packets0_1_ProvidePositionReport_Pkg *outC)
{
  kcg_save_SV_Build_Packet0_ProvidePositionReport_Pkg(
    &SV->Context_Build_Packet0_2,
    &outC->Context_Build_Packet0_2);
  kcg_copy_PT0_PositionReport_T_Packet_TrainTypes_Pkg(
    &SV->Context__L22,
    &outC->_L22);
...
void kcg_load_SV_Build_Packets0_1_ProvidePositionReport_Pkg(
  outC_Build_Packets0_1_ProvidePositionReport_Pkg *outC,
  SV_Build_Packets0_1_ProvidePositionReport_Pkg *SV)
{
  kcg_load_SV_Build_Packet0_ProvidePositionReport_Pkg(
    &outC->Context_Build_Packet0_2,
    &SV->Context_Build_Packet0_2);
  kcg_copy_PT0_PositionReport_T_Packet_TrainTypes_Pkg(
    &outC->_L22,
