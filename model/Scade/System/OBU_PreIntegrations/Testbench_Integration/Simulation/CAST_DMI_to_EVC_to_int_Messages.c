...
{
  static array_int64_307 tmp;
  static array_int64_304 tmp1;
  static array_int64_301 tmp2;
  static array_int64_292 tmp3;
  static array_int64_289 tmp4;
  static array_int64_285 tmp5;
  static array_int64_283 tmp6;
  static array_int64_280 tmp7;
  static array_int64_269 tmp8;
  static array_int64_266 tmp9;
  static array_int64_5 tmp10;
  ...
  outC_CAST_DMI_to_EVC_to_int_Messages *outC)
{
  ...
  for (idx2 = 0; idx2 < 4; idx2++) {
    outC->_L28[idx2] = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 3; idx3++) {
    outC->_L27[idx3] = kcg_lit_int64(0);
  }
  for (idx4 = 0; idx4 < 9; idx4++) {
    outC->_L26[idx4] = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 3; idx5++) {
    outC->_L25[idx5] = kcg_lit_int64(0);
  }
  for (idx6 = 0; idx6 < 3; idx6++) {
    outC->_L24[idx6] = kcg_lit_int64(0);
  }
  for (idx7 = 0; idx7 < 4; idx7++) {
    outC->_L23[idx7] = kcg_lit_int64(0);
  }
  for (idx8 = 0; idx8 < 2; idx8++) {
    outC->_L22[idx8] = kcg_lit_int64(0);
  }
  for (idx9 = 0; idx9 < 3; idx9++) {
    outC->_L21[idx9] = kcg_lit_int64(0);
  }
  for (idx10 = 0; idx10 < 11; idx10++) {
    outC->_L20[idx10] = kcg_lit_int64(0);
  }
  for (idx11 = 0; idx11 < 3; idx11++) {
    outC->_L19[idx11] = kcg_lit_int64(0);
  }
  for (idx12 = 0; idx12 < 261; idx12++) {
    outC->_L18[idx12] = kcg_lit_int64(0);
  }
  ...
  outC->_L3.systemTime = kcg_lit_int64(0);
  outC->_L3.DMI_nid_icon_identifier = kcg_lit_int64(0);
  ...
  outC->_L5.l_train = kcg_lit_int64(0);
  outC->_L5.m_brakeperct = kcg_lit_int64(0);
  outC->_L5.v_maxTrain = kcg_lit_int64(0);
  ...
  outC->_L7.textMessage_ID = kcg_lit_int64(0);
  outC->_L7.acknowledged = kcg_true;
  outC->_L8.valid = kcg_true;
  outC->_L8.systemTime = kcg_lit_int64(0);
  outC->_L9.valid = kcg_true;
  outC->_L9.systemTime = kcg_lit_int64(0);
  ...
  outC->_L12.l_name = kcg_lit_int64(0);
  ...
  outC->_L13.nAlive = kcg_lit_int64(0);
  outC->_L14 = kcg_true;
  ...
  for (idx18 = 0; idx18 < 311; idx18++) {
    outC->dmi_to_evc_int[idx18] = kcg_lit_int64(0);
  }
  /* _L17=(DATA::Packets::DMI_to_EVC::Write_DMI_Status_to_int#1)/ */
