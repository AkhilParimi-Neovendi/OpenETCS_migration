  ...
  outC_Manage_NID_EM_Store_TA_EmergencyStop_NID_EM_Store *outC)
{
  ...
  if (outC->IfBlock1_clock) {
    kcg_copy__54_array(&outC->_L16_then_IfBlock1, &(*inStore).items);
    ...
    kcg_copy__54_array(&outC->_L5_then_IfBlock1, &(*inStore).items);
    kcg_copy_NID_EM_STORE_Acc_T_TA_EmergencyStop_NID_EM_Store(
    ...
    kcg_copy__54_array(&outC->_L4_then_IfBlock1.items, &outC->_L2_then_IfBlock1);
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      kcg_copy__54_array(&outC->_L4_then_else_IfBlock1, &(*inStore).items);
      kcg_copy_NID_EM_STORE_Acc_T_TA_EmergencyStop_NID_EM_Store(
