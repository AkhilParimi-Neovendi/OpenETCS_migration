...
void kcg_save_SV_RBC__ProcessGeneralMessage_RBC_Model_Pkg(
  SV_RBC__ProcessGeneralMessage_RBC_Model_Pkg *SV,
  outC_RBC__ProcessGeneralMessage_RBC_Model_Pkg *outC)
{
  SV->Context_radioTrackTrainMessageWasSentTimestamp =
    outC->radioTrackTrainMessageWasSentTimestamp;
  SV->Context_ackRequired = outC->ackRequired;
  SV->Context_GENERAL_MESSAGE_SM_reset_nxt = outC->GENERAL_MESSAGE_SM_reset_nxt;
  SV->Context_GENERAL_MESSAGE_SM_reset_act = outC->GENERAL_MESSAGE_SM_reset_act;
  SV->Context_GENERAL_MESSAGE_SM_state_nxt = outC->GENERAL_MESSAGE_SM_state_nxt;
  SV->Context_validAck = outC->validAck;
  SV->Context_invalidAck = outC->invalidAck;
}

void kcg_load_SV_RBC__ProcessGeneralMessage_RBC_Model_Pkg(
  outC_RBC__ProcessGeneralMessage_RBC_Model_Pkg *outC,
  SV_RBC__ProcessGeneralMessage_RBC_Model_Pkg *SV)
{
  outC->radioTrackTrainMessageWasSentTimestamp =
  ...
  outC->GENERAL_MESSAGE_SM_reset_nxt = SV->Context_GENERAL_MESSAGE_SM_reset_nxt;
  outC->GENERAL_MESSAGE_SM_reset_act = SV->Context_GENERAL_MESSAGE_SM_reset_act;
  outC->GENERAL_MESSAGE_SM_state_nxt = SV->Context_GENERAL_MESSAGE_SM_state_nxt;
