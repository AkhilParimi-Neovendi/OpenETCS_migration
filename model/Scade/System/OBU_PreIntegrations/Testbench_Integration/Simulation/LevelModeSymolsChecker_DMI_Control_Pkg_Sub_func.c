...
void LevelModeSymolsChecker_DMI_Control_Pkg_Sub_func(
  /* GroupIndex/ */
  kcg_int64 GroupIndex,
  /* SymbolIndex/ */
  kcg_int64 SymbolIndex,
  outC_LevelModeSymolsChecker_DMI_Control_Pkg_Sub_func *outC)
{
  ...
  kcg_copy_array_int64_5(
    &outC->_L17,
    (array_int64_5 *) &ArrayOfIndex_YellowLevelSymbols_DMI_Control_Pkg);
  ...
  if (outC->_L19) {
    ...
    for (idx1 = 0; idx1 < 5; idx1++) {
      ...
      outC->_L22 = /* _L22= */(kcg_int64) (idx1 + 1);
      /* _L22= */
  ...
  kcg_copy_array_int64_8(
    &outC->_L16,
    (array_int64_8 *) &ArrayOfIndex_YellowModeSymbols_DMI_Control_Pkg);
  /* _L14/ */
  ...
  if (outC->_L18) {
    ...
    for (idx4 = 0; idx4 < 8; idx4++) {
      ...
      outC->_L20 = /* _L20= */(kcg_int64) (idx4 + 1);
      /* _L20= */
  ...
  outC_LevelModeSymolsChecker_DMI_Control_Pkg_Sub_func *outC)
{
  ...
  for (idx3 = 0; idx3 < 8; idx3++) {
    outC->_L16[idx3] = kcg_lit_int64(0);
  }
  for (idx4 = 0; idx4 < 5; idx4++) {
    outC->_L15[idx4] = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 8; idx5++) {
    outC->_L14[idx5] = kcg_lit_int64(0);
  }
  outC->_L13 = kcg_true;
  outC->_L12 = kcg_true;
  outC->_L11 = kcg_true;
