...
typedef struct {
  ...
  kcg_bool /* requestsToSetupASafeRadioConnectionAreStopped/ */ requestsToSetupASafeRadioConnectionAreStopped;
...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* connectionStatus_SM: */ Context_connectionStatus_SM_reset_nxt;
  kcg_bool /* connectionStatus_SM: */ Context_connectionStatus_SM_reset_act;
  SSM_ST_connectionStatus_SM /* connectionStatus_SM: */ Context_connectionStatus_SM_state_nxt;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_countDownTimer_MoRC_Pck_Utils Context_countDownTimer_1;
  SV_RisingEdge_digital Context_RisingEdge_3;
  SV_RisingEdge_digital Context_RisingEdge_4;
} SV_safeRadioConnectionIndication_v2_MoRC_Pck_Subfunc_Pkg;

extern void kcg_save_SV_safeRadioConnectionIndication_v2_MoRC_Pck_Subfunc_Pkg(
  SV_safeRadioConnectionIndication_v2_MoRC_Pck_Subfunc_Pkg *SV,
  outC_safeRadioConnectionIndication_v2_MoRC_Pck_Subfunc_Pkg *outC);
extern void kcg_load_SV_safeRadioConnectionIndication_v2_MoRC_Pck_Subfunc_Pkg(
  outC_safeRadioConnectionIndication_v2_MoRC_Pck_Subfunc_Pkg *outC,
  SV_safeRadioConnectionIndication_v2_MoRC_Pck_Subfunc_Pkg *SV);
