...
void ManageLevelAndMode_init(outC_ManageLevelAndMode *outC)
{
  ...
  outC->_L111.LevelTransition.transition.position = kcg_lit_int64(0);
  ...
  outC->_L111.LevelTransition.transition.AckLength = kcg_lit_int64(0);
  outC->_L111.LevelTransition.LRBG = kcg_lit_int64(0);
  outC->_L111.LevelTransition.referenceLocation = kcg_lit_int64(0);
  ...
  for (idx = 0; idx < 7; idx++) {
    ...
    outC->_L96.level_transition_priority_table[idx].transition.AckLength =
      kcg_lit_int64(0);
    outC->_L96.level_transition_priority_table[idx].LRBG = kcg_lit_int64(0);
  ...
  for (idx1 = 0; idx1 < 7; idx1++) {
    ...
    outC->_L96.conditionnalTransition[idx1].transition.position = kcg_lit_int64(0);
    ...
    outC->_L96.conditionnalTransition[idx1].transition.AckLength = kcg_lit_int64(0);
    outC->_L96.conditionnalTransition[idx1].LRBG = kcg_lit_int64(0);
    outC->_L96.conditionnalTransition[idx1].referenceLocation = kcg_lit_int64(0);
  }
  ...
  outC->_L95.Common_Errors.nid_c = kcg_lit_int64(0);
  outC->_L95.Common_Errors.nid_errorbg = kcg_lit_int64(0);
  ...
  outC->_L92.Common_Errors.nid_c = kcg_lit_int64(0);
  outC->_L92.Common_Errors.nid_errorbg = kcg_lit_int64(0);
  ...
  outC->_L61.transition.position = kcg_lit_int64(0);
  outC->_L61.transition.transitionType =
    M_TransitionType_Conditional_Level_And_Mode_Types_Pkg;
  outC->_L61.transition.immediateAck = kcg_true;
  outC->_L61.transition.AckLength = kcg_lit_int64(0);
  outC->_L61.LRBG = kcg_lit_int64(0);
  outC->_L61.referenceLocation = kcg_lit_int64(0);
  ...
  for (idx2 = 0; idx2 < 5; idx2++) {
    ...
    outC->_L57.P_12[idx2].v_main = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].v_loa = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].t_loa = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].l_section = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].q_sectiontimer_k =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L57.P_12[idx2].t_sectiontimer_k = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].d_sectiontimerstoploc_k = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].l_endsection = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].q_sectiontimer =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L57.P_12[idx2].t_sectiontimer = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].d_sectiontimerstoploc = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].q_endtimer = Q_ENDTIMER_No_End_section_timer_information;
    outC->_L57.P_12[idx2].t_endtimer = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].d_endtimerstartloc = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].q_dangerpoint = Q_DANGERPOINT_No_danger_point_information;
    outC->_L57.P_12[idx2].d_dp = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].v_releasedp = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].q_overlap = Q_OVERLAP_No_overlap_information;
    outC->_L57.P_12[idx2].d_startol = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].t_ol = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].d_ol = kcg_lit_int64(0);
    outC->_L57.P_12[idx2].v_releaseol = kcg_lit_int64(0);
  }
  ...
  outC->_L57.P_138.d_startreverse = kcg_lit_int64(0);
  outC->_L57.P_138.l_reversearea = kcg_lit_int64(0);
  outC->_L57.P_139.valid = kcg_true;
  outC->_L57.P_139.q_dir = Q_DIR_Reverse;
  outC->_L57.P_139.q_scale = Q_SCALE_10_cm_scale;
  outC->_L57.P_139.d_reverse = kcg_lit_int64(0);
  outC->_L57.P_139.v_reverse = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 5; idx3++) {
    ...
    outC->_L57.P_15[idx3].v_loa = kcg_lit_int64(0);
    outC->_L57.P_15[idx3].t_loa = kcg_lit_int64(0);
    outC->_L57.P_15[idx3].l_section = kcg_lit_int64(0);
    outC->_L57.P_15[idx3].q_sectiontimer_k =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L57.P_15[idx3].t_sectiontimer_k = kcg_lit_int64(0);
    outC->_L57.P_15[idx3].d_sectiontimerstoploc_k = kcg_lit_int64(0);
    outC->_L57.P_15[idx3].l_endsection = kcg_lit_int64(0);
    outC->_L57.P_15[idx3].q_sectiontimer =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L57.P_15[idx3].t_sectiontimer = kcg_lit_int64(0);
    outC->_L57.P_15[idx3].d_sectiontimerstoploc = kcg_lit_int64(0);
    outC->_L57.P_15[idx3].q_endtimer = Q_ENDTIMER_No_End_section_timer_information;
    outC->_L57.P_15[idx3].t_endtimer = kcg_lit_int64(0);
    outC->_L57.P_15[idx3].d_endtimerstartloc = kcg_lit_int64(0);
    outC->_L57.P_15[idx3].q_dangerpoint = Q_DANGERPOINT_No_danger_point_information;
    outC->_L57.P_15[idx3].d_dp = kcg_lit_int64(0);
    outC->_L57.P_15[idx3].v_releasedp = kcg_lit_int64(0);
    outC->_L57.P_15[idx3].q_overlap = Q_OVERLAP_No_overlap_information;
    outC->_L57.P_15[idx3].d_startol = kcg_lit_int64(0);
    outC->_L57.P_15[idx3].t_ol = kcg_lit_int64(0);
    outC->_L57.P_15[idx3].d_ol = kcg_lit_int64(0);
    outC->_L57.P_15[idx3].v_releaseol = kcg_lit_int64(0);
  }
  for (idx4 = 0; idx4 < 7; idx4++) {
    ...
    outC->_L57.P_21[idx4].d_gradient = kcg_lit_int64(0);
    outC->_L57.P_21[idx4].q_gdir = Q_GDIR_downhill;
    outC->_L57.P_21[idx4].g_a = kcg_lit_int64(0);
  }
  outC->_L57.P_27.valid = kcg_true;
  outC->_L57.P_27.q_dir = Q_DIR_Reverse;
  outC->_L57.P_27.q_scale = Q_SCALE_10_cm_scale;
  outC->_L57.P_27.d_static = kcg_lit_int64(0);
  outC->_L57.P_27.v_static = kcg_lit_int64(0);
  ...
  for (idx5 = 0; idx5 < 7; idx5++) {
    ...
    outC->_L57.P_27.diffArray[idx5].nc_diff = kcg_lit_int64(0);
    outC->_L57.P_27.diffArray[idx5].v_diff = kcg_lit_int64(0);
  }
  for (idx7 = 0; idx7 < 7; idx7++) {
    outC->_L57.P_27.SSPArray[idx7].valid = kcg_true;
    outC->_L57.P_27.SSPArray[idx7].d_static = kcg_lit_int64(0);
    outC->_L57.P_27.SSPArray[idx7].v_static = kcg_lit_int64(0);
    ...
    for (idx6 = 0; idx6 < 7; idx6++) {
      ...
      outC->_L57.P_27.SSPArray[idx7].diffArray[idx6].nc_cddiff =
        NC_CDDIFF_Specific_SSP_applicable_to_Cant_Deficiency_80_mm;
      outC->_L57.P_27.SSPArray[idx7].diffArray[idx6].nc_diff = kcg_lit_int64(0);
      outC->_L57.P_27.SSPArray[idx7].diffArray[idx6].v_diff = kcg_lit_int64(0);
    }
  }
  for (idx8 = 0; idx8 < 7; idx8++) {
    ...
    outC->_L57.P_41[idx8].d_leveltr = kcg_lit_int64(0);
    outC->_L57.P_41[idx8].m_leveltr = M_LEVELTR_Level_0;
    outC->_L57.P_41[idx8].nid_ntc = kcg_lit_int64(0);
    outC->_L57.P_41[idx8].l_ackleveltr = kcg_lit_int64(0);
  }
  for (idx9 = 0; idx9 < 7; idx9++) {
    ...
    outC->_L57.P_46[idx9].nid_ntc = kcg_lit_int64(0);
  }
  for (idx10 = 0; idx10 < 7; idx10++) {
    ...
    outC->_L57.P_63[idx10].nid_c = kcg_lit_int64(0);
    outC->_L57.P_63[idx10].nid_bg = kcg_lit_int64(0);
  }
  for (idx11 = 0; idx11 < 3; idx11++) {
    ...
    outC->_L57.P_80[idx11].d_mamode = kcg_lit_int64(0);
    outC->_L57.P_80[idx11].m_mamode = M_MAMODE_On_Sight;
    outC->_L57.P_80[idx11].v_mamode = kcg_lit_int64(0);
    outC->_L57.P_80[idx11].l_mamode = kcg_lit_int64(0);
    outC->_L57.P_80[idx11].l_ackmamode = kcg_lit_int64(0);
    outC->_L57.P_80[idx11].q_mamode = Q_MAMODE_as_the_EOA;
  }
  outC->_L57.LRBG = kcg_lit_int64(0);
  outC->_L57.referenceLocation = kcg_lit_int64(0);
  ...
  outC->_L55.brake_pressure.pressure = kcg_lit_int64(0);
  ...
  outC->_L55.train_data_info.trainLength = kcg_lit_int64(0);
  outC->_L55.train_data_info.brakePerctage = kcg_lit_int64(0);
  outC->_L55.train_data_info.maxTrainSpeed = kcg_lit_int64(0);
  ...
  outC->_L55.train_data_info.axleNumber = kcg_lit_int64(0);
  outC->_L55.train_data_info.numberNationalSystems = kcg_lit_int64(0);
  for (idx12 = 0; idx12 < 5; idx12++) {
    outC->_L55.train_data_info.nationSystems[idx12] = kcg_lit_int64(0);
  }
  outC->_L55.train_data_info.numberTractionSystems = kcg_lit_int64(0);
  ...
  outC->_L54.PositionErrors.bg.nid_c = kcg_lit_int64(0);
  outC->_L54.PositionErrors.bg.nid_bg = kcg_lit_int64(0);
  outC->_L54.PositionErrors.bg.q_link = Q_LINK_Unlinked;
  outC->_L54.PositionErrors.bg.location.nominal = kcg_lit_int64(0);
  outC->_L54.PositionErrors.bg.location.d_min = kcg_lit_int64(0);
  outC->_L54.PositionErrors.bg.location.d_max = kcg_lit_int64(0);
  outC->_L54.PositionErrors.bg.seqNoOnTrack = kcg_lit_int64(0);
  ...
  outC->_L54.PositionErrors.bg.infoFromLinking.expectedLocation.d_max =
    kcg_lit_int64(0);
  outC->_L54.PositionErrors.bg.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L54.PositionErrors.bg.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L54.PositionErrors.bg.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  ...
  outC->_L54.PositionErrors.bg.infoFromPassing.BG_Header.m_mcount =
    kcg_lit_int64(0);
  outC->_L54.PositionErrors.bg.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L54.PositionErrors.bg.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(
      0);
  ...
  outC->_L54.Train_Position.timestamp = kcg_lit_int64(0);
  ...
  outC->_L54.Train_Position.trainPosition.nominal = kcg_lit_int64(0);
  outC->_L54.Train_Position.trainPosition.d_min = kcg_lit_int64(0);
  outC->_L54.Train_Position.trainPosition.d_max = kcg_lit_int64(0);
  outC->_L54.Train_Position.estimatedFrontEndPosition = kcg_lit_int64(0);
  outC->_L54.Train_Position.minSafeFrontEndPosition = kcg_lit_int64(0);
  outC->_L54.Train_Position.maxSafeFrontEndPostion = kcg_lit_int64(0);
  outC->_L54.Train_Position.LRBG.valid = kcg_true;
  outC->_L54.Train_Position.LRBG.nid_c = kcg_lit_int64(0);
  outC->_L54.Train_Position.LRBG.nid_bg = kcg_lit_int64(0);
  outC->_L54.Train_Position.LRBG.q_link = Q_LINK_Unlinked;
  outC->_L54.Train_Position.LRBG.location.nominal = kcg_lit_int64(0);
  outC->_L54.Train_Position.LRBG.location.d_min = kcg_lit_int64(0);
  outC->_L54.Train_Position.LRBG.location.d_max = kcg_lit_int64(0);
  outC->_L54.Train_Position.LRBG.seqNoOnTrack = kcg_lit_int64(0);
  ...
  outC->_L54.Train_Position.LRBG.infoFromLinking.expectedLocation.d_max =
    kcg_lit_int64(0);
  outC->_L54.Train_Position.LRBG.infoFromLinking.d_link.nominal = kcg_lit_int64(
      0);
  outC->_L54.Train_Position.LRBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L54.Train_Position.LRBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  ...
  outC->_L54.Train_Position.prvLRBG.nid_c = kcg_lit_int64(0);
  outC->_L54.Train_Position.prvLRBG.nid_bg = kcg_lit_int64(0);
  outC->_L54.Train_Position.prvLRBG.q_link = Q_LINK_Unlinked;
  outC->_L54.Train_Position.prvLRBG.location.nominal = kcg_lit_int64(0);
  outC->_L54.Train_Position.prvLRBG.location.d_min = kcg_lit_int64(0);
  outC->_L54.Train_Position.prvLRBG.location.d_max = kcg_lit_int64(0);
  outC->_L54.Train_Position.prvLRBG.seqNoOnTrack = kcg_lit_int64(0);
  ...
  outC->_L54.Train_Position.estimatedRearEndPosition = kcg_lit_int64(0);
  outC->_L54.Train_Position.minSafeRearEndPosition = kcg_lit_int64(0);
  outC->_L54.Train_Position.maxSafeRearEndPosition = kcg_lit_int64(0);
  outC->_L54.Train_Speed = kcg_lit_int64(0);
  ...
  for (idx17 = 0; idx17 < 3; idx17++) {
    outC->_L44.Mode_Profile_On_Board[idx17].Distance = kcg_lit_int64(0);
    outC->_L44.Mode_Profile_On_Board[idx17].Mode =
      Profile_OS_Level_And_Mode_Types_Pkg;
    outC->_L44.Mode_Profile_On_Board[idx17].Speed = kcg_lit_int64(0);
    outC->_L44.Mode_Profile_On_Board[idx17].Length = kcg_lit_int64(0);
    outC->_L44.Mode_Profile_On_Board[idx17].Length_Ack = kcg_lit_int64(0);
  }
  ...
  outC->_L44.Reversing_Data.Dist_Start = kcg_lit_int64(0);
  outC->_L44.Reversing_Data.Length = kcg_lit_int64(0);
  outC->_L44.Reversing_Data.Dist_Run = kcg_lit_int64(0);
  outC->_L44.Reversing_Data.Speed = kcg_lit_int64(0);
  ...
  outC->_L43.brake_pressure.pressure = kcg_lit_int64(0);
  ...
  outC->_L43.train_data_info.trainLength = kcg_lit_int64(0);
  outC->_L43.train_data_info.brakePerctage = kcg_lit_int64(0);
  outC->_L43.train_data_info.maxTrainSpeed = kcg_lit_int64(0);
  ...
  outC->_L43.train_data_info.axleNumber = kcg_lit_int64(0);
  outC->_L43.train_data_info.numberNationalSystems = kcg_lit_int64(0);
  for (idx18 = 0; idx18 < 5; idx18++) {
    outC->_L43.train_data_info.nationSystems[idx18] = kcg_lit_int64(0);
  }
  outC->_L43.train_data_info.numberTractionSystems = kcg_lit_int64(0);
  ...
  outC->_L41.PositionErrors.bg.nid_c = kcg_lit_int64(0);
  outC->_L41.PositionErrors.bg.nid_bg = kcg_lit_int64(0);
  outC->_L41.PositionErrors.bg.q_link = Q_LINK_Unlinked;
  outC->_L41.PositionErrors.bg.location.nominal = kcg_lit_int64(0);
  outC->_L41.PositionErrors.bg.location.d_min = kcg_lit_int64(0);
  outC->_L41.PositionErrors.bg.location.d_max = kcg_lit_int64(0);
  outC->_L41.PositionErrors.bg.seqNoOnTrack = kcg_lit_int64(0);
  ...
  outC->_L41.PositionErrors.bg.infoFromLinking.expectedLocation.d_max =
    kcg_lit_int64(0);
  outC->_L41.PositionErrors.bg.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L41.PositionErrors.bg.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L41.PositionErrors.bg.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  ...
  outC->_L41.PositionErrors.bg.infoFromPassing.BG_Header.m_mcount =
    kcg_lit_int64(0);
  outC->_L41.PositionErrors.bg.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L41.PositionErrors.bg.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(
      0);
  ...
  outC->_L41.Train_Position.timestamp = kcg_lit_int64(0);
  ...
  outC->_L41.Train_Position.trainPosition.nominal = kcg_lit_int64(0);
  outC->_L41.Train_Position.trainPosition.d_min = kcg_lit_int64(0);
  outC->_L41.Train_Position.trainPosition.d_max = kcg_lit_int64(0);
  outC->_L41.Train_Position.estimatedFrontEndPosition = kcg_lit_int64(0);
  outC->_L41.Train_Position.minSafeFrontEndPosition = kcg_lit_int64(0);
  outC->_L41.Train_Position.maxSafeFrontEndPostion = kcg_lit_int64(0);
  outC->_L41.Train_Position.LRBG.valid = kcg_true;
  outC->_L41.Train_Position.LRBG.nid_c = kcg_lit_int64(0);
  outC->_L41.Train_Position.LRBG.nid_bg = kcg_lit_int64(0);
  outC->_L41.Train_Position.LRBG.q_link = Q_LINK_Unlinked;
  outC->_L41.Train_Position.LRBG.location.nominal = kcg_lit_int64(0);
  outC->_L41.Train_Position.LRBG.location.d_min = kcg_lit_int64(0);
  outC->_L41.Train_Position.LRBG.location.d_max = kcg_lit_int64(0);
  outC->_L41.Train_Position.LRBG.seqNoOnTrack = kcg_lit_int64(0);
  ...
  outC->_L41.Train_Position.LRBG.infoFromLinking.expectedLocation.d_max =
    kcg_lit_int64(0);
  outC->_L41.Train_Position.LRBG.infoFromLinking.d_link.nominal = kcg_lit_int64(
      0);
  outC->_L41.Train_Position.LRBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L41.Train_Position.LRBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  ...
  outC->_L41.Train_Position.prvLRBG.nid_c = kcg_lit_int64(0);
  outC->_L41.Train_Position.prvLRBG.nid_bg = kcg_lit_int64(0);
  outC->_L41.Train_Position.prvLRBG.q_link = Q_LINK_Unlinked;
  outC->_L41.Train_Position.prvLRBG.location.nominal = kcg_lit_int64(0);
  outC->_L41.Train_Position.prvLRBG.location.d_min = kcg_lit_int64(0);
  outC->_L41.Train_Position.prvLRBG.location.d_max = kcg_lit_int64(0);
  outC->_L41.Train_Position.prvLRBG.seqNoOnTrack = kcg_lit_int64(0);
  ...
  outC->_L41.Train_Position.estimatedRearEndPosition = kcg_lit_int64(0);
  outC->_L41.Train_Position.minSafeRearEndPosition = kcg_lit_int64(0);
  outC->_L41.Train_Position.maxSafeRearEndPosition = kcg_lit_int64(0);
  outC->_L41.Train_Speed = kcg_lit_int64(0);
  ...
  outC->_L30.timestamp = kcg_lit_int64(0);
  outC->_L30.trainPositionIsUnknown = kcg_true;
  outC->_L30.noCoordinateSystemHasBeenAssigned = kcg_true;
  outC->_L30.trainPosition.nominal = kcg_lit_int64(0);
  outC->_L30.trainPosition.d_min = kcg_lit_int64(0);
  outC->_L30.trainPosition.d_max = kcg_lit_int64(0);
  outC->_L30.estimatedFrontEndPosition = kcg_lit_int64(0);
  outC->_L30.minSafeFrontEndPosition = kcg_lit_int64(0);
  outC->_L30.maxSafeFrontEndPostion = kcg_lit_int64(0);
  outC->_L30.LRBG.valid = kcg_true;
  outC->_L30.LRBG.nid_c = kcg_lit_int64(0);
  outC->_L30.LRBG.nid_bg = kcg_lit_int64(0);
  outC->_L30.LRBG.q_link = Q_LINK_Unlinked;
  outC->_L30.LRBG.location.nominal = kcg_lit_int64(0);
  outC->_L30.LRBG.location.d_min = kcg_lit_int64(0);
  outC->_L30.LRBG.location.d_max = kcg_lit_int64(0);
  outC->_L30.LRBG.seqNoOnTrack = kcg_lit_int64(0);
  outC->_L30.LRBG.infoFromLinking.valid = kcg_true;
  outC->_L30.LRBG.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L30.LRBG.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->_L30.LRBG.infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
  outC->_L30.LRBG.infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
  outC->_L30.LRBG.infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
  outC->_L30.LRBG.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L30.LRBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L30.LRBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->_L30.LRBG.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->_L30.LRBG.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  ...
  outC->_L30.LRBG.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L30.LRBG.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L30.LRBG.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L30.LRBG.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  outC->_L30.LRBG.infoFromLinking.linkingInfo.q_linkorientation =
    Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
  outC->_L30.LRBG.infoFromLinking.linkingInfo.q_linkreaction =
    Q_LINKREACTION_Train_trip;
  outC->_L30.LRBG.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->_L30.LRBG.infoFromPassing.BG_Header.n_total =
    N_TOTAL_1_balise_in_the_group;
  outC->_L30.LRBG.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L30.LRBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L30.LRBG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L30.LRBG.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L30.LRBG.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx23 = 0; idx23 < 33; idx23++) {
    ...
    outC->_L30.LRBG.infoFromPassing.linkedBGs[idx23].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L30.LRBG.infoFromPassing.linkedBGs[idx23].d_link = kcg_lit_int64(0);
    outC->_L30.LRBG.infoFromPassing.linkedBGs[idx23].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L30.LRBG.infoFromPassing.linkedBGs[idx23].nid_c = kcg_lit_int64(0);
    outC->_L30.LRBG.infoFromPassing.linkedBGs[idx23].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L30.LRBG.infoFromPassing.linkedBGs[idx23].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L30.LRBG.infoFromPassing.linkedBGs[idx23].q_locacc = kcg_lit_int64(0);
  }
  outC->_L30.LRBG.missed = kcg_true;
  outC->_L30.prvLRBG.valid = kcg_true;
  outC->_L30.prvLRBG.nid_c = kcg_lit_int64(0);
  outC->_L30.prvLRBG.nid_bg = kcg_lit_int64(0);
  outC->_L30.prvLRBG.q_link = Q_LINK_Unlinked;
  outC->_L30.prvLRBG.location.nominal = kcg_lit_int64(0);
  outC->_L30.prvLRBG.location.d_min = kcg_lit_int64(0);
  outC->_L30.prvLRBG.location.d_max = kcg_lit_int64(0);
  outC->_L30.prvLRBG.seqNoOnTrack = kcg_lit_int64(0);
  outC->_L30.prvLRBG.infoFromLinking.valid = kcg_true;
  outC->_L30.prvLRBG.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L30.prvLRBG.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->_L30.prvLRBG.infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
  outC->_L30.prvLRBG.infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
  outC->_L30.prvLRBG.infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
  outC->_L30.prvLRBG.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L30.prvLRBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L30.prvLRBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->_L30.prvLRBG.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->_L30.prvLRBG.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  ...
  outC->_L30.prvLRBG.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L30.prvLRBG.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L30.prvLRBG.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L30.prvLRBG.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L30.prvLRBG.infoFromLinking.linkingInfo.q_linkreaction =
    Q_LINKREACTION_Train_trip;
  outC->_L30.prvLRBG.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->_L30.prvLRBG.infoFromPassing.BG_Header.n_total =
    N_TOTAL_1_balise_in_the_group;
  outC->_L30.prvLRBG.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L30.prvLRBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L30.prvLRBG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L30.prvLRBG.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L30.prvLRBG.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx24 = 0; idx24 < 33; idx24++) {
    ...
    outC->_L30.prvLRBG.infoFromPassing.linkedBGs[idx24].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L30.prvLRBG.infoFromPassing.linkedBGs[idx24].q_scale =
      Q_SCALE_10_cm_scale;
    outC->_L30.prvLRBG.infoFromPassing.linkedBGs[idx24].d_link = kcg_lit_int64(0);
    outC->_L30.prvLRBG.infoFromPassing.linkedBGs[idx24].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L30.prvLRBG.infoFromPassing.linkedBGs[idx24].nid_c = kcg_lit_int64(0);
    outC->_L30.prvLRBG.infoFromPassing.linkedBGs[idx24].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L30.prvLRBG.infoFromPassing.linkedBGs[idx24].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L30.prvLRBG.infoFromPassing.linkedBGs[idx24].q_locacc = kcg_lit_int64(0);
  }
  ...
  outC->_L30.estimatedRearEndPosition = kcg_lit_int64(0);
  outC->_L30.minSafeRearEndPosition = kcg_lit_int64(0);
  outC->_L30.maxSafeRearEndPosition = kcg_lit_int64(0);
  outC->_L29 = kcg_true;
  ...
  outC->_L9.transition.position = kcg_lit_int64(0);
  outC->_L9.transition.transitionType =
    M_TransitionType_Conditional_Level_And_Mode_Types_Pkg;
  outC->_L9.transition.immediateAck = kcg_true;
  outC->_L9.transition.AckLength = kcg_lit_int64(0);
  outC->_L9.LRBG = kcg_lit_int64(0);
  outC->_L9.referenceLocation = kcg_lit_int64(0);
  outC->_L10 = kcg_true;
  outC->_L11 = kcg_true;
  outC->_L12 = kcg_true;
...
void kcg_save_SV_ManageLevelAndMode(
  SV_ManageLevelAndMode *SV,
  outC_ManageLevelAndMode *outC)
{
  kcg_save_SV_ManageLevels(
    &SV->Context_ManageLevels_1,
    &outC->Context_ManageLevels_1);
  kcg_save_SV_ManageModes(
    &SV->Context_ManageModes_1,
    &outC->Context_ManageModes_1);
  kcg_save_SV_Output(&SV->Context_Output_1, &outC->Context_Output_1);
}

void kcg_load_SV_ManageLevelAndMode(
  outC_ManageLevelAndMode *outC,
  SV_ManageLevelAndMode *SV)
{
  kcg_load_SV_ManageLevels(
    &outC->Context_ManageLevels_1,
    &SV->Context_ManageLevels_1);
  kcg_load_SV_ManageModes(
    &outC->Context_ManageModes_1,
    &SV->Context_ManageModes_1);
  kcg_load_SV_Output(&outC->Context_Output_1, &SV->Context_Output_1);
}
