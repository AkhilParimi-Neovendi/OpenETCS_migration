  ...
  outC_initCollector_Receive_TrackSide_Msg_Pkg_BaliseSupport *outC)
{
  ...
  outC->_L12.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L12.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L12.telegramheader.nid_bg = kcg_lit_int64(0);
  outC->_L12.telegramheader.q_link = Q_LINK_Unlinked;
  for (idx = 0; idx < 30; idx++) {
    outC->_L12.packets.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L12.packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L12.packets.PacketHeaders[idx].valid = kcg_true;
    outC->_L12.packets.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L12.packets.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L12.packets.PacketData[idx1] = kcg_lit_int64(0);
  }
  outC->_L1 = kcg_true;
  ...
  outC->_L6.m_mcount = kcg_lit_int64(0);
  ...
  outC->_L10.odometerOfBaliseDetection.timestamp = kcg_lit_int64(0);
  outC->_L10.odometerOfBaliseDetection.odo.o_nominal = kcg_lit_int64(0);
  outC->_L10.odometerOfBaliseDetection.odo.o_min = kcg_lit_int64(0);
  outC->_L10.odometerOfBaliseDetection.odo.o_max = kcg_lit_int64(0);
  outC->_L10.odometerOfBaliseDetection.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L10.odometerOfBaliseDetection.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L10.odometerOfBaliseDetection.speed.v_lower = kcg_lit_int64(0);
  outC->_L10.odometerOfBaliseDetection.speed.v_upper = kcg_lit_int64(0);
  outC->_L10.odometerOfBaliseDetection.acceleration = kcg_lit_int64(0);
  ...
  outC->_L11.C_ID = kcg_lit_int64(0);
  outC->_L11.BG_ID = kcg_lit_int64(0);
  outC->_L11.balisePosition.odometerOfBaliseDetection.valid = kcg_true;
  outC->_L11.balisePosition.odometerOfBaliseDetection.timestamp = kcg_lit_int64(
      0);
  outC->_L11.balisePosition.odometerOfBaliseDetection.odo.o_nominal =
    kcg_lit_int64(0);
  outC->_L11.balisePosition.odometerOfBaliseDetection.odo.o_min = kcg_lit_int64(
      0);
  outC->_L11.balisePosition.odometerOfBaliseDetection.odo.o_max = kcg_lit_int64(
      0);
  ...
  outC->_L11.positionFirstContact.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L11.collectedTelegrams = kcg_lit_int64(0);
  outC->_L11.totalTelegrams = kcg_lit_int64(0);
