...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_indexOfBG_by_id_itr_CalculateTrainPosition_Pkg_BG_utilities_Pkg /* _L8=(CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_by_id_itr#1)/ */ Context_indexOfBG_by_id_itr_1[41];
...
extern void indexOfBG_by_id_init_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
  outC_indexOfBG_by_id_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC);
