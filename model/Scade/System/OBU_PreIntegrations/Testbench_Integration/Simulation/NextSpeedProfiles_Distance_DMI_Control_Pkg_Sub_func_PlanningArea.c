...
void NextSpeedProfiles_Distance_DMI_Control_Pkg_Sub_func_PlanningArea(
  ...
  array_float64_32 *inSpeedProfiles_Distance,
  outC_NextSpeedProfiles_Distance_DMI_Control_Pkg_Sub_func_PlanningArea *outC)
{
  ...
  kcg_copy_array_float64_32(&outC->_L32, inSpeedProfiles_Distance);
  ...
  kcg_copy_array_float64_10(&outC->SpeedProfiles_Distance, &outC->_L38);
}
  ...
  outC_NextSpeedProfiles_Distance_DMI_Control_Pkg_Sub_func_PlanningArea *outC)
{
  ...
  for (idx2 = 0; idx2 < 10; idx2++) {
    outC->SpeedProfiles_Distance[idx2] = kcg_lit_float64(0.0);
  }
}
