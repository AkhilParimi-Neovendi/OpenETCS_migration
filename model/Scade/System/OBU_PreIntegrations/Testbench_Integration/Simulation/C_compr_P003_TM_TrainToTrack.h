...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  P003_nid_radio_list_int_t_TM_TrainToTrack /* _L89/ */ Context__L89;
  kcg_bool Context_init;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
} SV_C_compr_P003_TM_TrainToTrack;

extern void kcg_save_SV_C_compr_P003_TM_TrainToTrack(
  SV_C_compr_P003_TM_TrainToTrack *SV,
  outC_C_compr_P003_TM_TrainToTrack *outC);
extern void kcg_load_SV_C_compr_P003_TM_TrainToTrack(
  outC_C_compr_P003_TM_TrainToTrack *outC,
  SV_C_compr_P003_TM_TrainToTrack *SV);
