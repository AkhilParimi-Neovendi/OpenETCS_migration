...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_Supervision_T_Cycloc_ProvidePositionReport_Pkg Context_Supervision_T_Cycloc_1;
  SV_Supervision_M_Loc_ProvidePositionReport_Pkg Context_Supervision_M_Loc_1;
} SV_Supervise_PosRepParam_ProvidePositionReport_Pkg;

extern void kcg_save_SV_Supervise_PosRepParam_ProvidePositionReport_Pkg(
  SV_Supervise_PosRepParam_ProvidePositionReport_Pkg *SV,
  outC_Supervise_PosRepParam_ProvidePositionReport_Pkg *outC);
extern void kcg_load_SV_Supervise_PosRepParam_ProvidePositionReport_Pkg(
  outC_Supervise_PosRepParam_ProvidePositionReport_Pkg *outC,
  SV_Supervise_PosRepParam_ProvidePositionReport_Pkg *SV);
