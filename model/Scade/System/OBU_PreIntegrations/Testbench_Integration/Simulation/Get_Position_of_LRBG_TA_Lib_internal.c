  ...
  outC_Get_Position_of_LRBG_TA_Lib_internal *outC)
{
  ...
  for (idx1 = 0; idx1 < 41; idx1++) {
    ...
    outC->_L18[idx1].nid_c = kcg_lit_int64(0);
    outC->_L18[idx1].nid_bg = kcg_lit_int64(0);
    outC->_L18[idx1].q_link = Q_LINK_Unlinked;
    outC->_L18[idx1].location.nominal = kcg_lit_int64(0);
    outC->_L18[idx1].location.d_min = kcg_lit_int64(0);
    outC->_L18[idx1].location.d_max = kcg_lit_int64(0);
    outC->_L18[idx1].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L18[idx1].infoFromLinking.valid = kcg_true;
    outC->_L18[idx1].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L18[idx1].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L18[idx1].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L18[idx1].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L18[idx1].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L18[idx1].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L18[idx1].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L18[idx1].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L18[idx1].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L18[idx1].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L18[idx1].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L18[idx1].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L18[idx1].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L18[idx1].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L18[idx1].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L18[idx1].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L18[idx1].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L18[idx1].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L18[idx1].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L18[idx1].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx = 0; idx < 33; idx++) {
      ...
      outC->_L18[idx1].infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L18[idx1].infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int64(0);
      outC->_L18[idx1].infoFromPassing.linkedBGs[idx].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L18[idx1].infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int64(0);
      outC->_L18[idx1].infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L18[idx1].infoFromPassing.linkedBGs[idx].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L18[idx1].infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int64(0);
    }
  ...
  for (idx2 = 0; idx2 < 33; idx2++) {
    ...
    outC->_L17.infoFromPassing.linkedBGs[idx2].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L17.infoFromPassing.linkedBGs[idx2].d_link = kcg_lit_int64(0);
    outC->_L17.infoFromPassing.linkedBGs[idx2].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L17.infoFromPassing.linkedBGs[idx2].nid_c = kcg_lit_int64(0);
    outC->_L17.infoFromPassing.linkedBGs[idx2].nid_bg = kcg_lit_int64(0);
    outC->_L17.infoFromPassing.linkedBGs[idx2].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L17.infoFromPassing.linkedBGs[idx2].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L17.infoFromPassing.linkedBGs[idx2].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx3 = 0; idx3 < 33; idx3++) {
    ...
    outC->_L15.linkedBGs[idx3].nid_LRBG = kcg_lit_int64(0);
    outC->_L15.linkedBGs[idx3].q_dir = Q_DIR_Reverse;
    outC->_L15.linkedBGs[idx3].q_scale = Q_SCALE_10_cm_scale;
    outC->_L15.linkedBGs[idx3].d_link = kcg_lit_int64(0);
    outC->_L15.linkedBGs[idx3].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L15.linkedBGs[idx3].nid_c = kcg_lit_int64(0);
    outC->_L15.linkedBGs[idx3].nid_bg = kcg_lit_int64(0);
    outC->_L15.linkedBGs[idx3].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L15.linkedBGs[idx3].q_linkreaction = Q_LINKREACTION_Train_trip;
    outC->_L15.linkedBGs[idx3].q_locacc = kcg_lit_int64(0);
  }
  outC->_L14.valid = kcg_true;
  outC->_L14.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L14.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->_L14.expectedLocation.nominal = kcg_lit_int64(0);
  outC->_L14.expectedLocation.d_min = kcg_lit_int64(0);
  outC->_L14.expectedLocation.d_max = kcg_lit_int64(0);
  outC->_L14.d_link.nominal = kcg_lit_int64(0);
  outC->_L14.d_link.d_min = kcg_lit_int64(0);
  outC->_L14.d_link.d_max = kcg_lit_int64(0);
  outC->_L14.linkingInfo.valid = kcg_true;
  outC->_L14.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  outC->_L14.linkingInfo.q_dir = Q_DIR_Reverse;
  outC->_L14.linkingInfo.q_scale = Q_SCALE_10_cm_scale;
  outC->_L14.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L14.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L14.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L14.linkingInfo.nid_bg = kcg_lit_int64(0);
  outC->_L14.linkingInfo.q_linkorientation =
    Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
  outC->_L14.linkingInfo.q_linkreaction = Q_LINKREACTION_Train_trip;
  outC->_L14.linkingInfo.q_locacc = kcg_lit_int64(0);
  outC->_L13 = kcg_true;
  outC->_L12 = kcg_lit_int64(0);
  outC->_L11.nominal = kcg_lit_int64(0);
  outC->_L11.d_min = kcg_lit_int64(0);
  outC->_L11.d_max = kcg_lit_int64(0);
  ...
  for (idx4 = 0; idx4 < 33; idx4++) {
    ...
    outC->_L8.infoFromPassing.linkedBGs[idx4].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L8.infoFromPassing.linkedBGs[idx4].d_link = kcg_lit_int64(0);
    outC->_L8.infoFromPassing.linkedBGs[idx4].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L8.infoFromPassing.linkedBGs[idx4].nid_c = kcg_lit_int64(0);
    outC->_L8.infoFromPassing.linkedBGs[idx4].nid_bg = kcg_lit_int64(0);
    outC->_L8.infoFromPassing.linkedBGs[idx4].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L8.infoFromPassing.linkedBGs[idx4].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L8.infoFromPassing.linkedBGs[idx4].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx5 = 0; idx5 < 30; idx5++) {
    outC->_L7.packets.PacketHeaders[idx5].nid_packet = kcg_lit_int64(0);
    outC->_L7.packets.PacketHeaders[idx5].q_dir = Q_DIR_Reverse;
    outC->_L7.packets.PacketHeaders[idx5].valid = kcg_true;
    outC->_L7.packets.PacketHeaders[idx5].startAddress = kcg_lit_int64(0);
    outC->_L7.packets.PacketHeaders[idx5].endAddress = kcg_lit_int64(0);
  }
  for (idx6 = 0; idx6 < 500; idx6++) {
    outC->_L7.packets.PacketData[idx6] = kcg_lit_int64(0);
  }
  ...
  for (idx8 = 0; idx8 < 41; idx8++) {
    ...
    outC->_L4[idx8].nid_c = kcg_lit_int64(0);
    outC->_L4[idx8].nid_bg = kcg_lit_int64(0);
    outC->_L4[idx8].q_link = Q_LINK_Unlinked;
    outC->_L4[idx8].location.nominal = kcg_lit_int64(0);
    outC->_L4[idx8].location.d_min = kcg_lit_int64(0);
    outC->_L4[idx8].location.d_max = kcg_lit_int64(0);
    outC->_L4[idx8].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L4[idx8].infoFromLinking.valid = kcg_true;
    outC->_L4[idx8].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L4[idx8].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L4[idx8].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L4[idx8].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L4[idx8].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L4[idx8].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L4[idx8].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L4[idx8].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L4[idx8].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L4[idx8].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L4[idx8].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L4[idx8].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L4[idx8].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L4[idx8].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    outC->_L4[idx8].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L4[idx8].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L4[idx8].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L4[idx8].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L4[idx8].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L4[idx8].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L4[idx8].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L4[idx8].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L4[idx8].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx7 = 0; idx7 < 33; idx7++) {
      ...
      outC->_L4[idx8].infoFromPassing.linkedBGs[idx7].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L4[idx8].infoFromPassing.linkedBGs[idx7].d_link = kcg_lit_int64(0);
      outC->_L4[idx8].infoFromPassing.linkedBGs[idx7].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L4[idx8].infoFromPassing.linkedBGs[idx7].nid_c = kcg_lit_int64(0);
      outC->_L4[idx8].infoFromPassing.linkedBGs[idx7].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L4[idx8].infoFromPassing.linkedBGs[idx7].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L4[idx8].infoFromPassing.linkedBGs[idx7].q_locacc = kcg_lit_int64(0);
    }
