...
void kcg_save_SV_RBC__ProcessPositionReport_RBC_Model_Pkg(
  SV_RBC__ProcessPositionReport_RBC_Model_Pkg *SV,
  outC_RBC__ProcessPositionReport_RBC_Model_Pkg *outC)
{
  SV->Context_POSITION_REPORT_SM_reset_nxt = outC->POSITION_REPORT_SM_reset_nxt;
  SV->Context_POSITION_REPORT_SM_reset_act = outC->POSITION_REPORT_SM_reset_act;
  SV->Context_POSITION_REPORT_SM_state_nxt = outC->POSITION_REPORT_SM_state_nxt;
}

void kcg_load_SV_RBC__ProcessPositionReport_RBC_Model_Pkg(
  outC_RBC__ProcessPositionReport_RBC_Model_Pkg *outC,
  SV_RBC__ProcessPositionReport_RBC_Model_Pkg *SV)
{
  outC->POSITION_REPORT_SM_reset_nxt = SV->Context_POSITION_REPORT_SM_reset_nxt;
  outC->POSITION_REPORT_SM_reset_act = SV->Context_POSITION_REPORT_SM_reset_act;
  outC->POSITION_REPORT_SM_state_nxt = SV->Context_POSITION_REPORT_SM_state_nxt;
}
