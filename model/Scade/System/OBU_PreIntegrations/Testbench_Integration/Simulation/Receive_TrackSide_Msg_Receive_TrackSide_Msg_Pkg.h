...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_Receive_BaliseTelegram_Receive_TrackSide_Msg_Pkg Context_Receive_BaliseTelegram_1;
} SV_Receive_TrackSide_Msg_Receive_TrackSide_Msg_Pkg;

extern void kcg_save_SV_Receive_TrackSide_Msg_Receive_TrackSide_Msg_Pkg(
  SV_Receive_TrackSide_Msg_Receive_TrackSide_Msg_Pkg *SV,
  outC_Receive_TrackSide_Msg_Receive_TrackSide_Msg_Pkg *outC);
extern void kcg_load_SV_Receive_TrackSide_Msg_Receive_TrackSide_Msg_Pkg(
  outC_Receive_TrackSide_Msg_Receive_TrackSide_Msg_Pkg *outC,
  SV_Receive_TrackSide_Msg_Receive_TrackSide_Msg_Pkg *SV);
