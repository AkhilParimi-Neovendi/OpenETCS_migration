...
void op_DOUBTOVER_ProvidePositionReport_Pkg(
  /* trainPos/ */
  ...
  outC_op_DOUBTOVER_ProvidePositionReport_Pkg *outC)
{
  ...
  outC->_L7 = outC->_L1.minSafeFrontEndPosition;
  outC->_L4 = outC->_L1.estimatedFrontEndPosition;
  outC->_L11 = outC->_L4 - outC->_L7;
  ...
  outC->_L10 = outC->A_Output_Abs_1_int32;
  outC->l_doubtover = outC->_L10;
}

#ifndef KCG_USER_DEFINED_INIT
void op_DOUBTOVER_init_ProvidePositionReport_Pkg(
  outC_op_DOUBTOVER_ProvidePositionReport_Pkg *outC)
{
  static kcg_size idx;
  ...
  for (idx = 0; idx < 33; idx++) {
    ...
    outC->_L1.LRBG.infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L1.LRBG.infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int32(0);
    outC->_L1.LRBG.infoFromPassing.linkedBGs[idx].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L1.LRBG.infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int32(0);
    outC->_L1.LRBG.infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int32(0);
    outC->_L1.LRBG.infoFromPassing.linkedBGs[idx].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L1.LRBG.infoFromPassing.linkedBGs[idx].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L1.LRBG.infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int32(0);
  }
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L1.prvLRBG.infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L1.prvLRBG.infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int32(0);
    outC->_L1.prvLRBG.infoFromPassing.linkedBGs[idx1].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L1.prvLRBG.infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int32(0);
    outC->_L1.prvLRBG.infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int32(0);
    ...
    outC->_L1.prvLRBG.infoFromPassing.linkedBGs[idx1].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L1.prvLRBG.infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int32(0);
  }
  ...
  outC->l_doubtover = kcg_lit_int32(0);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void op_DOUBTOVER_reset_ProvidePositionReport_Pkg(
  outC_op_DOUBTOVER_ProvidePositionReport_Pkg *outC)
{
}
