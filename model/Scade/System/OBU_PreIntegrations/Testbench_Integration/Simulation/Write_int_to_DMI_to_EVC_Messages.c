  ...
  outC_Write_int_to_DMI_to_EVC_Messages *outC)
{
  ...
  outC->_L6.driverRequest.systemTime = kcg_lit_int64(0);
  ...
  outC->_L6.radioNetData.systemTime = kcg_lit_int64(0);
  outC->_L6.textMessageAck.valid = kcg_true;
  outC->_L6.textMessageAck.systemTime = kcg_lit_int64(0);
  outC->_L6.textMessageAck.textMessage_ID = kcg_lit_int64(0);
  outC->_L6.textMessageAck.acknowledged = kcg_true;
  outC->_L6.trainDataAck.valid = kcg_true;
  outC->_L6.trainDataAck.systemTime = kcg_lit_int64(0);
  ...
  outC->_L6.iconAck.systemTime = kcg_lit_int64(0);
  outC->_L6.iconAck.DMI_nid_icon_identifier = kcg_lit_int64(0);
  outC->_L6.selectedLevel.valid = kcg_true;
  outC->_L6.selectedLevel.systemTime = kcg_lit_int64(0);
  outC->_L6.selectedLevel.level.level = M_LEVEL_Level_0;
  outC->_L6.selectedLevel.level.nid_stm = kcg_lit_int64(0);
  outC->_L5.present = kcg_true;
  outC->_L5.status.valid = kcg_true;
  outC->_L5.status.systemTime = kcg_lit_int64(0);
  outC->_L5.status.statusSet = Running_state_DMI_Types_Pkg;
  outC->_L5.status.nAlive = kcg_lit_int64(0);
  outC->_L5.identifier.valid = kcg_true;
  outC->_L5.identifier.systemTime = kcg_lit_int64(0);
  outC->_L5.identifier.DMI_Identifier = DMI_1_DMI_Types_Pkg;
  outC->_L5.identifier.Cabin_Identifier = cabin_A_DMI_Types_Pkg;
  outC->_L5.identifier.l_name = kcg_lit_int64(0);
  ...
  outC->_L5.driverRequest.systemTime = kcg_lit_int64(0);
  ...
  outC->_L5.radioNetData.systemTime = kcg_lit_int64(0);
  outC->_L5.textMessageAck.valid = kcg_true;
  outC->_L5.textMessageAck.systemTime = kcg_lit_int64(0);
  outC->_L5.textMessageAck.textMessage_ID = kcg_lit_int64(0);
  outC->_L5.textMessageAck.acknowledged = kcg_true;
  outC->_L5.trainDataAck.valid = kcg_true;
  outC->_L5.trainDataAck.systemTime = kcg_lit_int64(0);
  ...
  outC->_L5.iconAck.systemTime = kcg_lit_int64(0);
  outC->_L5.iconAck.DMI_nid_icon_identifier = kcg_lit_int64(0);
  outC->_L5.selectedLevel.valid = kcg_true;
  outC->_L5.selectedLevel.systemTime = kcg_lit_int64(0);
  outC->_L5.selectedLevel.level.level = M_LEVEL_Level_0;
  outC->_L5.selectedLevel.level.nid_stm = kcg_lit_int64(0);
  outC->_L4 = kcg_lit_int64(0);
  outC->_L3 = kcg_true;
  outC->_L2 = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 311; idx4++) {
    outC->_L1[idx4] = kcg_lit_int64(0);
  }
  outC->every = kcg_true;
  outC->dmi_to_evc_ct.present = kcg_true;
  outC->dmi_to_evc_ct.status.valid = kcg_true;
  outC->dmi_to_evc_ct.status.systemTime = kcg_lit_int64(0);
  outC->dmi_to_evc_ct.status.statusSet = Running_state_DMI_Types_Pkg;
  outC->dmi_to_evc_ct.status.nAlive = kcg_lit_int64(0);
  outC->dmi_to_evc_ct.identifier.valid = kcg_true;
  outC->dmi_to_evc_ct.identifier.systemTime = kcg_lit_int64(0);
  ...
  outC->dmi_to_evc_ct.identifier.l_name = kcg_lit_int64(0);
  ...
  outC->dmi_to_evc_ct.driverRequest.systemTime = kcg_lit_int64(0);
  ...
  outC->dmi_to_evc_ct.driverIdentifier.systemTime = kcg_lit_int64(0);
  ...
  outC->dmi_to_evc_ct.trainRunningNumber.systemTime = kcg_lit_int64(0);
  outC->dmi_to_evc_ct.trainRunningNumber.trainRunningNumber = kcg_lit_int64(0);
  outC->dmi_to_evc_ct.radioNetData.valid = kcg_true;
  outC->dmi_to_evc_ct.radioNetData.systemTime = kcg_lit_int64(0);
  outC->dmi_to_evc_ct.textMessageAck.valid = kcg_true;
  outC->dmi_to_evc_ct.textMessageAck.systemTime = kcg_lit_int64(0);
  outC->dmi_to_evc_ct.textMessageAck.textMessage_ID = kcg_lit_int64(0);
  outC->dmi_to_evc_ct.textMessageAck.acknowledged = kcg_true;
  outC->dmi_to_evc_ct.trainDataAck.valid = kcg_true;
  outC->dmi_to_evc_ct.trainDataAck.systemTime = kcg_lit_int64(0);
  outC->dmi_to_evc_ct.trainDataAck.acknowledged = kcg_true;
  outC->dmi_to_evc_ct.trainData.valid = kcg_true;
  outC->dmi_to_evc_ct.trainData.systemTime = kcg_lit_int64(0);
  outC->dmi_to_evc_ct.trainData.trainCategory =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->dmi_to_evc_ct.trainData.l_train = kcg_lit_int64(0);
  outC->dmi_to_evc_ct.trainData.m_brakeperct = kcg_lit_int64(0);
  outC->dmi_to_evc_ct.trainData.v_maxTrain = kcg_lit_int64(0);
  ...
  outC->dmi_to_evc_ct.adhesionFactor.systemTime = kcg_lit_int64(0);
  outC->dmi_to_evc_ct.adhesionFactor.adhesionFactor = M_ADHESION_Slippery_rail;
  outC->dmi_to_evc_ct.iconAck.valid = kcg_true;
  outC->dmi_to_evc_ct.iconAck.systemTime = kcg_lit_int64(0);
  outC->dmi_to_evc_ct.iconAck.DMI_nid_icon_identifier = kcg_lit_int64(0);
  outC->dmi_to_evc_ct.selectedLevel.valid = kcg_true;
  outC->dmi_to_evc_ct.selectedLevel.systemTime = kcg_lit_int64(0);
  outC->dmi_to_evc_ct.selectedLevel.level.level = M_LEVEL_Level_0;
  outC->dmi_to_evc_ct.selectedLevel.level.nid_stm = kcg_lit_int64(0);
  /* _L5=(Messages::CAST_int_to_DMI_to_EVC#1)/ */
