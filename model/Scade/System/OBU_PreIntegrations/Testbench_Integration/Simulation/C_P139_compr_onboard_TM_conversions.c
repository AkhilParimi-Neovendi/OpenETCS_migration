  ...
  outC_C_P139_compr_onboard_TM_conversions *outC)
{
  ...
  outC->_L10.d_reverse = kcg_lit_int32(0);
  outC->_L10.v_reverse = kcg_lit_int32(0);
  ...
  outC->P139_onboard.d_reverse = kcg_lit_int32(0);
  outC->P139_onboard.v_reverse = kcg_lit_int32(0);
  /* _L31=(TM_conversions::CAST_Int_to_D_REVERSE#1)/ */
