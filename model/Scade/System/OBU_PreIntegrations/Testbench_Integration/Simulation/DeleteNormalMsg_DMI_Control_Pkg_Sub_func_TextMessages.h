...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  kcg_int64 /* NumE/ */ NumE;
  array_float64_10 /* new_mm/ */ new_mm;
  array_float64_10 /* new_hh/ */ new_hh;
  kcg_bool /* msg_is_Empty/ */ msg_is_Empty;
  _95_array /* MsgQueue/ */ MsgQueue;
  /* -----------------------  no local probes  ----------------------- */
  /* ----------------------- local memories  ------------------------- */
  _95_array /* localQueue/ */ mem_localQueue;
  ...
  _95_array /* _L125/ */ _L125;
  _95_array /* _L126/ */ _L126;
  array_float64_10 /* _L134/ */ _L134;
  array_float64_10 /* _L135/ */ _L135;
  array_float64_10 /* _L131/ */ _L131;
  array_float64_10 /* _L130/ */ _L130;
  array_float64_10 /* _L129/ */ _L129;
  array_float64_10 /* _L128/ */ _L128;
  kcg_bool /* _L137/ */ _L137;
  _95_array /* _L138/ */ _L138;
  array_float64_10 /* _L140/ */ _L140;
  array_float64_10 /* _L139/ */ _L139;
...
typedef struct {
  ...
  array_float64_10 /* new_hh/ */ Context_new_hh;
  array_float64_10 /* new_mm/ */ Context_new_mm;
  kcg_int64 /* NumE/ */ Context_NumE;
  /* ----------------------- local memories  ------------------------- */
  kcg_bool Context_init;
  kcg_int64 /* local_num_ack/ */ Context_mem_local_num_ack;
  _95_array /* localQueue/ */ Context_mem_localQueue;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
