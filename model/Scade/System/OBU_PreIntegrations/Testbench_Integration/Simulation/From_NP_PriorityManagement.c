...
{
  /* FromNP_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg FromNP_To_NewMode_partial;
  /* FromNP_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _1_FromNP_To_NewMode_partial;
  /* FromNP_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _2_FromNP_To_NewMode_partial;
  /* FromNP_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _3_FromNP_To_NewMode_partial;
