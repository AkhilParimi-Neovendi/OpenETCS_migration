  ...
  outC_Sheet11_BreukelenKeerspoor_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC *outC)
{
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L10.packets.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    outC->_L10.packets.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L10.packets.PacketHeaders[idx2].valid = kcg_true;
    outC->_L10.packets.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L10.packets.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L10.packets.PacketData[idx3] = kcg_lit_int32(0);
  }
  ...
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L9.packets.PacketHeaders[idx4].nid_packet = kcg_lit_int32(0);
    outC->_L9.packets.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L9.packets.PacketHeaders[idx4].valid = kcg_true;
    outC->_L9.packets.PacketHeaders[idx4].startAddress = kcg_lit_int32(0);
    outC->_L9.packets.PacketHeaders[idx4].endAddress = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L9.packets.PacketData[idx5] = kcg_lit_int32(0);
  }
  ...
  for (idx10 = 0; idx10 < 30; idx10++) {
    outC->_L6.packets.PacketHeaders[idx10].nid_packet = kcg_lit_int32(0);
    outC->_L6.packets.PacketHeaders[idx10].q_dir = Q_DIR_Reverse;
    outC->_L6.packets.PacketHeaders[idx10].valid = kcg_true;
    outC->_L6.packets.PacketHeaders[idx10].startAddress = kcg_lit_int32(0);
    outC->_L6.packets.PacketHeaders[idx10].endAddress = kcg_lit_int32(0);
  }
  for (idx11 = 0; idx11 < 500; idx11++) {
    outC->_L6.packets.PacketData[idx11] = kcg_lit_int32(0);
  }
  ...
  for (idx12 = 0; idx12 < 30; idx12++) {
    outC->_L5.packets.PacketHeaders[idx12].nid_packet = kcg_lit_int32(0);
    outC->_L5.packets.PacketHeaders[idx12].q_dir = Q_DIR_Reverse;
    outC->_L5.packets.PacketHeaders[idx12].valid = kcg_true;
    outC->_L5.packets.PacketHeaders[idx12].startAddress = kcg_lit_int32(0);
    outC->_L5.packets.PacketHeaders[idx12].endAddress = kcg_lit_int32(0);
  }
  for (idx13 = 0; idx13 < 500; idx13++) {
    outC->_L5.packets.PacketData[idx13] = kcg_lit_int32(0);
  }
  ...
  for (idx14 = 0; idx14 < 30; idx14++) {
    outC->_L4.packets.PacketHeaders[idx14].nid_packet = kcg_lit_int32(0);
    outC->_L4.packets.PacketHeaders[idx14].q_dir = Q_DIR_Reverse;
    outC->_L4.packets.PacketHeaders[idx14].valid = kcg_true;
    outC->_L4.packets.PacketHeaders[idx14].startAddress = kcg_lit_int32(0);
    outC->_L4.packets.PacketHeaders[idx14].endAddress = kcg_lit_int32(0);
  }
  for (idx15 = 0; idx15 < 500; idx15++) {
    outC->_L4.packets.PacketData[idx15] = kcg_lit_int32(0);
  }
  ...
  for (idx16 = 0; idx16 < 30; idx16++) {
    outC->_L3.packets.PacketHeaders[idx16].nid_packet = kcg_lit_int32(0);
    outC->_L3.packets.PacketHeaders[idx16].q_dir = Q_DIR_Reverse;
    outC->_L3.packets.PacketHeaders[idx16].valid = kcg_true;
    outC->_L3.packets.PacketHeaders[idx16].startAddress = kcg_lit_int32(0);
    outC->_L3.packets.PacketHeaders[idx16].endAddress = kcg_lit_int32(0);
  }
  for (idx17 = 0; idx17 < 500; idx17++) {
    outC->_L3.packets.PacketData[idx17] = kcg_lit_int32(0);
  }
  ...
  for (idx18 = 0; idx18 < 30; idx18++) {
    outC->_L2.packets.PacketHeaders[idx18].nid_packet = kcg_lit_int32(0);
    outC->_L2.packets.PacketHeaders[idx18].q_dir = Q_DIR_Reverse;
    outC->_L2.packets.PacketHeaders[idx18].valid = kcg_true;
    outC->_L2.packets.PacketHeaders[idx18].startAddress = kcg_lit_int32(0);
    outC->_L2.packets.PacketHeaders[idx18].endAddress = kcg_lit_int32(0);
  }
  for (idx19 = 0; idx19 < 500; idx19++) {
    outC->_L2.packets.PacketData[idx19] = kcg_lit_int32(0);
  }
  ...
  for (idx20 = 0; idx20 < 30; idx20++) {
    outC->_L1.packets.PacketHeaders[idx20].nid_packet = kcg_lit_int32(0);
    outC->_L1.packets.PacketHeaders[idx20].q_dir = Q_DIR_Reverse;
    outC->_L1.packets.PacketHeaders[idx20].valid = kcg_true;
    outC->_L1.packets.PacketHeaders[idx20].startAddress = kcg_lit_int32(0);
    outC->_L1.packets.PacketHeaders[idx20].endAddress = kcg_lit_int32(0);
  }
  for (idx21 = 0; idx21 < 500; idx21++) {
    outC->_L1.packets.PacketData[idx21] = kcg_lit_int32(0);
  }
  ...
  for (idx22 = 0; idx22 < 30; idx22++) {
    outC->R_data_out.packets.PacketHeaders[idx22].nid_packet = kcg_lit_int32(0);
    ...
    outC->R_data_out.packets.PacketHeaders[idx22].startAddress = kcg_lit_int32(0);
    outC->R_data_out.packets.PacketHeaders[idx22].endAddress = kcg_lit_int32(0);
  }
  for (idx23 = 0; idx23 < 500; idx23++) {
    outC->R_data_out.packets.PacketData[idx23] = kcg_lit_int32(0);
  }
  outC->R_data_out.trigger = kcg_lit_int32(0);
  outC->R_data_out.message_sent = kcg_true;
  /* _L10=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_408_D_00050_9_M015#1)/ */
  Send_RBC_LRBG_408_D_00050_9_M015_init_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_408_D_00050_9_M015_1);
  /* _L9=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_407_D_00167_3_M015#1)/ */
  Send_RBC_LRBG_407_D_00167_3_M015_init_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_407_D_00167_3_M015_1);
  /* _L8=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_405_D_00042_2_M015#1)/ */
  Send_RBC_LRBG_405_D_00042_2_M015_init_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_405_D_00042_2_M015_1);
  /* _L7=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_404_D_00184_3_M015#1)/ */
  Send_RBC_LRBG_404_D_00184_3_M015_init_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_404_D_00184_3_M015_1);
  /* _L6=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_402_D_00063_3_M015#1)/ */
  Send_RBC_LRBG_402_D_00063_3_M015_init_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_402_D_00063_3_M015_1);
  /* _L5=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_401_D_00182_7_M015#1)/ */
  Send_RBC_LRBG_401_D_00182_7_M015_init_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_401_D_00182_7_M015_1);
  /* _L4=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_400_D_00371_2_M003#1)/ */
  Send_RBC_LRBG_400_D_00371_2_M003_init_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_400_D_00371_2_M003_1);
  /* _L3=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_400_D_00106_0_M015#1)/ */
  Send_RBC_LRBG_400_D_00106_0_M015_init_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_400_D_00106_0_M015_1);
  /* _L2=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_397_D_00382_0_M003#1)/ */
  Send_RBC_LRBG_397_D_00382_0_M003_init_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_397_D_00382_0_M003_1);
  /* _L1=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_397_D_00169_2_M015#1)/ */
  Send_RBC_LRBG_397_D_00169_2_M015_init_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_397_D_00169_2_M015_1);
}
...
{
  /* _L10=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_408_D_00050_9_M015#1)/ */
  Send_RBC_LRBG_408_D_00050_9_M015_reset_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_408_D_00050_9_M015_1);
  /* _L9=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_407_D_00167_3_M015#1)/ */
  Send_RBC_LRBG_407_D_00167_3_M015_reset_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_407_D_00167_3_M015_1);
  /* _L8=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_405_D_00042_2_M015#1)/ */
  Send_RBC_LRBG_405_D_00042_2_M015_reset_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_405_D_00042_2_M015_1);
  /* _L7=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_404_D_00184_3_M015#1)/ */
  Send_RBC_LRBG_404_D_00184_3_M015_reset_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_404_D_00184_3_M015_1);
  /* _L6=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_402_D_00063_3_M015#1)/ */
  Send_RBC_LRBG_402_D_00063_3_M015_reset_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_402_D_00063_3_M015_1);
  /* _L5=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_401_D_00182_7_M015#1)/ */
  Send_RBC_LRBG_401_D_00182_7_M015_reset_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_401_D_00182_7_M015_1);
  /* _L4=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_400_D_00371_2_M003#1)/ */
  Send_RBC_LRBG_400_D_00371_2_M003_reset_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_400_D_00371_2_M003_1);
  /* _L3=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_400_D_00106_0_M015#1)/ */
  Send_RBC_LRBG_400_D_00106_0_M015_reset_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_400_D_00106_0_M015_1);
  /* _L2=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_397_D_00382_0_M003#1)/ */
  Send_RBC_LRBG_397_D_00382_0_M003_reset_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_397_D_00382_0_M003_1);
  /* _L1=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_RBC::Send_RBC_LRBG_397_D_00169_2_M015#1)/ */
  Send_RBC_LRBG_397_D_00169_2_M015_reset_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_RBC(
    &outC->Context_Send_RBC_LRBG_397_D_00169_2_M015_1);
}
