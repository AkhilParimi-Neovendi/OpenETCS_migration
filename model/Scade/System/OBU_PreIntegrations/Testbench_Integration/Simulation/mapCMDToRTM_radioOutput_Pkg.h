...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_mapnewCMD_toCmd_radioOutput_Pkg Context_mapnewCMD_toCmd_1;
} SV_mapCMDToRTM_radioOutput_Pkg;

extern void kcg_save_SV_mapCMDToRTM_radioOutput_Pkg(
  SV_mapCMDToRTM_radioOutput_Pkg *SV,
  outC_mapCMDToRTM_radioOutput_Pkg *outC);
extern void kcg_load_SV_mapCMDToRTM_radioOutput_Pkg(
  outC_mapCMDToRTM_radioOutput_Pkg *outC,
  SV_mapCMDToRTM_radioOutput_Pkg *SV);
