  ...
  outC_Receive_BaliseTelegram_Receive_TrackSide_Msg_Pkg *outC)
{
  ...
  outC->_L55.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L55.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L55.telegramheader.nid_bg = kcg_lit_int64(0);
  outC->_L55.telegramheader.q_link = Q_LINK_Unlinked;
  for (idx = 0; idx < 30; idx++) {
    outC->_L55.packets.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L55.packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L55.packets.PacketHeaders[idx].valid = kcg_true;
    outC->_L55.packets.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L55.packets.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L55.packets.PacketData[idx1] = kcg_lit_int64(0);
  }
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L46.PacketHeaders[idx2].nid_packet = kcg_lit_int64(0);
    outC->_L46.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L46.PacketHeaders[idx2].valid = kcg_true;
    outC->_L46.PacketHeaders[idx2].startAddress = kcg_lit_int64(0);
    outC->_L46.PacketHeaders[idx2].endAddress = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L46.PacketData[idx3] = kcg_lit_int64(0);
  }
  ...
  outC->_L28.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L28.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L28.telegramheader.nid_bg = kcg_lit_int64(0);
  outC->_L28.telegramheader.q_link = Q_LINK_Unlinked;
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L28.packets.PacketHeaders[idx4].nid_packet = kcg_lit_int64(0);
    outC->_L28.packets.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L28.packets.PacketHeaders[idx4].valid = kcg_true;
    outC->_L28.packets.PacketHeaders[idx4].startAddress = kcg_lit_int64(0);
    outC->_L28.packets.PacketHeaders[idx4].endAddress = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L28.packets.PacketData[idx5] = kcg_lit_int64(0);
  }
  ...
  outC->_L26.m_mcount = kcg_lit_int64(0);
  ...
  outC->_L25.odometerOfBaliseDetection.timestamp = kcg_lit_int64(0);
  outC->_L25.odometerOfBaliseDetection.odo.o_nominal = kcg_lit_int64(0);
  outC->_L25.odometerOfBaliseDetection.odo.o_min = kcg_lit_int64(0);
  outC->_L25.odometerOfBaliseDetection.odo.o_max = kcg_lit_int64(0);
  outC->_L25.odometerOfBaliseDetection.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L25.odometerOfBaliseDetection.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L25.odometerOfBaliseDetection.speed.v_lower = kcg_lit_int64(0);
  outC->_L25.odometerOfBaliseDetection.speed.v_upper = kcg_lit_int64(0);
  outC->_L25.odometerOfBaliseDetection.acceleration = kcg_lit_int64(0);
  ...
  outC->_L25.BG_centerDetectionInaccuraccuracies.nominal = kcg_lit_int64(0);
  outC->_L25.BG_centerDetectionInaccuraccuracies.d_min = kcg_lit_int64(0);
  outC->_L25.BG_centerDetectionInaccuraccuracies.d_max = kcg_lit_int64(0);
  ...
  outC->_L17.systemTimeMsgReceived = kcg_lit_int64(0);
  ...
  outC->_L17.btm_msg.api_header.m_mcount = kcg_lit_int64(0);
  outC->_L17.btm_msg.api_header.nid_c = kcg_lit_int64(0);
  outC->_L17.btm_msg.api_header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L17.rtm_msg.Radio_Common_Header.radioDevice = kcg_lit_int64(0);
  outC->_L17.rtm_msg.Radio_Common_Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L17.rtm_msg.Radio_Common_Header.nid_message = kcg_lit_int64(0);
  outC->_L17.rtm_msg.Radio_Common_Header.t_train = kcg_lit_int64(0);
  outC->_L17.rtm_msg.Radio_Common_Header.m_ack =
    M_ACK_No_acknowledgement_required;
  outC->_L17.rtm_msg.Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L17.rtm_msg.Radio_Common_Header.t_train_reference = kcg_lit_int64(0);
  outC->_L17.rtm_msg.Radio_Common_Header.nid_em = kcg_lit_int64(0);
  outC->_L17.rtm_msg.Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L17.rtm_msg.Radio_Common_Header.d_sr = kcg_lit_int64(0);
  outC->_L17.rtm_msg.Radio_Common_Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L17.rtm_msg.Radio_Common_Header.d_ref = kcg_lit_int64(0);
  outC->_L17.rtm_msg.Radio_Common_Header.q_dir = Q_DIR_Reverse;
  outC->_L17.rtm_msg.Radio_Common_Header.d_emergencystop = kcg_lit_int64(0);
  ...
  outC->_L17.rtm_msg.sendingRBC_Id.nid_c = kcg_lit_int64(0);
  outC->_L17.rtm_msg.sendingRBC_Id.rbc_id = kcg_lit_int64(0);
  outC->_L17.rtm_msg.sendingRBC_Id.device_id = kcg_lit_int64(0);
  ...
  outC->_L13.header.radioDevice = kcg_lit_int64(0);
  outC->_L13.header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L13.header.nid_message = kcg_lit_int64(0);
  outC->_L13.header.t_train = kcg_lit_int64(0);
  outC->_L13.header.m_ack = M_ACK_No_acknowledgement_required;
  outC->_L13.header.nid_lrbg = kcg_lit_int64(0);
  outC->_L13.header.t_train_reference = kcg_lit_int64(0);
  outC->_L13.header.nid_em = kcg_lit_int64(0);
  outC->_L13.header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L13.header.d_sr = kcg_lit_int64(0);
  outC->_L13.header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L13.header.d_ref = kcg_lit_int64(0);
  outC->_L13.header.q_dir = Q_DIR_Reverse;
  outC->_L13.header.d_emergencystop = kcg_lit_int64(0);
  ...
  outC->_L7.telegramHeaders.numberBalises = kcg_lit_int64(0);
  ...
  outC->_L7.radio_Msg.header.radioDevice = kcg_lit_int64(0);
  outC->_L7.radio_Msg.header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L7.radio_Msg.header.nid_message = kcg_lit_int64(0);
  outC->_L7.radio_Msg.header.t_train = kcg_lit_int64(0);
  outC->_L7.radio_Msg.header.m_ack = M_ACK_No_acknowledgement_required;
  outC->_L7.radio_Msg.header.nid_lrbg = kcg_lit_int64(0);
  outC->_L7.radio_Msg.header.t_train_reference = kcg_lit_int64(0);
  outC->_L7.radio_Msg.header.nid_em = kcg_lit_int64(0);
  outC->_L7.radio_Msg.header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L7.radio_Msg.header.d_sr = kcg_lit_int64(0);
  outC->_L7.radio_Msg.header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L7.radio_Msg.header.d_ref = kcg_lit_int64(0);
  outC->_L7.radio_Msg.header.q_dir = Q_DIR_Reverse;
  outC->_L7.radio_Msg.header.d_emergencystop = kcg_lit_int64(0);
  ...
  for (idx13 = 0; idx13 < 30; idx13++) {
    outC->_L7.radio_Msg.packets.PacketHeaders[idx13].nid_packet = kcg_lit_int64(0);
    ...
    outC->_L7.radio_Msg.packets.PacketHeaders[idx13].startAddress =
      kcg_lit_int64(0);
    outC->_L7.radio_Msg.packets.PacketHeaders[idx13].endAddress = kcg_lit_int64(0);
  }
  for (idx14 = 0; idx14 < 500; idx14++) {
    outC->_L7.radio_Msg.packets.PacketData[idx14] = kcg_lit_int64(0);
  }
  outC->_L7.radio_Msg.sendingRBC.valid = kcg_true;
  outC->_L7.radio_Msg.sendingRBC.nid_c = kcg_lit_int64(0);
  outC->_L7.radio_Msg.sendingRBC.rbc_id = kcg_lit_int64(0);
  outC->_L7.radio_Msg.sendingRBC.device_id = kcg_lit_int64(0);
  ...
  for (idx17 = 0; idx17 < 8; idx17++) {
    ...
    outC->_L6.Telegrams[idx17].telegramheader.m_mcount = kcg_lit_int64(0);
    outC->_L6.Telegrams[idx17].telegramheader.nid_c = kcg_lit_int64(0);
    outC->_L6.Telegrams[idx17].telegramheader.nid_bg = kcg_lit_int64(0);
    ...
    for (idx16 = 0; idx16 < 500; idx16++) {
      outC->_L6.Telegrams[idx17].packets.PacketData[idx16] = kcg_lit_int64(0);
    }
  }
  outC->_L6.numberBalises = kcg_lit_int64(0);
  ...
  outC->_L1 = kcg_true;
  outC->systemTimeMsgReceived = kcg_lit_int64(0);
  ...
  outC->decodedTelegram.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->decodedTelegram.telegramheader.nid_c = kcg_lit_int64(0);
  outC->decodedTelegram.telegramheader.nid_bg = kcg_lit_int64(0);
  ...
  for (idx19 = 0; idx19 < 500; idx19++) {
    outC->decodedTelegram.packets.PacketData[idx19] = kcg_lit_int64(0);
  }
...
void kcg_save_SV_Receive_BaliseTelegram_Receive_TrackSide_Msg_Pkg(
  SV_Receive_BaliseTelegram_Receive_TrackSide_Msg_Pkg *SV,
  outC_Receive_BaliseTelegram_Receive_TrackSide_Msg_Pkg *outC)
{
  kcg_save_SV_BuildBGMessage_Receive_TrackSide_Msg_Pkg(
    &SV->Context_BuildBGMessage_1,
    &outC->Context_BuildBGMessage_1);
}

void kcg_load_SV_Receive_BaliseTelegram_Receive_TrackSide_Msg_Pkg(
  outC_Receive_BaliseTelegram_Receive_TrackSide_Msg_Pkg *outC,
  SV_Receive_BaliseTelegram_Receive_TrackSide_Msg_Pkg *SV)
{
  kcg_load_SV_BuildBGMessage_Receive_TrackSide_Msg_Pkg(
    &outC->Context_BuildBGMessage_1,
    &SV->Context_BuildBGMessage_1);
}
