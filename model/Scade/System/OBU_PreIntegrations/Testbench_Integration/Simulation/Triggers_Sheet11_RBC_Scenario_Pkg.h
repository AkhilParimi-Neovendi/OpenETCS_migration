...
typedef struct {
  ...
  SV_RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg Context_RadioTrackTrainMessageTrigger__Trigger_7;
  SV_RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg Context_RadioTrackTrainMessageTrigger__Trigger_8;
  SV_RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg Context_RadioTrackTrainMessageTrigger__Trigger_9;
  SV_RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg Context_RadioTrackTrainMessageTrigger__Trigger_10;
} SV_Triggers_Sheet11_RBC_Scenario_Pkg;

extern void kcg_save_SV_Triggers_Sheet11_RBC_Scenario_Pkg(
  SV_Triggers_Sheet11_RBC_Scenario_Pkg *SV,
  outC_Triggers_Sheet11_RBC_Scenario_Pkg *outC);
extern void kcg_load_SV_Triggers_Sheet11_RBC_Scenario_Pkg(
  outC_Triggers_Sheet11_RBC_Scenario_Pkg *outC,
  SV_Triggers_Sheet11_RBC_Scenario_Pkg *SV);
