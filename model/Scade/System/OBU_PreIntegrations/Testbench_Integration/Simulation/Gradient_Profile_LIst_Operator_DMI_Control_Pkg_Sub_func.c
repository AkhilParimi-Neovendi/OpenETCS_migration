  ...
  outC_Gradient_Profile_LIst_Operator_DMI_Control_Pkg_Sub_func *outC)
{
  ...
  outC->Gradient_Value_Section = kcg_lit_float64(0.0);
  outC->Gradient_End_Section = kcg_lit_float64(0.0);
  outC->Gradient_Begin_Section = kcg_lit_float64(0.0);
