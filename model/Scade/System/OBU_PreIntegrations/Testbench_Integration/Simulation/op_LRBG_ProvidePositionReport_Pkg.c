  ...
  outC_op_LRBG_ProvidePositionReport_Pkg *outC)
{
  ...
  outC->A_Input_Abs_1_int64 = outC->_L33;
  ...
  outC->_L20 = kcg_lit_int64(32767);
  outC->_L19 = outC->A_Output_Abs_1_int64;
  ...
  outC_op_LRBG_ProvidePositionReport_Pkg *outC)
{
  ...
  outC->_L39.nid_c = kcg_lit_int64(0);
  outC->_L39.nid_bg = kcg_lit_int64(0);
  outC->_L39.q_link = Q_LINK_Unlinked;
  outC->_L39.location.nominal = kcg_lit_int64(0);
  outC->_L39.location.d_min = kcg_lit_int64(0);
  outC->_L39.location.d_max = kcg_lit_int64(0);
  outC->_L39.seqNoOnTrack = kcg_lit_int64(0);
  outC->_L39.infoFromLinking.valid = kcg_true;
  outC->_L39.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L39.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->_L39.infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
  outC->_L39.infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
  outC->_L39.infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
  outC->_L39.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L39.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L39.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->_L39.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->_L39.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  ...
  outC->_L39.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L39.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L39.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L39.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L39.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->_L39.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L39.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L39.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  outC->_L39.infoFromPassing.BG_Header.q_link = Q_LINK_Unlinked;
  outC->_L39.infoFromPassing.BG_Header.bgPosition.valid = kcg_true;
  outC->_L39.infoFromPassing.BG_Header.bgPosition.timestamp = kcg_lit_int64(0);
  outC->_L39.infoFromPassing.BG_Header.bgPosition.odo.o_nominal = kcg_lit_int64(
      0);
  outC->_L39.infoFromPassing.BG_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->_L39.infoFromPassing.BG_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
  ...
  outC->_L39.infoFromPassing.BG_Header.bgPosition.speed.v_rawNominal =
    kcg_lit_int64(0);
  outC->_L39.infoFromPassing.BG_Header.bgPosition.speed.v_lower = kcg_lit_int64(
      0);
  outC->_L39.infoFromPassing.BG_Header.bgPosition.speed.v_upper = kcg_lit_int64(
      0);
  outC->_L39.infoFromPassing.BG_Header.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->_L39.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L39.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx = 0; idx < 33; idx++) {
    ...
    outC->_L39.infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L39.infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int64(0);
    outC->_L39.infoFromPassing.linkedBGs[idx].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L39.infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int64(0);
    outC->_L39.infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int64(0);
    outC->_L39.infoFromPassing.linkedBGs[idx].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L39.infoFromPassing.linkedBGs[idx].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L39.infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx2 = 0; idx2 < 41; idx2++) {
    ...
    outC->_L1[idx2].nid_c = kcg_lit_int64(0);
    outC->_L1[idx2].nid_bg = kcg_lit_int64(0);
    outC->_L1[idx2].q_link = Q_LINK_Unlinked;
    outC->_L1[idx2].location.nominal = kcg_lit_int64(0);
    outC->_L1[idx2].location.d_min = kcg_lit_int64(0);
    outC->_L1[idx2].location.d_max = kcg_lit_int64(0);
    outC->_L1[idx2].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L1[idx2].infoFromLinking.valid = kcg_true;
    outC->_L1[idx2].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L1[idx2].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L1[idx2].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L1[idx2].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L1[idx2].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L1[idx2].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L1[idx2].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L1[idx2].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L1[idx2].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L1[idx2].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L1[idx2].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L1[idx2].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L1[idx2].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L1[idx2].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    outC->_L1[idx2].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L1[idx2].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L1[idx2].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L1[idx2].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L1[idx2].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L1[idx2].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L1[idx2].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L1[idx2].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx1 = 0; idx1 < 33; idx1++) {
      ...
      outC->_L1[idx2].infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L1[idx2].infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int64(0);
      outC->_L1[idx2].infoFromPassing.linkedBGs[idx1].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L1[idx2].infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int64(0);
      outC->_L1[idx2].infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L1[idx2].infoFromPassing.linkedBGs[idx1].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L1[idx2].infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int64(0);
    }
  ...
  for (idx3 = 0; idx3 < 33; idx3++) {
    ...
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx3].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx3].d_link = kcg_lit_int64(0);
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx3].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx3].nid_c = kcg_lit_int64(0);
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx3].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx3].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx3].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx4 = 0; idx4 < 33; idx4++) {
    ...
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx4].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx4].d_link = kcg_lit_int64(0);
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx4].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx4].nid_c = kcg_lit_int64(0);
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx4].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx4].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx4].q_locacc = kcg_lit_int64(0);
  }
