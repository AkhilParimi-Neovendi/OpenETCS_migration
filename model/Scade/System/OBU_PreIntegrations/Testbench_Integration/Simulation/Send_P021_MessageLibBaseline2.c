  ...
  outC_Send_P021_MessageLibBaseline2 *outC)
{
  ...
  if (outC->every) {
    /* _L6=(TM_trackside::Write_P021#1)/ */
    Write_P021_TM_trackside(
      &outC->_L4,
      &outC->_L3,
      &outC->Context_Write_P021_1);
    _1_op_call = outC->Context_Write_P021_1.Error;
  ...
  outC_Send_P021_MessageLibBaseline2 *outC)
{
  ...
  outC->_L4.Q_GDIR = kcg_lit_int32(0);
  outC->_L4.G_A = kcg_lit_int32(0);
  outC->_L4.N_ITER = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L4.SECTIONS[idx2].D_GRADIENT = kcg_lit_int32(0);
    outC->_L4.SECTIONS[idx2].Q_GDIR = kcg_lit_int32(0);
    outC->_L4.SECTIONS[idx2].G_A = kcg_lit_int32(0);
  }
