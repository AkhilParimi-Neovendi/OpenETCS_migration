...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  DMI_List_Entry_Request_INT_T_DATA /* dmi_list_entry_request_int/ */ dmi_list_entry_request_int;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  kcg_bool /* _L48/ */ _L48;
} outC_CAST_DMI_List_Entry_Request_to_int_DATA_Variables;

/* ===========  node initialization and cycle functions  =========== */
/* DATA::Variables::CAST_DMI_List_Entry_Request_to_int/ */
extern void CAST_DMI_List_Entry_Request_to_int_DATA_Variables(
...
extern void CAST_DMI_List_Entry_Request_to_int_reset_DATA_Variables(
  outC_CAST_DMI_List_Entry_Request_to_int_DATA_Variables *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CAST_DMI_List_Entry_Request_to_int_init_DATA_Variables(
  outC_CAST_DMI_List_Entry_Request_to_int_DATA_Variables *outC);
