...
void positionedBGs_ids_notEqual_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
  /* bg_2/ */
  ...
  outC_positionedBGs_ids_notEqual_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  ...
  outC->_L10 = outC->_L9 & outC->_L11 & outC->_L8;
  outC->idsNotEqual = outC->_L10;
}

#ifndef KCG_USER_DEFINED_INIT
void positionedBGs_ids_notEqual_init_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
  outC_positionedBGs_ids_notEqual_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  static kcg_size idx;
...
void positionedBGs_ids_notEqual_reset_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
  outC_positionedBGs_ids_notEqual_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  /* _L3=(CalculateTrainPosition_Pkg::BG_utilities_Pkg::nidBG_nidc_equal#1)/ */
