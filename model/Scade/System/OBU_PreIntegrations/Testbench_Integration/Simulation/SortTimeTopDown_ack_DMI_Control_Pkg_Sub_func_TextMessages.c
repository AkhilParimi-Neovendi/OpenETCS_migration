  ...
  outC_SortTimeTopDown_ack_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  kcg_copy_array_float32_5(&outC->_L32, TimeQueue);
  outC->_L28 = c_hh_DMI_Control_Pkg;
  if ((kcg_lit_int32(0) <= outC->_L69) & (outC->_L69 < kcg_lit_int32(5))) {
    outC->_L25 = outC->_L32[outC->_L69];
  }
  else {
    outC->_L25 = outC->_L28;
  }
  kcg_copy_array_float32_5(&outC->_L22, acc);
  kcg_copy_array_float32_5(&outC->_L14, &outC->_L22);
  if ((kcg_lit_int32(0) <= outC->_L71) & (outC->_L71 < kcg_lit_int32(5))) {
    outC->_L14[outC->_L71] = outC->_L25;
  }
  kcg_copy_array_float32_5(&outC->_L21, acc);
  /* _L19= */
  if (outC->_L62) {
    kcg_copy_array_float32_5(&outC->_L19, &outC->_L21);
  }
  else {
    kcg_copy_array_float32_5(&outC->_L19, &outC->_L14);
  }
  kcg_copy_array_float32_5(&outC->outTimeArray, &outC->_L19);
}
  ...
  outC_SortTimeTopDown_ack_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  for (idx = 0; idx < 5; idx++) {
    outC->_L14[idx] = kcg_lit_float32(0.0);
  }
  outC->_L18 = kcg_lit_int32(0);
  for (idx1 = 0; idx1 < 5; idx1++) {
    outC->_L19[idx1] = kcg_lit_float32(0.0);
  }
  ...
  for (idx4 = 0; idx4 < 5; idx4++) {
    outC->_L32[idx4] = kcg_lit_float32(0.0);
  }
  for (idx5 = 0; idx5 < 5; idx5++) {
    outC->outTimeArray[idx5] = kcg_lit_float32(0.0);
  }
}
