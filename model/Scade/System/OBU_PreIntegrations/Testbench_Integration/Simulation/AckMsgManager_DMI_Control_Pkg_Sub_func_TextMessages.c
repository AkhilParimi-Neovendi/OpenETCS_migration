  ...
  outC_AckMsgManager_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  static array_float64_5 acc;
  static kcg_size idx5;
  static kcg_size idx6;
  static array_float64_5 acc7;
  ...
  /* IndexFixedMsg/ */
  static array_int64_5 IndexFixedMsg_partial;
  /* ArrayPlainText/ */
  static array_char_30_5 ArrayPlainText_partial;
  static kcg_bool noname;
  /* IndexFixedMsg/ */
  static array_int64_5 _13_IndexFixedMsg_partial;
  /* ArrayPlainText/ */
  ...
  /* IndexFixedMsg/ */
  static array_int64_5 IndexFixedMsg;
  /* Array_hh/ */
  static array_float64_5 Array_hh;
  /* Array_mm/ */
  static array_float64_5 Array_mm;

  kcg_copy_array_float64_5(&outC->_L53, array_mm_local);
  ...
  kcg_copy_array_float64_5(&outC->_L55, array_hh_local);
  ...
  outC->_L46 = kcg_lit_float64(-1.0);
  outC->_L45 = kcg_lit_float64(-1.0);
  kcg_copy_array_float64_5(
    &outC->_L28,
    (array_float64_5 *) &cArray_mm_leer5_DMI_Control_Pkg);
  kcg_copy_array_float64_5(&outC->_L20, array_mm_local);
  /* _L33/ */
  for (idx4 = 0; idx4 < 5; idx4++) {
    kcg_copy_array_float64_5(&outC->_L33[idx4], &outC->_L20);
  }
  kcg_copy_array_float64_5(&outC->_L23, &outC->_L28);
  /* _L23= */
  for (idx5 = 0; idx5 < 5; idx5++) {
    kcg_copy_array_float64_5(&acc, &outC->_L23);
  ...
  outC->_L42 = kcg_lit_float64(-1.0);
  outC->_L43 = kcg_lit_float64(-1.0);
  ...
  kcg_copy_array_float64_5(&outC->_L19, array_hh_local);
  /* _L29/ */
  for (idx6 = 0; idx6 < 5; idx6++) {
    kcg_copy_array_float64_5(&outC->_L29[idx6], &outC->_L19);
  }
  kcg_copy_array_float64_5(&outC->_L31, &outC->_L21);
  /* _L31= */
  for (idx8 = 0; idx8 < 5; idx8++) {
    kcg_copy_array_float64_5(&acc7, &outC->_L31);
  ...
  outC->_L35 = kcg_lit_float64(-1.0);
  outC->_L36 = kcg_lit_float64(-1.0);
  outC->_L37 = kcg_lit_float64(-1.0);
  ...
  kcg_copy_array_float64_5(&outC->Array_mm, &outC->_L44);
  kcg_copy_array_float64_5(&outC->Array_hh, &outC->_L38);
  kcg_copy__80_array(&outC->_L1, Queue);
  ...
  IndexFixedMsg[0] = kcg_lit_int64(0);
  IndexFixedMsg[1] = kcg_lit_int64(0);
  IndexFixedMsg[2] = kcg_lit_int64(0);
  IndexFixedMsg[3] = kcg_lit_int64(0);
  IndexFixedMsg[4] = kcg_lit_int64(0);
  /* IfBlock1: */
  if (outC->IfBlock1_clock) {
    ...
    kcg_copy__80_array(&outC->_L2_then_IfBlock1, Queue);
    ...
    if (outC->_L24_then_IfBlock1) {
      ...
      for (idx11 = 0; idx11 < 27; idx11++) {
        ...
        Find_Q_Text_iterator_DMI_Control_Pkg_Sub_func_TextMessages(
          /* IfBlock1:then:_L23= */(kcg_int64) idx11,
          acc10,
        ...
        outC->_L23_then_IfBlock1 = /* IfBlock1:then:_L23= */(kcg_int64) (idx11 + 1);
        /* IfBlock1:then:_L23= */
    ...
    kcg_copy_array_int64_4(&outC->_L13_then_IfBlock1[1], &outC->_L12_then_IfBlock1);
    kcg_copy_array_int64_5(&IndexFixedMsg_partial, &outC->_L13_then_IfBlock1);
    noname = outC->_L21_then_IfBlock1;
    kcg_copy_array_int64_5(&outC->IndexFixedMsg, &IndexFixedMsg_partial);
    kcg_copy_array_char_30_5(&outC->ArrayPlainText, &ArrayPlainText_partial);
  }
  else {
    kcg_copy_array_int64_5(&_13_IndexFixedMsg_partial, &IndexFixedMsg);
    outC->else_clock_IfBlock1 = outC->PlainText;
    /* IfBlock1:else: */
    if (outC->else_clock_IfBlock1) {
      kcg_copy__80_array(&outC->_L12_then_else_IfBlock1, Queue);
    ...
    kcg_copy_array_int64_5(&outC->IndexFixedMsg, &_13_IndexFixedMsg_partial);
  ...
  outC_AckMsgManager_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  for (idx10 = 0; idx10 < 5; idx10++) {
    outC->_L38[idx10] = kcg_lit_float64(0.0);
  }
  for (idx11 = 0; idx11 < 5; idx11++) {
    outC->_L21[idx11] = kcg_lit_float64(0.0);
  }
  for (idx12 = 0; idx12 < 5; idx12++) {
    outC->_L23[idx12] = kcg_lit_float64(0.0);
  }
  for (idx13 = 0; idx13 < 5; idx13++) {
    outC->_L28[idx13] = kcg_lit_float64(0.0);
  }
  for (idx15 = 0; idx15 < 5; idx15++) {
    for (idx14 = 0; idx14 < 5; idx14++) {
      outC->_L29[idx15][idx14] = kcg_lit_float64(0.0);
    }
  }
  for (idx16 = 0; idx16 < 5; idx16++) {
    outC->_L31[idx16] = kcg_lit_float64(0.0);
  }
  for (idx18 = 0; idx18 < 5; idx18++) {
    for (idx17 = 0; idx17 < 5; idx17++) {
      outC->_L33[idx18][idx17] = kcg_lit_float64(0.0);
    }
  }
  for (idx19 = 0; idx19 < 5; idx19++) {
    outC->_L20[idx19] = kcg_lit_float64(0.0);
  }
  for (idx20 = 0; idx20 < 5; idx20++) {
    outC->_L19[idx20] = kcg_lit_float64(0.0);
  }
  outC->_L17 = kcg_true;
  outC->_L18 = kcg_true;
  outC->_L14 = kcg_true;
  ...
  for (idx22 = 0; idx22 < 5; idx22++) {
    ...
    outC->_L1[idx22].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L1[idx22].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L1[idx22].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L1[idx22].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  outC->num_hh = kcg_lit_int64(0);
  outC->num_mm = kcg_lit_int64(0);
  ...
  outC->_L10_then_else_IfBlock1.dmi_msg.system_clock = kcg_lit_int64(0);
  outC->_L10_then_else_IfBlock1.dmi_msg.textMessage_ID = kcg_lit_int64(0);
  outC->_L10_then_else_IfBlock1.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L10_then_else_IfBlock1.dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx27 = 0; idx27 < 5; idx27++) {
    ...
    outC->_L12_then_else_IfBlock1[idx27].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L12_then_else_IfBlock1[idx27].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L12_then_else_IfBlock1[idx27].dmi_msg.q_text =
      balise_read_error_DMI_Types_Pkg;
    outC->_L12_then_else_IfBlock1[idx27].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  outC->_L3_then_IfBlock1.textMessage_ID = kcg_lit_int64(0);
  outC->_L3_then_IfBlock1.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L3_then_IfBlock1.l_text = kcg_lit_int64(0);
  ...
  for (idx37 = 0; idx37 < 5; idx37++) {
    ...
    outC->_L2_then_IfBlock1[idx37].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx37].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx37].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L2_then_IfBlock1[idx37].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  outC->_L1_then_IfBlock1.dmi_msg.system_clock = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.dmi_msg.textMessage_ID = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L1_then_IfBlock1.dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx41 = 0; idx41 < 4; idx41++) {
    outC->_L12_then_IfBlock1[idx41] = kcg_lit_int64(0);
  }
  for (idx42 = 0; idx42 < 5; idx42++) {
    outC->_L13_then_IfBlock1[idx42] = kcg_lit_int64(0);
  }
  outC->_L14_then_IfBlock1 = kcg_lit_int64(0);
  outC->_L15_then_IfBlock1 = kcg_lit_int64(0);
  outC->_L16_then_IfBlock1 = kcg_lit_int64(0);
  ...
  for (idx43 = 0; idx43 < 1; idx43++) {
    outC->_L18_then_IfBlock1[idx43] = kcg_lit_int64(0);
  }
  ...
  for (idx44 = 0; idx44 < 5; idx44++) {
    outC->Array_mm[idx44] = kcg_lit_float64(0.0);
  }
  for (idx45 = 0; idx45 < 5; idx45++) {
    outC->Array_hh[idx45] = kcg_lit_float64(0.0);
  }
  ...
  for (idx48 = 0; idx48 < 5; idx48++) {
    outC->IndexFixedMsg[idx48] = kcg_lit_int64(0);
  }
