...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ----------------------- local memories  ------------------------- */
  kcg_int64 /* NumImp/ */ NumImp;
  kcg_int64 /* NumAuxi/ */ NumAuxi;
  _95_array /* impQueue/ */ impQueue;
  _95_array /* auxiQueue/ */ auxiQueue;
  kcg_float64 /* Local_mm/ */ Local_mm;
  kcg_float64 /* Local_hh/ */ Local_hh;
  array_float64_10 /* Local_mm_array_imp/ */ Local_mm_array_imp;
  array_float64_10 /* Local_hh_array_imp/ */ Local_hh_array_imp;
  array_float64_10 /* Local_hh_array_auxi/ */ Local_hh_array_auxi;
  array_float64_10 /* Local_mm_array_auxi/ */ Local_mm_array_auxi;
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  array_float64_10 /* OperationQueue_IfBlock:then:_L183/ */ _L183_then_OperationQueue_IfBlock;
  array_float64_10 /* OperationQueue_IfBlock:then:_L182/ */ _L182_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:_L178/ */ _L178_then_OperationQueue_IfBlock;
  array_float64_10 /* OperationQueue_IfBlock:then:_L181/ */ _L181_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:_L177/ */ _L177_then_OperationQueue_IfBlock;
  array_float64_10 /* OperationQueue_IfBlock:then:_L176/ */ _L176_then_OperationQueue_IfBlock;
  array_float64_10 /* OperationQueue_IfBlock:then:_L175/ */ _L175_then_OperationQueue_IfBlock;
  array_float64_10 /* OperationQueue_IfBlock:then:_L174/ */ _L174_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:_L141/ */ _L141_then_OperationQueue_IfBlock;
  _95_array /* OperationQueue_IfBlock:then:_L142/ */ _L142_then_OperationQueue_IfBlock;
  _95_array /* OperationQueue_IfBlock:then:_L143/ */ _L143_then_OperationQueue_IfBlock;
  _95_array /* OperationQueue_IfBlock:then:_L144/ */ _L144_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:_L52/ */ _L52_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:IfBlock1:else:_L1/ */ _L1_else_IfBlock1_then_OperationQueue_IfBlock;
  ...
  kcg_int64 /* OperationQueue_IfBlock:then:IfBlock1:else:_L4/ */ _L4_else_IfBlock1_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:IfBlock1:else:_L3/ */ _L3_else_IfBlock1_then_OperationQueue_IfBlock;
  _95_array /* OperationQueue_IfBlock:then:IfBlock1:else:_L2/ */ _L2_else_IfBlock1_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:IfBlock1:else:_L7/ */ _L7_else_IfBlock1_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:IfBlock1:else:_L8/ */ _L8_else_IfBlock1_then_OperationQueue_IfBlock;
  array_float64_10 /* OperationQueue_IfBlock:then:IfBlock1:else:_L9/ */ _L9_else_IfBlock1_then_OperationQueue_IfBlock;
  array_float64_10 /* OperationQueue_IfBlock:then:IfBlock1:else:_L10/ */ _L10_else_IfBlock1_then_OperationQueue_IfBlock;
  kcg_float64 /* OperationQueue_IfBlock:then:IfBlock1:else:_L13/ */ _L13_else_IfBlock1_then_OperationQueue_IfBlock;
  kcg_float64 /* OperationQueue_IfBlock:then:IfBlock1:else:_L14/ */ _L14_else_IfBlock1_then_OperationQueue_IfBlock;
  kcg_bool /* OperationQueue_IfBlock:then:IfBlock1:else:_L17/ */ _L17_else_IfBlock1_then_OperationQueue_IfBlock;
  _95_array /* OperationQueue_IfBlock:then:IfBlock1:then:_L7/ */ _L7_then_IfBlock1_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:IfBlock1:then:_L6/ */ _L6_then_IfBlock1_then_OperationQueue_IfBlock;
  ...
  kcg_int64 /* OperationQueue_IfBlock:then:IfBlock1:then:_L3/ */ _L3_then_IfBlock1_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:IfBlock1:then:_L8/ */ _L8_then_IfBlock1_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:IfBlock1:then:_L9/ */ _L9_then_IfBlock1_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:IfBlock1:then:_L2/ */ _L2_then_IfBlock1_then_OperationQueue_IfBlock;
  array_float64_10 /* OperationQueue_IfBlock:then:IfBlock1:then:_L10/ */ _L10_then_IfBlock1_then_OperationQueue_IfBlock;
  array_float64_10 /* OperationQueue_IfBlock:then:IfBlock1:then:_L11/ */ _L11_then_IfBlock1_then_OperationQueue_IfBlock;
  kcg_float64 /* OperationQueue_IfBlock:then:IfBlock1:then:_L14/ */ _L14_then_IfBlock1_then_OperationQueue_IfBlock;
  kcg_float64 /* OperationQueue_IfBlock:then:IfBlock1:then:_L15/ */ _L15_then_IfBlock1_then_OperationQueue_IfBlock;
  kcg_bool /* OperationQueue_IfBlock:then:IfBlock1:then:_L19/ */ _L19_then_IfBlock1_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:else:_L2/ */ _L2_else_OperationQueue_IfBlock;
  ...
  kcg_int64 /* CountCommand/ */ CountCommand;
  kcg_bool /* ins/ */ ins;
  kcg_bool /* insertImpMsg/ */ insertImpMsg;
  kcg_int64 /* CountCommand_imp/ */ CountCommand_imp;
  kcg_int64 /* CountCommand_auxi/ */ CountCommand_auxi;
...
typedef struct {
  ...
  _95_array /* queue/ */ Context_queue;
  kcg_bool /* isEmpty/ */ Context_isEmpty;
  kcg_bool /* isFull/ */ Context_isFull;
  /* ----------------------- local memories  ------------------------- */
  array_float64_10 /* Local_mm_array_auxi/ */ Context_Local_mm_array_auxi;
  array_float64_10 /* Local_hh_array_auxi/ */ Context_Local_hh_array_auxi;
  array_float64_10 /* Local_hh_array_imp/ */ Context_Local_hh_array_imp;
  array_float64_10 /* Local_mm_array_imp/ */ Context_Local_mm_array_imp;
  kcg_float64 /* Local_hh/ */ Context_Local_hh;
  kcg_float64 /* Local_mm/ */ Context_Local_mm;
  _95_array /* auxiQueue/ */ Context_auxiQueue;
  _95_array /* impQueue/ */ Context_impQueue;
  kcg_int64 /* NumAuxi/ */ Context_NumAuxi;
  kcg_int64 /* NumImp/ */ Context_NumImp;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
