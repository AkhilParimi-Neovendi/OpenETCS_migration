  ...
  outC_RadioTrackTrainFactory__CreateP058_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg *outC)
{
  ...
  kcg_copy__68_array(&outC->_L18, inIncrementalDistancesAndQualifiers);
  ...
  outC_RadioTrackTrainFactory__CreateP058_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg *outC)
{
  ...
  /* _L12=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RBC_RadioTrackTrainPacket058_Pkg::RadioTrackTrainPacket058__Create#1)/ */
  RadioTrackTrainPacket058__Create_init_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTrainPacket058_Pkg(
    &outC->Context_RadioTrackTrainPacket058__Create_1);
}
...
{
  /* _L12=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RBC_RadioTrackTrainPacket058_Pkg::RadioTrackTrainPacket058__Create#1)/ */
  RadioTrackTrainPacket058__Create_reset_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTrainPacket058_Pkg(
    &outC->Context_RadioTrackTrainPacket058__Create_1);
}
