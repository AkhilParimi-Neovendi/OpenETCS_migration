  ...
  outC_deleteBGs_beforeIndex_itr_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  ...
  if ((kcg_lit_int32(0) <= outC->_L8) & (outC->_L8 < kcg_lit_int32(41))) {
  ...
  outC_deleteBGs_beforeIndex_itr_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  ...
  for (idx4 = 0; idx4 < 41; idx4++) {
    ...
    outC->_L7[idx4].nid_c = kcg_lit_int32(0);
    outC->_L7[idx4].nid_bg = kcg_lit_int32(0);
    outC->_L7[idx4].q_link = Q_LINK_Unlinked;
    outC->_L7[idx4].location.nominal = kcg_lit_int32(0);
    outC->_L7[idx4].location.d_min = kcg_lit_int32(0);
    outC->_L7[idx4].location.d_max = kcg_lit_int32(0);
    outC->_L7[idx4].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L7[idx4].infoFromLinking.valid = kcg_true;
    outC->_L7[idx4].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L7[idx4].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L7[idx4].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L7[idx4].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L7[idx4].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L7[idx4].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L7[idx4].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L7[idx4].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L7[idx4].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L7[idx4].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L7[idx4].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L7[idx4].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L7[idx4].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L7[idx4].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    outC->_L7[idx4].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L7[idx4].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L7[idx4].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L7[idx4].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L7[idx4].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L7[idx4].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L7[idx4].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L7[idx4].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L7[idx4].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx3 = 0; idx3 < 33; idx3++) {
      ...
      outC->_L7[idx4].infoFromPassing.linkedBGs[idx3].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L7[idx4].infoFromPassing.linkedBGs[idx3].d_link = kcg_lit_int32(0);
      outC->_L7[idx4].infoFromPassing.linkedBGs[idx3].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L7[idx4].infoFromPassing.linkedBGs[idx3].nid_c = kcg_lit_int32(0);
      outC->_L7[idx4].infoFromPassing.linkedBGs[idx3].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L7[idx4].infoFromPassing.linkedBGs[idx3].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L7[idx4].infoFromPassing.linkedBGs[idx3].q_locacc = kcg_lit_int32(0);
    }
  ...
  for (idx5 = 0; idx5 < 33; idx5++) {
    ...
    outC->_L10.infoFromPassing.linkedBGs[idx5].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L10.infoFromPassing.linkedBGs[idx5].d_link = kcg_lit_int32(0);
    outC->_L10.infoFromPassing.linkedBGs[idx5].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L10.infoFromPassing.linkedBGs[idx5].nid_c = kcg_lit_int32(0);
    outC->_L10.infoFromPassing.linkedBGs[idx5].nid_bg = kcg_lit_int32(0);
    outC->_L10.infoFromPassing.linkedBGs[idx5].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L10.infoFromPassing.linkedBGs[idx5].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L10.infoFromPassing.linkedBGs[idx5].q_locacc = kcg_lit_int32(0);
  }
