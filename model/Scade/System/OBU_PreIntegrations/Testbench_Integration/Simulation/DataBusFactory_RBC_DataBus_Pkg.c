  ...
  outC_DataBusFactory_RBC_DataBus_Pkg *outC)
{
  ...
  kcg_copy__57_array(
    &outC->_L38,
    (_57_array *) &DIAG_MSG_DEFAULT_ARRAY_RBC_Diagnostic_Pkg);
  kcg_copy_RBC_Data_T_RBC_DataBus_Pkg(&outC->_L8, inDataBus);
  kcg_copy__57_array(&outC->_L16, &outC->_L8.diagnostic);
  outC->_L3 = outC->o_times_1_int32;
  /* _L28= */
  if (outC->_L3) {
    kcg_copy__57_array(&outC->_L28, &outC->_L38);
  }
  else {
    kcg_copy__57_array(&outC->_L28, &outC->_L16);
  }
  ...
  kcg_copy__57_array(&outC->_L17.diagnostic, &outC->_L28);
...
void kcg_save_SV_DataBusFactory_RBC_DataBus_Pkg(
  ...
  outC_DataBusFactory_RBC_DataBus_Pkg *outC)
{
  SV->Context_v3_times_1 = outC->v3_times_1_int32;
...
void kcg_load_SV_DataBusFactory_RBC_DataBus_Pkg(
  ...
  SV_DataBusFactory_RBC_DataBus_Pkg *SV)
{
  outC->v3_times_1_int32 = SV->Context_v3_times_1;
