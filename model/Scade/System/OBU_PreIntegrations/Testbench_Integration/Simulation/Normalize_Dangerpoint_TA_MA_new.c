  ...
  outC_Normalize_Dangerpoint_TA_MA_new *outC)
{
  ...
  outC->_L15.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L15.v_release = kcg_lit_int64(0);
  ...
  for (idx = 0; idx < 32; idx++) {
    ...
    outC->_L8.sections[idx].l_section = kcg_lit_int64(0);
    outC->_L8.sections[idx].q_sectiontimer =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L8.sections[idx].t_sectiontimer = kcg_lit_int64(0);
    outC->_L8.sections[idx].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->_L8.l_endsection = kcg_lit_int64(0);
  outC->_L8.q_sectiontimer = Q_SECTIONTIMER_No_Section_Timer_information;
  outC->_L8.t_sectiontimer = kcg_lit_int64(0);
  outC->_L8.d_sectiontimerstoploc = kcg_lit_int64(0);
  outC->_L8.q_endtimer = Q_ENDTIMER_No_End_section_timer_information;
  outC->_L8.t_endtimer = kcg_lit_int64(0);
  outC->_L8.d_endtimerstartloc = kcg_lit_int64(0);
  outC->_L8.q_dangerpoint = Q_DANGERPOINT_No_danger_point_information;
  outC->_L8.d_dp = kcg_lit_int64(0);
  outC->_L8.v_releasedp = kcg_lit_int64(0);
  outC->_L8.q_overlap = Q_OVERLAP_No_overlap_information;
  outC->_L8.d_startol = kcg_lit_int64(0);
  outC->_L8.t_ol = kcg_lit_int64(0);
  outC->_L8.d_ol = kcg_lit_int64(0);
  outC->_L8.v_releaseol = kcg_lit_int64(0);
  ...
  for (idx1 = 0; idx1 < 32; idx1++) {
    ...
    outC->_L7.SECTIONS[idx1].nid_c = kcg_lit_int64(0);
  }
  ...
  outC->_L7.v_nvsopovtrp = kcg_lit_int64(0);
  ...
  outC->_L5.d_DP_or_OL = kcg_lit_int64(0);
