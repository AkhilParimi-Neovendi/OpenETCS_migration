...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P012_us_array_TM_lib_internal /* _L7=(TM_lib_internal::C_P012_us_array#1)/ */ Context_C_P012_us_array_1[32];
...
extern void C_P012_unflatten_sections_init_TM_lib_internal(
  outC_C_P012_unflatten_sections_TM_lib_internal *outC);
