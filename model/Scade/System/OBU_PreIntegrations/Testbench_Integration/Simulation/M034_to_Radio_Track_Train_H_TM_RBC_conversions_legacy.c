...
void M034_to_Radio_Track_Train_H_init_TM_RBC_conversions_legacy(
  outC_M034_to_Radio_Track_Train_H_TM_RBC_conversions_legacy *outC)
{
  outC->_L31 =
  ...
  outC->_L1.d_tafdisplay = kcg_lit_int32(0);
  outC->_L1.l_tafdisplay = kcg_lit_int32(0);
