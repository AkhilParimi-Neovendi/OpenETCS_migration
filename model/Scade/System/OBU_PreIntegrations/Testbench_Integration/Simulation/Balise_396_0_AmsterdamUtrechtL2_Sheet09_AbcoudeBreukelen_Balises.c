...
void Balise_396_0_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
  ...
  /* PIG_nom/ */
  kcg_int64 PIG_nom,
  outC_Balise_396_0_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet09_AbcoudeBreukelen_Balises::Packets_BG396#1)/ */
    Packets_BG396_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG396_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG396_1.Balise_data_out);
...
void Balise_396_0_init_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
  outC_Balise_396_0_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises *outC)
{
  static kcg_size idx;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet09_AbcoudeBreukelen_Balises::Packets_BG396#1)/ */
  Packets_BG396_init_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
    &outC->Context_Packets_BG396_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_396_0_reset_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
  outC_Balise_396_0_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet09_AbcoudeBreukelen_Balises::Packets_BG396#1)/ */
  Packets_BG396_reset_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
    &outC->Context_Packets_BG396_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
