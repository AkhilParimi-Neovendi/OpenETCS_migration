  ...
  outC_checkSingleBB_Receive_TrackSide_Msg_Pkg_BaliseSupport *outC)
{
  ...
  outC->_L26.odometerOfBaliseDetection.timestamp = kcg_lit_int64(0);
  outC->_L26.odometerOfBaliseDetection.odo.o_nominal = kcg_lit_int64(0);
  outC->_L26.odometerOfBaliseDetection.odo.o_min = kcg_lit_int64(0);
  outC->_L26.odometerOfBaliseDetection.odo.o_max = kcg_lit_int64(0);
  outC->_L26.odometerOfBaliseDetection.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L26.odometerOfBaliseDetection.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L26.odometerOfBaliseDetection.speed.v_lower = kcg_lit_int64(0);
  outC->_L26.odometerOfBaliseDetection.speed.v_upper = kcg_lit_int64(0);
  outC->_L26.odometerOfBaliseDetection.acceleration = kcg_lit_int64(0);
  ...
  outC->_L26.odometerOfBaliseDetection.motionDirection =
    unknownDirection_Obu_BasicTypes_Pkg;
  outC->_L26.BG_centerDetectionInaccuraccuracies.nominal = kcg_lit_int64(0);
  outC->_L26.BG_centerDetectionInaccuraccuracies.d_min = kcg_lit_int64(0);
  outC->_L26.BG_centerDetectionInaccuraccuracies.d_max = kcg_lit_int64(0);
