  ...
  outC_CAST_DMI_Track_Description_to_int_DATA_Packets_EVC_to_DMI *outC)
{
  ...
  outC->_L2.nIter = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 32; idx5++) {
    outC->_L2.trackCondition[idx5].d_trackcond = kcg_lit_int64(0);
  ...
  for (idx6 = 0; idx6 < 32; idx6++) {
    ...
    outC->_L3.gradientProfiles[idx6].begin_section = kcg_lit_int64(0);
    outC->_L3.gradientProfiles[idx6].end_section = kcg_lit_int64(0);
    outC->_L3.gradientProfiles[idx6].gradient = kcg_lit_int64(0);
  }
  outC->_L4.profileChanged = kcg_true;
  for (idx7 = 0; idx7 < 32; idx7++) {
    outC->_L4.speedProfiles[idx7].valid = kcg_true;
    outC->_L4.speedProfiles[idx7].Loc_Abs = kcg_lit_int64(0);
    outC->_L4.speedProfiles[idx7].Loc_LRBG = kcg_lit_int64(0);
    outC->_L4.speedProfiles[idx7].MRS = kcg_lit_int64(0);
  }
  ...
  for (idx8 = 0; idx8 < 32; idx8++) {
    ...
    outC->_L1.speedProfiles.speedProfiles[idx8].Loc_Abs = kcg_lit_int64(0);
    outC->_L1.speedProfiles.speedProfiles[idx8].Loc_LRBG = kcg_lit_int64(0);
    outC->_L1.speedProfiles.speedProfiles[idx8].MRS = kcg_lit_int64(0);
  }
  ...
  for (idx9 = 0; idx9 < 32; idx9++) {
    ...
    outC->_L1.gradientProfiles.gradientProfiles[idx9].end_section =
      kcg_lit_int64(0);
    outC->_L1.gradientProfiles.gradientProfiles[idx9].gradient = kcg_lit_int64(0);
  }
  outC->_L1.trackConditions.nIter = kcg_lit_int64(0);
  for (idx10 = 0; idx10 < 32; idx10++) {
    outC->_L1.trackConditions.trackCondition[idx10].d_trackcond = kcg_lit_int64(0);
    outC->_L1.trackConditions.trackCondition[idx10].m_trackcond =
      M_TRACKCOND_Non_stopping_area_Initial_state_is_stopping_permitted;
  }
  for (idx11 = 0; idx11 < 325; idx11++) {
    outC->Output1[idx11] = kcg_lit_int64(0);
  }
  /* _L11=(Utilities::Bool_to_Int#1)/ */
