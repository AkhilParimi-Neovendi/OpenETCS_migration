  ...
  outC_ComputeDistDisplay *outC)
{
  ...
  static kcg_float64 ObjectScreenYPosition_partial;
  /* ObjectScreenYPosition/ */
  static kcg_float64 _1_ObjectScreenYPosition_partial;
  /* ObjectScreenYPosition/ */
  static kcg_float64 _2_ObjectScreenYPosition_partial;
  /* ObjectScreenYPosition/ */
  static kcg_float64 _3_ObjectScreenYPosition_partial;
  /* ObjectScreenYPosition/ */
  static kcg_float64 _4_ObjectScreenYPosition_partial;
  /* ObjectScreenYPosition/ */
  static kcg_float64 _5_ObjectScreenYPosition_partial;
  ...
  outC->_L5 = Zoomlevel;
  kcg_copy_array_float64_6(&outC->_L3, (array_float64_6 *) &LinearScaleFactors);
  ...
  if (outC->IfBlock1_clock) {
    ...
    outC->else_clock_IfBlock1 = outC->l_objectDistance < kcg_lit_float64(0.0);
    /* IfBlock1:else: */
    if (outC->else_clock_IfBlock1) {
      ...
      if (outC->else_clock_else_IfBlock1) {
        outC->_L1_then_else_else_IfBlock1 = kcg_lit_float64(262.0);
        ...
        outC->_L9_else_else_else_IfBlock1 =
          ...
          LogR64_mathext_mathextimpl(outC->_L13_else_else_else_IfBlock1);
        ...
        outC->_L2_else_else_else_IfBlock1 =
          ...
          LogR64_mathext_mathextimpl(outC->_L1_else_else_else_IfBlock1);
...
void ComputeDistDisplay_init(outC_ComputeDistDisplay *outC)
{
  ...
  outC->l_objectDistance = kcg_lit_float64(0.0);
  ...
  outC->_L13_else_else_else_IfBlock1 = kcg_lit_float64(0.0);
  ...
  outC->ObjectScreenYPosition = kcg_lit_float64(0.0);
}
