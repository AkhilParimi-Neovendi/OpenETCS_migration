...
void kcg_save_SV_Procedure_Start_L1_L2_L3_Procedures(
  SV_Procedure_Start_L1_L2_L3_Procedures *SV,
  outC_Procedure_Start_L1_L2_L3_Procedures *outC)
{
  SV->Context_SM_Start_L1_L2_L3_reset_nxt = outC->SM_Start_L1_L2_L3_reset_nxt;
  SV->Context_SM_Start_L1_L2_L3_reset_act = outC->SM_Start_L1_L2_L3_reset_act;
  SV->Context_SM_Start_L1_L2_L3_state_nxt = outC->SM_Start_L1_L2_L3_state_nxt;
}

void kcg_load_SV_Procedure_Start_L1_L2_L3_Procedures(
  outC_Procedure_Start_L1_L2_L3_Procedures *outC,
  SV_Procedure_Start_L1_L2_L3_Procedures *SV)
{
  outC->SM_Start_L1_L2_L3_reset_nxt = SV->Context_SM_Start_L1_L2_L3_reset_nxt;
  outC->SM_Start_L1_L2_L3_reset_act = SV->Context_SM_Start_L1_L2_L3_reset_act;
  outC->SM_Start_L1_L2_L3_state_nxt = SV->Context_SM_Start_L1_L2_L3_state_nxt;
}
