...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  T_Mode_Level_Level_And_Mode_Types_Pkg /* inModeAndLevel/ */ Context_mem_inModeAndLevel;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_isSendingNeeded_manage_DMI_Output_Pkg Context_isSendingNeeded_1;
} SV_cyclicReportToDMI_manage_DMI_Output_Pkg;

extern void kcg_save_SV_cyclicReportToDMI_manage_DMI_Output_Pkg(
  SV_cyclicReportToDMI_manage_DMI_Output_Pkg *SV,
  outC_cyclicReportToDMI_manage_DMI_Output_Pkg *outC);
extern void kcg_load_SV_cyclicReportToDMI_manage_DMI_Output_Pkg(
  outC_cyclicReportToDMI_manage_DMI_Output_Pkg *outC,
  SV_cyclicReportToDMI_manage_DMI_Output_Pkg *SV);
