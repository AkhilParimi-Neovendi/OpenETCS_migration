  ...
  outC_C_int_to_DMI_Driver_Identifier_DATA_Packets_Bothways *outC)
{
  kcg_copy_DMI_Driver_Identifier_int_array_T_DATA(
    &outC->_L9,
    dmi_driver_identifier_int);
  kcg_copy_array_int64_9(&outC->_L21, (array_int64_9 *) &outC->_L9[2]);
...
void C_int_to_DMI_Driver_Identifier_init_DATA_Packets_Bothways(
  outC_C_int_to_DMI_Driver_Identifier_DATA_Packets_Bothways *outC)
{
  static kcg_size idx;
...
void C_int_to_DMI_Driver_Identifier_reset_DATA_Packets_Bothways(
  outC_C_int_to_DMI_Driver_Identifier_DATA_Packets_Bothways *outC)
{
  /* _L6=(DATA::Variables::CAST_int_to_DriverIdentfier#1)/ */
