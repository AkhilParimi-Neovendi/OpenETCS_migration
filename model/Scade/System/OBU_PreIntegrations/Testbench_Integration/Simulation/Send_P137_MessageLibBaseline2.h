...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_Write_P137_TM_trackside /* _L6=(TM_trackside::Write_P137#1)/ */ Context_Write_P137_1;
  /* ------------------ clocks of observable data -------------------- */
  kcg_bool every;
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  CompressedPackets_T_Common_Types_Pkg /* _L3/ */ _L3;
  P137_trackside_int_T_TM /* _L4/ */ _L4;
  kcg_bool /* _L8/ */ _L8;
  kcg_bool /* _L6/ */ _L6;
...
extern void Send_P137_init_MessageLibBaseline2(
  outC_Send_P137_MessageLibBaseline2 *outC);
