...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_signChanged_BasicLocationFunctions_Pkg Context_signChanged_2;
  SV_signChanged_BasicLocationFunctions_Pkg Context_signChanged_1;
  SV_RisingEdge_digital Context_RisingEdge_1;
} SV_locReachedOrPassed_BasicLocationFunctions_Pkg;

extern void kcg_save_SV_locReachedOrPassed_BasicLocationFunctions_Pkg(
  SV_locReachedOrPassed_BasicLocationFunctions_Pkg *SV,
  outC_locReachedOrPassed_BasicLocationFunctions_Pkg *outC);
extern void kcg_load_SV_locReachedOrPassed_BasicLocationFunctions_Pkg(
  outC_locReachedOrPassed_BasicLocationFunctions_Pkg *outC,
  SV_locReachedOrPassed_BasicLocationFunctions_Pkg *SV);
