  ...
  outC_NextGradients_DMI_Control_Pkg_Sub_func_PlanningArea *outC)
{
  ...
  kcg_copy_array_float64_32(&outC->_L54, inGradientsValue);
  kcg_copy_array_float64_32(&outC->_L53, inGradientsEnd);
  kcg_copy_array_float64_32(&outC->_L52, inGradientsStart);
  outC->_L13 = kcg_lit_int64(2);
  outC->_L2 = inTrainPosition;
  kcg_copy_array_float64_32(&outC->_L3, inGradientsStart);
  outC->_L7 = kcg_true;
  outC->_L51 = outC->_L2;
  /* _L6= */
  if (outC->_L7) {
  ...
  noname = outC->_L51;
  kcg_copy_array_float64_32(&outC->GradientsValueDMI, &outC->_L54);
  kcg_copy_array_float64_32(&outC->GradientsEndDMI, &outC->_L53);
  kcg_copy_array_float64_32(&outC->GradientsStartDMI, &outC->_L52);
  kcg_copy_array_float64_32(&outC->_L48, inGradientsValue);
  kcg_copy_array_float64_32(&outC->_L47, inGradientsEnd);
  outC->_L46 = outC->lGradientsFirstIndex;
  outC->_L45 = outC->lGradientsFirstIndex;
  outC->_L44 = outC->lGradientsFirstIndex;
  kcg_copy_array_float64_32(&outC->_L43, inGradientsStart);
  ...
  outC_NextGradients_DMI_Control_Pkg_Sub_func_PlanningArea *outC)
{
  ...
  for (idx1 = 0; idx1 < 32; idx1++) {
    outC->_L54[idx1] = kcg_lit_float64(0.0);
  }
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L53[idx2] = kcg_lit_float64(0.0);
  }
  for (idx3 = 0; idx3 < 32; idx3++) {
    outC->_L52[idx3] = kcg_lit_float64(0.0);
  }
  outC->_L12 = kcg_lit_int64(0);
  outC->_L13 = kcg_lit_int64(0);
  outC->_L51 = kcg_lit_float64(0.0);
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->_L48[idx4] = kcg_lit_float64(0.0);
  }
  for (idx5 = 0; idx5 < 32; idx5++) {
    outC->_L47[idx5] = kcg_lit_float64(0.0);
  }
  outC->_L46 = kcg_lit_int64(0);
  outC->_L45 = kcg_lit_int64(0);
  outC->_L44 = kcg_lit_int64(0);
  for (idx6 = 0; idx6 < 32; idx6++) {
    outC->_L43[idx6] = kcg_lit_float64(0.0);
  }
  outC->_L7 = kcg_true;
  outC->_L6 = kcg_lit_int64(0);
  for (idx7 = 0; idx7 < 32; idx7++) {
    outC->_L3[idx7] = kcg_lit_float64(0.0);
  }
  outC->_L2 = kcg_lit_float64(0.0);
  outC->lGradientsFirstIndex = kcg_lit_int64(0);
  for (idx8 = 0; idx8 < 32; idx8++) {
    outC->GradientsValueDMI[idx8] = kcg_lit_float64(0.0);
  }
  for (idx9 = 0; idx9 < 32; idx9++) {
    outC->GradientsEndDMI[idx9] = kcg_lit_float64(0.0);
  }
  for (idx10 = 0; idx10 < 32; idx10++) {
    outC->GradientsStartDMI[idx10] = kcg_lit_float64(0.0);
  }
  /* _=(DMI_Control_Pkg::Sub_func::PlanningArea::NextGradients_Start#1)/ */
