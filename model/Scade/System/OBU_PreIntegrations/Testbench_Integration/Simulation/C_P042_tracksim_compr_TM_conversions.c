...
void C_P042_tracksim_compr_TM_conversions(
  /* P042_from_track/ */
  P042_trackside_int_T_TM *P042_from_track,
  outC_C_P042_tracksim_compr_TM_conversions *outC)
{
  ...
  /* _L393=(TM_lib_internal::T_Build_Metadata_Packet_ID#1)/ */
  ...
  outC->_L393 = outC->Context_T_Build_Metadata_Packet_ID_1.nid_packet_meta;
  outC->_L388 = DIM_MaxElementsPacket042_TM;
  outC->_L336 = kcg_lit_int64(0);
  /* _L209/ */
  for (idx = 0; idx < 492; idx++) {
  ...
  kcg_copy_array_int64_8(&outC->_L383[0], &outC->_L373);
  kcg_copy_array_int64_492(&outC->_L383[8], &outC->_L209);
...
void C_P042_tracksim_compr_init_TM_conversions(
  outC_C_P042_tracksim_compr_TM_conversions *outC)
{
  static kcg_size idx;
  ...
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->P042_compressed[idx3] = kcg_lit_int64(0);
  }
...
void C_P042_tracksim_compr_reset_TM_conversions(
  outC_C_P042_tracksim_compr_TM_conversions *outC)
{
  /* _L393=(TM_lib_internal::T_Build_Metadata_Packet_ID#1)/ */
...
/*
  Expanded instances for: TM_conversions::C_P042_tracksim_compr/
