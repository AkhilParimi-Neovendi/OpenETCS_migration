...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_CaseLinkingInUse_CheckBGConsistency_Pkg Context_CaseLinkingInUse_2;
} SV_CheckBGConsistency_CheckBGConsistency_Pkg;

extern void kcg_save_SV_CheckBGConsistency_CheckBGConsistency_Pkg(
  SV_CheckBGConsistency_CheckBGConsistency_Pkg *SV,
  outC_CheckBGConsistency_CheckBGConsistency_Pkg *outC);
extern void kcg_load_SV_CheckBGConsistency_CheckBGConsistency_Pkg(
  outC_CheckBGConsistency_CheckBGConsistency_Pkg *outC,
  SV_CheckBGConsistency_CheckBGConsistency_Pkg *SV);
