...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P015_sections_array_flat_T_TM /* Flattened/ */ Flattened;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P015_fs_flatten_array_TM_lib_internal /* _L78=(TM_lib_internal::C_P015_fs_flatten_array#1)/ */ Context_C_P015_fs_flatten_array_1[128];
  outC_C_P015_fs_struct_to_array_TM_lib_internal /* _L74=(TM_lib_internal::C_P015_fs_struct_to_array#2)/ */ Context_C_P015_fs_struct_to_array_2[32];
  /* ----------------- no clocks of observable data ------------------ */
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  P015_sections_array_flat_T_TM /* _L76/ */ _L76;
...
extern void C_P015_flatten_sections_init_TM_lib_internal(
  outC_C_P015_flatten_sections_TM_lib_internal *outC);
