...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_Update_MA_TA_MA_new Context_Update_MA_1;
} SV_MA_L23_Postprocessing_TA_MA_new;

extern void kcg_save_SV_MA_L23_Postprocessing_TA_MA_new(
  SV_MA_L23_Postprocessing_TA_MA_new *SV,
  outC_MA_L23_Postprocessing_TA_MA_new *outC);
extern void kcg_load_SV_MA_L23_Postprocessing_TA_MA_new(
  outC_MA_L23_Postprocessing_TA_MA_new *outC,
  SV_MA_L23_Postprocessing_TA_MA_new *SV);
