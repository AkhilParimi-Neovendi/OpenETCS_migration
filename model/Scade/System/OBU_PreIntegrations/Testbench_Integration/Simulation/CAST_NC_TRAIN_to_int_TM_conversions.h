...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  kcg_int64 /* nc_train_int/ */ nc_train_int;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  NC_TRAIN /* nc_train_in/ */ nc_train_in;
  kcg_bool /* error/ */ error;
  NC_TRAIN /* _L4/ */ _L4;
  kcg_bool /* _L5/ */ _L5;
} outC_CAST_NC_TRAIN_to_int_TM_conversions;

/* ===========  node initialization and cycle functions  =========== */
/* TM_conversions::CAST_NC_TRAIN_to_int/ */
extern void CAST_NC_TRAIN_to_int_TM_conversions(
  /* nc_train/ */
  NC_TRAIN nc_train,
  outC_CAST_NC_TRAIN_to_int_TM_conversions *outC);

#ifndef KCG_NO_EXTERN_CALL_TO_RESET
extern void CAST_NC_TRAIN_to_int_reset_TM_conversions(
  outC_CAST_NC_TRAIN_to_int_TM_conversions *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CAST_NC_TRAIN_to_int_init_TM_conversions(
  outC_CAST_NC_TRAIN_to_int_TM_conversions *outC);
