...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  trainData_T_TIU_Types_Pkg /* trainData/ */ Context_trainData;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
} SV_trainDataStorage_trainData_pkg;

extern void kcg_save_SV_trainDataStorage_trainData_pkg(
  SV_trainDataStorage_trainData_pkg *SV,
  outC_trainDataStorage_trainData_pkg *outC);
extern void kcg_load_SV_trainDataStorage_trainData_pkg(
  outC_trainDataStorage_trainData_pkg *outC,
  SV_trainDataStorage_trainData_pkg *SV);
