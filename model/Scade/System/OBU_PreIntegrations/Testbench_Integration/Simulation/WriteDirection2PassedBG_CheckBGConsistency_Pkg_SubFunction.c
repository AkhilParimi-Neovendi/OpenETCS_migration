  ...
  outC_WriteDirection2PassedBG_CheckBGConsistency_Pkg_SubFunction *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L22.packets.PacketHeaders[idx].nid_packet = kcg_lit_int32(0);
    outC->_L22.packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L22.packets.PacketHeaders[idx].valid = kcg_true;
    outC->_L22.packets.PacketHeaders[idx].startAddress = kcg_lit_int32(0);
    outC->_L22.packets.PacketHeaders[idx].endAddress = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L22.packets.PacketData[idx1] = kcg_lit_int32(0);
  }
  ...
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L25.packets.PacketHeaders[idx4].nid_packet = kcg_lit_int32(0);
    outC->_L25.packets.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L25.packets.PacketHeaders[idx4].valid = kcg_true;
    outC->_L25.packets.PacketHeaders[idx4].startAddress = kcg_lit_int32(0);
    outC->_L25.packets.PacketHeaders[idx4].endAddress = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L25.packets.PacketData[idx5] = kcg_lit_int32(0);
  }
  ...
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L19.packets.PacketHeaders[idx6].nid_packet = kcg_lit_int32(0);
    outC->_L19.packets.PacketHeaders[idx6].q_dir = Q_DIR_Reverse;
    outC->_L19.packets.PacketHeaders[idx6].valid = kcg_true;
    outC->_L19.packets.PacketHeaders[idx6].startAddress = kcg_lit_int32(0);
    outC->_L19.packets.PacketHeaders[idx6].endAddress = kcg_lit_int32(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->_L19.packets.PacketData[idx7] = kcg_lit_int32(0);
  }
  ...
  for (idx8 = 0; idx8 < 30; idx8++) {
    outC->_L16.packets.PacketHeaders[idx8].nid_packet = kcg_lit_int32(0);
    outC->_L16.packets.PacketHeaders[idx8].q_dir = Q_DIR_Reverse;
    outC->_L16.packets.PacketHeaders[idx8].valid = kcg_true;
    outC->_L16.packets.PacketHeaders[idx8].startAddress = kcg_lit_int32(0);
    outC->_L16.packets.PacketHeaders[idx8].endAddress = kcg_lit_int32(0);
  }
  for (idx9 = 0; idx9 < 500; idx9++) {
    outC->_L16.packets.PacketData[idx9] = kcg_lit_int32(0);
  }
  ...
  for (idx10 = 0; idx10 < 30; idx10++) {
    outC->_L15.packets.PacketHeaders[idx10].nid_packet = kcg_lit_int32(0);
    outC->_L15.packets.PacketHeaders[idx10].q_dir = Q_DIR_Reverse;
    outC->_L15.packets.PacketHeaders[idx10].valid = kcg_true;
    outC->_L15.packets.PacketHeaders[idx10].startAddress = kcg_lit_int32(0);
    outC->_L15.packets.PacketHeaders[idx10].endAddress = kcg_lit_int32(0);
  }
  for (idx11 = 0; idx11 < 500; idx11++) {
    outC->_L15.packets.PacketData[idx11] = kcg_lit_int32(0);
  }
  ...
  for (idx14 = 0; idx14 < 30; idx14++) {
    outC->passedBG_out.packets.PacketHeaders[idx14].nid_packet = kcg_lit_int32(0);
    ...
    outC->passedBG_out.packets.PacketHeaders[idx14].startAddress = kcg_lit_int32(0);
    outC->passedBG_out.packets.PacketHeaders[idx14].endAddress = kcg_lit_int32(0);
  }
  for (idx15 = 0; idx15 < 500; idx15++) {
    outC->passedBG_out.packets.PacketData[idx15] = kcg_lit_int32(0);
  }
