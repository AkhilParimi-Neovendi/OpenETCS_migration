  ...
  outC_CAST_int_to_EVC_to_DMI_Messages *outC)
{
  ...
  kcg_copy_array_int32_3(&outC->_L57, (array_int32_3 *) &outC->_L55[25]);
  ...
  kcg_copy_array_int32_3(&outC->_L58, (array_int32_3 *) &outC->_L55[28]);
  ...
  kcg_copy_array_int32_9(&outC->_L59, (array_int32_9 *) &outC->_L55[31]);
  ...
  kcg_copy_array_int32_261(&outC->_L65, (array_int32_261 *) &outC->_L55[627]);
  ...
  kcg_copy_array_int32_3(&outC->_L66, (array_int32_3 *) &outC->_L55[888]);
  ...
  kcg_copy_array_int32_3(&outC->_L67, (array_int32_3 *) &outC->_L55[891]);
  ...
  kcg_copy_array_int32_3(&outC->_L69, (array_int32_3 *) &outC->_L55[961]);
  ...
  kcg_copy_array_int32_11(&outC->_L70, (array_int32_11 *) &outC->_L55[964]);
  ...
  kcg_copy_array_int32_3(&outC->_L71, (array_int32_3 *) &outC->_L55[975]);
  ...
  kcg_copy_array_int32_9(&outC->_L72, (array_int32_9 *) &outC->_L55[978]);
  ...
  kcg_copy_array_int32_3(&outC->_L73, (array_int32_3 *) &outC->_L55[987]);
  ...
  kcg_copy_array_int32_9(&outC->_L74, (array_int32_9 *) &outC->_L55[990]);
  ...
  outC_CAST_int_to_EVC_to_DMI_Messages *outC)
{
  ...
  for (idx = 0; idx < 9; idx++) {
    outC->_L74[idx] = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 3; idx1++) {
    outC->_L73[idx1] = kcg_lit_int32(0);
  }
  for (idx2 = 0; idx2 < 9; idx2++) {
    outC->_L72[idx2] = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 3; idx3++) {
    outC->_L71[idx3] = kcg_lit_int32(0);
  }
  for (idx4 = 0; idx4 < 11; idx4++) {
    outC->_L70[idx4] = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 3; idx5++) {
    outC->_L69[idx5] = kcg_lit_int32(0);
  }
  for (idx6 = 0; idx6 < 67; idx6++) {
    outC->_L68[idx6] = kcg_lit_int32(0);
  }
  for (idx7 = 0; idx7 < 3; idx7++) {
    outC->_L67[idx7] = kcg_lit_int32(0);
  }
  for (idx8 = 0; idx8 < 3; idx8++) {
    outC->_L66[idx8] = kcg_lit_int32(0);
  }
  for (idx9 = 0; idx9 < 261; idx9++) {
    outC->_L65[idx9] = kcg_lit_int32(0);
  }
  for (idx10 = 0; idx10 < 325; idx10++) {
    outC->_L64[idx10] = kcg_lit_int32(0);
  }
  for (idx11 = 0; idx11 < 262; idx11++) {
    outC->_L60[idx11] = kcg_lit_int32(0);
  }
  for (idx12 = 0; idx12 < 9; idx12++) {
    outC->_L59[idx12] = kcg_lit_int32(0);
  }
  for (idx13 = 0; idx13 < 3; idx13++) {
    outC->_L58[idx13] = kcg_lit_int32(0);
  }
  for (idx14 = 0; idx14 < 3; idx14++) {
    outC->_L57[idx14] = kcg_lit_int32(0);
  }
  for (idx15 = 0; idx15 < 24; idx15++) {
    outC->_L56[idx15] = kcg_lit_int32(0);
  }
  for (idx16 = 0; idx16 < 999; idx16++) {
    outC->_L55[idx16] = kcg_lit_int32(0);
  }
  ...
  outC->_L50.DMI_m_icon_flashing_freq = kcg_lit_float32(0.0);
  outC->_L50.DMI_nid_icon_group = level_symbol_DMI_Types_Pkg;
  outC->_L50.DMI_nid_icon_rank = kcg_lit_int32(0);
  outC->_L50.DMI_nid_area_group = A_DMI_Types_Pkg;
  outC->_L50.DMI_nid_area_rank = kcg_lit_int32(0);
  outC->_L50.DMI_nid_icon_identifier = kcg_lit_int32(0);
  ...
  outC->_L48.systemTime = kcg_lit_int32(0);
  outC->_L48.trainCategory =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L48.l_train = kcg_lit_int32(0);
  outC->_L48.m_brakeperct = kcg_lit_int32(0);
  outC->_L48.v_maxTrain = kcg_lit_int32(0);
  ...
  outC->_L42.EVC_Version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L42.l_name = kcg_lit_int32(0);
  for (idx19 = 0; idx19 < 255; idx19++) {
    outC->_L42.x_name[idx19] = ' ';
  }
  outC->_L42.l_extra = kcg_lit_int32(0);
  outC->_L41.valid = kcg_true;
  outC->_L41.system_clock = kcg_lit_int32(0);
  ...
  for (idx20 = 0; idx20 < 32; idx20++) {
    ...
    outC->_L41.speedProfiles.speedProfiles[idx20].Loc_Abs = kcg_lit_int32(0);
    outC->_L41.speedProfiles.speedProfiles[idx20].Loc_LRBG = kcg_lit_int32(0);
    outC->_L41.speedProfiles.speedProfiles[idx20].MRS = kcg_lit_int32(0);
  }
  ...
  for (idx21 = 0; idx21 < 32; idx21++) {
    ...
    outC->_L41.gradientProfiles.gradientProfiles[idx21].end_section =
      kcg_lit_int32(0);
    outC->_L41.gradientProfiles.gradientProfiles[idx21].gradient = kcg_lit_int32(0);
  }
  outC->_L41.trackConditions.nIter = kcg_lit_int32(0);
  for (idx22 = 0; idx22 < 32; idx22++) {
    outC->_L41.trackConditions.trackCondition[idx22].d_trackcond = kcg_lit_int32(0);
  ...
  outC->_L40.textMessage_ID = kcg_lit_int32(0);
  outC->_L40.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L40.l_text = kcg_lit_int32(0);
  ...
  outC->_L39.trainID.number = kcg_lit_int32(0);
  outC->_L39.trainID.dig1 = kcg_lit_int32(0);
  outC->_L39.trainID.dig2 = kcg_lit_int32(0);
  outC->_L39.trainID.dig3 = kcg_lit_int32(0);
  outC->_L39.trainID.dig4 = kcg_lit_int32(0);
  outC->_L39.trainID.dig5 = kcg_lit_int32(0);
  outC->_L39.trainLength.number = kcg_lit_int32(0);
  outC->_L39.trainLength.dig1 = kcg_lit_int32(0);
  outC->_L39.trainLength.dig2 = kcg_lit_int32(0);
  outC->_L39.trainLength.dig3 = kcg_lit_int32(0);
  outC->_L39.trainLength.dig4 = kcg_lit_int32(0);
  outC->_L39.brakeModel.number = kcg_lit_int32(0);
  outC->_L39.brakeModel.dig1 = kcg_lit_int32(0);
  outC->_L39.brakeModel.dig2 = kcg_lit_int32(0);
  outC->_L39.brakeModel.dig3 = kcg_lit_int32(0);
  outC->_L39.vmax.number = kcg_lit_int32(0);
  outC->_L39.vmax.dig1 = kcg_lit_int32(0);
  outC->_L39.vmax.dig2 = kcg_lit_int32(0);
  outC->_L39.vmax.dig3 = kcg_lit_int32(0);
  outC->_L39.mAxleLoad = M_AXLELOADCAT_A;
  outC->_L39.airTightSystem.number = kcg_lit_int32(0);
  outC->_L39.airTightSystem.dig1 = kcg_lit_int32(0);
  outC->_L39.airTightSystem.dig2 = kcg_lit_int32(0);
  outC->_L39.airTightSystem.dig3 = kcg_lit_int32(0);
  outC->_L39.mLoadingGauge.number = kcg_lit_int32(0);
  outC->_L39.mLoadingGauge.dig1 = kcg_lit_int32(0);
  outC->_L39.mLoadingGauge.dig2 = kcg_lit_int32(0);
  outC->_L39.mLoadingGauge.dig3 = kcg_lit_int32(0);
  ...
  outC->_L37.system_clock = kcg_lit_int32(0);
  ...
  outC->_L36.system_clock = kcg_lit_int32(0);
  outC->_L36.v_train = kcg_lit_int32(0);
  outC->_L36.location_front_train = kcg_lit_int32(0);
  outC->_L36.location_brake_target = kcg_lit_int32(0);
  outC->_L36.v_target = kcg_lit_int32(0);
  outC->_L36.v_permitted = kcg_lit_int32(0);
  outC->_L36.v_release = kcg_lit_int32(0);
  outC->_L36.location_brake_curve_starting_point = kcg_lit_int32(0);
  outC->_L36.v_intervention = kcg_lit_int32(0);
  outC->_L36.mode = M_MODE_Full_Supervision;
  outC->_L36.level.level = M_LEVEL_Level_0;
  outC->_L36.level.nid_stm = kcg_lit_int32(0);
  outC->_L36.nid_c = kcg_lit_int32(0);
  outC->_L36.nid_c_valid = kcg_true;
  outC->_L36.m_warning = supDis_normal_DMI_Types_Pkg;
  outC->_L36.sup_status = CSM_DMI_Types_Pkg;
  outC->_L36.location_LOA = kcg_lit_int32(0);
  outC->_L36.v_LOA = kcg_lit_int32(0);
  outC->_L36.location_KP_Balise_Track = kcg_lit_int32(0);
  outC->_L36.distance_KP_Balise = kcg_lit_int32(0);
  outC->_L36.distance_to_TSA = kcg_lit_int32(0);
  outC->_L36.radioConnectionStatus = conn_unknown_API_RadioCommunication_Pkg;
  outC->_L36.distanceIndicationPoint = kcg_lit_int32(0);
  outC->_L29.present = kcg_true;
  outC->_L29.dynamic.valid = kcg_true;
  outC->_L29.dynamic.system_clock = kcg_lit_int32(0);
  outC->_L29.dynamic.v_train = kcg_lit_int32(0);
  outC->_L29.dynamic.location_front_train = kcg_lit_int32(0);
  outC->_L29.dynamic.location_brake_target = kcg_lit_int32(0);
  outC->_L29.dynamic.v_target = kcg_lit_int32(0);
  outC->_L29.dynamic.v_permitted = kcg_lit_int32(0);
  outC->_L29.dynamic.v_release = kcg_lit_int32(0);
  outC->_L29.dynamic.location_brake_curve_starting_point = kcg_lit_int32(0);
  outC->_L29.dynamic.v_intervention = kcg_lit_int32(0);
  outC->_L29.dynamic.mode = M_MODE_Full_Supervision;
  outC->_L29.dynamic.level.level = M_LEVEL_Level_0;
  outC->_L29.dynamic.level.nid_stm = kcg_lit_int32(0);
  outC->_L29.dynamic.nid_c = kcg_lit_int32(0);
  ...
  outC->_L29.dynamic.location_LOA = kcg_lit_int32(0);
  outC->_L29.dynamic.v_LOA = kcg_lit_int32(0);
  outC->_L29.dynamic.location_KP_Balise_Track = kcg_lit_int32(0);
  outC->_L29.dynamic.distance_KP_Balise = kcg_lit_int32(0);
  outC->_L29.dynamic.distance_to_TSA = kcg_lit_int32(0);
  outC->_L29.dynamic.radioConnectionStatus =
    conn_unknown_API_RadioCommunication_Pkg;
  outC->_L29.dynamic.distanceIndicationPoint = kcg_lit_int32(0);
  outC->_L29.menu_request.valid = kcg_true;
  outC->_L29.menu_request.system_clock = kcg_lit_int32(0);
  ...
  outC->_L29.entry_request.system_clock = kcg_lit_int32(0);
  ...
  outC->_L29.evc_coded_train_data.system_clock = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.trainID.number = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.trainID.dig1 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.trainID.dig2 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.trainID.dig3 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.trainID.dig4 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.trainID.dig5 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.trainLength.number = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.trainLength.dig1 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.trainLength.dig2 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.trainLength.dig3 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.trainLength.dig4 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.brakeModel.number = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.brakeModel.dig1 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.brakeModel.dig2 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.brakeModel.dig3 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.vmax.number = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.vmax.dig1 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.vmax.dig2 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.vmax.dig3 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.mAxleLoad = M_AXLELOADCAT_A;
  outC->_L29.evc_coded_train_data.airTightSystem.number = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.airTightSystem.dig1 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.airTightSystem.dig2 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.airTightSystem.dig3 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.mLoadingGauge.number = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.mLoadingGauge.dig1 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.mLoadingGauge.dig2 = kcg_lit_int32(0);
  outC->_L29.evc_coded_train_data.mLoadingGauge.dig3 = kcg_lit_int32(0);
  outC->_L29.textMessage.valid = kcg_true;
  outC->_L29.textMessage.system_clock = kcg_lit_int32(0);
  outC->_L29.textMessage.textMessage_ID = kcg_lit_int32(0);
  outC->_L29.textMessage.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L29.textMessage.l_text = kcg_lit_int32(0);
  ...
  outC->_L29.trackDescription.system_clock = kcg_lit_int32(0);
  ...
  outC->_L29.trackDescription.trackConditions.nIter = kcg_lit_int32(0);
  ...
  outC->_L29.identifierRequest.system_clock = kcg_lit_int32(0);
  outC->_L29.identifierRequest.ERTMS_Version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L29.identifierRequest.EVC_Version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L29.identifierRequest.l_name = kcg_lit_int32(0);
  for (idx28 = 0; idx28 < 255; idx28++) {
    outC->_L29.identifierRequest.x_name[idx28] = ' ';
  }
  outC->_L29.identifierRequest.l_extra = kcg_lit_int32(0);
  outC->_L29.systemVersion.valid = kcg_true;
  outC->_L29.systemVersion.system_clock = kcg_lit_int32(0);
  ...
  outC->_L29.displayControl.system_clock = kcg_lit_int32(0);
  outC->_L29.EVC_levelData.valid = kcg_true;
  outC->_L29.EVC_levelData.system_clock = kcg_lit_int32(0);
  outC->_L29.EVC_levelData.levelList.number = kcg_lit_int32(0);
  for (idx29 = 0; idx29 < 32; idx29++) {
    outC->_L29.EVC_levelData.levelList.levelList[idx29].level = M_LEVEL_Level_0;
    outC->_L29.EVC_levelData.levelList.levelList[idx29].nid_stm = kcg_lit_int32(0);
  }
  outC->_L29.EVC_radioNetData.valid = kcg_true;
  outC->_L29.EVC_radioNetData.system_clock = kcg_lit_int32(0);
  outC->_L29.EVC_radioNetData.nid_mn = kcg_lit_int32(0);
  ...
  outC->_L29.iconRequest.system_clock = kcg_lit_int32(0);
  outC->_L29.iconRequest.DMI_m_icon_control_flag =
    show_icon_in_area_DMI_Types_Pkg;
  outC->_L29.iconRequest.DMI_m_icon_flashing_freq = kcg_lit_float32(0.0);
  outC->_L29.iconRequest.DMI_nid_icon_group = level_symbol_DMI_Types_Pkg;
  outC->_L29.iconRequest.DMI_nid_icon_rank = kcg_lit_int32(0);
  outC->_L29.iconRequest.DMI_nid_area_group = A_DMI_Types_Pkg;
  outC->_L29.iconRequest.DMI_nid_area_rank = kcg_lit_int32(0);
  outC->_L29.iconRequest.DMI_nid_icon_identifier = kcg_lit_int32(0);
