  ...
  outC_CalcBrakeCmd_SDM_Commands_Pkg *outC)
{
  ...
  outC->_L15.T_traction_cut_off = kcg_lit_int64(0);
  outC->_L15.offsetAntennaL1 = kcg_lit_int64(0);
  outC->_L15.T_b_limit = kcg_lit_int64(0);
  ...
  outC->_L8.d_validnv = kcg_lit_int64(0);
  for (idx = 0; idx < 7; idx++) {
    outC->_L8.nid_cArray[idx].valid = kcg_true;
    outC->_L8.nid_cArray[idx].nid_c = kcg_lit_int64(0);
  }
  outC->_L8.v_nvshunt = kcg_lit_int64(0);
  outC->_L8.v_nvstff = kcg_lit_int64(0);
  outC->_L8.v_nvonsight = kcg_lit_int64(0);
  outC->_L8.v_nvlimsuperv = kcg_lit_int64(0);
  outC->_L8.v_nvunfit = kcg_lit_int64(0);
  outC->_L8.v_nvrel = kcg_lit_int64(0);
  outC->_L8.d_nvroll = kcg_lit_int64(0);
  ...
  outC->_L8.v_nvallowovtrp = kcg_lit_int64(0);
  outC->_L8.v_nvsupovtrp = kcg_lit_int64(0);
  outC->_L8.d_nvovtrp = kcg_lit_int64(0);
  outC->_L8.t_nvovtrp = kcg_lit_int64(0);
  outC->_L8.d_nvpotrp = kcg_lit_int64(0);
  outC->_L8.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->_L8.t_nvcontact = kcg_lit_int64(0);
  outC->_L8.m_nvderun = M_NVDERUN_No;
  outC->_L8.d_nvstff = kcg_lit_int64(0);
  outC->_L8.q_nvdriver_adhes = Q_NVDRIVER_ADHES_Not_allowed;
  outC->_L8.a_nvmaxredadh1 = kcg_lit_float64(0.0);
  outC->_L8.a_nvmaxredadh2 = kcg_lit_float64(0.0);
  outC->_L8.a_nvmaxredadh3 = kcg_lit_float64(0.0);
  outC->_L8.q_nvlocacc = kcg_lit_int64(0);
  outC->_L8.m_nvavadh = kcg_lit_float64(0.0);
  ...
  for (idx2 = 0; idx2 < 7; idx2++) {
    ...
    outC->_L8.nvkvintsetArray[idx2].a_nvp12 = kcg_lit_float64(0.0);
    outC->_L8.nvkvintsetArray[idx2].a_nvp23 = kcg_lit_float64(0.0);
    for (idx1 = 0; idx1 < 7; idx1++) {
      outC->_L8.nvkvintsetArray[idx2].nvkintArray[idx1].valid = kcg_true;
      outC->_L8.nvkvintsetArray[idx2].nvkintArray[idx1].v_nvkvint = kcg_lit_int64(0);
  ...
  for (idx3 = 0; idx3 < 7; idx3++) {
    ...
    outC->_L8.nvkrintArray[idx3].m_nvkrint = kcg_lit_float64(0.0);
  }
  outC->_L8.m_nvktint = kcg_lit_float64(0.0);
...
void kcg_save_SV_CalcBrakeCmd_SDM_Commands_Pkg(
  SV_CalcBrakeCmd_SDM_Commands_Pkg *SV,
  outC_CalcBrakeCmd_SDM_Commands_Pkg *outC)
{
  SV->Context_trigSB = outC->trigSB;
  SV->Context_trigEB = outC->trigEB;
}

void kcg_load_SV_CalcBrakeCmd_SDM_Commands_Pkg(
  outC_CalcBrakeCmd_SDM_Commands_Pkg *outC,
  SV_CalcBrakeCmd_SDM_Commands_Pkg *SV)
{
  outC->trigSB = SV->Context_trigSB;
  outC->trigEB = SV->Context_trigEB;
}
