...
void kcg_save_SV_probe_MsgOut_RadioSupport_Pkg(
  SV_probe_MsgOut_RadioSupport_Pkg *SV,
  outC_probe_MsgOut_RadioSupport_Pkg *outC)
{
  SV->Context_lastTTrain = outC->lastTTrain;
  SV->Context_lastMSG = outC->lastMSG;
}

void kcg_load_SV_probe_MsgOut_RadioSupport_Pkg(
  outC_probe_MsgOut_RadioSupport_Pkg *outC,
  SV_probe_MsgOut_RadioSupport_Pkg *SV)
{
  outC->lastTTrain = SV->Context_lastTTrain;
  outC->lastMSG = SV->Context_lastMSG;
}
