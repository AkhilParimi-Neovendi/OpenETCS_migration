...
typedef struct {
  ...
  outC_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_Bijlmer_RBC_Scenario_Pkg /* _L35=(RBC_Scenario_Pkg::UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_Bijlmer#1)/ */ Context_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_Bijlmer_1;
...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_Amstel_RBC_Scenario_Pkg Context_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_Amstel_1;
  SV_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_Bijlmer_RBC_Scenario_Pkg Context_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_Bijlmer_1;
  SV_Triggers_Sheet07_RBC_Scenario_Pkg Context_Triggers_Sheet07_1;
  SV_Triggers_Sheet08A_RBC_Scenario_Pkg Context_Triggers_Sheet08A_1;
  SV_Triggers_Sheet08B_RBC_Scenario_Pkg Context_Triggers_Sheet08B_2;
  SV_Triggers_Sheet09_RBC_Scenario_Pkg Context_Triggers_Sheet09_1;
  SV_Triggers_Sheet11_RBC_Scenario_Pkg Context_Triggers_Sheet11_1;
  SV_Triggers_Sheet12_RBC_Scenario_Pkg Context_Triggers_Sheet12_1;
  SV_Triggers_Sheet13_RBC_Scenario_Pkg Context_Triggers_Sheet13_1;
  SV_Triggers_Sheet14_RBC_Scenario_Pkg Context_Triggers_Sheet14_1;
  SV_Triggers_UserStory13_RBC_Scenario_Pkg Context_Triggers_UserStory13_1;
} SV_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_RBC_Scenario_Pkg;

extern void kcg_save_SV_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_RBC_Scenario_Pkg(
  SV_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_RBC_Scenario_Pkg *SV,
  outC_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_RBC_Scenario_Pkg *outC);
extern void kcg_load_SV_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_RBC_Scenario_Pkg(
  outC_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_RBC_Scenario_Pkg *outC,
  SV_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_RBC_Scenario_Pkg *SV);
