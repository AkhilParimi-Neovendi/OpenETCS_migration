  ...
  outC_SSP_Postprocessing_TA_SSP_new *outC)
{
  ...
  for (idx = 0; idx < 50; idx++) {
    ...
    outC->_L8[idx].d_static_abs = kcg_lit_int32(0);
    outC->_L8[idx].d_static_LRBG = kcg_lit_int32(0);
    outC->_L8[idx].q_train_length_corr = kcg_true;
    outC->_L8[idx].v_static = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 50; idx1++) {
    outC->_L1[idx1].valid = kcg_true;
    outC->_L1[idx1].d_static_abs = kcg_lit_int32(0);
    outC->_L1[idx1].d_static_LRBG = kcg_lit_int32(0);
    outC->_L1[idx1].q_train_length_corr = kcg_true;
    outC->_L1[idx1].v_static = kcg_lit_int32(0);
  }
  outC->_L3 = kcg_true;
  ...
  for (idx3 = 0; idx3 < 50; idx3++) {
    ...
    outC->_L4[idx3].d_static_abs = kcg_lit_int32(0);
    outC->_L4[idx3].d_static_LRBG = kcg_lit_int32(0);
    outC->_L4[idx3].q_train_length_corr = kcg_true;
    outC->_L4[idx3].v_static = kcg_lit_int32(0);
  }
  outC->init = kcg_true;
...
void kcg_save_SV_SSP_Postprocessing_TA_SSP_new(
  SV_SSP_Postprocessing_TA_SSP_new *SV,
  outC_SSP_Postprocessing_TA_SSP_new *outC)
{
  kcg_copy_StaticSpeedProfile_t_TrackAtlasTypes(&SV->Context__L4, &outC->_L4);
  SV->Context_init = outC->init;
}

void kcg_load_SV_SSP_Postprocessing_TA_SSP_new(
  outC_SSP_Postprocessing_TA_SSP_new *outC,
  SV_SSP_Postprocessing_TA_SSP_new *SV)
{
  kcg_copy_StaticSpeedProfile_t_TrackAtlasTypes(&outC->_L4, &SV->Context__L4);
