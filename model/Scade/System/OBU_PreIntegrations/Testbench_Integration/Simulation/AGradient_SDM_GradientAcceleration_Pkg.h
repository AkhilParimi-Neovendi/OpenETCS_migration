...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  A_gradient_t_SDM_GradientAcceleration_types /* _L1/ */ Context__L1;
  kcg_bool Context_init;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
} SV_AGradient_SDM_GradientAcceleration_Pkg;

extern void kcg_save_SV_AGradient_SDM_GradientAcceleration_Pkg(
  SV_AGradient_SDM_GradientAcceleration_Pkg *SV,
  outC_AGradient_SDM_GradientAcceleration_Pkg *outC);
extern void kcg_load_SV_AGradient_SDM_GradientAcceleration_Pkg(
  outC_AGradient_SDM_GradientAcceleration_Pkg *outC,
  SV_AGradient_SDM_GradientAcceleration_Pkg *SV);
