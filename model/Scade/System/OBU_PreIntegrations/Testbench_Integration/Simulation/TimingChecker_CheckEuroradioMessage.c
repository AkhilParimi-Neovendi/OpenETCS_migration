  ...
  outC_TimingChecker_CheckEuroradioMessage *outC)
{
  ...
  /* sequenceError/ */
  static kcg_bool sequenceError_partial;
  /* otherTimingError/ */
  static kcg_bool otherTimingError_partial;
  /* lastKnownTTrain/ */
  static T_TRAIN lastKnownTTrain_partial;
  /* ignoreTimestamp/ */
  static kcg_bool ignoreTimestamp_partial;
  /* tNvContactError/ */
  static kcg_bool _1_tNvContactError_partial;
  /* sequenceError/ */
  static kcg_bool _2_sequenceError_partial;
  /* otherTimingError/ */
  static kcg_bool _3_otherTimingError_partial;
  /* lastKnownTTrain/ */
  static T_TRAIN _4_lastKnownTTrain_partial;
  /* ignoreTimestamp/ */
  static kcg_bool _5_ignoreTimestamp_partial;
  /* tNvContactError/ */
  static kcg_bool _6_tNvContactError_partial;
  /* sequenceError/ */
  static kcg_bool _7_sequenceError_partial;
  /* otherTimingError/ */
  static kcg_bool _8_otherTimingError_partial;
  /* lastKnownTTrain/ */
  static T_TRAIN _9_lastKnownTTrain_partial;
  /* ignoreTimestamp/ */
  static kcg_bool _10_ignoreTimestamp_partial;
  /* tNvContactError/ */
  static kcg_bool _11_tNvContactError_partial;
  /* sequenceError/ */
  static kcg_bool _12_sequenceError_partial;
  /* otherTimingError/ */
  static kcg_bool _13_otherTimingError_partial;
  /* lastKnownTTrain/ */
  static T_TRAIN _14_lastKnownTTrain_partial;
  /* ignoreTimestamp/ */
  static kcg_bool _15_ignoreTimestamp_partial;
  /* ignoreTimestamp/ */
  static kcg_bool _16_ignoreTimestamp_partial;
  /* lastKnownTTrain/ */
  static T_TRAIN _17_lastKnownTTrain_partial;
  /* otherTimingError/ */
  static kcg_bool _18_otherTimingError_partial;
  /* sequenceError/ */
  static kcg_bool _19_sequenceError_partial;
  /* tNvContactError/ */
  static kcg_bool _20_tNvContactError_partial;
  /* tNvContactError/ */
  static kcg_bool _21_tNvContactError_partial;
  /* sequenceError/ */
  static kcg_bool _22_sequenceError_partial;
  /* otherTimingError/ */
  static kcg_bool _23_otherTimingError_partial;
  /* lastKnownTTrain/ */
  static T_TRAIN _24_lastKnownTTrain_partial;
  /* ignoreTimestamp/ */
  static kcg_bool _25_ignoreTimestamp_partial;
  /* tNvContactError/ */
  static kcg_bool _26_tNvContactError_partial;
  /* sequenceError/ */
  static kcg_bool _27_sequenceError_partial;
  /* otherTimingError/ */
  static kcg_bool _28_otherTimingError_partial;
  /* lastKnownTTrain/ */
  static T_TRAIN _29_lastKnownTTrain_partial;
  /* ignoreTimestamp/ */
  static kcg_bool _30_ignoreTimestamp_partial;
  /* ignoreTimestamp/ */
  static kcg_bool _31_ignoreTimestamp_partial;
  /* lastKnownTTrain/ */
  static T_TRAIN _32_lastKnownTTrain_partial;
  /* otherTimingError/ */
  static kcg_bool _33_otherTimingError_partial;
  /* sequenceError/ */
  static kcg_bool _34_sequenceError_partial;
  /* tNvContactError/ */
  static kcg_bool _35_tNvContactError_partial;
  /* ignoreTimestamp/ */
  ...
  if (outC->IfBlock1_clock) {
    outC->_L41_then_IfBlock1 = kcg_lit_int64(256000);
    ...
    outC->_L36_then_IfBlock1 = kcg_lit_int64(256000);
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      if (outC->IfBlock2_clock_then_else_IfBlock1) {
        ...
        outC->_L3_then_IfBlock2_then_else_IfBlock1 = kcg_lit_int64(0);
      ...
      if (outC->IfBlock2_clock_else_else_IfBlock1) {
        ...
        outC->_L3_then_IfBlock2_else_else_IfBlock1 = kcg_lit_int64(0);
  ...
  outC_TimingChecker_CheckEuroradioMessage *outC)
{
  ...
  outC->_L30.BG_Common_Header.m_mcount = kcg_lit_int64(0);
  outC->_L30.BG_Common_Header.nid_c = kcg_lit_int64(0);
  outC->_L30.BG_Common_Header.nid_bg = kcg_lit_int64(0);
  outC->_L30.BG_Common_Header.q_link = Q_LINK_Unlinked;
  outC->_L30.BG_Common_Header.bgPosition.valid = kcg_true;
  outC->_L30.BG_Common_Header.bgPosition.timestamp = kcg_lit_int64(0);
  outC->_L30.BG_Common_Header.bgPosition.odo.o_nominal = kcg_lit_int64(0);
  outC->_L30.BG_Common_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->_L30.BG_Common_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
  outC->_L30.BG_Common_Header.bgPosition.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L30.BG_Common_Header.bgPosition.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L30.BG_Common_Header.bgPosition.speed.v_lower = kcg_lit_int64(0);
  outC->_L30.BG_Common_Header.bgPosition.speed.v_upper = kcg_lit_int64(0);
  outC->_L30.BG_Common_Header.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->_L30.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L30.BG_Common_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  outC->_L30.Radio_Common_Header.radioDevice = kcg_lit_int64(0);
  outC->_L30.Radio_Common_Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L30.Radio_Common_Header.nid_message = kcg_lit_int64(0);
  outC->_L30.Radio_Common_Header.t_train = kcg_lit_int64(0);
  outC->_L30.Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_required;
  outC->_L30.Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L30.Radio_Common_Header.t_train_reference = kcg_lit_int64(0);
  outC->_L30.Radio_Common_Header.nid_em = kcg_lit_int64(0);
  outC->_L30.Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L30.Radio_Common_Header.d_sr = kcg_lit_int64(0);
  outC->_L30.Radio_Common_Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L30.Radio_Common_Header.d_ref = kcg_lit_int64(0);
  outC->_L30.Radio_Common_Header.q_dir = Q_DIR_Reverse;
  outC->_L30.Radio_Common_Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L30.Radio_Common_Header.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  for (idx = 0; idx < 30; idx++) {
    outC->_L30.packets.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L30.packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L30.packets.PacketHeaders[idx].valid = kcg_true;
    outC->_L30.packets.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L30.packets.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L30.packets.PacketData[idx1] = kcg_lit_int64(0);
  }
  outC->_L30.sendingRBC.valid = kcg_true;
  outC->_L30.sendingRBC.nid_c = kcg_lit_int64(0);
  outC->_L30.sendingRBC.rbc_id = kcg_lit_int64(0);
  outC->_L30.sendingRBC.device_id = kcg_lit_int64(0);
  outC->TimestampKnown = kcg_true;
  outC->IfBlock1_clock = kcg_true;
  outC->_L9_then_else_IfBlock1.valid = kcg_true;
  outC->_L9_then_else_IfBlock1.mobileDeviceNo = kcg_lit_int64(0);
  ...
  outC->_L8_then_else_IfBlock1.registration.mobileDeviceNo = kcg_lit_int64(0);
  ...
  outC->_L8_then_else_IfBlock1.registration.nid_mn = kcg_lit_int64(0);
  outC->_L8_then_else_IfBlock1.connection.valid = kcg_true;
  outC->_L8_then_else_IfBlock1.connection.mobileDeviceNo = kcg_lit_int64(0);
  ...
  outC->_L8_then_else_IfBlock1.session.nid_c = kcg_lit_int64(0);
  outC->_L8_then_else_IfBlock1.session.nid_rbc = kcg_lit_int64(0);
  ...
  outC->_L6_else_else_IfBlock1.mobileDeviceNo = kcg_lit_int64(0);
  ...
  outC->_L1_else_else_IfBlock1.registration.mobileDeviceNo = kcg_lit_int64(0);
  ...
  outC->_L1_else_else_IfBlock1.registration.status =
    mrs_unregistered_RCM_Types_Pkg;
  outC->_L1_else_else_IfBlock1.registration.nid_mn = kcg_lit_int64(0);
  outC->_L1_else_else_IfBlock1.connection.valid = kcg_true;
  outC->_L1_else_else_IfBlock1.connection.mobileDeviceNo = kcg_lit_int64(0);
  ...
  outC->_L1_else_else_IfBlock1.session.phase =
    sp_terminated_RCM_Session_Types_Pkg;
  outC->_L1_else_else_IfBlock1.session.nid_c = kcg_lit_int64(0);
  outC->_L1_else_else_IfBlock1.session.nid_rbc = kcg_lit_int64(0);
  ...
  outC->_L10_then_IfBlock1.BG_Common_Header.m_mcount = kcg_lit_int64(0);
  outC->_L10_then_IfBlock1.BG_Common_Header.nid_c = kcg_lit_int64(0);
  outC->_L10_then_IfBlock1.BG_Common_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L10_then_IfBlock1.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L10_then_IfBlock1.BG_Common_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  outC->_L10_then_IfBlock1.BG_Common_Header.trainRunningDirectionToBG =
    Q_DIRTRAIN_Reverse;
  outC->_L10_then_IfBlock1.Radio_Common_Header.radioDevice = kcg_lit_int64(0);
  outC->_L10_then_IfBlock1.Radio_Common_Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L10_then_IfBlock1.Radio_Common_Header.nid_message = kcg_lit_int64(0);
  outC->_L10_then_IfBlock1.Radio_Common_Header.t_train = kcg_lit_int64(0);
  outC->_L10_then_IfBlock1.Radio_Common_Header.m_ack =
    M_ACK_No_acknowledgement_required;
  outC->_L10_then_IfBlock1.Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L10_then_IfBlock1.Radio_Common_Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L10_then_IfBlock1.Radio_Common_Header.nid_em = kcg_lit_int64(0);
  outC->_L10_then_IfBlock1.Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L10_then_IfBlock1.Radio_Common_Header.d_sr = kcg_lit_int64(0);
  outC->_L10_then_IfBlock1.Radio_Common_Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L10_then_IfBlock1.Radio_Common_Header.d_ref = kcg_lit_int64(0);
  outC->_L10_then_IfBlock1.Radio_Common_Header.q_dir = Q_DIR_Reverse;
  outC->_L10_then_IfBlock1.Radio_Common_Header.d_emergencystop = kcg_lit_int64(0);
  ...
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L10_then_IfBlock1.packets.PacketData[idx3] = kcg_lit_int64(0);
  }
  outC->_L10_then_IfBlock1.sendingRBC.valid = kcg_true;
  outC->_L10_then_IfBlock1.sendingRBC.nid_c = kcg_lit_int64(0);
  outC->_L10_then_IfBlock1.sendingRBC.rbc_id = kcg_lit_int64(0);
  outC->_L10_then_IfBlock1.sendingRBC.device_id = kcg_lit_int64(0);
  ...
  outC->_L34_then_IfBlock1 = kcg_lit_int64(0);
  outC->_L35_then_IfBlock1 = kcg_true;
  outC->_L36_then_IfBlock1 = kcg_lit_int64(0);
  outC->_L37_then_IfBlock1 = kcg_true;
  outC->_L38_then_IfBlock1 = kcg_true;
  outC->_L39_then_IfBlock1 = kcg_true;
  outC->_L40_then_IfBlock1 = kcg_lit_int64(0);
  outC->_L41_then_IfBlock1 = kcg_lit_int64(0);
...
void kcg_save_SV_TimingChecker_CheckEuroradioMessage(
  SV_TimingChecker_CheckEuroradioMessage *SV,
  outC_TimingChecker_CheckEuroradioMessage *outC)
{
  SV->Context_ignoreTimestamp = outC->ignoreTimestamp;
  SV->Context_lastKnownTTrain = outC->lastKnownTTrain;
}

void kcg_load_SV_TimingChecker_CheckEuroradioMessage(
  outC_TimingChecker_CheckEuroradioMessage *outC,
  SV_TimingChecker_CheckEuroradioMessage *SV)
{
  outC->ignoreTimestamp = SV->Context_ignoreTimestamp;
  outC->lastKnownTTrain = SV->Context_lastKnownTTrain;
}
