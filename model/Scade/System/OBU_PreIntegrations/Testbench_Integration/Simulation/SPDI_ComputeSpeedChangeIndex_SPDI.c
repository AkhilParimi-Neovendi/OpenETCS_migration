...
{
  /* SpeedChangeIndex/ */
  static kcg_int64 SpeedChangeIndex_partial;
  /* SpeedChangeIndex/ */
  static kcg_int64 _1_SpeedChangeIndex_partial;
  /* SpeedChangeIndex/ */
  static kcg_int64 _2_SpeedChangeIndex_partial;
  /* SpeedChangeIndex/ */
  static kcg_int64 _3_SpeedChangeIndex_partial;
  ...
  outC->IfBlock1_clock = (Speed == kcg_lit_float64(0.0)) | (Speed <
      kcg_lit_float64(0.0)) | (Speed == kcg_lit_float64(635.0)) | (Speed >
      kcg_lit_float64(635.0));
  /* IfBlock1: */
  if (outC->IfBlock1_clock) {
    outC->_L1_then_IfBlock1 = kcg_lit_int64(3);
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      outC->_L1_else_else_IfBlock1 = kcg_lit_int64(1);
  ...
  outC_SPDI_ComputeSpeedChangeIndex_SPDI *outC)
{
  ...
  outC->SpeedChangeIndex = kcg_lit_int64(0);
  outC->Acc_EndOfLogPart_Out = kcg_lit_float64(0.0);
  outC->Acc_Speed_Out = kcg_lit_float64(0.0);
}
