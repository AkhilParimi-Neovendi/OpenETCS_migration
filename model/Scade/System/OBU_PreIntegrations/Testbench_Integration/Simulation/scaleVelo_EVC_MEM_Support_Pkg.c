...
{
  outC->_L18 = kcg_lit_int64(36);
  outC->_L16 = kcg_lit_int64(1000);
  outC->_L14 = kcg_lit_int64(5);
  outC->_L12 = v_track;
  ...
  outC_scaleVelo_EVC_MEM_Support_Pkg *outC)
{
  ...
  outC->_L2.n_iter_nid_c = kcg_lit_int64(0);
  for (idx = 0; idx < 32; idx++) {
    outC->_L2.nid_c_list[idx].valid = kcg_true;
    outC->_L2.nid_c_list[idx].nid_c = kcg_lit_int64(0);
  }
  ...
  outC->_L2.v_nvkvint = kcg_lit_int64(0);
  outC->_L2.m_nvkvint_12 = kcg_lit_float64(0.0);
  outC->_L2.m_nvkvint_23 = kcg_lit_float64(0.0);
  outC->_L2.n_iter_n = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 32; idx1++) {
    outC->_L2.n_iter_n_list[idx1].valid = kcg_true;
    outC->_L2.n_iter_n_list[idx1].v_nvkvint_n = kcg_lit_int64(0);
    outC->_L2.n_iter_n_list[idx1].m_nvkvint_n_12 = kcg_lit_float64(0.0);
    outC->_L2.n_iter_n_list[idx1].m_nvkvint_n_23 = kcg_lit_float64(0.0);
  }
  outC->_L2.n_iter_k = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 32; idx3++) {
    outC->_L2.n_iter_k_list[idx3].valid = kcg_true;
    outC->_L2.n_iter_k_list[idx3].q_nvkvintset_k = Q_NVKVINTSET_Freight_trains;
    outC->_L2.n_iter_k_list[idx3].a_nvp12_k = kcg_lit_float64(0.0);
    outC->_L2.n_iter_k_list[idx3].a_nvp23_k = kcg_lit_float64(0.0);
    outC->_L2.n_iter_k_list[idx3].v_nvkvint_k = kcg_lit_int64(0);
    outC->_L2.n_iter_k_list[idx3].m_nvkvint_k_12 = kcg_lit_float64(0.0);
    outC->_L2.n_iter_k_list[idx3].m_nvkvint_k_23 = kcg_lit_float64(0.0);
    outC->_L2.n_iter_k_list[idx3].n_iter_k_m = kcg_lit_int64(0);
  ...
  outC->_L2.m_nvkrint = kcg_lit_float64(0.0);
  outC->_L2.n_iter_l = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->_L2.n_iter_l_list[idx4].valid = kcg_true;
    outC->_L2.n_iter_l_list[idx4].l_nvkrint_l = L_NVKRINT_0m;
    outC->_L2.n_iter_l_list[idx4].m_nvkrint_l = kcg_lit_float64(0.0);
  }
  outC->_L2.m_nvktint = kcg_lit_float64(0.0);
  outC->_L1 = kcg_lit_int64(0);
  outC->v_evc = kcg_lit_int64(0);
}
