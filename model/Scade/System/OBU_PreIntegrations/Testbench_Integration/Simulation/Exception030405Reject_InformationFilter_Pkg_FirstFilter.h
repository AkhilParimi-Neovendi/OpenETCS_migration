...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_Exception03RejectIfPendingAckOfTrainData_InformationFilter_Pkg_FirstFilter /* _L1=(InformationFilter_Pkg::FirstFilter::Exception03RejectIfPendingAckOfTrainData#1)/ */ Context_Exception03RejectIfPendingAckOfTrainData_1;
  outC_Exception04RejectIfSPPAndGradientOnBoardOrMACoverNotFullLength_InformationFilter_Pkg_FirstFilter /* _L3=(InformationFilter_Pkg::FirstFilter::Exception04RejectIfSPPAndGradientOnBoardOrMACoverNotFullLength#1)/ */ Context_Exception04RejectIfSPPAndGradientOnBoardOrMACoverNotFullLength_1;
  outC_Exception05RejectIfEmergencyStopAccepted_InformationFilter_Pkg_FirstFilter /* _L5=(InformationFilter_Pkg::FirstFilter::Exception05RejectIfEmergencyStopAccepted#1)/ */ Context_Exception05RejectIfEmergencyStopAccepted_1;
