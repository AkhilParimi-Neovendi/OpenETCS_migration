  ...
  outC_CAST_int_to_DMI_gradientProfile_DATA_Variables *outC)
{
  ...
  kcg_copy_array_int64_32(&outC->_L20, (array_int64_32 *) &outC->_L15[97]);
  ...
  kcg_copy_array_int64_32(&outC->_L18, (array_int64_32 *) &outC->_L15[65]);
  kcg_copy_array_int64_32(&outC->_L17, (array_int64_32 *) &outC->_L15[33]);
  kcg_copy_array_int64_32(&outC->_L16, (array_int64_32 *) &outC->_L15[1]);
  /* _L13= */
  ...
  outC_CAST_int_to_DMI_gradientProfile_DATA_Variables *outC)
{
  ...
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L18[idx2] = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 32; idx3++) {
    outC->_L17[idx3] = kcg_lit_int64(0);
  }
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->_L16[idx4] = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 129; idx5++) {
    outC->_L15[idx5] = kcg_lit_int64(0);
  }
  outC->_L14 = kcg_lit_int64(0);
  for (idx6 = 0; idx6 < 32; idx6++) {
    outC->_L13[idx6].valid = kcg_true;
    outC->_L13[idx6].begin_section = kcg_lit_int64(0);
    outC->_L13[idx6].end_section = kcg_lit_int64(0);
    outC->_L13[idx6].gradient = kcg_lit_int64(0);
  }
  outC->_L12.profileChanged = kcg_true;
  for (idx7 = 0; idx7 < 32; idx7++) {
    outC->_L12.gradientProfiles[idx7].valid = kcg_true;
    outC->_L12.gradientProfiles[idx7].begin_section = kcg_lit_int64(0);
    outC->_L12.gradientProfiles[idx7].end_section = kcg_lit_int64(0);
    outC->_L12.gradientProfiles[idx7].gradient = kcg_lit_int64(0);
  }
  ...
  for (idx8 = 0; idx8 < 32; idx8++) {
    ...
    outC->dmi_gradientProfile.gradientProfiles[idx8].begin_section =
      kcg_lit_int64(0);
    outC->dmi_gradientProfile.gradientProfiles[idx8].end_section = kcg_lit_int64(0);
    outC->dmi_gradientProfile.gradientProfiles[idx8].gradient = kcg_lit_int64(0);
  }
  for (idx = 0; idx < 32; idx++) {
    /* _L13=(DATA::Variables::CAST_int_to_DMI_gradientProfileElement#1)/ */
