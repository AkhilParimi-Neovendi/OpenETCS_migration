  ...
  outC_DetermineValidFlags_InformationFilter_Pkg_SecondFilter *outC)
{
  ...
  outC->_L13.startAddress = kcg_lit_int64(0);
  outC->_L13.endAddress = kcg_lit_int64(0);
  ...
  outC->packet.nid_packet = kcg_lit_int64(0);
  outC->packet.q_dir = Q_DIR_Reverse;
  outC->packet.valid = kcg_true;
  outC->packet.startAddress = kcg_lit_int64(0);
  outC->packet.endAddress = kcg_lit_int64(0);
}
