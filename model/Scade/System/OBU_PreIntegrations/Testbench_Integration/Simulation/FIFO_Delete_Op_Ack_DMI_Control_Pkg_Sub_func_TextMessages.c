  ...
  outC_FIFO_Delete_Op_Ack_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  kcg_copy__80_array(&outC->_L7, queueIn);
  kcg_copy__15_array(&outC->_L8, (_15_array *) &outC->_L7[1]);
  kcg_copy__15_array(&outC->_L6[0], &outC->_L8);
  kcg_copy_MsgStructure(&outC->_L6[4], &outC->_L9[0]);
  kcg_copy__80_array(&outC->_L5, queueIn);
  outC->_L2 = DeletePos;
  /* _L3/ */
  for (idx = 0; idx < 5; idx++) {
  ...
  kcg_copy__80_array(&outC->Queue, &outC->_L1);
}
