  ...
  outC_FIFO_Delete_Op_Ack_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  kcg_copy__82_array(&outC->_L7, queueIn);
  kcg_copy__14_array(&outC->_L8, (_14_array *) &outC->_L7[1]);
  kcg_copy__14_array(&outC->_L6[0], &outC->_L8);
  kcg_copy_MsgStructure(&outC->_L6[4], &outC->_L9[0]);
  kcg_copy__82_array(&outC->_L5, queueIn);
  outC->_L2 = DeletePos;
  /* _L3/ */
  for (idx = 0; idx < 5; idx++) {
  ...
  kcg_copy__82_array(&outC->Queue, &outC->_L1);
}

#ifndef KCG_USER_DEFINED_INIT
void FIFO_Delete_Op_Ack_init_DMI_Control_Pkg_Sub_func_TextMessages(
  outC_FIFO_Delete_Op_Ack_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  static kcg_size idx;
  static kcg_size idx1;
  ...
  for (idx2 = 0; idx2 < 1; idx2++) {
    ...
    outC->_L9[idx2].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L9[idx2].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L9[idx2].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L9[idx2].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx4 = 0; idx4 < 4; idx4++) {
    ...
    outC->_L8[idx4].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L8[idx4].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L8[idx4].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L8[idx4].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx6 = 0; idx6 < 5; idx6++) {
    ...
    outC->_L7[idx6].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L7[idx6].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L7[idx6].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L7[idx6].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx8 = 0; idx8 < 5; idx8++) {
    ...
    outC->_L6[idx8].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L6[idx8].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L6[idx8].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L6[idx8].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx10 = 0; idx10 < 5; idx10++) {
    ...
    outC->_L5[idx10].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L5[idx10].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L5[idx10].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L5[idx10].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx11 = 0; idx11 < 5; idx11++) {
    outC->_L3[idx11] = kcg_lit_int32(0);
  }
  outC->_L2 = kcg_lit_int32(0);
  for (idx13 = 0; idx13 < 5; idx13++) {
    outC->_L1[idx13].present = kcg_true;
    outC->_L1[idx13].dmi_msg.valid = kcg_true;
    outC->_L1[idx13].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L1[idx13].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L1[idx13].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L1[idx13].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx15 = 0; idx15 < 5; idx15++) {
    ...
    outC->Queue[idx15].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->Queue[idx15].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->Queue[idx15].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->Queue[idx15].dmi_msg.l_text = kcg_lit_int32(0);
...
void FIFO_Delete_Op_Ack_reset_DMI_Control_Pkg_Sub_func_TextMessages(
  outC_FIFO_Delete_Op_Ack_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  static kcg_size idx;
