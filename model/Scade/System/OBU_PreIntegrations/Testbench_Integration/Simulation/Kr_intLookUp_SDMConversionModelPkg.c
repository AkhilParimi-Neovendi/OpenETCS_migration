  ...
  outC_Kr_intLookUp_SDMConversionModelPkg *outC)
{
  ...
  for (idx1 = 0; idx1 < 7; idx1++) {
    outC->_L11[idx1] = kcg_lit_int64(0);
  }
  outC->_L10 = kcg_true;
  ...
  for (idx5 = 0; idx5 < 7; idx5++) {
    ...
    outC->_L2.nid_cArray[idx5].nid_c = kcg_lit_int64(0);
  }
  ...
  for (idx7 = 0; idx7 < 7; idx7++) {
    ...
    outC->_L2.nvkvintsetArray[idx7].a_nvp12 = kcg_lit_float64(0.0);
    outC->_L2.nvkvintsetArray[idx7].a_nvp23 = kcg_lit_float64(0.0);
    for (idx6 = 0; idx6 < 7; idx6++) {
      outC->_L2.nvkvintsetArray[idx7].nvkintArray[idx6].valid = kcg_true;
      outC->_L2.nvkvintsetArray[idx7].nvkintArray[idx6].v_nvkvint = kcg_lit_int64(0);
  ...
  for (idx8 = 0; idx8 < 7; idx8++) {
    ...
    outC->_L2.nvkrintArray[idx8].m_nvkrint = kcg_lit_float64(0.0);
  }
  outC->_L2.m_nvktint = kcg_lit_float64(0.0);
  outC->m_KrInt = kcg_lit_int64(0);
  for (idx = 0; idx < 7; idx++) {
    /* _L8=(SDMConversionModelPkg::Kr_intIterator#1)/ */
