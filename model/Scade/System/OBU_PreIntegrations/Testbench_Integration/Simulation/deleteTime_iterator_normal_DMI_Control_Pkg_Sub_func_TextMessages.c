  ...
  outC_deleteTime_iterator_normal_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  kcg_copy_array_float64_10(&outC->_L24, time_array);
  outC->_L23 = index;
  kcg_copy_array_float64_10(&outC->_L22, acc);
  if ((kcg_lit_int64(0) <= outC->_L27) & (outC->_L27 < kcg_lit_int64(10))) {
    outC->_L20 = outC->_L24[outC->_L27];
  }
  else {
    outC->_L20 = outC->_L26;
  }
  kcg_copy_array_float64_10(&outC->_L21, &outC->_L22);
  if ((kcg_lit_int64(0) <= outC->_L23) & (outC->_L23 < kcg_lit_int64(10))) {
    outC->_L21[outC->_L23] = outC->_L20;
  }
  kcg_copy_array_float64_10(&outC->_L19, acc);
  outC->_L2 = Position;
  outC->_L1 = index;
  outC->_L4 = outC->_L1 < outC->_L2;
  /* _L6= */
  if (outC->_L4) {
    kcg_copy_array_float64_10(&outC->_L6, &outC->_L19);
  }
  else {
    kcg_copy_array_float64_10(&outC->_L6, &outC->_L21);
  }
  kcg_copy_array_float64_10(&outC->time, &outC->_L6);
}
