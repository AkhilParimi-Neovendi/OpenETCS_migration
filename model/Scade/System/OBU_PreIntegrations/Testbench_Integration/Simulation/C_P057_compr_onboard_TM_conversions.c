  ...
  outC_C_P057_compr_onboard_TM_conversions *outC)
{
  ...
  kcg_copy_array_int64_6(&outC->_L34, (array_int64_6 *) &outC->_L9[0]);
  ...
  outC_C_P057_compr_onboard_TM_conversions *outC)
{
  ...
  outC->P057_onboard.t_mar = kcg_lit_int64(0);
  outC->P057_onboard.t_timeoutrqst = kcg_lit_int64(0);
  outC->P057_onboard.t_cycrqst = kcg_lit_int64(0);
  /* _L4=(TM_conversions::CAST_Int_to_T_MAR#1)/ */
