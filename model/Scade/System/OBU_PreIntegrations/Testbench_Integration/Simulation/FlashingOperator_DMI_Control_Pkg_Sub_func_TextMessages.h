...
typedef struct {
  ...
  _114_SSM_ST_SM1 /* SM1: */ Context_SM1_state_nxt;
...
} SV_FlashingOperator_DMI_Control_Pkg_Sub_func_TextMessages;

extern void kcg_save_SV_FlashingOperator_DMI_Control_Pkg_Sub_func_TextMessages(
  SV_FlashingOperator_DMI_Control_Pkg_Sub_func_TextMessages *SV,
  outC_FlashingOperator_DMI_Control_Pkg_Sub_func_TextMessages *outC);
extern void kcg_load_SV_FlashingOperator_DMI_Control_Pkg_Sub_func_TextMessages(
  outC_FlashingOperator_DMI_Control_Pkg_Sub_func_TextMessages *outC,
  SV_FlashingOperator_DMI_Control_Pkg_Sub_func_TextMessages *SV);
