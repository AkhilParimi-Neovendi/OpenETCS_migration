  ...
  outC_Write_int_to_DMI_Icons_DATA_Packets_EVC_to_DMI *outC)
{
  ...
  outC->_L34.system_clock = kcg_lit_int32(0);
  outC->_L34.DMI_m_icon_control_flag = show_icon_in_area_DMI_Types_Pkg;
  outC->_L34.DMI_m_icon_flashing_freq = kcg_lit_float32(0.0);
  outC->_L34.DMI_nid_icon_group = level_symbol_DMI_Types_Pkg;
  outC->_L34.DMI_nid_icon_rank = kcg_lit_int32(0);
  outC->_L34.DMI_nid_area_group = A_DMI_Types_Pkg;
  outC->_L34.DMI_nid_area_rank = kcg_lit_int32(0);
  outC->_L34.DMI_nid_icon_identifier = kcg_lit_int32(0);
  ...
  outC->_L30.DMI_m_icon_flashing_freq = kcg_lit_float32(0.0);
  outC->_L30.DMI_nid_icon_group = level_symbol_DMI_Types_Pkg;
  outC->_L30.DMI_nid_icon_rank = kcg_lit_int32(0);
  outC->_L30.DMI_nid_area_group = A_DMI_Types_Pkg;
  outC->_L30.DMI_nid_area_rank = kcg_lit_int32(0);
  outC->_L30.DMI_nid_icon_identifier = kcg_lit_int32(0);
  for (idx = 0; idx < 9; idx++) {
    outC->_L29[idx] = kcg_lit_int32(0);
  }
  outC->every = kcg_true;
  outC->dmi_icons_ct.valid = kcg_true;
  outC->dmi_icons_ct.system_clock = kcg_lit_int32(0);
  outC->dmi_icons_ct.DMI_m_icon_control_flag = show_icon_in_area_DMI_Types_Pkg;
  outC->dmi_icons_ct.DMI_m_icon_flashing_freq = kcg_lit_float32(0.0);
  outC->dmi_icons_ct.DMI_nid_icon_group = level_symbol_DMI_Types_Pkg;
  outC->dmi_icons_ct.DMI_nid_icon_rank = kcg_lit_int32(0);
  outC->dmi_icons_ct.DMI_nid_area_group = A_DMI_Types_Pkg;
  outC->dmi_icons_ct.DMI_nid_area_rank = kcg_lit_int32(0);
  outC->dmi_icons_ct.DMI_nid_icon_identifier = kcg_lit_int32(0);
  /* _L30=(DATA::Packets::EVC_to_DMI::CAST_int_to_DMI_Icons1#1)/ */
