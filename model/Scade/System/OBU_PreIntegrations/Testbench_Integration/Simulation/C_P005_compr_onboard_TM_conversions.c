  ...
  outC_C_P005_compr_onboard_TM_conversions *outC)
{
  ...
  for (idx2 = 0; idx2 < 33; idx2++) {
    ...
    outC->_L5[idx2].d_link = kcg_lit_int64(0);
    ...
    outC->_L5[idx2].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx5 = 0; idx5 < 33; idx5++) {
    ...
    outC->_L10.sections[idx5].d_link = kcg_lit_int64(0);
    outC->_L10.sections[idx5].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L10.sections[idx5].nid_c = kcg_lit_int64(0);
    outC->_L10.sections[idx5].nid_bg = kcg_lit_int64(0);
    outC->_L10.sections[idx5].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L10.sections[idx5].q_linkreaction = Q_LINKREACTION_Train_trip;
    outC->_L10.sections[idx5].q_locacc = kcg_lit_int64(0);
  }
  ...
  outC->P005_onboard.l_packet = kcg_lit_int64(0);
  outC->P005_onboard.q_scale = Q_SCALE_10_cm_scale;
  outC->P005_onboard.n_iter = kcg_lit_int64(0);
  for (idx7 = 0; idx7 < 33; idx7++) {
    outC->P005_onboard.sections[idx7].valid = kcg_true;
    outC->P005_onboard.sections[idx7].d_link = kcg_lit_int64(0);
    outC->P005_onboard.sections[idx7].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->P005_onboard.sections[idx7].nid_c = kcg_lit_int64(0);
    outC->P005_onboard.sections[idx7].nid_bg = kcg_lit_int64(0);
    ...
    outC->P005_onboard.sections[idx7].q_locacc = kcg_lit_int64(0);
  }
  /* _L5=(TM_lib_internal::C_P005_unflatten_sections#1)/ */
