...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
} SV_ToFullSupervision_Conditions;

extern void kcg_save_SV_ToFullSupervision_Conditions(
  SV_ToFullSupervision_Conditions *SV,
  outC_ToFullSupervision_Conditions *outC);
extern void kcg_load_SV_ToFullSupervision_Conditions(
  outC_ToFullSupervision_Conditions *outC,
  SV_ToFullSupervision_Conditions *SV);
