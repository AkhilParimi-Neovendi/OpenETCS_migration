...
typedef struct {
  ...
  probesBalises_T_xdebugSupport_Pkg /* baliseInfo/ */ Context_baliseInfo;
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
} SV_setProbesBalises_xdebugSupport_Pkg;

extern void kcg_save_SV_setProbesBalises_xdebugSupport_Pkg(
  SV_setProbesBalises_xdebugSupport_Pkg *SV,
  outC_setProbesBalises_xdebugSupport_Pkg *outC);
extern void kcg_load_SV_setProbesBalises_xdebugSupport_Pkg(
  outC_setProbesBalises_xdebugSupport_Pkg *outC,
  SV_setProbesBalises_xdebugSupport_Pkg *SV);
