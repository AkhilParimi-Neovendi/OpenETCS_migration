...
typedef struct {
  ...
  kcg_bool /* _L13/ */ _L13;
  Q_SLEEPSESSION /* _L12/ */ _L12;
} outC_CAST_Q_SLEEPSESSION_to_int_TM_conversions;

/* ===========  node initialization and cycle functions  =========== */
/* TM_conversions::CAST_Q_SLEEPSESSION_to_int/ */
extern void CAST_Q_SLEEPSESSION_to_int_TM_conversions(
  /* q_sleepsession_int/ */
  Q_SLEEPSESSION q_sleepsession_int,
  outC_CAST_Q_SLEEPSESSION_to_int_TM_conversions *outC);

#ifndef KCG_NO_EXTERN_CALL_TO_RESET
extern void CAST_Q_SLEEPSESSION_to_int_reset_TM_conversions(
  outC_CAST_Q_SLEEPSESSION_to_int_TM_conversions *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CAST_Q_SLEEPSESSION_to_int_init_TM_conversions(
  outC_CAST_Q_SLEEPSESSION_to_int_TM_conversions *outC);
