  ...
  outC_countPacketsMsg_xdebugSupport_Pkg *outC)
{
  ...
  for (idx1 = 0; idx1 < 30; idx1++) {
    outC->_L13.packets.PacketHeaders[idx1].nid_packet = kcg_lit_int32(0);
    outC->_L13.packets.PacketHeaders[idx1].q_dir = Q_DIR_Reverse;
    outC->_L13.packets.PacketHeaders[idx1].valid = kcg_true;
    outC->_L13.packets.PacketHeaders[idx1].startAddress = kcg_lit_int32(0);
    outC->_L13.packets.PacketHeaders[idx1].endAddress = kcg_lit_int32(0);
  }
  for (idx2 = 0; idx2 < 500; idx2++) {
    outC->_L13.packets.PacketData[idx2] = kcg_lit_int32(0);
  }
  ...
  for (idx3 = 0; idx3 < 30; idx3++) {
    outC->_L10.PacketHeaders[idx3].nid_packet = kcg_lit_int32(0);
    outC->_L10.PacketHeaders[idx3].q_dir = Q_DIR_Reverse;
    outC->_L10.PacketHeaders[idx3].valid = kcg_true;
    outC->_L10.PacketHeaders[idx3].startAddress = kcg_lit_int32(0);
    outC->_L10.PacketHeaders[idx3].endAddress = kcg_lit_int32(0);
  }
  for (idx4 = 0; idx4 < 500; idx4++) {
    outC->_L10.PacketData[idx4] = kcg_lit_int32(0);
  }
  outC->_L7 = kcg_true;
  outC->_L6 = kcg_lit_int32(0);
  outC->_L5 = kcg_lit_int32(0);
  ...
  for (idx5 = 0; idx5 < 30; idx5++) {
    outC->_L2[idx5].nid_packet = kcg_lit_int32(0);
    outC->_L2[idx5].q_dir = Q_DIR_Reverse;
    outC->_L2[idx5].valid = kcg_true;
    outC->_L2[idx5].startAddress = kcg_lit_int32(0);
    outC->_L2[idx5].endAddress = kcg_lit_int32(0);
  }
