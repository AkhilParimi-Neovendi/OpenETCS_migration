...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P011_fs_struct_to_array_ntc_TM_TrainToTrack_lib_internal /* _L74=(TM_TrainToTrack_lib_internal::C_P011_fs_struct_to_array_ntc#1)/ */ Context_C_P011_fs_struct_to_array_ntc_1[5];
