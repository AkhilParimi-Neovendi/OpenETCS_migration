  ...
  outC_DistanceToTargetManager_DMI_Control_Pkg_Sub_func_DistanceToTarget *outC)
{
  ...
  /* InterpolatedDistanceToTarget_toDisplay/ */
  static kcg_float64 last_InterpolatedDistanceToTarget_toDisplay;
  /* DistanceToTarget_toDisplay/ */
  static kcg_float64 last_DistanceToTarget_toDisplay;
  ...
  outC_DistanceToTargetManager_DMI_Control_Pkg_Sub_func_DistanceToTarget *outC)
{
  ...
  outC->_L20.location_front_train = kcg_lit_int64(0);
  outC->_L20.location_brake_target = kcg_lit_int64(0);
  outC->_L20.v_target = kcg_lit_int64(0);
  outC->_L20.v_permitted = kcg_lit_int64(0);
  outC->_L20.v_release = kcg_lit_int64(0);
  outC->_L20.location_brake_curve_starting_point = kcg_lit_int64(0);
  outC->_L20.v_intervention = kcg_lit_int64(0);
  outC->_L20.mode = M_MODE_Full_Supervision;
  outC->_L20.level.level = M_LEVEL_Level_0;
  outC->_L20.level.nid_stm = kcg_lit_int64(0);
  ...
  outC->_L20.location_LOA = kcg_lit_int64(0);
  outC->_L20.v_LOA = kcg_lit_int64(0);
  outC->_L20.location_KP_Balise_Track = kcg_lit_int64(0);
  outC->_L20.distance_KP_Balise = kcg_lit_int64(0);
  outC->_L20.distance_to_TSA = kcg_lit_int64(0);
  ...
  outC->_L9.location_front_train = kcg_lit_int64(0);
  outC->_L9.location_brake_target = kcg_lit_int64(0);
  outC->_L9.v_target = kcg_lit_int64(0);
  outC->_L9.v_permitted = kcg_lit_int64(0);
  outC->_L9.v_release = kcg_lit_int64(0);
  outC->_L9.location_brake_curve_starting_point = kcg_lit_int64(0);
  outC->_L9.v_intervention = kcg_lit_int64(0);
  outC->_L9.mode = M_MODE_Full_Supervision;
  outC->_L9.level.level = M_LEVEL_Level_0;
  outC->_L9.level.nid_stm = kcg_lit_int64(0);
  ...
  outC->_L9.location_LOA = kcg_lit_int64(0);
  outC->_L9.v_LOA = kcg_lit_int64(0);
  outC->_L9.location_KP_Balise_Track = kcg_lit_int64(0);
  outC->_L9.distance_KP_Balise = kcg_lit_int64(0);
  outC->_L9.distance_to_TSA = kcg_lit_int64(0);
  outC->_L9.radioConnectionStatus = conn_unknown_API_RadioCommunication_Pkg;
  outC->_L9.distanceIndicationPoint = kcg_lit_int64(0);
  outC->_L8 = kcg_true;
  outC->_L7.valid = kcg_true;
  outC->_L7.system_clock = kcg_lit_int64(0);
  outC->_L7.v_train = kcg_lit_int64(0);
  outC->_L7.location_front_train = kcg_lit_int64(0);
  outC->_L7.location_brake_target = kcg_lit_int64(0);
  outC->_L7.v_target = kcg_lit_int64(0);
  outC->_L7.v_permitted = kcg_lit_int64(0);
  outC->_L7.v_release = kcg_lit_int64(0);
  outC->_L7.location_brake_curve_starting_point = kcg_lit_int64(0);
  outC->_L7.v_intervention = kcg_lit_int64(0);
  outC->_L7.mode = M_MODE_Full_Supervision;
  outC->_L7.level.level = M_LEVEL_Level_0;
  outC->_L7.level.nid_stm = kcg_lit_int64(0);
  ...
  outC->_L7.location_LOA = kcg_lit_int64(0);
  outC->_L7.v_LOA = kcg_lit_int64(0);
  outC->_L7.location_KP_Balise_Track = kcg_lit_int64(0);
  outC->_L7.distance_KP_Balise = kcg_lit_int64(0);
  outC->_L7.distance_to_TSA = kcg_lit_int64(0);
  outC->_L7.radioConnectionStatus = conn_unknown_API_RadioCommunication_Pkg;
  outC->_L7.distanceIndicationPoint = kcg_lit_int64(0);
  outC->ConditionDistanceToTarget = kcg_true;
  outC->localDistanceToTarget = kcg_lit_float64(0.0);
  ...
  outC->_L2_then_DistanceToTargetBarIfBlock = kcg_lit_float64(0.0);
  outC->_L6_then_DistanceToTargetBarIfBlock = kcg_true;
  outC->_L15_then_DistanceToTargetBarIfBlock = kcg_lit_float64(0.0);
  outC->_L1_else_DistanceToTargetA2IfBlock = kcg_true;
  outC->_L1_then_DistanceToTargetA2IfBlock = kcg_lit_float64(0.0);
  outC->_L2_then_DistanceToTargetA2IfBlock = kcg_true;
  outC->_L19 = kcg_true;
  outC->_L6 = kcg_true;
  outC->init = kcg_true;
  ...
  ConditionDistanceToTargetBar_init_DMI_Control_Pkg_Sub_func_DistanceToTarget(
    &outC->Context_ConditionDistanceToTargetBar_1);
  outC->DistanceToTarget_toDisplay = kcg_lit_float64(0.0);
  outC->InterpolatedDistanceToTarget_toDisplay = kcg_lit_float64(0.0);
