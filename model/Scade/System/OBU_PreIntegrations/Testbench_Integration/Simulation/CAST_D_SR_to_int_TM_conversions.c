...
void CAST_D_SR_to_int_TM_conversions(
  /* d_sr/ */
  D_SR d_sr,
  outC_CAST_D_SR_to_int_TM_conversions *outC)
{
  ...
  _1_noname = outC->_L8;
  noname = outC->_L9;
  outC->d_sr_int = outC->_L1;
}

#ifndef KCG_USER_DEFINED_INIT
void CAST_D_SR_to_int_init_TM_conversions(
  outC_CAST_D_SR_to_int_TM_conversions *outC)
{
  ...
  outC->d_sr_int = kcg_lit_int32(0);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void CAST_D_SR_to_int_reset_TM_conversions(
  outC_CAST_D_SR_to_int_TM_conversions *outC)
{
}
