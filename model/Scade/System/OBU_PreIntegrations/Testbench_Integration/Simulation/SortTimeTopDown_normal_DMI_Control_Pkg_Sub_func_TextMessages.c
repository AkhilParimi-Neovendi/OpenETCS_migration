  ...
  outC_SortTimeTopDown_normal_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  outC->_L76 = index;
  kcg_copy_array_float64_10(&outC->_L72, TimeQueue);
  if ((kcg_lit_int64(0) <= outC->_L79) & (outC->_L79 < kcg_lit_int64(10))) {
    outC->_L65 = outC->_L72[outC->_L79];
  }
  else {
    outC->_L65 = outC->_L77;
  }
  kcg_copy_array_float64_10(&outC->_L64, acc);
  kcg_copy_array_float64_10(&outC->_L66, &outC->_L64);
  if ((kcg_lit_int64(0) <= outC->_L76) & (outC->_L76 < kcg_lit_int64(10))) {
    outC->_L66[outC->_L76] = outC->_L65;
  }
  kcg_copy_array_float64_10(&outC->_L75, acc);
  outC->_L62 = kcg_lit_float64(-1.0);
  outC->_L69 = kcg_lit_float64(-1.0);
  outC->_L67 = index;
  kcg_copy_array_float64_10(&outC->_L63, acc);
  if ((kcg_lit_int64(0) <= outC->_L67) & (outC->_L67 < kcg_lit_int64(10))) {
  ...
  /* _L70= */
  if (outC->_L74) {
    kcg_copy_array_float64_10(&outC->_L70, &outC->_L75);
  }
  else {
    kcg_copy_array_float64_10(&outC->_L70, &outC->_L66);
  }
  kcg_copy_array_float64_10(&outC->outTimeArray, &outC->_L70);
}
  ...
  outC_SortTimeTopDown_normal_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  for (idx6 = 0; idx6 < 10; idx6++) {
    outC->outTimeArray[idx6] = kcg_lit_float64(0.0);
  }
}
