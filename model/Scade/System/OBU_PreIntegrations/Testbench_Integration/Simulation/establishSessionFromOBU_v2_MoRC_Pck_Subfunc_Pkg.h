...
typedef struct {
  ...
  _130_SSM_ST_SM1 /* SM1: */ SM1_state_nxt;
  ...
  kcg_bool every;
  _130_SSM_ST_SM1 /* SM1: */ SM1_state_sel;
  _130_SSM_ST_SM1 /* SM1: */ SM1_state_act;
  /* -------------------- (-debug) no assertions  -------------------- */
  ...
  _131_SSM_TR_SM1 /* SM1: */ SM1_fired_strong;
  _131_SSM_TR_SM1 /* SM1: */ SM1_fired;
...
typedef struct {
  ...
  _130_SSM_ST_SM1 /* SM1: */ Context_SM1_state_nxt;
  sessionCmd_T_RCM_Session_Types_Pkg /* @1/_L8/ */ Context__L8_Memory_1;
  kcg_bool Context_init;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
} SV_establishSessionFromOBU_v2_MoRC_Pck_Subfunc_Pkg;

extern void kcg_save_SV_establishSessionFromOBU_v2_MoRC_Pck_Subfunc_Pkg(
  SV_establishSessionFromOBU_v2_MoRC_Pck_Subfunc_Pkg *SV,
  outC_establishSessionFromOBU_v2_MoRC_Pck_Subfunc_Pkg *outC);
extern void kcg_load_SV_establishSessionFromOBU_v2_MoRC_Pck_Subfunc_Pkg(
  outC_establishSessionFromOBU_v2_MoRC_Pck_Subfunc_Pkg *outC,
  SV_establishSessionFromOBU_v2_MoRC_Pck_Subfunc_Pkg *SV);
