...
void Balise_384_0_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
  ...
  /* PIG_nom/ */
  kcg_int64 PIG_nom,
  outC_Balise_384_0_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet08B_Abcoude_Balises::Packets_BG384#1)/ */
    Packets_BG384_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG384_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG384_1.Balise_data_out);
...
void Balise_384_0_init_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
  outC_Balise_384_0_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises *outC)
{
  static kcg_size idx;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet08B_Abcoude_Balises::Packets_BG384#1)/ */
  Packets_BG384_init_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
    &outC->Context_Packets_BG384_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_384_0_reset_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
  outC_Balise_384_0_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet08B_Abcoude_Balises::Packets_BG384#1)/ */
  Packets_BG384_reset_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
    &outC->Context_Packets_BG384_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
