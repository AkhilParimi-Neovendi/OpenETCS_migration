...
void CAST_DMI_DMI_identifier_to_int_DATA_Variables(
  ...
  outC_CAST_DMI_DMI_identifier_to_int_DATA_Variables *outC)
{
  ...
  if (outC->IfBlock1_clock) {
    ...
    outC->else_clock_IfBlock1 = dmi_dmi_identifier_ct ==
  ...
  /* IfBlock1: */
  if (outC->IfBlock1_clock) {
    outC->_L1_then_IfBlock1 = INT_DMI_DMI_Identifier_T_DMI_1;
    dmi_dmi_identifier_int_partial = outC->_L1_then_IfBlock1;
    outC->dmi_dmi_identifier_int = dmi_dmi_identifier_int_partial;
  }
  else {
    /* IfBlock1:else: */
    if (outC->else_clock_IfBlock1) {
      outC->_L3_then_else_IfBlock1 = INT_DMI_DMI_Identifier_T_DMI_2;
      _6_dmi_dmi_identifier_int_partial = outC->_L3_then_else_IfBlock1;
      _1_dmi_dmi_identifier_int_partial = _6_dmi_dmi_identifier_int_partial;
    }
    else {
      outC->_L1_else_else_IfBlock1 = INT_DMI_DMI_Identifier_T_DMI_1;
      _4_dmi_dmi_identifier_int_partial = outC->_L1_else_else_IfBlock1;
      _1_dmi_dmi_identifier_int_partial = _4_dmi_dmi_identifier_int_partial;
    }
    outC->dmi_dmi_identifier_int = _1_dmi_dmi_identifier_int_partial;
  }
}

#ifndef KCG_USER_DEFINED_INIT
void CAST_DMI_DMI_identifier_to_int_init_DATA_Variables(
  outC_CAST_DMI_DMI_identifier_to_int_DATA_Variables *outC)
{
  outC->_L22 = kcg_true;
  outC->error = kcg_true;
...
void CAST_DMI_DMI_identifier_to_int_reset_DATA_Variables(
  outC_CAST_DMI_DMI_identifier_to_int_DATA_Variables *outC)
{
}
