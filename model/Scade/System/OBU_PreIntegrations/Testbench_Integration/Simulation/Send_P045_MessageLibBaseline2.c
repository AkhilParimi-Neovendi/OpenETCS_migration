  ...
  outC_Send_P045_MessageLibBaseline2 *outC)
{
  ...
  if (outC->every) {
    /* _L6=(TM_trackside::Write_P045#1)/ */
    Write_P045_TM_trackside(
      &outC->_L4,
      &outC->_L3,
      &outC->Context_Write_P045_1);
    _1_op_call = outC->Context_Write_P045_1.Error;
    kcg_copy_CompressedPackets_T_Common_Types_Pkg(
      &op_call,
      &outC->Context_Write_P045_1.RadioPacketsOut);
  }
  outC->_L8 = kcg_false;
  if (outC->every) {
    outC->_L6 = _1_op_call;
...
void Send_P045_init_MessageLibBaseline2(
  outC_Send_P045_MessageLibBaseline2 *outC)
{
  static kcg_size idx;
  ...
  outC->_L4.NID_MN = kcg_lit_int32(0);
  ...
  /* _L6=(TM_trackside::Write_P045#1)/ */
  Write_P045_init_TM_trackside(&outC->Context_Write_P045_1);
}
...
{
  /* _L6=(TM_trackside::Write_P045#1)/ */
  Write_P045_reset_TM_trackside(&outC->Context_Write_P045_1);
}
