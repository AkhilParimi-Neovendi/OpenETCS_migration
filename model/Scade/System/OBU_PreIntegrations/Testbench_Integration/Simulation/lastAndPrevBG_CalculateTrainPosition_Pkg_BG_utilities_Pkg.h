...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  positionedBG_T_TrainPosition_Types_Pck /* storedBG_loc/ */ Context_storedBG_loc;
  positionedBG_T_TrainPosition_Types_Pck /* prvBG_loc/ */ Context_prvBG_loc;
  positionedBG_T_TrainPosition_Types_Pck /* @2/_L8/ */ Context__L8_Memory_2;
  positionedBG_T_TrainPosition_Types_Pck /* @1/_L8/ */ Context__L8_Memory_1;
  kcg_bool Context_init;
  positionedBG_T_TrainPosition_Types_Pck /* BG/ */ Context_mem_BG;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
} SV_lastAndPrevBG_CalculateTrainPosition_Pkg_BG_utilities_Pkg;

extern void kcg_save_SV_lastAndPrevBG_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
  SV_lastAndPrevBG_CalculateTrainPosition_Pkg_BG_utilities_Pkg *SV,
  outC_lastAndPrevBG_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC);
extern void kcg_load_SV_lastAndPrevBG_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
  outC_lastAndPrevBG_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC,
  SV_lastAndPrevBG_CalculateTrainPosition_Pkg_BG_utilities_Pkg *SV);
