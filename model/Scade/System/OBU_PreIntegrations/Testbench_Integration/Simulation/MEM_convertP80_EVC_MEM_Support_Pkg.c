  ...
  outC_MEM_convertP80_EVC_MEM_Support_Pkg *outC)
{
  ...
  kcg_copy__23_array(&outC->_L11, (_23_array *) &outC->_L10[0]);
  ...
  outC_MEM_convertP80_EVC_MEM_Support_Pkg *outC)
{
  ...
  outC->_L15.d_validnv = kcg_lit_int64(0);
  outC->_L15.nid_c = kcg_lit_int64(0);
  outC->_L15.n_iter_nid_c = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 32; idx1++) {
    outC->_L15.nid_c_list[idx1].valid = kcg_true;
    outC->_L15.nid_c_list[idx1].nid_c = kcg_lit_int64(0);
  }
  outC->_L15.v_nvshunt = kcg_lit_int64(0);
  outC->_L15.v_nvstff = kcg_lit_int64(0);
  outC->_L15.v_nvonsight = kcg_lit_int64(0);
  outC->_L15.v_nvlimsuperv = kcg_lit_int64(0);
  outC->_L15.v_nvunfit = kcg_lit_int64(0);
  outC->_L15.v_nvrel = kcg_lit_int64(0);
  outC->_L15.d_nvroll = kcg_lit_int64(0);
  ...
  outC->_L15.v_nvallowovtrp = kcg_lit_int64(0);
  outC->_L15.v_nvsupovtrp = kcg_lit_int64(0);
  outC->_L15.d_nvovtrp = kcg_lit_int64(0);
  outC->_L15.t_nvovtrp = kcg_lit_int64(0);
  outC->_L15.d_nvpotrp = kcg_lit_int64(0);
  outC->_L15.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->_L15.t_nvcontact = kcg_lit_int64(0);
  outC->_L15.m_nvderun = M_NVDERUN_No;
  outC->_L15.d_nvstff = kcg_lit_int64(0);
  outC->_L15.q_nvdriver_adhes = Q_NVDRIVER_ADHES_Not_allowed;
  outC->_L15.a_nvmaxredadh1 = kcg_lit_float64(0.0);
  outC->_L15.a_nvmaxredadh2 = kcg_lit_float64(0.0);
  outC->_L15.a_nvmaxredadh3 = kcg_lit_float64(0.0);
  outC->_L15.q_nvlocacc = kcg_lit_int64(0);
  outC->_L15.m_nvavadh = kcg_lit_float64(0.0);
  ...
  outC->_L15.a_nvp12 = kcg_lit_float64(0.0);
  outC->_L15.a_nvp23 = kcg_lit_float64(0.0);
  outC->_L15.v_nvkvint = kcg_lit_int64(0);
  outC->_L15.m_nvkvint_12 = kcg_lit_float64(0.0);
  outC->_L15.m_nvkvint_23 = kcg_lit_float64(0.0);
  outC->_L15.n_iter_n = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L15.n_iter_n_list[idx2].valid = kcg_true;
    outC->_L15.n_iter_n_list[idx2].v_nvkvint_n = kcg_lit_int64(0);
    outC->_L15.n_iter_n_list[idx2].m_nvkvint_n_12 = kcg_lit_float64(0.0);
    outC->_L15.n_iter_n_list[idx2].m_nvkvint_n_23 = kcg_lit_float64(0.0);
  }
  outC->_L15.n_iter_k = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->_L15.n_iter_k_list[idx4].valid = kcg_true;
    outC->_L15.n_iter_k_list[idx4].q_nvkvintset_k = Q_NVKVINTSET_Freight_trains;
    outC->_L15.n_iter_k_list[idx4].a_nvp12_k = kcg_lit_float64(0.0);
    outC->_L15.n_iter_k_list[idx4].a_nvp23_k = kcg_lit_float64(0.0);
    outC->_L15.n_iter_k_list[idx4].v_nvkvint_k = kcg_lit_int64(0);
    outC->_L15.n_iter_k_list[idx4].m_nvkvint_k_12 = kcg_lit_float64(0.0);
    outC->_L15.n_iter_k_list[idx4].m_nvkvint_k_23 = kcg_lit_float64(0.0);
    outC->_L15.n_iter_k_list[idx4].n_iter_k_m = kcg_lit_int64(0);
  ...
  outC->_L15.m_nvkrint = kcg_lit_float64(0.0);
  outC->_L15.n_iter_l = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 32; idx5++) {
    outC->_L15.n_iter_l_list[idx5].valid = kcg_true;
    outC->_L15.n_iter_l_list[idx5].l_nvkrint_l = L_NVKRINT_0m;
    outC->_L15.n_iter_l_list[idx5].m_nvkrint_l = kcg_lit_float64(0.0);
  }
  outC->_L15.m_nvktint = kcg_lit_float64(0.0);
  for (idx11 = 0; idx11 < 3; idx11++) {
    outC->_L14[idx11].valid = kcg_true;
    outC->_L14[idx11].nid_packet = kcg_lit_int64(0);
    outC->_L14[idx11].q_dir = Q_DIR_Reverse;
    outC->_L14[idx11].q_scale = Q_SCALE_10_cm_scale;
    outC->_L14[idx11].d_validnv = kcg_lit_int64(0);
    outC->_L14[idx11].nid_c = kcg_lit_int64(0);
    outC->_L14[idx11].n_iter_nid_c = kcg_lit_int64(0);
    for (idx6 = 0; idx6 < 32; idx6++) {
      outC->_L14[idx11].nid_c_list[idx6].valid = kcg_true;
      outC->_L14[idx11].nid_c_list[idx6].nid_c = kcg_lit_int64(0);
    }
    outC->_L14[idx11].v_nvshunt = kcg_lit_int64(0);
    outC->_L14[idx11].v_nvstff = kcg_lit_int64(0);
    outC->_L14[idx11].v_nvonsight = kcg_lit_int64(0);
    outC->_L14[idx11].v_nvlimsuperv = kcg_lit_int64(0);
    outC->_L14[idx11].v_nvunfit = kcg_lit_int64(0);
    outC->_L14[idx11].v_nvrel = kcg_lit_int64(0);
    outC->_L14[idx11].d_nvroll = kcg_lit_int64(0);
    ...
    outC->_L14[idx11].v_nvallowovtrp = kcg_lit_int64(0);
    outC->_L14[idx11].v_nvsupovtrp = kcg_lit_int64(0);
    outC->_L14[idx11].d_nvovtrp = kcg_lit_int64(0);
    outC->_L14[idx11].t_nvovtrp = kcg_lit_int64(0);
    outC->_L14[idx11].d_nvpotrp = kcg_lit_int64(0);
    outC->_L14[idx11].m_nvcontact = M_NVCONTACT_Train_trip;
    outC->_L14[idx11].t_nvcontact = kcg_lit_int64(0);
    outC->_L14[idx11].m_nvderun = M_NVDERUN_No;
    outC->_L14[idx11].d_nvstff = kcg_lit_int64(0);
    outC->_L14[idx11].q_nvdriver_adhes = Q_NVDRIVER_ADHES_Not_allowed;
    outC->_L14[idx11].a_nvmaxredadh1 = kcg_lit_float64(0.0);
    outC->_L14[idx11].a_nvmaxredadh2 = kcg_lit_float64(0.0);
    outC->_L14[idx11].a_nvmaxredadh3 = kcg_lit_float64(0.0);
    outC->_L14[idx11].q_nvlocacc = kcg_lit_int64(0);
    outC->_L14[idx11].m_nvavadh = kcg_lit_float64(0.0);
    ...
    outC->_L14[idx11].a_nvp12 = kcg_lit_float64(0.0);
    outC->_L14[idx11].a_nvp23 = kcg_lit_float64(0.0);
    outC->_L14[idx11].v_nvkvint = kcg_lit_int64(0);
    outC->_L14[idx11].m_nvkvint_12 = kcg_lit_float64(0.0);
    outC->_L14[idx11].m_nvkvint_23 = kcg_lit_float64(0.0);
    outC->_L14[idx11].n_iter_n = kcg_lit_int64(0);
    for (idx7 = 0; idx7 < 32; idx7++) {
      outC->_L14[idx11].n_iter_n_list[idx7].valid = kcg_true;
      outC->_L14[idx11].n_iter_n_list[idx7].v_nvkvint_n = kcg_lit_int64(0);
      outC->_L14[idx11].n_iter_n_list[idx7].m_nvkvint_n_12 = kcg_lit_float64(0.0);
      outC->_L14[idx11].n_iter_n_list[idx7].m_nvkvint_n_23 = kcg_lit_float64(0.0);
    }
    outC->_L14[idx11].n_iter_k = kcg_lit_int64(0);
    for (idx9 = 0; idx9 < 32; idx9++) {
      ...
      outC->_L14[idx11].n_iter_k_list[idx9].a_nvp12_k = kcg_lit_float64(0.0);
      outC->_L14[idx11].n_iter_k_list[idx9].a_nvp23_k = kcg_lit_float64(0.0);
      outC->_L14[idx11].n_iter_k_list[idx9].v_nvkvint_k = kcg_lit_int64(0);
      outC->_L14[idx11].n_iter_k_list[idx9].m_nvkvint_k_12 = kcg_lit_float64(0.0);
      outC->_L14[idx11].n_iter_k_list[idx9].m_nvkvint_k_23 = kcg_lit_float64(0.0);
      outC->_L14[idx11].n_iter_k_list[idx9].n_iter_k_m = kcg_lit_int64(0);
    ...
    outC->_L14[idx11].m_nvkrint = kcg_lit_float64(0.0);
    outC->_L14[idx11].n_iter_l = kcg_lit_int64(0);
    for (idx10 = 0; idx10 < 32; idx10++) {
      ...
      outC->_L14[idx11].n_iter_l_list[idx10].m_nvkrint_l = kcg_lit_float64(0.0);
    }
    outC->_L14[idx11].m_nvktint = kcg_lit_float64(0.0);
  }
  ...
  for (idx13 = 0; idx13 < 3; idx13++) {
    ...
    outC->_L11[idx13].d_mamode = kcg_lit_int64(0);
    outC->_L11[idx13].m_mamode = M_MAMODE_On_Sight;
    outC->_L11[idx13].v_mamode = kcg_lit_int64(0);
    outC->_L11[idx13].l_mamode = kcg_lit_int64(0);
    outC->_L11[idx13].l_ackmamode = kcg_lit_int64(0);
    outC->_L11[idx13].q_mamode = Q_MAMODE_as_the_EOA;
  }
  for (idx14 = 0; idx14 < 33; idx14++) {
    outC->_L10[idx14].valid = kcg_true;
    outC->_L10[idx14].d_mamode = kcg_lit_int64(0);
    outC->_L10[idx14].m_mamode = M_MAMODE_On_Sight;
    outC->_L10[idx14].v_mamode = kcg_lit_int64(0);
    outC->_L10[idx14].l_mamode = kcg_lit_int64(0);
    outC->_L10[idx14].l_ackmamode = kcg_lit_int64(0);
  ...
  outC->_L5.d_mamode = kcg_lit_int64(0);
  outC->_L5.m_mamode = M_MAMODE_On_Sight;
  outC->_L5.v_mamode = kcg_lit_int64(0);
  outC->_L5.l_mamode = kcg_lit_int64(0);
  outC->_L5.l_ackmamode = kcg_lit_int64(0);
  ...
  for (idx16 = 0; idx16 < 3; idx16++) {
    ...
    outC->_L3[idx16].d_mamode = kcg_lit_int64(0);
    outC->_L3[idx16].m_mamode = M_MAMODE_On_Sight;
    outC->_L3[idx16].v_mamode = kcg_lit_int64(0);
    outC->_L3[idx16].l_mamode = kcg_lit_int64(0);
    outC->_L3[idx16].l_ackmamode = kcg_lit_int64(0);
  ...
  for (idx17 = 0; idx17 < 33; idx17++) {
    ...
    outC->_L1.sections[idx17].d_mamode = kcg_lit_int64(0);
    outC->_L1.sections[idx17].m_mamode = M_MAMODE_On_Sight;
    outC->_L1.sections[idx17].v_mamode = kcg_lit_int64(0);
    outC->_L1.sections[idx17].l_mamode = kcg_lit_int64(0);
    outC->_L1.sections[idx17].l_ackmamode = kcg_lit_int64(0);
  ...
  for (idx18 = 0; idx18 < 3; idx18++) {
    ...
    outC->p80[idx18].d_mamode = kcg_lit_int64(0);
    outC->p80[idx18].m_mamode = M_MAMODE_On_Sight;
    outC->p80[idx18].v_mamode = kcg_lit_int64(0);
    outC->p80[idx18].l_mamode = kcg_lit_int64(0);
    outC->p80[idx18].l_ackmamode = kcg_lit_int64(0);
