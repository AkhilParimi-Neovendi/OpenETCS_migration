...
void nextGen_P05_init_radioOutput_Pkg(outC_nextGen_P05_radioOutput_Pkg *outC)
{
  ...
  outC->_L2.nid_opeartional = kcg_lit_int32(0);
  outC->_L1.valid = kcg_true;
  outC->_L1.TrainRunningNumber = kcg_lit_int32(0);
  outC->outP5.valid = kcg_true;
  outC->outP5.nid_packet = kcg_lit_int32(0);
  outC->outP5.l_packet = kcg_lit_int32(0);
  outC->outP5.nid_opeartional = kcg_lit_int32(0);
}
