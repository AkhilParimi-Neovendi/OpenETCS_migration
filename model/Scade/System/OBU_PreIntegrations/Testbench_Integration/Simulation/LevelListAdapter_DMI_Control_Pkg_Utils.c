  ...
  outC_LevelListAdapter_DMI_Control_Pkg_Utils *outC)
{
  ...
  kcg_copy_array_int32_12(&outC->_L21, (array_int32_12 *) &outC->_L9[0]);
  noname = outC->_L8;
  kcg_copy_array_int32_12(&outC->ArrayLevelIndex_toDisplay, &outC->_L21);
}
  ...
  outC_LevelListAdapter_DMI_Control_Pkg_Utils *outC)
{
  ...
  for (idx3 = 0; idx3 < 32; idx3++) {
    ...
    outC->_L15[idx3].nid_stm = kcg_lit_int32(0);
  }
  ...
  for (idx5 = 0; idx5 < 32; idx5++) {
    ...
    outC->_L7.levelList[idx5].nid_stm = kcg_lit_int32(0);
  }
  outC->_L4 = kcg_true;
  outC->_L1.valid = kcg_true;
  outC->_L1.system_clock = kcg_lit_int32(0);
  outC->_L1.levelList.number = kcg_lit_int32(0);
  for (idx6 = 0; idx6 < 32; idx6++) {
    outC->_L1.levelList.levelList[idx6].level = M_LEVEL_Level_0;
    outC->_L1.levelList.levelList[idx6].nid_stm = kcg_lit_int32(0);
  }
  for (idx7 = 0; idx7 < 12; idx7++) {
    outC->ArrayLevelIndex_toDisplay[idx7] = kcg_lit_int32(0);
  }
  for (idx = 0; idx < 32; idx++) {
    /* _L8=(DMI_Control_Pkg::Sub_func::LevelList_Iterator#1)/ */
