...
void BufferOutput_write_only3_TM_lib_internal(
  ...
  outC_BufferOutput_write_only3_TM_lib_internal *outC)
{
  static kcg_bool noname;

  outC->_L10 = DIM_FIFO_TrainTrackOutput_TM_lib_internal;
  outC->_L8 = kcg_lit_int64(3);
  ...
  kcg_copy__55_array(&outC->_L6, (_55_array *) &outC->_L3[0]);
  kcg_copy_M_TrainTrackRadioOutputBuffer_t_TM_lib_internal(&outC->_L1, Buffer_In);
  kcg_copy__13_array(&outC->_L4, (_13_array *) &outC->_L1[0]);
  kcg_copy__55_array(&outC->_L5[0], &outC->_L6);
  kcg_copy__13_array(&outC->_L5[3], &outC->_L4);
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
    &outC->Message_out,
    &outC->_L9);
...
void BufferOutput_write_only3_init_TM_lib_internal(
  outC_BufferOutput_write_only3_TM_lib_internal *outC)
{
  static kcg_size idx;
  ...
  for (idx8 = 0; idx8 < 5; idx8++) {
    ...
    outC->_L3[idx8].Message.nid_message = kcg_lit_int64(0);
    outC->_L3[idx8].Message.l_message = kcg_lit_int64(0);
    outC->_L3[idx8].Message.t_train = kcg_lit_int64(0);
    outC->_L3[idx8].Message.nid_engine = kcg_lit_int64(0);
    outC->_L3[idx8].Message.field1 = kcg_lit_int64(0);
    outC->_L3[idx8].Message.field2 = kcg_lit_int64(0);
    outC->_L3[idx8].Message.field3 = kcg_lit_int64(0);
    for (idx7 = 0; idx7 < 50; idx7++) {
      outC->_L3[idx8].OptionalPackets[idx7] = kcg_lit_int64(0);
    }
  }
  outC->_L2 = kcg_lit_int64(0);
  for (idx10 = 0; idx10 < 100; idx10++) {
    outC->_L1[idx10].Message.valid = kcg_true;
    outC->_L1[idx10].Message.nid_message = kcg_lit_int64(0);
    outC->_L1[idx10].Message.l_message = kcg_lit_int64(0);
    outC->_L1[idx10].Message.t_train = kcg_lit_int64(0);
    outC->_L1[idx10].Message.nid_engine = kcg_lit_int64(0);
    outC->_L1[idx10].Message.field1 = kcg_lit_int64(0);
    outC->_L1[idx10].Message.field2 = kcg_lit_int64(0);
    outC->_L1[idx10].Message.field3 = kcg_lit_int64(0);
    for (idx9 = 0; idx9 < 50; idx9++) {
      outC->_L1[idx10].OptionalPackets[idx9] = kcg_lit_int64(0);
    }
  }
  ...
  for (idx11 = 0; idx11 < 50; idx11++) {
    outC->Message_out.OptionalPackets[idx11] = kcg_lit_int64(0);
  }
  outC->Stacksize_new = kcg_lit_int64(0);
  for (idx13 = 0; idx13 < 100; idx13++) {
    outC->Buffer_Out[idx13].Message.valid = kcg_true;
    outC->Buffer_Out[idx13].Message.nid_message = kcg_lit_int64(0);
    outC->Buffer_Out[idx13].Message.l_message = kcg_lit_int64(0);
    outC->Buffer_Out[idx13].Message.t_train = kcg_lit_int64(0);
    outC->Buffer_Out[idx13].Message.nid_engine = kcg_lit_int64(0);
    outC->Buffer_Out[idx13].Message.field1 = kcg_lit_int64(0);
    outC->Buffer_Out[idx13].Message.field2 = kcg_lit_int64(0);
    outC->Buffer_Out[idx13].Message.field3 = kcg_lit_int64(0);
    for (idx12 = 0; idx12 < 50; idx12++) {
      outC->Buffer_Out[idx13].OptionalPackets[idx12] = kcg_lit_int64(0);
    }
  }
}
...
void BufferOutput_write_only3_reset_TM_lib_internal(
  outC_BufferOutput_write_only3_TM_lib_internal *outC)
{
}
