  ...
  outC_Write_int_to_DMI_Track_Description_DATA_Packets_EVC_to_DMI *outC)
{
  ...
  outC->_L29.system_clock = kcg_lit_int64(0);
  outC->_L29.speedProfiles.profileChanged = kcg_true;
  for (idx = 0; idx < 32; idx++) {
    outC->_L29.speedProfiles.speedProfiles[idx].valid = kcg_true;
    outC->_L29.speedProfiles.speedProfiles[idx].Loc_Abs = kcg_lit_int64(0);
    outC->_L29.speedProfiles.speedProfiles[idx].Loc_LRBG = kcg_lit_int64(0);
    outC->_L29.speedProfiles.speedProfiles[idx].MRS = kcg_lit_int64(0);
  }
  ...
  for (idx1 = 0; idx1 < 32; idx1++) {
    ...
    outC->_L29.gradientProfiles.gradientProfiles[idx1].end_section =
      kcg_lit_int64(0);
    outC->_L29.gradientProfiles.gradientProfiles[idx1].gradient = kcg_lit_int64(0);
  }
  outC->_L29.trackConditions.nIter = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L29.trackConditions.trackCondition[idx2].d_trackcond = kcg_lit_int64(0);
  ...
  outC->_L28.system_clock = kcg_lit_int64(0);
  outC->_L28.speedProfiles.profileChanged = kcg_true;
  for (idx3 = 0; idx3 < 32; idx3++) {
    outC->_L28.speedProfiles.speedProfiles[idx3].valid = kcg_true;
    outC->_L28.speedProfiles.speedProfiles[idx3].Loc_Abs = kcg_lit_int64(0);
    outC->_L28.speedProfiles.speedProfiles[idx3].Loc_LRBG = kcg_lit_int64(0);
    outC->_L28.speedProfiles.speedProfiles[idx3].MRS = kcg_lit_int64(0);
  }
  ...
  for (idx4 = 0; idx4 < 32; idx4++) {
    ...
    outC->_L28.gradientProfiles.gradientProfiles[idx4].end_section =
      kcg_lit_int64(0);
    outC->_L28.gradientProfiles.gradientProfiles[idx4].gradient = kcg_lit_int64(0);
  }
  outC->_L28.trackConditions.nIter = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 32; idx5++) {
    outC->_L28.trackConditions.trackCondition[idx5].d_trackcond = kcg_lit_int64(0);
