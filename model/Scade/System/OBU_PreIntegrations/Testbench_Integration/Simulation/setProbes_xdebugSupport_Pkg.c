  ...
  outC_setProbes_xdebugSupport_Pkg *outC)
{
  ...
  if ((kcg_lit_int32(0) <= outC->_L16) & (outC->_L16 < kcg_lit_int32(30))) {
    kcg_copy_MetadataElement_T_Common_Types_Pkg(
      &outC->_L15,
      &outC->_L10[outC->_L16]);
  }
  ...
  if ((kcg_lit_int32(0) <= outC->_L12) & (outC->_L12 < kcg_lit_int32(30))) {
    kcg_copy_MetadataElement_T_Common_Types_Pkg(
      &outC->_L11,
      &outC->_L10[outC->_L12]);
  }
...
void setProbes_init_xdebugSupport_Pkg(outC_setProbes_xdebugSupport_Pkg *outC)
{
  ...
  outC->_L29.startAddress = kcg_lit_int32(0);
  outC->_L29.endAddress = kcg_lit_int32(0);
  outC->_L28 = kcg_true;
  outC->_L27 = kcg_true;
  ...
  outC->_L15.startAddress = kcg_lit_int32(0);
  outC->_L15.endAddress = kcg_lit_int32(0);
  outC->_L13 = kcg_lit_int32(0);
  outC->_L12 = kcg_lit_int32(0);
  outC->_L11.nid_packet = kcg_lit_int32(0);
  outC->_L11.q_dir = Q_DIR_Reverse;
  outC->_L11.valid = kcg_true;
  outC->_L11.startAddress = kcg_lit_int32(0);
  outC->_L11.endAddress = kcg_lit_int32(0);
  for (idx = 0; idx < 30; idx++) {
    outC->_L10[idx].nid_packet = kcg_lit_int32(0);
    outC->_L10[idx].q_dir = Q_DIR_Reverse;
    outC->_L10[idx].valid = kcg_true;
    outC->_L10[idx].startAddress = kcg_lit_int32(0);
    outC->_L10[idx].endAddress = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 30; idx1++) {
    outC->_L9.PacketHeaders[idx1].nid_packet = kcg_lit_int32(0);
    outC->_L9.PacketHeaders[idx1].q_dir = Q_DIR_Reverse;
    outC->_L9.PacketHeaders[idx1].valid = kcg_true;
    outC->_L9.PacketHeaders[idx1].startAddress = kcg_lit_int32(0);
    outC->_L9.PacketHeaders[idx1].endAddress = kcg_lit_int32(0);
  }
  for (idx2 = 0; idx2 < 500; idx2++) {
    outC->_L9.PacketData[idx2] = kcg_lit_int32(0);
  }
  ...
  outC->_L6.api_header.m_mcount = kcg_lit_int32(0);
  outC->_L6.api_header.nid_c = kcg_lit_int32(0);
  outC->_L6.api_header.nid_bg = kcg_lit_int32(0);
  ...
  outC->_L4.radioDevice = kcg_lit_int32(0);
  outC->_L4.receivedSystemTime = kcg_lit_int32(0);
  outC->_L4.nid_message = kcg_lit_int32(0);
  outC->_L4.t_train = kcg_lit_int32(0);
  outC->_L4.m_ack = M_ACK_No_acknowledgement_required;
  outC->_L4.nid_lrbg = kcg_lit_int32(0);
  outC->_L4.t_train_reference = kcg_lit_int32(0);
  outC->_L4.nid_em = kcg_lit_int32(0);
  outC->_L4.q_scale = Q_SCALE_10_cm_scale;
  outC->_L4.d_sr = kcg_lit_int32(0);
  outC->_L4.t_sh_rqst = kcg_lit_int32(0);
  outC->_L4.d_ref = kcg_lit_int32(0);
  outC->_L4.q_dir = Q_DIR_Reverse;
  outC->_L4.d_emergencystop = kcg_lit_int32(0);
  outC->_L4.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  ...
  outC->_L2.sendingRBC_Id.nid_c = kcg_lit_int32(0);
  outC->_L2.sendingRBC_Id.rbc_id = kcg_lit_int32(0);
  outC->_L2.sendingRBC_Id.device_id = kcg_lit_int32(0);
  ...
  outC->every = kcg_true;
  outC->lastBG_ID = kcg_lit_int32(0);
  outC->lastRadioMSG = kcg_lit_int32(0);
  outC->packet_id2 = kcg_lit_int32(0);
  outC->packet_id1 = kcg_lit_int32(0);
  outC->BG_ID = kcg_lit_int32(0);
  outC->radioMSG = kcg_lit_int32(0);
  outC->isChanged = kcg_true;
  /* _L55=(xdebugSupport_Pkg::countPackets#1)/ */
  countPackets_init_xdebugSupport_Pkg(&outC->Context_countPackets_1);
  outC->bgID = kcg_lit_int32(0);
  outC->lastMsgID = kcg_lit_int32(0);
  outC->lastBGID = kcg_lit_int32(0);
  outC->msgID = kcg_lit_int32(0);
}
...
void kcg_save_SV_setProbes_xdebugSupport_Pkg(
  SV_setProbes_xdebugSupport_Pkg *SV,
  outC_setProbes_xdebugSupport_Pkg *outC)
{
  SV->Context_lastBGID = outC->lastBGID;
  SV->Context_lastMsgID = outC->lastMsgID;
  SV->Context_bgID = outC->bgID;
  SV->Context_msgID = outC->msgID;
}

void kcg_load_SV_setProbes_xdebugSupport_Pkg(
  outC_setProbes_xdebugSupport_Pkg *outC,
  SV_setProbes_xdebugSupport_Pkg *SV)
{
  outC->lastBGID = SV->Context_lastBGID;
  outC->lastMsgID = SV->Context_lastMsgID;
  outC->bgID = SV->Context_bgID;
  outC->msgID = SV->Context_msgID;
}
