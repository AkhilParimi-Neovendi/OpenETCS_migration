...
typedef struct {
  ...
  positionedBG_T_TrainPosition_Types_Pck /* _L3/ */ Context__L3;
  kcg_bool Context_init;
  LocWithInAcc_T_Obu_BasicTypes_Pkg /* position/ */ Context_mem_position;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_FallingEdge_digital Context_FallingEdge_1;
} SV_linkedBG_missed_CalculateTrainPosition_Pkg_Linking_Pkg;

extern void kcg_save_SV_linkedBG_missed_CalculateTrainPosition_Pkg_Linking_Pkg(
  SV_linkedBG_missed_CalculateTrainPosition_Pkg_Linking_Pkg *SV,
  outC_linkedBG_missed_CalculateTrainPosition_Pkg_Linking_Pkg *outC);
extern void kcg_load_SV_linkedBG_missed_CalculateTrainPosition_Pkg_Linking_Pkg(
  outC_linkedBG_missed_CalculateTrainPosition_Pkg_Linking_Pkg *outC,
  SV_linkedBG_missed_CalculateTrainPosition_Pkg_Linking_Pkg *SV);
