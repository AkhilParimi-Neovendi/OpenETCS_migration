...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* resetDelayedOrderFlag/ */ Context_resetDelayedOrderFlag;
  kcg_bool /* Register_SM: */ Context_Register_SM_reset_nxt;
  kcg_bool /* Register_SM: */ Context_Register_SM_reset_act;
  SSM_ST_Register_SM /* Register_SM: */ Context_Register_SM_state_nxt;
  kcg_bool /* @5/_L2/ */ Context__L2_FlipFlopSet_1;
  P45_RadioNetworkRegistration_T_Packet_Types_Pkg /* @4/_L8/ */ Context__L8_Memory_5;
  P45_RadioNetworkRegistration_T_Packet_Types_Pkg /* @3/_L8/ */ Context__L8_Memory_4;
  P45_RadioNetworkRegistration_T_Packet_Types_Pkg /* @2/_L8/ */ Context__L8_Memory_2;
  P45_RadioNetworkRegistration_T_Packet_Types_Pkg /* @1/_L8/ */ Context__L8_Memory_1;
  kcg_bool Context_init;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_RisingEdge_digital Context_RisingEdge_7;
  SV_RisingEdge_digital Context_RisingEdge_6;
  SV_FallingEdge_digital Context_FallingEdge_1;
  SV_RisingEdge_digital Context_RisingEdge_8;
} SV_registeringToTheRadioNetwork_v2_MoRC_Pck_Subfunc_Pkg;

extern void kcg_save_SV_registeringToTheRadioNetwork_v2_MoRC_Pck_Subfunc_Pkg(
  SV_registeringToTheRadioNetwork_v2_MoRC_Pck_Subfunc_Pkg *SV,
  outC_registeringToTheRadioNetwork_v2_MoRC_Pck_Subfunc_Pkg *outC);
extern void kcg_load_SV_registeringToTheRadioNetwork_v2_MoRC_Pck_Subfunc_Pkg(
  outC_registeringToTheRadioNetwork_v2_MoRC_Pck_Subfunc_Pkg *outC,
  SV_registeringToTheRadioNetwork_v2_MoRC_Pck_Subfunc_Pkg *SV);
