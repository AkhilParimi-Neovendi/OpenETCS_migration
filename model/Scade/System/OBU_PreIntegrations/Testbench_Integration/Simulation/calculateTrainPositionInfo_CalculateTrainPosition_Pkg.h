...
typedef struct {
  ...
  outC_positionDerivedFromPassedBG_CalculateTrainPosition_Pkg_BG_utilities_Pkg /* _L7=(CalculateTrainPosition_Pkg::BG_utilities_Pkg::positionDerivedFromPassedBG#1)/ */ Context_positionDerivedFromPassedBG_1;
...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  positionedBG_T_TrainPosition_Types_Pck /* _L71/ */ Context__L71;
  positionedBG_T_TrainPosition_Types_Pck /* _L70/ */ Context__L70;
  positionedBG_T_TrainPosition_Types_Pck /* _L61/ */ Context__L61;
  positionedBG_T_TrainPosition_Types_Pck /* _L62/ */ Context__L62;
  kcg_bool Context_init;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_lastAndPrevBG_CalculateTrainPosition_Pkg_BG_utilities_Pkg Context_lastAndPrevBG_1;
  SV_lastAndPrevBG_CalculateTrainPosition_Pkg_BG_utilities_Pkg Context_lastAndPrevBG_2;
  SV_linkingIsUsed_CalculateTrainPosition_Pkg_Linking_Pkg Context_linkingIsUsed_1;
} SV_calculateTrainPositionInfo_CalculateTrainPosition_Pkg;

extern void kcg_save_SV_calculateTrainPositionInfo_CalculateTrainPosition_Pkg(
  SV_calculateTrainPositionInfo_CalculateTrainPosition_Pkg *SV,
  outC_calculateTrainPositionInfo_CalculateTrainPosition_Pkg *outC);
extern void kcg_load_SV_calculateTrainPositionInfo_CalculateTrainPosition_Pkg(
  outC_calculateTrainPositionInfo_CalculateTrainPosition_Pkg *outC,
  SV_calculateTrainPositionInfo_CalculateTrainPosition_Pkg *SV);
