  ...
  outC_BufferOutput_write_only4_TM_lib_internal *outC)
{
  ...
  kcg_copy__19_array(&outC->_L6, (_19_array *) &outC->_L3[0]);
  kcg_copy_M_TrainTrackRadioOutputBuffer_t_TM_lib_internal(&outC->_L1, Buffer_In);
  kcg_copy__58_array(&outC->_L4, (_58_array *) &outC->_L1[0]);
  kcg_copy__19_array(&outC->_L5[0], &outC->_L6);
  kcg_copy__58_array(&outC->_L5[4], &outC->_L4);
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
    &outC->Message_out,
    &outC->_L9);
