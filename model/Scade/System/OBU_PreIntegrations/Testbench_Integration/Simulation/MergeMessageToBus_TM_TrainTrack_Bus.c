  ...
  outC_MergeMessageToBus_TM_TrainTrack_Bus *outC)
{
  ...
  for (idx1 = 0; idx1 < 5; idx1++) {
    ...
    outC->_L17[idx1].Message.nid_message = kcg_lit_int64(0);
    outC->_L17[idx1].Message.l_message = kcg_lit_int64(0);
    outC->_L17[idx1].Message.t_train = kcg_lit_int64(0);
    outC->_L17[idx1].Message.nid_engine = kcg_lit_int64(0);
    outC->_L17[idx1].Message.field1 = kcg_lit_int64(0);
    outC->_L17[idx1].Message.field2 = kcg_lit_int64(0);
    outC->_L17[idx1].Message.field3 = kcg_lit_int64(0);
    for (idx = 0; idx < 50; idx++) {
      outC->_L17[idx1].OptionalPackets[idx] = kcg_lit_int64(0);
    }
  }
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L16[idx3].Message.valid = kcg_true;
    outC->_L16[idx3].Message.nid_message = kcg_lit_int64(0);
    outC->_L16[idx3].Message.l_message = kcg_lit_int64(0);
    outC->_L16[idx3].Message.t_train = kcg_lit_int64(0);
    outC->_L16[idx3].Message.nid_engine = kcg_lit_int64(0);
    outC->_L16[idx3].Message.field1 = kcg_lit_int64(0);
    outC->_L16[idx3].Message.field2 = kcg_lit_int64(0);
    outC->_L16[idx3].Message.field3 = kcg_lit_int64(0);
    for (idx2 = 0; idx2 < 50; idx2++) {
      outC->_L16[idx3].OptionalPackets[idx2] = kcg_lit_int64(0);
    }
  }
  ...
  for (idx5 = 0; idx5 < 5; idx5++) {
    ...
    outC->_L13[idx5].Message.nid_message = kcg_lit_int64(0);
    outC->_L13[idx5].Message.l_message = kcg_lit_int64(0);
    outC->_L13[idx5].Message.t_train = kcg_lit_int64(0);
    outC->_L13[idx5].Message.nid_engine = kcg_lit_int64(0);
    outC->_L13[idx5].Message.field1 = kcg_lit_int64(0);
    outC->_L13[idx5].Message.field2 = kcg_lit_int64(0);
    outC->_L13[idx5].Message.field3 = kcg_lit_int64(0);
    for (idx4 = 0; idx4 < 50; idx4++) {
      outC->_L13[idx5].OptionalPackets[idx4] = kcg_lit_int64(0);
    }
  }
  ...
  for (idx6 = 0; idx6 < 50; idx6++) {
    outC->_L12.OptionalPackets[idx6] = kcg_lit_int64(0);
  }
  ...
  for (idx7 = 0; idx7 < 50; idx7++) {
    outC->_L7.OptionalPackets[idx7] = kcg_lit_int64(0);
  }
  ...
  for (idx9 = 0; idx9 < 5; idx9++) {
    ...
    outC->MessageBus_out[idx9].Message.nid_message = kcg_lit_int64(0);
    outC->MessageBus_out[idx9].Message.l_message = kcg_lit_int64(0);
    outC->MessageBus_out[idx9].Message.t_train = kcg_lit_int64(0);
    outC->MessageBus_out[idx9].Message.nid_engine = kcg_lit_int64(0);
    outC->MessageBus_out[idx9].Message.field1 = kcg_lit_int64(0);
    outC->MessageBus_out[idx9].Message.field2 = kcg_lit_int64(0);
    outC->MessageBus_out[idx9].Message.field3 = kcg_lit_int64(0);
    for (idx8 = 0; idx8 < 50; idx8++) {
      outC->MessageBus_out[idx9].OptionalPackets[idx8] = kcg_lit_int64(0);
    }
  }
}
