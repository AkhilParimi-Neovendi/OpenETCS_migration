  ...
  outC_RECV_ReadPackets_TM_lib_internal *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L47[idx].nid_packet = kcg_lit_int64(0);
    outC->_L47[idx].q_dir = Q_DIR_Reverse;
    outC->_L47[idx].valid = kcg_true;
    outC->_L47[idx].startAddress = kcg_lit_int64(0);
    outC->_L47[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L48[idx1] = kcg_lit_int64(0);
  }
  ...
  for (idx4 = 0; idx4 < 500; idx4++) {
    outC->_L44[idx4] = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L4[idx5] = kcg_lit_int64(0);
  }
  outC->_L1 = kcg_true;
  ...
  for (idx6 = 0; idx6 < 500; idx6++) {
    outC->Data[idx6] = kcg_lit_int64(0);
  }
  /* _L4=(TM_lib_internal::RECV_ReadPacketKernel#1)/ */
