...
typedef struct {
  ...
  kcg_int64 /* IfBlock1:else:else:then:_L8/ */ _L8_then_else_else_IfBlock1;
...
typedef struct {
  ...
  M_TrainTrackRadioOutputBuffer_t_TM_lib_internal /* buffer/ */ Context_buffer;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
} SV_BufferOutput_TM_lib_internal;

extern void kcg_save_SV_BufferOutput_TM_lib_internal(
  SV_BufferOutput_TM_lib_internal *SV,
  outC_BufferOutput_TM_lib_internal *outC);
extern void kcg_load_SV_BufferOutput_TM_lib_internal(
  outC_BufferOutput_TM_lib_internal *outC,
  SV_BufferOutput_TM_lib_internal *SV);
