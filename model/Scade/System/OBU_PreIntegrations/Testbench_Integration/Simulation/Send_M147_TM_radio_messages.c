  ...
  outC_Send_M147_TM_radio_messages *outC)
{
  ...
  kcg_copy_array_int64_33(&outC->_L92[17], &outC->_L86);
...
void Send_M147_init_TM_radio_messages(outC_Send_M147_TM_radio_messages *outC)
{
  ...
  outC->_L103.Message.nid_message = kcg_lit_int64(0);
  outC->_L103.Message.l_message = kcg_lit_int64(0);
  outC->_L103.Message.t_train = kcg_lit_int64(0);
  outC->_L103.Message.nid_engine = kcg_lit_int64(0);
  outC->_L103.Message.field1 = kcg_lit_int64(0);
  outC->_L103.Message.field2 = kcg_lit_int64(0);
  outC->_L103.Message.field3 = kcg_lit_int64(0);
  for (idx = 0; idx < 50; idx++) {
    outC->_L103.OptionalPackets[idx] = kcg_lit_int64(0);
  }
  for (idx2 = 0; idx2 < 5; idx2++) {
    outC->_L100[idx2].Message.valid = kcg_true;
    outC->_L100[idx2].Message.nid_message = kcg_lit_int64(0);
    outC->_L100[idx2].Message.l_message = kcg_lit_int64(0);
    outC->_L100[idx2].Message.t_train = kcg_lit_int64(0);
    outC->_L100[idx2].Message.nid_engine = kcg_lit_int64(0);
    outC->_L100[idx2].Message.field1 = kcg_lit_int64(0);
    outC->_L100[idx2].Message.field2 = kcg_lit_int64(0);
    outC->_L100[idx2].Message.field3 = kcg_lit_int64(0);
    for (idx1 = 0; idx1 < 50; idx1++) {
      outC->_L100[idx2].OptionalPackets[idx1] = kcg_lit_int64(0);
    }
  }
  outC->_L101 = kcg_lit_int64(0);
  outC->_L102.Message.valid = kcg_true;
  outC->_L102.Message.nid_message = kcg_lit_int64(0);
  outC->_L102.Message.l_message = kcg_lit_int64(0);
  outC->_L102.Message.t_train = kcg_lit_int64(0);
  outC->_L102.Message.nid_engine = kcg_lit_int64(0);
  outC->_L102.Message.field1 = kcg_lit_int64(0);
  outC->_L102.Message.field2 = kcg_lit_int64(0);
  outC->_L102.Message.field3 = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 50; idx3++) {
    outC->_L102.OptionalPackets[idx3] = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 5; idx5++) {
    outC->_L104[idx5].Message.valid = kcg_true;
    outC->_L104[idx5].Message.nid_message = kcg_lit_int64(0);
    outC->_L104[idx5].Message.l_message = kcg_lit_int64(0);
    outC->_L104[idx5].Message.t_train = kcg_lit_int64(0);
    outC->_L104[idx5].Message.nid_engine = kcg_lit_int64(0);
    outC->_L104[idx5].Message.field1 = kcg_lit_int64(0);
    outC->_L104[idx5].Message.field2 = kcg_lit_int64(0);
    outC->_L104[idx5].Message.field3 = kcg_lit_int64(0);
    for (idx4 = 0; idx4 < 50; idx4++) {
      outC->_L104[idx5].OptionalPackets[idx4] = kcg_lit_int64(0);
    }
  }
  for (idx6 = 0; idx6 < 17; idx6++) {
    outC->_L83[idx6] = kcg_lit_int64(0);
  }
  for (idx7 = 0; idx7 < 17; idx7++) {
    outC->_L84[idx7] = kcg_lit_int64(0);
  }
  for (idx8 = 0; idx8 < 33; idx8++) {
    outC->_L86[idx8] = kcg_lit_int64(0);
  }
  outC->_L87 = kcg_true;
  outC->_L88 = kcg_true;
  outC->_L89 = kcg_true;
  for (idx9 = 0; idx9 < 17; idx9++) {
    outC->_L90[idx9] = kcg_lit_int64(0);
  }
  for (idx10 = 0; idx10 < 50; idx10++) {
    outC->_L92[idx10] = kcg_lit_int64(0);
  }
  outC->_L93 = kcg_lit_int64(0);
  outC->_L94 =
  ...
  outC->_L96.nid_lrbg = kcg_lit_int64(0);
  outC->_L96.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L96.d_lrbg = kcg_lit_int64(0);
  outC->_L96.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L96.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L96.l_doubtover = kcg_lit_int64(0);
  outC->_L96.l_doubtunder = kcg_lit_int64(0);
  outC->_L96.q_length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L96.l_trainint = kcg_lit_int64(0);
  outC->_L96.v_train = kcg_lit_int64(0);
  outC->_L96.q_dirtrain = Q_DIRTRAIN_Reverse;
  outC->_L96.m_mode = M_MODE_Full_Supervision;
  outC->_L96.m_level = M_LEVEL_Level_0;
  outC->_L96.nid_ntc = kcg_lit_int64(0);
  ...
  for (idx12 = 0; idx12 < 5; idx12++) {
    ...
    outC->MessageBus_out[idx12].Message.nid_message = kcg_lit_int64(0);
    outC->MessageBus_out[idx12].Message.l_message = kcg_lit_int64(0);
    outC->MessageBus_out[idx12].Message.t_train = kcg_lit_int64(0);
    outC->MessageBus_out[idx12].Message.nid_engine = kcg_lit_int64(0);
    outC->MessageBus_out[idx12].Message.field1 = kcg_lit_int64(0);
    outC->MessageBus_out[idx12].Message.field2 = kcg_lit_int64(0);
    outC->MessageBus_out[idx12].Message.field3 = kcg_lit_int64(0);
    for (idx11 = 0; idx11 < 50; idx11++) {
      outC->MessageBus_out[idx12].OptionalPackets[idx11] = kcg_lit_int64(0);
    }
  }
  /* _L100=(TM_TrainTrack_Bus::MergeMessageToBus#1)/ */
...
void kcg_save_SV_Send_M147_TM_radio_messages(
  SV_Send_M147_TM_radio_messages *SV,
  outC_Send_M147_TM_radio_messages *outC)
{
...
void kcg_load_SV_Send_M147_TM_radio_messages(
  outC_Send_M147_TM_radio_messages *outC,
  SV_Send_M147_TM_radio_messages *SV)
{
