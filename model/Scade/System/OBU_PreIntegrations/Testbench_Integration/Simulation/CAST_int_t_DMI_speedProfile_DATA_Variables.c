  ...
  outC_CAST_int_t_DMI_speedProfile_DATA_Variables *outC)
{
  ...
  kcg_copy_array_int32_32(&outC->_L20, (array_int32_32 *) &outC->_L13[1]);
  kcg_copy_array_int32_32(&outC->_L21, (array_int32_32 *) &outC->_L13[33]);
  kcg_copy_array_int32_32(&outC->_L24, (array_int32_32 *) &outC->_L13[65]);
  kcg_copy_array_int32_32(&outC->_L25, (array_int32_32 *) &outC->_L13[97]);
  /* _L23= */
  ...
  outC_CAST_int_t_DMI_speedProfile_DATA_Variables *outC)
{
  ...
  for (idx3 = 0; idx3 < 32; idx3++) {
    ...
    outC->_L23[idx3].Loc_Abs = kcg_lit_int32(0);
    outC->_L23[idx3].Loc_LRBG = kcg_lit_int32(0);
    outC->_L23[idx3].MRS = kcg_lit_int32(0);
  }
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->_L24[idx4] = kcg_lit_int32(0);
  }
  ...
  for (idx6 = 0; idx6 < 32; idx6++) {
    ...
    outC->_L26.speedProfiles[idx6].Loc_Abs = kcg_lit_int32(0);
    outC->_L26.speedProfiles[idx6].Loc_LRBG = kcg_lit_int32(0);
    outC->_L26.speedProfiles[idx6].MRS = kcg_lit_int32(0);
  }
  outC->_L27 = kcg_true;
  for (idx7 = 0; idx7 < 129; idx7++) {
    outC->_L13[idx7] = kcg_lit_int32(0);
  }
  ...
  for (idx8 = 0; idx8 < 32; idx8++) {
    ...
    outC->dmi_speedProfile.speedProfiles[idx8].Loc_Abs = kcg_lit_int32(0);
    outC->dmi_speedProfile.speedProfiles[idx8].Loc_LRBG = kcg_lit_int32(0);
    outC->dmi_speedProfile.speedProfiles[idx8].MRS = kcg_lit_int32(0);
  }
  for (idx = 0; idx < 32; idx++) {
    /* _L23=(DATA::Variables::CAST_int_to_DMI_speedProfileElement#2)/ */
