  ...
  outC_improveUnlinkedBGLocations_itr_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  ...
  if ((kcg_lit_int64(0) <= outC->_L10) & (outC->_L10 < kcg_lit_int64(41))) {
    kcg_copy_positionedBG_T_TrainPosition_Types_Pck(
      &outC->_L16,
      &outC->_L1[outC->_L10]);
  }
  ...
  if ((kcg_lit_int64(0) <= outC->_L5) & (outC->_L5 < kcg_lit_int64(41))) {
    kcg_copy_positionedBG_T_TrainPosition_Types_Pck(
      &outC->_L2,
      &outC->_L1[outC->_L5]);
  }
  ...
  outC_improveUnlinkedBGLocations_itr_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  ...
  for (idx = 0; idx < 33; idx++) {
    ...
    outC->_L17.infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L17.infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int64(0);
    outC->_L17.infoFromPassing.linkedBGs[idx].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L17.infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int64(0);
    outC->_L17.infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int64(0);
    outC->_L17.infoFromPassing.linkedBGs[idx].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L17.infoFromPassing.linkedBGs[idx].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L17.infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L16.infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L16.infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int64(0);
    outC->_L16.infoFromPassing.linkedBGs[idx1].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L16.infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int64(0);
    outC->_L16.infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int64(0);
    outC->_L16.infoFromPassing.linkedBGs[idx1].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L16.infoFromPassing.linkedBGs[idx1].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L16.infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx2 = 0; idx2 < 33; idx2++) {
    ...
    outC->_L15.infoFromPassing.linkedBGs[idx2].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L15.infoFromPassing.linkedBGs[idx2].d_link = kcg_lit_int64(0);
    outC->_L15.infoFromPassing.linkedBGs[idx2].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L15.infoFromPassing.linkedBGs[idx2].nid_c = kcg_lit_int64(0);
    outC->_L15.infoFromPassing.linkedBGs[idx2].nid_bg = kcg_lit_int64(0);
    outC->_L15.infoFromPassing.linkedBGs[idx2].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L15.infoFromPassing.linkedBGs[idx2].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L15.infoFromPassing.linkedBGs[idx2].q_locacc = kcg_lit_int64(0);
  }
  ...
  outC->_L4.previousLinkedBG_idx = kcg_lit_int64(0);
  outC->_L4.currentIndex = kcg_lit_int64(0);
  outC->_L4.subsequentLinkedBG_idx = kcg_lit_int64(0);
  ...
  for (idx5 = 0; idx5 < 41; idx5++) {
    ...
    outC->_L1[idx5].nid_c = kcg_lit_int64(0);
    outC->_L1[idx5].nid_bg = kcg_lit_int64(0);
    outC->_L1[idx5].q_link = Q_LINK_Unlinked;
    outC->_L1[idx5].location.nominal = kcg_lit_int64(0);
    outC->_L1[idx5].location.d_min = kcg_lit_int64(0);
    outC->_L1[idx5].location.d_max = kcg_lit_int64(0);
    outC->_L1[idx5].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L1[idx5].infoFromLinking.valid = kcg_true;
    outC->_L1[idx5].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L1[idx5].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L1[idx5].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L1[idx5].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L1[idx5].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L1[idx5].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L1[idx5].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L1[idx5].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L1[idx5].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L1[idx5].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L1[idx5].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L1[idx5].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L1[idx5].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L1[idx5].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    outC->_L1[idx5].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L1[idx5].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L1[idx5].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L1[idx5].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L1[idx5].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L1[idx5].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L1[idx5].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L1[idx5].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx4 = 0; idx4 < 33; idx4++) {
      ...
      outC->_L1[idx5].infoFromPassing.linkedBGs[idx4].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L1[idx5].infoFromPassing.linkedBGs[idx4].d_link = kcg_lit_int64(0);
      outC->_L1[idx5].infoFromPassing.linkedBGs[idx4].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L1[idx5].infoFromPassing.linkedBGs[idx4].nid_c = kcg_lit_int64(0);
      outC->_L1[idx5].infoFromPassing.linkedBGs[idx4].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L1[idx5].infoFromPassing.linkedBGs[idx4].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L1[idx5].infoFromPassing.linkedBGs[idx4].q_locacc = kcg_lit_int64(0);
    }
