...
void kcg_save_SV_registeringToTheRadioNetwork_v2_MoRC_Pck_Subfunc_Pkg(
  SV_registeringToTheRadioNetwork_v2_MoRC_Pck_Subfunc_Pkg *SV,
  outC_registeringToTheRadioNetwork_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  kcg_save_SV_RisingEdge_digital(
    &SV->Context_RisingEdge_7,
    &outC->Context_RisingEdge_7);
  kcg_save_SV_RisingEdge_digital(
    &SV->Context_RisingEdge_6,
    &outC->Context_RisingEdge_6);
  ...
  SV->Context_resetDelayedOrderFlag = outC->resetDelayedOrderFlag;
  SV->Context_Register_SM_reset_nxt = outC->Register_SM_reset_nxt;
  SV->Context_Register_SM_reset_act = outC->Register_SM_reset_act;
  SV->Context_Register_SM_state_nxt = outC->Register_SM_state_nxt;
  SV->Context__L2_FlipFlopSet_1 = outC->_L2_FlipFlopSet_1;
  kcg_copy_P45_RadioNetworkRegistration_T_Packet_Types_Pkg(
    &SV->Context__L8_Memory_5,
    &outC->_L8_Memory_5_struct);
  kcg_copy_P45_RadioNetworkRegistration_T_Packet_Types_Pkg(
    &SV->Context__L8_Memory_4,
    &outC->_L8_Memory_4_struct);
  kcg_copy_P45_RadioNetworkRegistration_T_Packet_Types_Pkg(
...
void kcg_load_SV_registeringToTheRadioNetwork_v2_MoRC_Pck_Subfunc_Pkg(
  outC_registeringToTheRadioNetwork_v2_MoRC_Pck_Subfunc_Pkg *outC,
  SV_registeringToTheRadioNetwork_v2_MoRC_Pck_Subfunc_Pkg *SV)
{
  ...
  kcg_load_SV_RisingEdge_digital(
    &outC->Context_RisingEdge_8,
    &SV->Context_RisingEdge_8);
  outC->resetDelayedOrderFlag = SV->Context_resetDelayedOrderFlag;
  outC->Register_SM_reset_nxt = SV->Context_Register_SM_reset_nxt;
  outC->Register_SM_reset_act = SV->Context_Register_SM_reset_act;
  outC->Register_SM_state_nxt = SV->Context_Register_SM_state_nxt;
