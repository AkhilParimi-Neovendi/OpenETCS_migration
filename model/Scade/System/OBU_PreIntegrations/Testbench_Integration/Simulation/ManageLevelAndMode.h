...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_ManageLevels Context_ManageLevels_1;
  SV_ManageModes Context_ManageModes_1;
  SV_Output Context_Output_1;
} SV_ManageLevelAndMode;

extern void kcg_save_SV_ManageLevelAndMode(
  SV_ManageLevelAndMode *SV,
  outC_ManageLevelAndMode *outC);
extern void kcg_load_SV_ManageLevelAndMode(
  outC_ManageLevelAndMode *outC,
  SV_ManageLevelAndMode *SV);
