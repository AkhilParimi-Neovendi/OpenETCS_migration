  ...
  outC_C_P058_to_legacy_t_TM_conversions *outC)
{
  ...
  for (idx2 = 0; idx2 < 2; idx2++) {
    for (idx1 = 0; idx1 < 32; idx1++) {
      ...
      outC->_L22[idx2][idx1].d_loc = kcg_lit_int32(0);
      outC->_L22[idx2][idx1].q_lgtloc = Q_LGTLOC_Min_safe_rear_end;
    }
  }
  for (idx3 = 0; idx3 < 2; idx3++) {
    outC->_L20[idx3].d_loc = kcg_lit_int32(0);
  ...
  for (idx4 = 0; idx4 < 32; idx4++) {
    ...
    outC->_L10[idx4].d_loc = kcg_lit_int32(0);
  ...
  for (idx5 = 0; idx5 < 2; idx5++) {
    outC->_L2.iterPacket58List[idx5].d_loc = kcg_lit_int32(0);
  ...
  for (idx7 = 0; idx7 < 2; idx7++) {
    outC->P058_legacy_out.iterPacket58List[idx7].d_loc = kcg_lit_int32(0);
