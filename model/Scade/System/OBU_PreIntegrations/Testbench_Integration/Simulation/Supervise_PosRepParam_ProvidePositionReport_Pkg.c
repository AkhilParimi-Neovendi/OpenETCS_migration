  ...
  outC_Supervise_PosRepParam_ProvidePositionReport_Pkg *outC)
{
  ...
  for (idx = 0; idx < 2; idx++) {
    outC->_L6[idx].d_loc = kcg_lit_int32(0);
  ...
  for (idx1 = 0; idx1 < 2; idx1++) {
    outC->_L1.iterPacket58List[idx1].d_loc = kcg_lit_int32(0);
  ...
  for (idx2 = 0; idx2 < 33; idx2++) {
    ...
    outC->_L4.LRBG.infoFromPassing.linkedBGs[idx2].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L4.LRBG.infoFromPassing.linkedBGs[idx2].d_link = kcg_lit_int32(0);
    outC->_L4.LRBG.infoFromPassing.linkedBGs[idx2].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L4.LRBG.infoFromPassing.linkedBGs[idx2].nid_c = kcg_lit_int32(0);
    outC->_L4.LRBG.infoFromPassing.linkedBGs[idx2].nid_bg = kcg_lit_int32(0);
    ...
    outC->_L4.LRBG.infoFromPassing.linkedBGs[idx2].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L4.LRBG.infoFromPassing.linkedBGs[idx2].q_locacc = kcg_lit_int32(0);
  }
  ...
  for (idx3 = 0; idx3 < 33; idx3++) {
    ...
    outC->_L4.prvLRBG.infoFromPassing.linkedBGs[idx3].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L4.prvLRBG.infoFromPassing.linkedBGs[idx3].d_link = kcg_lit_int32(0);
    outC->_L4.prvLRBG.infoFromPassing.linkedBGs[idx3].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L4.prvLRBG.infoFromPassing.linkedBGs[idx3].nid_c = kcg_lit_int32(0);
    outC->_L4.prvLRBG.infoFromPassing.linkedBGs[idx3].nid_bg = kcg_lit_int32(0);
    ...
    outC->_L4.prvLRBG.infoFromPassing.linkedBGs[idx3].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L4.prvLRBG.infoFromPassing.linkedBGs[idx3].q_locacc = kcg_lit_int32(0);
  }
...
void kcg_save_SV_Supervise_PosRepParam_ProvidePositionReport_Pkg(
  SV_Supervise_PosRepParam_ProvidePositionReport_Pkg *SV,
  outC_Supervise_PosRepParam_ProvidePositionReport_Pkg *outC)
{
  kcg_save_SV_Supervision_T_Cycloc_ProvidePositionReport_Pkg(
    &SV->Context_Supervision_T_Cycloc_1,
    &outC->Context_Supervision_T_Cycloc_1);
  kcg_save_SV_Supervision_M_Loc_ProvidePositionReport_Pkg(
    &SV->Context_Supervision_M_Loc_1,
    &outC->Context_Supervision_M_Loc_1);
}

void kcg_load_SV_Supervise_PosRepParam_ProvidePositionReport_Pkg(
  outC_Supervise_PosRepParam_ProvidePositionReport_Pkg *outC,
  SV_Supervise_PosRepParam_ProvidePositionReport_Pkg *SV)
{
  kcg_load_SV_Supervision_T_Cycloc_ProvidePositionReport_Pkg(
    &outC->Context_Supervision_T_Cycloc_1,
    &SV->Context_Supervision_T_Cycloc_1);
  kcg_load_SV_Supervision_M_Loc_ProvidePositionReport_Pkg(
    &outC->Context_Supervision_M_Loc_1,
    &SV->Context_Supervision_M_Loc_1);
}
