...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ----------------------- local memories  ------------------------- */
  _134_SSM_ST_SM1 /* SM1: */ SM1_state_nxt;
  ...
  _134_SSM_ST_SM1 /* SM1: */ SM1_state_act;
  /* -------------------- (-debug) no assertions  -------------------- */
  ...
  _134_SSM_ST_SM1 /* SM1: */ SM1_state_sel;
  _135_SSM_TR_SM1 /* SM1: */ SM1_fired_strong;
  _135_SSM_TR_SM1 /* SM1: */ SM1_fired;
...
typedef struct {
  ...
  _134_SSM_ST_SM1 /* SM1: */ Context_SM1_state_nxt;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
} SV_RequestAck_Acknowledgement;

extern void kcg_save_SV_RequestAck_Acknowledgement(
  SV_RequestAck_Acknowledgement *SV,
  outC_RequestAck_Acknowledgement *outC);
extern void kcg_load_SV_RequestAck_Acknowledgement(
  outC_RequestAck_Acknowledgement *outC,
  SV_RequestAck_Acknowledgement *SV);
