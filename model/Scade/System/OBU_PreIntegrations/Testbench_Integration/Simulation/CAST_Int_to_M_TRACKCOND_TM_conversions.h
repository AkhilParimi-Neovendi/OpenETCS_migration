...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  M_TRACKCOND /* m_trackcond/ */ m_trackcond;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  M_TRACKCOND /* IfBlock1:then:_L4/ */ _L4_then_IfBlock1;
  kcg_bool /* IfBlock1:else:else:then:_L4/ */ _L4_then_else_else_IfBlock1;
  M_TRACKCOND /* IfBlock1:else:else:then:_L2/ */ _L2_then_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:then:_L4/ */ _L4_then_else_else_else_else_IfBlock1;
  M_TRACKCOND /* IfBlock1:else:else:else:else:then:_L2/ */ _L2_then_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:then:_L4/ */ _L4_then_else_else_else_else_else_else_IfBlock1;
  M_TRACKCOND /* IfBlock1:else:else:else:else:else:else:then:_L2/ */ _L2_then_else_else_else_else_else_else_IfBlock1;
  ...
  M_TRACKCOND /* IfBlock1:else:else:else:else:else:else:else:else:then:_L3/ */ _L3_then_else_else_else_else_else_else_else_else_IfBlock1;
  ...
  M_TRACKCOND /* IfBlock1:else:else:else:else:else:else:else:else:else:else:then:_L2/ */ _L2_then_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  M_TRACKCOND /* IfBlock1:else:else:else:else:else:else:else:else:else:else:else:_L1/ */ _L1_else_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  ...
  M_TRACKCOND /* IfBlock1:else:else:else:else:else:else:else:else:else:then:_L2/ */ _L2_then_else_else_else_else_else_else_else_else_else_IfBlock1;
  ...
  M_TRACKCOND /* IfBlock1:else:else:else:else:else:else:else:then:_L2/ */ _L2_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L4/ */ _L4_then_else_else_else_else_else_else_else_IfBlock1;
  M_TRACKCOND /* IfBlock1:else:else:else:else:else:then:_L2/ */ _L2_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L4/ */ _L4_then_else_else_else_else_else_IfBlock1;
  M_TRACKCOND /* IfBlock1:else:else:else:then:_L2/ */ _L2_then_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:then:_L4/ */ _L4_then_else_else_else_IfBlock1;
  M_TRACKCOND /* IfBlock1:else:then:_L3/ */ _L3_then_else_IfBlock1;
  kcg_bool /* IfBlock1:else:then:_L5/ */ _L5_then_else_IfBlock1;
  kcg_int64 /* m_trackcond_in/ */ m_trackcond_in;
  kcg_bool /* error/ */ error;
  kcg_int64 /* _L4/ */ _L4;
  kcg_bool /* _L5/ */ _L5;
} outC_CAST_Int_to_M_TRACKCOND_TM_conversions;

/* ===========  node initialization and cycle functions  =========== */
/* TM_conversions::CAST_Int_to_M_TRACKCOND/ */
extern void CAST_Int_to_M_TRACKCOND_TM_conversions(
  /* m_trackcond_int/ */
  kcg_int64 m_trackcond_int,
  outC_CAST_Int_to_M_TRACKCOND_TM_conversions *outC);

#ifndef KCG_NO_EXTERN_CALL_TO_RESET
extern void CAST_Int_to_M_TRACKCOND_reset_TM_conversions(
  outC_CAST_Int_to_M_TRACKCOND_TM_conversions *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CAST_Int_to_M_TRACKCOND_init_TM_conversions(
  outC_CAST_Int_to_M_TRACKCOND_TM_conversions *outC);
