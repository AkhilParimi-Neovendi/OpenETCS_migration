...
void ManageAck_init_Acknowledgement(outC_ManageAck_Acknowledgement *outC)
{
  ...
  outC->_L9.estimatedFrontEndPosition = kcg_lit_int64(0);
  outC->_L9.minSafeFrontEndPosition = kcg_lit_int64(0);
  outC->_L9.maxSafeFrontEndPostion = kcg_lit_int64(0);
  outC->_L9.LRBG.valid = kcg_true;
  outC->_L9.LRBG.nid_c = kcg_lit_int64(0);
  outC->_L9.LRBG.nid_bg = kcg_lit_int64(0);
  outC->_L9.LRBG.q_link = Q_LINK_Unlinked;
  outC->_L9.LRBG.location.nominal = kcg_lit_int64(0);
  outC->_L9.LRBG.location.d_min = kcg_lit_int64(0);
  outC->_L9.LRBG.location.d_max = kcg_lit_int64(0);
  outC->_L9.LRBG.seqNoOnTrack = kcg_lit_int64(0);
  outC->_L9.LRBG.infoFromLinking.valid = kcg_true;
  outC->_L9.LRBG.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L9.LRBG.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->_L9.LRBG.infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
  outC->_L9.LRBG.infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
  outC->_L9.LRBG.infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
  outC->_L9.LRBG.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L9.LRBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L9.LRBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->_L9.LRBG.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->_L9.LRBG.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  ...
  outC->_L9.LRBG.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L9.LRBG.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L9.LRBG.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L9.LRBG.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L9.LRBG.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->_L9.LRBG.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L9.LRBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L9.LRBG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L9.LRBG.infoFromPassing.BG_Header.bgPosition.timestamp = kcg_lit_int64(
      0);
  outC->_L9.LRBG.infoFromPassing.BG_Header.bgPosition.odo.o_nominal =
    kcg_lit_int64(0);
  outC->_L9.LRBG.infoFromPassing.BG_Header.bgPosition.odo.o_min = kcg_lit_int64(
      0);
  outC->_L9.LRBG.infoFromPassing.BG_Header.bgPosition.odo.o_max = kcg_lit_int64(
      0);
  ...
  outC->_L9.LRBG.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L9.LRBG.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx = 0; idx < 33; idx++) {
    ...
    outC->_L9.LRBG.infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L9.LRBG.infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int64(0);
    outC->_L9.LRBG.infoFromPassing.linkedBGs[idx].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L9.LRBG.infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int64(0);
    outC->_L9.LRBG.infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int64(0);
    outC->_L9.LRBG.infoFromPassing.linkedBGs[idx].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L9.LRBG.infoFromPassing.linkedBGs[idx].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L9.LRBG.infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int64(0);
  }
  outC->_L9.LRBG.missed = kcg_true;
  outC->_L9.prvLRBG.valid = kcg_true;
  outC->_L9.prvLRBG.nid_c = kcg_lit_int64(0);
  outC->_L9.prvLRBG.nid_bg = kcg_lit_int64(0);
  outC->_L9.prvLRBG.q_link = Q_LINK_Unlinked;
  outC->_L9.prvLRBG.location.nominal = kcg_lit_int64(0);
  outC->_L9.prvLRBG.location.d_min = kcg_lit_int64(0);
  outC->_L9.prvLRBG.location.d_max = kcg_lit_int64(0);
  outC->_L9.prvLRBG.seqNoOnTrack = kcg_lit_int64(0);
  outC->_L9.prvLRBG.infoFromLinking.valid = kcg_true;
  outC->_L9.prvLRBG.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L9.prvLRBG.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->_L9.prvLRBG.infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
  outC->_L9.prvLRBG.infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
  outC->_L9.prvLRBG.infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
  outC->_L9.prvLRBG.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L9.prvLRBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L9.prvLRBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->_L9.prvLRBG.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->_L9.prvLRBG.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  ...
  outC->_L9.prvLRBG.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L9.prvLRBG.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L9.prvLRBG.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L9.prvLRBG.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L9.prvLRBG.infoFromLinking.linkingInfo.q_linkreaction =
    Q_LINKREACTION_Train_trip;
  outC->_L9.prvLRBG.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->_L9.prvLRBG.infoFromPassing.BG_Header.n_total =
    N_TOTAL_1_balise_in_the_group;
  outC->_L9.prvLRBG.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L9.prvLRBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L9.prvLRBG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L9.prvLRBG.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L9.prvLRBG.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L9.prvLRBG.infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L9.prvLRBG.infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int64(0);
    outC->_L9.prvLRBG.infoFromPassing.linkedBGs[idx1].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L9.prvLRBG.infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int64(0);
    outC->_L9.prvLRBG.infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L9.prvLRBG.infoFromPassing.linkedBGs[idx1].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L9.prvLRBG.infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int64(0);
  }
  ...
  outC->_L9.estimatedRearEndPosition = kcg_lit_int64(0);
  outC->_L9.minSafeRearEndPosition = kcg_lit_int64(0);
  outC->_L9.maxSafeRearEndPosition = kcg_lit_int64(0);
  outC->_L8.is_set = kcg_true;
  outC->_L8.transition.level = M_LEVEL_Level_0;
  outC->_L8.transition.position = kcg_lit_int64(0);
  outC->_L8.transition.transitionType =
    M_TransitionType_Conditional_Level_And_Mode_Types_Pkg;
  outC->_L8.transition.immediateAck = kcg_true;
  outC->_L8.transition.AckLength = kcg_lit_int64(0);
  outC->_L8.LRBG = kcg_lit_int64(0);
  outC->_L8.referenceLocation = kcg_lit_int64(0);
  outC->_L7 = kcg_true;
  outC->_L6 = kcg_true;
  outC->_L5 = M_LEVEL_Level_0;
  outC->_L4.is_set = kcg_true;
  outC->_L4.transition.level = M_LEVEL_Level_0;
  outC->_L4.transition.position = kcg_lit_int64(0);
  outC->_L4.transition.transitionType =
    M_TransitionType_Conditional_Level_And_Mode_Types_Pkg;
  outC->_L4.transition.immediateAck = kcg_true;
  outC->_L4.transition.AckLength = kcg_lit_int64(0);
  outC->_L4.LRBG = kcg_lit_int64(0);
  outC->_L4.referenceLocation = kcg_lit_int64(0);
  outC->_L3 = kcg_true;
...
void kcg_save_SV_ManageAck_Acknowledgement(
  SV_ManageAck_Acknowledgement *SV,
  outC_ManageAck_Acknowledgement *outC)
{
  kcg_save_SV_RequestAck_Acknowledgement(
    &SV->Context_RequestAck_1,
    &outC->Context_RequestAck_1);
}

void kcg_load_SV_ManageAck_Acknowledgement(
  outC_ManageAck_Acknowledgement *outC,
  SV_ManageAck_Acknowledgement *SV)
{
  kcg_load_SV_RequestAck_Acknowledgement(
    &outC->Context_RequestAck_1,
    &SV->Context_RequestAck_1);
}
