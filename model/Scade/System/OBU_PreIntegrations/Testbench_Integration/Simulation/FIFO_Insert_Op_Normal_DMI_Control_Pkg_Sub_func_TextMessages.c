  ...
  outC_FIFO_Insert_Op_Normal_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  kcg_copy__94_array(&outC->_L36, &last_queue);
  outC->_L29 = isFull;
  /* _L31/ */
  ...
  if (outC->_L21) {
    ...
    for (idx4 = 0; idx4 < 10; idx4++) {
      ...
      outC->_L22 = /* _L22= */(kcg_int32) (idx4 + 1);
      /* _L22= */
  ...
  for (idx4 = /* _L22= */(kcg_size) outC->_L22; idx4 < 10; idx4++) {
    outC->_L23[idx4] = kcg_lit_float32(-1.0);
    outC->_L24[idx4] = kcg_lit_float32(-1.0);
  }
#endif /* KCG_MAPW_CPY */

  kcg_copy_array_float32_10(&outC->mm_array, &outC->_L24);
  kcg_copy_array_float32_10(&outC->hh_array, &outC->_L23);
  noname = outC->_L22;
  outC->_L5 = Pos;
  /* _L9/ */
  ...
  kcg_copy__94_array(&outC->_L34, &outC->_L36);
  /* _L34= */
  for (idx7 = 0; idx7 < 10; idx7++) {
    kcg_copy__94_array(&acc, &outC->_L34);
  ...
  kcg_copy__94_array(&outC->queue, &outC->_L34);
}
  ...
  outC_FIFO_Insert_Op_Normal_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  for (idx3 = 0; idx3 < 10; idx3++) {
    ...
    outC->_L36[idx3].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L36[idx3].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L36[idx3].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L36[idx3].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx5 = 0; idx5 < 10; idx5++) {
    ...
    outC->_L34[idx5].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L34[idx5].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L34[idx5].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L34[idx5].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx8 = 0; idx8 < 10; idx8++) {
    outC->_L24[idx8] = kcg_lit_float32(0.0);
  }
  for (idx9 = 0; idx9 < 10; idx9++) {
    outC->_L23[idx9] = kcg_lit_float32(0.0);
  }
  outC->_L22 = kcg_lit_int32(0);
