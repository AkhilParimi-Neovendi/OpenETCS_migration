  ...
  outC_getLRBGForRadioMessage_ValidateDataDirectionGeneral_Pkg_Subfunctions *outC)
{
  ...
  for (idx1 = 0; idx1 < 41; idx1++) {
    outC->_L12[idx1] = kcg_lit_int64(0);
  }
  ...
  for (idx2 = 0; idx2 < 33; idx2++) {
    ...
    outC->_L8.infoFromPassing.linkedBGs[idx2].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L8.infoFromPassing.linkedBGs[idx2].d_link = kcg_lit_int64(0);
    outC->_L8.infoFromPassing.linkedBGs[idx2].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L8.infoFromPassing.linkedBGs[idx2].nid_c = kcg_lit_int64(0);
    outC->_L8.infoFromPassing.linkedBGs[idx2].nid_bg = kcg_lit_int64(0);
    outC->_L8.infoFromPassing.linkedBGs[idx2].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L8.infoFromPassing.linkedBGs[idx2].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L8.infoFromPassing.linkedBGs[idx2].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx4 = 0; idx4 < 33; idx4++) {
    ...
    outC->_L5.infoFromPassing.linkedBGs[idx4].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L5.infoFromPassing.linkedBGs[idx4].d_link = kcg_lit_int64(0);
    outC->_L5.infoFromPassing.linkedBGs[idx4].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L5.infoFromPassing.linkedBGs[idx4].nid_c = kcg_lit_int64(0);
    outC->_L5.infoFromPassing.linkedBGs[idx4].nid_bg = kcg_lit_int64(0);
    outC->_L5.infoFromPassing.linkedBGs[idx4].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L5.infoFromPassing.linkedBGs[idx4].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L5.infoFromPassing.linkedBGs[idx4].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx6 = 0; idx6 < 41; idx6++) {
    ...
    outC->_L2[idx6].location.nominal = kcg_lit_int64(0);
    outC->_L2[idx6].location.d_min = kcg_lit_int64(0);
    outC->_L2[idx6].location.d_max = kcg_lit_int64(0);
    outC->_L2[idx6].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L2[idx6].infoFromLinking.valid = kcg_true;
    outC->_L2[idx6].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L2[idx6].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L2[idx6].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L2[idx6].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L2[idx6].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L2[idx6].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L2[idx6].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L2[idx6].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L2[idx6].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L2[idx6].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L2[idx6].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L2[idx6].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L2[idx6].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L2[idx6].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    outC->_L2[idx6].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L2[idx6].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L2[idx6].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L2[idx6].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L2[idx6].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L2[idx6].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L2[idx6].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L2[idx6].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx5 = 0; idx5 < 33; idx5++) {
      ...
      outC->_L2[idx6].infoFromPassing.linkedBGs[idx5].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L2[idx6].infoFromPassing.linkedBGs[idx5].d_link = kcg_lit_int64(0);
      outC->_L2[idx6].infoFromPassing.linkedBGs[idx5].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L2[idx6].infoFromPassing.linkedBGs[idx5].nid_c = kcg_lit_int64(0);
      outC->_L2[idx6].infoFromPassing.linkedBGs[idx5].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L2[idx6].infoFromPassing.linkedBGs[idx5].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L2[idx6].infoFromPassing.linkedBGs[idx5].q_locacc = kcg_lit_int64(0);
    }
  ...
  for (idx7 = 0; idx7 < 30; idx7++) {
    outC->_L1.packets.PacketHeaders[idx7].nid_packet = kcg_lit_int64(0);
    outC->_L1.packets.PacketHeaders[idx7].q_dir = Q_DIR_Reverse;
    outC->_L1.packets.PacketHeaders[idx7].valid = kcg_true;
    outC->_L1.packets.PacketHeaders[idx7].startAddress = kcg_lit_int64(0);
    outC->_L1.packets.PacketHeaders[idx7].endAddress = kcg_lit_int64(0);
  }
  for (idx8 = 0; idx8 < 500; idx8++) {
    outC->_L1.packets.PacketData[idx8] = kcg_lit_int64(0);
  }
  ...
  outC->outLRBG.nid_c = kcg_lit_int64(0);
  outC->outLRBG.nid_bg = kcg_lit_int64(0);
  outC->outLRBG.q_link = Q_LINK_Unlinked;
  outC->outLRBG.location.nominal = kcg_lit_int64(0);
  outC->outLRBG.location.d_min = kcg_lit_int64(0);
  outC->outLRBG.location.d_max = kcg_lit_int64(0);
  outC->outLRBG.seqNoOnTrack = kcg_lit_int64(0);
  outC->outLRBG.infoFromLinking.valid = kcg_true;
  outC->outLRBG.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->outLRBG.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->outLRBG.infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
  outC->outLRBG.infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
  outC->outLRBG.infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
  outC->outLRBG.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->outLRBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->outLRBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->outLRBG.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->outLRBG.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  ...
  outC->outLRBG.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->outLRBG.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->outLRBG.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->outLRBG.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  outC->outLRBG.infoFromLinking.linkingInfo.q_linkorientation =
    Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
  outC->outLRBG.infoFromLinking.linkingInfo.q_linkreaction =
    Q_LINKREACTION_Train_trip;
  outC->outLRBG.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->outLRBG.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->outLRBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->outLRBG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->outLRBG.infoFromPassing.BG_Header.bgPosition.timestamp = kcg_lit_int64(0);
  outC->outLRBG.infoFromPassing.BG_Header.bgPosition.odo.o_nominal =
    kcg_lit_int64(0);
  outC->outLRBG.infoFromPassing.BG_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->outLRBG.infoFromPassing.BG_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
  ...
  outC->outLRBG.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->outLRBG.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx9 = 0; idx9 < 33; idx9++) {
    ...
    outC->outLRBG.infoFromPassing.linkedBGs[idx9].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->outLRBG.infoFromPassing.linkedBGs[idx9].d_link = kcg_lit_int64(0);
    outC->outLRBG.infoFromPassing.linkedBGs[idx9].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->outLRBG.infoFromPassing.linkedBGs[idx9].nid_c = kcg_lit_int64(0);
    outC->outLRBG.infoFromPassing.linkedBGs[idx9].nid_bg = kcg_lit_int64(0);
    outC->outLRBG.infoFromPassing.linkedBGs[idx9].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->outLRBG.infoFromPassing.linkedBGs[idx9].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->outLRBG.infoFromPassing.linkedBGs[idx9].q_locacc = kcg_lit_int64(0);
  }
  outC->outLRBG.missed = kcg_true;
  for (idx = 0; idx < 41; idx++) {
    /* _L5=(ValidateDataDirectionGeneral_Pkg::Subfunctions::getLRBGForRadioMessageIterator#1)/ */
    getLRBGForRadioMessageIterator_init_ValidateDataDirectionGeneral_Pkg_Subfunctions(
  ...
  outC_getLRBGForRadioMessage_ValidateDataDirectionGeneral_Pkg_Subfunctions *outC)
{
  ...
  for (idx = 0; idx < 41; idx++) {
    /* _L5=(ValidateDataDirectionGeneral_Pkg::Subfunctions::getLRBGForRadioMessageIterator#1)/ */
    getLRBGForRadioMessageIterator_reset_ValidateDataDirectionGeneral_Pkg_Subfunctions(
      &outC->Context_getLRBGForRadioMessageIterator_1[idx]);
  }
  /* _L9=(TM::Decode_NID_LRBG#1)/ */
