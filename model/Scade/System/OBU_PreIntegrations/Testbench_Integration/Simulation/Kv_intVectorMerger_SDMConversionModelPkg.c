...
{
  kcg_copy_array_int64_2(&outC->_L51, indices_in);
  ...
  if ((kcg_lit_int64(0) <= outC->_L48) & (outC->_L48 < kcg_lit_int64(6))) {
    outC->_L44 = outC->_L49[outC->_L48];
  }
  else {
    outC->_L44 = kcg_lit_int64(0);
  }
  outC->I2_Max_1_int64 = outC->_L44;
  outC->_L2_Max_1_int64 = outC->I2_Max_1_int64;
  kcg_copy_array_int64_2(&outC->_L47, indices_in);
  ...
  if ((kcg_lit_int64(0) <= outC->_L50) & (outC->_L50 < kcg_lit_int64(7))) {
    outC->_L45 = outC->_L42[outC->_L50];
  }
  else {
    outC->_L45 = kcg_lit_int64(0);
  }
  outC->I1_Max_1_int64 = outC->_L45;
  ...
  kcg_copy_array_int64_2(&outC->_L21, indices_in);
  ...
  if ((kcg_lit_int64(0) <= outC->_L26) & (outC->_L26 < kcg_lit_int64(6))) {
    outC->_L18 = outC->_L15[outC->_L26];
  }
  else {
    outC->_L18 = kcg_lit_int64(0);
  }
  kcg_copy_array_int64_2(&outC->_L19, indices_in);
  ...
  if ((kcg_lit_int64(0) <= outC->_L24) & (outC->_L24 < kcg_lit_int64(7))) {
  ...
  outC->_L54 = outC->Ma_Output_Max_1_int64;
  /* _L31= */
  if (outC->_L58) {
    outC->_L31 = outC->_L26;
  }
  ...
  outC->v = outC->_L54;
  outC->a = outC->_L12;
  kcg_copy_array_int64_2(&outC->indices_out, &outC->_L28);
}
  ...
  outC_Kv_intVectorMerger_SDMConversionModelPkg *outC)
{
  ...
  for (idx1 = 0; idx1 < 6; idx1++) {
    outC->_L43.a[idx1] = kcg_lit_int64(0);
  }
  for (idx2 = 0; idx2 < 6; idx2++) {
    outC->_L43.v[idx2] = kcg_lit_int64(0);
  }
  outC->_L44 = kcg_lit_int64(0);
  outC->_L45 = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 7; idx3++) {
    outC->_L46.m[idx3] = kcg_lit_int64(0);
  }
  for (idx4 = 0; idx4 < 7; idx4++) {
    outC->_L46.v[idx4] = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 2; idx5++) {
    outC->_L47[idx5] = kcg_lit_int64(0);
  }
  outC->_L48 = kcg_lit_int64(0);
  for (idx6 = 0; idx6 < 6; idx6++) {
    outC->_L49[idx6] = kcg_lit_int64(0);
  }
  ...
  for (idx8 = 0; idx8 < 2; idx8++) {
    outC->_L28[idx8] = kcg_lit_int64(0);
  }
  outC->_L27 = kcg_true;
  ...
  for (idx9 = 0; idx9 < 6; idx9++) {
    outC->_L15[idx9] = kcg_lit_int64(0);
  }
  for (idx10 = 0; idx10 < 7; idx10++) {
    outC->_L16.m[idx10] = kcg_lit_int64(0);
  }
  for (idx11 = 0; idx11 < 7; idx11++) {
    outC->_L16.v[idx11] = kcg_lit_int64(0);
  }
  for (idx12 = 0; idx12 < 7; idx12++) {
    outC->_L17[idx12] = kcg_lit_int64(0);
  }
  outC->_L18 = kcg_lit_int64(0);
  for (idx13 = 0; idx13 < 2; idx13++) {
    outC->_L19[idx13] = kcg_lit_int64(0);
  }
  for (idx14 = 0; idx14 < 6; idx14++) {
    outC->_L20.a[idx14] = kcg_lit_int64(0);
  }
  for (idx15 = 0; idx15 < 6; idx15++) {
    outC->_L20.v[idx15] = kcg_lit_int64(0);
  }
  for (idx16 = 0; idx16 < 2; idx16++) {
    outC->_L21[idx16] = kcg_lit_int64(0);
  }
  ...
  for (idx17 = 0; idx17 < 7; idx17++) {
    outC->_L8[idx17] = kcg_lit_int64(0);
  }
  for (idx18 = 0; idx18 < 6; idx18++) {
    outC->_L7[idx18] = kcg_lit_int64(0);
  }
  for (idx19 = 0; idx19 < 2; idx19++) {
    outC->_L6[idx19] = kcg_lit_int64(0);
  }
  outC->_L5 = kcg_lit_int64(0);
  outC->_L4 = kcg_lit_int64(0);
  for (idx20 = 0; idx20 < 6; idx20++) {
    outC->_L3.a[idx20] = kcg_lit_int64(0);
  }
  for (idx21 = 0; idx21 < 6; idx21++) {
    outC->_L3.v[idx21] = kcg_lit_int64(0);
  }
  for (idx22 = 0; idx22 < 7; idx22++) {
    outC->_L2.m[idx22] = kcg_lit_int64(0);
  }
  for (idx23 = 0; idx23 < 7; idx23++) {
    outC->_L2.v[idx23] = kcg_lit_int64(0);
  }
  for (idx24 = 0; idx24 < 2; idx24++) {
    outC->_L1[idx24] = kcg_lit_int64(0);
  }
  ...
  outC->a = kcg_lit_int64(0);
  for (idx25 = 0; idx25 < 2; idx25++) {
    outC->indices_out[idx25] = kcg_lit_int64(0);
  }
}
