...
void kcg_save_SV_handleTraction_output_to_TIU_API_Pkg(
  SV_handleTraction_output_to_TIU_API_Pkg *SV,
  outC_handleTraction_output_to_TIU_API_Pkg *outC)
{
  SV->Context_tractionCutOffStatus = outC->tractionCutOffStatus;
}

void kcg_load_SV_handleTraction_output_to_TIU_API_Pkg(
  outC_handleTraction_output_to_TIU_API_Pkg *outC,
  SV_handleTraction_output_to_TIU_API_Pkg *SV)
{
  outC->tractionCutOffStatus = SV->Context_tractionCutOffStatus;
}
