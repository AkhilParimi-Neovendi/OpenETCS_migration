  ...
  outC_DMI_Toolbox *outC)
{
  ...
  outC->_L130 = kcg_lit_float32(0.0);
  ...
  kcg_copy_array_float32_5(&outC->DMI_Array_mm_toDisplay, &outC->_L200);
  kcg_copy_array_float32_5(&outC->DMI_Array_hh_toDisplay, &outC->_L199);
  kcg_copy_array_char_30_5(&outC->DMI_PlainText_toDisplay, &outC->_L198);
  outC->_L273 = kcg_false;
  kcg_copy_array_float32_32(&outC->DMI_GradientsStart_toDisplay, &outC->_L238);
  kcg_copy_array_float32_32(&outC->DMI_GradientsEnd_toDisplay, &outC->_L237);
  kcg_copy_array_float32_32(&outC->DMI_GradientsValue_toDisplay, &outC->_L241);
  ...
  kcg_copy_array_int32_9(&outC->DMI_TrainRN_Display_toDisplay, &outC->_L156);
  kcg_copy_array_int32_5(&outC->DMI_IndexFixedMsg_toDisplay, &outC->_L197);
  ...
  kcg_copy_array_int32_12(&outC->DMI_ArrayLevelIndex_toDisplay, &outC->_L194);
  ...
  kcg_copy_array_int32_30(&outC->DMI_ArrayButtonsEnabler_toDisplay, &outC->_L158);
  ...
  kcg_copy_array_int32_9(&outC->DMI_DriverID_Display_toDisplay, &outC->_L155);
  ...
  kcg_copy_array_int32_5(&outC->DMI_ArrayOfMsgIndex_toDisplay, &outC->_L165);
...
void DMI_init_Toolbox(outC_DMI_Toolbox *outC)
{
  ...
  outC->_L287 = kcg_true;
  for (idx = 0; idx < 4; idx++) {
    outC->_L286[idx] = kcg_lit_float32(0.0);
  }
  outC->_L285 = kcg_true;
  outC->_L284 = kcg_true;
  for (idx1 = 0; idx1 < 311; idx1++) {
    outC->_L283[idx1] = kcg_lit_int32(0);
  }
  ...
  outC->_L279.trainLength = kcg_lit_int32(0);
  outC->_L279.brakePerctage = kcg_lit_int32(0);
  outC->_L279.maxTrainSpeed = kcg_lit_int32(0);
  ...
  outC->_L279.axleNumber = kcg_lit_int32(0);
  outC->_L279.numberNationalSystems = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 5; idx2++) {
    outC->_L279.nationSystems[idx2] = kcg_lit_int32(0);
  }
  outC->_L279.numberTractionSystems = kcg_lit_int32(0);
  for (idx3 = 0; idx3 < 4; idx3++) {
    outC->_L279.tractionSystem[idx3].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L279.tractionSystem[idx3].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L278 = kcg_true;
  outC->_L277 = kcg_true;
  outC->_L276 = kcg_true;
  ...
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->_L237[idx4] = kcg_lit_float32(0.0);
  }
  for (idx5 = 0; idx5 < 32; idx5++) {
    outC->_L238[idx5] = kcg_lit_float32(0.0);
  }
  for (idx6 = 0; idx6 < 9; idx6++) {
    outC->_L239[idx6] = kcg_lit_float32(0.0);
  }
  outC->_L240 = kcg_true;
  for (idx7 = 0; idx7 < 32; idx7++) {
    outC->_L241[idx7] = kcg_lit_float32(0.0);
  }
  outC->_L119 = kcg_true;
  outC->_L121 = kcg_true;
  outC->_L122 = kcg_true;
  ...
  for (idx9 = 0; idx9 < 4; idx9++) {
    outC->_L207[idx9] = kcg_lit_float32(0.0);
  }
  for (idx10 = 0; idx10 < 4; idx10++) {
    outC->_L206[idx10] = kcg_lit_float32(0.0);
  }
  for (idx11 = 0; idx11 < 1; idx11++) {
    outC->_L205[idx11] = kcg_lit_float32(0.0);
  }
  for (idx12 = 0; idx12 < 10; idx12++) {
    outC->_L204[idx12] = kcg_lit_float32(0.0);
  }
  for (idx13 = 0; idx13 < 10; idx13++) {
    outC->_L203[idx13] = kcg_lit_int32(0);
  }
  ...
  for (idx15 = 0; idx15 < 5; idx15++) {
    outC->_L200[idx15] = kcg_lit_float32(0.0);
  }
  for (idx16 = 0; idx16 < 5; idx16++) {
    outC->_L199[idx16] = kcg_lit_float32(0.0);
  }
  ...
  for (idx19 = 0; idx19 < 5; idx19++) {
    outC->_L197[idx19] = kcg_lit_int32(0);
  }
  outC->_L196.valid = kcg_true;
  outC->_L196.systemTime = kcg_lit_int32(0);
  outC->_L196.level.level = M_LEVEL_Level_0;
  outC->_L196.level.nid_stm = kcg_lit_int32(0);
  outC->_L195 = kcg_lit_int32(0);
  for (idx20 = 0; idx20 < 12; idx20++) {
    outC->_L194[idx20] = kcg_lit_int32(0);
  }
  outC->_L193 = kcg_true;
  outC->_L192 = kcg_lit_int32(0);
  outC->_L191 = kcg_lit_int32(0);
  outC->_L190 = kcg_true;
  outC->_L189 = kcg_true;
  ...
  outC->_L185 = kcg_true;
  outC->_L184 = kcg_lit_float32(0.0);
  outC->_L183 = kcg_lit_int32(0);
  outC->_L182 = kcg_lit_int32(0);
  outC->_L181 = kcg_lit_int32(0);
  outC->_L180 = kcg_true;
  outC->_L179.valid = kcg_true;
  outC->_L179.systemTime = kcg_lit_int32(0);
  outC->_L179.DMI_nid_icon_identifier = kcg_lit_int32(0);
  outC->_L178 = kcg_true;
  outC->_L177 = kcg_true;
  ...
  for (idx21 = 0; idx21 < 5; idx21++) {
    outC->_L165[idx21] = kcg_lit_int32(0);
  }
  outC->_L164 = kcg_true;
  ...
  outC->_L146 = kcg_lit_float32(0.0);
  outC->_L145 = kcg_lit_float32(0.0);
  outC->_L144 = kcg_lit_float32(0.0);
  outC->_L143 = kcg_lit_float32(0.0);
  outC->_L142 = kcg_true;
  outC->_L141 = kcg_lit_float32(0.0);
  outC->_L140 = kcg_true;
  outC->_L139 = kcg_lit_int32(0);
  outC->_L138 = kcg_lit_float32(0.0);
  outC->_L209 = kcg_true;
  ...
  outC->_L118.info.brake_pressure.pressure = kcg_lit_int32(0);
  ...
  outC->_L118.info.train_data_info.trainLength = kcg_lit_int32(0);
  outC->_L118.info.train_data_info.brakePerctage = kcg_lit_int32(0);
  outC->_L118.info.train_data_info.maxTrainSpeed = kcg_lit_int32(0);
  ...
  outC->_L118.info.train_data_info.axleNumber = kcg_lit_int32(0);
  outC->_L118.info.train_data_info.numberNationalSystems = kcg_lit_int32(0);
  for (idx28 = 0; idx28 < 5; idx28++) {
    outC->_L118.info.train_data_info.nationSystems[idx28] = kcg_lit_int32(0);
  }
  outC->_L118.info.train_data_info.numberTractionSystems = kcg_lit_int32(0);
  ...
  for (idx30 = 0; idx30 < 5; idx30++) {
    outC->_L6.train_data_info.nationSystems[idx30] = kcg_lit_int32(0);
  }
  ...
  for (idx32 = 0; idx32 < 999; idx32++) {
    outC->_L17[idx32] = kcg_lit_int32(0);
  }
  for (idx33 = 0; idx33 < 4; idx33++) {
    outC->DMI_TimeArray[idx33] = kcg_lit_float32(0.0);
  }
  outC->DMI_ScrollUpEnableIndex = kcg_lit_int32(0);
  outC->DMI_ScrollDownEnableIndex = kcg_lit_int32(0);
  outC->DMI_PlanningAreaVisibility_toDisplay = kcg_true;
  for (idx34 = 0; idx34 < 9; idx34++) {
    outC->DMI_D_Scale_toDisplay[idx34] = kcg_lit_float32(0.0);
  }
  for (idx35 = 0; idx35 < 32; idx35++) {
    outC->DMI_D_GradientVisible_toDisplay[idx35] = kcg_true;
  }
  for (idx36 = 0; idx36 < 1; idx36++) {
    outC->DMI_D_PASP_IndicationMarker_toDisplay[idx36] = kcg_lit_float32(0.0);
  }
  for (idx37 = 0; idx37 < 4; idx37++) {
    outC->DMI_D_PASP_Distances_toDisplay[idx37] = kcg_lit_float32(0.0);
  }
  for (idx38 = 0; idx38 < 4; idx38++) {
    outC->DMI_D_PASP_Speeds_toDisplay[idx38] = kcg_lit_float32(0.0);
  }
  for (idx39 = 0; idx39 < 10; idx39++) {
    outC->DMI_D_SPDI_SpeedChangePosition_toDisplay[idx39] = kcg_lit_float32(0.0);
  }
  for (idx40 = 0; idx40 < 10; idx40++) {
    outC->DMI_D_SPDI_SpeedChangeIndex_toDisplay[idx40] = kcg_lit_int32(0);
  }
  ...
  for (idx42 = 0; idx42 < 5; idx42++) {
    outC->DMI_Array_mm_toDisplay[idx42] = kcg_lit_float32(0.0);
  }
  for (idx43 = 0; idx43 < 5; idx43++) {
    outC->DMI_Array_hh_toDisplay[idx43] = kcg_lit_float32(0.0);
  }
  ...
  for (idx46 = 0; idx46 < 12; idx46++) {
    outC->DMI_ArrayLevelIndex_toDisplay[idx46] = kcg_lit_int32(0);
  }
  outC->DMI_IndexLevel_toDisplay = kcg_lit_int32(0);
  ...
  for (idx47 = 0; idx47 < 5; idx47++) {
    outC->DMI_IndexFixedMsg_toDisplay[idx47] = kcg_lit_int32(0);
  }
  outC->DMI_SingleMsgAckRequiredVisibility_toDysplay = kcg_true;
  outC->DMI_InterpolatedDistanceToTarget_toDisplay = kcg_lit_float32(0.0);
  for (idx48 = 0; idx48 < 5; idx48++) {
    outC->DMI_ArrayOfMsgIndex_toDisplay[idx48] = kcg_lit_int32(0);
  }
  outC->DMI_iconGroupIndex_toDisplay = kcg_lit_int32(0);
  outC->DMI_TrainSpeed_toDisplay = kcg_lit_float32(0.0);
  ...
  for (idx49 = 0; idx49 < 32; idx49++) {
    outC->DMI_GradientsStart_toDisplay[idx49] = kcg_lit_float32(0.0);
  }
  outC->DMI_trainAirtightIndex_toDisplay = kcg_lit_int32(0);
  outC->DMI_yellowBorderC1Area_toDisplay = kcg_true;
  outC->DMI_SpeedDigitTwo_toDisplay = kcg_lit_float32(0.0);
  for (idx50 = 0; idx50 < 9; idx50++) {
    outC->DMI_DriverID_Display_toDisplay[idx50] = kcg_lit_int32(0);
  }
  outC->DMI_yellowBorderMsg_toDisplay = kcg_true;
  outC->DMI_Vinterv_Color_toDisplay = kcg_lit_int32(0);
  outC->DMI_DistanceToTarget_toDisplay = kcg_lit_float32(0.0);
  outC->DMI_ModeSymbol_toDisplay = kcg_lit_int32(0);
  outC->DMI_modeSymbolAnnouncementIndex_toDisplay = kcg_lit_int32(0);
  outC->DMI_ETCS_LevelSymbol_toDisplay = kcg_lit_int32(0);
  for (idx51 = 0; idx51 < 30; idx51++) {
    outC->DMI_ArrayButtonsEnabler_toDisplay[idx51] = kcg_lit_int32(0);
  }
  outC->DMI_trainBrakePerc_toDisplay = kcg_lit_float32(0.0);
  outC->DMI_VreleaseColor_toDisplay = kcg_lit_int32(0);
  outC->DMI_SpeedPermitted_toDisplay = kcg_lit_float32(0.0);
  outC->DMI_trainCategoryIndex_toDisplay = kcg_lit_int32(0);
  outC->DMI_levelSymbolAnnouncementIndex_toDisplay = kcg_lit_int32(0);
  outC->DMI_TrainDataWindowVisibility_toDisplay = kcg_true;
  outC->DMI_StatusSymbolBrake_toDisplay = kcg_true;
  outC->DMI_traindataYesNoIndex_toDisplay = kcg_lit_int32(0);
  outC->DMI_vtarget_permColor_toDisplay = kcg_lit_int32(0);
  for (idx52 = 0; idx52 < 32; idx52++) {
    outC->DMI_GradientsEnd_toDisplay[idx52] = kcg_lit_float32(0.0);
  }
  outC->DMI_RBC_status_symbol_toDisplay = kcg_lit_int32(0);
  for (idx53 = 0; idx53 < 9; idx53++) {
    outC->DMI_TrainRN_Display_toDisplay[idx53] = kcg_lit_int32(0);
  }
  outC->DMI_trainLoadingGougeIndex_toDisplay = kcg_lit_int32(0);
  outC->DMI_hourGlassCounter_toDisplay = kcg_lit_float32(0.0);
  outC->DMI_SpeedDigitThree_toDisplay = kcg_lit_float32(0.0);
  outC->DMI_ModeSymbolVisibility_toDisplay = kcg_true;
  outC->DMI_closeButtonIndex_toDisplay = kcg_lit_int32(0);
  outC->DMI_yellowBorderBrakeSymbol_toDisplay = kcg_true;
  outC->DMI_SpeedIntervention_toDisplay = kcg_lit_float32(0.0);
  outC->DMI_LevelSymbolVisibility_toDisplay = kcg_true;
  outC->DMI_DistanceToTargetVisible_toDisplay = kcg_true;
  outC->DMI_trainMaxspeed_toDisplay = kcg_lit_float32(0.0);
  outC->DMI_VtargetColor_toDisplay = kcg_lit_int32(0);
  outC->DMI_SpeedRelease_toDisplay = kcg_lit_float32(0.0);
  outC->DMI_CloseButtonEnabler_toDisplay = kcg_lit_int32(0);
  outC->DMI_PointerColor_toDisplay = kcg_lit_int32(0);
  outC->DMI_trainAxleloadIndex_toDisplay = kcg_lit_int32(0);
  outC->DMI_hourGlassVisibility_toDisplay = kcg_true;
  outC->DMI_SpeedDigitOne_toDisplay = kcg_lit_float32(0.0);
  outC->DMI_DistanceToTargetBarVisibility_toDisplay = kcg_true;
  outC->DMI_Vinterv_Visibility_toDisplay = kcg_true;
  outC->DMI_TrainPosition_toDisplay = kcg_lit_float32(0.0);
  for (idx54 = 0; idx54 < 32; idx54++) {
    outC->DMI_GradientsValue_toDisplay[idx54] = kcg_lit_float32(0.0);
  }
  outC->DMI_trainLenght_toDisplay = kcg_lit_float32(0.0);
  outC->DMI_VpermColor_toDisplay = kcg_lit_int32(0);
  outC->DMI_SpeedTarget_toDisplay = kcg_lit_float32(0.0);
  ...
  outC->DMI_icons_ack.systemTime = kcg_lit_int32(0);
  outC->DMI_icons_ack.DMI_nid_icon_identifier = kcg_lit_int32(0);
  for (idx56 = 0; idx56 < 311; idx56++) {
    outC->EVC_fromDMI[idx56] = kcg_lit_int32(0);
  }
  /* _L138=(DMI_Control_Pkg::DMI_Controller#2)/ */
