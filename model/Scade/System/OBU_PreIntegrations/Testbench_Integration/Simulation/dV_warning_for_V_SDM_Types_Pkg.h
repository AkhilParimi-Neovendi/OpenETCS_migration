...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  V_odometry_Type_Obu_BasicTypes_Pkg /* dv_warning/ */ dv_warning;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
...
} outC_dV_warning_for_V_SDM_Types_Pkg;

/* ===========  node initialization and cycle functions  =========== */
/* SDM_Types_Pkg::dV_warning_for_V/ */
extern void dV_warning_for_V_SDM_Types_Pkg(
  /* V_input/ */
  V_odometry_Type_Obu_BasicTypes_Pkg V_input,
  outC_dV_warning_for_V_SDM_Types_Pkg *outC);

#ifndef KCG_NO_EXTERN_CALL_TO_RESET
extern void dV_warning_for_V_reset_SDM_Types_Pkg(
  outC_dV_warning_for_V_SDM_Types_Pkg *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void dV_warning_for_V_init_SDM_Types_Pkg(
  outC_dV_warning_for_V_SDM_Types_Pkg *outC);
