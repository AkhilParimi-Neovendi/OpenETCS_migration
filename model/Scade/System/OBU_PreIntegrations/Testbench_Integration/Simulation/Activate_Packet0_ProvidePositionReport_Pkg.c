  ...
  outC_Activate_Packet0_ProvidePositionReport_Pkg *outC)
{
  ...
  outC->_L6.packet0.NID_PACKET = kcg_lit_int64(0);
  outC->_L6.packet0.L_PACKET = kcg_lit_int64(0);
  outC->_L6.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L6.packet0.NID_LRBG = kcg_lit_int64(0);
  outC->_L6.packet0.D_LRBG = kcg_lit_int64(0);
  outC->_L6.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L6.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->_L6.packet0.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L6.packet0.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L6.packet0.length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L6.packet0.L_TRAININT = kcg_lit_int64(0);
  outC->_L6.packet0.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L6.packet0.NID_NTC = kcg_lit_int64(0);
  ...
  outC->out_packet0.packet0.NID_PACKET = kcg_lit_int64(0);
  outC->out_packet0.packet0.L_PACKET = kcg_lit_int64(0);
  outC->out_packet0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->out_packet0.packet0.NID_LRBG = kcg_lit_int64(0);
  outC->out_packet0.packet0.D_LRBG = kcg_lit_int64(0);
  outC->out_packet0.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->out_packet0.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->out_packet0.packet0.L_DOUBTOVER = kcg_lit_int64(0);
  outC->out_packet0.packet0.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->out_packet0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->out_packet0.packet0.L_TRAININT = kcg_lit_int64(0);
  outC->out_packet0.packet0.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->out_packet0.packet0.NID_NTC = kcg_lit_int64(0);
}
