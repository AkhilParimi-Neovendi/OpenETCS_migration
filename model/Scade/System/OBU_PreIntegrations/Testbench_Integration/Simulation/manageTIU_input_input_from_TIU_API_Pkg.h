...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  Message_Train_Interface_to_EVC_T_TIU_Types_Pkg /* storeTIU/ */ Context_storeTIU;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_detectEvokeBrake_input_from_TIU_API_Pkg Context_detectEvokeBrake_1;
} SV_manageTIU_input_input_from_TIU_API_Pkg;

extern void kcg_save_SV_manageTIU_input_input_from_TIU_API_Pkg(
  SV_manageTIU_input_input_from_TIU_API_Pkg *SV,
  outC_manageTIU_input_input_from_TIU_API_Pkg *outC);
extern void kcg_load_SV_manageTIU_input_input_from_TIU_API_Pkg(
  outC_manageTIU_input_input_from_TIU_API_Pkg *outC,
  SV_manageTIU_input_input_from_TIU_API_Pkg *SV);
