...
{
  /* identifierRequest/ */
  static DMI_Identifier_Request_T_DMI_Messages_EVC_to_DMI_Pkg identifierRequest_partial;
  /* identifierRequest/ */
  static DMI_Identifier_Request_T_DMI_Messages_EVC_to_DMI_Pkg _1_identifierRequest_partial;
...
void kcg_save_SV_doIdentifierRequest_manage_DMI_Output_Pkg(
  SV_doIdentifierRequest_manage_DMI_Output_Pkg *SV,
  outC_doIdentifierRequest_manage_DMI_Output_Pkg *outC)
{
  SV->Context_init = outC->init;
}

void kcg_load_SV_doIdentifierRequest_manage_DMI_Output_Pkg(
  outC_doIdentifierRequest_manage_DMI_Output_Pkg *outC,
  SV_doIdentifierRequest_manage_DMI_Output_Pkg *SV)
{
