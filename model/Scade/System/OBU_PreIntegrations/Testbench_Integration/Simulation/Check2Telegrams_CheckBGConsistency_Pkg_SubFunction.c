  ...
  outC_Check2Telegrams_CheckBGConsistency_Pkg_SubFunction *outC)
{
  ...
  outC->_L85.telegramheader.m_mcount = kcg_lit_int32(0);
  outC->_L85.telegramheader.nid_c = kcg_lit_int32(0);
  outC->_L85.telegramheader.nid_bg = kcg_lit_int32(0);
  outC->_L85.telegramheader.q_link = Q_LINK_Unlinked;
  for (idx = 0; idx < 30; idx++) {
    outC->_L85.packets.PacketHeaders[idx].nid_packet = kcg_lit_int32(0);
    outC->_L85.packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L85.packets.PacketHeaders[idx].valid = kcg_true;
    outC->_L85.packets.PacketHeaders[idx].startAddress = kcg_lit_int32(0);
    outC->_L85.packets.PacketHeaders[idx].endAddress = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L85.packets.PacketData[idx1] = kcg_lit_int32(0);
  }
  outC->_L10 = kcg_true;
  outC->_L9 = kcg_true;
  outC->_L8 = kcg_true;
  ...
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->telegram_out.packets.PacketHeaders[idx6].nid_packet = kcg_lit_int32(0);
    ...
    outC->telegram_out.packets.PacketHeaders[idx6].startAddress = kcg_lit_int32(0);
    outC->telegram_out.packets.PacketHeaders[idx6].endAddress = kcg_lit_int32(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->telegram_out.packets.PacketData[idx7] = kcg_lit_int32(0);
  }
