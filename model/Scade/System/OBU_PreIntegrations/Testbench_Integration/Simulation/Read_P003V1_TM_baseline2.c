...
void Read_P003V1_init_TM_baseline2(outC_Read_P003V1_TM_baseline2 *outC)
{
  ...
  outC->_L166.d_validnv = kcg_lit_int64(0);
  outC->_L166.n_iter = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 32; idx1++) {
    outC->_L166.SECTIONS[idx1].valid = kcg_true;
    outC->_L166.SECTIONS[idx1].nid_c = kcg_lit_int64(0);
  }
  outC->_L166.v_nvshunt = kcg_lit_int64(0);
  outC->_L166.v_nvstff = kcg_lit_int64(0);
  outC->_L166.v_nvonsight = kcg_lit_int64(0);
  outC->_L166.v_nvunfit = kcg_lit_int64(0);
  outC->_L166.v_nvrel = kcg_lit_int64(0);
  outC->_L166.d_nvroll = kcg_lit_int64(0);
  outC->_L166.q_nvsbtsmperm = Q_NVSBTSMPERM_No;
  outC->_L166.q_nvemrrls =
    Q_NVEMRRLS_Revoke_emergency_brake_command_at_standstill;
  outC->_L166.v_nvallowovtrp = kcg_lit_int64(0);
  outC->_L166.v_nvsopovtrp = kcg_lit_int64(0);
  outC->_L166.d_nvovtrp = kcg_lit_int64(0);
  outC->_L166.t_nvovtrp = kcg_lit_int64(0);
  outC->_L166.d_nvpotrp = kcg_lit_int64(0);
  outC->_L166.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->_L166.t_nvcontact = kcg_lit_int64(0);
  outC->_L166.m_nvderun = M_NVDERUN_No;
  outC->_L166.d_nvstff = kcg_lit_int64(0);
  outC->_L166.q_nvdriver_adhes = Q_NVDRIVER_ADHES_Not_allowed;
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L6.PacketHeaders[idx2].nid_packet = kcg_lit_int64(0);
    outC->_L6.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L6.PacketHeaders[idx2].valid = kcg_true;
    outC->_L6.PacketHeaders[idx2].startAddress = kcg_lit_int64(0);
    outC->_L6.PacketHeaders[idx2].endAddress = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L6.PacketData[idx3] = kcg_lit_int64(0);
  }
  outC->P003V1_OBU_out.valid = kcg_true;
  outC->P003V1_OBU_out.q_dir = Q_DIR_Reverse;
  outC->P003V1_OBU_out.q_scale = Q_SCALE_10_cm_scale;
  outC->P003V1_OBU_out.d_validnv = kcg_lit_int64(0);
  outC->P003V1_OBU_out.n_iter = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->P003V1_OBU_out.SECTIONS[idx4].valid = kcg_true;
    outC->P003V1_OBU_out.SECTIONS[idx4].nid_c = kcg_lit_int64(0);
  }
  outC->P003V1_OBU_out.v_nvshunt = kcg_lit_int64(0);
  outC->P003V1_OBU_out.v_nvstff = kcg_lit_int64(0);
  outC->P003V1_OBU_out.v_nvonsight = kcg_lit_int64(0);
  outC->P003V1_OBU_out.v_nvunfit = kcg_lit_int64(0);
  outC->P003V1_OBU_out.v_nvrel = kcg_lit_int64(0);
  outC->P003V1_OBU_out.d_nvroll = kcg_lit_int64(0);
  outC->P003V1_OBU_out.q_nvsbtsmperm = Q_NVSBTSMPERM_No;
  outC->P003V1_OBU_out.q_nvemrrls =
    Q_NVEMRRLS_Revoke_emergency_brake_command_at_standstill;
  outC->P003V1_OBU_out.v_nvallowovtrp = kcg_lit_int64(0);
  outC->P003V1_OBU_out.v_nvsopovtrp = kcg_lit_int64(0);
  outC->P003V1_OBU_out.d_nvovtrp = kcg_lit_int64(0);
  outC->P003V1_OBU_out.t_nvovtrp = kcg_lit_int64(0);
  outC->P003V1_OBU_out.d_nvpotrp = kcg_lit_int64(0);
  outC->P003V1_OBU_out.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->P003V1_OBU_out.t_nvcontact = kcg_lit_int64(0);
  outC->P003V1_OBU_out.m_nvderun = M_NVDERUN_No;
  outC->P003V1_OBU_out.d_nvstff = kcg_lit_int64(0);
