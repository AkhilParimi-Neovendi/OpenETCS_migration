...
void kcg_save_SV_Build_MA_request_TA_MA_Request(
  SV_Build_MA_request_TA_MA_Request *SV,
  outC_Build_MA_request_TA_MA_Request *outC)
{
  kcg_save_SV_Send_M132_TM_radio_messages(
    &SV->Context_Send_M132_1,
    &outC->Context_Send_M132_1);
}

void kcg_load_SV_Build_MA_request_TA_MA_Request(
  outC_Build_MA_request_TA_MA_Request *outC,
  SV_Build_MA_request_TA_MA_Request *SV)
{
  kcg_load_SV_Send_M132_TM_radio_messages(
    &outC->Context_Send_M132_1,
    &SV->Context_Send_M132_1);
}
