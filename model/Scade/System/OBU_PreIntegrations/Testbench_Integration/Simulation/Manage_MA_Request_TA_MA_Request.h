...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_Receive_MA_RequestParameters_TA_MA_Request Context_Receive_MA_RequestParameters_1;
  SV_MA_Request_Supervision_TA_MA_Request Context_MA_Request_Supervision_1;
  SV_Build_MA_request_TA_MA_Request Context_Build_MA_request_1;
} SV_Manage_MA_Request_TA_MA_Request;

extern void kcg_save_SV_Manage_MA_Request_TA_MA_Request(
  SV_Manage_MA_Request_TA_MA_Request *SV,
  outC_Manage_MA_Request_TA_MA_Request *outC);
extern void kcg_load_SV_Manage_MA_Request_TA_MA_Request(
  outC_Manage_MA_Request_TA_MA_Request *outC,
  SV_Manage_MA_Request_TA_MA_Request *SV);
