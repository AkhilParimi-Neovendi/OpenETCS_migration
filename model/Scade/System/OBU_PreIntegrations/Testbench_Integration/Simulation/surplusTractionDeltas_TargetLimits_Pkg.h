...
typedef struct {
  ...
  outC_TransformV_odoToV_real_SDM_Types_Pkg /* _L148=(SDM_Types_Pkg::TransformV_odoToV_real#2)/ */ Context_TransformV_odoToV_real_2;
  outC_TransformV_odoToV_real_SDM_Types_Pkg /* _L149=(SDM_Types_Pkg::TransformV_odoToV_real#1)/ */ Context_TransformV_odoToV_real_1;
  outC_TransformT_intToT_real_SDM_Types_Pkg /* _L158=(SDM_Types_Pkg::TransformT_intToT_real#1)/ */ Context_TransformT_intToT_real_1;
  outC_TransformT_intToT_real_SDM_Types_Pkg /* _L162=(SDM_Types_Pkg::TransformT_intToT_real#2)/ */ Context_TransformT_intToT_real_2;
