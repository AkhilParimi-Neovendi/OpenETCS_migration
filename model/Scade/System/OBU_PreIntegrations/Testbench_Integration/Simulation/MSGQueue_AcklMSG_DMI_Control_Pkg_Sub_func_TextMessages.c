  ...
  outC_MSGQueue_AcklMSG_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  /* queue/ */
  static _82_array queue_partial;
  /* hh_array/ */
  static array_float32_5 hh_array_partial;
  /* mm_array/ */
  static array_float32_5 mm_array_partial;
  /* CountCommand/ */
  static kcg_int32 CountCommand_partial;
  /* queue/ */
  static _82_array _7_queue_partial;
  /* hh_array/ */
  static array_float32_5 _8_hh_array_partial;
  /* mm_array/ */
  static array_float32_5 _9_mm_array_partial;
  /* CountCommand/ */
  static kcg_int32 _10_CountCommand_partial;
  /* Local_hh/ */
  ...
  if (outC->OperationQueue_IfBlock_clock) {
    outC->_L23_then_OperationQueue_IfBlock = kcg_lit_int32(1);
  ...
  /* OperationQueue_IfBlock: */
  if (outC->OperationQueue_IfBlock_clock) {
    outC->_L5_then_OperationQueue_IfBlock = kcg_lit_int32(1);
    ...
    kcg_copy_array_float32_5(
      &hh_array_partial,
      &outC->_L33_then_OperationQueue_IfBlock);
    kcg_copy__82_array(&queue_partial, &outC->_L32_then_OperationQueue_IfBlock);
    kcg_copy__82_array(&outC->queue, &queue_partial);
    kcg_copy_array_float32_5(&outC->hh_array, &hh_array_partial);
    kcg_copy_array_float32_5(&outC->mm_array, &mm_array_partial);
  }
  else {
    kcg_copy_array_float32_5(
      &_9_mm_array_partial,
    ...
    kcg_copy__82_array(
      &_7_queue_partial,
      (_82_array *) &cListMsgStructure_DMI_Control_Pkg);
    kcg_copy__82_array(&outC->queue, &_7_queue_partial);
    kcg_copy_array_float32_5(&outC->hh_array, &_8_hh_array_partial);
    kcg_copy_array_float32_5(&outC->mm_array, &_9_mm_array_partial);
  }
}
  ...
  outC_MSGQueue_AcklMSG_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  for (idx = 0; idx < 4; idx++) {
    outC->_L98[idx] = kcg_lit_float32(0.0);
  }
  outC->_L99 = kcg_lit_float32(0.0);
  ...
  outC->_L89.system_clock = kcg_lit_int32(0);
  outC->_L89.textMessage_ID = kcg_lit_int32(0);
  outC->_L89.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L89.l_text = kcg_lit_int32(0);
  ...
  outC->_L2_else_OperationQueue_IfBlock = kcg_lit_int32(0);
  outC->_L7_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  outC->_L6_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  outC->_L5_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  outC->_L2_then_OperationQueue_IfBlock.valid = kcg_true;
  outC->_L2_then_OperationQueue_IfBlock.system_clock = kcg_lit_int32(0);
  outC->_L2_then_OperationQueue_IfBlock.textMessage_ID = kcg_lit_int32(0);
  outC->_L2_then_OperationQueue_IfBlock.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L2_then_OperationQueue_IfBlock.l_text = kcg_lit_int32(0);
  ...
  outC->_L23_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  outC->_L26_then_OperationQueue_IfBlock = kcg_lit_float32(0.0);
  outC->_L27_then_OperationQueue_IfBlock = kcg_lit_float32(0.0);
  outC->_L31_then_OperationQueue_IfBlock = kcg_true;
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L34_then_OperationQueue_IfBlock[idx3] = kcg_lit_float32(0.0);
  }
  for (idx4 = 0; idx4 < 5; idx4++) {
    outC->_L33_then_OperationQueue_IfBlock[idx4] = kcg_lit_float32(0.0);
  }
  for (idx6 = 0; idx6 < 5; idx6++) {
    ...
    outC->_L32_then_OperationQueue_IfBlock[idx6].dmi_msg.l_text = kcg_lit_int32(0);
