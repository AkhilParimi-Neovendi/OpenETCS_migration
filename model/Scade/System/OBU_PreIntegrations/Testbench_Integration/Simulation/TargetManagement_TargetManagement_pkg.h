...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  Target_real_T_TargetManagement_types /* _L93/ */ Context__L93;
  Target_real_T_TargetManagement_types /* _L12/ */ Context__L12;
  Target_list_MRSP_real_T_TargetManagement_types /* MRSPTargetList/ */ Context_MRSPTargetList;
  kcg_bool Context_init;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
} SV_TargetManagement_TargetManagement_pkg;

extern void kcg_save_SV_TargetManagement_TargetManagement_pkg(
  SV_TargetManagement_TargetManagement_pkg *SV,
  outC_TargetManagement_TargetManagement_pkg *outC);
extern void kcg_load_SV_TargetManagement_TargetManagement_pkg(
  outC_TargetManagement_TargetManagement_pkg *outC,
  SV_TargetManagement_TargetManagement_pkg *SV);
