  ...
  outC_Area_D_DMI_Control_Pkg_Sub_func_PlanningArea *outC)
{
  ...
  kcg_copy_array_float32_32(&outC->_L9, inSpeedProfile_Distance);
  kcg_copy_array_float32_32(&outC->_L10, inSpeedProfile_Speed);
  ...
  kcg_copy_array_float32_10(&outC->_L11[0], &outC->_L13);
  kcg_copy_array_float32_10(&outC->_L11[1], &outC->_L14);
  ...
  kcg_copy_array_float32_32(&outC->_L4, inGradientsStart);
  kcg_copy_array_float32_32(&outC->_L5, inGradientsEnd);
  kcg_copy_array_float32_32(&outC->_L6, inGradientsValue);
  ...
  kcg_copy_array_float32_32(&outC->GradientsStart, &outC->_L1);
  kcg_copy_array_float32_32(&outC->GradientsEnd, &outC->_L2);
  kcg_copy_array_float32_32(&outC->GradientsValue, &outC->_L3);
}
  ...
  outC_Area_D_DMI_Control_Pkg_Sub_func_PlanningArea *outC)
{
  ...
  for (idx = 0; idx < 10; idx++) {
    outC->_L13[idx] = kcg_lit_float32(0.0);
  }
  ...
  for (idx3 = 0; idx3 < 2; idx3++) {
    for (idx2 = 0; idx2 < 10; idx2++) {
      outC->_L11[idx3][idx2] = kcg_lit_float32(0.0);
    }
  }
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->_L10[idx4] = kcg_lit_float32(0.0);
  }
  for (idx5 = 0; idx5 < 32; idx5++) {
    outC->_L9[idx5] = kcg_lit_float32(0.0);
  }
  outC->_L8 = kcg_lit_float32(0.0);
  for (idx6 = 0; idx6 < 32; idx6++) {
    outC->_L3[idx6] = kcg_lit_float32(0.0);
  }
  for (idx7 = 0; idx7 < 32; idx7++) {
    outC->_L2[idx7] = kcg_lit_float32(0.0);
  }
  for (idx8 = 0; idx8 < 32; idx8++) {
    outC->_L1[idx8] = kcg_lit_float32(0.0);
  }
  for (idx9 = 0; idx9 < 32; idx9++) {
    outC->_L4[idx9] = kcg_lit_float32(0.0);
  }
  ...
  for (idx12 = 0; idx12 < 32; idx12++) {
    outC->GradientsValue[idx12] = kcg_lit_float32(0.0);
  }
  outC->CeilingPermittedSpeed = kcg_lit_float32(0.0);
  for (idx14 = 0; idx14 < 2; idx14++) {
    for (idx13 = 0; idx13 < 10; idx13++) {
      outC->PlaningAreaSpeedProfile[idx14][idx13] = kcg_lit_float32(0.0);
    }
  }
  for (idx15 = 0; idx15 < 32; idx15++) {
    outC->GradientsEnd[idx15] = kcg_lit_float32(0.0);
  }
  for (idx16 = 0; idx16 < 32; idx16++) {
    outC->GradientsStart[idx16] = kcg_lit_float32(0.0);
  }
  /* _L1=(DMI_Control_Pkg::Sub_func::PlanningArea::NextGradients#1)/ */
