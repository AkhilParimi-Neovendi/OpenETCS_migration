  ...
  outC_CalcModeTransOutput_SDM_Commands_Pkg *outC)
{
  ...
  outC->_L30.T_traction_cut_off = kcg_lit_int64(0);
  outC->_L30.offsetAntennaL1 = kcg_lit_int64(0);
  outC->_L30.T_b_limit = kcg_lit_int64(0);
  ...
  for (idx = 0; idx < 33; idx++) {
    ...
    outC->_L4.LRBG.infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L4.LRBG.infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int64(0);
    outC->_L4.LRBG.infoFromPassing.linkedBGs[idx].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L4.LRBG.infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int64(0);
    outC->_L4.LRBG.infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int64(0);
    outC->_L4.LRBG.infoFromPassing.linkedBGs[idx].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L4.LRBG.infoFromPassing.linkedBGs[idx].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L4.LRBG.infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L4.prvLRBG.infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L4.prvLRBG.infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int64(0);
    outC->_L4.prvLRBG.infoFromPassing.linkedBGs[idx1].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L4.prvLRBG.infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int64(0);
    outC->_L4.prvLRBG.infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L4.prvLRBG.infoFromPassing.linkedBGs[idx1].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L4.prvLRBG.infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int64(0);
  }
  ...
  outC->_L6.SBD_preindication_location = kcg_lit_int64(0);
  outC->_L6.EBD_preindication_location = kcg_lit_int64(0);
  outC->_L6.EBD_RSM_start_location = kcg_lit_int64(0);
  outC->_L6.SBD_RSM_start_location = kcg_lit_int64(0);
  outC->_L6.d_I_of_V_est = kcg_lit_int64(0);
  outC->_L6.d_I_of_V_MRSP = kcg_lit_int64(0);
  outC->_L6.d_P_of_V_est = kcg_lit_int64(0);
  outC->_L6.d_W_of_V_est = kcg_lit_int64(0);
  outC->_L6.d_FLOI_of_V_est = kcg_lit_int64(0);
  outC->_L6.d_EBI_of_V_est = kcg_lit_int64(0);
  outC->_L6.FLOI_of_V_est = kcg_lit_int64(0);
  outC->_L6.SBI1_of_V_est = kcg_lit_int64(0);
  outC->_L6.SBI2_of_V_est = kcg_lit_int64(0);
  outC->_L6.d_target = kcg_lit_int64(0);
  outC->_L6.d_eoa = kcg_lit_int64(0);
  outC->_L6.d_svl = kcg_lit_int64(0);
  ...
  outC->_L9.V_est = kcg_lit_int64(0);
  outC->_L9.V_MRSP = kcg_lit_int64(0);
  outC->_L9.V_release = kcg_lit_int64(0);
  outC->_L9.V_target = kcg_lit_int64(0);
  outC->_L9.v_p_mrdt = kcg_lit_int64(0);
  outC->_L9.v_p_dmi = kcg_lit_int64(0);
  outC->_L9.v_sbi_mrdt = kcg_lit_int64(0);
  outC->_L9.v_FLOI_dmi = kcg_lit_int64(0);
  outC->_L9.dV_warning_V_MRSP = kcg_lit_int64(0);
  outC->_L9.dV_warning_V_target = kcg_lit_int64(0);
  outC->_L9.dV_sbi_V_MRSP = kcg_lit_int64(0);
  outC->_L9.dV_sbi_V_target = kcg_lit_int64(0);
  outC->_L9.dV_ebi_V_MRSP = kcg_lit_int64(0);
  outC->_L9.dV_ebi_V_target = kcg_lit_int64(0);
