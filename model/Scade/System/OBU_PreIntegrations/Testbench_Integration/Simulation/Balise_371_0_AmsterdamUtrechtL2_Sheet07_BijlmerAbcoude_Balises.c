...
void Balise_371_0_AmsterdamUtrechtL2_Sheet07_BijlmerAbcoude_Balises(
  ...
  /* PIG_nom/ */
  kcg_int64 PIG_nom,
  outC_Balise_371_0_AmsterdamUtrechtL2_Sheet07_BijlmerAbcoude_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet07_BijlmerAbcoude_Balises::Packets_BG371#1)/ */
    Packets_BG371_AmsterdamUtrechtL2_Sheet07_BijlmerAbcoude_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG371_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG371_1.Balise_data_out);
...
void Balise_371_0_init_AmsterdamUtrechtL2_Sheet07_BijlmerAbcoude_Balises(
  outC_Balise_371_0_AmsterdamUtrechtL2_Sheet07_BijlmerAbcoude_Balises *outC)
{
  static kcg_size idx;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet07_BijlmerAbcoude_Balises::Packets_BG371#1)/ */
  Packets_BG371_init_AmsterdamUtrechtL2_Sheet07_BijlmerAbcoude_Balises(
    &outC->Context_Packets_BG371_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_371_0_reset_AmsterdamUtrechtL2_Sheet07_BijlmerAbcoude_Balises(
  outC_Balise_371_0_AmsterdamUtrechtL2_Sheet07_BijlmerAbcoude_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet07_BijlmerAbcoude_Balises::Packets_BG371#1)/ */
  Packets_BG371_reset_AmsterdamUtrechtL2_Sheet07_BijlmerAbcoude_Balises(
    &outC->Context_Packets_BG371_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
