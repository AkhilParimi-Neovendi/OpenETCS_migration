...
void Balise_14_100_1_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  /* B_data_in/ */
  ...
  outC_Balise_14_100_1_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Packets_BG14_100#1)/ */
    Packets_BG14_100_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG14_100_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG14_100_1.Balise_data_out);
...
void Balise_14_100_1_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  outC_Balise_14_100_1_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  static kcg_size idx;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Packets_BG14_100#1)/ */
  Packets_BG14_100_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->Context_Packets_BG14_100_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_14_100_1_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  outC_Balise_14_100_1_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Packets_BG14_100#1)/ */
  Packets_BG14_100_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->Context_Packets_BG14_100_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Balise_14_100_1_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone.c
** Generation date: 2023-11-05T09:07:02
*************************************************************$ */
