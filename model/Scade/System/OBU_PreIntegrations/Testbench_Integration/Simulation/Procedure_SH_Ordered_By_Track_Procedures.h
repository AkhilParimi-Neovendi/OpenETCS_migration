...
} SV_Procedure_SH_Ordered_By_Track_Procedures;

extern void kcg_save_SV_Procedure_SH_Ordered_By_Track_Procedures(
  SV_Procedure_SH_Ordered_By_Track_Procedures *SV,
  outC_Procedure_SH_Ordered_By_Track_Procedures *outC);
extern void kcg_load_SV_Procedure_SH_Ordered_By_Track_Procedures(
  outC_Procedure_SH_Ordered_By_Track_Procedures *outC,
  SV_Procedure_SH_Ordered_By_Track_Procedures *SV);
