  ...
  outC_CAST_int_to_DMI_EVC_Level_Data1_DATA_Packets_EVC_to_DMI *outC)
{
  ...
  kcg_copy_array_int64_65(&outC->_L5, (array_int64_65 *) &outC->_L11[2]);
  ...
  outC_CAST_int_to_DMI_EVC_Level_Data1_DATA_Packets_EVC_to_DMI *outC)
{
  ...
  for (idx1 = 0; idx1 < 32; idx1++) {
    ...
    outC->_L7.levelList[idx1].nid_stm = kcg_lit_int64(0);
  }
  outC->_L6 = kcg_true;
  ...
  outC->_L2.levelList.number = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 32; idx3++) {
    outC->_L2.levelList.levelList[idx3].level = M_LEVEL_Level_0;
    outC->_L2.levelList.levelList[idx3].nid_stm = kcg_lit_int64(0);
  }
