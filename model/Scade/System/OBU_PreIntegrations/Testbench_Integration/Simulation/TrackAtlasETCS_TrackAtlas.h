...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  L_internal_Type_Obu_BasicTypes_Pkg /* _L94/ */ Context__L94;
  kcg_bool Context_init;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_StoreRaw_NV_TA_Storage Context_StoreRaw_NV_1;
  SV_Manage_EmergencyStop_TA_EmergencyStop Context_Manage_EmergencyStop_1;
  SV_Build_MA_L23_TA_MA_new Context_Build_MA_L23_1;
  SV_Manage_MA_Request_TA_MA_Request Context_Manage_MA_Request_1;
  SV_Build_MRSP_TA_MRSP_new Context_Build_MRSP_1;
  SV_Build_GradientProfile_TA_Gradient_new Context_Build_GradientProfile_1;
} SV_TrackAtlasETCS_TrackAtlas;

extern void kcg_save_SV_TrackAtlasETCS_TrackAtlas(
  SV_TrackAtlasETCS_TrackAtlas *SV,
  outC_TrackAtlasETCS_TrackAtlas *outC);
extern void kcg_load_SV_TrackAtlasETCS_TrackAtlas(
  outC_TrackAtlasETCS_TrackAtlas *outC,
  SV_TrackAtlasETCS_TrackAtlas *SV);
