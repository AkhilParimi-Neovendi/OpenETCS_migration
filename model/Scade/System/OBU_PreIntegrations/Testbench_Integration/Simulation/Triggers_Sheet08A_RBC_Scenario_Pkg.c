  ...
  outC_Triggers_Sheet08A_RBC_Scenario_Pkg *outC)
{
  ...
  RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg(
    ...
    outC->_L4,
    kcg_lit_int32(374),
    kcg_lit_float32(173.9),
    kcg_lit_float32(183.9),
  ...
  RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg(
    ...
    outC->_L4,
    kcg_lit_int32(375),
    kcg_lit_float32(49.4),
    kcg_lit_float32(59.4),
  ...
  RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg(
    ...
    outC->_L4,
    kcg_lit_int32(376),
    kcg_lit_float32(286.3),
    kcg_lit_float32(296.3),
...
void kcg_save_SV_Triggers_Sheet08A_RBC_Scenario_Pkg(
...
void kcg_load_SV_Triggers_Sheet08A_RBC_Scenario_Pkg(
  outC_Triggers_Sheet08A_RBC_Scenario_Pkg *outC,
  SV_Triggers_Sheet08A_RBC_Scenario_Pkg *SV)
{
