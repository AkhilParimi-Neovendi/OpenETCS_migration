  ...
  outC_RBC__PingTrain_RBC_Model_Pkg *outC)
{
  ...
  /* Level_2_or_3/ */
  static kcg_bool Level_2_or_3_partial;
  /* messageQueue/ */
  static RadioTrackTrainMessageQueue_T _1_messageQueue_partial;
  /* Level_2_or_3/ */
  static kcg_bool _2_Level_2_or_3_partial;
  /* Level_2_or_3/ */
  ...
  DynamicConfig__GetNationalParams_RBC_Config_Pkg(
    &outC->_L129,
  ...
  NationalParams__Get_T_NVCONTACT_RBC_Config_Pkg(
    &outC->_L76,
  ...
  kcg_copy_RadioTrackTrainMessageQueue_T(&outC->_L131, &outC->_L130.messageQueue);
  ...
  if (outC->IfBlock1_clock) {
    ...
    RadioTrackTrainMessageQueueEntry__Create_RBC_Collections_Pkg(
      &outC->_L1_then_IfBlock1,
      &outC->Context_RadioTrackTrainMessageQueueEntry__Create_2);
    kcg_copy_RadioTrackTrainMessageQueueEntry_T(
      &outC->_L15_then_IfBlock1,
      &outC->Context_RadioTrackTrainMessageQueueEntry__Create_2.outRadioTrackTrainMessageQueueEntry);
  ...
  kcg_copy_RadioTrackTrainMessageQueue_T(&outC->_L140, &outC->messageQueue);
  kcg_copy_RBC_Data_T_RBC_DataBus_Pkg(&outC->_L138, inDataBus);
  kcg_copy_RBC_Data_T_RBC_DataBus_Pkg(&outC->_L139, &outC->_L138);
  if (kcg_true) {
    kcg_copy_RadioTrackTrainMessageQueue_T(&outC->_L139.messageQueue, &outC->_L140);
  }
...
void RBC__PingTrain_init_RBC_Model_Pkg(outC_RBC__PingTrain_RBC_Model_Pkg *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L142.Messages.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L142.Messages.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L142.Messages.PacketHeaders[idx].valid = kcg_true;
    outC->_L142.Messages.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L142.Messages.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L142.Messages.PacketData[idx1] = kcg_lit_int64(0);
  }
  outC->_L141.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  outC->_L141.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(
      0);
  ...
  outC->_L141.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  ...
  outC->_L141.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L141.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L141.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L141.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L141.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L141.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L141.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L141.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L141.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L141.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L141.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L141.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L141.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L141.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L141.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L141.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L141.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L141.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L141.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L141.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L141.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L141.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L141.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L141.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L141.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L141.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L141.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L141.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  outC->_L141.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L141.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L141.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L141.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx7 = 0; idx7 < 16; idx7++) {
    ...
    outC->_L141.diagnostic[idx7].count = kcg_lit_int64(0);
    outC->_L141.diagnostic[idx7].timestamp = kcg_lit_int64(0);
  ...
  outC->_L141.clockk.m_Value = kcg_lit_int64(0);
  outC->_L141.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int64(0);
  outC->_L141.lastSentTrackTrainMessage.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L141.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int64(0);
  outC->_L141.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int64(0);
  outC->_L141.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int64(0);
  outC->_L141.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L141.lastSentTrackTrainMessage.Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L141.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int64(0);
  outC->_L141.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int64(0);
  outC->_L141.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int64(0);
  outC->_L141.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L141.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int64(0);
  outC->_L141.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int64(0);
  outC->_L141.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L141.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int64(0);
  ...
  for (idx15 = 0; idx15 < 8; idx15++) {
    ...
    outC->_L140.m_Entries[idx15].m_Entry.Header.radioDevice = kcg_lit_int64(0);
    outC->_L140.m_Entries[idx15].m_Entry.Header.receivedSystemTime =
      kcg_lit_int64(0);
    outC->_L140.m_Entries[idx15].m_Entry.Header.nid_message = kcg_lit_int64(0);
    outC->_L140.m_Entries[idx15].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L140.m_Entries[idx15].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L140.m_Entries[idx15].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L140.m_Entries[idx15].m_Entry.Header.t_train_reference =
      kcg_lit_int64(0);
    outC->_L140.m_Entries[idx15].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L140.m_Entries[idx15].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L140.m_Entries[idx15].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L140.m_Entries[idx15].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L140.m_Entries[idx15].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L140.m_Entries[idx15].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L140.m_Entries[idx15].m_Entry.Header.d_emergencystop = kcg_lit_int64(0);
    outC->_L140.m_Entries[idx15].m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L139.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  outC->_L139.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(
      0);
  ...
  outC->_L139.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L139.session.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L139.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L139.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L139.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L139.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L139.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L139.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L139.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L139.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L139.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L139.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L139.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L139.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L139.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L139.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L139.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L139.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L139.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L139.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L139.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L139.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L139.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L139.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L139.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L139.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L139.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L139.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L139.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L139.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L139.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  outC->_L139.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L139.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L139.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L139.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx21 = 0; idx21 < 16; idx21++) {
    ...
    outC->_L139.diagnostic[idx21].count = kcg_lit_int64(0);
    outC->_L139.diagnostic[idx21].timestamp = kcg_lit_int64(0);
  ...
  outC->_L139.clockk.m_Value = kcg_lit_int64(0);
  outC->_L139.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int64(0);
  outC->_L139.lastSentTrackTrainMessage.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L139.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int64(0);
  outC->_L139.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int64(0);
  outC->_L139.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int64(0);
  outC->_L139.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L139.lastSentTrackTrainMessage.Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L139.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int64(0);
  outC->_L139.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int64(0);
  outC->_L139.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int64(0);
  outC->_L139.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L139.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int64(0);
  outC->_L139.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int64(0);
  outC->_L139.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L139.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L138.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  outC->_L138.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(
      0);
  ...
  outC->_L138.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L138.session.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L138.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L138.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L138.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L138.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L138.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L138.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L138.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L138.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L138.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L138.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L138.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L138.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L138.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L138.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L138.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L138.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L138.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L138.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L138.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L138.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L138.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L138.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L138.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L138.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L138.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L138.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L138.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L138.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L138.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  outC->_L138.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L138.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L138.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L138.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx32 = 0; idx32 < 16; idx32++) {
    ...
    outC->_L138.diagnostic[idx32].count = kcg_lit_int64(0);
    outC->_L138.diagnostic[idx32].timestamp = kcg_lit_int64(0);
  ...
  outC->_L138.clockk.m_Value = kcg_lit_int64(0);
  outC->_L138.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int64(0);
  outC->_L138.lastSentTrackTrainMessage.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L138.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int64(0);
  outC->_L138.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int64(0);
  outC->_L138.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int64(0);
  outC->_L138.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L138.lastSentTrackTrainMessage.Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L138.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int64(0);
  outC->_L138.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int64(0);
  outC->_L138.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int64(0);
  outC->_L138.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L138.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int64(0);
  outC->_L138.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int64(0);
  outC->_L138.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L138.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L132.m_Value = kcg_lit_int64(0);
  outC->_L133.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  outC->_L133.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(
      0);
  ...
  outC->_L133.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L133.session.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L133.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L133.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L133.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L133.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L133.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L133.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L133.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L133.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L133.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L133.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L133.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L133.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L133.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L133.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L133.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L133.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L133.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L133.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L133.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L133.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L133.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L133.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L133.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L133.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L133.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L133.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L133.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L133.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L133.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  outC->_L133.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L133.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L133.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L133.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx43 = 0; idx43 < 16; idx43++) {
    ...
    outC->_L133.diagnostic[idx43].count = kcg_lit_int64(0);
    outC->_L133.diagnostic[idx43].timestamp = kcg_lit_int64(0);
  ...
  outC->_L133.clockk.m_Value = kcg_lit_int64(0);
  outC->_L133.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int64(0);
  outC->_L133.lastSentTrackTrainMessage.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L133.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int64(0);
  outC->_L133.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int64(0);
  outC->_L133.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int64(0);
  outC->_L133.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L133.lastSentTrackTrainMessage.Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L133.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int64(0);
  outC->_L133.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int64(0);
  outC->_L133.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int64(0);
  outC->_L133.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L133.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int64(0);
  outC->_L133.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int64(0);
  outC->_L133.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L133.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L130.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  outC->_L130.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(
      0);
  ...
  outC->_L130.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L130.session.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L130.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L130.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L130.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L130.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L130.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L130.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L130.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L130.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L130.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L130.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L130.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L130.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L130.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L130.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L130.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L130.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L130.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L130.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L130.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L130.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L130.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L130.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L130.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L130.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L130.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L130.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L130.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L130.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L130.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  outC->_L130.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L130.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L130.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L130.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx54 = 0; idx54 < 16; idx54++) {
    ...
    outC->_L130.diagnostic[idx54].count = kcg_lit_int64(0);
    outC->_L130.diagnostic[idx54].timestamp = kcg_lit_int64(0);
  ...
  outC->_L130.clockk.m_Value = kcg_lit_int64(0);
  outC->_L130.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int64(0);
  outC->_L130.lastSentTrackTrainMessage.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L130.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int64(0);
  outC->_L130.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int64(0);
  outC->_L130.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int64(0);
  outC->_L130.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L130.lastSentTrackTrainMessage.Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L130.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int64(0);
  outC->_L130.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int64(0);
  outC->_L130.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int64(0);
  outC->_L130.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L130.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int64(0);
  outC->_L130.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int64(0);
  outC->_L130.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L130.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int64(0);
  ...
  for (idx62 = 0; idx62 < 8; idx62++) {
    ...
    outC->_L131.m_Entries[idx62].m_Entry.Header.radioDevice = kcg_lit_int64(0);
    outC->_L131.m_Entries[idx62].m_Entry.Header.receivedSystemTime =
      kcg_lit_int64(0);
    outC->_L131.m_Entries[idx62].m_Entry.Header.nid_message = kcg_lit_int64(0);
    outC->_L131.m_Entries[idx62].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L131.m_Entries[idx62].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L131.m_Entries[idx62].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L131.m_Entries[idx62].m_Entry.Header.t_train_reference =
      kcg_lit_int64(0);
    outC->_L131.m_Entries[idx62].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L131.m_Entries[idx62].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L131.m_Entries[idx62].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L131.m_Entries[idx62].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L131.m_Entries[idx62].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L131.m_Entries[idx62].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L131.m_Entries[idx62].m_Entry.Header.d_emergencystop = kcg_lit_int64(0);
    outC->_L131.m_Entries[idx62].m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L129.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L129.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L129.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L129.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L129.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L129.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L129.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L129.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L129.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L129.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L129.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L129.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  outC->_L129.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L129.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L129.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L129.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  outC->_L128.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  outC->_L128.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(
      0);
  ...
  outC->_L128.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L128.session.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L128.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L128.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L128.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L128.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L128.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L128.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L128.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L128.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L128.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L128.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L128.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L128.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L128.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L128.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L128.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L128.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L128.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L128.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L128.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L128.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L128.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L128.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L128.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L128.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L128.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L128.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L128.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L128.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L128.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  outC->_L128.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L128.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L128.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L128.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx69 = 0; idx69 < 16; idx69++) {
    ...
    outC->_L128.diagnostic[idx69].count = kcg_lit_int64(0);
    outC->_L128.diagnostic[idx69].timestamp = kcg_lit_int64(0);
  ...
  outC->_L128.clockk.m_Value = kcg_lit_int64(0);
  outC->_L128.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int64(0);
  outC->_L128.lastSentTrackTrainMessage.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L128.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int64(0);
  outC->_L128.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int64(0);
  outC->_L128.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int64(0);
  outC->_L128.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L128.lastSentTrackTrainMessage.Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L128.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int64(0);
  outC->_L128.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int64(0);
  outC->_L128.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int64(0);
  outC->_L128.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L128.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int64(0);
  outC->_L128.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int64(0);
  outC->_L128.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L128.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L120.header.nid_message = kcg_lit_int64(0);
  outC->_L120.header.t_train = kcg_lit_int64(0);
  outC->_L120.header.nid_engine = kcg_lit_int64(0);
  outC->_L120.header.xQ_MARQSTREASON = Q_MARQSTREASON_Start_selected_by_driver;
  outC->_L120.header.xT_TRAIN = kcg_lit_int64(0);
  outC->_L120.header.xNID_EM = kcg_lit_int64(0);
  outC->_L120.header.xQ_EMERGENCYSTOP =
    Q_EMERGENCYSTOP_Conditional_Emergency_Stop_accepted_with_update_of_EOA;
  outC->_L120.header.xNID_TEXTMESSAGE = kcg_lit_int64(0);
  outC->_L120.packets.p0.valid = kcg_true;
  outC->_L120.packets.p0.packet0.NID_PACKET = kcg_lit_int64(0);
  outC->_L120.packets.p0.packet0.L_PACKET = kcg_lit_int64(0);
  outC->_L120.packets.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L120.packets.p0.packet0.NID_LRBG = kcg_lit_int64(0);
  outC->_L120.packets.p0.packet0.D_LRBG = kcg_lit_int64(0);
  outC->_L120.packets.p0.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L120.packets.p0.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->_L120.packets.p0.packet0.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L120.packets.p0.packet0.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L120.packets.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L120.packets.p0.packet0.L_TRAININT = kcg_lit_int64(0);
  outC->_L120.packets.p0.packet0.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L120.packets.p0.packet0.NID_NTC = kcg_lit_int64(0);
  outC->_L120.packets.p1.valid = kcg_true;
  outC->_L120.packets.p1.packet1.NID_PACKET = kcg_lit_int64(0);
  outC->_L120.packets.p1.packet1.L_PACKET = kcg_lit_int64(0);
  outC->_L120.packets.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L120.packets.p1.packet1.NID_LRBG = kcg_lit_int64(0);
  outC->_L120.packets.p1.packet1.NID_PRVLRBG = kcg_lit_int64(0);
  outC->_L120.packets.p1.packet1.D_LRBG = kcg_lit_int64(0);
  outC->_L120.packets.p1.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L120.packets.p1.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L120.packets.p1.packet1.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L120.packets.p1.packet1.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L120.packets.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L120.packets.p1.packet1.L_TRAININT = kcg_lit_int64(0);
  outC->_L120.packets.p1.packet1.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L120.packets.p1.packet1.NID_NTC = kcg_lit_int64(0);
  outC->_L120.packets.p3.valid = kcg_true;
  outC->_L120.packets.p3.number = kcg_lit_int64(0);
  ...
  outC->_L120.packets.p5.TrainRunningNumber = kcg_lit_int64(0);
  outC->_L120.packets.p9.valid = kcg_true;
  outC->_L120.packets.p9.transitionInformation = kcg_lit_int64(0);
  ...
  outC->_L120.packets.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L120.packets.p11.l_train = kcg_lit_int64(0);
  outC->_L120.packets.p11.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L120.packets.p11.n_axle = kcg_lit_int64(0);
  outC->_L120.packets.p11.nIter_tractionIdentity = kcg_lit_int64(0);
  ...
  outC->_L120.packets.p11.nIter_ntc = kcg_lit_int64(0);
  for (idx78 = 0; idx78 < 5; idx78++) {
    outC->_L120.packets.p11.nid_ntc[idx78] = kcg_lit_int64(0);
  }
  outC->_L123.Header.radioDevice = kcg_lit_int64(0);
  outC->_L123.Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L123.Header.nid_message = kcg_lit_int64(0);
  outC->_L123.Header.t_train = kcg_lit_int64(0);
  outC->_L123.Header.m_ack = kcg_lit_int64(0);
  outC->_L123.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L123.Header.t_train_reference = kcg_lit_int64(0);
  outC->_L123.Header.nid_em = kcg_lit_int64(0);
  outC->_L123.Header.q_scale = kcg_lit_int64(0);
  outC->_L123.Header.d_sr = kcg_lit_int64(0);
  outC->_L123.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L123.Header.d_ref = kcg_lit_int64(0);
  outC->_L123.Header.q_dir = kcg_lit_int64(0);
  outC->_L123.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L123.Header.m_version = kcg_lit_int64(0);
  for (idx79 = 0; idx79 < 30; idx79++) {
    outC->_L123.Messages.PacketHeaders[idx79].nid_packet = kcg_lit_int64(0);
    outC->_L123.Messages.PacketHeaders[idx79].q_dir = Q_DIR_Reverse;
    outC->_L123.Messages.PacketHeaders[idx79].valid = kcg_true;
    outC->_L123.Messages.PacketHeaders[idx79].startAddress = kcg_lit_int64(0);
    outC->_L123.Messages.PacketHeaders[idx79].endAddress = kcg_lit_int64(0);
  }
  for (idx80 = 0; idx80 < 500; idx80++) {
    outC->_L123.Messages.PacketData[idx80] = kcg_lit_int64(0);
  }
  outC->_L112 = kcg_lit_int64(0);
  outC->_L114.radioDevice = kcg_lit_int64(0);
  outC->_L114.receivedSystemTime = kcg_lit_int64(0);
  outC->_L114.nid_message = kcg_lit_int64(0);
  outC->_L114.t_train = kcg_lit_int64(0);
  outC->_L114.m_ack = kcg_lit_int64(0);
  outC->_L114.nid_lrbg = kcg_lit_int64(0);
  outC->_L114.t_train_reference = kcg_lit_int64(0);
  outC->_L114.nid_em = kcg_lit_int64(0);
  outC->_L114.q_scale = kcg_lit_int64(0);
  outC->_L114.d_sr = kcg_lit_int64(0);
  outC->_L114.t_sh_rqst = kcg_lit_int64(0);
  outC->_L114.d_ref = kcg_lit_int64(0);
  outC->_L114.q_dir = kcg_lit_int64(0);
  outC->_L114.d_emergencystop = kcg_lit_int64(0);
  outC->_L114.m_version = kcg_lit_int64(0);
  outC->_L115 = kcg_true;
  ...
  outC->_L76.nid_c = kcg_lit_int64(0);
  outC->_L76.v_nvshunt = kcg_lit_int64(0);
  outC->_L76.v_nvstff = kcg_lit_int64(0);
  outC->_L76.v_nvonsight = kcg_lit_int64(0);
  outC->_L76.v_nvunfit = kcg_lit_int64(0);
  outC->_L76.v_nvrel = kcg_lit_int64(0);
  outC->_L76.t_nvcontact = kcg_lit_int64(0);
  for (idx83 = 0; idx83 < 8; idx83++) {
    ...
    outC->messageQueue.m_Entries[idx83].m_Entry.Header.nid_message =
      kcg_lit_int64(0);
    outC->messageQueue.m_Entries[idx83].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->messageQueue.m_Entries[idx83].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->messageQueue.m_Entries[idx83].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->messageQueue.m_Entries[idx83].m_Entry.Header.t_train_reference =
      kcg_lit_int64(0);
    outC->messageQueue.m_Entries[idx83].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->messageQueue.m_Entries[idx83].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->messageQueue.m_Entries[idx83].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->messageQueue.m_Entries[idx83].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->messageQueue.m_Entries[idx83].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->messageQueue.m_Entries[idx83].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->messageQueue.m_Entries[idx83].m_Entry.Header.d_emergencystop =
      kcg_lit_int64(0);
    outC->messageQueue.m_Entries[idx83].m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  outC->rbcTimestamp = kcg_lit_int64(0);
  outC->remainingCapacity = kcg_lit_int64(0);
  outC->rbcContactTime = kcg_lit_int64(0);
  ...
  for (idx86 = 0; idx86 < 8; idx86++) {
    ...
    outC->_L4_else_IfBlock1.m_Entries[idx86].m_Entry.Header.q_scale =
      kcg_lit_int64(0);
    outC->_L4_else_IfBlock1.m_Entries[idx86].m_Entry.Header.d_sr = kcg_lit_int64(0);
  ...
  outC->_L3_else_IfBlock1.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  ...
  outC->_L3_else_IfBlock1.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.session.m_TrainData.nc_cdtrain =
    NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L3_else_IfBlock1.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L3_else_IfBlock1.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L3_else_IfBlock1.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L3_else_IfBlock1.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L3_else_IfBlock1.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  ...
  outC->_L3_else_IfBlock1.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L3_else_IfBlock1.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L3_else_IfBlock1.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L3_else_IfBlock1.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L3_else_IfBlock1.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  ...
  outC->_L3_else_IfBlock1.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx92 = 0; idx92 < 16; idx92++) {
    ...
    outC->_L3_else_IfBlock1.diagnostic[idx92].count = kcg_lit_int64(0);
    outC->_L3_else_IfBlock1.diagnostic[idx92].timestamp = kcg_lit_int64(0);
  ...
  outC->_L3_else_IfBlock1.clockk.m_Value = kcg_lit_int64(0);
  ...
  outC->_L3_else_IfBlock1.lastSentTrackTrainMessage.Header.q_scale =
    kcg_lit_int64(0);
  outC->_L3_else_IfBlock1.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int64(
      0);
  ...
  outC->_L1_then_IfBlock1.Header.radioDevice = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.Header.nid_message = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.Header.t_train = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.Header.m_ack = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.Header.t_train_reference = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.Header.nid_em = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.Header.q_scale = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.Header.d_sr = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.Header.d_ref = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.Header.q_dir = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.Header.m_version = kcg_lit_int64(0);
  ...
  for (idx99 = 0; idx99 < 500; idx99++) {
    outC->_L1_then_IfBlock1.Messages.PacketData[idx99] = kcg_lit_int64(0);
  }
  outC->_L5_then_IfBlock1 = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1 = M_ACK_No_acknowledgement_required;
  outC->_L15_then_IfBlock1.m_IsValid = kcg_true;
  outC->_L15_then_IfBlock1.m_Entry.Header.radioDevice = kcg_lit_int64(0);
  outC->_L15_then_IfBlock1.m_Entry.Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L15_then_IfBlock1.m_Entry.Header.nid_message = kcg_lit_int64(0);
  outC->_L15_then_IfBlock1.m_Entry.Header.t_train = kcg_lit_int64(0);
  outC->_L15_then_IfBlock1.m_Entry.Header.m_ack = kcg_lit_int64(0);
  outC->_L15_then_IfBlock1.m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L15_then_IfBlock1.m_Entry.Header.t_train_reference = kcg_lit_int64(0);
  outC->_L15_then_IfBlock1.m_Entry.Header.nid_em = kcg_lit_int64(0);
  outC->_L15_then_IfBlock1.m_Entry.Header.q_scale = kcg_lit_int64(0);
  outC->_L15_then_IfBlock1.m_Entry.Header.d_sr = kcg_lit_int64(0);
  outC->_L15_then_IfBlock1.m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L15_then_IfBlock1.m_Entry.Header.d_ref = kcg_lit_int64(0);
  outC->_L15_then_IfBlock1.m_Entry.Header.q_dir = kcg_lit_int64(0);
  outC->_L15_then_IfBlock1.m_Entry.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L15_then_IfBlock1.m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  for (idx101 = 0; idx101 < 500; idx101++) {
    outC->_L15_then_IfBlock1.m_Entry.Messages.PacketData[idx101] = kcg_lit_int64(0);
  }
  ...
  outC->_L21_then_IfBlock1.nid_lrbg = kcg_lit_int64(0);
  outC->_L21_then_IfBlock1.q_scale = Q_SCALE_10_cm_scale;
  outC->_L21_then_IfBlock1.d_lrbg = kcg_lit_int64(0);
  outC->_L21_then_IfBlock1.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L21_then_IfBlock1.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L21_then_IfBlock1.l_doubtover = kcg_lit_int64(0);
  outC->_L21_then_IfBlock1.l_doubtunder = kcg_lit_int64(0);
  outC->_L21_then_IfBlock1.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L21_then_IfBlock1.l_trainint = kcg_lit_int64(0);
  outC->_L21_then_IfBlock1.v_train = kcg_lit_int64(0);
  ...
  outC->_L21_then_IfBlock1.nid_ntc = kcg_lit_int64(0);
  outC->_L21_then_IfBlock1.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L20_then_IfBlock1 = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  ...
  outC->_L25_then_IfBlock1.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.session.m_TrainData.nc_cdtrain =
    NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L25_then_IfBlock1.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L25_then_IfBlock1.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L25_then_IfBlock1.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L25_then_IfBlock1.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L25_then_IfBlock1.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  ...
  outC->_L25_then_IfBlock1.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L25_then_IfBlock1.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L25_then_IfBlock1.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L25_then_IfBlock1.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L25_then_IfBlock1.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  ...
  outC->_L25_then_IfBlock1.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L25_then_IfBlock1.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx110 = 0; idx110 < 16; idx110++) {
    ...
    outC->_L25_then_IfBlock1.diagnostic[idx110].count = kcg_lit_int64(0);
    outC->_L25_then_IfBlock1.diagnostic[idx110].timestamp = kcg_lit_int64(0);
  ...
  outC->_L25_then_IfBlock1.clockk.m_Value = kcg_lit_int64(0);
  ...
  outC->_L24_then_IfBlock1.m_TrainData.nid_engine = kcg_lit_int64(0);
  ...
  outC->_L24_then_IfBlock1.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L24_then_IfBlock1.m_TrainData.nc_cdtrain =
    NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L24_then_IfBlock1.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L24_then_IfBlock1.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L24_then_IfBlock1.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L24_then_IfBlock1.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L24_then_IfBlock1.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L24_then_IfBlock1.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L24_then_IfBlock1.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L24_then_IfBlock1.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L24_then_IfBlock1.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L24_then_IfBlock1.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L24_then_IfBlock1.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L24_then_IfBlock1.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L24_then_IfBlock1.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L24_then_IfBlock1.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L24_then_IfBlock1.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L24_then_IfBlock1.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L24_then_IfBlock1.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  ...
  outC->_L29_then_IfBlock1.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.session.m_TrainData.nc_cdtrain =
    NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L29_then_IfBlock1.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L29_then_IfBlock1.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L29_then_IfBlock1.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L29_then_IfBlock1.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L29_then_IfBlock1.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  ...
  outC->_L29_then_IfBlock1.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L29_then_IfBlock1.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L29_then_IfBlock1.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L29_then_IfBlock1.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L29_then_IfBlock1.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  ...
  outC->_L29_then_IfBlock1.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L29_then_IfBlock1.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx125 = 0; idx125 < 16; idx125++) {
    ...
    outC->_L29_then_IfBlock1.diagnostic[idx125].count = kcg_lit_int64(0);
    outC->_L29_then_IfBlock1.diagnostic[idx125].timestamp = kcg_lit_int64(0);
  ...
  outC->_L29_then_IfBlock1.clockk.m_Value = kcg_lit_int64(0);
  ...
  outC->_L31_then_IfBlock1.NID_PACKET = kcg_lit_int64(0);
  outC->_L31_then_IfBlock1.Q_DIR = kcg_lit_int64(0);
  outC->_L31_then_IfBlock1.L_PACKET = kcg_lit_int64(0);
  outC->_L31_then_IfBlock1.Q_RBC = kcg_lit_int64(0);
  outC->_L31_then_IfBlock1.NID_C = kcg_lit_int64(0);
  outC->_L31_then_IfBlock1.NID_RBC = kcg_lit_int64(0);
  outC->_L31_then_IfBlock1.NID_RADIO = kcg_lit_int64(0);
  outC->_L31_then_IfBlock1.Q_SLEEPSESSION = kcg_lit_int64(0);
  outC->_L33_then_IfBlock1.valid = kcg_true;
  outC->_L33_then_IfBlock1.NID_PACKET = kcg_lit_int64(0);
  outC->_L33_then_IfBlock1.Q_DIR = kcg_lit_int64(0);
  outC->_L33_then_IfBlock1.L_PACKET = kcg_lit_int64(0);
  outC->_L33_then_IfBlock1.Q_RBC = kcg_lit_int64(0);
  outC->_L33_then_IfBlock1.NID_C = kcg_lit_int64(0);
  outC->_L33_then_IfBlock1.NID_RBC = kcg_lit_int64(0);
  outC->_L33_then_IfBlock1.NID_RADIO = kcg_lit_int64(0);
  outC->_L33_then_IfBlock1.Q_SLEEPSESSION = kcg_lit_int64(0);
  outC->_L34_then_IfBlock1.valid = kcg_true;
  outC->_L34_then_IfBlock1.NID_PACKET = kcg_lit_int64(0);
  outC->_L34_then_IfBlock1.Q_DIR = kcg_lit_int64(0);
  outC->_L34_then_IfBlock1.L_PACKET = kcg_lit_int64(0);
  outC->_L34_then_IfBlock1.Q_RBC = kcg_lit_int64(0);
  outC->_L34_then_IfBlock1.NID_C = kcg_lit_int64(0);
  outC->_L34_then_IfBlock1.NID_RBC = kcg_lit_int64(0);
  outC->_L34_then_IfBlock1.NID_RADIO = kcg_lit_int64(0);
  outC->_L34_then_IfBlock1.Q_SLEEPSESSION = kcg_lit_int64(0);
  outC->_L80_then_IfBlock1.nid_lrbg = kcg_lit_int64(0);
  outC->_L80_then_IfBlock1.q_scale = Q_SCALE_10_cm_scale;
  outC->_L80_then_IfBlock1.d_lrbg = kcg_lit_int64(0);
  outC->_L80_then_IfBlock1.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L80_then_IfBlock1.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L80_then_IfBlock1.l_doubtover = kcg_lit_int64(0);
  outC->_L80_then_IfBlock1.l_doubtunder = kcg_lit_int64(0);
  outC->_L80_then_IfBlock1.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L80_then_IfBlock1.l_trainint = kcg_lit_int64(0);
  outC->_L80_then_IfBlock1.v_train = kcg_lit_int64(0);
  ...
  outC->_L80_then_IfBlock1.nid_ntc = kcg_lit_int64(0);
  outC->_L80_then_IfBlock1.nid_prvlrbg = kcg_lit_int64(0);
  ...
  for (idx139 = 0; idx139 < 5; idx139++) {
    outC->outRadioTrainTrackMessage.packets.p11.nid_ntc[idx139] = kcg_lit_int64(0);
  }
  ...
  for (idx145 = 0; idx145 < 16; idx145++) {
    ...
    outC->outDataBus.diagnostic[idx145].count = kcg_lit_int64(0);
    outC->outDataBus.diagnostic[idx145].timestamp = kcg_lit_int64(0);
  ...
  RadioTrackTrainMessageQueueEntry__Create_init_RBC_Collections_Pkg(
    &outC->Context_RadioTrackTrainMessageQueueEntry__Create_2);
  /* IfBlock1:then:_L1=(RBC_Messaging_Pkg::RBC_RadioTrackTrainFactory_Pkg::RadioTrackTrainFactory__CreateMsg024_BSL2#1)/ */
  RadioTrackTrainFactory__CreateMsg024_BSL2_init_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg(
    &outC->Context_RadioTrackTrainFactory__CreateMsg024_BSL2_1);
  /* IfBlock1:then:_L79=(RBC_Session_Pkg::PosData__Get_M_LEVEL#8)/ */
  ...
  /* _L115=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__IsValid#2)/ */
  RadioTrackTrainMessage__IsValid_init_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg(
    &outC->Context_RadioTrackTrainMessage__IsValid_2);
  /* _L112=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_T_TRAIN#2)/ */
  ...
  RadioTrackTrainMessage__GetHeader_init_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg(
    &outC->Context_RadioTrackTrainMessage__GetHeader_2);
  /* _L75=(RBC_Config_Pkg::NationalParams__Get_T_NVCONTACT#1)/ */
  NationalParams__Get_T_NVCONTACT_init_RBC_Config_Pkg(
    &outC->Context_NationalParams__Get_T_NVCONTACT_1);
  /* _L76=(RBC_Config_Pkg::DynamicConfig__GetNationalParams#1)/ */
  DynamicConfig__GetNationalParams_init_RBC_Config_Pkg(
    &outC->Context_DynamicConfig__GetNationalParams_1);
...
void RBC__PingTrain_reset_RBC_Model_Pkg(outC_RBC__PingTrain_RBC_Model_Pkg *outC)
{
  ...
  RadioTrackTrainMessageQueueEntry__Create_reset_RBC_Collections_Pkg(
    &outC->Context_RadioTrackTrainMessageQueueEntry__Create_2);
  /* IfBlock1:then:_L1=(RBC_Messaging_Pkg::RBC_RadioTrackTrainFactory_Pkg::RadioTrackTrainFactory__CreateMsg024_BSL2#1)/ */
  RadioTrackTrainFactory__CreateMsg024_BSL2_reset_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg(
    &outC->Context_RadioTrackTrainFactory__CreateMsg024_BSL2_1);
  /* IfBlock1:then:_L79=(RBC_Session_Pkg::PosData__Get_M_LEVEL#8)/ */
  ...
  /* _L115=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__IsValid#2)/ */
  RadioTrackTrainMessage__IsValid_reset_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg(
    &outC->Context_RadioTrackTrainMessage__IsValid_2);
  /* _L112=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_T_TRAIN#2)/ */
  ...
  RadioTrackTrainMessage__GetHeader_reset_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg(
    &outC->Context_RadioTrackTrainMessage__GetHeader_2);
  /* _L75=(RBC_Config_Pkg::NationalParams__Get_T_NVCONTACT#1)/ */
  NationalParams__Get_T_NVCONTACT_reset_RBC_Config_Pkg(
    &outC->Context_NationalParams__Get_T_NVCONTACT_1);
  /* _L76=(RBC_Config_Pkg::DynamicConfig__GetNationalParams#1)/ */
  DynamicConfig__GetNationalParams_reset_RBC_Config_Pkg(
    &outC->Context_DynamicConfig__GetNationalParams_1);
  outC->lastRadioTrackTrainMessageWasSentTimestamp = T_TRAIN_MIN;
  outC->Level_2_or_3 = kcg_false;
}
...
void kcg_save_SV_RBC__PingTrain_RBC_Model_Pkg(
  SV_RBC__PingTrain_RBC_Model_Pkg *SV,
  outC_RBC__PingTrain_RBC_Model_Pkg *outC)
{
  SV->Context_Level_2_or_3 = outC->Level_2_or_3;
  SV->Context_lastRadioTrackTrainMessageWasSentTimestamp =
    outC->lastRadioTrackTrainMessageWasSentTimestamp;
}

void kcg_load_SV_RBC__PingTrain_RBC_Model_Pkg(
  outC_RBC__PingTrain_RBC_Model_Pkg *outC,
  SV_RBC__PingTrain_RBC_Model_Pkg *SV)
{
  outC->Level_2_or_3 = SV->Context_Level_2_or_3;
  outC->lastRadioTrackTrainMessageWasSentTimestamp =
    SV->Context_lastRadioTrackTrainMessageWasSentTimestamp;
}
