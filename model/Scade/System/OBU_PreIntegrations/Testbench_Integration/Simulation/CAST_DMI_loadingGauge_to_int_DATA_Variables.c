...
void CAST_DMI_loadingGauge_to_int_DATA_Variables(
  /* dmi_loadingGauge_ct/ */
  ...
  outC_CAST_DMI_loadingGauge_to_int_DATA_Variables *outC)
{
  ...
  kcg_copy_DMI_loadingGauge_T_DMI_Types_Pkg(&outC->_L1, dmi_loadingGauge_ct);
  outC->_L7 = outC->_L1.number;
  outC->_L40 = kcg_lit_int64(3);
  ...
  outC->dmi_loadingGauge_int = outC->_L22;
}

#ifndef KCG_USER_DEFINED_INIT
void CAST_DMI_loadingGauge_to_int_init_DATA_Variables(
  outC_CAST_DMI_loadingGauge_to_int_DATA_Variables *outC)
{
  outC->_L41 = kcg_true;
  ...
  outC->error = kcg_true;
  outC->dmi_loadingGauge_int = kcg_lit_int64(0);
  /* _L23=(Utilities::BCD_to_Int#1)/ */
...
void CAST_DMI_loadingGauge_to_int_reset_DATA_Variables(
  outC_CAST_DMI_loadingGauge_to_int_DATA_Variables *outC)
{
  /* _L23=(Utilities::BCD_to_Int#1)/ */
