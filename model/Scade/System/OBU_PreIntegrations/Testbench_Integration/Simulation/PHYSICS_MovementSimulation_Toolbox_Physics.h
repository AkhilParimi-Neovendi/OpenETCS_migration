...
typedef struct {
  ...
  _118_SSM_ST_SM1 /* SM1: */ Context_SM1_state_nxt;
  kcg_float32 /* SM1:Driving:_L14/ */ Context__L14;
  kcg_float32 /* SM1:Driving:_L15/ */ Context__L15;
  kcg_bool /* @1/_L2/ */ Context__L2_FlipFlopSet_1;
  kcg_bool _1_Context_init;
  kcg_bool Context_init;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_PHYSICS_simulateAccelerationBuildupTime_Toolbox_Physics_Basic Context_PHYSICS_simulateAccelerationBuildupTime_1;
  SV_TRAIN_systemTimeGenerator_Toolbox_Functions Context_TRAIN_systemTimeGenerator_1;
} SV_PHYSICS_MovementSimulation_Toolbox_Physics;

extern void kcg_save_SV_PHYSICS_MovementSimulation_Toolbox_Physics(
  SV_PHYSICS_MovementSimulation_Toolbox_Physics *SV,
  outC_PHYSICS_MovementSimulation_Toolbox_Physics *outC);
extern void kcg_load_SV_PHYSICS_MovementSimulation_Toolbox_Physics(
  outC_PHYSICS_MovementSimulation_Toolbox_Physics *outC,
  SV_PHYSICS_MovementSimulation_Toolbox_Physics *SV);
