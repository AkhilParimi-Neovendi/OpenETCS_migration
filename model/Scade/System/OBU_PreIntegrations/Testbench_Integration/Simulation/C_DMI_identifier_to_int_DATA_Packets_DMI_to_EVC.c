  ...
  outC_C_DMI_identifier_to_int_DATA_Packets_DMI_to_EVC *outC)
{
  ...
  kcg_copy_array_int64_5(&tmp[0], &outC->_L32);
  kcg_copy_DMI_TEXT_INT_Array_T_DATA(&tmp[5], &outC->_L23);
  kcg_copy_array_int64_260(&outC->_L39[0], &tmp);
  ...
  outC_C_DMI_identifier_to_int_DATA_Packets_DMI_to_EVC *outC)
{
  ...
  outC->_L40.l_name = kcg_lit_int64(0);
  ...
  for (idx1 = 0; idx1 < 261; idx1++) {
    outC->_L39[idx1] = kcg_lit_int64(0);
  }
  outC->_L36 = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 5; idx2++) {
    outC->_L32[idx2] = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 1; idx3++) {
    outC->_L28[idx3] = kcg_lit_int64(0);
  }
  outC->_L24 = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 255; idx4++) {
    outC->_L23[idx4] = kcg_lit_int64(0);
  }
  ...
  for (idx6 = 0; idx6 < 261; idx6++) {
    outC->dmi_identifier_int[idx6] = kcg_lit_int64(0);
  }
  /* _L24=(DATA::Variables::CAST_DMI_Cabin_identifier_to_int#1)/ */
