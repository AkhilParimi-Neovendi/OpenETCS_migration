...
void RBC_Clock_Tick_init_RBC_Time_Pkg(outC_RBC_Clock_Tick_RBC_Time_Pkg *outC)
{
  ...
  outC->_L4.session.m_TrainData.nid_engine = kcg_lit_int32(0);
  outC->_L4.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int32(0);
  ...
  outC->_L4.session.m_TrainData.t_train_ref = kcg_lit_int32(0);
  ...
  outC->_L4.session.m_TrainData.l_train = kcg_lit_int32(0);
  outC->_L4.session.m_TrainData.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L4.session.m_TrainData.n_axle = kcg_lit_int32(0);
  ...
  outC->_L4.session.m_TrainData.nid_operational = kcg_lit_int32(0);
  outC->_L4.session.m_PosData.nid_lrbg = kcg_lit_int32(0);
  outC->_L4.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L4.session.m_PosData.d_lrbg = kcg_lit_int32(0);
  outC->_L4.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L4.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L4.session.m_PosData.l_doubtover = kcg_lit_int32(0);
  outC->_L4.session.m_PosData.l_doubtunder = kcg_lit_int32(0);
  outC->_L4.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L4.session.m_PosData.l_trainint = kcg_lit_int32(0);
  outC->_L4.session.m_PosData.v_train = kcg_lit_int32(0);
  ...
  outC->_L4.session.m_PosData.nid_ntc = kcg_lit_int32(0);
  outC->_L4.session.m_PosData.nid_prvlrbg = kcg_lit_int32(0);
  outC->_L4.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L4.config.m_NationalParams.nid_c = kcg_lit_int32(0);
  outC->_L4.config.m_NationalParams.v_nvshunt = kcg_lit_int32(0);
  outC->_L4.config.m_NationalParams.v_nvstff = kcg_lit_int32(0);
  outC->_L4.config.m_NationalParams.v_nvonsight = kcg_lit_int32(0);
  outC->_L4.config.m_NationalParams.v_nvunfit = kcg_lit_int32(0);
  outC->_L4.config.m_NationalParams.v_nvrel = kcg_lit_int32(0);
  outC->_L4.config.m_NationalParams.t_nvcontact = kcg_lit_int32(0);
  outC->_L4.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L4.config.m_MAReqParams.t_mar = kcg_lit_int32(0);
  outC->_L4.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int32(0);
  outC->_L4.config.m_MAReqParams.t_cycrqst = kcg_lit_int32(0);
  outC->_L4.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L4.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L4.config.m_PosRepParams.t_cycloc = kcg_lit_int32(0);
  outC->_L4.config.m_PosRepParams.d_cycloc = kcg_lit_int32(0);
  ...
  for (idx5 = 0; idx5 < 16; idx5++) {
    ...
    outC->_L4.diagnostic[idx5].count = kcg_lit_int32(0);
    outC->_L4.diagnostic[idx5].timestamp = kcg_lit_int32(0);
  ...
  for (idx8 = 0; idx8 < 8; idx8++) {
    ...
    outC->_L4.messageQueue.m_Entries[idx8].m_Entry.Header.t_train =
      kcg_lit_int32(0);
    outC->_L4.messageQueue.m_Entries[idx8].m_Entry.Header.m_ack = kcg_lit_int32(0);
    ...
    outC->_L4.messageQueue.m_Entries[idx8].m_Entry.Header.t_train_reference =
      kcg_lit_int32(0);
    outC->_L4.messageQueue.m_Entries[idx8].m_Entry.Header.nid_em = kcg_lit_int32(0);
    outC->_L4.messageQueue.m_Entries[idx8].m_Entry.Header.q_scale =
      kcg_lit_int32(0);
    outC->_L4.messageQueue.m_Entries[idx8].m_Entry.Header.d_sr = kcg_lit_int32(0);
    outC->_L4.messageQueue.m_Entries[idx8].m_Entry.Header.t_sh_rqst =
      kcg_lit_int32(0);
    outC->_L4.messageQueue.m_Entries[idx8].m_Entry.Header.d_ref = kcg_lit_int32(0);
    outC->_L4.messageQueue.m_Entries[idx8].m_Entry.Header.q_dir = kcg_lit_int32(0);
  ...
  outC->_L4.clockk.m_Value = kcg_lit_int32(0);
  outC->_L4.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int32(0);
  outC->_L4.lastSentTrackTrainMessage.Header.receivedSystemTime = kcg_lit_int32(
      0);
  outC->_L4.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int32(0);
  outC->_L4.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int32(0);
  outC->_L4.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int32(0);
  outC->_L4.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L4.lastSentTrackTrainMessage.Header.t_train_reference = kcg_lit_int32(0);
  outC->_L4.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int32(0);
  outC->_L4.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int32(0);
  outC->_L4.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int32(0);
  outC->_L4.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L4.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int32(0);
  outC->_L4.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int32(0);
  outC->_L4.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int32(0);
  outC->_L4.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int32(0);
  ...
  outC->_L3.session.m_TrainData.nid_engine = kcg_lit_int32(0);
  outC->_L3.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int32(0);
  ...
  outC->_L3.session.m_TrainData.t_train_ref = kcg_lit_int32(0);
  outC->_L3.session.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L3.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L3.session.m_TrainData.l_train = kcg_lit_int32(0);
  outC->_L3.session.m_TrainData.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L3.session.m_TrainData.n_axle = kcg_lit_int32(0);
  ...
  outC->_L3.session.m_TrainData.nid_operational = kcg_lit_int32(0);
  outC->_L3.session.m_PosData.nid_lrbg = kcg_lit_int32(0);
  outC->_L3.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L3.session.m_PosData.d_lrbg = kcg_lit_int32(0);
  outC->_L3.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L3.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L3.session.m_PosData.l_doubtover = kcg_lit_int32(0);
  outC->_L3.session.m_PosData.l_doubtunder = kcg_lit_int32(0);
  outC->_L3.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L3.session.m_PosData.l_trainint = kcg_lit_int32(0);
  outC->_L3.session.m_PosData.v_train = kcg_lit_int32(0);
  ...
  outC->_L3.session.m_PosData.nid_ntc = kcg_lit_int32(0);
  outC->_L3.session.m_PosData.nid_prvlrbg = kcg_lit_int32(0);
  outC->_L3.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L3.config.m_NationalParams.nid_c = kcg_lit_int32(0);
  outC->_L3.config.m_NationalParams.v_nvshunt = kcg_lit_int32(0);
  outC->_L3.config.m_NationalParams.v_nvstff = kcg_lit_int32(0);
  outC->_L3.config.m_NationalParams.v_nvonsight = kcg_lit_int32(0);
  outC->_L3.config.m_NationalParams.v_nvunfit = kcg_lit_int32(0);
  outC->_L3.config.m_NationalParams.v_nvrel = kcg_lit_int32(0);
  outC->_L3.config.m_NationalParams.t_nvcontact = kcg_lit_int32(0);
  outC->_L3.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L3.config.m_MAReqParams.t_mar = kcg_lit_int32(0);
  outC->_L3.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int32(0);
  outC->_L3.config.m_MAReqParams.t_cycrqst = kcg_lit_int32(0);
  outC->_L3.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L3.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L3.config.m_PosRepParams.t_cycloc = kcg_lit_int32(0);
  outC->_L3.config.m_PosRepParams.d_cycloc = kcg_lit_int32(0);
  ...
  for (idx16 = 0; idx16 < 16; idx16++) {
    ...
    outC->_L3.diagnostic[idx16].count = kcg_lit_int32(0);
    outC->_L3.diagnostic[idx16].timestamp = kcg_lit_int32(0);
  ...
  for (idx19 = 0; idx19 < 8; idx19++) {
    ...
    outC->_L3.messageQueue.m_Entries[idx19].m_Entry.Header.t_train =
      kcg_lit_int32(0);
    outC->_L3.messageQueue.m_Entries[idx19].m_Entry.Header.m_ack = kcg_lit_int32(0);
    ...
    outC->_L3.messageQueue.m_Entries[idx19].m_Entry.Header.q_scale =
      kcg_lit_int32(0);
    outC->_L3.messageQueue.m_Entries[idx19].m_Entry.Header.d_sr = kcg_lit_int32(0);
    outC->_L3.messageQueue.m_Entries[idx19].m_Entry.Header.t_sh_rqst =
      kcg_lit_int32(0);
    outC->_L3.messageQueue.m_Entries[idx19].m_Entry.Header.d_ref = kcg_lit_int32(0);
    outC->_L3.messageQueue.m_Entries[idx19].m_Entry.Header.q_dir = kcg_lit_int32(0);
  ...
  outC->_L3.clockk.m_Value = kcg_lit_int32(0);
  outC->_L3.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int32(0);
  outC->_L3.lastSentTrackTrainMessage.Header.receivedSystemTime = kcg_lit_int32(
      0);
  outC->_L3.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int32(0);
  outC->_L3.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int32(0);
  outC->_L3.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int32(0);
  outC->_L3.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L3.lastSentTrackTrainMessage.Header.t_train_reference = kcg_lit_int32(0);
  outC->_L3.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int32(0);
  outC->_L3.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int32(0);
  outC->_L3.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int32(0);
  outC->_L3.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L3.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int32(0);
  outC->_L3.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int32(0);
  outC->_L3.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int32(0);
  outC->_L3.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int32(0);
  ...
  for (idx27 = 0; idx27 < 16; idx27++) {
    ...
    outC->outDataBus.diagnostic[idx27].count = kcg_lit_int32(0);
    outC->outDataBus.diagnostic[idx27].timestamp = kcg_lit_int32(0);
