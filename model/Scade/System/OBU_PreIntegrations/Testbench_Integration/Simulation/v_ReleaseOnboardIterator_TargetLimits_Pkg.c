  ...
  outC_v_ReleaseOnboardIterator_TargetLimits_Pkg *outC)
{
  ...
  if (outC->every) {
    outC->I2_Max_1_float64 = outC->_L9;
    outC->_L2_Max_1_float64 = outC->I2_Max_1_float64;
  }
  outC->_L12 = V_ura;
  if (outC->every) {
    outC->I1_Max_1_float64 = outC->_L12;
    ...
    op_call = outC->Ma_Output_Max_1_float64;
  }
  ...
  outC->A_Input_Abs_1_float64 = outC->_L40;
  ...
  outC->_L45 = kcg_lit_float64(1.0) / kcg_lit_float64(3.6);
  outC->_L39 = outC->A_Output_Abs_1_float64;
  ...
  outC_v_ReleaseOnboardIterator_TargetLimits_Pkg *outC)
{
  ...
  outC->_L54 = kcg_true;
  outC->_L55.Traction = kcg_lit_float64(0.0);
  outC->_L55.berem = kcg_lit_float64(0.0);
  outC->_L55.bs = kcg_lit_float64(0.0);
  outC->_L55.bs1 = kcg_lit_float64(0.0);
  outC->_L55.bs2 = kcg_lit_float64(0.0);
  outC->_L55.inhComp = kcg_true;
  outC->_L55.indication = kcg_lit_float64(0.0);
  ...
  for (idx = 0; idx < 114; idx++) {
    outC->_L34.distances[idx] = kcg_lit_float64(0.0);
  }
  for (idx1 = 0; idx1 < 114; idx1++) {
    outC->_L34.speeds[idx1] = kcg_lit_float64(0.0);
  }
  for (idx2 = 0; idx2 < 114; idx2++) {
    outC->_L34.accelerations[idx2] = kcg_lit_float64(0.0);
  }
  ...
  outC->_L8.Traction = kcg_lit_float64(0.0);
  outC->_L8.berem = kcg_lit_float64(0.0);
  outC->_L8.bs = kcg_lit_float64(0.0);
  outC->_L8.bs1 = kcg_lit_float64(0.0);
  outC->_L8.bs2 = kcg_lit_float64(0.0);
  outC->_L8.inhComp = kcg_true;
  outC->_L8.indication = kcg_lit_float64(0.0);
  outC->_L9 = kcg_lit_float64(0.0);
  outC->_L10 = kcg_true;
  for (idx4 = 0; idx4 < 114; idx4++) {
    outC->_L1.distances[idx4] = kcg_lit_float64(0.0);
  }
  for (idx5 = 0; idx5 < 114; idx5++) {
    outC->_L1.speeds[idx5] = kcg_lit_float64(0.0);
  }
  for (idx6 = 0; idx6 < 114; idx6++) {
    outC->_L1.accelerations[idx6] = kcg_lit_float64(0.0);
  }
  for (idx7 = 0; idx7 < 114; idx7++) {
    outC->_L1.valid[idx7] = kcg_true;
  }
  outC->end_condition = kcg_true;
  outC->d_bec = kcg_lit_float64(0.0);
  outC->v_delta0rsob = kcg_lit_float64(0.0);
  outC->every = kcg_true;
  ...
  outC->V_release_next = kcg_lit_float64(0.0);
