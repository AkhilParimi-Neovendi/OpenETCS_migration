...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_Write_P003V1_TM_trackside_baseline2 /* _L6=(TM_trackside_baseline2::Write_P003V1#1)/ */ Context_Write_P003V1_1;
  /* ------------------ clocks of observable data -------------------- */
  kcg_bool every;
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  CompressedPackets_T_Common_Types_Pkg /* _L3/ */ _L3;
  P003V1_trackside_int_T_TM_baseline2 /* _L4/ */ _L4;
  kcg_bool /* _L8/ */ _L8;
  kcg_bool /* _L6/ */ _L6;
...
extern void Send_P003V1_init_MessageLibBaseline2(
  outC_Send_P003V1_MessageLibBaseline2 *outC);
