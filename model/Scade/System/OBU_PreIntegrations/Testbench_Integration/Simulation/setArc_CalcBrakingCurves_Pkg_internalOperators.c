  ...
  outC_setArc_CalcBrakingCurves_Pkg_internalOperators *outC)
{
  ...
  kcg_copy_ParabolaCurveDistances_T_CalcBrakingCurves_types(
    &outC->_L24,
    &outC->_L4);
  if ((kcg_lit_int64(0) <= outC->_L36) & (outC->_L36 < kcg_lit_int64(114))) {
  ...
  outC_setArc_CalcBrakingCurves_Pkg_internalOperators *outC)
{
  ...
  for (idx2 = 0; idx2 < 114; idx2++) {
    outC->_L22[idx2] = kcg_lit_float64(0.0);
  }
  outC->_L29 = kcg_lit_float64(0.0);
  outC->_L30 = kcg_lit_float64(0.0);
  outC->_L31 = kcg_lit_float64(0.0);
  outC->_L25.distance = kcg_lit_float64(0.0);
  outC->_L25.speed = kcg_lit_float64(0.0);
  outC->_L25.acceleration = kcg_lit_float64(0.0);
  outC->_L18 = kcg_true;
  for (idx3 = 0; idx3 < 114; idx3++) {
    outC->_L16[idx3] = kcg_true;
  }
  for (idx4 = 0; idx4 < 114; idx4++) {
    outC->_L14.distances[idx4] = kcg_lit_float64(0.0);
  }
  for (idx5 = 0; idx5 < 114; idx5++) {
    outC->_L14.speeds[idx5] = kcg_lit_float64(0.0);
  }
  for (idx6 = 0; idx6 < 114; idx6++) {
    outC->_L14.accelerations[idx6] = kcg_lit_float64(0.0);
  }
  ...
  for (idx9 = 0; idx9 < 114; idx9++) {
    outC->_L6[idx9] = kcg_lit_float64(0.0);
  }
  for (idx10 = 0; idx10 < 114; idx10++) {
    outC->_L5[idx10] = kcg_lit_float64(0.0);
  }
  for (idx11 = 0; idx11 < 114; idx11++) {
    outC->_L4[idx11] = kcg_lit_float64(0.0);
  }
  for (idx12 = 0; idx12 < 114; idx12++) {
    outC->_L1.distances[idx12] = kcg_lit_float64(0.0);
  }
  for (idx13 = 0; idx13 < 114; idx13++) {
    outC->_L1.speeds[idx13] = kcg_lit_float64(0.0);
  }
  for (idx14 = 0; idx14 < 114; idx14++) {
    outC->_L1.accelerations[idx14] = kcg_lit_float64(0.0);
  }
  for (idx15 = 0; idx15 < 114; idx15++) {
    outC->_L1.valid[idx15] = kcg_true;
  }
  for (idx16 = 0; idx16 < 114; idx16++) {
    outC->newBC.distances[idx16] = kcg_lit_float64(0.0);
  }
  for (idx17 = 0; idx17 < 114; idx17++) {
    outC->newBC.speeds[idx17] = kcg_lit_float64(0.0);
  }
  for (idx18 = 0; idx18 < 114; idx18++) {
    outC->newBC.accelerations[idx18] = kcg_lit_float64(0.0);
  }
