  ...
  outC_terminateSession_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  ...
  /* SM1: */
  static _124_SSM_ST_SM1 _4_SM1_state_nxt_partial;
  /* SM1: */
  static kcg_bool _5_SM1_reset_nxt_partial;
  /* SM1: */
  static _125_SSM_TR_SM1 _6_SM1_fired_partial;
  ...
  /* SM1: */
  static _124_SSM_ST_SM1 _18_SM1_state_act_partial;
  /* SM1: */
  static kcg_bool _19_SM1_reset_act_partial;
  /* SM1: */
  static _125_SSM_TR_SM1 _20_SM1_fired_strong_partial;
  ...
  /* SM1: */
  static _124_SSM_ST_SM1 _21_SM1_state_act_partial;
  /* SM1: */
  static kcg_bool _22_SM1_reset_act_partial;
  /* SM1: */
  static _125_SSM_TR_SM1 _23_SM1_fired_strong_partial;
  /* SM1:terminated:<1> */
  ...
  switch (outC->SM1_state_sel) {
    case SSM_st_terminated_SM1 :
      ...
      if (tr_1_guard_terminated_SM1) {
        _21_SM1_state_act_partial = _158_SSM_st_idle_SM1;
      }
      else {
      ...
      if (tr_1_guard_terminated_SM1) {
        ...
        _23_SM1_fired_strong_partial = _159_SSM_TR_no_trans_SM1;
      }
    ...
    case SSM_st_waitForAckTerminationOfCommunicationSessionReceived_SM1 :
      ...
      if (tr_1_guard_waitForAckTerminationOfCommunicationSessionReceived_SM1) {
        _18_SM1_state_act_partial = _158_SSM_st_idle_SM1;
      }
      else {
      ...
      if (tr_1_guard_waitForAckTerminationOfCommunicationSessionReceived_SM1) {
        ...
        _20_SM1_fired_strong_partial = _159_SSM_TR_no_trans_SM1;
      }
    ...
    case _158_SSM_st_idle_SM1 :
      ...
      if (tr_1_guard_idle_SM1) {
        ...
        SM1_state_act_partial = _158_SSM_st_idle_SM1;
      }
      ...
      if (tr_1_guard_idle_SM1) {
        ...
        SM1_fired_strong_partial = _159_SSM_TR_no_trans_SM1;
      }
  ...
  switch (outC->SM1_state_act) {
    case SSM_st_waitForAckTerminationOfCommunicationSessionReceived_SM1 :
      outC->waitForAckTerminationOfCommunicationSessionReceived_weakb_clock_SM1 =
        outC->SM1_fired_strong != _159_SSM_TR_no_trans_SM1;
  ...
  switch (outC->SM1_state_act) {
    ...
    case SSM_st_waitForAckTerminationOfCommunicationSessionReceived_SM1 :
      ...
      if (outC->waitForAckTerminationOfCommunicationSessionReceived_weakb_clock_SM1) {
        ...
        if (tr_2_guard_waitForAckTerminationOfCommunicationSessionReceived_SM1) {
          ...
          _7_SM1_fired_partial = _159_SSM_TR_no_trans_SM1;
        }
    ...
    case _158_SSM_st_idle_SM1 :
      ...
      SM1_state_nxt_partial = _158_SSM_st_idle_SM1;
  ...
  outC_terminateSession_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  ...
  outC->SM1_fired = _159_SSM_TR_no_trans_SM1;
  outC->SM1_fired_strong = _159_SSM_TR_no_trans_SM1;
  outC->SM1_state_act = _158_SSM_st_idle_SM1;
  outC->SM1_state_sel = _158_SSM_st_idle_SM1;
...
void kcg_save_SV_terminateSession_v2_MoRC_Pck_Subfunc_Pkg(
  SV_terminateSession_v2_MoRC_Pck_Subfunc_Pkg *SV,
  outC_terminateSession_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
...
void kcg_load_SV_terminateSession_v2_MoRC_Pck_Subfunc_Pkg(
  outC_terminateSession_v2_MoRC_Pck_Subfunc_Pkg *outC,
  SV_terminateSession_v2_MoRC_Pck_Subfunc_Pkg *SV)
{
