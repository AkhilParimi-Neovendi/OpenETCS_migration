  ...
  outC_CalculateDistanceToTarget_DMI_Control_Pkg_Sub_func_DistanceToTarget *outC)
{
  ...
  static kcg_float64 InterpolatedDistanceToTarget_partial;
  /* InterpolatedDistanceToTarget/ */
  static kcg_float64 _1_InterpolatedDistanceToTarget_partial;
  /* InterpolatedDistanceToTarget/ */
  static kcg_float64 _2_InterpolatedDistanceToTarget_partial;
  /* InterpolatedDistanceToTarget/ */
  static kcg_float64 _3_InterpolatedDistanceToTarget_partial;
  /* InterpolatedDistanceToTarget/ */
  static kcg_float64 _4_InterpolatedDistanceToTarget_partial;
  /* InterpolatedDistanceToTarget/ */
  static kcg_float64 _5_InterpolatedDistanceToTarget_partial;
  /* InterpolatedDistanceToTarget/ */
  static kcg_float64 last_InterpolatedDistanceToTarget;

  last_InterpolatedDistanceToTarget = outC->InterpolatedDistanceToTarget;
  outC->IfBlock1_clock = DistanceToTarget < kcg_lit_float64(0.0);
  /* IfBlock1: */
  if (outC->IfBlock1_clock) {
    outC->_L8_then_IfBlock1 = kcg_lit_float64(-89.5);
    ...
    outC->else_clock_IfBlock1 = DistanceToTarget < kcg_lit_float64(100.0);
    /* IfBlock1:else: */
    if (outC->else_clock_IfBlock1) {
      outC->_L1_then_else_IfBlock1 = kcg_lit_float64(0.33);
      ...
      outC->_L4_then_else_IfBlock1 = kcg_lit_float64(-89.5);
      ...
      outC->else_clock_else_IfBlock1 = DistanceToTarget > kcg_lit_float64(1000.0);
      /* IfBlock1:else:else: */
      if (outC->else_clock_else_IfBlock1) {
        outC->_L1_then_else_else_IfBlock1 = kcg_lit_float64(96.5);
        ...
        outC->_L8_else_else_else_IfBlock1 = kcg_lit_float64(2.0);
        ...
        outC->_L6_else_else_else_IfBlock1 =
          ...
          LogR64_mathext_mathextimpl(outC->_L2_else_else_else_IfBlock1);
  ...
  outC_CalculateDistanceToTarget_DMI_Control_Pkg_Sub_func_DistanceToTarget *outC)
{
  ...
  outC->InterpolatedDistanceToTarget = kcg_lit_float64(0.0);
}
