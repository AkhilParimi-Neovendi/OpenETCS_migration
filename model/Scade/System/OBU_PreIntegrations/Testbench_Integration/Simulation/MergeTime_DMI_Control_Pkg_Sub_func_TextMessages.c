  ...
  outC_MergeTime_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  kcg_copy_array_float64_10(&outC->_L12, AuxTimeiArray);
  kcg_copy_array_float64_10(&outC->_L13, impTimeArray);
  /* _L10/ */
  for (idx = 0; idx < 10; idx++) {
    kcg_copy_array_float64_10(&outC->_L10[idx], &outC->_L13);
  }
  outC->_L11 = num;
  /* _L8/ */
  ...
  for (idx2 = 0; idx2 < 10; idx2++) {
    kcg_copy_array_float64_10(&outC->_L14[idx2], &outC->_L12);
  }
  kcg_copy_array_float64_10(&outC->_L9, &outC->_L12);
  /* _L9= */
  for (idx3 = 0; idx3 < 10; idx3++) {
    kcg_copy_array_float64_10(&acc, &outC->_L9);
  ...
  kcg_copy_array_float64_10(&outC->OutQueue, &outC->_L9);
}
  ...
  outC_MergeTime_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  for (idx2 = 0; idx2 < 10; idx2++) {
    outC->_L9[idx2] = kcg_lit_float64(0.0);
  }
  for (idx4 = 0; idx4 < 10; idx4++) {
    for (idx3 = 0; idx3 < 10; idx3++) {
      outC->_L10[idx4][idx3] = kcg_lit_float64(0.0);
    }
  }
  outC->_L11 = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 10; idx5++) {
    outC->_L12[idx5] = kcg_lit_float64(0.0);
  }
  ...
  for (idx8 = 0; idx8 < 10; idx8++) {
    for (idx7 = 0; idx7 < 10; idx7++) {
      outC->_L14[idx8][idx7] = kcg_lit_float64(0.0);
    }
  }
  for (idx9 = 0; idx9 < 10; idx9++) {
    outC->OutQueue[idx9] = kcg_lit_float64(0.0);
  }
  for (idx = 0; idx < 10; idx++) {
    /* _L9=(DMI_Control_Pkg::Sub_func::TextMessages::MergeTime_iterator#1)/ */
