  ...
  outC_SessionManagement__GetPosData_RBC_Session_Pkg *outC)
{
  ...
  outC->outPositionManagement.nid_lrbg = kcg_lit_int64(0);
  outC->outPositionManagement.q_scale = Q_SCALE_10_cm_scale;
  outC->outPositionManagement.d_lrbg = kcg_lit_int64(0);
  outC->outPositionManagement.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->outPositionManagement.q_dlrbg = Q_DLRBG_Reverse;
  outC->outPositionManagement.l_doubtover = kcg_lit_int64(0);
  outC->outPositionManagement.l_doubtunder = kcg_lit_int64(0);
  outC->outPositionManagement.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->outPositionManagement.l_trainint = kcg_lit_int64(0);
  outC->outPositionManagement.v_train = kcg_lit_int64(0);
  ...
  outC->outPositionManagement.nid_ntc = kcg_lit_int64(0);
  outC->outPositionManagement.nid_prvlrbg = kcg_lit_int64(0);
}
