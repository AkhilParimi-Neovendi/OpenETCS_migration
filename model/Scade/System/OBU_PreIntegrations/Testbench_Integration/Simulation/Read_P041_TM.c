  ...
  outC_Read_P041_TM *outC)
{
  ...
  C_P041_compr_onboard_TM_conversions(
    &outC->_L5,
    &outC->_L30,
    &outC->Context_C_P041_compr_onboard_1);
  kcg_copy_P041_OBU_T_TM(
    &outC->_L166,
    &outC->Context_C_P041_compr_onboard_1.P041_onboard);
  kcg_copy_P041_OBU_T_TM(&outC->P041_OBU_out, &outC->_L166);
}

#ifndef KCG_USER_DEFINED_INIT
void Read_P041_init_TM(outC_Read_P041_TM *outC)
{
  static kcg_size idx;
  ...
  /* _L166=(TM_conversions::C_P041_compr_onboard#1)/ */
  C_P041_compr_onboard_init_TM_conversions(
    &outC->Context_C_P041_compr_onboard_1);
  /* _L5=(TM_lib_internal::RECV_ReadPackets#1)/ */
...
{
  /* _L166=(TM_conversions::C_P041_compr_onboard#1)/ */
  C_P041_compr_onboard_reset_TM_conversions(
    &outC->Context_C_P041_compr_onboard_1);
  /* _L5=(TM_lib_internal::RECV_ReadPackets#1)/ */
