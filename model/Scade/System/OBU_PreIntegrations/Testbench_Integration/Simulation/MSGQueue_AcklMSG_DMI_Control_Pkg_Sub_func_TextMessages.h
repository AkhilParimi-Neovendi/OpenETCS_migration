...
typedef struct {
  ...
  _80_array /* OperationQueue_IfBlock:then:_L32/ */ _L32_then_OperationQueue_IfBlock;
  array_float64_5 /* OperationQueue_IfBlock:then:_L33/ */ _L33_then_OperationQueue_IfBlock;
  array_float64_5 /* OperationQueue_IfBlock:then:_L34/ */ _L34_then_OperationQueue_IfBlock;
  kcg_bool /* OperationQueue_IfBlock:then:_L31/ */ _L31_then_OperationQueue_IfBlock;
  kcg_float64 /* OperationQueue_IfBlock:then:_L27/ */ _L27_then_OperationQueue_IfBlock;
  kcg_float64 /* OperationQueue_IfBlock:then:_L26/ */ _L26_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:_L23/ */ _L23_then_OperationQueue_IfBlock;
  DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg /* OperationQueue_IfBlock:then:_L2/ */ _L2_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:_L5/ */ _L5_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:_L6/ */ _L6_then_OperationQueue_IfBlock;
  kcg_int64 /* OperationQueue_IfBlock:then:_L7/ */ _L7_then_OperationQueue_IfBlock;
