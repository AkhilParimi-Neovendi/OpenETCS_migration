...
typedef struct {
  ...
  positionedBG_T_TrainPosition_Types_Pck /* IfBlock1:else:then:_L3/ */ _L3_then_else_IfBlock1;
...
extern void insertBG_atIndex_itr_init_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
  outC_insertBG_atIndex_itr_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC);
