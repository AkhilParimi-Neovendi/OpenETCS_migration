...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_Receive_TrackSide_Msg_Receive_TrackSide_Msg_Pkg Context_Receive_TrackSide_Msg_1;
  SV_CheckBGConsistency_CheckBGConsistency_Pkg Context_CheckBGConsistency_1;
  SV_CheckEuroRadioMessage_CheckEuroradioMessage Context_CheckEuroRadioMessage_1;
  SV_InformationFilter_InformationFilter_Pkg Context_InformationFilter_3;
} SV_Manage_TrackSideInformation_Integration_Manage_TrackSideInformation_Integration_Pkg;

extern void kcg_save_SV_Manage_TrackSideInformation_Integration_Manage_TrackSideInformation_Integration_Pkg(
  SV_Manage_TrackSideInformation_Integration_Manage_TrackSideInformation_Integration_Pkg *SV,
  outC_Manage_TrackSideInformation_Integration_Manage_TrackSideInformation_Integration_Pkg *outC);
extern void kcg_load_SV_Manage_TrackSideInformation_Integration_Manage_TrackSideInformation_Integration_Pkg(
  outC_Manage_TrackSideInformation_Integration_Manage_TrackSideInformation_Integration_Pkg *outC,
  SV_Manage_TrackSideInformation_Integration_Manage_TrackSideInformation_Integration_Pkg *SV);
