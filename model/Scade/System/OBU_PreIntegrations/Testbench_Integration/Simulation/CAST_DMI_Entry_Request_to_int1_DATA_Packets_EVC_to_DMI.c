...
void CAST_DMI_Entry_Request_to_int1_DATA_Packets_EVC_to_DMI(
...
void CAST_DMI_Entry_Request_to_int1_init_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_Entry_Request_to_int1_DATA_Packets_EVC_to_DMI *outC)
{
  static kcg_size idx;
...
void CAST_DMI_Entry_Request_to_int1_reset_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_Entry_Request_to_int1_DATA_Packets_EVC_to_DMI *outC)
{
  /* _L7=(DATA::Variables::CAST_DMI_List_Entry_Request_to_int#1)/ */
  CAST_DMI_List_Entry_Request_to_int_reset_DATA_Variables(
    &outC->Context_CAST_DMI_List_Entry_Request_to_int_1);
  /* _L6=(Utilities::Bool_to_Int#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_Entry_Request_to_int1_DATA_Packets_EVC_to_DMI.c
** Generation date: 2023-11-05T09:07:00
*************************************************************$ */
