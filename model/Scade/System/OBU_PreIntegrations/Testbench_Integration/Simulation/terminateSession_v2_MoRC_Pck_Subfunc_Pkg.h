...
typedef struct {
  ...
  _124_SSM_ST_SM1 /* SM1: */ SM1_state_nxt;
  ...
  _124_SSM_ST_SM1 /* SM1: */ SM1_state_sel;
  _124_SSM_ST_SM1 /* SM1: */ SM1_state_act;
  /* -------------------- (-debug) no assertions  -------------------- */
  ...
  _125_SSM_TR_SM1 /* SM1: */ SM1_fired_strong;
  _125_SSM_TR_SM1 /* SM1: */ SM1_fired;
...
typedef struct {
  ...
  _124_SSM_ST_SM1 /* SM1: */ Context_SM1_state_nxt;
  sessionStatus_T_RCM_Session_Types_Pkg /* @1/_L4/ */ Context__L4_MemoryBasic_1;
  kcg_bool Context_init;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_waitAndRepeatTimer_MoRC_Pck_Utils Context_waitAndRepeatTimer_1;
} SV_terminateSession_v2_MoRC_Pck_Subfunc_Pkg;

extern void kcg_save_SV_terminateSession_v2_MoRC_Pck_Subfunc_Pkg(
  SV_terminateSession_v2_MoRC_Pck_Subfunc_Pkg *SV,
  outC_terminateSession_v2_MoRC_Pck_Subfunc_Pkg *outC);
extern void kcg_load_SV_terminateSession_v2_MoRC_Pck_Subfunc_Pkg(
  outC_terminateSession_v2_MoRC_Pck_Subfunc_Pkg *outC,
  SV_terminateSession_v2_MoRC_Pck_Subfunc_Pkg *SV);
