...
typedef struct {
  ...
  kcg_bool /* SM_StartOfMissionProcedure: */ SM_StartOfMissionProcedure_reset_nxt;
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  SSM_ST_SM_SoM_On_Procedure_On_SM_StartOfMissionProcedure /* SM_StartOfMissionProcedure:Procedure_On:SM_SoM_On: */ _1_SM_SoM_On_clock_Procedure_On_SM_StartOfMissionProcedure;
  SSM_ST_SM_StartOfMissionProcedure /* SM_StartOfMissionProcedure: */ SM_StartOfMissionProcedure_state_act;
  /* -------------------- (-debug) no assertions  -------------------- */
  ...
  SSM_ST_SM_StartOfMissionProcedure /* SM_StartOfMissionProcedure: */ SM_StartOfMissionProcedure_state_sel;
  SSM_TR_SM_StartOfMissionProcedure /* SM_StartOfMissionProcedure: */ SM_StartOfMissionProcedure_fired_strong;
  SSM_TR_SM_StartOfMissionProcedure /* SM_StartOfMissionProcedure: */ SM_StartOfMissionProcedure_fired;
...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* SM_StartOfMissionProcedure: */ Context_SM_StartOfMissionProcedure_reset_nxt;
  kcg_bool /* SM_StartOfMissionProcedure: */ Context_SM_StartOfMissionProcedure_reset_act;
  SSM_ST_SM_StartOfMissionProcedure /* SM_StartOfMissionProcedure: */ Context_SM_StartOfMissionProcedure_state_nxt;
  SSM_ST_SM_SoM_On_Procedure_On_SM_StartOfMissionProcedure /* SM_StartOfMissionProcedure:Procedure_On:SM_SoM_On: */ Context_SM_SoM_On_state_nxt;
  kcg_bool /* SM_StartOfMissionProcedure:Procedure_On:SM_SoM_On: */ Context_SM_SoM_On_reset_act;
  kcg_bool /* SM_StartOfMissionProcedure:Procedure_On:SM_SoM_On: */ Context_SM_SoM_On_reset_nxt;
  kcg_bool Context_init;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_Procedure_Start_L1_L2_L3_Procedures Context_Procedure_Start_L1_L2_L3_1;
  SV_SH_Initiated_By_Driver_On_Procedures Context_SH_Initiated_By_Driver_On_1;
} SV_Procedure_StartOfMission_Procedures;

extern void kcg_save_SV_Procedure_StartOfMission_Procedures(
  SV_Procedure_StartOfMission_Procedures *SV,
  outC_Procedure_StartOfMission_Procedures *outC);
extern void kcg_load_SV_Procedure_StartOfMission_Procedures(
  outC_Procedure_StartOfMission_Procedures *outC,
  SV_Procedure_StartOfMission_Procedures *SV);
