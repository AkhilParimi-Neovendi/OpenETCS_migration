...
{
  /* OutputArray/ */
  static _94_array last_OutputArray;

  kcg_copy__94_array(&last_OutputArray, &outC->OutputArray);
  outC->_L72 = Position;
  outC->_L70 = index;
  ...
  kcg_copy_DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg(
    ...
    &outC->_L80);
  outC->_L76 = index;
  kcg_copy__94_array(&outC->_L75, acc);
  kcg_copy__94_array(&outC->_L78, &outC->_L75);
  if ((kcg_lit_int32(0) <= outC->_L76) & (outC->_L76 < kcg_lit_int32(10))) {
    kcg_copy_MsgStructure(&outC->_L78[outC->_L76], &outC->_L77);
  }
  kcg_copy__94_array(&outC->_L63, acc);
  /* _L74= */
  if (outC->_L85) {
    kcg_copy__94_array(&outC->_L74, &outC->_L78);
  }
  else {
    kcg_copy__94_array(&outC->_L74, &outC->_L63);
  }
  ...
  kcg_copy__94_array(&outC->_L40, acc);
  if ((kcg_lit_int32(0) <= outC->_L43) & (outC->_L43 < kcg_lit_int32(10))) {
  ...
  outC->_L38 = index;
  kcg_copy__94_array(&outC->_L22, acc);
  kcg_copy__94_array(&outC->_L26, &outC->_L22);
  if ((kcg_lit_int32(0) <= outC->_L38) & (outC->_L38 < kcg_lit_int32(10))) {
  ...
  /* _L35= */
  if (outC->_L31) {
    kcg_copy__94_array(&outC->_L35, &outC->_L26);
  }
  else {
    kcg_copy__94_array(&outC->_L35, &outC->_L74);
  }
  outC->_L20 = index;
  outC->_L13 = kcg_true;
  ...
  kcg_copy_DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg(
    &outC->_L12.dmi_msg,
    &outC->_L3);
  kcg_copy__94_array(&outC->_L14, acc);
  kcg_copy__94_array(&outC->_L19, &outC->_L14);
  if ((kcg_lit_int32(0) <= outC->_L20) & (outC->_L20 < kcg_lit_int32(10))) {
    kcg_copy_MsgStructure(&outC->_L19[outC->_L20], &outC->_L12);
  }
  /* _L6= */
  if (outC->_L81) {
    kcg_copy__94_array(&outC->_L6, &outC->_L19);
  }
  else {
    kcg_copy__94_array(&outC->_L6, &outC->_L35);
  }
  kcg_copy__94_array(&outC->OutputArray, &outC->_L6);
}
...
void kcg_save_SV_InsertStructMSGFIFO_iterator_normal_DMI_Control_Pkg_Sub_func_TextMessages(
  ...
  outC_InsertStructMSGFIFO_iterator_normal_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  kcg_copy__94_array(&SV->Context_OutputArray, &outC->OutputArray);
}
...
void kcg_load_SV_InsertStructMSGFIFO_iterator_normal_DMI_Control_Pkg_Sub_func_TextMessages(
  ...
  SV_InsertStructMSGFIFO_iterator_normal_DMI_Control_Pkg_Sub_func_TextMessages *SV)
{
  kcg_copy__94_array(&outC->OutputArray, &SV->Context_OutputArray);
}
