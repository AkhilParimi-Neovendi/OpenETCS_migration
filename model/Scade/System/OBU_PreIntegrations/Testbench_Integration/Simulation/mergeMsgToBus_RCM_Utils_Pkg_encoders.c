  ...
  outC_mergeMsgToBus_RCM_Utils_Pkg_encoders *outC)
{
  ...
  /* SM1: */
  static _120_SSM_ST_SM1 _2_SM1_state_nxt_partial;
  /* SM1: */
  static kcg_bool _3_SM1_reset_nxt_partial;
  /* SM1: */
  static _121_SSM_TR_SM1 _4_SM1_fired_partial;
  /* SM1: */
  static _120_SSM_ST_SM1 SM1_state_act_partial;
  /* SM1: */
  static kcg_bool SM1_reset_act_partial;
  /* SM1: */
  static _121_SSM_TR_SM1 SM1_fired_strong_partial;
  /* SM1:notRequested:<2> */
  static kcg_bool tr_2_guard_notRequested_SM1;
  /* SM1:notRequested:<1> */
  static kcg_bool tr_1_guard_notRequested_SM1;
  /* SM1: */
  static _120_SSM_ST_SM1 _5_SM1_state_act_partial;
  /* SM1: */
  static kcg_bool _6_SM1_reset_act_partial;
  /* SM1: */
  static _121_SSM_TR_SM1 _7_SM1_fired_strong_partial;
  /* SM1:requested:<1> */
  ...
  switch (outC->SM1_state_sel) {
    case SSM_st_requested_SM1 :
      ...
      if (tr_1_guard_requested_SM1) {
        ...
        _7_SM1_fired_strong_partial = _161_SSM_TR_no_trans_SM1;
      }
    ...
    case SSM_st_notRequested_SM1 :
      ...
      if (tr_1_guard_notRequested_SM1) {
        ...
        SM1_fired_strong_partial = _161_SSM_TR_no_trans_SM1;
      }
...
void kcg_save_SV_mergeMsgToBus_RCM_Utils_Pkg_encoders(
...
void kcg_load_SV_mergeMsgToBus_RCM_Utils_Pkg_encoders(
  outC_mergeMsgToBus_RCM_Utils_Pkg_encoders *outC,
  SV_mergeMsgToBus_RCM_Utils_Pkg_encoders *SV)
{
