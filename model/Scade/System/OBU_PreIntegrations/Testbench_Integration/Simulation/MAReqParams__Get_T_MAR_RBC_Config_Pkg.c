...
void MAReqParams__Get_T_MAR_RBC_Config_Pkg(
  /* inMAReqParams/ */
  MAReqParams_T *inMAReqParams,
  outC_MAReqParams__Get_T_MAR_RBC_Config_Pkg *outC)
{
  kcg_copy_MAReqParams_T(&outC->_L1, inMAReqParams);
  outC->_L2 = outC->_L1.t_mar;
  outC->out_T_MAR = outC->_L2;
}

#ifndef KCG_USER_DEFINED_INIT
void MAReqParams__Get_T_MAR_init_RBC_Config_Pkg(
  outC_MAReqParams__Get_T_MAR_RBC_Config_Pkg *outC)
{
  ...
  outC->out_T_MAR = kcg_lit_int32(0);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void MAReqParams__Get_T_MAR_reset_RBC_Config_Pkg(
  outC_MAReqParams__Get_T_MAR_RBC_Config_Pkg *outC)
{
}
