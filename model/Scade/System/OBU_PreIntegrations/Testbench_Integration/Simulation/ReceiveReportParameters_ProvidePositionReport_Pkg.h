...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  P58_PositionReportParameters_T_Packet_Types_Pkg /* @1/_L4/ */ Context__L4_MemoryBasic_1;
  kcg_bool Context_init;
  ReportedBGList_T_ProvidePositionReport_Pkg /* reportedBGs/ */ Context_mem_reportedBGs;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_CheckValidityPacket58_ProvidePositionReport_Pkg Context_CheckValidityPacket58_1;
} SV_ReceiveReportParameters_ProvidePositionReport_Pkg;

extern void kcg_save_SV_ReceiveReportParameters_ProvidePositionReport_Pkg(
  SV_ReceiveReportParameters_ProvidePositionReport_Pkg *SV,
  outC_ReceiveReportParameters_ProvidePositionReport_Pkg *outC);
extern void kcg_load_SV_ReceiveReportParameters_ProvidePositionReport_Pkg(
  outC_ReceiveReportParameters_ProvidePositionReport_Pkg *outC,
  SV_ReceiveReportParameters_ProvidePositionReport_Pkg *SV);
