  ...
  outC_ConvertTrackSideMessageToRadioMessage_CheckEuroradioMessage *outC)
{
  ...
  outC->_L19.rbc_id = kcg_lit_int64(0);
  outC->_L19.device_id = kcg_lit_int64(0);
  outC->_L12 = kcg_true;
  ...
  for (idx8 = 0; idx8 < 8; idx8++) {
    ...
    outC->_L3.Telegrams[idx8].telegramheader.m_mcount = kcg_lit_int64(0);
    outC->_L3.Telegrams[idx8].telegramheader.nid_c = kcg_lit_int64(0);
    outC->_L3.Telegrams[idx8].telegramheader.nid_bg = kcg_lit_int64(0);
    ...
    for (idx7 = 0; idx7 < 500; idx7++) {
      outC->_L3.Telegrams[idx8].packets.PacketData[idx7] = kcg_lit_int64(0);
    }
  }
  outC->_L3.numberBalises = kcg_lit_int64(0);
  ...
  outC->_L1.telegramHeaders.numberBalises = kcg_lit_int64(0);
  ...
  outC->_L1.radio_Msg.header.radioDevice = kcg_lit_int64(0);
  outC->_L1.radio_Msg.header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L1.radio_Msg.header.nid_message = kcg_lit_int64(0);
  outC->_L1.radio_Msg.header.t_train = kcg_lit_int64(0);
  outC->_L1.radio_Msg.header.m_ack = M_ACK_No_acknowledgement_required;
  outC->_L1.radio_Msg.header.nid_lrbg = kcg_lit_int64(0);
  outC->_L1.radio_Msg.header.t_train_reference = kcg_lit_int64(0);
  outC->_L1.radio_Msg.header.nid_em = kcg_lit_int64(0);
  outC->_L1.radio_Msg.header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L1.radio_Msg.header.d_sr = kcg_lit_int64(0);
  outC->_L1.radio_Msg.header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L1.radio_Msg.header.d_ref = kcg_lit_int64(0);
  outC->_L1.radio_Msg.header.q_dir = Q_DIR_Reverse;
  outC->_L1.radio_Msg.header.d_emergencystop = kcg_lit_int64(0);
  ...
  for (idx12 = 0; idx12 < 30; idx12++) {
    outC->_L1.radio_Msg.packets.PacketHeaders[idx12].nid_packet = kcg_lit_int64(0);
    ...
    outC->_L1.radio_Msg.packets.PacketHeaders[idx12].startAddress =
      kcg_lit_int64(0);
    outC->_L1.radio_Msg.packets.PacketHeaders[idx12].endAddress = kcg_lit_int64(0);
  }
  for (idx13 = 0; idx13 < 500; idx13++) {
    outC->_L1.radio_Msg.packets.PacketData[idx13] = kcg_lit_int64(0);
  }
  outC->_L1.radio_Msg.sendingRBC.valid = kcg_true;
  outC->_L1.radio_Msg.sendingRBC.nid_c = kcg_lit_int64(0);
  outC->_L1.radio_Msg.sendingRBC.rbc_id = kcg_lit_int64(0);
  outC->_L1.radio_Msg.sendingRBC.device_id = kcg_lit_int64(0);
  ...
  for (idx15 = 0; idx15 < 500; idx15++) {
    outC->ReceivedMessage.packets.PacketData[idx15] = kcg_lit_int64(0);
  }
