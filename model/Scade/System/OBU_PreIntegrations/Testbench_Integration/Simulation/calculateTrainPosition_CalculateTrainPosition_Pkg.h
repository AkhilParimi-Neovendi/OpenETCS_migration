...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  positionedBGs_T_TrainPosition_Types_Pck /* BGs_loc/ */ Context_BGs_loc;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_calculateBGLocations_CalculateTrainPosition_Pkg Context_calculateBGLocations_6;
  SV_calculateTrainPositionInfo_CalculateTrainPosition_Pkg Context_calculateTrainPositionInfo_1;
  SV_linkedBG_missed_CalculateTrainPosition_Pkg_Linking_Pkg Context_linkedBG_missed_2;
  SV_twoConsecutiveLinkedBGs_missed_CalculateTrainPosition_Pkg_Linking_Pkg Context_twoConsecutiveLinkedBGs_missed_1;
} SV_calculateTrainPosition_CalculateTrainPosition_Pkg;

extern void kcg_save_SV_calculateTrainPosition_CalculateTrainPosition_Pkg(
  SV_calculateTrainPosition_CalculateTrainPosition_Pkg *SV,
  outC_calculateTrainPosition_CalculateTrainPosition_Pkg *outC);
extern void kcg_load_SV_calculateTrainPosition_CalculateTrainPosition_Pkg(
  outC_calculateTrainPosition_CalculateTrainPosition_Pkg *outC,
  SV_calculateTrainPosition_CalculateTrainPosition_Pkg *SV);
