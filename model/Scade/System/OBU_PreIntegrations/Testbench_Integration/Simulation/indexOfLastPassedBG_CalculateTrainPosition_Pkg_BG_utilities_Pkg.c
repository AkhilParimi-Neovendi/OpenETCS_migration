  ...
  outC_indexOfLastPassedBG_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  ...
  if (outC->_L6) {
    ...
    for (idx1 = 0; idx1 < 41; idx1++) {
      acc = outC->_L1;
      /* _L3=(CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastPassedBG_itr#1)/ */
      indexOfLastPassedBG_itr_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
        /* _L3= */(kcg_int32) idx1,
        acc,
        outC->_L14[idx1],
        &outC->_L4[idx1],
        &outC->Context_indexOfLastPassedBG_itr_1[idx1]);
      outC->_L1 = outC->Context_indexOfLastPassedBG_itr_1[idx1].indexOfBG;
      outC->_L3 = /* _L3= */(kcg_int32) (idx1 + 1);
      /* _L3= */
      if (!outC->Context_indexOfLastPassedBG_itr_1[idx1].cont) {
        break;
      }
    }
  }
...
void indexOfLastPassedBG_init_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
  outC_indexOfLastPassedBG_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  static kcg_size idx;
  static kcg_size idx1;
  ...
  for (idx2 = 0; idx2 < 33; idx2++) {
    ...
    outC->_L7.infoFromPassing.linkedBGs[idx2].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L7.infoFromPassing.linkedBGs[idx2].d_link = kcg_lit_int32(0);
    outC->_L7.infoFromPassing.linkedBGs[idx2].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L7.infoFromPassing.linkedBGs[idx2].nid_c = kcg_lit_int32(0);
    outC->_L7.infoFromPassing.linkedBGs[idx2].nid_bg = kcg_lit_int32(0);
    outC->_L7.infoFromPassing.linkedBGs[idx2].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L7.infoFromPassing.linkedBGs[idx2].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L7.infoFromPassing.linkedBGs[idx2].q_locacc = kcg_lit_int32(0);
  }
  ...
  for (idx = 0; idx < 41; idx++) {
    /* _L3=(CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastPassedBG_itr#1)/ */
    indexOfLastPassedBG_itr_init_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
      &outC->Context_indexOfLastPassedBG_itr_1[idx]);
  }
}
...
void indexOfLastPassedBG_reset_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
  outC_indexOfLastPassedBG_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  static kcg_size idx;
  ...
  for (idx = 0; idx < 41; idx++) {
    /* _L3=(CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastPassedBG_itr#1)/ */
    indexOfLastPassedBG_itr_reset_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
      &outC->Context_indexOfLastPassedBG_itr_1[idx]);
  }
}
