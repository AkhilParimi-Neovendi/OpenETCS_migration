...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_M032_int_to_header_TM_RBC_conversions /* _L2=(TM_RBC_conversions::C_M032_int_to_header#1)/ */ Context_C_M032_int_to_header_1;
...
extern void Send_M032_JRU_init_MessageLibBaseline2(
  outC_Send_M032_JRU_MessageLibBaseline2 *outC);
