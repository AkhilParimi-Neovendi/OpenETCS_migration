...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* SM_Start_L1_L2_L3: */ Context_SM_Start_L1_L2_L3_reset_nxt;
  kcg_bool /* SM_Start_L1_L2_L3: */ Context_SM_Start_L1_L2_L3_reset_act;
  SSM_ST_SM_Start_L1_L2_L3 /* SM_Start_L1_L2_L3: */ Context_SM_Start_L1_L2_L3_state_nxt;
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
} SV_Procedure_Start_L1_L2_L3_Procedures;

extern void kcg_save_SV_Procedure_Start_L1_L2_L3_Procedures(
  SV_Procedure_Start_L1_L2_L3_Procedures *SV,
  outC_Procedure_Start_L1_L2_L3_Procedures *outC);
extern void kcg_load_SV_Procedure_Start_L1_L2_L3_Procedures(
  outC_Procedure_Start_L1_L2_L3_Procedures *outC,
  SV_Procedure_Start_L1_L2_L3_Procedures *SV);
