...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  M_NVCONTACT /* m_nvcontact/ */ m_nvcontact;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  M_NVCONTACT /* IfBlock1:then:_L4/ */ _L4_then_IfBlock1;
  kcg_bool /* IfBlock1:else:else:then:_L3/ */ _L3_then_else_else_IfBlock1;
  M_NVCONTACT /* IfBlock1:else:else:then:_L2/ */ _L2_then_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:_L3/ */ _L3_else_else_else_IfBlock1;
  M_NVCONTACT /* IfBlock1:else:else:else:_L2/ */ _L2_else_else_else_IfBlock1;
  M_NVCONTACT /* IfBlock1:else:then:_L3/ */ _L3_then_else_IfBlock1;
  kcg_bool /* IfBlock1:else:then:_L4/ */ _L4_then_else_IfBlock1;
  kcg_int32 /* m_nvcontact_in/ */ m_nvcontact_in;
...
extern void CAST_Int_to_M_NVCONTACT_init_TM_conversions(
  outC_CAST_Int_to_M_NVCONTACT_TM_conversions *outC);
