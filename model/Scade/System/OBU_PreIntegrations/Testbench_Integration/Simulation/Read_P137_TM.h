...
typedef struct {
  ...
  P137_StopIfInStaffResponsible_T_Packet_Types_Pkg /* P137_OBU_out/ */ P137_OBU_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P137_compr_onboard_TM_conversions /* _L166=(TM_conversions::C_P137_compr_onboard#1)/ */ Context_C_P137_compr_onboard_1;
  ...
  P137_StopIfInStaffResponsible_T_Packet_Types_Pkg /* _L166/ */ _L166;
...
extern void Read_P137_init_TM(outC_Read_P137_TM *outC);
