...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_ButtonMask_to_buttonIndex_iterator_DMI_Control_Pkg_Sub_func_MenuRequest /* _L37=(DMI_Control_Pkg::Sub_func::MenuRequest::ButtonMask_to_buttonIndex_iterator#1)/ */ Context_ButtonMask_to_buttonIndex_iterator_1[30];
...
extern void DMI_menu_req_To_ButtonEnabler_reset_DMI_Control_Pkg_Sub_func_MenuRequest(
  outC_DMI_menu_req_To_ButtonEnabler_DMI_Control_Pkg_Sub_func_MenuRequest *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void DMI_menu_req_To_ButtonEnabler_init_DMI_Control_Pkg_Sub_func_MenuRequest(
  outC_DMI_menu_req_To_ButtonEnabler_DMI_Control_Pkg_Sub_func_MenuRequest *outC);
