...
void RadioTrainTrackPackets__GetP011_init_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
  outC_RadioTrainTrackPackets__GetP011_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
  static kcg_size idx;
  ...
  outC->_L3.nIter_tractionIdentity = kcg_lit_int32(0);
  for (idx = 0; idx < 4; idx++) {
    outC->_L3.tractionIdentity[idx].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L3.tractionIdentity[idx].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L3.nIter_ntc = kcg_lit_int32(0);
  for (idx1 = 0; idx1 < 5; idx1++) {
    outC->_L3.nid_ntc[idx1] = kcg_lit_int32(0);
  }
  ...
  outC->outRadioTrainTrackPacket.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->outRadioTrainTrackPacket.l_train = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->outRadioTrainTrackPacket.n_axle = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.nIter_tractionIdentity = kcg_lit_int32(0);
  ...
  outC->outRadioTrainTrackPacket.nIter_ntc = kcg_lit_int32(0);
  for (idx7 = 0; idx7 < 5; idx7++) {
    outC->outRadioTrainTrackPacket.nid_ntc[idx7] = kcg_lit_int32(0);
  }
}
...
void RadioTrainTrackPackets__GetP011_reset_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
  outC_RadioTrainTrackPackets__GetP011_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
}
