...
void NextSpeedProfiles_Speed_DMI_Control_Pkg_Sub_func_PlanningArea(
  ...
  array_float32_32 *inSpeedProfiles_Speed,
  outC_NextSpeedProfiles_Speed_DMI_Control_Pkg_Sub_func_PlanningArea *outC)
{
  ...
  kcg_copy_array_float32_32(&outC->_L32, inSpeedProfiles_Speed);
  ...
  kcg_copy_array_float32_10(&outC->SpeedProfiles_Speed, &outC->_L38);
}
  ...
  outC_NextSpeedProfiles_Speed_DMI_Control_Pkg_Sub_func_PlanningArea *outC)
{
  ...
  for (idx2 = 0; idx2 < 10; idx2++) {
    outC->SpeedProfiles_Speed[idx2] = kcg_lit_float32(0.0);
  }
}
