...
void Read_P012_init_TM(outC_Read_P012_TM *outC)
{
  ...
  outC->_L166.v_main = kcg_lit_int32(0);
  ...
  outC->P012_OBU_out.v_main = kcg_lit_int32(0);
  outC->P012_OBU_out.v_loa = kcg_lit_int32(0);
  outC->P012_OBU_out.t_loa = kcg_lit_int32(0);
  outC->P012_OBU_out.n_iter = kcg_lit_int32(0);
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->P012_OBU_out.sections[idx4].valid = kcg_true;
    outC->P012_OBU_out.sections[idx4].l_section = kcg_lit_int32(0);
    outC->P012_OBU_out.sections[idx4].q_sectiontimer =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->P012_OBU_out.sections[idx4].t_sectiontimer = kcg_lit_int32(0);
    outC->P012_OBU_out.sections[idx4].d_sectiontimerstoploc = kcg_lit_int32(0);
  }
  outC->P012_OBU_out.l_endsection = kcg_lit_int32(0);
  outC->P012_OBU_out.q_sectiontimer = Q_SECTIONTIMER_No_Section_Timer_information;
  outC->P012_OBU_out.t_sectiontimer = kcg_lit_int32(0);
  outC->P012_OBU_out.d_sectiontimerstoploc = kcg_lit_int32(0);
  outC->P012_OBU_out.q_endtimer = Q_ENDTIMER_No_End_section_timer_information;
  outC->P012_OBU_out.t_endtimer = kcg_lit_int32(0);
  outC->P012_OBU_out.d_endtimerstartloc = kcg_lit_int32(0);
  outC->P012_OBU_out.q_dangerpoint = Q_DANGERPOINT_No_danger_point_information;
  outC->P012_OBU_out.d_dp = kcg_lit_int32(0);
  outC->P012_OBU_out.v_releasedp = kcg_lit_int32(0);
  outC->P012_OBU_out.q_overlap = Q_OVERLAP_No_overlap_information;
  outC->P012_OBU_out.d_startol = kcg_lit_int32(0);
  outC->P012_OBU_out.t_ol = kcg_lit_int32(0);
  outC->P012_OBU_out.d_ol = kcg_lit_int32(0);
  outC->P012_OBU_out.v_releaseol = kcg_lit_int32(0);
