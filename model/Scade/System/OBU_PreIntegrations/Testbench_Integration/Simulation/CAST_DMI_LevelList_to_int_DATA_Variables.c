  ...
  outC_CAST_DMI_LevelList_to_int_DATA_Variables *outC)
{
  ...
  tmp[0] = outC->_L7[0];
  kcg_copy_array_int64_32(&tmp[1], &outC->_L6);
  kcg_copy_array_int64_33(&outC->_L4[0], &tmp);
  kcg_copy_array_int64_32(&outC->_L4[33], &outC->_L8);
  ...
  outC_CAST_DMI_LevelList_to_int_DATA_Variables *outC)
{
  ...
  for (idx4 = 0; idx4 < 32; idx4++) {
    ...
    outC->_L5.levelList[idx4].nid_stm = kcg_lit_int64(0);
  }
  ...
  for (idx6 = 0; idx6 < 32; idx6++) {
    ...
    outC->_L2[idx6].nid_stm = kcg_lit_int64(0);
  }
  outC->_L3 = kcg_lit_int64(0);
  for (idx7 = 0; idx7 < 65; idx7++) {
    outC->dmi_LevelList_int[idx7] = kcg_lit_int64(0);
  }
  for (idx = 0; idx < 32; idx++) {
    /* _L6=(DATA::Variables::CAST_DMI_level_to_int#1)/ */
