...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  T_internal_Type_Obu_BasicTypes_Pkg /* lastSystemTime/ */ Context_lastSystemTime;
  kcg_bool /* setRepeater/ */ Context_mem_setRepeater;
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
} SV_op_RepeatReq_TA_MA_Request;

extern void kcg_save_SV_op_RepeatReq_TA_MA_Request(
  SV_op_RepeatReq_TA_MA_Request *SV,
  outC_op_RepeatReq_TA_MA_Request *outC);
extern void kcg_load_SV_op_RepeatReq_TA_MA_Request(
  outC_op_RepeatReq_TA_MA_Request *outC,
  SV_op_RepeatReq_TA_MA_Request *SV);
