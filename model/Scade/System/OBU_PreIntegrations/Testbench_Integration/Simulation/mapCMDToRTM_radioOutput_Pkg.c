...
void kcg_save_SV_mapCMDToRTM_radioOutput_Pkg(
  SV_mapCMDToRTM_radioOutput_Pkg *SV,
  outC_mapCMDToRTM_radioOutput_Pkg *outC)
{
  kcg_save_SV_mapnewCMD_toCmd_radioOutput_Pkg(
    &SV->Context_mapnewCMD_toCmd_1,
    &outC->Context_mapnewCMD_toCmd_1);
}

void kcg_load_SV_mapCMDToRTM_radioOutput_Pkg(
  outC_mapCMDToRTM_radioOutput_Pkg *outC,
  SV_mapCMDToRTM_radioOutput_Pkg *SV)
{
  kcg_load_SV_mapnewCMD_toCmd_radioOutput_Pkg(
    &outC->Context_mapnewCMD_toCmd_1,
    &SV->Context_mapnewCMD_toCmd_1);
}
