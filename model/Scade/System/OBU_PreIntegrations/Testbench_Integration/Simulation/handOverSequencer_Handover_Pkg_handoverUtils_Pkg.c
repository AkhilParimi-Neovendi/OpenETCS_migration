  ...
  outC_handOverSequencer_Handover_Pkg_handoverUtils_Pkg *outC)
{
  ...
  /* @1/_L5= */
  if (outC->init) {
    kcg_copy_struct_492780(&outC->_L5_Memory_1_struct, &outC->_L9_Memory_1_struct);
  }
  else {
    kcg_copy_struct_492780(&outC->_L5_Memory_1_struct, &outC->_L8_Memory_1_struct);
  }
  kcg_copy_msgFromTrack_T_RCM_MsgTypes_Pkg(
  ...
  if (outC->_L3_Memory_1_struct) {
    kcg_copy_struct_492780(&outC->_L7_Memory_1_struct, &outC->_L6_Memory_1_struct);
  }
  else {
    kcg_copy_struct_492780(&outC->_L7_Memory_1_struct, &outC->_L5_Memory_1_struct);
  }
  /* @1/_L8= */
  if (outC->_L1_Memory_1_struct) {
    kcg_copy_struct_492780(&outC->_L8_Memory_1_struct, &outC->_L2_Memory_1_struct);
  }
  else {
    kcg_copy_struct_492780(&outC->_L8_Memory_1_struct, &outC->_L7_Memory_1_struct);
  }
  kcg_copy_struct_492780(&outC->Out_Memory_1_struct, &outC->_L8_Memory_1_struct);
  ...
  outC_handOverSequencer_Handover_Pkg_handoverUtils_Pkg *outC)
{
  ...
  SV->Context_establishSessionWithAcceptingRBCOrdered =
    outC->establishSessionWithAcceptingRBCOrdered_then_IfBlock1;
  kcg_copy_struct_492780(&SV->Context__L8_Memory_1, &outC->_L8_Memory_1_struct);
  ...
  SV_handOverSequencer_Handover_Pkg_handoverUtils_Pkg *SV)
{
  ...
  outC->establishSessionWithAcceptingRBCOrdered_then_IfBlock1 =
    SV->Context_establishSessionWithAcceptingRBCOrdered;
  kcg_copy_struct_492780(&outC->_L8_Memory_1_struct, &SV->Context__L8_Memory_1);
