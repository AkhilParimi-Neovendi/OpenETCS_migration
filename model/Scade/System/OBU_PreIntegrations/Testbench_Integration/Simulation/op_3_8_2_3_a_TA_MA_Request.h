...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  L_internal_Type_Obu_BasicTypes_Pkg /* preindicationLoc/ */ Context_mem_preindicationLoc;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_RisingEdge_digital Context_RisingEdge_1;
} SV_op_3_8_2_3_a_TA_MA_Request;

extern void kcg_save_SV_op_3_8_2_3_a_TA_MA_Request(
  SV_op_3_8_2_3_a_TA_MA_Request *SV,
  outC_op_3_8_2_3_a_TA_MA_Request *outC);
extern void kcg_load_SV_op_3_8_2_3_a_TA_MA_Request(
  outC_op_3_8_2_3_a_TA_MA_Request *outC,
  SV_op_3_8_2_3_a_TA_MA_Request *SV);
