  ...
  outC_CheckCompleteness_CheckBGConsistency_Pkg *outC)
{
  ...
  /* isComplete/ */
  static kcg_bool _1_isComplete_partial;
  /* isSingleBG/ */
  static kcg_bool _2_isSingleBG_partial;
  /* lastTelegram/ */
  static Telegram_T_BG_Types_Pkg _3_lastTelegram_partial;
  /* lastTelegram/ */
  static Telegram_T_BG_Types_Pkg _4_lastTelegram_partial;
  /* isSingleBG/ */
  static kcg_bool _5_isSingleBG_partial;
  /* isComplete/ */
  static kcg_bool _6_isComplete_partial;
  /* lastTelegram/ */
  static Telegram_T_BG_Types_Pkg _7_lastTelegram_partial;
  /* isSingleBG/ */
  static kcg_bool _8_isSingleBG_partial;
  /* isComplete/ */
  static kcg_bool _9_isComplete_partial;
