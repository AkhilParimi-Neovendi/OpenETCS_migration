...
void C_M159_to_header_TM_RBC_conversions(
  /* Message_Data_in/ */
  M_159_T_TM_radio_messages *Message_Data_in,
  outC_C_M159_to_header_TM_RBC_conversions *outC)
{
  kcg_copy_M_159_T_TM_radio_messages(&outC->_L1, Message_Data_in);
...
void C_M159_to_header_init_TM_RBC_conversions(
  outC_C_M159_to_header_TM_RBC_conversions *outC)
{
...
void C_M159_to_header_reset_TM_RBC_conversions(
  outC_C_M159_to_header_TM_RBC_conversions *outC)
{
  /* _L20=(TM_conversions::CAST_T_TRAIN_to_int#1)/ */
