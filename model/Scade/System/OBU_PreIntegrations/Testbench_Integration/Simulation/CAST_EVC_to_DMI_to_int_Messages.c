...
{
  static array_int64_990 tmp;
  static array_int64_987 tmp1;
  static array_int64_978 tmp2;
  static array_int64_975 tmp3;
  static array_int64_964 tmp4;
  static array_int64_961 tmp5;
  static array_int64_894 tmp6;
  static array_int64_891 tmp7;
  static array_int64_888 tmp8;
  static array_int64_627 tmp9;
  static array_int64_302 tmp10;
  static array_int64_40 tmp11;
  static array_int64_31 tmp12;
  static array_int64_28 tmp13;
  static array_int64_25 tmp14;

  outC->_L55 = kcg_lit_int64(0);
  outC->_L54 = kcg_lit_int64(1);
  ...
  outC_CAST_EVC_to_DMI_to_int_Messages *outC)
{
  ...
  for (idx = 0; idx < 11; idx++) {
    outC->_L51[idx] = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 9; idx1++) {
    outC->_L50[idx1] = kcg_lit_int64(0);
  }
  for (idx2 = 0; idx2 < 3; idx2++) {
    outC->_L49[idx2] = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 9; idx3++) {
    outC->_L48[idx3] = kcg_lit_int64(0);
  }
  for (idx4 = 0; idx4 < 3; idx4++) {
    outC->_L47[idx4] = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 3; idx5++) {
    outC->_L46[idx5] = kcg_lit_int64(0);
  }
  for (idx6 = 0; idx6 < 67; idx6++) {
    outC->_L45[idx6] = kcg_lit_int64(0);
  }
  for (idx7 = 0; idx7 < 3; idx7++) {
    outC->_L44[idx7] = kcg_lit_int64(0);
  }
  for (idx8 = 0; idx8 < 3; idx8++) {
    outC->_L43[idx8] = kcg_lit_int64(0);
  }
  for (idx9 = 0; idx9 < 261; idx9++) {
    outC->_L42[idx9] = kcg_lit_int64(0);
  }
  for (idx10 = 0; idx10 < 325; idx10++) {
    outC->_L41[idx10] = kcg_lit_int64(0);
  }
  for (idx11 = 0; idx11 < 262; idx11++) {
    outC->_L40[idx11] = kcg_lit_int64(0);
  }
  for (idx12 = 0; idx12 < 9; idx12++) {
    outC->_L39[idx12] = kcg_lit_int64(0);
  }
  for (idx13 = 0; idx13 < 3; idx13++) {
    outC->_L38[idx13] = kcg_lit_int64(0);
  }
  for (idx14 = 0; idx14 < 3; idx14++) {
    outC->_L37[idx14] = kcg_lit_int64(0);
  }
  for (idx15 = 0; idx15 < 24; idx15++) {
    outC->_L36[idx15] = kcg_lit_int64(0);
  }
  outC->_L32.valid = kcg_true;
  outC->_L32.system_clock = kcg_lit_int64(0);
  outC->_L32.DMI_m_icon_control_flag = show_icon_in_area_DMI_Types_Pkg;
  outC->_L32.DMI_m_icon_flashing_freq = kcg_lit_float64(0.0);
  outC->_L32.DMI_nid_icon_group = level_symbol_DMI_Types_Pkg;
  outC->_L32.DMI_nid_icon_rank = kcg_lit_int64(0);
  outC->_L32.DMI_nid_area_group = A_DMI_Types_Pkg;
  outC->_L32.DMI_nid_area_rank = kcg_lit_int64(0);
  outC->_L32.DMI_nid_icon_identifier = kcg_lit_int64(0);
  outC->_L33.valid = kcg_true;
  outC->_L33.systemTime = kcg_lit_int64(0);
  ...
  outC->_L35.systemTime = kcg_lit_int64(0);
  outC->_L35.trainRunningNumber = kcg_lit_int64(0);
  for (idx16 = 0; idx16 < 1; idx16++) {
    outC->_L16[idx16] = kcg_lit_int64(0);
  }
  for (idx17 = 0; idx17 < 999; idx17++) {
    outC->_L29[idx17] = kcg_lit_int64(0);
  }
  ...
  outC->_L3.nid_mn = kcg_lit_int64(0);
  ...
  for (idx19 = 0; idx19 < 32; idx19++) {
    ...
    outC->_L4.levelList.levelList[idx19].nid_stm = kcg_lit_int64(0);
  }
  ...
  outC->_L7.EVC_Version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L7.l_name = kcg_lit_int64(0);
  for (idx20 = 0; idx20 < 255; idx20++) {
    outC->_L7.x_name[idx20] = ' ';
  }
  outC->_L7.l_extra = kcg_lit_int64(0);
  ...
  for (idx21 = 0; idx21 < 32; idx21++) {
    ...
    outC->_L8.speedProfiles.speedProfiles[idx21].Loc_Abs = kcg_lit_int64(0);
    outC->_L8.speedProfiles.speedProfiles[idx21].Loc_LRBG = kcg_lit_int64(0);
    outC->_L8.speedProfiles.speedProfiles[idx21].MRS = kcg_lit_int64(0);
  }
  ...
  for (idx22 = 0; idx22 < 32; idx22++) {
    ...
    outC->_L8.gradientProfiles.gradientProfiles[idx22].end_section =
      kcg_lit_int64(0);
    outC->_L8.gradientProfiles.gradientProfiles[idx22].gradient = kcg_lit_int64(0);
  }
  outC->_L8.trackConditions.nIter = kcg_lit_int64(0);
  for (idx23 = 0; idx23 < 32; idx23++) {
    outC->_L8.trackConditions.trackCondition[idx23].d_trackcond = kcg_lit_int64(0);
  ...
  outC->_L9.textMessage_ID = kcg_lit_int64(0);
  outC->_L9.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L9.l_text = kcg_lit_int64(0);
  ...
  outC->_L10.trainID.number = kcg_lit_int64(0);
  outC->_L10.trainID.dig1 = kcg_lit_int64(0);
  outC->_L10.trainID.dig2 = kcg_lit_int64(0);
  outC->_L10.trainID.dig3 = kcg_lit_int64(0);
  outC->_L10.trainID.dig4 = kcg_lit_int64(0);
  outC->_L10.trainID.dig5 = kcg_lit_int64(0);
  outC->_L10.trainLength.number = kcg_lit_int64(0);
  outC->_L10.trainLength.dig1 = kcg_lit_int64(0);
  outC->_L10.trainLength.dig2 = kcg_lit_int64(0);
  outC->_L10.trainLength.dig3 = kcg_lit_int64(0);
  outC->_L10.trainLength.dig4 = kcg_lit_int64(0);
  outC->_L10.brakeModel.number = kcg_lit_int64(0);
  outC->_L10.brakeModel.dig1 = kcg_lit_int64(0);
  outC->_L10.brakeModel.dig2 = kcg_lit_int64(0);
  outC->_L10.brakeModel.dig3 = kcg_lit_int64(0);
  outC->_L10.vmax.number = kcg_lit_int64(0);
  outC->_L10.vmax.dig1 = kcg_lit_int64(0);
  outC->_L10.vmax.dig2 = kcg_lit_int64(0);
  outC->_L10.vmax.dig3 = kcg_lit_int64(0);
  outC->_L10.mAxleLoad = M_AXLELOADCAT_A;
  outC->_L10.airTightSystem.number = kcg_lit_int64(0);
  outC->_L10.airTightSystem.dig1 = kcg_lit_int64(0);
  outC->_L10.airTightSystem.dig2 = kcg_lit_int64(0);
  outC->_L10.airTightSystem.dig3 = kcg_lit_int64(0);
  outC->_L10.mLoadingGauge.number = kcg_lit_int64(0);
  outC->_L10.mLoadingGauge.dig1 = kcg_lit_int64(0);
  outC->_L10.mLoadingGauge.dig2 = kcg_lit_int64(0);
  outC->_L10.mLoadingGauge.dig3 = kcg_lit_int64(0);
  ...
  outC->_L13.system_clock = kcg_lit_int64(0);
  outC->_L13.v_train = kcg_lit_int64(0);
  outC->_L13.location_front_train = kcg_lit_int64(0);
  outC->_L13.location_brake_target = kcg_lit_int64(0);
  outC->_L13.v_target = kcg_lit_int64(0);
  outC->_L13.v_permitted = kcg_lit_int64(0);
  outC->_L13.v_release = kcg_lit_int64(0);
  outC->_L13.location_brake_curve_starting_point = kcg_lit_int64(0);
  outC->_L13.v_intervention = kcg_lit_int64(0);
  ...
  outC->_L13.location_LOA = kcg_lit_int64(0);
  outC->_L13.v_LOA = kcg_lit_int64(0);
  outC->_L13.location_KP_Balise_Track = kcg_lit_int64(0);
  outC->_L13.distance_KP_Balise = kcg_lit_int64(0);
  outC->_L13.distance_to_TSA = kcg_lit_int64(0);
  outC->_L13.radioConnectionStatus = conn_unknown_API_RadioCommunication_Pkg;
  outC->_L13.distanceIndicationPoint = kcg_lit_int64(0);
  outC->_L14 = kcg_true;
  ...
  for (idx30 = 0; idx30 < 32; idx30++) {
    ...
    outC->_L1.EVC_levelData.levelList.levelList[idx30].nid_stm = kcg_lit_int64(0);
  }
  ...
  for (idx32 = 0; idx32 < 999; idx32++) {
    outC->evc_to_dmi_int[idx32] = kcg_lit_int64(0);
  }
  /* _L36=(DATA::Packets::EVC_to_DMI::Write_DMI_Dynamic_to_int#1)/ */
