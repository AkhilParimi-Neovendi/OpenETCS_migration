  ...
  outC_DeleteNormalMsg_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  /* new_hh/ */
  static array_float32_10 last_new_hh;
  /* new_mm/ */
  static array_float32_10 last_new_mm;
  /* NumE/ */
  static kcg_int32 last_NumE;
  /* local_num_ack/ */
  static kcg_int32 last_local_num_ack;
  /* localQueue/ */
  static _94_array last_localQueue;

  kcg_copy__94_array(&last_localQueue, &outC->mem_localQueue);
  kcg_copy__94_array(&outC->mem_localQueue, localQueue);
  ...
  /* new_hh/ */
  if (outC->init) {
    kcg_copy_array_float32_10(&last_new_hh, hh_array);
  }
  else {
    kcg_copy_array_float32_10(&last_new_hh, &outC->new_hh);
  }
  /* new_mm/ */
  if (outC->init) {
    kcg_copy_array_float32_10(&last_new_mm, mm_array);
  }
  else {
    kcg_copy_array_float32_10(&last_new_mm, &outC->new_mm);
  }
  /* NumE/ */
  if (outC->init) {
  ...
  kcg_copy_array_float32_10(&outC->_L130, hh_array);
  kcg_copy_array_float32_10(&outC->_L131, mm_array);
  ...
  kcg_copy__94_array(&outC->_L125, localQueue);
  ...
  kcg_copy__94_array(&outC->_L138, &outC->Context_FIFO_Delete_Op_Normal_1.Queue);
  outC->_L137 = deleteMsg;
  kcg_copy_array_float32_10(&outC->_L128, mm_array);
  /* _L134= */
  if (outC->_L137) {
    kcg_copy_array_float32_10(&outC->_L134, &outC->_L139);
  }
  else {
    kcg_copy_array_float32_10(&outC->_L134, &outC->_L128);
  }
  kcg_copy_array_float32_10(&outC->new_mm, &outC->_L134);
  kcg_copy_array_float32_10(&outC->_L129, hh_array);
  /* _L134= */
  if (outC->_L137) {
    kcg_copy_array_float32_10(&outC->_L135, &outC->_L140);
  }
  else {
    kcg_copy_array_float32_10(&outC->_L135, &outC->_L129);
  }
  kcg_copy_array_float32_10(&outC->new_hh, &outC->_L135);
  outC->_L123 = num;
  outC->_L110 = kcg_lit_int32(1);
  outC->_L121 = num;
  ...
  kcg_copy__94_array(&outC->_L126, localQueue);
  /* _L112= */
  if (outC->_L119) {
    kcg_copy__94_array(&outC->_L112, &outC->_L138);
  }
  else {
    kcg_copy__94_array(&outC->_L112, &outC->_L126);
  }
  outC->NumE = outC->_L113;
  kcg_copy__94_array(&outC->MsgQueue, &outC->_L112);
  ...
  outC_DeleteNormalMsg_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  for (idx = 0; idx < 10; idx++) {
    outC->_L139[idx] = kcg_lit_float32(0.0);
  }
  for (idx1 = 0; idx1 < 10; idx1++) {
    outC->_L140[idx1] = kcg_lit_float32(0.0);
  }
  for (idx3 = 0; idx3 < 10; idx3++) {
    outC->_L138[idx3].present = kcg_true;
    outC->_L138[idx3].dmi_msg.valid = kcg_true;
    outC->_L138[idx3].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L138[idx3].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L138[idx3].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L138[idx3].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx4 = 0; idx4 < 10; idx4++) {
    outC->_L128[idx4] = kcg_lit_float32(0.0);
  }
  for (idx5 = 0; idx5 < 10; idx5++) {
    outC->_L129[idx5] = kcg_lit_float32(0.0);
  }
  for (idx6 = 0; idx6 < 10; idx6++) {
    outC->_L130[idx6] = kcg_lit_float32(0.0);
  }
  for (idx7 = 0; idx7 < 10; idx7++) {
    outC->_L131[idx7] = kcg_lit_float32(0.0);
  }
  for (idx8 = 0; idx8 < 10; idx8++) {
    outC->_L135[idx8] = kcg_lit_float32(0.0);
  }
  for (idx9 = 0; idx9 < 10; idx9++) {
    outC->_L134[idx9] = kcg_lit_float32(0.0);
  }
  for (idx11 = 0; idx11 < 10; idx11++) {
    outC->_L126[idx11].present = kcg_true;
    outC->_L126[idx11].dmi_msg.valid = kcg_true;
    outC->_L126[idx11].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L126[idx11].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L126[idx11].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L126[idx11].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx13 = 0; idx13 < 10; idx13++) {
    ...
    outC->_L125[idx13].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L125[idx13].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L125[idx13].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L125[idx13].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx15 = 0; idx15 < 10; idx15++) {
    ...
    outC->_L112[idx15].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L112[idx15].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L112[idx15].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L112[idx15].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  outC_DeleteNormalMsg_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  kcg_copy_array_float32_10(&SV->Context_new_hh, &outC->new_hh);
  kcg_copy_array_float32_10(&SV->Context_new_mm, &outC->new_mm);
  SV->Context_NumE = outC->NumE;
  SV->Context_init = outC->init;
  SV->Context_mem_local_num_ack = outC->mem_local_num_ack;
  kcg_copy__94_array(&SV->Context_mem_localQueue, &outC->mem_localQueue);
}
  ...
  SV_DeleteNormalMsg_DMI_Control_Pkg_Sub_func_TextMessages *SV)
{
  ...
  kcg_copy_array_float32_10(&outC->new_hh, &SV->Context_new_hh);
  kcg_copy_array_float32_10(&outC->new_mm, &SV->Context_new_mm);
  outC->NumE = SV->Context_NumE;
  outC->init = SV->Context_init;
  outC->mem_local_num_ack = SV->Context_mem_local_num_ack;
  kcg_copy__94_array(&outC->mem_localQueue, &SV->Context_mem_localQueue);
}
