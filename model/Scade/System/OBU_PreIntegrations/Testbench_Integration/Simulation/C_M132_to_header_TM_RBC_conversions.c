...
void C_M132_to_header_TM_RBC_conversions(
  /* Message_Data_in/ */
  M_132_T_TM_radio_messages *Message_Data_in,
  outC_C_M132_to_header_TM_RBC_conversions *outC)
{
  kcg_copy_M_132_T_TM_radio_messages(&outC->_L1, Message_Data_in);
  outC->_L6 = outC->_L1.t_train;
  /* _L25=(TM_conversions::CAST_T_TRAIN_to_int#1)/ */
  CAST_T_TRAIN_to_int_TM_conversions(
    outC->_L6,
    &outC->Context_CAST_T_TRAIN_to_int_1);
  outC->_L25 = outC->Context_CAST_T_TRAIN_to_int_1.t_train_int;
  outC->_L7 = outC->_L1.nid_engine;
  /* _L24=(TM_conversions::CAST_NID_ENGINE_to_int#1)/ */
  CAST_NID_ENGINE_to_int_TM_conversions(
    outC->_L7,
    &outC->Context_CAST_NID_ENGINE_to_int_1);
  outC->_L24 = outC->Context_CAST_NID_ENGINE_to_int_1.nid_ctraction_int;
  outC->_L5 = outC->_L1.l_message;
  /* _L23=(TM_conversions::CAST_L_MESSAGE_to_int#1)/ */
  CAST_L_MESSAGE_to_int_TM_conversions(
    outC->_L5,
    &outC->Context_CAST_L_MESSAGE_to_int_1);
  outC->_L23 = outC->Context_CAST_L_MESSAGE_to_int_1.l_message_int;
  outC->_L4 = outC->_L1.nid_message;
  /* _L22=(TM_conversions::CAST_NID_MESSAGE_to_int#1)/ */
  CAST_NID_MESSAGE_to_int_TM_conversions(
    outC->_L4,
    &outC->Context_CAST_NID_MESSAGE_to_int_1);
  outC->_L22 = outC->Context_CAST_NID_MESSAGE_to_int_1.nid_message_int;
  outC->_L20 = outC->_L1.q_marqstreason;
  /* _L21=(TM_conversions::CAST_Q_MARQSTREASON_to_int#1)/ */
  CAST_Q_MARQSTREASON_to_int_TM_conversions(
    outC->_L20,
    &outC->Context_CAST_Q_MARQSTREASON_to_int_1);
  outC->_L21 = outC->Context_CAST_Q_MARQSTREASON_to_int_1.q_marqstreason_int;
...
void C_M132_to_header_init_TM_RBC_conversions(
  outC_C_M132_to_header_TM_RBC_conversions *outC)
{
  ...
  outC->_L20 = Q_MARQSTREASON_Start_selected_by_driver;
  outC->_L19 = kcg_lit_int64(0);
  outC->_L3 = kcg_true;
  ...
  outC->_L1.q_marqstreason = Q_MARQSTREASON_Start_selected_by_driver;
  ...
  /* _L21=(TM_conversions::CAST_Q_MARQSTREASON_to_int#1)/ */
  CAST_Q_MARQSTREASON_to_int_init_TM_conversions(
    &outC->Context_CAST_Q_MARQSTREASON_to_int_1);
  /* _L22=(TM_conversions::CAST_NID_MESSAGE_to_int#1)/ */
...
void C_M132_to_header_reset_TM_RBC_conversions(
  outC_C_M132_to_header_TM_RBC_conversions *outC)
{
  /* _L21=(TM_conversions::CAST_Q_MARQSTREASON_to_int#1)/ */
  CAST_Q_MARQSTREASON_to_int_reset_TM_conversions(
    &outC->Context_CAST_Q_MARQSTREASON_to_int_1);
  /* _L22=(TM_conversions::CAST_NID_MESSAGE_to_int#1)/ */
