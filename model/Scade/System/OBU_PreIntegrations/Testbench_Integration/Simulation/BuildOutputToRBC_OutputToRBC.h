...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_ExitLevel2or3_OutputToRBC Context_ExitLevel2or3_1;
} SV_BuildOutputToRBC_OutputToRBC;

extern void kcg_save_SV_BuildOutputToRBC_OutputToRBC(
  SV_BuildOutputToRBC_OutputToRBC *SV,
  outC_BuildOutputToRBC_OutputToRBC *outC);
extern void kcg_load_SV_BuildOutputToRBC_OutputToRBC(
  outC_BuildOutputToRBC_OutputToRBC *outC,
  SV_BuildOutputToRBC_OutputToRBC *SV);
