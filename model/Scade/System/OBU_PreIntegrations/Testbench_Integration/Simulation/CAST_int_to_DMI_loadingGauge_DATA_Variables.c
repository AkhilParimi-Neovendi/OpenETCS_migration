  ...
  outC_CAST_int_to_DMI_loadingGauge_DATA_Variables *outC)
{
  ...
  outC->dmi_loadingGauge_ct.number = kcg_lit_int64(0);
  outC->dmi_loadingGauge_ct.dig1 = kcg_lit_int64(0);
  outC->dmi_loadingGauge_ct.dig2 = kcg_lit_int64(0);
  outC->dmi_loadingGauge_ct.dig3 = kcg_lit_int64(0);
}
