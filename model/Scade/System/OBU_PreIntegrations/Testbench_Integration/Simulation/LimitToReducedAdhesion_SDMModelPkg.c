  ...
  outC_LimitToReducedAdhesion_SDMModelPkg *outC)
{
  ...
  kcg_copy_array_int32_14(&noname, &outC->_L23);
  ...
  outC_LimitToReducedAdhesion_SDMModelPkg *outC)
{
  ...
  outC->_L38.d_validnv = kcg_lit_int32(0);
  for (idx = 0; idx < 7; idx++) {
    outC->_L38.nid_cArray[idx].valid = kcg_true;
    outC->_L38.nid_cArray[idx].nid_c = kcg_lit_int32(0);
  }
  outC->_L38.v_nvshunt = kcg_lit_int32(0);
  outC->_L38.v_nvstff = kcg_lit_int32(0);
  outC->_L38.v_nvonsight = kcg_lit_int32(0);
  outC->_L38.v_nvlimsuperv = kcg_lit_int32(0);
  outC->_L38.v_nvunfit = kcg_lit_int32(0);
  outC->_L38.v_nvrel = kcg_lit_int32(0);
  outC->_L38.d_nvroll = kcg_lit_int32(0);
  ...
  outC->_L38.v_nvallowovtrp = kcg_lit_int32(0);
  outC->_L38.v_nvsupovtrp = kcg_lit_int32(0);
  outC->_L38.d_nvovtrp = kcg_lit_int32(0);
  outC->_L38.t_nvovtrp = kcg_lit_int32(0);
  outC->_L38.d_nvpotrp = kcg_lit_int32(0);
  outC->_L38.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->_L38.t_nvcontact = kcg_lit_int32(0);
  outC->_L38.m_nvderun = M_NVDERUN_No;
  outC->_L38.d_nvstff = kcg_lit_int32(0);
  outC->_L38.q_nvdriver_adhes = Q_NVDRIVER_ADHES_Not_allowed;
  outC->_L38.a_nvmaxredadh1 = kcg_lit_float32(0.0);
  outC->_L38.a_nvmaxredadh2 = kcg_lit_float32(0.0);
  outC->_L38.a_nvmaxredadh3 = kcg_lit_float32(0.0);
  outC->_L38.q_nvlocacc = kcg_lit_int32(0);
  outC->_L38.m_nvavadh = kcg_lit_float32(0.0);
  ...
  for (idx2 = 0; idx2 < 7; idx2++) {
    ...
    outC->_L38.nvkvintsetArray[idx2].a_nvp12 = kcg_lit_float32(0.0);
    outC->_L38.nvkvintsetArray[idx2].a_nvp23 = kcg_lit_float32(0.0);
    for (idx1 = 0; idx1 < 7; idx1++) {
      outC->_L38.nvkvintsetArray[idx2].nvkintArray[idx1].valid = kcg_true;
      outC->_L38.nvkvintsetArray[idx2].nvkintArray[idx1].v_nvkvint = kcg_lit_int32(0);
  ...
  for (idx3 = 0; idx3 < 7; idx3++) {
    ...
    outC->_L38.nvkrintArray[idx3].m_nvkrint = kcg_lit_float32(0.0);
  }
  outC->_L38.m_nvktint = kcg_lit_float32(0.0);
  outC->_L37 = kcg_true;
  outC->_L36 = kcg_true;
  outC->_L35 = Q_NVDRIVER_ADHES_Not_allowed;
  for (idx4 = 0; idx4 < 100; idx4++) {
    outC->_L34.distance_definition[idx4] = kcg_lit_float32(0.0);
  }
  for (idx5 = 0; idx5 < 14; idx5++) {
    outC->_L34.speed_definition[idx5] = kcg_lit_float32(0.0);
  }
  for (idx7 = 0; idx7 < 14; idx7++) {
    for (idx6 = 0; idx6 < 100; idx6++) {
      outC->_L34.data[idx7][idx6] = kcg_lit_float32(0.0);
    }
  }
  for (idx8 = 0; idx8 < 100; idx8++) {
    outC->_L28[idx8] = kcg_lit_float32(0.0);
  }
  for (idx9 = 0; idx9 < 14; idx9++) {
    outC->_L29[idx9] = kcg_lit_float32(0.0);
  }
  for (idx11 = 0; idx11 < 14; idx11++) {
    for (idx10 = 0; idx10 < 100; idx10++) {
      outC->_L30[idx11][idx10] = kcg_lit_float32(0.0);
    }
  }
  ...
  for (idx13 = 0; idx13 < 100; idx13++) {
    outC->_L10.distance_definition[idx13] = kcg_lit_float32(0.0);
  }
  for (idx14 = 0; idx14 < 14; idx14++) {
    outC->_L10.speed_definition[idx14] = kcg_lit_float32(0.0);
  }
  for (idx16 = 0; idx16 < 14; idx16++) {
    for (idx15 = 0; idx15 < 100; idx15++) {
      outC->_L10.data[idx16][idx15] = kcg_lit_float32(0.0);
    }
  }
  outC->_L9 = kcg_true;
  ...
  for (idx17 = 0; idx17 < 7; idx17++) {
    ...
    outC->_L1.nid_cArray[idx17].nid_c = kcg_lit_int32(0);
  }
  ...
  for (idx19 = 0; idx19 < 7; idx19++) {
    ...
    outC->_L1.nvkvintsetArray[idx19].a_nvp12 = kcg_lit_float32(0.0);
    outC->_L1.nvkvintsetArray[idx19].a_nvp23 = kcg_lit_float32(0.0);
  ...
  for (idx20 = 0; idx20 < 7; idx20++) {
    ...
    outC->_L1.nvkrintArray[idx20].m_nvkrint = kcg_lit_float32(0.0);
  }
  ...
  outC->_L3.trainLength = kcg_lit_int32(0);
  outC->_L3.brakePerctage = kcg_lit_int32(0);
  outC->_L3.maxTrainSpeed = kcg_lit_int32(0);
  ...
  outC->_L3.axleNumber = kcg_lit_int32(0);
  outC->_L3.numberNationalSystems = kcg_lit_int32(0);
  for (idx21 = 0; idx21 < 5; idx21++) {
    outC->_L3.nationSystems[idx21] = kcg_lit_int32(0);
  }
  outC->_L3.numberTractionSystems = kcg_lit_int32(0);
  for (idx22 = 0; idx22 < 4; idx22++) {
    outC->_L3.tractionSystem[idx22].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L3.tractionSystem[idx22].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L4 =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  for (idx23 = 0; idx23 < 100; idx23++) {
    outC->A_brake_safe_reduced.distance_definition[idx23] = kcg_lit_float32(0.0);
  }
  for (idx24 = 0; idx24 < 14; idx24++) {
    outC->A_brake_safe_reduced.speed_definition[idx24] = kcg_lit_float32(0.0);
  }
  for (idx26 = 0; idx26 < 14; idx26++) {
    for (idx25 = 0; idx25 < 100; idx25++) {
      outC->A_brake_safe_reduced.data[idx26][idx25] = kcg_lit_float32(0.0);
    }
  }
  /* _L24=(SDM_Types_Pkg::TransformA_realToA_int#1)/ */
