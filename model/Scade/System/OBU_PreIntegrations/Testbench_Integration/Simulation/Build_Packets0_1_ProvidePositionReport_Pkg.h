...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  PT0_PositionReport_T_Packet_TrainTypes_Pkg /* _L22/ */ Context__L22;
  PT1_PositionReport_2BG_T_Packet_TrainTypes_Pkg /* _L21/ */ Context__L21;
  kcg_bool Context_init;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_Build_Packet0_ProvidePositionReport_Pkg Context_Build_Packet0_2;
} SV_Build_Packets0_1_ProvidePositionReport_Pkg;

extern void kcg_save_SV_Build_Packets0_1_ProvidePositionReport_Pkg(
  SV_Build_Packets0_1_ProvidePositionReport_Pkg *SV,
  outC_Build_Packets0_1_ProvidePositionReport_Pkg *outC);
extern void kcg_load_SV_Build_Packets0_1_ProvidePositionReport_Pkg(
  outC_Build_Packets0_1_ProvidePositionReport_Pkg *outC,
  SV_Build_Packets0_1_ProvidePositionReport_Pkg *SV);
