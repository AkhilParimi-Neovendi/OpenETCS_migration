...
void Write_DMI_Track_Description_to_int_init_DATA_Packets_EVC_to_DMI(
  outC_Write_DMI_Track_Description_to_int_DATA_Packets_EVC_to_DMI *outC)
{
  static kcg_size idx;
  ...
  for (idx2 = 0; idx2 < 32; idx2++) {
    ...
    outC->_L1.speedProfiles.speedProfiles[idx2].Loc_Abs = kcg_lit_int64(0);
    outC->_L1.speedProfiles.speedProfiles[idx2].Loc_LRBG = kcg_lit_int64(0);
    outC->_L1.speedProfiles.speedProfiles[idx2].MRS = kcg_lit_int64(0);
  }
  ...
  for (idx3 = 0; idx3 < 32; idx3++) {
    ...
    outC->_L1.gradientProfiles.gradientProfiles[idx3].end_section =
      kcg_lit_int64(0);
    outC->_L1.gradientProfiles.gradientProfiles[idx3].gradient = kcg_lit_int64(0);
  }
  outC->_L1.trackConditions.nIter = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->_L1.trackConditions.trackCondition[idx4].d_trackcond = kcg_lit_int64(0);
  ...
  for (idx5 = 0; idx5 < 325; idx5++) {
    outC->dmi_track_description_int[idx5] = kcg_lit_int64(0);
  }
  /* _L13=(DATA::Packets::EVC_to_DMI::CAST_DMI_Track_Description_to_int#1)/ */
  CAST_DMI_Track_Description_to_int_init_DATA_Packets_EVC_to_DMI(
    &outC->Context_CAST_DMI_Track_Description_to_int_1);
}
...
void Write_DMI_Track_Description_to_int_reset_DATA_Packets_EVC_to_DMI(
  outC_Write_DMI_Track_Description_to_int_DATA_Packets_EVC_to_DMI *outC)
{
  /* _L13=(DATA::Packets::EVC_to_DMI::CAST_DMI_Track_Description_to_int#1)/ */
  CAST_DMI_Track_Description_to_int_reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_CAST_DMI_Track_Description_to_int_1);
}
