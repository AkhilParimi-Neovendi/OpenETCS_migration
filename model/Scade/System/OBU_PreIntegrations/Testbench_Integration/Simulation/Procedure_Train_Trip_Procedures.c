...
void kcg_save_SV_Procedure_Train_Trip_Procedures(
  SV_Procedure_Train_Trip_Procedures *SV,
  outC_Procedure_Train_Trip_Procedures *outC)
{
  ...
  kcg_save_SV_Procedure_Start_L1_L2_L3_Procedures(
    ...
    &outC->Context_Procedure_Start_L1_L2_L3_1);
  SV->Context_SM_Train_Trip_reset_nxt = outC->SM_Train_Trip_reset_nxt;
  SV->Context_SM_Train_Trip_reset_act = outC->SM_Train_Trip_reset_act;
  SV->Context_SM_Train_Trip_state_nxt = outC->SM_Train_Trip_state_nxt;
}

void kcg_load_SV_Procedure_Train_Trip_Procedures(
  outC_Procedure_Train_Trip_Procedures *outC,
  SV_Procedure_Train_Trip_Procedures *SV)
{
  ...
  kcg_load_SV_Procedure_Start_L1_L2_L3_Procedures(
    &outC->Context_Procedure_Start_L1_L2_L3_1,
    &SV->Context_Procedure_Start_L1_L2_L3_1);
  outC->SM_Train_Trip_reset_nxt = SV->Context_SM_Train_Trip_reset_nxt;
  outC->SM_Train_Trip_reset_act = SV->Context_SM_Train_Trip_reset_act;
  outC->SM_Train_Trip_state_nxt = SV->Context_SM_Train_Trip_state_nxt;
}
