  ...
  outC_FIFO_delete_time_Normal_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  static array_float32_10 acc5;
  static kcg_size idx6;
  /* new_hh_array/ */
  static array_float32_10 last_new_hh_array;
  /* new_mm_array/ */
  static array_float32_10 last_new_mm_array;

  kcg_copy_array_float32_10(&last_new_hh_array, &outC->new_hh_array);
  kcg_copy_array_float32_10(&last_new_mm_array, &outC->new_mm_array);
  kcg_copy_array_float32_10(&outC->_L10, mm_array);
  /* _L28/ */
  for (idx = 0; idx < 10; idx++) {
    kcg_copy_array_float32_10(&outC->_L28[idx], &outC->_L10);
  }
  kcg_copy_array_float32_10(&outC->_L1, hh_array);
  /* _L24/ */
  for (idx1 = 0; idx1 < 10; idx1++) {
    kcg_copy_array_float32_10(&outC->_L24[idx1], &outC->_L1);
  }
  ...
  kcg_copy_array_float32_10(&outC->_L20, &outC->_L21);
  /* _L20= */
  for (idx3 = 0; idx3 < 10; idx3++) {
    kcg_copy_array_float32_10(&acc, &outC->_L20);
  ...
  kcg_copy_array_float32_10(&outC->_L15, &outC->_L17);
  /* _L15= */
  for (idx6 = 0; idx6 < 10; idx6++) {
    kcg_copy_array_float32_10(&acc5, &outC->_L15);
  ...
  kcg_copy_array_float32_10(&outC->new_hh_array, &outC->_L15);
  kcg_copy_array_float32_10(&outC->new_mm_array, &outC->_L20);
}
...
void kcg_save_SV_FIFO_delete_time_Normal_DMI_Control_Pkg_Sub_func_TextMessages(
  ...
  outC_FIFO_delete_time_Normal_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  kcg_copy_array_float32_10(&SV->Context_new_hh_array, &outC->new_hh_array);
  kcg_copy_array_float32_10(&SV->Context_new_mm_array, &outC->new_mm_array);
}
...
void kcg_load_SV_FIFO_delete_time_Normal_DMI_Control_Pkg_Sub_func_TextMessages(
  ...
  SV_FIFO_delete_time_Normal_DMI_Control_Pkg_Sub_func_TextMessages *SV)
{
  kcg_copy_array_float32_10(&outC->new_hh_array, &SV->Context_new_hh_array);
  kcg_copy_array_float32_10(&outC->new_mm_array, &SV->Context_new_mm_array);
}
