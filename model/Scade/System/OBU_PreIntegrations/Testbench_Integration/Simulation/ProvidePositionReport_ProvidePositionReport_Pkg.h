...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_ReceiveReportParameters_ProvidePositionReport_Pkg Context_ReceiveReportParameters_1;
  SV_PosReport_Supervision_ProvidePositionReport_Pkg Context_PosReport_Supervision_1;
  SV_Build_Packets0_1_ProvidePositionReport_Pkg Context_Build_Packets0_1_1;
  SV_nextGen_Msg136_radioOutput_Pkg Context_nextGen_Msg136_1;
} SV_ProvidePositionReport_ProvidePositionReport_Pkg;

extern void kcg_save_SV_ProvidePositionReport_ProvidePositionReport_Pkg(
  SV_ProvidePositionReport_ProvidePositionReport_Pkg *SV,
  outC_ProvidePositionReport_ProvidePositionReport_Pkg *outC);
extern void kcg_load_SV_ProvidePositionReport_ProvidePositionReport_Pkg(
  outC_ProvidePositionReport_ProvidePositionReport_Pkg *outC,
  SV_ProvidePositionReport_ProvidePositionReport_Pkg *SV);
