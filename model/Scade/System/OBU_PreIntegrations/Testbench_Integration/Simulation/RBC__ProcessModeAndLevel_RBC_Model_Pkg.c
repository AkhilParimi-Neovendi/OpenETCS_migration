...
void kcg_save_SV_RBC__ProcessModeAndLevel_RBC_Model_Pkg(
  SV_RBC__ProcessModeAndLevel_RBC_Model_Pkg *SV,
  outC_RBC__ProcessModeAndLevel_RBC_Model_Pkg *outC)
{
  SV->Context_level = outC->level;
  SV->Context_mode = outC->mode;
}

void kcg_load_SV_RBC__ProcessModeAndLevel_RBC_Model_Pkg(
  outC_RBC__ProcessModeAndLevel_RBC_Model_Pkg *outC,
  SV_RBC__ProcessModeAndLevel_RBC_Model_Pkg *SV)
{
  outC->level = SV->Context_level;
  outC->mode = SV->Context_mode;
}
