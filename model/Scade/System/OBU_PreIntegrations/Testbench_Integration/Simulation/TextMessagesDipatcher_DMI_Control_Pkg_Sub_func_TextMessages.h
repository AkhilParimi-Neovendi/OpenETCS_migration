...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  _82_array /* AckMsgQueue/ */ AckMsgQueue;
  _94_array /* MsgQueue/ */ MsgQueue;
  kcg_int32 /* NumE/ */ NumE;
  kcg_bool /* AckisEmpty/ */ AckisEmpty;
  kcg_bool /* isEmpty/ */ isEmpty;
  kcg_int32 /* NumAckMsg/ */ NumAckMsg;
  array_float32_10 /* hh_array/ */ hh_array;
  array_float32_10 /* mm_array/ */ mm_array;
  array_float32_5 /* ack_hh_array/ */ ack_hh_array;
  array_float32_5 /* ack_mm_array/ */ ack_mm_array;
  /* -----------------------   local probes  ------------------------- */
  kcg_bool /* debugExpired/ */ debugExpired;
  /* ----------------------- local memories  ------------------------- */
  kcg_int32 /* numAckMsg/ */ numAckMsg;
  array_float32_5 /* mm_local_array_ack/ */ mm_local_array_ack;
  array_float32_5 /* hh_local_array_ack/ */ hh_local_array_ack;
  _82_array /* Local_AckMsgQueue/ */ Local_AckMsgQueue;
  kcg_int32 /* numNormalMsg/ */ numNormalMsg;
  _94_array /* Local_NormaliMsgQueue/ */ Local_NormaliMsgQueue;
  kcg_bool /* Local_ack_empty/ */ Local_ack_empty;
  array_float32_10 /* mm_local_array/ */ mm_local_array;
  kcg_bool /* Local_isEmpty/ */ Local_isEmpty;
  array_float32_10 /* hh_local_array/ */ hh_local_array;
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  kcg_int32 /* IfBlock5:then:_L52/ */ _L52_then_IfBlock5;
  kcg_bool /* IfBlock5:then:_L49/ */ _L49_then_IfBlock5;
  array_float32_5 /* IfBlock5:then:_L51/ */ _L51_then_IfBlock5;
  array_float32_5 /* IfBlock5:then:_L50/ */ _L50_then_IfBlock5;
  kcg_bool /* IfBlock5:then:_L48/ */ _L48_then_IfBlock5;
  kcg_int32 /* IfBlock5:then:_L28/ */ _L28_then_IfBlock5;
  DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg /* IfBlock5:then:_L13/ */ _L13_then_IfBlock5;
  _82_array /* IfBlock5:then:_L5/ */ _L5_then_IfBlock5;
  kcg_int32 /* IfBlock5:else:else:_L10/ */ _L10_else_else_IfBlock5;
  _82_array /* IfBlock5:else:else:_L5/ */ _L5_else_else_IfBlock5;
  kcg_int32 /* IfBlock5:else:else:_L6/ */ _L6_else_else_IfBlock5;
  array_float32_5 /* IfBlock5:else:else:_L7/ */ _L7_else_else_IfBlock5;
  array_float32_5 /* IfBlock5:else:else:_L8/ */ _L8_else_else_IfBlock5;
  kcg_bool /* IfBlock5:else:else:_L9/ */ _L9_else_else_IfBlock5;
  array_float32_5 /* IfBlock5:else:else:_L3/ */ _L3_else_else_IfBlock5;
  array_float32_5 /* IfBlock5:else:else:_L2/ */ _L2_else_else_IfBlock5;
  kcg_bool /* IfBlock5:else:else:_L1/ */ _L1_else_else_IfBlock5;
  _94_array /* IfBlock5:else:else:_L12/ */ _L12_else_else_IfBlock5;
  kcg_int32 /* IfBlock5:else:else:_L11/ */ _L11_else_else_IfBlock5;
  kcg_bool /* IfBlock5:else:else:_L23/ */ _L23_else_else_IfBlock5;
  kcg_bool /* IfBlock5:else:else:_L24/ */ _L24_else_else_IfBlock5;
  _82_array /* IfBlock5:else:else:_L28/ */ _L28_else_else_IfBlock5;
  kcg_bool /* IfBlock5:else:else:_L33/ */ _L33_else_else_IfBlock5;
  array_float32_10 /* IfBlock5:else:else:_L32/ */ _L32_else_else_IfBlock5;
  array_float32_10 /* IfBlock5:else:else:_L31/ */ _L31_else_else_IfBlock5;
  kcg_int32 /* IfBlock5:else:else:_L30/ */ _L30_else_else_IfBlock5;
  _94_array /* IfBlock5:else:else:_L34/ */ _L34_else_else_IfBlock5;
  kcg_int32 /* IfBlock5:else:else:_L43/ */ _L43_else_else_IfBlock5;
  array_float32_10 /* IfBlock5:else:else:_L44/ */ _L44_else_else_IfBlock5;
  array_float32_10 /* IfBlock5:else:else:_L45/ */ _L45_else_else_IfBlock5;
  ...
  _94_array /* IfBlock5:else:then:_L36/ */ _L36_then_else_IfBlock5;
  kcg_int32 /* IfBlock5:else:then:_L35/ */ _L35_then_else_IfBlock5;
  ...
  array_float32_10 /* IfBlock5:else:then:_L40/ */ _L40_then_else_IfBlock5;
  array_float32_10 /* IfBlock5:else:then:_L41/ */ _L41_then_else_IfBlock5;
  kcg_int32 /* IfBlock5:else:then:_L42/ */ _L42_then_else_IfBlock5;
...
typedef struct {
  /* ----------------------  memorised outputs  ---------------------- */
  array_float32_5 /* ack_mm_array/ */ Context_ack_mm_array;
  array_float32_5 /* ack_hh_array/ */ Context_ack_hh_array;
  array_float32_10 /* mm_array/ */ Context_mm_array;
  array_float32_10 /* hh_array/ */ Context_hh_array;
  kcg_int32 /* NumAckMsg/ */ Context_NumAckMsg;
  ...
  _82_array /* AckMsgQueue/ */ Context_AckMsgQueue;
  /* ----------------------- local memories  ------------------------- */
  array_float32_10 /* hh_local_array/ */ Context_hh_local_array;
  kcg_bool /* Local_isEmpty/ */ Context_Local_isEmpty;
  array_float32_10 /* mm_local_array/ */ Context_mm_local_array;
  kcg_bool /* Local_ack_empty/ */ Context_Local_ack_empty;
  _94_array /* Local_NormaliMsgQueue/ */ Context_Local_NormaliMsgQueue;
  kcg_int32 /* numNormalMsg/ */ Context_numNormalMsg;
  _82_array /* Local_AckMsgQueue/ */ Context_Local_AckMsgQueue;
  array_float32_5 /* hh_local_array_ack/ */ Context_hh_local_array_ack;
  array_float32_5 /* mm_local_array_ack/ */ Context_mm_local_array_ack;
  kcg_int32 /* numAckMsg/ */ Context_numAckMsg;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
