  ...
  outC_CAST_int_to_DMI_gradientProfileElement_DATA_Variables *outC)
{
  ...
  outC->_L11.begin_section = kcg_lit_int32(0);
  outC->_L11.end_section = kcg_lit_int32(0);
  outC->_L11.gradient = kcg_lit_int32(0);
  outC->dmi_gradientProfileElemen.valid = kcg_true;
  outC->dmi_gradientProfileElemen.begin_section = kcg_lit_int32(0);
  outC->dmi_gradientProfileElemen.end_section = kcg_lit_int32(0);
  outC->dmi_gradientProfileElemen.gradient = kcg_lit_int32(0);
  /* _L12=(Utilities::Int_to_Bool#1)/ */
