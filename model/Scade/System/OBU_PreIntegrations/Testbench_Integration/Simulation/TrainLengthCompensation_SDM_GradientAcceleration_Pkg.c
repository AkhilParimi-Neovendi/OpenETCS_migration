  ...
  outC_TrainLengthCompensation_SDM_GradientAcceleration_Pkg *outC)
{
  ...
  SearchIndexInGradientProfile_SDM_GradientAcceleration_Pkg(
    &outC->_L96,
    outC->_L94,
    &outC->Context_SearchIndexInGradientProfile_1);
  outC->_L90 = outC->Context_SearchIndexInGradientProfile_1.index;
  kcg_copy_GradientProfile_real_t_SDM_GradientAcceleration_types(
    &outC->_L45,
    GradientProfile);
  ...
  outC_TrainLengthCompensation_SDM_GradientAcceleration_Pkg *outC)
{
  ...
  outC->_L97 = kcg_lit_float64(0.0);
  for (idx1 = 0; idx1 < 50; idx1++) {
    outC->_L96[idx1].location = kcg_lit_float64(0.0);
    outC->_L96[idx1].gradient = kcg_lit_float64(0.0);
    outC->_L96[idx1].valid = kcg_true;
  }
  outC->_L95 = kcg_lit_float64(0.0);
  ...
  outC->_L93.trainLength = kcg_lit_int64(0);
  outC->_L93.brakePerctage = kcg_lit_int64(0);
  outC->_L93.maxTrainSpeed = kcg_lit_int64(0);
  ...
  outC->_L93.axleNumber = kcg_lit_int64(0);
  outC->_L93.numberNationalSystems = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 5; idx2++) {
    outC->_L93.nationSystems[idx2] = kcg_lit_int64(0);
  }
  outC->_L93.numberTractionSystems = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 4; idx3++) {
    outC->_L93.tractionSystem[idx3].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L93.tractionSystem[idx3].nid_ctraction = kcg_lit_int64(0);
  }
  ...
  for (idx4 = 0; idx4 < 100; idx4++) {
    outC->_L88[idx4].location = kcg_lit_float64(0.0);
    outC->_L88[idx4].gradient = kcg_lit_float64(0.0);
    outC->_L88[idx4].valid = kcg_true;
  }
  outC->_L66 = kcg_lit_int64(0);
  outC->_L52 = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 50; idx5++) {
    outC->_L45[idx5].location = kcg_lit_float64(0.0);
    outC->_L45[idx5].gradient = kcg_lit_float64(0.0);
    outC->_L45[idx5].valid = kcg_true;
  }
  for (idx6 = 0; idx6 < 100; idx6++) {
    outC->_L37[idx6].location = kcg_lit_float64(0.0);
    outC->_L37[idx6].gradient = kcg_lit_float64(0.0);
    outC->_L37[idx6].valid = kcg_true;
  }
  outC->_L21 = kcg_lit_float64(0.0);
  for (idx7 = 0; idx7 < 100; idx7++) {
    outC->_L18[idx7].location = kcg_lit_float64(0.0);
    outC->_L18[idx7].gradient = kcg_lit_float64(0.0);
    outC->_L18[idx7].valid = kcg_true;
  }
  outC->_L17 = kcg_true;
  outC->_L16.location = kcg_lit_float64(0.0);
  outC->_L16.gradient = kcg_lit_float64(0.0);
  outC->_L16.valid = kcg_true;
  for (idx8 = 0; idx8 < 50; idx8++) {
    outC->_L15[idx8].location = kcg_lit_float64(0.0);
    outC->_L15[idx8].gradient = kcg_lit_float64(0.0);
    outC->_L15[idx8].valid = kcg_true;
  }
  outC->_L13 = kcg_true;
  outC->_L12 = kcg_lit_float64(0.0);
  outC->_L11.location = kcg_lit_float64(0.0);
  outC->_L11.gradient = kcg_lit_float64(0.0);
  ...
  for (idx9 = 0; idx9 < 100; idx9++) {
    outC->_L9.compensatedGradientProfile[idx9].location = kcg_lit_float64(0.0);
    outC->_L9.compensatedGradientProfile[idx9].gradient = kcg_lit_float64(0.0);
    outC->_L9.compensatedGradientProfile[idx9].valid = kcg_true;
  }
  for (idx11 = 0; idx11 < 100; idx11++) {
    for (idx10 = 0; idx10 < 50; idx10++) {
      outC->_L8[idx11][idx10].location = kcg_lit_float64(0.0);
      outC->_L8[idx11][idx10].gradient = kcg_lit_float64(0.0);
      outC->_L8[idx11][idx10].valid = kcg_true;
    }
  }
  for (idx12 = 0; idx12 < 100; idx12++) {
    outC->_L7[idx12] = kcg_lit_float64(0.0);
  }
  outC->_L6 = kcg_lit_float64(0.0);
  outC->_L5 = kcg_lit_int64(0);
  outC->_L3.frontPos = kcg_lit_float64(0.0);
  outC->_L3.frontIndex = kcg_lit_int64(0);
  outC->_L3.rearPos = kcg_lit_float64(0.0);
  outC->_L3.rearIndex = kcg_lit_int64(0);
  for (idx13 = 0; idx13 < 100; idx13++) {
    outC->_L3.compensatedGradientProfile[idx13].location = kcg_lit_float64(0.0);
    outC->_L3.compensatedGradientProfile[idx13].gradient = kcg_lit_float64(0.0);
    outC->_L3.compensatedGradientProfile[idx13].valid = kcg_true;
  }
  for (idx14 = 0; idx14 < 50; idx14++) {
    outC->_L1[idx14].location = kcg_lit_float64(0.0);
    outC->_L1[idx14].gradient = kcg_lit_float64(0.0);
    outC->_L1[idx14].valid = kcg_true;
  }
  outC->rear_end_index = kcg_lit_int64(0);
  outC->d_est_front_index = kcg_lit_int64(0);
  for (idx15 = 0; idx15 < 100; idx15++) {
    outC->initilizedCompensatedProfile[idx15].location = kcg_lit_float64(0.0);
    outC->initilizedCompensatedProfile[idx15].gradient = kcg_lit_float64(0.0);
    outC->initilizedCompensatedProfile[idx15].valid = kcg_true;
  }
  for (idx16 = 0; idx16 < 100; idx16++) {
    outC->CompensatedProfile[idx16].location = kcg_lit_float64(0.0);
    outC->CompensatedProfile[idx16].gradient = kcg_lit_float64(0.0);
