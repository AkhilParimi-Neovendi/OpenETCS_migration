  ...
  outC_DeleteMSGFIFO_iterator_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  outC->_L35.dmi_msg.system_clock = kcg_lit_int64(0);
  outC->_L35.dmi_msg.textMessage_ID = kcg_lit_int64(0);
  outC->_L35.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L35.dmi_msg.l_text = kcg_lit_int64(0);
  ...
  outC->_L30.dmi_msg.system_clock = kcg_lit_int64(0);
  outC->_L30.dmi_msg.textMessage_ID = kcg_lit_int64(0);
  outC->_L30.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L30.dmi_msg.l_text = kcg_lit_int64(0);
  ...
  outC->_L19.dmi_msg.system_clock = kcg_lit_int64(0);
  outC->_L19.dmi_msg.textMessage_ID = kcg_lit_int64(0);
  outC->_L19.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L19.dmi_msg.l_text = kcg_lit_int64(0);
  ...
  outC->QueueElemOut.dmi_msg.system_clock = kcg_lit_int64(0);
  outC->QueueElemOut.dmi_msg.textMessage_ID = kcg_lit_int64(0);
  outC->QueueElemOut.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->QueueElemOut.dmi_msg.l_text = kcg_lit_int64(0);
