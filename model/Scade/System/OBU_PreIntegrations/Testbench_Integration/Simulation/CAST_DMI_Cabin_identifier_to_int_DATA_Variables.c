  ...
  outC_CAST_DMI_Cabin_identifier_to_int_DATA_Variables *outC)
{
  ...
  static kcg_int64 dmi_cabin_identifier_int_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* dmi_cabin_identifier_int/ */
  static kcg_int64 _1_dmi_cabin_identifier_int_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* error/ */
  static kcg_bool _3_error_partial;
  /* dmi_cabin_identifier_int/ */
  static kcg_int64 _4_dmi_cabin_identifier_int_partial;
  /* error/ */
  static kcg_bool _5_error_partial;
  /* dmi_cabin_identifier_int/ */
  static kcg_int64 _6_dmi_cabin_identifier_int_partial;
  ...
  outC_CAST_DMI_Cabin_identifier_to_int_DATA_Variables *outC)
{
  ...
  outC->dmi_cabin_identifier_int = kcg_lit_int64(0);
}
