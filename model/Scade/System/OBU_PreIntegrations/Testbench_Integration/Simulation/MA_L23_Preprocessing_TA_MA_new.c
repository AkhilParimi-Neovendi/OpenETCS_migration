  ...
  outC_MA_L23_Preprocessing_TA_MA_new *outC)
{
  ...
  MA_Convert_P15_to_DistanceProfile_TA_MA_new(
    &outC->_L1,
    &outC->_L22,
  ...
  outC_MA_L23_Preprocessing_TA_MA_new *outC)
{
  ...
  for (idx = 0; idx < 32; idx++) {
    ...
    outC->_L22.SECTIONS[idx].nid_c = kcg_lit_int64(0);
  }
  ...
  outC->_L13.v_main = kcg_lit_int64(0);
  outC->_L13.v_loa = kcg_lit_int64(0);
  outC->_L13.t_loa_unlimited = kcg_true;
  outC->_L13.t_loa = kcg_lit_int64(0);
  outC->_L13.n_iter = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 10; idx1++) {
    outC->_L13.sections[idx1].valid = kcg_true;
    outC->_L13.sections[idx1].q_endsection = kcg_true;
    outC->_L13.sections[idx1].l_section = kcg_lit_int64(0);
    outC->_L13.sections[idx1].q_sectiontimer = kcg_true;
    outC->_L13.sections[idx1].t_sectiontimer = kcg_lit_int64(0);
    outC->_L13.sections[idx1].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->_L13.q_dangerpoint = kcg_true;
  outC->_L13.dangerpoint.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L13.dangerpoint.v_release = kcg_lit_int64(0);
  outC->_L13.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->_L13.q_overlap = kcg_true;
  outC->_L13.overlap.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L13.overlap.v_release = kcg_lit_int64(0);
  outC->_L13.overlap.calc_v_release_onboard = kcg_true;
  outC->_L13.q_endtimer = kcg_true;
  outC->_L13.endtimer_t.t_endtimer = kcg_lit_int64(0);
  outC->_L13.endtimer_t.d_endtimerstoploc = kcg_lit_int64(0);
  ...
  for (idx2 = 0; idx2 < 10; idx2++) {
    ...
    outC->_L14.sections[idx2].l_section = kcg_lit_int64(0);
    outC->_L14.sections[idx2].q_sectiontimer = kcg_true;
    outC->_L14.sections[idx2].t_sectiontimer = kcg_lit_int64(0);
    outC->_L14.sections[idx2].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  ...
  for (idx3 = 0; idx3 < 32; idx3++) {
    ...
    outC->_L1.sections[idx3].l_section = kcg_lit_int64(0);
    outC->_L1.sections[idx3].q_sectiontimer =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L1.sections[idx3].t_sectiontimer = kcg_lit_int64(0);
    outC->_L1.sections[idx3].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  ...
  outC->MA.v_main = kcg_lit_int64(0);
  outC->MA.v_loa = kcg_lit_int64(0);
  outC->MA.t_loa_unlimited = kcg_true;
  outC->MA.t_loa = kcg_lit_int64(0);
  outC->MA.n_iter = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 10; idx4++) {
    outC->MA.sections[idx4].valid = kcg_true;
    outC->MA.sections[idx4].q_endsection = kcg_true;
    outC->MA.sections[idx4].l_section = kcg_lit_int64(0);
    outC->MA.sections[idx4].q_sectiontimer = kcg_true;
    outC->MA.sections[idx4].t_sectiontimer = kcg_lit_int64(0);
    outC->MA.sections[idx4].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->MA.q_dangerpoint = kcg_true;
  outC->MA.dangerpoint.d_DP_or_OL = kcg_lit_int64(0);
  outC->MA.dangerpoint.v_release = kcg_lit_int64(0);
  outC->MA.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->MA.q_overlap = kcg_true;
  outC->MA.overlap.d_DP_or_OL = kcg_lit_int64(0);
  outC->MA.overlap.v_release = kcg_lit_int64(0);
  outC->MA.overlap.calc_v_release_onboard = kcg_true;
  outC->MA.q_endtimer = kcg_true;
  outC->MA.endtimer_t.t_endtimer = kcg_lit_int64(0);
  outC->MA.endtimer_t.d_endtimerstoploc = kcg_lit_int64(0);
  /* _L13=(TA_Lib_internal::MoveMAAbsolute_new#1)/ */
  MoveMAAbsolute_new_init_TA_Lib_internal(&outC->Context_MoveMAAbsolute_new_1);
  /* _L14=(TA_MA_new::MA_Convert_P15_to_DistanceProfile#1)/ */
  MA_Convert_P15_to_DistanceProfile_init_TA_MA_new(
    &outC->Context_MA_Convert_P15_to_DistanceProfile_1);
}
  ...
  outC_MA_L23_Preprocessing_TA_MA_new *outC)
{
  ...
  /* _L14=(TA_MA_new::MA_Convert_P15_to_DistanceProfile#1)/ */
  MA_Convert_P15_to_DistanceProfile_reset_TA_MA_new(
    &outC->Context_MA_Convert_P15_to_DistanceProfile_1);
}
