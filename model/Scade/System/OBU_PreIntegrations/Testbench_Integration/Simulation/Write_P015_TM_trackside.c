...
void Write_P015_init_TM_trackside(outC_Write_P015_TM_trackside *outC)
{
  ...
  for (idx9 = 0; idx9 < 32; idx9++) {
    outC->_L1.SECTIONS[idx9].L_SECTION = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx9].Q_SECTIONTIMER = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx9].T_SECTIONTIMER = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx9].D_SECTIONTIMERSTOPLOC = kcg_lit_int64(0);
  }
