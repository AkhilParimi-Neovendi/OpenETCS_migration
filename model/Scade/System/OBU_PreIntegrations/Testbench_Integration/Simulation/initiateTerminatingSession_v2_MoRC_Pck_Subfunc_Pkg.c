  ...
  outC_initiateTerminatingSession_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  ...
  /* definedNumberOfRepetitionsHasBeenReached/ */
  static kcg_bool _1_definedNumberOfRepetitionsHasBeenReached_partial;
  /* TrainExitedFromRBCArea_SM: */
  static SSM_ST_TrainExitedFromRBCArea_SM _2_TrainExitedFromRBCArea_SM_state_nxt_partial;
  /* TrainExitedFromRBCArea_SM: */
  static kcg_bool _3_TrainExitedFromRBCArea_SM_reset_nxt_partial;
  /* TrainExitedFromRBCArea_SM: */
  static SSM_TR_TrainExitedFromRBCArea_SM _4_TrainExitedFromRBCArea_SM_fired_partial;
  ...
  /* TrainExitedFromRBCArea_SM: */
  static SSM_TR_TrainExitedFromRBCArea_SM _5_TrainExitedFromRBCArea_SM_fired_partial;
  /* TrainExitedFromRBCArea_SM: */
  static kcg_bool _6_TrainExitedFromRBCArea_SM_reset_nxt_partial;
  /* TrainExitedFromRBCArea_SM: */
  static SSM_ST_TrainExitedFromRBCArea_SM _7_TrainExitedFromRBCArea_SM_state_nxt_partial;
  /* TrainExitedFromRBCArea_SM: */
  static SSM_TR_TrainExitedFromRBCArea_SM _8_TrainExitedFromRBCArea_SM_fired_partial;
  /* TrainExitedFromRBCArea_SM: */
  static kcg_bool _9_TrainExitedFromRBCArea_SM_reset_nxt_partial;
  /* TrainExitedFromRBCArea_SM: */
  static SSM_ST_TrainExitedFromRBCArea_SM _10_TrainExitedFromRBCArea_SM_state_nxt_partial;
  /* TrainExitedFromRBCArea_SM: */
  ...
  /* TrainExitedFromRBCArea_SM: */
  static SSM_ST_TrainExitedFromRBCArea_SM _11_TrainExitedFromRBCArea_SM_state_act_partial;
  /* TrainExitedFromRBCArea_SM: */
  static kcg_bool _12_TrainExitedFromRBCArea_SM_reset_act_partial;
  /* TrainExitedFromRBCArea_SM: */
  static SSM_TR_TrainExitedFromRBCArea_SM _13_TrainExitedFromRBCArea_SM_fired_strong_partial;
...
void kcg_save_SV_initiateTerminatingSession_v2_MoRC_Pck_Subfunc_Pkg(
  SV_initiateTerminatingSession_v2_MoRC_Pck_Subfunc_Pkg *SV,
  outC_initiateTerminatingSession_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  kcg_save_SV_waitAndRepeatTimer_MoRC_Pck_Utils(
    &SV->Context_waitAndRepeatTimer_1,
    &outC->Context_waitAndRepeatTimer_1);
  SV->Context_TrainExitedFromRBCArea_SM_reset_nxt =
    outC->TrainExitedFromRBCArea_SM_reset_nxt;
  SV->Context_TrainExitedFromRBCArea_SM_reset_act =
    outC->TrainExitedFromRBCArea_SM_reset_act;
  SV->Context_TrainExitedFromRBCArea_SM_state_nxt =
    outC->TrainExitedFromRBCArea_SM_state_nxt;
}

void kcg_load_SV_initiateTerminatingSession_v2_MoRC_Pck_Subfunc_Pkg(
  outC_initiateTerminatingSession_v2_MoRC_Pck_Subfunc_Pkg *outC,
  SV_initiateTerminatingSession_v2_MoRC_Pck_Subfunc_Pkg *SV)
{
  kcg_load_SV_waitAndRepeatTimer_MoRC_Pck_Utils(
    &outC->Context_waitAndRepeatTimer_1,
    &SV->Context_waitAndRepeatTimer_1);
  outC->TrainExitedFromRBCArea_SM_reset_nxt =
    SV->Context_TrainExitedFromRBCArea_SM_reset_nxt;
