...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  kcg_int64 /* m_loadinggauge_int/ */ m_loadinggauge_int;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  kcg_int64 /* IfBlock1:else:else:else:else:else:_L1/ */ _L1_else_else_else_else_else_IfBlock1;
  ...
  M_LOADINGGAUGE /* m_loadinggauge_in/ */ m_loadinggauge_in;
  kcg_bool /* error/ */ error;
  M_LOADINGGAUGE /* _L4/ */ _L4;
  kcg_bool /* _L7/ */ _L7;
} outC_CAST_M_LOADINGGAUGE_to_int_TM_conversions;

/* ===========  node initialization and cycle functions  =========== */
/* TM_conversions::CAST_M_LOADINGGAUGE_to_int/ */
extern void CAST_M_LOADINGGAUGE_to_int_TM_conversions(
  /* m_loadinggauge/ */
  M_LOADINGGAUGE m_loadinggauge,
  outC_CAST_M_LOADINGGAUGE_to_int_TM_conversions *outC);

#ifndef KCG_NO_EXTERN_CALL_TO_RESET
extern void CAST_M_LOADINGGAUGE_to_int_reset_TM_conversions(
  outC_CAST_M_LOADINGGAUGE_to_int_TM_conversions *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CAST_M_LOADINGGAUGE_to_int_init_TM_conversions(
  outC_CAST_M_LOADINGGAUGE_to_int_TM_conversions *outC);
