...
void StoreRaw_NV_init_TA_Storage(outC_StoreRaw_NV_TA_Storage *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L26.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L26.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L26.PacketHeaders[idx].valid = kcg_true;
    outC->_L26.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L26.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L26.PacketData[idx1] = kcg_lit_int64(0);
  }
  outC->_L22.valid = kcg_true;
  outC->_L22.q_dir = Q_DIR_Reverse;
  outC->_L22.q_scale = Q_SCALE_10_cm_scale;
  outC->_L22.d_validnv = kcg_lit_int64(0);
  outC->_L22.n_iter = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L22.SECTIONS[idx2].valid = kcg_true;
    outC->_L22.SECTIONS[idx2].nid_c = kcg_lit_int64(0);
  }
  outC->_L22.v_nvshunt = kcg_lit_int64(0);
  outC->_L22.v_nvstff = kcg_lit_int64(0);
  outC->_L22.v_nvonsight = kcg_lit_int64(0);
  outC->_L22.v_nvunfit = kcg_lit_int64(0);
  outC->_L22.v_nvrel = kcg_lit_int64(0);
  outC->_L22.d_nvroll = kcg_lit_int64(0);
  outC->_L22.q_nvsbtsmperm = Q_NVSBTSMPERM_No;
  outC->_L22.q_nvemrrls = Q_NVEMRRLS_Revoke_emergency_brake_command_at_standstill;
  outC->_L22.v_nvallowovtrp = kcg_lit_int64(0);
  outC->_L22.v_nvsopovtrp = kcg_lit_int64(0);
  outC->_L22.d_nvovtrp = kcg_lit_int64(0);
  outC->_L22.t_nvovtrp = kcg_lit_int64(0);
  outC->_L22.d_nvpotrp = kcg_lit_int64(0);
  outC->_L22.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->_L22.t_nvcontact = kcg_lit_int64(0);
  outC->_L22.m_nvderun = M_NVDERUN_No;
  outC->_L22.d_nvstff = kcg_lit_int64(0);
  ...
  for (idx3 = 0; idx3 < 30; idx3++) {
    outC->_L25.packets.PacketHeaders[idx3].nid_packet = kcg_lit_int64(0);
    outC->_L25.packets.PacketHeaders[idx3].q_dir = Q_DIR_Reverse;
    outC->_L25.packets.PacketHeaders[idx3].valid = kcg_true;
    outC->_L25.packets.PacketHeaders[idx3].startAddress = kcg_lit_int64(0);
    outC->_L25.packets.PacketHeaders[idx3].endAddress = kcg_lit_int64(0);
  }
  for (idx4 = 0; idx4 < 500; idx4++) {
    outC->_L25.packets.PacketData[idx4] = kcg_lit_int64(0);
  }
  ...
  outC->_L24.d_validnv = kcg_lit_int64(0);
  outC->_L24.n_iter = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 32; idx5++) {
    outC->_L24.SECTIONS[idx5].valid = kcg_true;
    outC->_L24.SECTIONS[idx5].nid_c = kcg_lit_int64(0);
  }
  outC->_L24.v_nvshunt = kcg_lit_int64(0);
  outC->_L24.v_nvstff = kcg_lit_int64(0);
  outC->_L24.v_nvonsight = kcg_lit_int64(0);
  outC->_L24.v_nvunfit = kcg_lit_int64(0);
  outC->_L24.v_nvrel = kcg_lit_int64(0);
  outC->_L24.d_nvroll = kcg_lit_int64(0);
  outC->_L24.q_nvsbtsmperm = Q_NVSBTSMPERM_No;
  outC->_L24.q_nvemrrls = Q_NVEMRRLS_Revoke_emergency_brake_command_at_standstill;
  outC->_L24.v_nvallowovtrp = kcg_lit_int64(0);
  outC->_L24.v_nvsopovtrp = kcg_lit_int64(0);
  outC->_L24.d_nvovtrp = kcg_lit_int64(0);
  outC->_L24.t_nvovtrp = kcg_lit_int64(0);
  outC->_L24.d_nvpotrp = kcg_lit_int64(0);
  outC->_L24.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->_L24.t_nvcontact = kcg_lit_int64(0);
  outC->_L24.m_nvderun = M_NVDERUN_No;
  outC->_L24.d_nvstff = kcg_lit_int64(0);
  ...
  outC->NV_onboard_out.d_validnv = kcg_lit_int64(0);
  outC->NV_onboard_out.n_iter = kcg_lit_int64(0);
  for (idx6 = 0; idx6 < 32; idx6++) {
    outC->NV_onboard_out.SECTIONS[idx6].valid = kcg_true;
    outC->NV_onboard_out.SECTIONS[idx6].nid_c = kcg_lit_int64(0);
  }
  outC->NV_onboard_out.v_nvshunt = kcg_lit_int64(0);
  outC->NV_onboard_out.v_nvstff = kcg_lit_int64(0);
  outC->NV_onboard_out.v_nvonsight = kcg_lit_int64(0);
  outC->NV_onboard_out.v_nvunfit = kcg_lit_int64(0);
  outC->NV_onboard_out.v_nvrel = kcg_lit_int64(0);
  outC->NV_onboard_out.d_nvroll = kcg_lit_int64(0);
  ...
  outC->NV_onboard_out.v_nvallowovtrp = kcg_lit_int64(0);
  outC->NV_onboard_out.v_nvsopovtrp = kcg_lit_int64(0);
  outC->NV_onboard_out.d_nvovtrp = kcg_lit_int64(0);
  outC->NV_onboard_out.t_nvovtrp = kcg_lit_int64(0);
  outC->NV_onboard_out.d_nvpotrp = kcg_lit_int64(0);
  outC->NV_onboard_out.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->NV_onboard_out.t_nvcontact = kcg_lit_int64(0);
  outC->NV_onboard_out.m_nvderun = M_NVDERUN_No;
  outC->NV_onboard_out.d_nvstff = kcg_lit_int64(0);
...
void kcg_save_SV_StoreRaw_NV_TA_Storage(
  SV_StoreRaw_NV_TA_Storage *SV,
  outC_StoreRaw_NV_TA_Storage *outC)
{
  kcg_copy_P003V1_OBU_T_TM_baseline2(&SV->Context__L24, &outC->_L24);
  SV->Context__L23 = outC->_L23;
  SV->Context_init = outC->init;
}

void kcg_load_SV_StoreRaw_NV_TA_Storage(
  outC_StoreRaw_NV_TA_Storage *outC,
  SV_StoreRaw_NV_TA_Storage *SV)
{
  kcg_copy_P003V1_OBU_T_TM_baseline2(&outC->_L24, &SV->Context__L24);
  outC->_L23 = SV->Context__L23;
