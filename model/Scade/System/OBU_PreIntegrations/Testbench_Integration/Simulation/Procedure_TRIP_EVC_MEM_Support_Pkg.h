...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* revokeEB/ */ Context_revokeEB;
  kcg_bool /* Revoke_Procedure: */ Context_Revoke_Procedure_reset_nxt;
  kcg_bool /* Revoke_Procedure: */ Context_Revoke_Procedure_reset_act;
  SSM_ST_Revoke_Procedure /* Revoke_Procedure: */ Context_Revoke_Procedure_state_nxt;
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
} SV_Procedure_TRIP_EVC_MEM_Support_Pkg;

extern void kcg_save_SV_Procedure_TRIP_EVC_MEM_Support_Pkg(
  SV_Procedure_TRIP_EVC_MEM_Support_Pkg *SV,
  outC_Procedure_TRIP_EVC_MEM_Support_Pkg *outC);
extern void kcg_load_SV_Procedure_TRIP_EVC_MEM_Support_Pkg(
  outC_Procedure_TRIP_EVC_MEM_Support_Pkg *outC,
  SV_Procedure_TRIP_EVC_MEM_Support_Pkg *SV);
