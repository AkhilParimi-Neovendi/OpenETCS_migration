  ...
  outC_selectGradientOffset_SDM_GradientAcceleration_Pkg *outC)
{
  ...
  kcg_copy_GradientProfile_real_t_SDM_GradientAcceleration_types(
    &outC->_L1,
    GradientProfile);
  if ((kcg_lit_int32(0) <= outC->_L9) & (outC->_L9 < kcg_lit_int32(50))) {
  ...
  outC_selectGradientOffset_SDM_GradientAcceleration_Pkg *outC)
{
  ...
  outC->_L5 = kcg_true;
  outC->_L4.location = kcg_lit_float32(0.0);
  outC->_L4.gradient = kcg_lit_float32(0.0);
  ...
  outC->GradientSect.location = kcg_lit_float32(0.0);
  outC->GradientSect.gradient = kcg_lit_float32(0.0);
