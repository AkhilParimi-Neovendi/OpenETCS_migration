  ...
  outC_MRSP_reduction_TA_Export *outC)
{
  ...
  if ((kcg_lit_int64(0) <= outC->_L14) & (outC->_L14 < kcg_lit_int64(110))) {
...
void MRSP_reduction_init_TA_Export(outC_MRSP_reduction_TA_Export *outC)
{
  ...
  outC->_L2.write_index = kcg_lit_int64(0);
  for (idx = 0; idx < 110; idx++) {
    outC->_L2.MRSP[idx].valid = kcg_true;
    outC->_L2.MRSP[idx].Loc_Abs = kcg_lit_int64(0);
    outC->_L2.MRSP[idx].Loc_LRBG = kcg_lit_int64(0);
    outC->_L2.MRSP[idx].MRS = kcg_lit_int64(0);
  }
  outC->_L28 = kcg_true;
  ...
  for (idx1 = 0; idx1 < 110; idx1++) {
    ...
    outC->_L18[idx1].Loc_Abs = kcg_lit_int64(0);
    outC->_L18[idx1].Loc_LRBG = kcg_lit_int64(0);
    outC->_L18[idx1].MRS = kcg_lit_int64(0);
  }
  ...
  outC->_L15.Loc_Abs = kcg_lit_int64(0);
  outC->_L15.Loc_LRBG = kcg_lit_int64(0);
  outC->_L15.MRS = kcg_lit_int64(0);
  outC->_L14 = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 110; idx2++) {
    outC->_L13[idx2].valid = kcg_true;
    outC->_L13[idx2].Loc_Abs = kcg_lit_int64(0);
    outC->_L13[idx2].Loc_LRBG = kcg_lit_int64(0);
    outC->_L13[idx2].MRS = kcg_lit_int64(0);
  }
  outC->_L12 = kcg_lit_int64(0);
  outC->_L11.write_index = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 110; idx3++) {
    outC->_L11.MRSP[idx3].valid = kcg_true;
    outC->_L11.MRSP[idx3].Loc_Abs = kcg_lit_int64(0);
    outC->_L11.MRSP[idx3].Loc_LRBG = kcg_lit_int64(0);
    outC->_L11.MRSP[idx3].MRS = kcg_lit_int64(0);
  }
  outC->_L6 = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 110; idx4++) {
    outC->_L7[idx4].valid = kcg_true;
    outC->_L7[idx4].Loc_Abs = kcg_lit_int64(0);
    outC->_L7[idx4].Loc_LRBG = kcg_lit_int64(0);
    outC->_L7[idx4].MRS = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 110; idx5++) {
    outC->_L3[idx5].valid = kcg_true;
    outC->_L3[idx5].Loc_Abs = kcg_lit_int64(0);
    outC->_L3[idx5].Loc_LRBG = kcg_lit_int64(0);
    outC->_L3[idx5].MRS = kcg_lit_int64(0);
  }
  outC->_L1 = kcg_lit_int64(0);
  outC->next_index = kcg_lit_int64(0);
  outC->index = kcg_lit_int64(0);
  outC->reduced.write_index = kcg_lit_int64(0);
  for (idx6 = 0; idx6 < 110; idx6++) {
    outC->reduced.MRSP[idx6].valid = kcg_true;
    outC->reduced.MRSP[idx6].Loc_Abs = kcg_lit_int64(0);
    outC->reduced.MRSP[idx6].Loc_LRBG = kcg_lit_int64(0);
    outC->reduced.MRSP[idx6].MRS = kcg_lit_int64(0);
  }
  outC->cont = kcg_true;
}
