...
void CAST_Int_to_Q_UPDOWN_TM_conversions(
  /* q_updown_int/ */
  kcg_int32 q_updown_int,
  outC_CAST_Int_to_Q_UPDOWN_TM_conversions *outC)
{
  /* q_updown/ */
  static Q_UPDOWN q_updown_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* q_updown/ */
  static Q_UPDOWN _1_q_updown_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* error/ */
  static kcg_bool _3_error_partial;
  /* q_updown/ */
  static Q_UPDOWN _4_q_updown_partial;
  /* error/ */
  static kcg_bool _5_error_partial;
  /* q_updown/ */
  static Q_UPDOWN _6_q_updown_partial;
  ...
  if (outC->IfBlock1_clock) {
    ...
    outC->_L4_then_IfBlock1 = ENUM_Q_UPDOWN_downlink_TM_conversions;
    q_updown_partial = outC->_L4_then_IfBlock1;
    outC->q_updown = q_updown_partial;
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      outC->_L3_then_else_IfBlock1 = ENUM_Q_UPDOWN_uplink_TM_conversions;
      _6_q_updown_partial = outC->_L3_then_else_IfBlock1;
      _1_q_updown_partial = _6_q_updown_partial;
      _2_error_partial = _5_error_partial;
    }
    else {
      outC->_L2_else_else_IfBlock1 = kcg_true;
      _3_error_partial = outC->_L2_else_else_IfBlock1;
      outC->_L1_else_else_IfBlock1 = ENUM_Q_UPDOWN_downlink_TM_conversions;
      _4_q_updown_partial = outC->_L1_else_else_IfBlock1;
      _1_q_updown_partial = _4_q_updown_partial;
      _2_error_partial = _3_error_partial;
    }
    outC->q_updown = _1_q_updown_partial;
  ...
  outC_CAST_Int_to_Q_UPDOWN_TM_conversions *outC)
{
  ...
  outC->_L13 = kcg_true;
  outC->q_updown_in = kcg_lit_int32(0);
  outC->error = kcg_true;
  outC->IfBlock1_clock = kcg_true;
  outC->_L5_then_else_IfBlock1 = kcg_true;
  outC->_L3_then_else_IfBlock1 = Q_UPDOWN_Down_link_telegram;
  outC->_L1_else_else_IfBlock1 = Q_UPDOWN_Down_link_telegram;
  outC->_L2_else_else_IfBlock1 = kcg_true;
  outC->else_clock_IfBlock1 = kcg_true;
  outC->_L4_then_IfBlock1 = Q_UPDOWN_Down_link_telegram;
