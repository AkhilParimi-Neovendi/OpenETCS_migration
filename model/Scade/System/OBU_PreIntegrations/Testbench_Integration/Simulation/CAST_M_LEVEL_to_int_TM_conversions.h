...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  kcg_int64 /* m_level_int/ */ m_level_int;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  kcg_int64 /* IfBlock1:else:else:else:else:else:_L2/ */ _L2_else_else_else_else_else_IfBlock1;
...
extern void CAST_M_LEVEL_to_int_init_TM_conversions(
  outC_CAST_M_LEVEL_to_int_TM_conversions *outC);
