...
void kcg_save_SV_SDMLimitLocations_TargetLimits_Pkg(
  SV_SDMLimitLocations_TargetLimits_Pkg *SV,
  outC_SDMLimitLocations_TargetLimits_Pkg *outC)
{
  kcg_save_SV_LowerOrHold_TargetLimits_Pkg(
    &SV->Context_LowerOrHold_2,
    &outC->Context_LowerOrHold_2);
  kcg_save_SV_LowerOrHold_TargetLimits_Pkg(
    &SV->Context_LowerOrHold_1,
    &outC->Context_LowerOrHold_1);
  kcg_save_SV_LowerOrHold_TargetLimits_Pkg(
    &SV->Context_LowerOrHold_3,
    &outC->Context_LowerOrHold_3);
}

void kcg_load_SV_SDMLimitLocations_TargetLimits_Pkg(
  outC_SDMLimitLocations_TargetLimits_Pkg *outC,
  SV_SDMLimitLocations_TargetLimits_Pkg *SV)
{
  kcg_load_SV_LowerOrHold_TargetLimits_Pkg(
    &outC->Context_LowerOrHold_2,
    &SV->Context_LowerOrHold_2);
  kcg_load_SV_LowerOrHold_TargetLimits_Pkg(
    &outC->Context_LowerOrHold_1,
