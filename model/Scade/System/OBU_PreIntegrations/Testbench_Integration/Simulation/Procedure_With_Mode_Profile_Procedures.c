  ...
  outC_Procedure_With_Mode_Profile_Procedures *outC)
{
  ...
  /* Loc_Timer/ */
  static kcg_int32 Loc_Timer_partial;
  /* Loc_Confirmation/ */
  ...
  /* Loc_Timer/ */
  static kcg_int32 _7_Loc_Timer_partial;
  /* Loc_Confirmation/ */
  ...
  /* Loc_Timer/ */
  static kcg_int32 _39_Loc_Timer_partial;
  /* Loc_Confirmation/ */
  ...
  static kcg_bool tr_1_guard_Switch_Autorized_Waiting_Ack_SM_Current_Location_Current_Location_SM_Mode_Profile_By_Trackside;
  /* SM_Mode_Profile_By_Trackside:Current_Location:SM_Current_Location:Switch_Autorized_Waiting_Ack:<2> */
  static kcg_bool tr_2_guard_Switch_Autorized_Waiting_Ack_SM_Current_Location_Current_Location_SM_Mode_Profile_By_Trackside;
  /* SM_Mode_Profile_By_Trackside:Current_Location:SM_Current_Location: */
  ...
  /* Loc_Timer/ */
  static kcg_int32 _57_Loc_Timer_partial;
  /* Service_Brake_Command/ */
  ...
  /* Loc_Timer/ */
  static kcg_int32 _67_Loc_Timer_partial;
  /* Service_Brake_Command/ */
  ...
  /* Loc_Timer/ */
  static kcg_int32 _77_Loc_Timer_partial;
  /* Service_Brake_Command/ */
  ...
  /* Loc_Timer/ */
  static kcg_int32 _97_Loc_Timer_partial;
  /* Service_Brake_Command/ */
  ...
  /* Loc_Timer/ */
  static kcg_int32 _107_Loc_Timer_partial;
  /* Service_Brake_Command/ */
  ...
  /* Loc_Timer/ */
  static kcg_int32 last_Loc_Timer;
  /* SM_Mode_Profile_By_Trackside: */
...
void kcg_save_SV_Procedure_With_Mode_Profile_Procedures(
  SV_Procedure_With_Mode_Profile_Procedures *SV,
  outC_Procedure_With_Mode_Profile_Procedures *outC)
{
  kcg_save_SV_Counter_pwlinear_int32(
    &SV->Context_Counter_8,
    &outC->Context_Counter_8);
  SV->Context_Loc_Confirmation = outC->Loc_Confirmation;
  SV->Context_Loc_Timer = outC->Loc_Timer;
  SV->Context_SM_Mode_Profile_By_Trackside_reset_nxt =
    outC->SM_Mode_Profile_By_Trackside_reset_nxt;
  SV->Context_SM_Mode_Profile_By_Trackside_reset_act =
    outC->SM_Mode_Profile_By_Trackside_reset_act;
  SV->Context_SM_Mode_Profile_By_Trackside_state_nxt =
    outC->SM_Mode_Profile_By_Trackside_state_nxt;
  SV->Context_SM_Current_Location_state_nxt =
    outC->SM_Current_Location_state_nxt_Current_Location_SM_Mode_Profile_By_Trackside;
  SV->Context_SM_Current_Location_reset_act =
    outC->SM_Current_Location_reset_act_Current_Location_SM_Mode_Profile_By_Trackside;
  SV->Context_SM_Current_Location_reset_nxt =
    outC->SM_Current_Location_reset_nxt_Current_Location_SM_Mode_Profile_By_Trackside;
  SV->Context_SM_Futher_Location_state_nxt =
    outC->SM_Futher_Location_state_nxt_Futher_location_SM_Mode_Profile_By_Trackside;
  SV->Context_SM_Futher_Location_reset_act =
    outC->SM_Futher_Location_reset_act_Futher_location_SM_Mode_Profile_By_Trackside;
  SV->Context_SM_Futher_Location_reset_nxt =
    outC->SM_Futher_Location_reset_nxt_Futher_location_SM_Mode_Profile_By_Trackside;
  SV->_1_Context_init = outC->init1;
  SV->Context_init = outC->init;
}

void kcg_load_SV_Procedure_With_Mode_Profile_Procedures(
  outC_Procedure_With_Mode_Profile_Procedures *outC,
  SV_Procedure_With_Mode_Profile_Procedures *SV)
{
  kcg_load_SV_Counter_pwlinear_int32(
    &outC->Context_Counter_8,
    &SV->Context_Counter_8);
  outC->Loc_Confirmation = SV->Context_Loc_Confirmation;
  outC->Loc_Timer = SV->Context_Loc_Timer;
  outC->SM_Mode_Profile_By_Trackside_reset_nxt =
    SV->Context_SM_Mode_Profile_By_Trackside_reset_nxt;
  outC->SM_Mode_Profile_By_Trackside_reset_act =
    SV->Context_SM_Mode_Profile_By_Trackside_reset_act;
