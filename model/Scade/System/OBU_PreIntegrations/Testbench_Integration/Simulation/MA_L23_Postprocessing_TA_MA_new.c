  ...
  outC_MA_L23_Postprocessing_TA_MA_new *outC)
{
  ...
  outC->_L14.v_main = kcg_lit_int64(0);
  outC->_L14.v_loa = kcg_lit_int64(0);
  outC->_L14.t_loa_unlimited = kcg_true;
  outC->_L14.t_loa = kcg_lit_int64(0);
  outC->_L14.n_iter = kcg_lit_int64(0);
  for (idx = 0; idx < 10; idx++) {
    outC->_L14.sections[idx].valid = kcg_true;
    outC->_L14.sections[idx].q_endsection = kcg_true;
    outC->_L14.sections[idx].l_section = kcg_lit_int64(0);
    outC->_L14.sections[idx].q_sectiontimer = kcg_true;
    outC->_L14.sections[idx].t_sectiontimer = kcg_lit_int64(0);
    outC->_L14.sections[idx].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->_L14.q_dangerpoint = kcg_true;
  outC->_L14.dangerpoint.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L14.dangerpoint.v_release = kcg_lit_int64(0);
  outC->_L14.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->_L14.q_overlap = kcg_true;
  outC->_L14.overlap.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L14.overlap.v_release = kcg_lit_int64(0);
  outC->_L14.overlap.calc_v_release_onboard = kcg_true;
  outC->_L14.q_endtimer = kcg_true;
  outC->_L14.endtimer_t.t_endtimer = kcg_lit_int64(0);
  outC->_L14.endtimer_t.d_endtimerstoploc = kcg_lit_int64(0);
  outC->_L8.valid = kcg_true;
  outC->_L8.Level = MA_L1_TrackAtlasTypes;
  outC->_L8.q_dir = Q_DIR_Reverse;
  outC->_L8.v_main = kcg_lit_int64(0);
  outC->_L8.v_loa = kcg_lit_int64(0);
  outC->_L8.t_loa_unlimited = kcg_true;
  outC->_L8.t_loa = kcg_lit_int64(0);
  outC->_L8.n_iter = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 10; idx1++) {
    outC->_L8.sections[idx1].valid = kcg_true;
    outC->_L8.sections[idx1].q_endsection = kcg_true;
    outC->_L8.sections[idx1].l_section = kcg_lit_int64(0);
    outC->_L8.sections[idx1].q_sectiontimer = kcg_true;
    outC->_L8.sections[idx1].t_sectiontimer = kcg_lit_int64(0);
    outC->_L8.sections[idx1].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->_L8.q_dangerpoint = kcg_true;
  outC->_L8.dangerpoint.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L8.dangerpoint.v_release = kcg_lit_int64(0);
  outC->_L8.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->_L8.q_overlap = kcg_true;
  outC->_L8.overlap.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L8.overlap.v_release = kcg_lit_int64(0);
  outC->_L8.overlap.calc_v_release_onboard = kcg_true;
  outC->_L8.q_endtimer = kcg_true;
  outC->_L8.endtimer_t.t_endtimer = kcg_lit_int64(0);
  outC->_L8.endtimer_t.d_endtimerstoploc = kcg_lit_int64(0);
  outC->_L2.valid = kcg_true;
  outC->_L2.Level = MA_L1_TrackAtlasTypes;
  outC->_L2.q_dir = Q_DIR_Reverse;
  outC->_L2.v_main = kcg_lit_int64(0);
  ...
  for (idx2 = 0; idx2 < 10; idx2++) {
    ...
    outC->_L2.sections[idx2].l_section = kcg_lit_int64(0);
    outC->_L2.sections[idx2].q_sectiontimer = kcg_true;
    outC->_L2.sections[idx2].t_sectiontimer = kcg_lit_int64(0);
    outC->_L2.sections[idx2].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->_L2.q_dangerpoint = kcg_true;
  outC->_L2.dangerpoint.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L2.dangerpoint.v_release = kcg_lit_int64(0);
  outC->_L2.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->_L2.q_overlap = kcg_true;
  outC->_L2.overlap.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L2.overlap.v_release = kcg_lit_int64(0);
  outC->_L2.overlap.calc_v_release_onboard = kcg_true;
  outC->_L2.q_endtimer = kcg_true;
  outC->_L2.endtimer_t.t_endtimer = kcg_lit_int64(0);
  outC->_L2.endtimer_t.d_endtimerstoploc = kcg_lit_int64(0);
  ...
  for (idx3 = 0; idx3 < 10; idx3++) {
    ...
    outC->MA_absolute.sections[idx3].l_section = kcg_lit_int64(0);
    outC->MA_absolute.sections[idx3].q_sectiontimer = kcg_true;
    outC->MA_absolute.sections[idx3].t_sectiontimer = kcg_lit_int64(0);
    outC->MA_absolute.sections[idx3].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  ...
  outC->MA_at_LRBG.v_main = kcg_lit_int64(0);
  outC->MA_at_LRBG.v_loa = kcg_lit_int64(0);
  outC->MA_at_LRBG.t_loa_unlimited = kcg_true;
  outC->MA_at_LRBG.t_loa = kcg_lit_int64(0);
  outC->MA_at_LRBG.n_iter = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 10; idx4++) {
    outC->MA_at_LRBG.sections[idx4].valid = kcg_true;
    outC->MA_at_LRBG.sections[idx4].q_endsection = kcg_true;
    outC->MA_at_LRBG.sections[idx4].l_section = kcg_lit_int64(0);
    outC->MA_at_LRBG.sections[idx4].q_sectiontimer = kcg_true;
    outC->MA_at_LRBG.sections[idx4].t_sectiontimer = kcg_lit_int64(0);
    outC->MA_at_LRBG.sections[idx4].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->MA_at_LRBG.q_dangerpoint = kcg_true;
  outC->MA_at_LRBG.dangerpoint.d_DP_or_OL = kcg_lit_int64(0);
  outC->MA_at_LRBG.dangerpoint.v_release = kcg_lit_int64(0);
  outC->MA_at_LRBG.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->MA_at_LRBG.q_overlap = kcg_true;
  outC->MA_at_LRBG.overlap.d_DP_or_OL = kcg_lit_int64(0);
  outC->MA_at_LRBG.overlap.v_release = kcg_lit_int64(0);
  outC->MA_at_LRBG.overlap.calc_v_release_onboard = kcg_true;
  outC->MA_at_LRBG.q_endtimer = kcg_true;
  outC->MA_at_LRBG.endtimer_t.t_endtimer = kcg_lit_int64(0);
  outC->MA_at_LRBG.endtimer_t.d_endtimerstoploc = kcg_lit_int64(0);
  /* _L14=(TA_MA_new::MA_Normalize_MA_LRBG#1)/ */
...
void kcg_save_SV_MA_L23_Postprocessing_TA_MA_new(
  SV_MA_L23_Postprocessing_TA_MA_new *SV,
  outC_MA_L23_Postprocessing_TA_MA_new *outC)
{
  kcg_save_SV_Update_MA_TA_MA_new(
    &SV->Context_Update_MA_1,
    &outC->Context_Update_MA_1);
}

void kcg_load_SV_MA_L23_Postprocessing_TA_MA_new(
  outC_MA_L23_Postprocessing_TA_MA_new *outC,
  SV_MA_L23_Postprocessing_TA_MA_new *SV)
{
  kcg_load_SV_Update_MA_TA_MA_new(
    &outC->Context_Update_MA_1,
    &SV->Context_Update_MA_1);
}
