...
typedef struct {
  ...
  kcg_int32 /* @1/Me_output/ */ Me_output_Mean_1_int32;
  kcg_int32 /* @1/I2/ */ I2_Mean_1_int32;
  kcg_int32 /* @1/I1/ */ I1_Mean_1_int32;
  kcg_int32 /* @1/_L6/ */ _L6_Mean_1_int32;
  kcg_int32 /* @1/_L4/ */ _L4_Mean_1_int32;
  kcg_int32 /* @1/_L3/ */ _L3_Mean_1_int32;
  kcg_int32 /* @1/_L2/ */ _L2_Mean_1_int32;
  kcg_int32 /* @1/_L1/ */ _L1_Mean_1_int32;
  T_internal_Type_Obu_BasicTypes_Pkg /* IfBlock1:then:_L17/ */ _L17_then_IfBlock1;
  kcg_int32 /* IfBlock1:then:_L16/ */ _L16_then_IfBlock1;
  ...
  kcg_int32 /* IfBlock1:else:else:then:_L29/ */ _L29_then_else_else_IfBlock1;
  ...
  kcg_int32 /* IfBlock1:else:else:else:then:_L7/ */ _L7_then_else_else_else_IfBlock1;
  ...
  kcg_int32 /* IfBlock1:else:else:else:then:_L13/ */ _L13_then_else_else_else_IfBlock1;
  ...
  kcg_int32 /* IfBlock1:else:then:_L12/ */ _L12_then_else_IfBlock1;
...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_Send_M154_TM_radio_messages Context_Send_M154_1;
  SV_Send_M159_TM_radio_messages Context_Send_M159_2;
  SV_Send_M156_TM_radio_messages Context_Send_M156_1;
  SV_Send_M155_TM_radio_messages Context_Send_M155_1;
} SV_genMsgToBus_RCM_Utils_Pkg_encoders;

extern void kcg_save_SV_genMsgToBus_RCM_Utils_Pkg_encoders(
  SV_genMsgToBus_RCM_Utils_Pkg_encoders *SV,
  outC_genMsgToBus_RCM_Utils_Pkg_encoders *outC);
extern void kcg_load_SV_genMsgToBus_RCM_Utils_Pkg_encoders(
  outC_genMsgToBus_RCM_Utils_Pkg_encoders *outC,
  SV_genMsgToBus_RCM_Utils_Pkg_encoders *SV);
