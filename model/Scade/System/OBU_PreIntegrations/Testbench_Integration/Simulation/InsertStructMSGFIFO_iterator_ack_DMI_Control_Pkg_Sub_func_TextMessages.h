...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  _80_array /* OutputArray/ */ OutputArray;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
...
typedef struct {
  /* ----------------------  memorised outputs  ---------------------- */
  _80_array /* OutputArray/ */ Context_OutputArray;
  /* -----------------------  no local memory  ----------------------- */
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
} SV_InsertStructMSGFIFO_iterator_ack_DMI_Control_Pkg_Sub_func_TextMessages;

extern void kcg_save_SV_InsertStructMSGFIFO_iterator_ack_DMI_Control_Pkg_Sub_func_TextMessages(
  SV_InsertStructMSGFIFO_iterator_ack_DMI_Control_Pkg_Sub_func_TextMessages *SV,
  outC_InsertStructMSGFIFO_iterator_ack_DMI_Control_Pkg_Sub_func_TextMessages *outC);
extern void kcg_load_SV_InsertStructMSGFIFO_iterator_ack_DMI_Control_Pkg_Sub_func_TextMessages(
  outC_InsertStructMSGFIFO_iterator_ack_DMI_Control_Pkg_Sub_func_TextMessages *outC,
  SV_InsertStructMSGFIFO_iterator_ack_DMI_Control_Pkg_Sub_func_TextMessages *SV);
