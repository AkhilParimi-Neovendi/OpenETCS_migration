...
void MergeTime_iterator_DMI_Control_Pkg_Sub_func_TextMessages(
  ...
  /* ImpArray/ */
  array_float32_10 *ImpArray,
  /* numAuxi/ */
  kcg_int32 numAuxi,
  /* AuxiArray/ */
  array_float32_10 *AuxiArray,
  outC_MergeTime_iterator_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  outC->_L25 = numAuxi;
  outC->_L41 = index;
  outC->_L42 = outC->_L41 - outC->_L25;
  kcg_copy_array_float32_10(&outC->_L40, AuxiArray);
  kcg_copy_array_float32_10(&outC->_L38, acc);
  ...
  kcg_copy_array_float32_10(&outC->_L24, ImpArray);
  outC->_L21 = index;
  if ((kcg_lit_int32(0) <= outC->_L42) & (outC->_L42 < kcg_lit_int32(10))) {
    outC->_L11 = outC->_L24[outC->_L42];
  }
  else {
    outC->_L11 = outC->_L29;
  }
  kcg_copy_array_float32_10(&outC->_L12, acc);
  kcg_copy_array_float32_10(&outC->_L15, &outC->_L12);
  if ((kcg_lit_int32(0) <= outC->_L21) & (outC->_L21 < kcg_lit_int32(10))) {
    outC->_L15[outC->_L21] = outC->_L11;
  }
  /* _L5= */
  if (outC->_L35) {
    kcg_copy_array_float32_10(&outC->_L5, &outC->_L38);
  }
  else {
    kcg_copy_array_float32_10(&outC->_L5, &outC->_L15);
  }
  kcg_copy_array_float32_10(&outC->OutputTimeArray, &outC->_L5);
}
