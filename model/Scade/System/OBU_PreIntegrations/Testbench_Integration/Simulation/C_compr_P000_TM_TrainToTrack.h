...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P000_TM_TrainToTrack /* P000_out/ */ P000_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  outC_Filter_Variable_TM_TrainToTrack /* _L93=(TM_TrainToTrack::Filter_Variable#3)/ */ Context_Filter_Variable_3;
  outC_Filter_Variable_TM_TrainToTrack /* _L94=(TM_TrainToTrack::Filter_Variable#6)/ */ Context_Filter_Variable_6;
  outC_Filter_Variable_TM_TrainToTrack /* _L95=(TM_TrainToTrack::Filter_Variable#5)/ */ Context_Filter_Variable_5;
  outC_Filter_Variable_TM_TrainToTrack /* _L96=(TM_TrainToTrack::Filter_Variable#8)/ */ Context_Filter_Variable_8;
  outC_Filter_Variable_TM_TrainToTrack /* _L97=(TM_TrainToTrack::Filter_Variable#7)/ */ Context_Filter_Variable_7;
  outC_Filter_Variable_TM_TrainToTrack /* _L98=(TM_TrainToTrack::Filter_Variable#10)/ */ Context_Filter_Variable_10;
  outC_Filter_Variable_TM_TrainToTrack /* _L99=(TM_TrainToTrack::Filter_Variable#9)/ */ Context_Filter_Variable_9;
  outC_Filter_Variable_TM_TrainToTrack /* _L100=(TM_TrainToTrack::Filter_Variable#12)/ */ Context_Filter_Variable_12;
  outC_Filter_Variable_TM_TrainToTrack /* _L101=(TM_TrainToTrack::Filter_Variable#11)/ */ Context_Filter_Variable_11;
  outC_Filter_Variable_TM_TrainToTrack /* _L102=(TM_TrainToTrack::Filter_Variable#14)/ */ Context_Filter_Variable_14;
  outC_Filter_Variable_TM_TrainToTrack /* _L103=(TM_TrainToTrack::Filter_Variable#13)/ */ Context_Filter_Variable_13;
  outC_Filter_Variable_TM_TrainToTrack /* _L104=(TM_TrainToTrack::Filter_Variable#16)/ */ Context_Filter_Variable_16;
  outC_CAST_Int_to_D_LRBG_TM_conversions /* _L107=(TM_conversions::CAST_Int_to_D_LRBG#1)/ */ Context_CAST_Int_to_D_LRBG_1;
  outC_Filter_Variable_TM_TrainToTrack /* _L105=(TM_TrainToTrack::Filter_Variable#17)/ */ Context_Filter_Variable_17;
  outC_Filter_Variable_TM_TrainToTrack /* _L92=(TM_TrainToTrack::Filter_Variable#4)/ */ Context_Filter_Variable_4;
  ...
  P000_TrainTrack_int_TM_TrainToTrack /* _L1/ */ _L1;
  kcg_int64 /* _L16/ */ _L16;
  kcg_int64 /* _L15/ */ _L15;
  kcg_int64 /* _L14/ */ _L14;
  kcg_int64 /* _L13/ */ _L13;
  ...
  M_LEVEL /* _L84/ */ _L84;
  NID_NTC /* _L85/ */ _L85;
  P000_TM_TrainToTrack /* _L86/ */ _L86;
  kcg_bool /* _L88/ */ _L88;
  kcg_int64 /* _L90/ */ _L90;
  kcg_int64 /* _L91/ */ _L91;
  kcg_int64 /* _L93/ */ _L93;
...
extern void C_compr_P000_init_TM_TrainToTrack(
  outC_C_compr_P000_TM_TrainToTrack *outC);
