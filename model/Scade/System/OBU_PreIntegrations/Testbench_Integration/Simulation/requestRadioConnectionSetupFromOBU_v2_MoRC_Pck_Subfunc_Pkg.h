...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* repeat_SM: */ Context_repeat_SM_reset_nxt;
  kcg_bool /* repeat_SM: */ Context_repeat_SM_reset_act;
  SSM_ST_repeat_SM /* repeat_SM: */ Context_repeat_SM_state_nxt;
  p42_sessionManagement_T_RCM_MsgTypes_Pkg /* @1/_L8/ */ Context__L8_Memory_1;
...
} SV_requestRadioConnectionSetupFromOBU_v2_MoRC_Pck_Subfunc_Pkg;

extern void kcg_save_SV_requestRadioConnectionSetupFromOBU_v2_MoRC_Pck_Subfunc_Pkg(
  SV_requestRadioConnectionSetupFromOBU_v2_MoRC_Pck_Subfunc_Pkg *SV,
  outC_requestRadioConnectionSetupFromOBU_v2_MoRC_Pck_Subfunc_Pkg *outC);
extern void kcg_load_SV_requestRadioConnectionSetupFromOBU_v2_MoRC_Pck_Subfunc_Pkg(
  outC_requestRadioConnectionSetupFromOBU_v2_MoRC_Pck_Subfunc_Pkg *outC,
  SV_requestRadioConnectionSetupFromOBU_v2_MoRC_Pck_Subfunc_Pkg *SV);
