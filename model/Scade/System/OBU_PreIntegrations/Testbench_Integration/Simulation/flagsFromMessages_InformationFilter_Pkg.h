...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* NTC_transitionPending/ */ Context_NTC_transitionPending;
  kcg_bool /* p27valid/ */ Context_p27valid;
  kcg_bool /* p21valid/ */ Context_p21valid;
  kcg_bool /* p15valid/ */ Context_p15valid;
  kcg_bool /* p12valid/ */ Context_p12valid;
  kcg_bool /* L1_transitionPending/ */ Context_L1_transitionPending;
  kcg_bool /* L2L3_transitionPending/ */ Context_L2L3_transitionPending;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
} SV_flagsFromMessages_InformationFilter_Pkg;

extern void kcg_save_SV_flagsFromMessages_InformationFilter_Pkg(
  SV_flagsFromMessages_InformationFilter_Pkg *SV,
  outC_flagsFromMessages_InformationFilter_Pkg *outC);
extern void kcg_load_SV_flagsFromMessages_InformationFilter_Pkg(
  outC_flagsFromMessages_InformationFilter_Pkg *outC,
  SV_flagsFromMessages_InformationFilter_Pkg *SV);
