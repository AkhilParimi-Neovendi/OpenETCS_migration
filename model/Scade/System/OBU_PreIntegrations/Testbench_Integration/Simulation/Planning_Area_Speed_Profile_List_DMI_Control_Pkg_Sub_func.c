  ...
  outC_Planning_Area_Speed_Profile_List_DMI_Control_Pkg_Sub_func *outC)
{
  ...
  outC->MRSP_DMI = kcg_lit_float32(0.0);
  outC->Loc_Abs_DMI = kcg_lit_float32(0.0);
