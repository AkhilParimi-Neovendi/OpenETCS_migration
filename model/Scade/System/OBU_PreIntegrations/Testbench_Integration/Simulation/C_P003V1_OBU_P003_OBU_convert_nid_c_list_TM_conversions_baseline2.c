  ...
  outC_C_P003V1_OBU_P003_OBU_convert_nid_c_list_TM_conversions_baseline2 *outC)
{
  ...
  kcg_copy_P003V1_sectionlist_enum_T_TM_baseline2(
    &outC->_L109,
    &outC->_L59.SECTIONS);
  kcg_copy__101_array(&outC->_L110, (_101_array *) &outC->_L109[1]);
  kcg_copy__101_array(&outC->_L113[0], &outC->_L110);
  ...
  kcg_copy_P003_OBU_nid_c_sectionlist_enum_T_TM(&outC->nid_c_list, &outC->_L113);
  outC->n_iter_out = outC->_L108;
  outC->nid_c1 = outC->_L112;
}

#ifndef KCG_USER_DEFINED_INIT
void C_P003V1_OBU_P003_OBU_convert_nid_c_list_init_TM_conversions_baseline2(
  outC_C_P003V1_OBU_P003_OBU_convert_nid_c_list_TM_conversions_baseline2 *outC)
{
  static kcg_size idx;
