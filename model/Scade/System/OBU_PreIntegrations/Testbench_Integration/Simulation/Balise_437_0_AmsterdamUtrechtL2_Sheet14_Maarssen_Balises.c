...
void Balise_437_0_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises(
  ...
  /* PIG_nom/ */
  kcg_int32 PIG_nom,
  outC_Balise_437_0_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Balises::Packets_BG437#1)/ */
    Packets_BG437_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG437_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG437_1.Balise_data_out);
...
void Balise_437_0_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises(
  outC_Balise_437_0_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises *outC)
{
  static kcg_size idx;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Balises::Packets_BG437#1)/ */
  Packets_BG437_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises(
    &outC->Context_Packets_BG437_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_437_0_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises(
  outC_Balise_437_0_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Balises::Packets_BG437#1)/ */
  Packets_BG437_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises(
    &outC->Context_Packets_BG437_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
