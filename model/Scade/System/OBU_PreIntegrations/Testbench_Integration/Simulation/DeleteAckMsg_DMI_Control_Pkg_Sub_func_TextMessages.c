  ...
  outC_DeleteAckMsg_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  /* new_hh/ */
  static array_float64_5 last_new_hh;
  /* new_mm/ */
  static array_float64_5 last_new_mm;
  /* NumE/ */
  ...
  /* localQueue/ */
  static _80_array last_localQueue;

  kcg_copy__80_array(&last_localQueue, &outC->mem_localQueue);
  kcg_copy__80_array(&outC->mem_localQueue, localQueue);
  last_local_num_ack = outC->mem_local_num_ack;
  outC->mem_local_num_ack = local_num_ack;
  last_ack_is_Empty = outC->ack_is_Empty;
  /* new_hh/ */
  if (outC->init) {
    kcg_copy_array_float64_5(&last_new_hh, hh_array);
  }
  else {
    kcg_copy_array_float64_5(&last_new_hh, &outC->new_hh);
  }
  /* new_mm/ */
  if (outC->init) {
    kcg_copy_array_float64_5(&last_new_mm, mm_array);
  }
  else {
    kcg_copy_array_float64_5(&last_new_mm, &outC->new_mm);
  }
  /* NumE/ */
  if (outC->init) {
  ...
  /* queue/ */
  if (outC->init) {
    kcg_copy__80_array(&last_queue, localQueue);
  }
  else {
    kcg_copy__80_array(&last_queue, &outC->queue);
  }
  kcg_copy_array_float64_5(&outC->_L32, hh_array);
  kcg_copy_array_float64_5(&outC->_L33, mm_array);
  ...
  kcg_copy__80_array(&outC->_L19, localQueue);
  ...
  kcg_copy__80_array(&outC->_L108, &outC->Context_FIFO_Delete_Op_Ack_1.Queue);
  outC->_L107 = kcg_lit_int64(1);
  ...
  kcg_copy_array_float64_5(&outC->_L103, hh_array);
  kcg_copy_array_float64_5(&outC->_L102, mm_array);
  kcg_copy__80_array(&outC->_L101, localQueue);
  ...
  /* _L84= */
  if (outC->_L80) {
    kcg_copy_array_float64_5(&outC->_L84, &outC->_L109);
  }
  else {
    kcg_copy_array_float64_5(&outC->_L84, &outC->_L102);
  }
  /* _L84= */
  if (outC->_L80) {
    kcg_copy_array_float64_5(&outC->_L85, &outC->_L110);
  }
  else {
    kcg_copy_array_float64_5(&outC->_L85, &outC->_L103);
  }
  outC->NumE = outC->_L104;
  kcg_copy_array_float64_5(&outC->new_hh, &outC->_L85);
  kcg_copy_array_float64_5(&outC->new_mm, &outC->_L84);
  outC->_L27 = Delete;
  /* _L25= */
  if (outC->_L27) {
    kcg_copy__80_array(&outC->_L25, &outC->_L108);
  }
  else {
    kcg_copy__80_array(&outC->_L25, &outC->_L101);
  }
  kcg_copy__80_array(&outC->queue, &outC->_L25);
  outC->init = kcg_false;
}
  ...
  outC_DeleteAckMsg_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  for (idx = 0; idx < 5; idx++) {
    outC->_L109[idx] = kcg_lit_float64(0.0);
  }
  for (idx1 = 0; idx1 < 5; idx1++) {
    outC->_L110[idx1] = kcg_lit_float64(0.0);
  }
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L108[idx3].present = kcg_true;
    outC->_L108[idx3].dmi_msg.valid = kcg_true;
    outC->_L108[idx3].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L108[idx3].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L108[idx3].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L108[idx3].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx4 = 0; idx4 < 5; idx4++) {
    outC->_L102[idx4] = kcg_lit_float64(0.0);
  }
  for (idx5 = 0; idx5 < 5; idx5++) {
    outC->_L103[idx5] = kcg_lit_float64(0.0);
  }
  for (idx7 = 0; idx7 < 5; idx7++) {
    outC->_L101[idx7].present = kcg_true;
    outC->_L101[idx7].dmi_msg.valid = kcg_true;
    outC->_L101[idx7].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L101[idx7].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L101[idx7].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L101[idx7].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx8 = 0; idx8 < 5; idx8++) {
    outC->_L85[idx8] = kcg_lit_float64(0.0);
  }
  for (idx9 = 0; idx9 < 5; idx9++) {
    outC->_L84[idx9] = kcg_lit_float64(0.0);
  }
  outC->_L80 = kcg_true;
  ...
  for (idx11 = 0; idx11 < 5; idx11++) {
    outC->_L32[idx11] = kcg_lit_float64(0.0);
  }
  outC->_L27 = kcg_true;
  for (idx13 = 0; idx13 < 5; idx13++) {
    outC->_L25[idx13].present = kcg_true;
    outC->_L25[idx13].dmi_msg.valid = kcg_true;
    outC->_L25[idx13].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L25[idx13].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L25[idx13].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L25[idx13].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx15 = 0; idx15 < 5; idx15++) {
    ...
    outC->_L19[idx15].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L19[idx15].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L19[idx15].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L19[idx15].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx19 = 0; idx19 < 5; idx19++) {
    ...
    outC->queue[idx19].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->queue[idx19].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->queue[idx19].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->queue[idx19].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  outC_DeleteAckMsg_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  kcg_copy_array_float64_5(&SV->Context_new_hh, &outC->new_hh);
  kcg_copy_array_float64_5(&SV->Context_new_mm, &outC->new_mm);
  ...
  kcg_copy__80_array(&SV->Context_mem_localQueue, &outC->mem_localQueue);
}
  ...
  SV_DeleteAckMsg_DMI_Control_Pkg_Sub_func_TextMessages *SV)
{
  ...
  kcg_copy_array_float64_5(&outC->new_hh, &SV->Context_new_hh);
  kcg_copy_array_float64_5(&outC->new_mm, &SV->Context_new_mm);
  ...
  kcg_copy__80_array(&outC->mem_localQueue, &SV->Context_mem_localQueue);
}
