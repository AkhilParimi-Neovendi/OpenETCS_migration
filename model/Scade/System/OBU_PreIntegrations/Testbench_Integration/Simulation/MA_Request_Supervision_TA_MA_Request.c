  ...
  outC_MA_Request_Supervision_TA_MA_Request *outC)
{
  ...
  /* SM1: */
  static _132_SSM_ST_SM1 SM1_state_nxt_partial;
  /* SM1: */
  static kcg_bool SM1_reset_nxt_partial;
  /* SM1: */
  static _133_SSM_TR_SM1 SM1_fired_partial;
  /* pendingReq/ */
  static kcg_bool _3_pendingReq_partial;
  /* SM1: */
  static _132_SSM_ST_SM1 _4_SM1_state_nxt_partial;
  /* SM1: */
  static kcg_bool _5_SM1_reset_nxt_partial;
  /* SM1: */
  static _133_SSM_TR_SM1 _6_SM1_fired_partial;
  /* pendingReq/ */
  static kcg_bool _7_pendingReq_partial;
  /* SM1: */
  static _132_SSM_ST_SM1 _8_SM1_state_nxt_partial;
  /* SM1: */
  static kcg_bool _9_SM1_reset_nxt_partial;
  /* SM1: */
  static _133_SSM_TR_SM1 _10_SM1_fired_partial;
  /* SM1: */
  static _132_SSM_ST_SM1 SM1_state_act_partial;
  /* SM1: */
  static kcg_bool SM1_reset_act_partial;
  /* SM1: */
  static _133_SSM_TR_SM1 SM1_fired_strong_partial;
  /* SM1:init:<1> */
  static kcg_bool tr_1_guard_init_SM1;
  /* SM1: */
  static _132_SSM_ST_SM1 _11_SM1_state_act_partial;
  /* SM1: */
  static kcg_bool _12_SM1_reset_act_partial;
  /* SM1: */
  static _133_SSM_TR_SM1 _13_SM1_fired_strong_partial;
  /* SM1:NoReqPending:<1> */
  static kcg_bool tr_1_guard_NoReqPending_SM1;
  /* SM1: */
  static _132_SSM_ST_SM1 _14_SM1_state_act_partial;
  /* SM1: */
  static kcg_bool _15_SM1_reset_act_partial;
  /* SM1: */
  static _133_SSM_TR_SM1 _16_SM1_fired_strong_partial;
  /* SM1:ReqPending:<1> */
  ...
  switch (outC->SM1_state_sel) {
    case SSM_st_ReqPending_SM1 :
      if (tr_1_guard_ReqPending_SM1) {
        ...
        _16_SM1_fired_strong_partial = _150_SSM_TR_no_trans_SM1;
      }
    ...
    case SSM_st_NoReqPending_SM1 :
      if (tr_1_guard_NoReqPending_SM1) {
        ...
        _13_SM1_fired_strong_partial = _150_SSM_TR_no_trans_SM1;
      }
    ...
    case SSM_st_init_SM1 :
      if (tr_1_guard_init_SM1) {
        ...
        SM1_fired_strong_partial = _150_SSM_TR_no_trans_SM1;
      }
  ...
  outC_MA_Request_Supervision_TA_MA_Request *outC)
{
  ...
  outC->_L24.v_main = kcg_lit_int64(0);
  outC->_L24.v_loa = kcg_lit_int64(0);
  outC->_L24.t_loa_unlimited = kcg_true;
  outC->_L24.t_loa = kcg_lit_int64(0);
  outC->_L24.n_iter = kcg_lit_int64(0);
  for (idx = 0; idx < 10; idx++) {
    outC->_L24.sections[idx].valid = kcg_true;
    outC->_L24.sections[idx].q_endsection = kcg_true;
    outC->_L24.sections[idx].l_section = kcg_lit_int64(0);
    outC->_L24.sections[idx].q_sectiontimer = kcg_true;
    outC->_L24.sections[idx].t_sectiontimer = kcg_lit_int64(0);
    outC->_L24.sections[idx].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->_L24.q_dangerpoint = kcg_true;
  outC->_L24.dangerpoint.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L24.dangerpoint.v_release = kcg_lit_int64(0);
  outC->_L24.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->_L24.q_overlap = kcg_true;
  outC->_L24.overlap.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L24.overlap.v_release = kcg_lit_int64(0);
  outC->_L24.overlap.calc_v_release_onboard = kcg_true;
  outC->_L24.q_endtimer = kcg_true;
  outC->_L24.endtimer_t.t_endtimer = kcg_lit_int64(0);
  outC->_L24.endtimer_t.d_endtimerstoploc = kcg_lit_int64(0);
  outC->_L23 = kcg_true;
  outC->_L22 = kcg_true;
  outC->_L9.valid = kcg_true;
  outC->_L9.timestamp = kcg_lit_int64(0);
  outC->_L9.odo.o_nominal = kcg_lit_int64(0);
  outC->_L9.odo.o_min = kcg_lit_int64(0);
  outC->_L9.odo.o_max = kcg_lit_int64(0);
  outC->_L9.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L9.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L9.speed.v_lower = kcg_lit_int64(0);
  outC->_L9.speed.v_upper = kcg_lit_int64(0);
  outC->_L9.acceleration = kcg_lit_int64(0);
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int64(0);
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx1].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int64(0);
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx1].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx2 = 0; idx2 < 33; idx2++) {
    ...
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx2].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx2].d_link = kcg_lit_int64(0);
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx2].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx2].nid_c = kcg_lit_int64(0);
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx2].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx2].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx2].q_locacc = kcg_lit_int64(0);
  }
  ...
  outC->SM1_fired = _150_SSM_TR_no_trans_SM1;
  outC->SM1_fired_strong = _150_SSM_TR_no_trans_SM1;
...
void kcg_save_SV_MA_Request_Supervision_TA_MA_Request(
  SV_MA_Request_Supervision_TA_MA_Request *SV,
  outC_MA_Request_Supervision_TA_MA_Request *outC)
{
  kcg_save_SV_op_3_8_2_3_a_TA_MA_Request(
    &SV->Context_op_3_8_2_3_a,
    &outC->Context_op_3_8_2_3_a);
  kcg_save_SV_op_RepeatReq_TA_MA_Request(
    &SV->Context_op_RepeatReq_1,
    &outC->Context_op_RepeatReq_1);
  ...
  SV->Context_pendingReq = outC->pendingReq;
  ...
  SV->Context_mem_in_triggerMA = outC->mem_in_triggerMA;
}

void kcg_load_SV_MA_Request_Supervision_TA_MA_Request(
  outC_MA_Request_Supervision_TA_MA_Request *outC,
  SV_MA_Request_Supervision_TA_MA_Request *SV)
{
  kcg_load_SV_op_3_8_2_3_a_TA_MA_Request(
    &outC->Context_op_3_8_2_3_a,
    &SV->Context_op_3_8_2_3_a);
  kcg_load_SV_op_RepeatReq_TA_MA_Request(
    &outC->Context_op_RepeatReq_1,
    &SV->Context_op_RepeatReq_1);
  ...
  outC->pendingReq = SV->Context_pendingReq;
  ...
  outC->mem_in_triggerMA = SV->Context_mem_in_triggerMA;
}
