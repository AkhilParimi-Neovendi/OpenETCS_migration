...
void Read_P057_init_TM(outC_Read_P057_TM *outC)
{
  ...
  outC->_L166.t_mar = kcg_lit_int32(0);
  outC->_L166.t_timeoutrqst = kcg_lit_int32(0);
  outC->_L166.t_cycrqst = kcg_lit_int32(0);
  ...
  outC->P057_OBU_out.t_mar = kcg_lit_int32(0);
  outC->P057_OBU_out.t_timeoutrqst = kcg_lit_int32(0);
  outC->P057_OBU_out.t_cycrqst = kcg_lit_int32(0);
