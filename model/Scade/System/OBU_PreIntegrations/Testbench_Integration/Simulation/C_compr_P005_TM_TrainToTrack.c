  ...
  outC_C_compr_P005_TM_TrainToTrack *outC)
{
  ...
  /* _L71=(TM_conversions::CAST_Int_to_NID_OPERATIONAL#1)/ */
  CAST_Int_to_NID_OPERATIONAL_TM_conversions(
    outC->_L76,
    &outC->Context_CAST_Int_to_NID_OPERATIONAL_1);
  outC->_L71 = outC->Context_CAST_Int_to_NID_OPERATIONAL_1.nid_operational;
...
void C_compr_P005_init_TM_TrainToTrack(outC_C_compr_P005_TM_TrainToTrack *outC)
{
  static kcg_size idx;
  ...
  outC->_L72.nid_opeartional = kcg_lit_int32(0);
  ...
  outC->P005_out.valid = kcg_true;
  outC->P005_out.nid_packet = kcg_lit_int32(0);
  outC->P005_out.l_packet = kcg_lit_int32(0);
  outC->P005_out.nid_opeartional = kcg_lit_int32(0);
  /* _L71=(TM_conversions::CAST_Int_to_NID_OPERATIONAL#1)/ */
