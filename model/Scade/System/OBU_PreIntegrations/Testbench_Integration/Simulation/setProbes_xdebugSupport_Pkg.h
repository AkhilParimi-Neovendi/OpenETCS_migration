...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  NID_BG /* lastBGID/ */ Context_lastBGID;
  NID_MESSAGE /* lastMsgID/ */ Context_lastMsgID;
  NID_BG /* bgID/ */ Context_bgID;
  NID_MESSAGE /* msgID/ */ Context_msgID;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
} SV_setProbes_xdebugSupport_Pkg;

extern void kcg_save_SV_setProbes_xdebugSupport_Pkg(
  SV_setProbes_xdebugSupport_Pkg *SV,
  outC_setProbes_xdebugSupport_Pkg *outC);
extern void kcg_load_SV_setProbes_xdebugSupport_Pkg(
  outC_setProbes_xdebugSupport_Pkg *outC,
  SV_setProbes_xdebugSupport_Pkg *SV);
