  ...
  outC_FlashingOperator_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  switch (outC->SM1_state_act) {
    case _165_SSM_st_start_SM1 :
      ...
      outC->_L26_start_SM1 = kcg_lit_int32(0);
      outC->_L22_start_SM1 = kcg_lit_int32(1);
      ...
      outC->_L19_start_SM1 = kcg_lit_int32(20);
  ...
  outC_FlashingOperator_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  outC->_L17_start_SM1 = kcg_lit_int32(0);
  ...
  outC->_L22_start_SM1 = kcg_lit_int32(0);
  outC->_L23_start_SM1 = kcg_lit_int32(0);
