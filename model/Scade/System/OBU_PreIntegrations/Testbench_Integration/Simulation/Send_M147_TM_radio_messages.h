...
} SV_Send_M147_TM_radio_messages;

extern void kcg_save_SV_Send_M147_TM_radio_messages(
  SV_Send_M147_TM_radio_messages *SV,
  outC_Send_M147_TM_radio_messages *outC);
extern void kcg_load_SV_Send_M147_TM_radio_messages(
  outC_Send_M147_TM_radio_messages *outC,
  SV_Send_M147_TM_radio_messages *SV);
