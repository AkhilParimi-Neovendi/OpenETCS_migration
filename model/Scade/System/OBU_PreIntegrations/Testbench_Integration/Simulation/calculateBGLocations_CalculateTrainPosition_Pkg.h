...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_genPassedBG_SeqNo_CalculateTrainPosition_Pkg Context_genPassedBG_SeqNo_2;
} SV_calculateBGLocations_CalculateTrainPosition_Pkg;

extern void kcg_save_SV_calculateBGLocations_CalculateTrainPosition_Pkg(
  SV_calculateBGLocations_CalculateTrainPosition_Pkg *SV,
  outC_calculateBGLocations_CalculateTrainPosition_Pkg *outC);
extern void kcg_load_SV_calculateBGLocations_CalculateTrainPosition_Pkg(
  outC_calculateBGLocations_CalculateTrainPosition_Pkg *outC,
  SV_calculateBGLocations_CalculateTrainPosition_Pkg *SV);
