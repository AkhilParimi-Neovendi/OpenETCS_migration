...
extern void C_DMI_Train_Running_Number_to_int_DATA_Packets_Bothways(
  ...
  outC_C_DMI_Train_Running_Number_to_int_DATA_Packets_Bothways *outC);

#ifndef KCG_NO_EXTERN_CALL_TO_RESET
extern void C_DMI_Train_Running_Number_to_int_reset_DATA_Packets_Bothways(
  outC_C_DMI_Train_Running_Number_to_int_DATA_Packets_Bothways *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void C_DMI_Train_Running_Number_to_int_init_DATA_Packets_Bothways(
  outC_C_DMI_Train_Running_Number_to_int_DATA_Packets_Bothways *outC);
