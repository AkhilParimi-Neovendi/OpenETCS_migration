  ...
  outC_AGradient_SDM_GradientAcceleration_Pkg *outC)
{
  ...
  for (idx = 0; idx < 110; idx++) {
    ...
    outC->_L29.MRSP_targetList[idx].distance = kcg_lit_float64(0.0);
    outC->_L29.MRSP_targetList[idx].speed = kcg_lit_float64(0.0);
  }
  outC->_L29.EOA_target.targetType = EoA_TargetManagement_types;
  outC->_L29.EOA_target.distance = kcg_lit_float64(0.0);
  outC->_L29.EOA_target.speed = kcg_lit_float64(0.0);
  outC->_L29.SvL_LoA_target.targetType = EoA_TargetManagement_types;
  outC->_L29.SvL_LoA_target.distance = kcg_lit_float64(0.0);
  outC->_L29.SvL_LoA_target.speed = kcg_lit_float64(0.0);
  ...
  for (idx1 = 0; idx1 < 110; idx1++) {
    ...
    outC->_L27.MRSP_targetList[idx1].distance = kcg_lit_float64(0.0);
    outC->_L27.MRSP_targetList[idx1].speed = kcg_lit_float64(0.0);
  }
  outC->_L27.EOA_target.targetType = EoA_TargetManagement_types;
  outC->_L27.EOA_target.distance = kcg_lit_float64(0.0);
  outC->_L27.EOA_target.speed = kcg_lit_float64(0.0);
  outC->_L27.SvL_LoA_target.targetType = EoA_TargetManagement_types;
  outC->_L27.SvL_LoA_target.distance = kcg_lit_float64(0.0);
  outC->_L27.SvL_LoA_target.speed = kcg_lit_float64(0.0);
  outC->_L26.targetType = EoA_TargetManagement_types;
  outC->_L26.distance = kcg_lit_float64(0.0);
  outC->_L26.speed = kcg_lit_float64(0.0);
  outC->_L24.targetType = EoA_TargetManagement_types;
  outC->_L24.distance = kcg_lit_float64(0.0);
  outC->_L24.speed = kcg_lit_float64(0.0);
  outC->_L25 = kcg_true;
  outC->_L23 = kcg_lit_float64(0.0);
  outC->_L22 = EoA_TargetManagement_types;
  outC->_L21 = kcg_true;
  for (idx2 = 0; idx2 < 100; idx2++) {
    outC->_L20[idx2].position = kcg_lit_float64(0.0);
    outC->_L20[idx2].gradient_acceleration = kcg_lit_float64(0.0);
    outC->_L20[idx2].valid = kcg_true;
  }
  outC->_L19 = kcg_true;
  outC->_L18 = kcg_lit_float64(0.0);
  outC->_L17.position = kcg_lit_float64(0.0);
  outC->_L17.gradient_acceleration = kcg_lit_float64(0.0);
  ...
  for (idx3 = 0; idx3 < 110; idx3++) {
    ...
    outC->_L10.MRSP_targetList[idx3].distance = kcg_lit_float64(0.0);
    outC->_L10.MRSP_targetList[idx3].speed = kcg_lit_float64(0.0);
  }
  outC->_L10.EOA_target.targetType = EoA_TargetManagement_types;
  outC->_L10.EOA_target.distance = kcg_lit_float64(0.0);
  outC->_L10.EOA_target.speed = kcg_lit_float64(0.0);
  outC->_L10.SvL_LoA_target.targetType = EoA_TargetManagement_types;
  outC->_L10.SvL_LoA_target.distance = kcg_lit_float64(0.0);
  outC->_L10.SvL_LoA_target.speed = kcg_lit_float64(0.0);
  ...
  for (idx4 = 0; idx4 < 5; idx4++) {
    outC->_L4.nationSystems[idx4] = kcg_lit_int64(0);
  }
  outC->_L4.numberTractionSystems = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 4; idx5++) {
    outC->_L4.tractionSystem[idx5].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L4.tractionSystem[idx5].nid_ctraction = kcg_lit_int64(0);
  }
  for (idx6 = 0; idx6 < 50; idx6++) {
    outC->_L3[idx6].location = kcg_lit_float64(0.0);
    outC->_L3[idx6].gradient = kcg_lit_float64(0.0);
    outC->_L3[idx6].valid = kcg_true;
  }
  outC->_L2.trainPositionIsValid = kcg_true;
  outC->_L2.d_est_frontendPos = kcg_lit_float64(0.0);
  outC->_L2.d_minSafeFrontEndPos = kcg_lit_float64(0.0);
  outC->_L2.d_maxSafeFrontEndPos = kcg_lit_float64(0.0);
  outC->_L2.d_LRBG = kcg_lit_float64(0.0);
  outC->_L2.d_accLRBG = kcg_lit_float64(0.0);
  outC->every = kcg_true;
  for (idx7 = 0; idx7 < 100; idx7++) {
    outC->_L1[idx7].position = kcg_lit_float64(0.0);
    outC->_L1[idx7].gradient_acceleration = kcg_lit_float64(0.0);
    outC->_L1[idx7].valid = kcg_true;
  }
  outC->init = kcg_true;
  for (idx8 = 0; idx8 < 100; idx8++) {
    outC->A_gradient[idx8].position = kcg_lit_float64(0.0);
    outC->A_gradient[idx8].gradient_acceleration = kcg_lit_float64(0.0);
...
void kcg_save_SV_AGradient_SDM_GradientAcceleration_Pkg(
  SV_AGradient_SDM_GradientAcceleration_Pkg *SV,
  outC_AGradient_SDM_GradientAcceleration_Pkg *outC)
{
  kcg_copy_A_gradient_t_SDM_GradientAcceleration_types(
    &SV->Context__L1,
...
void kcg_load_SV_AGradient_SDM_GradientAcceleration_Pkg(
  outC_AGradient_SDM_GradientAcceleration_Pkg *outC,
  SV_AGradient_SDM_GradientAcceleration_Pkg *SV)
{
  kcg_copy_A_gradient_t_SDM_GradientAcceleration_types(
