...
typedef struct {
  ...
  kcg_bool /* IfBlock1:else:handOver_with_1_Session_SM:WaitForHandingOverRBCTerminated:sessionWithHandingOverRBC_terminated/ */ sessionWithHandingOverRBC_terminated_WaitForHandingOverRBCTerminated_handOver_with_1_Session_SM_else_IfBlock1;
  ...
  kcg_bool /* IfBlock1:else:handOver_with_1_Session_SM:WaitForTerminationOrderFromHandingOverRBC:terminationWithHandingOverRBCOrdered/ */ terminationWithHandingOverRBCOrdered_WaitForTerminationOrderFromHandingOverRBC_handOver_with_1_Session_SM_else_IfBlock1;
  ...
  kcg_bool /* IfBlock1:else:handOver_with_1_Session_SM:WaitForSessionWithAcceptingRBCEstablished:sessionWithAcceptingRBCEstablished/ */ sessionWithAcceptingRBCEstablished_WaitForSessionWithAcceptingRBCEstablished_handOver_with_1_Session_SM_else_IfBlock1;
...
typedef struct {
  /* ----------------------  memorised outputs  ---------------------- */
  kcg_bool /* handoverFinished/ */ Context_handoverFinished;
  /* ----------------------- local memories  ------------------------- */
  SSM_ST_handOver_with_1_Session_SM_else_IfBlock1 /* IfBlock1:else:handOver_with_1_Session_SM: */ Context_handOver_with_1_Session_SM_state_nxt;
  kcg_bool /* IfBlock1:else:handOver_with_1_Session_SM: */ Context_handOver_with_1_Session_SM_reset_act;
  kcg_bool /* IfBlock1:else:handOver_with_1_Session_SM: */ Context_handOver_with_1_Session_SM_reset_nxt;
  msgFromTrack_T_RCM_MsgTypes_Pkg /* IfBlock1:else:p131_transitionOrder_loc/ */ Context_p131_transitionOrder_loc;
  msgFromTrack_T_RCM_MsgTypes_Pkg /* IfBlock1:else:p45_radioNetworkRegistrationOrder_2_handingOverRBC_loc/ */ _3_Context_p45_radioNetworkRegistrationOrder_2_handingOverRBC_loc;
  SSM_ST_handOver_with_2_Sessions_SM_then_IfBlock1 /* IfBlock1:then:handOver_with_2_Sessions_SM: */ Context_handOver_with_2_Sessions_SM_state_nxt;
  kcg_bool /* IfBlock1:then:handOver_with_2_Sessions_SM: */ Context_handOver_with_2_Sessions_SM_reset_act;
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_RisingEdge_digital Context_RisingEdge_5;
  SV_RisingEdge_digital Context_RisingEdge_8;
  SV_RisingEdge_digital Context_RisingEdge_26;
  SV_RisingEdge_digital Context_RisingEdge_28;
  SV_RisingEdge_digital Context_RisingEdge_9;
  SV_RisingEdge_digital Context_RisingEdge_4;
} SV_handOverSequencer_Handover_Pkg_handoverUtils_Pkg;

extern void kcg_save_SV_handOverSequencer_Handover_Pkg_handoverUtils_Pkg(
  SV_handOverSequencer_Handover_Pkg_handoverUtils_Pkg *SV,
  outC_handOverSequencer_Handover_Pkg_handoverUtils_Pkg *outC);
extern void kcg_load_SV_handOverSequencer_Handover_Pkg_handoverUtils_Pkg(
  outC_handOverSequencer_Handover_Pkg_handoverUtils_Pkg *outC,
  SV_handOverSequencer_Handover_Pkg_handoverUtils_Pkg *SV);
