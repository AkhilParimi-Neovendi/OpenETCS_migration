...
{
  /* new_menuRequest/ */
  static DMI_Menu_Request_T_DMI_Messages_EVC_to_DMI_Pkg new_menuRequest_partial;
  /* sendTrainDataToDMI/ */
  static kcg_bool sendTrainDataToDMI_partial;
  /* outLevelsNeeded/ */
  static kcg_bool outLevelsNeeded_partial;
  /* new_menuRequest/ */
  static DMI_Menu_Request_T_DMI_Messages_EVC_to_DMI_Pkg _1_new_menuRequest_partial;
  /* sendTrainDataToDMI/ */
  static kcg_bool _2_sendTrainDataToDMI_partial;
  /* outLevelsNeeded/ */
  static kcg_bool _3_outLevelsNeeded_partial;
