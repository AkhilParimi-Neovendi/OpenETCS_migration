...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_countUp_CalculateTrainPosition_Pkg_gp_functions_Pkg Context_countUp_1;
} SV_genPassedBG_SeqNo_CalculateTrainPosition_Pkg;

extern void kcg_save_SV_genPassedBG_SeqNo_CalculateTrainPosition_Pkg(
  SV_genPassedBG_SeqNo_CalculateTrainPosition_Pkg *SV,
  outC_genPassedBG_SeqNo_CalculateTrainPosition_Pkg *outC);
extern void kcg_load_SV_genPassedBG_SeqNo_CalculateTrainPosition_Pkg(
  outC_genPassedBG_SeqNo_CalculateTrainPosition_Pkg *outC,
  SV_genPassedBG_SeqNo_CalculateTrainPosition_Pkg *SV);
