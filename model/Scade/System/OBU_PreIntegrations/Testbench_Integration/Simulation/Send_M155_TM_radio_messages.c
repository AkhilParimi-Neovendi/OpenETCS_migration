  ...
  outC_Send_M155_TM_radio_messages *outC)
{
  ...
  kcg_copy_M_155_T_TM_radio_messages(&outC->_L2, Message_155_in);
  /* _L1=(TM_RBC_conversions::C_M155_to_header#1)/ */
  C_M155_to_header_TM_RBC_conversions(
    &outC->_L2,
    &outC->Context_C_M155_to_header_1);
  kcg_copy_M_TrainTrack_MessageHd_T_TM_radio_messages(
    &outC->_L1,
    &outC->Context_C_M155_to_header_1.Message_Header_Out);
  /* _L9=(TM_TrainToTrack::Merge_PacketsToMessage#1)/ */
  ...
  CheckSpace_TM_TrainTrack_Bus(&outC->_L13, &outC->Context_CheckSpace_1);
  outC->_L16 = outC->Context_CheckSpace_1.Busy;
  outC->_L17 = outC->Context_CheckSpace_1.SlotsUsed;
  outC->_L18 = !outC->_L16;
  /* _L12=(TM_lib_internal::BufferMsg#1)/ */
  BufferMsg_TM_lib_internal(&outC->_L9, outC->_L18, &outC->Context_BufferMsg_1);
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
    &outC->_L12,
...
void Send_M155_init_TM_radio_messages(outC_Send_M155_TM_radio_messages *outC)
{
  ...
  for (idx = 0; idx < 50; idx++) {
    outC->_L12.OptionalPackets[idx] = kcg_lit_int64(0);
  }
  ...
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L11[idx3].Message.valid = kcg_true;
    outC->_L11[idx3].Message.nid_message = kcg_lit_int64(0);
    outC->_L11[idx3].Message.l_message = kcg_lit_int64(0);
    outC->_L11[idx3].Message.t_train = kcg_lit_int64(0);
    outC->_L11[idx3].Message.nid_engine = kcg_lit_int64(0);
    outC->_L11[idx3].Message.field1 = kcg_lit_int64(0);
    outC->_L11[idx3].Message.field2 = kcg_lit_int64(0);
    outC->_L11[idx3].Message.field3 = kcg_lit_int64(0);
    for (idx2 = 0; idx2 < 50; idx2++) {
      outC->_L11[idx3].OptionalPackets[idx2] = kcg_lit_int64(0);
    }
  }
  ...
  Merge_PacketsToMessage_init_TM_TrainToTrack(
    &outC->Context_Merge_PacketsToMessage_1);
  /* _L1=(TM_RBC_conversions::C_M155_to_header#1)/ */
  C_M155_to_header_init_TM_RBC_conversions(&outC->Context_C_M155_to_header_1);
}
...
void Send_M155_reset_TM_radio_messages(outC_Send_M155_TM_radio_messages *outC)
{
  ...
  Merge_PacketsToMessage_reset_TM_TrainToTrack(
    &outC->Context_Merge_PacketsToMessage_1);
  /* _L1=(TM_RBC_conversions::C_M155_to_header#1)/ */
  C_M155_to_header_reset_TM_RBC_conversions(&outC->Context_C_M155_to_header_1);
}
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */


void kcg_save_SV_Send_M155_TM_radio_messages(
  SV_Send_M155_TM_radio_messages *SV,
  outC_Send_M155_TM_radio_messages *outC)
{
...
void kcg_load_SV_Send_M155_TM_radio_messages(
  outC_Send_M155_TM_radio_messages *outC,
  SV_Send_M155_TM_radio_messages *SV)
{
