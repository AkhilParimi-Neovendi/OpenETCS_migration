...
typedef struct {
  ...
  DMI_Track_Description_T_DMI_Messages_EVC_to_DMI_Pkg /* _L49/ */ _L49;
  ...
  DMI_Driver_Identifier_T_DMI_Messages_Bothways_Pkg /* _L68/ */ _L68;
...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  dmiOutputs_T_manage_DMI_Output_Pkg /* outputStatus/ */ Context_outputStatus;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
} SV_collectDMIPackets_manage_DMI_Output_Pkg;

extern void kcg_save_SV_collectDMIPackets_manage_DMI_Output_Pkg(
  SV_collectDMIPackets_manage_DMI_Output_Pkg *SV,
  outC_collectDMIPackets_manage_DMI_Output_Pkg *outC);
extern void kcg_load_SV_collectDMIPackets_manage_DMI_Output_Pkg(
  outC_collectDMIPackets_manage_DMI_Output_Pkg *outC,
  SV_collectDMIPackets_manage_DMI_Output_Pkg *SV);
