...
void kcg_save_SV_detectEvokeBrake_input_from_TIU_API_Pkg(
  SV_detectEvokeBrake_input_from_TIU_API_Pkg *SV,
  outC_detectEvokeBrake_input_from_TIU_API_Pkg *outC)
{
  SV->Context_EB_RevokedByDriver = outC->EB_RevokedByDriver;
  SV->Context_brake_Management_reset_nxt = outC->brake_Management_reset_nxt;
  SV->Context_brake_Management_reset_act = outC->brake_Management_reset_act;
  SV->Context_brake_Management_state_nxt = outC->brake_Management_state_nxt;
}

void kcg_load_SV_detectEvokeBrake_input_from_TIU_API_Pkg(
  outC_detectEvokeBrake_input_from_TIU_API_Pkg *outC,
  SV_detectEvokeBrake_input_from_TIU_API_Pkg *SV)
{
  outC->EB_RevokedByDriver = SV->Context_EB_RevokedByDriver;
  outC->brake_Management_reset_nxt = SV->Context_brake_Management_reset_nxt;
  outC->brake_Management_reset_act = SV->Context_brake_Management_reset_act;
  outC->brake_Management_state_nxt = SV->Context_brake_Management_state_nxt;
}
