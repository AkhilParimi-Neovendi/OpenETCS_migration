  ...
  outC_twoConsecutiveLinkedBGs_missed_CalculateTrainPosition_Pkg_Linking_Pkg *outC)
{
  ...
  for (idx = 0; idx < 33; idx++) {
    ...
    outC->_L12.infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L12.infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int64(0);
    outC->_L12.infoFromPassing.linkedBGs[idx].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L12.infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int64(0);
    outC->_L12.infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int64(0);
    outC->_L12.infoFromPassing.linkedBGs[idx].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L12.infoFromPassing.linkedBGs[idx].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L12.infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L10.infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L10.infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int64(0);
    outC->_L10.infoFromPassing.linkedBGs[idx1].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L10.infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int64(0);
    outC->_L10.infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int64(0);
    outC->_L10.infoFromPassing.linkedBGs[idx1].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L10.infoFromPassing.linkedBGs[idx1].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L10.infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx3 = 0; idx3 < 33; idx3++) {
    ...
    outC->_L4.infoFromPassing.linkedBGs[idx3].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L4.infoFromPassing.linkedBGs[idx3].d_link = kcg_lit_int64(0);
    outC->_L4.infoFromPassing.linkedBGs[idx3].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L4.infoFromPassing.linkedBGs[idx3].nid_c = kcg_lit_int64(0);
    outC->_L4.infoFromPassing.linkedBGs[idx3].nid_bg = kcg_lit_int64(0);
    outC->_L4.infoFromPassing.linkedBGs[idx3].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L4.infoFromPassing.linkedBGs[idx3].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L4.infoFromPassing.linkedBGs[idx3].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx4 = 0; idx4 < 33; idx4++) {
    ...
    outC->_L2.infoFromPassing.linkedBGs[idx4].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L2.infoFromPassing.linkedBGs[idx4].d_link = kcg_lit_int64(0);
    outC->_L2.infoFromPassing.linkedBGs[idx4].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L2.infoFromPassing.linkedBGs[idx4].nid_c = kcg_lit_int64(0);
    outC->_L2.infoFromPassing.linkedBGs[idx4].nid_bg = kcg_lit_int64(0);
    outC->_L2.infoFromPassing.linkedBGs[idx4].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L2.infoFromPassing.linkedBGs[idx4].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L2.infoFromPassing.linkedBGs[idx4].q_locacc = kcg_lit_int64(0);
  }
...
void kcg_save_SV_twoConsecutiveLinkedBGs_missed_CalculateTrainPosition_Pkg_Linking_Pkg(
  SV_twoConsecutiveLinkedBGs_missed_CalculateTrainPosition_Pkg_Linking_Pkg *SV,
  outC_twoConsecutiveLinkedBGs_missed_CalculateTrainPosition_Pkg_Linking_Pkg *outC)
{
  kcg_copy_positionedBG_T_TrainPosition_Types_Pck(
    &SV->Context_storedMissedBG,
    &outC->storedMissedBG);
  kcg_copy_positionedBG_T_TrainPosition_Types_Pck(
...
void kcg_load_SV_twoConsecutiveLinkedBGs_missed_CalculateTrainPosition_Pkg_Linking_Pkg(
  outC_twoConsecutiveLinkedBGs_missed_CalculateTrainPosition_Pkg_Linking_Pkg *outC,
  SV_twoConsecutiveLinkedBGs_missed_CalculateTrainPosition_Pkg_Linking_Pkg *SV)
{
  kcg_copy_positionedBG_T_TrainPosition_Types_Pck(
