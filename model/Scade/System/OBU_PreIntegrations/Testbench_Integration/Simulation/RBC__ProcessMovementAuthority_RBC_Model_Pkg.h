...
typedef struct {
  ...
  kcg_bool /* MOVEMENT_AUTHORITY_SM: */ Context_MOVEMENT_AUTHORITY_SM_reset_nxt;
  kcg_bool /* MOVEMENT_AUTHORITY_SM: */ Context_MOVEMENT_AUTHORITY_SM_reset_act;
  SSM_ST_MOVEMENT_AUTHORITY_SM /* MOVEMENT_AUTHORITY_SM: */ Context_MOVEMENT_AUTHORITY_SM_state_nxt;
  kcg_bool /* validAcknowledgement/ */ Context_validAcknowledgement;
  kcg_bool /* invalidAcknowledgement/ */ Context_invalidAcknowledgement;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
} SV_RBC__ProcessMovementAuthority_RBC_Model_Pkg;

extern void kcg_save_SV_RBC__ProcessMovementAuthority_RBC_Model_Pkg(
  SV_RBC__ProcessMovementAuthority_RBC_Model_Pkg *SV,
  outC_RBC__ProcessMovementAuthority_RBC_Model_Pkg *outC);
extern void kcg_load_SV_RBC__ProcessMovementAuthority_RBC_Model_Pkg(
  outC_RBC__ProcessMovementAuthority_RBC_Model_Pkg *outC,
  SV_RBC__ProcessMovementAuthority_RBC_Model_Pkg *SV);
