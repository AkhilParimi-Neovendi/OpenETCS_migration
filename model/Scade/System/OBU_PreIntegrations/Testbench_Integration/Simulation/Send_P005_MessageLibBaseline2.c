  ...
  outC_Send_P005_MessageLibBaseline2 *outC)
{
  ...
  outC->_L4.Q_NEWCOUNTRY = kcg_lit_int32(0);
  outC->_L4.NID_C = kcg_lit_int32(0);
  outC->_L4.NID_BG = kcg_lit_int32(0);
  outC->_L4.Q_LINKORIENTATION = kcg_lit_int32(0);
  outC->_L4.Q_LINKREACTION = kcg_lit_int32(0);
  outC->_L4.Q_LOCACC = kcg_lit_int32(0);
  outC->_L4.N_ITER = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L4.SECTIONS[idx2].D_LINK = kcg_lit_int32(0);
    outC->_L4.SECTIONS[idx2].Q_NEWCOUNTRY = kcg_lit_int32(0);
    outC->_L4.SECTIONS[idx2].NID_C = kcg_lit_int32(0);
    outC->_L4.SECTIONS[idx2].NID_BG = kcg_lit_int32(0);
    outC->_L4.SECTIONS[idx2].Q_LINKORIENTATION = kcg_lit_int32(0);
    outC->_L4.SECTIONS[idx2].Q_LINKREACTION = kcg_lit_int32(0);
    outC->_L4.SECTIONS[idx2].Q_LOCACC = kcg_lit_int32(0);
  }
