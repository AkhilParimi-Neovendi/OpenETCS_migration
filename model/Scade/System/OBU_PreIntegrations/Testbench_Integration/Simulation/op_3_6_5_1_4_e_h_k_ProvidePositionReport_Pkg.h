...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  RBC_Communication_T_ProvidePositionReport_Pkg /* rbcComm/ */ Context_mem_rbcComm;
  LocationBasedEvents_T_ProvidePositionReport_Pkg /* trackInfo/ */ Context_mem_trackInfo;
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
} SV_op_3_6_5_1_4_e_h_k_ProvidePositionReport_Pkg;

extern void kcg_save_SV_op_3_6_5_1_4_e_h_k_ProvidePositionReport_Pkg(
  SV_op_3_6_5_1_4_e_h_k_ProvidePositionReport_Pkg *SV,
  outC_op_3_6_5_1_4_e_h_k_ProvidePositionReport_Pkg *outC);
extern void kcg_load_SV_op_3_6_5_1_4_e_h_k_ProvidePositionReport_Pkg(
  outC_op_3_6_5_1_4_e_h_k_ProvidePositionReport_Pkg *outC,
  SV_op_3_6_5_1_4_e_h_k_ProvidePositionReport_Pkg *SV);
