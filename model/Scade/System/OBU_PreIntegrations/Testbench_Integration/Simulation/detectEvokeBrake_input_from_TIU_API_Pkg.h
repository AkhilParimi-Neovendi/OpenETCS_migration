...
typedef struct {
  /* ----------------------  memorised outputs  ---------------------- */
  kcg_bool /* EB_RevokedByDriver/ */ Context_EB_RevokedByDriver;
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* brake_Management: */ Context_brake_Management_reset_nxt;
  kcg_bool /* brake_Management: */ Context_brake_Management_reset_act;
  SSM_ST_brake_Management /* brake_Management: */ Context_brake_Management_state_nxt;
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
} SV_detectEvokeBrake_input_from_TIU_API_Pkg;

extern void kcg_save_SV_detectEvokeBrake_input_from_TIU_API_Pkg(
  SV_detectEvokeBrake_input_from_TIU_API_Pkg *SV,
  outC_detectEvokeBrake_input_from_TIU_API_Pkg *outC);
extern void kcg_load_SV_detectEvokeBrake_input_from_TIU_API_Pkg(
  outC_detectEvokeBrake_input_from_TIU_API_Pkg *outC,
  SV_detectEvokeBrake_input_from_TIU_API_Pkg *SV);
