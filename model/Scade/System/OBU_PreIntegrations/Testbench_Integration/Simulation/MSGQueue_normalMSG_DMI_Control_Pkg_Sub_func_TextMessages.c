...
{
  /* queue/ */
  static _94_array queue_partial;
  /* mm_array/ */
  static array_float32_10 mm_array_partial;
  /* hh_array/ */
  static array_float32_10 hh_array_partial;
  /* CountCommand/ */
  static kcg_int32 CountCommand_partial;
  /* CountCommand_imp/ */
  static kcg_int32 CountCommand_imp_partial;
  /* CountCommand_auxi/ */
  static kcg_int32 CountCommand_auxi_partial;
  /* impQueue/ */
  static _94_array impQueue_partial;
  /* auxiQueue/ */
  static _94_array auxiQueue_partial;
  /* Local_mm_array_imp/ */
  static array_float32_10 Local_mm_array_imp_partial;
  /* Local_hh_array_imp/ */
  static array_float32_10 Local_hh_array_imp_partial;
  /* Local_hh_array_auxi/ */
  static array_float32_10 Local_hh_array_auxi_partial;
  /* Local_mm_array_auxi/ */
  static array_float32_10 Local_mm_array_auxi_partial;
  /* Local_mm_array_auxi/ */
  static array_float32_10 _1_Local_mm_array_auxi_partial;
  /* Local_hh_array_auxi/ */
  static array_float32_10 _2_Local_hh_array_auxi_partial;
  /* Local_hh_array_imp/ */
  static array_float32_10 _3_Local_hh_array_imp_partial;
  /* Local_mm_array_imp/ */
  static array_float32_10 _4_Local_mm_array_imp_partial;
  /* auxiQueue/ */
  static _94_array _5_auxiQueue_partial;
  /* impQueue/ */
  static _94_array _6_impQueue_partial;
  /* CountCommand_auxi/ */
  static kcg_int32 _7_CountCommand_auxi_partial;
  /* CountCommand_imp/ */
  static kcg_int32 _8_CountCommand_imp_partial;
  /* Local_mm_array_auxi/ */
  static array_float32_10 _9_Local_mm_array_auxi_partial;
  /* Local_hh_array_auxi/ */
  static array_float32_10 _10_Local_hh_array_auxi_partial;
  /* Local_hh_array_imp/ */
  static array_float32_10 _11_Local_hh_array_imp_partial;
  /* Local_mm_array_imp/ */
  static array_float32_10 _12_Local_mm_array_imp_partial;
  /* auxiQueue/ */
  static _94_array _13_auxiQueue_partial;
  /* impQueue/ */
  static _94_array _14_impQueue_partial;
  /* CountCommand_auxi/ */
  static kcg_int32 _15_CountCommand_auxi_partial;
  /* CountCommand_imp/ */
  static kcg_int32 _16_CountCommand_imp_partial;
  /* queue/ */
  static _94_array _17_queue_partial;
  /* mm_array/ */
  static array_float32_10 _18_mm_array_partial;
  /* hh_array/ */
  static array_float32_10 _19_hh_array_partial;
  /* CountCommand/ */
  static kcg_int32 _20_CountCommand_partial;
  /* CountCommand_imp/ */
  static kcg_int32 _21_CountCommand_imp_partial;
  /* CountCommand_auxi/ */
  static kcg_int32 _22_CountCommand_auxi_partial;
  /* impQueue/ */
  static _94_array _23_impQueue_partial;
  /* auxiQueue/ */
  static _94_array _24_auxiQueue_partial;
  /* Local_mm_array_imp/ */
  static array_float32_10 _25_Local_mm_array_imp_partial;
  /* Local_hh_array_imp/ */
  static array_float32_10 _26_Local_hh_array_imp_partial;
  /* Local_hh_array_auxi/ */
  static array_float32_10 _27_Local_hh_array_auxi_partial;
  /* Local_mm_array_auxi/ */
  static array_float32_10 _28_Local_mm_array_auxi_partial;
  /* isFull/ */
  ...
  /* Local_mm_array_auxi/ */
  static array_float32_10 last_Local_mm_array_auxi;
  /* Local_hh_array_auxi/ */
  static array_float32_10 last_Local_hh_array_auxi;
  /* Local_hh_array_imp/ */
  static array_float32_10 last_Local_hh_array_imp;
  /* Local_mm_array_imp/ */
  static array_float32_10 last_Local_mm_array_imp;
  /* Local_hh/ */
  static kcg_float32 last_Local_hh;
  /* Local_mm/ */
  static kcg_float32 last_Local_mm;
  /* auxiQueue/ */
  static _94_array last_auxiQueue;
  /* impQueue/ */
  static _94_array last_impQueue;
  /* NumAuxi/ */
  static kcg_int32 last_NumAuxi;
  /* NumImp/ */
  static kcg_int32 last_NumImp;
  /* hh_array/ */
  static array_float32_10 last_hh_array;
  /* mm_array/ */
  static array_float32_10 last_mm_array;
  /* queue/ */
  static _94_array last_queue;
  /* isEmpty/ */
  ...
  kcg_copy_array_float32_10(&last_Local_hh_array_imp, &outC->Local_hh_array_imp);
  kcg_copy_array_float32_10(&last_Local_mm_array_imp, &outC->Local_mm_array_imp);
  last_Local_hh = outC->Local_hh;
  last_Local_mm = outC->Local_mm;
  kcg_copy__94_array(&last_auxiQueue, &outC->auxiQueue);
  kcg_copy__94_array(&last_impQueue, &outC->impQueue);
  ...
  kcg_copy__94_array(&last_queue, &outC->queue);
  ...
  if (outC->OperationQueue_IfBlock_clock) {
    ...
    if (outC->IfBlock1_clock_then_OperationQueue_IfBlock) {
      outC->_L9_then_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_int32(0);
      ...
      outC->_L8_else_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_int32(1);
    ...
    outC->_L2_else_OperationQueue_IfBlock = kcg_lit_int32(0);
  ...
  if (outC->OperationQueue_IfBlock_clock) {
    /* OperationQueue_IfBlock:then:IfBlock1: */
    if (outC->IfBlock1_clock_then_OperationQueue_IfBlock) {
      outC->_L2_then_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_int32(1);
      ...
      outC->_L1_else_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  ...
  if (outC->OperationQueue_IfBlock_clock) {
    /* OperationQueue_IfBlock:then:IfBlock1: */
    if (outC->IfBlock1_clock_then_OperationQueue_IfBlock) {
      outC->_L6_then_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_int32(1);
    ...
    if (outC->IfBlock1_clock_then_OperationQueue_IfBlock) {
      ...
      outC->_L3_else_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_int32(1);
    ...
    if (outC->IfBlock1_clock_then_OperationQueue_IfBlock) {
      kcg_copy__94_array(
        ...
        &outC->_L7_then_IfBlock1_then_OperationQueue_IfBlock);
      kcg_copy__94_array(&impQueue_partial, &_14_impQueue_partial);
    }
    else {
      kcg_copy__94_array(&_6_impQueue_partial, &last_impQueue);
      kcg_copy__94_array(&impQueue_partial, &_6_impQueue_partial);
    }
    kcg_copy__94_array(&outC->_L144_then_OperationQueue_IfBlock, &impQueue_partial);
    /* OperationQueue_IfBlock:then:IfBlock1: */
    if (outC->IfBlock1_clock_then_OperationQueue_IfBlock) {
      kcg_copy__94_array(&_13_auxiQueue_partial, &last_auxiQueue);
      kcg_copy__94_array(&auxiQueue_partial, &_13_auxiQueue_partial);
    }
    else {
      kcg_copy__94_array(
        &_5_auxiQueue_partial,
        &outC->_L2_else_IfBlock1_then_OperationQueue_IfBlock);
      kcg_copy__94_array(&auxiQueue_partial, &_5_auxiQueue_partial);
    }
    kcg_copy__94_array(
    ...
    kcg_copy__94_array(&queue_partial, &outC->_L142_then_OperationQueue_IfBlock);
    outC->_L52_then_OperationQueue_IfBlock = kcg_lit_int32(1);
    CountCommand_partial = outC->_L52_then_OperationQueue_IfBlock;
    kcg_copy__94_array(&outC->queue, &queue_partial);
    ...
    kcg_copy__94_array(&outC->impQueue, &impQueue_partial);
    kcg_copy__94_array(&outC->auxiQueue, &auxiQueue_partial);
    kcg_copy_array_float32_10(
    ...
    kcg_copy_array_float32_10(
      ...
      &last_Local_mm_array_imp);
    kcg_copy__94_array(&_24_auxiQueue_partial, &last_auxiQueue);
    kcg_copy__94_array(&_23_impQueue_partial, &last_impQueue);
    kcg_copy_array_float32_10(&_19_hh_array_partial, &last_hh_array);
    kcg_copy_array_float32_10(&_18_mm_array_partial, &last_mm_array);
    kcg_copy__94_array(&_17_queue_partial, &last_queue);
    _20_CountCommand_partial = outC->_L2_else_OperationQueue_IfBlock;
    kcg_copy__94_array(&outC->queue, &_17_queue_partial);
    kcg_copy_array_float32_10(&outC->mm_array, &_18_mm_array_partial);
    kcg_copy_array_float32_10(&outC->hh_array, &_19_hh_array_partial);
    outC->CountCommand = _20_CountCommand_partial;
    kcg_copy__94_array(&outC->impQueue, &_23_impQueue_partial);
    kcg_copy__94_array(&outC->auxiQueue, &_24_auxiQueue_partial);
    kcg_copy_array_float32_10(
      &outC->Local_mm_array_imp,
      &_25_Local_mm_array_imp_partial);
    kcg_copy_array_float32_10(
  ...
  if (outC->StatusQueue_IfBlock_clock) {
    ...
    outC->else_clock_StatusQueue_IfBlock = outC->NumElem <= kcg_lit_int32(0);
  ...
  outC_MSGQueue_normalMSG_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  for (idx = 0; idx < 4; idx++) {
    outC->_L111[idx] = kcg_lit_float32(0.0);
  }
  outC->_L112 = kcg_lit_float32(0.0);
  outC->_L113 = kcg_lit_float32(0.0);
  ...
  outC->_L102.system_clock = kcg_lit_int32(0);
  outC->_L102.textMessage_ID = kcg_lit_int32(0);
  outC->_L102.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L102.l_text = kcg_lit_int32(0);
  ...
  outC->CountCommand_auxi = kcg_lit_int32(0);
  outC->CountCommand_imp = kcg_lit_int32(0);
  outC->insertImpMsg = kcg_true;
  outC->ins = kcg_true;
  outC->CountCommand = kcg_lit_int32(0);
  ...
  outC->_L15_then_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_float32(0.0);
  outC->_L14_then_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_float32(0.0);
  ...
  outC->_L2_then_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  outC->_L9_then_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  outC->_L8_then_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  outC->_L3_then_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  ...
  outC->_L5_then_IfBlock1_then_OperationQueue_IfBlock.l_text = kcg_lit_int32(0);
  ...
  outC->_L6_then_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  ...
  outC->_L14_else_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_float32(0.0);
  outC->_L13_else_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_float32(0.0);
  for (idx7 = 0; idx7 < 10; idx7++) {
    outC->_L10_else_IfBlock1_then_OperationQueue_IfBlock[idx7] =
      kcg_lit_float32(0.0);
  }
  for (idx8 = 0; idx8 < 10; idx8++) {
    outC->_L9_else_IfBlock1_then_OperationQueue_IfBlock[idx8] = kcg_lit_float32(
        0.0);
  }
  outC->_L8_else_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  outC->_L7_else_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  ...
  outC->_L3_else_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  outC->_L4_else_IfBlock1_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  ...
  outC->_L6_else_IfBlock1_then_OperationQueue_IfBlock.q_text =
    balise_read_error_DMI_Types_Pkg;
  outC->_L6_else_IfBlock1_then_OperationQueue_IfBlock.l_text = kcg_lit_int32(0);
  ...
  outC->_L52_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  ...
  outC->_L141_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  for (idx18 = 0; idx18 < 10; idx18++) {
    outC->_L174_then_OperationQueue_IfBlock[idx18] = kcg_lit_float32(0.0);
  }
  for (idx19 = 0; idx19 < 10; idx19++) {
    outC->_L175_then_OperationQueue_IfBlock[idx19] = kcg_lit_float32(0.0);
  }
  for (idx20 = 0; idx20 < 10; idx20++) {
    outC->_L176_then_OperationQueue_IfBlock[idx20] = kcg_lit_float32(0.0);
  }
  outC->_L177_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  for (idx21 = 0; idx21 < 10; idx21++) {
    outC->_L181_then_OperationQueue_IfBlock[idx21] = kcg_lit_float32(0.0);
  }
  outC->_L178_then_OperationQueue_IfBlock = kcg_lit_int32(0);
  for (idx22 = 0; idx22 < 10; idx22++) {
    outC->_L182_then_OperationQueue_IfBlock[idx22] = kcg_lit_float32(0.0);
  }
  for (idx23 = 0; idx23 < 10; idx23++) {
    outC->_L183_then_OperationQueue_IfBlock[idx23] = kcg_lit_float32(0.0);
  }
  ...
  outC->NumImp = kcg_lit_int32(0);
  outC->NumAuxi = kcg_lit_int32(0);
  kcg_copy__94_array(
    &outC->impQueue,
    (_94_array *) &cMsgStructQueueMax_DMI_Control_Pkg);
  kcg_copy__94_array(
    &outC->auxiQueue,
    (_94_array *) &cMsgStructQueueMax_DMI_Control_Pkg);
  outC->Local_mm = kcg_lit_float32(10.0);
  outC->Local_hh = kcg_lit_float32(17.0);
  kcg_copy_array_float32_10(
    &outC->Local_mm_array_imp,
    (array_float32_10 *) &cArray_mm_leer_DMI_Control_Pkg);
  kcg_copy_array_float32_10(
  ...
  outC_MSGQueue_normalMSG_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  kcg_copy__94_array(&SV->Context_queue, &outC->queue);
  ...
  kcg_copy__94_array(&SV->Context_auxiQueue, &outC->auxiQueue);
  kcg_copy__94_array(&SV->Context_impQueue, &outC->impQueue);
  ...
  SV_MSGQueue_normalMSG_DMI_Control_Pkg_Sub_func_TextMessages *SV)
{
  ...
  kcg_copy__94_array(&outC->queue, &SV->Context_queue);
  ...
  kcg_copy__94_array(&outC->auxiQueue, &SV->Context_auxiQueue);
  kcg_copy__94_array(&outC->impQueue, &SV->Context_impQueue);
