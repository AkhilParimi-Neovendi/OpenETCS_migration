  ...
  outC_calculateLocalBGInaccuracies_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  ...
  outC->_L27.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L27.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L27.BG_Header.nid_bg = kcg_lit_int64(0);
  outC->_L27.BG_Header.q_link = Q_LINK_Unlinked;
  outC->_L27.BG_Header.bgPosition.valid = kcg_true;
  outC->_L27.BG_Header.bgPosition.timestamp = kcg_lit_int64(0);
  outC->_L27.BG_Header.bgPosition.odo.o_nominal = kcg_lit_int64(0);
  outC->_L27.BG_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->_L27.BG_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
  outC->_L27.BG_Header.bgPosition.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L27.BG_Header.bgPosition.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L27.BG_Header.bgPosition.speed.v_lower = kcg_lit_int64(0);
  outC->_L27.BG_Header.bgPosition.speed.v_upper = kcg_lit_int64(0);
  outC->_L27.BG_Header.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->_L27.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L27.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  outC->_L19.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L19.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L19.BG_Header.nid_bg = kcg_lit_int64(0);
  outC->_L19.BG_Header.q_link = Q_LINK_Unlinked;
  outC->_L19.BG_Header.bgPosition.valid = kcg_true;
  outC->_L19.BG_Header.bgPosition.timestamp = kcg_lit_int64(0);
  outC->_L19.BG_Header.bgPosition.odo.o_nominal = kcg_lit_int64(0);
  outC->_L19.BG_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->_L19.BG_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
  outC->_L19.BG_Header.bgPosition.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L19.BG_Header.bgPosition.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L19.BG_Header.bgPosition.speed.v_lower = kcg_lit_int64(0);
  outC->_L19.BG_Header.bgPosition.speed.v_upper = kcg_lit_int64(0);
  outC->_L19.BG_Header.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->_L19.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L19.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  outC->_L3.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L3.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->_L3.expectedLocation.nominal = kcg_lit_int64(0);
  outC->_L3.expectedLocation.d_min = kcg_lit_int64(0);
  outC->_L3.expectedLocation.d_max = kcg_lit_int64(0);
  outC->_L3.d_link.nominal = kcg_lit_int64(0);
  outC->_L3.d_link.d_min = kcg_lit_int64(0);
  outC->_L3.d_link.d_max = kcg_lit_int64(0);
  outC->_L3.linkingInfo.valid = kcg_true;
  outC->_L3.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  outC->_L3.linkingInfo.q_dir = Q_DIR_Reverse;
  outC->_L3.linkingInfo.q_scale = Q_SCALE_10_cm_scale;
  outC->_L3.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L3.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L3.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L3.linkingInfo.nid_bg = kcg_lit_int64(0);
  outC->_L3.linkingInfo.q_linkorientation =
    Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
  outC->_L3.linkingInfo.q_linkreaction = Q_LINKREACTION_Train_trip;
  outC->_L3.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  for (idx2 = 0; idx2 < 33; idx2++) {
    ...
    outC->_L1.infoFromPassing.linkedBGs[idx2].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L1.infoFromPassing.linkedBGs[idx2].d_link = kcg_lit_int64(0);
    outC->_L1.infoFromPassing.linkedBGs[idx2].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L1.infoFromPassing.linkedBGs[idx2].nid_c = kcg_lit_int64(0);
    outC->_L1.infoFromPassing.linkedBGs[idx2].nid_bg = kcg_lit_int64(0);
    outC->_L1.infoFromPassing.linkedBGs[idx2].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L1.infoFromPassing.linkedBGs[idx2].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L1.infoFromPassing.linkedBGs[idx2].q_locacc = kcg_lit_int64(0);
  }
  ...
  outC->_L2.d_baliseAntenna_2_frontend.nominal = kcg_lit_int64(0);
  outC->_L2.d_baliseAntenna_2_frontend.d_min = kcg_lit_int64(0);
  outC->_L2.d_baliseAntenna_2_frontend.d_max = kcg_lit_int64(0);
  outC->_L2.d_frontend_2_rearend.nominal = kcg_lit_int64(0);
  outC->_L2.d_frontend_2_rearend.d_min = kcg_lit_int64(0);
  outC->_L2.d_frontend_2_rearend.d_max = kcg_lit_int64(0);
  outC->_L2.locationAccuracy_DefaultValue.nominal = kcg_lit_int64(0);
  outC->_L2.locationAccuracy_DefaultValue.d_min = kcg_lit_int64(0);
  outC->_L2.locationAccuracy_DefaultValue.d_max = kcg_lit_int64(0);
  outC->_L2.centerDetectionAcc_DefaultValue.nominal = kcg_lit_int64(0);
  outC->_L2.centerDetectionAcc_DefaultValue.d_min = kcg_lit_int64(0);
  outC->_L2.centerDetectionAcc_DefaultValue.d_max = kcg_lit_int64(0);
  outC->localInaccuracies.nominal = kcg_lit_int64(0);
  outC->localInaccuracies.d_min = kcg_lit_int64(0);
  outC->localInaccuracies.d_max = kcg_lit_int64(0);
  /* _L23=(BasicLocationFunctions_Pkg::add_2_Distances#5)/ */
