  ...
  outC_CAST_Int_to_Q_MARQSTREASON_TM_conversions *outC)
{
  ...
  /* q_marqstreason/ */
  static Q_MARQSTREASON _1_q_marqstreason_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* q_marqstreason/ */
  static Q_MARQSTREASON _3_q_marqstreason_partial;
  /* error/ */
  ...
  /* q_marqstreason/ */
  static Q_MARQSTREASON _7_q_marqstreason_partial;
  /* error/ */
  static kcg_bool _8_error_partial;
  /* q_marqstreason/ */
  static Q_MARQSTREASON _9_q_marqstreason_partial;
  /* error/ */
  static kcg_bool _10_error_partial;
  /* error/ */
  static kcg_bool _11_error_partial;
  /* q_marqstreason/ */
  static Q_MARQSTREASON _12_q_marqstreason_partial;
  /* error/ */
  static kcg_bool _13_error_partial;
  /* q_marqstreason/ */
  static Q_MARQSTREASON _14_q_marqstreason_partial;
  /* error/ */
  static kcg_bool _15_error_partial;
  /* q_marqstreason/ */
  static Q_MARQSTREASON _16_q_marqstreason_partial;
  /* error/ */
  static kcg_bool _17_error_partial;
  /* q_marqstreason/ */
  static Q_MARQSTREASON _18_q_marqstreason_partial;
