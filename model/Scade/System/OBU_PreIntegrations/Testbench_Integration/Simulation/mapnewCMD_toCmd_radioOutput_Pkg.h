...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  NID_RADIO /* nidRadio/ */ Context_nidRadio;
  NID_MN /* nidMN/ */ Context_nidMN;
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
} SV_mapnewCMD_toCmd_radioOutput_Pkg;

extern void kcg_save_SV_mapnewCMD_toCmd_radioOutput_Pkg(
  SV_mapnewCMD_toCmd_radioOutput_Pkg *SV,
  outC_mapnewCMD_toCmd_radioOutput_Pkg *outC);
extern void kcg_load_SV_mapnewCMD_toCmd_radioOutput_Pkg(
  outC_mapnewCMD_toCmd_radioOutput_Pkg *outC,
  SV_mapnewCMD_toCmd_radioOutput_Pkg *SV);
