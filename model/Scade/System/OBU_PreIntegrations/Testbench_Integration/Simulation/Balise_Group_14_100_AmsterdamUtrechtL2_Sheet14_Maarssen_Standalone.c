...
/* AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Balise_Group_14_100/ */
void Balise_Group_14_100_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  /* BG_message_in/ */
  ...
  outC_Balise_Group_14_100_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  ...
  /* _L8=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Balise_14_100_0#1)/ */
  Balise_14_100_0_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->_L9,
    (BaliseTelegramHeader_int_T_TM *) &BG100_header_B0_Balises_Sim,
    outC->_L20,
    &outC->Context_Balise_14_100_0_1);
  kcg_copy_B_data_internal_T_InfraLib(
    &outC->_L8,
    &outC->Context_Balise_14_100_0_1.B_data_out);
  outC->_L21 = kcg_lit_int32(1);
  /* _L7=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Balise_14_100_1#1)/ */
  Balise_14_100_1_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->_L8,
    (BaliseTelegramHeader_int_T_TM *) &BG100_header_B1_Balises_Sim,
    outC->_L21,
    &outC->Context_Balise_14_100_1_1);
  kcg_copy_B_data_internal_T_InfraLib(
    &outC->_L7,
    &outC->Context_Balise_14_100_1_1.B_data_out);
...
void Balise_Group_14_100_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  outC_Balise_Group_14_100_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  static kcg_size idx;
  ...
  /* _L7=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Balise_14_100_1#1)/ */
  Balise_14_100_1_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->Context_Balise_14_100_1_1);
  /* _L8=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Balise_14_100_0#1)/ */
  Balise_14_100_0_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->Context_Balise_14_100_0_1);
  /* _L11=(InfraLib::Balise_Group_Init#1)/ */
...
void Balise_Group_14_100_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  outC_Balise_Group_14_100_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  /* _L14=(InfraLib::Balise_Group_Close#1)/ */
  Balise_Group_Close_reset_InfraLib(&outC->Context_Balise_Group_Close_1);
  /* _L7=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Balise_14_100_1#1)/ */
  Balise_14_100_1_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->Context_Balise_14_100_1_1);
  /* _L8=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Balise_14_100_0#1)/ */
  Balise_14_100_0_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->Context_Balise_14_100_0_1);
  /* _L11=(InfraLib::Balise_Group_Init#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Balise_Group_14_100_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone.c
** Generation date: 2023-11-05T09:07:02
*************************************************************$ */
