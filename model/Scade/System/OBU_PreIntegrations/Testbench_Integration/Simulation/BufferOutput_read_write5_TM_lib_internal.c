  ...
  outC_BufferOutput_read_write5_TM_lib_internal *outC)
{
  ...
  kcg_copy__84_array(&outC->_L29, (_84_array *) &outC->_L23[0]);
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
    &outC->_L38,
    (M_TrainTrack_Message_T_TM_radio_messages *)
      &EMPTY_TrainTrackMessage_TM_lib_internal);
  ...
  kcg_copy__17_array(&outC->_L36, (_17_array *) &outC->_L23[1]);
  kcg_copy__17_array(&outC->_L39[0], &outC->_L36);
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
    &outC->_L39[4],
    &outC->_L40[0]);
  /* _L41= */
  if (outC->_L34) {
    kcg_copy__84_array(&outC->_L41, &outC->_L39);
  }
  else {
    kcg_copy__84_array(&outC->_L41, &outC->_L29);
  }
  outC->_L32 = kcg_lit_int32(4);
  outC->_L31 = outC->_L15 + outC->_L32;
  kcg_copy__96_array(&outC->_L24, (_96_array *) &outC->_L12[0]);
  kcg_copy__84_array(&outC->_L25[0], &outC->_L41);
  kcg_copy__96_array(&outC->_L25[5], &outC->_L24);
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
    &outC->Message_out,
    &outC->_L42);
