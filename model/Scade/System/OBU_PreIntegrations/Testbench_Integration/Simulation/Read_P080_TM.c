...
void Read_P080_init_TM(outC_Read_P080_TM *outC)
{
  ...
  outC->_L166.l_packet = kcg_lit_int64(0);
  outC->_L166.q_scale = Q_SCALE_10_cm_scale;
  outC->_L166.n_iter = kcg_lit_int64(0);
  for (idx = 0; idx < 33; idx++) {
    outC->_L166.sections[idx].valid = kcg_true;
    outC->_L166.sections[idx].d_mamode = kcg_lit_int64(0);
    outC->_L166.sections[idx].m_mamode = M_MAMODE_On_Sight;
    outC->_L166.sections[idx].v_mamode = kcg_lit_int64(0);
    outC->_L166.sections[idx].l_mamode = kcg_lit_int64(0);
    outC->_L166.sections[idx].l_ackmamode = kcg_lit_int64(0);
  ...
  outC->P080_OBU_out.l_packet = kcg_lit_int64(0);
  outC->P080_OBU_out.q_scale = Q_SCALE_10_cm_scale;
  outC->P080_OBU_out.n_iter = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 33; idx4++) {
    outC->P080_OBU_out.sections[idx4].valid = kcg_true;
    outC->P080_OBU_out.sections[idx4].d_mamode = kcg_lit_int64(0);
    outC->P080_OBU_out.sections[idx4].m_mamode = M_MAMODE_On_Sight;
    outC->P080_OBU_out.sections[idx4].v_mamode = kcg_lit_int64(0);
    outC->P080_OBU_out.sections[idx4].l_mamode = kcg_lit_int64(0);
    outC->P080_OBU_out.sections[idx4].l_ackmamode = kcg_lit_int64(0);
