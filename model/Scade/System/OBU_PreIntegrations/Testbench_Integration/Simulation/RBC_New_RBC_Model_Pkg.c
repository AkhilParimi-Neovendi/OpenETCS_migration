...
void RBC_New_init_RBC_Model_Pkg(outC_RBC_New_RBC_Model_Pkg *outC)
{
  ...
  outC->_L256.header.nid_message = kcg_lit_int64(0);
  outC->_L256.header.t_train = kcg_lit_int64(0);
  outC->_L256.header.nid_engine = kcg_lit_int64(0);
  outC->_L256.header.xQ_MARQSTREASON = Q_MARQSTREASON_Start_selected_by_driver;
  outC->_L256.header.xT_TRAIN = kcg_lit_int64(0);
  outC->_L256.header.xNID_EM = kcg_lit_int64(0);
  outC->_L256.header.xQ_EMERGENCYSTOP =
    Q_EMERGENCYSTOP_Conditional_Emergency_Stop_accepted_with_update_of_EOA;
  outC->_L256.header.xNID_TEXTMESSAGE = kcg_lit_int64(0);
  outC->_L256.packets.p0.valid = kcg_true;
  outC->_L256.packets.p0.packet0.NID_PACKET = kcg_lit_int64(0);
  outC->_L256.packets.p0.packet0.L_PACKET = kcg_lit_int64(0);
  outC->_L256.packets.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L256.packets.p0.packet0.NID_LRBG = kcg_lit_int64(0);
  outC->_L256.packets.p0.packet0.D_LRBG = kcg_lit_int64(0);
  outC->_L256.packets.p0.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L256.packets.p0.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->_L256.packets.p0.packet0.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L256.packets.p0.packet0.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L256.packets.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L256.packets.p0.packet0.L_TRAININT = kcg_lit_int64(0);
  outC->_L256.packets.p0.packet0.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L256.packets.p0.packet0.NID_NTC = kcg_lit_int64(0);
  outC->_L256.packets.p1.valid = kcg_true;
  outC->_L256.packets.p1.packet1.NID_PACKET = kcg_lit_int64(0);
  outC->_L256.packets.p1.packet1.L_PACKET = kcg_lit_int64(0);
  outC->_L256.packets.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L256.packets.p1.packet1.NID_LRBG = kcg_lit_int64(0);
  outC->_L256.packets.p1.packet1.NID_PRVLRBG = kcg_lit_int64(0);
  outC->_L256.packets.p1.packet1.D_LRBG = kcg_lit_int64(0);
  outC->_L256.packets.p1.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L256.packets.p1.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L256.packets.p1.packet1.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L256.packets.p1.packet1.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L256.packets.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L256.packets.p1.packet1.L_TRAININT = kcg_lit_int64(0);
  outC->_L256.packets.p1.packet1.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L256.packets.p1.packet1.NID_NTC = kcg_lit_int64(0);
  outC->_L256.packets.p3.valid = kcg_true;
  outC->_L256.packets.p3.number = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 1; idx1++) {
    outC->_L256.packets.p3.aNID_RADIO[idx1].valid = kcg_true;
    for (idx = 0; idx < 15; idx++) {
      outC->_L256.packets.p3.aNID_RADIO[idx1].telephoneNumber[idx] = kcg_lit_int64(0);
    }
  }
  ...
  outC->_L256.packets.p5.TrainRunningNumber = kcg_lit_int64(0);
  outC->_L256.packets.p9.valid = kcg_true;
  outC->_L256.packets.p9.transitionInformation = kcg_lit_int64(0);
  ...
  outC->_L256.packets.p11.l_train = kcg_lit_int64(0);
  outC->_L256.packets.p11.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L256.packets.p11.n_axle = kcg_lit_int64(0);
  outC->_L256.packets.p11.nIter_tractionIdentity = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 4; idx2++) {
    outC->_L256.packets.p11.tractionIdentity[idx2].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L256.packets.p11.tractionIdentity[idx2].nid_ctraction = kcg_lit_int64(0);
  }
  outC->_L256.packets.p11.nIter_ntc = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L256.packets.p11.nid_ntc[idx3] = kcg_lit_int64(0);
  }
  outC->_L254.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  outC->_L254.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(
      0);
  ...
  outC->_L254.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L254.session.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L254.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L254.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L254.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L254.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L254.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L254.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L254.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L254.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L254.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L254.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L254.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L254.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L254.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L254.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L254.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L254.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L254.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L254.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L254.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L254.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L254.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L254.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L254.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L254.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L254.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L254.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L254.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L254.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L254.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  outC->_L254.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L254.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L254.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L254.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx9 = 0; idx9 < 16; idx9++) {
    ...
    outC->_L254.diagnostic[idx9].count = kcg_lit_int64(0);
    outC->_L254.diagnostic[idx9].timestamp = kcg_lit_int64(0);
  ...
  outC->_L254.clockk.m_Value = kcg_lit_int64(0);
  outC->_L254.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int64(0);
  outC->_L254.lastSentTrackTrainMessage.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L254.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int64(0);
  outC->_L254.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int64(0);
  outC->_L254.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int64(0);
  outC->_L254.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L254.lastSentTrackTrainMessage.Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L254.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int64(0);
  outC->_L254.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int64(0);
  outC->_L254.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int64(0);
  outC->_L254.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L254.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int64(0);
  outC->_L254.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int64(0);
  outC->_L254.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L254.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L255.m_Value = kcg_lit_int64(0);
  outC->_L253.m_TrainData.nid_engine = kcg_lit_int64(0);
  outC->_L253.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(0);
  ...
  outC->_L253.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L253.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L253.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L253.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L253.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L253.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  for (idx18 = 0; idx18 < 5; idx18++) {
    outC->_L253.m_TrainData.m_NationalSystemIdentities[idx18] = kcg_lit_int64(0);
  }
  outC->_L253.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L253.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L253.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L253.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L253.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L253.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L253.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L253.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L253.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L253.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L253.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L253.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L253.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L245.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  outC->_L245.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(
      0);
  ...
  outC->_L245.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L245.session.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L245.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L245.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L245.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L245.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L245.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L245.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L245.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L245.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L245.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L245.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L245.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L245.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L245.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L245.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L245.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L245.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L245.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L245.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L245.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L245.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L245.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L245.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L245.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L245.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L245.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L245.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L245.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L245.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L245.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  outC->_L245.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L245.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L245.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L245.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx24 = 0; idx24 < 16; idx24++) {
    ...
    outC->_L245.diagnostic[idx24].count = kcg_lit_int64(0);
    outC->_L245.diagnostic[idx24].timestamp = kcg_lit_int64(0);
  ...
  outC->_L245.clockk.m_Value = kcg_lit_int64(0);
  outC->_L245.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int64(0);
  outC->_L245.lastSentTrackTrainMessage.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L245.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int64(0);
  outC->_L245.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int64(0);
  outC->_L245.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int64(0);
  outC->_L245.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L245.lastSentTrackTrainMessage.Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L245.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int64(0);
  outC->_L245.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int64(0);
  outC->_L245.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int64(0);
  outC->_L245.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L245.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int64(0);
  outC->_L245.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int64(0);
  outC->_L245.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L245.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L246.Header.radioDevice = kcg_lit_int64(0);
  outC->_L246.Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L246.Header.nid_message = kcg_lit_int64(0);
  outC->_L246.Header.t_train = kcg_lit_int64(0);
  outC->_L246.Header.m_ack = kcg_lit_int64(0);
  outC->_L246.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L246.Header.t_train_reference = kcg_lit_int64(0);
  outC->_L246.Header.nid_em = kcg_lit_int64(0);
  outC->_L246.Header.q_scale = kcg_lit_int64(0);
  outC->_L246.Header.d_sr = kcg_lit_int64(0);
  outC->_L246.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L246.Header.d_ref = kcg_lit_int64(0);
  outC->_L246.Header.q_dir = kcg_lit_int64(0);
  outC->_L246.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L246.Header.m_version = kcg_lit_int64(0);
  for (idx30 = 0; idx30 < 30; idx30++) {
    outC->_L246.Messages.PacketHeaders[idx30].nid_packet = kcg_lit_int64(0);
    outC->_L246.Messages.PacketHeaders[idx30].q_dir = Q_DIR_Reverse;
    outC->_L246.Messages.PacketHeaders[idx30].valid = kcg_true;
    outC->_L246.Messages.PacketHeaders[idx30].startAddress = kcg_lit_int64(0);
    outC->_L246.Messages.PacketHeaders[idx30].endAddress = kcg_lit_int64(0);
  }
  for (idx31 = 0; idx31 < 500; idx31++) {
    outC->_L246.Messages.PacketData[idx31] = kcg_lit_int64(0);
  }
  outC->_L240.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  outC->_L240.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(
      0);
  ...
  outC->_L240.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L240.session.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L240.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L240.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L240.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L240.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L240.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L240.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L240.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L240.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L240.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L240.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L240.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L240.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L240.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L240.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L240.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L240.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L240.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L240.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L240.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L240.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L240.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L240.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L240.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L240.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L240.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L240.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L240.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L240.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L240.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  outC->_L240.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L240.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L240.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L240.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx37 = 0; idx37 < 16; idx37++) {
    ...
    outC->_L240.diagnostic[idx37].count = kcg_lit_int64(0);
    outC->_L240.diagnostic[idx37].timestamp = kcg_lit_int64(0);
  ...
  outC->_L240.clockk.m_Value = kcg_lit_int64(0);
  outC->_L240.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int64(0);
  outC->_L240.lastSentTrackTrainMessage.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L240.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int64(0);
  outC->_L240.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int64(0);
  outC->_L240.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int64(0);
  outC->_L240.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L240.lastSentTrackTrainMessage.Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L240.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int64(0);
  outC->_L240.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int64(0);
  outC->_L240.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int64(0);
  outC->_L240.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L240.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int64(0);
  outC->_L240.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int64(0);
  outC->_L240.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L240.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L239.header.nid_message = kcg_lit_int64(0);
  outC->_L239.header.t_train = kcg_lit_int64(0);
  outC->_L239.header.nid_engine = kcg_lit_int64(0);
  outC->_L239.header.xQ_MARQSTREASON = Q_MARQSTREASON_Start_selected_by_driver;
  outC->_L239.header.xT_TRAIN = kcg_lit_int64(0);
  outC->_L239.header.xNID_EM = kcg_lit_int64(0);
  outC->_L239.header.xQ_EMERGENCYSTOP =
    Q_EMERGENCYSTOP_Conditional_Emergency_Stop_accepted_with_update_of_EOA;
  outC->_L239.header.xNID_TEXTMESSAGE = kcg_lit_int64(0);
  outC->_L239.packets.p0.valid = kcg_true;
  outC->_L239.packets.p0.packet0.NID_PACKET = kcg_lit_int64(0);
  outC->_L239.packets.p0.packet0.L_PACKET = kcg_lit_int64(0);
  outC->_L239.packets.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L239.packets.p0.packet0.NID_LRBG = kcg_lit_int64(0);
  outC->_L239.packets.p0.packet0.D_LRBG = kcg_lit_int64(0);
  outC->_L239.packets.p0.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L239.packets.p0.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->_L239.packets.p0.packet0.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L239.packets.p0.packet0.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L239.packets.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L239.packets.p0.packet0.L_TRAININT = kcg_lit_int64(0);
  outC->_L239.packets.p0.packet0.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L239.packets.p0.packet0.NID_NTC = kcg_lit_int64(0);
  outC->_L239.packets.p1.valid = kcg_true;
  outC->_L239.packets.p1.packet1.NID_PACKET = kcg_lit_int64(0);
  outC->_L239.packets.p1.packet1.L_PACKET = kcg_lit_int64(0);
  outC->_L239.packets.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L239.packets.p1.packet1.NID_LRBG = kcg_lit_int64(0);
  outC->_L239.packets.p1.packet1.NID_PRVLRBG = kcg_lit_int64(0);
  outC->_L239.packets.p1.packet1.D_LRBG = kcg_lit_int64(0);
  outC->_L239.packets.p1.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L239.packets.p1.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L239.packets.p1.packet1.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L239.packets.p1.packet1.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L239.packets.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L239.packets.p1.packet1.L_TRAININT = kcg_lit_int64(0);
  outC->_L239.packets.p1.packet1.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L239.packets.p1.packet1.NID_NTC = kcg_lit_int64(0);
  outC->_L239.packets.p3.valid = kcg_true;
  outC->_L239.packets.p3.number = kcg_lit_int64(0);
  ...
  outC->_L239.packets.p5.TrainRunningNumber = kcg_lit_int64(0);
  outC->_L239.packets.p9.valid = kcg_true;
  outC->_L239.packets.p9.transitionInformation = kcg_lit_int64(0);
  ...
  outC->_L239.packets.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L239.packets.p11.l_train = kcg_lit_int64(0);
  outC->_L239.packets.p11.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L239.packets.p11.n_axle = kcg_lit_int64(0);
  outC->_L239.packets.p11.nIter_tractionIdentity = kcg_lit_int64(0);
  ...
  outC->_L239.packets.p11.nIter_ntc = kcg_lit_int64(0);
  for (idx46 = 0; idx46 < 5; idx46++) {
    outC->_L239.packets.p11.nid_ntc[idx46] = kcg_lit_int64(0);
  }
  outC->_L223.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  outC->_L223.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(
      0);
  ...
  outC->_L223.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L223.session.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L223.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L223.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L223.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L223.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L223.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L223.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L223.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L223.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L223.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L223.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L223.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L223.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L223.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L223.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L223.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L223.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L223.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L223.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L223.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L223.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L223.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L223.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L223.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L223.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L223.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L223.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L223.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L223.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L223.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  outC->_L223.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L223.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L223.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L223.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx52 = 0; idx52 < 16; idx52++) {
    ...
    outC->_L223.diagnostic[idx52].count = kcg_lit_int64(0);
    outC->_L223.diagnostic[idx52].timestamp = kcg_lit_int64(0);
  ...
  outC->_L223.clockk.m_Value = kcg_lit_int64(0);
  outC->_L223.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int64(0);
  outC->_L223.lastSentTrackTrainMessage.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L223.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int64(0);
  outC->_L223.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int64(0);
  outC->_L223.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int64(0);
  outC->_L223.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L223.lastSentTrackTrainMessage.Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L223.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int64(0);
  outC->_L223.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int64(0);
  outC->_L223.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int64(0);
  outC->_L223.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L223.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int64(0);
  outC->_L223.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int64(0);
  outC->_L223.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L223.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L220.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L220.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L220.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L220.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L220.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L220.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L220.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L220.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L220.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L220.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L220.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L220.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  outC->_L220.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L220.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L220.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L220.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  outC->_L218.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  outC->_L218.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(
      0);
  ...
  outC->_L218.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L218.session.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L218.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L218.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L218.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L218.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L218.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L218.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L218.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L218.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L218.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L218.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L218.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L218.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L218.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L218.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L218.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L218.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L218.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L218.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L218.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L218.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L218.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L218.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L218.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L218.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L218.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L218.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L218.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L218.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L218.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  outC->_L218.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L218.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L218.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L218.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx64 = 0; idx64 < 16; idx64++) {
    ...
    outC->_L218.diagnostic[idx64].count = kcg_lit_int64(0);
    outC->_L218.diagnostic[idx64].timestamp = kcg_lit_int64(0);
  ...
  outC->_L218.clockk.m_Value = kcg_lit_int64(0);
  outC->_L218.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int64(0);
  outC->_L218.lastSentTrackTrainMessage.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L218.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int64(0);
  outC->_L218.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int64(0);
  outC->_L218.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int64(0);
  outC->_L218.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L218.lastSentTrackTrainMessage.Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L218.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int64(0);
  outC->_L218.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int64(0);
  outC->_L218.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int64(0);
  outC->_L218.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L218.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int64(0);
  outC->_L218.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int64(0);
  outC->_L218.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L218.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L217.Header.radioDevice = kcg_lit_int64(0);
  outC->_L217.Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L217.Header.nid_message = kcg_lit_int64(0);
  outC->_L217.Header.t_train = kcg_lit_int64(0);
  outC->_L217.Header.m_ack = kcg_lit_int64(0);
  outC->_L217.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L217.Header.t_train_reference = kcg_lit_int64(0);
  outC->_L217.Header.nid_em = kcg_lit_int64(0);
  outC->_L217.Header.q_scale = kcg_lit_int64(0);
  outC->_L217.Header.d_sr = kcg_lit_int64(0);
  outC->_L217.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L217.Header.d_ref = kcg_lit_int64(0);
  outC->_L217.Header.q_dir = kcg_lit_int64(0);
  outC->_L217.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L217.Header.m_version = kcg_lit_int64(0);
  for (idx70 = 0; idx70 < 30; idx70++) {
    outC->_L217.Messages.PacketHeaders[idx70].nid_packet = kcg_lit_int64(0);
    outC->_L217.Messages.PacketHeaders[idx70].q_dir = Q_DIR_Reverse;
    outC->_L217.Messages.PacketHeaders[idx70].valid = kcg_true;
    outC->_L217.Messages.PacketHeaders[idx70].startAddress = kcg_lit_int64(0);
    outC->_L217.Messages.PacketHeaders[idx70].endAddress = kcg_lit_int64(0);
  }
  for (idx71 = 0; idx71 < 500; idx71++) {
    outC->_L217.Messages.PacketData[idx71] = kcg_lit_int64(0);
  }
  outC->_L157.Message.valid = kcg_true;
  outC->_L157.Message.nid_message = kcg_lit_int64(0);
  outC->_L157.Message.l_message = kcg_lit_int64(0);
  outC->_L157.Message.t_train = kcg_lit_int64(0);
  outC->_L157.Message.nid_engine = kcg_lit_int64(0);
  outC->_L157.Message.field1 = kcg_lit_int64(0);
  outC->_L157.Message.field2 = kcg_lit_int64(0);
  outC->_L157.Message.field3 = kcg_lit_int64(0);
  for (idx72 = 0; idx72 < 50; idx72++) {
    outC->_L157.OptionalPackets[idx72] = kcg_lit_int64(0);
  }
  ...
  for (idx74 = 0; idx74 < 500; idx74++) {
    outC->outRadioTrackTrainMessage.Messages.PacketData[idx74] = kcg_lit_int64(0);
  }
  outC->outSessionManagement.m_TrainData.nid_engine = kcg_lit_int64(0);
  ...
  outC->outSessionManagement.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->outSessionManagement.m_TrainData.nc_cdtrain =
    NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->outSessionManagement.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->outSessionManagement.m_TrainData.l_train = kcg_lit_int64(0);
  outC->outSessionManagement.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->outSessionManagement.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->outSessionManagement.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->outSessionManagement.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->outSessionManagement.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->outSessionManagement.m_PosData.d_lrbg = kcg_lit_int64(0);
  ...
  outC->outSessionManagement.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->outSessionManagement.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->outSessionManagement.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->outSessionManagement.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->outSessionManagement.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->outSessionManagement.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->outSessionManagement.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  /* _L254=(RBC_Time_Pkg::RBC_Clock_Tick#1)/ */
...
void kcg_save_SV_RBC_New_RBC_Model_Pkg(
  SV_RBC_New_RBC_Model_Pkg *SV,
  outC_RBC_New_RBC_Model_Pkg *outC)
{
  kcg_save_SV_ToOldRadioTrainTrackMsg_RBC_Model_Pkg_TrainTrackMsgConversion(
    &SV->Context_ToOldRadioTrainTrackMsg_1,
    &outC->Context_ToOldRadioTrainTrackMsg_1);
  kcg_save_SV_DataBusFactory_RBC_DataBus_Pkg(
    &SV->Context_DataBusFactory_1,
    &outC->Context_DataBusFactory_1);
  kcg_save_SV_RadioTrainTrackInputHandler_RBC_Messaging_Pkg(
    &SV->Context_RadioTrainTrackInputHandler_1,
    &outC->Context_RadioTrainTrackInputHandler_1);
  kcg_save_SV_RBC__ProcessController_RBC_Model_Pkg(
    &SV->Context_RBC__ProcessController_1,
    &outC->Context_RBC__ProcessController_1);
  kcg_copy_RBC_Data_T_RBC_DataBus_Pkg(&SV->Context_dataBus, &outC->dataBus);
}

void kcg_load_SV_RBC_New_RBC_Model_Pkg(
  outC_RBC_New_RBC_Model_Pkg *outC,
  SV_RBC_New_RBC_Model_Pkg *SV)
{
  kcg_load_SV_ToOldRadioTrainTrackMsg_RBC_Model_Pkg_TrainTrackMsgConversion(
    &outC->Context_ToOldRadioTrainTrackMsg_1,
    &SV->Context_ToOldRadioTrainTrackMsg_1);
  kcg_load_SV_DataBusFactory_RBC_DataBus_Pkg(
    &outC->Context_DataBusFactory_1,
    &SV->Context_DataBusFactory_1);
  kcg_load_SV_RadioTrainTrackInputHandler_RBC_Messaging_Pkg(
    &outC->Context_RadioTrainTrackInputHandler_1,
    &SV->Context_RadioTrainTrackInputHandler_1);
  kcg_load_SV_RBC__ProcessController_RBC_Model_Pkg(
    &outC->Context_RBC__ProcessController_1,
    &SV->Context_RBC__ProcessController_1);
  kcg_copy_RBC_Data_T_RBC_DataBus_Pkg(&outC->dataBus, &SV->Context_dataBus);
}
