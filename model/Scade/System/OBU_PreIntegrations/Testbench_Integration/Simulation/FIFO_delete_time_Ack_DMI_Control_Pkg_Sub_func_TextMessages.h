...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  array_float32_5 /* new_mm_array/ */ new_mm_array;
  array_float32_5 /* new_hh_array/ */ new_hh_array;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  array_float32_5 /* _L10/ */ _L10;
  array_int32_5 /* _L4/ */ _L4;
  ...
  array_int32_5 /* _L19/ */ _L19;
  array_float32_5_5 /* _L24/ */ _L24;
  array_float32_5_5 /* _L28/ */ _L28;
...
typedef struct {
  /* ----------------------  memorised outputs  ---------------------- */
  array_float32_5 /* new_hh_array/ */ Context_new_hh_array;
  array_float32_5 /* new_mm_array/ */ Context_new_mm_array;
  /* -----------------------  no local memory  ----------------------- */
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
