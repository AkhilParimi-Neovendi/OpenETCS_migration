...
} SV_Supervision_M_Loc_ProvidePositionReport_Pkg;

extern void kcg_save_SV_Supervision_M_Loc_ProvidePositionReport_Pkg(
  SV_Supervision_M_Loc_ProvidePositionReport_Pkg *SV,
  outC_Supervision_M_Loc_ProvidePositionReport_Pkg *outC);
extern void kcg_load_SV_Supervision_M_Loc_ProvidePositionReport_Pkg(
  outC_Supervision_M_Loc_ProvidePositionReport_Pkg *outC,
  SV_Supervision_M_Loc_ProvidePositionReport_Pkg *SV);
