...
void kcg_save_SV_RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg(
  SV_RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg *SV,
  outC_RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg *outC)
{
  SV->Context_referenceTime = outC->referenceTime;
  SV->Context_setReferenceTime = outC->setReferenceTime;
  SV->Context_valid = outC->valid;
}

void kcg_load_SV_RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg(
  outC_RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg *outC,
  SV_RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg *SV)
{
  outC->referenceTime = SV->Context_referenceTime;
  outC->setReferenceTime = SV->Context_setReferenceTime;
  outC->valid = SV->Context_valid;
}
