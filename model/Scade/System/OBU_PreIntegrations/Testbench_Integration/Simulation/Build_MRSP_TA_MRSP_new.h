...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  MRSP_Profile_t_TrackAtlasTypes /* _L1/ */ Context__L1;
  kcg_bool Context_init;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_Build_StaticSpeedProfile_TA_SSP_new Context_Build_StaticSpeedProfile_1;
} SV_Build_MRSP_TA_MRSP_new;

extern void kcg_save_SV_Build_MRSP_TA_MRSP_new(
  SV_Build_MRSP_TA_MRSP_new *SV,
  outC_Build_MRSP_TA_MRSP_new *outC);
extern void kcg_load_SV_Build_MRSP_TA_MRSP_new(
  outC_Build_MRSP_TA_MRSP_new *outC,
  SV_Build_MRSP_TA_MRSP_new *SV);
