...
void kcg_save_SV_LowerOrHold_TargetLimits_Pkg(
  SV_LowerOrHold_TargetLimits_Pkg *SV,
  outC_LowerOrHold_TargetLimits_Pkg *outC)
{
  SV->Context_vo = outC->vo;
  SV->Context_mem_vi = outC->mem_vi;
}

void kcg_load_SV_LowerOrHold_TargetLimits_Pkg(
  outC_LowerOrHold_TargetLimits_Pkg *outC,
  SV_LowerOrHold_TargetLimits_Pkg *SV)
{
  outC->vo = SV->Context_vo;
  outC->mem_vi = SV->Context_mem_vi;
}
