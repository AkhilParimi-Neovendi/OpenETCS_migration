  ...
  outC_NextSpeedProfiles_DMI_Control_Pkg_Sub_func_PlanningArea *outC)
{
  ...
  kcg_copy_array_float64_32(&outC->_L48, inSpeedProfile_Speed);
  outC->_L13 = kcg_lit_int64(2);
  outC->_L2 = inTrainPosition;
  kcg_copy_array_float64_32(&outC->_L3, inSpeedProfile_Distance);
  outC->_L7 = kcg_true;
  outC->_L51 = outC->_L2;
  /* _L6= */
  if (outC->_L7) {
  ...
  kcg_copy_array_float64_10(&outC->SpeedProfile_Speed_DMI, &outC->_L40);
  outC->_L44 = outC->lSpeedProfileFirstIndex;
  kcg_copy_array_float64_32(&outC->_L43, inSpeedProfile_Distance);
  ...
  kcg_copy_array_float64_10(&outC->SpeedProfile_Distance_DMI, &outC->_L38);
}
  ...
  outC_NextSpeedProfiles_DMI_Control_Pkg_Sub_func_PlanningArea *outC)
{
  ...
  for (idx1 = 0; idx1 < 32; idx1++) {
    outC->_L48[idx1] = kcg_lit_float64(0.0);
  }
  ...
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L43[idx2] = kcg_lit_float64(0.0);
  }
  for (idx3 = 0; idx3 < 10; idx3++) {
    outC->_L40[idx3] = kcg_lit_float64(0.0);
  }
  for (idx4 = 0; idx4 < 10; idx4++) {
    outC->_L38[idx4] = kcg_lit_float64(0.0);
  }
  outC->_L7 = kcg_true;
  outC->_L6 = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 32; idx5++) {
    outC->_L3[idx5] = kcg_lit_float64(0.0);
  }
  outC->_L2 = kcg_lit_float64(0.0);
  outC->lSpeedProfileFirstIndex = kcg_lit_int64(0);
  for (idx6 = 0; idx6 < 10; idx6++) {
    outC->SpeedProfile_Speed_DMI[idx6] = kcg_lit_float64(0.0);
  }
  for (idx7 = 0; idx7 < 10; idx7++) {
    outC->SpeedProfile_Distance_DMI[idx7] = kcg_lit_float64(0.0);
  }
  /* _L38=(DMI_Control_Pkg::Sub_func::PlanningArea::NextSpeedProfiles_Distance#1)/ */
