  ...
  outC_C_header_to_M045_TM_RBC_conversions *outC)
{
  ...
  /* _L33=(TM_conversions::CAST_Int_to_NID_MESSAGE#1)/ */
  CAST_Int_to_NID_MESSAGE_TM_conversions(
    outC->_L3,
    &outC->Context_CAST_Int_to_NID_MESSAGE_1);
  outC->_L33 = outC->Context_CAST_Int_to_NID_MESSAGE_1.nid_message;
  outC->_L5 = outC->_L1.t_train;
  /* _L32=(TM_conversions::CAST_Int_to_T_TRAIN#1)/ */
  CAST_Int_to_T_TRAIN_TM_conversions(
    outC->_L5,
    &outC->Context_CAST_Int_to_T_TRAIN_1);
  outC->_L32 = outC->Context_CAST_Int_to_T_TRAIN_1.t_train;
  outC->_L4 = outC->_L1.l_message;
  /* _L31=(TM_conversions::CAST_Int_to_L_MESSAGE#1)/ */
  CAST_Int_to_L_MESSAGE_TM_conversions(
    outC->_L4,
    &outC->Context_CAST_Int_to_L_MESSAGE_1);
  outC->_L31 = outC->Context_CAST_Int_to_L_MESSAGE_1.l_message;
  outC->_L8 = outC->_L1.field3;
  /* _L29=(TM_conversions::CAST_Int_to_Q_ORIENTATION#1)/ */
  CAST_Int_to_Q_ORIENTATION_TM_conversions(
    outC->_L8,
    &outC->Context_CAST_Int_to_Q_ORIENTATION_1);
  outC->_L29 = outC->Context_CAST_Int_to_Q_ORIENTATION_1.q_orientation;
  ...
  outC_C_header_to_M045_TM_RBC_conversions *outC)
{
  ...
  CAST_Int_to_NID_LRBG_init_TM_conversions(
    &outC->Context_CAST_Int_to_NID_LRBG_1);
  /* _L29=(TM_conversions::CAST_Int_to_Q_ORIENTATION#1)/ */
  CAST_Int_to_Q_ORIENTATION_init_TM_conversions(
    &outC->Context_CAST_Int_to_Q_ORIENTATION_1);
  /* _L31=(TM_conversions::CAST_Int_to_L_MESSAGE#1)/ */
  ...
  outC_C_header_to_M045_TM_RBC_conversions *outC)
{
  ...
  CAST_Int_to_NID_LRBG_reset_TM_conversions(
    &outC->Context_CAST_Int_to_NID_LRBG_1);
  /* _L29=(TM_conversions::CAST_Int_to_Q_ORIENTATION#1)/ */
  CAST_Int_to_Q_ORIENTATION_reset_TM_conversions(
    &outC->Context_CAST_Int_to_Q_ORIENTATION_1);
  /* _L31=(TM_conversions::CAST_Int_to_L_MESSAGE#1)/ */
