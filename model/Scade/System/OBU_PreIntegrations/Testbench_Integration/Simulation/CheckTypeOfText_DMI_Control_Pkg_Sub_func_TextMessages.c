  ...
  outC_CheckTypeOfText_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  outC->_L2.dmi_msg.system_clock = kcg_lit_int64(0);
  outC->_L2.dmi_msg.textMessage_ID = kcg_lit_int64(0);
  outC->_L2.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L2.dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx3 = 0; idx3 < 5; idx3++) {
    ...
    outC->_L1[idx3].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L1[idx3].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L1[idx3].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L1[idx3].dmi_msg.l_text = kcg_lit_int64(0);
