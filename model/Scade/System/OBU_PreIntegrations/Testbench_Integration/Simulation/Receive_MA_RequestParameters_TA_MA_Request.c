  ...
  outC_Receive_MA_RequestParameters_TA_MA_Request *outC)
{
  ...
  outC->_L11.t_loa = kcg_lit_int64(0);
  outC->_L11.n_iter = kcg_lit_int64(0);
  for (idx = 0; idx < 32; idx++) {
    outC->_L11.sections[idx].valid = kcg_true;
    outC->_L11.sections[idx].l_section = kcg_lit_int64(0);
    outC->_L11.sections[idx].q_sectiontimer =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L11.sections[idx].t_sectiontimer = kcg_lit_int64(0);
    outC->_L11.sections[idx].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->_L11.l_endsection = kcg_lit_int64(0);
  outC->_L11.q_sectiontimer = Q_SECTIONTIMER_No_Section_Timer_information;
  outC->_L11.t_sectiontimer = kcg_lit_int64(0);
  outC->_L11.d_sectiontimerstoploc = kcg_lit_int64(0);
  outC->_L11.q_endtimer = Q_ENDTIMER_No_End_section_timer_information;
  outC->_L11.t_endtimer = kcg_lit_int64(0);
  outC->_L11.d_endtimerstartloc = kcg_lit_int64(0);
  outC->_L11.q_dangerpoint = Q_DANGERPOINT_No_danger_point_information;
  outC->_L11.d_dp = kcg_lit_int64(0);
  outC->_L11.v_releasedp = kcg_lit_int64(0);
  outC->_L11.q_overlap = Q_OVERLAP_No_overlap_information;
  outC->_L11.d_startol = kcg_lit_int64(0);
  outC->_L11.t_ol = kcg_lit_int64(0);
  outC->_L11.d_ol = kcg_lit_int64(0);
  outC->_L11.v_releaseol = kcg_lit_int64(0);
  outC->_L9 = kcg_true;
  ...
  outC->_L8.t_mar = kcg_lit_int64(0);
  outC->_L8.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L8.t_cycrqst = kcg_lit_int64(0);
  ...
  outC->_L2_MemoryBasic_1_struct.t_mar = kcg_lit_int64(0);
  outC->_L2_MemoryBasic_1_struct.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L2_MemoryBasic_1_struct.t_cycrqst = kcg_lit_int64(0);
  ...
  outC->_L6_MemoryBasic_1_struct.t_mar = kcg_lit_int64(0);
  outC->_L6_MemoryBasic_1_struct.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L6_MemoryBasic_1_struct.t_cycrqst = kcg_lit_int64(0);
  outC->_L7_MemoryBasic_1_struct.valid = kcg_true;
  outC->_L7_MemoryBasic_1_struct.q_dir = Q_DIR_Reverse;
  outC->_L7_MemoryBasic_1_struct.t_mar = kcg_lit_int64(0);
  outC->_L7_MemoryBasic_1_struct.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L7_MemoryBasic_1_struct.t_cycrqst = kcg_lit_int64(0);
  outC->BM_Input_MemoryBasic_1_struct.valid = kcg_true;
  outC->BM_Input_MemoryBasic_1_struct.q_dir = Q_DIR_Reverse;
  outC->BM_Input_MemoryBasic_1_struct.t_mar = kcg_lit_int64(0);
  outC->BM_Input_MemoryBasic_1_struct.t_timeoutrqst = kcg_lit_int64(0);
  outC->BM_Input_MemoryBasic_1_struct.t_cycrqst = kcg_lit_int64(0);
  outC->Init_MemoryBasic_1_struct.valid = kcg_true;
  outC->Init_MemoryBasic_1_struct.q_dir = Q_DIR_Reverse;
  outC->Init_MemoryBasic_1_struct.t_mar = kcg_lit_int64(0);
  outC->Init_MemoryBasic_1_struct.t_timeoutrqst = kcg_lit_int64(0);
  outC->Init_MemoryBasic_1_struct.t_cycrqst = kcg_lit_int64(0);
  ...
  outC->Memorized_MemoryBasic_1_struct.t_mar = kcg_lit_int64(0);
  outC->Memorized_MemoryBasic_1_struct.t_timeoutrqst = kcg_lit_int64(0);
  outC->Memorized_MemoryBasic_1_struct.t_cycrqst = kcg_lit_int64(0);
  outC->_L4_MemoryBasic_1_struct.valid = kcg_true;
  outC->_L4_MemoryBasic_1_struct.q_dir = Q_DIR_Reverse;
  outC->_L4_MemoryBasic_1_struct.t_mar = kcg_lit_int64(0);
  outC->_L4_MemoryBasic_1_struct.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L4_MemoryBasic_1_struct.t_cycrqst = kcg_lit_int64(0);
  outC->init = kcg_true;
  outC->ma_received = kcg_true;
  outC->MA_RequestParams.valid = kcg_true;
  outC->MA_RequestParams.q_dir = Q_DIR_Reverse;
  outC->MA_RequestParams.t_mar = kcg_lit_int64(0);
  outC->MA_RequestParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->MA_RequestParams.t_cycrqst = kcg_lit_int64(0);
  outC->IsNew = kcg_true;
