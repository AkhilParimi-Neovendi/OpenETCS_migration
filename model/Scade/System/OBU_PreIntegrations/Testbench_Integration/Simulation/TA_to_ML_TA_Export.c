...
void TA_to_ML_init_TA_Export(outC_TA_to_ML_TA_Export *outC)
{
  ...
  for (idx = 0; idx < 5; idx++) {
    ...
    outC->_L124[idx].v_main = kcg_lit_int64(0);
    outC->_L124[idx].v_loa = kcg_lit_int64(0);
    outC->_L124[idx].t_loa = kcg_lit_int64(0);
    outC->_L124[idx].l_section = kcg_lit_int64(0);
    outC->_L124[idx].q_sectiontimer_k = Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L124[idx].t_sectiontimer_k = kcg_lit_int64(0);
    outC->_L124[idx].d_sectiontimerstoploc_k = kcg_lit_int64(0);
    outC->_L124[idx].l_endsection = kcg_lit_int64(0);
    outC->_L124[idx].q_sectiontimer = Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L124[idx].t_sectiontimer = kcg_lit_int64(0);
    outC->_L124[idx].d_sectiontimerstoploc = kcg_lit_int64(0);
    outC->_L124[idx].q_endtimer = Q_ENDTIMER_No_End_section_timer_information;
    outC->_L124[idx].t_endtimer = kcg_lit_int64(0);
    outC->_L124[idx].d_endtimerstartloc = kcg_lit_int64(0);
    outC->_L124[idx].q_dangerpoint = Q_DANGERPOINT_No_danger_point_information;
    outC->_L124[idx].d_dp = kcg_lit_int64(0);
    outC->_L124[idx].v_releasedp = kcg_lit_int64(0);
    outC->_L124[idx].q_overlap = Q_OVERLAP_No_overlap_information;
    outC->_L124[idx].d_startol = kcg_lit_int64(0);
    outC->_L124[idx].t_ol = kcg_lit_int64(0);
    outC->_L124[idx].d_ol = kcg_lit_int64(0);
    outC->_L124[idx].v_releaseol = kcg_lit_int64(0);
  }
  ...
  for (idx1 = 0; idx1 < 7; idx1++) {
    ...
    outC->_L123.diffArray[idx1].nc_diff = kcg_lit_int64(0);
    outC->_L123.diffArray[idx1].v_diff = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 7; idx3++) {
    outC->_L123.SSPArray[idx3].valid = kcg_true;
    outC->_L123.SSPArray[idx3].d_static = kcg_lit_int64(0);
    outC->_L123.SSPArray[idx3].v_static = kcg_lit_int64(0);
    ...
    for (idx2 = 0; idx2 < 7; idx2++) {
      ...
      outC->_L123.SSPArray[idx3].diffArray[idx2].nc_cddiff =
        NC_CDDIFF_Specific_SSP_applicable_to_Cant_Deficiency_80_mm;
      outC->_L123.SSPArray[idx3].diffArray[idx2].nc_diff = kcg_lit_int64(0);
      outC->_L123.SSPArray[idx3].diffArray[idx2].v_diff = kcg_lit_int64(0);
    }
  }
  for (idx4 = 0; idx4 < 7; idx4++) {
    ...
    outC->_L122[idx4].d_gradient = kcg_lit_int64(0);
    outC->_L122[idx4].q_gdir = Q_GDIR_downhill;
    outC->_L122[idx4].g_a = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 5; idx5++) {
    ...
    outC->_L121[idx5].v_loa = kcg_lit_int64(0);
    outC->_L121[idx5].t_loa = kcg_lit_int64(0);
    outC->_L121[idx5].l_section = kcg_lit_int64(0);
    outC->_L121[idx5].q_sectiontimer_k =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L121[idx5].t_sectiontimer_k = kcg_lit_int64(0);
    outC->_L121[idx5].d_sectiontimerstoploc_k = kcg_lit_int64(0);
    outC->_L121[idx5].l_endsection = kcg_lit_int64(0);
    outC->_L121[idx5].q_sectiontimer = Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L121[idx5].t_sectiontimer = kcg_lit_int64(0);
    outC->_L121[idx5].d_sectiontimerstoploc = kcg_lit_int64(0);
    outC->_L121[idx5].q_endtimer = Q_ENDTIMER_No_End_section_timer_information;
    outC->_L121[idx5].t_endtimer = kcg_lit_int64(0);
    outC->_L121[idx5].d_endtimerstartloc = kcg_lit_int64(0);
    outC->_L121[idx5].q_dangerpoint = Q_DANGERPOINT_No_danger_point_information;
    outC->_L121[idx5].d_dp = kcg_lit_int64(0);
    outC->_L121[idx5].v_releasedp = kcg_lit_int64(0);
    outC->_L121[idx5].q_overlap = Q_OVERLAP_No_overlap_information;
    outC->_L121[idx5].d_startol = kcg_lit_int64(0);
    outC->_L121[idx5].t_ol = kcg_lit_int64(0);
    outC->_L121[idx5].d_ol = kcg_lit_int64(0);
    outC->_L121[idx5].v_releaseol = kcg_lit_int64(0);
  }
  outC->_L111 = kcg_true;
  outC->_L110 = kcg_true;
  outC->_L109 = kcg_true;
  ...
  outC->_L108.v_main = kcg_lit_int64(0);
  outC->_L108.v_loa = kcg_lit_int64(0);
  outC->_L108.t_loa = kcg_lit_int64(0);
  outC->_L108.n_iter = kcg_lit_int64(0);
  for (idx6 = 0; idx6 < 32; idx6++) {
    outC->_L108.sections[idx6].valid = kcg_true;
    outC->_L108.sections[idx6].l_section = kcg_lit_int64(0);
    outC->_L108.sections[idx6].q_sectiontimer =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L108.sections[idx6].t_sectiontimer = kcg_lit_int64(0);
    outC->_L108.sections[idx6].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->_L108.l_endsection = kcg_lit_int64(0);
  outC->_L108.q_sectiontimer = Q_SECTIONTIMER_No_Section_Timer_information;
  outC->_L108.t_sectiontimer = kcg_lit_int64(0);
  outC->_L108.d_sectiontimerstoploc = kcg_lit_int64(0);
  outC->_L108.q_endtimer = Q_ENDTIMER_No_End_section_timer_information;
  outC->_L108.t_endtimer = kcg_lit_int64(0);
  outC->_L108.d_endtimerstartloc = kcg_lit_int64(0);
  outC->_L108.q_dangerpoint = Q_DANGERPOINT_No_danger_point_information;
  outC->_L108.d_dp = kcg_lit_int64(0);
  outC->_L108.v_releasedp = kcg_lit_int64(0);
  outC->_L108.q_overlap = Q_OVERLAP_No_overlap_information;
  outC->_L108.d_startol = kcg_lit_int64(0);
  outC->_L108.t_ol = kcg_lit_int64(0);
  outC->_L108.d_ol = kcg_lit_int64(0);
  outC->_L108.v_releaseol = kcg_lit_int64(0);
  outC->_L103 = kcg_true;
  ...
  outC->_L97.BG_Common_Header.m_mcount = kcg_lit_int64(0);
  outC->_L97.BG_Common_Header.nid_c = kcg_lit_int64(0);
  outC->_L97.BG_Common_Header.nid_bg = kcg_lit_int64(0);
  outC->_L97.BG_Common_Header.q_link = Q_LINK_Unlinked;
  outC->_L97.BG_Common_Header.bgPosition.valid = kcg_true;
  outC->_L97.BG_Common_Header.bgPosition.timestamp = kcg_lit_int64(0);
  outC->_L97.BG_Common_Header.bgPosition.odo.o_nominal = kcg_lit_int64(0);
  outC->_L97.BG_Common_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->_L97.BG_Common_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
  outC->_L97.BG_Common_Header.bgPosition.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L97.BG_Common_Header.bgPosition.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L97.BG_Common_Header.bgPosition.speed.v_lower = kcg_lit_int64(0);
  outC->_L97.BG_Common_Header.bgPosition.speed.v_upper = kcg_lit_int64(0);
  outC->_L97.BG_Common_Header.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->_L97.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L97.BG_Common_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  outC->_L97.Radio_Common_Header.radioDevice = kcg_lit_int64(0);
  outC->_L97.Radio_Common_Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L97.Radio_Common_Header.nid_message = kcg_lit_int64(0);
  outC->_L97.Radio_Common_Header.t_train = kcg_lit_int64(0);
  outC->_L97.Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_required;
  outC->_L97.Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L97.Radio_Common_Header.t_train_reference = kcg_lit_int64(0);
  outC->_L97.Radio_Common_Header.nid_em = kcg_lit_int64(0);
  outC->_L97.Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L97.Radio_Common_Header.d_sr = kcg_lit_int64(0);
  outC->_L97.Radio_Common_Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L97.Radio_Common_Header.d_ref = kcg_lit_int64(0);
  outC->_L97.Radio_Common_Header.q_dir = Q_DIR_Reverse;
  outC->_L97.Radio_Common_Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L97.Radio_Common_Header.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  for (idx7 = 0; idx7 < 30; idx7++) {
    outC->_L97.packets.PacketHeaders[idx7].nid_packet = kcg_lit_int64(0);
    outC->_L97.packets.PacketHeaders[idx7].q_dir = Q_DIR_Reverse;
    outC->_L97.packets.PacketHeaders[idx7].valid = kcg_true;
    outC->_L97.packets.PacketHeaders[idx7].startAddress = kcg_lit_int64(0);
    outC->_L97.packets.PacketHeaders[idx7].endAddress = kcg_lit_int64(0);
  }
  for (idx8 = 0; idx8 < 500; idx8++) {
    outC->_L97.packets.PacketData[idx8] = kcg_lit_int64(0);
  }
  outC->_L97.sendingRBC.valid = kcg_true;
  outC->_L97.sendingRBC.nid_c = kcg_lit_int64(0);
  outC->_L97.sendingRBC.rbc_id = kcg_lit_int64(0);
  outC->_L97.sendingRBC.device_id = kcg_lit_int64(0);
  for (idx9 = 0; idx9 < 30; idx9++) {
    outC->_L99.PacketHeaders[idx9].nid_packet = kcg_lit_int64(0);
    outC->_L99.PacketHeaders[idx9].q_dir = Q_DIR_Reverse;
    outC->_L99.PacketHeaders[idx9].valid = kcg_true;
    outC->_L99.PacketHeaders[idx9].startAddress = kcg_lit_int64(0);
    outC->_L99.PacketHeaders[idx9].endAddress = kcg_lit_int64(0);
  }
  for (idx10 = 0; idx10 < 500; idx10++) {
    outC->_L99.PacketData[idx10] = kcg_lit_int64(0);
  }
  for (idx11 = 0; idx11 < 3; idx11++) {
    ...
    outC->_L86[idx11].d_mamode = kcg_lit_int64(0);
    outC->_L86[idx11].m_mamode = M_MAMODE_On_Sight;
    outC->_L86[idx11].v_mamode = kcg_lit_int64(0);
    outC->_L86[idx11].l_mamode = kcg_lit_int64(0);
    outC->_L86[idx11].l_ackmamode = kcg_lit_int64(0);
  ...
  for (idx12 = 0; idx12 < 7; idx12++) {
    ...
    outC->_L85[idx12].nid_c = kcg_lit_int64(0);
    outC->_L85[idx12].nid_bg = kcg_lit_int64(0);
  }
  for (idx13 = 0; idx13 < 7; idx13++) {
    ...
    outC->_L83[idx13].nid_ntc = kcg_lit_int64(0);
  }
  for (idx14 = 0; idx14 < 7; idx14++) {
    ...
    outC->_L81[idx14].d_leveltr = kcg_lit_int64(0);
    outC->_L81[idx14].m_leveltr = M_LEVELTR_Level_0;
    outC->_L81[idx14].nid_ntc = kcg_lit_int64(0);
    outC->_L81[idx14].l_ackleveltr = kcg_lit_int64(0);
  }
  outC->_L73.valid = kcg_true;
  outC->_L73.q_dir = Q_DIR_Reverse;
  outC->_L73.q_scale = Q_SCALE_10_cm_scale;
  outC->_L73.d_reverse = kcg_lit_int64(0);
  outC->_L73.v_reverse = kcg_lit_int64(0);
  outC->_L71.valid = kcg_true;
  outC->_L71.q_dir = Q_DIR_Reverse;
  outC->_L71.q_scale = Q_SCALE_10_cm_scale;
  outC->_L71.d_startreverse = kcg_lit_int64(0);
  outC->_L71.l_reversearea = kcg_lit_int64(0);
  ...
  for (idx15 = 0; idx15 < 30; idx15++) {
    outC->_L49.packets.PacketHeaders[idx15].nid_packet = kcg_lit_int64(0);
    outC->_L49.packets.PacketHeaders[idx15].q_dir = Q_DIR_Reverse;
    outC->_L49.packets.PacketHeaders[idx15].valid = kcg_true;
    outC->_L49.packets.PacketHeaders[idx15].startAddress = kcg_lit_int64(0);
    outC->_L49.packets.PacketHeaders[idx15].endAddress = kcg_lit_int64(0);
  }
  for (idx16 = 0; idx16 < 500; idx16++) {
    outC->_L49.packets.PacketData[idx16] = kcg_lit_int64(0);
  }
  ...
  for (idx17 = 0; idx17 < 30; idx17++) {
    outC->_L51.PacketHeaders[idx17].nid_packet = kcg_lit_int64(0);
    outC->_L51.PacketHeaders[idx17].q_dir = Q_DIR_Reverse;
    outC->_L51.PacketHeaders[idx17].valid = kcg_true;
    outC->_L51.PacketHeaders[idx17].startAddress = kcg_lit_int64(0);
    outC->_L51.PacketHeaders[idx17].endAddress = kcg_lit_int64(0);
  }
  for (idx18 = 0; idx18 < 500; idx18++) {
    outC->_L51.PacketData[idx18] = kcg_lit_int64(0);
  }
  ...
  outC->_L33.BG_Common_Header.m_mcount = kcg_lit_int64(0);
  outC->_L33.BG_Common_Header.nid_c = kcg_lit_int64(0);
  outC->_L33.BG_Common_Header.nid_bg = kcg_lit_int64(0);
  outC->_L33.BG_Common_Header.q_link = Q_LINK_Unlinked;
  outC->_L33.BG_Common_Header.bgPosition.valid = kcg_true;
  outC->_L33.BG_Common_Header.bgPosition.timestamp = kcg_lit_int64(0);
  outC->_L33.BG_Common_Header.bgPosition.odo.o_nominal = kcg_lit_int64(0);
  outC->_L33.BG_Common_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->_L33.BG_Common_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
  outC->_L33.BG_Common_Header.bgPosition.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L33.BG_Common_Header.bgPosition.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L33.BG_Common_Header.bgPosition.speed.v_lower = kcg_lit_int64(0);
  outC->_L33.BG_Common_Header.bgPosition.speed.v_upper = kcg_lit_int64(0);
  outC->_L33.BG_Common_Header.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->_L33.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L33.BG_Common_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  outC->_L33.Radio_Common_Header.radioDevice = kcg_lit_int64(0);
  outC->_L33.Radio_Common_Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L33.Radio_Common_Header.nid_message = kcg_lit_int64(0);
  outC->_L33.Radio_Common_Header.t_train = kcg_lit_int64(0);
  outC->_L33.Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_required;
  outC->_L33.Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L33.Radio_Common_Header.t_train_reference = kcg_lit_int64(0);
  outC->_L33.Radio_Common_Header.nid_em = kcg_lit_int64(0);
  outC->_L33.Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L33.Radio_Common_Header.d_sr = kcg_lit_int64(0);
  outC->_L33.Radio_Common_Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L33.Radio_Common_Header.d_ref = kcg_lit_int64(0);
  outC->_L33.Radio_Common_Header.q_dir = Q_DIR_Reverse;
  outC->_L33.Radio_Common_Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L33.Radio_Common_Header.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  for (idx19 = 0; idx19 < 30; idx19++) {
    outC->_L33.packets.PacketHeaders[idx19].nid_packet = kcg_lit_int64(0);
    outC->_L33.packets.PacketHeaders[idx19].q_dir = Q_DIR_Reverse;
    outC->_L33.packets.PacketHeaders[idx19].valid = kcg_true;
    outC->_L33.packets.PacketHeaders[idx19].startAddress = kcg_lit_int64(0);
    outC->_L33.packets.PacketHeaders[idx19].endAddress = kcg_lit_int64(0);
  }
  for (idx20 = 0; idx20 < 500; idx20++) {
    outC->_L33.packets.PacketData[idx20] = kcg_lit_int64(0);
  }
  outC->_L33.sendingRBC.valid = kcg_true;
  outC->_L33.sendingRBC.nid_c = kcg_lit_int64(0);
  outC->_L33.sendingRBC.rbc_id = kcg_lit_int64(0);
  outC->_L33.sendingRBC.device_id = kcg_lit_int64(0);
  outC->_L32 = kcg_true;
  ...
  for (idx21 = 0; idx21 < 5; idx21++) {
    ...
    outC->_L6.P_12[idx21].v_main = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].v_loa = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].t_loa = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].l_section = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].q_sectiontimer_k =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L6.P_12[idx21].t_sectiontimer_k = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].d_sectiontimerstoploc_k = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].l_endsection = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].q_sectiontimer =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L6.P_12[idx21].t_sectiontimer = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].d_sectiontimerstoploc = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].q_endtimer = Q_ENDTIMER_No_End_section_timer_information;
    outC->_L6.P_12[idx21].t_endtimer = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].d_endtimerstartloc = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].q_dangerpoint = Q_DANGERPOINT_No_danger_point_information;
    outC->_L6.P_12[idx21].d_dp = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].v_releasedp = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].q_overlap = Q_OVERLAP_No_overlap_information;
    outC->_L6.P_12[idx21].d_startol = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].t_ol = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].d_ol = kcg_lit_int64(0);
    outC->_L6.P_12[idx21].v_releaseol = kcg_lit_int64(0);
  }
  ...
  outC->_L6.P_138.d_startreverse = kcg_lit_int64(0);
  outC->_L6.P_138.l_reversearea = kcg_lit_int64(0);
  outC->_L6.P_139.valid = kcg_true;
  outC->_L6.P_139.q_dir = Q_DIR_Reverse;
  outC->_L6.P_139.q_scale = Q_SCALE_10_cm_scale;
  outC->_L6.P_139.d_reverse = kcg_lit_int64(0);
  outC->_L6.P_139.v_reverse = kcg_lit_int64(0);
  for (idx22 = 0; idx22 < 5; idx22++) {
    ...
    outC->_L6.P_15[idx22].v_loa = kcg_lit_int64(0);
    outC->_L6.P_15[idx22].t_loa = kcg_lit_int64(0);
    outC->_L6.P_15[idx22].l_section = kcg_lit_int64(0);
    outC->_L6.P_15[idx22].q_sectiontimer_k =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L6.P_15[idx22].t_sectiontimer_k = kcg_lit_int64(0);
    outC->_L6.P_15[idx22].d_sectiontimerstoploc_k = kcg_lit_int64(0);
    outC->_L6.P_15[idx22].l_endsection = kcg_lit_int64(0);
    outC->_L6.P_15[idx22].q_sectiontimer =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L6.P_15[idx22].t_sectiontimer = kcg_lit_int64(0);
    outC->_L6.P_15[idx22].d_sectiontimerstoploc = kcg_lit_int64(0);
    outC->_L6.P_15[idx22].q_endtimer = Q_ENDTIMER_No_End_section_timer_information;
    outC->_L6.P_15[idx22].t_endtimer = kcg_lit_int64(0);
    outC->_L6.P_15[idx22].d_endtimerstartloc = kcg_lit_int64(0);
    outC->_L6.P_15[idx22].q_dangerpoint = Q_DANGERPOINT_No_danger_point_information;
    outC->_L6.P_15[idx22].d_dp = kcg_lit_int64(0);
    outC->_L6.P_15[idx22].v_releasedp = kcg_lit_int64(0);
    outC->_L6.P_15[idx22].q_overlap = Q_OVERLAP_No_overlap_information;
    outC->_L6.P_15[idx22].d_startol = kcg_lit_int64(0);
    outC->_L6.P_15[idx22].t_ol = kcg_lit_int64(0);
    outC->_L6.P_15[idx22].d_ol = kcg_lit_int64(0);
    outC->_L6.P_15[idx22].v_releaseol = kcg_lit_int64(0);
  }
  for (idx23 = 0; idx23 < 7; idx23++) {
    ...
    outC->_L6.P_21[idx23].d_gradient = kcg_lit_int64(0);
    outC->_L6.P_21[idx23].q_gdir = Q_GDIR_downhill;
    outC->_L6.P_21[idx23].g_a = kcg_lit_int64(0);
  }
  outC->_L6.P_27.valid = kcg_true;
  outC->_L6.P_27.q_dir = Q_DIR_Reverse;
  outC->_L6.P_27.q_scale = Q_SCALE_10_cm_scale;
  outC->_L6.P_27.d_static = kcg_lit_int64(0);
  outC->_L6.P_27.v_static = kcg_lit_int64(0);
  ...
  for (idx24 = 0; idx24 < 7; idx24++) {
    ...
    outC->_L6.P_27.diffArray[idx24].nc_cddiff =
      NC_CDDIFF_Specific_SSP_applicable_to_Cant_Deficiency_80_mm;
    outC->_L6.P_27.diffArray[idx24].nc_diff = kcg_lit_int64(0);
    outC->_L6.P_27.diffArray[idx24].v_diff = kcg_lit_int64(0);
  }
  for (idx26 = 0; idx26 < 7; idx26++) {
    outC->_L6.P_27.SSPArray[idx26].valid = kcg_true;
    outC->_L6.P_27.SSPArray[idx26].d_static = kcg_lit_int64(0);
    outC->_L6.P_27.SSPArray[idx26].v_static = kcg_lit_int64(0);
    ...
    for (idx25 = 0; idx25 < 7; idx25++) {
      ...
      outC->_L6.P_27.SSPArray[idx26].diffArray[idx25].nc_cddiff =
        NC_CDDIFF_Specific_SSP_applicable_to_Cant_Deficiency_80_mm;
      outC->_L6.P_27.SSPArray[idx26].diffArray[idx25].nc_diff = kcg_lit_int64(0);
      outC->_L6.P_27.SSPArray[idx26].diffArray[idx25].v_diff = kcg_lit_int64(0);
    }
  }
  for (idx27 = 0; idx27 < 7; idx27++) {
    ...
    outC->_L6.P_41[idx27].d_leveltr = kcg_lit_int64(0);
    outC->_L6.P_41[idx27].m_leveltr = M_LEVELTR_Level_0;
    outC->_L6.P_41[idx27].nid_ntc = kcg_lit_int64(0);
    outC->_L6.P_41[idx27].l_ackleveltr = kcg_lit_int64(0);
  }
  for (idx28 = 0; idx28 < 7; idx28++) {
    ...
    outC->_L6.P_46[idx28].nid_ntc = kcg_lit_int64(0);
  }
  for (idx29 = 0; idx29 < 7; idx29++) {
    ...
    outC->_L6.P_63[idx29].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L6.P_63[idx29].nid_c = kcg_lit_int64(0);
    outC->_L6.P_63[idx29].nid_bg = kcg_lit_int64(0);
  }
  for (idx30 = 0; idx30 < 3; idx30++) {
    ...
    outC->_L6.P_80[idx30].d_mamode = kcg_lit_int64(0);
    outC->_L6.P_80[idx30].m_mamode = M_MAMODE_On_Sight;
    outC->_L6.P_80[idx30].v_mamode = kcg_lit_int64(0);
    outC->_L6.P_80[idx30].l_mamode = kcg_lit_int64(0);
    outC->_L6.P_80[idx30].l_ackmamode = kcg_lit_int64(0);
  ...
  for (idx31 = 0; idx31 < 5; idx31++) {
    ...
    outC->Data_to_From_Track_Packets_at_ML.P_12[idx31].q_scale =
      Q_SCALE_10_cm_scale;
    outC->Data_to_From_Track_Packets_at_ML.P_12[idx31].v_main = kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_12[idx31].v_loa = kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_12[idx31].t_loa = kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_12[idx31].l_section = kcg_lit_int64(0);
    ...
    outC->Data_to_From_Track_Packets_at_ML.P_12[idx31].d_dp = kcg_lit_int64(0);
    ...
    outC->Data_to_From_Track_Packets_at_ML.P_12[idx31].d_startol = kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_12[idx31].t_ol = kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_12[idx31].d_ol = kcg_lit_int64(0);
  ...
  outC->Data_to_From_Track_Packets_at_ML.P_138.d_startreverse = kcg_lit_int64(0);
  outC->Data_to_From_Track_Packets_at_ML.P_138.l_reversearea = kcg_lit_int64(0);
  ...
  outC->Data_to_From_Track_Packets_at_ML.P_139.d_reverse = kcg_lit_int64(0);
  outC->Data_to_From_Track_Packets_at_ML.P_139.v_reverse = kcg_lit_int64(0);
  for (idx32 = 0; idx32 < 5; idx32++) {
    ...
    outC->Data_to_From_Track_Packets_at_ML.P_15[idx32].q_scale =
      Q_SCALE_10_cm_scale;
    outC->Data_to_From_Track_Packets_at_ML.P_15[idx32].v_loa = kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_15[idx32].t_loa = kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_15[idx32].l_section = kcg_lit_int64(0);
    ...
    outC->Data_to_From_Track_Packets_at_ML.P_15[idx32].q_dangerpoint =
      Q_DANGERPOINT_No_danger_point_information;
    outC->Data_to_From_Track_Packets_at_ML.P_15[idx32].d_dp = kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_15[idx32].v_releasedp =
      kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_15[idx32].q_overlap =
      Q_OVERLAP_No_overlap_information;
    outC->Data_to_From_Track_Packets_at_ML.P_15[idx32].d_startol = kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_15[idx32].t_ol = kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_15[idx32].d_ol = kcg_lit_int64(0);
  ...
  for (idx33 = 0; idx33 < 7; idx33++) {
    ...
    outC->Data_to_From_Track_Packets_at_ML.P_21[idx33].g_a = kcg_lit_int64(0);
  }
  ...
  outC->Data_to_From_Track_Packets_at_ML.P_27.d_static = kcg_lit_int64(0);
  outC->Data_to_From_Track_Packets_at_ML.P_27.v_static = kcg_lit_int64(0);
  ...
  for (idx37 = 0; idx37 < 7; idx37++) {
    ...
    outC->Data_to_From_Track_Packets_at_ML.P_41[idx37].q_scale =
      Q_SCALE_10_cm_scale;
    outC->Data_to_From_Track_Packets_at_ML.P_41[idx37].d_leveltr = kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_41[idx37].m_leveltr =
      M_LEVELTR_Level_0;
    outC->Data_to_From_Track_Packets_at_ML.P_41[idx37].nid_ntc = kcg_lit_int64(0);
  ...
  for (idx38 = 0; idx38 < 7; idx38++) {
    ...
    outC->Data_to_From_Track_Packets_at_ML.P_46[idx38].m_leveltr =
      M_LEVELTR_Level_0;
    outC->Data_to_From_Track_Packets_at_ML.P_46[idx38].nid_ntc = kcg_lit_int64(0);
  }
  for (idx39 = 0; idx39 < 7; idx39++) {
    ...
    outC->Data_to_From_Track_Packets_at_ML.P_63[idx39].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->Data_to_From_Track_Packets_at_ML.P_63[idx39].nid_c = kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_63[idx39].nid_bg = kcg_lit_int64(0);
  }
  for (idx40 = 0; idx40 < 3; idx40++) {
    ...
    outC->Data_to_From_Track_Packets_at_ML.P_80[idx40].q_scale =
      Q_SCALE_10_cm_scale;
    outC->Data_to_From_Track_Packets_at_ML.P_80[idx40].d_mamode = kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_80[idx40].m_mamode = M_MAMODE_On_Sight;
    outC->Data_to_From_Track_Packets_at_ML.P_80[idx40].v_mamode = kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_80[idx40].l_mamode = kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_80[idx40].l_ackmamode =
      kcg_lit_int64(0);
    outC->Data_to_From_Track_Packets_at_ML.P_80[idx40].q_mamode =
      Q_MAMODE_as_the_EOA;
  }
  outC->Data_to_From_Track_Packets_at_ML.LRBG = kcg_lit_int64(0);
  outC->Data_to_From_Track_Packets_at_ML.referenceLocation = kcg_lit_int64(0);
  /* _L69=(TM_specific::Read_P137_Legacy#1)/ */
