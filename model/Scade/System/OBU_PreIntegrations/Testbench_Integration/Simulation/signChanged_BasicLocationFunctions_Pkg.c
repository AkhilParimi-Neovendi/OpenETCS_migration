...
void kcg_save_SV_signChanged_BasicLocationFunctions_Pkg(
  SV_signChanged_BasicLocationFunctions_Pkg *SV,
  outC_signChanged_BasicLocationFunctions_Pkg *outC)
{
  SV->Context_mem_val = outC->mem_val;
}

void kcg_load_SV_signChanged_BasicLocationFunctions_Pkg(
  outC_signChanged_BasicLocationFunctions_Pkg *outC,
  SV_signChanged_BasicLocationFunctions_Pkg *SV)
{
  outC->mem_val = SV->Context_mem_val;
}
