  ...
  outC_RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_RBC_Messaging_Pkg_RBC_Consistency_Pkg *outC)
{
  ...
  /* IfBlock1:then:_L4=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::RadioTrainTrackMessageConsistencyChecker__HasConsistentHeader#1)/ */
  RadioTrainTrackMessageConsistencyChecker__HasConsistentHeader_init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_RadioTrainTrackMessageConsistencyChecker__HasConsistentHeader_1);
  /* IfBlock1:then:_L1=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets#1)/ */
  RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets_init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets_1);
  /* _L5=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__IsPresent#1)/ */
...
{
  /* IfBlock1:then:_L4=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::RadioTrainTrackMessageConsistencyChecker__HasConsistentHeader#1)/ */
  RadioTrainTrackMessageConsistencyChecker__HasConsistentHeader_reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_RadioTrainTrackMessageConsistencyChecker__HasConsistentHeader_1);
  /* IfBlock1:then:_L1=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets#1)/ */
  RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets_reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets_1);
  /* _L5=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__IsPresent#1)/ */
...
void kcg_save_SV_RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
  SV_RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_RBC_Messaging_Pkg_RBC_Consistency_Pkg *SV,
  outC_RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_RBC_Messaging_Pkg_RBC_Consistency_Pkg *outC)
{
  SV->Context_lastReceivedRadioTrainTrackMessageTimestamp =
    outC->lastReceivedRadioTrainTrackMessageTimestamp;
}

void kcg_load_SV_RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
  outC_RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_RBC_Messaging_Pkg_RBC_Consistency_Pkg *outC,
  SV_RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_RBC_Messaging_Pkg_RBC_Consistency_Pkg *SV)
{
  outC->lastReceivedRadioTrainTrackMessageTimestamp =
