...
typedef struct {
  ...
  kcg_bool /* UNCONDITIONAL_EMERGENCY_STOP_SM: */ Context_UNCONDITIONAL_EMERGENCY_STOP_SM_reset_nxt;
  kcg_bool /* UNCONDITIONAL_EMERGENCY_STOP_SM: */ Context_UNCONDITIONAL_EMERGENCY_STOP_SM_reset_act;
  SSM_ST_UNCONDITIONAL_EMERGENCY_STOP_SM /* UNCONDITIONAL_EMERGENCY_STOP_SM: */ Context_UNCONDITIONAL_EMERGENCY_STOP_SM_state_nxt;
  kcg_bool /* validAck/ */ Context_validAck;
  kcg_bool /* invalidAck/ */ Context_invalidAck;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
} SV_RBC__ProcessUnconditionalEmergencyStop_RBC_Model_Pkg;

extern void kcg_save_SV_RBC__ProcessUnconditionalEmergencyStop_RBC_Model_Pkg(
  SV_RBC__ProcessUnconditionalEmergencyStop_RBC_Model_Pkg *SV,
  outC_RBC__ProcessUnconditionalEmergencyStop_RBC_Model_Pkg *outC);
extern void kcg_load_SV_RBC__ProcessUnconditionalEmergencyStop_RBC_Model_Pkg(
  outC_RBC__ProcessUnconditionalEmergencyStop_RBC_Model_Pkg *outC,
  SV_RBC__ProcessUnconditionalEmergencyStop_RBC_Model_Pkg *SV);
