  ...
  outC_cyclicReportToDMI_manage_DMI_Output_Pkg *outC)
{
  ...
  outC->_L12.DMI_Identifier.systemTime = kcg_lit_int64(0);
  ...
  outC->_L12.DMI_Identifier.l_name = kcg_lit_int64(0);
  ...
  outC->_L1_then_IfBlock1.location_front_train = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.location_brake_target = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.v_target = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.v_permitted = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.v_release = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.location_brake_curve_starting_point = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.v_intervention = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.mode = M_MODE_Full_Supervision;
  outC->_L1_then_IfBlock1.level.level = M_LEVEL_Level_0;
  outC->_L1_then_IfBlock1.level.nid_stm = kcg_lit_int64(0);
  ...
  outC->_L1_then_IfBlock1.location_LOA = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.v_LOA = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.location_KP_Balise_Track = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.distance_KP_Balise = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.distance_to_TSA = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.radioConnectionStatus =
    conn_unknown_API_RadioCommunication_Pkg;
  outC->_L1_then_IfBlock1.distanceIndicationPoint = kcg_lit_int64(0);
  outC->_L10_then_IfBlock1 = kcg_lit_int64(0);
  outC->_L11_then_IfBlock1.valid = kcg_true;
  outC->_L11_then_IfBlock1.timestamp = kcg_lit_int64(0);
  outC->_L11_then_IfBlock1.odo.o_nominal = kcg_lit_int64(0);
  outC->_L11_then_IfBlock1.odo.o_min = kcg_lit_int64(0);
  outC->_L11_then_IfBlock1.odo.o_max = kcg_lit_int64(0);
  outC->_L11_then_IfBlock1.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L11_then_IfBlock1.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L11_then_IfBlock1.speed.v_lower = kcg_lit_int64(0);
  outC->_L11_then_IfBlock1.speed.v_upper = kcg_lit_int64(0);
  outC->_L11_then_IfBlock1.acceleration = kcg_lit_int64(0);
  ...
  outC->_L12_then_IfBlock1.timestamp = kcg_lit_int64(0);
  ...
  outC->_L12_then_IfBlock1.trainPosition.nominal = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.trainPosition.d_min = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.trainPosition.d_max = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.estimatedFrontEndPosition = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.minSafeFrontEndPosition = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.maxSafeFrontEndPostion = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.LRBG.valid = kcg_true;
  outC->_L12_then_IfBlock1.LRBG.nid_c = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.LRBG.nid_bg = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.LRBG.q_link = Q_LINK_Unlinked;
  outC->_L12_then_IfBlock1.LRBG.location.nominal = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.LRBG.location.d_min = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.LRBG.location.d_max = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.LRBG.seqNoOnTrack = kcg_lit_int64(0);
  ...
  outC->_L12_then_IfBlock1.LRBG.infoFromLinking.expectedLocation.d_max =
    kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.LRBG.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.LRBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.LRBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  ...
  outC->_L12_then_IfBlock1.LRBG.infoFromPassing.BG_Header.m_mcount =
    kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.LRBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(
      0);
  ...
  outC->_L12_then_IfBlock1.prvLRBG.nid_c = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.prvLRBG.nid_bg = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.prvLRBG.q_link = Q_LINK_Unlinked;
  outC->_L12_then_IfBlock1.prvLRBG.location.nominal = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.prvLRBG.location.d_min = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.prvLRBG.location.d_max = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.prvLRBG.seqNoOnTrack = kcg_lit_int64(0);
  ...
  outC->_L12_then_IfBlock1.prvLRBG.infoFromLinking.d_link.nominal =
    kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.prvLRBG.infoFromLinking.d_link.d_min = kcg_lit_int64(
      0);
  outC->_L12_then_IfBlock1.prvLRBG.infoFromLinking.d_link.d_max = kcg_lit_int64(
      0);
  ...
  outC->_L12_then_IfBlock1.estimatedRearEndPosition = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.minSafeRearEndPosition = kcg_lit_int64(0);
  outC->_L12_then_IfBlock1.maxSafeRearEndPosition = kcg_lit_int64(0);
  outC->_L13_then_IfBlock1.valid = kcg_true;
  outC->_L13_then_IfBlock1.targetSpeed = kcg_lit_int64(0);
  outC->_L13_then_IfBlock1.permittedSpeed = kcg_lit_int64(0);
  outC->_L13_then_IfBlock1.releaseSpeed = kcg_lit_int64(0);
  outC->_L13_then_IfBlock1.locationBrakeTarget = kcg_lit_int64(0);
  outC->_L13_then_IfBlock1.location_brake_curve_starting_point = kcg_lit_int64(0);
  outC->_L13_then_IfBlock1.interventionSpeed = kcg_lit_int64(0);
  ...
  outC->_L13_then_IfBlock1.distanceIndicationPoint = kcg_lit_int64(0);
  ...
  outC->_L16_then_IfBlock1.location_LOA = kcg_lit_int64(0);
  outC->_L16_then_IfBlock1.v_LOA = kcg_lit_int64(0);
  outC->_L19_then_IfBlock1 = kcg_lit_int64(0);
  outC->_L20_then_IfBlock1.registration.valid = kcg_true;
  outC->_L20_then_IfBlock1.registration.mobileDeviceNo = kcg_lit_int64(0);
  ...
  outC->_L20_then_IfBlock1.registration.nid_mn = kcg_lit_int64(0);
  outC->_L20_then_IfBlock1.connection.valid = kcg_true;
  outC->_L20_then_IfBlock1.connection.mobileDeviceNo = kcg_lit_int64(0);
  ...
  outC->_L20_then_IfBlock1.session.nid_c = kcg_lit_int64(0);
  outC->_L20_then_IfBlock1.session.nid_rbc = kcg_lit_int64(0);
