...
void kcg_save_SV_op_3_6_5_1_4_e_h_k_ProvidePositionReport_Pkg(
  SV_op_3_6_5_1_4_e_h_k_ProvidePositionReport_Pkg *SV,
  outC_op_3_6_5_1_4_e_h_k_ProvidePositionReport_Pkg *outC)
{
  kcg_copy_RBC_Communication_T_ProvidePositionReport_Pkg(
    &SV->Context_mem_rbcComm,
    &outC->mem_rbcComm);
  kcg_copy_LocationBasedEvents_T_ProvidePositionReport_Pkg(
    &SV->Context_mem_trackInfo,
    &outC->mem_trackInfo);
}

void kcg_load_SV_op_3_6_5_1_4_e_h_k_ProvidePositionReport_Pkg(
  outC_op_3_6_5_1_4_e_h_k_ProvidePositionReport_Pkg *outC,
  SV_op_3_6_5_1_4_e_h_k_ProvidePositionReport_Pkg *SV)
{
  kcg_copy_RBC_Communication_T_ProvidePositionReport_Pkg(
