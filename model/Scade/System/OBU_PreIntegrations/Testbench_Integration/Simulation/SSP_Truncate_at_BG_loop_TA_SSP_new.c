  ...
  outC_SSP_Truncate_at_BG_loop_TA_SSP_new *outC)
{
  ...
  outC->_L8.d_static_abs = kcg_lit_int64(0);
  outC->_L8.d_static_LRBG = kcg_lit_int64(0);
  outC->_L8.q_train_length_corr = kcg_true;
  outC->_L8.v_static = kcg_lit_int64(0);
  ...
  for (idx1 = 0; idx1 < 50; idx1++) {
    ...
    outC->_L3[idx1].d_static_abs = kcg_lit_int64(0);
    outC->_L3[idx1].d_static_LRBG = kcg_lit_int64(0);
    outC->_L3[idx1].q_train_length_corr = kcg_true;
    outC->_L3[idx1].v_static = kcg_lit_int64(0);
  }
  ...
  for (idx3 = 0; idx3 < 50; idx3++) {
    ...
    outC->Profile_out[idx3].d_static_abs = kcg_lit_int64(0);
    outC->Profile_out[idx3].d_static_LRBG = kcg_lit_int64(0);
    outC->Profile_out[idx3].q_train_length_corr = kcg_true;
    outC->Profile_out[idx3].v_static = kcg_lit_int64(0);
  }
  outC->cont = kcg_true;
}
