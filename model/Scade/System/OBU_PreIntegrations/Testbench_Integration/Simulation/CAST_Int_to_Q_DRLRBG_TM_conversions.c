...
void CAST_Int_to_Q_DRLRBG_TM_conversions(
  /* q_drlrbg_int/ */
  kcg_int64 q_drlrbg_int,
  outC_CAST_Int_to_Q_DRLRBG_TM_conversions *outC)
{
  /* q_dlrbg/ */
  static Q_DLRBG q_dlrbg_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* q_dlrbg/ */
  static Q_DLRBG _1_q_dlrbg_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* q_dlrbg/ */
  static Q_DLRBG _3_q_dlrbg_partial;
  /* error/ */
  static kcg_bool _4_error_partial;
  /* q_dlrbg/ */
  static Q_DLRBG _5_q_dlrbg_partial;
  /* error/ */
  static kcg_bool _6_error_partial;
  /* error/ */
  static kcg_bool _7_error_partial;
  /* q_dlrbg/ */
  static Q_DLRBG _8_q_dlrbg_partial;
  /* error/ */
  static kcg_bool _9_error_partial;
  /* q_dlrbg/ */
  static Q_DLRBG _10_q_dlrbg_partial;
  static kcg_bool noname;

  outC->_L12 = q_drlrbg_int;
  outC->q_drlrbg_in = outC->_L12;
  outC->IfBlock1_clock = outC->q_drlrbg_in == INT_Q_DLRBG_nominal_TM_conversions;
  /* IfBlock1: */
  if (outC->IfBlock1_clock) {
    outC->_L5_then_IfBlock1 = kcg_false;
    error_partial = outC->_L5_then_IfBlock1;
    outC->_L4_then_IfBlock1 = ENUM_Q_DLRBG_nominal_TM_conversions;
    q_dlrbg_partial = outC->_L4_then_IfBlock1;
    outC->q_dlrbg = q_dlrbg_partial;
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      outC->_L3_then_else_IfBlock1 = ENUM_Q_DLRBG_reverse_TM_conversions;
      _10_q_dlrbg_partial = outC->_L3_then_else_IfBlock1;
      _1_q_dlrbg_partial = _10_q_dlrbg_partial;
      ...
      if (outC->else_clock_else_IfBlock1) {
        ...
        outC->_L2_then_else_else_IfBlock1 = ENUM_Q_DLRBG_unknown_TM_conversions;
        _3_q_dlrbg_partial = outC->_L2_then_else_else_IfBlock1;
        _8_q_dlrbg_partial = _3_q_dlrbg_partial;
        _7_error_partial = _4_error_partial;
      }
      else {
        outC->_L2_else_else_else_IfBlock1 = ENUM_Q_DLRBG_unknown_TM_conversions;
        outC->_L1_else_else_else_IfBlock1 = kcg_true;
        _6_error_partial = outC->_L1_else_else_else_IfBlock1;
        _5_q_dlrbg_partial = outC->_L2_else_else_else_IfBlock1;
        _8_q_dlrbg_partial = _5_q_dlrbg_partial;
        _7_error_partial = _6_error_partial;
      }
      _1_q_dlrbg_partial = _8_q_dlrbg_partial;
      _2_error_partial = _7_error_partial;
    }
    outC->q_dlrbg = _1_q_dlrbg_partial;
