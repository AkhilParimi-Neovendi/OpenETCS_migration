  ...
  outC_MergeMsg_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  kcg_copy__95_array(&outC->_L43, AuxiQueue);
  /* _L47/ */
  for (idx = 0; idx < 10; idx++) {
    kcg_copy__95_array(&outC->_L47[idx], &outC->_L43);
  }
  outC->_L45 = num;
  /* _L46/ */
  ...
  kcg_copy__95_array(&outC->_L14, impQueue);
  /* _L40/ */
  for (idx2 = 0; idx2 < 10; idx2++) {
    kcg_copy__95_array(&outC->_L40[idx2], &outC->_L14);
  }
  kcg_copy__95_array(&outC->_L39, &outC->_L43);
  /* _L39= */
  for (idx3 = 0; idx3 < 10; idx3++) {
    kcg_copy__95_array(&acc, &outC->_L39);
  ...
  kcg_copy__95_array(&outC->OutQueue, &outC->_L39);
}
  ...
  outC_MergeMsg_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  for (idx3 = 0; idx3 < 10; idx3++) {
    for (idx2 = 0; idx2 < 10; idx2++) {
      ...
      outC->_L47[idx3][idx2].dmi_msg.system_clock = kcg_lit_int64(0);
      outC->_L47[idx3][idx2].dmi_msg.textMessage_ID = kcg_lit_int64(0);
      outC->_L47[idx3][idx2].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
      outC->_L47[idx3][idx2].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx7 = 0; idx7 < 10; idx7++) {
    for (idx6 = 0; idx6 < 10; idx6++) {
      ...
      outC->_L40[idx7][idx6].dmi_msg.system_clock = kcg_lit_int64(0);
      outC->_L40[idx7][idx6].dmi_msg.textMessage_ID = kcg_lit_int64(0);
      outC->_L40[idx7][idx6].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
      outC->_L40[idx7][idx6].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx9 = 0; idx9 < 10; idx9++) {
    ...
    outC->_L43[idx9].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L43[idx9].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L43[idx9].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L43[idx9].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx11 = 0; idx11 < 10; idx11++) {
    ...
    outC->_L39[idx11].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L39[idx11].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L39[idx11].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L39[idx11].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx13 = 0; idx13 < 10; idx13++) {
    ...
    outC->_L14[idx13].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L14[idx13].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L14[idx13].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L14[idx13].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx15 = 0; idx15 < 10; idx15++) {
    ...
    outC->OutQueue[idx15].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->OutQueue[idx15].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->OutQueue[idx15].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->OutQueue[idx15].dmi_msg.l_text = kcg_lit_int64(0);
