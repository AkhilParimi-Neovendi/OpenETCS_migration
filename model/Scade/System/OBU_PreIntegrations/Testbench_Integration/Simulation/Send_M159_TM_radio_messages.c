  ...
  outC_Send_M159_TM_radio_messages *outC)
{
  ...
  kcg_copy_array_int32_42(&outC->_L21[8], &outC->_L11);
...
void Send_M159_init_TM_radio_messages(outC_Send_M159_TM_radio_messages *outC)
{
  ...
  outC->_L14.Message.nid_message = kcg_lit_int32(0);
  outC->_L14.Message.l_message = kcg_lit_int32(0);
  outC->_L14.Message.t_train = kcg_lit_int32(0);
  outC->_L14.Message.nid_engine = kcg_lit_int32(0);
  outC->_L14.Message.field1 = kcg_lit_int32(0);
  outC->_L14.Message.field2 = kcg_lit_int32(0);
  outC->_L14.Message.field3 = kcg_lit_int32(0);
  for (idx = 0; idx < 50; idx++) {
    outC->_L14.OptionalPackets[idx] = kcg_lit_int32(0);
  }
  ...
  for (idx2 = 0; idx2 < 50; idx2++) {
    outC->_L12.OptionalPackets[idx2] = kcg_lit_int32(0);
  }
  outC->_L15 = kcg_lit_int32(0);
  for (idx4 = 0; idx4 < 5; idx4++) {
    outC->_L18[idx4].Message.valid = kcg_true;
    outC->_L18[idx4].Message.nid_message = kcg_lit_int32(0);
    outC->_L18[idx4].Message.l_message = kcg_lit_int32(0);
    outC->_L18[idx4].Message.t_train = kcg_lit_int32(0);
    outC->_L18[idx4].Message.nid_engine = kcg_lit_int32(0);
    outC->_L18[idx4].Message.field1 = kcg_lit_int32(0);
    outC->_L18[idx4].Message.field2 = kcg_lit_int32(0);
    outC->_L18[idx4].Message.field3 = kcg_lit_int32(0);
    for (idx3 = 0; idx3 < 50; idx3++) {
      outC->_L18[idx4].OptionalPackets[idx3] = kcg_lit_int32(0);
    }
  }
  for (idx6 = 0; idx6 < 5; idx6++) {
    outC->_L20[idx6].Message.valid = kcg_true;
    outC->_L20[idx6].Message.nid_message = kcg_lit_int32(0);
    outC->_L20[idx6].Message.l_message = kcg_lit_int32(0);
    outC->_L20[idx6].Message.t_train = kcg_lit_int32(0);
    outC->_L20[idx6].Message.nid_engine = kcg_lit_int32(0);
    outC->_L20[idx6].Message.field1 = kcg_lit_int32(0);
    outC->_L20[idx6].Message.field2 = kcg_lit_int32(0);
    outC->_L20[idx6].Message.field3 = kcg_lit_int32(0);
    for (idx5 = 0; idx5 < 50; idx5++) {
      outC->_L20[idx6].OptionalPackets[idx5] = kcg_lit_int32(0);
    }
  }
  outC->_L10 = kcg_lit_int32(0);
  for (idx7 = 0; idx7 < 42; idx7++) {
    outC->_L11[idx7] = kcg_lit_int32(0);
  }
  for (idx8 = 0; idx8 < 8; idx8++) {
    outC->_L9[idx8] = kcg_lit_int32(0);
  }
  ...
  for (idx9 = 0; idx9 < 5; idx9++) {
    outC->_L7.nid_radio[idx9] = kcg_lit_int32(0);
  }
  outC->_L6 =
  ...
  for (idx11 = 0; idx11 < 5; idx11++) {
    ...
    outC->MessageBus_out[idx11].Message.nid_message = kcg_lit_int32(0);
    outC->MessageBus_out[idx11].Message.l_message = kcg_lit_int32(0);
    outC->MessageBus_out[idx11].Message.t_train = kcg_lit_int32(0);
    outC->MessageBus_out[idx11].Message.nid_engine = kcg_lit_int32(0);
    outC->MessageBus_out[idx11].Message.field1 = kcg_lit_int32(0);
    outC->MessageBus_out[idx11].Message.field2 = kcg_lit_int32(0);
    outC->MessageBus_out[idx11].Message.field3 = kcg_lit_int32(0);
    for (idx10 = 0; idx10 < 50; idx10++) {
      outC->MessageBus_out[idx11].OptionalPackets[idx10] = kcg_lit_int32(0);
    }
  }
  /* _L20=(TM_TrainTrack_Bus::MergeMessageToBus#1)/ */
