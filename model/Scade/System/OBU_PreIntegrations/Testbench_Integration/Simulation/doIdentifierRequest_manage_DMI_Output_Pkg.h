...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
} SV_doIdentifierRequest_manage_DMI_Output_Pkg;

extern void kcg_save_SV_doIdentifierRequest_manage_DMI_Output_Pkg(
  SV_doIdentifierRequest_manage_DMI_Output_Pkg *SV,
  outC_doIdentifierRequest_manage_DMI_Output_Pkg *outC);
extern void kcg_load_SV_doIdentifierRequest_manage_DMI_Output_Pkg(
  outC_doIdentifierRequest_manage_DMI_Output_Pkg *outC,
  SV_doIdentifierRequest_manage_DMI_Output_Pkg *SV);
