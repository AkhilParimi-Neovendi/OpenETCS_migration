  ...
  outC_countPackets_xdebugSupport_Pkg *outC)
{
  ...
  for (idx1 = 0; idx1 < 30; idx1++) {
    outC->_L10.PacketHeaders[idx1].nid_packet = kcg_lit_int64(0);
    outC->_L10.PacketHeaders[idx1].q_dir = Q_DIR_Reverse;
    outC->_L10.PacketHeaders[idx1].valid = kcg_true;
    outC->_L10.PacketHeaders[idx1].startAddress = kcg_lit_int64(0);
    outC->_L10.PacketHeaders[idx1].endAddress = kcg_lit_int64(0);
  }
  for (idx2 = 0; idx2 < 500; idx2++) {
    outC->_L10.PacketData[idx2] = kcg_lit_int64(0);
  }
  outC->_L7 = kcg_true;
  outC->_L6 = kcg_lit_int64(0);
  outC->_L5 = kcg_lit_int64(0);
  ...
  for (idx3 = 0; idx3 < 30; idx3++) {
    outC->_L2[idx3].nid_packet = kcg_lit_int64(0);
    outC->_L2[idx3].q_dir = Q_DIR_Reverse;
    outC->_L2[idx3].valid = kcg_true;
    outC->_L2[idx3].startAddress = kcg_lit_int64(0);
    outC->_L2[idx3].endAddress = kcg_lit_int64(0);
  }
