...
{
  /* m_level/ */
  static M_LEVEL m_level_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* m_level/ */
  static M_LEVEL _1_m_level_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* m_level/ */
  static M_LEVEL _3_m_level_partial;
  /* error/ */
  static kcg_bool _4_error_partial;
  /* m_level/ */
  static M_LEVEL _5_m_level_partial;
  /* error/ */
  static kcg_bool _6_error_partial;
  /* m_level/ */
  static M_LEVEL _7_m_level_partial;
  /* error/ */
  static kcg_bool _8_error_partial;
  /* m_level/ */
  static M_LEVEL _9_m_level_partial;
  /* error/ */
  static kcg_bool _10_error_partial;
  /* error/ */
  static kcg_bool _11_error_partial;
  /* m_level/ */
  static M_LEVEL _12_m_level_partial;
  /* error/ */
  static kcg_bool _13_error_partial;
  /* m_level/ */
  static M_LEVEL _14_m_level_partial;
  /* error/ */
  static kcg_bool _15_error_partial;
  /* m_level/ */
  static M_LEVEL _16_m_level_partial;
  /* error/ */
  static kcg_bool _17_error_partial;
  /* m_level/ */
  static M_LEVEL _18_m_level_partial;
