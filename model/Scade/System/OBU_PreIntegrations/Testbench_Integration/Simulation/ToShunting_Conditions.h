...
typedef struct {
  ...
  outC_Procedure_SH_Initiated_By_Driver_Procedures /* _L449=(Procedures::Procedure_SH_Initiated_By_Driver#1)/ */ Context_Procedure_SH_Initiated_By_Driver_1;
...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_Procedure_SH_Initiated_By_Driver_Procedures Context_Procedure_SH_Initiated_By_Driver_1;
  SV_Procedure_SH_Ordered_By_Track_Procedures Context_Procedure_SH_Ordered_By_Track_1;
} SV_ToShunting_Conditions;

extern void kcg_save_SV_ToShunting_Conditions(
  SV_ToShunting_Conditions *SV,
  outC_ToShunting_Conditions *outC);
extern void kcg_load_SV_ToShunting_Conditions(
  outC_ToShunting_Conditions *outC,
  SV_ToShunting_Conditions *SV);
