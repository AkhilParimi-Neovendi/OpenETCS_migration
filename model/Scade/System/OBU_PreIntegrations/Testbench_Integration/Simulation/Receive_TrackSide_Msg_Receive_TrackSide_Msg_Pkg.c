  ...
  outC_Receive_TrackSide_Msg_Receive_TrackSide_Msg_Pkg *outC)
{
  ...
  outC->_L2.systemTimeMsgReceived = kcg_lit_int64(0);
  ...
  outC->_L2.btm_msg.api_header.m_mcount = kcg_lit_int64(0);
  outC->_L2.btm_msg.api_header.nid_c = kcg_lit_int64(0);
  outC->_L2.btm_msg.api_header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L2.rtm_msg.Radio_Common_Header.radioDevice = kcg_lit_int64(0);
  outC->_L2.rtm_msg.Radio_Common_Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L2.rtm_msg.Radio_Common_Header.nid_message = kcg_lit_int64(0);
  outC->_L2.rtm_msg.Radio_Common_Header.t_train = kcg_lit_int64(0);
  outC->_L2.rtm_msg.Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_required;
  outC->_L2.rtm_msg.Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L2.rtm_msg.Radio_Common_Header.t_train_reference = kcg_lit_int64(0);
  outC->_L2.rtm_msg.Radio_Common_Header.nid_em = kcg_lit_int64(0);
  outC->_L2.rtm_msg.Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L2.rtm_msg.Radio_Common_Header.d_sr = kcg_lit_int64(0);
  outC->_L2.rtm_msg.Radio_Common_Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L2.rtm_msg.Radio_Common_Header.d_ref = kcg_lit_int64(0);
  outC->_L2.rtm_msg.Radio_Common_Header.q_dir = Q_DIR_Reverse;
  outC->_L2.rtm_msg.Radio_Common_Header.d_emergencystop = kcg_lit_int64(0);
  ...
  outC->_L2.rtm_msg.sendingRBC_Id.nid_c = kcg_lit_int64(0);
  outC->_L2.rtm_msg.sendingRBC_Id.rbc_id = kcg_lit_int64(0);
  outC->_L2.rtm_msg.sendingRBC_Id.device_id = kcg_lit_int64(0);
  for (idx = 0; idx < 30; idx++) {
    outC->_L2.packets.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L2.packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L2.packets.PacketHeaders[idx].valid = kcg_true;
    outC->_L2.packets.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L2.packets.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L2.packets.PacketData[idx1] = kcg_lit_int64(0);
  }
  outC->_L1 = kcg_true;
  ...
  outC->_L1_else_IfBlock1.odo.o_nominal = kcg_lit_int64(0);
  outC->_L1_else_IfBlock1.odo.o_min = kcg_lit_int64(0);
  outC->_L1_else_IfBlock1.odo.o_max = kcg_lit_int64(0);
  outC->_L1_else_IfBlock1.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L1_else_IfBlock1.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L1_else_IfBlock1.speed.v_lower = kcg_lit_int64(0);
  outC->_L1_else_IfBlock1.speed.v_upper = kcg_lit_int64(0);
  outC->_L1_else_IfBlock1.acceleration = kcg_lit_int64(0);
  ...
  outC->_L4_else_IfBlock1.systemTimeMsgReceived = kcg_lit_int64(0);
  ...
  outC->_L4_else_IfBlock1.btm_msg.api_header.m_mcount = kcg_lit_int64(0);
  outC->_L4_else_IfBlock1.btm_msg.api_header.nid_c = kcg_lit_int64(0);
  outC->_L4_else_IfBlock1.btm_msg.api_header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L4_else_IfBlock1.rtm_msg.Radio_Common_Header.nid_message =
    kcg_lit_int64(0);
  outC->_L4_else_IfBlock1.rtm_msg.Radio_Common_Header.t_train = kcg_lit_int64(0);
  outC->_L4_else_IfBlock1.rtm_msg.Radio_Common_Header.m_ack =
    M_ACK_No_acknowledgement_required;
  outC->_L4_else_IfBlock1.rtm_msg.Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L4_else_IfBlock1.rtm_msg.Radio_Common_Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L4_else_IfBlock1.rtm_msg.Radio_Common_Header.nid_em = kcg_lit_int64(0);
  outC->_L4_else_IfBlock1.rtm_msg.Radio_Common_Header.q_scale =
    Q_SCALE_10_cm_scale;
  outC->_L4_else_IfBlock1.rtm_msg.Radio_Common_Header.d_sr = kcg_lit_int64(0);
  outC->_L4_else_IfBlock1.rtm_msg.Radio_Common_Header.t_sh_rqst = kcg_lit_int64(
      0);
  outC->_L4_else_IfBlock1.rtm_msg.Radio_Common_Header.d_ref = kcg_lit_int64(0);
  ...
  outC->_L4_else_IfBlock1.rtm_msg.sendingRBC_Id.nid_c = kcg_lit_int64(0);
  outC->_L4_else_IfBlock1.rtm_msg.sendingRBC_Id.rbc_id = kcg_lit_int64(0);
  outC->_L4_else_IfBlock1.rtm_msg.sendingRBC_Id.device_id = kcg_lit_int64(0);
  ...
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L4_else_IfBlock1.packets.PacketData[idx3] = kcg_lit_int64(0);
  }
  outC->_L22_else_IfBlock1.valid = kcg_true;
  outC->_L22_else_IfBlock1.systemTime = kcg_lit_int64(0);
  ...
  outC->_L22_else_IfBlock1.telegramHeaders.numberBalises = kcg_lit_int64(0);
  ...
  outC->_L22_else_IfBlock1.radio_Msg.header.radioDevice = kcg_lit_int64(0);
  outC->_L22_else_IfBlock1.radio_Msg.header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L22_else_IfBlock1.radio_Msg.header.nid_message = kcg_lit_int64(0);
  outC->_L22_else_IfBlock1.radio_Msg.header.t_train = kcg_lit_int64(0);
  outC->_L22_else_IfBlock1.radio_Msg.header.m_ack =
    M_ACK_No_acknowledgement_required;
  outC->_L22_else_IfBlock1.radio_Msg.header.nid_lrbg = kcg_lit_int64(0);
  outC->_L22_else_IfBlock1.radio_Msg.header.t_train_reference = kcg_lit_int64(0);
  outC->_L22_else_IfBlock1.radio_Msg.header.nid_em = kcg_lit_int64(0);
  outC->_L22_else_IfBlock1.radio_Msg.header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L22_else_IfBlock1.radio_Msg.header.d_sr = kcg_lit_int64(0);
  outC->_L22_else_IfBlock1.radio_Msg.header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L22_else_IfBlock1.radio_Msg.header.d_ref = kcg_lit_int64(0);
  outC->_L22_else_IfBlock1.radio_Msg.header.q_dir = Q_DIR_Reverse;
  outC->_L22_else_IfBlock1.radio_Msg.header.d_emergencystop = kcg_lit_int64(0);
  ...
  for (idx8 = 0; idx8 < 500; idx8++) {
    outC->_L22_else_IfBlock1.radio_Msg.packets.PacketData[idx8] = kcg_lit_int64(0);
  }
  outC->_L22_else_IfBlock1.radio_Msg.sendingRBC.valid = kcg_true;
  outC->_L22_else_IfBlock1.radio_Msg.sendingRBC.nid_c = kcg_lit_int64(0);
  outC->_L22_else_IfBlock1.radio_Msg.sendingRBC.rbc_id = kcg_lit_int64(0);
  outC->_L22_else_IfBlock1.radio_Msg.sendingRBC.device_id = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.valid = kcg_true;
  outC->_L1_then_IfBlock1.systemTimeMsgReceived = kcg_lit_int64(0);
  ...
  outC->_L1_then_IfBlock1.btm_msg.api_header.m_mcount = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.btm_msg.api_header.nid_c = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.btm_msg.api_header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L1_then_IfBlock1.rtm_msg.Radio_Common_Header.nid_message =
    kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.rtm_msg.Radio_Common_Header.t_train = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.rtm_msg.Radio_Common_Header.m_ack =
    M_ACK_No_acknowledgement_required;
  outC->_L1_then_IfBlock1.rtm_msg.Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.rtm_msg.Radio_Common_Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.rtm_msg.Radio_Common_Header.nid_em = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.rtm_msg.Radio_Common_Header.q_scale =
    Q_SCALE_10_cm_scale;
  outC->_L1_then_IfBlock1.rtm_msg.Radio_Common_Header.d_sr = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.rtm_msg.Radio_Common_Header.t_sh_rqst = kcg_lit_int64(
      0);
  outC->_L1_then_IfBlock1.rtm_msg.Radio_Common_Header.d_ref = kcg_lit_int64(0);
  ...
  outC->_L1_then_IfBlock1.rtm_msg.sendingRBC_Id.nid_c = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.rtm_msg.sendingRBC_Id.rbc_id = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.rtm_msg.sendingRBC_Id.device_id = kcg_lit_int64(0);
  ...
  for (idx10 = 0; idx10 < 500; idx10++) {
    outC->_L1_then_IfBlock1.packets.PacketData[idx10] = kcg_lit_int64(0);
  }
  ...
  outC->_L2_then_IfBlock1.telegramHeaders.numberBalises = kcg_lit_int64(0);
  ...
  outC->_L2_then_IfBlock1.radio_Msg.header.radioDevice = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.radio_Msg.header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.radio_Msg.header.nid_message = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.radio_Msg.header.t_train = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.radio_Msg.header.m_ack =
    M_ACK_No_acknowledgement_required;
  outC->_L2_then_IfBlock1.radio_Msg.header.nid_lrbg = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.radio_Msg.header.t_train_reference = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.radio_Msg.header.nid_em = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.radio_Msg.header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L2_then_IfBlock1.radio_Msg.header.d_sr = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.radio_Msg.header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.radio_Msg.header.d_ref = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.radio_Msg.header.q_dir = Q_DIR_Reverse;
  outC->_L2_then_IfBlock1.radio_Msg.header.d_emergencystop = kcg_lit_int64(0);
  ...
  for (idx15 = 0; idx15 < 500; idx15++) {
    outC->_L2_then_IfBlock1.radio_Msg.packets.PacketData[idx15] = kcg_lit_int64(0);
  }
  outC->_L2_then_IfBlock1.radio_Msg.sendingRBC.valid = kcg_true;
  outC->_L2_then_IfBlock1.radio_Msg.sendingRBC.nid_c = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.radio_Msg.sendingRBC.rbc_id = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.radio_Msg.sendingRBC.device_id = kcg_lit_int64(0);
  outC->outTrackMessage_for_check.valid = kcg_true;
  outC->outTrackMessage_for_check.systemTime = kcg_lit_int64(0);
  ...
  outC->outTrackMessage_for_check.telegramHeaders.numberBalises = kcg_lit_int64(
      0);
  ...
  outC->outTrackMessage_for_check.radio_Msg.header.radioDevice = kcg_lit_int64(0);
  outC->outTrackMessage_for_check.radio_Msg.header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->outTrackMessage_for_check.radio_Msg.header.nid_message = kcg_lit_int64(0);
  outC->outTrackMessage_for_check.radio_Msg.header.t_train = kcg_lit_int64(0);
  outC->outTrackMessage_for_check.radio_Msg.header.m_ack =
    M_ACK_No_acknowledgement_required;
  outC->outTrackMessage_for_check.radio_Msg.header.nid_lrbg = kcg_lit_int64(0);
  outC->outTrackMessage_for_check.radio_Msg.header.t_train_reference =
    kcg_lit_int64(0);
  outC->outTrackMessage_for_check.radio_Msg.header.nid_em = kcg_lit_int64(0);
  outC->outTrackMessage_for_check.radio_Msg.header.q_scale = Q_SCALE_10_cm_scale;
  outC->outTrackMessage_for_check.radio_Msg.header.d_sr = kcg_lit_int64(0);
  outC->outTrackMessage_for_check.radio_Msg.header.t_sh_rqst = kcg_lit_int64(0);
  outC->outTrackMessage_for_check.radio_Msg.header.d_ref = kcg_lit_int64(0);
  ...
  outC->outTrackMessage_for_check.radio_Msg.sendingRBC.nid_c = kcg_lit_int64(0);
  outC->outTrackMessage_for_check.radio_Msg.sendingRBC.rbc_id = kcg_lit_int64(0);
...
void kcg_save_SV_Receive_TrackSide_Msg_Receive_TrackSide_Msg_Pkg(
  SV_Receive_TrackSide_Msg_Receive_TrackSide_Msg_Pkg *SV,
  outC_Receive_TrackSide_Msg_Receive_TrackSide_Msg_Pkg *outC)
{
  kcg_save_SV_Receive_BaliseTelegram_Receive_TrackSide_Msg_Pkg(
    &SV->Context_Receive_BaliseTelegram_1,
    &outC->Context_Receive_BaliseTelegram_1);
}

void kcg_load_SV_Receive_TrackSide_Msg_Receive_TrackSide_Msg_Pkg(
  outC_Receive_TrackSide_Msg_Receive_TrackSide_Msg_Pkg *outC,
  SV_Receive_TrackSide_Msg_Receive_TrackSide_Msg_Pkg *SV)
{
  kcg_load_SV_Receive_BaliseTelegram_Receive_TrackSide_Msg_Pkg(
    &outC->Context_Receive_BaliseTelegram_1,
    &SV->Context_Receive_BaliseTelegram_1);
}
