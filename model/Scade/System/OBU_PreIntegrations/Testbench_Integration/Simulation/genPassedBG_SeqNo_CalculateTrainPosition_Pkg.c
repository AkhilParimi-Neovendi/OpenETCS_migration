  ...
  outC_genPassedBG_SeqNo_CalculateTrainPosition_Pkg *outC)
{
  ...
  if ((kcg_lit_int32(0) <= outC->_L4) & (outC->_L4 < kcg_lit_int32(41))) {
  ...
  outC_genPassedBG_SeqNo_CalculateTrainPosition_Pkg *outC)
{
  ...
  for (idx2 = 0; idx2 < 41; idx2++) {
    ...
    outC->_L2[idx2].nid_c = kcg_lit_int32(0);
    outC->_L2[idx2].nid_bg = kcg_lit_int32(0);
    outC->_L2[idx2].q_link = Q_LINK_Unlinked;
    outC->_L2[idx2].location.nominal = kcg_lit_int32(0);
    outC->_L2[idx2].location.d_min = kcg_lit_int32(0);
    outC->_L2[idx2].location.d_max = kcg_lit_int32(0);
    outC->_L2[idx2].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L2[idx2].infoFromLinking.valid = kcg_true;
    outC->_L2[idx2].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L2[idx2].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L2[idx2].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L2[idx2].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L2[idx2].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L2[idx2].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L2[idx2].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L2[idx2].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L2[idx2].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L2[idx2].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L2[idx2].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L2[idx2].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L2[idx2].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L2[idx2].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    outC->_L2[idx2].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L2[idx2].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L2[idx2].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L2[idx2].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L2[idx2].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L2[idx2].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L2[idx2].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L2[idx2].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx1 = 0; idx1 < 33; idx1++) {
      ...
      outC->_L2[idx2].infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L2[idx2].infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int32(0);
      outC->_L2[idx2].infoFromPassing.linkedBGs[idx1].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L2[idx2].infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int32(0);
      outC->_L2[idx2].infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L2[idx2].infoFromPassing.linkedBGs[idx1].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L2[idx2].infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int32(0);
    }
...
void kcg_save_SV_genPassedBG_SeqNo_CalculateTrainPosition_Pkg(
  SV_genPassedBG_SeqNo_CalculateTrainPosition_Pkg *SV,
  outC_genPassedBG_SeqNo_CalculateTrainPosition_Pkg *outC)
{
  kcg_save_SV_countUp_CalculateTrainPosition_Pkg_gp_functions_Pkg(
    &SV->Context_countUp_1,
    &outC->Context_countUp_1);
}

void kcg_load_SV_genPassedBG_SeqNo_CalculateTrainPosition_Pkg(
  outC_genPassedBG_SeqNo_CalculateTrainPosition_Pkg *outC,
  SV_genPassedBG_SeqNo_CalculateTrainPosition_Pkg *SV)
{
  kcg_load_SV_countUp_CalculateTrainPosition_Pkg_gp_functions_Pkg(
    &outC->Context_countUp_1,
    &SV->Context_countUp_1);
}
