  ...
  outC_MoveMAAbsolute_Loop_new_TA_Lib_internal *outC)
{
  ...
  outC->_L9.l_section = kcg_lit_int64(0);
  outC->_L9.q_sectiontimer = kcg_true;
  outC->_L9.t_sectiontimer = kcg_lit_int64(0);
  outC->_L9.d_sectiontimerstoploc = kcg_lit_int64(0);
  for (idx = 0; idx < 10; idx++) {
    outC->_L7[idx].valid = kcg_true;
    outC->_L7[idx].q_endsection = kcg_true;
    outC->_L7[idx].l_section = kcg_lit_int64(0);
    outC->_L7[idx].q_sectiontimer = kcg_true;
    outC->_L7[idx].t_sectiontimer = kcg_lit_int64(0);
    outC->_L7[idx].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->_L6.valid = kcg_true;
  outC->_L6.q_endsection = kcg_true;
  outC->_L6.l_section = kcg_lit_int64(0);
  outC->_L6.q_sectiontimer = kcg_true;
  outC->_L6.t_sectiontimer = kcg_lit_int64(0);
  outC->_L6.d_sectiontimerstoploc = kcg_lit_int64(0);
  ...
  for (idx2 = 0; idx2 < 10; idx2++) {
    ...
    outC->ProfileOut[idx2].l_section = kcg_lit_int64(0);
    outC->ProfileOut[idx2].q_sectiontimer = kcg_true;
    outC->ProfileOut[idx2].t_sectiontimer = kcg_lit_int64(0);
    outC->ProfileOut[idx2].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
}
