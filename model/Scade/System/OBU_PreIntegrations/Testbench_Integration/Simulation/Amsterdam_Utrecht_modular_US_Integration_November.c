  ...
  outC_Amsterdam_Utrecht_modular_US_Integration_November *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L15.PacketHeaders[idx].nid_packet = kcg_lit_int32(0);
    outC->_L15.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L15.PacketHeaders[idx].valid = kcg_true;
    outC->_L15.PacketHeaders[idx].startAddress = kcg_lit_int32(0);
    outC->_L15.PacketHeaders[idx].endAddress = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L15.PacketData[idx1] = kcg_lit_int32(0);
  }
  ...
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L19.PacketHeaders[idx4].nid_packet = kcg_lit_int32(0);
    outC->_L19.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L19.PacketHeaders[idx4].valid = kcg_true;
    outC->_L19.PacketHeaders[idx4].startAddress = kcg_lit_int32(0);
    outC->_L19.PacketHeaders[idx4].endAddress = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L19.PacketData[idx5] = kcg_lit_int32(0);
  }
  outC->_L20.Header.radioDevice = kcg_lit_int32(0);
  outC->_L20.Header.receivedSystemTime = kcg_lit_int32(0);
  outC->_L20.Header.nid_message = kcg_lit_int32(0);
  outC->_L20.Header.t_train = kcg_lit_int32(0);
  outC->_L20.Header.m_ack = kcg_lit_int32(0);
  outC->_L20.Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L20.Header.t_train_reference = kcg_lit_int32(0);
  outC->_L20.Header.nid_em = kcg_lit_int32(0);
  outC->_L20.Header.q_scale = kcg_lit_int32(0);
  outC->_L20.Header.d_sr = kcg_lit_int32(0);
  outC->_L20.Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L20.Header.d_ref = kcg_lit_int32(0);
  outC->_L20.Header.q_dir = kcg_lit_int32(0);
  outC->_L20.Header.d_emergencystop = kcg_lit_int32(0);
