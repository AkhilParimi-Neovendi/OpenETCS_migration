  ...
  outC_SSP_to_MRSP_TA_Export *outC)
{
  ...
  if ((kcg_lit_int32(0) <= outC->_L8) & (outC->_L8 < kcg_lit_int32(50))) {
...
void SSP_to_MRSP_init_TA_Export(outC_SSP_to_MRSP_TA_Export *outC)
{
  ...
  for (idx = 0; idx < 110; idx++) {
    ...
    outC->_L5[idx].Loc_Abs = kcg_lit_int32(0);
    outC->_L5[idx].Loc_LRBG = kcg_lit_int32(0);
    outC->_L5[idx].MRS = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 110; idx1++) {
    outC->_L4[idx1].valid = kcg_true;
    outC->_L4[idx1].Loc_Abs = kcg_lit_int32(0);
    outC->_L4[idx1].Loc_LRBG = kcg_lit_int32(0);
    outC->_L4[idx1].MRS = kcg_lit_int32(0);
  }
  for (idx2 = 0; idx2 < 50; idx2++) {
    outC->_L3[idx2].valid = kcg_true;
    outC->_L3[idx2].d_static_abs = kcg_lit_int32(0);
    outC->_L3[idx2].d_static_LRBG = kcg_lit_int32(0);
    outC->_L3[idx2].q_train_length_corr = kcg_true;
    outC->_L3[idx2].v_static = kcg_lit_int32(0);
  }
