...
typedef struct {
  /* ----------------------  memorised outputs  ---------------------- */
  kcg_float32 /* distance/ */ Context_distance;
  /* ----------------------- local memories  ------------------------- */
  L_internal_Type_Obu_BasicTypes_Pkg /* BGLocation/ */ Context_BGLocation;
  NID_BG /* BG_ID/ */ Context_BG_ID;
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
} SV_distanceLastBG_xdebugSupport_Pkg;

extern void kcg_save_SV_distanceLastBG_xdebugSupport_Pkg(
  SV_distanceLastBG_xdebugSupport_Pkg *SV,
  outC_distanceLastBG_xdebugSupport_Pkg *outC);
extern void kcg_load_SV_distanceLastBG_xdebugSupport_Pkg(
  outC_distanceLastBG_xdebugSupport_Pkg *outC,
  SV_distanceLastBG_xdebugSupport_Pkg *SV);
