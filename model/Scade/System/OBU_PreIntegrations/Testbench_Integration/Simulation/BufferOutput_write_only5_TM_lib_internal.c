  ...
  outC_BufferOutput_write_only5_TM_lib_internal *outC)
{
  ...
  kcg_copy__84_array(&outC->_L6, (_84_array *) &outC->_L3[0]);
  kcg_copy_M_TrainTrackRadioOutputBuffer_t_TM_lib_internal(&outC->_L1, Buffer_In);
  kcg_copy__96_array(&outC->_L4, (_96_array *) &outC->_L1[0]);
  kcg_copy__84_array(&outC->_L5[0], &outC->_L6);
  kcg_copy__96_array(&outC->_L5[5], &outC->_L4);
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
    &outC->Message_out,
    &outC->_L9);
