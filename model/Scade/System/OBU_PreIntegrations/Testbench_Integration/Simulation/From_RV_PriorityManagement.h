...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  T_Mode_Level_And_Mode_Types_Pkg /* FromRV_To_NewMode/ */ FromRV_To_NewMode;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  T_Mode_Level_And_Mode_Types_Pkg /* IfBlock1:else:else:else:else:_L1/ */ _L1_else_else_else_else_IfBlock1;
...
} outC_From_RV_PriorityManagement;

/* ===========  node initialization and cycle functions  =========== */
/* PriorityManagement::From_RV/ */
extern void From_RV_PriorityManagement(
  /* Condition1/ */
  kcg_bool Condition1,
  /* Condition13/ */
...
extern void From_RV_reset_PriorityManagement(
  outC_From_RV_PriorityManagement *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void From_RV_init_PriorityManagement(
  outC_From_RV_PriorityManagement *outC);
