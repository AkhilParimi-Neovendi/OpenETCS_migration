...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  array_float32_10 /* SpeedProfile_Distance_DMI/ */ SpeedProfile_Distance_DMI;
  array_float32_10 /* SpeedProfile_Speed_DMI/ */ SpeedProfile_Speed_DMI;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  kcg_int32 /* lSpeedProfileFirstIndex/ */ lSpeedProfileFirstIndex;
  kcg_float32 /* _L2/ */ _L2;
  array_float32_32 /* _L3/ */ _L3;
  kcg_int32 /* _L6/ */ _L6;
  kcg_bool /* _L7/ */ _L7;
  array_float32_10 /* _L38/ */ _L38;
  array_float32_10 /* _L40/ */ _L40;
