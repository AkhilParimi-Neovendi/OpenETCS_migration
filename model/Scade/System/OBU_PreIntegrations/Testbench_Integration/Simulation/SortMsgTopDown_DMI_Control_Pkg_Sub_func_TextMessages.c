  ...
  outC_SortMsgTopDown_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  kcg_copy_MsgStructure(
    ...
    (MsgStructure *) &cMsgStructure_DMI_Control_Pkg);
  outC->_L22 = index;
  kcg_copy__95_array(&outC->_L21, acc);
  if ((kcg_lit_int64(0) <= outC->_L22) & (outC->_L22 < kcg_lit_int64(10))) {
  ...
  outC->_L2 = index;
  kcg_copy__95_array(&outC->_L19, &outC->_L35);
  if ((kcg_lit_int64(0) <= outC->_L2) & (outC->_L2 < kcg_lit_int64(10))) {
    kcg_copy_MsgStructure(&outC->_L19[outC->_L2], &outC->_L32);
  }
  /* _L4= */
  if (outC->_L25) {
    kcg_copy__95_array(&outC->_L4, &outC->_L26);
  }
  else {
    kcg_copy__95_array(&outC->_L4, &outC->_L19);
  }
  kcg_copy__95_array(&outC->outArray, &outC->_L4);
}
  ...
  outC_SortMsgTopDown_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  for (idx1 = 0; idx1 < 10; idx1++) {
    ...
    outC->_L35[idx1].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L35[idx1].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L35[idx1].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L35[idx1].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx4 = 0; idx4 < 10; idx4++) {
    ...
    outC->_L33[idx4].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L33[idx4].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L33[idx4].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L33[idx4].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx7 = 0; idx7 < 10; idx7++) {
    ...
    outC->_L26[idx7].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L26[idx7].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L26[idx7].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L26[idx7].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  outC->_L24.dmi_msg.system_clock = kcg_lit_int64(0);
  outC->_L24.dmi_msg.textMessage_ID = kcg_lit_int64(0);
  outC->_L24.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L24.dmi_msg.l_text = kcg_lit_int64(0);
  ...
  outC->_L20.dmi_msg.system_clock = kcg_lit_int64(0);
  outC->_L20.dmi_msg.textMessage_ID = kcg_lit_int64(0);
  outC->_L20.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L20.dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx11 = 0; idx11 < 10; idx11++) {
    ...
    outC->_L21[idx11].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L21[idx11].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L21[idx11].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L21[idx11].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  outC->_L23.dmi_msg.system_clock = kcg_lit_int64(0);
  outC->_L23.dmi_msg.textMessage_ID = kcg_lit_int64(0);
  outC->_L23.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L23.dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx14 = 0; idx14 < 10; idx14++) {
    ...
    outC->_L19[idx14].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L19[idx14].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L19[idx14].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L19[idx14].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx16 = 0; idx16 < 10; idx16++) {
    ...
    outC->_L4[idx16].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->_L4[idx16].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->_L4[idx16].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L4[idx16].dmi_msg.l_text = kcg_lit_int64(0);
  ...
  for (idx18 = 0; idx18 < 10; idx18++) {
    ...
    outC->outArray[idx18].dmi_msg.system_clock = kcg_lit_int64(0);
    outC->outArray[idx18].dmi_msg.textMessage_ID = kcg_lit_int64(0);
    outC->outArray[idx18].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->outArray[idx18].dmi_msg.l_text = kcg_lit_int64(0);
