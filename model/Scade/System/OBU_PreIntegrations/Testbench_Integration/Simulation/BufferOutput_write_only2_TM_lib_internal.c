  ...
  outC_BufferOutput_write_only2_TM_lib_internal *outC)
{
  ...
  kcg_copy__79_array(&outC->_L4, (_79_array *) &outC->_L1[0]);
  kcg_copy_M_TrainTrackMessageBus_t_TM_TrainTrack_Bus(&outC->_L3, Message_In);
  kcg_copy__95_array(&outC->_L6, (_95_array *) &outC->_L3[0]);
  kcg_copy__95_array(&outC->_L5[0], &outC->_L6);
  kcg_copy__79_array(&outC->_L5[2], &outC->_L4);
