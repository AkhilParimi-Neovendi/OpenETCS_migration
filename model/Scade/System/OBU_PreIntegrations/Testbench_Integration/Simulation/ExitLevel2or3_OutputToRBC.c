  ...
  outC_ExitLevel2or3_OutputToRBC *outC)
{
  ...
  /* SM1: */
  static _136_SSM_ST_SM1 SM1_state_nxt_partial;
  /* SM1: */
  static kcg_bool SM1_reset_nxt_partial;
  /* SM1: */
  static _137_SSM_TR_SM1 SM1_fired_partial;
  /* SM1:BeforeChange:<1> */
  ...
  /* SM1: */
  static _136_SSM_ST_SM1 _3_SM1_state_nxt_partial;
  /* SM1: */
  static kcg_bool _4_SM1_reset_nxt_partial;
  /* SM1: */
  static _137_SSM_TR_SM1 _5_SM1_fired_partial;
  /* SM1:State2:<1> */
  ...
  switch (outC->SM1_state_act) {
    case _148_SSM_st_State2_SM1 :
      ...
      if (tr_1_guard_State2_SM1) {
        ...
        _5_SM1_fired_partial = _147_SSM_TR_no_trans_SM1;
      }
      ...
      if (tr_1_guard_State2_SM1) {
        ...
        _3_SM1_state_nxt_partial = _148_SSM_st_State2_SM1;
      }
      break;
  ...
  switch (outC->SM1_state_act) {
    ...
    case SSM_st_BeforeChange_SM1 :
      ...
      if (tr_1_guard_BeforeChange_SM1) {
        ...
        SM1_fired_partial = _147_SSM_TR_no_trans_SM1;
      }
      SM1_reset_nxt_partial = tr_1_guard_BeforeChange_SM1;
      if (tr_1_guard_BeforeChange_SM1) {
        SM1_state_nxt_partial = _148_SSM_st_State2_SM1;
      }
      else {
  ...
  outC->SM1_fired_strong = _147_SSM_TR_no_trans_SM1;
...
void kcg_save_SV_ExitLevel2or3_OutputToRBC(
  SV_ExitLevel2or3_OutputToRBC *SV,
  outC_ExitLevel2or3_OutputToRBC *outC)
{
  SV->Context_Loc_Position = outC->Loc_Position;
...
void kcg_load_SV_ExitLevel2or3_OutputToRBC(
  outC_ExitLevel2or3_OutputToRBC *outC,
  SV_ExitLevel2or3_OutputToRBC *SV)
{
  outC->Loc_Position = SV->Context_Loc_Position;
