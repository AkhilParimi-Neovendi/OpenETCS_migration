...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  trainDataStatus_T_trainData_Types_pkg /* trainDataStatus/ */ Context_trainDataStatus;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_trainDataStorage_trainData_pkg Context_trainDataStorage_1;
  SV_sendValidTrainDataRBC_trainData_pkg Context_sendValidTrainDataRBC_1;
  SV_sendAcknowledgementRBC_trainData_pkg Context_sendAcknowledgementRBC_1;
} SV_trainData_trainData_pkg;

extern void kcg_save_SV_trainData_trainData_pkg(
  SV_trainData_trainData_pkg *SV,
  outC_trainData_trainData_pkg *outC);
extern void kcg_load_SV_trainData_trainData_pkg(
  outC_trainData_trainData_pkg *outC,
  SV_trainData_trainData_pkg *SV);
