...
void CAST_Int_to_D_TRACKCOND_TM_conversions(
  /* d_trackcond_int/ */
  ...
  outC_CAST_Int_to_D_TRACKCOND_TM_conversions *outC)
{
  ...
  outC->_L1 = d_trackcond_int;
  outC->_L9 = outC->_L1 > outC->_L7;
  outC->_L6 = DIM_D_min_TM_conversions;
  outC->_L8 = outC->_L1 < outC->_L6;
  _1_noname = outC->_L8;
  noname = outC->_L9;
  outC->d_trackcond = outC->_L1;
}

#ifndef KCG_USER_DEFINED_INIT
void CAST_Int_to_D_TRACKCOND_init_TM_conversions(
  outC_CAST_Int_to_D_TRACKCOND_TM_conversions *outC)
{
  ...
  outC->d_trackcond = kcg_lit_int32(0);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void CAST_Int_to_D_TRACKCOND_reset_TM_conversions(
  outC_CAST_Int_to_D_TRACKCOND_TM_conversions *outC)
{
}
