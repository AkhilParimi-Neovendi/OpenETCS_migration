...
void CAST_Int_to_V_MAIN_TM_conversions(
  /* v_main_int/ */
  ...
  outC_CAST_Int_to_V_MAIN_TM_conversions *outC)
{
  ...
  _1_noname = outC->_L8;
  noname = outC->_L9;
  outC->v_main = outC->_L11;
}

#ifndef KCG_USER_DEFINED_INIT
void CAST_Int_to_V_MAIN_init_TM_conversions(
  outC_CAST_Int_to_V_MAIN_TM_conversions *outC)
{
  ...
  outC->v_main = kcg_lit_int64(0);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void CAST_Int_to_V_MAIN_reset_TM_conversions(
  outC_CAST_Int_to_V_MAIN_TM_conversions *outC)
{
}
