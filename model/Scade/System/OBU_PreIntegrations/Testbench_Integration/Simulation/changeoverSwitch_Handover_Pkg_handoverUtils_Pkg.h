...
typedef struct {
  ...
  _122_SSM_ST_SM1 /* SM1: */ Context_SM1_state_nxt;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_FallingEdge_digital Context_FallingEdge_1;
} SV_changeoverSwitch_Handover_Pkg_handoverUtils_Pkg;

extern void kcg_save_SV_changeoverSwitch_Handover_Pkg_handoverUtils_Pkg(
  SV_changeoverSwitch_Handover_Pkg_handoverUtils_Pkg *SV,
  outC_changeoverSwitch_Handover_Pkg_handoverUtils_Pkg *outC);
extern void kcg_load_SV_changeoverSwitch_Handover_Pkg_handoverUtils_Pkg(
  outC_changeoverSwitch_Handover_Pkg_handoverUtils_Pkg *outC,
  SV_changeoverSwitch_Handover_Pkg_handoverUtils_Pkg *SV);
