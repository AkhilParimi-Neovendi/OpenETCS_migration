  ...
  outC_DeterminePacketValidity_ProvidePositionReport_Pkg *outC)
{
  ...
  for (idx = 0; idx < 33; idx++) {
    ...
    outC->_L15.infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L15.infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int64(0);
    outC->_L15.infoFromPassing.linkedBGs[idx].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L15.infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int64(0);
    outC->_L15.infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int64(0);
    outC->_L15.infoFromPassing.linkedBGs[idx].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L15.infoFromPassing.linkedBGs[idx].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L15.infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int64(0);
  }
  ...
  outC->_L5.bgPosition.timestamp = kcg_lit_int64(0);
  outC->_L5.bgPosition.odo.o_nominal = kcg_lit_int64(0);
  outC->_L5.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->_L5.bgPosition.odo.o_max = kcg_lit_int64(0);
  outC->_L5.bgPosition.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L5.bgPosition.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L5.bgPosition.speed.v_lower = kcg_lit_int64(0);
  outC->_L5.bgPosition.speed.v_upper = kcg_lit_int64(0);
  outC->_L5.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->_L5.BG_centerDetectionInaccuraccuracies.nominal = kcg_lit_int64(0);
  outC->_L5.BG_centerDetectionInaccuraccuracies.d_min = kcg_lit_int64(0);
  outC->_L5.BG_centerDetectionInaccuraccuracies.d_max = kcg_lit_int64(0);
  outC->_L5.q_nvlocacc = kcg_lit_int64(0);
  ...
  outC->_L11.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L11.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L11.BG_Header.nid_bg = kcg_lit_int64(0);
  outC->_L11.BG_Header.q_link = Q_LINK_Unlinked;
  outC->_L11.BG_Header.bgPosition.valid = kcg_true;
  outC->_L11.BG_Header.bgPosition.timestamp = kcg_lit_int64(0);
  outC->_L11.BG_Header.bgPosition.odo.o_nominal = kcg_lit_int64(0);
  outC->_L11.BG_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->_L11.BG_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
  outC->_L11.BG_Header.bgPosition.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L11.BG_Header.bgPosition.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L11.BG_Header.bgPosition.speed.v_lower = kcg_lit_int64(0);
  outC->_L11.BG_Header.bgPosition.speed.v_upper = kcg_lit_int64(0);
  outC->_L11.BG_Header.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->_L11.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L11.BG_Header.q_nvlocacc = kcg_lit_int64(0);
