  ...
  outC_CAST_int_to_DMI_Track_Description_DATA_Packets_EVC_to_DMI *outC)
{
  kcg_copy_DMI_Track_Description_int_array_T(
    &outC->_L14,
    dmi_track_description_int);
  kcg_copy_array_int32_129(&outC->_L17, (array_int32_129 *) &outC->_L14[2]);
  ...
  kcg_copy_array_int32_65(&outC->_L19, (array_int32_65 *) &outC->_L14[260]);
  ...
  kcg_copy_array_int32_129(&outC->_L18, (array_int32_129 *) &outC->_L14[131]);
  ...
  outC_CAST_int_to_DMI_Track_Description_DATA_Packets_EVC_to_DMI *outC)
{
  ...
  for (idx = 0; idx < 32; idx++) {
    ...
    outC->_L23.speedProfiles[idx].Loc_Abs = kcg_lit_int32(0);
    outC->_L23.speedProfiles[idx].Loc_LRBG = kcg_lit_int32(0);
    outC->_L23.speedProfiles[idx].MRS = kcg_lit_int32(0);
  }
  outC->_L22 = kcg_true;
  outC->_L21.nIter = kcg_lit_int32(0);
  for (idx1 = 0; idx1 < 32; idx1++) {
    outC->_L21.trackCondition[idx1].d_trackcond = kcg_lit_int32(0);
  ...
  for (idx2 = 0; idx2 < 32; idx2++) {
    ...
    outC->_L20.gradientProfiles[idx2].begin_section = kcg_lit_int32(0);
    outC->_L20.gradientProfiles[idx2].end_section = kcg_lit_int32(0);
    outC->_L20.gradientProfiles[idx2].gradient = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 65; idx3++) {
    outC->_L19[idx3] = kcg_lit_int32(0);
  }
  for (idx4 = 0; idx4 < 129; idx4++) {
    outC->_L18[idx4] = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 129; idx5++) {
    outC->_L17[idx5] = kcg_lit_int32(0);
  }
  ...
  for (idx7 = 0; idx7 < 32; idx7++) {
    ...
    outC->_L12.speedProfiles.speedProfiles[idx7].Loc_Abs = kcg_lit_int32(0);
    outC->_L12.speedProfiles.speedProfiles[idx7].Loc_LRBG = kcg_lit_int32(0);
    outC->_L12.speedProfiles.speedProfiles[idx7].MRS = kcg_lit_int32(0);
  }
  ...
  for (idx8 = 0; idx8 < 32; idx8++) {
    ...
    outC->_L12.gradientProfiles.gradientProfiles[idx8].end_section =
      kcg_lit_int32(0);
    outC->_L12.gradientProfiles.gradientProfiles[idx8].gradient = kcg_lit_int32(0);
  }
  outC->_L12.trackConditions.nIter = kcg_lit_int32(0);
  for (idx9 = 0; idx9 < 32; idx9++) {
    outC->_L12.trackConditions.trackCondition[idx9].d_trackcond = kcg_lit_int32(0);
