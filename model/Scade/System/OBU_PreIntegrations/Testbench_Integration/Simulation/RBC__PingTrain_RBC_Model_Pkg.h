...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* Level_2_or_3/ */ Context_Level_2_or_3;
  T_TRAIN /* lastRadioTrackTrainMessageWasSentTimestamp/ */ Context_lastRadioTrackTrainMessageWasSentTimestamp;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
} SV_RBC__PingTrain_RBC_Model_Pkg;

extern void kcg_save_SV_RBC__PingTrain_RBC_Model_Pkg(
  SV_RBC__PingTrain_RBC_Model_Pkg *SV,
  outC_RBC__PingTrain_RBC_Model_Pkg *outC);
extern void kcg_load_SV_RBC__PingTrain_RBC_Model_Pkg(
  outC_RBC__PingTrain_RBC_Model_Pkg *outC,
  SV_RBC__PingTrain_RBC_Model_Pkg *SV);
