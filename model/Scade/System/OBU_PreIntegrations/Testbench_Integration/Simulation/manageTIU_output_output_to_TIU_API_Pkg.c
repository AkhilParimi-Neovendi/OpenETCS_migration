...
void kcg_save_SV_manageTIU_output_output_to_TIU_API_Pkg(
  SV_manageTIU_output_output_to_TIU_API_Pkg *SV,
  outC_manageTIU_output_output_to_TIU_API_Pkg *outC)
{
  kcg_save_SV_handleBrakeCommand_output_to_TIU_API_Pkg(
    &SV->Context_handleBrakeCommand_1,
    &outC->Context_handleBrakeCommand_1);
}

void kcg_load_SV_manageTIU_output_output_to_TIU_API_Pkg(
  outC_manageTIU_output_output_to_TIU_API_Pkg *outC,
  SV_manageTIU_output_output_to_TIU_API_Pkg *SV)
{
  kcg_load_SV_handleBrakeCommand_output_to_TIU_API_Pkg(
    &outC->Context_handleBrakeCommand_1,
    &SV->Context_handleBrakeCommand_1);
}
