...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_CAST_DMI_Menu_Request_to_int1_DATA_Packets_EVC_to_DMI /* _L9=(DATA::Packets::EVC_to_DMI::CAST_DMI_Menu_Request_to_int1#1)/ */ Context_CAST_DMI_Menu_Request_to_int1_1;
  /* ------------------ clocks of observable data -------------------- */
  kcg_bool every;
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  DMI_Menu_Request_T_DMI_Messages_EVC_to_DMI_Pkg /* _L1/ */ _L1;
  DMI_Menu_Request_int_array_T_DATA /* _L9/ */ _L9;
  DMI_Menu_Request_int_array_T_DATA /* _L10/ */ _L10;
  kcg_bool /* _L11/ */ _L11;
} outC_Write_DMI_Menu_Request_to_int_DATA_Packets_EVC_to_DMI;

/* ===========  node initialization and cycle functions  =========== */
/* DATA::Packets::EVC_to_DMI::Write_DMI_Menu_Request_to_int/ */
extern void Write_DMI_Menu_Request_to_int_DATA_Packets_EVC_to_DMI(
  /* dmi_menu_request_ct/ */
...
extern void Write_DMI_Menu_Request_to_int_reset_DATA_Packets_EVC_to_DMI(
  outC_Write_DMI_Menu_Request_to_int_DATA_Packets_EVC_to_DMI *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void Write_DMI_Menu_Request_to_int_init_DATA_Packets_EVC_to_DMI(
  outC_Write_DMI_Menu_Request_to_int_DATA_Packets_EVC_to_DMI *outC);
