  ...
  outC_ThirdFilter_InformationFilter_Pkg_ThirdFilter *outC)
{
  ...
  outC->_L76.rbc_id = kcg_lit_int64(0);
  outC->_L76.device_id = kcg_lit_int64(0);
  outC->_L68.valid = kcg_true;
  outC->_L68.nid_c = kcg_lit_int64(0);
  outC->_L68.rbc_id = kcg_lit_int64(0);
  outC->_L68.device_id = kcg_lit_int64(0);
  ...
  outC->_L21.m_mcount = kcg_lit_int64(0);
  ...
  outC->_L21.bgPosition.timestamp = kcg_lit_int64(0);
  outC->_L21.bgPosition.odo.o_nominal = kcg_lit_int64(0);
  outC->_L21.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->_L21.bgPosition.odo.o_max = kcg_lit_int64(0);
  outC->_L21.bgPosition.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L21.bgPosition.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L21.bgPosition.speed.v_lower = kcg_lit_int64(0);
  outC->_L21.bgPosition.speed.v_upper = kcg_lit_int64(0);
  outC->_L21.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->_L30.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  for (idx3 = 0; idx3 < 30; idx3++) {
    outC->_L29.PacketHeaders[idx3].nid_packet = kcg_lit_int64(0);
    outC->_L29.PacketHeaders[idx3].q_dir = Q_DIR_Reverse;
    outC->_L29.PacketHeaders[idx3].valid = kcg_true;
    outC->_L29.PacketHeaders[idx3].startAddress = kcg_lit_int64(0);
    outC->_L29.PacketHeaders[idx3].endAddress = kcg_lit_int64(0);
  }
  for (idx4 = 0; idx4 < 500; idx4++) {
    outC->_L29.PacketData[idx4] = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 30; idx5++) {
    outC->_L53[idx5].nid_packet = kcg_lit_int64(0);
    outC->_L53[idx5].q_dir = Q_DIR_Reverse;
    outC->_L53[idx5].valid = kcg_true;
    outC->_L53[idx5].startAddress = kcg_lit_int64(0);
    outC->_L53[idx5].endAddress = kcg_lit_int64(0);
  }
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L52.PacketHeaders[idx6].nid_packet = kcg_lit_int64(0);
    outC->_L52.PacketHeaders[idx6].q_dir = Q_DIR_Reverse;
    outC->_L52.PacketHeaders[idx6].valid = kcg_true;
    outC->_L52.PacketHeaders[idx6].startAddress = kcg_lit_int64(0);
    outC->_L52.PacketHeaders[idx6].endAddress = kcg_lit_int64(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->_L52.PacketData[idx7] = kcg_lit_int64(0);
  }
  for (idx8 = 0; idx8 < 30; idx8++) {
    outC->_L33.PacketHeaders[idx8].nid_packet = kcg_lit_int64(0);
    outC->_L33.PacketHeaders[idx8].q_dir = Q_DIR_Reverse;
    outC->_L33.PacketHeaders[idx8].valid = kcg_true;
    outC->_L33.PacketHeaders[idx8].startAddress = kcg_lit_int64(0);
    outC->_L33.PacketHeaders[idx8].endAddress = kcg_lit_int64(0);
  }
  for (idx9 = 0; idx9 < 500; idx9++) {
    outC->_L33.PacketData[idx9] = kcg_lit_int64(0);
  }
  ...
  outC->_L31.m_mcount = kcg_lit_int64(0);
  outC->_L31.nid_c = kcg_lit_int64(0);
  outC->_L31.nid_bg = kcg_lit_int64(0);
  outC->_L31.q_link = Q_LINK_Unlinked;
  outC->_L31.bgPosition.valid = kcg_true;
  outC->_L31.bgPosition.timestamp = kcg_lit_int64(0);
  outC->_L31.bgPosition.odo.o_nominal = kcg_lit_int64(0);
  outC->_L31.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->_L31.bgPosition.odo.o_max = kcg_lit_int64(0);
  outC->_L31.bgPosition.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L31.bgPosition.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L31.bgPosition.speed.v_lower = kcg_lit_int64(0);
  outC->_L31.bgPosition.speed.v_upper = kcg_lit_int64(0);
  outC->_L31.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->_L31.BG_centerDetectionInaccuraccuracies.nominal = kcg_lit_int64(0);
  outC->_L31.BG_centerDetectionInaccuraccuracies.d_min = kcg_lit_int64(0);
  outC->_L31.BG_centerDetectionInaccuraccuracies.d_max = kcg_lit_int64(0);
  outC->_L31.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx11 = 0; idx11 < 30; idx11++) {
    outC->_L22.packets.PacketHeaders[idx11].nid_packet = kcg_lit_int64(0);
    outC->_L22.packets.PacketHeaders[idx11].q_dir = Q_DIR_Reverse;
    outC->_L22.packets.PacketHeaders[idx11].valid = kcg_true;
    outC->_L22.packets.PacketHeaders[idx11].startAddress = kcg_lit_int64(0);
    outC->_L22.packets.PacketHeaders[idx11].endAddress = kcg_lit_int64(0);
  }
  for (idx12 = 0; idx12 < 500; idx12++) {
    outC->_L22.packets.PacketData[idx12] = kcg_lit_int64(0);
  }
  ...
  for (idx13 = 0; idx13 < 30; idx13++) {
    outC->_L13[idx13].nid_packet = kcg_lit_int64(0);
    outC->_L13[idx13].q_dir = Q_DIR_Reverse;
    outC->_L13[idx13].valid = kcg_true;
    outC->_L13[idx13].startAddress = kcg_lit_int64(0);
    outC->_L13[idx13].endAddress = kcg_lit_int64(0);
  }
  for (idx14 = 0; idx14 < 30; idx14++) {
    outC->_L12[idx14] = kcg_lit_int64(0);
  }
  ...
  for (idx15 = 0; idx15 < 30; idx15++) {
    outC->_L11.packets.PacketHeaders[idx15].nid_packet = kcg_lit_int64(0);
    outC->_L11.packets.PacketHeaders[idx15].q_dir = Q_DIR_Reverse;
    outC->_L11.packets.PacketHeaders[idx15].valid = kcg_true;
    outC->_L11.packets.PacketHeaders[idx15].startAddress = kcg_lit_int64(0);
    outC->_L11.packets.PacketHeaders[idx15].endAddress = kcg_lit_int64(0);
  }
  for (idx16 = 0; idx16 < 500; idx16++) {
    outC->_L11.packets.PacketData[idx16] = kcg_lit_int64(0);
  }
  ...
  for (idx18 = 0; idx18 < 30; idx18++) {
    outC->packets.PacketHeaders[idx18].nid_packet = kcg_lit_int64(0);
    outC->packets.PacketHeaders[idx18].q_dir = Q_DIR_Reverse;
    outC->packets.PacketHeaders[idx18].valid = kcg_true;
    outC->packets.PacketHeaders[idx18].startAddress = kcg_lit_int64(0);
    outC->packets.PacketHeaders[idx18].endAddress = kcg_lit_int64(0);
  }
  for (idx19 = 0; idx19 < 500; idx19++) {
    outC->packets.PacketData[idx19] = kcg_lit_int64(0);
  }
  ...
  for (idx20 = 0; idx20 < 30; idx20++) {
    outC->outMessage.packets.PacketHeaders[idx20].nid_packet = kcg_lit_int64(0);
    ...
    outC->outMessage.packets.PacketHeaders[idx20].startAddress = kcg_lit_int64(0);
    outC->outMessage.packets.PacketHeaders[idx20].endAddress = kcg_lit_int64(0);
  }
  for (idx21 = 0; idx21 < 500; idx21++) {
    outC->outMessage.packets.PacketData[idx21] = kcg_lit_int64(0);
  }
