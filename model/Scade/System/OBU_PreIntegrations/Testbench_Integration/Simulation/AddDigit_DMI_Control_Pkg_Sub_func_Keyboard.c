  ...
  outC_AddDigit_DMI_Control_Pkg_Sub_func_Keyboard *outC)
{
  ...
  kcg_copy_array_int64_9(&outC->_L2, in_digit_display);
  outC->_L14 = kcg_true;
  /* _L13= */
  if (outC->_L14) {
    /* _L13= */
    for (idx1 = 0; idx1 < 9; idx1++) {
      ...
      outC->_L13 = /* _L13= */(kcg_int64) (idx1 + 1);
      /* _L13= */
  ...
  noname = outC->_L13;
  kcg_copy_array_int64_9(&outC->out_digit_display, &outC->_L12);
}
  ...
  outC_AddDigit_DMI_Control_Pkg_Sub_func_Keyboard *outC)
{
  ...
  for (idx4 = 0; idx4 < 9; idx4++) {
    outC->out_digit_display[idx4] = kcg_lit_int64(0);
  }
  for (idx = 0; idx < 9; idx++) {
    /* _L13=(DMI_Control_Pkg::Sub_func::Keyboard::AddDigit_iterator#1)/ */
