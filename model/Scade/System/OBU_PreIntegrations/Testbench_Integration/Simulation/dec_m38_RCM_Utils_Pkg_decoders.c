  ...
  outC_dec_m38_RCM_Utils_Pkg_decoders *outC)
{
  ...
  outC->_L77.rbc_id = kcg_lit_int64(0);
  outC->_L77.device_id = kcg_lit_int64(0);
  outC->_L76.valid = kcg_true;
  outC->_L76.msgSrc = msrc_undefined_Common_Types_Pkg;
  outC->_L76.origin.valid = kcg_true;
  outC->_L76.origin.nid_c = kcg_lit_int64(0);
  outC->_L76.origin.rbc_id = kcg_lit_int64(0);
  outC->_L76.origin.device_id = kcg_lit_int64(0);
  outC->_L75 = kcg_true;
  ...
  outC->m38_initiationOfComSession.origin.nid_c = kcg_lit_int64(0);
  outC->m38_initiationOfComSession.origin.rbc_id = kcg_lit_int64(0);
  outC->m38_initiationOfComSession.origin.device_id = kcg_lit_int64(0);
}
