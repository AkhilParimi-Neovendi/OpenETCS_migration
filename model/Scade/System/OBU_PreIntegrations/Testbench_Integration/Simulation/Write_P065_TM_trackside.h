...
typedef struct {
  ...
  outC_C_P065_tracksim_compr_TM_conversions /* _L43=(TM_conversions::C_P065_tracksim_compr#1)/ */ Context_C_P065_tracksim_compr_1;
...
extern void Write_P065_init_TM_trackside(outC_Write_P065_TM_trackside *outC);
