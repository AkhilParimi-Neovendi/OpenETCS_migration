  ...
  outC_InitalValues_CalcBrakingCurves_Pkg_internalOperators *outC)
{
  ...
  outC->_L151 = kcg_lit_float32(0.0);
  ...
  outC_InitalValues_CalcBrakingCurves_Pkg_internalOperators *outC)
{
  ...
  outC->_L149.distance = kcg_lit_float32(0.0);
  outC->_L149.speed = kcg_lit_float32(0.0);
  outC->_L148 = kcg_lit_float32(0.0);
  outC->_L147 = kcg_lit_float32(0.0);
  outC->_L146 = kcg_true;
  outC->_L141.distance = kcg_lit_float32(0.0);
  outC->_L141.speed = kcg_lit_float32(0.0);
  outC->_L141.distanceIndex = kcg_lit_int32(0);
  outC->_L141.speedIndex = kcg_lit_int32(0);
  for (idx = 0; idx < 114; idx++) {
    outC->_L141.BC.distances[idx] = kcg_lit_float32(0.0);
  }
  for (idx1 = 0; idx1 < 114; idx1++) {
    outC->_L141.BC.speeds[idx1] = kcg_lit_float32(0.0);
  }
  for (idx2 = 0; idx2 < 114; idx2++) {
    outC->_L141.BC.accelerations[idx2] = kcg_lit_float32(0.0);
  }
  ...
  outC->_L40.distance = kcg_lit_float32(0.0);
  outC->_L40.speed = kcg_lit_float32(0.0);
  for (idx4 = 0; idx4 < 100; idx4++) {
    outC->_L39.distance_definition[idx4] = kcg_lit_float32(0.0);
  }
  for (idx5 = 0; idx5 < 14; idx5++) {
    outC->_L39.speed_definition[idx5] = kcg_lit_float32(0.0);
  }
  for (idx7 = 0; idx7 < 14; idx7++) {
    for (idx6 = 0; idx6 < 100; idx6++) {
      outC->_L39.data[idx7][idx6] = kcg_lit_float32(0.0);
    }
  }
  outC->_L27.targetType = EoA_TargetManagement_types;
  outC->_L27.distance = kcg_lit_float32(0.0);
  outC->_L27.speed = kcg_lit_float32(0.0);
  ...
  for (idx8 = 0; idx8 < 100; idx8++) {
    outC->_L2.distance_definition[idx8] = kcg_lit_float32(0.0);
  }
  for (idx9 = 0; idx9 < 14; idx9++) {
    outC->_L2.speed_definition[idx9] = kcg_lit_float32(0.0);
  }
  for (idx11 = 0; idx11 < 14; idx11++) {
    for (idx10 = 0; idx10 < 100; idx10++) {
      outC->_L2.data[idx11][idx10] = kcg_lit_float32(0.0);
    }
  }
  outC->targetIsMRSPorLOA = kcg_true;
  outC->EBDFootMRSPorLOA = kcg_lit_float32(0.0);
  outC->every = kcg_true;
  outC->BCAcc.distance = kcg_lit_float32(0.0);
  outC->BCAcc.speed = kcg_lit_float32(0.0);
  outC->BCAcc.distanceIndex = kcg_lit_int32(0);
  outC->BCAcc.speedIndex = kcg_lit_int32(0);
  for (idx12 = 0; idx12 < 114; idx12++) {
    outC->BCAcc.BC.distances[idx12] = kcg_lit_float32(0.0);
  }
  for (idx13 = 0; idx13 < 114; idx13++) {
    outC->BCAcc.BC.speeds[idx13] = kcg_lit_float32(0.0);
  }
  for (idx14 = 0; idx14 < 114; idx14++) {
    outC->BCAcc.BC.accelerations[idx14] = kcg_lit_float32(0.0);
  }
