...
{
  /* weakenedPosition/ */
  static LocWithInAcc_T_Obu_BasicTypes_Pkg weakenedPosition_partial;
  static L_internal_Type_Obu_BasicTypes_Pkg noname;
  static L_internal_Type_Obu_BasicTypes_Pkg _1_noname;
  /* weakenedPosition/ */
  static LocWithInAcc_T_Obu_BasicTypes_Pkg _2_weakenedPosition_partial;
  ...
  if ((kcg_lit_int64(0) <= outC->_L71) & (outC->_L71 < kcg_lit_int64(41))) {
    kcg_copy_positionedBG_T_TrainPosition_Types_Pck(
      &outC->_L75,
      &outC->_L5[outC->_L71]);
  }
  ...
  outC_linkedBG_missed_CalculateTrainPosition_Pkg_Linking_Pkg *outC)
{
  ...
  for (idx = 0; idx < 33; idx++) {
    ...
    outC->_L75.infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L75.infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int64(0);
    outC->_L75.infoFromPassing.linkedBGs[idx].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L75.infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int64(0);
    outC->_L75.infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int64(0);
    outC->_L75.infoFromPassing.linkedBGs[idx].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L75.infoFromPassing.linkedBGs[idx].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L75.infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx2 = 0; idx2 < 41; idx2++) {
    ...
    outC->_L66[idx2].nid_c = kcg_lit_int64(0);
    outC->_L66[idx2].nid_bg = kcg_lit_int64(0);
    outC->_L66[idx2].q_link = Q_LINK_Unlinked;
    outC->_L66[idx2].location.nominal = kcg_lit_int64(0);
    outC->_L66[idx2].location.d_min = kcg_lit_int64(0);
    outC->_L66[idx2].location.d_max = kcg_lit_int64(0);
    outC->_L66[idx2].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L66[idx2].infoFromLinking.valid = kcg_true;
    outC->_L66[idx2].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L66[idx2].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L66[idx2].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L66[idx2].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L66[idx2].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L66[idx2].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L66[idx2].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L66[idx2].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L66[idx2].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L66[idx2].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L66[idx2].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L66[idx2].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L66[idx2].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L66[idx2].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    outC->_L66[idx2].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L66[idx2].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L66[idx2].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L66[idx2].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L66[idx2].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L66[idx2].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L66[idx2].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L66[idx2].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx1 = 0; idx1 < 33; idx1++) {
      ...
      outC->_L66[idx2].infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L66[idx2].infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int64(0);
      outC->_L66[idx2].infoFromPassing.linkedBGs[idx1].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L66[idx2].infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int64(0);
      outC->_L66[idx2].infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L66[idx2].infoFromPassing.linkedBGs[idx1].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L66[idx2].infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int64(0);
    }
    outC->_L66[idx2].missed = kcg_true;
  }
  for (idx4 = 0; idx4 < 41; idx4++) {
    outC->_L65[idx4].valid = kcg_true;
    outC->_L65[idx4].nid_c = kcg_lit_int64(0);
    outC->_L65[idx4].nid_bg = kcg_lit_int64(0);
    outC->_L65[idx4].q_link = Q_LINK_Unlinked;
    outC->_L65[idx4].location.nominal = kcg_lit_int64(0);
    outC->_L65[idx4].location.d_min = kcg_lit_int64(0);
    outC->_L65[idx4].location.d_max = kcg_lit_int64(0);
    outC->_L65[idx4].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L65[idx4].infoFromLinking.valid = kcg_true;
    outC->_L65[idx4].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L65[idx4].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L65[idx4].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L65[idx4].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L65[idx4].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L65[idx4].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L65[idx4].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L65[idx4].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L65[idx4].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L65[idx4].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L65[idx4].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L65[idx4].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L65[idx4].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L65[idx4].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    outC->_L65[idx4].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L65[idx4].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L65[idx4].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L65[idx4].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L65[idx4].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L65[idx4].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L65[idx4].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L65[idx4].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L65[idx4].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx3 = 0; idx3 < 33; idx3++) {
      ...
      outC->_L65[idx4].infoFromPassing.linkedBGs[idx3].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L65[idx4].infoFromPassing.linkedBGs[idx3].d_link = kcg_lit_int64(0);
      outC->_L65[idx4].infoFromPassing.linkedBGs[idx3].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L65[idx4].infoFromPassing.linkedBGs[idx3].nid_c = kcg_lit_int64(0);
      outC->_L65[idx4].infoFromPassing.linkedBGs[idx3].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L65[idx4].infoFromPassing.linkedBGs[idx3].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L65[idx4].infoFromPassing.linkedBGs[idx3].q_locacc = kcg_lit_int64(0);
    }
    outC->_L65[idx4].missed = kcg_true;
  }
  for (idx6 = 0; idx6 < 41; idx6++) {
    outC->_L64[idx6].valid = kcg_true;
    outC->_L64[idx6].nid_c = kcg_lit_int64(0);
    outC->_L64[idx6].nid_bg = kcg_lit_int64(0);
    outC->_L64[idx6].q_link = Q_LINK_Unlinked;
    outC->_L64[idx6].location.nominal = kcg_lit_int64(0);
    outC->_L64[idx6].location.d_min = kcg_lit_int64(0);
    outC->_L64[idx6].location.d_max = kcg_lit_int64(0);
    outC->_L64[idx6].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L64[idx6].infoFromLinking.valid = kcg_true;
    outC->_L64[idx6].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L64[idx6].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L64[idx6].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L64[idx6].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L64[idx6].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L64[idx6].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L64[idx6].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L64[idx6].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L64[idx6].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L64[idx6].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L64[idx6].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L64[idx6].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L64[idx6].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L64[idx6].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    outC->_L64[idx6].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L64[idx6].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L64[idx6].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L64[idx6].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L64[idx6].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L64[idx6].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L64[idx6].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L64[idx6].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L64[idx6].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx5 = 0; idx5 < 33; idx5++) {
      ...
      outC->_L64[idx6].infoFromPassing.linkedBGs[idx5].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L64[idx6].infoFromPassing.linkedBGs[idx5].d_link = kcg_lit_int64(0);
      outC->_L64[idx6].infoFromPassing.linkedBGs[idx5].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L64[idx6].infoFromPassing.linkedBGs[idx5].nid_c = kcg_lit_int64(0);
      outC->_L64[idx6].infoFromPassing.linkedBGs[idx5].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L64[idx6].infoFromPassing.linkedBGs[idx5].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L64[idx6].infoFromPassing.linkedBGs[idx5].q_locacc = kcg_lit_int64(0);
    }
  ...
  for (idx7 = 0; idx7 < 33; idx7++) {
    ...
    outC->_L62.infoFromPassing.linkedBGs[idx7].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L62.infoFromPassing.linkedBGs[idx7].d_link = kcg_lit_int64(0);
    outC->_L62.infoFromPassing.linkedBGs[idx7].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L62.infoFromPassing.linkedBGs[idx7].nid_c = kcg_lit_int64(0);
    outC->_L62.infoFromPassing.linkedBGs[idx7].nid_bg = kcg_lit_int64(0);
    outC->_L62.infoFromPassing.linkedBGs[idx7].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L62.infoFromPassing.linkedBGs[idx7].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L62.infoFromPassing.linkedBGs[idx7].q_locacc = kcg_lit_int64(0);
  }
  ...
  outC->_L53 = kcg_true;
  outC->_L54.nominal = kcg_lit_int64(0);
  outC->_L54.d_min = kcg_lit_int64(0);
  outC->_L54.d_max = kcg_lit_int64(0);
  outC->_L55 = kcg_lit_int64(0);
  outC->_L56.nominal = kcg_lit_int64(0);
  outC->_L56.d_min = kcg_lit_int64(0);
  outC->_L56.d_max = kcg_lit_int64(0);
  outC->_L57 = kcg_lit_int64(0);
  ...
  for (idx8 = 0; idx8 < 33; idx8++) {
    ...
    outC->_L10.infoFromPassing.linkedBGs[idx8].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L10.infoFromPassing.linkedBGs[idx8].d_link = kcg_lit_int64(0);
    outC->_L10.infoFromPassing.linkedBGs[idx8].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L10.infoFromPassing.linkedBGs[idx8].nid_c = kcg_lit_int64(0);
    outC->_L10.infoFromPassing.linkedBGs[idx8].nid_bg = kcg_lit_int64(0);
    outC->_L10.infoFromPassing.linkedBGs[idx8].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L10.infoFromPassing.linkedBGs[idx8].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L10.infoFromPassing.linkedBGs[idx8].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx10 = 0; idx10 < 41; idx10++) {
    ...
    outC->_L5[idx10].nid_c = kcg_lit_int64(0);
    outC->_L5[idx10].nid_bg = kcg_lit_int64(0);
    outC->_L5[idx10].q_link = Q_LINK_Unlinked;
    outC->_L5[idx10].location.nominal = kcg_lit_int64(0);
    outC->_L5[idx10].location.d_min = kcg_lit_int64(0);
    outC->_L5[idx10].location.d_max = kcg_lit_int64(0);
    outC->_L5[idx10].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L5[idx10].infoFromLinking.valid = kcg_true;
    outC->_L5[idx10].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L5[idx10].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L5[idx10].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L5[idx10].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L5[idx10].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L5[idx10].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L5[idx10].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L5[idx10].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L5[idx10].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L5[idx10].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L5[idx10].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L5[idx10].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L5[idx10].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L5[idx10].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    outC->_L5[idx10].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L5[idx10].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L5[idx10].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L5[idx10].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L5[idx10].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L5[idx10].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L5[idx10].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L5[idx10].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L5[idx10].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx9 = 0; idx9 < 33; idx9++) {
      ...
      outC->_L5[idx10].infoFromPassing.linkedBGs[idx9].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L5[idx10].infoFromPassing.linkedBGs[idx9].d_link = kcg_lit_int64(0);
      outC->_L5[idx10].infoFromPassing.linkedBGs[idx9].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L5[idx10].infoFromPassing.linkedBGs[idx9].nid_c = kcg_lit_int64(0);
      outC->_L5[idx10].infoFromPassing.linkedBGs[idx9].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L5[idx10].infoFromPassing.linkedBGs[idx9].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L5[idx10].infoFromPassing.linkedBGs[idx9].q_locacc = kcg_lit_int64(0);
    }
    outC->_L5[idx10].missed = kcg_true;
  }
  outC->_L1 = kcg_true;
  outC->weakenedPosition.nominal = kcg_lit_int64(0);
  outC->weakenedPosition.d_min = kcg_lit_int64(0);
  outC->weakenedPosition.d_max = kcg_lit_int64(0);
  outC->movedAhead = kcg_true;
  outC->IfBlock1_clock = kcg_true;
  outC->_L11_else_IfBlock1 = kcg_lit_int64(0);
  outC->_L12_else_IfBlock1 = kcg_lit_int64(0);
  outC->_L13_else_IfBlock1 = kcg_lit_int64(0);
  outC->_L10_else_IfBlock1 = kcg_lit_int64(0);
  outC->_L9_else_IfBlock1.nominal = kcg_lit_int64(0);
  outC->_L9_else_IfBlock1.d_min = kcg_lit_int64(0);
  outC->_L9_else_IfBlock1.d_max = kcg_lit_int64(0);
  outC->_L8_else_IfBlock1.nominal = kcg_lit_int64(0);
  outC->_L8_else_IfBlock1.d_min = kcg_lit_int64(0);
  outC->_L8_else_IfBlock1.d_max = kcg_lit_int64(0);
  outC->_L5_else_IfBlock1 = kcg_lit_int64(0);
  outC->_L6_else_IfBlock1 = kcg_lit_int64(0);
  ...
  outC->_L2_then_IfBlock1.nominal = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.d_min = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.d_max = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.nominal = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.d_min = kcg_lit_int64(0);
  outC->_L1_then_IfBlock1.d_max = kcg_lit_int64(0);
  outC->_L5_then_IfBlock1 = kcg_lit_int64(0);
  outC->_L4_then_IfBlock1 = kcg_lit_int64(0);
  outC->_L3_then_IfBlock1 = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.nominal = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.d_min = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.d_max = kcg_lit_int64(0);
  ...
  for (idx11 = 0; idx11 < 33; idx11++) {
    ...
    outC->_L3.infoFromPassing.linkedBGs[idx11].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L3.infoFromPassing.linkedBGs[idx11].d_link = kcg_lit_int64(0);
    outC->_L3.infoFromPassing.linkedBGs[idx11].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L3.infoFromPassing.linkedBGs[idx11].nid_c = kcg_lit_int64(0);
    outC->_L3.infoFromPassing.linkedBGs[idx11].nid_bg = kcg_lit_int64(0);
    outC->_L3.infoFromPassing.linkedBGs[idx11].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L3.infoFromPassing.linkedBGs[idx11].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L3.infoFromPassing.linkedBGs[idx11].q_locacc = kcg_lit_int64(0);
  }
  outC->_L3.missed = kcg_true;
  outC->init = kcg_true;
  for (idx13 = 0; idx13 < 41; idx13++) {
    outC->BGs_out[idx13].valid = kcg_true;
    outC->BGs_out[idx13].nid_c = kcg_lit_int64(0);
    outC->BGs_out[idx13].nid_bg = kcg_lit_int64(0);
    outC->BGs_out[idx13].q_link = Q_LINK_Unlinked;
    outC->BGs_out[idx13].location.nominal = kcg_lit_int64(0);
    outC->BGs_out[idx13].location.d_min = kcg_lit_int64(0);
    outC->BGs_out[idx13].location.d_max = kcg_lit_int64(0);
    outC->BGs_out[idx13].seqNoOnTrack = kcg_lit_int64(0);
    outC->BGs_out[idx13].infoFromLinking.valid = kcg_true;
    outC->BGs_out[idx13].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->BGs_out[idx13].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->BGs_out[idx13].infoFromLinking.expectedLocation.nominal =
      kcg_lit_int64(0);
    outC->BGs_out[idx13].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->BGs_out[idx13].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->BGs_out[idx13].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->BGs_out[idx13].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->BGs_out[idx13].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->BGs_out[idx13].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->BGs_out[idx13].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->BGs_out[idx13].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->BGs_out[idx13].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->BGs_out[idx13].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->BGs_out[idx13].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    ...
    outC->BGs_out[idx13].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->BGs_out[idx13].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->BGs_out[idx13].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->BGs_out[idx13].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->BGs_out[idx13].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->BGs_out[idx13].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->BGs_out[idx13].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->BGs_out[idx13].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx12 = 0; idx12 < 33; idx12++) {
      ...
      outC->BGs_out[idx13].infoFromPassing.linkedBGs[idx12].q_scale =
        Q_SCALE_10_cm_scale;
      outC->BGs_out[idx13].infoFromPassing.linkedBGs[idx12].d_link = kcg_lit_int64(0);
      outC->BGs_out[idx13].infoFromPassing.linkedBGs[idx12].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->BGs_out[idx13].infoFromPassing.linkedBGs[idx12].nid_c = kcg_lit_int64(0);
      outC->BGs_out[idx13].infoFromPassing.linkedBGs[idx12].nid_bg = kcg_lit_int64(0);
  ...
  outC->BG.nid_c = kcg_lit_int64(0);
  outC->BG.nid_bg = kcg_lit_int64(0);
  outC->BG.q_link = Q_LINK_Unlinked;
  outC->BG.location.nominal = kcg_lit_int64(0);
  outC->BG.location.d_min = kcg_lit_int64(0);
  outC->BG.location.d_max = kcg_lit_int64(0);
  outC->BG.seqNoOnTrack = kcg_lit_int64(0);
  outC->BG.infoFromLinking.valid = kcg_true;
  outC->BG.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->BG.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->BG.infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
  outC->BG.infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
  outC->BG.infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
  outC->BG.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->BG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->BG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->BG.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->BG.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  outC->BG.infoFromLinking.linkingInfo.q_dir = Q_DIR_Reverse;
  outC->BG.infoFromLinking.linkingInfo.q_scale = Q_SCALE_10_cm_scale;
  outC->BG.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->BG.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->BG.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->BG.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  ...
  outC->BG.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->BG.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->BG.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->BG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  outC->BG.infoFromPassing.BG_Header.q_link = Q_LINK_Unlinked;
  outC->BG.infoFromPassing.BG_Header.bgPosition.valid = kcg_true;
  outC->BG.infoFromPassing.BG_Header.bgPosition.timestamp = kcg_lit_int64(0);
  outC->BG.infoFromPassing.BG_Header.bgPosition.odo.o_nominal = kcg_lit_int64(0);
  outC->BG.infoFromPassing.BG_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->BG.infoFromPassing.BG_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
  ...
  outC->BG.infoFromPassing.BG_Header.bgPosition.speed.v_rawNominal =
    kcg_lit_int64(0);
  outC->BG.infoFromPassing.BG_Header.bgPosition.speed.v_lower = kcg_lit_int64(0);
  outC->BG.infoFromPassing.BG_Header.bgPosition.speed.v_upper = kcg_lit_int64(0);
  outC->BG.infoFromPassing.BG_Header.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->BG.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->BG.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx14 = 0; idx14 < 33; idx14++) {
    ...
    outC->BG.infoFromPassing.linkedBGs[idx14].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->BG.infoFromPassing.linkedBGs[idx14].d_link = kcg_lit_int64(0);
    outC->BG.infoFromPassing.linkedBGs[idx14].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->BG.infoFromPassing.linkedBGs[idx14].nid_c = kcg_lit_int64(0);
    outC->BG.infoFromPassing.linkedBGs[idx14].nid_bg = kcg_lit_int64(0);
    outC->BG.infoFromPassing.linkedBGs[idx14].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->BG.infoFromPassing.linkedBGs[idx14].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->BG.infoFromPassing.linkedBGs[idx14].q_locacc = kcg_lit_int64(0);
  }
...
void kcg_save_SV_linkedBG_missed_CalculateTrainPosition_Pkg_Linking_Pkg(
  SV_linkedBG_missed_CalculateTrainPosition_Pkg_Linking_Pkg *SV,
  outC_linkedBG_missed_CalculateTrainPosition_Pkg_Linking_Pkg *outC)
{
  kcg_save_SV_FallingEdge_digital(
    &SV->Context_FallingEdge_1,
    &outC->Context_FallingEdge_1);
  SV->Context__L2 = outC->_L2;
  kcg_copy_positionedBG_T_TrainPosition_Types_Pck(&SV->Context__L3, &outC->_L3);
  SV->Context_init = outC->init;
  kcg_copy_LocWithInAcc_T_Obu_BasicTypes_Pkg(
    &SV->Context_mem_position,
    &outC->mem_position);
}

void kcg_load_SV_linkedBG_missed_CalculateTrainPosition_Pkg_Linking_Pkg(
  outC_linkedBG_missed_CalculateTrainPosition_Pkg_Linking_Pkg *outC,
  SV_linkedBG_missed_CalculateTrainPosition_Pkg_Linking_Pkg *SV)
{
  kcg_load_SV_FallingEdge_digital(
    &outC->Context_FallingEdge_1,
    &SV->Context_FallingEdge_1);
  outC->_L2 = SV->Context__L2;
  kcg_copy_positionedBG_T_TrainPosition_Types_Pck(&outC->_L3, &SV->Context__L3);
