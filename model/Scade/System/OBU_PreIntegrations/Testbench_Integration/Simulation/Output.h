...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_Output_To_DMI_OutputManagement Context_Output_To_DMI_1;
  SV_Output_Mode_Level_To_Use_OutputManagement Context_Output_Mode_Level_To_Use_1;
} SV_Output;

extern void kcg_save_SV_Output(SV_Output *SV, outC_Output *outC);
extern void kcg_load_SV_Output(outC_Output *outC, SV_Output *SV);
