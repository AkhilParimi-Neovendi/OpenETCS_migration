  ...
  outC_DMI_Speed_and_CPS_for_Planning_Area_DMI_Control_Pkg_Sub_func *outC)
{
  ...
  outC->_L3.location_front_train = kcg_lit_int32(0);
  outC->_L3.location_brake_target = kcg_lit_int32(0);
  outC->_L3.v_target = kcg_lit_int32(0);
  outC->_L3.v_permitted = kcg_lit_int32(0);
  outC->_L3.v_release = kcg_lit_int32(0);
  outC->_L3.location_brake_curve_starting_point = kcg_lit_int32(0);
  outC->_L3.v_intervention = kcg_lit_int32(0);
  outC->_L3.mode = M_MODE_Full_Supervision;
  outC->_L3.level.level = M_LEVEL_Level_0;
  outC->_L3.level.nid_stm = kcg_lit_int32(0);
  ...
  outC->_L3.location_LOA = kcg_lit_int32(0);
  outC->_L3.v_LOA = kcg_lit_int32(0);
  outC->_L3.location_KP_Balise_Track = kcg_lit_int32(0);
  outC->_L3.distance_KP_Balise = kcg_lit_int32(0);
  outC->_L3.distance_to_TSA = kcg_lit_int32(0);
  ...
  outC->fronttrain = kcg_lit_float32(0.0);
  outC->vpermitted = kcg_lit_float32(0.0);
}
