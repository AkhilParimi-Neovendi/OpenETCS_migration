...
void kcg_save_SV_SoM_NTC_SN_SoMProcedure_Pkg(
  SV_SoM_NTC_SN_SoMProcedure_Pkg *SV,
  outC_SoM_NTC_SN_SoMProcedure_Pkg *outC)
{
  SV->Context_Level_NTC_and_Mode_SN_reset_nxt =
    outC->Level_NTC_and_Mode_SN_reset_nxt;
  SV->Context_Level_NTC_and_Mode_SN_reset_act =
    outC->Level_NTC_and_Mode_SN_reset_act;
  SV->Context_Level_NTC_and_Mode_SN_state_nxt =
    outC->Level_NTC_and_Mode_SN_state_nxt;
}

void kcg_load_SV_SoM_NTC_SN_SoMProcedure_Pkg(
  outC_SoM_NTC_SN_SoMProcedure_Pkg *outC,
  SV_SoM_NTC_SN_SoMProcedure_Pkg *SV)
{
  outC->Level_NTC_and_Mode_SN_reset_nxt =
