  ...
  outC_Read_P131_TM *outC)
{
  ...
  /* _L166=(TM_conversions::C_P131_compr_onboard#1)/ */
  C_P131_compr_onboard_TM_conversions(
    &outC->_L5,
    &outC->_L30,
    &outC->Context_C_P131_compr_onboard_1);
  kcg_copy_P131_OBU_T_TM(
    &outC->_L166,
    &outC->Context_C_P131_compr_onboard_1.P131_onboard);
  kcg_copy_P131_OBU_T_TM(&outC->P131_OBU_out, &outC->_L166);
}

#ifndef KCG_USER_DEFINED_INIT
void Read_P131_init_TM(outC_Read_P131_TM *outC)
{
  static kcg_size idx;
  ...
  outC->_L166.d_rbctr = kcg_lit_int64(0);
  outC->_L166.nid_c = kcg_lit_int64(0);
  outC->_L166.nid_rbc = kcg_lit_int64(0);
  ...
  outC->P131_OBU_out.valid = kcg_true;
  outC->P131_OBU_out.q_dir = Q_DIR_Reverse;
  outC->P131_OBU_out.q_scale = Q_SCALE_10_cm_scale;
  outC->P131_OBU_out.d_rbctr = kcg_lit_int64(0);
  outC->P131_OBU_out.nid_c = kcg_lit_int64(0);
  outC->P131_OBU_out.nid_rbc = kcg_lit_int64(0);
  outC->P131_OBU_out.nid_radio = kcg_lit_int64(0);
  outC->P131_OBU_out.q_sleepsession =
    Q_SLEEPSESSION_Ignore_session_establishment_order;
  outC->received = kcg_true;
  /* _L166=(TM_conversions::C_P131_compr_onboard#1)/ */
  C_P131_compr_onboard_init_TM_conversions(
    &outC->Context_C_P131_compr_onboard_1);
  /* _L5=(TM_lib_internal::RECV_ReadPackets#1)/ */
...
void Read_P131_reset_TM(outC_Read_P131_TM *outC)
{
  /* _L166=(TM_conversions::C_P131_compr_onboard#1)/ */
  C_P131_compr_onboard_reset_TM_conversions(
    &outC->Context_C_P131_compr_onboard_1);
  /* _L5=(TM_lib_internal::RECV_ReadPackets#1)/ */
