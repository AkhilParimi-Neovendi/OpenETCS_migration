...
void kcg_save_SV_Supervision_T_Cycloc_ProvidePositionReport_Pkg(
  SV_Supervision_T_Cycloc_ProvidePositionReport_Pkg *SV,
  outC_Supervision_T_Cycloc_ProvidePositionReport_Pkg *outC)
{
  SV->Context_lastTime = outC->lastTime;
}

void kcg_load_SV_Supervision_T_Cycloc_ProvidePositionReport_Pkg(
  outC_Supervision_T_Cycloc_ProvidePositionReport_Pkg *outC,
  SV_Supervision_T_Cycloc_ProvidePositionReport_Pkg *SV)
{
  outC->lastTime = SV->Context_lastTime;
}
