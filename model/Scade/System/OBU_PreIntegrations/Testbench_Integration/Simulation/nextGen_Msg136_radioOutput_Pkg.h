...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_Send_M136_TM_radio_messages Context_Send_M136_2;
} SV_nextGen_Msg136_radioOutput_Pkg;

extern void kcg_save_SV_nextGen_Msg136_radioOutput_Pkg(
  SV_nextGen_Msg136_radioOutput_Pkg *SV,
  outC_nextGen_Msg136_radioOutput_Pkg *outC);
extern void kcg_load_SV_nextGen_Msg136_radioOutput_Pkg(
  outC_nextGen_Msg136_radioOutput_Pkg *outC,
  SV_nextGen_Msg136_radioOutput_Pkg *SV);
