  ...
  outC_distanceLastBG_xdebugSupport_Pkg *outC)
{
  ...
  /* distance/ */
  static kcg_float32 last_distance;
  ...
  /* IfBlock1: */
  if (outC->IfBlock1_clock) {
    outC->_L9_then_IfBlock1 = kcg_lit_float32(0.0);
    ...
    outC->_L10_else_IfBlock1 = kcg_lit_float32(100.0);
    ...
    outC->_L8_else_IfBlock1 = /* IfBlock1:else:_L8= */(kcg_float32)
  ...
  outC_distanceLastBG_xdebugSupport_Pkg *outC)
{
  ...
  outC->_L3_else_IfBlock1 = kcg_lit_int32(0);
  outC->_L6_else_IfBlock1.valid = kcg_true;
  outC->_L6_else_IfBlock1.timestamp = kcg_lit_int32(0);
  outC->_L6_else_IfBlock1.odo.o_nominal = kcg_lit_int32(0);
  outC->_L6_else_IfBlock1.odo.o_min = kcg_lit_int32(0);
  outC->_L6_else_IfBlock1.odo.o_max = kcg_lit_int32(0);
  outC->_L6_else_IfBlock1.speed.v_safeNominal = kcg_lit_int32(0);
  outC->_L6_else_IfBlock1.speed.v_rawNominal = kcg_lit_int32(0);
  outC->_L6_else_IfBlock1.speed.v_lower = kcg_lit_int32(0);
  outC->_L6_else_IfBlock1.speed.v_upper = kcg_lit_int32(0);
  outC->_L6_else_IfBlock1.acceleration = kcg_lit_int32(0);
  ...
  outC->_L5_else_IfBlock1.o_nominal = kcg_lit_int32(0);
  outC->_L5_else_IfBlock1.o_min = kcg_lit_int32(0);
  outC->_L5_else_IfBlock1.o_max = kcg_lit_int32(0);
  outC->_L4_else_IfBlock1 = kcg_lit_int32(0);
  outC->_L7_else_IfBlock1 = kcg_lit_int32(0);
  outC->_L8_else_IfBlock1 = kcg_lit_float32(0.0);
  outC->_L9_else_IfBlock1 = kcg_lit_float32(0.0);
  ...
  outC->_L2_then_IfBlock1.BG_Common_Header.m_mcount = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.BG_Common_Header.nid_c = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.BG_Common_Header.nid_bg = kcg_lit_int32(0);
  ...
  outC->_L2_then_IfBlock1.BG_Common_Header.bgPosition.timestamp = kcg_lit_int32(
      0);
  outC->_L2_then_IfBlock1.BG_Common_Header.bgPosition.odo.o_nominal =
    kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.BG_Common_Header.bgPosition.odo.o_min = kcg_lit_int32(
      0);
  outC->_L2_then_IfBlock1.BG_Common_Header.bgPosition.odo.o_max = kcg_lit_int32(
      0);
  ...
  outC->_L2_then_IfBlock1.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.BG_Common_Header.q_nvlocacc = kcg_lit_int32(0);
  ...
  outC->_L2_then_IfBlock1.BG_Common_Header.trainRunningDirectionToBG =
    Q_DIRTRAIN_Reverse;
  outC->_L2_then_IfBlock1.Radio_Common_Header.radioDevice = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.Radio_Common_Header.receivedSystemTime =
    kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.Radio_Common_Header.nid_message = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.Radio_Common_Header.t_train = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.Radio_Common_Header.m_ack =
    M_ACK_No_acknowledgement_required;
  outC->_L2_then_IfBlock1.Radio_Common_Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.Radio_Common_Header.t_train_reference = kcg_lit_int32(
      0);
  outC->_L2_then_IfBlock1.Radio_Common_Header.nid_em = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L2_then_IfBlock1.Radio_Common_Header.d_sr = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.Radio_Common_Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.Radio_Common_Header.d_ref = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.Radio_Common_Header.q_dir = Q_DIR_Reverse;
  outC->_L2_then_IfBlock1.Radio_Common_Header.d_emergencystop = kcg_lit_int32(0);
  ...
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L2_then_IfBlock1.packets.PacketData[idx3] = kcg_lit_int32(0);
  }
  outC->_L2_then_IfBlock1.sendingRBC.valid = kcg_true;
  outC->_L2_then_IfBlock1.sendingRBC.nid_c = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.sendingRBC.rbc_id = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.sendingRBC.device_id = kcg_lit_int32(0);
  ...
  outC->_L3_then_IfBlock1.m_mcount = kcg_lit_int32(0);
  outC->_L3_then_IfBlock1.nid_c = kcg_lit_int32(0);
  outC->_L3_then_IfBlock1.nid_bg = kcg_lit_int32(0);
  outC->_L3_then_IfBlock1.q_link = Q_LINK_Unlinked;
  outC->_L3_then_IfBlock1.bgPosition.valid = kcg_true;
  outC->_L3_then_IfBlock1.bgPosition.timestamp = kcg_lit_int32(0);
  outC->_L3_then_IfBlock1.bgPosition.odo.o_nominal = kcg_lit_int32(0);
  outC->_L3_then_IfBlock1.bgPosition.odo.o_min = kcg_lit_int32(0);
  outC->_L3_then_IfBlock1.bgPosition.odo.o_max = kcg_lit_int32(0);
  outC->_L3_then_IfBlock1.bgPosition.speed.v_safeNominal = kcg_lit_int32(0);
  outC->_L3_then_IfBlock1.bgPosition.speed.v_rawNominal = kcg_lit_int32(0);
  outC->_L3_then_IfBlock1.bgPosition.speed.v_lower = kcg_lit_int32(0);
  outC->_L3_then_IfBlock1.bgPosition.speed.v_upper = kcg_lit_int32(0);
  outC->_L3_then_IfBlock1.bgPosition.acceleration = kcg_lit_int32(0);
  ...
  outC->_L3_then_IfBlock1.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int32(0);
  outC->_L3_then_IfBlock1.q_nvlocacc = kcg_lit_int32(0);
  ...
  outC->_L6_then_IfBlock1.odo.o_nominal = kcg_lit_int32(0);
  outC->_L6_then_IfBlock1.odo.o_min = kcg_lit_int32(0);
  outC->_L6_then_IfBlock1.odo.o_max = kcg_lit_int32(0);
  outC->_L6_then_IfBlock1.speed.v_safeNominal = kcg_lit_int32(0);
  outC->_L6_then_IfBlock1.speed.v_rawNominal = kcg_lit_int32(0);
  outC->_L6_then_IfBlock1.speed.v_lower = kcg_lit_int32(0);
  outC->_L6_then_IfBlock1.speed.v_upper = kcg_lit_int32(0);
  outC->_L6_then_IfBlock1.acceleration = kcg_lit_int32(0);
  ...
  outC->_L7_then_IfBlock1.o_nominal = kcg_lit_int32(0);
  outC->_L7_then_IfBlock1.o_min = kcg_lit_int32(0);
  outC->_L7_then_IfBlock1.o_max = kcg_lit_int32(0);
  outC->_L8_then_IfBlock1 = kcg_lit_int32(0);
  outC->_L9_then_IfBlock1 = kcg_lit_float32(0.0);
  outC->lastBG = kcg_lit_int32(0);
  outC->distance = kcg_lit_float32(0.0);
  outC->BG_ID = kcg_lit_int32(0);
  outC->BGLocation = kcg_lit_int32(0);
}
...
void kcg_save_SV_distanceLastBG_xdebugSupport_Pkg(
  SV_distanceLastBG_xdebugSupport_Pkg *SV,
  outC_distanceLastBG_xdebugSupport_Pkg *outC)
{
  SV->Context_distance = outC->distance;
  SV->Context_BGLocation = outC->BGLocation;
  SV->Context_BG_ID = outC->BG_ID;
}

void kcg_load_SV_distanceLastBG_xdebugSupport_Pkg(
  outC_distanceLastBG_xdebugSupport_Pkg *outC,
  SV_distanceLastBG_xdebugSupport_Pkg *SV)
{
  outC->distance = SV->Context_distance;
  outC->BGLocation = SV->Context_BGLocation;
  outC->BG_ID = SV->Context_BG_ID;
}
