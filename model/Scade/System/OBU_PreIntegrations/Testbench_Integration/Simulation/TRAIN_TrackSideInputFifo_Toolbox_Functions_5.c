  ...
  outC_TRAIN_TrackSideInputFifo_Toolbox_Functions_5 *outC)
{
  ...
  /* buffer/ */
  static _109_array buffer_partial_5;
  /* next_entry/ */
  static kcg_int64 _1_next_entry_partial_5;
  /* buffer/ */
  static _109_array _2_buffer_partial_5;
  /* entry/ */
  static kcg_int64 last_entry_5;
  /* buffer/ */
  static _109_array last_buffer_5;
  /* next_entry/ */
  ...
  kcg_copy__109_array(&last_buffer_5, &outC->buffer_5);
  ...
  if (outC->IfBlock1_clock_5) {
    ...
    /* IfBlock1:then:_L22= */
    if (outC->init1) {
      kcg_copy__109_array(&outC->_L22_then_IfBlock1_5, &outC->_L19_then_IfBlock1_5);
    }
    else {
      kcg_copy__109_array(&outC->_L22_then_IfBlock1_5, &outC->_L4_then_IfBlock1_5);
    }
    kcg_copy__109_array(&outC->_L1_then_IfBlock1_5, &outC->_L22_then_IfBlock1_5);
    ...
    kcg_copy__109_array(&buffer_partial_5, &outC->_L1_then_IfBlock1_5);
    kcg_copy__109_array(&outC->buffer_5, &buffer_partial_5);
  }
  else {
    kcg_copy__109_array(&_2_buffer_partial_5, &last_buffer_5);
    kcg_copy__109_array(&outC->buffer_5, &_2_buffer_partial_5);
  }
  kcg_copy__109_array(&outC->_L19_5, &outC->buffer_5);
  ...
  if (outC->IfBlock1_clock_5) {
    ...
    kcg_copy__109_array(&outC->_L4_then_IfBlock1_5, &buffer_partial_5);
...
void kcg_save_SV_TRAIN_TrackSideInputFifo_Toolbox_Functions_5(
  SV_TRAIN_TrackSideInputFifo_Toolbox_Functions_5 *SV,
  outC_TRAIN_TrackSideInputFifo_Toolbox_Functions_5 *outC)
{
  SV->Context__L50 = outC->_L50_5;
  SV->Context__L32 = outC->_L32_5;
  SV->Context_entry = outC->entry_5;
  kcg_copy__109_array(&SV->Context_buffer, &outC->buffer_5);
  SV->Context_next_entry = outC->next_entry_5;
  SV->Context_l_size = outC->l_size_5;
  kcg_copy__109_array(&SV->Context__L4, &outC->_L4_then_IfBlock1_5);
  SV->Context__L20 = outC->_L20_then_IfBlock1_5;
  SV->_1_Context_init = outC->init1;
  SV->Context_init = outC->init;
}

void kcg_load_SV_TRAIN_TrackSideInputFifo_Toolbox_Functions_5(
  outC_TRAIN_TrackSideInputFifo_Toolbox_Functions_5 *outC,
  SV_TRAIN_TrackSideInputFifo_Toolbox_Functions_5 *SV)
{
  outC->_L50_5 = SV->Context__L50;
  outC->_L32_5 = SV->Context__L32;
  outC->entry_5 = SV->Context_entry;
  kcg_copy__109_array(&outC->buffer_5, &SV->Context_buffer);
  outC->next_entry_5 = SV->Context_next_entry;
  outC->l_size_5 = SV->Context_l_size;
  kcg_copy__109_array(&outC->_L4_then_IfBlock1_5, &SV->Context__L4);
  outC->_L20_then_IfBlock1_5 = SV->Context__L20;
