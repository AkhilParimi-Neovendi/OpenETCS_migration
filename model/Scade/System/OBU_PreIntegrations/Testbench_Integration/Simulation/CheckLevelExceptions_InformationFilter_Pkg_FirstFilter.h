...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_Exception01StoreOnboardIfPendingL1Transition_InformationFilter_Pkg_FirstFilter /* _L30=(InformationFilter_Pkg::FirstFilter::Exception01StoreOnboardIfPendingL1Transition#2)/ */ Context_Exception01StoreOnboardIfPendingL1Transition_2;
  outC_Exception02StoreOnboardIfPendingL2L3Transition_InformationFilter_Pkg_FirstFilter /* _L34=(InformationFilter_Pkg::FirstFilter::Exception02StoreOnboardIfPendingL2L3Transition#2)/ */ Context_Exception02StoreOnboardIfPendingL2L3Transition_2;
  outC_Exception03RejectIfPendingAckOfTrainData_InformationFilter_Pkg_FirstFilter /* _L36=(InformationFilter_Pkg::FirstFilter::Exception03RejectIfPendingAckOfTrainData#2)/ */ Context_Exception03RejectIfPendingAckOfTrainData_2;
  outC_Exception05RejectIfEmergencyStopAccepted_InformationFilter_Pkg_FirstFilter /* _L38=(InformationFilter_Pkg::FirstFilter::Exception05RejectIfEmergencyStopAccepted#2)/ */ Context_Exception05RejectIfEmergencyStopAccepted_2;
  outC_Exception06StoreOnboardIfPendingNTCTransition_InformationFilter_Pkg_FirstFilter /* _L40=(InformationFilter_Pkg::FirstFilter::Exception06StoreOnboardIfPendingNTCTransition#2)/ */ Context_Exception06StoreOnboardIfPendingNTCTransition_2;
  outC_Exception07RejectIfNoPendingNTCTransition_InformationFilter_Pkg_FirstFilter /* _L65=(InformationFilter_Pkg::FirstFilter::Exception07RejectIfNoPendingNTCTransition#1)/ */ Context_Exception07RejectIfNoPendingNTCTransition_1;
  outC_Exception09RejectIfNoL2L3TransitionIsStored_InformationFilter_Pkg_FirstFilter /* _L111=(InformationFilter_Pkg::FirstFilter::Exception09RejectIfNoL2L3TransitionIsStored#1)/ */ Context_Exception09RejectIfNoL2L3TransitionIsStored_1;
  outC_Exception11RejectIfPendingTransition_InformationFilter_Pkg_FirstFilter /* _L113=(InformationFilter_Pkg::FirstFilter::Exception11RejectIfPendingTransition#1)/ */ Context_Exception11RejectIfPendingTransition_1;
  outC_Exception12RejectIfTextMessageAckPending_InformationFilter_Pkg_FirstFilter /* _L115=(InformationFilter_Pkg::FirstFilter::Exception12RejectIfTextMessageAckPending#1)/ */ Context_Exception12RejectIfTextMessageAckPending_1;
  outC_Exception04RejectIfSPPAndGradientOnBoardOrMACoverNotFullLength_InformationFilter_Pkg_FirstFilter /* _L127=(InformationFilter_Pkg::FirstFilter::Exception04RejectIfSPPAndGradientOnBoardOrMACoverNotFullLength#1)/ */ Context_Exception04RejectIfSPPAndGradientOnBoardOrMACoverNotFullLength_1;
  ...
  outC_Exception0102StoreOnboardIfPendingTransition_InformationFilter_Pkg_FirstFilter /* _L135=(InformationFilter_Pkg::FirstFilter::Exception0102StoreOnboardIfPendingTransition#1)/ */ Context_Exception0102StoreOnboardIfPendingTransition_1;
  outC_Exception13RejectIfNotWithImmediateL1L2L3Transition_InformationFilter_Pkg_FirstFilter /* _L117=(InformationFilter_Pkg::FirstFilter::Exception13RejectIfNotWithImmediateL1L2L3Transition#1)/ */ Context_Exception13RejectIfNotWithImmediateL1L2L3Transition_1;
