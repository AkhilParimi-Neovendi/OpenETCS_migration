...
typedef struct {
  ...
  kcg_float64 /* Gradient_Begin_Section/ */ Gradient_Begin_Section;
  kcg_float64 /* Gradient_End_Section/ */ Gradient_End_Section;
  kcg_float64 /* Gradient_Value_Section/ */ Gradient_Value_Section;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
