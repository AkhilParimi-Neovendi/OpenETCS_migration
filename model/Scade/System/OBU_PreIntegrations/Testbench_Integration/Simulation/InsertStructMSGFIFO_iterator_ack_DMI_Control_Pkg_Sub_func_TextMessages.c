...
{
  /* OutputArray/ */
  static _82_array last_OutputArray;

  kcg_copy__82_array(&last_OutputArray, &outC->OutputArray);
  outC->_L72 = Position;
  outC->_L70 = index;
  ...
  kcg_copy_DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg(
    ...
    &outC->_L80);
  outC->_L76 = index;
  kcg_copy__82_array(&outC->_L75, acc);
  kcg_copy__82_array(&outC->_L78, &outC->_L75);
  if ((kcg_lit_int32(0) <= outC->_L76) & (outC->_L76 < kcg_lit_int32(5))) {
    kcg_copy_MsgStructure(&outC->_L78[outC->_L76], &outC->_L77);
  }
  kcg_copy__82_array(&outC->_L63, acc);
  /* _L74= */
  if (outC->_L85) {
    kcg_copy__82_array(&outC->_L74, &outC->_L78);
  }
  else {
    kcg_copy__82_array(&outC->_L74, &outC->_L63);
  }
  ...
  kcg_copy__82_array(&outC->_L40, acc);
  if ((kcg_lit_int32(0) <= outC->_L43) & (outC->_L43 < kcg_lit_int32(5))) {
  ...
  outC->_L38 = index;
  kcg_copy__82_array(&outC->_L22, acc);
  kcg_copy__82_array(&outC->_L26, &outC->_L22);
  if ((kcg_lit_int32(0) <= outC->_L38) & (outC->_L38 < kcg_lit_int32(5))) {
  ...
  /* _L35= */
  if (outC->_L31) {
    kcg_copy__82_array(&outC->_L35, &outC->_L26);
  }
  else {
    kcg_copy__82_array(&outC->_L35, &outC->_L74);
  }
  outC->_L20 = index;
  outC->_L13 = kcg_true;
  ...
  kcg_copy_DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg(
    &outC->_L12.dmi_msg,
    &outC->_L3);
  kcg_copy__82_array(&outC->_L14, acc);
  kcg_copy__82_array(&outC->_L19, &outC->_L14);
  if ((kcg_lit_int32(0) <= outC->_L20) & (outC->_L20 < kcg_lit_int32(5))) {
    kcg_copy_MsgStructure(&outC->_L19[outC->_L20], &outC->_L12);
  }
  /* _L6= */
  if (outC->_L81) {
    kcg_copy__82_array(&outC->_L6, &outC->_L19);
  }
  else {
    kcg_copy__82_array(&outC->_L6, &outC->_L35);
  }
  kcg_copy__82_array(&outC->OutputArray, &outC->_L6);
}
  ...
  outC_InsertStructMSGFIFO_iterator_ack_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  for (idx1 = 0; idx1 < 5; idx1++) {
    ...
    outC->_L75[idx1].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L75[idx1].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L75[idx1].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L75[idx1].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  outC->_L77.dmi_msg.system_clock = kcg_lit_int32(0);
  outC->_L77.dmi_msg.textMessage_ID = kcg_lit_int32(0);
  outC->_L77.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L77.dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx4 = 0; idx4 < 5; idx4++) {
    ...
    outC->_L78[idx4].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L78[idx4].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L78[idx4].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L78[idx4].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  outC->_L80.system_clock = kcg_lit_int32(0);
  outC->_L80.textMessage_ID = kcg_lit_int32(0);
  outC->_L80.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L80.l_text = kcg_lit_int32(0);
  ...
  for (idx7 = 0; idx7 < 5; idx7++) {
    ...
    outC->_L74[idx7].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L74[idx7].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L74[idx7].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L74[idx7].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx9 = 0; idx9 < 5; idx9++) {
    ...
    outC->_L63[idx9].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L63[idx9].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L63[idx9].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L63[idx9].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  outC->_L41.dmi_msg.system_clock = kcg_lit_int32(0);
  outC->_L41.dmi_msg.textMessage_ID = kcg_lit_int32(0);
  outC->_L41.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L41.dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx12 = 0; idx12 < 5; idx12++) {
    ...
    outC->_L40[idx12].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L40[idx12].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L40[idx12].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L40[idx12].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  outC->_L39.dmi_msg.system_clock = kcg_lit_int32(0);
  outC->_L39.dmi_msg.textMessage_ID = kcg_lit_int32(0);
  outC->_L39.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L39.dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx15 = 0; idx15 < 5; idx15++) {
    ...
    outC->_L35[idx15].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L35[idx15].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L35[idx15].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L35[idx15].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx17 = 0; idx17 < 5; idx17++) {
    ...
    outC->_L22[idx17].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L22[idx17].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L22[idx17].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L22[idx17].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx19 = 0; idx19 < 5; idx19++) {
    ...
    outC->_L26[idx19].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L26[idx19].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L26[idx19].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L26[idx19].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx21 = 0; idx21 < 5; idx21++) {
    ...
    outC->_L19[idx21].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L19[idx21].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L19[idx21].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L19[idx21].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  outC->_L3.textMessage_ID = kcg_lit_int32(0);
  outC->_L3.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L3.l_text = kcg_lit_int32(0);
  ...
  outC->_L12.dmi_msg.system_clock = kcg_lit_int32(0);
  outC->_L12.dmi_msg.textMessage_ID = kcg_lit_int32(0);
  outC->_L12.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L12.dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx25 = 0; idx25 < 5; idx25++) {
    ...
    outC->_L14[idx25].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L14[idx25].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L14[idx25].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L14[idx25].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx27 = 0; idx27 < 5; idx27++) {
    ...
    outC->_L6[idx27].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L6[idx27].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L6[idx27].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L6[idx27].dmi_msg.l_text = kcg_lit_int32(0);
...
void kcg_save_SV_InsertStructMSGFIFO_iterator_ack_DMI_Control_Pkg_Sub_func_TextMessages(
  SV_InsertStructMSGFIFO_iterator_ack_DMI_Control_Pkg_Sub_func_TextMessages *SV,
  outC_InsertStructMSGFIFO_iterator_ack_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  kcg_copy__82_array(&SV->Context_OutputArray, &outC->OutputArray);
}

void kcg_load_SV_InsertStructMSGFIFO_iterator_ack_DMI_Control_Pkg_Sub_func_TextMessages(
  outC_InsertStructMSGFIFO_iterator_ack_DMI_Control_Pkg_Sub_func_TextMessages *outC,
  SV_InsertStructMSGFIFO_iterator_ack_DMI_Control_Pkg_Sub_func_TextMessages *SV)
{
  kcg_copy__82_array(&outC->OutputArray, &SV->Context_OutputArray);
}
