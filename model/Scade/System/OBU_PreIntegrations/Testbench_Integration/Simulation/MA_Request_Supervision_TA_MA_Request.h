...
typedef struct {
  ...
  _132_SSM_ST_SM1 /* SM1: */ SM1_state_nxt;
  ...
  kcg_bool every;
  kcg_bool every1;
  _132_SSM_ST_SM1 /* SM1: */ SM1_state_act;
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  kcg_bool /* SM1:NoReqPending:_L1/ */ _L1_NoReqPending_SM1;
  kcg_bool /* SM1:ReqPending:_L4/ */ _L4_ReqPending_SM1;
  _132_SSM_ST_SM1 /* SM1: */ SM1_state_sel;
  _133_SSM_TR_SM1 /* SM1: */ SM1_fired_strong;
  _133_SSM_TR_SM1 /* SM1: */ SM1_fired;
...
typedef struct {
  /* ----------------------  memorised outputs  ---------------------- */
  kcg_bool /* triggerMA/ */ Context_triggerMA;
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* pendingReq/ */ Context_pendingReq;
  kcg_bool /* SM1: */ Context_SM1_reset_nxt;
  kcg_bool /* SM1: */ Context_SM1_reset_act;
  _132_SSM_ST_SM1 /* SM1: */ Context_SM1_state_nxt;
  kcg_bool /* in_triggerMA/ */ Context_mem_in_triggerMA;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_op_3_8_2_3_a_TA_MA_Request Context_op_3_8_2_3_a;
  SV_op_RepeatReq_TA_MA_Request Context_op_RepeatReq_1;
  SV_RisingEdge_digital Context_RisingEdge_2;
  SV_RisingEdge_digital Context_RisingEdge_1;
} SV_MA_Request_Supervision_TA_MA_Request;

extern void kcg_save_SV_MA_Request_Supervision_TA_MA_Request(
  SV_MA_Request_Supervision_TA_MA_Request *SV,
  outC_MA_Request_Supervision_TA_MA_Request *outC);
extern void kcg_load_SV_MA_Request_Supervision_TA_MA_Request(
  outC_MA_Request_Supervision_TA_MA_Request *outC,
  SV_MA_Request_Supervision_TA_MA_Request *SV);
