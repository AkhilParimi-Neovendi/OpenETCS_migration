...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* SM_Train_Trip: */ Context_SM_Train_Trip_reset_nxt;
  kcg_bool /* SM_Train_Trip: */ Context_SM_Train_Trip_reset_act;
  SSM_ST_SM_Train_Trip /* SM_Train_Trip: */ Context_SM_Train_Trip_state_nxt;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
...
} SV_Procedure_Train_Trip_Procedures;

extern void kcg_save_SV_Procedure_Train_Trip_Procedures(
  SV_Procedure_Train_Trip_Procedures *SV,
  outC_Procedure_Train_Trip_Procedures *outC);
extern void kcg_load_SV_Procedure_Train_Trip_Procedures(
  outC_Procedure_Train_Trip_Procedures *outC,
  SV_Procedure_Train_Trip_Procedures *SV);
