  ...
  outC_Length_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  outC->_L77 = kcg_lit_int64(5);
  outC->_L69 = kcg_lit_float64(-1.0);
  kcg_copy_array_float64_5(&outC->_L65, array_mm_local);
  ...
  outC->_L62 = kcg_lit_int64(4);
  kcg_copy_array_float64_5(&outC->_L60, array_mm_local);
  outC->_L61 = outC->_L60[0];
  outC->_L59 = outC->_L60[1];
  outC->_L52 = kcg_lit_float64(-1.0);
  ...
  outC->_L47 = kcg_lit_int64(3);
  outC->_L37 = kcg_lit_float64(-1.0);
  kcg_copy_array_float64_5(&outC->_L43, array_mm_local);
  ...
  outC->_L20 = kcg_lit_float64(-1.0);
  kcg_copy_array_float64_5(&outC->_L22, array_mm_local);
  ...
  kcg_copy_array_float64_5(&outC->_L1, array_mm_local);
  outC->_L8 = outC->_L1[4];
  ...
  outC_Length_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  for (idx = 0; idx < 5; idx++) {
    outC->_L65[idx] = kcg_lit_float64(0.0);
  }
  outC->_L66 = kcg_true;
  outC->_L67 = kcg_true;
  ...
  for (idx1 = 0; idx1 < 5; idx1++) {
    outC->_L60[idx1] = kcg_lit_float64(0.0);
  }
  ...
  for (idx4 = 0; idx4 < 5; idx4++) {
    outC->_L1[idx4] = kcg_lit_float64(0.0);
  }
  outC->length = kcg_lit_int64(0);
}
