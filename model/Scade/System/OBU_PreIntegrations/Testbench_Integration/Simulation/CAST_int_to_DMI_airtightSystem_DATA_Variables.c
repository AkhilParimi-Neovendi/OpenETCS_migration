  ...
  outC_CAST_int_to_DMI_airtightSystem_DATA_Variables *outC)
{
  ...
  outC->dmi_airtightSystem_ct.number = kcg_lit_int32(0);
  outC->dmi_airtightSystem_ct.dig1 = kcg_lit_int32(0);
  outC->dmi_airtightSystem_ct.dig2 = kcg_lit_int32(0);
  outC->dmi_airtightSystem_ct.dig3 = kcg_lit_int32(0);
}
