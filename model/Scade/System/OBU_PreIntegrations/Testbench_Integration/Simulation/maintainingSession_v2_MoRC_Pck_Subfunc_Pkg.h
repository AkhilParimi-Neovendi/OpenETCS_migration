...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
} SV_maintainingSession_v2_MoRC_Pck_Subfunc_Pkg;

extern void kcg_save_SV_maintainingSession_v2_MoRC_Pck_Subfunc_Pkg(
  SV_maintainingSession_v2_MoRC_Pck_Subfunc_Pkg *SV,
  outC_maintainingSession_v2_MoRC_Pck_Subfunc_Pkg *outC);
extern void kcg_load_SV_maintainingSession_v2_MoRC_Pck_Subfunc_Pkg(
  outC_maintainingSession_v2_MoRC_Pck_Subfunc_Pkg *outC,
  SV_maintainingSession_v2_MoRC_Pck_Subfunc_Pkg *SV);
