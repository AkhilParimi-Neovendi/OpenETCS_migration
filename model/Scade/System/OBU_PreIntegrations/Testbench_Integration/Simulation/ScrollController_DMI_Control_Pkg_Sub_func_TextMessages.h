...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  kcg_int64 /* scrollUpTypeIndex/ */ scrollUpTypeIndex;
  kcg_int64 /* scrollLevel/ */ scrollLevel;
  kcg_int64 /* scrollDownTypeIndex/ */ scrollDownTypeIndex;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
...
typedef struct {
  /* ----------------------  memorised outputs  ---------------------- */
  kcg_int64 /* scrollDownTypeIndex/ */ Context_scrollDownTypeIndex;
  kcg_int64 /* scrollLevel/ */ Context_scrollLevel;
  kcg_int64 /* scrollUpTypeIndex/ */ Context_scrollUpTypeIndex;
  /* -----------------------  no local memory  ----------------------- */
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
