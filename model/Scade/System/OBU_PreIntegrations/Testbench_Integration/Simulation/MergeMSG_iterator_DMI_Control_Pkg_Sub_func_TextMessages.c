...
{
  kcg_copy__94_array(&outC->_L38, acc);
  kcg_copy__94_array(&outC->_L37, auximsgArray);
  ...
  kcg_copy_MsgStructure(
    ...
    (MsgStructure *) &cMsgStructure_DMI_Control_Pkg);
  outC->_L33 = index;
  if ((kcg_lit_int32(0) <= outC->_L33) & (outC->_L33 < kcg_lit_int32(10))) {
  ...
  kcg_copy_MsgStructure(
    ...
    (MsgStructure *) &cMsgStructure_DMI_Control_Pkg);
  outC->_L25 = numAuxi;
  kcg_copy__94_array(&outC->_L24, ImpmsgArray);
  outC->_L22 = index;
  outC->_L21 = index;
  outC->_L13 = outC->_L22 - outC->_L25;
  if ((kcg_lit_int32(0) <= outC->_L13) & (outC->_L13 < kcg_lit_int32(10))) {
    kcg_copy_MsgStructure(&outC->_L11, &outC->_L24[outC->_L13]);
  }
  else {
    kcg_copy_MsgStructure(&outC->_L11, &outC->_L29);
  }
  kcg_copy__94_array(&outC->_L12, acc);
  kcg_copy__94_array(&outC->_L15, &outC->_L12);
  if ((kcg_lit_int32(0) <= outC->_L21) & (outC->_L21 < kcg_lit_int32(10))) {
    kcg_copy_MsgStructure(&outC->_L15[outC->_L21], &outC->_L11);
  }
  /* _L5= */
  if (outC->_L35) {
    kcg_copy__94_array(&outC->_L5, &outC->_L38);
  }
  else {
    kcg_copy__94_array(&outC->_L5, &outC->_L15);
  }
  kcg_copy__94_array(&outC->OutputArray, &outC->_L5);
}
  ...
  outC_MergeMSG_iterator_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  for (idx1 = 0; idx1 < 10; idx1++) {
    ...
    outC->_L38[idx1].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L38[idx1].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L38[idx1].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L38[idx1].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx3 = 0; idx3 < 10; idx3++) {
    ...
    outC->_L37[idx3].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L37[idx3].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L37[idx3].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L37[idx3].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  outC->_L36.dmi_msg.system_clock = kcg_lit_int32(0);
  outC->_L36.dmi_msg.textMessage_ID = kcg_lit_int32(0);
  outC->_L36.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L36.dmi_msg.l_text = kcg_lit_int32(0);
  ...
  outC->_L29.dmi_msg.system_clock = kcg_lit_int32(0);
  outC->_L29.dmi_msg.textMessage_ID = kcg_lit_int32(0);
  outC->_L29.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L29.dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx9 = 0; idx9 < 10; idx9++) {
    ...
    outC->_L24[idx9].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L24[idx9].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L24[idx9].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L24[idx9].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  outC->_L11.dmi_msg.system_clock = kcg_lit_int32(0);
  outC->_L11.dmi_msg.textMessage_ID = kcg_lit_int32(0);
  outC->_L11.dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
  outC->_L11.dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx12 = 0; idx12 < 10; idx12++) {
    ...
    outC->_L12[idx12].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L12[idx12].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L12[idx12].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L12[idx12].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx14 = 0; idx14 < 10; idx14++) {
    ...
    outC->_L15[idx14].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L15[idx14].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L15[idx14].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L15[idx14].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx16 = 0; idx16 < 10; idx16++) {
    ...
    outC->_L5[idx16].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->_L5[idx16].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->_L5[idx16].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->_L5[idx16].dmi_msg.l_text = kcg_lit_int32(0);
  ...
  for (idx18 = 0; idx18 < 10; idx18++) {
    ...
    outC->OutputArray[idx18].dmi_msg.system_clock = kcg_lit_int32(0);
    outC->OutputArray[idx18].dmi_msg.textMessage_ID = kcg_lit_int32(0);
    outC->OutputArray[idx18].dmi_msg.q_text = balise_read_error_DMI_Types_Pkg;
    outC->OutputArray[idx18].dmi_msg.l_text = kcg_lit_int32(0);
