...
{
  /* q_media/ */
  static Q_MEDIA q_media_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* q_media/ */
  static Q_MEDIA _1_q_media_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* error/ */
  static kcg_bool _3_error_partial;
  /* q_media/ */
  static Q_MEDIA _4_q_media_partial;
  /* error/ */
  static kcg_bool _5_error_partial;
  /* q_media/ */
  static Q_MEDIA _6_q_media_partial;
  ...
  outC_CAST_Int_to_Q_MEDIA_TM_conversions *outC)
{
  ...
  outC->_L13 = kcg_true;
  outC->q_media_in = kcg_lit_int32(0);
  outC->error = kcg_true;
