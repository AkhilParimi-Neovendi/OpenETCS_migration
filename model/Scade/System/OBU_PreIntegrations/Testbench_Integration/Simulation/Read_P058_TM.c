  ...
  outC_Read_P058_TM *outC)
{
  ...
  /* _L166=(TM_conversions::C_P058_compr_onboard#1)/ */
  C_P058_compr_onboard_TM_conversions(
    &outC->_L5,
    &outC->_L30,
    &outC->Context_C_P058_compr_onboard_1);
  kcg_copy_P058_OBU_T_TM(
    &outC->_L166,
    &outC->Context_C_P058_compr_onboard_1.P058_onboard);
  kcg_copy_P058_OBU_T_TM(&outC->P058_OBU_out, &outC->_L166);
}

#ifndef KCG_USER_DEFINED_INIT
void Read_P058_init_TM(outC_Read_P058_TM *outC)
{
  static kcg_size idx;
  ...
  outC->_L166.t_cycloc = kcg_lit_int32(0);
  outC->_L166.d_cycloc = kcg_lit_int32(0);
  outC->_L166.m_loc = M_LOC_Now;
  outC->_L166.n_iter = kcg_lit_int32(0);
  for (idx = 0; idx < 32; idx++) {
    outC->_L166.sections[idx].valid = kcg_true;
    outC->_L166.sections[idx].d_loc = kcg_lit_int32(0);
    outC->_L166.sections[idx].q_lgtloc = Q_LGTLOC_Min_safe_rear_end;
  }
  ...
  outC->P058_OBU_out.valid = kcg_true;
  outC->P058_OBU_out.q_dir = Q_DIR_Reverse;
  outC->P058_OBU_out.q_scale = Q_SCALE_10_cm_scale;
  outC->P058_OBU_out.t_cycloc = kcg_lit_int32(0);
  outC->P058_OBU_out.d_cycloc = kcg_lit_int32(0);
  outC->P058_OBU_out.m_loc = M_LOC_Now;
  outC->P058_OBU_out.n_iter = kcg_lit_int32(0);
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->P058_OBU_out.sections[idx4].valid = kcg_true;
    outC->P058_OBU_out.sections[idx4].d_loc = kcg_lit_int32(0);
    outC->P058_OBU_out.sections[idx4].q_lgtloc = Q_LGTLOC_Min_safe_rear_end;
  }
  outC->received = kcg_true;
  /* _L166=(TM_conversions::C_P058_compr_onboard#1)/ */
  C_P058_compr_onboard_init_TM_conversions(
    &outC->Context_C_P058_compr_onboard_1);
  /* _L5=(TM_lib_internal::RECV_ReadPackets#1)/ */
...
void Read_P058_reset_TM(outC_Read_P058_TM *outC)
{
  /* _L166=(TM_conversions::C_P058_compr_onboard#1)/ */
  C_P058_compr_onboard_reset_TM_conversions(
    &outC->Context_C_P058_compr_onboard_1);
  /* _L5=(TM_lib_internal::RECV_ReadPackets#1)/ */
