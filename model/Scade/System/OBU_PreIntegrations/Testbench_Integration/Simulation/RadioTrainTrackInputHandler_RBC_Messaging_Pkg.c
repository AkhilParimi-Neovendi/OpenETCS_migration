  ...
  outC_RadioTrainTrackInputHandler_RBC_Messaging_Pkg *outC)
{
  ...
  outC->_L4.header.nid_message = kcg_lit_int32(0);
  outC->_L4.header.t_train = kcg_lit_int32(0);
  outC->_L4.header.nid_engine = kcg_lit_int32(0);
  outC->_L4.header.xQ_MARQSTREASON = Q_MARQSTREASON_Start_selected_by_driver;
  outC->_L4.header.xT_TRAIN = kcg_lit_int32(0);
  outC->_L4.header.xNID_EM = kcg_lit_int32(0);
  outC->_L4.header.xQ_EMERGENCYSTOP =
    Q_EMERGENCYSTOP_Conditional_Emergency_Stop_accepted_with_update_of_EOA;
  outC->_L4.header.xNID_TEXTMESSAGE = kcg_lit_int32(0);
  outC->_L4.packets.p0.valid = kcg_true;
  outC->_L4.packets.p0.packet0.NID_PACKET = kcg_lit_int32(0);
  outC->_L4.packets.p0.packet0.L_PACKET = kcg_lit_int32(0);
  outC->_L4.packets.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L4.packets.p0.packet0.NID_LRBG = kcg_lit_int32(0);
  outC->_L4.packets.p0.packet0.D_LRBG = kcg_lit_int32(0);
  outC->_L4.packets.p0.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L4.packets.p0.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->_L4.packets.p0.packet0.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L4.packets.p0.packet0.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L4.packets.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L4.packets.p0.packet0.L_TRAININT = kcg_lit_int32(0);
  outC->_L4.packets.p0.packet0.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L4.packets.p0.packet0.NID_NTC = kcg_lit_int32(0);
  outC->_L4.packets.p1.valid = kcg_true;
  outC->_L4.packets.p1.packet1.NID_PACKET = kcg_lit_int32(0);
  outC->_L4.packets.p1.packet1.L_PACKET = kcg_lit_int32(0);
  outC->_L4.packets.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L4.packets.p1.packet1.NID_LRBG = kcg_lit_int32(0);
  outC->_L4.packets.p1.packet1.NID_PRVLRBG = kcg_lit_int32(0);
  outC->_L4.packets.p1.packet1.D_LRBG = kcg_lit_int32(0);
  outC->_L4.packets.p1.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L4.packets.p1.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L4.packets.p1.packet1.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L4.packets.p1.packet1.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L4.packets.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L4.packets.p1.packet1.L_TRAININT = kcg_lit_int32(0);
  outC->_L4.packets.p1.packet1.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L4.packets.p1.packet1.NID_NTC = kcg_lit_int32(0);
  outC->_L4.packets.p3.valid = kcg_true;
  outC->_L4.packets.p3.number = kcg_lit_int32(0);
  for (idx1 = 0; idx1 < 1; idx1++) {
    outC->_L4.packets.p3.aNID_RADIO[idx1].valid = kcg_true;
    for (idx = 0; idx < 15; idx++) {
      outC->_L4.packets.p3.aNID_RADIO[idx1].telephoneNumber[idx] = kcg_lit_int32(0);
    }
  }
  ...
  outC->_L4.packets.p5.TrainRunningNumber = kcg_lit_int32(0);
  outC->_L4.packets.p9.valid = kcg_true;
  outC->_L4.packets.p9.transitionInformation = kcg_lit_int32(0);
  ...
  outC->_L4.packets.p11.l_train = kcg_lit_int32(0);
  outC->_L4.packets.p11.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L4.packets.p11.n_axle = kcg_lit_int32(0);
  outC->_L4.packets.p11.nIter_tractionIdentity = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 4; idx2++) {
    outC->_L4.packets.p11.tractionIdentity[idx2].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L4.packets.p11.tractionIdentity[idx2].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L4.packets.p11.nIter_ntc = kcg_lit_int32(0);
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L4.packets.p11.nid_ntc[idx3] = kcg_lit_int32(0);
  }
  ...
  for (idx9 = 0; idx9 < 1; idx9++) {
    ...
    for (idx8 = 0; idx8 < 15; idx8++) {
      outC->_L2.packets.p3.aNID_RADIO[idx9].telephoneNumber[idx8] = kcg_lit_int32(0);
    }
  }
  ...
  for (idx10 = 0; idx10 < 4; idx10++) {
    outC->_L2.packets.p11.tractionIdentity[idx10].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L2.packets.p11.tractionIdentity[idx10].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L2.packets.p11.nIter_ntc = kcg_lit_int32(0);
  for (idx11 = 0; idx11 < 5; idx11++) {
    outC->_L2.packets.p11.nid_ntc[idx11] = kcg_lit_int32(0);
  }
  outC->_L3 = kcg_true;
  outC->outRadioTrainTrack.present = kcg_true;
  outC->outRadioTrainTrack.header.present = kcg_true;
  outC->outRadioTrainTrack.header.nid_message = kcg_lit_int32(0);
  outC->outRadioTrainTrack.header.t_train = kcg_lit_int32(0);
  outC->outRadioTrainTrack.header.nid_engine = kcg_lit_int32(0);
  outC->outRadioTrainTrack.header.xQ_MARQSTREASON =
    Q_MARQSTREASON_Start_selected_by_driver;
  outC->outRadioTrainTrack.header.xT_TRAIN = kcg_lit_int32(0);
  outC->outRadioTrainTrack.header.xNID_EM = kcg_lit_int32(0);
  outC->outRadioTrainTrack.header.xQ_EMERGENCYSTOP =
    Q_EMERGENCYSTOP_Conditional_Emergency_Stop_accepted_with_update_of_EOA;
  outC->outRadioTrainTrack.header.xNID_TEXTMESSAGE = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p0.valid = kcg_true;
  outC->outRadioTrainTrack.packets.p0.packet0.NID_PACKET = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p0.packet0.L_PACKET = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->outRadioTrainTrack.packets.p0.packet0.NID_LRBG = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p0.packet0.D_LRBG = kcg_lit_int32(0);
  ...
  outC->outRadioTrainTrack.packets.p0.packet0.L_DOUBTOVER = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p0.packet0.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->outRadioTrainTrack.packets.p0.packet0.L_TRAININT = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p0.packet0.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->outRadioTrainTrack.packets.p0.packet0.NID_NTC = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p1.valid = kcg_true;
  outC->outRadioTrainTrack.packets.p1.packet1.NID_PACKET = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p1.packet1.L_PACKET = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->outRadioTrainTrack.packets.p1.packet1.NID_LRBG = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p1.packet1.NID_PRVLRBG = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p1.packet1.D_LRBG = kcg_lit_int32(0);
  ...
  outC->outRadioTrainTrack.packets.p1.packet1.L_DOUBTOVER = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p1.packet1.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->outRadioTrainTrack.packets.p1.packet1.L_TRAININT = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p1.packet1.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->outRadioTrainTrack.packets.p1.packet1.NID_NTC = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p3.valid = kcg_true;
  outC->outRadioTrainTrack.packets.p3.number = kcg_lit_int32(0);
  ...
  outC->outRadioTrainTrack.packets.p5.TrainRunningNumber = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p9.valid = kcg_true;
  outC->outRadioTrainTrack.packets.p9.transitionInformation = kcg_lit_int32(0);
  ...
  outC->outRadioTrainTrack.packets.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->outRadioTrainTrack.packets.p11.l_train = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p11.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->outRadioTrainTrack.packets.p11.n_axle = kcg_lit_int32(0);
  outC->outRadioTrainTrack.packets.p11.nIter_tractionIdentity = kcg_lit_int32(0);
  ...
  outC->outRadioTrainTrack.packets.p11.nIter_ntc = kcg_lit_int32(0);
  for (idx15 = 0; idx15 < 5; idx15++) {
    outC->outRadioTrainTrack.packets.p11.nid_ntc[idx15] = kcg_lit_int32(0);
  }
  /* _L3=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg#1)/ */
  RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_1);
  /* _L1=(RBC_Messaging_Pkg::RBC_RadioTrainTrackFactory_Pkg::RadioTrainTrackFactory__CreateDefaultMsg#1)/ */
  RadioTrainTrackFactory__CreateDefaultMsg_init_RBC_Messaging_Pkg_RBC_RadioTrainTrackFactory_Pkg(
    &outC->Context_RadioTrainTrackFactory__CreateDefaultMsg_1);
}
  ...
  outC_RadioTrainTrackInputHandler_RBC_Messaging_Pkg *outC)
{
  ...
  RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_1);
  /* _L1=(RBC_Messaging_Pkg::RBC_RadioTrainTrackFactory_Pkg::RadioTrainTrackFactory__CreateDefaultMsg#1)/ */
  RadioTrainTrackFactory__CreateDefaultMsg_reset_RBC_Messaging_Pkg_RBC_RadioTrainTrackFactory_Pkg(
    &outC->Context_RadioTrainTrackFactory__CreateDefaultMsg_1);
}
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */


void kcg_save_SV_RadioTrainTrackInputHandler_RBC_Messaging_Pkg(
  SV_RadioTrainTrackInputHandler_RBC_Messaging_Pkg *SV,
  outC_RadioTrainTrackInputHandler_RBC_Messaging_Pkg *outC)
{
  kcg_save_SV_RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &SV->Context_RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_1,
    &outC->Context_RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_1);
}

void kcg_load_SV_RadioTrainTrackInputHandler_RBC_Messaging_Pkg(
  outC_RadioTrainTrackInputHandler_RBC_Messaging_Pkg *outC,
  SV_RadioTrainTrackInputHandler_RBC_Messaging_Pkg *SV)
{
  kcg_load_SV_RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_1,
    &SV->Context_RadioTrainTrackMessageConsistencyChecker__IsConsistentMsg_1);
}
