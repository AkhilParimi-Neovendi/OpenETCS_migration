...
void C_P046_unflatten_sections_TM_lib_internal(
  ...
  outC_C_P046_unflatten_sections_TM_lib_internal *outC)
{
  static kcg_size idx;
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    kcg_copy_P046_sections_array_flat_T_TM(&outC->_L6[idx1], &outC->_L1);
  }
  /* _L7= */
  if (outC->_L11) {
    /* _L7= */
    for (idx2 = 0; idx2 < 33; idx2++) {
      /* _L7=(TM_lib_internal::C_P046_us_array#1)/ */
      C_P046_us_array_TM_lib_internal(
        /* _L7= */(kcg_int64) idx2,
        outC->_L5[idx2],
        &outC->_L6[idx2],
        &outC->Context_C_P046_us_array_1[idx2]);
      kcg_copy_P046_section_enum_T_TM(
        &outC->_L9[idx2],
        &outC->Context_C_P046_us_array_1[idx2].sections);
      outC->_L7 = /* _L7= */(kcg_int64) (idx2 + 1);
      /* _L7= */
      if (!outC->Context_C_P046_us_array_1[idx2].cont) {
        break;
      }
    }
  }
  ...
  noname = outC->_L7;
  kcg_copy_P046_OBU_sectionlist_enum_T_TM(&outC->sections, &outC->_L9);
}

#ifndef KCG_USER_DEFINED_INIT
void C_P046_unflatten_sections_init_TM_lib_internal(
  outC_C_P046_unflatten_sections_TM_lib_internal *outC)
{
  static kcg_size idx;
  static kcg_size idx1;
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L9[idx1].nid_ntc = kcg_lit_int64(0);
  }
  outC->_L7 = kcg_lit_int64(0);
  ...
  for (idx6 = 0; idx6 < 33; idx6++) {
    ...
    outC->sections[idx6].nid_ntc = kcg_lit_int64(0);
  }
  for (idx = 0; idx < 33; idx++) {
    /* _L7=(TM_lib_internal::C_P046_us_array#1)/ */
    C_P046_us_array_init_TM_lib_internal(&outC->Context_C_P046_us_array_1[idx]);
  }
}
...
void C_P046_unflatten_sections_reset_TM_lib_internal(
  outC_C_P046_unflatten_sections_TM_lib_internal *outC)
{
  static kcg_size idx;
  ...
  for (idx = 0; idx < 33; idx++) {
    /* _L7=(TM_lib_internal::C_P046_us_array#1)/ */
    C_P046_us_array_reset_TM_lib_internal(
      &outC->Context_C_P046_us_array_1[idx]);
  }
}
