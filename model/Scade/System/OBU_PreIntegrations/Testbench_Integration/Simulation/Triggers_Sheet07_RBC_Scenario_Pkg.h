...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg /* _L10=(RBC_Scenario_Pkg::RadioTrackTrainMessageTrigger__Trigger#5)/ */ Context_RadioTrackTrainMessageTrigger__Trigger_5;
  outC_RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg /* _L9=(RBC_Scenario_Pkg::RadioTrackTrainMessageTrigger__Trigger#4)/ */ Context_RadioTrackTrainMessageTrigger__Trigger_4;
  outC_RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg /* _L8=(RBC_Scenario_Pkg::RadioTrackTrainMessageTrigger__Trigger#3)/ */ Context_RadioTrackTrainMessageTrigger__Trigger_3;
...
} SV_Triggers_Sheet07_RBC_Scenario_Pkg;

extern void kcg_save_SV_Triggers_Sheet07_RBC_Scenario_Pkg(
  SV_Triggers_Sheet07_RBC_Scenario_Pkg *SV,
  outC_Triggers_Sheet07_RBC_Scenario_Pkg *outC);
extern void kcg_load_SV_Triggers_Sheet07_RBC_Scenario_Pkg(
  outC_Triggers_Sheet07_RBC_Scenario_Pkg *outC,
  SV_Triggers_Sheet07_RBC_Scenario_Pkg *SV);
