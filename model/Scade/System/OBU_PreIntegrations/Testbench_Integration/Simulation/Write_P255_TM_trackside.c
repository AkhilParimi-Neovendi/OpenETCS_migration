...
void Write_P255_TM_trackside(
  /* Packet255/ */
  P255_trackside_int_T_TM *Packet255,
  /* Packets/ */
  CompressedPackets_T_Common_Types_Pkg *Packets,
  outC_Write_P255_TM_trackside *outC)
{
  kcg_copy_P255_trackside_int_T_TM(&outC->_L1, Packet255);
  /* _L43=(TM_conversions::C_P255_tracksim_compr#1)/ */
  C_P255_tracksim_compr_TM_conversions(
    &outC->_L1,
    &outC->Context_C_P255_tracksim_compr_1);
  kcg_copy_MetadataElement_T_Common_Types_Pkg(
    &outC->_L43,
    &outC->Context_C_P255_tracksim_compr_1.Header);
  kcg_copy_CompressedPacketData_T_Common_Types_Pkg(
    &outC->_L44,
    &outC->Context_C_P255_tracksim_compr_1.P005_compressed);
...
void Write_P255_init_TM_trackside(outC_Write_P255_TM_trackside *outC)
{
  static kcg_size idx;
  ...
  SEND_WriteBaliseMessageHeader_init_TM_lib_internal(
    &outC->Context_SEND_WriteBaliseMessageHeader_1);
  /* _L43=(TM_conversions::C_P255_tracksim_compr#1)/ */
  C_P255_tracksim_compr_init_TM_conversions(
    &outC->Context_C_P255_tracksim_compr_1);
}
...
void Write_P255_reset_TM_trackside(outC_Write_P255_TM_trackside *outC)
{
  ...
  SEND_WriteBaliseMessageHeader_reset_TM_lib_internal(
    &outC->Context_SEND_WriteBaliseMessageHeader_1);
  /* _L43=(TM_conversions::C_P255_tracksim_compr#1)/ */
  C_P255_tracksim_compr_reset_TM_conversions(
    &outC->Context_C_P255_tracksim_compr_1);
}
