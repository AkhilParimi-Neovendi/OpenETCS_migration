  ...
  outC_C_P046_compr_onboard_TM_conversions *outC)
{
  ...
  kcg_copy_array_int64_4(&outC->_L29, (array_int64_4 *) &outC->_L9[0]);
  ...
  outC_C_P046_compr_onboard_TM_conversions *outC)
{
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L5[idx1].nid_ntc = kcg_lit_int64(0);
  }
  ...
  for (idx3 = 0; idx3 < 33; idx3++) {
    ...
    outC->_L10.sections[idx3].nid_ntc = kcg_lit_int64(0);
  }
  ...
  outC->P046_onboard.n_iter = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 33; idx5++) {
    ...
    outC->P046_onboard.sections[idx5].nid_ntc = kcg_lit_int64(0);
  }
  /* _L5=(TM_lib_internal::C_P046_unflatten_sections#1)/ */
