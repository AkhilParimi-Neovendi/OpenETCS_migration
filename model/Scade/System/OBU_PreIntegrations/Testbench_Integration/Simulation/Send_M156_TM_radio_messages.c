...
void Send_M156_init_TM_radio_messages(outC_Send_M156_TM_radio_messages *outC)
{
  ...
  for (idx = 0; idx < 50; idx++) {
    outC->_L13.OptionalPackets[idx] = kcg_lit_int64(0);
  }
  outC->_L16 = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 50; idx1++) {
    outC->_L17[idx1] = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L7[idx3].Message.valid = kcg_true;
    outC->_L7[idx3].Message.nid_message = kcg_lit_int64(0);
    outC->_L7[idx3].Message.l_message = kcg_lit_int64(0);
    outC->_L7[idx3].Message.t_train = kcg_lit_int64(0);
    outC->_L7[idx3].Message.nid_engine = kcg_lit_int64(0);
    outC->_L7[idx3].Message.field1 = kcg_lit_int64(0);
    outC->_L7[idx3].Message.field2 = kcg_lit_int64(0);
    outC->_L7[idx3].Message.field3 = kcg_lit_int64(0);
    for (idx2 = 0; idx2 < 50; idx2++) {
      outC->_L7[idx3].OptionalPackets[idx2] = kcg_lit_int64(0);
    }
  }
  outC->_L10 = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 5; idx5++) {
    outC->_L11[idx5].Message.valid = kcg_true;
    outC->_L11[idx5].Message.nid_message = kcg_lit_int64(0);
    outC->_L11[idx5].Message.l_message = kcg_lit_int64(0);
    outC->_L11[idx5].Message.t_train = kcg_lit_int64(0);
    outC->_L11[idx5].Message.nid_engine = kcg_lit_int64(0);
    outC->_L11[idx5].Message.field1 = kcg_lit_int64(0);
    outC->_L11[idx5].Message.field2 = kcg_lit_int64(0);
    outC->_L11[idx5].Message.field3 = kcg_lit_int64(0);
    for (idx4 = 0; idx4 < 50; idx4++) {
      outC->_L11[idx5].OptionalPackets[idx4] = kcg_lit_int64(0);
    }
  }
  outC->_L15.Message.valid = kcg_true;
  outC->_L15.Message.nid_message = kcg_lit_int64(0);
  outC->_L15.Message.l_message = kcg_lit_int64(0);
  outC->_L15.Message.t_train = kcg_lit_int64(0);
  outC->_L15.Message.nid_engine = kcg_lit_int64(0);
  outC->_L15.Message.field1 = kcg_lit_int64(0);
  outC->_L15.Message.field2 = kcg_lit_int64(0);
  outC->_L15.Message.field3 = kcg_lit_int64(0);
  for (idx6 = 0; idx6 < 50; idx6++) {
    outC->_L15.OptionalPackets[idx6] = kcg_lit_int64(0);
  }
  outC->_L6 =
...
void kcg_save_SV_Send_M156_TM_radio_messages(
  SV_Send_M156_TM_radio_messages *SV,
  outC_Send_M156_TM_radio_messages *outC)
{
...
void kcg_load_SV_Send_M156_TM_radio_messages(
  outC_Send_M156_TM_radio_messages *outC,
  SV_Send_M156_TM_radio_messages *SV)
{
