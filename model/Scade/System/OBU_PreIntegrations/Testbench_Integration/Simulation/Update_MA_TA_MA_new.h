...
typedef struct {
  /* ----------------------  memorised outputs  ---------------------- */
  MovementAuthority_t_TrackAtlasTypes /* MA_in_force/ */ Context_MA_in_force;
  /* -----------------------  no local memory  ----------------------- */
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
} SV_Update_MA_TA_MA_new;

extern void kcg_save_SV_Update_MA_TA_MA_new(
  SV_Update_MA_TA_MA_new *SV,
  outC_Update_MA_TA_MA_new *outC);
extern void kcg_load_SV_Update_MA_TA_MA_new(
  outC_Update_MA_TA_MA_new *outC,
  SV_Update_MA_TA_MA_new *SV);
