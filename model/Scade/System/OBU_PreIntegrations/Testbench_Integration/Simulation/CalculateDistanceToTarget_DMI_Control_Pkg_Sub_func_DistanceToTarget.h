...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  kcg_float32 /* InterpolatedDistanceToTarget/ */ InterpolatedDistanceToTarget;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  kcg_float32 /* IfBlock1:then:_L8/ */ _L8_then_IfBlock1;
  ...
  kcg_float32 /* IfBlock1:else:then:_L5/ */ _L5_then_else_IfBlock1;
  kcg_float32 /* IfBlock1:else:then:_L4/ */ _L4_then_else_IfBlock1;
  kcg_float32 /* IfBlock1:else:then:_L3/ */ _L3_then_else_IfBlock1;
...
typedef struct {
  /* ----------------------  memorised outputs  ---------------------- */
  kcg_float32 /* InterpolatedDistanceToTarget/ */ Context_InterpolatedDistanceToTarget;
  /* -----------------------  no local memory  ----------------------- */
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
