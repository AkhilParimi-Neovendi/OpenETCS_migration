...
void kcg_save_SV_op_RepeatReq_TA_MA_Request(
  SV_op_RepeatReq_TA_MA_Request *SV,
  outC_op_RepeatReq_TA_MA_Request *outC)
{
  SV->Context_lastSystemTime = outC->lastSystemTime;
  SV->Context_mem_setRepeater = outC->mem_setRepeater;
}

void kcg_load_SV_op_RepeatReq_TA_MA_Request(
  outC_op_RepeatReq_TA_MA_Request *outC,
  SV_op_RepeatReq_TA_MA_Request *SV)
{
  outC->lastSystemTime = SV->Context_lastSystemTime;
  outC->mem_setRepeater = SV->Context_mem_setRepeater;
}
