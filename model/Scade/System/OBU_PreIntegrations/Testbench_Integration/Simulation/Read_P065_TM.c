  ...
  outC_Read_P065_TM *outC)
{
  ...
  /* _L166=(TM_conversions::C_P065_compr_onboard#1)/ */
  C_P065_compr_onboard_TM_conversions(
    &outC->_L5,
    &outC->_L30,
    &outC->Context_C_P065_compr_onboard_1);
  kcg_copy_P065_OBU_T_TM(
    &outC->_L166,
    &outC->Context_C_P065_compr_onboard_1.P065_onboard);
  kcg_copy_P065_OBU_T_TM(&outC->P065_OBU_out, &outC->_L166);
}

#ifndef KCG_USER_DEFINED_INIT
void Read_P065_init_TM(outC_Read_P065_TM *outC)
{
  static kcg_size idx;
  ...
  outC->_L166.nid_tsr = kcg_lit_int64(0);
  outC->_L166.d_tsr = kcg_lit_int64(0);
  outC->_L166.l_tsr = kcg_lit_int64(0);
  outC->_L166.q_front =
    Q_FRONT_Train_length_delay_on_validity_end_point_of_profile_element;
  outC->_L166.v_tsr = kcg_lit_int64(0);
  ...
  outC->P065_OBU_out.valid = kcg_true;
  outC->P065_OBU_out.q_dir = Q_DIR_Reverse;
  outC->P065_OBU_out.q_scale = Q_SCALE_10_cm_scale;
  outC->P065_OBU_out.nid_tsr = kcg_lit_int64(0);
  outC->P065_OBU_out.d_tsr = kcg_lit_int64(0);
  outC->P065_OBU_out.l_tsr = kcg_lit_int64(0);
  outC->P065_OBU_out.q_front =
    Q_FRONT_Train_length_delay_on_validity_end_point_of_profile_element;
  outC->P065_OBU_out.v_tsr = kcg_lit_int64(0);
  outC->received = kcg_true;
  /* _L166=(TM_conversions::C_P065_compr_onboard#1)/ */
  C_P065_compr_onboard_init_TM_conversions(
    &outC->Context_C_P065_compr_onboard_1);
  /* _L5=(TM_lib_internal::RECV_ReadPackets#1)/ */
...
{
  /* _L166=(TM_conversions::C_P065_compr_onboard#1)/ */
  C_P065_compr_onboard_reset_TM_conversions(
    &outC->Context_C_P065_compr_onboard_1);
  /* _L5=(TM_lib_internal::RECV_ReadPackets#1)/ */
