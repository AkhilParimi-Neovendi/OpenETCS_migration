  ...
  outC_recalculate_BG_location_astern_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  ...
  for (idx10 = 0; idx10 < 33; idx10++) {
    ...
    outC->_L162.infoFromPassing.linkedBGs[idx10].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L162.infoFromPassing.linkedBGs[idx10].d_link = kcg_lit_int64(0);
    outC->_L162.infoFromPassing.linkedBGs[idx10].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L162.infoFromPassing.linkedBGs[idx10].nid_c = kcg_lit_int64(0);
    outC->_L162.infoFromPassing.linkedBGs[idx10].nid_bg = kcg_lit_int64(0);
    outC->_L162.infoFromPassing.linkedBGs[idx10].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L162.infoFromPassing.linkedBGs[idx10].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L162.infoFromPassing.linkedBGs[idx10].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx11 = 0; idx11 < 33; idx11++) {
    ...
    outC->BG_out.infoFromPassing.linkedBGs[idx11].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->BG_out.infoFromPassing.linkedBGs[idx11].d_link = kcg_lit_int64(0);
    outC->BG_out.infoFromPassing.linkedBGs[idx11].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->BG_out.infoFromPassing.linkedBGs[idx11].nid_c = kcg_lit_int64(0);
    outC->BG_out.infoFromPassing.linkedBGs[idx11].nid_bg = kcg_lit_int64(0);
    outC->BG_out.infoFromPassing.linkedBGs[idx11].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->BG_out.infoFromPassing.linkedBGs[idx11].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->BG_out.infoFromPassing.linkedBGs[idx11].q_locacc = kcg_lit_int64(0);
  }
