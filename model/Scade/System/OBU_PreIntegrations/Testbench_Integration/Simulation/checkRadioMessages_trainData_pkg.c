  ...
  outC_checkRadioMessages_trainData_pkg *outC)
{
  ...
  kcg_copy_trainDataStatus_T_trainData_Types_pkg(&outC->_L18, actualStatus);
  outC->_L17 = outC->_L18.timeStampValidateToRBC;
  kcg_copy_ReceivedMessage_T_Common_Types_Pkg(&outC->_L8, trackMessages);
  kcg_copy_Radio_TrackTrain_Header_T_Radio_Types_Pkg(
    &outC->_L7,
    &outC->_L8.Radio_Common_Header);
  outC->_L14 = outC->_L7.t_train_reference;
  outC->_L15 = outC->_L14 == outC->_L17;
  outC->_L12 = cm08_Acknowledgement_of_Train_Data_Id_Pkg;
  outC->_L10 = outC->_L7.nid_message;
  outC->_L9 = outC->_L10 == outC->_L12;
  outC->_L13 = outC->_L9 & outC->_L15;
...
void checkRadioMessages_init_trainData_pkg(
  outC_checkRadioMessages_trainData_pkg *outC)
{
  static kcg_size idx;
...
void checkRadioMessages_reset_trainData_pkg(
  outC_checkRadioMessages_trainData_pkg *outC)
{
}
