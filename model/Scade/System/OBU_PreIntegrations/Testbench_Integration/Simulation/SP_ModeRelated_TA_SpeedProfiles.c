  ...
  outC_SP_ModeRelated_TA_SpeedProfiles *outC)
{
  ...
  for (idx = 0; idx < 50; idx++) {
    outC->_L6[idx].target = kcg_lit_int64(0);
    outC->_L6[idx].speed = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 50; idx1++) {
    outC->_L5[idx1].target = kcg_lit_int64(0);
    outC->_L5[idx1].speed = kcg_lit_int64(0);
  }
  outC->_L4 = kcg_true;
  for (idx2 = 0; idx2 < 50; idx2++) {
    outC->_L3[idx2].target = kcg_lit_int64(0);
    outC->_L3[idx2].speed = kcg_lit_int64(0);
  }
  ...
  for (idx5 = 0; idx5 < 50; idx5++) {
    outC->ModeRelated[idx5].target = kcg_lit_int64(0);
    outC->ModeRelated[idx5].speed = kcg_lit_int64(0);
  }
}
