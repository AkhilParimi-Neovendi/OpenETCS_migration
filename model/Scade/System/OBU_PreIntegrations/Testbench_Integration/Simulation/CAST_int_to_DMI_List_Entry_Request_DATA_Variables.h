...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* dmi_list_entry_request_ct/ */ dmi_list_entry_request_ct;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:then:_L1/ */ _L1_then_IfBlock1;
  kcg_bool /* IfBlock1:else:else:then:_L3/ */ _L3_then_else_else_IfBlock1;
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:else:else:then:_L2/ */ _L2_then_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:then:_L2/ */ _L2_then_else_else_else_else_IfBlock1;
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:else:else:else:else:then:_L1/ */ _L1_then_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:then:_L2/ */ _L2_then_else_else_else_else_else_else_IfBlock1;
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:else:else:else:else:else:else:then:_L1/ */ _L1_then_else_else_else_else_else_else_IfBlock1;
  ...
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:else:else:else:else:else:else:else:else:then:_L1/ */ _L1_then_else_else_else_else_else_else_else_else_IfBlock1;
  ...
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:else:else:else:else:else:else:else:else:else:else:then:_L1/ */ _L1_then_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  ...
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:else:else:else:else:else:else:else:else:else:else:else:else:then:_L1/ */ _L1_then_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  ...
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:else:else:else:else:else:else:else:else:else:else:else:else:else:else:then:_L1/ */ _L1_then_else_else_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  ...
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:else:else:else:else:else:else:else:else:else:else:else:else:else:else:else:_L1/ */ _L1_else_else_else_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:else:else:else:else:else:else:else:else:else:else:else:else:else:then:_L1/ */ _L1_then_else_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  ...
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:else:else:else:else:else:else:else:else:else:else:else:then:_L1/ */ _L1_then_else_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  ...
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:else:else:else:else:else:else:else:else:else:then:_L1/ */ _L1_then_else_else_else_else_else_else_else_else_else_IfBlock1;
  ...
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:else:else:else:else:else:else:else:then:_L1/ */ _L1_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L2/ */ _L2_then_else_else_else_else_else_else_else_IfBlock1;
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:else:else:else:else:else:then:_L1/ */ _L1_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L2/ */ _L2_then_else_else_else_else_else_IfBlock1;
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:else:else:else:then:_L1/ */ _L1_then_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:then:_L2/ */ _L2_then_else_else_else_IfBlock1;
  DMI_List_Entry_Request_T_DMI_Types_Pkg /* IfBlock1:else:then:_L2/ */ _L2_then_else_IfBlock1;
  kcg_bool /* IfBlock1:else:then:_L3/ */ _L3_then_else_IfBlock1;
  kcg_bool /* error/ */ error;
  kcg_bool /* _L48/ */ _L48;
} outC_CAST_int_to_DMI_List_Entry_Request_DATA_Variables;

/* ===========  node initialization and cycle functions  =========== */
/* DATA::Variables::CAST_int_to_DMI_List_Entry_Request/ */
extern void CAST_int_to_DMI_List_Entry_Request_DATA_Variables(
...
extern void CAST_int_to_DMI_List_Entry_Request_reset_DATA_Variables(
  outC_CAST_int_to_DMI_List_Entry_Request_DATA_Variables *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CAST_int_to_DMI_List_Entry_Request_init_DATA_Variables(
  outC_CAST_int_to_DMI_List_Entry_Request_DATA_Variables *outC);
