...
void TrackInit_init_InfraLib(outC_TrackInit_InfraLib *outC)
{
  ...
  outC->_L11 = kcg_lit_float32(0.0);
  outC->_L10.TrainPos_in = kcg_lit_float32(0.0);
  outC->_L10.OffsetTotal = kcg_lit_int32(0);
  outC->_L10.TrainPosCalibrated = kcg_lit_float32(0.0);
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L8.BG_Message.Messages.PacketHeaders[idx].nid_packet = kcg_lit_int32(0);
    ...
    outC->_L8.BG_Message.Messages.PacketHeaders[idx].startAddress =
      kcg_lit_int32(0);
    outC->_L8.BG_Message.Messages.PacketHeaders[idx].endAddress = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L8.BG_Message.Messages.PacketData[idx1] = kcg_lit_int32(0);
  }
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L4.Messages.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    outC->_L4.Messages.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L4.Messages.PacketHeaders[idx2].valid = kcg_true;
    outC->_L4.Messages.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L4.Messages.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L4.Messages.PacketData[idx3] = kcg_lit_int32(0);
  }
  ...
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->SectionData_out.BG_Message.Messages.PacketData[idx5] = kcg_lit_int32(0);
  }
}
