...
void CAST_M_SupervisionDisplay_to_int_DATA_Variables(
  ...
  outC_CAST_M_SupervisionDisplay_to_int_DATA_Variables *outC)
{
  ...
  static M_SupervisionDisplay_INT_T_DATA m_supervisiondisplay_int_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* m_supervisiondisplay_int/ */
  static M_SupervisionDisplay_INT_T_DATA _1_m_supervisiondisplay_int_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* m_supervisiondisplay_int/ */
  static M_SupervisionDisplay_INT_T_DATA _3_m_supervisiondisplay_int_partial;
  /* error/ */
  static kcg_bool _4_error_partial;
  /* m_supervisiondisplay_int/ */
  static M_SupervisionDisplay_INT_T_DATA _5_m_supervisiondisplay_int_partial;
  /* error/ */
  static kcg_bool _6_error_partial;
  /* m_supervisiondisplay_int/ */
  static M_SupervisionDisplay_INT_T_DATA _7_m_supervisiondisplay_int_partial;
  /* error/ */
  static kcg_bool _8_error_partial;
  /* m_supervisiondisplay_int/ */
  static M_SupervisionDisplay_INT_T_DATA _9_m_supervisiondisplay_int_partial;
  /* error/ */
  static kcg_bool _10_error_partial;
  /* error/ */
  static kcg_bool _11_error_partial;
  /* m_supervisiondisplay_int/ */
  static M_SupervisionDisplay_INT_T_DATA _12_m_supervisiondisplay_int_partial;
  /* error/ */
  static kcg_bool _13_error_partial;
  /* m_supervisiondisplay_int/ */
  static M_SupervisionDisplay_INT_T_DATA _14_m_supervisiondisplay_int_partial;
  /* error/ */
  static kcg_bool _15_error_partial;
  /* m_supervisiondisplay_int/ */
  static M_SupervisionDisplay_INT_T_DATA _16_m_supervisiondisplay_int_partial;
  /* error/ */
  static kcg_bool _17_error_partial;
  /* m_supervisiondisplay_int/ */
  static M_SupervisionDisplay_INT_T_DATA _18_m_supervisiondisplay_int_partial;
  ...
  if (outC->IfBlock1_clock) {
    ...
    /* IfBlock1:else: */
    if (outC->else_clock_IfBlock1) {
      outC->_L1_then_else_IfBlock1 = INT_M_SupervisionDisplay_T_supDis_indication;
      ...
      /* IfBlock1:else:else: */
      if (outC->else_clock_else_IfBlock1) {
        outC->_L1_then_else_else_IfBlock1 = INT_M_SupervisionDisplay_T_supDis_overspeed;
...
void CAST_M_SupervisionDisplay_to_int_init_DATA_Variables(
  outC_CAST_M_SupervisionDisplay_to_int_DATA_Variables *outC)
{
  outC->_L1 = kcg_true;
  outC->error = kcg_true;
...
void CAST_M_SupervisionDisplay_to_int_reset_DATA_Variables(
  outC_CAST_M_SupervisionDisplay_to_int_DATA_Variables *outC)
{
}
