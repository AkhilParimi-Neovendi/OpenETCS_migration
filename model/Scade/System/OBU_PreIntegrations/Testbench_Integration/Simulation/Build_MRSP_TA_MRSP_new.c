...
void Build_MRSP_init_TA_MRSP_new(outC_Build_MRSP_TA_MRSP_new *outC)
{
  ...
  for (idx1 = 0; idx1 < 41; idx1++) {
    ...
    outC->_L35[idx1].nid_c = kcg_lit_int32(0);
    outC->_L35[idx1].nid_bg = kcg_lit_int32(0);
    outC->_L35[idx1].q_link = Q_LINK_Unlinked;
    outC->_L35[idx1].location.nominal = kcg_lit_int32(0);
    outC->_L35[idx1].location.d_min = kcg_lit_int32(0);
    outC->_L35[idx1].location.d_max = kcg_lit_int32(0);
    outC->_L35[idx1].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L35[idx1].infoFromLinking.valid = kcg_true;
    outC->_L35[idx1].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L35[idx1].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L35[idx1].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L35[idx1].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L35[idx1].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L35[idx1].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L35[idx1].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L35[idx1].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L35[idx1].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L35[idx1].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L35[idx1].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L35[idx1].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L35[idx1].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L35[idx1].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L35[idx1].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L35[idx1].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L35[idx1].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L35[idx1].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L35[idx1].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L35[idx1].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx = 0; idx < 33; idx++) {
      ...
      outC->_L35[idx1].infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L35[idx1].infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int32(0);
      outC->_L35[idx1].infoFromPassing.linkedBGs[idx].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L35[idx1].infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int32(0);
      outC->_L35[idx1].infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L35[idx1].infoFromPassing.linkedBGs[idx].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L35[idx1].infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int32(0);
    }
  ...
  for (idx2 = 0; idx2 < 50; idx2++) {
    outC->_L29[idx2].target = kcg_lit_int32(0);
    outC->_L29[idx2].speed = kcg_lit_int32(0);
  }
  outC->_L27 = kcg_true;
  for (idx3 = 0; idx3 < 50; idx3++) {
    outC->_L26[idx3].valid = kcg_true;
    outC->_L26[idx3].d_static_abs = kcg_lit_int32(0);
    outC->_L26[idx3].d_static_LRBG = kcg_lit_int32(0);
    outC->_L26[idx3].q_train_length_corr = kcg_true;
    outC->_L26[idx3].v_static = kcg_lit_int32(0);
  }
  ...
  for (idx4 = 0; idx4 < 33; idx4++) {
    ...
    outC->_L23.LRBG.infoFromPassing.linkedBGs[idx4].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L23.LRBG.infoFromPassing.linkedBGs[idx4].d_link = kcg_lit_int32(0);
    outC->_L23.LRBG.infoFromPassing.linkedBGs[idx4].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L23.LRBG.infoFromPassing.linkedBGs[idx4].nid_c = kcg_lit_int32(0);
    outC->_L23.LRBG.infoFromPassing.linkedBGs[idx4].nid_bg = kcg_lit_int32(0);
    ...
    outC->_L23.LRBG.infoFromPassing.linkedBGs[idx4].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L23.LRBG.infoFromPassing.linkedBGs[idx4].q_locacc = kcg_lit_int32(0);
  }
  ...
  for (idx5 = 0; idx5 < 33; idx5++) {
    ...
    outC->_L23.prvLRBG.infoFromPassing.linkedBGs[idx5].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L23.prvLRBG.infoFromPassing.linkedBGs[idx5].q_scale =
      Q_SCALE_10_cm_scale;
    outC->_L23.prvLRBG.infoFromPassing.linkedBGs[idx5].d_link = kcg_lit_int32(0);
    outC->_L23.prvLRBG.infoFromPassing.linkedBGs[idx5].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L23.prvLRBG.infoFromPassing.linkedBGs[idx5].nid_c = kcg_lit_int32(0);
    outC->_L23.prvLRBG.infoFromPassing.linkedBGs[idx5].nid_bg = kcg_lit_int32(0);
    ...
    outC->_L23.prvLRBG.infoFromPassing.linkedBGs[idx5].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L23.prvLRBG.infoFromPassing.linkedBGs[idx5].q_locacc = kcg_lit_int32(0);
  }
  ...
  outC->_L16.BG_Common_Header.m_mcount = kcg_lit_int32(0);
  outC->_L16.BG_Common_Header.nid_c = kcg_lit_int32(0);
  outC->_L16.BG_Common_Header.nid_bg = kcg_lit_int32(0);
  outC->_L16.BG_Common_Header.q_link = Q_LINK_Unlinked;
  outC->_L16.BG_Common_Header.bgPosition.valid = kcg_true;
  outC->_L16.BG_Common_Header.bgPosition.timestamp = kcg_lit_int32(0);
  outC->_L16.BG_Common_Header.bgPosition.odo.o_nominal = kcg_lit_int32(0);
  outC->_L16.BG_Common_Header.bgPosition.odo.o_min = kcg_lit_int32(0);
  outC->_L16.BG_Common_Header.bgPosition.odo.o_max = kcg_lit_int32(0);
  outC->_L16.BG_Common_Header.bgPosition.speed.v_safeNominal = kcg_lit_int32(0);
  outC->_L16.BG_Common_Header.bgPosition.speed.v_rawNominal = kcg_lit_int32(0);
  outC->_L16.BG_Common_Header.bgPosition.speed.v_lower = kcg_lit_int32(0);
  outC->_L16.BG_Common_Header.bgPosition.speed.v_upper = kcg_lit_int32(0);
  outC->_L16.BG_Common_Header.bgPosition.acceleration = kcg_lit_int32(0);
  ...
  outC->_L16.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int32(0);
  outC->_L16.BG_Common_Header.q_nvlocacc = kcg_lit_int32(0);
  ...
  outC->_L16.Radio_Common_Header.radioDevice = kcg_lit_int32(0);
  outC->_L16.Radio_Common_Header.receivedSystemTime = kcg_lit_int32(0);
  outC->_L16.Radio_Common_Header.nid_message = kcg_lit_int32(0);
  outC->_L16.Radio_Common_Header.t_train = kcg_lit_int32(0);
  outC->_L16.Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_required;
  outC->_L16.Radio_Common_Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L16.Radio_Common_Header.t_train_reference = kcg_lit_int32(0);
  outC->_L16.Radio_Common_Header.nid_em = kcg_lit_int32(0);
  outC->_L16.Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L16.Radio_Common_Header.d_sr = kcg_lit_int32(0);
  outC->_L16.Radio_Common_Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L16.Radio_Common_Header.d_ref = kcg_lit_int32(0);
  outC->_L16.Radio_Common_Header.q_dir = Q_DIR_Reverse;
  outC->_L16.Radio_Common_Header.d_emergencystop = kcg_lit_int32(0);
  outC->_L16.Radio_Common_Header.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L16.packets.PacketHeaders[idx6].nid_packet = kcg_lit_int32(0);
    outC->_L16.packets.PacketHeaders[idx6].q_dir = Q_DIR_Reverse;
    outC->_L16.packets.PacketHeaders[idx6].valid = kcg_true;
    outC->_L16.packets.PacketHeaders[idx6].startAddress = kcg_lit_int32(0);
    outC->_L16.packets.PacketHeaders[idx6].endAddress = kcg_lit_int32(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->_L16.packets.PacketData[idx7] = kcg_lit_int32(0);
  }
  outC->_L16.sendingRBC.valid = kcg_true;
  outC->_L16.sendingRBC.nid_c = kcg_lit_int32(0);
  outC->_L16.sendingRBC.rbc_id = kcg_lit_int32(0);
  outC->_L16.sendingRBC.device_id = kcg_lit_int32(0);
  for (idx8 = 0; idx8 < 50; idx8++) {
    outC->_L15[idx8].target = kcg_lit_int32(0);
    outC->_L15[idx8].speed = kcg_lit_int32(0);
  }
  for (idx9 = 0; idx9 < 50; idx9++) {
    outC->_L14[idx9].target = kcg_lit_int32(0);
    outC->_L14[idx9].speed = kcg_lit_int32(0);
  }
  for (idx10 = 0; idx10 < 50; idx10++) {
    outC->_L13[idx10].target = kcg_lit_int32(0);
    outC->_L13[idx10].speed = kcg_lit_int32(0);
  }
  for (idx11 = 0; idx11 < 50; idx11++) {
    outC->_L11[idx11].target = kcg_lit_int32(0);
    outC->_L11[idx11].speed = kcg_lit_int32(0);
  }
  for (idx12 = 0; idx12 < 50; idx12++) {
    outC->_L9[idx12].target = kcg_lit_int32(0);
    outC->_L9[idx12].speed = kcg_lit_int32(0);
  }
  for (idx13 = 0; idx13 < 50; idx13++) {
    outC->_L8[idx13].target = kcg_lit_int32(0);
    outC->_L8[idx13].speed = kcg_lit_int32(0);
  }
  for (idx14 = 0; idx14 < 50; idx14++) {
    outC->_L7[idx14].target = kcg_lit_int32(0);
    outC->_L7[idx14].speed = kcg_lit_int32(0);
  }
  for (idx15 = 0; idx15 < 50; idx15++) {
    outC->_L5[idx15].target = kcg_lit_int32(0);
    outC->_L5[idx15].speed = kcg_lit_int32(0);
  }
  for (idx16 = 0; idx16 < 50; idx16++) {
    outC->_L4[idx16].target = kcg_lit_int32(0);
    outC->_L4[idx16].speed = kcg_lit_int32(0);
  }
  for (idx17 = 0; idx17 < 50; idx17++) {
    outC->_L3[idx17].target = kcg_lit_int32(0);
    outC->_L3[idx17].speed = kcg_lit_int32(0);
  }
  for (idx19 = 0; idx19 < 11; idx19++) {
    for (idx18 = 0; idx18 < 50; idx18++) {
      outC->_L2[idx19][idx18].target = kcg_lit_int32(0);
      outC->_L2[idx19][idx18].speed = kcg_lit_int32(0);
    }
  }
  outC->every = kcg_true;
  for (idx20 = 0; idx20 < 110; idx20++) {
    outC->_L1[idx20].valid = kcg_true;
    outC->_L1[idx20].Loc_Abs = kcg_lit_int32(0);
    outC->_L1[idx20].Loc_LRBG = kcg_lit_int32(0);
    outC->_L1[idx20].MRS = kcg_lit_int32(0);
  }
  outC->init = kcg_true;
  for (idx21 = 0; idx21 < 50; idx21++) {
    outC->SSP[idx21].valid = kcg_true;
    outC->SSP[idx21].d_static_abs = kcg_lit_int32(0);
    outC->SSP[idx21].d_static_LRBG = kcg_lit_int32(0);
    outC->SSP[idx21].q_train_length_corr = kcg_true;
    outC->SSP[idx21].v_static = kcg_lit_int32(0);
  }
  outC->SSP_available = kcg_true;
  for (idx22 = 0; idx22 < 110; idx22++) {
    outC->MRSP[idx22].valid = kcg_true;
    outC->MRSP[idx22].Loc_Abs = kcg_lit_int32(0);
    outC->MRSP[idx22].Loc_LRBG = kcg_lit_int32(0);
    outC->MRSP[idx22].MRS = kcg_lit_int32(0);
  }
...
void kcg_save_SV_Build_MRSP_TA_MRSP_new(
  SV_Build_MRSP_TA_MRSP_new *SV,
  outC_Build_MRSP_TA_MRSP_new *outC)
{
  kcg_save_SV_Build_StaticSpeedProfile_TA_SSP_new(
    &SV->Context_Build_StaticSpeedProfile_1,
    &outC->Context_Build_StaticSpeedProfile_1);
  kcg_copy_MRSP_Profile_t_TrackAtlasTypes(&SV->Context__L1, &outC->_L1);
  SV->Context_init = outC->init;
}

void kcg_load_SV_Build_MRSP_TA_MRSP_new(
  outC_Build_MRSP_TA_MRSP_new *outC,
  SV_Build_MRSP_TA_MRSP_new *SV)
{
  kcg_load_SV_Build_StaticSpeedProfile_TA_SSP_new(
    &outC->Context_Build_StaticSpeedProfile_1,
    &SV->Context_Build_StaticSpeedProfile_1);
  kcg_copy_MRSP_Profile_t_TrackAtlasTypes(&outC->_L1, &SV->Context__L1);
