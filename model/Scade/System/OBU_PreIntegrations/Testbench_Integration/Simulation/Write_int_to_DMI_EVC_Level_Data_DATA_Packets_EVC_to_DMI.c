  ...
  outC_Write_int_to_DMI_EVC_Level_Data_DATA_Packets_EVC_to_DMI *outC)
{
  ...
  outC->_L82.system_clock = kcg_lit_int64(0);
  outC->_L82.levelList.number = kcg_lit_int64(0);
  for (idx = 0; idx < 32; idx++) {
    outC->_L82.levelList.levelList[idx].level = M_LEVEL_Level_0;
    outC->_L82.levelList.levelList[idx].nid_stm = kcg_lit_int64(0);
  }
  outC->_L79 = kcg_lit_int64(0);
  outC->_L80 = kcg_true;
  outC->_L81 = kcg_lit_int64(0);
  outC->_L78.valid = kcg_true;
  outC->_L78.system_clock = kcg_lit_int64(0);
  outC->_L78.levelList.number = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 32; idx1++) {
    outC->_L78.levelList.levelList[idx1].level = M_LEVEL_Level_0;
    outC->_L78.levelList.levelList[idx1].nid_stm = kcg_lit_int64(0);
  }
  for (idx2 = 0; idx2 < 67; idx2++) {
    outC->_L11[idx2] = kcg_lit_int64(0);
  }
  outC->every = kcg_true;
  outC->dmi_evc_level_data_ct.valid = kcg_true;
  outC->dmi_evc_level_data_ct.system_clock = kcg_lit_int64(0);
  outC->dmi_evc_level_data_ct.levelList.number = kcg_lit_int64(0);
