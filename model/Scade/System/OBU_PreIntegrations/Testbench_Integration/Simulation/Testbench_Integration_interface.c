...
kcg_float32 _ctx_GUI_targetSpeed_buffer;
kcg_float32 _ctx_GUI_traction_buffer;
kcg_float32 _ctx_GUI_brake_buffer;
kcg_float32 _ctx_GUI_initialPosition_buffer;
kcg_float32 _ctx_GUI_initialVelocity_buffer;
kcg_int32 _ctx_GUI_mode_buffer;
kcg_int32 _ctx_GUI_level_buffer;
kcg_int32 _ctx_GUI_mobileHWStatus_buffer;
...
static void _SCSIM_RestoreInterface(void) {
    ...
    init_kcg_float32(&GUI_targetSpeed);
    init_kcg_float32(&_ctx_GUI_targetSpeed_buffer);
    init_kcg_float32(&GUI_traction);
    init_kcg_float32(&_ctx_GUI_traction_buffer);
    init_kcg_float32(&GUI_brake);
    init_kcg_float32(&_ctx_GUI_brake_buffer);
    init_kcg_float32(&GUI_initialPosition);
    init_kcg_float32(&_ctx_GUI_initialPosition_buffer);
    init_kcg_float32(&GUI_initialVelocity);
    init_kcg_float32(&_ctx_GUI_initialVelocity_buffer);
    init_kcg_int32(&GUI_mode);
    init_kcg_int32(&_ctx_GUI_mode_buffer);
    init_kcg_int32(&GUI_level);
    init_kcg_int32(&_ctx_GUI_level_buffer);
    init_kcg_int32(&GUI_mobileHWStatus);
    init_kcg_int32(&_ctx_GUI_mobileHWStatus_buffer);
    ...
    init_kcg_float32(&DMI_SpeedTarget_toDisplay);
    init_kcg_int32(&DMI_VpermColor_toDisplay);
    init_kcg_float32(&DMI_trainLenght_toDisplay);
    init_array_float32_32(&DMI_GradientsValue_toDisplay);
    init_kcg_float32(&DMI_TrainPosition_toDisplay);
    init_kcg_bool(&DMI_Vinterv_Visibility_toDisplay);
    init_kcg_bool(&DMI_DistanceToTargetBarVisibility_toDisplay);
    init_kcg_float32(&DMI_SpeedDigitOne_toDisplay);
    init_kcg_bool(&DMI_hourGlassVisibility_toDisplay);
    init_kcg_int32(&DMI_trainAxleloadIndex_toDisplay);
    init_kcg_int32(&DMI_PointerColor_toDisplay);
    init_kcg_int32(&DMI_CloseButtonEnabler_toDisplay);
    init_kcg_float32(&DMI_SpeedRelease_toDisplay);
    init_kcg_int32(&DMI_VtargetColor_toDisplay);
    init_kcg_float32(&DMI_trainMaxspeed_toDisplay);
    init_kcg_bool(&DMI_DistanceToTargetVisible_toDisplay);
    init_kcg_bool(&DMI_LevelSymbolVisibility_toDisplay);
    init_kcg_float32(&DMI_SpeedIntervention_toDisplay);
    init_kcg_bool(&DMI_yellowBorderBrakeSymbol_toDisplay);
    init_kcg_int32(&DMI_closeButtonIndex_toDisplay);
    init_kcg_bool(&DMI_ModeSymbolVisibility_toDisplay);
    init_kcg_float32(&DMI_SpeedDigitThree_toDisplay);
    init_kcg_float32(&DMI_hourGlassCounter_toDisplay);
    init_kcg_int32(&DMI_trainLoadingGougeIndex_toDisplay);
    init_array_int32_9(&DMI_TrainRN_Display_toDisplay);
    init_kcg_int32(&DMI_RBC_status_symbol_toDisplay);
    init_array_float32_32(&DMI_GradientsEnd_toDisplay);
    init_kcg_int32(&DMI_vtarget_permColor_toDisplay);
    init_kcg_int32(&DMI_traindataYesNoIndex_toDisplay);
    init_kcg_bool(&DMI_StatusSymbolBrake_toDisplay);
    init_kcg_bool(&DMI_TrainDataWindowVisibility_toDisplay);
    init_kcg_int32(&DMI_levelSymbolAnnouncementIndex_toDisplay);
    init_kcg_int32(&DMI_trainCategoryIndex_toDisplay);
    init_kcg_float32(&DMI_SpeedPermitted_toDisplay);
    init_kcg_int32(&DMI_VreleaseColor_toDisplay);
    init_kcg_float32(&DMI_trainBrakePerc_toDisplay);
    init_array_int32_30(&DMI_ArrayButtonsEnabler_toDisplay);
    init_kcg_int32(&DMI_ETCS_LevelSymbol_toDisplay);
    init_kcg_int32(&DMI_modeSymbolAnnouncementIndex_toDisplay);
    init_kcg_int32(&DMI_ModeSymbol_toDisplay);
    init_kcg_float32(&DMI_DistanceToTarget_toDisplay);
    init_kcg_int32(&DMI_Vinterv_Color_toDisplay);
    init_kcg_bool(&DMI_yellowBorderMsg_toDisplay);
    init_array_int32_9(&DMI_DriverID_Display_toDisplay);
    init_kcg_float32(&DMI_SpeedDigitTwo_toDisplay);
    init_kcg_bool(&DMI_yellowBorderC1Area_toDisplay);
    init_kcg_int32(&DMI_trainAirtightIndex_toDisplay);
    init_array_float32_32(&DMI_GradientsStart_toDisplay);
    ...
    init_kcg_float32(&DMI_TrainSpeed_toDisplay);
    init_kcg_int32(&DMI_iconGroupIndex_toDisplay);
    init_array_int32_5(&DMI_ArrayOfMsgIndex_toDisplay);
    init_kcg_float32(&DMI_InterpolatedDistanceToTarget_toDisplay);
    init_kcg_bool(&DMI_SingleMsgAckRequiredVisibility_toDysplay);
    init_array_int32_5(&DMI_IndexFixedMsg_toDisplay);
    init_DMI_Level_Data_T_DMI_Messages_Bothways_Pkg(&DMI_level_data);
    init_kcg_int32(&DMI_IndexLevel_toDisplay);
    init_array_int32_12(&DMI_ArrayLevelIndex_toDisplay);
    init_kcg_bool(&DMI_levelMenuVisibility_toDisplay);
    init_array_char_30_5(&DMI_PlainText_toDisplay);
    init_array_float32_5(&DMI_Array_hh_toDisplay);
    init_array_float32_5(&DMI_Array_mm_toDisplay);
    init_kcg_bool(&DMI_isAuxiliarMsg_toDisplay);
    init_array_bool_10(&DMI_D_SPDI_SpeedChangeSymbolsVisible_toDisplay);
    init_array_float32_1(&DMI_D_PASP_IndicationMarker_toDisplay);
    init_array_int32_10(&DMI_D_SPDI_SpeedChangeIndex_toDisplay);
    init_array_float32_10(&DMI_D_SPDI_SpeedChangePosition_toDisplay);
    ...
    init_kcg_float32(&GUI_currentPositionInM);
    init_kcg_float32(&GUI_currentVelocityInKmH);
    init_kcg_float32(&GUI_TrainPositionDeltaMax);
    init_kcg_float32(&GUI_TrainPositionDeltaMin);
    init_kcg_int32(&GUI_timestamp);
    init_kcg_float32(&GUI_TrainPositionNominal);
    init_kcg_bool(&GUI_emergencyBrake);
    init_kcg_bool(&GUI_AFBActive);
    init_kcg_int32(&DMI_ScrollDownEnableIndex);
    init_kcg_int32(&DMI_ScrollUpEnableIndex);
...
const char* _SCSIM_CheckSum = "81c9b333117ffd9d82e6c5e98af3c5ef";
...
int SsmGetDumpSize(void) {
    ...
    nSize += sizeof(kcg_float32);
    nSize += sizeof(kcg_int32);
    nSize += sizeof(array_int32_5);
    nSize += sizeof(kcg_float32);
    nSize += sizeof(kcg_bool);
    nSize += sizeof(array_int32_5);
    nSize += sizeof(DMI_Level_Data_T_DMI_Messages_Bothways_Pkg);
    nSize += sizeof(kcg_int32);
    nSize += sizeof(array_int32_12);
    nSize += sizeof(kcg_bool);
    nSize += sizeof(array_char_30_5);
    nSize += sizeof(array_float32_5);
    nSize += sizeof(array_float32_5);
    nSize += sizeof(kcg_bool);
    nSize += sizeof(array_bool_10);
    nSize += sizeof(array_float32_1);
    nSize += sizeof(array_int32_10);
    nSize += sizeof(array_float32_10);
...
void SsmGatherDumpData(char * pData) {
    ...
    memcpy(pCurrent, &GUI_targetSpeed, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &GUI_traction, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &GUI_brake, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &GUI_initialPosition, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &GUI_initialVelocity, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &GUI_mode, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &GUI_level, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &GUI_mobileHWStatus, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    ...
    memcpy(pCurrent, &DMI_SpeedTarget_toDisplay, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &DMI_VpermColor_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_trainLenght_toDisplay, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &DMI_GradientsValue_toDisplay, sizeof(array_float32_32));
    pCurrent += sizeof(array_float32_32);
    memcpy(pCurrent, &DMI_TrainPosition_toDisplay, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    ...
    pCurrent += sizeof(kcg_bool);
    memcpy(pCurrent, &DMI_SpeedDigitOne_toDisplay, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &DMI_hourGlassVisibility_toDisplay, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(pCurrent, &DMI_trainAxleloadIndex_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_PointerColor_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_CloseButtonEnabler_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_SpeedRelease_toDisplay, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &DMI_VtargetColor_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_trainMaxspeed_toDisplay, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    ...
    pCurrent += sizeof(kcg_bool);
    memcpy(pCurrent, &DMI_SpeedIntervention_toDisplay, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &DMI_yellowBorderBrakeSymbol_toDisplay, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(pCurrent, &DMI_closeButtonIndex_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_ModeSymbolVisibility_toDisplay, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(pCurrent, &DMI_SpeedDigitThree_toDisplay, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &DMI_hourGlassCounter_toDisplay, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &DMI_trainLoadingGougeIndex_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_TrainRN_Display_toDisplay, sizeof(array_int32_9));
    pCurrent += sizeof(array_int32_9);
    memcpy(pCurrent, &DMI_RBC_status_symbol_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_GradientsEnd_toDisplay, sizeof(array_float32_32));
    pCurrent += sizeof(array_float32_32);
    memcpy(pCurrent, &DMI_vtarget_permColor_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_traindataYesNoIndex_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    ...
    pCurrent += sizeof(kcg_bool);
    memcpy(pCurrent, &DMI_levelSymbolAnnouncementIndex_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_trainCategoryIndex_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_SpeedPermitted_toDisplay, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &DMI_VreleaseColor_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_trainBrakePerc_toDisplay, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &DMI_ArrayButtonsEnabler_toDisplay, sizeof(array_int32_30));
    pCurrent += sizeof(array_int32_30);
    memcpy(pCurrent, &DMI_ETCS_LevelSymbol_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_modeSymbolAnnouncementIndex_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_ModeSymbol_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_DistanceToTarget_toDisplay, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &DMI_Vinterv_Color_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_yellowBorderMsg_toDisplay, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(pCurrent, &DMI_DriverID_Display_toDisplay, sizeof(array_int32_9));
    pCurrent += sizeof(array_int32_9);
    memcpy(pCurrent, &DMI_SpeedDigitTwo_toDisplay, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &DMI_yellowBorderC1Area_toDisplay, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(pCurrent, &DMI_trainAirtightIndex_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_GradientsStart_toDisplay, sizeof(array_float32_32));
    pCurrent += sizeof(array_float32_32);
    ...
    pCurrent += sizeof(kcg_bool);
    memcpy(pCurrent, &DMI_TrainSpeed_toDisplay, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &DMI_iconGroupIndex_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_ArrayOfMsgIndex_toDisplay, sizeof(array_int32_5));
    pCurrent += sizeof(array_int32_5);
    memcpy(pCurrent, &DMI_InterpolatedDistanceToTarget_toDisplay, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &DMI_SingleMsgAckRequiredVisibility_toDysplay, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(pCurrent, &DMI_IndexFixedMsg_toDisplay, sizeof(array_int32_5));
    pCurrent += sizeof(array_int32_5);
    ...
    memcpy(pCurrent, &DMI_IndexLevel_toDisplay, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_ArrayLevelIndex_toDisplay, sizeof(array_int32_12));
    pCurrent += sizeof(array_int32_12);
    ...
    memcpy(pCurrent, &DMI_Array_hh_toDisplay, sizeof(array_float32_5));
    pCurrent += sizeof(array_float32_5);
    memcpy(pCurrent, &DMI_Array_mm_toDisplay, sizeof(array_float32_5));
    pCurrent += sizeof(array_float32_5);
    ...
    memcpy(pCurrent, &DMI_D_PASP_IndicationMarker_toDisplay, sizeof(array_float32_1));
    pCurrent += sizeof(array_float32_1);
    memcpy(pCurrent, &DMI_D_SPDI_SpeedChangeIndex_toDisplay, sizeof(array_int32_10));
    pCurrent += sizeof(array_int32_10);
    memcpy(pCurrent, &DMI_D_SPDI_SpeedChangePosition_toDisplay, sizeof(array_float32_10));
    pCurrent += sizeof(array_float32_10);
    ...
    memcpy(pCurrent, &GUI_currentPositionInM, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &GUI_currentVelocityInKmH, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &GUI_TrainPositionDeltaMax, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &GUI_TrainPositionDeltaMin, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &GUI_timestamp, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &GUI_TrainPositionNominal, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(pCurrent, &GUI_emergencyBrake, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(pCurrent, &GUI_AFBActive, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(pCurrent, &DMI_ScrollDownEnableIndex, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(pCurrent, &DMI_ScrollUpEnableIndex, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
...
void SsmRestoreDumpData(const char * pData) {
    ...
    pCurrent += sizeof(kcg_bool);
    memcpy(&GUI_targetSpeed, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&GUI_traction, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&GUI_brake, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&GUI_initialPosition, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&GUI_initialVelocity, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&GUI_mode, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&GUI_level, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&GUI_mobileHWStatus, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    ...
    pCurrent += sizeof(array_bool_15);
    memcpy(&DMI_SpeedTarget_toDisplay, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&DMI_VpermColor_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_trainLenght_toDisplay, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&DMI_GradientsValue_toDisplay, pCurrent, sizeof(array_float32_32));
    pCurrent += sizeof(array_float32_32);
    memcpy(&DMI_TrainPosition_toDisplay, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    ...
    pCurrent += sizeof(kcg_bool);
    memcpy(&DMI_SpeedDigitOne_toDisplay, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&DMI_hourGlassVisibility_toDisplay, pCurrent, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(&DMI_trainAxleloadIndex_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_PointerColor_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_CloseButtonEnabler_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_SpeedRelease_toDisplay, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&DMI_VtargetColor_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_trainMaxspeed_toDisplay, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    ...
    pCurrent += sizeof(kcg_bool);
    memcpy(&DMI_SpeedIntervention_toDisplay, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&DMI_yellowBorderBrakeSymbol_toDisplay, pCurrent, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(&DMI_closeButtonIndex_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_ModeSymbolVisibility_toDisplay, pCurrent, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(&DMI_SpeedDigitThree_toDisplay, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&DMI_hourGlassCounter_toDisplay, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&DMI_trainLoadingGougeIndex_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_TrainRN_Display_toDisplay, pCurrent, sizeof(array_int32_9));
    pCurrent += sizeof(array_int32_9);
    memcpy(&DMI_RBC_status_symbol_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_GradientsEnd_toDisplay, pCurrent, sizeof(array_float32_32));
    pCurrent += sizeof(array_float32_32);
    memcpy(&DMI_vtarget_permColor_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_traindataYesNoIndex_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    ...
    pCurrent += sizeof(kcg_bool);
    memcpy(&DMI_levelSymbolAnnouncementIndex_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_trainCategoryIndex_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_SpeedPermitted_toDisplay, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&DMI_VreleaseColor_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_trainBrakePerc_toDisplay, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&DMI_ArrayButtonsEnabler_toDisplay, pCurrent, sizeof(array_int32_30));
    pCurrent += sizeof(array_int32_30);
    memcpy(&DMI_ETCS_LevelSymbol_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_modeSymbolAnnouncementIndex_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_ModeSymbol_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_DistanceToTarget_toDisplay, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&DMI_Vinterv_Color_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_yellowBorderMsg_toDisplay, pCurrent, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(&DMI_DriverID_Display_toDisplay, pCurrent, sizeof(array_int32_9));
    pCurrent += sizeof(array_int32_9);
    memcpy(&DMI_SpeedDigitTwo_toDisplay, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&DMI_yellowBorderC1Area_toDisplay, pCurrent, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(&DMI_trainAirtightIndex_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_GradientsStart_toDisplay, pCurrent, sizeof(array_float32_32));
    pCurrent += sizeof(array_float32_32);
    ...
    pCurrent += sizeof(kcg_bool);
    memcpy(&DMI_TrainSpeed_toDisplay, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&DMI_iconGroupIndex_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_ArrayOfMsgIndex_toDisplay, pCurrent, sizeof(array_int32_5));
    pCurrent += sizeof(array_int32_5);
    memcpy(&DMI_InterpolatedDistanceToTarget_toDisplay, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&DMI_SingleMsgAckRequiredVisibility_toDysplay, pCurrent, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(&DMI_IndexFixedMsg_toDisplay, pCurrent, sizeof(array_int32_5));
    pCurrent += sizeof(array_int32_5);
    memcpy(&DMI_level_data, pCurrent, sizeof(DMI_Level_Data_T_DMI_Messages_Bothways_Pkg));
    pCurrent += sizeof(DMI_Level_Data_T_DMI_Messages_Bothways_Pkg);
    memcpy(&DMI_IndexLevel_toDisplay, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_ArrayLevelIndex_toDisplay, pCurrent, sizeof(array_int32_12));
    pCurrent += sizeof(array_int32_12);
    ...
    pCurrent += sizeof(array_char_30_5);
    memcpy(&DMI_Array_hh_toDisplay, pCurrent, sizeof(array_float32_5));
    pCurrent += sizeof(array_float32_5);
    memcpy(&DMI_Array_mm_toDisplay, pCurrent, sizeof(array_float32_5));
    pCurrent += sizeof(array_float32_5);
    ...
    pCurrent += sizeof(array_bool_10);
    memcpy(&DMI_D_PASP_IndicationMarker_toDisplay, pCurrent, sizeof(array_float32_1));
    pCurrent += sizeof(array_float32_1);
    memcpy(&DMI_D_SPDI_SpeedChangeIndex_toDisplay, pCurrent, sizeof(array_int32_10));
    pCurrent += sizeof(array_int32_10);
    memcpy(&DMI_D_SPDI_SpeedChangePosition_toDisplay, pCurrent, sizeof(array_float32_10));
    pCurrent += sizeof(array_float32_10);
    ...
    pCurrent += sizeof(L_internal_Type_Obu_BasicTypes_Pkg);
    memcpy(&GUI_currentPositionInM, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&GUI_currentVelocityInKmH, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&GUI_TrainPositionDeltaMax, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&GUI_TrainPositionDeltaMin, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&GUI_timestamp, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&GUI_TrainPositionNominal, pCurrent, sizeof(kcg_float32));
    pCurrent += sizeof(kcg_float32);
    memcpy(&GUI_emergencyBrake, pCurrent, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(&GUI_AFBActive, pCurrent, sizeof(kcg_bool));
    pCurrent += sizeof(kcg_bool);
    memcpy(&DMI_ScrollDownEnableIndex, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
    memcpy(&DMI_ScrollUpEnableIndex, pCurrent, sizeof(kcg_int32));
    pCurrent += sizeof(kcg_int32);
