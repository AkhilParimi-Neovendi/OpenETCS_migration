...
typedef struct {
  ...
  _126_SSM_ST_SM1 /* SM1: */ Context_SM1_state_nxt;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_establishSessionFromRBC_v2_MoRC_Pck_Subfunc_Pkg Context_establishSessionFromRBC_v2_1;
  SV_establishSessionFromOBU_v2_MoRC_Pck_Subfunc_Pkg Context_establishSessionFromOBU_v2_1;
} SV_establishSession_v2_MoRC_Pck_Subfunc_Pkg;

extern void kcg_save_SV_establishSession_v2_MoRC_Pck_Subfunc_Pkg(
  SV_establishSession_v2_MoRC_Pck_Subfunc_Pkg *SV,
  outC_establishSession_v2_MoRC_Pck_Subfunc_Pkg *outC);
extern void kcg_load_SV_establishSession_v2_MoRC_Pck_Subfunc_Pkg(
  outC_establishSession_v2_MoRC_Pck_Subfunc_Pkg *outC,
  SV_establishSession_v2_MoRC_Pck_Subfunc_Pkg *SV);
