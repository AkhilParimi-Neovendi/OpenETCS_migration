  ...
  outC_improveUnlinkedBGLocations_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  ...
  for (idx3 = 0; idx3 < 41; idx3++) {
    for (idx2 = 0; idx2 < 41; idx2++) {
      ...
      outC->_L8[idx3][idx2].nid_c = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].nid_bg = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].q_link = Q_LINK_Unlinked;
      outC->_L8[idx3][idx2].location.nominal = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].location.d_min = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].location.d_max = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].seqNoOnTrack = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].infoFromLinking.valid = kcg_true;
      outC->_L8[idx3][idx2].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].infoFromLinking.expectedLocation.nominal =
        kcg_lit_int64(0);
      outC->_L8[idx3][idx2].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].infoFromLinking.linkingInfo.valid = kcg_true;
      outC->_L8[idx3][idx2].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L8[idx3][idx2].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].infoFromLinking.linkingInfo.q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L8[idx3][idx2].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
      ...
      outC->_L8[idx3][idx2].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
      ...
      outC->_L8[idx3][idx2].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
      outC->_L8[idx3][idx2].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
      ...
      outC->_L8[idx3][idx2].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
        kcg_lit_int64(0);
      outC->_L8[idx3][idx2].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
      ...
      for (idx1 = 0; idx1 < 33; idx1++) {
        ...
        outC->_L8[idx3][idx2].infoFromPassing.linkedBGs[idx1].q_scale =
          Q_SCALE_10_cm_scale;
        outC->_L8[idx3][idx2].infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int64(0);
        outC->_L8[idx3][idx2].infoFromPassing.linkedBGs[idx1].q_newcountry =
          Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
        outC->_L8[idx3][idx2].infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int64(0);
        outC->_L8[idx3][idx2].infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int64(0);
  ...
  for (idx7 = 0; idx7 < 41; idx7++) {
    ...
    outC->_L3[idx7].nid_c = kcg_lit_int64(0);
    outC->_L3[idx7].nid_bg = kcg_lit_int64(0);
    outC->_L3[idx7].q_link = Q_LINK_Unlinked;
    outC->_L3[idx7].location.nominal = kcg_lit_int64(0);
    outC->_L3[idx7].location.d_min = kcg_lit_int64(0);
    outC->_L3[idx7].location.d_max = kcg_lit_int64(0);
    outC->_L3[idx7].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L3[idx7].infoFromLinking.valid = kcg_true;
    outC->_L3[idx7].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L3[idx7].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L3[idx7].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L3[idx7].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L3[idx7].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L3[idx7].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L3[idx7].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L3[idx7].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L3[idx7].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L3[idx7].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L3[idx7].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L3[idx7].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L3[idx7].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L3[idx7].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    outC->_L3[idx7].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L3[idx7].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L3[idx7].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L3[idx7].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L3[idx7].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L3[idx7].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L3[idx7].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L3[idx7].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L3[idx7].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx6 = 0; idx6 < 33; idx6++) {
      ...
      outC->_L3[idx7].infoFromPassing.linkedBGs[idx6].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L3[idx7].infoFromPassing.linkedBGs[idx6].d_link = kcg_lit_int64(0);
      outC->_L3[idx7].infoFromPassing.linkedBGs[idx6].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L3[idx7].infoFromPassing.linkedBGs[idx6].nid_c = kcg_lit_int64(0);
      outC->_L3[idx7].infoFromPassing.linkedBGs[idx6].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L3[idx7].infoFromPassing.linkedBGs[idx6].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L3[idx7].infoFromPassing.linkedBGs[idx6].q_locacc = kcg_lit_int64(0);
    }
    outC->_L3[idx7].missed = kcg_true;
  }
  for (idx8 = 0; idx8 < 41; idx8++) {
    outC->_L2[idx8].previousLinkedBG_idx = kcg_lit_int64(0);
    outC->_L2[idx8].currentIndex = kcg_lit_int64(0);
    outC->_L2[idx8].subsequentLinkedBG_idx = kcg_lit_int64(0);
  }
