...
void kcg_save_SV_MergeMLRequests_SDM_Commands_Pkg(
  SV_MergeMLRequests_SDM_Commands_Pkg *SV,
  outC_MergeMLRequests_SDM_Commands_Pkg *outC)
{
  SV->Context_triggered = outC->triggered;
  SV->Context_revoked = outC->revoked;
  SV->Context_mem_req = outC->mem_req;
}

void kcg_load_SV_MergeMLRequests_SDM_Commands_Pkg(
  outC_MergeMLRequests_SDM_Commands_Pkg *outC,
  SV_MergeMLRequests_SDM_Commands_Pkg *SV)
{
  outC->triggered = SV->Context_triggered;
  outC->revoked = SV->Context_revoked;
  outC->mem_req = SV->Context_mem_req;
}
