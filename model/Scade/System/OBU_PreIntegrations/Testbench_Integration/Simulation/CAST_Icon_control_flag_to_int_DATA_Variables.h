...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  Icon_control_flag_INT_T_DATA /* Output1/ */ Output1;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  kcg_bool /* _L10/ */ _L10;
} outC_CAST_Icon_control_flag_to_int_DATA_Variables;

/* ===========  node initialization and cycle functions  =========== */
/* DATA::Variables::CAST_Icon_control_flag_to_int/ */
extern void CAST_Icon_control_flag_to_int_DATA_Variables(
  /* Input1/ */
  Icon_control_flag_T_DMI_Types_Pkg Input1,
  outC_CAST_Icon_control_flag_to_int_DATA_Variables *outC);

#ifndef KCG_NO_EXTERN_CALL_TO_RESET
extern void CAST_Icon_control_flag_to_int_reset_DATA_Variables(
  outC_CAST_Icon_control_flag_to_int_DATA_Variables *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CAST_Icon_control_flag_to_int_init_DATA_Variables(
  outC_CAST_Icon_control_flag_to_int_DATA_Variables *outC);
