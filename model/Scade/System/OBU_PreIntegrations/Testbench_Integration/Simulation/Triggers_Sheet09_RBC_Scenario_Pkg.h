...
} SV_Triggers_Sheet09_RBC_Scenario_Pkg;

extern void kcg_save_SV_Triggers_Sheet09_RBC_Scenario_Pkg(
  SV_Triggers_Sheet09_RBC_Scenario_Pkg *SV,
  outC_Triggers_Sheet09_RBC_Scenario_Pkg *outC);
extern void kcg_load_SV_Triggers_Sheet09_RBC_Scenario_Pkg(
  outC_Triggers_Sheet09_RBC_Scenario_Pkg *outC,
  SV_Triggers_Sheet09_RBC_Scenario_Pkg *SV);
