...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P137_StopIfInStaffResponsible_T_Packet_Types_Pkg /* P137_legacy_out/ */ P137_legacy_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_Read_P137_TM /* _L1=(TM::Read_P137#1)/ */ Context_Read_P137_1;
  /* ----------------- no clocks of observable data ------------------ */
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  P137_StopIfInStaffResponsible_T_Packet_Types_Pkg /* _L2/ */ _L2;
  kcg_bool /* _L1/ */ _L1;
...
extern void Read_P137_Legacy_init_TM_specific(
  outC_Read_P137_Legacy_TM_specific *outC);
