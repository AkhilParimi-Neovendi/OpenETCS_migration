...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P046_sections_array_flat_T_TM /* flat/ */ flat;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  kcg_int64 /* _L5/ */ _L5;
  kcg_int64 /* _L6/ */ _L6;
  P046_sections_array_flat_T_TM /* _L7/ */ _L7;
  kcg_int64 /* _L8/ */ _L8;
  P046_OBU_sectionlist_array_T_TM /* _L2/ */ _L2;
  kcg_int64 /* _L10/ */ _L10;
...
extern void C_P046_fs_flatten_array_init_TM_lib_internal(
  outC_C_P046_fs_flatten_array_TM_lib_internal *outC);
