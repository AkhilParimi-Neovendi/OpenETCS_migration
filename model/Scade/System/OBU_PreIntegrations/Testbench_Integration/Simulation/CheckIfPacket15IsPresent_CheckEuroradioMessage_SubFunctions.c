  ...
  outC_CheckIfPacket15IsPresent_CheckEuroradioMessage_SubFunctions *outC)
{
  ...
  for (idx1 = 0; idx1 < 30; idx1++) {
    outC->_L4[idx1].nid_packet = kcg_lit_int64(0);
    outC->_L4[idx1].q_dir = Q_DIR_Reverse;
    outC->_L4[idx1].valid = kcg_true;
    outC->_L4[idx1].startAddress = kcg_lit_int64(0);
    outC->_L4[idx1].endAddress = kcg_lit_int64(0);
  }
  outC->_L3 = kcg_true;
  ...
  for (idx = 0; idx < 30; idx++) {
    /* _L5=(CheckEuroradioMessage::SubFunctions::CheckIfPacketRadioMetadataElementIsPacket15#1)/ */
    CheckIfPacketRadioMetadataElementIsPacket15_init_CheckEuroradioMessage_SubFunctions(
      &outC->Context_CheckIfPacketRadioMetadataElementIsPacket15_1[idx]);
  }
}
  ...
  outC_CheckIfPacket15IsPresent_CheckEuroradioMessage_SubFunctions *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    /* _L5=(CheckEuroradioMessage::SubFunctions::CheckIfPacketRadioMetadataElementIsPacket15#1)/ */
    CheckIfPacketRadioMetadataElementIsPacket15_reset_CheckEuroradioMessage_SubFunctions(
      &outC->Context_CheckIfPacketRadioMetadataElementIsPacket15_1[idx]);
  }
}
