...
typedef struct {
  ...
  kcg_bool /* useInformationFromAcceptingRBC_loc/ */ Context_useInformationFromAcceptingRBC_loc;
  kcg_bool /* handoverInprogress/ */ Context_handoverInprogress;
  p131_q_rbcTransitionOrder_T_Handover_Pkg /* @1/_L8/ */ Context__L8_Memory_1;
  kcg_bool Context_init;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_changeoverSwitch_Handover_Pkg_handoverUtils_Pkg Context_changeoverSwitch_3;
  SV_locReachedOrPassed_BasicLocationFunctions_Pkg Context_locReachedOrPassed_1;
  SV_locReachedOrPassed_BasicLocationFunctions_Pkg Context_locReachedOrPassed_2;
  SV_handOverSequencer_Handover_Pkg_handoverUtils_Pkg Context_handOverSequencer_1;
  SV_EitherEdge_digital Context_EitherEdge_2;
  SV_EitherEdge_digital Context_EitherEdge_1;
} SV_processHandingOver_Handover_Pkg_handoverUtils_Pkg;

extern void kcg_save_SV_processHandingOver_Handover_Pkg_handoverUtils_Pkg(
  SV_processHandingOver_Handover_Pkg_handoverUtils_Pkg *SV,
  outC_processHandingOver_Handover_Pkg_handoverUtils_Pkg *outC);
extern void kcg_load_SV_processHandingOver_Handover_Pkg_handoverUtils_Pkg(
  outC_processHandingOver_Handover_Pkg_handoverUtils_Pkg *outC,
  SV_processHandingOver_Handover_Pkg_handoverUtils_Pkg *SV);
