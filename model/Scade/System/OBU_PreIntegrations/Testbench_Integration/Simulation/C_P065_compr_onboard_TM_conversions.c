  ...
  outC_C_P065_compr_onboard_TM_conversions *outC)
{
  ...
  kcg_copy_array_int64_9(&outC->_L46, (array_int64_9 *) &outC->_L9[0]);
  ...
  outC_C_P065_compr_onboard_TM_conversions *outC)
{
  ...
  outC->_L10.nid_tsr = kcg_lit_int64(0);
  outC->_L10.d_tsr = kcg_lit_int64(0);
  outC->_L10.l_tsr = kcg_lit_int64(0);
  outC->_L10.q_front =
    Q_FRONT_Train_length_delay_on_validity_end_point_of_profile_element;
  outC->_L10.v_tsr = kcg_lit_int64(0);
  ...
  outC->P065_onboard.nid_tsr = kcg_lit_int64(0);
  outC->P065_onboard.d_tsr = kcg_lit_int64(0);
  outC->P065_onboard.l_tsr = kcg_lit_int64(0);
  outC->P065_onboard.q_front =
    Q_FRONT_Train_length_delay_on_validity_end_point_of_profile_element;
  outC->P065_onboard.v_tsr = kcg_lit_int64(0);
  /* _L4=(TM_conversions::CAST_Int_to_NID_MN#1)/ */
