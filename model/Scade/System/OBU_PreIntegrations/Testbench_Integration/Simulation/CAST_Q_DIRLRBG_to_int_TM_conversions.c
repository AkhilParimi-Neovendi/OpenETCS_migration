...
{
  /* q_dirlrbg_int/ */
  static kcg_int64 q_dirlrbg_int_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* q_dirlrbg_int/ */
  static kcg_int64 _1_q_dirlrbg_int_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* q_dirlrbg_int/ */
  static kcg_int64 _3_q_dirlrbg_int_partial;
  /* error/ */
  static kcg_bool _4_error_partial;
  /* q_dirlrbg_int/ */
  static kcg_int64 _5_q_dirlrbg_int_partial;
  /* error/ */
  static kcg_bool _6_error_partial;
  /* error/ */
  static kcg_bool _7_error_partial;
  /* q_dirlrbg_int/ */
  static kcg_int64 _8_q_dirlrbg_int_partial;
  /* error/ */
  static kcg_bool _9_error_partial;
  /* q_dirlrbg_int/ */
  static kcg_int64 _10_q_dirlrbg_int_partial;
  ...
  if (outC->IfBlock1_clock) {
    ...
    outC->_L4_then_IfBlock1 = INT_Q_DIRLRBG_nominal_TM_conversions;
    q_dirlrbg_int_partial = outC->_L4_then_IfBlock1;
    outC->q_dirlrbg_int = q_dirlrbg_int_partial;
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      outC->_L3_then_else_IfBlock1 = INT_Q_DIRLRBG_reverse_TM_conversions;
      _10_q_dirlrbg_int_partial = outC->_L3_then_else_IfBlock1;
      _1_q_dirlrbg_int_partial = _10_q_dirlrbg_int_partial;
      ...
      if (outC->else_clock_else_IfBlock1) {
        ...
        outC->_L2_then_else_else_IfBlock1 = INT_Q_DIRLRBG_unknown_TM_conversions;
        _3_q_dirlrbg_int_partial = outC->_L2_then_else_else_IfBlock1;
        _8_q_dirlrbg_int_partial = _3_q_dirlrbg_int_partial;
        _7_error_partial = _4_error_partial;
      }
      else {
        outC->_L2_else_else_else_IfBlock1 = INT_Q_DIRLRBG_unknown_TM_conversions;
        outC->_L1_else_else_else_IfBlock1 = kcg_true;
        _6_error_partial = outC->_L1_else_else_else_IfBlock1;
        _5_q_dirlrbg_int_partial = outC->_L2_else_else_else_IfBlock1;
        _8_q_dirlrbg_int_partial = _5_q_dirlrbg_int_partial;
        _7_error_partial = _6_error_partial;
      }
      _1_q_dirlrbg_int_partial = _8_q_dirlrbg_int_partial;
      _2_error_partial = _7_error_partial;
    }
    outC->q_dirlrbg_int = _1_q_dirlrbg_int_partial;
...
void CAST_Q_DIRLRBG_to_int_init_TM_conversions(
  outC_CAST_Q_DIRLRBG_to_int_TM_conversions *outC)
{
  outC->_L12 = Q_DIRLRBG_Reverse;
  outC->_L13 = kcg_true;
  outC->q_dirlrbg_in = Q_DIRLRBG_Reverse;
  outC->error = kcg_true;
  ...
  outC->q_dirlrbg_int = kcg_lit_int64(0);
}
