  ...
  outC_Send_M132_TM_radio_messages *outC)
{
  ...
  kcg_copy_array_int32_20(&outC->_L56[0], &outC->_L55);
  kcg_copy_array_int32_30(&outC->_L56[20], &outC->_L57);
...
void Send_M132_init_TM_radio_messages(outC_Send_M132_TM_radio_messages *outC)
{
  ...
  outC->_L47.Message.nid_message = kcg_lit_int32(0);
  outC->_L47.Message.l_message = kcg_lit_int32(0);
  outC->_L47.Message.t_train = kcg_lit_int32(0);
  outC->_L47.Message.nid_engine = kcg_lit_int32(0);
  outC->_L47.Message.field1 = kcg_lit_int32(0);
  outC->_L47.Message.field2 = kcg_lit_int32(0);
  outC->_L47.Message.field3 = kcg_lit_int32(0);
  for (idx = 0; idx < 50; idx++) {
    outC->_L47.OptionalPackets[idx] = kcg_lit_int32(0);
  }
  outC->_L58 = kcg_lit_int32(0);
  for (idx1 = 0; idx1 < 20; idx1++) {
    outC->_L55[idx1] = kcg_lit_int32(0);
  }
  for (idx2 = 0; idx2 < 50; idx2++) {
    outC->_L56[idx2] = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 30; idx3++) {
    outC->_L57[idx3] = kcg_lit_int32(0);
  }
  outC->_L46 = kcg_lit_int32(0);
  for (idx5 = 0; idx5 < 5; idx5++) {
    outC->_L49[idx5].Message.valid = kcg_true;
    outC->_L49[idx5].Message.nid_message = kcg_lit_int32(0);
    outC->_L49[idx5].Message.l_message = kcg_lit_int32(0);
    outC->_L49[idx5].Message.t_train = kcg_lit_int32(0);
    outC->_L49[idx5].Message.nid_engine = kcg_lit_int32(0);
    outC->_L49[idx5].Message.field1 = kcg_lit_int32(0);
    outC->_L49[idx5].Message.field2 = kcg_lit_int32(0);
    outC->_L49[idx5].Message.field3 = kcg_lit_int32(0);
    for (idx4 = 0; idx4 < 50; idx4++) {
      outC->_L49[idx5].OptionalPackets[idx4] = kcg_lit_int32(0);
    }
  }
  outC->_L50.Message.valid = kcg_true;
  outC->_L50.Message.nid_message = kcg_lit_int32(0);
  outC->_L50.Message.l_message = kcg_lit_int32(0);
  outC->_L50.Message.t_train = kcg_lit_int32(0);
  outC->_L50.Message.nid_engine = kcg_lit_int32(0);
  outC->_L50.Message.field1 = kcg_lit_int32(0);
  outC->_L50.Message.field2 = kcg_lit_int32(0);
  outC->_L50.Message.field3 = kcg_lit_int32(0);
  for (idx6 = 0; idx6 < 50; idx6++) {
    outC->_L50.OptionalPackets[idx6] = kcg_lit_int32(0);
  }
  for (idx8 = 0; idx8 < 5; idx8++) {
    outC->_L51[idx8].Message.valid = kcg_true;
    outC->_L51[idx8].Message.nid_message = kcg_lit_int32(0);
    outC->_L51[idx8].Message.l_message = kcg_lit_int32(0);
    outC->_L51[idx8].Message.t_train = kcg_lit_int32(0);
    outC->_L51[idx8].Message.nid_engine = kcg_lit_int32(0);
    outC->_L51[idx8].Message.field1 = kcg_lit_int32(0);
    outC->_L51[idx8].Message.field2 = kcg_lit_int32(0);
    outC->_L51[idx8].Message.field3 = kcg_lit_int32(0);
    for (idx7 = 0; idx7 < 50; idx7++) {
      outC->_L51[idx8].OptionalPackets[idx7] = kcg_lit_int32(0);
    }
  }
  outC->_L44.valid = kcg_true;
  outC->_L44.nid_message = kcg_lit_int32(0);
  outC->_L44.l_message = kcg_lit_int32(0);
  outC->_L44.t_train = kcg_lit_int32(0);
  outC->_L44.nid_engine = kcg_lit_int32(0);
  outC->_L44.field1 = kcg_lit_int32(0);
  outC->_L44.field2 = kcg_lit_int32(0);
  outC->_L44.field3 = kcg_lit_int32(0);
  outC->_L45.valid = kcg_true;
  outC->_L45.nid_message = kcg_lit_int32(0);
  outC->_L45.l_message = kcg_lit_int32(0);
  outC->_L45.t_train = kcg_lit_int32(0);
  outC->_L45.nid_engine = kcg_lit_int32(0);
  ...
  for (idx14 = 0; idx14 < 5; idx14++) {
    ...
    outC->MessageBus_out[idx14].Message.nid_message = kcg_lit_int32(0);
    outC->MessageBus_out[idx14].Message.l_message = kcg_lit_int32(0);
    outC->MessageBus_out[idx14].Message.t_train = kcg_lit_int32(0);
    outC->MessageBus_out[idx14].Message.nid_engine = kcg_lit_int32(0);
    outC->MessageBus_out[idx14].Message.field1 = kcg_lit_int32(0);
    outC->MessageBus_out[idx14].Message.field2 = kcg_lit_int32(0);
    outC->MessageBus_out[idx14].Message.field3 = kcg_lit_int32(0);
    for (idx13 = 0; idx13 < 50; idx13++) {
      outC->MessageBus_out[idx14].OptionalPackets[idx13] = kcg_lit_int32(0);
    }
  }
  /* _L51=(TM_TrainTrack_Bus::MergeMessageToBus#1)/ */
