...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  msgToTrack_T_RCM_MsgTypes_Pkg /* msgToRBC/ */ msgToRBC;
  msgToTrackTriggers_T_RCM_MsgTypes_Pkg /* msgToTrackTriggers/ */ msgToTrackTriggers;
  ...
  morcStatus_T_RCM_Session_Types_Pkg /* status/ */ status;
...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  sessionStatus_T_RCM_Session_Types_Pkg /* sessionStatus_l/ */ Context_sessionStatus_l;
  mobileRegistrationContext_T_RCM_Types_Pkg /* registrationStatus_l/ */ Context_registrationStatus_l;
  mobileConnectionContext_T_RCM_Types_Pkg /* connectionStatus_l/ */ Context_connectionStatus_l;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_initiateTerminatingSession_v2_MoRC_Pck_Subfunc_Pkg Context_initiateTerminatingSession_v2_1;
  SV_sessionSequencer_v2_MoRC_Pck_Subfunc_Pkg Context_sessionSequencer_v2_1;
  SV_requestRadioConnectionSetupFromOBU_v2_MoRC_Pck_Subfunc_Pkg Context_requestRadioConnectionSetupFromOBU_v2_1;
  SV_registeringToTheRadioNetwork_v2_MoRC_Pck_Subfunc_Pkg Context_registeringToTheRadioNetwork_v2_1;
  SV_safeRadioConnectionIndication_v2_MoRC_Pck_Subfunc_Pkg Context_safeRadioConnectionIndication_v2_1;
} SV_MoRC_Main_v2_MoRC_Pck;

extern void kcg_save_SV_MoRC_Main_v2_MoRC_Pck(
  SV_MoRC_Main_v2_MoRC_Pck *SV,
  outC_MoRC_Main_v2_MoRC_Pck *outC);
extern void kcg_load_SV_MoRC_Main_v2_MoRC_Pck(
  outC_MoRC_Main_v2_MoRC_Pck *outC,
  SV_MoRC_Main_v2_MoRC_Pck *SV);
