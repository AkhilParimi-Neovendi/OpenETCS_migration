...
void Send_P046_MessageLibBaseline2(
  ...
  outC_Send_P046_MessageLibBaseline2 *outC)
{
  static CompressedPackets_T_Common_Types_Pkg op_call;
  static kcg_bool _1_op_call;
  static kcg_bool noname;

  kcg_copy_P046_trackside_int_T_TM(&outC->_L4, P046);
  outC->_L5 = outC->_L4.valid;
  outC->every = outC->_L5;
  kcg_copy_CompressedPackets_T_Common_Types_Pkg(&outC->_L3, B_data_in);
  if (outC->every) {
    /* _L6=(TM_trackside::Write_P046#1)/ */
    Write_P046_TM_trackside(
      &outC->_L4,
      &outC->_L3,
      &outC->Context_Write_P046_1);
    _1_op_call = outC->Context_Write_P046_1.Error;
    kcg_copy_CompressedPackets_T_Common_Types_Pkg(
      &op_call,
      &outC->Context_Write_P046_1.RadioPacketsOut);
  }
  outC->_L8 = kcg_false;
  if (outC->every) {
    outC->_L6 = _1_op_call;
...
void Send_P046_init_MessageLibBaseline2(
  outC_Send_P046_MessageLibBaseline2 *outC)
{
  static kcg_size idx;
  ...
  outC->_L4.M_LEVELTR = kcg_lit_int32(0);
  outC->_L4.NID_NTC = kcg_lit_int32(0);
  outC->_L4.N_ITER = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L4.SECTIONS[idx2].M_LEVELTR = kcg_lit_int32(0);
    outC->_L4.SECTIONS[idx2].NID_NTC = kcg_lit_int32(0);
  }
  ...
  /* _L6=(TM_trackside::Write_P046#1)/ */
  Write_P046_init_TM_trackside(&outC->Context_Write_P046_1);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void Send_P046_reset_MessageLibBaseline2(
  outC_Send_P046_MessageLibBaseline2 *outC)
{
  /* _L6=(TM_trackside::Write_P046#1)/ */
  Write_P046_reset_TM_trackside(&outC->Context_Write_P046_1);
}
