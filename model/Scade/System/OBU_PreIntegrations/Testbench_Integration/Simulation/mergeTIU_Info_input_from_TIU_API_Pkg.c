  ...
  outC_mergeTIU_Info_input_from_TIU_API_Pkg *outC)
{
  ...
  outC->_L79.trainLength = kcg_lit_int64(0);
  outC->_L79.brakePerctage = kcg_lit_int64(0);
  outC->_L79.maxTrainSpeed = kcg_lit_int64(0);
  ...
  outC->_L79.axleNumber = kcg_lit_int64(0);
  outC->_L79.numberNationalSystems = kcg_lit_int64(0);
  for (idx = 0; idx < 5; idx++) {
    outC->_L79.nationSystems[idx] = kcg_lit_int64(0);
  }
  outC->_L79.numberTractionSystems = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 4; idx1++) {
    outC->_L79.tractionSystem[idx1].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L79.tractionSystem[idx1].nid_ctraction = kcg_lit_int64(0);
  }
  ...
  outC->_L78.trainLength = kcg_lit_int64(0);
  outC->_L78.brakePerctage = kcg_lit_int64(0);
  outC->_L78.maxTrainSpeed = kcg_lit_int64(0);
  outC->_L78.loadingGauge =
    M_LOADINGGAUGE_The_train_does_not_fit_to_any_of_the_interoperable_loading_gauge_profiles;
  outC->_L78.axleLoadCategory = M_AXLELOADCAT_A;
  outC->_L78.airtightSystem = M_AIRTIGHT_Not_fitted;
  outC->_L78.axleNumber = kcg_lit_int64(0);
  outC->_L78.numberNationalSystems = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 5; idx2++) {
    outC->_L78.nationSystems[idx2] = kcg_lit_int64(0);
  }
  outC->_L78.numberTractionSystems = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 4; idx3++) {
    outC->_L78.tractionSystem[idx3].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L78.tractionSystem[idx3].nid_ctraction = kcg_lit_int64(0);
  }
  ...
  outC->_L66.empty_profile_initial_state_to_be_resumed.now = kcg_lit_int64(0);
  outC->_L66.empty_profile_initial_state_to_be_resumed.distance = kcg_lit_int64(
      0);
  outC->_L67 = kcg_true;
  ...
  outC->_L68.nothing_to_resume_profile_follow.m_trackcond =
    non_stopping_area_TIU_Types_Pkg;
  outC->_L68.empty_profile_initial_state_to_be_resumed.now = kcg_lit_int64(0);
  outC->_L68.empty_profile_initial_state_to_be_resumed.distance = kcg_lit_int64(
      0);
  ...
  outC->_L69.nothing_to_resume_profile_follow.m_trackcond =
    non_stopping_area_TIU_Types_Pkg;
  outC->_L69.empty_profile_initial_state_to_be_resumed.now = kcg_lit_int64(0);
  outC->_L69.empty_profile_initial_state_to_be_resumed.distance = kcg_lit_int64(
      0);
  ...
  outC->_L65.trainLength = kcg_lit_int64(0);
  outC->_L65.brakePerctage = kcg_lit_int64(0);
  outC->_L65.maxTrainSpeed = kcg_lit_int64(0);
  outC->_L65.loadingGauge =
    M_LOADINGGAUGE_The_train_does_not_fit_to_any_of_the_interoperable_loading_gauge_profiles;
  outC->_L65.axleLoadCategory = M_AXLELOADCAT_A;
  outC->_L65.airtightSystem = M_AIRTIGHT_Not_fitted;
  outC->_L65.axleNumber = kcg_lit_int64(0);
  outC->_L65.numberNationalSystems = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 5; idx4++) {
    outC->_L65.nationSystems[idx4] = kcg_lit_int64(0);
  }
  outC->_L65.numberTractionSystems = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 4; idx5++) {
    outC->_L65.tractionSystem[idx5].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L65.tractionSystem[idx5].nid_ctraction = kcg_lit_int64(0);
  }
  outC->_L58.valid = kcg_true;
  outC->_L58.pressure = kcg_lit_int64(0);
  outC->_L59 = kcg_true;
  outC->_L60.valid = kcg_true;
  outC->_L60.pressure = kcg_lit_int64(0);
  outC->_L61.valid = kcg_true;
  outC->_L61.pressure = kcg_lit_int64(0);
  ...
  outC->_L52.brake_pressure.pressure = kcg_lit_int64(0);
  ...
  outC->_L52.train_data_info.trainLength = kcg_lit_int64(0);
  outC->_L52.train_data_info.brakePerctage = kcg_lit_int64(0);
  outC->_L52.train_data_info.maxTrainSpeed = kcg_lit_int64(0);
  ...
  outC->_L52.train_data_info.axleNumber = kcg_lit_int64(0);
  outC->_L52.train_data_info.numberNationalSystems = kcg_lit_int64(0);
  for (idx6 = 0; idx6 < 5; idx6++) {
    outC->_L52.train_data_info.nationSystems[idx6] = kcg_lit_int64(0);
  }
  outC->_L52.train_data_info.numberTractionSystems = kcg_lit_int64(0);
  ...
  outC->_L31.brake_pressure.pressure = kcg_lit_int64(0);
  ...
  outC->_L31.train_data_info.trainLength = kcg_lit_int64(0);
  outC->_L31.train_data_info.brakePerctage = kcg_lit_int64(0);
  outC->_L31.train_data_info.maxTrainSpeed = kcg_lit_int64(0);
  ...
  outC->_L31.train_data_info.axleNumber = kcg_lit_int64(0);
  outC->_L31.train_data_info.numberNationalSystems = kcg_lit_int64(0);
  for (idx8 = 0; idx8 < 5; idx8++) {
    outC->_L31.train_data_info.nationSystems[idx8] = kcg_lit_int64(0);
  }
  outC->_L31.train_data_info.numberTractionSystems = kcg_lit_int64(0);
  ...
  for (idx10 = 0; idx10 < 5; idx10++) {
    outC->_L6.train_data_info.nationSystems[idx10] = kcg_lit_int64(0);
  }
  ...
  outC->updatedInfo.brake_pressure.pressure = kcg_lit_int64(0);
  ...
  outC->updatedInfo.train_data_info.trainLength = kcg_lit_int64(0);
  outC->updatedInfo.train_data_info.brakePerctage = kcg_lit_int64(0);
  outC->updatedInfo.train_data_info.maxTrainSpeed = kcg_lit_int64(0);
  ...
  outC->updatedInfo.train_data_info.axleNumber = kcg_lit_int64(0);
  outC->updatedInfo.train_data_info.numberNationalSystems = kcg_lit_int64(0);
  for (idx12 = 0; idx12 < 5; idx12++) {
    outC->updatedInfo.train_data_info.nationSystems[idx12] = kcg_lit_int64(0);
  }
  outC->updatedInfo.train_data_info.numberTractionSystems = kcg_lit_int64(0);
