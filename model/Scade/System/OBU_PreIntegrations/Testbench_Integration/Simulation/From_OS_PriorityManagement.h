...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  T_Mode_Level_And_Mode_Types_Pkg /* FromOS_To_NewMode/ */ FromOS_To_NewMode;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  kcg_bool /* _L13/ */ _L13;
  kcg_bool /* _L14/ */ _L14;
} outC_From_OS_PriorityManagement;

/* ===========  node initialization and cycle functions  =========== */
/* PriorityManagement::From_OS/ */
extern void From_OS_PriorityManagement(
  /* Condition1/ */
  kcg_bool Condition1,
  /* Condition5/ */
  kcg_bool Condition5,
...
extern void From_OS_reset_PriorityManagement(
  outC_From_OS_PriorityManagement *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void From_OS_init_PriorityManagement(
  outC_From_OS_PriorityManagement *outC);
