...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* SH_Initiated_By_Driver: */ Context_SH_Initiated_By_Driver_reset_nxt;
  kcg_bool /* SH_Initiated_By_Driver: */ Context_SH_Initiated_By_Driver_reset_act;
  SSM_ST_SH_Initiated_By_Driver /* SH_Initiated_By_Driver: */ Context_SH_Initiated_By_Driver_state_nxt;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_SH_Initiated_By_Driver_On_Procedures Context_SH_Initiated_By_Driver_On_1;
} SV_Procedure_SH_Initiated_By_Driver_Procedures;

extern void kcg_save_SV_Procedure_SH_Initiated_By_Driver_Procedures(
  SV_Procedure_SH_Initiated_By_Driver_Procedures *SV,
  outC_Procedure_SH_Initiated_By_Driver_Procedures *outC);
extern void kcg_load_SV_Procedure_SH_Initiated_By_Driver_Procedures(
  outC_Procedure_SH_Initiated_By_Driver_Procedures *outC,
  SV_Procedure_SH_Initiated_By_Driver_Procedures *SV);
