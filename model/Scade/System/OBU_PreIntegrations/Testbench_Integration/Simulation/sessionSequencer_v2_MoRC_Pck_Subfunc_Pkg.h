...
typedef struct {
  ...
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* initializeSession/ */ Context_initializeSession;
  sessionStatus_T_RCM_Session_Types_Pkg /* sessionStatus_l/ */ Context_sessionStatus_l;
  kcg_bool /* Session_SM: */ Context_Session_SM_reset_nxt;
  kcg_bool /* Session_SM: */ Context_Session_SM_reset_act;
  SSM_ST_Session_SM /* Session_SM: */ Context_Session_SM_state_nxt;
  sessionCmd_T_RCM_Session_Types_Pkg /* sessionEstablishCmd/ */ Context_mem_sessionEstablishCmd;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_establishSession_v2_MoRC_Pck_Subfunc_Pkg Context_establishSession_v2_1;
  SV_terminateSession_v2_MoRC_Pck_Subfunc_Pkg Context_terminateSession_v2_1;
  SV_maintainingSession_v2_MoRC_Pck_Subfunc_Pkg Context_maintainingSession_v2_1;
} SV_sessionSequencer_v2_MoRC_Pck_Subfunc_Pkg;

extern void kcg_save_SV_sessionSequencer_v2_MoRC_Pck_Subfunc_Pkg(
  SV_sessionSequencer_v2_MoRC_Pck_Subfunc_Pkg *SV,
  outC_sessionSequencer_v2_MoRC_Pck_Subfunc_Pkg *outC);
extern void kcg_load_SV_sessionSequencer_v2_MoRC_Pck_Subfunc_Pkg(
  outC_sessionSequencer_v2_MoRC_Pck_Subfunc_Pkg *outC,
  SV_sessionSequencer_v2_MoRC_Pck_Subfunc_Pkg *SV);
