...
void kcg_save_SV_ProvidePositionReport_ProvidePositionReport_Pkg(
  SV_ProvidePositionReport_ProvidePositionReport_Pkg *SV,
  outC_ProvidePositionReport_ProvidePositionReport_Pkg *outC)
{
  kcg_save_SV_ReceiveReportParameters_ProvidePositionReport_Pkg(
    &SV->Context_ReceiveReportParameters_1,
    &outC->Context_ReceiveReportParameters_1);
  kcg_save_SV_PosReport_Supervision_ProvidePositionReport_Pkg(
    &SV->Context_PosReport_Supervision_1,
    &outC->Context_PosReport_Supervision_1);
  kcg_save_SV_Build_Packets0_1_ProvidePositionReport_Pkg(
    &SV->Context_Build_Packets0_1_1,
    &outC->Context_Build_Packets0_1_1);
  kcg_save_SV_nextGen_Msg136_radioOutput_Pkg(
    &SV->Context_nextGen_Msg136_1,
    &outC->Context_nextGen_Msg136_1);
  kcg_copy_ReportedBGList_T_ProvidePositionReport_Pkg(
  ...
  kcg_copy_ModeLevel2PositionReport_T_ProvidePositionReport_Pkg(
    ...
    &outC->mem_modeLevelStatus);
  kcg_copy_odometry_T_Obu_BasicTypes_Pkg(
    &SV->Context_mem_odometry,
    &outC->mem_odometry);
}

void kcg_load_SV_ProvidePositionReport_ProvidePositionReport_Pkg(
  outC_ProvidePositionReport_ProvidePositionReport_Pkg *outC,
  SV_ProvidePositionReport_ProvidePositionReport_Pkg *SV)
{
  kcg_load_SV_ReceiveReportParameters_ProvidePositionReport_Pkg(
    &outC->Context_ReceiveReportParameters_1,
    &SV->Context_ReceiveReportParameters_1);
  kcg_load_SV_PosReport_Supervision_ProvidePositionReport_Pkg(
    &outC->Context_PosReport_Supervision_1,
    &SV->Context_PosReport_Supervision_1);
  kcg_load_SV_Build_Packets0_1_ProvidePositionReport_Pkg(
    &outC->Context_Build_Packets0_1_1,
    &SV->Context_Build_Packets0_1_1);
  kcg_load_SV_nextGen_Msg136_radioOutput_Pkg(
    &outC->Context_nextGen_Msg136_1,
    &SV->Context_nextGen_Msg136_1);
  kcg_copy_ReportedBGList_T_ProvidePositionReport_Pkg(
    &outC->mem_reportedBGs,
