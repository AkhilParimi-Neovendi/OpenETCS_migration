...
void Balise_420_1_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises(
  ...
  /* PIG_nom/ */
  kcg_int32 PIG_nom,
  outC_Balise_420_1_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_Balises::Packets_BG420#1)/ */
    Packets_BG420_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG420_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG420_1.Balise_data_out);
...
void Balise_420_1_init_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises(
  outC_Balise_420_1_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises *outC)
{
  static kcg_size idx;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_Balises::Packets_BG420#1)/ */
  Packets_BG420_init_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises(
    &outC->Context_Packets_BG420_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_420_1_reset_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises(
  outC_Balise_420_1_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_Balises::Packets_BG420#1)/ */
  Packets_BG420_reset_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises(
    &outC->Context_Packets_BG420_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
