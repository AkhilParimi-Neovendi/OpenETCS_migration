...
void Balises0002_Amstel_UB_Signal_613_to_617_init_AmsterdamUtrechtL2_Sheet05_Amstel_Balises(
  outC_Balises0002_Amstel_UB_Signal_613_to_617_AmsterdamUtrechtL2_Sheet05_Amstel_Balises *outC)
{
  static kcg_size idx;
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L6.BG_Message.Messages.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    ...
    outC->_L6.BG_Message.Messages.PacketHeaders[idx].startAddress =
      kcg_lit_int64(0);
    outC->_L6.BG_Message.Messages.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L6.BG_Message.Messages.PacketData[idx1] = kcg_lit_int64(0);
  }
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L1.Messages.PacketHeaders[idx2].nid_packet = kcg_lit_int64(0);
    outC->_L1.Messages.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L1.Messages.PacketHeaders[idx2].valid = kcg_true;
    outC->_L1.Messages.PacketHeaders[idx2].startAddress = kcg_lit_int64(0);
    outC->_L1.Messages.PacketHeaders[idx2].endAddress = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L1.Messages.PacketData[idx3] = kcg_lit_int64(0);
  }
  ...
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L3.Messages.PacketHeaders[idx4].nid_packet = kcg_lit_int64(0);
    outC->_L3.Messages.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L3.Messages.PacketHeaders[idx4].valid = kcg_true;
    outC->_L3.Messages.PacketHeaders[idx4].startAddress = kcg_lit_int64(0);
    outC->_L3.Messages.PacketHeaders[idx4].endAddress = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L3.Messages.PacketData[idx5] = kcg_lit_int64(0);
  }
  ...
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L4.BG_Message.Messages.PacketHeaders[idx6].nid_packet = kcg_lit_int64(0);
    ...
    outC->_L4.BG_Message.Messages.PacketHeaders[idx6].startAddress =
      kcg_lit_int64(0);
    outC->_L4.BG_Message.Messages.PacketHeaders[idx6].endAddress = kcg_lit_int64(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->_L4.BG_Message.Messages.PacketData[idx7] = kcg_lit_int64(0);
  }
  ...
  for (idx9 = 0; idx9 < 500; idx9++) {
    outC->SectionData_out.BG_Message.Messages.PacketData[idx9] = kcg_lit_int64(0);
  }
  /* _L1=(AmsterdamUtrechtL2::Sheet05_Amstel_Balises::Balise_Group_353#2)/ */
...
void Balises0002_Amstel_UB_Signal_613_to_617_reset_AmsterdamUtrechtL2_Sheet05_Amstel_Balises(
  outC_Balises0002_Amstel_UB_Signal_613_to_617_AmsterdamUtrechtL2_Sheet05_Amstel_Balises *outC)
{
  /* _L1=(AmsterdamUtrechtL2::Sheet05_Amstel_Balises::Balise_Group_353#2)/ */
