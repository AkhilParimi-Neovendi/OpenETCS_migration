  ...
  outC_Supervise_Events_ProvidePositionReport_Pkg *outC)
{
  ...
  for (idx4 = 0; idx4 < 33; idx4++) {
    ...
    outC->_L16.infoFromPassing.linkedBGs[idx4].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L16.infoFromPassing.linkedBGs[idx4].d_link = kcg_lit_int64(0);
    outC->_L16.infoFromPassing.linkedBGs[idx4].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L16.infoFromPassing.linkedBGs[idx4].nid_c = kcg_lit_int64(0);
    outC->_L16.infoFromPassing.linkedBGs[idx4].nid_bg = kcg_lit_int64(0);
    outC->_L16.infoFromPassing.linkedBGs[idx4].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L16.infoFromPassing.linkedBGs[idx4].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L16.infoFromPassing.linkedBGs[idx4].q_locacc = kcg_lit_int64(0);
  }
...
void kcg_save_SV_Supervise_Events_ProvidePositionReport_Pkg(
  SV_Supervise_Events_ProvidePositionReport_Pkg *SV,
  outC_Supervise_Events_ProvidePositionReport_Pkg *outC)
{
  kcg_save_SV_op_3_6_5_1_4_a_i_ProvidePositionReport_Pkg(
    &SV->Context_op_3_6_5_1_4_a_i_1,
    &outC->Context_op_3_6_5_1_4_a_i_1);
  kcg_save_SV_op_3_6_5_1_4_j_ProvidePositionReport_Pkg(
    &SV->Context_op_3_6_5_1_4_j_1,
    &outC->Context_op_3_6_5_1_4_j_1);
  kcg_save_SV_op_3_6_5_1_4_c_d_ProvidePositionReport_Pkg(
    &SV->Context_op_3_6_5_1_4_c_d_1,
    &outC->Context_op_3_6_5_1_4_c_d_1);
  kcg_save_SV_op_3_6_5_1_4_e_h_k_ProvidePositionReport_Pkg(
    &SV->Context_op_3_6_5_1_4_e_h_k_1,
    &outC->Context_op_3_6_5_1_4_e_h_k_1);
  kcg_save_SV_op_3_6_5_1_4_f_g_ProvidePositionReport_Pkg(
    &SV->Context_op_3_6_5_1_4_f_g_1,
    &outC->Context_op_3_6_5_1_4_f_g_1);
  kcg_save_SV_op_3_6_5_1_4_b_ProvidePositionReport_Pkg(
    &SV->Context_op_3_6_5_1_4_b_1,
    &outC->Context_op_3_6_5_1_4_b_1);
}

void kcg_load_SV_Supervise_Events_ProvidePositionReport_Pkg(
  outC_Supervise_Events_ProvidePositionReport_Pkg *outC,
  SV_Supervise_Events_ProvidePositionReport_Pkg *SV)
{
  kcg_load_SV_op_3_6_5_1_4_a_i_ProvidePositionReport_Pkg(
    &outC->Context_op_3_6_5_1_4_a_i_1,
    &SV->Context_op_3_6_5_1_4_a_i_1);
  kcg_load_SV_op_3_6_5_1_4_j_ProvidePositionReport_Pkg(
    &outC->Context_op_3_6_5_1_4_j_1,
    &SV->Context_op_3_6_5_1_4_j_1);
  kcg_load_SV_op_3_6_5_1_4_c_d_ProvidePositionReport_Pkg(
    &outC->Context_op_3_6_5_1_4_c_d_1,
    &SV->Context_op_3_6_5_1_4_c_d_1);
  kcg_load_SV_op_3_6_5_1_4_e_h_k_ProvidePositionReport_Pkg(
    &outC->Context_op_3_6_5_1_4_e_h_k_1,
    &SV->Context_op_3_6_5_1_4_e_h_k_1);
  kcg_load_SV_op_3_6_5_1_4_f_g_ProvidePositionReport_Pkg(
    &outC->Context_op_3_6_5_1_4_f_g_1,
    &SV->Context_op_3_6_5_1_4_f_g_1);
  kcg_load_SV_op_3_6_5_1_4_b_ProvidePositionReport_Pkg(
    &outC->Context_op_3_6_5_1_4_b_1,
    &SV->Context_op_3_6_5_1_4_b_1);
}
