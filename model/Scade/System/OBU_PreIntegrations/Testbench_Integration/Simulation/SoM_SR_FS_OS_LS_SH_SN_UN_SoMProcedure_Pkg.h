...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ----------------------- local memories  ------------------------- */
  _142_SSM_ST_SM1 /* SM1: */ SM1_state_nxt;
  ...
  _142_SSM_ST_SM1 /* SM1: */ SM1_state_sel;
  _142_SSM_ST_SM1 /* SM1: */ SM1_state_act;
  /* -------------------- (-debug) no assertions  -------------------- */
  ...
  _143_SSM_TR_SM1 /* SM1: */ SM1_fired_strong;
  _143_SSM_TR_SM1 /* SM1: */ SM1_fired;
...
typedef struct {
  ...
  _142_SSM_ST_SM1 /* SM1: */ Context_SM1_state_nxt;
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- no sub nodes' contexts  -------------------- */
} SV_SoM_SR_FS_OS_LS_SH_SN_UN_SoMProcedure_Pkg;

extern void kcg_save_SV_SoM_SR_FS_OS_LS_SH_SN_UN_SoMProcedure_Pkg(
  SV_SoM_SR_FS_OS_LS_SH_SN_UN_SoMProcedure_Pkg *SV,
  outC_SoM_SR_FS_OS_LS_SH_SN_UN_SoMProcedure_Pkg *outC);
extern void kcg_load_SV_SoM_SR_FS_OS_LS_SH_SN_UN_SoMProcedure_Pkg(
  outC_SoM_SR_FS_OS_LS_SH_SN_UN_SoMProcedure_Pkg *outC,
  SV_SoM_SR_FS_OS_LS_SH_SN_UN_SoMProcedure_Pkg *SV);
