  ...
  outC_checkGeneralMessage_trainData_pkg *outC)
{
  ...
  outC->_L26 = cm24_General_Message_Id_Pkg;
  ...
  outC->_L16 = outC->_L6 & outC->_L9;
  outC->_L28 = last_GeneralMsgReceived;
  outC->_L27 = outC->_L28 | outC->_L16;
  outC->GeneralMsgReceived = outC->_L27;
  outC->_L30 = outC->GeneralMsgReceived;
  ...
  outC->ackRequested = outC->_L19;
  outC->genMessageReceived = outC->_L30;
}
  ...
  outC_checkGeneralMessage_trainData_pkg *outC)
{
  ...
  outC->GeneralMsgReceived = kcg_false;
}
...
void kcg_save_SV_checkGeneralMessage_trainData_pkg(
  SV_checkGeneralMessage_trainData_pkg *SV,
  outC_checkGeneralMessage_trainData_pkg *outC)
{
  SV->Context_GeneralMsgReceived = outC->GeneralMsgReceived;
}

void kcg_load_SV_checkGeneralMessage_trainData_pkg(
  outC_checkGeneralMessage_trainData_pkg *outC,
  SV_checkGeneralMessage_trainData_pkg *SV)
{
  outC->GeneralMsgReceived = SV->Context_GeneralMsgReceived;
}
