...
{
  /* scrollLevel/ */
  static kcg_int32 scrollLevel_partial;
  /* scrollLevel/ */
  static kcg_int32 _1_scrollLevel_partial;
  /* scrollLevel/ */
  static kcg_int32 _2_scrollLevel_partial;
  /* scrollLevel/ */
  static kcg_int32 _3_scrollLevel_partial;
  /* scrollDownTypeIndex/ */
  static kcg_int32 last_scrollDownTypeIndex;
  /* scrollLevel/ */
  static kcg_int32 last_scrollLevel;
  /* scrollUpTypeIndex/ */
  static kcg_int32 last_scrollUpTypeIndex;
  ...
  outC->IfBlock1_clock = scrollUp & (outC->scrollUpTypeIndex == kcg_lit_int32(1));
  /* IfBlock1: */
  if (outC->IfBlock1_clock) {
    outC->_L3_then_IfBlock1 = kcg_lit_int32(1);
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      outC->_L2_then_else_IfBlock1 = kcg_lit_int32(1);
  ...
  outC_ScrollController_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  outC->scrollUpTypeIndex = kcg_lit_int32(0);
  outC->scrollLevel = kcg_lit_int32(0);
  outC->scrollDownTypeIndex = kcg_lit_int32(0);
}
