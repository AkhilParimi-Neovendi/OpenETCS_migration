...
typedef struct {
  ...
  kcg_bool /* Loc_End_Of_Mission_Procedure_Req_SB/ */ Loc_End_Of_Mission_Procedure_Req_SB;
  kcg_bool /* Loc_End_Of_Mission_Procedure_Req_TR/ */ Loc_End_Of_Mission_Procedure_Req_TR;
  kcg_bool /* Loc_Clean_BG_List_SH_Area_TR/ */ Loc_Clean_BG_List_SH_Area_TR;
  kcg_bool /* Loc_End_Of_Mission_Procedure_Req_SoM/ */ Loc_End_Of_Mission_Procedure_Req_SoM;
...
typedef struct {
  /* ----------------------  memorised outputs  ---------------------- */
  kcg_bool /* End_Of_Mission_Procedure_Req/ */ Context_End_Of_Mission_Procedure_Req;
  /* ----------------------- local memories  ------------------------- */
  kcg_bool /* On_Going_Mission/ */ Context_On_Going_Mission;
  kcg_bool /* Failure_Occured/ */ Context_mem_Failure_Occured;
  kcg_bool /* Train_Overpass_EOA_Antenna/ */ Context_mem_Train_Overpass_EOA_Antenna;
  kcg_bool /* Override_Function_Active/ */ Context_mem_Override_Function_Active;
  M_LEVEL /* Current_Level/ */ Context_mem_Current_Level;
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_ToShunting_Conditions Context_ToShunting_1;
  SV_Procedure_StartOfMission_Procedures Context_Procedure_StartOfMission_1;
  SV_ToTrip_Conditions Context_ToTrip_1;
  SV_Procedure_Train_Trip_Procedures Context_Procedure_Train_Trip_1;
  SV_Procedure_LimitedSupervision_Procedures Context_Procedure_LimitedSupervision_1;
  SV_Procedure_OnSight_Procedures Context_Procedure_OnSight_1;
  SV_ToFullSupervision_Conditions Context_ToFullSupervision_1;
  SV_Procedure_Train_Reversing_Procedures Context_Procedure_Train_Reversing_1;
  SV_ToSystemNational_Conditions Context_ToSystemNational_1;
  SV_ToUnfitted_Conditions Context_ToUnfitted_1;
  SV_ToStaffResponsible_Conditions Context_ToStaffResponsible_1;
} SV_ComputeModesConditions;

extern void kcg_save_SV_ComputeModesConditions(
  SV_ComputeModesConditions *SV,
  outC_ComputeModesConditions *outC);
extern void kcg_load_SV_ComputeModesConditions(
  outC_ComputeModesConditions *outC,
  SV_ComputeModesConditions *SV);
