...
void RadioTrackTrainFactory__CreateMsg039_BSL2_init_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg(
  outC_RadioTrackTrainFactory__CreateMsg039_BSL2_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg *outC)
{
  static kcg_size idx;
  ...
  outC->_L105.Header.radioDevice = kcg_lit_int32(0);
  outC->_L105.Header.receivedSystemTime = kcg_lit_int32(0);
  outC->_L105.Header.nid_message = kcg_lit_int32(0);
  outC->_L105.Header.t_train = kcg_lit_int32(0);
  outC->_L105.Header.m_ack = kcg_lit_int32(0);
  outC->_L105.Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L105.Header.t_train_reference = kcg_lit_int32(0);
  outC->_L105.Header.nid_em = kcg_lit_int32(0);
  outC->_L105.Header.q_scale = kcg_lit_int32(0);
  outC->_L105.Header.d_sr = kcg_lit_int32(0);
  outC->_L105.Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L105.Header.d_ref = kcg_lit_int32(0);
  outC->_L105.Header.q_dir = kcg_lit_int32(0);
  outC->_L105.Header.d_emergencystop = kcg_lit_int32(0);
  outC->_L105.Header.m_version = kcg_lit_int32(0);
  for (idx = 0; idx < 30; idx++) {
    outC->_L105.Messages.PacketHeaders[idx].nid_packet = kcg_lit_int32(0);
    outC->_L105.Messages.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L105.Messages.PacketHeaders[idx].valid = kcg_true;
    outC->_L105.Messages.PacketHeaders[idx].startAddress = kcg_lit_int32(0);
    outC->_L105.Messages.PacketHeaders[idx].endAddress = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L105.Messages.PacketData[idx1] = kcg_lit_int32(0);
  }
  outC->_L103 =
  ...
  outC->_L88.NID_PACKET = kcg_lit_int32(0);
  outC->_L88.Q_DIR = kcg_lit_int32(0);
  outC->_L88.L_PACKET = kcg_lit_int32(0);
  outC->_L88.T_MAR = kcg_lit_int32(0);
  outC->_L88.T_TIMEOUTRQST = kcg_lit_int32(0);
  outC->_L88.T_CYCRQST = kcg_lit_int32(0);
  ...
  outC->_L90.D_STATIC = kcg_lit_int32(0);
  outC->_L90.V_STATIC = kcg_lit_int32(0);
  outC->_L90.Q_FRONT = kcg_lit_int32(0);
  outC->_L90.N_ITER_n = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L90.SECTIONS_q_diff[idx2].NC_DIFF = kcg_lit_int32(0);
    outC->_L90.SECTIONS_q_diff[idx2].V_DIFF = kcg_lit_int32(0);
  }
  outC->_L90.N_ITER_k = kcg_lit_int32(0);
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->_L90.SECTIONS_SSP[idx4].D_STATIC = kcg_lit_int32(0);
    outC->_L90.SECTIONS_SSP[idx4].V_STATIC = kcg_lit_int32(0);
    outC->_L90.SECTIONS_SSP[idx4].Q_FRONT = kcg_lit_int32(0);
    outC->_L90.SECTIONS_SSP[idx4].N_ITER = kcg_lit_int32(0);
    for (idx3 = 0; idx3 < 32; idx3++) {
      outC->_L90.SECTIONS_SSP[idx4].SECTIONS_q_diff[idx3].NC_DIFF = kcg_lit_int32(0);
      outC->_L90.SECTIONS_SSP[idx4].SECTIONS_q_diff[idx3].V_DIFF = kcg_lit_int32(0);
    }
  }
  ...
  outC->_L91.T_CYCLOC = kcg_lit_int32(0);
  outC->_L91.D_CYCLOC = kcg_lit_int32(0);
  outC->_L91.M_LOC = kcg_lit_int32(0);
  outC->_L91.N_ITER = kcg_lit_int32(0);
  for (idx5 = 0; idx5 < 32; idx5++) {
    outC->_L91.SECTIONS[idx5].D_LOC = kcg_lit_int32(0);
    outC->_L91.SECTIONS[idx5].Q_LGTLOC = kcg_lit_int32(0);
  }
  ...
  outC->_L92.D_GRADIENT = kcg_lit_int32(0);
  outC->_L92.Q_GDIR = kcg_lit_int32(0);
  outC->_L92.G_A = kcg_lit_int32(0);
  outC->_L92.N_ITER = kcg_lit_int32(0);
  for (idx6 = 0; idx6 < 32; idx6++) {
    outC->_L92.SECTIONS[idx6].D_GRADIENT = kcg_lit_int32(0);
    outC->_L92.SECTIONS[idx6].Q_GDIR = kcg_lit_int32(0);
    outC->_L92.SECTIONS[idx6].G_A = kcg_lit_int32(0);
  }
...
void RadioTrackTrainFactory__CreateMsg039_BSL2_reset_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg(
  outC_RadioTrackTrainFactory__CreateMsg039_BSL2_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg *outC)
{
  /* _L105=(RBC_SendMergeRadio_Pkg::SEND_MergeRadioPackets#2)/ */
