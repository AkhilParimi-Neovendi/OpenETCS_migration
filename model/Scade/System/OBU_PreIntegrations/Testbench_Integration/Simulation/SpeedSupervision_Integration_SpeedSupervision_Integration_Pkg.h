...
typedef struct {
  ...
  /* -----------------------  no local probes  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  SV_SDM_InputWrapper_SDM_Input_Wrappers Context_SDM_InputWrapper_1;
  SV_TargetManagement_TargetManagement_pkg Context_TargetManagement_2;
  SV_AGradient_SDM_GradientAcceleration_Pkg Context_AGradient_1;
  SV_CalcBrakingCurves_integration_CalcBrakingCurves_Pkg Context_CalcBrakingCurves_integration_1;
  SV_SDMLimitLocations_TargetLimits_Pkg Context_SDMLimitLocations_4;
  SV_SDM_Commands_SDM_Commands_Pkg Context_SDM_Commands_1;
} SV_SpeedSupervision_Integration_SpeedSupervision_Integration_Pkg;

extern void kcg_save_SV_SpeedSupervision_Integration_SpeedSupervision_Integration_Pkg(
  SV_SpeedSupervision_Integration_SpeedSupervision_Integration_Pkg *SV,
  outC_SpeedSupervision_Integration_SpeedSupervision_Integration_Pkg *outC);
extern void kcg_load_SV_SpeedSupervision_Integration_SpeedSupervision_Integration_Pkg(
  outC_SpeedSupervision_Integration_SpeedSupervision_Integration_Pkg *outC,
  SV_SpeedSupervision_Integration_SpeedSupervision_Integration_Pkg *SV);
