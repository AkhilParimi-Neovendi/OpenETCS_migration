...
{
  /* toRTMCMD/ */
  static cmdRadioUnit_T_API_RadioCommunication_Pkg toRTMCMD_partial;
  /* nidMN/ */
  static NID_MN nidMN_partial;
  /* nidRadio/ */
  static NID_RADIO nidRadio_partial;
  /* toRTMCMD/ */
  static cmdRadioUnit_T_API_RadioCommunication_Pkg _1_toRTMCMD_partial;
  /* nidMN/ */
  static NID_MN _2_nidMN_partial;
  /* nidRadio/ */
  static NID_RADIO _3_nidRadio_partial;
  /* nidRadio/ */
  static NID_RADIO _4_nidRadio_partial;
  /* nidMN/ */
  static NID_MN _5_nidMN_partial;
  /* toRTMCMD/ */
  static cmdRadioUnit_T_API_RadioCommunication_Pkg _6_toRTMCMD_partial;
  /* nidRadio/ */
  static NID_RADIO _7_nidRadio_partial;
  /* nidMN/ */
  static NID_MN _8_nidMN_partial;
  /* toRTMCMD/ */
  static cmdRadioUnit_T_API_RadioCommunication_Pkg _9_toRTMCMD_partial;
  /* nidRadio/ */
...
void kcg_save_SV_mapnewCMD_toCmd_radioOutput_Pkg(
  SV_mapnewCMD_toCmd_radioOutput_Pkg *SV,
  outC_mapnewCMD_toCmd_radioOutput_Pkg *outC)
{
  SV->Context_nidRadio = outC->nidRadio;
  SV->Context_nidMN = outC->nidMN;
}

void kcg_load_SV_mapnewCMD_toCmd_radioOutput_Pkg(
  outC_mapnewCMD_toCmd_radioOutput_Pkg *outC,
  SV_mapnewCMD_toCmd_radioOutput_Pkg *SV)
{
  outC->nidRadio = SV->Context_nidRadio;
  outC->nidMN = SV->Context_nidMN;
}
