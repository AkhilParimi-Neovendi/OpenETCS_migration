...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P009_TM_TrainToTrack /* P009_out/ */ P009_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_CAST_Int_to_NID_LTRBG_TM_conversions /* _L71=(TM_conversions::CAST_Int_to_NID_LTRBG#1)/ */ Context_CAST_Int_to_NID_LTRBG_1;
...
extern void C_compr_P009_reset_TM_TrainToTrack(
  outC_C_compr_P009_TM_TrainToTrack *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void C_compr_P009_init_TM_TrainToTrack(
  outC_C_compr_P009_TM_TrainToTrack *outC);
#endif /* KCG_USER_DEFINED_INIT */

/*
  Expanded instances for: TM_TrainToTrack::C_compr_P009/
