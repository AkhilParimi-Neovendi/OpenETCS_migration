  ...
  outC_CheckOneTelegram_CheckBGConsistency_Pkg_SubFunction *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L50.PacketHeaders[idx].nid_packet = kcg_lit_int32(0);
    outC->_L50.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L50.PacketHeaders[idx].valid = kcg_true;
    outC->_L50.PacketHeaders[idx].startAddress = kcg_lit_int32(0);
    outC->_L50.PacketHeaders[idx].endAddress = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L50.PacketData[idx1] = kcg_lit_int32(0);
  }
  ...
  outC->_L51.m_mcount = kcg_lit_int32(0);
  outC->_L51.nid_c = kcg_lit_int32(0);
  outC->_L51.nid_bg = kcg_lit_int32(0);
