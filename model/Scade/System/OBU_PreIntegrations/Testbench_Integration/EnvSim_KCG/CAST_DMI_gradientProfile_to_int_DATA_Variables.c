  ...
  outC_CAST_DMI_gradientProfile_to_int_DATA_Variables *outC)
{
  ...
  outC->_L5[0] = outC->_L4;
  tmp2[0] = outC->_L5[0];
  kcg_copy_array_int64_32(&tmp2[1], &outC->_L6);
  kcg_copy_array_int64_33(&tmp1[0], &tmp2);
  kcg_copy_array_int64_32(&tmp1[33], &outC->_L7);
  kcg_copy_array_int64_65(&tmp[0], &tmp1);
  kcg_copy_array_int64_32(&tmp[65], &outC->_L8);
  kcg_copy_array_int64_97(&outC->_L10[0], &tmp);
  kcg_copy_array_int64_32(&outC->_L10[97], &outC->_L9);
  ...
  outC_CAST_DMI_gradientProfile_to_int_DATA_Variables *outC)
{
  ...
  for (idx6 = 0; idx6 < 1; idx6++) {
    outC->_L5[idx6] = kcg_lit_int64(0);
  }
  outC->_L4 = kcg_lit_int64(0);
  for (idx7 = 0; idx7 < 32; idx7++) {
    outC->_L2[idx7].valid = kcg_true;
    outC->_L2[idx7].begin_section = kcg_lit_int64(0);
    outC->_L2[idx7].end_section = kcg_lit_int64(0);
    outC->_L2[idx7].gradient = kcg_lit_int64(0);
  }
  outC->_L3 = kcg_true;
  outC->_L1.profileChanged = kcg_true;
  for (idx8 = 0; idx8 < 32; idx8++) {
    outC->_L1.gradientProfiles[idx8].valid = kcg_true;
    outC->_L1.gradientProfiles[idx8].begin_section = kcg_lit_int64(0);
    outC->_L1.gradientProfiles[idx8].end_section = kcg_lit_int64(0);
    outC->_L1.gradientProfiles[idx8].gradient = kcg_lit_int64(0);
  }
  for (idx9 = 0; idx9 < 129; idx9++) {
    outC->DMI_gradientProfile_int[idx9] = kcg_lit_int64(0);
  }
  /* _L4=(Utilities::Bool_to_Int#1)/ */
