...
void Exception04RejectIfSPPAndGradientOnBoardOrMACoverNotFullLength_init_InformationFilter_Pkg_FirstFilte(
  outC_Exception04RejectIfSPPAndGradientOnBoardOrMACoverNotFullLength_InformationFilter_Pkg_FirstFilte *outC)
{
  outC->_L5 = kcg_true;
  outC->_L4 = kcg_true;
...
void Exception04RejectIfSPPAndGradientOnBoardOrMACoverNotFullLength_reset_InformationFilter_Pkg_FirstFilt(
  outC_Exception04RejectIfSPPAndGradientOnBoardOrMACoverNotFullLength_InformationFilter_Pkg_FirstFilte *outC)
{
}
