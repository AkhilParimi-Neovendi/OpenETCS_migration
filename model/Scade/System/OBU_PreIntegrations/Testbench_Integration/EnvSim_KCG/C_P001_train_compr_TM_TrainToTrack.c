  ...
  outC_C_P001_train_compr_TM_TrainToTrack *outC)
{
  ...
  /* _L93=(TM_conversions::CAST_NID_PRVLRBG_to_int#1)/ */
  CAST_NID_PRVLRBG_to_int_TM_conversions(
    outC->_L92,
    &outC->Context_CAST_NID_PRVLRBG_to_int_1);
  outC->_L93 = outC->Context_CAST_NID_PRVLRBG_to_int_1.nid_prvlrbg_in;
  outC->_L90 = outC->_L1.d_lrbg;
  /* _L91=(TM_conversions::CAST_D_LRBG_to_int#1)/ */
  CAST_D_LRBG_to_int_TM_conversions(
    outC->_L90,
    &outC->Context_CAST_D_LRBG_to_int_1);
  outC->_L91 = outC->Context_CAST_D_LRBG_to_int_1.d_lrbg_int;
  ...
  /* _L77=(TM_conversions::CAST_L_DOUBTOVER_to_int#1)/ */
  CAST_L_DOUBTOVER_to_int_TM_conversions(
    outC->_L9,
    &outC->Context_CAST_L_DOUBTOVER_to_int_1);
  outC->_L77 = outC->Context_CAST_L_DOUBTOVER_to_int_1.l_doubtiver_int;
  outC->_L8 = outC->_L1.q_dlrbg;
  /* _L75=(TM_conversions::CAST_Q_DRLRBG_to_int#1)/ */
  CAST_Q_DRLRBG_to_int_TM_conversions(
    outC->_L8,
    &outC->Context_CAST_Q_DRLRBG_to_int_1);
  outC->_L75 = outC->Context_CAST_Q_DRLRBG_to_int_1.q_drlrbg_int;
...
void C_P001_train_compr_init_TM_TrainToTrack(
  outC_C_P001_train_compr_TM_TrainToTrack *outC)
{
  static kcg_size idx;
  ...
  for (idx1 = 0; idx1 < 17; idx1++) {
    outC->P001_int[idx1] = kcg_lit_int64(0);
  }
  /* _L70=(TM_conversions::CAST_L_PACKET_to_int#1)/ */
