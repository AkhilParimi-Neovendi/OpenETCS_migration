...
void Send_M032_JRU_MessageLibBaseline2(
  /* M032/ */
  M_032_int_T_TM_radio_messages *M032,
  outC_Send_M032_JRU_MessageLibBaseline2 *outC)
{
  kcg_copy_M_032_int_T_TM_radio_messages(&outC->_L1, M032);
  /* _L2=(TM_RBC_conversions::C_M032_int_to_header#1)/ */
  C_M032_int_to_header_TM_RBC_conversions(
    &outC->_L1,
    &outC->Context_C_M032_int_to_header_1);
  kcg_copy_M_TrackTrain_Radio_T_TM_radio_messages(
    &outC->_L2,
    &outC->Context_C_M032_int_to_header_1.Message_Header_Out);
  kcg_copy_M_TrackTrain_Radio_T_TM_radio_messages(&outC->Message_Out, &outC->_L2);
}

#ifndef KCG_USER_DEFINED_INIT
void Send_M032_JRU_init_MessageLibBaseline2(
  outC_Send_M032_JRU_MessageLibBaseline2 *outC)
{
  ...
  /* _L2=(TM_RBC_conversions::C_M032_int_to_header#1)/ */
  C_M032_int_to_header_init_TM_RBC_conversions(
    &outC->Context_C_M032_int_to_header_1);
}
...
{
  /* _L2=(TM_RBC_conversions::C_M032_int_to_header#1)/ */
  C_M032_int_to_header_reset_TM_RBC_conversions(
    &outC->Context_C_M032_int_to_header_1);
}
