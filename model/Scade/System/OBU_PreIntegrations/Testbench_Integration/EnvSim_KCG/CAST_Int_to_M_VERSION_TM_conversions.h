...
typedef struct {
  ...
  M_VERSION /* IfBlock1:then:_L4/ */ _L4_then_IfBlock1;
  kcg_bool /* IfBlock1:else:else:then:_L4/ */ _L4_then_else_else_IfBlock1;
  M_VERSION /* IfBlock1:else:else:then:_L2/ */ _L2_then_else_else_IfBlock1;
  M_VERSION /* IfBlock1:else:else:else:else:_L2/ */ _L2_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:_L1/ */ _L1_else_else_else_else_IfBlock1;
  M_VERSION /* IfBlock1:else:else:else:then:_L2/ */ _L2_then_else_else_else_IfBlock1;
