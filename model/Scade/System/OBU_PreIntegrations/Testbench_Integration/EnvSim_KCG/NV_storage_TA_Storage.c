...
void NV_storage_init_TA_Storage(outC_NV_storage_TA_Storage *outC)
{
  ...
  for (idx = 0; idx < 32; idx++) {
    ...
    outC->_L1.SECTIONS[idx].nid_c = kcg_lit_int32(0);
  }
  ...
  outC->_L1.v_nvsopovtrp = kcg_lit_int32(0);
  ...
  outC->Packet3_out.d_validnv = kcg_lit_int32(0);
  outC->Packet3_out.n_iter = kcg_lit_int32(0);
  for (idx1 = 0; idx1 < 32; idx1++) {
    outC->Packet3_out.SECTIONS[idx1].valid = kcg_true;
    outC->Packet3_out.SECTIONS[idx1].nid_c = kcg_lit_int32(0);
  }
  outC->Packet3_out.v_nvshunt = kcg_lit_int32(0);
  outC->Packet3_out.v_nvstff = kcg_lit_int32(0);
  outC->Packet3_out.v_nvonsight = kcg_lit_int32(0);
  outC->Packet3_out.v_nvunfit = kcg_lit_int32(0);
  outC->Packet3_out.v_nvrel = kcg_lit_int32(0);
  outC->Packet3_out.d_nvroll = kcg_lit_int32(0);
  ...
  outC->Packet3_out.v_nvallowovtrp = kcg_lit_int32(0);
  outC->Packet3_out.v_nvsopovtrp = kcg_lit_int32(0);
  outC->Packet3_out.d_nvovtrp = kcg_lit_int32(0);
  outC->Packet3_out.t_nvovtrp = kcg_lit_int32(0);
  outC->Packet3_out.d_nvpotrp = kcg_lit_int32(0);
  outC->Packet3_out.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->Packet3_out.t_nvcontact = kcg_lit_int32(0);
  outC->Packet3_out.m_nvderun = M_NVDERUN_No;
  outC->Packet3_out.d_nvstff = kcg_lit_int32(0);
