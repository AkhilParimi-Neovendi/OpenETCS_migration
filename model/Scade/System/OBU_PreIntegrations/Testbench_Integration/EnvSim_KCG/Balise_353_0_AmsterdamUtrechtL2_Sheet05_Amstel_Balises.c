...
void Balise_353_0_AmsterdamUtrechtL2_Sheet05_Amstel_Balises(
  ...
  /* PIG_nom/ */
  kcg_int32 PIG_nom,
  outC_Balise_353_0_AmsterdamUtrechtL2_Sheet05_Amstel_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet05_Amstel_Balises::Packets_BG353#1)/ */
    Packets_BG353_AmsterdamUtrechtL2_Sheet05_Amstel_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG353_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG353_1.Balise_data_out);
...
void Balise_353_0_init_AmsterdamUtrechtL2_Sheet05_Amstel_Balises(
  outC_Balise_353_0_AmsterdamUtrechtL2_Sheet05_Amstel_Balises *outC)
{
  static kcg_size idx;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet05_Amstel_Balises::Packets_BG353#1)/ */
  Packets_BG353_init_AmsterdamUtrechtL2_Sheet05_Amstel_Balises(
    &outC->Context_Packets_BG353_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_353_0_reset_AmsterdamUtrechtL2_Sheet05_Amstel_Balises(
  outC_Balise_353_0_AmsterdamUtrechtL2_Sheet05_Amstel_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet05_Amstel_Balises::Packets_BG353#1)/ */
  Packets_BG353_reset_AmsterdamUtrechtL2_Sheet05_Amstel_Balises(
    &outC->Context_Packets_BG353_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
