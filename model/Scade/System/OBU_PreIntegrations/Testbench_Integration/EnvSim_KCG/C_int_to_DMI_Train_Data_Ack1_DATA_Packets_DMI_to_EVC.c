...
void C_int_to_DMI_Train_Data_Ack1_init_DATA_Packets_DMI_to_EVC(
  outC_C_int_to_DMI_Train_Data_Ack1_DATA_Packets_DMI_to_EVC *outC)
{
  static kcg_size idx;
  ...
  outC->dmi_train_data_ack_ct.systemTime = kcg_lit_int64(0);
...
void C_int_to_DMI_Train_Data_Ack1_reset_DATA_Packets_DMI_to_EVC(
  outC_C_int_to_DMI_Train_Data_Ack1_DATA_Packets_DMI_to_EVC *outC)
{
  /* _L9=(Utilities::Int_to_Bool#1)/ */
