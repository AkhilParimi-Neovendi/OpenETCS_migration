  ...
  outC_SpeedSupervision_Integration_SpeedSupervision_Integration_Pkg *outC)
{
  ...
  outC->_L226 = kcg_true;
  outC->_L94 = kcg_lit_int64(800);
  outC->_L275 = kcg_lit_int64(1200);
  ...
  outC_SpeedSupervision_Integration_SpeedSupervision_Integration_Pkg *outC)
{
  ...
  outC->_L277.targetSpeed = kcg_lit_int64(0);
  outC->_L277.permittedSpeed = kcg_lit_int64(0);
  outC->_L277.releaseSpeed = kcg_lit_int64(0);
  outC->_L277.locationBrakeTarget = kcg_lit_int64(0);
  outC->_L277.location_brake_curve_starting_point = kcg_lit_int64(0);
  outC->_L277.interventionSpeed = kcg_lit_int64(0);
  outC->_L277.sup_status = CSM_DMI_Types_Pkg;
  outC->_L277.supervisionDisplay = supDis_normal_DMI_Types_Pkg;
  outC->_L277.distanceIndicationPoint = kcg_lit_int64(0);
  ...
  outC->_L276.MA.v_main = kcg_lit_int64(0);
  outC->_L276.MA.v_loa = kcg_lit_int64(0);
  outC->_L276.MA.t_loa_unlimited = kcg_true;
  outC->_L276.MA.t_loa = kcg_lit_int64(0);
  outC->_L276.MA.n_iter = kcg_lit_int64(0);
  for (idx = 0; idx < 10; idx++) {
    outC->_L276.MA.sections[idx].valid = kcg_true;
    outC->_L276.MA.sections[idx].q_endsection = kcg_true;
    outC->_L276.MA.sections[idx].l_section = kcg_lit_int64(0);
    outC->_L276.MA.sections[idx].q_sectiontimer = kcg_true;
    outC->_L276.MA.sections[idx].t_sectiontimer = kcg_lit_int64(0);
    outC->_L276.MA.sections[idx].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->_L276.MA.q_dangerpoint = kcg_true;
  outC->_L276.MA.dangerpoint.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L276.MA.dangerpoint.v_release = kcg_lit_int64(0);
  outC->_L276.MA.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->_L276.MA.q_overlap = kcg_true;
  outC->_L276.MA.overlap.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L276.MA.overlap.v_release = kcg_lit_int64(0);
  outC->_L276.MA.overlap.calc_v_release_onboard = kcg_true;
  outC->_L276.MA.q_endtimer = kcg_true;
  outC->_L276.MA.endtimer_t.t_endtimer = kcg_lit_int64(0);
  outC->_L276.MA.endtimer_t.d_endtimerstoploc = kcg_lit_int64(0);
  outC->_L276.freshGradientProfile = kcg_true;
  for (idx1 = 0; idx1 < 50; idx1++) {
    outC->_L276.GradientProfile[idx1].valid = kcg_true;
    outC->_L276.GradientProfile[idx1].Loc_Absolute = kcg_lit_int64(0);
    outC->_L276.GradientProfile[idx1].Loc_LRBG = kcg_lit_int64(0);
    outC->_L276.GradientProfile[idx1].Gradient = kcg_lit_int64(0);
    outC->_L276.GradientProfile[idx1].L_Gradient = kcg_lit_int64(0);
  }
  outC->_L276.freshMRSP = kcg_true;
  for (idx2 = 0; idx2 < 110; idx2++) {
    outC->_L276.MRSP[idx2].valid = kcg_true;
    outC->_L276.MRSP[idx2].Loc_Abs = kcg_lit_int64(0);
    outC->_L276.MRSP[idx2].Loc_LRBG = kcg_lit_int64(0);
    outC->_L276.MRSP[idx2].MRS = kcg_lit_int64(0);
  }
  outC->_L275 = kcg_lit_int64(0);
  for (idx7 = 0; idx7 < 110; idx7++) {
    for (idx3 = 0; idx3 < 114; idx3++) {
      outC->_L254.MRSP_EBD_curves[idx7].distances[idx3] = kcg_lit_float64(0.0);
    }
    for (idx4 = 0; idx4 < 114; idx4++) {
      outC->_L254.MRSP_EBD_curves[idx7].speeds[idx4] = kcg_lit_float64(0.0);
    }
    for (idx5 = 0; idx5 < 114; idx5++) {
      outC->_L254.MRSP_EBD_curves[idx7].accelerations[idx5] = kcg_lit_float64(0.0);
    }
  ...
  for (idx8 = 0; idx8 < 114; idx8++) {
    outC->_L254.EOA_SBD_curve.distances[idx8] = kcg_lit_float64(0.0);
  }
  for (idx9 = 0; idx9 < 114; idx9++) {
    outC->_L254.EOA_SBD_curve.speeds[idx9] = kcg_lit_float64(0.0);
  }
  for (idx10 = 0; idx10 < 114; idx10++) {
    outC->_L254.EOA_SBD_curve.accelerations[idx10] = kcg_lit_float64(0.0);
  }
  for (idx11 = 0; idx11 < 114; idx11++) {
    outC->_L254.EOA_SBD_curve.valid[idx11] = kcg_true;
  }
  for (idx12 = 0; idx12 < 114; idx12++) {
    outC->_L254.SvL_LoA_EBD_curve.distances[idx12] = kcg_lit_float64(0.0);
  }
  for (idx13 = 0; idx13 < 114; idx13++) {
    outC->_L254.SvL_LoA_EBD_curve.speeds[idx13] = kcg_lit_float64(0.0);
  }
  for (idx14 = 0; idx14 < 114; idx14++) {
    outC->_L254.SvL_LoA_EBD_curve.accelerations[idx14] = kcg_lit_float64(0.0);
  }
  for (idx15 = 0; idx15 < 114; idx15++) {
    outC->_L254.SvL_LoA_EBD_curve.valid[idx15] = kcg_true;
  }
  for (idx16 = 0; idx16 < 114; idx16++) {
    outC->_L254.GUI_curve.distances[idx16] = kcg_lit_float64(0.0);
  }
  for (idx17 = 0; idx17 < 114; idx17++) {
    outC->_L254.GUI_curve.speeds[idx17] = kcg_lit_float64(0.0);
  }
  for (idx18 = 0; idx18 < 114; idx18++) {
    outC->_L254.GUI_curve.accelerations[idx18] = kcg_lit_float64(0.0);
  }
  ...
  for (idx20 = 0; idx20 < 110; idx20++) {
    ...
    outC->_L255.MRSP_targetList[idx20].distance = kcg_lit_float64(0.0);
    outC->_L255.MRSP_targetList[idx20].speed = kcg_lit_float64(0.0);
  }
  outC->_L255.EOA_target.targetType = EoA_TargetManagement_types;
  outC->_L255.EOA_target.distance = kcg_lit_float64(0.0);
  outC->_L255.EOA_target.speed = kcg_lit_float64(0.0);
  outC->_L255.SvL_LoA_target.targetType = EoA_TargetManagement_types;
  outC->_L255.SvL_LoA_target.distance = kcg_lit_float64(0.0);
  outC->_L255.SvL_LoA_target.speed = kcg_lit_float64(0.0);
  outC->_L256.targetType = EoA_TargetManagement_types;
  outC->_L256.distance = kcg_lit_int64(0);
  outC->_L256.speed = kcg_lit_int64(0);
  outC->_L256.valid = kcg_true;
  outC->_L250.targetType = EoA_TargetManagement_types;
  outC->_L250.distance = kcg_lit_int64(0);
  outC->_L250.speed = kcg_lit_int64(0);
  ...
  outC->_L246.MA.v_main = kcg_lit_int64(0);
  outC->_L246.MA.v_loa = kcg_lit_int64(0);
  outC->_L246.MA.t_loa_unlimited = kcg_true;
  outC->_L246.MA.t_loa = kcg_lit_int64(0);
  outC->_L246.MA.n_iter = kcg_lit_int64(0);
  for (idx21 = 0; idx21 < 10; idx21++) {
    outC->_L246.MA.sections[idx21].valid = kcg_true;
    outC->_L246.MA.sections[idx21].q_endsection = kcg_true;
    outC->_L246.MA.sections[idx21].l_section = kcg_lit_int64(0);
    outC->_L246.MA.sections[idx21].q_sectiontimer = kcg_true;
    outC->_L246.MA.sections[idx21].t_sectiontimer = kcg_lit_int64(0);
    outC->_L246.MA.sections[idx21].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->_L246.MA.q_dangerpoint = kcg_true;
  outC->_L246.MA.dangerpoint.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L246.MA.dangerpoint.v_release = kcg_lit_int64(0);
  outC->_L246.MA.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->_L246.MA.q_overlap = kcg_true;
  outC->_L246.MA.overlap.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L246.MA.overlap.v_release = kcg_lit_int64(0);
  outC->_L246.MA.overlap.calc_v_release_onboard = kcg_true;
  outC->_L246.MA.q_endtimer = kcg_true;
  outC->_L246.MA.endtimer_t.t_endtimer = kcg_lit_int64(0);
  outC->_L246.MA.endtimer_t.d_endtimerstoploc = kcg_lit_int64(0);
  outC->_L246.freshGradientProfile = kcg_true;
  for (idx22 = 0; idx22 < 50; idx22++) {
    outC->_L246.GradientProfile[idx22].valid = kcg_true;
    outC->_L246.GradientProfile[idx22].Loc_Absolute = kcg_lit_int64(0);
    outC->_L246.GradientProfile[idx22].Loc_LRBG = kcg_lit_int64(0);
    outC->_L246.GradientProfile[idx22].Gradient = kcg_lit_int64(0);
    outC->_L246.GradientProfile[idx22].L_Gradient = kcg_lit_int64(0);
  }
  outC->_L246.freshMRSP = kcg_true;
  for (idx23 = 0; idx23 < 110; idx23++) {
    outC->_L246.MRSP[idx23].valid = kcg_true;
    outC->_L246.MRSP[idx23].Loc_Abs = kcg_lit_int64(0);
    outC->_L246.MRSP[idx23].Loc_LRBG = kcg_lit_int64(0);
    outC->_L246.MRSP[idx23].MRS = kcg_lit_int64(0);
  }
  ...
  outC->_L244.trainLength = kcg_lit_int64(0);
  outC->_L244.brakePerctage = kcg_lit_int64(0);
  outC->_L244.maxTrainSpeed = kcg_lit_int64(0);
  ...
  outC->_L244.axleNumber = kcg_lit_int64(0);
  outC->_L244.numberNationalSystems = kcg_lit_int64(0);
  for (idx24 = 0; idx24 < 5; idx24++) {
    outC->_L244.nationSystems[idx24] = kcg_lit_int64(0);
  }
  outC->_L244.numberTractionSystems = kcg_lit_int64(0);
  for (idx25 = 0; idx25 < 4; idx25++) {
    outC->_L244.tractionSystem[idx25].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L244.tractionSystem[idx25].nid_ctraction = kcg_lit_int64(0);
  }
  outC->_L243.valid = kcg_true;
  outC->_L243.timestamp = kcg_lit_int64(0);
  outC->_L243.trainPositionIsUnknown = kcg_true;
  outC->_L243.noCoordinateSystemHasBeenAssigned = kcg_true;
  outC->_L243.trainPosition.nominal = kcg_lit_int64(0);
  outC->_L243.trainPosition.d_min = kcg_lit_int64(0);
  outC->_L243.trainPosition.d_max = kcg_lit_int64(0);
  outC->_L243.estimatedFrontEndPosition = kcg_lit_int64(0);
  outC->_L243.minSafeFrontEndPosition = kcg_lit_int64(0);
  outC->_L243.maxSafeFrontEndPostion = kcg_lit_int64(0);
  outC->_L243.LRBG.valid = kcg_true;
  outC->_L243.LRBG.nid_c = kcg_lit_int64(0);
  outC->_L243.LRBG.nid_bg = kcg_lit_int64(0);
  outC->_L243.LRBG.q_link = Q_LINK_Unlinked;
  outC->_L243.LRBG.location.nominal = kcg_lit_int64(0);
  outC->_L243.LRBG.location.d_min = kcg_lit_int64(0);
  outC->_L243.LRBG.location.d_max = kcg_lit_int64(0);
  outC->_L243.LRBG.seqNoOnTrack = kcg_lit_int64(0);
  outC->_L243.LRBG.infoFromLinking.valid = kcg_true;
  outC->_L243.LRBG.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L243.LRBG.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->_L243.LRBG.infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
  outC->_L243.LRBG.infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
  outC->_L243.LRBG.infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
  outC->_L243.LRBG.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L243.LRBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L243.LRBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->_L243.LRBG.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->_L243.LRBG.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  ...
  outC->_L243.LRBG.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L243.LRBG.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L243.LRBG.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L243.LRBG.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L243.LRBG.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->_L243.LRBG.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L243.LRBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L243.LRBG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L243.LRBG.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L243.LRBG.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx26 = 0; idx26 < 33; idx26++) {
    ...
    outC->_L243.LRBG.infoFromPassing.linkedBGs[idx26].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L243.LRBG.infoFromPassing.linkedBGs[idx26].d_link = kcg_lit_int64(0);
    outC->_L243.LRBG.infoFromPassing.linkedBGs[idx26].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L243.LRBG.infoFromPassing.linkedBGs[idx26].nid_c = kcg_lit_int64(0);
    outC->_L243.LRBG.infoFromPassing.linkedBGs[idx26].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L243.LRBG.infoFromPassing.linkedBGs[idx26].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L243.LRBG.infoFromPassing.linkedBGs[idx26].q_locacc = kcg_lit_int64(0);
  }
  outC->_L243.LRBG.missed = kcg_true;
  outC->_L243.prvLRBG.valid = kcg_true;
  outC->_L243.prvLRBG.nid_c = kcg_lit_int64(0);
  outC->_L243.prvLRBG.nid_bg = kcg_lit_int64(0);
  outC->_L243.prvLRBG.q_link = Q_LINK_Unlinked;
  outC->_L243.prvLRBG.location.nominal = kcg_lit_int64(0);
  outC->_L243.prvLRBG.location.d_min = kcg_lit_int64(0);
  outC->_L243.prvLRBG.location.d_max = kcg_lit_int64(0);
  outC->_L243.prvLRBG.seqNoOnTrack = kcg_lit_int64(0);
  outC->_L243.prvLRBG.infoFromLinking.valid = kcg_true;
  outC->_L243.prvLRBG.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L243.prvLRBG.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->_L243.prvLRBG.infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
  outC->_L243.prvLRBG.infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
  outC->_L243.prvLRBG.infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
  outC->_L243.prvLRBG.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L243.prvLRBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L243.prvLRBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->_L243.prvLRBG.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->_L243.prvLRBG.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  ...
  outC->_L243.prvLRBG.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L243.prvLRBG.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L243.prvLRBG.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L243.prvLRBG.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L243.prvLRBG.infoFromLinking.linkingInfo.q_linkreaction =
    Q_LINKREACTION_Train_trip;
  outC->_L243.prvLRBG.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->_L243.prvLRBG.infoFromPassing.BG_Header.n_total =
    N_TOTAL_1_balise_in_the_group;
  outC->_L243.prvLRBG.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L243.prvLRBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L243.prvLRBG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L243.prvLRBG.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L243.prvLRBG.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx27 = 0; idx27 < 33; idx27++) {
    ...
    outC->_L243.prvLRBG.infoFromPassing.linkedBGs[idx27].q_scale =
      Q_SCALE_10_cm_scale;
    outC->_L243.prvLRBG.infoFromPassing.linkedBGs[idx27].d_link = kcg_lit_int64(0);
    outC->_L243.prvLRBG.infoFromPassing.linkedBGs[idx27].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L243.prvLRBG.infoFromPassing.linkedBGs[idx27].nid_c = kcg_lit_int64(0);
    outC->_L243.prvLRBG.infoFromPassing.linkedBGs[idx27].nid_bg = kcg_lit_int64(0);
  ...
  outC->_L243.estimatedRearEndPosition = kcg_lit_int64(0);
  outC->_L243.minSafeRearEndPosition = kcg_lit_int64(0);
  outC->_L243.maxSafeRearEndPosition = kcg_lit_int64(0);
  outC->_L242.valid = kcg_true;
  outC->_L242.timestamp = kcg_lit_int64(0);
  outC->_L242.odo.o_nominal = kcg_lit_int64(0);
  outC->_L242.odo.o_min = kcg_lit_int64(0);
  outC->_L242.odo.o_max = kcg_lit_int64(0);
  outC->_L242.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L242.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L242.speed.v_lower = kcg_lit_int64(0);
  outC->_L242.speed.v_upper = kcg_lit_int64(0);
  outC->_L242.acceleration = kcg_lit_int64(0);
  ...
  outC->_L241.d_validnv = kcg_lit_int64(0);
  for (idx28 = 0; idx28 < 7; idx28++) {
    outC->_L241.nid_cArray[idx28].valid = kcg_true;
    outC->_L241.nid_cArray[idx28].nid_c = kcg_lit_int64(0);
  }
  outC->_L241.v_nvshunt = kcg_lit_int64(0);
  outC->_L241.v_nvstff = kcg_lit_int64(0);
  outC->_L241.v_nvonsight = kcg_lit_int64(0);
  outC->_L241.v_nvlimsuperv = kcg_lit_int64(0);
  outC->_L241.v_nvunfit = kcg_lit_int64(0);
  outC->_L241.v_nvrel = kcg_lit_int64(0);
  outC->_L241.d_nvroll = kcg_lit_int64(0);
  ...
  outC->_L241.v_nvallowovtrp = kcg_lit_int64(0);
  outC->_L241.v_nvsupovtrp = kcg_lit_int64(0);
  outC->_L241.d_nvovtrp = kcg_lit_int64(0);
  outC->_L241.t_nvovtrp = kcg_lit_int64(0);
  outC->_L241.d_nvpotrp = kcg_lit_int64(0);
  outC->_L241.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->_L241.t_nvcontact = kcg_lit_int64(0);
  outC->_L241.m_nvderun = M_NVDERUN_No;
  outC->_L241.d_nvstff = kcg_lit_int64(0);
  outC->_L241.q_nvdriver_adhes = Q_NVDRIVER_ADHES_Not_allowed;
  outC->_L241.a_nvmaxredadh1 = kcg_lit_float64(0.0);
  outC->_L241.a_nvmaxredadh2 = kcg_lit_float64(0.0);
  outC->_L241.a_nvmaxredadh3 = kcg_lit_float64(0.0);
  outC->_L241.q_nvlocacc = kcg_lit_int64(0);
  outC->_L241.m_nvavadh = kcg_lit_float64(0.0);
  ...
  for (idx30 = 0; idx30 < 7; idx30++) {
    ...
    outC->_L241.nvkvintsetArray[idx30].a_nvp12 = kcg_lit_float64(0.0);
    outC->_L241.nvkvintsetArray[idx30].a_nvp23 = kcg_lit_float64(0.0);
  ...
  for (idx31 = 0; idx31 < 7; idx31++) {
    ...
    outC->_L241.nvkrintArray[idx31].m_nvkrint = kcg_lit_float64(0.0);
  }
  outC->_L241.m_nvktint = kcg_lit_float64(0.0);
  outC->_L240 = kcg_true;
  outC->_L239.valid = kcg_true;
  outC->_L239.timestamp = kcg_lit_int64(0);
  outC->_L239.trainPositionIsUnknown = kcg_true;
  outC->_L239.noCoordinateSystemHasBeenAssigned = kcg_true;
  outC->_L239.trainPosition.nominal = kcg_lit_int64(0);
  outC->_L239.trainPosition.d_min = kcg_lit_int64(0);
  outC->_L239.trainPosition.d_max = kcg_lit_int64(0);
  outC->_L239.estimatedFrontEndPosition = kcg_lit_int64(0);
  outC->_L239.minSafeFrontEndPosition = kcg_lit_int64(0);
  outC->_L239.maxSafeFrontEndPostion = kcg_lit_int64(0);
  outC->_L239.LRBG.valid = kcg_true;
  outC->_L239.LRBG.nid_c = kcg_lit_int64(0);
  outC->_L239.LRBG.nid_bg = kcg_lit_int64(0);
  outC->_L239.LRBG.q_link = Q_LINK_Unlinked;
  outC->_L239.LRBG.location.nominal = kcg_lit_int64(0);
  outC->_L239.LRBG.location.d_min = kcg_lit_int64(0);
  outC->_L239.LRBG.location.d_max = kcg_lit_int64(0);
  outC->_L239.LRBG.seqNoOnTrack = kcg_lit_int64(0);
  outC->_L239.LRBG.infoFromLinking.valid = kcg_true;
  outC->_L239.LRBG.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L239.LRBG.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->_L239.LRBG.infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
  outC->_L239.LRBG.infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
  outC->_L239.LRBG.infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
  outC->_L239.LRBG.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L239.LRBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L239.LRBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->_L239.LRBG.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->_L239.LRBG.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  ...
  outC->_L239.LRBG.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L239.LRBG.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L239.LRBG.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L239.LRBG.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  outC->_L239.LRBG.infoFromLinking.linkingInfo.q_linkorientation =
    Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
  outC->_L239.LRBG.infoFromLinking.linkingInfo.q_linkreaction =
    Q_LINKREACTION_Train_trip;
  outC->_L239.LRBG.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->_L239.LRBG.infoFromPassing.BG_Header.n_total =
    N_TOTAL_1_balise_in_the_group;
  outC->_L239.LRBG.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L239.LRBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L239.LRBG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L239.LRBG.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L239.LRBG.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx32 = 0; idx32 < 33; idx32++) {
    ...
    outC->_L239.LRBG.infoFromPassing.linkedBGs[idx32].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L239.LRBG.infoFromPassing.linkedBGs[idx32].d_link = kcg_lit_int64(0);
    outC->_L239.LRBG.infoFromPassing.linkedBGs[idx32].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L239.LRBG.infoFromPassing.linkedBGs[idx32].nid_c = kcg_lit_int64(0);
    outC->_L239.LRBG.infoFromPassing.linkedBGs[idx32].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L239.LRBG.infoFromPassing.linkedBGs[idx32].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L239.LRBG.infoFromPassing.linkedBGs[idx32].q_locacc = kcg_lit_int64(0);
  }
  outC->_L239.LRBG.missed = kcg_true;
  outC->_L239.prvLRBG.valid = kcg_true;
  outC->_L239.prvLRBG.nid_c = kcg_lit_int64(0);
  outC->_L239.prvLRBG.nid_bg = kcg_lit_int64(0);
  outC->_L239.prvLRBG.q_link = Q_LINK_Unlinked;
  outC->_L239.prvLRBG.location.nominal = kcg_lit_int64(0);
  outC->_L239.prvLRBG.location.d_min = kcg_lit_int64(0);
  outC->_L239.prvLRBG.location.d_max = kcg_lit_int64(0);
  outC->_L239.prvLRBG.seqNoOnTrack = kcg_lit_int64(0);
  outC->_L239.prvLRBG.infoFromLinking.valid = kcg_true;
  outC->_L239.prvLRBG.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L239.prvLRBG.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->_L239.prvLRBG.infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
  outC->_L239.prvLRBG.infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
  outC->_L239.prvLRBG.infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
  outC->_L239.prvLRBG.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L239.prvLRBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L239.prvLRBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->_L239.prvLRBG.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->_L239.prvLRBG.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  ...
  outC->_L239.prvLRBG.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L239.prvLRBG.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L239.prvLRBG.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L239.prvLRBG.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L239.prvLRBG.infoFromLinking.linkingInfo.q_linkreaction =
    Q_LINKREACTION_Train_trip;
  outC->_L239.prvLRBG.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->_L239.prvLRBG.infoFromPassing.BG_Header.n_total =
    N_TOTAL_1_balise_in_the_group;
  outC->_L239.prvLRBG.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L239.prvLRBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L239.prvLRBG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L239.prvLRBG.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L239.prvLRBG.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx33 = 0; idx33 < 33; idx33++) {
    ...
    outC->_L239.prvLRBG.infoFromPassing.linkedBGs[idx33].q_scale =
      Q_SCALE_10_cm_scale;
    outC->_L239.prvLRBG.infoFromPassing.linkedBGs[idx33].d_link = kcg_lit_int64(0);
    outC->_L239.prvLRBG.infoFromPassing.linkedBGs[idx33].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L239.prvLRBG.infoFromPassing.linkedBGs[idx33].nid_c = kcg_lit_int64(0);
    outC->_L239.prvLRBG.infoFromPassing.linkedBGs[idx33].nid_bg = kcg_lit_int64(0);
  ...
  outC->_L239.estimatedRearEndPosition = kcg_lit_int64(0);
  outC->_L239.minSafeRearEndPosition = kcg_lit_int64(0);
  outC->_L239.maxSafeRearEndPosition = kcg_lit_int64(0);
  outC->_L233 = kcg_lit_int64(0);
  outC->_L232 = kcg_true;
  outC->_L230 = kcg_true;
  outC->_L229 = kcg_true;
  outC->_L228.valid = kcg_true;
  outC->_L228.q_dir = Q_DIR_Reverse;
  outC->_L228.d_validnv = kcg_lit_int64(0);
  for (idx34 = 0; idx34 < 7; idx34++) {
    outC->_L228.nid_cArray[idx34].valid = kcg_true;
    outC->_L228.nid_cArray[idx34].nid_c = kcg_lit_int64(0);
  }
  outC->_L228.v_nvshunt = kcg_lit_int64(0);
  outC->_L228.v_nvstff = kcg_lit_int64(0);
  outC->_L228.v_nvonsight = kcg_lit_int64(0);
  outC->_L228.v_nvlimsuperv = kcg_lit_int64(0);
  outC->_L228.v_nvunfit = kcg_lit_int64(0);
  outC->_L228.v_nvrel = kcg_lit_int64(0);
  outC->_L228.d_nvroll = kcg_lit_int64(0);
  ...
  outC->_L228.v_nvallowovtrp = kcg_lit_int64(0);
  outC->_L228.v_nvsupovtrp = kcg_lit_int64(0);
  outC->_L228.d_nvovtrp = kcg_lit_int64(0);
  outC->_L228.t_nvovtrp = kcg_lit_int64(0);
  outC->_L228.d_nvpotrp = kcg_lit_int64(0);
  outC->_L228.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->_L228.t_nvcontact = kcg_lit_int64(0);
  outC->_L228.m_nvderun = M_NVDERUN_No;
  outC->_L228.d_nvstff = kcg_lit_int64(0);
  outC->_L228.q_nvdriver_adhes = Q_NVDRIVER_ADHES_Not_allowed;
  outC->_L228.a_nvmaxredadh1 = kcg_lit_float64(0.0);
  outC->_L228.a_nvmaxredadh2 = kcg_lit_float64(0.0);
  outC->_L228.a_nvmaxredadh3 = kcg_lit_float64(0.0);
  outC->_L228.q_nvlocacc = kcg_lit_int64(0);
  outC->_L228.m_nvavadh = kcg_lit_float64(0.0);
  ...
  for (idx36 = 0; idx36 < 7; idx36++) {
    ...
    outC->_L228.nvkvintsetArray[idx36].a_nvp12 = kcg_lit_float64(0.0);
    outC->_L228.nvkvintsetArray[idx36].a_nvp23 = kcg_lit_float64(0.0);
  ...
  for (idx37 = 0; idx37 < 7; idx37++) {
    ...
    outC->_L228.nvkrintArray[idx37].m_nvkrint = kcg_lit_float64(0.0);
  }
  outC->_L228.m_nvktint = kcg_lit_float64(0.0);
  outC->_L227 = Q_NVSBFBPERM_No;
  outC->_L226 = kcg_true;
  for (idx38 = 0; idx38 < 2; idx38++) {
    outC->_L225.emergency[idx38] = kcg_lit_float64(0.0);
  }
  for (idx39 = 0; idx39 < 2; idx39++) {
    outC->_L225.service[idx39] = kcg_lit_float64(0.0);
  }
  outC->_L223.isSB_FBAvailable = kcg_true;
  outC->_L223.isSB_CmdAvailable = kcg_true;
  outC->_L223.isTCOAvailable = kcg_true;
  outC->_L223.T_traction_cut_off = kcg_lit_int64(0);
  outC->_L223.offsetAntennaL1 = kcg_lit_int64(0);
  outC->_L223.T_b_limit = kcg_lit_int64(0);
  outC->_L222.isSB_FBAvailable = kcg_true;
  outC->_L222.isSB_CmdAvailable = kcg_true;
  outC->_L222.isTCOAvailable = kcg_true;
  outC->_L222.T_traction_cut_off = kcg_lit_int64(0);
  outC->_L222.offsetAntennaL1 = kcg_lit_int64(0);
  outC->_L222.T_b_limit = kcg_lit_int64(0);
  outC->_L216.valid = kcg_true;
  outC->_L216.v_main = kcg_lit_float64(0.0);
  outC->_L216.EOA.Location = kcg_lit_float64(0.0);
  outC->_L216.EOA.TargetSpeed = kcg_lit_float64(0.0);
  outC->_L216.DP_valid = kcg_true;
  outC->_L216.DangerPoint = kcg_lit_float64(0.0);
  outC->_L216.OL_valid = kcg_true;
  outC->_L216.Overlap = kcg_lit_float64(0.0);
  outC->_L216.q_calculate_release = kcg_true;
  outC->_L216.ReleaseSpeed = kcg_lit_float64(0.0);
  outC->_L216.level = MA_L1_TrackAtlasTypes;
  outC->_L215.valid = kcg_true;
  outC->_L215.q_dir = Q_DIR_Reverse;
  outC->_L215.d_validnv = kcg_lit_int64(0);
  for (idx40 = 0; idx40 < 7; idx40++) {
    outC->_L215.nid_cArray[idx40].valid = kcg_true;
    outC->_L215.nid_cArray[idx40].nid_c = kcg_lit_int64(0);
  }
  outC->_L215.v_nvshunt = kcg_lit_int64(0);
  outC->_L215.v_nvstff = kcg_lit_int64(0);
  outC->_L215.v_nvonsight = kcg_lit_int64(0);
  outC->_L215.v_nvlimsuperv = kcg_lit_int64(0);
  outC->_L215.v_nvunfit = kcg_lit_int64(0);
  outC->_L215.v_nvrel = kcg_lit_int64(0);
  outC->_L215.d_nvroll = kcg_lit_int64(0);
  ...
  outC->_L215.v_nvallowovtrp = kcg_lit_int64(0);
  outC->_L215.v_nvsupovtrp = kcg_lit_int64(0);
  outC->_L215.d_nvovtrp = kcg_lit_int64(0);
  outC->_L215.t_nvovtrp = kcg_lit_int64(0);
  outC->_L215.d_nvpotrp = kcg_lit_int64(0);
  outC->_L215.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->_L215.t_nvcontact = kcg_lit_int64(0);
  outC->_L215.m_nvderun = M_NVDERUN_No;
  outC->_L215.d_nvstff = kcg_lit_int64(0);
  outC->_L215.q_nvdriver_adhes = Q_NVDRIVER_ADHES_Not_allowed;
  outC->_L215.a_nvmaxredadh1 = kcg_lit_float64(0.0);
  outC->_L215.a_nvmaxredadh2 = kcg_lit_float64(0.0);
  outC->_L215.a_nvmaxredadh3 = kcg_lit_float64(0.0);
  outC->_L215.q_nvlocacc = kcg_lit_int64(0);
  outC->_L215.m_nvavadh = kcg_lit_float64(0.0);
  ...
  for (idx42 = 0; idx42 < 7; idx42++) {
    ...
    outC->_L215.nvkvintsetArray[idx42].a_nvp12 = kcg_lit_float64(0.0);
    outC->_L215.nvkvintsetArray[idx42].a_nvp23 = kcg_lit_float64(0.0);
  ...
  for (idx43 = 0; idx43 < 7; idx43++) {
    ...
    outC->_L215.nvkrintArray[idx43].m_nvkrint = kcg_lit_float64(0.0);
  }
  outC->_L215.m_nvktint = kcg_lit_float64(0.0);
  ...
  for (idx44 = 0; idx44 < 100; idx44++) {
    outC->_L208.distance_definition[idx44] = kcg_lit_float64(0.0);
  }
  for (idx45 = 0; idx45 < 14; idx45++) {
    outC->_L208.speed_definition[idx45] = kcg_lit_float64(0.0);
  }
  for (idx47 = 0; idx47 < 14; idx47++) {
    for (idx46 = 0; idx46 < 100; idx46++) {
      outC->_L208.data[idx47][idx46] = kcg_lit_float64(0.0);
    }
  }
  for (idx48 = 0; idx48 < 100; idx48++) {
    outC->_L206.distance_definition[idx48] = kcg_lit_float64(0.0);
  }
  for (idx49 = 0; idx49 < 14; idx49++) {
    outC->_L206.speed_definition[idx49] = kcg_lit_float64(0.0);
  }
  for (idx51 = 0; idx51 < 14; idx51++) {
    for (idx50 = 0; idx50 < 100; idx50++) {
      outC->_L206.data[idx51][idx50] = kcg_lit_float64(0.0);
    }
  }
  ...
  for (idx52 = 0; idx52 < 110; idx52++) {
    ...
    outC->_L196.MRSP_targetList[idx52].distance = kcg_lit_float64(0.0);
    outC->_L196.MRSP_targetList[idx52].speed = kcg_lit_float64(0.0);
  }
  outC->_L196.EOA_target.targetType = EoA_TargetManagement_types;
  outC->_L196.EOA_target.distance = kcg_lit_float64(0.0);
  outC->_L196.EOA_target.speed = kcg_lit_float64(0.0);
  outC->_L196.SvL_LoA_target.targetType = EoA_TargetManagement_types;
  outC->_L196.SvL_LoA_target.distance = kcg_lit_float64(0.0);
  outC->_L196.SvL_LoA_target.speed = kcg_lit_float64(0.0);
  for (idx53 = 0; idx53 < 100; idx53++) {
    outC->_L190[idx53].position = kcg_lit_float64(0.0);
    outC->_L190[idx53].gradient_acceleration = kcg_lit_float64(0.0);
  ...
  outC->_L193.trainLength = kcg_lit_int64(0);
  outC->_L193.brakePerctage = kcg_lit_int64(0);
  outC->_L193.maxTrainSpeed = kcg_lit_int64(0);
  outC->_L193.loadingGauge =
    M_LOADINGGAUGE_The_train_does_not_fit_to_any_of_the_interoperable_loading_gauge_profiles;
  outC->_L193.axleLoadCategory = M_AXLELOADCAT_A;
  outC->_L193.airtightSystem = M_AIRTIGHT_Not_fitted;
  outC->_L193.axleNumber = kcg_lit_int64(0);
  outC->_L193.numberNationalSystems = kcg_lit_int64(0);
  for (idx54 = 0; idx54 < 5; idx54++) {
    outC->_L193.nationSystems[idx54] = kcg_lit_int64(0);
  }
  outC->_L193.numberTractionSystems = kcg_lit_int64(0);
  for (idx55 = 0; idx55 < 4; idx55++) {
    outC->_L193.tractionSystem[idx55].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L193.tractionSystem[idx55].nid_ctraction = kcg_lit_int64(0);
  }
  for (idx56 = 0; idx56 < 50; idx56++) {
    outC->_L189[idx56].location = kcg_lit_float64(0.0);
    outC->_L189[idx56].gradient = kcg_lit_float64(0.0);
    outC->_L189[idx56].valid = kcg_true;
  }
  for (idx57 = 0; idx57 < 100; idx57++) {
    outC->_L186.distance_definition[idx57] = kcg_lit_float64(0.0);
  }
  for (idx58 = 0; idx58 < 14; idx58++) {
    outC->_L186.speed_definition[idx58] = kcg_lit_float64(0.0);
  }
  for (idx60 = 0; idx60 < 14; idx60++) {
    for (idx59 = 0; idx59 < 100; idx59++) {
      outC->_L186.data[idx60][idx59] = kcg_lit_float64(0.0);
    }
  }
  for (idx61 = 0; idx61 < 100; idx61++) {
    outC->_L187.distance_definition[idx61] = kcg_lit_float64(0.0);
  }
  for (idx62 = 0; idx62 < 14; idx62++) {
    outC->_L187.speed_definition[idx62] = kcg_lit_float64(0.0);
  }
  for (idx64 = 0; idx64 < 14; idx64++) {
    for (idx63 = 0; idx63 < 100; idx63++) {
      outC->_L187.data[idx64][idx63] = kcg_lit_float64(0.0);
    }
  }
  outC->_L185.isSB_FBAvailable = kcg_true;
  outC->_L185.isSB_CmdAvailable = kcg_true;
  outC->_L185.isTCOAvailable = kcg_true;
  outC->_L185.T_traction_cut_off = kcg_lit_int64(0);
  outC->_L185.offsetAntennaL1 = kcg_lit_int64(0);
  outC->_L185.T_b_limit = kcg_lit_int64(0);
  outC->_L163 = kcg_true;
  ...
  outC->_L162.MA.v_main = kcg_lit_int64(0);
  outC->_L162.MA.v_loa = kcg_lit_int64(0);
  outC->_L162.MA.t_loa_unlimited = kcg_true;
  outC->_L162.MA.t_loa = kcg_lit_int64(0);
  outC->_L162.MA.n_iter = kcg_lit_int64(0);
  for (idx65 = 0; idx65 < 10; idx65++) {
    outC->_L162.MA.sections[idx65].valid = kcg_true;
    outC->_L162.MA.sections[idx65].q_endsection = kcg_true;
    outC->_L162.MA.sections[idx65].l_section = kcg_lit_int64(0);
    outC->_L162.MA.sections[idx65].q_sectiontimer = kcg_true;
    outC->_L162.MA.sections[idx65].t_sectiontimer = kcg_lit_int64(0);
    outC->_L162.MA.sections[idx65].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->_L162.MA.q_dangerpoint = kcg_true;
  outC->_L162.MA.dangerpoint.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L162.MA.dangerpoint.v_release = kcg_lit_int64(0);
  outC->_L162.MA.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->_L162.MA.q_overlap = kcg_true;
  outC->_L162.MA.overlap.d_DP_or_OL = kcg_lit_int64(0);
  outC->_L162.MA.overlap.v_release = kcg_lit_int64(0);
  outC->_L162.MA.overlap.calc_v_release_onboard = kcg_true;
  outC->_L162.MA.q_endtimer = kcg_true;
  outC->_L162.MA.endtimer_t.t_endtimer = kcg_lit_int64(0);
  outC->_L162.MA.endtimer_t.d_endtimerstoploc = kcg_lit_int64(0);
  outC->_L162.freshGradientProfile = kcg_true;
  for (idx66 = 0; idx66 < 50; idx66++) {
    outC->_L162.GradientProfile[idx66].valid = kcg_true;
    outC->_L162.GradientProfile[idx66].Loc_Absolute = kcg_lit_int64(0);
    outC->_L162.GradientProfile[idx66].Loc_LRBG = kcg_lit_int64(0);
    outC->_L162.GradientProfile[idx66].Gradient = kcg_lit_int64(0);
    outC->_L162.GradientProfile[idx66].L_Gradient = kcg_lit_int64(0);
  }
  outC->_L162.freshMRSP = kcg_true;
  for (idx67 = 0; idx67 < 110; idx67++) {
    outC->_L162.MRSP[idx67].valid = kcg_true;
    outC->_L162.MRSP[idx67].Loc_Abs = kcg_lit_int64(0);
    outC->_L162.MRSP[idx67].Loc_LRBG = kcg_lit_int64(0);
    outC->_L162.MRSP[idx67].MRS = kcg_lit_int64(0);
  }
  ...
  outC->_L143.trainLength = kcg_lit_int64(0);
  outC->_L143.brakePerctage = kcg_lit_int64(0);
  outC->_L143.maxTrainSpeed = kcg_lit_int64(0);
  outC->_L143.loadingGauge =
    M_LOADINGGAUGE_The_train_does_not_fit_to_any_of_the_interoperable_loading_gauge_profiles;
  outC->_L143.axleLoadCategory = M_AXLELOADCAT_A;
  outC->_L143.airtightSystem = M_AIRTIGHT_Not_fitted;
  outC->_L143.axleNumber = kcg_lit_int64(0);
  outC->_L143.numberNationalSystems = kcg_lit_int64(0);
  for (idx68 = 0; idx68 < 5; idx68++) {
    outC->_L143.nationSystems[idx68] = kcg_lit_int64(0);
  }
  outC->_L143.numberTractionSystems = kcg_lit_int64(0);
  for (idx69 = 0; idx69 < 4; idx69++) {
    outC->_L143.tractionSystem[idx69].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L143.tractionSystem[idx69].nid_ctraction = kcg_lit_int64(0);
  }
  outC->_L141.valid = kcg_true;
  outC->_L141.q_dir = Q_DIR_Reverse;
  outC->_L141.d_validnv = kcg_lit_int64(0);
  for (idx70 = 0; idx70 < 7; idx70++) {
    outC->_L141.nid_cArray[idx70].valid = kcg_true;
    outC->_L141.nid_cArray[idx70].nid_c = kcg_lit_int64(0);
  }
  outC->_L141.v_nvshunt = kcg_lit_int64(0);
  outC->_L141.v_nvstff = kcg_lit_int64(0);
  outC->_L141.v_nvonsight = kcg_lit_int64(0);
  outC->_L141.v_nvlimsuperv = kcg_lit_int64(0);
  outC->_L141.v_nvunfit = kcg_lit_int64(0);
  outC->_L141.v_nvrel = kcg_lit_int64(0);
  outC->_L141.d_nvroll = kcg_lit_int64(0);
  ...
  outC->_L141.v_nvallowovtrp = kcg_lit_int64(0);
  outC->_L141.v_nvsupovtrp = kcg_lit_int64(0);
  outC->_L141.d_nvovtrp = kcg_lit_int64(0);
  outC->_L141.t_nvovtrp = kcg_lit_int64(0);
  outC->_L141.d_nvpotrp = kcg_lit_int64(0);
  outC->_L141.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->_L141.t_nvcontact = kcg_lit_int64(0);
  outC->_L141.m_nvderun = M_NVDERUN_No;
  outC->_L141.d_nvstff = kcg_lit_int64(0);
  outC->_L141.q_nvdriver_adhes = Q_NVDRIVER_ADHES_Not_allowed;
  outC->_L141.a_nvmaxredadh1 = kcg_lit_float64(0.0);
  outC->_L141.a_nvmaxredadh2 = kcg_lit_float64(0.0);
  outC->_L141.a_nvmaxredadh3 = kcg_lit_float64(0.0);
  outC->_L141.q_nvlocacc = kcg_lit_int64(0);
  outC->_L141.m_nvavadh = kcg_lit_float64(0.0);
  ...
  for (idx72 = 0; idx72 < 7; idx72++) {
    ...
    outC->_L141.nvkvintsetArray[idx72].a_nvp12 = kcg_lit_float64(0.0);
    outC->_L141.nvkvintsetArray[idx72].a_nvp23 = kcg_lit_float64(0.0);
  ...
  for (idx73 = 0; idx73 < 7; idx73++) {
    ...
    outC->_L141.nvkrintArray[idx73].m_nvkrint = kcg_lit_float64(0.0);
  }
  outC->_L141.m_nvktint = kcg_lit_float64(0.0);
  for (idx74 = 0; idx74 < 2; idx74++) {
    outC->_L139.emergency[idx74] = kcg_lit_float64(0.0);
  }
  for (idx75 = 0; idx75 < 2; idx75++) {
    outC->_L139.service[idx75] = kcg_lit_float64(0.0);
  }
  outC->_L111.V_est = kcg_lit_int64(0);
  outC->_L111.V_MRSP = kcg_lit_int64(0);
  outC->_L111.V_release = kcg_lit_int64(0);
  outC->_L111.V_target = kcg_lit_int64(0);
  outC->_L111.v_p_mrdt = kcg_lit_int64(0);
  outC->_L111.v_p_dmi = kcg_lit_int64(0);
  outC->_L111.v_sbi_mrdt = kcg_lit_int64(0);
  outC->_L111.v_FLOI_dmi = kcg_lit_int64(0);
  outC->_L111.dV_warning_V_MRSP = kcg_lit_int64(0);
  outC->_L111.dV_warning_V_target = kcg_lit_int64(0);
  outC->_L111.dV_sbi_V_MRSP = kcg_lit_int64(0);
  outC->_L111.dV_sbi_V_target = kcg_lit_int64(0);
  outC->_L111.dV_ebi_V_MRSP = kcg_lit_int64(0);
  outC->_L111.dV_ebi_V_target = kcg_lit_int64(0);
  outC->_L111.OdoStandStill = kcg_true;
  outC->_L112.SBD_preindication_location = kcg_lit_int64(0);
  outC->_L112.EBD_preindication_location = kcg_lit_int64(0);
  outC->_L112.EBD_RSM_start_location = kcg_lit_int64(0);
  outC->_L112.SBD_RSM_start_location = kcg_lit_int64(0);
  outC->_L112.d_I_of_V_est = kcg_lit_int64(0);
  outC->_L112.d_I_of_V_MRSP = kcg_lit_int64(0);
  outC->_L112.d_P_of_V_est = kcg_lit_int64(0);
  outC->_L112.d_W_of_V_est = kcg_lit_int64(0);
  outC->_L112.d_FLOI_of_V_est = kcg_lit_int64(0);
  outC->_L112.d_EBI_of_V_est = kcg_lit_int64(0);
  outC->_L112.FLOI_of_V_est = kcg_lit_int64(0);
  outC->_L112.SBI1_of_V_est = kcg_lit_int64(0);
  outC->_L112.SBI2_of_V_est = kcg_lit_int64(0);
  outC->_L112.d_target = kcg_lit_int64(0);
  outC->_L112.d_eoa = kcg_lit_int64(0);
  outC->_L112.d_svl = kcg_lit_int64(0);
  ...
  outC->_L113.distance = kcg_lit_int64(0);
  outC->_L113.speed = kcg_lit_int64(0);
  ...
  for (idx76 = 0; idx76 < 110; idx76++) {
    ...
    outC->_L102.MRSP_targetList[idx76].distance = kcg_lit_float64(0.0);
    outC->_L102.MRSP_targetList[idx76].speed = kcg_lit_float64(0.0);
  }
  outC->_L102.EOA_target.targetType = EoA_TargetManagement_types;
  outC->_L102.EOA_target.distance = kcg_lit_float64(0.0);
  outC->_L102.EOA_target.speed = kcg_lit_float64(0.0);
  outC->_L102.SvL_LoA_target.targetType = EoA_TargetManagement_types;
  outC->_L102.SvL_LoA_target.distance = kcg_lit_float64(0.0);
  outC->_L102.SvL_LoA_target.speed = kcg_lit_float64(0.0);
  for (idx77 = 0; idx77 < 110; idx77++) {
    outC->_L98[idx77].Loc_Abs = kcg_lit_float64(0.0);
    outC->_L98[idx77].MRS = kcg_lit_float64(0.0);
  ...
  for (idx78 = 0; idx78 < 110; idx78++) {
    ...
    outC->_L97.MRSP_targetList[idx78].distance = kcg_lit_float64(0.0);
    outC->_L97.MRSP_targetList[idx78].speed = kcg_lit_float64(0.0);
  }
  outC->_L97.EOA_target.targetType = EoA_TargetManagement_types;
  outC->_L97.EOA_target.distance = kcg_lit_float64(0.0);
  outC->_L97.EOA_target.speed = kcg_lit_float64(0.0);
  outC->_L97.SvL_LoA_target.targetType = EoA_TargetManagement_types;
  outC->_L97.SvL_LoA_target.distance = kcg_lit_float64(0.0);
  outC->_L97.SvL_LoA_target.speed = kcg_lit_float64(0.0);
  outC->_L96.trainPositionIsValid = kcg_true;
  outC->_L96.d_est_frontendPos = kcg_lit_float64(0.0);
  outC->_L96.d_minSafeFrontEndPos = kcg_lit_float64(0.0);
  outC->_L96.d_maxSafeFrontEndPos = kcg_lit_float64(0.0);
  outC->_L96.d_LRBG = kcg_lit_float64(0.0);
  outC->_L96.d_accLRBG = kcg_lit_float64(0.0);
  outC->_L94 = kcg_lit_int64(0);
  outC->_L86.trainPositionIsValid = kcg_true;
  outC->_L86.d_est_frontendPos = kcg_lit_float64(0.0);
  outC->_L86.d_minSafeFrontEndPos = kcg_lit_float64(0.0);
  outC->_L86.d_maxSafeFrontEndPos = kcg_lit_float64(0.0);
  outC->_L86.d_LRBG = kcg_lit_float64(0.0);
  outC->_L86.d_accLRBG = kcg_lit_float64(0.0);
  ...
  for (idx79 = 0; idx79 < 110; idx79++) {
    ...
    outC->_L81.MRSP_targetList[idx79].distance = kcg_lit_float64(0.0);
    outC->_L81.MRSP_targetList[idx79].speed = kcg_lit_float64(0.0);
  }
  outC->_L81.EOA_target.targetType = EoA_TargetManagement_types;
  outC->_L81.EOA_target.distance = kcg_lit_float64(0.0);
  outC->_L81.EOA_target.speed = kcg_lit_float64(0.0);
  outC->_L81.SvL_LoA_target.targetType = EoA_TargetManagement_types;
  outC->_L81.SvL_LoA_target.distance = kcg_lit_float64(0.0);
  outC->_L81.SvL_LoA_target.speed = kcg_lit_float64(0.0);
  outC->_L65.valid = kcg_true;
  outC->_L65.estimatedSpeed = kcg_lit_int64(0);
  outC->_L65.valid_v_est = kcg_true;
  outC->_L65.permittedSpeed = kcg_lit_int64(0);
  outC->_L65.valid_v_permitted = kcg_true;
  outC->_L65.releaseSpeed = kcg_lit_int64(0);
  outC->_L65.valid_v_release = kcg_true;
  outC->_L65.mrdtSpeed = kcg_lit_int64(0);
  outC->_L65.valid_v_mrdt = kcg_true;
  outC->_L65.sbiSpeed = kcg_lit_int64(0);
  outC->_L65.valid_v_sbi = kcg_true;
  outC->_L65.targetDistance = kcg_lit_int64(0);
  ...
  outC->_L55.v_main = kcg_lit_float64(0.0);
  outC->_L55.EOA.Location = kcg_lit_float64(0.0);
  outC->_L55.EOA.TargetSpeed = kcg_lit_float64(0.0);
  outC->_L55.DP_valid = kcg_true;
  outC->_L55.DangerPoint = kcg_lit_float64(0.0);
  outC->_L55.OL_valid = kcg_true;
  outC->_L55.Overlap = kcg_lit_float64(0.0);
  outC->_L55.q_calculate_release = kcg_true;
  outC->_L55.ReleaseSpeed = kcg_lit_float64(0.0);
  outC->_L55.level = MA_L1_TrackAtlasTypes;
  for (idx80 = 0; idx80 < 110; idx80++) {
    outC->_L54[idx80].Loc_Abs = kcg_lit_float64(0.0);
    outC->_L54[idx80].MRS = kcg_lit_float64(0.0);
    outC->_L54[idx80].valid = kcg_true;
  }
  outC->_L48.trainPositionIsValid = kcg_true;
  outC->_L48.d_est_frontendPos = kcg_lit_float64(0.0);
  outC->_L48.d_minSafeFrontEndPos = kcg_lit_float64(0.0);
  outC->_L48.d_maxSafeFrontEndPos = kcg_lit_float64(0.0);
  outC->_L48.d_LRBG = kcg_lit_float64(0.0);
  outC->_L48.d_accLRBG = kcg_lit_float64(0.0);
  for (idx85 = 0; idx85 < 110; idx85++) {
    for (idx81 = 0; idx81 < 114; idx81++) {
      outC->_L43.MRSP_EBD_curves[idx85].distances[idx81] = kcg_lit_float64(0.0);
    }
    for (idx82 = 0; idx82 < 114; idx82++) {
      outC->_L43.MRSP_EBD_curves[idx85].speeds[idx82] = kcg_lit_float64(0.0);
    }
    for (idx83 = 0; idx83 < 114; idx83++) {
      outC->_L43.MRSP_EBD_curves[idx85].accelerations[idx83] = kcg_lit_float64(0.0);
    }
  ...
  for (idx86 = 0; idx86 < 114; idx86++) {
    outC->_L43.EOA_SBD_curve.distances[idx86] = kcg_lit_float64(0.0);
  }
  for (idx87 = 0; idx87 < 114; idx87++) {
    outC->_L43.EOA_SBD_curve.speeds[idx87] = kcg_lit_float64(0.0);
  }
  for (idx88 = 0; idx88 < 114; idx88++) {
    outC->_L43.EOA_SBD_curve.accelerations[idx88] = kcg_lit_float64(0.0);
  }
  for (idx89 = 0; idx89 < 114; idx89++) {
    outC->_L43.EOA_SBD_curve.valid[idx89] = kcg_true;
  }
  for (idx90 = 0; idx90 < 114; idx90++) {
    outC->_L43.SvL_LoA_EBD_curve.distances[idx90] = kcg_lit_float64(0.0);
  }
  for (idx91 = 0; idx91 < 114; idx91++) {
    outC->_L43.SvL_LoA_EBD_curve.speeds[idx91] = kcg_lit_float64(0.0);
  }
  for (idx92 = 0; idx92 < 114; idx92++) {
    outC->_L43.SvL_LoA_EBD_curve.accelerations[idx92] = kcg_lit_float64(0.0);
  }
  for (idx93 = 0; idx93 < 114; idx93++) {
    outC->_L43.SvL_LoA_EBD_curve.valid[idx93] = kcg_true;
  }
  for (idx94 = 0; idx94 < 114; idx94++) {
    outC->_L43.GUI_curve.distances[idx94] = kcg_lit_float64(0.0);
  }
  for (idx95 = 0; idx95 < 114; idx95++) {
    outC->_L43.GUI_curve.speeds[idx95] = kcg_lit_float64(0.0);
  }
  for (idx96 = 0; idx96 < 114; idx96++) {
    outC->_L43.GUI_curve.accelerations[idx96] = kcg_lit_float64(0.0);
  }
  ...
  outC->_L34.nid_operational = kcg_lit_int64(0);
  outC->_L34.l_train = kcg_lit_int64(0);
  outC->_L34.d_baliseAntenna_2_frontend.nominal = kcg_lit_int64(0);
  outC->_L34.d_baliseAntenna_2_frontend.d_min = kcg_lit_int64(0);
  outC->_L34.d_baliseAntenna_2_frontend.d_max = kcg_lit_int64(0);
  outC->_L34.d_frontend_2_rearend.nominal = kcg_lit_int64(0);
  outC->_L34.d_frontend_2_rearend.d_min = kcg_lit_int64(0);
  outC->_L34.d_frontend_2_rearend.d_max = kcg_lit_int64(0);
  outC->_L34.locationAccuracy_DefaultValue.nominal = kcg_lit_int64(0);
  outC->_L34.locationAccuracy_DefaultValue.d_min = kcg_lit_int64(0);
  outC->_L34.locationAccuracy_DefaultValue.d_max = kcg_lit_int64(0);
  outC->_L34.centerDetectionAcc_DefaultValue.nominal = kcg_lit_int64(0);
  outC->_L34.centerDetectionAcc_DefaultValue.d_min = kcg_lit_int64(0);
  outC->_L34.centerDetectionAcc_DefaultValue.d_max = kcg_lit_int64(0);
  outC->_L24.valid = kcg_true;
  outC->_L24.timestamp = kcg_lit_int64(0);
  outC->_L24.odo.o_nominal = kcg_lit_int64(0);
  outC->_L24.odo.o_min = kcg_lit_int64(0);
  outC->_L24.odo.o_max = kcg_lit_int64(0);
  outC->_L24.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L24.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L24.speed.v_lower = kcg_lit_int64(0);
  outC->_L24.speed.v_upper = kcg_lit_int64(0);
  outC->_L24.acceleration = kcg_lit_int64(0);
  ...
  outC->_L22.trainPosition.nominal = kcg_lit_int64(0);
  outC->_L22.trainPosition.d_min = kcg_lit_int64(0);
  outC->_L22.trainPosition.d_max = kcg_lit_int64(0);
  outC->_L22.estimatedFrontEndPosition = kcg_lit_int64(0);
  outC->_L22.minSafeFrontEndPosition = kcg_lit_int64(0);
  outC->_L22.maxSafeFrontEndPostion = kcg_lit_int64(0);
  outC->_L22.LRBG.valid = kcg_true;
  outC->_L22.LRBG.nid_c = kcg_lit_int64(0);
  outC->_L22.LRBG.nid_bg = kcg_lit_int64(0);
  outC->_L22.LRBG.q_link = Q_LINK_Unlinked;
  outC->_L22.LRBG.location.nominal = kcg_lit_int64(0);
  outC->_L22.LRBG.location.d_min = kcg_lit_int64(0);
  outC->_L22.LRBG.location.d_max = kcg_lit_int64(0);
  outC->_L22.LRBG.seqNoOnTrack = kcg_lit_int64(0);
  outC->_L22.LRBG.infoFromLinking.valid = kcg_true;
  outC->_L22.LRBG.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L22.LRBG.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->_L22.LRBG.infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
  outC->_L22.LRBG.infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
  outC->_L22.LRBG.infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
  outC->_L22.LRBG.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L22.LRBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L22.LRBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->_L22.LRBG.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->_L22.LRBG.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  ...
  outC->_L22.LRBG.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L22.LRBG.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L22.LRBG.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L22.LRBG.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  outC->_L22.LRBG.infoFromLinking.linkingInfo.q_linkorientation =
    Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
  outC->_L22.LRBG.infoFromLinking.linkingInfo.q_linkreaction =
    Q_LINKREACTION_Train_trip;
  outC->_L22.LRBG.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->_L22.LRBG.infoFromPassing.BG_Header.n_total =
    N_TOTAL_1_balise_in_the_group;
  outC->_L22.LRBG.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L22.LRBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L22.LRBG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L22.LRBG.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L22.LRBG.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx98 = 0; idx98 < 33; idx98++) {
    ...
    outC->_L22.LRBG.infoFromPassing.linkedBGs[idx98].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L22.LRBG.infoFromPassing.linkedBGs[idx98].d_link = kcg_lit_int64(0);
    outC->_L22.LRBG.infoFromPassing.linkedBGs[idx98].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L22.LRBG.infoFromPassing.linkedBGs[idx98].nid_c = kcg_lit_int64(0);
    outC->_L22.LRBG.infoFromPassing.linkedBGs[idx98].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L22.LRBG.infoFromPassing.linkedBGs[idx98].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L22.LRBG.infoFromPassing.linkedBGs[idx98].q_locacc = kcg_lit_int64(0);
  }
  outC->_L22.LRBG.missed = kcg_true;
  outC->_L22.prvLRBG.valid = kcg_true;
  outC->_L22.prvLRBG.nid_c = kcg_lit_int64(0);
  outC->_L22.prvLRBG.nid_bg = kcg_lit_int64(0);
  outC->_L22.prvLRBG.q_link = Q_LINK_Unlinked;
  outC->_L22.prvLRBG.location.nominal = kcg_lit_int64(0);
  outC->_L22.prvLRBG.location.d_min = kcg_lit_int64(0);
  outC->_L22.prvLRBG.location.d_max = kcg_lit_int64(0);
  outC->_L22.prvLRBG.seqNoOnTrack = kcg_lit_int64(0);
  outC->_L22.prvLRBG.infoFromLinking.valid = kcg_true;
  outC->_L22.prvLRBG.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L22.prvLRBG.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->_L22.prvLRBG.infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
  outC->_L22.prvLRBG.infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
  outC->_L22.prvLRBG.infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
  outC->_L22.prvLRBG.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L22.prvLRBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L22.prvLRBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->_L22.prvLRBG.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->_L22.prvLRBG.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  ...
  outC->_L22.prvLRBG.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L22.prvLRBG.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L22.prvLRBG.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L22.prvLRBG.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L22.prvLRBG.infoFromLinking.linkingInfo.q_linkreaction =
    Q_LINKREACTION_Train_trip;
  outC->_L22.prvLRBG.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->_L22.prvLRBG.infoFromPassing.BG_Header.n_total =
    N_TOTAL_1_balise_in_the_group;
  outC->_L22.prvLRBG.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L22.prvLRBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L22.prvLRBG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L22.prvLRBG.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L22.prvLRBG.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx99 = 0; idx99 < 33; idx99++) {
    ...
    outC->_L22.prvLRBG.infoFromPassing.linkedBGs[idx99].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L22.prvLRBG.infoFromPassing.linkedBGs[idx99].q_scale =
      Q_SCALE_10_cm_scale;
    outC->_L22.prvLRBG.infoFromPassing.linkedBGs[idx99].d_link = kcg_lit_int64(0);
    outC->_L22.prvLRBG.infoFromPassing.linkedBGs[idx99].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L22.prvLRBG.infoFromPassing.linkedBGs[idx99].nid_c = kcg_lit_int64(0);
    outC->_L22.prvLRBG.infoFromPassing.linkedBGs[idx99].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L22.prvLRBG.infoFromPassing.linkedBGs[idx99].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L22.prvLRBG.infoFromPassing.linkedBGs[idx99].q_locacc = kcg_lit_int64(0);
  }
  ...
  outC->_L22.estimatedRearEndPosition = kcg_lit_int64(0);
  outC->_L22.minSafeRearEndPosition = kcg_lit_int64(0);
  outC->_L22.maxSafeRearEndPosition = kcg_lit_int64(0);
  ...
  outC->_L21.v_nvsupovtrp = kcg_lit_int64(0);
  ...
  outC->_L21.a_nvmaxredadh1 = kcg_lit_float64(0.0);
  outC->_L21.a_nvmaxredadh2 = kcg_lit_float64(0.0);
  outC->_L21.a_nvmaxredadh3 = kcg_lit_float64(0.0);
  outC->_L21.q_nvlocacc = kcg_lit_int64(0);
  outC->_L21.m_nvavadh = kcg_lit_float64(0.0);
  ...
  for (idx102 = 0; idx102 < 7; idx102++) {
    ...
    outC->_L21.nvkvintsetArray[idx102].a_nvp12 = kcg_lit_float64(0.0);
    outC->_L21.nvkvintsetArray[idx102].a_nvp23 = kcg_lit_float64(0.0);
  ...
  for (idx103 = 0; idx103 < 7; idx103++) {
    ...
    outC->_L21.nvkrintArray[idx103].m_nvkrint = kcg_lit_float64(0.0);
  }
  outC->_L21.m_nvktint = kcg_lit_float64(0.0);
  outC->_L3.valid = kcg_true;
  outC->_L3.targetSpeed = kcg_lit_int64(0);
  outC->_L3.permittedSpeed = kcg_lit_int64(0);
  outC->_L3.releaseSpeed = kcg_lit_int64(0);
  outC->_L3.locationBrakeTarget = kcg_lit_int64(0);
  outC->_L3.location_brake_curve_starting_point = kcg_lit_int64(0);
  outC->_L3.interventionSpeed = kcg_lit_int64(0);
  ...
  outC->sdmToDMILocal.targetSpeed = kcg_lit_int64(0);
  outC->sdmToDMILocal.permittedSpeed = kcg_lit_int64(0);
  outC->sdmToDMILocal.releaseSpeed = kcg_lit_int64(0);
  outC->sdmToDMILocal.locationBrakeTarget = kcg_lit_int64(0);
  outC->sdmToDMILocal.location_brake_curve_starting_point = kcg_lit_int64(0);
  outC->sdmToDMILocal.interventionSpeed = kcg_lit_int64(0);
  outC->sdmToDMILocal.sup_status = CSM_DMI_Types_Pkg;
  outC->sdmToDMILocal.supervisionDisplay = supDis_normal_DMI_Types_Pkg;
  outC->sdmToDMILocal.distanceIndicationPoint = kcg_lit_int64(0);
  ...
  for (idx109 = 0; idx109 < 114; idx109++) {
    outC->CurveCollection.EOA_SBD_curve.distances[idx109] = kcg_lit_float64(0.0);
  }
  for (idx110 = 0; idx110 < 114; idx110++) {
    outC->CurveCollection.EOA_SBD_curve.speeds[idx110] = kcg_lit_float64(0.0);
  }
  for (idx111 = 0; idx111 < 114; idx111++) {
    outC->CurveCollection.EOA_SBD_curve.accelerations[idx111] = kcg_lit_float64(
        0.0);
  }
  ...
  for (idx113 = 0; idx113 < 114; idx113++) {
    outC->CurveCollection.SvL_LoA_EBD_curve.distances[idx113] = kcg_lit_float64(
        0.0);
  }
  for (idx114 = 0; idx114 < 114; idx114++) {
    outC->CurveCollection.SvL_LoA_EBD_curve.speeds[idx114] = kcg_lit_float64(0.0);
  }
  ...
  for (idx117 = 0; idx117 < 114; idx117++) {
    outC->CurveCollection.GUI_curve.distances[idx117] = kcg_lit_float64(0.0);
  }
  for (idx118 = 0; idx118 < 114; idx118++) {
    outC->CurveCollection.GUI_curve.speeds[idx118] = kcg_lit_float64(0.0);
  }
  for (idx119 = 0; idx119 < 114; idx119++) {
    outC->CurveCollection.GUI_curve.accelerations[idx119] = kcg_lit_float64(0.0);
  }
  ...
  for (idx121 = 0; idx121 < 2; idx121++) {
    outC->T_b.emergency[idx121] = kcg_lit_float64(0.0);
  }
  for (idx122 = 0; idx122 < 2; idx122++) {
    outC->T_b.service[idx122] = kcg_lit_float64(0.0);
  }
  ...
  outC->trainData_extras.T_traction_cut_off = kcg_lit_int64(0);
  outC->trainData_extras.offsetAntennaL1 = kcg_lit_int64(0);
  outC->trainData_extras.T_b_limit = kcg_lit_int64(0);
  outC->MA_internal.valid = kcg_true;
  outC->MA_internal.v_main = kcg_lit_float64(0.0);
  outC->MA_internal.EOA.Location = kcg_lit_float64(0.0);
  outC->MA_internal.EOA.TargetSpeed = kcg_lit_float64(0.0);
  outC->MA_internal.DP_valid = kcg_true;
  outC->MA_internal.DangerPoint = kcg_lit_float64(0.0);
  outC->MA_internal.OL_valid = kcg_true;
  outC->MA_internal.Overlap = kcg_lit_float64(0.0);
  outC->MA_internal.q_calculate_release = kcg_true;
  outC->MA_internal.ReleaseSpeed = kcg_lit_float64(0.0);
  outC->MA_internal.level = MA_L1_TrackAtlasTypes;
  for (idx123 = 0; idx123 < 110; idx123++) {
    outC->MRSP_internal[idx123].Loc_Abs = kcg_lit_float64(0.0);
    outC->MRSP_internal[idx123].MRS = kcg_lit_float64(0.0);
    outC->MRSP_internal[idx123].valid = kcg_true;
  }
  outC->Trainlocations_internal.trainPositionIsValid = kcg_true;
  outC->Trainlocations_internal.d_est_frontendPos = kcg_lit_float64(0.0);
  outC->Trainlocations_internal.d_minSafeFrontEndPos = kcg_lit_float64(0.0);
  outC->Trainlocations_internal.d_maxSafeFrontEndPos = kcg_lit_float64(0.0);
  outC->Trainlocations_internal.d_LRBG = kcg_lit_float64(0.0);
  outC->Trainlocations_internal.d_accLRBG = kcg_lit_float64(0.0);
  ...
  for (idx124 = 0; idx124 < 110; idx124++) {
    ...
    outC->targetCollection.MRSP_targetList[idx124].distance = kcg_lit_float64(0.0);
    outC->targetCollection.MRSP_targetList[idx124].speed = kcg_lit_float64(0.0);
  }
  ...
  outC->sdmCommands.estimatedSpeed = kcg_lit_int64(0);
  outC->sdmCommands.valid_v_est = kcg_true;
  outC->sdmCommands.permittedSpeed = kcg_lit_int64(0);
  outC->sdmCommands.valid_v_permitted = kcg_true;
  outC->sdmCommands.releaseSpeed = kcg_lit_int64(0);
  outC->sdmCommands.valid_v_release = kcg_true;
  outC->sdmCommands.mrdtSpeed = kcg_lit_int64(0);
  outC->sdmCommands.valid_v_mrdt = kcg_true;
  outC->sdmCommands.sbiSpeed = kcg_lit_int64(0);
  outC->sdmCommands.valid_v_sbi = kcg_true;
  outC->sdmCommands.targetDistance = kcg_lit_int64(0);
  ...
  outC->target.distance = kcg_lit_int64(0);
  outC->target.speed = kcg_lit_int64(0);
