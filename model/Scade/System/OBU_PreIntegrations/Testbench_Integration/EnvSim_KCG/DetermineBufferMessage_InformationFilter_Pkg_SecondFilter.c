  ...
  outC_DetermineBufferMessage_InformationFilter_Pkg_SecondFilter *outC)
{
  ...
  for (idx1 = 0; idx1 < 30; idx1++) {
    outC->_L125[idx1].nid_packet = kcg_lit_int64(0);
    outC->_L125[idx1].q_dir = Q_DIR_Reverse;
    outC->_L125[idx1].valid = kcg_true;
    outC->_L125[idx1].startAddress = kcg_lit_int64(0);
    outC->_L125[idx1].endAddress = kcg_lit_int64(0);
  }
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L123.PacketHeaders[idx2].nid_packet = kcg_lit_int64(0);
    outC->_L123.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L123.PacketHeaders[idx2].valid = kcg_true;
    outC->_L123.PacketHeaders[idx2].startAddress = kcg_lit_int64(0);
    outC->_L123.PacketHeaders[idx2].endAddress = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L123.PacketData[idx3] = kcg_lit_int64(0);
  }
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L52[idx4].nid_packet = kcg_lit_int64(0);
    outC->_L52[idx4].q_dir = Q_DIR_Reverse;
    outC->_L52[idx4].valid = kcg_true;
    outC->_L52[idx4].startAddress = kcg_lit_int64(0);
    outC->_L52[idx4].endAddress = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 30; idx5++) {
    outC->_L30.PacketHeaders[idx5].nid_packet = kcg_lit_int64(0);
    outC->_L30.PacketHeaders[idx5].q_dir = Q_DIR_Reverse;
    outC->_L30.PacketHeaders[idx5].valid = kcg_true;
    outC->_L30.PacketHeaders[idx5].startAddress = kcg_lit_int64(0);
    outC->_L30.PacketHeaders[idx5].endAddress = kcg_lit_int64(0);
  }
  for (idx6 = 0; idx6 < 500; idx6++) {
    outC->_L30.PacketData[idx6] = kcg_lit_int64(0);
  }
  for (idx7 = 0; idx7 < 30; idx7++) {
    outC->_L19[idx7].nid_packet = kcg_lit_int64(0);
    outC->_L19[idx7].q_dir = Q_DIR_Reverse;
    outC->_L19[idx7].valid = kcg_true;
    outC->_L19[idx7].startAddress = kcg_lit_int64(0);
    outC->_L19[idx7].endAddress = kcg_lit_int64(0);
  }
  ...
  for (idx8 = 0; idx8 < 30; idx8++) {
    outC->_L17.packets.PacketHeaders[idx8].nid_packet = kcg_lit_int64(0);
    outC->_L17.packets.PacketHeaders[idx8].q_dir = Q_DIR_Reverse;
    outC->_L17.packets.PacketHeaders[idx8].valid = kcg_true;
    outC->_L17.packets.PacketHeaders[idx8].startAddress = kcg_lit_int64(0);
    outC->_L17.packets.PacketHeaders[idx8].endAddress = kcg_lit_int64(0);
  }
  for (idx9 = 0; idx9 < 500; idx9++) {
    outC->_L17.packets.PacketData[idx9] = kcg_lit_int64(0);
  }
  ...
  outC->_L13.bgPosition.timestamp = kcg_lit_int64(0);
  outC->_L13.bgPosition.odo.o_nominal = kcg_lit_int64(0);
  outC->_L13.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->_L13.bgPosition.odo.o_max = kcg_lit_int64(0);
  outC->_L13.bgPosition.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L13.bgPosition.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L13.bgPosition.speed.v_lower = kcg_lit_int64(0);
  outC->_L13.bgPosition.speed.v_upper = kcg_lit_int64(0);
  outC->_L13.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->_L13.BG_centerDetectionInaccuraccuracies.nominal = kcg_lit_int64(0);
  outC->_L13.BG_centerDetectionInaccuraccuracies.d_min = kcg_lit_int64(0);
  outC->_L13.BG_centerDetectionInaccuraccuracies.d_max = kcg_lit_int64(0);
  outC->_L13.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx10 = 0; idx10 < 30; idx10++) {
    outC->_L15.PacketHeaders[idx10].nid_packet = kcg_lit_int64(0);
    outC->_L15.PacketHeaders[idx10].q_dir = Q_DIR_Reverse;
    outC->_L15.PacketHeaders[idx10].valid = kcg_true;
    outC->_L15.PacketHeaders[idx10].startAddress = kcg_lit_int64(0);
    outC->_L15.PacketHeaders[idx10].endAddress = kcg_lit_int64(0);
  }
  for (idx11 = 0; idx11 < 500; idx11++) {
    outC->_L15.PacketData[idx11] = kcg_lit_int64(0);
  }
  outC->_L16.valid = kcg_true;
  outC->_L16.nid_c = kcg_lit_int64(0);
  outC->_L16.rbc_id = kcg_lit_int64(0);
  outC->_L16.device_id = kcg_lit_int64(0);
  ...
  for (idx12 = 0; idx12 < 30; idx12++) {
    outC->_L2.packets.PacketHeaders[idx12].nid_packet = kcg_lit_int64(0);
    outC->_L2.packets.PacketHeaders[idx12].q_dir = Q_DIR_Reverse;
    outC->_L2.packets.PacketHeaders[idx12].valid = kcg_true;
    outC->_L2.packets.PacketHeaders[idx12].startAddress = kcg_lit_int64(0);
    outC->_L2.packets.PacketHeaders[idx12].endAddress = kcg_lit_int64(0);
  }
  for (idx13 = 0; idx13 < 500; idx13++) {
    outC->_L2.packets.PacketData[idx13] = kcg_lit_int64(0);
  }
  ...
  for (idx17 = 0; idx17 < 500; idx17++) {
    outC->outMessageForBuffer.packets.PacketData[idx17] = kcg_lit_int64(0);
  }
