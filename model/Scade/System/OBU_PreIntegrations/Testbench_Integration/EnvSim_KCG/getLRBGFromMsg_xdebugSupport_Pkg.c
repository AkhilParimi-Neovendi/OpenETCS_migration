...
{
  outC->_L34 = kcg_lit_int64(100000);
  ...
  outC_getLRBGFromMsg_xdebugSupport_Pkg *outC)
{
  ...
  outC->_L22.bgPosition.timestamp = kcg_lit_int64(0);
  outC->_L22.bgPosition.odo.o_nominal = kcg_lit_int64(0);
  outC->_L22.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->_L22.bgPosition.odo.o_max = kcg_lit_int64(0);
  outC->_L22.bgPosition.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L22.bgPosition.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L22.bgPosition.speed.v_lower = kcg_lit_int64(0);
  outC->_L22.bgPosition.speed.v_upper = kcg_lit_int64(0);
  outC->_L22.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->_L22.BG_centerDetectionInaccuraccuracies.nominal = kcg_lit_int64(0);
  outC->_L22.BG_centerDetectionInaccuraccuracies.d_min = kcg_lit_int64(0);
  outC->_L22.BG_centerDetectionInaccuraccuracies.d_max = kcg_lit_int64(0);
  outC->_L22.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L6.packets.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L6.packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L6.packets.PacketHeaders[idx].valid = kcg_true;
    outC->_L6.packets.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L6.packets.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L6.packets.PacketData[idx1] = kcg_lit_int64(0);
  }
