...
void Balise_356_0_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
  ...
  /* PIG_nom/ */
  kcg_int32 PIG_nom,
  outC_Balise_356_0_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet06_Bijlmer_Balises::Packets_BG356#1)/ */
    Packets_BG356_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG356_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG356_1.Balise_data_out);
...
void Balise_356_0_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
  outC_Balise_356_0_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises *outC)
{
  static kcg_size idx;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet06_Bijlmer_Balises::Packets_BG356#1)/ */
  Packets_BG356_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
    &outC->Context_Packets_BG356_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_356_0_reset_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
  outC_Balise_356_0_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet06_Bijlmer_Balises::Packets_BG356#1)/ */
  Packets_BG356_reset_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
    &outC->Context_Packets_BG356_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
