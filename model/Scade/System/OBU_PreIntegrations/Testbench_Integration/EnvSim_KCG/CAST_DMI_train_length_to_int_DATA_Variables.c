...
void CAST_DMI_train_length_to_int_DATA_Variables(
  /* dmi_train_length_ct/ */
  ...
  outC_CAST_DMI_train_length_to_int_DATA_Variables *outC)
{
  ...
  outC->_L37 = outC->_L24 | outC->_L26 | outC->_L29 | outC->_L31 | outC->_L38;
...
void CAST_DMI_train_length_to_int_init_DATA_Variables(
  outC_CAST_DMI_train_length_to_int_DATA_Variables *outC)
{
  outC->_L41 = kcg_true;
...
void CAST_DMI_train_length_to_int_reset_DATA_Variables(
  outC_CAST_DMI_train_length_to_int_DATA_Variables *outC)
{
  /* _L23=(Utilities::BCD_to_Int#1)/ */
