  ...
  outC_Read_P137_TM *outC)
{
  ...
  /* _L166=(TM_conversions::C_P137_compr_onboard#1)/ */
  C_P137_compr_onboard_TM_conversions(
    &outC->_L5,
    &outC->_L30,
    &outC->Context_C_P137_compr_onboard_1);
  kcg_copy_P137_StopIfInStaffResponsible_T_Packet_Types_Pkg(
    &outC->_L166,
    &outC->Context_C_P137_compr_onboard_1.P137_onboard);
  kcg_copy_P137_StopIfInStaffResponsible_T_Packet_Types_Pkg(
    &outC->P137_OBU_out,
    &outC->_L166);
}
...
void Read_P137_init_TM(outC_Read_P137_TM *outC)
{
  static kcg_size idx;
  ...
  outC->P137_OBU_out.q_srstop = Q_SRSTOP_Stop_if_in_SR_mode;
  outC->received = kcg_true;
  /* _L166=(TM_conversions::C_P137_compr_onboard#1)/ */
  C_P137_compr_onboard_init_TM_conversions(
    &outC->Context_C_P137_compr_onboard_1);
  /* _L5=(TM_lib_internal::RECV_ReadPackets#1)/ */
...
{
  /* _L166=(TM_conversions::C_P137_compr_onboard#1)/ */
  C_P137_compr_onboard_reset_TM_conversions(
    &outC->Context_C_P137_compr_onboard_1);
  /* _L5=(TM_lib_internal::RECV_ReadPackets#1)/ */
