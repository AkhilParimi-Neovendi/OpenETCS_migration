...
void SP_PBD_SR_init_TA_SpeedProfiles(outC_SP_PBD_SR_TA_SpeedProfiles *outC)
{
  static kcg_size idx;
  ...
  for (idx3 = 0; idx3 < 50; idx3++) {
    outC->PBD_SR[idx3].target = kcg_lit_int64(0);
    outC->PBD_SR[idx3].speed = kcg_lit_int64(0);
  }
}
