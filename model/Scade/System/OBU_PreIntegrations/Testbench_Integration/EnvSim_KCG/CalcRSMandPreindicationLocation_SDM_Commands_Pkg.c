...
void CalcRSMandPreindicationLocation_init_SDM_Commands_Pkg(
  outC_CalcRSMandPreindicationLocation_SDM_Commands_Pkg *outC)
{
  static kcg_size idx;
  ...
  for (idx = 0; idx < 33; idx++) {
    ...
    outC->_L15.LRBG.infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L15.LRBG.infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int64(0);
    outC->_L15.LRBG.infoFromPassing.linkedBGs[idx].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L15.LRBG.infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int64(0);
    outC->_L15.LRBG.infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L15.LRBG.infoFromPassing.linkedBGs[idx].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L15.LRBG.infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L15.prvLRBG.infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L15.prvLRBG.infoFromPassing.linkedBGs[idx1].q_scale =
      Q_SCALE_10_cm_scale;
    outC->_L15.prvLRBG.infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int64(0);
    outC->_L15.prvLRBG.infoFromPassing.linkedBGs[idx1].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L15.prvLRBG.infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int64(0);
    outC->_L15.prvLRBG.infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L15.prvLRBG.infoFromPassing.linkedBGs[idx1].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L15.prvLRBG.infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int64(0);
  }
...
void CalcRSMandPreindicationLocation_reset_SDM_Commands_Pkg(
  outC_CalcRSMandPreindicationLocation_SDM_Commands_Pkg *outC)
{
}
