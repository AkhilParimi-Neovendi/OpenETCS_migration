...
void Write_P021_TM_trackside(
  /* Packet21/ */
  P021_trackside_int_T_TM *Packet21,
  /* Packets/ */
  CompressedPackets_T_Common_Types_Pkg *Packets,
  outC_Write_P021_TM_trackside *outC)
{
  kcg_copy_P021_trackside_int_T_TM(&outC->_L1, Packet21);
  /* _L43=(TM_conversions::C_P021_tracksim_compr#1)/ */
  C_P021_tracksim_compr_TM_conversions(
    &outC->_L1,
    &outC->Context_C_P021_tracksim_compr_1);
  kcg_copy_MetadataElement_T_Common_Types_Pkg(
    &outC->_L43,
    &outC->Context_C_P021_tracksim_compr_1.Header);
  kcg_copy_CompressedPacketData_T_Common_Types_Pkg(
    &outC->_L44,
    &outC->Context_C_P021_tracksim_compr_1.P005_compressed);
...
void Write_P021_init_TM_trackside(outC_Write_P021_TM_trackside *outC)
{
  ...
  for (idx9 = 0; idx9 < 32; idx9++) {
    outC->_L1.SECTIONS[idx9].D_GRADIENT = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx9].Q_GDIR = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx9].G_A = kcg_lit_int64(0);
  }
  ...
  SEND_WriteBaliseMessageHeader_init_TM_lib_internal(
    &outC->Context_SEND_WriteBaliseMessageHeader_1);
  /* _L43=(TM_conversions::C_P021_tracksim_compr#1)/ */
  C_P021_tracksim_compr_init_TM_conversions(
    &outC->Context_C_P021_tracksim_compr_1);
}
...
void Write_P021_reset_TM_trackside(outC_Write_P021_TM_trackside *outC)
{
  ...
  SEND_WriteBaliseMessageHeader_reset_TM_lib_internal(
    &outC->Context_SEND_WriteBaliseMessageHeader_1);
  /* _L43=(TM_conversions::C_P021_tracksim_compr#1)/ */
  C_P021_tracksim_compr_reset_TM_conversions(
    &outC->Context_C_P021_tracksim_compr_1);
}
