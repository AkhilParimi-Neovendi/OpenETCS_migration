...
void CAST_DMI_EVC_Radio_Net_Data_to_int1_DATA_Packets_EVC_to_DMI(
...
void CAST_DMI_EVC_Radio_Net_Data_to_int1_init_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_EVC_Radio_Net_Data_to_int1_DATA_Packets_EVC_to_DMI *outC)
{
  static kcg_size idx;
...
void CAST_DMI_EVC_Radio_Net_Data_to_int1_reset_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_EVC_Radio_Net_Data_to_int1_DATA_Packets_EVC_to_DMI *outC)
{
  /* _L6=(TM_conversions::CAST_NID_MN_to_int#1)/ */
