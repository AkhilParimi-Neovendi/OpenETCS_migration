  ...
  outC_brakeBuildUp_SDMConversionModelPkg *outC)
{
  ...
  for (idx = 0; idx < 2; idx++) {
    outC->_L22[idx] = kcg_lit_float32(0.0);
  }
  for (idx1 = 0; idx1 < 2; idx1++) {
  ...
  outC->_L19.trainLength = kcg_lit_int32(0);
  outC->_L19.brakePerctage = kcg_lit_int32(0);
  outC->_L19.maxTrainSpeed = kcg_lit_int32(0);
  ...
  outC->_L19.axleNumber = kcg_lit_int32(0);
  outC->_L19.numberNationalSystems = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 5; idx2++) {
    outC->_L19.nationSystems[idx2] = kcg_lit_int32(0);
  }
  outC->_L19.numberTractionSystems = kcg_lit_int32(0);
  for (idx3 = 0; idx3 < 4; idx3++) {
    outC->_L19.tractionSystem[idx3].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L19.tractionSystem[idx3].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L18 = kcg_lit_float32(0.0);
  for (idx4 = 0; idx4 < 2; idx4++) {
    outC->_L15.emergency[idx4] = kcg_lit_float32(0.0);
  }
  for (idx5 = 0; idx5 < 2; idx5++) {
    outC->_L15.service[idx5] = kcg_lit_float32(0.0);
  }
  for (idx6 = 0; idx6 < 2; idx6++) {
    outC->_L14.emergency[idx6] = kcg_lit_float32(0.0);
  }
  for (idx7 = 0; idx7 < 2; idx7++) {
    outC->_L14.service[idx7] = kcg_lit_float32(0.0);
  }
  for (idx8 = 0; idx8 < 2; idx8++) {
    outC->_L11[idx8] = kcg_lit_float32(0.0);
  }
  for (idx9 = 0; idx9 < 2; idx9++) {
    outC->_L10[idx9] = kcg_lit_float32(0.0);
  }
  ...
  for (idx10 = 0; idx10 < 7; idx10++) {
    ...
    outC->_L1.nid_cArray[idx10].nid_c = kcg_lit_int32(0);
  }
  ...
  for (idx12 = 0; idx12 < 7; idx12++) {
    ...
    outC->_L1.nvkvintsetArray[idx12].a_nvp12 = kcg_lit_float32(0.0);
    outC->_L1.nvkvintsetArray[idx12].a_nvp23 = kcg_lit_float32(0.0);
  ...
  for (idx13 = 0; idx13 < 7; idx13++) {
    ...
    outC->_L1.nvkrintArray[idx13].m_nvkrint = kcg_lit_float32(0.0);
  }
  outC->_L1.m_nvktint = kcg_lit_float32(0.0);
  for (idx14 = 0; idx14 < 2; idx14++) {
    outC->T_b.emergency[idx14] = kcg_lit_float32(0.0);
  }
  for (idx15 = 0; idx15 < 2; idx15++) {
    outC->T_b.service[idx15] = kcg_lit_float32(0.0);
  }
  /* _L15=(SDMConversionModelPkg::brakePosition#1)/ */
