  ...
  outC_C_P139_compr_onboard_TM_conversions *outC)
{
  ...
  kcg_copy_array_int64_6(&outC->_L45, (array_int64_6 *) &outC->_L9[0]);
  ...
  /* _L33=(TM_conversions::CAST_Int_to_V_REVERSE#1)/ */
  CAST_Int_to_V_REVERSE_TM_conversions(
    outC->_L62,
    &outC->Context_CAST_Int_to_V_REVERSE_1);
  outC->_L33 = outC->Context_CAST_Int_to_V_REVERSE_1.v_reverse;
  /* _L31=(TM_conversions::CAST_Int_to_D_REVERSE#1)/ */
  CAST_Int_to_D_REVERSE_TM_conversions(
    outC->_L61,
    &outC->Context_CAST_Int_to_D_REVERSE_1);
  outC->_L31 = outC->Context_CAST_Int_to_D_REVERSE_1.d_reverse;
  outC->_L29 = outC->q_scale_CAST_Int_to_Q_SCALE_1;
  outC->_L21 = kcg_lit_int64(139);
  ...
  outC->_L10.d_reverse = outC->_L31;
  outC->_L10.v_reverse = outC->_L33;
  kcg_copy_P139_OBU_T_TM(&outC->P139_onboard, &outC->_L10);
}

#ifndef KCG_USER_DEFINED_INIT
void C_P139_compr_onboard_init_TM_conversions(
  outC_C_P139_compr_onboard_TM_conversions *outC)
{
  static kcg_size idx;
  ...
  outC->_L10.d_reverse = kcg_lit_int64(0);
  outC->_L10.v_reverse = kcg_lit_int64(0);
  ...
  outC->P139_onboard.valid = kcg_true;
  outC->P139_onboard.q_dir = Q_DIR_Reverse;
  outC->P139_onboard.q_scale = Q_SCALE_10_cm_scale;
  outC->P139_onboard.d_reverse = kcg_lit_int64(0);
  outC->P139_onboard.v_reverse = kcg_lit_int64(0);
  /* _L31=(TM_conversions::CAST_Int_to_D_REVERSE#1)/ */
  CAST_Int_to_D_REVERSE_init_TM_conversions(
    &outC->Context_CAST_Int_to_D_REVERSE_1);
  /* _L33=(TM_conversions::CAST_Int_to_V_REVERSE#1)/ */
  CAST_Int_to_V_REVERSE_init_TM_conversions(
    &outC->Context_CAST_Int_to_V_REVERSE_1);
}
...
void C_P139_compr_onboard_reset_TM_conversions(
  outC_C_P139_compr_onboard_TM_conversions *outC)
{
  /* _L31=(TM_conversions::CAST_Int_to_D_REVERSE#1)/ */
  CAST_Int_to_D_REVERSE_reset_TM_conversions(
    &outC->Context_CAST_Int_to_D_REVERSE_1);
  /* _L33=(TM_conversions::CAST_Int_to_V_REVERSE#1)/ */
  CAST_Int_to_V_REVERSE_reset_TM_conversions(
    &outC->Context_CAST_Int_to_V_REVERSE_1);
}
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

/*
  Expanded instances for: TM_conversions::C_P139_compr_onboard/
