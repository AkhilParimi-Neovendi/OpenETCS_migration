  ...
  outC_Packets_BG353_AmsterdamUtrechtL2_Sheet05_Amstel_Balises *outC)
{
  ...
  for (idx18 = 0; idx18 < 30; idx18++) {
    outC->_L2.PacketHeaders[idx18].nid_packet = kcg_lit_int32(0);
    outC->_L2.PacketHeaders[idx18].q_dir = Q_DIR_Reverse;
    outC->_L2.PacketHeaders[idx18].valid = kcg_true;
    outC->_L2.PacketHeaders[idx18].startAddress = kcg_lit_int32(0);
    outC->_L2.PacketHeaders[idx18].endAddress = kcg_lit_int32(0);
  }
  for (idx19 = 0; idx19 < 500; idx19++) {
    outC->_L2.PacketData[idx19] = kcg_lit_int32(0);
  }
  for (idx20 = 0; idx20 < 30; idx20++) {
    outC->B_data_out.PacketHeaders[idx20].nid_packet = kcg_lit_int32(0);
    outC->B_data_out.PacketHeaders[idx20].q_dir = Q_DIR_Reverse;
    outC->B_data_out.PacketHeaders[idx20].valid = kcg_true;
    outC->B_data_out.PacketHeaders[idx20].startAddress = kcg_lit_int32(0);
    outC->B_data_out.PacketHeaders[idx20].endAddress = kcg_lit_int32(0);
  }
  for (idx21 = 0; idx21 < 500; idx21++) {
    outC->B_data_out.PacketData[idx21] = kcg_lit_int32(0);
  }
  for (idx22 = 0; idx22 < 30; idx22++) {
    outC->B_data_in.PacketHeaders[idx22].nid_packet = kcg_lit_int32(0);
    outC->B_data_in.PacketHeaders[idx22].q_dir = Q_DIR_Reverse;
    outC->B_data_in.PacketHeaders[idx22].valid = kcg_true;
    outC->B_data_in.PacketHeaders[idx22].startAddress = kcg_lit_int32(0);
    outC->B_data_in.PacketHeaders[idx22].endAddress = kcg_lit_int32(0);
  }
  for (idx23 = 0; idx23 < 500; idx23++) {
    outC->B_data_in.PacketData[idx23] = kcg_lit_int32(0);
  }
  ...
  for (idx25 = 0; idx25 < 500; idx25++) {
    outC->Balise_data_out.packets.PacketData[idx25] = kcg_lit_int32(0);
  }
