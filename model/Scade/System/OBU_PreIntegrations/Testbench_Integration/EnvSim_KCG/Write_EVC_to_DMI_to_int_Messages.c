  ...
  outC_Write_EVC_to_DMI_to_int_Messages *outC)
{
  ...
  for (idx5 = 0; idx5 < 32; idx5++) {
    ...
    outC->_L5.EVC_levelData.levelList.levelList[idx5].nid_stm = kcg_lit_int64(0);
  }
  ...
  for (idx7 = 0; idx7 < 999; idx7++) {
    outC->_L4[idx7] = kcg_lit_int64(0);
  }
  outC->_L3 = kcg_true;
  for (idx8 = 0; idx8 < 999; idx8++) {
    outC->_L2[idx8] = kcg_lit_int64(0);
  }
  outC->every = kcg_true;
  for (idx9 = 0; idx9 < 999; idx9++) {
    outC->evc_to_dmi_int[idx9] = kcg_lit_int64(0);
  }
  /* _L2=(Messages::CAST_EVC_to_DMI_to_int#1)/ */
