  ...
  outC_CalculateSafeTrainLength_ProvidePositionReport_Pkg *outC)
{
  ...
  outC->A_Input_Abs_2_int32 = outC->_L20;
  ...
  outC->A_Input_Abs_3_int32 = outC->_L24;
  ...
  outC->_L23 = outC->A_Output_Abs_3_int32;
  outC->minSafeRearEnd = outC->_L23;
  outC->_L22 = outC->A_Output_Abs_2_int32;
  ...
  outC_CalculateSafeTrainLength_ProvidePositionReport_Pkg *outC)
{
  ...
  outC->minSafeRearEnd = kcg_lit_int32(0);
  outC->safeTrainLength = kcg_lit_int32(0);
}
