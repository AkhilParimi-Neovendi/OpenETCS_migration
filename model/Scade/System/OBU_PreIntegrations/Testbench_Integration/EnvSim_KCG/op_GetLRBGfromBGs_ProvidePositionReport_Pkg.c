  ...
  outC_op_GetLRBGfromBGs_ProvidePositionReport_Pkg *outC)
{
  ...
  if ((kcg_lit_int32(0) <= outC->_L15) & (outC->_L15 < kcg_lit_int32(41))) {
    kcg_copy_positionedBG_T_TrainPosition_Types_Pck(
      &outC->_L9,
      &outC->_L1[outC->_L15]);
  }
  ...
  outC_op_GetLRBGfromBGs_ProvidePositionReport_Pkg *outC)
{
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L14.infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L14.infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int32(0);
    outC->_L14.infoFromPassing.linkedBGs[idx1].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L14.infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int32(0);
    outC->_L14.infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int32(0);
    outC->_L14.infoFromPassing.linkedBGs[idx1].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L14.infoFromPassing.linkedBGs[idx1].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L14.infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int32(0);
  }
  ...
  for (idx4 = 0; idx4 < 33; idx4++) {
    ...
    outC->_L7.infoFromPassing.linkedBGs[idx4].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L7.infoFromPassing.linkedBGs[idx4].d_link = kcg_lit_int32(0);
    outC->_L7.infoFromPassing.linkedBGs[idx4].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L7.infoFromPassing.linkedBGs[idx4].nid_c = kcg_lit_int32(0);
    outC->_L7.infoFromPassing.linkedBGs[idx4].nid_bg = kcg_lit_int32(0);
    outC->_L7.infoFromPassing.linkedBGs[idx4].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L7.infoFromPassing.linkedBGs[idx4].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L7.infoFromPassing.linkedBGs[idx4].q_locacc = kcg_lit_int32(0);
  }
  ...
  for (idx6 = 0; idx6 < 41; idx6++) {
    ...
    outC->_L1[idx6].nid_c = kcg_lit_int32(0);
    outC->_L1[idx6].nid_bg = kcg_lit_int32(0);
    outC->_L1[idx6].q_link = Q_LINK_Unlinked;
    outC->_L1[idx6].location.nominal = kcg_lit_int32(0);
    outC->_L1[idx6].location.d_min = kcg_lit_int32(0);
    outC->_L1[idx6].location.d_max = kcg_lit_int32(0);
    outC->_L1[idx6].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L1[idx6].infoFromLinking.valid = kcg_true;
    outC->_L1[idx6].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L1[idx6].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L1[idx6].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L1[idx6].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L1[idx6].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L1[idx6].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L1[idx6].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L1[idx6].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L1[idx6].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L1[idx6].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L1[idx6].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L1[idx6].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L1[idx6].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L1[idx6].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    outC->_L1[idx6].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L1[idx6].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L1[idx6].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L1[idx6].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L1[idx6].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L1[idx6].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L1[idx6].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L1[idx6].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx5 = 0; idx5 < 33; idx5++) {
      ...
      outC->_L1[idx6].infoFromPassing.linkedBGs[idx5].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L1[idx6].infoFromPassing.linkedBGs[idx5].d_link = kcg_lit_int32(0);
      outC->_L1[idx6].infoFromPassing.linkedBGs[idx5].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L1[idx6].infoFromPassing.linkedBGs[idx5].nid_c = kcg_lit_int32(0);
      outC->_L1[idx6].infoFromPassing.linkedBGs[idx5].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L1[idx6].infoFromPassing.linkedBGs[idx5].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L1[idx6].infoFromPassing.linkedBGs[idx5].q_locacc = kcg_lit_int32(0);
    }
  ...
  for (idx9 = 0; idx9 < 33; idx9++) {
    ...
    outC->lrbg.infoFromPassing.linkedBGs[idx9].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->lrbg.infoFromPassing.linkedBGs[idx9].d_link = kcg_lit_int32(0);
    outC->lrbg.infoFromPassing.linkedBGs[idx9].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->lrbg.infoFromPassing.linkedBGs[idx9].nid_c = kcg_lit_int32(0);
    outC->lrbg.infoFromPassing.linkedBGs[idx9].nid_bg = kcg_lit_int32(0);
    outC->lrbg.infoFromPassing.linkedBGs[idx9].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->lrbg.infoFromPassing.linkedBGs[idx9].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->lrbg.infoFromPassing.linkedBGs[idx9].q_locacc = kcg_lit_int32(0);
  }
