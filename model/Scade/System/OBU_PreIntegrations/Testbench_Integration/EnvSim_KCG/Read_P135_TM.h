...
typedef struct {
  ...
  P135_OBU_T_TM /* P135_OBU_out/ */ P135_OBU_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P135_compr_onboard_TM_conversions /* _L166=(TM_conversions::C_P135_compr_onboard#1)/ */ Context_C_P135_compr_onboard_1;
...
extern void Read_P135_init_TM(outC_Read_P135_TM *outC);
