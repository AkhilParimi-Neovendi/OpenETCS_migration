...
void C_compr_P000_init_TM_TrainToTrack(outC_C_compr_P000_TM_TrainToTrack *outC)
{
  ...
  outC->P000_out.nid_packet = kcg_lit_int32(0);
  outC->P000_out.l_packet = kcg_lit_int32(0);
  outC->P000_out.q_scale = Q_SCALE_10_cm_scale;
  outC->P000_out.nid_lrbg = kcg_lit_int32(0);
  outC->P000_out.d_lrbg = kcg_lit_int32(0);
  outC->P000_out.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->P000_out.q_dlrbg = Q_DLRBG_Reverse;
  outC->P000_out.l_doubtover = kcg_lit_int32(0);
  outC->P000_out.l_doubtunder = kcg_lit_int32(0);
  outC->P000_out.q_length = Q_LENGTH_No_train_integrity_information_available;
  outC->P000_out.l_trainint = kcg_lit_int32(0);
  outC->P000_out.v_train = kcg_lit_int32(0);
  ...
  outC->P000_out.nid_ntc = kcg_lit_int32(0);
  /* _L85=(TM_conversions::CAST_Int_to_NID_NTC#1)/ */
