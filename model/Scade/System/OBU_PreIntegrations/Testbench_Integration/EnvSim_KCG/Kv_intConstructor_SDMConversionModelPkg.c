  ...
  outC_Kv_intConstructor_SDMConversionModelPkg *outC)
{
  ...
  if ((kcg_lit_int64(0) <= outC->_L15) & (outC->_L15 < kcg_lit_int64(7))) {
  ...
  if (outC->_L42) {
    ...
    for (idx6 = 0; idx6 < 7; idx6++) {
      ...
      outC->_L39 = /* _L39= */(kcg_int64) (idx6 + 1);
      /* _L39= */
  ...
  outC_Kv_intConstructor_SDMConversionModelPkg *outC)
{
  ...
  for (idx2 = 0; idx2 < 7; idx2++) {
    outC->_L66.m[idx2] = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 7; idx3++) {
    outC->_L66.v[idx3] = kcg_lit_int64(0);
  }
  for (idx4 = 0; idx4 < 13; idx4++) {
    outC->_L59.a[idx4] = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 13; idx5++) {
    outC->_L59.v[idx5] = kcg_lit_int64(0);
  }
  ...
  for (idx7 = 0; idx7 < 7; idx7++) {
    outC->_L46[idx7] = kcg_lit_int64(0);
  }
  for (idx8 = 0; idx8 < 7; idx8++) {
    outC->_L45[idx8] = kcg_lit_int64(0);
  }
  for (idx9 = 0; idx9 < 7; idx9++) {
    outC->_L44[idx9] = kcg_lit_int64(0);
  }
  for (idx10 = 0; idx10 < 7; idx10++) {
    outC->_L43[idx10].valid = kcg_true;
    outC->_L43[idx10].v_nvkvint = kcg_lit_int64(0);
    outC->_L43[idx10].m_nvkvint12 = kcg_lit_float64(0.0);
    outC->_L43[idx10].m_nvkvint23 = kcg_lit_float64(0.0);
  }
  outC->_L42 = kcg_true;
  ...
  for (idx12 = 0; idx12 < 7; idx12++) {
    outC->_L38[idx12] = kcg_lit_int64(0);
  }
  for (idx13 = 0; idx13 < 6; idx13++) {
    outC->_L36.a[idx13] = kcg_lit_int64(0);
  }
  for (idx14 = 0; idx14 < 6; idx14++) {
    outC->_L36.v[idx14] = kcg_lit_int64(0);
  }
  ...
  for (idx16 = 0; idx16 < 5; idx16++) {
    outC->_L33.nationSystems[idx16] = kcg_lit_int64(0);
  }
  ...
  for (idx17 = 0; idx17 < 4; idx17++) {
    ...
    outC->_L33.tractionSystem[idx17].nid_ctraction = kcg_lit_int64(0);
  }
  outC->_L34 =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L32 = kcg_true;
  ...
  for (idx18 = 0; idx18 < 7; idx18++) {
    ...
    outC->_L27.nvkintArray[idx18].v_nvkvint = kcg_lit_int64(0);
    outC->_L27.nvkintArray[idx18].m_nvkvint12 = kcg_lit_float64(0.0);
    outC->_L27.nvkintArray[idx18].m_nvkvint23 = kcg_lit_float64(0.0);
  }
  outC->_L16 = kcg_lit_int64(0);
  outC->_L15 = kcg_lit_int64(0);
  outC->_L14.valid = kcg_true;
  outC->_L14.q_nvkvintset = Q_NVKVINTSET_Freight_trains;
  outC->_L14.a_nvp12 = kcg_lit_float64(0.0);
  outC->_L14.a_nvp23 = kcg_lit_float64(0.0);
  for (idx19 = 0; idx19 < 7; idx19++) {
    outC->_L14.nvkintArray[idx19].valid = kcg_true;
    outC->_L14.nvkintArray[idx19].v_nvkvint = kcg_lit_int64(0);
    outC->_L14.nvkintArray[idx19].m_nvkvint12 = kcg_lit_float64(0.0);
    outC->_L14.nvkintArray[idx19].m_nvkvint23 = kcg_lit_float64(0.0);
  }
  outC->_L12 = kcg_true;
  outC->_L10 = kcg_lit_int64(0);
  ...
  outC->_L4.a_nvmaxredadh1 = kcg_lit_float64(0.0);
  outC->_L4.a_nvmaxredadh2 = kcg_lit_float64(0.0);
  outC->_L4.a_nvmaxredadh3 = kcg_lit_float64(0.0);
  outC->_L4.q_nvlocacc = kcg_lit_int64(0);
  outC->_L4.m_nvavadh = kcg_lit_float64(0.0);
  ...
  for (idx22 = 0; idx22 < 7; idx22++) {
    ...
    outC->_L4.nvkvintsetArray[idx22].a_nvp12 = kcg_lit_float64(0.0);
    outC->_L4.nvkvintsetArray[idx22].a_nvp23 = kcg_lit_float64(0.0);
  ...
  for (idx23 = 0; idx23 < 7; idx23++) {
    ...
    outC->_L4.nvkrintArray[idx23].m_nvkrint = kcg_lit_float64(0.0);
  }
  outC->_L4.m_nvktint = kcg_lit_float64(0.0);
  for (idx25 = 0; idx25 < 7; idx25++) {
    outC->_L6[idx25].valid = kcg_true;
    outC->_L6[idx25].q_nvkvintset = Q_NVKVINTSET_Freight_trains;
    outC->_L6[idx25].a_nvp12 = kcg_lit_float64(0.0);
    outC->_L6[idx25].a_nvp23 = kcg_lit_float64(0.0);
    for (idx24 = 0; idx24 < 7; idx24++) {
      outC->_L6[idx25].nvkintArray[idx24].valid = kcg_true;
      outC->_L6[idx25].nvkintArray[idx24].v_nvkvint = kcg_lit_int64(0);
      outC->_L6[idx25].nvkintArray[idx24].m_nvkvint12 = kcg_lit_float64(0.0);
      outC->_L6[idx25].nvkintArray[idx24].m_nvkvint23 = kcg_lit_float64(0.0);
    }
  }
  for (idx26 = 0; idx26 < 13; idx26++) {
    outC->A_brake_safe.a[idx26] = kcg_lit_int64(0);
  }
  for (idx27 = 0; idx27 < 13; idx27++) {
    outC->A_brake_safe.v[idx27] = kcg_lit_int64(0);
  }
  /* _L59=(SDMConversionModelPkg::Kv_intVectorMapper#1)/ */
