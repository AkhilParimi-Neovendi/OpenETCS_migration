  ...
  outC_C_header_to_M038_TM_RBC_conversions *outC)
{
  ...
  /* _L30=(TM_conversions::CAST_Int_to_NID_MESSAGE#1)/ */
  CAST_Int_to_NID_MESSAGE_TM_conversions(
    outC->_L3,
    &outC->Context_CAST_Int_to_NID_MESSAGE_1);
  outC->_L30 = outC->Context_CAST_Int_to_NID_MESSAGE_1.nid_message;
...
void C_header_to_M038_init_TM_RBC_conversions(
  outC_C_header_to_M038_TM_RBC_conversions *outC)
{
