  ...
  outC_findLinkedBGs_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  ...
  static linkedBG_index_T_CalculateTrainPosition_Pkg_BG_relocation_Pkg acc3;
  ...
  outC_findLinkedBGs_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  ...
  for (idx2 = 0; idx2 < 41; idx2++) {
    outC->_L32[idx2].previousLinkedBG_idx = kcg_lit_int64(0);
    outC->_L32[idx2].currentIndex = kcg_lit_int64(0);
    outC->_L32[idx2].subsequentLinkedBG_idx = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 41; idx3++) {
    outC->_L31[idx3].previousLinkedBG_idx = kcg_lit_int64(0);
    outC->_L31[idx3].currentIndex = kcg_lit_int64(0);
    outC->_L31[idx3].subsequentLinkedBG_idx = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 41; idx5++) {
    outC->_L30[idx5].valid = kcg_true;
    outC->_L30[idx5].nid_c = kcg_lit_int64(0);
    outC->_L30[idx5].nid_bg = kcg_lit_int64(0);
    outC->_L30[idx5].q_link = Q_LINK_Unlinked;
    outC->_L30[idx5].location.nominal = kcg_lit_int64(0);
    outC->_L30[idx5].location.d_min = kcg_lit_int64(0);
    outC->_L30[idx5].location.d_max = kcg_lit_int64(0);
    outC->_L30[idx5].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L30[idx5].infoFromLinking.valid = kcg_true;
    outC->_L30[idx5].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L30[idx5].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L30[idx5].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L30[idx5].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L30[idx5].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L30[idx5].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L30[idx5].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L30[idx5].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L30[idx5].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L30[idx5].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L30[idx5].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L30[idx5].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L30[idx5].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L30[idx5].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L30[idx5].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L30[idx5].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L30[idx5].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L30[idx5].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L30[idx5].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L30[idx5].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx4 = 0; idx4 < 33; idx4++) {
      ...
      outC->_L30[idx5].infoFromPassing.linkedBGs[idx4].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L30[idx5].infoFromPassing.linkedBGs[idx4].d_link = kcg_lit_int64(0);
      outC->_L30[idx5].infoFromPassing.linkedBGs[idx4].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L30[idx5].infoFromPassing.linkedBGs[idx4].nid_c = kcg_lit_int64(0);
      outC->_L30[idx5].infoFromPassing.linkedBGs[idx4].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L30[idx5].infoFromPassing.linkedBGs[idx4].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L30[idx5].infoFromPassing.linkedBGs[idx4].q_locacc = kcg_lit_int64(0);
    }
    outC->_L30[idx5].missed = kcg_true;
  }
  outC->_L28.previousLinkedBG_idx = kcg_lit_int64(0);
  outC->_L28.currentIndex = kcg_lit_int64(0);
  outC->_L28.subsequentLinkedBG_idx = kcg_lit_int64(0);
  for (idx6 = 0; idx6 < 41; idx6++) {
    outC->_L29[idx6].previousLinkedBG_idx = kcg_lit_int64(0);
    outC->_L29[idx6].currentIndex = kcg_lit_int64(0);
    outC->_L29[idx6].subsequentLinkedBG_idx = kcg_lit_int64(0);
  }
  for (idx8 = 0; idx8 < 41; idx8++) {
    outC->_L26[idx8].valid = kcg_true;
    outC->_L26[idx8].nid_c = kcg_lit_int64(0);
    outC->_L26[idx8].nid_bg = kcg_lit_int64(0);
    outC->_L26[idx8].q_link = Q_LINK_Unlinked;
    outC->_L26[idx8].location.nominal = kcg_lit_int64(0);
    outC->_L26[idx8].location.d_min = kcg_lit_int64(0);
    outC->_L26[idx8].location.d_max = kcg_lit_int64(0);
    outC->_L26[idx8].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L26[idx8].infoFromLinking.valid = kcg_true;
    outC->_L26[idx8].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L26[idx8].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L26[idx8].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L26[idx8].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L26[idx8].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L26[idx8].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L26[idx8].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L26[idx8].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L26[idx8].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L26[idx8].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L26[idx8].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L26[idx8].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L26[idx8].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L26[idx8].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    outC->_L26[idx8].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L26[idx8].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L26[idx8].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L26[idx8].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L26[idx8].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L26[idx8].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L26[idx8].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L26[idx8].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L26[idx8].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx7 = 0; idx7 < 33; idx7++) {
      ...
      outC->_L26[idx8].infoFromPassing.linkedBGs[idx7].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L26[idx8].infoFromPassing.linkedBGs[idx7].d_link = kcg_lit_int64(0);
      outC->_L26[idx8].infoFromPassing.linkedBGs[idx7].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L26[idx8].infoFromPassing.linkedBGs[idx7].nid_c = kcg_lit_int64(0);
      outC->_L26[idx8].infoFromPassing.linkedBGs[idx7].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L26[idx8].infoFromPassing.linkedBGs[idx7].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L26[idx8].infoFromPassing.linkedBGs[idx7].q_locacc = kcg_lit_int64(0);
    }
  ...
  outC->_L23.previousLinkedBG_idx = kcg_lit_int64(0);
  outC->_L23.currentIndex = kcg_lit_int64(0);
  outC->_L23.subsequentLinkedBG_idx = kcg_lit_int64(0);
  for (idx9 = 0; idx9 < 41; idx9++) {
    outC->_L24[idx9].previousLinkedBG_idx = kcg_lit_int64(0);
    outC->_L24[idx9].currentIndex = kcg_lit_int64(0);
    outC->_L24[idx9].subsequentLinkedBG_idx = kcg_lit_int64(0);
  }
  for (idx10 = 0; idx10 < 41; idx10++) {
    outC->BGs_indices[idx10].previousLinkedBG_idx = kcg_lit_int64(0);
    outC->BGs_indices[idx10].currentIndex = kcg_lit_int64(0);
    outC->BGs_indices[idx10].subsequentLinkedBG_idx = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 41; idx1++) {
    /* _L28=(CalculateTrainPosition_Pkg::BG_relocation_Pkg::findLinkedBG_bckwd_itr#1)/ */
