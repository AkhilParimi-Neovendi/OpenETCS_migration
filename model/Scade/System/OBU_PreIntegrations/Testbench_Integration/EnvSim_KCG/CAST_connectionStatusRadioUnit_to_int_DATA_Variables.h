...
typedef struct {
  ...
  kcg_int64 /* IfBlock1:else:else:else:else:_L1/ */ _L1_else_else_else_else_IfBlock1;
  ...
  kcg_bool /* _L1/ */ _L1;
} outC_CAST_connectionStatusRadioUnit_to_int_DATA_Variables;

/* ===========  node initialization and cycle functions  =========== */
/* DATA::Variables::CAST_connectionStatusRadioUnit_to_int/ */
extern void CAST_connectionStatusRadioUnit_to_int_DATA_Variables(
...
extern void CAST_connectionStatusRadioUnit_to_int_reset_DATA_Variables(
  outC_CAST_connectionStatusRadioUnit_to_int_DATA_Variables *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CAST_connectionStatusRadioUnit_to_int_init_DATA_Variables(
  outC_CAST_connectionStatusRadioUnit_to_int_DATA_Variables *outC);
