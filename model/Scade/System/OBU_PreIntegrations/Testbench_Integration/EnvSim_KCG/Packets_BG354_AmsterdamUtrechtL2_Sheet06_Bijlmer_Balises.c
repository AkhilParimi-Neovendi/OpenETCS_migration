  ...
  outC_Packets_BG354_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises *outC)
{
  ...
  for (idx16 = 0; idx16 < 30; idx16++) {
    outC->_L5.PacketHeaders[idx16].nid_packet = kcg_lit_int32(0);
    outC->_L5.PacketHeaders[idx16].q_dir = Q_DIR_Reverse;
    outC->_L5.PacketHeaders[idx16].valid = kcg_true;
    outC->_L5.PacketHeaders[idx16].startAddress = kcg_lit_int32(0);
    outC->_L5.PacketHeaders[idx16].endAddress = kcg_lit_int32(0);
  }
  for (idx17 = 0; idx17 < 500; idx17++) {
    outC->_L5.PacketData[idx17] = kcg_lit_int32(0);
  }
  for (idx18 = 0; idx18 < 30; idx18++) {
    outC->_L4.PacketHeaders[idx18].nid_packet = kcg_lit_int32(0);
    outC->_L4.PacketHeaders[idx18].q_dir = Q_DIR_Reverse;
    outC->_L4.PacketHeaders[idx18].valid = kcg_true;
    outC->_L4.PacketHeaders[idx18].startAddress = kcg_lit_int32(0);
    outC->_L4.PacketHeaders[idx18].endAddress = kcg_lit_int32(0);
  }
  for (idx19 = 0; idx19 < 500; idx19++) {
    outC->_L4.PacketData[idx19] = kcg_lit_int32(0);
  }
  for (idx20 = 0; idx20 < 30; idx20++) {
    outC->_L3.PacketHeaders[idx20].nid_packet = kcg_lit_int32(0);
    outC->_L3.PacketHeaders[idx20].q_dir = Q_DIR_Reverse;
    outC->_L3.PacketHeaders[idx20].valid = kcg_true;
    outC->_L3.PacketHeaders[idx20].startAddress = kcg_lit_int32(0);
    outC->_L3.PacketHeaders[idx20].endAddress = kcg_lit_int32(0);
  }
  for (idx21 = 0; idx21 < 500; idx21++) {
    outC->_L3.PacketData[idx21] = kcg_lit_int32(0);
  }
  for (idx22 = 0; idx22 < 30; idx22++) {
    outC->_L2.PacketHeaders[idx22].nid_packet = kcg_lit_int32(0);
    outC->_L2.PacketHeaders[idx22].q_dir = Q_DIR_Reverse;
    outC->_L2.PacketHeaders[idx22].valid = kcg_true;
    outC->_L2.PacketHeaders[idx22].startAddress = kcg_lit_int32(0);
    outC->_L2.PacketHeaders[idx22].endAddress = kcg_lit_int32(0);
  }
  for (idx23 = 0; idx23 < 500; idx23++) {
    outC->_L2.PacketData[idx23] = kcg_lit_int32(0);
  }
  for (idx24 = 0; idx24 < 30; idx24++) {
    outC->B_data_out.PacketHeaders[idx24].nid_packet = kcg_lit_int32(0);
    outC->B_data_out.PacketHeaders[idx24].q_dir = Q_DIR_Reverse;
    outC->B_data_out.PacketHeaders[idx24].valid = kcg_true;
    outC->B_data_out.PacketHeaders[idx24].startAddress = kcg_lit_int32(0);
    outC->B_data_out.PacketHeaders[idx24].endAddress = kcg_lit_int32(0);
  }
  for (idx25 = 0; idx25 < 500; idx25++) {
    outC->B_data_out.PacketData[idx25] = kcg_lit_int32(0);
  }
  for (idx26 = 0; idx26 < 30; idx26++) {
    outC->B_data_in.PacketHeaders[idx26].nid_packet = kcg_lit_int32(0);
    outC->B_data_in.PacketHeaders[idx26].q_dir = Q_DIR_Reverse;
    outC->B_data_in.PacketHeaders[idx26].valid = kcg_true;
    outC->B_data_in.PacketHeaders[idx26].startAddress = kcg_lit_int32(0);
    outC->B_data_in.PacketHeaders[idx26].endAddress = kcg_lit_int32(0);
  }
  for (idx27 = 0; idx27 < 500; idx27++) {
    outC->B_data_in.PacketData[idx27] = kcg_lit_int32(0);
  }
  ...
  for (idx29 = 0; idx29 < 500; idx29++) {
    outC->Balise_data_out.packets.PacketData[idx29] = kcg_lit_int32(0);
  }
