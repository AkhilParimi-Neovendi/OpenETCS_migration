...
void SP_TSR_init_TA_SpeedProfiles(outC_SP_TSR_TA_SpeedProfiles *outC)
{
  static kcg_size idx;
  ...
  for (idx = 0; idx < 50; idx++) {
    outC->_L2[idx].target = kcg_lit_int64(0);
    outC->_L2[idx].speed = kcg_lit_int64(0);
  }
  ...
  for (idx3 = 0; idx3 < 50; idx3++) {
    outC->TSR[idx3].target = kcg_lit_int64(0);
    outC->TSR[idx3].speed = kcg_lit_int64(0);
  }
}
...
void SP_TSR_reset_TA_SpeedProfiles(outC_SP_TSR_TA_SpeedProfiles *outC)
{
}
