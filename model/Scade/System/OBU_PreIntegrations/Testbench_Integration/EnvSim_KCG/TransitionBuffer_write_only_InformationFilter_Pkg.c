  ...
  outC_TransitionBuffer_write_only_InformationFilter_Pkg *outC)
{
  ...
  kcg_copy__77_array(&outC->_L7, (_77_array *) &outC->_L14[0]);
  /* _L3/ */
  for (idx = 0; idx < 1; idx++) {
  ...
  kcg_copy__77_array(&outC->_L8[1], &outC->_L7);
  kcg_copy_TransitionBuffer_T_InformationFilter_Pkg(
    &outC->Buffer_Out,
    &outC->_L8);
  outC->_L4 = DIM_TransitionBuffer_InformationFilter_Pkg;
  outC->_L1 = kcg_lit_int64(1);
  ...
  outC_TransitionBuffer_write_only_InformationFilter_Pkg *outC)
{
  ...
  for (idx2 = 0; idx2 < 3; idx2++) {
    ...
    outC->_L15[idx2].BG_Common_Header.m_mcount = kcg_lit_int64(0);
    outC->_L15[idx2].BG_Common_Header.nid_c = kcg_lit_int64(0);
    outC->_L15[idx2].BG_Common_Header.nid_bg = kcg_lit_int64(0);
    outC->_L15[idx2].BG_Common_Header.q_link = Q_LINK_Unlinked;
    outC->_L15[idx2].BG_Common_Header.bgPosition.valid = kcg_true;
    outC->_L15[idx2].BG_Common_Header.bgPosition.timestamp = kcg_lit_int64(0);
    outC->_L15[idx2].BG_Common_Header.bgPosition.odo.o_nominal = kcg_lit_int64(0);
    outC->_L15[idx2].BG_Common_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
    outC->_L15[idx2].BG_Common_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
    ...
    outC->_L15[idx2].BG_Common_Header.bgPosition.speed.v_rawNominal =
      kcg_lit_int64(0);
    outC->_L15[idx2].BG_Common_Header.bgPosition.speed.v_lower = kcg_lit_int64(0);
    outC->_L15[idx2].BG_Common_Header.bgPosition.speed.v_upper = kcg_lit_int64(0);
    outC->_L15[idx2].BG_Common_Header.bgPosition.acceleration = kcg_lit_int64(0);
    ...
    outC->_L15[idx2].BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L15[idx2].BG_Common_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    outC->_L15[idx2].BG_Common_Header.trainRunningDirectionToBG =
      Q_DIRTRAIN_Reverse;
    outC->_L15[idx2].Radio_Common_Header.radioDevice = kcg_lit_int64(0);
    outC->_L15[idx2].Radio_Common_Header.receivedSystemTime = kcg_lit_int64(0);
    outC->_L15[idx2].Radio_Common_Header.nid_message = kcg_lit_int64(0);
    outC->_L15[idx2].Radio_Common_Header.t_train = kcg_lit_int64(0);
    outC->_L15[idx2].Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_required;
    outC->_L15[idx2].Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L15[idx2].Radio_Common_Header.t_train_reference = kcg_lit_int64(0);
    outC->_L15[idx2].Radio_Common_Header.nid_em = kcg_lit_int64(0);
    outC->_L15[idx2].Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
    outC->_L15[idx2].Radio_Common_Header.d_sr = kcg_lit_int64(0);
    outC->_L15[idx2].Radio_Common_Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L15[idx2].Radio_Common_Header.d_ref = kcg_lit_int64(0);
    outC->_L15[idx2].Radio_Common_Header.q_dir = Q_DIR_Reverse;
    outC->_L15[idx2].Radio_Common_Header.d_emergencystop = kcg_lit_int64(0);
    outC->_L15[idx2].Radio_Common_Header.m_version =
      M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
    for (idx = 0; idx < 30; idx++) {
      outC->_L15[idx2].packets.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
      outC->_L15[idx2].packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
      outC->_L15[idx2].packets.PacketHeaders[idx].valid = kcg_true;
      outC->_L15[idx2].packets.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
      outC->_L15[idx2].packets.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
    }
    for (idx1 = 0; idx1 < 500; idx1++) {
      outC->_L15[idx2].packets.PacketData[idx1] = kcg_lit_int64(0);
    }
    outC->_L15[idx2].sendingRBC.valid = kcg_true;
    outC->_L15[idx2].sendingRBC.nid_c = kcg_lit_int64(0);
    outC->_L15[idx2].sendingRBC.rbc_id = kcg_lit_int64(0);
    outC->_L15[idx2].sendingRBC.device_id = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 3; idx5++) {
    ...
    outC->_L14[idx5].BG_Common_Header.m_mcount = kcg_lit_int64(0);
    outC->_L14[idx5].BG_Common_Header.nid_c = kcg_lit_int64(0);
    outC->_L14[idx5].BG_Common_Header.nid_bg = kcg_lit_int64(0);
    outC->_L14[idx5].BG_Common_Header.q_link = Q_LINK_Unlinked;
    outC->_L14[idx5].BG_Common_Header.bgPosition.valid = kcg_true;
    outC->_L14[idx5].BG_Common_Header.bgPosition.timestamp = kcg_lit_int64(0);
    outC->_L14[idx5].BG_Common_Header.bgPosition.odo.o_nominal = kcg_lit_int64(0);
    outC->_L14[idx5].BG_Common_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
    outC->_L14[idx5].BG_Common_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
    ...
    outC->_L14[idx5].BG_Common_Header.bgPosition.speed.v_rawNominal =
      kcg_lit_int64(0);
    outC->_L14[idx5].BG_Common_Header.bgPosition.speed.v_lower = kcg_lit_int64(0);
    outC->_L14[idx5].BG_Common_Header.bgPosition.speed.v_upper = kcg_lit_int64(0);
    outC->_L14[idx5].BG_Common_Header.bgPosition.acceleration = kcg_lit_int64(0);
    ...
    outC->_L14[idx5].BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L14[idx5].BG_Common_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    outC->_L14[idx5].BG_Common_Header.trainRunningDirectionToBG =
      Q_DIRTRAIN_Reverse;
    outC->_L14[idx5].Radio_Common_Header.radioDevice = kcg_lit_int64(0);
    outC->_L14[idx5].Radio_Common_Header.receivedSystemTime = kcg_lit_int64(0);
    outC->_L14[idx5].Radio_Common_Header.nid_message = kcg_lit_int64(0);
    outC->_L14[idx5].Radio_Common_Header.t_train = kcg_lit_int64(0);
    outC->_L14[idx5].Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_required;
    outC->_L14[idx5].Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L14[idx5].Radio_Common_Header.t_train_reference = kcg_lit_int64(0);
    outC->_L14[idx5].Radio_Common_Header.nid_em = kcg_lit_int64(0);
    outC->_L14[idx5].Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
    outC->_L14[idx5].Radio_Common_Header.d_sr = kcg_lit_int64(0);
    outC->_L14[idx5].Radio_Common_Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L14[idx5].Radio_Common_Header.d_ref = kcg_lit_int64(0);
    outC->_L14[idx5].Radio_Common_Header.q_dir = Q_DIR_Reverse;
    outC->_L14[idx5].Radio_Common_Header.d_emergencystop = kcg_lit_int64(0);
    outC->_L14[idx5].Radio_Common_Header.m_version =
      M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
    for (idx3 = 0; idx3 < 30; idx3++) {
      outC->_L14[idx5].packets.PacketHeaders[idx3].nid_packet = kcg_lit_int64(0);
      outC->_L14[idx5].packets.PacketHeaders[idx3].q_dir = Q_DIR_Reverse;
      outC->_L14[idx5].packets.PacketHeaders[idx3].valid = kcg_true;
      outC->_L14[idx5].packets.PacketHeaders[idx3].startAddress = kcg_lit_int64(0);
      outC->_L14[idx5].packets.PacketHeaders[idx3].endAddress = kcg_lit_int64(0);
    }
    for (idx4 = 0; idx4 < 500; idx4++) {
      outC->_L14[idx5].packets.PacketData[idx4] = kcg_lit_int64(0);
    }
    outC->_L14[idx5].sendingRBC.valid = kcg_true;
    outC->_L14[idx5].sendingRBC.nid_c = kcg_lit_int64(0);
    outC->_L14[idx5].sendingRBC.rbc_id = kcg_lit_int64(0);
    outC->_L14[idx5].sendingRBC.device_id = kcg_lit_int64(0);
  }
  outC->_L13 = kcg_true;
  ...
  for (idx8 = 0; idx8 < 1; idx8++) {
    ...
    outC->_L3[idx8].BG_Common_Header.m_mcount = kcg_lit_int64(0);
    outC->_L3[idx8].BG_Common_Header.nid_c = kcg_lit_int64(0);
    outC->_L3[idx8].BG_Common_Header.nid_bg = kcg_lit_int64(0);
    outC->_L3[idx8].BG_Common_Header.q_link = Q_LINK_Unlinked;
    outC->_L3[idx8].BG_Common_Header.bgPosition.valid = kcg_true;
    outC->_L3[idx8].BG_Common_Header.bgPosition.timestamp = kcg_lit_int64(0);
    outC->_L3[idx8].BG_Common_Header.bgPosition.odo.o_nominal = kcg_lit_int64(0);
    outC->_L3[idx8].BG_Common_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
    outC->_L3[idx8].BG_Common_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
    ...
    outC->_L3[idx8].BG_Common_Header.bgPosition.speed.v_rawNominal =
      kcg_lit_int64(0);
    outC->_L3[idx8].BG_Common_Header.bgPosition.speed.v_lower = kcg_lit_int64(0);
    outC->_L3[idx8].BG_Common_Header.bgPosition.speed.v_upper = kcg_lit_int64(0);
    outC->_L3[idx8].BG_Common_Header.bgPosition.acceleration = kcg_lit_int64(0);
    ...
    outC->_L3[idx8].BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L3[idx8].BG_Common_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    outC->_L3[idx8].Radio_Common_Header.radioDevice = kcg_lit_int64(0);
    outC->_L3[idx8].Radio_Common_Header.receivedSystemTime = kcg_lit_int64(0);
    outC->_L3[idx8].Radio_Common_Header.nid_message = kcg_lit_int64(0);
    outC->_L3[idx8].Radio_Common_Header.t_train = kcg_lit_int64(0);
    outC->_L3[idx8].Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_required;
    outC->_L3[idx8].Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L3[idx8].Radio_Common_Header.t_train_reference = kcg_lit_int64(0);
    outC->_L3[idx8].Radio_Common_Header.nid_em = kcg_lit_int64(0);
    outC->_L3[idx8].Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
    outC->_L3[idx8].Radio_Common_Header.d_sr = kcg_lit_int64(0);
    outC->_L3[idx8].Radio_Common_Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L3[idx8].Radio_Common_Header.d_ref = kcg_lit_int64(0);
    outC->_L3[idx8].Radio_Common_Header.q_dir = Q_DIR_Reverse;
    outC->_L3[idx8].Radio_Common_Header.d_emergencystop = kcg_lit_int64(0);
    outC->_L3[idx8].Radio_Common_Header.m_version =
      M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
    for (idx6 = 0; idx6 < 30; idx6++) {
      outC->_L3[idx8].packets.PacketHeaders[idx6].nid_packet = kcg_lit_int64(0);
      outC->_L3[idx8].packets.PacketHeaders[idx6].q_dir = Q_DIR_Reverse;
      outC->_L3[idx8].packets.PacketHeaders[idx6].valid = kcg_true;
      outC->_L3[idx8].packets.PacketHeaders[idx6].startAddress = kcg_lit_int64(0);
      outC->_L3[idx8].packets.PacketHeaders[idx6].endAddress = kcg_lit_int64(0);
    }
    for (idx7 = 0; idx7 < 500; idx7++) {
      outC->_L3[idx8].packets.PacketData[idx7] = kcg_lit_int64(0);
    }
    outC->_L3[idx8].sendingRBC.valid = kcg_true;
    outC->_L3[idx8].sendingRBC.nid_c = kcg_lit_int64(0);
    outC->_L3[idx8].sendingRBC.rbc_id = kcg_lit_int64(0);
    outC->_L3[idx8].sendingRBC.device_id = kcg_lit_int64(0);
  }
  ...
  outC->_L6.BG_Common_Header.m_mcount = kcg_lit_int64(0);
  outC->_L6.BG_Common_Header.nid_c = kcg_lit_int64(0);
  outC->_L6.BG_Common_Header.nid_bg = kcg_lit_int64(0);
  outC->_L6.BG_Common_Header.q_link = Q_LINK_Unlinked;
  outC->_L6.BG_Common_Header.bgPosition.valid = kcg_true;
  outC->_L6.BG_Common_Header.bgPosition.timestamp = kcg_lit_int64(0);
  outC->_L6.BG_Common_Header.bgPosition.odo.o_nominal = kcg_lit_int64(0);
  outC->_L6.BG_Common_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->_L6.BG_Common_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
  outC->_L6.BG_Common_Header.bgPosition.speed.v_safeNominal = kcg_lit_int64(0);
  outC->_L6.BG_Common_Header.bgPosition.speed.v_rawNominal = kcg_lit_int64(0);
  outC->_L6.BG_Common_Header.bgPosition.speed.v_lower = kcg_lit_int64(0);
  outC->_L6.BG_Common_Header.bgPosition.speed.v_upper = kcg_lit_int64(0);
  outC->_L6.BG_Common_Header.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->_L6.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L6.BG_Common_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  outC->_L6.Radio_Common_Header.radioDevice = kcg_lit_int64(0);
  outC->_L6.Radio_Common_Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L6.Radio_Common_Header.nid_message = kcg_lit_int64(0);
  outC->_L6.Radio_Common_Header.t_train = kcg_lit_int64(0);
  outC->_L6.Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_required;
  outC->_L6.Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L6.Radio_Common_Header.t_train_reference = kcg_lit_int64(0);
  outC->_L6.Radio_Common_Header.nid_em = kcg_lit_int64(0);
  outC->_L6.Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L6.Radio_Common_Header.d_sr = kcg_lit_int64(0);
  outC->_L6.Radio_Common_Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L6.Radio_Common_Header.d_ref = kcg_lit_int64(0);
  outC->_L6.Radio_Common_Header.q_dir = Q_DIR_Reverse;
  outC->_L6.Radio_Common_Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L6.Radio_Common_Header.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  for (idx9 = 0; idx9 < 30; idx9++) {
    outC->_L6.packets.PacketHeaders[idx9].nid_packet = kcg_lit_int64(0);
    outC->_L6.packets.PacketHeaders[idx9].q_dir = Q_DIR_Reverse;
    outC->_L6.packets.PacketHeaders[idx9].valid = kcg_true;
    outC->_L6.packets.PacketHeaders[idx9].startAddress = kcg_lit_int64(0);
    outC->_L6.packets.PacketHeaders[idx9].endAddress = kcg_lit_int64(0);
  }
  for (idx10 = 0; idx10 < 500; idx10++) {
    outC->_L6.packets.PacketData[idx10] = kcg_lit_int64(0);
  }
  outC->_L6.sendingRBC.valid = kcg_true;
  outC->_L6.sendingRBC.nid_c = kcg_lit_int64(0);
  outC->_L6.sendingRBC.rbc_id = kcg_lit_int64(0);
  outC->_L6.sendingRBC.device_id = kcg_lit_int64(0);
  for (idx13 = 0; idx13 < 2; idx13++) {
    ...
    outC->_L7[idx13].BG_Common_Header.m_mcount = kcg_lit_int64(0);
    outC->_L7[idx13].BG_Common_Header.nid_c = kcg_lit_int64(0);
    outC->_L7[idx13].BG_Common_Header.nid_bg = kcg_lit_int64(0);
    outC->_L7[idx13].BG_Common_Header.q_link = Q_LINK_Unlinked;
    outC->_L7[idx13].BG_Common_Header.bgPosition.valid = kcg_true;
    outC->_L7[idx13].BG_Common_Header.bgPosition.timestamp = kcg_lit_int64(0);
    outC->_L7[idx13].BG_Common_Header.bgPosition.odo.o_nominal = kcg_lit_int64(0);
    outC->_L7[idx13].BG_Common_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
    outC->_L7[idx13].BG_Common_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
    ...
    outC->_L7[idx13].BG_Common_Header.bgPosition.speed.v_rawNominal =
      kcg_lit_int64(0);
    outC->_L7[idx13].BG_Common_Header.bgPosition.speed.v_lower = kcg_lit_int64(0);
    outC->_L7[idx13].BG_Common_Header.bgPosition.speed.v_upper = kcg_lit_int64(0);
    outC->_L7[idx13].BG_Common_Header.bgPosition.acceleration = kcg_lit_int64(0);
    ...
    outC->_L7[idx13].BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L7[idx13].BG_Common_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    outC->_L7[idx13].BG_Common_Header.trainRunningDirectionToBG =
      Q_DIRTRAIN_Reverse;
    outC->_L7[idx13].Radio_Common_Header.radioDevice = kcg_lit_int64(0);
    outC->_L7[idx13].Radio_Common_Header.receivedSystemTime = kcg_lit_int64(0);
    outC->_L7[idx13].Radio_Common_Header.nid_message = kcg_lit_int64(0);
    outC->_L7[idx13].Radio_Common_Header.t_train = kcg_lit_int64(0);
    outC->_L7[idx13].Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_required;
    outC->_L7[idx13].Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L7[idx13].Radio_Common_Header.t_train_reference = kcg_lit_int64(0);
    outC->_L7[idx13].Radio_Common_Header.nid_em = kcg_lit_int64(0);
    outC->_L7[idx13].Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
    outC->_L7[idx13].Radio_Common_Header.d_sr = kcg_lit_int64(0);
    outC->_L7[idx13].Radio_Common_Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L7[idx13].Radio_Common_Header.d_ref = kcg_lit_int64(0);
    outC->_L7[idx13].Radio_Common_Header.q_dir = Q_DIR_Reverse;
    outC->_L7[idx13].Radio_Common_Header.d_emergencystop = kcg_lit_int64(0);
    outC->_L7[idx13].Radio_Common_Header.m_version =
      M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
    for (idx11 = 0; idx11 < 30; idx11++) {
      outC->_L7[idx13].packets.PacketHeaders[idx11].nid_packet = kcg_lit_int64(0);
      outC->_L7[idx13].packets.PacketHeaders[idx11].q_dir = Q_DIR_Reverse;
      outC->_L7[idx13].packets.PacketHeaders[idx11].valid = kcg_true;
      outC->_L7[idx13].packets.PacketHeaders[idx11].startAddress = kcg_lit_int64(0);
      outC->_L7[idx13].packets.PacketHeaders[idx11].endAddress = kcg_lit_int64(0);
    }
    for (idx12 = 0; idx12 < 500; idx12++) {
      outC->_L7[idx13].packets.PacketData[idx12] = kcg_lit_int64(0);
    }
    outC->_L7[idx13].sendingRBC.valid = kcg_true;
    outC->_L7[idx13].sendingRBC.nid_c = kcg_lit_int64(0);
    outC->_L7[idx13].sendingRBC.rbc_id = kcg_lit_int64(0);
    outC->_L7[idx13].sendingRBC.device_id = kcg_lit_int64(0);
  }
  for (idx16 = 0; idx16 < 3; idx16++) {
    ...
    outC->_L8[idx16].BG_Common_Header.m_mcount = kcg_lit_int64(0);
    outC->_L8[idx16].BG_Common_Header.nid_c = kcg_lit_int64(0);
    outC->_L8[idx16].BG_Common_Header.nid_bg = kcg_lit_int64(0);
    outC->_L8[idx16].BG_Common_Header.q_link = Q_LINK_Unlinked;
    outC->_L8[idx16].BG_Common_Header.bgPosition.valid = kcg_true;
    outC->_L8[idx16].BG_Common_Header.bgPosition.timestamp = kcg_lit_int64(0);
    outC->_L8[idx16].BG_Common_Header.bgPosition.odo.o_nominal = kcg_lit_int64(0);
    outC->_L8[idx16].BG_Common_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
    outC->_L8[idx16].BG_Common_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
    ...
    outC->_L8[idx16].BG_Common_Header.bgPosition.speed.v_rawNominal =
      kcg_lit_int64(0);
    outC->_L8[idx16].BG_Common_Header.bgPosition.speed.v_lower = kcg_lit_int64(0);
    outC->_L8[idx16].BG_Common_Header.bgPosition.speed.v_upper = kcg_lit_int64(0);
    outC->_L8[idx16].BG_Common_Header.bgPosition.acceleration = kcg_lit_int64(0);
    ...
    outC->_L8[idx16].BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L8[idx16].BG_Common_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    outC->_L8[idx16].BG_Common_Header.trainRunningDirectionToBG =
      Q_DIRTRAIN_Reverse;
    outC->_L8[idx16].Radio_Common_Header.radioDevice = kcg_lit_int64(0);
    outC->_L8[idx16].Radio_Common_Header.receivedSystemTime = kcg_lit_int64(0);
    outC->_L8[idx16].Radio_Common_Header.nid_message = kcg_lit_int64(0);
    outC->_L8[idx16].Radio_Common_Header.t_train = kcg_lit_int64(0);
    outC->_L8[idx16].Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_required;
    outC->_L8[idx16].Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L8[idx16].Radio_Common_Header.t_train_reference = kcg_lit_int64(0);
    outC->_L8[idx16].Radio_Common_Header.nid_em = kcg_lit_int64(0);
    outC->_L8[idx16].Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
    outC->_L8[idx16].Radio_Common_Header.d_sr = kcg_lit_int64(0);
    outC->_L8[idx16].Radio_Common_Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L8[idx16].Radio_Common_Header.d_ref = kcg_lit_int64(0);
    outC->_L8[idx16].Radio_Common_Header.q_dir = Q_DIR_Reverse;
    outC->_L8[idx16].Radio_Common_Header.d_emergencystop = kcg_lit_int64(0);
    outC->_L8[idx16].Radio_Common_Header.m_version =
      M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
    for (idx14 = 0; idx14 < 30; idx14++) {
      outC->_L8[idx16].packets.PacketHeaders[idx14].nid_packet = kcg_lit_int64(0);
      outC->_L8[idx16].packets.PacketHeaders[idx14].q_dir = Q_DIR_Reverse;
      outC->_L8[idx16].packets.PacketHeaders[idx14].valid = kcg_true;
      outC->_L8[idx16].packets.PacketHeaders[idx14].startAddress = kcg_lit_int64(0);
      outC->_L8[idx16].packets.PacketHeaders[idx14].endAddress = kcg_lit_int64(0);
    }
    for (idx15 = 0; idx15 < 500; idx15++) {
      outC->_L8[idx16].packets.PacketData[idx15] = kcg_lit_int64(0);
    }
    outC->_L8[idx16].sendingRBC.valid = kcg_true;
    outC->_L8[idx16].sendingRBC.nid_c = kcg_lit_int64(0);
    outC->_L8[idx16].sendingRBC.rbc_id = kcg_lit_int64(0);
    outC->_L8[idx16].sendingRBC.device_id = kcg_lit_int64(0);
  }
  for (idx19 = 0; idx19 < 3; idx19++) {
    ...
    outC->_L9[idx19].BG_Common_Header.m_mcount = kcg_lit_int64(0);
    outC->_L9[idx19].BG_Common_Header.nid_c = kcg_lit_int64(0);
    outC->_L9[idx19].BG_Common_Header.nid_bg = kcg_lit_int64(0);
    outC->_L9[idx19].BG_Common_Header.q_link = Q_LINK_Unlinked;
    outC->_L9[idx19].BG_Common_Header.bgPosition.valid = kcg_true;
    outC->_L9[idx19].BG_Common_Header.bgPosition.timestamp = kcg_lit_int64(0);
    outC->_L9[idx19].BG_Common_Header.bgPosition.odo.o_nominal = kcg_lit_int64(0);
    outC->_L9[idx19].BG_Common_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
    outC->_L9[idx19].BG_Common_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
    ...
    outC->_L9[idx19].BG_Common_Header.bgPosition.speed.v_rawNominal =
      kcg_lit_int64(0);
    outC->_L9[idx19].BG_Common_Header.bgPosition.speed.v_lower = kcg_lit_int64(0);
    outC->_L9[idx19].BG_Common_Header.bgPosition.speed.v_upper = kcg_lit_int64(0);
    outC->_L9[idx19].BG_Common_Header.bgPosition.acceleration = kcg_lit_int64(0);
    ...
    outC->_L9[idx19].BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L9[idx19].BG_Common_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    outC->_L9[idx19].BG_Common_Header.trainRunningDirectionToBG =
      Q_DIRTRAIN_Reverse;
    outC->_L9[idx19].Radio_Common_Header.radioDevice = kcg_lit_int64(0);
    outC->_L9[idx19].Radio_Common_Header.receivedSystemTime = kcg_lit_int64(0);
    outC->_L9[idx19].Radio_Common_Header.nid_message = kcg_lit_int64(0);
    outC->_L9[idx19].Radio_Common_Header.t_train = kcg_lit_int64(0);
    outC->_L9[idx19].Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_required;
    outC->_L9[idx19].Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L9[idx19].Radio_Common_Header.t_train_reference = kcg_lit_int64(0);
    outC->_L9[idx19].Radio_Common_Header.nid_em = kcg_lit_int64(0);
    outC->_L9[idx19].Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
    outC->_L9[idx19].Radio_Common_Header.d_sr = kcg_lit_int64(0);
    outC->_L9[idx19].Radio_Common_Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L9[idx19].Radio_Common_Header.d_ref = kcg_lit_int64(0);
    outC->_L9[idx19].Radio_Common_Header.q_dir = Q_DIR_Reverse;
    outC->_L9[idx19].Radio_Common_Header.d_emergencystop = kcg_lit_int64(0);
    outC->_L9[idx19].Radio_Common_Header.m_version =
      M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
    for (idx17 = 0; idx17 < 30; idx17++) {
      outC->_L9[idx19].packets.PacketHeaders[idx17].nid_packet = kcg_lit_int64(0);
      outC->_L9[idx19].packets.PacketHeaders[idx17].q_dir = Q_DIR_Reverse;
      outC->_L9[idx19].packets.PacketHeaders[idx17].valid = kcg_true;
      outC->_L9[idx19].packets.PacketHeaders[idx17].startAddress = kcg_lit_int64(0);
      outC->_L9[idx19].packets.PacketHeaders[idx17].endAddress = kcg_lit_int64(0);
    }
    for (idx18 = 0; idx18 < 500; idx18++) {
      outC->_L9[idx19].packets.PacketData[idx18] = kcg_lit_int64(0);
    }
    outC->_L9[idx19].sendingRBC.valid = kcg_true;
    outC->_L9[idx19].sendingRBC.nid_c = kcg_lit_int64(0);
    outC->_L9[idx19].sendingRBC.rbc_id = kcg_lit_int64(0);
    outC->_L9[idx19].sendingRBC.device_id = kcg_lit_int64(0);
  }
  ...
  for (idx20 = 0; idx20 < 30; idx20++) {
    outC->_L12.packets.PacketHeaders[idx20].nid_packet = kcg_lit_int64(0);
    outC->_L12.packets.PacketHeaders[idx20].q_dir = Q_DIR_Reverse;
    outC->_L12.packets.PacketHeaders[idx20].valid = kcg_true;
    outC->_L12.packets.PacketHeaders[idx20].startAddress = kcg_lit_int64(0);
    outC->_L12.packets.PacketHeaders[idx20].endAddress = kcg_lit_int64(0);
  }
  for (idx21 = 0; idx21 < 500; idx21++) {
    outC->_L12.packets.PacketData[idx21] = kcg_lit_int64(0);
  }
  ...
  for (idx22 = 0; idx22 < 30; idx22++) {
    outC->Message_out.packets.PacketHeaders[idx22].nid_packet = kcg_lit_int64(0);
    ...
    outC->Message_out.packets.PacketHeaders[idx22].startAddress = kcg_lit_int64(0);
    outC->Message_out.packets.PacketHeaders[idx22].endAddress = kcg_lit_int64(0);
  }
  for (idx23 = 0; idx23 < 500; idx23++) {
    outC->Message_out.packets.PacketData[idx23] = kcg_lit_int64(0);
  }
  ...
  for (idx26 = 0; idx26 < 3; idx26++) {
    ...
    outC->Buffer_Out[idx26].BG_Common_Header.m_mcount = kcg_lit_int64(0);
    outC->Buffer_Out[idx26].BG_Common_Header.nid_c = kcg_lit_int64(0);
    outC->Buffer_Out[idx26].BG_Common_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->Buffer_Out[idx26].BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->Buffer_Out[idx26].BG_Common_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    outC->Buffer_Out[idx26].BG_Common_Header.trainRunningDirectionToBG =
      Q_DIRTRAIN_Reverse;
    outC->Buffer_Out[idx26].Radio_Common_Header.radioDevice = kcg_lit_int64(0);
    outC->Buffer_Out[idx26].Radio_Common_Header.receivedSystemTime =
      kcg_lit_int64(0);
    outC->Buffer_Out[idx26].Radio_Common_Header.nid_message = kcg_lit_int64(0);
    outC->Buffer_Out[idx26].Radio_Common_Header.t_train = kcg_lit_int64(0);
    outC->Buffer_Out[idx26].Radio_Common_Header.m_ack =
      M_ACK_No_acknowledgement_required;
    outC->Buffer_Out[idx26].Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
    outC->Buffer_Out[idx26].Radio_Common_Header.t_train_reference =
      kcg_lit_int64(0);
    outC->Buffer_Out[idx26].Radio_Common_Header.nid_em = kcg_lit_int64(0);
    outC->Buffer_Out[idx26].Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
    outC->Buffer_Out[idx26].Radio_Common_Header.d_sr = kcg_lit_int64(0);
    outC->Buffer_Out[idx26].Radio_Common_Header.t_sh_rqst = kcg_lit_int64(0);
    outC->Buffer_Out[idx26].Radio_Common_Header.d_ref = kcg_lit_int64(0);
    outC->Buffer_Out[idx26].Radio_Common_Header.q_dir = Q_DIR_Reverse;
    outC->Buffer_Out[idx26].Radio_Common_Header.d_emergencystop = kcg_lit_int64(0);
    ...
    for (idx25 = 0; idx25 < 500; idx25++) {
      outC->Buffer_Out[idx26].packets.PacketData[idx25] = kcg_lit_int64(0);
    }
    outC->Buffer_Out[idx26].sendingRBC.valid = kcg_true;
    outC->Buffer_Out[idx26].sendingRBC.nid_c = kcg_lit_int64(0);
    outC->Buffer_Out[idx26].sendingRBC.rbc_id = kcg_lit_int64(0);
    outC->Buffer_Out[idx26].sendingRBC.device_id = kcg_lit_int64(0);
  }
}
