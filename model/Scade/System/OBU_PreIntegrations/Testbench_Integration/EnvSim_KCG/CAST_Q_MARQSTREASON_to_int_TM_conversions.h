...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  kcg_int32 /* q_marqstreason_int/ */ q_marqstreason_int;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  Q_MARQSTREASON /* q_marqstreason_in/ */ q_marqstreason_in;
  kcg_bool /* error/ */ error;
  Q_MARQSTREASON /* _L2/ */ _L2;
  kcg_bool /* _L4/ */ _L4;
} outC_CAST_Q_MARQSTREASON_to_int_TM_conversions;

/* ===========  node initialization and cycle functions  =========== */
/* TM_conversions::CAST_Q_MARQSTREASON_to_int/ */
extern void CAST_Q_MARQSTREASON_to_int_TM_conversions(
  /* q_marqstreason/ */
  Q_MARQSTREASON q_marqstreason,
  outC_CAST_Q_MARQSTREASON_to_int_TM_conversions *outC);

#ifndef KCG_NO_EXTERN_CALL_TO_RESET
extern void CAST_Q_MARQSTREASON_to_int_reset_TM_conversions(
  outC_CAST_Q_MARQSTREASON_to_int_TM_conversions *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CAST_Q_MARQSTREASON_to_int_init_TM_conversions(
  outC_CAST_Q_MARQSTREASON_to_int_TM_conversions *outC);
