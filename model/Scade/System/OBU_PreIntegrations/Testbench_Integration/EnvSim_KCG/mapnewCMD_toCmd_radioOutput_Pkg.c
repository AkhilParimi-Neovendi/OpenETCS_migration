  ...
  outC_mapnewCMD_toCmd_radioOutput_Pkg *outC)
{
  ...
  outC->_L35.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L11_then_else_IfBlock1 = cmdr_not_relevant_API_RadioCommunication_Pkg;
  outC->_L30_else_else_IfBlock1 = kcg_lit_int32(0);
  ...
  outC->_L7_then_IfBlock1.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L9_then_IfBlock1.nid_radio = kcg_lit_int32(0);
