...
typedef struct {
  ...
  P005_OBU_T_TM /* P005_OBU_out/ */ P005_OBU_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P005_compr_onboard_TM_conversions /* _L166=(TM_conversions::C_P005_compr_onboard#3)/ */ Context_C_P005_compr_onboard_3;
...
extern void Read_P005_init_TM(outC_Read_P005_TM *outC);
