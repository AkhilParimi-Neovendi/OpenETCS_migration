...
{
  /* q_linkorientation/ */
  static Q_LINKORIENTATION q_linkorientation_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* q_linkorientation/ */
  static Q_LINKORIENTATION _1_q_linkorientation_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* error/ */
  static kcg_bool _3_error_partial;
  /* q_linkorientation/ */
  static Q_LINKORIENTATION _4_q_linkorientation_partial;
  /* error/ */
  static kcg_bool _5_error_partial;
  /* q_linkorientation/ */
  static Q_LINKORIENTATION _6_q_linkorientation_partial;
  ...
  outC_CAST_Int_to_Q_LINKORIENTATION_TM_conversions *outC)
{
  ...
  outC->_L13 = kcg_true;
  outC->q_linkorientation_in = kcg_lit_int64(0);
  outC->error = kcg_true;
