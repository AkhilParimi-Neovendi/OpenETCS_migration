  ...
  outC_genMsgToRBC_MoRC_Pck_Coder_Pkg *outC)
{
  ...
  outC->_L7.p0.packet0.NID_PACKET = kcg_lit_int64(0);
  outC->_L7.p0.packet0.L_PACKET = kcg_lit_int64(0);
  outC->_L7.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L7.p0.packet0.NID_LRBG = kcg_lit_int64(0);
  outC->_L7.p0.packet0.D_LRBG = kcg_lit_int64(0);
  outC->_L7.p0.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L7.p0.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->_L7.p0.packet0.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L7.p0.packet0.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L7.p0.packet0.length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L7.p0.packet0.L_TRAININT = kcg_lit_int64(0);
  outC->_L7.p0.packet0.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L7.p0.packet0.NID_NTC = kcg_lit_int64(0);
  outC->_L7.p1.valid = kcg_true;
  outC->_L7.p1.packet1.NID_PACKET = kcg_lit_int64(0);
  outC->_L7.p1.packet1.L_PACKET = kcg_lit_int64(0);
  outC->_L7.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L7.p1.packet1.NID_LRBG = kcg_lit_int64(0);
  outC->_L7.p1.packet1.NID_PRVLRBG = kcg_lit_int64(0);
  outC->_L7.p1.packet1.D_LRBG = kcg_lit_int64(0);
  outC->_L7.p1.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L7.p1.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L7.p1.packet1.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L7.p1.packet1.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L7.p1.packet1.length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L7.p1.packet1.L_TRAININT = kcg_lit_int64(0);
  outC->_L7.p1.packet1.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L7.p11.n_axle = kcg_lit_int64(0);
  outC->_L7.p11.nIter_tractionIdentity = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 4; idx2++) {
    outC->_L7.p11.tractionIdentity[idx2].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L7.p11.tractionIdentity[idx2].nid_ctraction = kcg_lit_int64(0);
  }
  outC->_L7.p11.nIter_ntc = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L7.p11.nid_ntc[idx3] = kcg_lit_int64(0);
  }
  ...
  outC->radioMessage.header.nid_engine = kcg_lit_int64(0);
  outC->radioMessage.header.xQ_MARQSTREASON =
    Q_MARQSTREASON_Start_selected_by_driver;
  outC->radioMessage.header.xT_TRAIN = kcg_lit_int64(0);
  outC->radioMessage.header.xNID_EM = kcg_lit_int64(0);
  outC->radioMessage.header.xQ_EMERGENCYSTOP =
    Q_EMERGENCYSTOP_Conditional_Emergency_Stop_accepted_with_update_of_EOA;
  outC->radioMessage.header.xNID_TEXTMESSAGE = kcg_lit_int64(0);
  outC->radioMessage.packets.p0.valid = kcg_true;
  outC->radioMessage.packets.p0.packet0.NID_PACKET = kcg_lit_int64(0);
  outC->radioMessage.packets.p0.packet0.L_PACKET = kcg_lit_int64(0);
  outC->radioMessage.packets.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->radioMessage.packets.p0.packet0.NID_LRBG = kcg_lit_int64(0);
  outC->radioMessage.packets.p0.packet0.D_LRBG = kcg_lit_int64(0);
  outC->radioMessage.packets.p0.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->radioMessage.packets.p0.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->radioMessage.packets.p0.packet0.L_DOUBTOVER = kcg_lit_int64(0);
  outC->radioMessage.packets.p0.packet0.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->radioMessage.packets.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->radioMessage.packets.p0.packet0.L_TRAININT = kcg_lit_int64(0);
  outC->radioMessage.packets.p0.packet0.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->radioMessage.packets.p0.packet0.NID_NTC = kcg_lit_int64(0);
  outC->radioMessage.packets.p1.valid = kcg_true;
  outC->radioMessage.packets.p1.packet1.NID_PACKET = kcg_lit_int64(0);
  outC->radioMessage.packets.p1.packet1.L_PACKET = kcg_lit_int64(0);
  outC->radioMessage.packets.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->radioMessage.packets.p1.packet1.NID_LRBG = kcg_lit_int64(0);
  outC->radioMessage.packets.p1.packet1.NID_PRVLRBG = kcg_lit_int64(0);
  outC->radioMessage.packets.p1.packet1.D_LRBG = kcg_lit_int64(0);
  outC->radioMessage.packets.p1.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->radioMessage.packets.p1.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->radioMessage.packets.p1.packet1.L_DOUBTOVER = kcg_lit_int64(0);
  outC->radioMessage.packets.p1.packet1.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->radioMessage.packets.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->radioMessage.packets.p1.packet1.L_TRAININT = kcg_lit_int64(0);
  outC->radioMessage.packets.p1.packet1.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->radioMessage.packets.p1.packet1.NID_NTC = kcg_lit_int64(0);
  outC->radioMessage.packets.p3.valid = kcg_true;
  outC->radioMessage.packets.p3.number = kcg_lit_int64(0);
  ...
  outC->radioMessage.packets.p5.TrainRunningNumber = kcg_lit_int64(0);
  outC->radioMessage.packets.p9.valid = kcg_true;
  outC->radioMessage.packets.p9.transitionInformation = kcg_lit_int64(0);
  ...
  outC->radioMessage.packets.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->radioMessage.packets.p11.l_train = kcg_lit_int64(0);
  outC->radioMessage.packets.p11.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->radioMessage.packets.p11.n_axle = kcg_lit_int64(0);
  outC->radioMessage.packets.p11.nIter_tractionIdentity = kcg_lit_int64(0);
  ...
  outC->radioMessage.packets.p11.nIter_ntc = kcg_lit_int64(0);
  for (idx11 = 0; idx11 < 5; idx11++) {
    outC->radioMessage.packets.p11.nid_ntc[idx11] = kcg_lit_int64(0);
  }
}
