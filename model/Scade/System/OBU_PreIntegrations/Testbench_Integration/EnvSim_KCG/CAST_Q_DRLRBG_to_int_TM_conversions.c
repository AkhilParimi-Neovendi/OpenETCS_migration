...
{
  /* q_drlrbg_int/ */
  static kcg_int32 q_drlrbg_int_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* q_drlrbg_int/ */
  static kcg_int32 _1_q_drlrbg_int_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* q_drlrbg_int/ */
  static kcg_int32 _3_q_drlrbg_int_partial;
  /* error/ */
  static kcg_bool _4_error_partial;
  /* q_drlrbg_int/ */
  static kcg_int32 _5_q_drlrbg_int_partial;
  /* error/ */
  static kcg_bool _6_error_partial;
  /* error/ */
  static kcg_bool _7_error_partial;
  /* q_drlrbg_int/ */
  static kcg_int32 _8_q_drlrbg_int_partial;
  /* error/ */
  static kcg_bool _9_error_partial;
  /* q_drlrbg_int/ */
  static kcg_int32 _10_q_drlrbg_int_partial;
  ...
  outC_CAST_Q_DRLRBG_to_int_TM_conversions *outC)
{
  ...
  outC->q_drlrbg_int = kcg_lit_int32(0);
}
