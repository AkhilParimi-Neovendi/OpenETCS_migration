...
typedef struct {
  ...
  kcg_bool /* _L11/ */ _L11;
  kcg_bool /* _L12/ */ _L12;
} outC_Position_In_Ack_Area_Librairies;

/* ===========  node initialization and cycle functions  =========== */
/* Librairies::Position_In_Ack_Area/ */
extern void Position_In_Ack_Area_Librairies(
  /* Position/ */
...
extern void Position_In_Ack_Area_reset_Librairies(
  outC_Position_In_Ack_Area_Librairies *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void Position_In_Ack_Area_init_Librairies(
  outC_Position_In_Ack_Area_Librairies *outC);
