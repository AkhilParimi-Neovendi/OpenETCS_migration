...
void Balise_412_0_AmsterdamUtrechtL2_Sheet12_Breukelen_Balises(
  ...
  /* PIG_nom/ */
  kcg_int64 PIG_nom,
  outC_Balise_412_0_AmsterdamUtrechtL2_Sheet12_Breukelen_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet12_Breukelen_Balises::Packets_BG412#1)/ */
    Packets_BG412_AmsterdamUtrechtL2_Sheet12_Breukelen_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG412_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG412_1.Balise_data_out);
...
void Balise_412_0_init_AmsterdamUtrechtL2_Sheet12_Breukelen_Balises(
  outC_Balise_412_0_AmsterdamUtrechtL2_Sheet12_Breukelen_Balises *outC)
{
  static kcg_size idx;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet12_Breukelen_Balises::Packets_BG412#1)/ */
  Packets_BG412_init_AmsterdamUtrechtL2_Sheet12_Breukelen_Balises(
    &outC->Context_Packets_BG412_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_412_0_reset_AmsterdamUtrechtL2_Sheet12_Breukelen_Balises(
  outC_Balise_412_0_AmsterdamUtrechtL2_Sheet12_Breukelen_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet12_Breukelen_Balises::Packets_BG412#1)/ */
  Packets_BG412_reset_AmsterdamUtrechtL2_Sheet12_Breukelen_Balises(
    &outC->Context_Packets_BG412_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
