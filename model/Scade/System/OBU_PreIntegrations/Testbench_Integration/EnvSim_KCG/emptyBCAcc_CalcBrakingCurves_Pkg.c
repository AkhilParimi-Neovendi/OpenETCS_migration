  ...
  outC_emptyBCAcc_CalcBrakingCurves_Pkg *outC)
{
  ...
  for (idx = 0; idx < 114; idx++) {
    outC->_L10.distances[idx] = kcg_lit_float32(0.0);
  }
  for (idx1 = 0; idx1 < 114; idx1++) {
    outC->_L10.speeds[idx1] = kcg_lit_float32(0.0);
  }
  for (idx2 = 0; idx2 < 114; idx2++) {
    outC->_L10.accelerations[idx2] = kcg_lit_float32(0.0);
  }
  ...
  outC->_L8 = kcg_lit_int32(0);
  outC->_L7 = kcg_lit_float32(0.0);
  outC->_L6.distance = kcg_lit_float32(0.0);
  outC->_L6.speed = kcg_lit_float32(0.0);
  outC->_L6.distanceIndex = kcg_lit_int32(0);
  outC->_L6.speedIndex = kcg_lit_int32(0);
  for (idx4 = 0; idx4 < 114; idx4++) {
    outC->_L6.BC.distances[idx4] = kcg_lit_float32(0.0);
  }
  for (idx5 = 0; idx5 < 114; idx5++) {
    outC->_L6.BC.speeds[idx5] = kcg_lit_float32(0.0);
  }
  for (idx6 = 0; idx6 < 114; idx6++) {
    outC->_L6.BC.accelerations[idx6] = kcg_lit_float32(0.0);
  }
  ...
  for (idx8 = 0; idx8 < 114; idx8++) {
    outC->Output1.BC.distances[idx8] = kcg_lit_float32(0.0);
  }
  for (idx9 = 0; idx9 < 114; idx9++) {
    outC->Output1.BC.speeds[idx9] = kcg_lit_float32(0.0);
  }
  for (idx10 = 0; idx10 < 114; idx10++) {
    outC->Output1.BC.accelerations[idx10] = kcg_lit_float32(0.0);
  }
