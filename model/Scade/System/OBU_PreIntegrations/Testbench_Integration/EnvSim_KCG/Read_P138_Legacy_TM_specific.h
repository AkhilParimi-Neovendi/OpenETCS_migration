...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P138_to_legacy_t_TM_conversions /* _L4=(TM_conversions::C_P138_to_legacy_t#1)/ */ Context_C_P138_to_legacy_t_1;
  outC_Read_P138_TM /* _L1=(TM::Read_P138#1)/ */ Context_Read_P138_1;
  /* ------------------ clocks of observable data -------------------- */
  kcg_bool every;
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  P138_OBU_T_TM /* _L2/ */ _L2;
  kcg_bool /* _L1/ */ _L1;
  CompressedPackets_T_Common_Types_Pkg /* _L3/ */ _L3;
  P138_ReversingAreaInformation_T_Packet_Types_Pkg /* _L4/ */ _L4;
...
extern void Read_P138_Legacy_init_TM_specific(
  outC_Read_P138_Legacy_TM_specific *outC);
