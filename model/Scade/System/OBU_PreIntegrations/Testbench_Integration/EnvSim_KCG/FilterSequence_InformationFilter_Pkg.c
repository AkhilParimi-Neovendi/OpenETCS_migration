  ...
  outC_FilterSequence_InformationFilter_Pkg *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L15.packets.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L15.packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L15.packets.PacketHeaders[idx].valid = kcg_true;
    outC->_L15.packets.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L15.packets.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L15.packets.PacketData[idx1] = kcg_lit_int64(0);
  }
  ...
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L10.packets.PacketHeaders[idx6].nid_packet = kcg_lit_int64(0);
    outC->_L10.packets.PacketHeaders[idx6].q_dir = Q_DIR_Reverse;
    outC->_L10.packets.PacketHeaders[idx6].valid = kcg_true;
    outC->_L10.packets.PacketHeaders[idx6].startAddress = kcg_lit_int64(0);
    outC->_L10.packets.PacketHeaders[idx6].endAddress = kcg_lit_int64(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->_L10.packets.PacketData[idx7] = kcg_lit_int64(0);
  }
  ...
  for (idx8 = 0; idx8 < 30; idx8++) {
    outC->_L9.packets.PacketHeaders[idx8].nid_packet = kcg_lit_int64(0);
    outC->_L9.packets.PacketHeaders[idx8].q_dir = Q_DIR_Reverse;
    outC->_L9.packets.PacketHeaders[idx8].valid = kcg_true;
    outC->_L9.packets.PacketHeaders[idx8].startAddress = kcg_lit_int64(0);
    outC->_L9.packets.PacketHeaders[idx8].endAddress = kcg_lit_int64(0);
  }
  for (idx9 = 0; idx9 < 500; idx9++) {
    outC->_L9.packets.PacketData[idx9] = kcg_lit_int64(0);
  }
  ...
  for (idx10 = 0; idx10 < 30; idx10++) {
    outC->_L7.packets.PacketHeaders[idx10].nid_packet = kcg_lit_int64(0);
    outC->_L7.packets.PacketHeaders[idx10].q_dir = Q_DIR_Reverse;
    outC->_L7.packets.PacketHeaders[idx10].valid = kcg_true;
    outC->_L7.packets.PacketHeaders[idx10].startAddress = kcg_lit_int64(0);
    outC->_L7.packets.PacketHeaders[idx10].endAddress = kcg_lit_int64(0);
  }
  for (idx11 = 0; idx11 < 500; idx11++) {
    outC->_L7.packets.PacketData[idx11] = kcg_lit_int64(0);
  }
  ...
  for (idx12 = 0; idx12 < 30; idx12++) {
    outC->_L6.packets.PacketHeaders[idx12].nid_packet = kcg_lit_int64(0);
    outC->_L6.packets.PacketHeaders[idx12].q_dir = Q_DIR_Reverse;
    outC->_L6.packets.PacketHeaders[idx12].valid = kcg_true;
    outC->_L6.packets.PacketHeaders[idx12].startAddress = kcg_lit_int64(0);
    outC->_L6.packets.PacketHeaders[idx12].endAddress = kcg_lit_int64(0);
  }
  for (idx13 = 0; idx13 < 500; idx13++) {
    outC->_L6.packets.PacketData[idx13] = kcg_lit_int64(0);
  }
  ...
  for (idx14 = 0; idx14 < 30; idx14++) {
    outC->_L1.packets.PacketHeaders[idx14].nid_packet = kcg_lit_int64(0);
    outC->_L1.packets.PacketHeaders[idx14].q_dir = Q_DIR_Reverse;
    outC->_L1.packets.PacketHeaders[idx14].valid = kcg_true;
    outC->_L1.packets.PacketHeaders[idx14].startAddress = kcg_lit_int64(0);
    outC->_L1.packets.PacketHeaders[idx14].endAddress = kcg_lit_int64(0);
  }
  for (idx15 = 0; idx15 < 500; idx15++) {
    outC->_L1.packets.PacketData[idx15] = kcg_lit_int64(0);
  }
  ...
  outC->_L3.lastAckTextMessageId = kcg_lit_int64(0);
  ...
  outC->bufferMessage.BG_Common_Header.m_mcount = kcg_lit_int64(0);
  outC->bufferMessage.BG_Common_Header.nid_c = kcg_lit_int64(0);
  outC->bufferMessage.BG_Common_Header.nid_bg = kcg_lit_int64(0);
  outC->bufferMessage.BG_Common_Header.q_link = Q_LINK_Unlinked;
  outC->bufferMessage.BG_Common_Header.bgPosition.valid = kcg_true;
  outC->bufferMessage.BG_Common_Header.bgPosition.timestamp = kcg_lit_int64(0);
  outC->bufferMessage.BG_Common_Header.bgPosition.odo.o_nominal = kcg_lit_int64(
      0);
  outC->bufferMessage.BG_Common_Header.bgPosition.odo.o_min = kcg_lit_int64(0);
  outC->bufferMessage.BG_Common_Header.bgPosition.odo.o_max = kcg_lit_int64(0);
  ...
  outC->bufferMessage.BG_Common_Header.bgPosition.speed.v_rawNominal =
    kcg_lit_int64(0);
  outC->bufferMessage.BG_Common_Header.bgPosition.speed.v_lower = kcg_lit_int64(
      0);
  outC->bufferMessage.BG_Common_Header.bgPosition.speed.v_upper = kcg_lit_int64(
      0);
  outC->bufferMessage.BG_Common_Header.bgPosition.acceleration = kcg_lit_int64(0);
  ...
  outC->bufferMessage.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->bufferMessage.BG_Common_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  outC->bufferMessage.BG_Common_Header.trainRunningDirectionToBG =
    Q_DIRTRAIN_Reverse;
  outC->bufferMessage.Radio_Common_Header.radioDevice = kcg_lit_int64(0);
  outC->bufferMessage.Radio_Common_Header.receivedSystemTime = kcg_lit_int64(0);
  outC->bufferMessage.Radio_Common_Header.nid_message = kcg_lit_int64(0);
  outC->bufferMessage.Radio_Common_Header.t_train = kcg_lit_int64(0);
  outC->bufferMessage.Radio_Common_Header.m_ack =
    M_ACK_No_acknowledgement_required;
  outC->bufferMessage.Radio_Common_Header.nid_lrbg = kcg_lit_int64(0);
  outC->bufferMessage.Radio_Common_Header.t_train_reference = kcg_lit_int64(0);
  outC->bufferMessage.Radio_Common_Header.nid_em = kcg_lit_int64(0);
  outC->bufferMessage.Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
  outC->bufferMessage.Radio_Common_Header.d_sr = kcg_lit_int64(0);
  outC->bufferMessage.Radio_Common_Header.t_sh_rqst = kcg_lit_int64(0);
  outC->bufferMessage.Radio_Common_Header.d_ref = kcg_lit_int64(0);
  outC->bufferMessage.Radio_Common_Header.q_dir = Q_DIR_Reverse;
  outC->bufferMessage.Radio_Common_Header.d_emergencystop = kcg_lit_int64(0);
  outC->bufferMessage.Radio_Common_Header.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  for (idx16 = 0; idx16 < 30; idx16++) {
    outC->bufferMessage.packets.PacketHeaders[idx16].nid_packet = kcg_lit_int64(0);
    ...
    outC->bufferMessage.packets.PacketHeaders[idx16].startAddress =
      kcg_lit_int64(0);
    outC->bufferMessage.packets.PacketHeaders[idx16].endAddress = kcg_lit_int64(0);
  }
  for (idx17 = 0; idx17 < 500; idx17++) {
    outC->bufferMessage.packets.PacketData[idx17] = kcg_lit_int64(0);
  }
  outC->bufferMessage.sendingRBC.valid = kcg_true;
  outC->bufferMessage.sendingRBC.nid_c = kcg_lit_int64(0);
  outC->bufferMessage.sendingRBC.rbc_id = kcg_lit_int64(0);
  outC->bufferMessage.sendingRBC.device_id = kcg_lit_int64(0);
  ...
  for (idx18 = 0; idx18 < 30; idx18++) {
    outC->outMessage.packets.PacketHeaders[idx18].nid_packet = kcg_lit_int64(0);
    ...
    outC->outMessage.packets.PacketHeaders[idx18].startAddress = kcg_lit_int64(0);
    outC->outMessage.packets.PacketHeaders[idx18].endAddress = kcg_lit_int64(0);
  }
  for (idx19 = 0; idx19 < 500; idx19++) {
    outC->outMessage.packets.PacketData[idx19] = kcg_lit_int64(0);
  }
