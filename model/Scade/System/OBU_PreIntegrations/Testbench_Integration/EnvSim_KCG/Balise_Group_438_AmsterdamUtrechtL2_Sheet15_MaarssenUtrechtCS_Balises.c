...
void Balise_Group_438_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
  ...
  outC_Balise_Group_438_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises *outC)
{
  ...
  /* _L8=(AmsterdamUtrechtL2::Sheet15_MaarssenUtrechtCS_Balises::Balise_438_0#1)/ */
  Balise_438_0_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
    ...
    outC->_L20,
    &outC->Context_Balise_438_0_1);
  kcg_copy_B_data_internal_T_InfraLib(
    &outC->_L8,
    &outC->Context_Balise_438_0_1.B_data_out);
  outC->_L21 = kcg_lit_int32(1);
  /* _L7=(AmsterdamUtrechtL2::Sheet15_MaarssenUtrechtCS_Balises::Balise_438_1#1)/ */
  Balise_438_1_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
    ...
    outC->_L21,
    &outC->Context_Balise_438_1_1);
  kcg_copy_B_data_internal_T_InfraLib(
    &outC->_L7,
    &outC->Context_Balise_438_1_1.B_data_out);
...
void Balise_Group_438_init_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
  outC_Balise_Group_438_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises *outC)
{
  static kcg_size idx;
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L16.packets.PacketHeaders[idx].nid_packet = kcg_lit_int32(0);
    outC->_L16.packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L16.packets.PacketHeaders[idx].valid = kcg_true;
    outC->_L16.packets.PacketHeaders[idx].startAddress = kcg_lit_int32(0);
    outC->_L16.packets.PacketHeaders[idx].endAddress = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L16.packets.PacketData[idx1] = kcg_lit_int32(0);
  }
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L29.Messages.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    outC->_L29.Messages.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L29.Messages.PacketHeaders[idx2].valid = kcg_true;
    outC->_L29.Messages.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L29.Messages.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L29.Messages.PacketData[idx3] = kcg_lit_int32(0);
  }
  ...
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L8.packets.PacketHeaders[idx4].nid_packet = kcg_lit_int32(0);
    outC->_L8.packets.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L8.packets.PacketHeaders[idx4].valid = kcg_true;
    outC->_L8.packets.PacketHeaders[idx4].startAddress = kcg_lit_int32(0);
    outC->_L8.packets.PacketHeaders[idx4].endAddress = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L8.packets.PacketData[idx5] = kcg_lit_int32(0);
  }
  ...
  /* _L7=(AmsterdamUtrechtL2::Sheet15_MaarssenUtrechtCS_Balises::Balise_438_1#1)/ */
  Balise_438_1_init_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
    &outC->Context_Balise_438_1_1);
  /* _L8=(AmsterdamUtrechtL2::Sheet15_MaarssenUtrechtCS_Balises::Balise_438_0#1)/ */
  Balise_438_0_init_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
    &outC->Context_Balise_438_0_1);
  /* _L11=(InfraLib::Balise_Group_Init#1)/ */
...
void Balise_Group_438_reset_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
  outC_Balise_Group_438_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises *outC)
{
  /* _L14=(InfraLib::Balise_Group_Close#1)/ */
  Balise_Group_Close_reset_InfraLib(&outC->Context_Balise_Group_Close_1);
  /* _L7=(AmsterdamUtrechtL2::Sheet15_MaarssenUtrechtCS_Balises::Balise_438_1#1)/ */
  Balise_438_1_reset_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
    &outC->Context_Balise_438_1_1);
  /* _L8=(AmsterdamUtrechtL2::Sheet15_MaarssenUtrechtCS_Balises::Balise_438_0#1)/ */
  Balise_438_0_reset_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
    &outC->Context_Balise_438_0_1);
  /* _L11=(InfraLib::Balise_Group_Init#1)/ */
