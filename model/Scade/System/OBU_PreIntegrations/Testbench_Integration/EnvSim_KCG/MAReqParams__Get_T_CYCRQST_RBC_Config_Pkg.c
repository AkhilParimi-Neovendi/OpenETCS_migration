...
void MAReqParams__Get_T_CYCRQST_RBC_Config_Pkg(
  /* inMAReqParams/ */
  ...
  outC_MAReqParams__Get_T_CYCRQST_RBC_Config_Pkg *outC)
{
  ...
  outC->_L2 = outC->_L1.t_cycrqst;
  outC->out_T_CYCRQST = outC->_L2;
}
...
void MAReqParams__Get_T_CYCRQST_reset_RBC_Config_Pkg(
  outC_MAReqParams__Get_T_CYCRQST_RBC_Config_Pkg *outC)
{
}
