  ...
  outC_IsBG_announced_CheckBGConsistency_Pkg_SubFunction *outC)
{
  ...
  if (outC->IfBlock1_clock) {
    ...
    kcg_copy_positionedBGs_T_TrainPosition_Types_Pck(
      ...
      storedBGs);
    if ((kcg_lit_int64(0) <= outC->_L3_then_IfBlock1) &
      (outC->_L3_then_IfBlock1 < kcg_lit_int64(41))) {
    ...
    kcg_copy_positionedBGs_T_TrainPosition_Types_Pck(
      ...
      storedBGs);
    if ((kcg_lit_int64(0) <= outC->_L12_else_IfBlock1) &
      (outC->_L12_else_IfBlock1 < kcg_lit_int64(41))) {
      kcg_copy_positionedBG_T_TrainPosition_Types_Pck(
  ...
  outC_IsBG_announced_CheckBGConsistency_Pkg_SubFunction *outC)
{
  ...
  for (idx1 = 0; idx1 < 41; idx1++) {
    ...
    outC->_L15[idx1].nid_c = kcg_lit_int64(0);
    outC->_L15[idx1].nid_bg = kcg_lit_int64(0);
    outC->_L15[idx1].q_link = Q_LINK_Unlinked;
    outC->_L15[idx1].location.nominal = kcg_lit_int64(0);
    outC->_L15[idx1].location.d_min = kcg_lit_int64(0);
    outC->_L15[idx1].location.d_max = kcg_lit_int64(0);
    outC->_L15[idx1].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L15[idx1].infoFromLinking.valid = kcg_true;
    outC->_L15[idx1].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L15[idx1].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L15[idx1].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L15[idx1].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L15[idx1].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L15[idx1].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L15[idx1].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L15[idx1].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L15[idx1].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L15[idx1].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L15[idx1].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L15[idx1].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L15[idx1].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L15[idx1].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L15[idx1].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L15[idx1].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L15[idx1].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L15[idx1].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L15[idx1].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L15[idx1].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx = 0; idx < 33; idx++) {
      ...
      outC->_L15[idx1].infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L15[idx1].infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int64(0);
      outC->_L15[idx1].infoFromPassing.linkedBGs[idx].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L15[idx1].infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int64(0);
      outC->_L15[idx1].infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L15[idx1].infoFromPassing.linkedBGs[idx].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L15[idx1].infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int64(0);
    }
    outC->_L15[idx1].missed = kcg_true;
  }
  outC->indexLocal = kcg_lit_int64(0);
  ...
  for (idx3 = 0; idx3 < 41; idx3++) {
    ...
    outC->_L15_else_IfBlock1[idx3].nid_c = kcg_lit_int64(0);
    outC->_L15_else_IfBlock1[idx3].nid_bg = kcg_lit_int64(0);
    outC->_L15_else_IfBlock1[idx3].q_link = Q_LINK_Unlinked;
    outC->_L15_else_IfBlock1[idx3].location.nominal = kcg_lit_int64(0);
    outC->_L15_else_IfBlock1[idx3].location.d_min = kcg_lit_int64(0);
    outC->_L15_else_IfBlock1[idx3].location.d_max = kcg_lit_int64(0);
    outC->_L15_else_IfBlock1[idx3].seqNoOnTrack = kcg_lit_int64(0);
    ...
    outC->_L15_else_IfBlock1[idx3].infoFromLinking.d_link.nominal =
      kcg_lit_int64(0);
    outC->_L15_else_IfBlock1[idx3].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L15_else_IfBlock1[idx3].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  ...
  outC->_L13_else_IfBlock1.nid_c = kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.nid_bg = kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.q_link = Q_LINK_Unlinked;
  outC->_L13_else_IfBlock1.location.nominal = kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.location.d_min = kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.location.d_max = kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.seqNoOnTrack = kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.infoFromLinking.valid = kcg_true;
  outC->_L13_else_IfBlock1.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(
      0);
  outC->_L13_else_IfBlock1.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  ...
  outC->_L13_else_IfBlock1.infoFromLinking.expectedLocation.d_max =
    kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->_L13_else_IfBlock1.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(
      0);
  ...
  outC->_L13_else_IfBlock1.infoFromLinking.linkingInfo.q_scale =
    Q_SCALE_10_cm_scale;
  outC->_L13_else_IfBlock1.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L13_else_IfBlock1.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.infoFromLinking.linkingInfo.q_linkorientation =
    Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
  outC->_L13_else_IfBlock1.infoFromLinking.linkingInfo.q_linkreaction =
    Q_LINKREACTION_Train_trip;
  outC->_L13_else_IfBlock1.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(
      0);
  ...
  outC->_L13_else_IfBlock1.infoFromPassing.BG_Header.n_total =
    N_TOTAL_1_balise_in_the_group;
  outC->_L13_else_IfBlock1.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L13_else_IfBlock1.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L13_else_IfBlock1.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(
      0);
  ...
  for (idx6 = 0; idx6 < 41; idx6++) {
    ...
    outC->_L1_then_IfBlock1[idx6].nid_c = kcg_lit_int64(0);
    outC->_L1_then_IfBlock1[idx6].nid_bg = kcg_lit_int64(0);
    outC->_L1_then_IfBlock1[idx6].q_link = Q_LINK_Unlinked;
    outC->_L1_then_IfBlock1[idx6].location.nominal = kcg_lit_int64(0);
    outC->_L1_then_IfBlock1[idx6].location.d_min = kcg_lit_int64(0);
    outC->_L1_then_IfBlock1[idx6].location.d_max = kcg_lit_int64(0);
    outC->_L1_then_IfBlock1[idx6].seqNoOnTrack = kcg_lit_int64(0);
    ...
    outC->_L1_then_IfBlock1[idx6].infoFromLinking.expectedLocation.d_max =
      kcg_lit_int64(0);
    outC->_L1_then_IfBlock1[idx6].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L1_then_IfBlock1[idx6].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L1_then_IfBlock1[idx6].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  ...
  outC->_L2_then_IfBlock1.location.nominal = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.location.d_min = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.location.d_max = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.seqNoOnTrack = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.infoFromLinking.valid = kcg_true;
  outC->_L2_then_IfBlock1.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  ...
  outC->_L2_then_IfBlock1.infoFromLinking.expectedLocation.d_max =
    kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->_L2_then_IfBlock1.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  ...
  outC->_L2_then_IfBlock1.infoFromLinking.linkingInfo.q_scale =
    Q_SCALE_10_cm_scale;
  outC->_L2_then_IfBlock1.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L2_then_IfBlock1.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.infoFromLinking.linkingInfo.q_linkorientation =
    Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
  outC->_L2_then_IfBlock1.infoFromLinking.linkingInfo.q_linkreaction =
    Q_LINKREACTION_Train_trip;
  outC->_L2_then_IfBlock1.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->_L2_then_IfBlock1.infoFromPassing.BG_Header.n_total =
    N_TOTAL_1_balise_in_the_group;
  outC->_L2_then_IfBlock1.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->_L2_then_IfBlock1.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
