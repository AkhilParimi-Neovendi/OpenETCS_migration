...
void C_P046_extract_el_section_TM_lib_internal(
  /* offset/ */
  kcg_int32 offset,
  /* flat/ */
  ...
  /* modulo/ */
  kcg_int32 modulo,
  outC_C_P046_extract_el_section_TM_lib_internal *outC)
{
  outC->_L3 = modulo;
  outC->_L1 = offset;
  outC->_L5 = outC->_L1 + outC->_L3;
  kcg_copy_P046_sections_array_flat_T_TM(&outC->_L2, flat);
  if ((kcg_lit_int32(0) <= outC->_L5) & (outC->_L5 < kcg_lit_int32(66))) {
...
void C_P046_extract_el_section_init_TM_lib_internal(
  outC_C_P046_extract_el_section_TM_lib_internal *outC)
{
  static kcg_size idx;
...
void C_P046_extract_el_section_reset_TM_lib_internal(
  outC_C_P046_extract_el_section_TM_lib_internal *outC)
{
}
