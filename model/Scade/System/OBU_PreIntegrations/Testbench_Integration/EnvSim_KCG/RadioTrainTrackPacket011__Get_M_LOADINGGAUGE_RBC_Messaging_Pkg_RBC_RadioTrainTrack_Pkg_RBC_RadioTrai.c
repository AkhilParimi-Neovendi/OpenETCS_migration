...
void RadioTrainTrackPacket011__Get_M_LOADINGGAUGE_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg_RBC_RadioTrai(
...
void RadioTrainTrackPacket011__Get_M_LOADINGGAUGE_init_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg_RBC_Radi(
  outC_RadioTrainTrackPacket011__Get_M_LOADINGGAUGE_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg_RBC_Radi *outC)
{
  static kcg_size idx;
...
void RadioTrainTrackPacket011__Get_M_LOADINGGAUGE_reset_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg_RBC_Rad(
  outC_RadioTrainTrackPacket011__Get_M_LOADINGGAUGE_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg_RBC_Radi *outC)
{
}
