  ...
  outC_MRSP_to_DMI_TA_Export *outC)
{
  ...
  if (outC->_L667) {
    ...
    for (idx1 = 0; idx1 < 110; idx1++) {
      ...
      outC->_L666 = /* _L666= */(kcg_int64) (idx1 + 1);
      /* _L666= */
  ...
  if (outC->_L670) {
    ...
    for (idx4 = 0; idx4 < 110; idx4++) {
      ...
      outC->_L669 = /* _L669= */(kcg_int64) (idx4 + 1);
      /* _L669= */
...
void MRSP_to_DMI_init_TA_Export(outC_MRSP_to_DMI_TA_Export *outC)
{
  ...
  for (idx3 = 0; idx3 < 110; idx3++) {
    for (idx2 = 0; idx2 < 110; idx2++) {
      ...
      outC->_L680[idx3][idx2].Loc_Abs = kcg_lit_int64(0);
      outC->_L680[idx3][idx2].Loc_LRBG = kcg_lit_int64(0);
      outC->_L680[idx3][idx2].MRS = kcg_lit_int64(0);
    }
  }
  for (idx4 = 0; idx4 < 110; idx4++) {
    outC->_L679[idx4].valid = kcg_true;
    outC->_L679[idx4].Loc_Abs = kcg_lit_int64(0);
    outC->_L679[idx4].Loc_LRBG = kcg_lit_int64(0);
    outC->_L679[idx4].MRS = kcg_lit_int64(0);
  }
  outC->_L677 = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 110; idx5++) {
    outC->_L676[idx5] = kcg_lit_int64(0);
  }
  outC->_L670 = kcg_true;
  outC->_L669 = kcg_lit_int64(0);
  outC->_L667 = kcg_true;
  outC->_L666 = kcg_lit_int64(0);
  outC->_L665.write_index = kcg_lit_int64(0);
  for (idx6 = 0; idx6 < 110; idx6++) {
    outC->_L665.MRSP[idx6].valid = kcg_true;
    outC->_L665.MRSP[idx6].Loc_Abs = kcg_lit_int64(0);
    outC->_L665.MRSP[idx6].Loc_LRBG = kcg_lit_int64(0);
    outC->_L665.MRSP[idx6].MRS = kcg_lit_int64(0);
  }
  for (idx7 = 0; idx7 < 110; idx7++) {
    outC->_L658[idx7].valid = kcg_true;
    outC->_L658[idx7].Loc_Abs = kcg_lit_int64(0);
    outC->_L658[idx7].Loc_LRBG = kcg_lit_int64(0);
    outC->_L658[idx7].MRS = kcg_lit_int64(0);
  }
  for (idx9 = 0; idx9 < 110; idx9++) {
    for (idx8 = 0; idx8 < 110; idx8++) {
      outC->_L659[idx9][idx8].valid = kcg_true;
      outC->_L659[idx9][idx8].Loc_Abs = kcg_lit_int64(0);
      outC->_L659[idx9][idx8].Loc_LRBG = kcg_lit_int64(0);
      outC->_L659[idx9][idx8].MRS = kcg_lit_int64(0);
    }
  }
  outC->_L660.write_index = kcg_lit_int64(0);
  for (idx10 = 0; idx10 < 110; idx10++) {
    outC->_L660.MRSP[idx10].valid = kcg_true;
    outC->_L660.MRSP[idx10].Loc_Abs = kcg_lit_int64(0);
    outC->_L660.MRSP[idx10].Loc_LRBG = kcg_lit_int64(0);
    outC->_L660.MRSP[idx10].MRS = kcg_lit_int64(0);
  }
  for (idx11 = 0; idx11 < 110; idx11++) {
    outC->_L657[idx11].valid = kcg_true;
    outC->_L657[idx11].Loc_Abs = kcg_lit_int64(0);
    outC->_L657[idx11].Loc_LRBG = kcg_lit_int64(0);
    outC->_L657[idx11].MRS = kcg_lit_int64(0);
  }
  for (idx12 = 0; idx12 < 110; idx12++) {
    outC->MRSP_to_DMI[idx12].valid = kcg_true;
    outC->MRSP_to_DMI[idx12].Loc_Abs = kcg_lit_int64(0);
    outC->MRSP_to_DMI[idx12].Loc_LRBG = kcg_lit_int64(0);
    outC->MRSP_to_DMI[idx12].MRS = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 110; idx1++) {
    /* _L669=(TA_Export::MRSP_limit_to_EOA#1)/ */
