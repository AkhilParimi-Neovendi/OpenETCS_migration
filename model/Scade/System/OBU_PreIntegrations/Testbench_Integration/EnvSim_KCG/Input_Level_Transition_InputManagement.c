  ...
  outC_Input_Level_Transition_InputManagement *outC)
{
  ...
  for (idx2 = 0; idx2 < 5; idx2++) {
    ...
    outC->_L134.P_12[idx2].v_main = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].v_loa = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].t_loa = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].l_section = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].q_sectiontimer_k =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L134.P_12[idx2].t_sectiontimer_k = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].d_sectiontimerstoploc_k = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].l_endsection = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].q_sectiontimer =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L134.P_12[idx2].t_sectiontimer = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].d_sectiontimerstoploc = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].q_endtimer = Q_ENDTIMER_No_End_section_timer_information;
    outC->_L134.P_12[idx2].t_endtimer = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].d_endtimerstartloc = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].q_dangerpoint =
      Q_DANGERPOINT_No_danger_point_information;
    outC->_L134.P_12[idx2].d_dp = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].v_releasedp = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].q_overlap = Q_OVERLAP_No_overlap_information;
    outC->_L134.P_12[idx2].d_startol = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].t_ol = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].d_ol = kcg_lit_int64(0);
    outC->_L134.P_12[idx2].v_releaseol = kcg_lit_int64(0);
  }
  ...
  outC->_L134.P_138.d_startreverse = kcg_lit_int64(0);
  outC->_L134.P_138.l_reversearea = kcg_lit_int64(0);
  outC->_L134.P_139.valid = kcg_true;
  outC->_L134.P_139.q_dir = Q_DIR_Reverse;
  outC->_L134.P_139.q_scale = Q_SCALE_10_cm_scale;
  outC->_L134.P_139.d_reverse = kcg_lit_int64(0);
  outC->_L134.P_139.v_reverse = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 5; idx3++) {
    ...
    outC->_L134.P_15[idx3].v_loa = kcg_lit_int64(0);
    outC->_L134.P_15[idx3].t_loa = kcg_lit_int64(0);
    outC->_L134.P_15[idx3].l_section = kcg_lit_int64(0);
    outC->_L134.P_15[idx3].q_sectiontimer_k =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L134.P_15[idx3].t_sectiontimer_k = kcg_lit_int64(0);
    outC->_L134.P_15[idx3].d_sectiontimerstoploc_k = kcg_lit_int64(0);
    outC->_L134.P_15[idx3].l_endsection = kcg_lit_int64(0);
    outC->_L134.P_15[idx3].q_sectiontimer =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L134.P_15[idx3].t_sectiontimer = kcg_lit_int64(0);
    outC->_L134.P_15[idx3].d_sectiontimerstoploc = kcg_lit_int64(0);
    outC->_L134.P_15[idx3].q_endtimer = Q_ENDTIMER_No_End_section_timer_information;
    outC->_L134.P_15[idx3].t_endtimer = kcg_lit_int64(0);
    outC->_L134.P_15[idx3].d_endtimerstartloc = kcg_lit_int64(0);
    outC->_L134.P_15[idx3].q_dangerpoint =
      Q_DANGERPOINT_No_danger_point_information;
    outC->_L134.P_15[idx3].d_dp = kcg_lit_int64(0);
    outC->_L134.P_15[idx3].v_releasedp = kcg_lit_int64(0);
    outC->_L134.P_15[idx3].q_overlap = Q_OVERLAP_No_overlap_information;
    outC->_L134.P_15[idx3].d_startol = kcg_lit_int64(0);
    outC->_L134.P_15[idx3].t_ol = kcg_lit_int64(0);
    outC->_L134.P_15[idx3].d_ol = kcg_lit_int64(0);
    outC->_L134.P_15[idx3].v_releaseol = kcg_lit_int64(0);
  }
  for (idx4 = 0; idx4 < 7; idx4++) {
    ...
    outC->_L134.P_21[idx4].d_gradient = kcg_lit_int64(0);
    outC->_L134.P_21[idx4].q_gdir = Q_GDIR_downhill;
    outC->_L134.P_21[idx4].g_a = kcg_lit_int64(0);
  }
  outC->_L134.P_27.valid = kcg_true;
  outC->_L134.P_27.q_dir = Q_DIR_Reverse;
  outC->_L134.P_27.q_scale = Q_SCALE_10_cm_scale;
  outC->_L134.P_27.d_static = kcg_lit_int64(0);
  outC->_L134.P_27.v_static = kcg_lit_int64(0);
  ...
  for (idx5 = 0; idx5 < 7; idx5++) {
    ...
    outC->_L134.P_27.diffArray[idx5].nc_diff = kcg_lit_int64(0);
    outC->_L134.P_27.diffArray[idx5].v_diff = kcg_lit_int64(0);
  }
  for (idx7 = 0; idx7 < 7; idx7++) {
    outC->_L134.P_27.SSPArray[idx7].valid = kcg_true;
    outC->_L134.P_27.SSPArray[idx7].d_static = kcg_lit_int64(0);
    outC->_L134.P_27.SSPArray[idx7].v_static = kcg_lit_int64(0);
    ...
    for (idx6 = 0; idx6 < 7; idx6++) {
      ...
      outC->_L134.P_27.SSPArray[idx7].diffArray[idx6].nc_cddiff =
        NC_CDDIFF_Specific_SSP_applicable_to_Cant_Deficiency_80_mm;
      outC->_L134.P_27.SSPArray[idx7].diffArray[idx6].nc_diff = kcg_lit_int64(0);
      outC->_L134.P_27.SSPArray[idx7].diffArray[idx6].v_diff = kcg_lit_int64(0);
    }
  }
  for (idx8 = 0; idx8 < 7; idx8++) {
    ...
    outC->_L134.P_41[idx8].d_leveltr = kcg_lit_int64(0);
    outC->_L134.P_41[idx8].m_leveltr = M_LEVELTR_Level_0;
    outC->_L134.P_41[idx8].nid_ntc = kcg_lit_int64(0);
    outC->_L134.P_41[idx8].l_ackleveltr = kcg_lit_int64(0);
  }
  for (idx9 = 0; idx9 < 7; idx9++) {
    ...
    outC->_L134.P_46[idx9].nid_ntc = kcg_lit_int64(0);
  }
  for (idx10 = 0; idx10 < 7; idx10++) {
    ...
    outC->_L134.P_63[idx10].nid_c = kcg_lit_int64(0);
    outC->_L134.P_63[idx10].nid_bg = kcg_lit_int64(0);
  }
  for (idx11 = 0; idx11 < 3; idx11++) {
    ...
    outC->_L134.P_80[idx11].d_mamode = kcg_lit_int64(0);
    outC->_L134.P_80[idx11].m_mamode = M_MAMODE_On_Sight;
    outC->_L134.P_80[idx11].v_mamode = kcg_lit_int64(0);
    outC->_L134.P_80[idx11].l_mamode = kcg_lit_int64(0);
    outC->_L134.P_80[idx11].l_ackmamode = kcg_lit_int64(0);
  ...
  for (idx12 = 0; idx12 < 7; idx12++) {
    ...
    outC->_L133[idx12].nid_ntc = kcg_lit_int64(0);
  }
  for (idx13 = 0; idx13 < 7; idx13++) {
    ...
    outC->_L132[idx13].d_leveltr = kcg_lit_int64(0);
    outC->_L132[idx13].m_leveltr = M_LEVELTR_Level_0;
    outC->_L132[idx13].nid_ntc = kcg_lit_int64(0);
    outC->_L132[idx13].l_ackleveltr = kcg_lit_int64(0);
  }
  ...
  for (idx14 = 0; idx14 < 7; idx14++) {
    ...
    outC->_L129[idx14].transition.position = kcg_lit_int64(0);
    outC->_L129[idx14].transition.transitionType =
      M_TransitionType_Conditional_Level_And_Mode_Types_Pkg;
    outC->_L129[idx14].transition.immediateAck = kcg_true;
    outC->_L129[idx14].transition.AckLength = kcg_lit_int64(0);
    outC->_L129[idx14].LRBG = kcg_lit_int64(0);
    outC->_L129[idx14].referenceLocation = kcg_lit_int64(0);
  }
  for (idx15 = 0; idx15 < 7; idx15++) {
    outC->_L127[idx15] = kcg_lit_int64(0);
  }
  for (idx16 = 0; idx16 < 7; idx16++) {
    outC->_L126[idx16] = kcg_lit_int64(0);
  }
  for (idx17 = 0; idx17 < 7; idx17++) {
    outC->_L124[idx17].is_set = kcg_true;
    outC->_L124[idx17].transition.level = M_LEVEL_Level_0;
    outC->_L124[idx17].transition.position = kcg_lit_int64(0);
    outC->_L124[idx17].transition.transitionType =
      M_TransitionType_Conditional_Level_And_Mode_Types_Pkg;
    outC->_L124[idx17].transition.immediateAck = kcg_true;
    outC->_L124[idx17].transition.AckLength = kcg_lit_int64(0);
    outC->_L124[idx17].LRBG = kcg_lit_int64(0);
    outC->_L124[idx17].referenceLocation = kcg_lit_int64(0);
  }
  for (idx18 = 0; idx18 < 7; idx18++) {
    ...
    outC->level_transition_priority_table[idx18].transition.AckLength =
      kcg_lit_int64(0);
    outC->level_transition_priority_table[idx18].LRBG = kcg_lit_int64(0);
  ...
  for (idx19 = 0; idx19 < 7; idx19++) {
    ...
    outC->conditional_transition[idx19].transition.position = kcg_lit_int64(0);
    ...
    outC->conditional_transition[idx19].transition.AckLength = kcg_lit_int64(0);
    outC->conditional_transition[idx19].LRBG = kcg_lit_int64(0);
    outC->conditional_transition[idx19].referenceLocation = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 7; idx1++) {
    /* _L124=(InputManagement::ConditionnalTransition)/ */
