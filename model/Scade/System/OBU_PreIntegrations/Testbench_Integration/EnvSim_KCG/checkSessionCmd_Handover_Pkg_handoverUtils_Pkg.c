  ...
  outC_checkSessionCmd_Handover_Pkg_handoverUtils_Pkg *outC)
{
  ...
  outC->_L50.nid_rbc = kcg_lit_int32(0);
  outC->_L50.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L46.BG_Common_Header.m_mcount = kcg_lit_int32(0);
  outC->_L46.BG_Common_Header.nid_c = kcg_lit_int32(0);
  outC->_L46.BG_Common_Header.nid_bg = kcg_lit_int32(0);
  outC->_L46.BG_Common_Header.q_link = Q_LINK_Unlinked;
  outC->_L46.BG_Common_Header.bgPosition.valid = kcg_true;
  outC->_L46.BG_Common_Header.bgPosition.timestamp = kcg_lit_int32(0);
  outC->_L46.BG_Common_Header.bgPosition.odo.o_nominal = kcg_lit_int32(0);
  outC->_L46.BG_Common_Header.bgPosition.odo.o_min = kcg_lit_int32(0);
  outC->_L46.BG_Common_Header.bgPosition.odo.o_max = kcg_lit_int32(0);
  outC->_L46.BG_Common_Header.bgPosition.speed.v_safeNominal = kcg_lit_int32(0);
  outC->_L46.BG_Common_Header.bgPosition.speed.v_rawNominal = kcg_lit_int32(0);
  outC->_L46.BG_Common_Header.bgPosition.speed.v_lower = kcg_lit_int32(0);
  outC->_L46.BG_Common_Header.bgPosition.speed.v_upper = kcg_lit_int32(0);
  outC->_L46.BG_Common_Header.bgPosition.acceleration = kcg_lit_int32(0);
  ...
  outC->_L46.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int32(0);
  outC->_L46.BG_Common_Header.q_nvlocacc = kcg_lit_int32(0);
  ...
  outC->_L46.Radio_Common_Header.radioDevice = kcg_lit_int32(0);
  outC->_L46.Radio_Common_Header.receivedSystemTime = kcg_lit_int32(0);
  outC->_L46.Radio_Common_Header.nid_message = kcg_lit_int32(0);
  outC->_L46.Radio_Common_Header.t_train = kcg_lit_int32(0);
  outC->_L46.Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_required;
  outC->_L46.Radio_Common_Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L46.Radio_Common_Header.t_train_reference = kcg_lit_int32(0);
  outC->_L46.Radio_Common_Header.nid_em = kcg_lit_int32(0);
  outC->_L46.Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L46.Radio_Common_Header.d_sr = kcg_lit_int32(0);
  outC->_L46.Radio_Common_Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L46.Radio_Common_Header.d_ref = kcg_lit_int32(0);
  outC->_L46.Radio_Common_Header.q_dir = Q_DIR_Reverse;
  outC->_L46.Radio_Common_Header.d_emergencystop = kcg_lit_int32(0);
  outC->_L46.Radio_Common_Header.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  for (idx = 0; idx < 30; idx++) {
    outC->_L46.packets.PacketHeaders[idx].nid_packet = kcg_lit_int32(0);
    outC->_L46.packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L46.packets.PacketHeaders[idx].valid = kcg_true;
    outC->_L46.packets.PacketHeaders[idx].startAddress = kcg_lit_int32(0);
    outC->_L46.packets.PacketHeaders[idx].endAddress = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L46.packets.PacketData[idx1] = kcg_lit_int32(0);
  }
  outC->_L46.sendingRBC.valid = kcg_true;
  outC->_L46.sendingRBC.nid_c = kcg_lit_int32(0);
  outC->_L46.sendingRBC.rbc_id = kcg_lit_int32(0);
  outC->_L46.sendingRBC.device_id = kcg_lit_int32(0);
  outC->_L45 = kcg_true;
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L42.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    outC->_L42.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L42.PacketHeaders[idx2].valid = kcg_true;
    outC->_L42.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L42.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L42.PacketData[idx3] = kcg_lit_int32(0);
  }
  ...
  outC->_L44.nid_rbc = kcg_lit_int32(0);
  outC->_L44.nid_radio = kcg_lit_int32(0);
  ...
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L21.packets.PacketHeaders[idx4].nid_packet = kcg_lit_int32(0);
    outC->_L21.packets.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L21.packets.PacketHeaders[idx4].valid = kcg_true;
    outC->_L21.packets.PacketHeaders[idx4].startAddress = kcg_lit_int32(0);
    outC->_L21.packets.PacketHeaders[idx4].endAddress = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L21.packets.PacketData[idx5] = kcg_lit_int32(0);
  }
  ...
  outC->_L5.session.nid_c = kcg_lit_int32(0);
  outC->_L5.session.nid_rbc = kcg_lit_int32(0);
  outC->_L5.session.nid_radio = kcg_lit_int32(0);
  ...
  outC->p42_sessionCmd_out.BG_Common_Header.m_mcount = kcg_lit_int32(0);
  outC->p42_sessionCmd_out.BG_Common_Header.nid_c = kcg_lit_int32(0);
  outC->p42_sessionCmd_out.BG_Common_Header.nid_bg = kcg_lit_int32(0);
  ...
  outC->p42_sessionCmd_out.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int32(0);
  outC->p42_sessionCmd_out.BG_Common_Header.q_nvlocacc = kcg_lit_int32(0);
  ...
  outC->p42_sessionCmd_out.BG_Common_Header.trainRunningDirectionToBG =
    Q_DIRTRAIN_Reverse;
  outC->p42_sessionCmd_out.Radio_Common_Header.radioDevice = kcg_lit_int32(0);
  outC->p42_sessionCmd_out.Radio_Common_Header.receivedSystemTime =
    kcg_lit_int32(0);
  outC->p42_sessionCmd_out.Radio_Common_Header.nid_message = kcg_lit_int32(0);
  outC->p42_sessionCmd_out.Radio_Common_Header.t_train = kcg_lit_int32(0);
  outC->p42_sessionCmd_out.Radio_Common_Header.m_ack =
    M_ACK_No_acknowledgement_required;
  outC->p42_sessionCmd_out.Radio_Common_Header.nid_lrbg = kcg_lit_int32(0);
  outC->p42_sessionCmd_out.Radio_Common_Header.t_train_reference =
    kcg_lit_int32(0);
  outC->p42_sessionCmd_out.Radio_Common_Header.nid_em = kcg_lit_int32(0);
  outC->p42_sessionCmd_out.Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
  outC->p42_sessionCmd_out.Radio_Common_Header.d_sr = kcg_lit_int32(0);
  outC->p42_sessionCmd_out.Radio_Common_Header.t_sh_rqst = kcg_lit_int32(0);
  outC->p42_sessionCmd_out.Radio_Common_Header.d_ref = kcg_lit_int32(0);
  outC->p42_sessionCmd_out.Radio_Common_Header.q_dir = Q_DIR_Reverse;
  outC->p42_sessionCmd_out.Radio_Common_Header.d_emergencystop = kcg_lit_int32(0);
  ...
  for (idx9 = 0; idx9 < 500; idx9++) {
    outC->p42_sessionCmd_out.packets.PacketData[idx9] = kcg_lit_int32(0);
  }
  outC->p42_sessionCmd_out.sendingRBC.valid = kcg_true;
  outC->p42_sessionCmd_out.sendingRBC.nid_c = kcg_lit_int32(0);
  outC->p42_sessionCmd_out.sendingRBC.rbc_id = kcg_lit_int32(0);
  outC->p42_sessionCmd_out.sendingRBC.device_id = kcg_lit_int32(0);
