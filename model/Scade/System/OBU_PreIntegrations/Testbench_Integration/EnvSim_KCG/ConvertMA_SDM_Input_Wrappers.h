...
typedef struct {
  ...
  outC_TransformL_intToL_real_SDM_Types_Pkg /* _L19=(SDM_Types_Pkg::TransformL_intToL_real#1)/ */ Context_TransformL_intToL_real_1;
  outC_TransformV_intToV_real_SDM_Types_Pkg /* _L23=(SDM_Types_Pkg::TransformV_intToV_real#2)/ */ Context_TransformV_intToV_real_2;
  outC_TransformL_intToL_real_SDM_Types_Pkg /* _L21=(SDM_Types_Pkg::TransformL_intToL_real#2)/ */ Context_TransformL_intToL_real_2;
  outC_TransformV_intToV_real_SDM_Types_Pkg /* _L187=(SDM_Types_Pkg::TransformV_intToV_real#3)/ */ Context_TransformV_intToV_real_3;
