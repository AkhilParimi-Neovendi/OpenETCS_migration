...
{
  /* q_gdir/ */
  static Q_GDIR q_gdir_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* q_gdir/ */
  static Q_GDIR _1_q_gdir_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* error/ */
  static kcg_bool _3_error_partial;
  /* q_gdir/ */
  static Q_GDIR _4_q_gdir_partial;
  /* error/ */
  static kcg_bool _5_error_partial;
  /* q_gdir/ */
  static Q_GDIR _6_q_gdir_partial;
  ...
  outC_CAST_Int_to_Q_GDIR_TM_conversions *outC)
{
  ...
  outC->_L13 = kcg_true;
  outC->q_gdir_in = kcg_lit_int64(0);
  outC->error = kcg_true;
