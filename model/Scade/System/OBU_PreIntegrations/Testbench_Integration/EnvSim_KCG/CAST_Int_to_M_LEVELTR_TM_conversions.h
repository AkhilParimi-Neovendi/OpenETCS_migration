...
typedef struct {
  ...
  M_LEVELTR /* IfBlock1:then:_L8/ */ _L8_then_IfBlock1;
  kcg_bool /* IfBlock1:then:_L7/ */ _L7_then_IfBlock1;
  M_LEVELTR /* IfBlock1:else:else:then:_L1/ */ _L1_then_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:then:_L2/ */ _L2_then_else_else_IfBlock1;
  M_LEVELTR /* IfBlock1:else:else:else:else:then:_L1/ */ _L1_then_else_else_else_else_IfBlock1;
  ...
  M_LEVELTR /* IfBlock1:else:else:else:else:else:_L2/ */ _L2_else_else_else_else_else_IfBlock1;
  M_LEVELTR /* IfBlock1:else:else:else:then:_L2/ */ _L2_then_else_else_else_IfBlock1;
  ...
  M_LEVELTR /* IfBlock1:else:then:_L7/ */ _L7_then_else_IfBlock1;
  kcg_int64 /* m_leveltr_in/ */ m_leveltr_in;
...
extern void CAST_Int_to_M_LEVELTR_init_TM_conversions(
  outC_CAST_Int_to_M_LEVELTR_TM_conversions *outC);
