...
typedef struct {
  ...
  P139_OBU_T_TM /* P139_OBU_out/ */ P139_OBU_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P139_compr_onboard_TM_conversions /* _L166=(TM_conversions::C_P139_compr_onboard#1)/ */ Context_C_P139_compr_onboard_1;
...
extern void Read_P139_reset_TM(outC_Read_P139_TM *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void Read_P139_init_TM(outC_Read_P139_TM *outC);
