  ...
  outC_C_P137_compr_onboard_TM_conversions *outC)
{
  ...
  /* _L4=(TM_conversions::CAST_Int_to_Q_SRSTOP#1)/ */
  CAST_Int_to_Q_SRSTOP_TM_conversions(
    outC->_L25,
    &outC->Context_CAST_Int_to_Q_SRSTOP_1);
  outC->_L4 = outC->Context_CAST_Int_to_Q_SRSTOP_1.q_srstop;
...
void C_P137_compr_onboard_init_TM_conversions(
  outC_C_P137_compr_onboard_TM_conversions *outC)
{
  static kcg_size idx;
  ...
  outC->P137_onboard.q_srstop = Q_SRSTOP_Stop_if_in_SR_mode;
  /* _L4=(TM_conversions::CAST_Int_to_Q_SRSTOP#1)/ */
  CAST_Int_to_Q_SRSTOP_init_TM_conversions(
    &outC->Context_CAST_Int_to_Q_SRSTOP_1);
}
...
{
  /* _L4=(TM_conversions::CAST_Int_to_Q_SRSTOP#1)/ */
  CAST_Int_to_Q_SRSTOP_reset_TM_conversions(
    &outC->Context_CAST_Int_to_Q_SRSTOP_1);
}
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

/*
  Expanded instances for: TM_conversions::C_P137_compr_onboard/
