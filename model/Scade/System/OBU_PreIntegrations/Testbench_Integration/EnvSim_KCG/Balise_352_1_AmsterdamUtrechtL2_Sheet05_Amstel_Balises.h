...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_Packets_BG352_AmsterdamUtrechtL2_Sheet05_Amstel_Balises /* _L4=(AmsterdamUtrechtL2::Sheet05_Amstel_Balises::Packets_BG352#1)/ */ Context_Packets_BG352_1;
...
extern void Balise_352_1_init_AmsterdamUtrechtL2_Sheet05_Amstel_Balises(
  outC_Balise_352_1_AmsterdamUtrechtL2_Sheet05_Amstel_Balises *outC);
