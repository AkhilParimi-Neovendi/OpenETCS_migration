...
void SP_LX_SR_init_TA_SpeedProfiles(outC_SP_LX_SR_TA_SpeedProfiles *outC)
{
  ...
  for (idx = 0; idx < 50; idx++) {
    outC->_L5[idx].target = kcg_lit_int64(0);
    outC->_L5[idx].speed = kcg_lit_int64(0);
  }
  ...
  for (idx1 = 0; idx1 < 30; idx1++) {
    outC->_L4.packets.PacketHeaders[idx1].nid_packet = kcg_lit_int64(0);
    outC->_L4.packets.PacketHeaders[idx1].q_dir = Q_DIR_Reverse;
    outC->_L4.packets.PacketHeaders[idx1].valid = kcg_true;
    outC->_L4.packets.PacketHeaders[idx1].startAddress = kcg_lit_int64(0);
    outC->_L4.packets.PacketHeaders[idx1].endAddress = kcg_lit_int64(0);
  }
  for (idx2 = 0; idx2 < 500; idx2++) {
    outC->_L4.packets.PacketData[idx2] = kcg_lit_int64(0);
  }
  ...
  for (idx3 = 0; idx3 < 50; idx3++) {
    outC->LX_SR[idx3].target = kcg_lit_int64(0);
    outC->LX_SR[idx3].speed = kcg_lit_int64(0);
  }
}
