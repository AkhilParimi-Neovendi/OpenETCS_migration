...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P041_sections_array_flat_T_TM /* Flattened/ */ Flattened;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P041_fs_flatten_array_TM_lib_internal /* _L78=(TM_lib_internal::C_P041_fs_flatten_array#1)/ */ Context_C_P041_fs_flatten_array_1[99];
  outC_C_P041_fs_struct_to_array_TM_lib_internal /* _L74=(TM_lib_internal::C_P041_fs_struct_to_array#1)/ */ Context_C_P041_fs_struct_to_array_1[33];
  /* ----------------- no clocks of observable data ------------------ */
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  P041_sections_array_flat_T_TM /* _L76/ */ _L76;
  P041_OBU_sectionlist_int_T_TM /* _L75/ */ _L75;
  array_int64_3_33 /* _L74/ */ _L74;
  P041_sections_array_flat_T_TM /* _L78/ */ _L78;
  array_int64_3_33_99 /* _L80/ */ _L80;
