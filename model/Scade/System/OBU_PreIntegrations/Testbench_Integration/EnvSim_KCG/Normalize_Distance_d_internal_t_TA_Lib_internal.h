...
extern void Normalize_Distance_d_internal_t_TA_Lib_internal(
  /* q_scale/ */
  Q_SCALE q_scale,
  /* d/ */
  kcg_int32 d,
...
extern void Normalize_Distance_d_internal_t_reset_TA_Lib_internal(
  outC_Normalize_Distance_d_internal_t_TA_Lib_internal *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void Normalize_Distance_d_internal_t_init_TA_Lib_internal(
  outC_Normalize_Distance_d_internal_t_TA_Lib_internal *outC);
