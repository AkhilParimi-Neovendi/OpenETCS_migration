  ...
  outC_Send_P137_MessageLibBaseline2 *outC)
{
  ...
  kcg_copy_P137_trackside_int_T_TM(&outC->_L4, P137);
  outC->_L5 = outC->_L4.valid;
  outC->every = outC->_L5;
  kcg_copy_CompressedPackets_T_Common_Types_Pkg(&outC->_L3, B_data_in);
  if (outC->every) {
    /* _L6=(TM_trackside::Write_P137#1)/ */
    Write_P137_TM_trackside(
      &outC->_L4,
      &outC->_L3,
      &outC->Context_Write_P137_1);
    _1_op_call = outC->Context_Write_P137_1.Error;
    kcg_copy_CompressedPackets_T_Common_Types_Pkg(
      &op_call,
      &outC->Context_Write_P137_1.RadioPacketsOut);
  }
  outC->_L8 = kcg_false;
  if (outC->every) {
    outC->_L6 = _1_op_call;
...
void Send_P137_init_MessageLibBaseline2(
  outC_Send_P137_MessageLibBaseline2 *outC)
{
  static kcg_size idx;
  ...
  outC->_L4.Q_SRSTOP = kcg_lit_int64(0);
  ...
  /* _L6=(TM_trackside::Write_P137#1)/ */
  Write_P137_init_TM_trackside(&outC->Context_Write_P137_1);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void Send_P137_reset_MessageLibBaseline2(
  outC_Send_P137_MessageLibBaseline2 *outC)
{
  /* _L6=(TM_trackside::Write_P137#1)/ */
  Write_P137_reset_TM_trackside(&outC->Context_Write_P137_1);
}
