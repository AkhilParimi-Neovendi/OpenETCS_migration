...
void Send_P058_init_MessageLibBaseline2(
  outC_Send_P058_MessageLibBaseline2 *outC)
{
  static kcg_size idx;
  ...
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L4.SECTIONS[idx2].D_LOC = kcg_lit_int32(0);
    outC->_L4.SECTIONS[idx2].Q_LGTLOC = kcg_lit_int32(0);
  }
...
void Send_P058_reset_MessageLibBaseline2(
  outC_Send_P058_MessageLibBaseline2 *outC)
{
  /* _L6=(TM_trackside::Write_P058#1)/ */
