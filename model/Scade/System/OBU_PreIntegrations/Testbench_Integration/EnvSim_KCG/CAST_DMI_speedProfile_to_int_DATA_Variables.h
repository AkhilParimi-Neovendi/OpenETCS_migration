...
typedef struct {
  ...
  outC_CAST_DMI_speedProfileElement_to_int_DATA_Variables /* _L5=(DATA::Variables::CAST_DMI_speedProfileElement_to_int#1)/ */ Context_CAST_DMI_speedProfileElement_to_int_1[32];
