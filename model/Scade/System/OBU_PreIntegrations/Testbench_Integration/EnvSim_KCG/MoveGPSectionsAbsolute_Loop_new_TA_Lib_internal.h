...
} outC_MoveGPSectionsAbsolute_Loop_new_TA_Lib_internal;
...
extern void MoveGPSectionsAbsolute_Loop_new_reset_TA_Lib_internal(
  outC_MoveGPSectionsAbsolute_Loop_new_TA_Lib_internal *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void MoveGPSectionsAbsolute_Loop_new_init_TA_Lib_internal(
  outC_MoveGPSectionsAbsolute_Loop_new_TA_Lib_internal *outC);
