  ...
  outC_Amsterdam_Utrecht_US_US_Integration_November *outC)
{
  ...
  outC->_L10.Header.radioDevice = kcg_lit_int64(0);
  outC->_L10.Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L10.Header.nid_message = kcg_lit_int64(0);
  outC->_L10.Header.t_train = kcg_lit_int64(0);
  outC->_L10.Header.m_ack = kcg_lit_int64(0);
  outC->_L10.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L10.Header.t_train_reference = kcg_lit_int64(0);
  outC->_L10.Header.nid_em = kcg_lit_int64(0);
  outC->_L10.Header.q_scale = kcg_lit_int64(0);
  outC->_L10.Header.d_sr = kcg_lit_int64(0);
  outC->_L10.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L10.Header.d_ref = kcg_lit_int64(0);
  outC->_L10.Header.q_dir = kcg_lit_int64(0);
  outC->_L10.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L10.Header.m_version = kcg_lit_int64(0);
  for (idx = 0; idx < 30; idx++) {
    outC->_L10.Messages.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L10.Messages.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L10.Messages.PacketHeaders[idx].valid = kcg_true;
    outC->_L10.Messages.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L10.Messages.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L10.Messages.PacketData[idx1] = kcg_lit_int64(0);
  }
  outC->_L13 = kcg_lit_int64(0);
  outC->_L8.radioDevice = kcg_lit_int64(0);
  outC->_L8.receivedSystemTime = kcg_lit_int64(0);
  ...
  outC->_L8.t_train_reference = kcg_lit_int64(0);
  outC->_L8.nid_em = kcg_lit_int64(0);
  outC->_L8.q_scale = Q_SCALE_10_cm_scale;
  outC->_L8.d_sr = kcg_lit_int64(0);
  outC->_L8.t_sh_rqst = kcg_lit_int64(0);
  outC->_L8.d_ref = kcg_lit_int64(0);
  outC->_L8.q_dir = Q_DIR_Reverse;
  outC->_L8.d_emergencystop = kcg_lit_int64(0);
  outC->_L8.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L9.PacketHeaders[idx2].nid_packet = kcg_lit_int64(0);
    outC->_L9.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L9.PacketHeaders[idx2].valid = kcg_true;
    outC->_L9.PacketHeaders[idx2].startAddress = kcg_lit_int64(0);
    outC->_L9.PacketHeaders[idx2].endAddress = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L9.PacketData[idx3] = kcg_lit_int64(0);
  }
  ...
  outC->_L5.q_updown = kcg_lit_int64(0);
  outC->_L5.m_version = kcg_lit_int64(0);
  outC->_L5.q_media = kcg_lit_int64(0);
  outC->_L5.n_pig = kcg_lit_int64(0);
  outC->_L5.n_total = kcg_lit_int64(0);
  outC->_L5.m_dup = kcg_lit_int64(0);
  outC->_L5.m_mcount = kcg_lit_int64(0);
  outC->_L5.nid_c = kcg_lit_int64(0);
  outC->_L5.nid_bg = kcg_lit_int64(0);
  outC->_L5.q_link = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L6.PacketHeaders[idx4].nid_packet = kcg_lit_int64(0);
    outC->_L6.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L6.PacketHeaders[idx4].valid = kcg_true;
    outC->_L6.PacketHeaders[idx4].startAddress = kcg_lit_int64(0);
    outC->_L6.PacketHeaders[idx4].endAddress = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L6.PacketData[idx5] = kcg_lit_int64(0);
  }
  ...
  CASTLIB_BaliseHeaders_init_TM_conversions(
    &outC->Context_CASTLIB_BaliseHeaders_1);
  /* _L8=(US_Integration_November::Amsterdam_Utrecht_RBC_Integration#1)/ */
  Amsterdam_Utrecht_RBC_Integration_init_US_Integration_November(
    &outC->Context_Amsterdam_Utrecht_RBC_Integration_1);
  /* _L1=(AmsterdamUtrechtL2::AmsterdamUtrechtTrack1::Amsterdam_Utrecht_Lijn1_balises#1)/ */
  Amsterdam_Utrecht_Lijn1_balises_init_AmsterdamUtrechtL2_AmsterdamUtrechtTrack1(
    &outC->Context_Amsterdam_Utrecht_Lijn1_balises_1);
}
  ...
  outC_Amsterdam_Utrecht_US_US_Integration_November *outC)
{
  ...
  CASTLIB_BaliseHeaders_reset_TM_conversions(
    &outC->Context_CASTLIB_BaliseHeaders_1);
  /* _L8=(US_Integration_November::Amsterdam_Utrecht_RBC_Integration#1)/ */
  Amsterdam_Utrecht_RBC_Integration_reset_US_Integration_November(
    &outC->Context_Amsterdam_Utrecht_RBC_Integration_1);
  /* _L1=(AmsterdamUtrechtL2::AmsterdamUtrechtTrack1::Amsterdam_Utrecht_Lijn1_balises#1)/ */
  Amsterdam_Utrecht_Lijn1_balises_reset_AmsterdamUtrechtL2_AmsterdamUtrechtTrack1(
    &outC->Context_Amsterdam_Utrecht_Lijn1_balises_1);
}
