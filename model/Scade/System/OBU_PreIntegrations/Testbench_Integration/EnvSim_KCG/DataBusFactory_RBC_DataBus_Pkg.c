  ...
  outC_DataBusFactory_RBC_DataBus_Pkg *outC)
{
  ...
  kcg_copy__55_array(
    &outC->_L38,
    (_55_array *) &DIAG_MSG_DEFAULT_ARRAY_RBC_Diagnostic_Pkg);
  kcg_copy_RBC_Data_T_RBC_DataBus_Pkg(&outC->_L8, inDataBus);
  kcg_copy__55_array(&outC->_L16, &outC->_L8.diagnostic);
  outC->_L3 = outC->o_times_1_int32;
  /* _L28= */
  if (outC->_L3) {
    kcg_copy__55_array(&outC->_L28, &outC->_L38);
  }
  else {
    kcg_copy__55_array(&outC->_L28, &outC->_L16);
  }
  ...
  kcg_copy__55_array(&outC->_L17.diagnostic, &outC->_L28);
