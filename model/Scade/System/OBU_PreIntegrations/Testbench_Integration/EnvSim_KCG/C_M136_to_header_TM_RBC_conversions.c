...
{
  kcg_copy_M_136_T_TM_radio_messages(&outC->_L1, Message_Data_in);
...
void C_M136_to_header_init_TM_RBC_conversions(
  outC_C_M136_to_header_TM_RBC_conversions *outC)
{
...
void C_M136_to_header_reset_TM_RBC_conversions(
  outC_C_M136_to_header_TM_RBC_conversions *outC)
{
  /* _L20=(TM_conversions::CAST_T_TRAIN_to_int#1)/ */
