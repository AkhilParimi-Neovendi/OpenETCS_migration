  ...
  outC_radioStatusRouter_Handover_Pkg_handoverUtils_Pkg *outC)
{
  ...
  outC->_L34_else_IfBlock1.connection.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L34_else_IfBlock1.session.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L35_else_IfBlock1.connection.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L35_else_IfBlock1.session.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L39_else_IfBlock1.connection.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L39_else_IfBlock1.session.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L40_else_IfBlock1.connection.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L40_else_IfBlock1.session.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L11_then_IfBlock1.connection.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L11_then_IfBlock1.session.nid_radio = kcg_lit_int32(0);
  ...
  outC->morcStatusFromHandingOverRBC.connection.nid_radio = kcg_lit_int32(0);
  ...
  outC->morcStatusFromHandingOverRBC.session.nid_radio = kcg_lit_int32(0);
  ...
  outC->morcStatusFromAcceptingRBC.connection.status =
    mcs_disconnected_RCM_Types_Pkg;
  outC->morcStatusFromAcceptingRBC.connection.nid_radio = kcg_lit_int32(0);
  ...
  outC->morcStatusFromAcceptingRBC.session.nid_radio = kcg_lit_int32(0);
}
