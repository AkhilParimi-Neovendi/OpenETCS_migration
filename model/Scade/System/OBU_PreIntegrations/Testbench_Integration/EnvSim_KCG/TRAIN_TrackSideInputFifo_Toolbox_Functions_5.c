  ...
  outC_TRAIN_TrackSideInputFifo_Toolbox_Functions_5 *outC)
{
  ...
  if (outC->IfBlock1_clock_5) {
    ...
    /* IfBlock1:then:_L22= */
    if (outC->init1) {
      kcg_copy__101_array(&outC->_L22_then_IfBlock1_5, &outC->_L19_then_IfBlock1_5);
    }
    else {
    ...
    kcg_copy__101_array(&buffer_partial_5, &outC->_L1_then_IfBlock1_5);
    kcg_copy__101_array(&outC->buffer_5, &buffer_partial_5);
  }
  else {
    kcg_copy__101_array(&_2_buffer_partial_5, &last_buffer_5);
