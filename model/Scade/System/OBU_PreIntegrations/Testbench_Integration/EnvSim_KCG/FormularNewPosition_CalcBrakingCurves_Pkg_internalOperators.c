  ...
  outC_FormularNewPosition_CalcBrakingCurves_Pkg_internalOperators *outC)
{
  ...
  Square_mathext_float64(outC->_L3, &outC->Context_Square_1);
  outC->_L6 = outC->Context_Square_1.Square_Out_float64;
  outC->_L2 = inEndSpeed;
  /* _L7=(mathext::Square#2)/ */
  Square_mathext_float64(outC->_L2, &outC->Context_Square_2);
  outC->_L7 = outC->Context_Square_2.Square_Out_float64;
  outC->_L8 = outC->_L7 - outC->_L6;
  outC->_L4 = inAcceleration;
  outC->_L11 = kcg_lit_float64(2.0);
  ...
  outC_FormularNewPosition_CalcBrakingCurves_Pkg_internalOperators *outC)
{
  ...
  outC->outD1 = kcg_lit_float64(0.0);
  /* _L7=(mathext::Square#2)/ */
