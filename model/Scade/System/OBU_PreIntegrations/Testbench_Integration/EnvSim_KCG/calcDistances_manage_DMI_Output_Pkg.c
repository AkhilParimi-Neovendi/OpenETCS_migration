  ...
  outC_calcDistances_manage_DMI_Output_Pkg *outC)
{
  ...
  if (outC->IfBlock1_clock) {
    ...
    outC->_L1_else_IfBlock1 = kcg_lit_int64(-1);
  ...
  outC_calcDistances_manage_DMI_Output_Pkg *outC)
{
  ...
  outC->outDistance_ToTSA = kcg_lit_int64(0);
  outC->ouDistanceKP_Balise = kcg_lit_int64(0);
  outC->outLocationKP_Balise_Track = kcg_lit_int64(0);
}
