  ...
  outC_C_P015_to_legacy_loop_TM_conversions *outC)
{
  ...
  for (idx = 0; idx < 32; idx++) {
    ...
    outC->_L137.sections[idx].l_section = kcg_lit_int64(0);
    outC->_L137.sections[idx].q_sectiontimer =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L137.sections[idx].t_sectiontimer = kcg_lit_int64(0);
    outC->_L137.sections[idx].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  ...
  outC->_L132.v_loa = kcg_lit_int64(0);
  outC->_L132.t_loa = kcg_lit_int64(0);
  outC->_L132.n_iter = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 32; idx1++) {
    outC->_L132.sections[idx1].valid = kcg_true;
    outC->_L132.sections[idx1].l_section = kcg_lit_int64(0);
    outC->_L132.sections[idx1].q_sectiontimer =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L132.sections[idx1].t_sectiontimer = kcg_lit_int64(0);
    outC->_L132.sections[idx1].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->_L132.l_endsection = kcg_lit_int64(0);
  outC->_L132.q_sectiontimer = Q_SECTIONTIMER_No_Section_Timer_information;
  outC->_L132.t_sectiontimer = kcg_lit_int64(0);
  outC->_L132.d_sectiontimerstoploc = kcg_lit_int64(0);
  outC->_L132.q_endtimer = Q_ENDTIMER_No_End_section_timer_information;
  outC->_L132.t_endtimer = kcg_lit_int64(0);
  outC->_L132.d_endtimerstartloc = kcg_lit_int64(0);
  outC->_L132.q_dangerpoint = Q_DANGERPOINT_No_danger_point_information;
  outC->_L132.d_dp = kcg_lit_int64(0);
  outC->_L132.v_releasedp = kcg_lit_int64(0);
  outC->_L132.q_overlap = Q_OVERLAP_No_overlap_information;
  outC->_L132.d_startol = kcg_lit_int64(0);
  outC->_L132.t_ol = kcg_lit_int64(0);
  outC->_L132.d_ol = kcg_lit_int64(0);
  outC->_L132.v_releaseol = kcg_lit_int64(0);
  ...
  outC->_L21.l_section = kcg_lit_int64(0);
  outC->_L21.q_sectiontimer = Q_SECTIONTIMER_No_Section_Timer_information;
  outC->_L21.t_sectiontimer = kcg_lit_int64(0);
  outC->_L21.d_sectiontimerstoploc = kcg_lit_int64(0);
  ...
  outC->_L2.t_sectiontimer_k = kcg_lit_int64(0);
  outC->_L2.d_sectiontimerstoploc_k = kcg_lit_int64(0);
  ...
  for (idx2 = 0; idx2 < 32; idx2++) {
    ...
    outC->_L1[idx2].l_section = kcg_lit_int64(0);
    outC->_L1[idx2].q_sectiontimer = Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L1[idx2].t_sectiontimer = kcg_lit_int64(0);
    outC->_L1[idx2].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  ...
  outC->P015_legacy_out.v_loa = kcg_lit_int64(0);
  outC->P015_legacy_out.t_loa = kcg_lit_int64(0);
  outC->P015_legacy_out.l_section = kcg_lit_int64(0);
  outC->P015_legacy_out.q_sectiontimer_k =
    Q_SECTIONTIMER_No_Section_Timer_information;
  outC->P015_legacy_out.t_sectiontimer_k = kcg_lit_int64(0);
  outC->P015_legacy_out.d_sectiontimerstoploc_k = kcg_lit_int64(0);
  outC->P015_legacy_out.l_endsection = kcg_lit_int64(0);
  outC->P015_legacy_out.q_sectiontimer =
    Q_SECTIONTIMER_No_Section_Timer_information;
  outC->P015_legacy_out.t_sectiontimer = kcg_lit_int64(0);
  outC->P015_legacy_out.d_sectiontimerstoploc = kcg_lit_int64(0);
  outC->P015_legacy_out.q_endtimer = Q_ENDTIMER_No_End_section_timer_information;
  outC->P015_legacy_out.t_endtimer = kcg_lit_int64(0);
  outC->P015_legacy_out.d_endtimerstartloc = kcg_lit_int64(0);
  outC->P015_legacy_out.q_dangerpoint = Q_DANGERPOINT_No_danger_point_information;
  outC->P015_legacy_out.d_dp = kcg_lit_int64(0);
  outC->P015_legacy_out.v_releasedp = kcg_lit_int64(0);
  outC->P015_legacy_out.q_overlap = Q_OVERLAP_No_overlap_information;
  outC->P015_legacy_out.d_startol = kcg_lit_int64(0);
  outC->P015_legacy_out.t_ol = kcg_lit_int64(0);
  outC->P015_legacy_out.d_ol = kcg_lit_int64(0);
  outC->P015_legacy_out.v_releaseol = kcg_lit_int64(0);
}
