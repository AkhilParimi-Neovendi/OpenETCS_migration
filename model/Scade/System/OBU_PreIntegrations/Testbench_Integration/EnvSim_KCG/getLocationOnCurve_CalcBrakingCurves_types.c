  ...
  outC_getLocationOnCurve_CalcBrakingCurves_types *outC)
{
  ...
  if (outC->_L45) {
    ...
    for (idx1 = 0; idx1 < 114; idx1++) {
      acc = outC->_L43;
      outC->_L112_searchIdxFloorBackward_1[idx1] = kcg_lit_float64(0.0);
      ...
      outC->_L114_searchIdxFloorBackward_1[idx1] =
        !outC->_L115_searchIdxFloorBackward_1[idx1];
      outC->_L86_searchIdxFloorBackward_1[idx1] = /* _L44= */(kcg_int64) idx1;
      ...
      outC->_L44 = /* _L44= */(kcg_int64) (idx1 + 1);
      /* _L44= */
  ...
  outC->idx = outC->_L43;
  outC->_L39 = outC->idx;
  if ((kcg_lit_int64(0) <= outC->_L39) & (outC->_L39 < kcg_lit_int64(114))) {
  ...
  outC_getLocationOnCurve_CalcBrakingCurves_types *outC)
{
  ...
  outC->_L32.acceleration = kcg_lit_float64(0.0);
  outC->_L34 = kcg_lit_float64(0.0);
  ...
  for (idx5 = 0; idx5 < 114; idx5++) {
    outC->_L1.distances[idx5] = kcg_lit_float64(0.0);
  }
  for (idx6 = 0; idx6 < 114; idx6++) {
    outC->_L1.speeds[idx6] = kcg_lit_float64(0.0);
  }
  for (idx7 = 0; idx7 < 114; idx7++) {
    outC->_L1.accelerations[idx7] = kcg_lit_float64(0.0);
  }
  ...
  for (idx9 = 0; idx9 < 114; idx9++) {
    outC->_L8_searchIdxFloorBackward_1[idx9] = kcg_lit_int64(0);
  }
  for (idx10 = 0; idx10 < 114; idx10++) {
    outC->_L40_searchIdxFloorBackward_1[idx10] = kcg_lit_float64(0.0);
  }
  for (idx11 = 0; idx11 < 114; idx11++) {
    outC->_L84_searchIdxFloorBackward_1[idx11] = kcg_lit_int64(0);
  }
  for (idx12 = 0; idx12 < 114; idx12++) {
    outC->_L74_searchIdxFloorBackward_1[idx12] = kcg_lit_float64(0.0);
  }
  for (idx13 = 0; idx13 < 114; idx13++) {
    outC->_L86_searchIdxFloorBackward_1[idx13] = kcg_lit_int64(0);
  }
  for (idx14 = 0; idx14 < 114; idx14++) {
    outC->_L90_searchIdxFloorBackward_1[idx14] = kcg_true;
  }
  for (idx15 = 0; idx15 < 114; idx15++) {
    outC->_L111_searchIdxFloorBackward_1[idx15] = kcg_lit_float64(0.0);
  }
  for (idx16 = 0; idx16 < 114; idx16++) {
    outC->_L112_searchIdxFloorBackward_1[idx16] = kcg_lit_float64(0.0);
  }
