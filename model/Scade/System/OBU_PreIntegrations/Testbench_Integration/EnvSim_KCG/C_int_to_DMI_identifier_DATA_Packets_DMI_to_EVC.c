  ...
  outC_C_int_to_DMI_identifier_DATA_Packets_DMI_to_EVC *outC)
{
  ...
  CAST_int_to_DMI_DMI_identifier_DATA_Variables(
    outC->_L274,
  ...
  outC_C_int_to_DMI_identifier_DATA_Packets_DMI_to_EVC *outC)
{
  ...
  outC->_L276 = kcg_lit_int64(0);
  outC->_L275 = kcg_lit_int64(0);
  outC->_L274 = kcg_lit_int64(0);
  outC->_L273 = kcg_lit_int64(0);
  outC->_L272 = kcg_lit_int64(0);
  outC->_L271 = kcg_lit_int64(0);
  for (idx = 0; idx < 255; idx++) {
    outC->_L270[idx] = kcg_lit_int64(0);
  }
  outC->_L14 = kcg_true;
  outC->_L13 =
  ...
  outC->dmi_identifier_ct_out.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  /* _L10=(DATA::Variables::CAST_int_to_DMI_DMI_identifier#1)/ */
  CAST_int_to_DMI_DMI_identifier_init_DATA_Variables(
    &outC->Context_CAST_int_to_DMI_DMI_identifier_1);
  /* _L11=(DATA::Variables::CAST_int_to_DMI_Cabin_identifier#1)/ */
  CAST_int_to_DMI_Cabin_identifier_init_DATA_Variables(
    &outC->Context_CAST_int_to_DMI_Cabin_identifier_1);
  /* _L12=(DATA::Variables::CAST_int_to_DMI_TEXT#1)/ */
...
{
  /* _L10=(DATA::Variables::CAST_int_to_DMI_DMI_identifier#1)/ */
  CAST_int_to_DMI_DMI_identifier_reset_DATA_Variables(
    &outC->Context_CAST_int_to_DMI_DMI_identifier_1);
  /* _L11=(DATA::Variables::CAST_int_to_DMI_Cabin_identifier#1)/ */
  CAST_int_to_DMI_Cabin_identifier_reset_DATA_Variables(
    &outC->Context_CAST_int_to_DMI_Cabin_identifier_1);
  /* _L12=(DATA::Variables::CAST_int_to_DMI_TEXT#1)/ */
