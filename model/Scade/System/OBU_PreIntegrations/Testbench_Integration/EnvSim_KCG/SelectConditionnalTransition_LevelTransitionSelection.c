  ...
  outC_SelectConditionnalTransition_LevelTransitionSelection *outC)
{
  ...
  /* Available_for_use/ */
  static kcg_bool Available_for_use_partial;
  /* output_level_transition/ */
  static T_LevelTransition_Level_And_Mode_Types_Pkg output_level_transition_partial;
  /* Available_for_use/ */
  static kcg_bool _2_Available_for_use_partial;
  /* output_level_transition/ */
  static T_LevelTransition_Level_And_Mode_Types_Pkg _3_output_level_transition_partial;
