  ...
  outC_Packets_BG14_100_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L34.PacketHeaders[idx].nid_packet = kcg_lit_int32(0);
    outC->_L34.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L34.PacketHeaders[idx].valid = kcg_true;
    outC->_L34.PacketHeaders[idx].startAddress = kcg_lit_int32(0);
    outC->_L34.PacketHeaders[idx].endAddress = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L34.PacketData[idx1] = kcg_lit_int32(0);
  }
  outC->_L33 = kcg_true;
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L32.packets.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    outC->_L32.packets.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L32.packets.PacketHeaders[idx2].valid = kcg_true;
    outC->_L32.packets.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L32.packets.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L32.packets.PacketData[idx3] = kcg_lit_int32(0);
  }
  ...
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L31.packets.PacketHeaders[idx4].nid_packet = kcg_lit_int32(0);
    outC->_L31.packets.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L31.packets.PacketHeaders[idx4].valid = kcg_true;
    outC->_L31.packets.PacketHeaders[idx4].startAddress = kcg_lit_int32(0);
    outC->_L31.packets.PacketHeaders[idx4].endAddress = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L31.packets.PacketData[idx5] = kcg_lit_int32(0);
  }
  ...
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L30.PacketHeaders[idx6].nid_packet = kcg_lit_int32(0);
    outC->_L30.PacketHeaders[idx6].q_dir = Q_DIR_Reverse;
    outC->_L30.PacketHeaders[idx6].valid = kcg_true;
    outC->_L30.PacketHeaders[idx6].startAddress = kcg_lit_int32(0);
    outC->_L30.PacketHeaders[idx6].endAddress = kcg_lit_int32(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->_L30.PacketData[idx7] = kcg_lit_int32(0);
  }
  ...
  for (idx8 = 0; idx8 < 30; idx8++) {
    outC->_L29.packets.PacketHeaders[idx8].nid_packet = kcg_lit_int32(0);
    outC->_L29.packets.PacketHeaders[idx8].q_dir = Q_DIR_Reverse;
    outC->_L29.packets.PacketHeaders[idx8].valid = kcg_true;
    outC->_L29.packets.PacketHeaders[idx8].startAddress = kcg_lit_int32(0);
    outC->_L29.packets.PacketHeaders[idx8].endAddress = kcg_lit_int32(0);
  }
  for (idx9 = 0; idx9 < 500; idx9++) {
    outC->_L29.packets.PacketData[idx9] = kcg_lit_int32(0);
  }
  ...
  for (idx10 = 0; idx10 < 30; idx10++) {
    outC->_L26.packets.PacketHeaders[idx10].nid_packet = kcg_lit_int32(0);
    outC->_L26.packets.PacketHeaders[idx10].q_dir = Q_DIR_Reverse;
    outC->_L26.packets.PacketHeaders[idx10].valid = kcg_true;
    outC->_L26.packets.PacketHeaders[idx10].startAddress = kcg_lit_int32(0);
    outC->_L26.packets.PacketHeaders[idx10].endAddress = kcg_lit_int32(0);
  }
  for (idx11 = 0; idx11 < 500; idx11++) {
    outC->_L26.packets.PacketData[idx11] = kcg_lit_int32(0);
  }
  ...
  for (idx12 = 0; idx12 < 30; idx12++) {
    outC->_L25.PacketHeaders[idx12].nid_packet = kcg_lit_int32(0);
    outC->_L25.PacketHeaders[idx12].q_dir = Q_DIR_Reverse;
    outC->_L25.PacketHeaders[idx12].valid = kcg_true;
    outC->_L25.PacketHeaders[idx12].startAddress = kcg_lit_int32(0);
    outC->_L25.PacketHeaders[idx12].endAddress = kcg_lit_int32(0);
  }
  for (idx13 = 0; idx13 < 500; idx13++) {
    outC->_L25.PacketData[idx13] = kcg_lit_int32(0);
  }
  ...
  for (idx16 = 0; idx16 < 30; idx16++) {
    outC->_L11.PacketHeaders[idx16].nid_packet = kcg_lit_int32(0);
    outC->_L11.PacketHeaders[idx16].q_dir = Q_DIR_Reverse;
    outC->_L11.PacketHeaders[idx16].valid = kcg_true;
    outC->_L11.PacketHeaders[idx16].startAddress = kcg_lit_int32(0);
    outC->_L11.PacketHeaders[idx16].endAddress = kcg_lit_int32(0);
  }
  for (idx17 = 0; idx17 < 500; idx17++) {
    outC->_L11.PacketData[idx17] = kcg_lit_int32(0);
  }
  for (idx18 = 0; idx18 < 30; idx18++) {
    outC->B_data_out.PacketHeaders[idx18].nid_packet = kcg_lit_int32(0);
    outC->B_data_out.PacketHeaders[idx18].q_dir = Q_DIR_Reverse;
    outC->B_data_out.PacketHeaders[idx18].valid = kcg_true;
    outC->B_data_out.PacketHeaders[idx18].startAddress = kcg_lit_int32(0);
    outC->B_data_out.PacketHeaders[idx18].endAddress = kcg_lit_int32(0);
  }
  for (idx19 = 0; idx19 < 500; idx19++) {
    outC->B_data_out.PacketData[idx19] = kcg_lit_int32(0);
  }
  for (idx20 = 0; idx20 < 30; idx20++) {
    outC->B_data_in.PacketHeaders[idx20].nid_packet = kcg_lit_int32(0);
    outC->B_data_in.PacketHeaders[idx20].q_dir = Q_DIR_Reverse;
    outC->B_data_in.PacketHeaders[idx20].valid = kcg_true;
    outC->B_data_in.PacketHeaders[idx20].startAddress = kcg_lit_int32(0);
    outC->B_data_in.PacketHeaders[idx20].endAddress = kcg_lit_int32(0);
  }
  for (idx21 = 0; idx21 < 500; idx21++) {
    outC->B_data_in.PacketData[idx21] = kcg_lit_int32(0);
  }
  ...
  for (idx23 = 0; idx23 < 500; idx23++) {
    outC->Balise_data_out.packets.PacketData[idx23] = kcg_lit_int32(0);
  }
