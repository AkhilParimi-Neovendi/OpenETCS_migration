  ...
  outC_collectRadioOutput_radioOutput_Pkg *outC)
{
  ...
  for (idx = 0; idx < 50; idx++) {
    outC->_L33.OptionalPackets[idx] = kcg_lit_int32(0);
  }
  outC->_L32 = kcg_true;
  outC->_L31.Message.valid = kcg_true;
  outC->_L31.Message.nid_message = kcg_lit_int32(0);
  outC->_L31.Message.l_message = kcg_lit_int32(0);
  outC->_L31.Message.t_train = kcg_lit_int32(0);
  outC->_L31.Message.nid_engine = kcg_lit_int32(0);
  outC->_L31.Message.field1 = kcg_lit_int32(0);
  outC->_L31.Message.field2 = kcg_lit_int32(0);
  outC->_L31.Message.field3 = kcg_lit_int32(0);
  for (idx1 = 0; idx1 < 50; idx1++) {
    outC->_L31.OptionalPackets[idx1] = kcg_lit_int32(0);
  }
  outC->_L30 = kcg_true;
  outC->_L29 = kcg_true;
  outC->_L28 = sp_terminated_RCM_Session_Types_Pkg;
  ...
  outC->_L24.session.nid_c = kcg_lit_int32(0);
  outC->_L24.session.nid_rbc = kcg_lit_int32(0);
  outC->_L24.session.nid_radio = kcg_lit_int32(0);
  outC->_L22.valid = kcg_true;
  outC->_L22.cmd = cmdr_not_relevant_API_RadioCommunication_Pkg;
  outC->_L22.networkID = kcg_lit_int32(0);
  outC->_L20 = kcg_lit_int32(0);
  outC->_L19 =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L1[idx3].Message.valid = kcg_true;
    outC->_L1[idx3].Message.nid_message = kcg_lit_int32(0);
    outC->_L1[idx3].Message.l_message = kcg_lit_int32(0);
    outC->_L1[idx3].Message.t_train = kcg_lit_int32(0);
    outC->_L1[idx3].Message.nid_engine = kcg_lit_int32(0);
    outC->_L1[idx3].Message.field1 = kcg_lit_int32(0);
    outC->_L1[idx3].Message.field2 = kcg_lit_int32(0);
    outC->_L1[idx3].Message.field3 = kcg_lit_int32(0);
    for (idx2 = 0; idx2 < 50; idx2++) {
      outC->_L1[idx3].OptionalPackets[idx2] = kcg_lit_int32(0);
    }
  }
  ...
  for (idx4 = 0; idx4 < 50; idx4++) {
    outC->toRBC.OptionalPackets[idx4] = kcg_lit_int32(0);
  }
  /* _L33=(RadioSupport_Pkg::patchMsgFlow#1)/ */
