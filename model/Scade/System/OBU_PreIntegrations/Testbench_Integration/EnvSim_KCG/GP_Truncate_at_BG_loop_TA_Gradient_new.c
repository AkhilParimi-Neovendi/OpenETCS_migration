  ...
  outC_GP_Truncate_at_BG_loop_TA_Gradient_new *outC)
{
  ...
  outC->_L8.Loc_Absolute = kcg_lit_int64(0);
  outC->_L8.Loc_LRBG = kcg_lit_int64(0);
  outC->_L8.Gradient = kcg_lit_int64(0);
  outC->_L8.L_Gradient = kcg_lit_int64(0);
  ...
  for (idx1 = 0; idx1 < 50; idx1++) {
    ...
    outC->_L3[idx1].Loc_Absolute = kcg_lit_int64(0);
    outC->_L3[idx1].Loc_LRBG = kcg_lit_int64(0);
    outC->_L3[idx1].Gradient = kcg_lit_int64(0);
    outC->_L3[idx1].L_Gradient = kcg_lit_int64(0);
  }
  ...
  for (idx3 = 0; idx3 < 50; idx3++) {
    ...
    outC->Profile_out[idx3].Loc_Absolute = kcg_lit_int64(0);
    outC->Profile_out[idx3].Loc_LRBG = kcg_lit_int64(0);
    outC->Profile_out[idx3].Gradient = kcg_lit_int64(0);
    outC->Profile_out[idx3].L_Gradient = kcg_lit_int64(0);
  }
  outC->cont = kcg_true;
}
