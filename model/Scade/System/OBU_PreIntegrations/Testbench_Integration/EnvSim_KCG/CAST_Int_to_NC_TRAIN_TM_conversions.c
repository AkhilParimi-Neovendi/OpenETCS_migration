...
{
  /* nc_train/ */
  static NC_TRAIN nc_train_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* nc_train/ */
  static NC_TRAIN _1_nc_train_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* nc_train/ */
  static NC_TRAIN _3_nc_train_partial;
  /* error/ */
  static kcg_bool _4_error_partial;
  /* nc_train/ */
  static NC_TRAIN _5_nc_train_partial;
  /* error/ */
  static kcg_bool _6_error_partial;
  /* error/ */
  static kcg_bool _7_error_partial;
  /* nc_train/ */
  static NC_TRAIN _8_nc_train_partial;
  /* error/ */
  static kcg_bool _9_error_partial;
  /* nc_train/ */
  static NC_TRAIN _10_nc_train_partial;
  /* error/ */
  static kcg_bool _11_error_partial;
  /* nc_train/ */
  static NC_TRAIN _12_nc_train_partial;
  /* error/ */
  static kcg_bool _13_error_partial;
  /* nc_train/ */
  static NC_TRAIN _14_nc_train_partial;
