  ...
  outC_A_brake_safe_SDMConversionModelPkg *outC)
{
  ...
  for (idx4 = 0; idx4 < 6; idx4++) {
    acc = outC->_L18;
    outC->_L2_Max_1_int64[idx4] = outC->_L14[idx4];
    outC->_L1_Max_1_int64[idx4] = acc;
    outC->_L3_Max_1_int64[idx4] = outC->_L1_Max_1_int64[idx4] >=
      outC->_L2_Max_1_int64[idx4];
    /* @1/_L4= */
    if (outC->_L3_Max_1_int64[idx4]) {
      outC->_L4_Max_1_int64[idx4] = outC->_L1_Max_1_int64[idx4];
    }
    else {
      outC->_L4_Max_1_int64[idx4] = outC->_L2_Max_1_int64[idx4];
    }
    outC->_L18 = outC->_L4_Max_1_int64[idx4];
  }
  ...
  outC_A_brake_safe_SDMConversionModelPkg *outC)
{
  ...
  for (idx = 0; idx < 6; idx++) {
    outC->_L48[idx] = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 6; idx1++) {
    outC->_L47.a[idx1] = kcg_lit_int64(0);
  }
  for (idx2 = 0; idx2 < 6; idx2++) {
    outC->_L47.v[idx2] = kcg_lit_int64(0);
  }
  ...
  outC->_L34.trainLength = kcg_lit_int64(0);
  outC->_L34.brakePerctage = kcg_lit_int64(0);
  outC->_L34.maxTrainSpeed = kcg_lit_int64(0);
  ...
  outC->_L34.axleNumber = kcg_lit_int64(0);
  outC->_L34.numberNationalSystems = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L34.nationSystems[idx3] = kcg_lit_int64(0);
  }
  outC->_L34.numberTractionSystems = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 4; idx4++) {
    outC->_L34.tractionSystem[idx4].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L34.tractionSystem[idx4].nid_ctraction = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 13; idx5++) {
    outC->_L32.a[idx5] = kcg_lit_int64(0);
  }
  for (idx6 = 0; idx6 < 13; idx6++) {
    outC->_L32.v[idx6] = kcg_lit_int64(0);
  }
  outC->_L30.valid = kcg_true;
  outC->_L30.q_dir = Q_DIR_Reverse;
  outC->_L30.d_validnv = kcg_lit_int64(0);
  for (idx7 = 0; idx7 < 7; idx7++) {
    outC->_L30.nid_cArray[idx7].valid = kcg_true;
    outC->_L30.nid_cArray[idx7].nid_c = kcg_lit_int64(0);
  }
  outC->_L30.v_nvshunt = kcg_lit_int64(0);
  outC->_L30.v_nvstff = kcg_lit_int64(0);
  outC->_L30.v_nvonsight = kcg_lit_int64(0);
  outC->_L30.v_nvlimsuperv = kcg_lit_int64(0);
  outC->_L30.v_nvunfit = kcg_lit_int64(0);
  outC->_L30.v_nvrel = kcg_lit_int64(0);
  outC->_L30.d_nvroll = kcg_lit_int64(0);
  ...
  outC->_L30.v_nvallowovtrp = kcg_lit_int64(0);
  outC->_L30.v_nvsupovtrp = kcg_lit_int64(0);
  outC->_L30.d_nvovtrp = kcg_lit_int64(0);
  outC->_L30.t_nvovtrp = kcg_lit_int64(0);
  outC->_L30.d_nvpotrp = kcg_lit_int64(0);
  outC->_L30.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->_L30.t_nvcontact = kcg_lit_int64(0);
  outC->_L30.m_nvderun = M_NVDERUN_No;
  outC->_L30.d_nvstff = kcg_lit_int64(0);
  outC->_L30.q_nvdriver_adhes = Q_NVDRIVER_ADHES_Not_allowed;
  outC->_L30.a_nvmaxredadh1 = kcg_lit_float64(0.0);
  outC->_L30.a_nvmaxredadh2 = kcg_lit_float64(0.0);
  outC->_L30.a_nvmaxredadh3 = kcg_lit_float64(0.0);
  outC->_L30.q_nvlocacc = kcg_lit_int64(0);
  outC->_L30.m_nvavadh = kcg_lit_float64(0.0);
  ...
  for (idx9 = 0; idx9 < 7; idx9++) {
    ...
    outC->_L30.nvkvintsetArray[idx9].a_nvp12 = kcg_lit_float64(0.0);
    outC->_L30.nvkvintsetArray[idx9].a_nvp23 = kcg_lit_float64(0.0);
    for (idx8 = 0; idx8 < 7; idx8++) {
      outC->_L30.nvkvintsetArray[idx9].nvkintArray[idx8].valid = kcg_true;
      outC->_L30.nvkvintsetArray[idx9].nvkintArray[idx8].v_nvkvint = kcg_lit_int64(0);
  ...
  for (idx10 = 0; idx10 < 7; idx10++) {
    ...
    outC->_L30.nvkrintArray[idx10].m_nvkrint = kcg_lit_float64(0.0);
  }
  outC->_L30.m_nvktint = kcg_lit_float64(0.0);
  outC->_L26 = kcg_lit_int64(0);
  for (idx11 = 0; idx11 < 6; idx11++) {
    outC->_L25[idx11] = kcg_lit_int64(0);
  }
  ...
  for (idx13 = 0; idx13 < 6; idx13++) {
    outC->_L17[idx13] = kcg_lit_int64(0);
  }
  for (idx14 = 0; idx14 < 6; idx14++) {
    outC->_L16[idx14] = kcg_lit_int64(0);
  }
  for (idx15 = 0; idx15 < 6; idx15++) {
    outC->_L14[idx15] = kcg_lit_int64(0);
  }
  for (idx16 = 0; idx16 < 6; idx16++) {
    outC->_L13.emergency.a[idx16] = kcg_lit_int64(0);
  }
  for (idx17 = 0; idx17 < 6; idx17++) {
    outC->_L13.emergency.v[idx17] = kcg_lit_int64(0);
  }
  for (idx18 = 0; idx18 < 6; idx18++) {
    outC->_L13.service.a[idx18] = kcg_lit_int64(0);
  }
  for (idx19 = 0; idx19 < 6; idx19++) {
    outC->_L13.service.v[idx19] = kcg_lit_int64(0);
  }
  ...
  outC->_L12.trainLength = kcg_lit_int64(0);
  outC->_L12.brakePerctage = kcg_lit_int64(0);
  outC->_L12.maxTrainSpeed = kcg_lit_int64(0);
  outC->_L12.loadingGauge =
    M_LOADINGGAUGE_The_train_does_not_fit_to_any_of_the_interoperable_loading_gauge_profiles;
  outC->_L12.axleLoadCategory = M_AXLELOADCAT_A;
  outC->_L12.airtightSystem = M_AIRTIGHT_Not_fitted;
  outC->_L12.axleNumber = kcg_lit_int64(0);
  outC->_L12.numberNationalSystems = kcg_lit_int64(0);
  for (idx20 = 0; idx20 < 5; idx20++) {
    outC->_L12.nationSystems[idx20] = kcg_lit_int64(0);
  }
  outC->_L12.numberTractionSystems = kcg_lit_int64(0);
  for (idx21 = 0; idx21 < 4; idx21++) {
    outC->_L12.tractionSystem[idx21].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L12.tractionSystem[idx21].nid_ctraction = kcg_lit_int64(0);
  }
  outC->_L11.valid = kcg_true;
  outC->_L11.q_dir = Q_DIR_Reverse;
  outC->_L11.d_validnv = kcg_lit_int64(0);
  for (idx22 = 0; idx22 < 7; idx22++) {
    outC->_L11.nid_cArray[idx22].valid = kcg_true;
    outC->_L11.nid_cArray[idx22].nid_c = kcg_lit_int64(0);
  }
  outC->_L11.v_nvshunt = kcg_lit_int64(0);
  outC->_L11.v_nvstff = kcg_lit_int64(0);
  outC->_L11.v_nvonsight = kcg_lit_int64(0);
  outC->_L11.v_nvlimsuperv = kcg_lit_int64(0);
  outC->_L11.v_nvunfit = kcg_lit_int64(0);
  outC->_L11.v_nvrel = kcg_lit_int64(0);
  outC->_L11.d_nvroll = kcg_lit_int64(0);
  ...
  outC->_L11.v_nvallowovtrp = kcg_lit_int64(0);
  outC->_L11.v_nvsupovtrp = kcg_lit_int64(0);
  outC->_L11.d_nvovtrp = kcg_lit_int64(0);
  outC->_L11.t_nvovtrp = kcg_lit_int64(0);
  outC->_L11.d_nvpotrp = kcg_lit_int64(0);
  outC->_L11.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->_L11.t_nvcontact = kcg_lit_int64(0);
  outC->_L11.m_nvderun = M_NVDERUN_No;
  outC->_L11.d_nvstff = kcg_lit_int64(0);
  outC->_L11.q_nvdriver_adhes = Q_NVDRIVER_ADHES_Not_allowed;
  outC->_L11.a_nvmaxredadh1 = kcg_lit_float64(0.0);
  outC->_L11.a_nvmaxredadh2 = kcg_lit_float64(0.0);
  outC->_L11.a_nvmaxredadh3 = kcg_lit_float64(0.0);
  outC->_L11.q_nvlocacc = kcg_lit_int64(0);
  outC->_L11.m_nvavadh = kcg_lit_float64(0.0);
  ...
  for (idx24 = 0; idx24 < 7; idx24++) {
    ...
    outC->_L11.nvkvintsetArray[idx24].a_nvp12 = kcg_lit_float64(0.0);
    outC->_L11.nvkvintsetArray[idx24].a_nvp23 = kcg_lit_float64(0.0);
  ...
  for (idx25 = 0; idx25 < 7; idx25++) {
    ...
    outC->_L11.nvkrintArray[idx25].m_nvkrint = kcg_lit_float64(0.0);
  }
  outC->_L11.m_nvktint = kcg_lit_float64(0.0);
  outC->_L10 = kcg_lit_int64(0);
  for (idx26 = 0; idx26 < 6; idx26++) {
    outC->_L1_Max_1_int64[idx26] = kcg_lit_int64(0);
  }
  for (idx27 = 0; idx27 < 6; idx27++) {
    outC->_L2_Max_1_int64[idx27] = kcg_lit_int64(0);
  }
  for (idx28 = 0; idx28 < 6; idx28++) {
    outC->_L3_Max_1_int64[idx28] = kcg_true;
  }
  for (idx29 = 0; idx29 < 6; idx29++) {
    outC->_L4_Max_1_int64[idx29] = kcg_lit_int64(0);
  }
  for (idx30 = 0; idx30 < 13; idx30++) {
    outC->aBrakeSafe_cm.a[idx30] = kcg_lit_int64(0);
  }
  for (idx31 = 0; idx31 < 13; idx31++) {
    outC->aBrakeSafe_cm.v[idx31] = kcg_lit_int64(0);
  }
  /* _L32=(SDMConversionModelPkg::Kv_intConstructor#1)/ */
