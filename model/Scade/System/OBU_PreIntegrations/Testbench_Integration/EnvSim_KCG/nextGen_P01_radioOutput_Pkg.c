...
void nextGen_P01_init_radioOutput_Pkg(outC_nextGen_P01_radioOutput_Pkg *outC)
{
  ...
  outC->_L36.NID_PACKET = kcg_lit_int64(0);
  outC->_L36.L_PACKET = kcg_lit_int64(0);
  ...
  outC->outP1.nid_packet = kcg_lit_int64(0);
  outC->outP1.l_packet = kcg_lit_int64(0);
  outC->outP1.q_scale = Q_SCALE_10_cm_scale;
  outC->outP1.nid_lrbg = kcg_lit_int64(0);
  outC->outP1.nid_prvlrbg = kcg_lit_int64(0);
  outC->outP1.d_lrbg = kcg_lit_int64(0);
  outC->outP1.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->outP1.q_dlrbg = Q_DLRBG_Reverse;
  outC->outP1.l_doubtover = kcg_lit_int64(0);
  outC->outP1.l_doubtunder = kcg_lit_int64(0);
  outC->outP1.q_length = Q_LENGTH_No_train_integrity_information_available;
  outC->outP1.l_trainint = kcg_lit_int64(0);
  outC->outP1.v_train = kcg_lit_int64(0);
  outC->outP1.q_dirtrain = Q_DIRTRAIN_Reverse;
  outC->outP1.m_mode = M_MODE_Full_Supervision;
  outC->outP1.m_level = M_LEVEL_Level_0;
  outC->outP1.nid_ntc = kcg_lit_int64(0);
}
