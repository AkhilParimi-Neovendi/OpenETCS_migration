...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  Q_LINKORIENTATION /* q_linkorientation/ */ q_linkorientation;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  Q_LINKORIENTATION /* IfBlock1:then:_L4/ */ _L4_then_IfBlock1;
  kcg_bool /* IfBlock1:else:else:_L2/ */ _L2_else_else_IfBlock1;
  Q_LINKORIENTATION /* IfBlock1:else:else:_L1/ */ _L1_else_else_IfBlock1;
...
extern void CAST_Int_to_Q_LINKORIENTATION_init_TM_conversions(
  outC_CAST_Int_to_Q_LINKORIENTATION_TM_conversions *outC);
