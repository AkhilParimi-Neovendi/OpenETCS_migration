  ...
  outC_C_P138_compr_onboard_TM_conversions *outC)
{
  ...
  outC->_L10.d_startreverse = kcg_lit_int64(0);
  outC->_L10.l_reversearea = kcg_lit_int64(0);
  ...
  outC->P138_onboard.d_startreverse = kcg_lit_int64(0);
  outC->P138_onboard.l_reversearea = kcg_lit_int64(0);
  /* _L31=(TM_conversions::CAST_Int_to_D_STARTREVERSE#1)/ */
