  ...
  outC_op_3_6_5_1_4_j_ProvidePositionReport_Pkg *outC)
{
  ...
  for (idx = 0; idx < 33; idx++) {
    ...
    outC->_L21.infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L21.infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int64(0);
    outC->_L21.infoFromPassing.linkedBGs[idx].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L21.infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int64(0);
    outC->_L21.infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int64(0);
    outC->_L21.infoFromPassing.linkedBGs[idx].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L21.infoFromPassing.linkedBGs[idx].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L21.infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L19.LRBG.infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L19.LRBG.infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int64(0);
    outC->_L19.LRBG.infoFromPassing.linkedBGs[idx1].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L19.LRBG.infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int64(0);
    outC->_L19.LRBG.infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L19.LRBG.infoFromPassing.linkedBGs[idx1].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L19.LRBG.infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int64(0);
  }
  ...
  for (idx2 = 0; idx2 < 33; idx2++) {
    ...
    outC->_L19.prvLRBG.infoFromPassing.linkedBGs[idx2].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L19.prvLRBG.infoFromPassing.linkedBGs[idx2].q_scale =
      Q_SCALE_10_cm_scale;
    outC->_L19.prvLRBG.infoFromPassing.linkedBGs[idx2].d_link = kcg_lit_int64(0);
    outC->_L19.prvLRBG.infoFromPassing.linkedBGs[idx2].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L19.prvLRBG.infoFromPassing.linkedBGs[idx2].nid_c = kcg_lit_int64(0);
    outC->_L19.prvLRBG.infoFromPassing.linkedBGs[idx2].nid_bg = kcg_lit_int64(0);
    ...
    outC->_L19.prvLRBG.infoFromPassing.linkedBGs[idx2].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L19.prvLRBG.infoFromPassing.linkedBGs[idx2].q_locacc = kcg_lit_int64(0);
  }
  ...
  outC->_L7.d_link = kcg_lit_int64(0);
  ...
  outC->_L7.q_locacc = kcg_lit_int64(0);
  outC->_L6.valid = kcg_true;
  outC->_L6.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->_L6.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->_L6.expectedLocation.nominal = kcg_lit_int64(0);
  outC->_L6.expectedLocation.d_min = kcg_lit_int64(0);
  outC->_L6.expectedLocation.d_max = kcg_lit_int64(0);
  outC->_L6.d_link.nominal = kcg_lit_int64(0);
  outC->_L6.d_link.d_min = kcg_lit_int64(0);
  outC->_L6.d_link.d_max = kcg_lit_int64(0);
  outC->_L6.linkingInfo.valid = kcg_true;
  outC->_L6.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  outC->_L6.linkingInfo.q_dir = Q_DIR_Reverse;
  outC->_L6.linkingInfo.q_scale = Q_SCALE_10_cm_scale;
  outC->_L6.linkingInfo.d_link = kcg_lit_int64(0);
  outC->_L6.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->_L6.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->_L6.linkingInfo.nid_bg = kcg_lit_int64(0);
  outC->_L6.linkingInfo.q_linkorientation =
    Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
  outC->_L6.linkingInfo.q_linkreaction = Q_LINKREACTION_Train_trip;
  outC->_L6.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  for (idx3 = 0; idx3 < 33; idx3++) {
    ...
    outC->_L1.infoFromPassing.linkedBGs[idx3].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L1.infoFromPassing.linkedBGs[idx3].d_link = kcg_lit_int64(0);
    outC->_L1.infoFromPassing.linkedBGs[idx3].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L1.infoFromPassing.linkedBGs[idx3].nid_c = kcg_lit_int64(0);
    outC->_L1.infoFromPassing.linkedBGs[idx3].nid_bg = kcg_lit_int64(0);
    outC->_L1.infoFromPassing.linkedBGs[idx3].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L1.infoFromPassing.linkedBGs[idx3].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L1.infoFromPassing.linkedBGs[idx3].q_locacc = kcg_lit_int64(0);
  }
