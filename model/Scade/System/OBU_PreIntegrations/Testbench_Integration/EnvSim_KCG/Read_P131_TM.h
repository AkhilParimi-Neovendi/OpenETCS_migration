...
typedef struct {
  ...
  P131_OBU_T_TM /* P131_OBU_out/ */ P131_OBU_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P131_compr_onboard_TM_conversions /* _L166=(TM_conversions::C_P131_compr_onboard#1)/ */ Context_C_P131_compr_onboard_1;
...
extern void Read_P131_reset_TM(outC_Read_P131_TM *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void Read_P131_init_TM(outC_Read_P131_TM *outC);
