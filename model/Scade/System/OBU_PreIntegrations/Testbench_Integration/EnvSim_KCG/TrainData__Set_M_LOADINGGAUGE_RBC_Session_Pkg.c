...
void TrainData__Set_M_LOADINGGAUGE_RBC_Session_Pkg(
  ...
  /* in_M_LOADINGGAUGE/ */
  M_LOADINGGAUGE in_M_LOADINGGAUGE,
  outC_TrainData__Set_M_LOADINGGAUGE_RBC_Session_Pkg *outC)
{
  outC->_L2 = in_M_LOADINGGAUGE;
  kcg_copy_TrainData_T(&outC->_L1, inTrainData);
  kcg_copy_TrainData_T(&outC->_L3, &outC->_L1);
  if (kcg_true) {
    outC->_L3.m_loadinggauge = outC->_L2;
  }
  kcg_copy_TrainData_T(&outC->outTrainData, &outC->_L3);
}

#ifndef KCG_USER_DEFINED_INIT
void TrainData__Set_M_LOADINGGAUGE_init_RBC_Session_Pkg(
  outC_TrainData__Set_M_LOADINGGAUGE_RBC_Session_Pkg *outC)
{
  static kcg_size idx;
...
void TrainData__Set_M_LOADINGGAUGE_reset_RBC_Session_Pkg(
  outC_TrainData__Set_M_LOADINGGAUGE_RBC_Session_Pkg *outC)
{
}
