  ...
  outC_C_P012_unflatten_sections_TM_lib_internal *outC)
{
  ...
  for (idx2 = 0; idx2 < 32; idx2++) {
    for (idx1 = 0; idx1 < 128; idx1++) {
      outC->_L15[idx2][idx1] = kcg_lit_int64(0);
    }
  }
  outC->_L11 = kcg_true;
  for (idx3 = 0; idx3 < 32; idx3++) {
    outC->_L9[idx3].valid = kcg_true;
    outC->_L9[idx3].l_section = kcg_lit_int64(0);
    outC->_L9[idx3].q_sectiontimer = Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L9[idx3].t_sectiontimer = kcg_lit_int64(0);
    outC->_L9[idx3].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  outC->_L7 = kcg_lit_int64(0);
  ...
  for (idx6 = 0; idx6 < 32; idx6++) {
    ...
    outC->sections[idx6].l_section = kcg_lit_int64(0);
    outC->sections[idx6].q_sectiontimer =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->sections[idx6].t_sectiontimer = kcg_lit_int64(0);
    outC->sections[idx6].d_sectiontimerstoploc = kcg_lit_int64(0);
  }
  for (idx = 0; idx < 32; idx++) {
    /* _L7=(TM_lib_internal::C_P012_us_array#1)/ */
