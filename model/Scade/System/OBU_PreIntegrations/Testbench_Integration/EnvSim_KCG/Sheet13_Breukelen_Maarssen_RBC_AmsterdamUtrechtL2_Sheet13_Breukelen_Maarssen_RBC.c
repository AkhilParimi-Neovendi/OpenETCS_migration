...
void Sheet13_Breukelen_Maarssen_RBC_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_RBC(
  ...
  outC_Sheet13_Breukelen_Maarssen_RBC_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_RBC *outC)
{
  kcg_copy_R_data_internal_T_InfraLib(&outC->_L13, RadiaDataIn);
  /* _L1=(AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_RBC::Send_RBC_LRBG_420_D_00169_4_M015#1)/ */
  Send_RBC_LRBG_420_D_00169_4_M015_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_RBC(
    &outC->_L13,
    kcg_lit_int64(420001694),
    &outC->Context_Send_RBC_LRBG_420_D_00169_4_M015_1);
  kcg_copy_R_data_internal_T_InfraLib(
    &outC->_L1,
    &outC->Context_Send_RBC_LRBG_420_D_00169_4_M015_1.R_data_out);
  /* _L2=(AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_RBC::Send_RBC_LRBG_421_D_00050_0_M015#1)/ */
  Send_RBC_LRBG_421_D_00050_0_M015_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_RBC(
    &outC->_L1,
    kcg_lit_int64(421000500),
    &outC->Context_Send_RBC_LRBG_421_D_00050_0_M015_1);
  kcg_copy_R_data_internal_T_InfraLib(
    &outC->_L2,
    &outC->Context_Send_RBC_LRBG_421_D_00050_0_M015_1.R_data_out);
  /* _L3=(AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_RBC::Send_RBC_LRBG_422_D_00192_7_M015#1)/ */
  Send_RBC_LRBG_422_D_00192_7_M015_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_RBC(
    &outC->_L2,
    kcg_lit_int64(422001927),
    &outC->Context_Send_RBC_LRBG_422_D_00192_7_M015_1);
  kcg_copy_R_data_internal_T_InfraLib(
    &outC->_L3,
    &outC->Context_Send_RBC_LRBG_422_D_00192_7_M015_1.R_data_out);
  kcg_copy_R_data_internal_T_InfraLib(&outC->R_data_out, &outC->_L3);
}

#ifndef KCG_USER_DEFINED_INIT
void Sheet13_Breukelen_Maarssen_RBC_init_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_RBC(
  outC_Sheet13_Breukelen_Maarssen_RBC_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_RBC *outC)
{
  static kcg_size idx;
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L3.packets.PacketHeaders[idx2].nid_packet = kcg_lit_int64(0);
    outC->_L3.packets.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L3.packets.PacketHeaders[idx2].valid = kcg_true;
    outC->_L3.packets.PacketHeaders[idx2].startAddress = kcg_lit_int64(0);
    outC->_L3.packets.PacketHeaders[idx2].endAddress = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L3.packets.PacketData[idx3] = kcg_lit_int64(0);
  }
  ...
  /* _L3=(AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_RBC::Send_RBC_LRBG_422_D_00192_7_M015#1)/ */
  Send_RBC_LRBG_422_D_00192_7_M015_init_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_RBC(
    &outC->Context_Send_RBC_LRBG_422_D_00192_7_M015_1);
  /* _L2=(AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_RBC::Send_RBC_LRBG_421_D_00050_0_M015#1)/ */
  Send_RBC_LRBG_421_D_00050_0_M015_init_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_RBC(
    &outC->Context_Send_RBC_LRBG_421_D_00050_0_M015_1);
  /* _L1=(AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_RBC::Send_RBC_LRBG_420_D_00169_4_M015#1)/ */
  Send_RBC_LRBG_420_D_00169_4_M015_init_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_RBC(
    &outC->Context_Send_RBC_LRBG_420_D_00169_4_M015_1);
}
...
void Sheet13_Breukelen_Maarssen_RBC_reset_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_RBC(
  outC_Sheet13_Breukelen_Maarssen_RBC_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_RBC *outC)
{
  /* _L3=(AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_RBC::Send_RBC_LRBG_422_D_00192_7_M015#1)/ */
  Send_RBC_LRBG_422_D_00192_7_M015_reset_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_RBC(
    &outC->Context_Send_RBC_LRBG_422_D_00192_7_M015_1);
  /* _L2=(AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_RBC::Send_RBC_LRBG_421_D_00050_0_M015#1)/ */
  Send_RBC_LRBG_421_D_00050_0_M015_reset_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_RBC(
    &outC->Context_Send_RBC_LRBG_421_D_00050_0_M015_1);
  /* _L1=(AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_RBC::Send_RBC_LRBG_420_D_00169_4_M015#1)/ */
  Send_RBC_LRBG_420_D_00169_4_M015_reset_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_RBC(
    &outC->Context_Send_RBC_LRBG_420_D_00169_4_M015_1);
}
