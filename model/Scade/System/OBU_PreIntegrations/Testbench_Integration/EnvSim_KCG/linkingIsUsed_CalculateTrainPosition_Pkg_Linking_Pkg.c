  ...
  outC_linkingIsUsed_CalculateTrainPosition_Pkg_Linking_Pkg *outC)
{
  ...
  static kcg_int64 _7_op_call;
  static kcg_bool _8_op_call;
  static kcg_bool _9_op_call;
  static kcg_int64 _10_op_call;
  ...
  outC_linkingIsUsed_CalculateTrainPosition_Pkg_Linking_Pkg *outC)
{
  ...
  outC->_L29.o_nominal = kcg_lit_int64(0);
  outC->_L29.o_min = kcg_lit_int64(0);
  outC->_L29.o_max = kcg_lit_int64(0);
  outC->_L28.nominal = kcg_lit_int64(0);
  outC->_L28.d_min = kcg_lit_int64(0);
  outC->_L28.d_max = kcg_lit_int64(0);
  outC->_L27 = kcg_true;
  outC->_L26 = kcg_true;
  ...
  for (idx1 = 0; idx1 < 41; idx1++) {
    ...
    outC->_L2[idx1].nid_c = kcg_lit_int64(0);
    outC->_L2[idx1].nid_bg = kcg_lit_int64(0);
    outC->_L2[idx1].q_link = Q_LINK_Unlinked;
    outC->_L2[idx1].location.nominal = kcg_lit_int64(0);
    outC->_L2[idx1].location.d_min = kcg_lit_int64(0);
    outC->_L2[idx1].location.d_max = kcg_lit_int64(0);
    outC->_L2[idx1].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L2[idx1].infoFromLinking.valid = kcg_true;
    outC->_L2[idx1].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L2[idx1].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L2[idx1].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L2[idx1].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L2[idx1].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L2[idx1].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L2[idx1].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L2[idx1].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L2[idx1].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L2[idx1].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L2[idx1].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L2[idx1].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L2[idx1].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L2[idx1].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L2[idx1].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L2[idx1].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L2[idx1].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L2[idx1].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L2[idx1].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L2[idx1].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx = 0; idx < 33; idx++) {
      ...
      outC->_L2[idx1].infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L2[idx1].infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int64(0);
      outC->_L2[idx1].infoFromPassing.linkedBGs[idx].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L2[idx1].infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int64(0);
      outC->_L2[idx1].infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int64(0);
      outC->_L2[idx1].infoFromPassing.linkedBGs[idx].q_linkorientation =
        Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
      outC->_L2[idx1].infoFromPassing.linkedBGs[idx].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L2[idx1].infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int64(0);
    }
  ...
  outC->lastPassedLinkedBG.nid_c = kcg_lit_int64(0);
  outC->lastPassedLinkedBG.nid_bg = kcg_lit_int64(0);
  outC->lastPassedLinkedBG.q_link = Q_LINK_Unlinked;
  outC->lastPassedLinkedBG.location.nominal = kcg_lit_int64(0);
  outC->lastPassedLinkedBG.location.d_min = kcg_lit_int64(0);
  outC->lastPassedLinkedBG.location.d_max = kcg_lit_int64(0);
  outC->lastPassedLinkedBG.seqNoOnTrack = kcg_lit_int64(0);
  outC->lastPassedLinkedBG.infoFromLinking.valid = kcg_true;
  outC->lastPassedLinkedBG.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(
      0);
  outC->lastPassedLinkedBG.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  ...
  outC->lastPassedLinkedBG.infoFromLinking.expectedLocation.d_max =
    kcg_lit_int64(0);
  outC->lastPassedLinkedBG.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->lastPassedLinkedBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->lastPassedLinkedBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->lastPassedLinkedBG.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->lastPassedLinkedBG.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(
      0);
  ...
  outC->lastPassedLinkedBG.infoFromLinking.linkingInfo.q_scale =
    Q_SCALE_10_cm_scale;
  outC->lastPassedLinkedBG.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->lastPassedLinkedBG.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->lastPassedLinkedBG.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->lastPassedLinkedBG.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  ...
  outC->lastPassedLinkedBG.infoFromLinking.linkingInfo.q_linkreaction =
    Q_LINKREACTION_Train_trip;
  outC->lastPassedLinkedBG.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(
      0);
  ...
  outC->lastPassedLinkedBG.infoFromPassing.BG_Header.n_total =
    N_TOTAL_1_balise_in_the_group;
  outC->lastPassedLinkedBG.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->lastPassedLinkedBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->lastPassedLinkedBG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->lastPassedLinkedBG.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->lastPassedLinkedBG.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(
      0);
  ...
  outC->lastLinkedBG.nid_c = kcg_lit_int64(0);
  outC->lastLinkedBG.nid_bg = kcg_lit_int64(0);
  outC->lastLinkedBG.q_link = Q_LINK_Unlinked;
  outC->lastLinkedBG.location.nominal = kcg_lit_int64(0);
  outC->lastLinkedBG.location.d_min = kcg_lit_int64(0);
  outC->lastLinkedBG.location.d_max = kcg_lit_int64(0);
  outC->lastLinkedBG.seqNoOnTrack = kcg_lit_int64(0);
  outC->lastLinkedBG.infoFromLinking.valid = kcg_true;
  outC->lastLinkedBG.infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
  outC->lastLinkedBG.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
  outC->lastLinkedBG.infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
  outC->lastLinkedBG.infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
  outC->lastLinkedBG.infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
  outC->lastLinkedBG.infoFromLinking.d_link.nominal = kcg_lit_int64(0);
  outC->lastLinkedBG.infoFromLinking.d_link.d_min = kcg_lit_int64(0);
  outC->lastLinkedBG.infoFromLinking.d_link.d_max = kcg_lit_int64(0);
  outC->lastLinkedBG.infoFromLinking.linkingInfo.valid = kcg_true;
  outC->lastLinkedBG.infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
  ...
  outC->lastLinkedBG.infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
  outC->lastLinkedBG.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->lastLinkedBG.infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
  outC->lastLinkedBG.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
  ...
  outC->lastLinkedBG.infoFromLinking.linkingInfo.q_linkreaction =
    Q_LINKREACTION_Train_trip;
  outC->lastLinkedBG.infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
  ...
  outC->lastLinkedBG.infoFromPassing.BG_Header.n_total =
    N_TOTAL_1_balise_in_the_group;
  outC->lastLinkedBG.infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
  outC->lastLinkedBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
  outC->lastLinkedBG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
  ...
  outC->lastLinkedBG.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int64(0);
  outC->lastLinkedBG.infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
  ...
  for (idx3 = 0; idx3 < 33; idx3++) {
    ...
    outC->lastLinkedBG.infoFromPassing.linkedBGs[idx3].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->lastLinkedBG.infoFromPassing.linkedBGs[idx3].q_scale =
      Q_SCALE_10_cm_scale;
    outC->lastLinkedBG.infoFromPassing.linkedBGs[idx3].d_link = kcg_lit_int64(0);
    outC->lastLinkedBG.infoFromPassing.linkedBGs[idx3].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->lastLinkedBG.infoFromPassing.linkedBGs[idx3].nid_c = kcg_lit_int64(0);
    outC->lastLinkedBG.infoFromPassing.linkedBGs[idx3].nid_bg = kcg_lit_int64(0);
    ...
    outC->lastLinkedBG.infoFromPassing.linkedBGs[idx3].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->lastLinkedBG.infoFromPassing.linkedBGs[idx3].q_locacc = kcg_lit_int64(0);
  }
