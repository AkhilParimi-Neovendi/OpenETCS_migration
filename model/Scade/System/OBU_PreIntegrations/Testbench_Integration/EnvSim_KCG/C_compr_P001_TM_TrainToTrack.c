  ...
  outC_C_compr_P001_TM_TrainToTrack *outC)
{
  ...
  /* @3/q_scale/ */
  static Q_SCALE _3_q_scale_partial_CAST_Int_to_Q_SCALE_1;
  /* @3/error/ */
  ...
  /* @3/error/ */
  static kcg_bool _11_error_partial_CAST_Int_to_Q_SCALE_1;
  /* @3/q_scale/ */
  ...
  outC->_L4 = outC->_L1[2];
  /* _L92=(TM_TrainToTrack::Filter_Variable#3)/ */
  Filter_Variable_TM_TrainToTrack(
    outC->_L88,
    outC->_L4,
    &outC->Context_Filter_Variable_3);
  outC->_L92 = outC->Context_Filter_Variable_3.int_out;
  ...
  outC->_L6 = outC->_L1[4];
  /* _L109=(TM_TrainToTrack::Filter_Variable#17)/ */
  Filter_Variable_TM_TrainToTrack(
    outC->_L88,
    outC->_L6,
    &outC->Context_Filter_Variable_17);
  outC->_L109 = outC->Context_Filter_Variable_17.int_out;
  /* _L110=(TM_conversions::CAST_Int_to_NID_PRVLRBG#1)/ */
  CAST_Int_to_NID_PRVLRBG_TM_conversions(
    outC->_L109,
    &outC->Context_CAST_Int_to_NID_PRVLRBG_1);
  outC->_L110 = outC->Context_CAST_Int_to_NID_PRVLRBG_1.nid_prvlgb;
  outC->_L7 = outC->_L1[5];
  /* _L106=(TM_TrainToTrack::Filter_Variable#16)/ */
  Filter_Variable_TM_TrainToTrack(
    outC->_L88,
    outC->_L7,
    &outC->Context_Filter_Variable_16);
  outC->_L106 = outC->Context_Filter_Variable_16.int_out;
  ...
  /* _L104=(TM_TrainToTrack::Filter_Variable#15)/ */
  Filter_Variable_TM_TrainToTrack(
    outC->_L88,
    outC->_L108,
    &outC->Context_Filter_Variable_15);
  outC->_L104 = outC->Context_Filter_Variable_15.int_out;
  outC->_L16 = outC->_L1[14];
  /* _L103=(TM_TrainToTrack::Filter_Variable#14)/ */
  Filter_Variable_TM_TrainToTrack(
    outC->_L88,
    outC->_L16,
    &outC->Context_Filter_Variable_14);
  outC->_L103 = outC->Context_Filter_Variable_14.int_out;
  outC->_L105 = outC->_L1[15];
  /* _L102=(TM_TrainToTrack::Filter_Variable#13)/ */
  Filter_Variable_TM_TrainToTrack(
    outC->_L88,
    outC->_L105,
    &outC->Context_Filter_Variable_13);
  outC->_L102 = outC->Context_Filter_Variable_13.int_out;
  outC->_L15 = outC->_L1[13];
  /* _L101=(TM_TrainToTrack::Filter_Variable#12)/ */
  Filter_Variable_TM_TrainToTrack(
    outC->_L88,
    outC->_L15,
    &outC->Context_Filter_Variable_12);
  outC->_L101 = outC->Context_Filter_Variable_12.int_out;
  outC->_L14 = outC->_L1[12];
  /* _L100=(TM_TrainToTrack::Filter_Variable#11)/ */
  Filter_Variable_TM_TrainToTrack(
    outC->_L88,
    outC->_L14,
    &outC->Context_Filter_Variable_11);
  outC->_L100 = outC->Context_Filter_Variable_11.int_out;
  outC->_L13 = outC->_L1[11];
  /* _L99=(TM_TrainToTrack::Filter_Variable#10)/ */
  Filter_Variable_TM_TrainToTrack(
    outC->_L88,
    outC->_L13,
    &outC->Context_Filter_Variable_10);
  outC->_L99 = outC->Context_Filter_Variable_10.int_out;
  outC->_L12 = outC->_L1[10];
  /* _L98=(TM_TrainToTrack::Filter_Variable#9)/ */
  Filter_Variable_TM_TrainToTrack(
    outC->_L88,
    outC->_L12,
    &outC->Context_Filter_Variable_9);
  outC->_L98 = outC->Context_Filter_Variable_9.int_out;
  outC->_L11 = outC->_L1[9];
  /* _L97=(TM_TrainToTrack::Filter_Variable#8)/ */
  Filter_Variable_TM_TrainToTrack(
    outC->_L88,
    outC->_L11,
    &outC->Context_Filter_Variable_8);
  outC->_L97 = outC->Context_Filter_Variable_8.int_out;
  outC->_L10 = outC->_L1[8];
  /* _L96=(TM_TrainToTrack::Filter_Variable#7)/ */
  Filter_Variable_TM_TrainToTrack(
    outC->_L88,
    outC->_L10,
    &outC->Context_Filter_Variable_7);
  outC->_L96 = outC->Context_Filter_Variable_7.int_out;
  outC->_L8 = outC->_L1[6];
  /* _L95=(TM_TrainToTrack::Filter_Variable#6)/ */
  Filter_Variable_TM_TrainToTrack(
    outC->_L88,
    outC->_L8,
    &outC->Context_Filter_Variable_6);
  outC->_L95 = outC->Context_Filter_Variable_6.int_out;
  outC->_L9 = outC->_L1[7];
  /* _L94=(TM_TrainToTrack::Filter_Variable#5)/ */
  Filter_Variable_TM_TrainToTrack(
    outC->_L88,
    outC->_L9,
    &outC->Context_Filter_Variable_5);
  outC->_L94 = outC->Context_Filter_Variable_5.int_out;
  outC->_L5 = outC->_L1[3];
  /* _L93=(TM_TrainToTrack::Filter_Variable#4)/ */
  Filter_Variable_TM_TrainToTrack(
    outC->_L88,
    outC->_L5,
    &outC->Context_Filter_Variable_4);
  outC->_L93 = outC->Context_Filter_Variable_4.int_out;
...
void C_compr_P001_init_TM_TrainToTrack(outC_C_compr_P001_TM_TrainToTrack *outC)
{
  static kcg_size idx;
  ...
  outC->_L86.nid_packet = kcg_lit_int32(0);
  outC->_L86.l_packet = kcg_lit_int32(0);
  outC->_L86.q_scale = Q_SCALE_10_cm_scale;
  outC->_L86.nid_lrbg = kcg_lit_int32(0);
  outC->_L86.nid_prvlrbg = kcg_lit_int32(0);
  outC->_L86.d_lrbg = kcg_lit_int32(0);
  outC->_L86.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L86.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L86.l_doubtover = kcg_lit_int32(0);
  outC->_L86.l_doubtunder = kcg_lit_int32(0);
  outC->_L86.q_length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L86.l_trainint = kcg_lit_int32(0);
  outC->_L86.v_train = kcg_lit_int32(0);
  outC->_L86.q_dirtrain = Q_DIRTRAIN_Reverse;
  outC->_L86.m_mode = M_MODE_Full_Supervision;
  outC->_L86.m_level = M_LEVEL_Level_0;
  outC->_L86.nid_ntc = kcg_lit_int32(0);
  ...
  outC->P001_out.valid = kcg_true;
  outC->P001_out.nid_packet = kcg_lit_int32(0);
  outC->P001_out.l_packet = kcg_lit_int32(0);
  outC->P001_out.q_scale = Q_SCALE_10_cm_scale;
  outC->P001_out.nid_lrbg = kcg_lit_int32(0);
  outC->P001_out.nid_prvlrbg = kcg_lit_int32(0);
  outC->P001_out.d_lrbg = kcg_lit_int32(0);
  outC->P001_out.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->P001_out.q_dlrbg = Q_DLRBG_Reverse;
  outC->P001_out.l_doubtover = kcg_lit_int32(0);
  outC->P001_out.l_doubtunder = kcg_lit_int32(0);
  outC->P001_out.q_length = Q_LENGTH_No_train_integrity_information_available;
  outC->P001_out.l_trainint = kcg_lit_int32(0);
  outC->P001_out.v_train = kcg_lit_int32(0);
  outC->P001_out.q_dirtrain = Q_DIRTRAIN_Reverse;
  outC->P001_out.m_mode = M_MODE_Full_Supervision;
  outC->P001_out.m_level = M_LEVEL_Level_0;
  outC->P001_out.nid_ntc = kcg_lit_int32(0);
  /* _L85=(TM_conversions::CAST_Int_to_NID_NTC#1)/ */
  ...
  /* _L104=(TM_TrainToTrack::Filter_Variable#15)/ */
  Filter_Variable_init_TM_TrainToTrack(&outC->Context_Filter_Variable_15);
  /* _L107=(TM_conversions::CAST_Int_to_D_LRBG#1)/ */
  ...
  /* _L110=(TM_conversions::CAST_Int_to_NID_PRVLRBG#1)/ */
  CAST_Int_to_NID_PRVLRBG_init_TM_conversions(
    &outC->Context_CAST_Int_to_NID_PRVLRBG_1);
  /* _L109=(TM_TrainToTrack::Filter_Variable#17)/ */
...
void C_compr_P001_reset_TM_TrainToTrack(outC_C_compr_P001_TM_TrainToTrack *outC)
{
  ...
  /* _L104=(TM_TrainToTrack::Filter_Variable#15)/ */
  Filter_Variable_reset_TM_TrainToTrack(&outC->Context_Filter_Variable_15);
  /* _L107=(TM_conversions::CAST_Int_to_D_LRBG#1)/ */
  ...
  /* _L110=(TM_conversions::CAST_Int_to_NID_PRVLRBG#1)/ */
  CAST_Int_to_NID_PRVLRBG_reset_TM_conversions(
    &outC->Context_CAST_Int_to_NID_PRVLRBG_1);
  /* _L109=(TM_TrainToTrack::Filter_Variable#17)/ */
