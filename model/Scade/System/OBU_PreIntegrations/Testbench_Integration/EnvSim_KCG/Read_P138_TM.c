...
void Read_P138_init_TM(outC_Read_P138_TM *outC)
{
  ...
  outC->_L166.d_startreverse = kcg_lit_int64(0);
  outC->_L166.l_reversearea = kcg_lit_int64(0);
  ...
  outC->P138_OBU_out.d_startreverse = kcg_lit_int64(0);
  outC->P138_OBU_out.l_reversearea = kcg_lit_int64(0);
