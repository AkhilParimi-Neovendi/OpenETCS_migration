...
void findLinkedBG_fwd_itr_init_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
  outC_findLinkedBG_fwd_itr_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  static kcg_size idx;
  ...
  outC->_L19.previousLinkedBG_idx = kcg_lit_int32(0);
  outC->_L19.currentIndex = kcg_lit_int32(0);
  outC->_L19.subsequentLinkedBG_idx = kcg_lit_int32(0);
  outC->_L16 = kcg_lit_int32(0);
  outC->_L17 = kcg_lit_int32(0);
  outC->_L18 = kcg_lit_int32(0);
  outC->_L12.previousLinkedBG_idx = kcg_lit_int32(0);
  outC->_L12.currentIndex = kcg_lit_int32(0);
  outC->_L12.subsequentLinkedBG_idx = kcg_lit_int32(0);
  outC->_L11 = kcg_true;
  ...
  for (idx = 0; idx < 33; idx++) {
    ...
    outC->_L5.infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L5.infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int32(0);
    outC->_L5.infoFromPassing.linkedBGs[idx].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L5.infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int32(0);
    outC->_L5.infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int32(0);
    outC->_L5.infoFromPassing.linkedBGs[idx].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L5.infoFromPassing.linkedBGs[idx].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L5.infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int32(0);
  }
  outC->_L5.missed = kcg_true;
  outC->index_out.previousLinkedBG_idx = kcg_lit_int32(0);
  outC->index_out.currentIndex = kcg_lit_int32(0);
  outC->index_out.subsequentLinkedBG_idx = kcg_lit_int32(0);
  outC->index_acc.previousLinkedBG_idx = kcg_lit_int32(0);
  outC->index_acc.currentIndex = kcg_lit_int32(0);
  outC->index_acc.subsequentLinkedBG_idx = kcg_lit_int32(0);
}
