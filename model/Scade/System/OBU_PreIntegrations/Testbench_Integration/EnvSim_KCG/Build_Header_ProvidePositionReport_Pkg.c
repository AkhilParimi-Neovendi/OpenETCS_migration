  ...
  outC_Build_Header_ProvidePositionReport_Pkg *outC)
{
  ...
  outC->_L5.nid_operational = kcg_lit_int64(0);
  outC->_L5.l_train = kcg_lit_int64(0);
  outC->_L5.d_baliseAntenna_2_frontend.nominal = kcg_lit_int64(0);
  outC->_L5.d_baliseAntenna_2_frontend.d_min = kcg_lit_int64(0);
  outC->_L5.d_baliseAntenna_2_frontend.d_max = kcg_lit_int64(0);
  outC->_L5.d_frontend_2_rearend.nominal = kcg_lit_int64(0);
  outC->_L5.d_frontend_2_rearend.d_min = kcg_lit_int64(0);
  outC->_L5.d_frontend_2_rearend.d_max = kcg_lit_int64(0);
  outC->_L5.locationAccuracy_DefaultValue.nominal = kcg_lit_int64(0);
  outC->_L5.locationAccuracy_DefaultValue.d_min = kcg_lit_int64(0);
  outC->_L5.locationAccuracy_DefaultValue.d_max = kcg_lit_int64(0);
  outC->_L5.centerDetectionAcc_DefaultValue.nominal = kcg_lit_int64(0);
  outC->_L5.centerDetectionAcc_DefaultValue.d_min = kcg_lit_int64(0);
  outC->_L5.centerDetectionAcc_DefaultValue.d_max = kcg_lit_int64(0);
