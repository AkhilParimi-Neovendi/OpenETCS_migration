  ...
  outC_C_P045_tracksim_compr_TM_conversions *outC)
{
  ...
  /* _L396=(TM_lib_internal::T_Build_Metadata_Packet_ID#1)/ */
  ...
  outC->_L396 = outC->Context_T_Build_Metadata_Packet_ID_1.nid_packet_meta;
  ...
  kcg_copy_array_int32_4(&outC->_L383[0], &outC->_L373);
  kcg_copy_array_int32_496(&outC->_L383[4], &outC->_L209);
...
void C_P045_tracksim_compr_init_TM_conversions(
  outC_C_P045_tracksim_compr_TM_conversions *outC)
{
  static kcg_size idx;
  ...
  outC->_L1.NID_MN = kcg_lit_int32(0);
  ...
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->P045_compressed[idx3] = kcg_lit_int32(0);
  }
