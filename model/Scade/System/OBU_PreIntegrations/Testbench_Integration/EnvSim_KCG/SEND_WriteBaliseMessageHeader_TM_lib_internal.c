  ...
  outC_SEND_WriteBaliseMessageHeader_TM_lib_internal *outC)
{
  ...
  if ((kcg_lit_int64(0) <= outC->_L17) & (outC->_L17 < kcg_lit_int64(30))) {
  ...
  outC_SEND_WriteBaliseMessageHeader_TM_lib_internal *outC)
{
  ...
  outC->_L44.nid_packet = kcg_lit_int64(0);
  outC->_L44.q_dir = Q_DIR_Reverse;
  outC->_L44.valid = kcg_true;
  outC->_L44.startAddress = kcg_lit_int64(0);
  outC->_L44.endAddress = kcg_lit_int64(0);
  ...
  for (idx1 = 0; idx1 < 30; idx1++) {
    outC->_L24[idx1].nid_packet = kcg_lit_int64(0);
    outC->_L24[idx1].q_dir = Q_DIR_Reverse;
    outC->_L24[idx1].valid = kcg_true;
    outC->_L24[idx1].startAddress = kcg_lit_int64(0);
    outC->_L24[idx1].endAddress = kcg_lit_int64(0);
  }
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L23[idx2].nid_packet = kcg_lit_int64(0);
    outC->_L23[idx2].q_dir = Q_DIR_Reverse;
    outC->_L23[idx2].valid = kcg_true;
    outC->_L23[idx2].startAddress = kcg_lit_int64(0);
    outC->_L23[idx2].endAddress = kcg_lit_int64(0);
  }
  ...
  outC->_L9.startAddress = kcg_lit_int64(0);
  outC->_L9.endAddress = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 30; idx3++) {
    outC->_L8[idx3].nid_packet = kcg_lit_int64(0);
    outC->_L8[idx3].q_dir = Q_DIR_Reverse;
    outC->_L8[idx3].valid = kcg_true;
    outC->_L8[idx3].startAddress = kcg_lit_int64(0);
    outC->_L8[idx3].endAddress = kcg_lit_int64(0);
  }
  outC->_L5 = kcg_lit_int64(0);
  outC->_L4 = kcg_true;
  ...
  outC->NewEndAddr = kcg_lit_int64(0);
  outC->NewStartAddr = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 30; idx5++) {
    outC->HeadersOut[idx5].nid_packet = kcg_lit_int64(0);
    outC->HeadersOut[idx5].q_dir = Q_DIR_Reverse;
    outC->HeadersOut[idx5].valid = kcg_true;
    outC->HeadersOut[idx5].startAddress = kcg_lit_int64(0);
    outC->HeadersOut[idx5].endAddress = kcg_lit_int64(0);
  }
  for (idx = 0; idx < 30; idx++) {
    /* _L3=(TM_lib_internal::SEND_FindSlot#1)/ */
