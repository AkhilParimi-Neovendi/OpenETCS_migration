...
{
  /* _L2=(TM_RBC_conversions::C_M015_int_to_header#1)/ */
  C_M015_int_to_header_reset_TM_RBC_conversions(
    &outC->Context_C_M015_int_to_header_1);
}
