  ...
  outC_fishHandoverCmds_Handover_Pkg_handoverUtils_Pkg *outC)
{
  ...
  outC->_L103.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L115.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L79.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L9.order.nid_radio = kcg_lit_int32(0);
  ...
  outC->p131_RBCTransitionOrder_decoced.order.nid_radio = kcg_lit_int32(0);
