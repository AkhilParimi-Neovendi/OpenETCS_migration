  ...
  outC_copyTrackDescription_manage_DMI_Output_Pkg *outC)
{
  ...
  if (outC->_L17) {
    ...
    for (idx1 = 0; idx1 < 32; idx1++) {
      ...
      outC->_L20 = /* _L20= */(kcg_int32) (idx1 + 1);
      /* _L20= */
  ...
  outC_copyTrackDescription_manage_DMI_Output_Pkg *outC)
{
  ...
  outC->_L34.begin_section = kcg_lit_int32(0);
  outC->_L34.end_section = kcg_lit_int32(0);
  outC->_L34.gradient = kcg_lit_int32(0);
  outC->_L33.valid = kcg_true;
  outC->_L33.Loc_Abs = kcg_lit_int32(0);
  outC->_L33.Loc_LRBG = kcg_lit_int32(0);
  outC->_L33.MRS = kcg_lit_int32(0);
  outC->_L31.nIter = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L31.trackCondition[idx2].d_trackcond = kcg_lit_int32(0);
  ...
  for (idx3 = 0; idx3 < 32; idx3++) {
    ...
    outC->_L27.speedProfiles.speedProfiles[idx3].Loc_Abs = kcg_lit_int32(0);
    outC->_L27.speedProfiles.speedProfiles[idx3].Loc_LRBG = kcg_lit_int32(0);
    outC->_L27.speedProfiles.speedProfiles[idx3].MRS = kcg_lit_int32(0);
  }
  ...
  for (idx4 = 0; idx4 < 32; idx4++) {
    ...
    outC->_L27.gradientProfiles.gradientProfiles[idx4].end_section =
      kcg_lit_int32(0);
    outC->_L27.gradientProfiles.gradientProfiles[idx4].gradient = kcg_lit_int32(0);
  }
  outC->_L27.trackConditions.nIter = kcg_lit_int32(0);
  for (idx5 = 0; idx5 < 32; idx5++) {
    outC->_L27.trackConditions.trackCondition[idx5].d_trackcond = kcg_lit_int32(0);
  ...
  for (idx6 = 0; idx6 < 32; idx6++) {
    ...
    outC->_L23.gradientProfiles[idx6].begin_section = kcg_lit_int32(0);
    outC->_L23.gradientProfiles[idx6].end_section = kcg_lit_int32(0);
    outC->_L23.gradientProfiles[idx6].gradient = kcg_lit_int32(0);
  }
  outC->_L22.profileChanged = kcg_true;
  for (idx7 = 0; idx7 < 32; idx7++) {
    outC->_L22.speedProfiles[idx7].valid = kcg_true;
    outC->_L22.speedProfiles[idx7].Loc_Abs = kcg_lit_int32(0);
    outC->_L22.speedProfiles[idx7].Loc_LRBG = kcg_lit_int32(0);
    outC->_L22.speedProfiles[idx7].MRS = kcg_lit_int32(0);
  }
  outC->_L20 = kcg_lit_int32(0);
  for (idx8 = 0; idx8 < 32; idx8++) {
    outC->_L19[idx8].valid = kcg_true;
    outC->_L19[idx8].begin_section = kcg_lit_int32(0);
    outC->_L19[idx8].end_section = kcg_lit_int32(0);
    outC->_L19[idx8].gradient = kcg_lit_int32(0);
  }
  outC->_L17 = kcg_true;
  for (idx9 = 0; idx9 < 50; idx9++) {
    outC->_L15[idx9].valid = kcg_true;
    outC->_L15[idx9].begin_section = kcg_lit_int32(0);
    outC->_L15[idx9].end_section = kcg_lit_int32(0);
    outC->_L15[idx9].gradient = kcg_lit_int32(0);
  }
  for (idx10 = 0; idx10 < 32; idx10++) {
    outC->_L16[idx10].valid = kcg_true;
    outC->_L16[idx10].begin_section = kcg_lit_int32(0);
    outC->_L16[idx10].end_section = kcg_lit_int32(0);
    outC->_L16[idx10].gradient = kcg_lit_int32(0);
  }
  for (idx11 = 0; idx11 < 32; idx11++) {
    outC->_L13[idx11].valid = kcg_true;
    outC->_L13[idx11].Loc_Abs = kcg_lit_int32(0);
    outC->_L13[idx11].Loc_LRBG = kcg_lit_int32(0);
    outC->_L13[idx11].MRS = kcg_lit_int32(0);
  }
  for (idx12 = 0; idx12 < 110; idx12++) {
    outC->_L11[idx12].valid = kcg_true;
    outC->_L11[idx12].Loc_Abs = kcg_lit_int32(0);
    outC->_L11[idx12].Loc_LRBG = kcg_lit_int32(0);
    outC->_L11[idx12].MRS = kcg_lit_int32(0);
  }
  outC->_L10 = kcg_true;
  outC->_L8 = kcg_lit_int32(0);
  for (idx13 = 0; idx13 < 32; idx13++) {
    outC->_L7[idx13].valid = kcg_true;
    outC->_L7[idx13].Loc_Abs = kcg_lit_int32(0);
    outC->_L7[idx13].Loc_LRBG = kcg_lit_int32(0);
    outC->_L7[idx13].MRS = kcg_lit_int32(0);
  }
  for (idx14 = 0; idx14 < 50; idx14++) {
    outC->_L1.GradientProfile[idx14].valid = kcg_true;
    outC->_L1.GradientProfile[idx14].begin_section = kcg_lit_int32(0);
    outC->_L1.GradientProfile[idx14].end_section = kcg_lit_int32(0);
    outC->_L1.GradientProfile[idx14].gradient = kcg_lit_int32(0);
  }
  outC->_L1.Gradient_profile_updated = kcg_true;
  for (idx15 = 0; idx15 < 110; idx15++) {
    outC->_L1.MRSP[idx15].valid = kcg_true;
    outC->_L1.MRSP[idx15].Loc_Abs = kcg_lit_int32(0);
    outC->_L1.MRSP[idx15].Loc_LRBG = kcg_lit_int32(0);
    outC->_L1.MRSP[idx15].MRS = kcg_lit_int32(0);
  }
  outC->_L1.MRSP_updated = kcg_true;
  outC->toDMI.valid = kcg_true;
  outC->toDMI.system_clock = kcg_lit_int32(0);
  ...
  for (idx16 = 0; idx16 < 32; idx16++) {
    ...
    outC->toDMI.speedProfiles.speedProfiles[idx16].Loc_Abs = kcg_lit_int32(0);
    outC->toDMI.speedProfiles.speedProfiles[idx16].Loc_LRBG = kcg_lit_int32(0);
    outC->toDMI.speedProfiles.speedProfiles[idx16].MRS = kcg_lit_int32(0);
  }
  ...
  outC->toDMI.trackConditions.nIter = kcg_lit_int32(0);
