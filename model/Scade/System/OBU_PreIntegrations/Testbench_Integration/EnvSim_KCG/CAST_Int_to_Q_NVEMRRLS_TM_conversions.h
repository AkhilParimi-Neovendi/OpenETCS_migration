...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  Q_NVEMRRLS /* q_nvemrrls/ */ q_nvemrrls;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  Q_NVEMRRLS /* IfBlock1:then:_L4/ */ _L4_then_IfBlock1;
  kcg_bool /* IfBlock1:else:else:_L2/ */ _L2_else_else_IfBlock1;
  Q_NVEMRRLS /* IfBlock1:else:else:_L1/ */ _L1_else_else_IfBlock1;
  Q_NVEMRRLS /* IfBlock1:else:then:_L3/ */ _L3_then_else_IfBlock1;
  kcg_bool /* IfBlock1:else:then:_L5/ */ _L5_then_else_IfBlock1;
  kcg_bool /* error/ */ error;
  kcg_int64 /* q_nvemrrls_in/ */ q_nvemrrls_in;
  kcg_bool /* _L13/ */ _L13;
  kcg_int64 /* _L12/ */ _L12;
...
extern void CAST_Int_to_Q_NVEMRRLS_init_TM_conversions(
  outC_CAST_Int_to_Q_NVEMRRLS_TM_conversions *outC);
