...
void InputLocalisation_init_Interfaces(outC_InputLocalisation_Interfaces *outC)
{
  ...
  for (idx = 0; idx < 33; idx++) {
    ...
    outC->_L11.LRBG.infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L11.LRBG.infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int32(0);
    outC->_L11.LRBG.infoFromPassing.linkedBGs[idx].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L11.LRBG.infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int32(0);
    outC->_L11.LRBG.infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int32(0);
    ...
    outC->_L11.LRBG.infoFromPassing.linkedBGs[idx].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L11.LRBG.infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int32(0);
  }
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L11.prvLRBG.infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L11.prvLRBG.infoFromPassing.linkedBGs[idx1].q_scale =
      Q_SCALE_10_cm_scale;
    outC->_L11.prvLRBG.infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int32(0);
    outC->_L11.prvLRBG.infoFromPassing.linkedBGs[idx1].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L11.prvLRBG.infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int32(0);
    outC->_L11.prvLRBG.infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int32(0);
    ...
    outC->_L11.prvLRBG.infoFromPassing.linkedBGs[idx1].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L11.prvLRBG.infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int32(0);
  }
  ...
  for (idx2 = 0; idx2 < 33; idx2++) {
    ...
    outC->_L12.bg.infoFromPassing.linkedBGs[idx2].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L12.bg.infoFromPassing.linkedBGs[idx2].d_link = kcg_lit_int32(0);
    outC->_L12.bg.infoFromPassing.linkedBGs[idx2].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L12.bg.infoFromPassing.linkedBGs[idx2].nid_c = kcg_lit_int32(0);
    outC->_L12.bg.infoFromPassing.linkedBGs[idx2].nid_bg = kcg_lit_int32(0);
    outC->_L12.bg.infoFromPassing.linkedBGs[idx2].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L12.bg.infoFromPassing.linkedBGs[idx2].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L12.bg.infoFromPassing.linkedBGs[idx2].q_locacc = kcg_lit_int32(0);
  }
  ...
  outC->Train_Speed = kcg_lit_int32(0);
  outC->Train_Position.valid = kcg_true;
  outC->Train_Position.timestamp = kcg_lit_int32(0);
  outC->Train_Position.trainPositionIsUnknown = kcg_true;
  outC->Train_Position.noCoordinateSystemHasBeenAssigned = kcg_true;
  outC->Train_Position.trainPosition.nominal = kcg_lit_int32(0);
  outC->Train_Position.trainPosition.d_min = kcg_lit_int32(0);
  outC->Train_Position.trainPosition.d_max = kcg_lit_int32(0);
  outC->Train_Position.estimatedFrontEndPosition = kcg_lit_int32(0);
  outC->Train_Position.minSafeFrontEndPosition = kcg_lit_int32(0);
  outC->Train_Position.maxSafeFrontEndPostion = kcg_lit_int32(0);
  outC->Train_Position.LRBG.valid = kcg_true;
  outC->Train_Position.LRBG.nid_c = kcg_lit_int32(0);
  outC->Train_Position.LRBG.nid_bg = kcg_lit_int32(0);
  outC->Train_Position.LRBG.q_link = Q_LINK_Unlinked;
  outC->Train_Position.LRBG.location.nominal = kcg_lit_int32(0);
  outC->Train_Position.LRBG.location.d_min = kcg_lit_int32(0);
  outC->Train_Position.LRBG.location.d_max = kcg_lit_int32(0);
  outC->Train_Position.LRBG.seqNoOnTrack = kcg_lit_int32(0);
  outC->Train_Position.LRBG.infoFromLinking.valid = kcg_true;
  outC->Train_Position.LRBG.infoFromLinking.nid_bg_fromLinkingBG =
    kcg_lit_int32(0);
  outC->Train_Position.LRBG.infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(
      0);
  ...
  outC->Train_Position.LRBG.infoFromLinking.expectedLocation.d_max =
    kcg_lit_int32(0);
  outC->Train_Position.LRBG.infoFromLinking.d_link.nominal = kcg_lit_int32(0);
  outC->Train_Position.LRBG.infoFromLinking.d_link.d_min = kcg_lit_int32(0);
  outC->Train_Position.LRBG.infoFromLinking.d_link.d_max = kcg_lit_int32(0);
  ...
  outC->Train_Position.LRBG.infoFromLinking.linkingInfo.q_scale =
    Q_SCALE_10_cm_scale;
  outC->Train_Position.LRBG.infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
  outC->Train_Position.LRBG.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  outC->Train_Position.LRBG.infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
  outC->Train_Position.LRBG.infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
  ...
  outC->Train_Position.LRBG.infoFromPassing.BG_Header.n_total =
    N_TOTAL_1_balise_in_the_group;
  outC->Train_Position.LRBG.infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
  outC->Train_Position.LRBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
  outC->Train_Position.LRBG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
  ...
  outC->Train_Position.prvLRBG.nid_c = kcg_lit_int32(0);
  outC->Train_Position.prvLRBG.nid_bg = kcg_lit_int32(0);
  outC->Train_Position.prvLRBG.q_link = Q_LINK_Unlinked;
  outC->Train_Position.prvLRBG.location.nominal = kcg_lit_int32(0);
  outC->Train_Position.prvLRBG.location.d_min = kcg_lit_int32(0);
  outC->Train_Position.prvLRBG.location.d_max = kcg_lit_int32(0);
  outC->Train_Position.prvLRBG.seqNoOnTrack = kcg_lit_int32(0);
  ...
  outC->Train_Position.prvLRBG.infoFromLinking.expectedLocation.d_max =
    kcg_lit_int32(0);
  outC->Train_Position.prvLRBG.infoFromLinking.d_link.nominal = kcg_lit_int32(0);
  outC->Train_Position.prvLRBG.infoFromLinking.d_link.d_min = kcg_lit_int32(0);
  outC->Train_Position.prvLRBG.infoFromLinking.d_link.d_max = kcg_lit_int32(0);
  ...
  outC->Train_Position.prvLRBG.infoFromPassing.BG_Header.m_mcount =
    kcg_lit_int32(0);
  outC->Train_Position.prvLRBG.infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
  outC->Train_Position.prvLRBG.infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(
      0);
  ...
  outC->Train_Position.estimatedRearEndPosition = kcg_lit_int32(0);
  outC->Train_Position.minSafeRearEndPosition = kcg_lit_int32(0);
  outC->Train_Position.maxSafeRearEndPosition = kcg_lit_int32(0);
