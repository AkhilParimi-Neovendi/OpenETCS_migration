...
{
  static kcg_size idx;
  static array_int64_97 tmp;
  static array_int64_65 tmp1;
  static array_int64_33 tmp2;
  ...
  outC->_L9[0] = outC->_L4;
  tmp2[0] = outC->_L9[0];
  kcg_copy_array_int64_32(&tmp2[1], &outC->_L5);
  kcg_copy_array_int64_33(&tmp1[0], &tmp2);
  kcg_copy_array_int64_32(&tmp1[33], &outC->_L6);
  kcg_copy_array_int64_65(&tmp[0], &tmp1);
  kcg_copy_array_int64_32(&tmp[65], &outC->_L7);
  kcg_copy_array_int64_97(&outC->_L10[0], &tmp);
  kcg_copy_array_int64_32(&outC->_L10[97], &outC->_L8);
  ...
  outC_CAST_DMI_speedProfile_to_int_DATA_Variables *outC)
{
  ...
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->_L6[idx4] = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 32; idx5++) {
    outC->_L7[idx5] = kcg_lit_int64(0);
  }
  ...
  for (idx7 = 0; idx7 < 32; idx7++) {
    ...
    outC->_L2[idx7].Loc_Abs = kcg_lit_int64(0);
    outC->_L2[idx7].Loc_LRBG = kcg_lit_int64(0);
    outC->_L2[idx7].MRS = kcg_lit_int64(0);
  }
  outC->_L3 = kcg_true;
  outC->_L1.profileChanged = kcg_true;
  for (idx8 = 0; idx8 < 32; idx8++) {
    outC->_L1.speedProfiles[idx8].valid = kcg_true;
    outC->_L1.speedProfiles[idx8].Loc_Abs = kcg_lit_int64(0);
    outC->_L1.speedProfiles[idx8].Loc_LRBG = kcg_lit_int64(0);
    outC->_L1.speedProfiles[idx8].MRS = kcg_lit_int64(0);
  }
  for (idx9 = 0; idx9 < 129; idx9++) {
    outC->dmi_speedProfile_int[idx9] = kcg_lit_int64(0);
  }
  /* _L4=(Utilities::Bool_to_Int#1)/ */
  Bool_to_Int_init_Utilities(&outC->Context_Bool_to_Int_1);
  for (idx = 0; idx < 32; idx++) {
    /* _L5=(DATA::Variables::CAST_DMI_speedProfileElement_to_int#1)/ */
    CAST_DMI_speedProfileElement_to_int_init_DATA_Variables(
      &outC->Context_CAST_DMI_speedProfileElement_to_int_1[idx]);
  }
}
  ...
  outC_CAST_DMI_speedProfile_to_int_DATA_Variables *outC)
{
  ...
  for (idx = 0; idx < 32; idx++) {
    /* _L5=(DATA::Variables::CAST_DMI_speedProfileElement_to_int#1)/ */
    CAST_DMI_speedProfileElement_to_int_reset_DATA_Variables(
      &outC->Context_CAST_DMI_speedProfileElement_to_int_1[idx]);
  }
}
