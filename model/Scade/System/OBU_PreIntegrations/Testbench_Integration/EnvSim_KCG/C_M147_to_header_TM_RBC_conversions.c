...
{
  kcg_copy_M_147_T_TM_radio_messages(&outC->_L1, Message_Data_in);
  outC->_L7 = outC->_L1.nid_engine;
  /* _L27=(TM_conversions::CAST_NID_ENGINE_to_int#1)/ */
  CAST_NID_ENGINE_to_int_TM_conversions(
    outC->_L7,
    &outC->Context_CAST_NID_ENGINE_to_int_1);
  outC->_L27 = outC->Context_CAST_NID_ENGINE_to_int_1.nid_ctraction_int;
  outC->_L5 = outC->_L1.l_message;
  /* _L26=(TM_conversions::CAST_L_MESSAGE_to_int#1)/ */
  CAST_L_MESSAGE_to_int_TM_conversions(
    outC->_L5,
    &outC->Context_CAST_L_MESSAGE_to_int_1);
  outC->_L26 = outC->Context_CAST_L_MESSAGE_to_int_1.l_message_int;
  outC->_L4 = outC->_L1.nid_message;
  /* _L25=(TM_conversions::CAST_NID_MESSAGE_to_int#1)/ */
  CAST_NID_MESSAGE_to_int_TM_conversions(
    outC->_L4,
    &outC->Context_CAST_NID_MESSAGE_to_int_1);
  outC->_L25 = outC->Context_CAST_NID_MESSAGE_to_int_1.nid_message_int;
  outC->_L6 = outC->_L1.t_train;
  /* _L24=(TM_conversions::CAST_T_TRAIN_to_int#1)/ */
  CAST_T_TRAIN_to_int_TM_conversions(
    outC->_L6,
    &outC->Context_CAST_T_TRAIN_to_int_1);
  outC->_L24 = outC->Context_CAST_T_TRAIN_to_int_1.t_train_int;
  outC->_L22 = outC->_L1.q_emergencystop;
  /* _L23=(TM_conversions::CAST_Q_EMERGENCYSTOP_to_int#1)/ */
  CAST_Q_EMERGENCYSTOP_to_int_TM_conversions(
    outC->_L22,
    &outC->Context_CAST_Q_EMERGENCYSTOP_to_int_1);
  outC->_L23 = outC->Context_CAST_Q_EMERGENCYSTOP_to_int_1.q_emergencystop_int;
  outC->_L20 = outC->_L1.nid_em;
  /* _L21=(TM_conversions::CAST_NID_EM_to_int#1)/ */
  CAST_NID_EM_to_int_TM_conversions(
    outC->_L20,
    &outC->Context_CAST_NID_EM_to_int_1);
  outC->_L21 = outC->Context_CAST_NID_EM_to_int_1.nid_em_int;
  outC->_L19 = kcg_lit_int64(0);
  outC->_L3 = outC->_L1.valid;
  outC->_L2.valid = outC->_L3;
  outC->_L2.nid_message = outC->_L25;
  outC->_L2.l_message = outC->_L26;
  outC->_L2.t_train = outC->_L24;
  outC->_L2.nid_engine = outC->_L27;
  outC->_L2.field1 = outC->_L21;
  outC->_L2.field2 = outC->_L23;
...
void C_M147_to_header_init_TM_RBC_conversions(
  outC_C_M147_to_header_TM_RBC_conversions *outC)
{
  ...
  outC->Message_Header_Out.nid_engine = kcg_lit_int64(0);
  ...
  /* _L23=(TM_conversions::CAST_Q_EMERGENCYSTOP_to_int#1)/ */
  CAST_Q_EMERGENCYSTOP_to_int_init_TM_conversions(
    &outC->Context_CAST_Q_EMERGENCYSTOP_to_int_1);
  /* _L24=(TM_conversions::CAST_T_TRAIN_to_int#1)/ */
...
void C_M147_to_header_reset_TM_RBC_conversions(
  outC_C_M147_to_header_TM_RBC_conversions *outC)
{
  /* _L21=(TM_conversions::CAST_NID_EM_to_int#1)/ */
  CAST_NID_EM_to_int_reset_TM_conversions(&outC->Context_CAST_NID_EM_to_int_1);
  /* _L23=(TM_conversions::CAST_Q_EMERGENCYSTOP_to_int#1)/ */
  CAST_Q_EMERGENCYSTOP_to_int_reset_TM_conversions(
    &outC->Context_CAST_Q_EMERGENCYSTOP_to_int_1);
  /* _L24=(TM_conversions::CAST_T_TRAIN_to_int#1)/ */
