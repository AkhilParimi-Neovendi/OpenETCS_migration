...
typedef struct {
  ...
  outC_Exception04RejectIfSPPAndGradientOnBoardOrMACoverNotFullLength_InformationFilter_Pkg_FirstFilte /* _L3=(InformationFilter_Pkg::FirstFilter::Exception04RejectIfSPPAndGradientOnBoardOrMACoverNotFullLength#1)/ */ Context_Exception04RejectIfSPPAndGradientOnBoardOrMACoverNotFullLength_1;
