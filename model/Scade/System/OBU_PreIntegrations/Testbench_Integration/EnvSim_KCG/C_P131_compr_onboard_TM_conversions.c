  ...
  outC_C_P131_compr_onboard_TM_conversions *outC)
{
  ...
  outC->_L40 = outC->_L34[3];
  outC->q_scale_int_CAST_Int_to_Q_SCALE_1 = outC->_L40;
  ...
  /* _L4=(TM_conversions::CAST_Int_to_D_RBCTR#1)/ */
  CAST_Int_to_D_RBCTR_TM_conversions(
    outC->_L39,
    &outC->Context_CAST_Int_to_D_RBCTR_1);
  outC->_L4 = outC->Context_CAST_Int_to_D_RBCTR_1.d_rbctr;
  outC->_L10.valid = outC->_L22;
  outC->_L10.q_dir = outC->_L11;
  outC->_L10.q_scale = outC->_L44;
...
void C_P131_compr_onboard_init_TM_conversions(
  outC_C_P131_compr_onboard_TM_conversions *outC)
{
  static kcg_size idx;
  ...
  /* _L4=(TM_conversions::CAST_Int_to_D_RBCTR#1)/ */
  CAST_Int_to_D_RBCTR_init_TM_conversions(&outC->Context_CAST_Int_to_D_RBCTR_1);
  /* _L27=(TM_conversions::CAST_Int_to_NID_C#1)/ */
...
void C_P131_compr_onboard_reset_TM_conversions(
  outC_C_P131_compr_onboard_TM_conversions *outC)
{
  /* _L4=(TM_conversions::CAST_Int_to_D_RBCTR#1)/ */
  CAST_Int_to_D_RBCTR_reset_TM_conversions(
    &outC->Context_CAST_Int_to_D_RBCTR_1);
  /* _L27=(TM_conversions::CAST_Int_to_NID_C#1)/ */
