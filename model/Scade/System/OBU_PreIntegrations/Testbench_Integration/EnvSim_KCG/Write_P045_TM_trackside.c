  ...
  outC_Write_P045_TM_trackside *outC)
{
  ...
  /* _L43=(TM_conversions::C_P045_tracksim_compr#1)/ */
  C_P045_tracksim_compr_TM_conversions(
    &outC->_L1,
    &outC->Context_C_P045_tracksim_compr_1);
  kcg_copy_MetadataElement_T_Common_Types_Pkg(
    &outC->_L43,
    &outC->Context_C_P045_tracksim_compr_1.Header);
  kcg_copy_CompressedPacketData_T_Common_Types_Pkg(
    &outC->_L44,
    &outC->Context_C_P045_tracksim_compr_1.P045_compressed);
...
void Write_P045_init_TM_trackside(outC_Write_P045_TM_trackside *outC)
{
  static kcg_size idx;
  ...
  outC->_L1.NID_MN = kcg_lit_int64(0);
  ...
  SEND_WriteBaliseMessageHeader_init_TM_lib_internal(
    &outC->Context_SEND_WriteBaliseMessageHeader_1);
  /* _L43=(TM_conversions::C_P045_tracksim_compr#1)/ */
  C_P045_tracksim_compr_init_TM_conversions(
    &outC->Context_C_P045_tracksim_compr_1);
}
...
void Write_P045_reset_TM_trackside(outC_Write_P045_TM_trackside *outC)
{
  ...
  SEND_WriteBaliseMessageHeader_reset_TM_lib_internal(
    &outC->Context_SEND_WriteBaliseMessageHeader_1);
  /* _L43=(TM_conversions::C_P045_tracksim_compr#1)/ */
  C_P045_tracksim_compr_reset_TM_conversions(
    &outC->Context_C_P045_tracksim_compr_1);
}
