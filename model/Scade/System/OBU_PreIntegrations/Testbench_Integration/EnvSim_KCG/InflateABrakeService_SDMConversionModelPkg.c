  ...
  outC_InflateABrakeService_SDMConversionModelPkg *outC)
{
  ...
  kcg_copy_array_float64_100_6(&outC->_L25[0], &outC->_L37);
  kcg_copy_array_float64_100_8(&outC->_L25[6], &outC->_L28);
  ...
  kcg_copy_array_float64_6(&outC->_L12[0], &outC->_L39);
  kcg_copy_array_float64_8(&outC->_L12[6], &outC->_L14);
  ...
  outC_InflateABrakeService_SDMConversionModelPkg *outC)
{
  ...
  for (idx4 = 0; idx4 < 6; idx4++) {
    for (idx3 = 0; idx3 < 100; idx3++) {
      outC->_L37[idx4][idx3] = kcg_lit_float64(0.0);
    }
  }
  ...
  for (idx5 = 0; idx5 < 100; idx5++) {
    outC->_L30[idx5] = kcg_lit_float64(0.0);
  }
  for (idx7 = 0; idx7 < 14; idx7++) {
    for (idx6 = 0; idx6 < 100; idx6++) {
      outC->_L25[idx7][idx6] = kcg_lit_float64(0.0);
    }
  }
  for (idx9 = 0; idx9 < 8; idx9++) {
    for (idx8 = 0; idx8 < 100; idx8++) {
      outC->_L28[idx9][idx8] = kcg_lit_float64(0.0);
    }
  }
  for (idx10 = 0; idx10 < 100; idx10++) {
    outC->_L16[idx10] = kcg_lit_float64(0.0);
  }
  outC->_L17 = kcg_lit_float64(0.0);
  for (idx11 = 0; idx11 < 8; idx11++) {
    outC->_L14[idx11] = kcg_lit_float64(0.0);
  }
  for (idx12 = 0; idx12 < 14; idx12++) {
    outC->_L12[idx12] = kcg_lit_float64(0.0);
  }
  ...
  for (idx17 = 0; idx17 < 6; idx17++) {
    outC->_L6[idx17] = kcg_lit_int64(0);
  }
  for (idx18 = 0; idx18 < 6; idx18++) {
    outC->_L7[idx18] = kcg_lit_int64(0);
  }
  for (idx19 = 0; idx19 < 6; idx19++) {
    outC->_L3.emergency.a[idx19] = kcg_lit_int64(0);
  }
  for (idx20 = 0; idx20 < 6; idx20++) {
    outC->_L3.emergency.v[idx20] = kcg_lit_int64(0);
  }
  for (idx21 = 0; idx21 < 6; idx21++) {
    outC->_L3.service.a[idx21] = kcg_lit_int64(0);
  }
  for (idx22 = 0; idx22 < 6; idx22++) {
    outC->_L3.service.v[idx22] = kcg_lit_int64(0);
  }
  for (idx23 = 0; idx23 < 6; idx23++) {
    outC->_L2.a[idx23] = kcg_lit_int64(0);
  }
  for (idx24 = 0; idx24 < 6; idx24++) {
    outC->_L2.v[idx24] = kcg_lit_int64(0);
  }
  for (idx25 = 0; idx25 < 100; idx25++) {
    outC->aBrakeService.distance_definition[idx25] = kcg_lit_float64(0.0);
  }
  for (idx26 = 0; idx26 < 14; idx26++) {
    outC->aBrakeService.speed_definition[idx26] = kcg_lit_float64(0.0);
  }
  for (idx28 = 0; idx28 < 14; idx28++) {
    for (idx27 = 0; idx27 < 100; idx27++) {
      outC->aBrakeService.data[idx28][idx27] = kcg_lit_float64(0.0);
    }
  }
