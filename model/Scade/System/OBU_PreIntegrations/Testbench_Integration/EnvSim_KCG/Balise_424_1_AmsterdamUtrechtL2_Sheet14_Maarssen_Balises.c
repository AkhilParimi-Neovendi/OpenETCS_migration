...
void Balise_424_1_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises(
  ...
  /* PIG_nom/ */
  kcg_int64 PIG_nom,
  outC_Balise_424_1_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Balises::Packets_BG424#1)/ */
    Packets_BG424_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG424_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG424_1.Balise_data_out);
...
void Balise_424_1_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises(
  outC_Balise_424_1_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises *outC)
{
  static kcg_size idx;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Balises::Packets_BG424#1)/ */
  Packets_BG424_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises(
    &outC->Context_Packets_BG424_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_424_1_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises(
  outC_Balise_424_1_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Balises::Packets_BG424#1)/ */
  Packets_BG424_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Balises(
    &outC->Context_Packets_BG424_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
