  ...
  outC_Sheet14_Balises_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L21.Messages.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L21.Messages.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L21.Messages.PacketHeaders[idx].valid = kcg_true;
    outC->_L21.Messages.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L21.Messages.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L21.Messages.PacketData[idx1] = kcg_lit_int64(0);
  }
