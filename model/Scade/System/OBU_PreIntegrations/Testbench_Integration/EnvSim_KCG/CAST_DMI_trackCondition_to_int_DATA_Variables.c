  ...
  outC_CAST_DMI_trackCondition_to_int_DATA_Variables *outC)
{
  ...
  outC->_L6[0] = outC->_L3;
  tmp[0] = outC->_L6[0];
  kcg_copy_array_int64_32(&tmp[1], &outC->_L8);
  kcg_copy_array_int64_33(&outC->_L7[0], &tmp);
  kcg_copy_array_int64_32(&outC->_L7[33], &outC->_L9);
