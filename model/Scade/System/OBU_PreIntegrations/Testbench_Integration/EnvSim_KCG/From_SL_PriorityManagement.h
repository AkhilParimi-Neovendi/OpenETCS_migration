...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  T_Mode_Level_And_Mode_Types_Pkg /* FromSL_To_NewMode/ */ FromSL_To_NewMode;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
...
} outC_From_SL_PriorityManagement;

/* ===========  node initialization and cycle functions  =========== */
/* PriorityManagement::From_SL/ */
extern void From_SL_PriorityManagement(
  /* Condition1/ */
  kcg_bool Condition1,
  /* Condition3/ */
  kcg_bool Condition3,
...
extern void From_SL_reset_PriorityManagement(
  outC_From_SL_PriorityManagement *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void From_SL_init_PriorityManagement(
  outC_From_SL_PriorityManagement *outC);
