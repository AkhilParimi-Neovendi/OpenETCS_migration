...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  T_Mode_Level_And_Mode_Types_Pkg /* FromNP_To_NewMode/ */ FromNP_To_NewMode;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  T_Mode_Level_And_Mode_Types_Pkg /* IfBlock1:else:else:_L3/ */ _L3_else_else_IfBlock1;
  T_Mode_Level_And_Mode_Types_Pkg /* IfBlock1:else:then:_L1/ */ _L1_then_else_IfBlock1;
} outC_From_NP_PriorityManagement;

/* ===========  node initialization and cycle functions  =========== */
/* PriorityManagement::From_NP/ */
extern void From_NP_PriorityManagement(
  /* Condition1/ */
  kcg_bool Condition1,
  /* Condition4/ */
  kcg_bool Condition4,
...
extern void From_NP_reset_PriorityManagement(
  outC_From_NP_PriorityManagement *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void From_NP_init_PriorityManagement(
  outC_From_NP_PriorityManagement *outC);
