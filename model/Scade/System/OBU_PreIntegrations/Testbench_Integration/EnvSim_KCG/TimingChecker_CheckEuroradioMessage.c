  ...
  outC_TimingChecker_CheckEuroradioMessage *outC)
{
  ...
  outC->_L9_then_else_IfBlock1.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L8_then_else_IfBlock1.connection.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L8_then_else_IfBlock1.session.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L6_else_else_IfBlock1.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L1_else_else_IfBlock1.connection.nid_radio = kcg_lit_int32(0);
  ...
  outC->_L1_else_else_IfBlock1.session.nid_radio = kcg_lit_int32(0);
