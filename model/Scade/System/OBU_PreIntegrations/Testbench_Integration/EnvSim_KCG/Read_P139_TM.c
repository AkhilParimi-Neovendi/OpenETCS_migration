...
void Read_P139_init_TM(outC_Read_P139_TM *outC)
{
  ...
  outC->_L166.d_reverse = kcg_lit_int32(0);
  outC->_L166.v_reverse = kcg_lit_int32(0);
  ...
  outC->P139_OBU_out.d_reverse = kcg_lit_int32(0);
  outC->P139_OBU_out.v_reverse = kcg_lit_int32(0);
