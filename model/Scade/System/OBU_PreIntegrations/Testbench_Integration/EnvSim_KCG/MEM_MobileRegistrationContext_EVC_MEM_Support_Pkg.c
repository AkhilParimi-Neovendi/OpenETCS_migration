  ...
  outC_MEM_MobileRegistrationContext_EVC_MEM_Support_Pkg *outC)
{
  ...
  outC->_L20.nid_mn = kcg_lit_int64(0);
  ...
  outC->_L2.nid_mn = kcg_lit_int64(0);
  ...
  outC->RegistrationContext.mobileDeviceNo = kcg_lit_int64(0);
  ...
  outC->RegistrationContext.nid_mn = kcg_lit_int64(0);
  outC->MobileRegistrationContext.valid = kcg_true;
  outC->MobileRegistrationContext.mobileDeviceNo = kcg_lit_int64(0);
  ...
  outC->MobileRegistrationContext.nid_mn = kcg_lit_int64(0);
  /* _L17=(EVC_MEM_Support_Pkg::getMobileRegStatus#1)/ */
