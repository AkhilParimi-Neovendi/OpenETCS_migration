  ...
  outC_trimSeqNoOnTrack_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  ...
  for (idx2 = 0; idx2 < 41; idx2++) {
    ...
    outC->_L3[idx2].nid_c = kcg_lit_int32(0);
    outC->_L3[idx2].nid_bg = kcg_lit_int32(0);
    outC->_L3[idx2].q_link = Q_LINK_Unlinked;
    outC->_L3[idx2].location.nominal = kcg_lit_int32(0);
    outC->_L3[idx2].location.d_min = kcg_lit_int32(0);
    outC->_L3[idx2].location.d_max = kcg_lit_int32(0);
    outC->_L3[idx2].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L3[idx2].infoFromLinking.valid = kcg_true;
    outC->_L3[idx2].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L3[idx2].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L3[idx2].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L3[idx2].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L3[idx2].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L3[idx2].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L3[idx2].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L3[idx2].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L3[idx2].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L3[idx2].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L3[idx2].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L3[idx2].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L3[idx2].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L3[idx2].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L3[idx2].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L3[idx2].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L3[idx2].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L3[idx2].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L3[idx2].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L3[idx2].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx1 = 0; idx1 < 33; idx1++) {
      ...
      outC->_L3[idx2].infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L3[idx2].infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int32(0);
      outC->_L3[idx2].infoFromPassing.linkedBGs[idx1].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L3[idx2].infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int32(0);
      outC->_L3[idx2].infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L3[idx2].infoFromPassing.linkedBGs[idx1].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L3[idx2].infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int32(0);
    }
    outC->_L3[idx2].missed = kcg_true;
  }
  for (idx4 = 0; idx4 < 41; idx4++) {
    outC->_L1[idx4].valid = kcg_true;
    outC->_L1[idx4].nid_c = kcg_lit_int32(0);
    outC->_L1[idx4].nid_bg = kcg_lit_int32(0);
    outC->_L1[idx4].q_link = Q_LINK_Unlinked;
    outC->_L1[idx4].location.nominal = kcg_lit_int32(0);
    outC->_L1[idx4].location.d_min = kcg_lit_int32(0);
    outC->_L1[idx4].location.d_max = kcg_lit_int32(0);
    outC->_L1[idx4].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L1[idx4].infoFromLinking.valid = kcg_true;
    outC->_L1[idx4].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L1[idx4].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L1[idx4].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L1[idx4].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L1[idx4].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L1[idx4].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L1[idx4].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L1[idx4].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L1[idx4].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L1[idx4].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L1[idx4].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L1[idx4].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L1[idx4].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L1[idx4].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    outC->_L1[idx4].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L1[idx4].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L1[idx4].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L1[idx4].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L1[idx4].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L1[idx4].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L1[idx4].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L1[idx4].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L1[idx4].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx3 = 0; idx3 < 33; idx3++) {
      ...
      outC->_L1[idx4].infoFromPassing.linkedBGs[idx3].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L1[idx4].infoFromPassing.linkedBGs[idx3].d_link = kcg_lit_int32(0);
      outC->_L1[idx4].infoFromPassing.linkedBGs[idx3].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L1[idx4].infoFromPassing.linkedBGs[idx3].nid_c = kcg_lit_int32(0);
      outC->_L1[idx4].infoFromPassing.linkedBGs[idx3].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L1[idx4].infoFromPassing.linkedBGs[idx3].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L1[idx4].infoFromPassing.linkedBGs[idx3].q_locacc = kcg_lit_int32(0);
    }
    outC->_L1[idx4].missed = kcg_true;
  }
  for (idx6 = 0; idx6 < 41; idx6++) {
    outC->BGs_out[idx6].valid = kcg_true;
    outC->BGs_out[idx6].nid_c = kcg_lit_int32(0);
    outC->BGs_out[idx6].nid_bg = kcg_lit_int32(0);
    outC->BGs_out[idx6].q_link = Q_LINK_Unlinked;
    outC->BGs_out[idx6].location.nominal = kcg_lit_int32(0);
    outC->BGs_out[idx6].location.d_min = kcg_lit_int32(0);
    outC->BGs_out[idx6].location.d_max = kcg_lit_int32(0);
    outC->BGs_out[idx6].seqNoOnTrack = kcg_lit_int32(0);
    outC->BGs_out[idx6].infoFromLinking.valid = kcg_true;
    outC->BGs_out[idx6].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->BGs_out[idx6].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->BGs_out[idx6].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->BGs_out[idx6].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->BGs_out[idx6].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->BGs_out[idx6].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->BGs_out[idx6].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->BGs_out[idx6].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->BGs_out[idx6].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->BGs_out[idx6].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->BGs_out[idx6].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->BGs_out[idx6].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->BGs_out[idx6].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->BGs_out[idx6].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    ...
    outC->BGs_out[idx6].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->BGs_out[idx6].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->BGs_out[idx6].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->BGs_out[idx6].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->BGs_out[idx6].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->BGs_out[idx6].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->BGs_out[idx6].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->BGs_out[idx6].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx5 = 0; idx5 < 33; idx5++) {
      ...
      outC->BGs_out[idx6].infoFromPassing.linkedBGs[idx5].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->BGs_out[idx6].infoFromPassing.linkedBGs[idx5].q_scale =
        Q_SCALE_10_cm_scale;
      outC->BGs_out[idx6].infoFromPassing.linkedBGs[idx5].d_link = kcg_lit_int32(0);
      outC->BGs_out[idx6].infoFromPassing.linkedBGs[idx5].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->BGs_out[idx6].infoFromPassing.linkedBGs[idx5].nid_c = kcg_lit_int32(0);
      outC->BGs_out[idx6].infoFromPassing.linkedBGs[idx5].nid_bg = kcg_lit_int32(0);
      ...
      outC->BGs_out[idx6].infoFromPassing.linkedBGs[idx5].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->BGs_out[idx6].infoFromPassing.linkedBGs[idx5].q_locacc = kcg_lit_int32(0);
    }
