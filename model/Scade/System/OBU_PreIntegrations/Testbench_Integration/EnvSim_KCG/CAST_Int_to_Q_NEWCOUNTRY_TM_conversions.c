...
{
  /* q_newcountry/ */
  static Q_NEWCOUNTRY q_newcountry_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* q_newcountry/ */
  static Q_NEWCOUNTRY _1_q_newcountry_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* error/ */
  static kcg_bool _3_error_partial;
  /* q_newcountry/ */
  static Q_NEWCOUNTRY _4_q_newcountry_partial;
  /* error/ */
  static kcg_bool _5_error_partial;
  /* q_newcountry/ */
  static Q_NEWCOUNTRY _6_q_newcountry_partial;
  ...
  outC_CAST_Int_to_Q_NEWCOUNTRY_TM_conversions *outC)
{
  ...
  outC->_L13 = kcg_true;
  outC->q_newcountry_in = kcg_lit_int64(0);
  outC->error = kcg_true;
