  ...
  outC_SP_ASP_TA_SpeedProfiles *outC)
{
  ...
  kcg_copy_SSP_cat_t_TA_MRSP(&outC->ASP, &outC->_L3);
}

#ifndef KCG_USER_DEFINED_INIT
void SP_ASP_init_TA_SpeedProfiles(outC_SP_ASP_TA_SpeedProfiles *outC)
{
  static kcg_size idx;
  ...
  for (idx = 0; idx < 50; idx++) {
    outC->_L3[idx].target = kcg_lit_int32(0);
    outC->_L3[idx].speed = kcg_lit_int32(0);
  }
  ...
  for (idx3 = 0; idx3 < 50; idx3++) {
    outC->ASP[idx3].target = kcg_lit_int32(0);
    outC->ASP[idx3].speed = kcg_lit_int32(0);
  }
}
...
void SP_ASP_reset_TA_SpeedProfiles(outC_SP_ASP_TA_SpeedProfiles *outC)
{
}
