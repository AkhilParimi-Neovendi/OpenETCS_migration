...
void Balise_358_1_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
  ...
  /* PIG_nom/ */
  kcg_int64 PIG_nom,
  outC_Balise_358_1_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet06_Bijlmer_Balises::Packets_BG358#1)/ */
    Packets_BG358_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG358_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG358_1.Balise_data_out);
...
void Balise_358_1_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
  outC_Balise_358_1_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises *outC)
{
  static kcg_size idx;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet06_Bijlmer_Balises::Packets_BG358#1)/ */
  Packets_BG358_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
    &outC->Context_Packets_BG358_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_358_1_reset_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
  outC_Balise_358_1_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet06_Bijlmer_Balises::Packets_BG358#1)/ */
  Packets_BG358_reset_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
    &outC->Context_Packets_BG358_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
