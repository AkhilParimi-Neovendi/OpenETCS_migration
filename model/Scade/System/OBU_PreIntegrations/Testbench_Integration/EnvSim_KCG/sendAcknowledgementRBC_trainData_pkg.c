  ...
  outC_sendAcknowledgementRBC_trainData_pkg *outC)
{
  ...
  outC->_L40.timeStampValidateToRBC = kcg_lit_int32(0);
  ...
  outC->_L43.timeStampValidateToRBC = kcg_lit_int32(0);
  ...
  for (idx1 = 0; idx1 < 5; idx1++) {
    ...
    outC->_L23[idx1].Message.nid_message = kcg_lit_int32(0);
    outC->_L23[idx1].Message.l_message = kcg_lit_int32(0);
    outC->_L23[idx1].Message.t_train = kcg_lit_int32(0);
    outC->_L23[idx1].Message.nid_engine = kcg_lit_int32(0);
    outC->_L23[idx1].Message.field1 = kcg_lit_int32(0);
    outC->_L23[idx1].Message.field2 = kcg_lit_int32(0);
    outC->_L23[idx1].Message.field3 = kcg_lit_int32(0);
    for (idx = 0; idx < 50; idx++) {
      outC->_L23[idx1].OptionalPackets[idx] = kcg_lit_int32(0);
    }
  }
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L24[idx3].Message.valid = kcg_true;
    outC->_L24[idx3].Message.nid_message = kcg_lit_int32(0);
    outC->_L24[idx3].Message.l_message = kcg_lit_int32(0);
    outC->_L24[idx3].Message.t_train = kcg_lit_int32(0);
    outC->_L24[idx3].Message.nid_engine = kcg_lit_int32(0);
    outC->_L24[idx3].Message.field1 = kcg_lit_int32(0);
    outC->_L24[idx3].Message.field2 = kcg_lit_int32(0);
    outC->_L24[idx3].Message.field3 = kcg_lit_int32(0);
    for (idx2 = 0; idx2 < 50; idx2++) {
      outC->_L24[idx3].OptionalPackets[idx2] = kcg_lit_int32(0);
    }
  }
  ...
  outC->_L32.l_message = kcg_lit_int32(0);
  outC->_L32.t_train = kcg_lit_int32(0);
  outC->_L32.nid_engine = kcg_lit_int32(0);
  outC->_L32.t_train_req = kcg_lit_int32(0);
  for (idx5 = 0; idx5 < 5; idx5++) {
    outC->outMessageBus[idx5].Message.valid = kcg_true;
    outC->outMessageBus[idx5].Message.nid_message = kcg_lit_int32(0);
    outC->outMessageBus[idx5].Message.l_message = kcg_lit_int32(0);
    outC->outMessageBus[idx5].Message.t_train = kcg_lit_int32(0);
    outC->outMessageBus[idx5].Message.nid_engine = kcg_lit_int32(0);
    outC->outMessageBus[idx5].Message.field1 = kcg_lit_int32(0);
    outC->outMessageBus[idx5].Message.field2 = kcg_lit_int32(0);
    outC->outMessageBus[idx5].Message.field3 = kcg_lit_int32(0);
    for (idx4 = 0; idx4 < 50; idx4++) {
      outC->outMessageBus[idx5].OptionalPackets[idx4] = kcg_lit_int32(0);
    }
  }
