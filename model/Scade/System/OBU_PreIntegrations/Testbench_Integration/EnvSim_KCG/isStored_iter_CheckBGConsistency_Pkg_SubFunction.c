  ...
  outC_isStored_iter_CheckBGConsistency_Pkg_SubFunction *outC)
{
  ...
  if (outC->_L13) {
    ...
    for (idx = 0; idx < 41; idx++) {
      ...
      outC->_L11 = /* _L11= */(kcg_int64) (idx + 1);
      /* _L11= */
  ...
  if ((kcg_lit_int64(0) <= outC->_L26) & (outC->_L26 < kcg_lit_int64(41))) {
  ...
  outC_isStored_iter_CheckBGConsistency_Pkg_SubFunction *outC)
{
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L24.infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L24.infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int64(0);
    outC->_L24.infoFromPassing.linkedBGs[idx1].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L24.infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int64(0);
    outC->_L24.infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int64(0);
    outC->_L24.infoFromPassing.linkedBGs[idx1].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L24.infoFromPassing.linkedBGs[idx1].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L24.infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int64(0);
  }
  outC->_L24.missed = kcg_true;
  for (idx3 = 0; idx3 < 41; idx3++) {
    outC->_L21[idx3].valid = kcg_true;
    outC->_L21[idx3].nid_c = kcg_lit_int64(0);
    outC->_L21[idx3].nid_bg = kcg_lit_int64(0);
    outC->_L21[idx3].q_link = Q_LINK_Unlinked;
    outC->_L21[idx3].location.nominal = kcg_lit_int64(0);
    outC->_L21[idx3].location.d_min = kcg_lit_int64(0);
    outC->_L21[idx3].location.d_max = kcg_lit_int64(0);
    outC->_L21[idx3].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L21[idx3].infoFromLinking.valid = kcg_true;
    outC->_L21[idx3].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L21[idx3].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L21[idx3].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L21[idx3].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L21[idx3].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L21[idx3].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L21[idx3].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L21[idx3].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L21[idx3].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L21[idx3].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L21[idx3].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L21[idx3].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L21[idx3].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L21[idx3].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    outC->_L21[idx3].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L21[idx3].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L21[idx3].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L21[idx3].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L21[idx3].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L21[idx3].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L21[idx3].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L21[idx3].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx2 = 0; idx2 < 33; idx2++) {
      ...
      outC->_L21[idx3].infoFromPassing.linkedBGs[idx2].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L21[idx3].infoFromPassing.linkedBGs[idx2].d_link = kcg_lit_int64(0);
      outC->_L21[idx3].infoFromPassing.linkedBGs[idx2].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L21[idx3].infoFromPassing.linkedBGs[idx2].nid_c = kcg_lit_int64(0);
      outC->_L21[idx3].infoFromPassing.linkedBGs[idx2].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L21[idx3].infoFromPassing.linkedBGs[idx2].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L21[idx3].infoFromPassing.linkedBGs[idx2].q_locacc = kcg_lit_int64(0);
    }
    outC->_L21[idx3].missed = kcg_true;
  }
  for (idx5 = 0; idx5 < 41; idx5++) {
    outC->_L15[idx5].valid = kcg_true;
    outC->_L15[idx5].nid_c = kcg_lit_int64(0);
    outC->_L15[idx5].nid_bg = kcg_lit_int64(0);
    outC->_L15[idx5].q_link = Q_LINK_Unlinked;
    outC->_L15[idx5].location.nominal = kcg_lit_int64(0);
    outC->_L15[idx5].location.d_min = kcg_lit_int64(0);
    outC->_L15[idx5].location.d_max = kcg_lit_int64(0);
    outC->_L15[idx5].seqNoOnTrack = kcg_lit_int64(0);
    outC->_L15[idx5].infoFromLinking.valid = kcg_true;
    outC->_L15[idx5].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int64(0);
    outC->_L15[idx5].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int64(0);
    outC->_L15[idx5].infoFromLinking.expectedLocation.nominal = kcg_lit_int64(0);
    outC->_L15[idx5].infoFromLinking.expectedLocation.d_min = kcg_lit_int64(0);
    outC->_L15[idx5].infoFromLinking.expectedLocation.d_max = kcg_lit_int64(0);
    outC->_L15[idx5].infoFromLinking.d_link.nominal = kcg_lit_int64(0);
    outC->_L15[idx5].infoFromLinking.d_link.d_min = kcg_lit_int64(0);
    outC->_L15[idx5].infoFromLinking.d_link.d_max = kcg_lit_int64(0);
    outC->_L15[idx5].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L15[idx5].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int64(0);
    ...
    outC->_L15[idx5].infoFromLinking.linkingInfo.d_link = kcg_lit_int64(0);
    outC->_L15[idx5].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L15[idx5].infoFromLinking.linkingInfo.nid_c = kcg_lit_int64(0);
    outC->_L15[idx5].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int64(0);
    outC->_L15[idx5].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L15[idx5].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L15[idx5].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int64(0);
    ...
    outC->_L15[idx5].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L15[idx5].infoFromPassing.BG_Header.m_mcount = kcg_lit_int64(0);
    outC->_L15[idx5].infoFromPassing.BG_Header.nid_c = kcg_lit_int64(0);
    outC->_L15[idx5].infoFromPassing.BG_Header.nid_bg = kcg_lit_int64(0);
    ...
    outC->_L15[idx5].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int64(0);
    outC->_L15[idx5].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int64(0);
    ...
    for (idx4 = 0; idx4 < 33; idx4++) {
      ...
      outC->_L15[idx5].infoFromPassing.linkedBGs[idx4].nid_LRBG = kcg_lit_int64(0);
      ...
      outC->_L15[idx5].infoFromPassing.linkedBGs[idx4].d_link = kcg_lit_int64(0);
      outC->_L15[idx5].infoFromPassing.linkedBGs[idx4].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L15[idx5].infoFromPassing.linkedBGs[idx4].nid_c = kcg_lit_int64(0);
      outC->_L15[idx5].infoFromPassing.linkedBGs[idx4].nid_bg = kcg_lit_int64(0);
      ...
      outC->_L15[idx5].infoFromPassing.linkedBGs[idx4].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L15[idx5].infoFromPassing.linkedBGs[idx4].q_locacc = kcg_lit_int64(0);
    }
