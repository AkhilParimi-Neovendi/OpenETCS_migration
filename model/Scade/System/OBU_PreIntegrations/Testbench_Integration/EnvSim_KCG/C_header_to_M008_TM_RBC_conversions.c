  ...
  outC_C_header_to_M008_TM_RBC_conversions *outC)
{
  ...
  /* _L32=(TM_conversions::CAST_Int_to_T_TRAIN#2)/ */
  CAST_Int_to_T_TRAIN_TM_conversions(
    outC->_L5,
    &outC->Context_CAST_Int_to_T_TRAIN_2);
  outC->_L32 = outC->Context_CAST_Int_to_T_TRAIN_2.t_train;
...
void C_header_to_M008_init_TM_RBC_conversions(
  outC_C_header_to_M008_TM_RBC_conversions *outC)
{
  ...
  outC->_L26.t_train_received = kcg_lit_int64(0);
  outC->_L2 = kcg_true;
  ...
  outC->message_out.t_train_received = kcg_lit_int64(0);
  /* _L27=(TM_conversions::CAST_Int_to_M_ACK#1)/ */
