  ...
  outC_BufferMsg_read_only_TM_lib_internal *outC)
{
  ...
  if ((kcg_lit_int64(0) <= outC->_L19) & (outC->_L19 < kcg_lit_int64(5))) {
    kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
      &outC->_L21[outC->_L19],
      &outC->_L22);
  }
  outC->_L18 = outC->index;
  if ((kcg_lit_int64(0) <= outC->_L18) & (outC->_L18 < kcg_lit_int64(5))) {
    kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
      &outC->_L12,
      &outC->_L1[outC->_L18]);
  }
  ...
  outC_BufferMsg_read_only_TM_lib_internal *outC)
{
  ...
  for (idx4 = 0; idx4 < 50; idx4++) {
    outC->_L3.OptionalPackets[idx4] = kcg_lit_int64(0);
  }
  ...
  for (idx7 = 0; idx7 < 50; idx7++) {
    outC->Message_out.OptionalPackets[idx7] = kcg_lit_int64(0);
  }
  outC->Stacksize_new = kcg_lit_int64(0);
  for (idx9 = 0; idx9 < 5; idx9++) {
    outC->Buffer_Out[idx9].Message.valid = kcg_true;
    outC->Buffer_Out[idx9].Message.nid_message = kcg_lit_int64(0);
    outC->Buffer_Out[idx9].Message.l_message = kcg_lit_int64(0);
    outC->Buffer_Out[idx9].Message.t_train = kcg_lit_int64(0);
    outC->Buffer_Out[idx9].Message.nid_engine = kcg_lit_int64(0);
    outC->Buffer_Out[idx9].Message.field1 = kcg_lit_int64(0);
    outC->Buffer_Out[idx9].Message.field2 = kcg_lit_int64(0);
    outC->Buffer_Out[idx9].Message.field3 = kcg_lit_int64(0);
    for (idx8 = 0; idx8 < 50; idx8++) {
      outC->Buffer_Out[idx9].OptionalPackets[idx8] = kcg_lit_int64(0);
    }
  }
}
