...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P058_section_array_T_TM /* section_arrays/ */ section_arrays;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
...
extern void C_P058_fs_struct_to_array_reset_TM_lib_internal(
  outC_C_P058_fs_struct_to_array_TM_lib_internal *outC);

#ifndef KCG_USER_DEFINED_INIT
extern void C_P058_fs_struct_to_array_init_TM_lib_internal(
  outC_C_P058_fs_struct_to_array_TM_lib_internal *outC);
