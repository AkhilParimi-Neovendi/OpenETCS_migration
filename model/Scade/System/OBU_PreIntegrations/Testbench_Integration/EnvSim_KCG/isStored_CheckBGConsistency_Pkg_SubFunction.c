  ...
  outC_isStored_CheckBGConsistency_Pkg_SubFunction *outC)
{
  ...
  outC->_L7.bgPosition.timestamp = kcg_lit_int32(0);
  outC->_L7.bgPosition.odo.o_nominal = kcg_lit_int32(0);
  outC->_L7.bgPosition.odo.o_min = kcg_lit_int32(0);
  outC->_L7.bgPosition.odo.o_max = kcg_lit_int32(0);
  outC->_L7.bgPosition.speed.v_safeNominal = kcg_lit_int32(0);
  outC->_L7.bgPosition.speed.v_rawNominal = kcg_lit_int32(0);
  outC->_L7.bgPosition.speed.v_lower = kcg_lit_int32(0);
  outC->_L7.bgPosition.speed.v_upper = kcg_lit_int32(0);
  outC->_L7.bgPosition.acceleration = kcg_lit_int32(0);
  ...
  outC->acc_out.m_mcount = kcg_lit_int32(0);
  outC->acc_out.nid_c = kcg_lit_int32(0);
  outC->acc_out.nid_bg = kcg_lit_int32(0);
  outC->acc_out.q_link = Q_LINK_Unlinked;
  outC->acc_out.bgPosition.valid = kcg_true;
  outC->acc_out.bgPosition.timestamp = kcg_lit_int32(0);
  outC->acc_out.bgPosition.odo.o_nominal = kcg_lit_int32(0);
  outC->acc_out.bgPosition.odo.o_min = kcg_lit_int32(0);
  outC->acc_out.bgPosition.odo.o_max = kcg_lit_int32(0);
  outC->acc_out.bgPosition.speed.v_safeNominal = kcg_lit_int32(0);
  outC->acc_out.bgPosition.speed.v_rawNominal = kcg_lit_int32(0);
  outC->acc_out.bgPosition.speed.v_lower = kcg_lit_int32(0);
  outC->acc_out.bgPosition.speed.v_upper = kcg_lit_int32(0);
  outC->acc_out.bgPosition.acceleration = kcg_lit_int32(0);
  ...
  outC->acc_out.BG_centerDetectionInaccuraccuracies.nominal = kcg_lit_int32(0);
  outC->acc_out.BG_centerDetectionInaccuraccuracies.d_min = kcg_lit_int32(0);
  outC->acc_out.BG_centerDetectionInaccuraccuracies.d_max = kcg_lit_int32(0);
  outC->acc_out.q_nvlocacc = kcg_lit_int32(0);
