  ...
  outC_sendValidTrainDataRBC_trainData_pkg *outC)
{
  ...
  outC->_L44.timeStampValidateToRBC = kcg_lit_int64(0);
  ...
  outC->_L37.l_train = kcg_lit_int64(0);
  outC->_L37.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L37.n_axle = kcg_lit_int64(0);
  outC->_L37.n_iter_voltage = kcg_lit_int64(0);
  for (idx = 0; idx < 4; idx++) {
    outC->_L37.voltage_list[idx].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L37.voltage_list[idx].nid_ctraction = kcg_lit_int64(0);
  }
  outC->_L37.n_iter_nid_ntc = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 5; idx1++) {
    outC->_L37.nid_ntc_list[idx1] = kcg_lit_int64(0);
  }
  ...
  outC->_L33.nid_lrbg = kcg_lit_int64(0);
  outC->_L33.d_lrbg = kcg_lit_int64(0);
  outC->_L33.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L33.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L33.l_doubtover = kcg_lit_int64(0);
  outC->_L33.l_doubtunder = kcg_lit_int64(0);
  outC->_L33.q_length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L33.l_trainint = kcg_lit_int64(0);
  ...
  outC->_L33.nid_ntc = kcg_lit_int64(0);
  outC->_L32.valid = kcg_true;
  outC->_L32.packet1.NID_PACKET = kcg_lit_int64(0);
  outC->_L32.packet1.L_PACKET = kcg_lit_int64(0);
  outC->_L32.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L32.packet1.NID_LRBG = kcg_lit_int64(0);
  outC->_L32.packet1.NID_PRVLRBG = kcg_lit_int64(0);
  outC->_L32.packet1.D_LRBG = kcg_lit_int64(0);
  outC->_L32.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L32.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L32.packet1.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L32.packet1.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L32.packet1.length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L32.packet1.L_TRAININT = kcg_lit_int64(0);
  outC->_L32.packet1.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L32.packet1.NID_NTC = kcg_lit_int64(0);
  outC->_L31.valid = kcg_true;
  outC->_L31.packet0.NID_PACKET = kcg_lit_int64(0);
  outC->_L31.packet0.L_PACKET = kcg_lit_int64(0);
  outC->_L31.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L31.packet0.NID_LRBG = kcg_lit_int64(0);
  outC->_L31.packet0.D_LRBG = kcg_lit_int64(0);
  outC->_L31.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L31.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->_L31.packet0.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L31.packet0.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L31.packet0.length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L31.packet0.L_TRAININT = kcg_lit_int64(0);
  outC->_L31.packet0.V_TRAIN = kcg_lit_int64(0);
  ...
  for (idx5 = 0; idx5 < 5; idx5++) {
    ...
    outC->_L25[idx5].Message.nid_message = kcg_lit_int64(0);
    outC->_L25[idx5].Message.l_message = kcg_lit_int64(0);
    outC->_L25[idx5].Message.t_train = kcg_lit_int64(0);
    outC->_L25[idx5].Message.nid_engine = kcg_lit_int64(0);
    outC->_L25[idx5].Message.field1 = kcg_lit_int64(0);
    outC->_L25[idx5].Message.field2 = kcg_lit_int64(0);
    outC->_L25[idx5].Message.field3 = kcg_lit_int64(0);
    for (idx4 = 0; idx4 < 50; idx4++) {
      outC->_L25[idx5].OptionalPackets[idx4] = kcg_lit_int64(0);
    }
  }
  for (idx7 = 0; idx7 < 5; idx7++) {
    outC->_L24[idx7].Message.valid = kcg_true;
    outC->_L24[idx7].Message.nid_message = kcg_lit_int64(0);
    outC->_L24[idx7].Message.l_message = kcg_lit_int64(0);
    outC->_L24[idx7].Message.t_train = kcg_lit_int64(0);
    outC->_L24[idx7].Message.nid_engine = kcg_lit_int64(0);
    outC->_L24[idx7].Message.field1 = kcg_lit_int64(0);
    outC->_L24[idx7].Message.field2 = kcg_lit_int64(0);
    outC->_L24[idx7].Message.field3 = kcg_lit_int64(0);
    for (idx6 = 0; idx6 < 50; idx6++) {
      outC->_L24[idx7].OptionalPackets[idx6] = kcg_lit_int64(0);
    }
  }
  outC->t_trainUsed = kcg_lit_int64(0);
  for (idx9 = 0; idx9 < 5; idx9++) {
    outC->outMessageBus[idx9].Message.valid = kcg_true;
    outC->outMessageBus[idx9].Message.nid_message = kcg_lit_int64(0);
    outC->outMessageBus[idx9].Message.l_message = kcg_lit_int64(0);
    outC->outMessageBus[idx9].Message.t_train = kcg_lit_int64(0);
    outC->outMessageBus[idx9].Message.nid_engine = kcg_lit_int64(0);
    outC->outMessageBus[idx9].Message.field1 = kcg_lit_int64(0);
    outC->outMessageBus[idx9].Message.field2 = kcg_lit_int64(0);
    outC->outMessageBus[idx9].Message.field3 = kcg_lit_int64(0);
    for (idx8 = 0; idx8 < 50; idx8++) {
      outC->outMessageBus[idx9].OptionalPackets[idx8] = kcg_lit_int64(0);
    }
  }
