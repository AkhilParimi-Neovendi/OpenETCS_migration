...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P137_StopIfInStaffResponsible_T_Packet_Types_Pkg /* P137_onboard/ */ P137_onboard;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_CAST_Int_to_Q_SRSTOP_TM_conversions /* _L4=(TM_conversions::CAST_Int_to_Q_SRSTOP#1)/ */ Context_CAST_Int_to_Q_SRSTOP_1;
  ...
  Q_DIR /* _L11/ */ _L11;
  P137_StopIfInStaffResponsible_T_Packet_Types_Pkg /* _L10/ */ _L10;
...
extern void C_P137_compr_onboard_init_TM_conversions(
  outC_C_P137_compr_onboard_TM_conversions *outC);
