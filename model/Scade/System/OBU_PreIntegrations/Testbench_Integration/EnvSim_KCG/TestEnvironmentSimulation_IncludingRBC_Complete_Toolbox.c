  ...
  outC_TestEnvironmentSimulation_IncludingRBC_Complete_Toolbox *outC)
{
  ...
  static kcg_float32 _6_noname;
  static CompressedPackets_T_Common_Types_Pkg _7_noname;
  static CompressedBaliseMessage_TM _8_noname;
  static CompressedRadioMessage_TM _9_noname;
  static M_TrainTrack_Message_T_TM_radio_messages _10_noname;
  ...
  /* GUI_currentVelocityInKmH/ */
  if (outC->init) {
    last_GUI_currentVelocityInKmH = GUI_initialVelocity;
  }
  else {
  ...
  outC->_L173 = GUI_traction;
  outC->_L171 = GUI_brake;
  outC->_L170 = GUI_traction;
  outC->_L169 = GUI_targetSpeed;
  ...
  outC->_L49 = GUI_mode;
  outC->_L48 = GUI_level;
  outC->_L51 = GUI_mobileHWStatus;
  outC->_L50 = kcg_lit_int32(0);
  outC->_L52 = GUI_openDesk;
  ...
  outC->_L156 = GUI_initialPosition;
  outC->_L157 = GUI_initialVelocity;
  ...
  kcg_copy_Radio_TrackTrain_Header_T_Radio_Types_Pkg(&_3_noname, &outC->_L135);
