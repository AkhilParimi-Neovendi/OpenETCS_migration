  ...
  outC_Read_P057_TM *outC)
{
  ...
  /* _L166=(TM_conversions::C_P057_compr_onboard#1)/ */
  C_P057_compr_onboard_TM_conversions(
    &outC->_L5,
    &outC->_L30,
    &outC->Context_C_P057_compr_onboard_1);
  kcg_copy_P57_MovementAuthorityRequestParameters_T_Packet_Types_Pkg(
    &outC->_L166,
    &outC->Context_C_P057_compr_onboard_1.P057_onboard);
  kcg_copy_P57_MovementAuthorityRequestParameters_T_Packet_Types_Pkg(
    &outC->P057_OBU_out,
    &outC->_L166);
}
...
void Read_P057_init_TM(outC_Read_P057_TM *outC)
{
  static kcg_size idx;
  ...
  outC->_L166.t_mar = kcg_lit_int64(0);
  outC->_L166.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L166.t_cycrqst = kcg_lit_int64(0);
  ...
  outC->P057_OBU_out.valid = kcg_true;
  outC->P057_OBU_out.q_dir = Q_DIR_Reverse;
  outC->P057_OBU_out.t_mar = kcg_lit_int64(0);
  outC->P057_OBU_out.t_timeoutrqst = kcg_lit_int64(0);
  outC->P057_OBU_out.t_cycrqst = kcg_lit_int64(0);
  outC->received = kcg_true;
  /* _L166=(TM_conversions::C_P057_compr_onboard#1)/ */
  C_P057_compr_onboard_init_TM_conversions(
    &outC->Context_C_P057_compr_onboard_1);
  /* _L5=(TM_lib_internal::RECV_ReadPackets#1)/ */
...
{
  /* _L166=(TM_conversions::C_P057_compr_onboard#1)/ */
  C_P057_compr_onboard_reset_TM_conversions(
    &outC->Context_C_P057_compr_onboard_1);
  /* _L5=(TM_lib_internal::RECV_ReadPackets#1)/ */
