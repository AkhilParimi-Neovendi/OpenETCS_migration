  ...
  outC_Build_RBC_LRBG_371_D_00105_2_M003_AmsterdamUtrechtL2_Sheet07_BijlmerAbcoude_RBC *outC)
{
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L43.packets.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    outC->_L43.packets.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L43.packets.PacketHeaders[idx2].valid = kcg_true;
    outC->_L43.packets.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L43.packets.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L43.packets.PacketData[idx3] = kcg_lit_int32(0);
  }
  ...
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L40.packets.PacketHeaders[idx4].nid_packet = kcg_lit_int32(0);
    outC->_L40.packets.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L40.packets.PacketHeaders[idx4].valid = kcg_true;
    outC->_L40.packets.PacketHeaders[idx4].startAddress = kcg_lit_int32(0);
    outC->_L40.packets.PacketHeaders[idx4].endAddress = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L40.packets.PacketData[idx5] = kcg_lit_int32(0);
  }
  ...
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L39.packets.PacketHeaders[idx6].nid_packet = kcg_lit_int32(0);
    outC->_L39.packets.PacketHeaders[idx6].q_dir = Q_DIR_Reverse;
    outC->_L39.packets.PacketHeaders[idx6].valid = kcg_true;
    outC->_L39.packets.PacketHeaders[idx6].startAddress = kcg_lit_int32(0);
    outC->_L39.packets.PacketHeaders[idx6].endAddress = kcg_lit_int32(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->_L39.packets.PacketData[idx7] = kcg_lit_int32(0);
  }
  outC->_L39.trigger = kcg_lit_int32(0);
  outC->_L39.message_sent = kcg_true;
  for (idx8 = 0; idx8 < 30; idx8++) {
    outC->_L38.PacketHeaders[idx8].nid_packet = kcg_lit_int32(0);
    outC->_L38.PacketHeaders[idx8].q_dir = Q_DIR_Reverse;
    outC->_L38.PacketHeaders[idx8].valid = kcg_true;
    outC->_L38.PacketHeaders[idx8].startAddress = kcg_lit_int32(0);
    outC->_L38.PacketHeaders[idx8].endAddress = kcg_lit_int32(0);
  }
  for (idx9 = 0; idx9 < 500; idx9++) {
    outC->_L38.PacketData[idx9] = kcg_lit_int32(0);
  }
