...
void Balise_400_1_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_Balises(
  ...
  /* PIG_nom/ */
  kcg_int32 PIG_nom,
  outC_Balise_400_1_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_Balises::Packets_BG400#1)/ */
    Packets_BG400_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG400_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG400_1.Balise_data_out);
...
void Balise_400_1_init_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_Balises(
  outC_Balise_400_1_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_Balises *outC)
{
  static kcg_size idx;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_Balises::Packets_BG400#1)/ */
  Packets_BG400_init_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_Balises(
    &outC->Context_Packets_BG400_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_400_1_reset_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_Balises(
  outC_Balise_400_1_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_Balises::Packets_BG400#1)/ */
  Packets_BG400_reset_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_Balises(
    &outC->Context_Packets_BG400_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
