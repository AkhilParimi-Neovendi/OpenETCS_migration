  ...
  outC_AggregatePackets_ProvidePositionReport_Pkg *outC)
{
  ...
  outC->_L22.transitionInformation = kcg_lit_int32(0);
  ...
  for (idx3 = 0; idx3 < 1; idx3++) {
    ...
    for (idx2 = 0; idx2 < 15; idx2++) {
      outC->_L7.aNID_RADIO[idx3].telephoneNumber[idx2] = kcg_lit_int32(0);
    }
  }
  ...
  for (idx5 = 0; idx5 < 1; idx5++) {
    ...
    for (idx4 = 0; idx4 < 15; idx4++) {
      outC->_L6.p3.aNID_RADIO[idx5].telephoneNumber[idx4] = kcg_lit_int32(0);
    }
  }
  ...
  for (idx6 = 0; idx6 < 4; idx6++) {
    outC->_L6.p11.tractionIdentity[idx6].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L6.p11.tractionIdentity[idx6].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L6.p11.nIter_ntc = kcg_lit_int32(0);
  for (idx7 = 0; idx7 < 5; idx7++) {
    outC->_L6.p11.nid_ntc[idx7] = kcg_lit_int32(0);
  }
  ...
  outC->_L2.packet1.NID_PACKET = kcg_lit_int32(0);
  outC->_L2.packet1.L_PACKET = kcg_lit_int32(0);
  outC->_L2.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L2.packet1.NID_LRBG = kcg_lit_int32(0);
  outC->_L2.packet1.NID_PRVLRBG = kcg_lit_int32(0);
  outC->_L2.packet1.D_LRBG = kcg_lit_int32(0);
  outC->_L2.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L2.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L2.packet1.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L2.packet1.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L2.packet1.length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L2.packet1.L_TRAININT = kcg_lit_int32(0);
  outC->_L2.packet1.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L2.packet1.NID_NTC = kcg_lit_int32(0);
  ...
  outC->outPackets.p0.packet0.NID_PACKET = kcg_lit_int32(0);
  outC->outPackets.p0.packet0.L_PACKET = kcg_lit_int32(0);
  outC->outPackets.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->outPackets.p0.packet0.NID_LRBG = kcg_lit_int32(0);
  outC->outPackets.p0.packet0.D_LRBG = kcg_lit_int32(0);
  outC->outPackets.p0.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->outPackets.p0.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->outPackets.p0.packet0.L_DOUBTOVER = kcg_lit_int32(0);
  outC->outPackets.p0.packet0.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->outPackets.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->outPackets.p0.packet0.L_TRAININT = kcg_lit_int32(0);
  outC->outPackets.p0.packet0.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->outPackets.p0.packet0.NID_NTC = kcg_lit_int32(0);
  outC->outPackets.p1.valid = kcg_true;
  outC->outPackets.p1.packet1.NID_PACKET = kcg_lit_int32(0);
  outC->outPackets.p1.packet1.L_PACKET = kcg_lit_int32(0);
  outC->outPackets.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->outPackets.p1.packet1.NID_LRBG = kcg_lit_int32(0);
  outC->outPackets.p1.packet1.NID_PRVLRBG = kcg_lit_int32(0);
  outC->outPackets.p1.packet1.D_LRBG = kcg_lit_int32(0);
  outC->outPackets.p1.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->outPackets.p1.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->outPackets.p1.packet1.L_DOUBTOVER = kcg_lit_int32(0);
  outC->outPackets.p1.packet1.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->outPackets.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->outPackets.p1.packet1.L_TRAININT = kcg_lit_int32(0);
  outC->outPackets.p1.packet1.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->outPackets.p1.packet1.NID_NTC = kcg_lit_int32(0);
  outC->outPackets.p3.valid = kcg_true;
  outC->outPackets.p3.number = kcg_lit_int32(0);
  for (idx9 = 0; idx9 < 1; idx9++) {
    outC->outPackets.p3.aNID_RADIO[idx9].valid = kcg_true;
    for (idx8 = 0; idx8 < 15; idx8++) {
      outC->outPackets.p3.aNID_RADIO[idx9].telephoneNumber[idx8] = kcg_lit_int32(0);
    }
  }
  ...
  outC->outPackets.p5.TrainRunningNumber = kcg_lit_int32(0);
  outC->outPackets.p9.valid = kcg_true;
  outC->outPackets.p9.transitionInformation = kcg_lit_int32(0);
  ...
  outC->outPackets.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->outPackets.p11.l_train = kcg_lit_int32(0);
  outC->outPackets.p11.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->outPackets.p11.n_axle = kcg_lit_int32(0);
  outC->outPackets.p11.nIter_tractionIdentity = kcg_lit_int32(0);
  for (idx10 = 0; idx10 < 4; idx10++) {
    outC->outPackets.p11.tractionIdentity[idx10].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->outPackets.p11.tractionIdentity[idx10].nid_ctraction = kcg_lit_int32(0);
  }
  outC->outPackets.p11.nIter_ntc = kcg_lit_int32(0);
  for (idx11 = 0; idx11 < 5; idx11++) {
    outC->outPackets.p11.nid_ntc[idx11] = kcg_lit_int32(0);
  }
}
