  ...
  outC_GP_Convert_P21_to_DistanceProfile_loop_TA_Gradient_new *outC)
{
  ...
  Normalize_Distance_d_internal_t_TA_Lib_internal(
    outC->_L139,
    outC->_L138,
    &outC->Context_Normalize_Distance_d_internal_t_3);
  outC->_L135 = outC->Context_Normalize_Distance_d_internal_t_3.d_internal;
...
void GP_Convert_P21_to_DistanceProfile_loop_init_TA_Gradient_new(
  outC_GP_Convert_P21_to_DistanceProfile_loop_TA_Gradient_new *outC)
{
  static kcg_size idx;
  ...
  outC->_L143.Loc_Absolute = kcg_lit_int64(0);
  outC->_L143.Loc_LRBG = kcg_lit_int64(0);
  outC->_L143.Gradient = kcg_lit_int64(0);
  outC->_L143.L_Gradient = kcg_lit_int64(0);
  for (idx = 0; idx < 50; idx++) {
    outC->_L142[idx].valid = kcg_true;
    outC->_L142[idx].Loc_Absolute = kcg_lit_int64(0);
    outC->_L142[idx].Loc_LRBG = kcg_lit_int64(0);
    outC->_L142[idx].Gradient = kcg_lit_int64(0);
    outC->_L142[idx].L_Gradient = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 33; idx1++) {
    outC->_L121[idx1].valid = kcg_true;
    outC->_L121[idx1].d_gradient = kcg_lit_int64(0);
    outC->_L121[idx1].q_gdir = Q_GDIR_downhill;
    outC->_L121[idx1].g_a = kcg_lit_int64(0);
  }
  outC->_L122 = kcg_lit_int64(0);
  outC->_L123.valid = kcg_true;
  outC->_L123.d_gradient = kcg_lit_int64(0);
  outC->_L123.q_gdir = Q_GDIR_downhill;
  outC->_L123.g_a = kcg_lit_int64(0);
  outC->_L124 = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 50; idx2++) {
    outC->_L125[idx2].valid = kcg_true;
    outC->_L125[idx2].Loc_Absolute = kcg_lit_int64(0);
    outC->_L125[idx2].Loc_LRBG = kcg_lit_int64(0);
    outC->_L125[idx2].Gradient = kcg_lit_int64(0);
    outC->_L125[idx2].L_Gradient = kcg_lit_int64(0);
  }
  outC->_L126 = kcg_lit_int64(0);
  outC->_L127 = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 33; idx3++) {
    outC->_L128[idx3].valid = kcg_true;
    outC->_L128[idx3].d_gradient = kcg_lit_int64(0);
    outC->_L128[idx3].q_gdir = Q_GDIR_downhill;
    outC->_L128[idx3].g_a = kcg_lit_int64(0);
  }
  ...
  for (idx4 = 0; idx4 < 50; idx4++) {
    ...
    outC->_L133[idx4].Loc_Absolute = kcg_lit_int64(0);
    outC->_L133[idx4].Loc_LRBG = kcg_lit_int64(0);
    outC->_L133[idx4].Gradient = kcg_lit_int64(0);
    outC->_L133[idx4].L_Gradient = kcg_lit_int64(0);
  }
  outC->_L134 = kcg_lit_int64(0);
  outC->_L135 = kcg_lit_int64(0);
  outC->_L136.valid = kcg_true;
  outC->_L136.Loc_Absolute = kcg_lit_int64(0);
  outC->_L136.Loc_LRBG = kcg_lit_int64(0);
  outC->_L136.Gradient = kcg_lit_int64(0);
  outC->_L136.L_Gradient = kcg_lit_int64(0);
  outC->_L137 = kcg_lit_int64(0);
  outC->_L138 = kcg_lit_int64(0);
  outC->_L139 = Q_SCALE_10_cm_scale;
  outC->_L140.valid = kcg_true;
  outC->_L140.d_gradient = kcg_lit_int64(0);
  outC->_L140.q_gdir = Q_GDIR_downhill;
  outC->_L140.g_a = kcg_lit_int64(0);
  outC->_L141 = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 50; idx5++) {
    outC->GradientProfile[idx5].valid = kcg_true;
    outC->GradientProfile[idx5].Loc_Absolute = kcg_lit_int64(0);
    outC->GradientProfile[idx5].Loc_LRBG = kcg_lit_int64(0);
    outC->GradientProfile[idx5].Gradient = kcg_lit_int64(0);
    outC->GradientProfile[idx5].L_Gradient = kcg_lit_int64(0);
  }
  /* _L122=(TA_Lib_internal::Normalize_Distance_d_internal_t#4)/ */
...
void GP_Convert_P21_to_DistanceProfile_loop_reset_TA_Gradient_new(
  outC_GP_Convert_P21_to_DistanceProfile_loop_TA_Gradient_new *outC)
{
  /* _L122=(TA_Lib_internal::Normalize_Distance_d_internal_t#4)/ */
