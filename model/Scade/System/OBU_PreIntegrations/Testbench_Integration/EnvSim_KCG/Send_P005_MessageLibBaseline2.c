  ...
  outC_Send_P005_MessageLibBaseline2 *outC)
{
  ...
  if (outC->every) {
    /* _L6=(TM_trackside::Write_P005#1)/ */
    Write_P005_TM_trackside(
      &outC->_L4,
      &outC->_L3,
      &outC->Context_Write_P005_1);
    _1_op_call = outC->Context_Write_P005_1.Error;
...
void Send_P005_init_MessageLibBaseline2(
  outC_Send_P005_MessageLibBaseline2 *outC)
{
  static kcg_size idx;
  ...
  outC->_L4.Q_NEWCOUNTRY = kcg_lit_int64(0);
  outC->_L4.NID_C = kcg_lit_int64(0);
  outC->_L4.NID_BG = kcg_lit_int64(0);
  outC->_L4.Q_LINKORIENTATION = kcg_lit_int64(0);
  outC->_L4.Q_LINKREACTION = kcg_lit_int64(0);
  outC->_L4.Q_LOCACC = kcg_lit_int64(0);
  outC->_L4.N_ITER = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L4.SECTIONS[idx2].D_LINK = kcg_lit_int64(0);
    outC->_L4.SECTIONS[idx2].Q_NEWCOUNTRY = kcg_lit_int64(0);
    outC->_L4.SECTIONS[idx2].NID_C = kcg_lit_int64(0);
    outC->_L4.SECTIONS[idx2].NID_BG = kcg_lit_int64(0);
    outC->_L4.SECTIONS[idx2].Q_LINKORIENTATION = kcg_lit_int64(0);
    outC->_L4.SECTIONS[idx2].Q_LINKREACTION = kcg_lit_int64(0);
    outC->_L4.SECTIONS[idx2].Q_LOCACC = kcg_lit_int64(0);
  }
