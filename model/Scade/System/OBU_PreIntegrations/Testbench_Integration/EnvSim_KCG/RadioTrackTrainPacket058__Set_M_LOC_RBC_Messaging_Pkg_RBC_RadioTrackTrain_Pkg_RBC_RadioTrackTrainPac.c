...
void RadioTrackTrainPacket058__Set_M_LOC_init_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTra(
  outC_RadioTrackTrainPacket058__Set_M_LOC_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTra *outC)
{
  static kcg_size idx;
...
void RadioTrackTrainPacket058__Set_M_LOC_reset_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTr(
  outC_RadioTrackTrainPacket058__Set_M_LOC_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTra *outC)
{
  /* _L4=(TM_conversions::CAST_M_LOC_to_int#1)/ */
