  ...
  outC_PHYSICS_MovementSimulation_Toolbox_Physics *outC)
{
  ...
  /* SM1: */
  static SSM_TR_SM1 _14_SM1_fired_partial;
  /* SM1: */
  ...
  /* SM1: */
  static SSM_ST_SM1 _15_SM1_state_act_partial;
  /* SM1: */
  static kcg_bool _16_SM1_reset_act_partial;
  /* SM1: */
  static SSM_TR_SM1 _17_SM1_fired_strong_partial;
  /* SM1:Driving:<1> */
  ...
  switch (outC->SM1_state_sel) {
    case SSM_st_Driving_SM1 :
      if (tr_1_guard_Driving_SM1) {
        ...
        _17_SM1_fired_strong_partial = _154_SSM_TR_no_trans_SM1;
      }
    ...
    case SSM_st_Reset_SM1 :
      if (tr_1_guard_Reset_SM1) {
        ...
        SM1_fired_strong_partial = _154_SSM_TR_no_trans_SM1;
      }
