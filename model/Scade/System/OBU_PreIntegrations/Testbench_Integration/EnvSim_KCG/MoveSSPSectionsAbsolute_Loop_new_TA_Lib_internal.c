  ...
  outC_MoveSSPSectionsAbsolute_Loop_new_TA_Lib_internal *outC)
{
  ...
  outC->_L256.d_static_abs = kcg_lit_int64(0);
  outC->_L256.d_static_LRBG = kcg_lit_int64(0);
  outC->_L256.q_train_length_corr = kcg_true;
  outC->_L256.v_static = kcg_lit_int64(0);
  outC->_L255 = kcg_lit_int64(0);
  ...
  outC->_L6.d_static_abs = kcg_lit_int64(0);
  outC->_L6.d_static_LRBG = kcg_lit_int64(0);
  outC->_L6.q_train_length_corr = kcg_true;
  outC->_L6.v_static = kcg_lit_int64(0);
  ...
  for (idx2 = 0; idx2 < 50; idx2++) {
    ...
    outC->ProfileOut[idx2].d_static_abs = kcg_lit_int64(0);
    outC->ProfileOut[idx2].d_static_LRBG = kcg_lit_int64(0);
    outC->ProfileOut[idx2].q_train_length_corr = kcg_true;
    outC->ProfileOut[idx2].v_static = kcg_lit_int64(0);
  }
}
