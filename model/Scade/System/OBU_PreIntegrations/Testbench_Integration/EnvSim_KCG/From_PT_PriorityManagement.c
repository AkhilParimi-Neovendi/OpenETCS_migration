...
{
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _1_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _2_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _3_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _4_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _5_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _6_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _7_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _8_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _9_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _10_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _11_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _12_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _13_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _14_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _15_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _16_FromPT_To_NewMode_partial;
  /* FromPT_To_NewMode/ */
  static T_Mode_Level_And_Mode_Types_Pkg _17_FromPT_To_NewMode_partial;
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              outC->_L1_then_else_else_else_else_else_IfBlock1 = OS_Level_And_Mode_Types_Pkg;
              ...
              if (outC->else_clock_else_else_else_else_else_IfBlock1) {
                ...
                outC->else_clock_else_else_else_else_else_else_IfBlock1 = Condition31;
