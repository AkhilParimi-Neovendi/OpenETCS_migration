  ...
  outC_MergAllPackets_CheckBGConsistency_Pkg_SubFunction_MergFunction *outC)
{
  ...
  outC->IfBlock1_clock = (outC->diff == kcg_lit_int64(-1)) & outC->nominal &
    outC->go_on;
  ...
  if (outC->IfBlock1_clock) {
    ...
    outC->else_clock_IfBlock1 = (outC->diff == kcg_lit_int64(1)) &
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      if (outC->else_clock_else_IfBlock1) {
        kcg_copy_CompressedPacketData_T_Common_Types_Pkg(
          ...
          &outC->packetlist);
        outC->_L14_then_else_else_IfBlock1 = kcg_lit_int64(1);
  ...
  outC_MergAllPackets_CheckBGConsistency_Pkg_SubFunction_MergFunction *outC)
{
  ...
  outC->_L73.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L73.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L73.telegramheader.nid_bg = kcg_lit_int64(0);
  outC->_L73.telegramheader.q_link = Q_LINK_Unlinked;
  for (idx = 0; idx < 30; idx++) {
    outC->_L73.packets.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L73.packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L73.packets.PacketHeaders[idx].valid = kcg_true;
    outC->_L73.packets.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L73.packets.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L73.packets.PacketData[idx1] = kcg_lit_int64(0);
  }
  for (idx2 = 0; idx2 < 500; idx2++) {
    outC->_L69[idx2] = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 30; idx3++) {
    outC->_L70.PacketHeaders[idx3].nid_packet = kcg_lit_int64(0);
    outC->_L70.PacketHeaders[idx3].q_dir = Q_DIR_Reverse;
    outC->_L70.PacketHeaders[idx3].valid = kcg_true;
    outC->_L70.PacketHeaders[idx3].startAddress = kcg_lit_int64(0);
    outC->_L70.PacketHeaders[idx3].endAddress = kcg_lit_int64(0);
  }
  for (idx4 = 0; idx4 < 500; idx4++) {
    outC->_L70.PacketData[idx4] = kcg_lit_int64(0);
  }
  ...
  outC->_L71.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L71.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L71.telegramheader.nid_bg = kcg_lit_int64(0);
  outC->_L71.telegramheader.q_link = Q_LINK_Unlinked;
  for (idx5 = 0; idx5 < 30; idx5++) {
    outC->_L71.packets.PacketHeaders[idx5].nid_packet = kcg_lit_int64(0);
    outC->_L71.packets.PacketHeaders[idx5].q_dir = Q_DIR_Reverse;
    outC->_L71.packets.PacketHeaders[idx5].valid = kcg_true;
    outC->_L71.packets.PacketHeaders[idx5].startAddress = kcg_lit_int64(0);
    outC->_L71.packets.PacketHeaders[idx5].endAddress = kcg_lit_int64(0);
  }
  for (idx6 = 0; idx6 < 500; idx6++) {
    outC->_L71.packets.PacketData[idx6] = kcg_lit_int64(0);
  }
  for (idx7 = 0; idx7 < 30; idx7++) {
    outC->_L72[idx7].nid_packet = kcg_lit_int64(0);
    outC->_L72[idx7].q_dir = Q_DIR_Reverse;
    outC->_L72[idx7].valid = kcg_true;
    outC->_L72[idx7].startAddress = kcg_lit_int64(0);
    outC->_L72[idx7].endAddress = kcg_lit_int64(0);
  }
  ...
  outC->_L60.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L60.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L60.telegramheader.nid_bg = kcg_lit_int64(0);
  outC->_L60.telegramheader.q_link = Q_LINK_Unlinked;
  for (idx8 = 0; idx8 < 30; idx8++) {
    outC->_L60.packets.PacketHeaders[idx8].nid_packet = kcg_lit_int64(0);
    outC->_L60.packets.PacketHeaders[idx8].q_dir = Q_DIR_Reverse;
    outC->_L60.packets.PacketHeaders[idx8].valid = kcg_true;
    outC->_L60.packets.PacketHeaders[idx8].startAddress = kcg_lit_int64(0);
    outC->_L60.packets.PacketHeaders[idx8].endAddress = kcg_lit_int64(0);
  }
  for (idx9 = 0; idx9 < 500; idx9++) {
    outC->_L60.packets.PacketData[idx9] = kcg_lit_int64(0);
  }
  ...
  outC->_L62.m_mcount = kcg_lit_int64(0);
  ...
  outC->_L63.m_mcount = kcg_lit_int64(0);
  ...
  outC->_L68.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L68.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L68.telegramheader.nid_bg = kcg_lit_int64(0);
  outC->_L68.telegramheader.q_link = Q_LINK_Unlinked;
  for (idx10 = 0; idx10 < 30; idx10++) {
    outC->_L68.packets.PacketHeaders[idx10].nid_packet = kcg_lit_int64(0);
    outC->_L68.packets.PacketHeaders[idx10].q_dir = Q_DIR_Reverse;
    outC->_L68.packets.PacketHeaders[idx10].valid = kcg_true;
    outC->_L68.packets.PacketHeaders[idx10].startAddress = kcg_lit_int64(0);
    outC->_L68.packets.PacketHeaders[idx10].endAddress = kcg_lit_int64(0);
  }
  for (idx11 = 0; idx11 < 500; idx11++) {
    outC->_L68.packets.PacketData[idx11] = kcg_lit_int64(0);
  }
  ...
  for (idx12 = 0; idx12 < 500; idx12++) {
    outC->packetlist[idx12] = kcg_lit_int64(0);
  }
  for (idx13 = 0; idx13 < 30; idx13++) {
    outC->metadata[idx13].nid_packet = kcg_lit_int64(0);
    outC->metadata[idx13].q_dir = Q_DIR_Reverse;
    outC->metadata[idx13].valid = kcg_true;
    outC->metadata[idx13].startAddress = kcg_lit_int64(0);
    outC->metadata[idx13].endAddress = kcg_lit_int64(0);
  }
  outC->revers = kcg_true;
  outC->nominal = kcg_true;
  outC->diff = kcg_lit_int64(0);
  outC->mDup2 = M_DUP_No_duplicates;
  outC->mDup1 = M_DUP_No_duplicates;
  outC->IfBlock1_clock = kcg_true;
  for (idx14 = 0; idx14 < 500; idx14++) {
    outC->_L2_then_else_IfBlock1[idx14] = kcg_lit_int64(0);
  }
  ...
  outC->_L3_then_else_IfBlock1.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L3_then_else_IfBlock1.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L3_then_else_IfBlock1.telegramheader.nid_bg = kcg_lit_int64(0);
  ...
  for (idx16 = 0; idx16 < 500; idx16++) {
    outC->_L3_then_else_IfBlock1.packets.PacketData[idx16] = kcg_lit_int64(0);
  }
  ...
  outC->_L4_then_else_IfBlock1.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L4_then_else_IfBlock1.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L4_then_else_IfBlock1.telegramheader.nid_bg = kcg_lit_int64(0);
  ...
  for (idx18 = 0; idx18 < 500; idx18++) {
    outC->_L4_then_else_IfBlock1.packets.PacketData[idx18] = kcg_lit_int64(0);
  }
  ...
  outC->_L5_then_else_IfBlock1.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L5_then_else_IfBlock1.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L5_then_else_IfBlock1.telegramheader.nid_bg = kcg_lit_int64(0);
  ...
  for (idx20 = 0; idx20 < 500; idx20++) {
    outC->_L5_then_else_IfBlock1.packets.PacketData[idx20] = kcg_lit_int64(0);
  }
  ...
  outC->_L1_else_else_else_IfBlock1.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L1_else_else_else_IfBlock1.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L1_else_else_else_IfBlock1.telegramheader.nid_bg = kcg_lit_int64(0);
  ...
  for (idx22 = 0; idx22 < 500; idx22++) {
    outC->_L1_else_else_else_IfBlock1.packets.PacketData[idx22] = kcg_lit_int64(0);
  }
  for (idx23 = 0; idx23 < 30; idx23++) {
    outC->_L2_then_else_else_IfBlock1[idx23].nid_packet = kcg_lit_int64(0);
    outC->_L2_then_else_else_IfBlock1[idx23].q_dir = Q_DIR_Reverse;
    outC->_L2_then_else_else_IfBlock1[idx23].valid = kcg_true;
    outC->_L2_then_else_else_IfBlock1[idx23].startAddress = kcg_lit_int64(0);
    outC->_L2_then_else_else_IfBlock1[idx23].endAddress = kcg_lit_int64(0);
  }
  for (idx24 = 0; idx24 < 500; idx24++) {
    outC->_L3_then_else_else_IfBlock1[idx24] = kcg_lit_int64(0);
  }
  ...
  outC->_L4_then_else_else_IfBlock1.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L4_then_else_else_IfBlock1.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L4_then_else_else_IfBlock1.telegramheader.nid_bg = kcg_lit_int64(0);
  ...
  for (idx26 = 0; idx26 < 500; idx26++) {
    outC->_L4_then_else_else_IfBlock1.packets.PacketData[idx26] = kcg_lit_int64(0);
  }
  for (idx27 = 0; idx27 < 30; idx27++) {
    outC->_L8_then_else_else_IfBlock1[idx27].nid_packet = kcg_lit_int64(0);
    outC->_L8_then_else_else_IfBlock1[idx27].q_dir = Q_DIR_Reverse;
    outC->_L8_then_else_else_IfBlock1[idx27].valid = kcg_true;
    outC->_L8_then_else_else_IfBlock1[idx27].startAddress = kcg_lit_int64(0);
    outC->_L8_then_else_else_IfBlock1[idx27].endAddress = kcg_lit_int64(0);
  }
  for (idx28 = 0; idx28 < 500; idx28++) {
    outC->_L9_then_else_else_IfBlock1[idx28] = kcg_lit_int64(0);
  }
  for (idx29 = 0; idx29 < 30; idx29++) {
    outC->_L10_then_else_else_IfBlock1[idx29].nid_packet = kcg_lit_int64(0);
    outC->_L10_then_else_else_IfBlock1[idx29].q_dir = Q_DIR_Reverse;
    outC->_L10_then_else_else_IfBlock1[idx29].valid = kcg_true;
    outC->_L10_then_else_else_IfBlock1[idx29].startAddress = kcg_lit_int64(0);
    outC->_L10_then_else_else_IfBlock1[idx29].endAddress = kcg_lit_int64(0);
  }
  outC->_L12_then_else_else_IfBlock1 = kcg_lit_int64(0);
  outC->_L11_then_else_else_IfBlock1 = kcg_lit_int64(0);
  outC->_L13_then_else_else_IfBlock1 = kcg_lit_int64(0);
  ...
  outC->_L15_then_else_else_IfBlock1.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L15_then_else_else_IfBlock1.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L15_then_else_else_IfBlock1.telegramheader.nid_bg = kcg_lit_int64(0);
  ...
  for (idx31 = 0; idx31 < 500; idx31++) {
    outC->_L15_then_else_else_IfBlock1.packets.PacketData[idx31] = kcg_lit_int64(0);
  }
  for (idx32 = 0; idx32 < 500; idx32++) {
    outC->_L16_then_else_else_IfBlock1[idx32] = kcg_lit_int64(0);
  }
  for (idx33 = 0; idx33 < 500; idx33++) {
    outC->_L17_then_else_else_IfBlock1[idx33] = kcg_lit_int64(0);
  }
  ...
  outC->_L18_then_else_else_IfBlock1.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L18_then_else_else_IfBlock1.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L18_then_else_else_IfBlock1.telegramheader.nid_bg = kcg_lit_int64(0);
  ...
  for (idx35 = 0; idx35 < 500; idx35++) {
    outC->_L18_then_else_else_IfBlock1.packets.PacketData[idx35] = kcg_lit_int64(0);
  }
  ...
  outC->_L19_then_else_else_IfBlock1.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L19_then_else_else_IfBlock1.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L19_then_else_else_IfBlock1.telegramheader.nid_bg = kcg_lit_int64(0);
  ...
  for (idx37 = 0; idx37 < 500; idx37++) {
    outC->_L19_then_else_else_IfBlock1.packets.PacketData[idx37] = kcg_lit_int64(0);
  }
  ...
  outC->_L20_then_else_else_IfBlock1.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L20_then_else_else_IfBlock1.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L20_then_else_else_IfBlock1.telegramheader.nid_bg = kcg_lit_int64(0);
  ...
  for (idx39 = 0; idx39 < 500; idx39++) {
    outC->_L20_then_else_else_IfBlock1.packets.PacketData[idx39] = kcg_lit_int64(0);
  }
  ...
  for (idx41 = 0; idx41 < 500; idx41++) {
    outC->_L1_then_IfBlock1.packets.PacketData[idx41] = kcg_lit_int64(0);
  }
  ...
  outC->_L2_then_IfBlock1.telegramheader.m_mcount = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.telegramheader.nid_c = kcg_lit_int64(0);
  outC->_L2_then_IfBlock1.telegramheader.nid_bg = kcg_lit_int64(0);
  ...
  for (idx43 = 0; idx43 < 500; idx43++) {
    outC->_L2_then_IfBlock1.packets.PacketData[idx43] = kcg_lit_int64(0);
  }
  ...
  for (idx45 = 0; idx45 < 500; idx45++) {
    outC->_L3_then_IfBlock1.packets.PacketData[idx45] = kcg_lit_int64(0);
  }
  for (idx46 = 0; idx46 < 500; idx46++) {
    outC->_L4_then_IfBlock1[idx46] = kcg_lit_int64(0);
  }
  ...
  for (idx47 = 0; idx47 < 30; idx47++) {
    outC->telegram_out.packets.PacketHeaders[idx47].nid_packet = kcg_lit_int64(0);
    ...
    outC->telegram_out.packets.PacketHeaders[idx47].startAddress = kcg_lit_int64(0);
    outC->telegram_out.packets.PacketHeaders[idx47].endAddress = kcg_lit_int64(0);
  }
  for (idx48 = 0; idx48 < 500; idx48++) {
    outC->telegram_out.packets.PacketData[idx48] = kcg_lit_int64(0);
  }
  outC->go_on = kcg_true;
  /* IfBlock1:else:else:then:_L2=(CheckBGConsistency_Pkg::SubFunction::MergFunction::Merg2MetaDataIteration#1)/ */
