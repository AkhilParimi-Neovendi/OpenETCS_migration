  ...
  outC_C_header_to_M034_TM_RBC_conversions *outC)
{
  ...
  outC->_L26.d_tafdisplay = kcg_lit_int32(0);
  outC->_L26.l_tafdisplay = kcg_lit_int32(0);
  outC->_L2 = kcg_true;
  ...
  outC->message_out.d_tafdisplay = kcg_lit_int32(0);
  outC->message_out.l_tafdisplay = kcg_lit_int32(0);
  /* _L27=(TM_conversions::CAST_Int_to_M_ACK#1)/ */
