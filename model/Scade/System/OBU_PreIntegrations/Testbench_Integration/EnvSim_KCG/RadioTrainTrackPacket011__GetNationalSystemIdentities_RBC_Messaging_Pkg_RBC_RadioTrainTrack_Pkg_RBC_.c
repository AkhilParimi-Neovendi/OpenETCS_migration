...
void RadioTrainTrackPacket011__GetNationalSystemIdentities_init_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
  outC_RadioTrainTrackPacket011__GetNationalSystemIdentities_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
  static kcg_size idx;
...
void RadioTrainTrackPacket011__GetNationalSystemIdentities_reset_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pk(
  outC_RadioTrainTrackPacket011__GetNationalSystemIdentities_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
}
