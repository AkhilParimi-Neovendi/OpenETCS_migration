...
void Read_P058_init_TM(outC_Read_P058_TM *outC)
{
  ...
  outC->_L166.t_cycloc = kcg_lit_int64(0);
  outC->_L166.d_cycloc = kcg_lit_int64(0);
  outC->_L166.m_loc = M_LOC_Now;
  outC->_L166.n_iter = kcg_lit_int64(0);
  for (idx = 0; idx < 32; idx++) {
    outC->_L166.sections[idx].valid = kcg_true;
    outC->_L166.sections[idx].d_loc = kcg_lit_int64(0);
  ...
  outC->P058_OBU_out.t_cycloc = kcg_lit_int64(0);
  outC->P058_OBU_out.d_cycloc = kcg_lit_int64(0);
  outC->P058_OBU_out.m_loc = M_LOC_Now;
  outC->P058_OBU_out.n_iter = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->P058_OBU_out.sections[idx4].valid = kcg_true;
    outC->P058_OBU_out.sections[idx4].d_loc = kcg_lit_int64(0);
