...
void RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
  ...
  outC_RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets_RBC_Messaging_Pkg_RBC_Consistenc *outC)
{
  /* outIsConsistent/ */
...
void RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets_init_RBC_Messaging_Pkg_RBC_Consistenc(
  outC_RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets_RBC_Messaging_Pkg_RBC_Consistenc *outC)
{
  static kcg_size idx;
  ...
  outC->_L3_then_else_else_else_else_else_IfBlock1.p3.number = kcg_lit_int32(0);
  ...
  outC->_L3_then_else_else_else_else_else_IfBlock1.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L3_then_else_else_else_else_else_IfBlock1.p11.l_train = kcg_lit_int32(0);
  ...
  outC->_L3_then_else_else_else_else_else_IfBlock1.p11.n_axle = kcg_lit_int32(0);
...
void RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets_reset_RBC_Messaging_Pkg_RBC_Consisten(
  outC_RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets_RBC_Messaging_Pkg_RBC_Consistenc *outC)
{
  /* IfBlock1:then:_L1=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg129ConsistencyChecker__HasConsistentPackets#1)/ */
