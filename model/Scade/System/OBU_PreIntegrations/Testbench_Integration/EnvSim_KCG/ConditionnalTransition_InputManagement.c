  ...
  outC_ConditionnalTransition_InputManagement *outC)
{
  ...
  outC->_L10.transition.position = kcg_lit_int32(0);
  outC->_L10.transition.transitionType =
    M_TransitionType_Conditional_Level_And_Mode_Types_Pkg;
  outC->_L10.transition.immediateAck = kcg_true;
  outC->_L10.transition.AckLength = kcg_lit_int32(0);
  outC->_L10.LRBG = kcg_lit_int32(0);
  outC->_L10.referenceLocation = kcg_lit_int32(0);
  ...
  outC->One_Transition.transition.position = kcg_lit_int32(0);
  outC->One_Transition.transition.transitionType =
    M_TransitionType_Conditional_Level_And_Mode_Types_Pkg;
  outC->One_Transition.transition.immediateAck = kcg_true;
  outC->One_Transition.transition.AckLength = kcg_lit_int32(0);
  outC->One_Transition.LRBG = kcg_lit_int32(0);
  outC->One_Transition.referenceLocation = kcg_lit_int32(0);
  /* _L16=(InputManagement::LevelTR2Level#2)/ */
