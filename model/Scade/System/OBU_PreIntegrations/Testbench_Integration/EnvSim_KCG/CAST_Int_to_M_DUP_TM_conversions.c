...
{
  /* m_dup/ */
  static M_DUP m_dup_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* m_dup/ */
  static M_DUP _1_m_dup_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* m_dup/ */
  static M_DUP _3_m_dup_partial;
  /* error/ */
  static kcg_bool _4_error_partial;
  /* m_dup/ */
  static M_DUP _5_m_dup_partial;
  /* error/ */
  static kcg_bool _6_error_partial;
  /* error/ */
  static kcg_bool _7_error_partial;
  /* m_dup/ */
  static M_DUP _8_m_dup_partial;
  /* error/ */
  static kcg_bool _9_error_partial;
  /* m_dup/ */
  static M_DUP _10_m_dup_partial;
