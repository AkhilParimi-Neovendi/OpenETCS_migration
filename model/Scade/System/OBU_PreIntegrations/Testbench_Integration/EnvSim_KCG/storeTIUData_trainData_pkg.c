...
void storeTIUData_init_trainData_pkg(outC_storeTIUData_trainData_pkg *outC)
{
  ...
  outC->_L6.timeStampValidateToRBC = kcg_lit_int64(0);
  outC->_L5 = kcg_true;
  ...
  outC->_L4.timeStampValidateToRBC = kcg_lit_int64(0);
  ...
  outC->_L3.timeStampValidateToRBC = kcg_lit_int64(0);
  ...
  for (idx = 0; idx < 5; idx++) {
    outC->_L2.nationSystems[idx] = kcg_lit_int64(0);
  }
  outC->_L2.numberTractionSystems = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 4; idx1++) {
    outC->_L2.tractionSystem[idx1].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L2.tractionSystem[idx1].nid_ctraction = kcg_lit_int64(0);
  }
  ...
  for (idx4 = 0; idx4 < 5; idx4++) {
    outC->actualTrainData.nationSystems[idx4] = kcg_lit_int64(0);
  }
  ...
  for (idx5 = 0; idx5 < 4; idx5++) {
    outC->actualTrainData.tractionSystem[idx5].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->actualTrainData.tractionSystem[idx5].nid_ctraction = kcg_lit_int64(0);
  }
}
