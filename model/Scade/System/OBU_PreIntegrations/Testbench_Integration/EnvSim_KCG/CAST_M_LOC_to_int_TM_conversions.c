...
{
  /* m_loc_int/ */
  static kcg_int64 m_loc_int_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* m_loc_int/ */
  static kcg_int64 _1_m_loc_int_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* m_loc_int/ */
  static kcg_int64 _3_m_loc_int_partial;
  /* error/ */
  static kcg_bool _4_error_partial;
  /* m_loc_int/ */
  static kcg_int64 _5_m_loc_int_partial;
  /* error/ */
  static kcg_bool _6_error_partial;
  /* error/ */
  static kcg_bool _7_error_partial;
  /* m_loc_int/ */
  static kcg_int64 _8_m_loc_int_partial;
  /* error/ */
  static kcg_bool _9_error_partial;
  /* m_loc_int/ */
  static kcg_int64 _10_m_loc_int_partial;
  ...
  outC_CAST_M_LOC_to_int_TM_conversions *outC)
{
  ...
  outC->m_loc_int = kcg_lit_int64(0);
}
