...
{
  /* m_loc_int/ */
  static kcg_int32 m_loc_int_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* m_loc_int/ */
  static kcg_int32 _1_m_loc_int_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* m_loc_int/ */
  static kcg_int32 _3_m_loc_int_partial;
  /* error/ */
  static kcg_bool _4_error_partial;
  /* m_loc_int/ */
  static kcg_int32 _5_m_loc_int_partial;
  /* error/ */
  static kcg_bool _6_error_partial;
  /* error/ */
  static kcg_bool _7_error_partial;
  /* m_loc_int/ */
  static kcg_int32 _8_m_loc_int_partial;
  /* error/ */
  static kcg_bool _9_error_partial;
  /* m_loc_int/ */
  static kcg_int32 _10_m_loc_int_partial;
