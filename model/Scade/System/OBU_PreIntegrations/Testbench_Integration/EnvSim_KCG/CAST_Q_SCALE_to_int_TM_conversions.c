...
{
  /* d/ */
  static kcg_int32 d_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* d/ */
  static kcg_int32 _1_d_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* d/ */
  static kcg_int32 _3_d_partial;
  /* error/ */
  static kcg_bool _4_error_partial;
  /* d/ */
  static kcg_int32 _5_d_partial;
  /* error/ */
  static kcg_bool _6_error_partial;
  /* error/ */
  static kcg_bool _7_error_partial;
  /* d/ */
  static kcg_int32 _8_d_partial;
  /* error/ */
  static kcg_bool _9_error_partial;
  /* d/ */
  static kcg_int32 _10_d_partial;
