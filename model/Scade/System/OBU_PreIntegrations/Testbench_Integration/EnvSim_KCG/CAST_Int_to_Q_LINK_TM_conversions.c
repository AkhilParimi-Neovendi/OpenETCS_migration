...
{
  /* q_link/ */
  static Q_LINK q_link_partial;
  /* error/ */
  static kcg_bool error_partial;
  /* q_link/ */
  static Q_LINK _1_q_link_partial;
  /* error/ */
  static kcg_bool _2_error_partial;
  /* error/ */
  static kcg_bool _3_error_partial;
  /* q_link/ */
  static Q_LINK _4_q_link_partial;
  /* error/ */
  static kcg_bool _5_error_partial;
  /* q_link/ */
  static Q_LINK _6_q_link_partial;
  ...
  outC_CAST_Int_to_Q_LINK_TM_conversions *outC)
{
  ...
  outC->_L13 = kcg_true;
  outC->q_link_in = kcg_lit_int64(0);
  outC->error = kcg_true;
