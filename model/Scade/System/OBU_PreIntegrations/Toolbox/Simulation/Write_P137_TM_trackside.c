...
void Write_P137_TM_trackside(
  /* Packet137/ */
  P137_trackside_int_T_TM *Packet137,
  /* Packets/ */
  CompressedPackets_T_Common_Types_Pkg *Packets,
  outC_Write_P137_TM_trackside *outC)
{
  kcg_copy_P137_trackside_int_T_TM(&outC->_L1, Packet137);
  /* _L43=(TM_conversions::C_P137_tracksim_compr#1)/ */
  C_P137_tracksim_compr_TM_conversions(
    &outC->_L1,
    &outC->Context_C_P137_tracksim_compr_1);
  kcg_copy_MetadataElement_T_Common_Types_Pkg(
    &outC->_L43,
    &outC->Context_C_P137_tracksim_compr_1.Header);
  kcg_copy_CompressedPacketData_T_Common_Types_Pkg(
    &outC->_L44,
    &outC->Context_C_P137_tracksim_compr_1.P137_compressed);
...
void Write_P137_init_TM_trackside(outC_Write_P137_TM_trackside *outC)
{
  kcg_size idx;
  kcg_size idx1;
  kcg_size idx2;
  ...
  for (idx9 = 0; idx9 < 30; idx9++) {
    outC->RadioPacketsOut.PacketHeaders[idx9].nid_packet = kcg_lit_int64(0);
    outC->RadioPacketsOut.PacketHeaders[idx9].q_dir = Q_DIR_Reverse;
    outC->RadioPacketsOut.PacketHeaders[idx9].valid = kcg_true;
    outC->RadioPacketsOut.PacketHeaders[idx9].startAddress = kcg_lit_int64(0);
    outC->RadioPacketsOut.PacketHeaders[idx9].endAddress = kcg_lit_int64(0);
  }
  for (idx10 = 0; idx10 < 500; idx10++) {
    outC->RadioPacketsOut.PacketData[idx10] = kcg_lit_int64(0);
  }
  outC->Error = kcg_true;
  /* _L10=(TM_lib_internal::SEND_MessageData#1)/ */
  ...
  SEND_WriteBaliseMessageHeader_init_TM_lib_internal(
    &outC->Context_SEND_WriteBaliseMessageHeader_1);
  /* _L43=(TM_conversions::C_P137_tracksim_compr#1)/ */
  C_P137_tracksim_compr_init_TM_conversions(
    &outC->Context_C_P137_tracksim_compr_1);
}
...
void Write_P137_reset_TM_trackside(outC_Write_P137_TM_trackside *outC)
{
  /* _L10=(TM_lib_internal::SEND_MessageData#1)/ */
  ...
  SEND_WriteBaliseMessageHeader_reset_TM_lib_internal(
    &outC->Context_SEND_WriteBaliseMessageHeader_1);
  /* _L43=(TM_conversions::C_P137_tracksim_compr#1)/ */
  C_P137_tracksim_compr_reset_TM_conversions(
    &outC->Context_C_P137_tracksim_compr_1);
}
