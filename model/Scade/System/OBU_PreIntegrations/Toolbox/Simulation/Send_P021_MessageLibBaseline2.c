  ...
  outC_Send_P021_MessageLibBaseline2 *outC)
{
  ...
  outC->_L4.Q_GDIR = kcg_lit_int64(0);
  outC->_L4.G_A = kcg_lit_int64(0);
  outC->_L4.N_ITER = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L4.SECTIONS[idx2].D_GRADIENT = kcg_lit_int64(0);
    outC->_L4.SECTIONS[idx2].Q_GDIR = kcg_lit_int64(0);
    outC->_L4.SECTIONS[idx2].G_A = kcg_lit_int64(0);
  }
