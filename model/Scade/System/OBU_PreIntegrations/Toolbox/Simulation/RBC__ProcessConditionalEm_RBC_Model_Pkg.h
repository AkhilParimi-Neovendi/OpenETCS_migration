...
*************************************************************$ */
#ifndef _RBC__ProcessConditionalEm_RBC_Model_Pkg_H_
#define _RBC__ProcessConditionalEm_RBC_Model_Pkg_H_

#include "kcg_types.h"
#include "_103_RadioTrainTrackHeade_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg.h"
#include "_102_RadioTrainTrackHeade_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg.h"
...
typedef struct {
  ...
  kcg_bool /* CONDITIONAL_EMERGENCY_STOP_SM: */ _1_CONDITIONAL_EMERGENCY_STOP_SM_reset_nxt;
  ...
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC__101_RadioTrackTrainHeade_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* CONDITIONAL_EMERGENCY_STOP_SM:SEND_CONDITIONAL_EMERGENCY_STOP:_L54=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_NID_EM#1)/ */ Context_RadioTrackTrainHeader__Get_NID_EM_1;
  outC_RadioTrackTrainMessage__G_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* CONDITIONAL_EMERGENCY_STOP_SM:SEND_CONDITIONAL_EMERGENCY_STOP:_L56=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__GetHeader#3)/ */ Context_RadioTrackTrainMessage__GetHeader_3;
  outC__102_RadioTrainTrackHeade_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* CONDITIONAL_EMERGENCY_STOP_SM:TRY_PROCESS_ACKNOWLEDGEMENT:IfBlock1:then:_L16=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__Get_Q_EMERGENCYSTOP#1)/ */ Context_RadioTrainTrackHeader__Get_Q_EMERGENCYSTOP_1;
  outC_RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* CONDITIONAL_EMERGENCY_STOP_SM:TRY_PROCESS_ACKNOWLEDGEMENT:IfBlock1:then:_L17=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__GetHeader#5)/ */ Context_RadioTrainTrackMessage__GetHeader_5;
  outC__50_RadioTrackTrainMessageQue_RBC_Collections_Pkg /* CONDITIONAL_EMERGENCY_STOP_SM:SEND_CONDITIONAL_EMERGENCY_STOP:_L57=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__TryPut#3)/ */ Context_RadioTrackTrainMessageQueue__TryPut_3;
  outC__51_RadioTrackTrainMessageQue_RBC_Collections_Pkg /* CONDITIONAL_EMERGENCY_STOP_SM:SEND_CONDITIONAL_EMERGENCY_STOP:_L59=(RBC_Collections_Pkg::RadioTrackTrainMessageQueueEntry__Create#3)/ */ _2_Context_RadioTrackTrainMessageQueueEntry__Create_3;
  ...
  outC__103_RadioTrainTrackHeade_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* CONDITIONAL_EMERGENCY_STOP_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L27=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__Get_NID_EM#1)/ */ _3_Context_RadioTrainTrackHeader__Get_NID_EM_1;
  outC_RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* CONDITIONAL_EMERGENCY_STOP_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L26=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__GetHeader#3)/ */ _4_Context_RadioTrainTrackMessage__GetHeader_3;
  outC_RadioTrackTrainHeader__Ge_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* _L63=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_NID_MESSAGE#2)/ */ _5_Context_RadioTrackTrainHeader__Get_NID_MESSAGE_2;
  outC_RadioTrackTrainMessage__G_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* _L65=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__GetHeader#4)/ */ _6_Context_RadioTrackTrainMessage__GetHeader_4;
  outC__100_RadioTrainTrackHeade_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* _L67=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__Get_NID_MESSAGE#2)/ */ _7_Context_RadioTrainTrackHeader__Get_NID_MESSAGE_2;
  outC_RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* _L66=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__GetHeader#4)/ */ _8_Context_RadioTrainTrackMessage__GetHeader_4;
  ...
  SSM_ST_CONDITIONAL_EMERGENCY_STOP_SM /* CONDITIONAL_EMERGENCY_STOP_SM: */ _9_CONDITIONAL_EMERGENCY_STOP_SM_state_act;
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  _2_RadioTrackTrainMessageQueue_T /* CONDITIONAL_EMERGENCY_STOP_SM:IDLE:_L5/ */ _L5_IDLE_CONDITIONAL_EMERGENCY_STOP_SM;
  ...
  _2_RadioTrackTrainMessageQueue_T /* CONDITIONAL_EMERGENCY_STOP_SM:SEND_CONDITIONAL_EMERGENCY_STOP:_L70/ */ _L70_SEND_CONDITIONAL_EMERGENCY_STOP_CONDITIONAL_EMERGENCY_STOP_SM;
  ...
  _2_RadioTrackTrainMessageQueue_T /* CONDITIONAL_EMERGENCY_STOP_SM:SEND_CONDITIONAL_EMERGENCY_STOP:_L57/ */ _L57_SEND_CONDITIONAL_EMERGENCY_STOP_CONDITIONAL_EMERGENCY_STOP_SM;
  ...
  _2_RadioTrackTrainMessageQueue_T /* CONDITIONAL_EMERGENCY_STOP_SM:AWAIT_ACKNOWLEDGEMENT:_L5/ */ _L5_AWAIT_ACKNOWLEDGEMENT_CONDITIONAL_EMERGENCY_STOP_SM;
  _2_RadioTrackTrainMessageQueue_T /* CONDITIONAL_EMERGENCY_STOP_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L36/ */ _L36_TRY_PROCESS_ACKNOWLEDGEMENT_CONDITIONAL_EMERGENCY_STOP_SM;
  ...
  SSM_ST_CONDITIONAL_EMERGENCY_STOP_SM /* CONDITIONAL_EMERGENCY_STOP_SM: */ _10_CONDITIONAL_EMERGENCY_STOP_SM_state_sel;
  SSM_TR_CONDITIONAL_EMERGENCY_STOP_SM /* CONDITIONAL_EMERGENCY_STOP_SM: */ CONDITIONAL_EMERGENCY_STOP_SM_fired_strong;
  SSM_TR_CONDITIONAL_EMERGENCY_STOP_SM /* CONDITIONAL_EMERGENCY_STOP_SM: */ _11_CONDITIONAL_EMERGENCY_STOP_SM_fired;
  ...
  _2_RadioTrackTrainMessageQueue_T /* _L78/ */ _L78;
  RBC_Data_T_RBC_DataBus_Pkg /* _L79/ */ _L79;
  SessionManagement_T /* _L80/ */ _L80;
} outC_RBC__ProcessConditionalEm_RBC_Model_Pkg;

/* ===========  node initialization and cycle functions  =========== */
/* RBC_Model_Pkg::RBC__ProcessConditionalEmergencyStop/ */
extern void RBC__ProcessConditionalEm_RBC_Model_Pkg(
  /* inDataBus/ */
...
extern void RBC__ProcessConditionalEm_reset_RBC_Model_Pkg(
  outC_RBC__ProcessConditionalEm_RBC_Model_Pkg *outC);

#ifndef KCG_USER_DEFINED_INIT
extern void RBC__ProcessConditionalEm_init_RBC_Model_Pkg(
  outC_RBC__ProcessConditionalEm_RBC_Model_Pkg *outC);
#endif /* KCG_USER_DEFINED_INIT */



#endif /* _RBC__ProcessConditionalEm_RBC_Model_Pkg_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** RBC__ProcessConditionalEm_RBC_Model_Pkg.h
** Generation date: 2023-09-12T13:45:50
*************************************************************$ */
