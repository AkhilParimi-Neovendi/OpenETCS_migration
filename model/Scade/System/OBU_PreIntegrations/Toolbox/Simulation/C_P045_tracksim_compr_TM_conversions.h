...
typedef struct {
  ...
  CompressedPacketData_T_Common_Types_Pkg /* P045_compressed/ */ P045_compressed;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_T_Build_Metadata_Packet_ID_TM_lib_internal /* _L396=(TM_lib_internal::T_Build_Metadata_Packet_ID#1)/ */ Context_T_Build_Metadata_Packet_ID_1;
  ...
  nid_packet_meta_TM /* _L396/ */ _L396;
...
extern void C_P045_tracksim_compr_TM_conversions(
  /* P045_from_track/ */
  P045_trackside_int_T_TM *P045_from_track,
...
extern void C_P045_tracksim_compr_init_TM_conversions(
  outC_C_P045_tracksim_compr_TM_conversions *outC);
#endif /* KCG_USER_DEFINED_INIT */

/*
  Expanded instances for: TM_conversions::C_P045_tracksim_compr/
