...
void Balise_395_0_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
  ...
  /* PIG_nom/ */
  kcg_int32 PIG_nom,
  outC_Balise_395_0_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet09_AbcoudeBreukelen_Balises::Packets_BG395#1)/ */
    Packets_BG395_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG395_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG395_1.Balise_data_out);
...
void Balise_395_0_init_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
  outC_Balise_395_0_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet09_AbcoudeBreukelen_Balises::Packets_BG395#1)/ */
  Packets_BG395_init_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
    &outC->Context_Packets_BG395_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_395_0_reset_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
  outC_Balise_395_0_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet09_AbcoudeBreukelen_Balises::Packets_BG395#1)/ */
  Packets_BG395_reset_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
    &outC->Context_Packets_BG395_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
