...
typedef struct {
  ...
  _4_Radio_TrackTrain_Header_T_Radio_Types_Pkg /* IfBlock1:then:_L4/ */ _L4_then_IfBlock1;
  ...
  _4_Radio_TrackTrain_Header_T_Radio_Types_Pkg /* IfBlock1:else:_L4/ */ _L4_else_IfBlock1;
