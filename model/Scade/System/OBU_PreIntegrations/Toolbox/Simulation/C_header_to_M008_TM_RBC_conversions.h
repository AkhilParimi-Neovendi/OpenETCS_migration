...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  M_008_T_TM_radio_messages /* message_out/ */ message_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  outC_CAST_Int_to_T_TRAIN_TM_conversions /* _L32=(TM_conversions::CAST_Int_to_T_TRAIN#2)/ */ Context_CAST_Int_to_T_TRAIN_2;
...
extern void C_header_to_M008_init_TM_RBC_conversions(
  outC_C_header_to_M008_TM_RBC_conversions *outC);
