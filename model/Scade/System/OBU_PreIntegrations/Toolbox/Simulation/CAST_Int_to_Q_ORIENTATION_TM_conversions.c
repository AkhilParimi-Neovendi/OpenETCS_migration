...
{
  /* q_orientation/ */
  Q_ORIENTATION q_orientation_partial;
  /* error/ */
  kcg_bool error_partial;
  /* q_orientation/ */
  Q_ORIENTATION _1_q_orientation_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* error/ */
  kcg_bool _3_error_partial;
  /* q_orientation/ */
  Q_ORIENTATION _4_q_orientation_partial;
  /* error/ */
  kcg_bool _5_error_partial;
  /* q_orientation/ */
  Q_ORIENTATION _6_q_orientation_partial;
  kcg_bool noname;
  ...
  outC_CAST_Int_to_Q_ORIENTATION_TM_conversions *outC)
{
  ...
  outC->_L13 = kcg_true;
  outC->q_orientation_in = kcg_lit_int32(0);
  outC->error = kcg_true;
