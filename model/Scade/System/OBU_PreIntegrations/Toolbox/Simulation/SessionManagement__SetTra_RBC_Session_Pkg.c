...
#include "SessionManagement__SetTra_RBC_Session_Pkg.h"

/* RBC_Session_Pkg::SessionManagement__SetTrainData/ */
void SessionManagement__SetTra_RBC_Session_Pkg(
  /* inSessionManagement/ */
...
void SessionManagement__SetTra_init_RBC_Session_Pkg(
  outC_SessionManagement__SetTra_RBC_Session_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx7 = 0; idx7 < 5; idx7++) {
    outC->_L2.m_TrainData.m_NationalSystemIdentities[idx7] = kcg_lit_int64(0);
  }
  ...
  for (idx11 = 0; idx11 < 5; idx11++) {
    outC->_L1.m_TrainData.m_NationalSystemIdentities[idx11] = kcg_lit_int64(0);
  }
...
void SessionManagement__SetTra_reset_RBC_Session_Pkg(
  outC_SessionManagement__SetTra_RBC_Session_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** SessionManagement__SetTra_RBC_Session_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
