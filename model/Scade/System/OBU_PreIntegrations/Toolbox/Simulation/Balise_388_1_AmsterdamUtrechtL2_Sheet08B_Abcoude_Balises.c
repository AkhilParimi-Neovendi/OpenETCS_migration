...
void Balise_388_1_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
  ...
  /* PIG_nom/ */
  kcg_int32 PIG_nom,
  outC_Balise_388_1_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises *outC)
{
  ...
  outC->_L20 = PIG_nom;
  /* _L21=(InfraLib::Balise_Localisation#2)/ */
  Balise_Localisation_InfraLib(
    &outC->_L15,
    &outC->_L19,
    outC->_L20,
    &outC->Context_Balise_Localisation_2);
  outC->_L21 = outC->Context_Balise_Localisation_2.PIG_0_out;
  outC->_L2 = outC->Context_Balise_Localisation_2.TrainPass;
  outC->every = outC->_L2;
  kcg_copy_BaliseTelegramHeader_int_T_TM(&outC->_L23, Header);
  kcg_copy_B_data_internal_T_InfraLib(&outC->_L5, B_data_in);
  if (outC->every) {
    /* _L4=(InfraLib::No_Balise_Packets#1)/ */
    No_Balise_Packets_InfraLib(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_No_Balise_Packets_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_No_Balise_Packets_1.Balise_data_out);
...
void Balise_388_1_init_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
  outC_Balise_388_1_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L4=(InfraLib::No_Balise_Packets#1)/ */
  No_Balise_Packets_init_InfraLib(&outC->Context_No_Balise_Packets_1);
  /* _L21=(InfraLib::Balise_Localisation#2)/ */
  Balise_Localisation_init_InfraLib(&outC->Context_Balise_Localisation_2);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void Balise_388_1_reset_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
  outC_Balise_388_1_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises *outC)
{
  /* _L4=(InfraLib::No_Balise_Packets#1)/ */
  No_Balise_Packets_reset_InfraLib(&outC->Context_No_Balise_Packets_1);
  /* _L21=(InfraLib::Balise_Localisation#2)/ */
  Balise_Localisation_reset_InfraLib(&outC->Context_Balise_Localisation_2);
}
