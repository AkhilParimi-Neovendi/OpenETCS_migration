  ...
  outC_EVC_InputBuffer_Toolbox_Functions *outC)
{
  ...
  TRAIN_TrackSideInputFifo_Toolbox_Functions_5(
    ...
    outC->_L9,
    outC->_L27,
    &outC->_1_Context_TRAIN_TrackSideInputFifo_1);
  kcg_copy_API_TrackSideInput_T_API_Msg_Pkg(
    &outC->_L1,
    &outC->_1_Context_TRAIN_TrackSideInputFifo_1.outData_5);
  outC->_L2 = outC->_1_Context_TRAIN_TrackSideInputFifo_1.outValid_5;
  outC->_L3 = outC->_1_Context_TRAIN_TrackSideInputFifo_1.size_5;
  noname = outC->_L3;
  outC->_L45 = kcg_false;
