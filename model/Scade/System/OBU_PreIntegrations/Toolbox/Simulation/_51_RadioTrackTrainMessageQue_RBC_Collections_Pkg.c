...
void _51_RadioTrackTrainMessageQue_RBC_Collections_Pkg(
...
void _51_RadioTrackTrainMessageQue_init_RBC_Collections_Pkg(
  outC__51_RadioTrackTrainMessageQue_RBC_Collections_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L3.m_Entry.Messages.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    ...
    outC->_L3.m_Entry.Messages.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L3.m_Entry.Messages.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L3.m_Entry.Messages.PacketData[idx3] = kcg_lit_int32(0);
  }
  outC->_L2.m_IsValid = kcg_true;
  outC->_L2.m_Entry.Header.radioDevice = kcg_lit_int32(0);
  outC->_L2.m_Entry.Header.receivedSystemTime = kcg_lit_int32(0);
  outC->_L2.m_Entry.Header.nid_message = kcg_lit_int32(0);
  outC->_L2.m_Entry.Header.t_train = kcg_lit_int32(0);
  outC->_L2.m_Entry.Header.m_ack = kcg_lit_int32(0);
  outC->_L2.m_Entry.Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L2.m_Entry.Header.t_train_reference = kcg_lit_int32(0);
  outC->_L2.m_Entry.Header.nid_em = kcg_lit_int32(0);
  outC->_L2.m_Entry.Header.q_scale = kcg_lit_int32(0);
  outC->_L2.m_Entry.Header.d_sr = kcg_lit_int32(0);
  outC->_L2.m_Entry.Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L2.m_Entry.Header.d_ref = kcg_lit_int32(0);
  outC->_L2.m_Entry.Header.q_dir = kcg_lit_int32(0);
  outC->_L2.m_Entry.Header.d_emergencystop = kcg_lit_int32(0);
  outC->_L2.m_Entry.Header.m_version = kcg_lit_int32(0);
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L2.m_Entry.Messages.PacketHeaders[idx4].nid_packet = kcg_lit_int32(0);
    ...
    outC->_L2.m_Entry.Messages.PacketHeaders[idx4].startAddress = kcg_lit_int32(0);
    outC->_L2.m_Entry.Messages.PacketHeaders[idx4].endAddress = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L2.m_Entry.Messages.PacketData[idx5] = kcg_lit_int32(0);
  }
...
void _51_RadioTrackTrainMessageQue_reset_RBC_Collections_Pkg(
  outC__51_RadioTrackTrainMessageQue_RBC_Collections_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _51_RadioTrackTrainMessageQue_RBC_Collections_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
