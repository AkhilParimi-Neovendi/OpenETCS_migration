...
{
  /* m_voltage/ */
  M_VOLTAGE m_voltage_partial;
  /* error/ */
  kcg_bool error_partial;
  /* m_voltage/ */
  M_VOLTAGE _1_m_voltage_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* m_voltage/ */
  M_VOLTAGE _3_m_voltage_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* m_voltage/ */
  M_VOLTAGE _5_m_voltage_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* m_voltage/ */
  M_VOLTAGE _7_m_voltage_partial;
  /* error/ */
  kcg_bool _8_error_partial;
  /* m_voltage/ */
  M_VOLTAGE _9_m_voltage_partial;
  /* error/ */
  kcg_bool _10_error_partial;
  /* error/ */
  kcg_bool _11_error_partial;
  /* m_voltage/ */
  M_VOLTAGE _12_m_voltage_partial;
  /* error/ */
  kcg_bool _13_error_partial;
  /* m_voltage/ */
  M_VOLTAGE _14_m_voltage_partial;
  /* error/ */
  kcg_bool _15_error_partial;
  /* m_voltage/ */
  M_VOLTAGE _16_m_voltage_partial;
  /* error/ */
  kcg_bool _17_error_partial;
  /* m_voltage/ */
  M_VOLTAGE _18_m_voltage_partial;
  /* error/ */
  kcg_bool _19_error_partial;
  /* m_voltage/ */
  M_VOLTAGE _20_m_voltage_partial;
  /* error/ */
  kcg_bool _21_error_partial;
  /* m_voltage/ */
  M_VOLTAGE _22_m_voltage_partial;
  kcg_bool noname;
  ...
  outC_CAST_Int_to_M_VOLTAGE_TM_conversions *outC)
{
  ...
  outC->error = kcg_true;
  outC->m_voltage_in = kcg_lit_int64(0);
