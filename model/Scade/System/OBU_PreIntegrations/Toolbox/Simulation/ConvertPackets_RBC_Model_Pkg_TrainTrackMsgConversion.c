...
{
  /* P003/ */
  P003_TM_TrainToTrack P003_partial;
  /* P003/ */
  P003_TM_TrainToTrack _1_P003_partial;
  /* P005/ */
  P005_TM_TrainToTrack P005_partial;
  /* P005/ */
  P005_TM_TrainToTrack _2_P005_partial;
  /* P004/ */
  P004_TM_TrainToTrack P004_partial;
  /* P004/ */
  P004_TM_TrainToTrack _3_P004_partial;
  /* P009/ */
  P009_TM_TrainToTrack P009_partial;
  /* P009/ */
  P009_TM_TrainToTrack _4_P009_partial;
  /* P011/ */
  P011_TM_TrainToTrack P011_partial;
  /* P011/ */
  P011_TM_TrainToTrack _5_P011_partial;
  /* P000/ */
  P000_TM_TrainToTrack P000_partial;
  /* P001/ */
  P001_TM_TrainToTrack P001_partial;
  /* P000/ */
  P000_TM_TrainToTrack _6_P000_partial;
  /* P001/ */
  P001_TM_TrainToTrack _7_P001_partial;
  /* P001/ */
  P001_TM_TrainToTrack _8_P001_partial;
  /* P000/ */
  P000_TM_TrainToTrack _9_P000_partial;
  /* P001/ */
  P001_TM_TrainToTrack _10_P001_partial;
  /* P000/ */
  P000_TM_TrainToTrack _11_P000_partial;

  outC->_L45 = !((nid_message == kcg_lit_int32(146)) | (nid_message ==
        kcg_lit_int32(154)) | (nid_message == kcg_lit_int32(155)) |
      (nid_message == kcg_lit_int32(156)) | (nid_message == kcg_lit_int32(
          159)));
  outC->hasPosReport = outC->_L45;
  outC->Det_if_P011_clock = nid_message == kcg_lit_int32(129);
  /* Det_if_P011: */
  if (outC->Det_if_P011_clock) {
    ...
    kcg_copy_P011_TrainTrack_int_TM_TrainToTrack(
      ...
      (P011_TrainTrack_int_TM_TrainToTrack *) &outC->_L3_then_Det_if_P011[17]);
  ...
  outC->Det_if_P009_clock = nid_message == kcg_lit_int32(132);
  /* Det_if_P009: */
  if (outC->Det_if_P009_clock) {
    ...
    kcg_copy_array_int32_3(
      ...
      (array_int32_3 *) &outC->_L3_then_Det_if_P009[17]);
  ...
  outC->Det_if_P005_clock = (nid_message == kcg_lit_int32(136)) |
    (nid_message == kcg_lit_int32(157));
  /* Det_if_P005: */
  if (outC->Det_if_P005_clock) {
    ...
    kcg_copy_array_int32_3(
      ...
      (array_int32_3 *) &outC->_L3_then_Det_if_P005[20]);
  ...
  outC->Det_if_P004_clock = (nid_message == kcg_lit_int32(136)) |
    (nid_message == kcg_lit_int32(157));
  /* Det_if_P004: */
  if (outC->Det_if_P004_clock) {
    ...
    kcg_copy_array_int32_3(
      ...
      (array_int32_3 *) &outC->_L3_then_Det_if_P004[17]);
  ...
  outC->Det_if_P003_clock = nid_message == kcg_lit_int32(159);
  /* Det_if_P003: */
  if (outC->Det_if_P003_clock) {
    ...
    kcg_copy_array_int32_8(
      ...
      (array_int32_8 *) &outC->_L3_then_Det_if_P003[0]);
  ...
  kcg_copy_M_TrainTrack_compressed_packets_T_TM_radio_messages(
    &outC->_L1,
    newPackets);
  kcg_copy_array_int32_17(&outC->_L4, (array_int32_17 *) &outC->_L1[0]);
  outC->_L3 = outC->_L4[1];
  ...
  outC_ConvertPackets_RBC_Model_Pkg_TrainTrackMsgConversion *outC)
{
  ...
  outC->_L44.l_train = kcg_lit_int32(0);
  outC->_L44.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L44.n_axle = kcg_lit_int32(0);
  outC->_L44.nIter_tractionIdentity = kcg_lit_int32(0);
  for (idx = 0; idx < 4; idx++) {
    outC->_L44.tractionIdentity[idx].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L44.tractionIdentity[idx].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L44.nIter_ntc = kcg_lit_int32(0);
  for (idx1 = 0; idx1 < 5; idx1++) {
    outC->_L44.nid_ntc[idx1] = kcg_lit_int32(0);
  }
  outC->_L43.valid = kcg_true;
  outC->_L43.transitionInformation = kcg_lit_int32(0);
  outC->_L42.valid = kcg_true;
  outC->_L42.TrainRunningNumber = kcg_lit_int32(0);
  outC->_L41.valid = kcg_true;
  outC->_L41.m_error = M_ERROR_Balise_group_linking_consistency_error;
  outC->_L40.valid = kcg_true;
  outC->_L40.number = kcg_lit_int32(0);
  for (idx3 = 0; idx3 < 1; idx3++) {
    outC->_L40.aNID_RADIO[idx3].valid = kcg_true;
    for (idx2 = 0; idx2 < 15; idx2++) {
      outC->_L40.aNID_RADIO[idx3].telephoneNumber[idx2] = kcg_lit_int32(0);
    }
  }
  outC->_L39.valid = kcg_true;
  outC->_L39.packet1.NID_PACKET = kcg_lit_int32(0);
  outC->_L39.packet1.L_PACKET = kcg_lit_int32(0);
  outC->_L39.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L39.packet1.NID_LRBG = kcg_lit_int32(0);
  outC->_L39.packet1.NID_PRVLRBG = kcg_lit_int32(0);
  outC->_L39.packet1.D_LRBG = kcg_lit_int32(0);
  outC->_L39.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L39.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L39.packet1.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L39.packet1.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L39.packet1.length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L39.packet1.L_TRAININT = kcg_lit_int32(0);
  outC->_L39.packet1.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L39.packet1.NID_NTC = kcg_lit_int32(0);
  outC->_L38.valid = kcg_true;
  outC->_L38.packet0.NID_PACKET = kcg_lit_int32(0);
  outC->_L38.packet0.L_PACKET = kcg_lit_int32(0);
  outC->_L38.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L38.packet0.NID_LRBG = kcg_lit_int32(0);
  outC->_L38.packet0.D_LRBG = kcg_lit_int32(0);
  outC->_L38.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L38.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->_L38.packet0.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L38.packet0.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L38.packet0.length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L38.packet0.L_TRAININT = kcg_lit_int32(0);
  outC->_L38.packet0.V_TRAIN = kcg_lit_int32(0);
  ...
  for (idx6 = 0; idx6 < 1; idx6++) {
    ...
    for (idx5 = 0; idx5 < 15; idx5++) {
      outC->_L18.p3.aNID_RADIO[idx6].telephoneNumber[idx5] = kcg_lit_int32(0);
    }
  }
  ...
  for (idx7 = 0; idx7 < 4; idx7++) {
    outC->_L18.p11.tractionIdentity[idx7].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L18.p11.tractionIdentity[idx7].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L18.p11.nIter_ntc = kcg_lit_int32(0);
  for (idx8 = 0; idx8 < 5; idx8++) {
    outC->_L18.p11.nid_ntc[idx8] = kcg_lit_int32(0);
  }
  ...
  outC->_L13.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L13.l_train = kcg_lit_int32(0);
  outC->_L13.v_maxtrain = kcg_lit_int32(0);
  outC->_L13.m_loadinggauge =
    M_LOADINGGAUGE_The_train_does_not_fit_to_any_of_the_interoperable_loading_gauge_profiles;
  outC->_L13.m_axleloadcat = M_AXLELOADCAT_A;
  outC->_L13.m_airtight = M_AIRTIGHT_Not_fitted;
  outC->_L13.n_axle = kcg_lit_int32(0);
  outC->_L13.n_iter_voltage = kcg_lit_int32(0);
  for (idx9 = 0; idx9 < 4; idx9++) {
    outC->_L13.voltage_list[idx9].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L13.voltage_list[idx9].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L13.n_iter_nid_ntc = kcg_lit_int32(0);
  for (idx10 = 0; idx10 < 5; idx10++) {
    outC->_L13.nid_ntc_list[idx10] = kcg_lit_int32(0);
  }
  ...
  for (idx11 = 0; idx11 < 17; idx11++) {
    outC->_L4[idx11] = kcg_lit_int32(0);
  }
  for (idx12 = 0; idx12 < 50; idx12++) {
    outC->_L1[idx12] = kcg_lit_int32(0);
  }
  outC->hasPosReport = kcg_true;
  outC->P003.valid = kcg_true;
  outC->P003.nid_packet = kcg_lit_int32(0);
  outC->P003.l_packet = kcg_lit_int32(0);
  outC->P003.n_iter = kcg_lit_int32(0);
  for (idx13 = 0; idx13 < 5; idx13++) {
    outC->P003.nid_radio[idx13] = kcg_lit_int32(0);
  }
  outC->P005.valid = kcg_true;
  outC->P005.nid_packet = kcg_lit_int32(0);
  outC->P005.l_packet = kcg_lit_int32(0);
  outC->P005.nid_opeartional = kcg_lit_int32(0);
  outC->P004.valid = kcg_true;
  outC->P004.nid_packet = kcg_lit_int32(0);
  outC->P004.l_packet = kcg_lit_int32(0);
  outC->P004.m_error = M_ERROR_Balise_group_linking_consistency_error;
  outC->P009.valid = kcg_true;
  outC->P009.nid_packet = kcg_lit_int32(0);
  outC->P009.l_packet = kcg_lit_int32(0);
  outC->P009.nid_ltrbg = kcg_lit_int32(0);
  outC->P011.valid = kcg_true;
  outC->P011.nid_packet = kcg_lit_int32(0);
  outC->P011.l_packet = kcg_lit_int32(0);
  outC->P011.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->P011.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->P011.l_train = kcg_lit_int32(0);
  outC->P011.v_maxtrain = kcg_lit_int32(0);
  outC->P011.m_loadinggauge =
    M_LOADINGGAUGE_The_train_does_not_fit_to_any_of_the_interoperable_loading_gauge_profiles;
  outC->P011.m_axleloadcat = M_AXLELOADCAT_A;
  outC->P011.m_airtight = M_AIRTIGHT_Not_fitted;
  outC->P011.n_axle = kcg_lit_int32(0);
  outC->P011.n_iter_voltage = kcg_lit_int32(0);
  for (idx14 = 0; idx14 < 4; idx14++) {
    outC->P011.voltage_list[idx14].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->P011.voltage_list[idx14].nid_ctraction = kcg_lit_int32(0);
  }
  outC->P011.n_iter_nid_ntc = kcg_lit_int32(0);
  for (idx15 = 0; idx15 < 5; idx15++) {
    outC->P011.nid_ntc_list[idx15] = kcg_lit_int32(0);
  }
  outC->P001.valid = kcg_true;
  outC->P001.nid_packet = kcg_lit_int32(0);
  outC->P001.l_packet = kcg_lit_int32(0);
  outC->P001.q_scale = Q_SCALE_10_cm_scale;
  outC->P001.nid_lrbg = kcg_lit_int32(0);
  outC->P001.nid_prvlrbg = kcg_lit_int32(0);
  outC->P001.d_lrbg = kcg_lit_int32(0);
  outC->P001.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->P001.q_dlrbg = Q_DLRBG_Reverse;
  outC->P001.l_doubtover = kcg_lit_int32(0);
  outC->P001.l_doubtunder = kcg_lit_int32(0);
  outC->P001.q_length = Q_LENGTH_No_train_integrity_information_available;
  outC->P001.l_trainint = kcg_lit_int32(0);
  outC->P001.v_train = kcg_lit_int32(0);
  outC->P001.q_dirtrain = Q_DIRTRAIN_Reverse;
  outC->P001.m_mode = M_MODE_Full_Supervision;
  outC->P001.m_level = M_LEVEL_Level_0;
  outC->P001.nid_ntc = kcg_lit_int32(0);
  outC->P000.valid = kcg_true;
  outC->P000.nid_packet = kcg_lit_int32(0);
  outC->P000.l_packet = kcg_lit_int32(0);
  outC->P000.q_scale = Q_SCALE_10_cm_scale;
  outC->P000.nid_lrbg = kcg_lit_int32(0);
  outC->P000.d_lrbg = kcg_lit_int32(0);
  outC->P000.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->P000.q_dlrbg = Q_DLRBG_Reverse;
  outC->P000.l_doubtover = kcg_lit_int32(0);
  outC->P000.l_doubtunder = kcg_lit_int32(0);
  outC->P000.q_length = Q_LENGTH_No_train_integrity_information_available;
  outC->P000.l_trainint = kcg_lit_int32(0);
  outC->P000.v_train = kcg_lit_int32(0);
  outC->P000.q_dirtrain = Q_DIRTRAIN_Reverse;
  outC->P000.m_mode = M_MODE_Full_Supervision;
  outC->P000.m_level = M_LEVEL_Level_0;
  outC->P000.nid_ntc = kcg_lit_int32(0);
  outC->nid_packet = kcg_lit_int32(0);
  for (idx16 = 0; idx16 < 17; idx16++) {
    outC->P0_or_P1[idx16] = kcg_lit_int32(0);
  }
  ...
  outC->_L5_then_else_Det_if_P0_or_P1.nid_packet = kcg_lit_int32(0);
  outC->_L5_then_else_Det_if_P0_or_P1.l_packet = kcg_lit_int32(0);
  outC->_L5_then_else_Det_if_P0_or_P1.q_scale = Q_SCALE_10_cm_scale;
  outC->_L5_then_else_Det_if_P0_or_P1.nid_lrbg = kcg_lit_int32(0);
  outC->_L5_then_else_Det_if_P0_or_P1.d_lrbg = kcg_lit_int32(0);
  outC->_L5_then_else_Det_if_P0_or_P1.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L5_then_else_Det_if_P0_or_P1.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L5_then_else_Det_if_P0_or_P1.l_doubtover = kcg_lit_int32(0);
  outC->_L5_then_else_Det_if_P0_or_P1.l_doubtunder = kcg_lit_int32(0);
  outC->_L5_then_else_Det_if_P0_or_P1.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L5_then_else_Det_if_P0_or_P1.l_trainint = kcg_lit_int32(0);
  outC->_L5_then_else_Det_if_P0_or_P1.v_train = kcg_lit_int32(0);
  ...
  outC->_L5_then_else_Det_if_P0_or_P1.nid_ntc = kcg_lit_int32(0);
  outC->_L3_then_else_Det_if_P0_or_P1.valid = kcg_true;
  outC->_L3_then_else_Det_if_P0_or_P1.nid_packet = kcg_lit_int32(0);
  outC->_L3_then_else_Det_if_P0_or_P1.l_packet = kcg_lit_int32(0);
  outC->_L3_then_else_Det_if_P0_or_P1.q_scale = Q_SCALE_10_cm_scale;
  outC->_L3_then_else_Det_if_P0_or_P1.nid_lrbg = kcg_lit_int32(0);
  outC->_L3_then_else_Det_if_P0_or_P1.nid_prvlrbg = kcg_lit_int32(0);
  outC->_L3_then_else_Det_if_P0_or_P1.d_lrbg = kcg_lit_int32(0);
  outC->_L3_then_else_Det_if_P0_or_P1.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L3_then_else_Det_if_P0_or_P1.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L3_then_else_Det_if_P0_or_P1.l_doubtover = kcg_lit_int32(0);
  outC->_L3_then_else_Det_if_P0_or_P1.l_doubtunder = kcg_lit_int32(0);
  outC->_L3_then_else_Det_if_P0_or_P1.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L3_then_else_Det_if_P0_or_P1.l_trainint = kcg_lit_int32(0);
  outC->_L3_then_else_Det_if_P0_or_P1.v_train = kcg_lit_int32(0);
  ...
  outC->_L3_then_else_Det_if_P0_or_P1.nid_ntc = kcg_lit_int32(0);
  for (idx17 = 0; idx17 < 17; idx17++) {
    outC->_L2_then_else_Det_if_P0_or_P1[idx17] = kcg_lit_int32(0);
  }
  outC->_L3_else_else_Det_if_P0_or_P1.valid = kcg_true;
  outC->_L3_else_else_Det_if_P0_or_P1.nid_packet = kcg_lit_int32(0);
  outC->_L3_else_else_Det_if_P0_or_P1.l_packet = kcg_lit_int32(0);
  outC->_L3_else_else_Det_if_P0_or_P1.q_scale = Q_SCALE_10_cm_scale;
  outC->_L3_else_else_Det_if_P0_or_P1.nid_lrbg = kcg_lit_int32(0);
  outC->_L3_else_else_Det_if_P0_or_P1.d_lrbg = kcg_lit_int32(0);
  outC->_L3_else_else_Det_if_P0_or_P1.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L3_else_else_Det_if_P0_or_P1.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L3_else_else_Det_if_P0_or_P1.l_doubtover = kcg_lit_int32(0);
  outC->_L3_else_else_Det_if_P0_or_P1.l_doubtunder = kcg_lit_int32(0);
  outC->_L3_else_else_Det_if_P0_or_P1.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L3_else_else_Det_if_P0_or_P1.l_trainint = kcg_lit_int32(0);
  outC->_L3_else_else_Det_if_P0_or_P1.v_train = kcg_lit_int32(0);
  ...
  outC->_L3_else_else_Det_if_P0_or_P1.nid_ntc = kcg_lit_int32(0);
  outC->_L2_else_else_Det_if_P0_or_P1.valid = kcg_true;
  outC->_L2_else_else_Det_if_P0_or_P1.nid_packet = kcg_lit_int32(0);
  outC->_L2_else_else_Det_if_P0_or_P1.l_packet = kcg_lit_int32(0);
  outC->_L2_else_else_Det_if_P0_or_P1.q_scale = Q_SCALE_10_cm_scale;
  outC->_L2_else_else_Det_if_P0_or_P1.nid_lrbg = kcg_lit_int32(0);
  outC->_L2_else_else_Det_if_P0_or_P1.nid_prvlrbg = kcg_lit_int32(0);
  outC->_L2_else_else_Det_if_P0_or_P1.d_lrbg = kcg_lit_int32(0);
  outC->_L2_else_else_Det_if_P0_or_P1.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L2_else_else_Det_if_P0_or_P1.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L2_else_else_Det_if_P0_or_P1.l_doubtover = kcg_lit_int32(0);
  outC->_L2_else_else_Det_if_P0_or_P1.l_doubtunder = kcg_lit_int32(0);
  outC->_L2_else_else_Det_if_P0_or_P1.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L2_else_else_Det_if_P0_or_P1.l_trainint = kcg_lit_int32(0);
  outC->_L2_else_else_Det_if_P0_or_P1.v_train = kcg_lit_int32(0);
  ...
  outC->_L2_else_else_Det_if_P0_or_P1.nid_ntc = kcg_lit_int32(0);
  outC->else_clock_Det_if_P0_or_P1 = kcg_true;
  outC->_L1_then_Det_if_P0_or_P1.valid = kcg_true;
  outC->_L1_then_Det_if_P0_or_P1.nid_packet = kcg_lit_int32(0);
  outC->_L1_then_Det_if_P0_or_P1.l_packet = kcg_lit_int32(0);
  outC->_L1_then_Det_if_P0_or_P1.q_scale = Q_SCALE_10_cm_scale;
  outC->_L1_then_Det_if_P0_or_P1.nid_lrbg = kcg_lit_int32(0);
  outC->_L1_then_Det_if_P0_or_P1.nid_prvlrbg = kcg_lit_int32(0);
  outC->_L1_then_Det_if_P0_or_P1.d_lrbg = kcg_lit_int32(0);
  outC->_L1_then_Det_if_P0_or_P1.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L1_then_Det_if_P0_or_P1.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L1_then_Det_if_P0_or_P1.l_doubtover = kcg_lit_int32(0);
  outC->_L1_then_Det_if_P0_or_P1.l_doubtunder = kcg_lit_int32(0);
  outC->_L1_then_Det_if_P0_or_P1.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L1_then_Det_if_P0_or_P1.l_trainint = kcg_lit_int32(0);
  outC->_L1_then_Det_if_P0_or_P1.v_train = kcg_lit_int32(0);
  ...
  outC->_L1_then_Det_if_P0_or_P1.nid_ntc = kcg_lit_int32(0);
  for (idx18 = 0; idx18 < 17; idx18++) {
    outC->_L2_then_Det_if_P0_or_P1[idx18] = kcg_lit_int32(0);
  }
  outC->_L3_then_Det_if_P0_or_P1.valid = kcg_true;
  outC->_L3_then_Det_if_P0_or_P1.nid_packet = kcg_lit_int32(0);
  outC->_L3_then_Det_if_P0_or_P1.l_packet = kcg_lit_int32(0);
  outC->_L3_then_Det_if_P0_or_P1.q_scale = Q_SCALE_10_cm_scale;
  outC->_L3_then_Det_if_P0_or_P1.nid_lrbg = kcg_lit_int32(0);
  outC->_L3_then_Det_if_P0_or_P1.d_lrbg = kcg_lit_int32(0);
  outC->_L3_then_Det_if_P0_or_P1.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L3_then_Det_if_P0_or_P1.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L3_then_Det_if_P0_or_P1.l_doubtover = kcg_lit_int32(0);
  outC->_L3_then_Det_if_P0_or_P1.l_doubtunder = kcg_lit_int32(0);
  outC->_L3_then_Det_if_P0_or_P1.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L3_then_Det_if_P0_or_P1.l_trainint = kcg_lit_int32(0);
  outC->_L3_then_Det_if_P0_or_P1.v_train = kcg_lit_int32(0);
  ...
  outC->_L3_then_Det_if_P0_or_P1.nid_ntc = kcg_lit_int32(0);
  outC->_L1_else_Det_if_P011.valid = kcg_true;
  outC->_L1_else_Det_if_P011.nid_packet = kcg_lit_int32(0);
  outC->_L1_else_Det_if_P011.l_packet = kcg_lit_int32(0);
  outC->_L1_else_Det_if_P011.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L1_else_Det_if_P011.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L1_else_Det_if_P011.l_train = kcg_lit_int32(0);
  outC->_L1_else_Det_if_P011.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L1_else_Det_if_P011.n_axle = kcg_lit_int32(0);
  outC->_L1_else_Det_if_P011.n_iter_voltage = kcg_lit_int32(0);
  for (idx19 = 0; idx19 < 4; idx19++) {
    outC->_L1_else_Det_if_P011.voltage_list[idx19].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L1_else_Det_if_P011.voltage_list[idx19].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L1_else_Det_if_P011.n_iter_nid_ntc = kcg_lit_int32(0);
  for (idx20 = 0; idx20 < 5; idx20++) {
    outC->_L1_else_Det_if_P011.nid_ntc_list[idx20] = kcg_lit_int32(0);
  }
  for (idx21 = 0; idx21 < 25; idx21++) {
    outC->_L1_then_Det_if_P011[idx21] = kcg_lit_int32(0);
  }
  outC->_L2_then_Det_if_P011.valid = kcg_true;
  outC->_L2_then_Det_if_P011.nid_packet = kcg_lit_int32(0);
  outC->_L2_then_Det_if_P011.l_packet = kcg_lit_int32(0);
  outC->_L2_then_Det_if_P011.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L2_then_Det_if_P011.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L2_then_Det_if_P011.l_train = kcg_lit_int32(0);
  outC->_L2_then_Det_if_P011.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L2_then_Det_if_P011.n_axle = kcg_lit_int32(0);
  outC->_L2_then_Det_if_P011.n_iter_voltage = kcg_lit_int32(0);
  for (idx22 = 0; idx22 < 4; idx22++) {
    outC->_L2_then_Det_if_P011.voltage_list[idx22].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L2_then_Det_if_P011.voltage_list[idx22].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L2_then_Det_if_P011.n_iter_nid_ntc = kcg_lit_int32(0);
  for (idx23 = 0; idx23 < 5; idx23++) {
    outC->_L2_then_Det_if_P011.nid_ntc_list[idx23] = kcg_lit_int32(0);
  }
  for (idx24 = 0; idx24 < 50; idx24++) {
    outC->_L3_then_Det_if_P011[idx24] = kcg_lit_int32(0);
  }
  outC->_L1_else_Det_if_P009.valid = kcg_true;
  outC->_L1_else_Det_if_P009.nid_packet = kcg_lit_int32(0);
  outC->_L1_else_Det_if_P009.l_packet = kcg_lit_int32(0);
  outC->_L1_else_Det_if_P009.nid_ltrbg = kcg_lit_int32(0);
  for (idx25 = 0; idx25 < 3; idx25++) {
    outC->_L1_then_Det_if_P009[idx25] = kcg_lit_int32(0);
  }
  outC->_L2_then_Det_if_P009.valid = kcg_true;
  outC->_L2_then_Det_if_P009.nid_packet = kcg_lit_int32(0);
  outC->_L2_then_Det_if_P009.l_packet = kcg_lit_int32(0);
  outC->_L2_then_Det_if_P009.nid_ltrbg = kcg_lit_int32(0);
  for (idx26 = 0; idx26 < 50; idx26++) {
    outC->_L3_then_Det_if_P009[idx26] = kcg_lit_int32(0);
  }
  outC->_L1_else_Det_if_P004.valid = kcg_true;
  outC->_L1_else_Det_if_P004.nid_packet = kcg_lit_int32(0);
  outC->_L1_else_Det_if_P004.l_packet = kcg_lit_int32(0);
  outC->_L1_else_Det_if_P004.m_error =
    M_ERROR_Balise_group_linking_consistency_error;
  for (idx27 = 0; idx27 < 3; idx27++) {
    outC->_L1_then_Det_if_P004[idx27] = kcg_lit_int32(0);
  }
  outC->_L2_then_Det_if_P004.valid = kcg_true;
  outC->_L2_then_Det_if_P004.nid_packet = kcg_lit_int32(0);
  outC->_L2_then_Det_if_P004.l_packet = kcg_lit_int32(0);
  outC->_L2_then_Det_if_P004.m_error =
    M_ERROR_Balise_group_linking_consistency_error;
  for (idx28 = 0; idx28 < 50; idx28++) {
    outC->_L3_then_Det_if_P004[idx28] = kcg_lit_int32(0);
  }
  outC->_L1_else_Det_if_P005.valid = kcg_true;
  outC->_L1_else_Det_if_P005.nid_packet = kcg_lit_int32(0);
  outC->_L1_else_Det_if_P005.l_packet = kcg_lit_int32(0);
  outC->_L1_else_Det_if_P005.nid_opeartional = kcg_lit_int32(0);
  for (idx29 = 0; idx29 < 3; idx29++) {
    outC->_L1_then_Det_if_P005[idx29] = kcg_lit_int32(0);
  }
  outC->_L2_then_Det_if_P005.valid = kcg_true;
  outC->_L2_then_Det_if_P005.nid_packet = kcg_lit_int32(0);
  outC->_L2_then_Det_if_P005.l_packet = kcg_lit_int32(0);
  outC->_L2_then_Det_if_P005.nid_opeartional = kcg_lit_int32(0);
  for (idx30 = 0; idx30 < 50; idx30++) {
    outC->_L3_then_Det_if_P005[idx30] = kcg_lit_int32(0);
  }
  outC->_L1_else_Det_if_P003.valid = kcg_true;
  outC->_L1_else_Det_if_P003.nid_packet = kcg_lit_int32(0);
  outC->_L1_else_Det_if_P003.l_packet = kcg_lit_int32(0);
  outC->_L1_else_Det_if_P003.n_iter = kcg_lit_int32(0);
  for (idx31 = 0; idx31 < 5; idx31++) {
    outC->_L1_else_Det_if_P003.nid_radio[idx31] = kcg_lit_int32(0);
  }
  for (idx32 = 0; idx32 < 8; idx32++) {
    outC->_L1_then_Det_if_P003[idx32] = kcg_lit_int32(0);
  }
  outC->_L2_then_Det_if_P003.valid = kcg_true;
  outC->_L2_then_Det_if_P003.nid_packet = kcg_lit_int32(0);
  outC->_L2_then_Det_if_P003.l_packet = kcg_lit_int32(0);
  outC->_L2_then_Det_if_P003.n_iter = kcg_lit_int32(0);
  for (idx33 = 0; idx33 < 5; idx33++) {
    outC->_L2_then_Det_if_P003.nid_radio[idx33] = kcg_lit_int32(0);
  }
  for (idx34 = 0; idx34 < 50; idx34++) {
    outC->_L3_then_Det_if_P003[idx34] = kcg_lit_int32(0);
  }
  outC->oldPackets.p0.valid = kcg_true;
  outC->oldPackets.p0.packet0.NID_PACKET = kcg_lit_int32(0);
  outC->oldPackets.p0.packet0.L_PACKET = kcg_lit_int32(0);
  outC->oldPackets.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->oldPackets.p0.packet0.NID_LRBG = kcg_lit_int32(0);
  outC->oldPackets.p0.packet0.D_LRBG = kcg_lit_int32(0);
  outC->oldPackets.p0.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->oldPackets.p0.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->oldPackets.p0.packet0.L_DOUBTOVER = kcg_lit_int32(0);
  outC->oldPackets.p0.packet0.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->oldPackets.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->oldPackets.p0.packet0.L_TRAININT = kcg_lit_int32(0);
  outC->oldPackets.p0.packet0.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->oldPackets.p0.packet0.NID_NTC = kcg_lit_int32(0);
  outC->oldPackets.p1.valid = kcg_true;
  outC->oldPackets.p1.packet1.NID_PACKET = kcg_lit_int32(0);
  outC->oldPackets.p1.packet1.L_PACKET = kcg_lit_int32(0);
  outC->oldPackets.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->oldPackets.p1.packet1.NID_LRBG = kcg_lit_int32(0);
  outC->oldPackets.p1.packet1.NID_PRVLRBG = kcg_lit_int32(0);
  outC->oldPackets.p1.packet1.D_LRBG = kcg_lit_int32(0);
  outC->oldPackets.p1.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->oldPackets.p1.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->oldPackets.p1.packet1.L_DOUBTOVER = kcg_lit_int32(0);
  outC->oldPackets.p1.packet1.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->oldPackets.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->oldPackets.p1.packet1.L_TRAININT = kcg_lit_int32(0);
  outC->oldPackets.p1.packet1.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->oldPackets.p1.packet1.NID_NTC = kcg_lit_int32(0);
  outC->oldPackets.p3.valid = kcg_true;
  outC->oldPackets.p3.number = kcg_lit_int32(0);
  for (idx36 = 0; idx36 < 1; idx36++) {
    outC->oldPackets.p3.aNID_RADIO[idx36].valid = kcg_true;
    for (idx35 = 0; idx35 < 15; idx35++) {
      outC->oldPackets.p3.aNID_RADIO[idx36].telephoneNumber[idx35] = kcg_lit_int32(0);
    }
  }
  ...
  outC->oldPackets.p5.TrainRunningNumber = kcg_lit_int32(0);
  outC->oldPackets.p9.valid = kcg_true;
  outC->oldPackets.p9.transitionInformation = kcg_lit_int32(0);
  ...
  outC->oldPackets.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->oldPackets.p11.l_train = kcg_lit_int32(0);
  outC->oldPackets.p11.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->oldPackets.p11.n_axle = kcg_lit_int32(0);
  outC->oldPackets.p11.nIter_tractionIdentity = kcg_lit_int32(0);
  for (idx37 = 0; idx37 < 4; idx37++) {
    outC->oldPackets.p11.tractionIdentity[idx37].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->oldPackets.p11.tractionIdentity[idx37].nid_ctraction = kcg_lit_int32(0);
  }
  outC->oldPackets.p11.nIter_ntc = kcg_lit_int32(0);
  for (idx38 = 0; idx38 < 5; idx38++) {
    outC->oldPackets.p11.nid_ntc[idx38] = kcg_lit_int32(0);
  }
  /* _L38=(RBC_Model_Pkg::TrainTrackMsgConversion::ConvertP000#1)/ */
