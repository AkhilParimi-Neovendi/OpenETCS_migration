  ...
  outC_Packets_BG355_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises *outC)
{
  ...
  for (idx16 = 0; idx16 < 30; idx16++) {
    outC->_L3.PacketHeaders[idx16].nid_packet = kcg_lit_int32(0);
    outC->_L3.PacketHeaders[idx16].q_dir = Q_DIR_Reverse;
    outC->_L3.PacketHeaders[idx16].valid = kcg_true;
    outC->_L3.PacketHeaders[idx16].startAddress = kcg_lit_int32(0);
    outC->_L3.PacketHeaders[idx16].endAddress = kcg_lit_int32(0);
  }
  for (idx17 = 0; idx17 < 500; idx17++) {
    outC->_L3.PacketData[idx17] = kcg_lit_int32(0);
  }
