  ...
  outC_Sheet14_Maarssen_balises_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L3.BG_Message.Messages.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    ...
    outC->_L3.BG_Message.Messages.PacketHeaders[idx].startAddress =
      kcg_lit_int64(0);
    outC->_L3.BG_Message.Messages.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L3.BG_Message.Messages.PacketData[idx1] = kcg_lit_int64(0);
  }
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L2.BG_Message.Messages.PacketHeaders[idx2].nid_packet = kcg_lit_int64(0);
    ...
    outC->_L2.BG_Message.Messages.PacketHeaders[idx2].startAddress =
      kcg_lit_int64(0);
    outC->_L2.BG_Message.Messages.PacketHeaders[idx2].endAddress = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L2.BG_Message.Messages.PacketData[idx3] = kcg_lit_int64(0);
  }
  ...
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L1.BG_Message.Messages.PacketHeaders[idx4].nid_packet = kcg_lit_int64(0);
    ...
    outC->_L1.BG_Message.Messages.PacketHeaders[idx4].startAddress =
      kcg_lit_int64(0);
    outC->_L1.BG_Message.Messages.PacketHeaders[idx4].endAddress = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L1.BG_Message.Messages.PacketData[idx5] = kcg_lit_int64(0);
  }
