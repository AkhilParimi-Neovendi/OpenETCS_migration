  ...
  outC_C_P003V1_tracksim_compr_TM_conversions_baseline2 *outC)
{
  ...
  kcg_copy_array_int64_18(&outC->_L381[6], &outC->_L407);
  kcg_copy_array_int64_24(&outC->_L384[0], &outC->_L381);
  kcg_copy_P003V1_trackide_sectionlist_T_TM_baseline2(
    &outC->_L384[24],
    &outC->_L408);
  ...
  kcg_copy_array_int64_56(&outC->_L383[0], &outC->_L384);
  kcg_copy_array_int64_444(&outC->_L383[56], &outC->_L209);
  /* _L379=(TM_lib_internal::T_DeterminePacketSizeInt#1)/ */
  T_DeterminePacketSizeInt_TM_lib_internal(
    outC->_L366,
    kcg_lit_int64(6) + kcg_lit_int64(17),
    kcg_lit_int64(1),
  ...
  outC_C_P003V1_tracksim_compr_TM_conversions_baseline2 *outC)
{
  ...
  outC->_L409 = kcg_lit_int64(0);
  for (idx = 0; idx < 32; idx++) {
    outC->_L408[idx] = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 18; idx1++) {
    outC->_L407[idx1] = kcg_lit_int64(0);
  }
  outC->_L404 = kcg_lit_int64(0);
  outC->_L403 = kcg_lit_int64(0);
  outC->_L402 = kcg_lit_int64(0);
  outC->_L401 = kcg_lit_int64(0);
  outC->_L400 = kcg_lit_int64(0);
  outC->_L399 = kcg_lit_int64(0);
  outC->_L398 = kcg_lit_int64(0);
  ...
  for (idx5 = 0; idx5 < 6; idx5++) {
    outC->_L373[idx5] = kcg_lit_int64(0);
  }
  for (idx6 = 0; idx6 < 32; idx6++) {
    outC->_L365[idx6] = kcg_lit_int64(0);
  }
  ...
  for (idx7 = 0; idx7 < 444; idx7++) {
    outC->_L209[idx7] = kcg_lit_int64(0);
  }
  outC->_L206 = kcg_lit_int64(0);
  ...
  for (idx8 = 0; idx8 < 32; idx8++) {
    outC->_L1.SECTIONS[idx8] = kcg_lit_int64(0);
  }
  ...
  for (idx9 = 0; idx9 < 32; idx9++) {
    outC->sections[idx9] = kcg_lit_int64(0);
  }
  ...
  for (idx10 = 0; idx10 < 500; idx10++) {
    outC->P003V1_compressed[idx10] = kcg_lit_int64(0);
  }
