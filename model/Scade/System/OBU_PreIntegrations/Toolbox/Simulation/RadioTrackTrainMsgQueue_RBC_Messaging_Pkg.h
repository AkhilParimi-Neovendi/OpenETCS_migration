...
#include "kcg_types.h"
#include "_148_RadioTrackTrainMessa_RBC_Collections_Pkg.h"
...
#include "_144_RadioTrackTrainFacto_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg.h"
...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_RadioTrackTrainMessage__S_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* IfBlock1:then:_L32=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__SetHeader#2)/ */ Context_RadioTrackTrainMessage__SetHeader_2;
  outC__35_RadioTrackTrainHeader__Se_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* IfBlock1:then:_L33=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Set_T_TRAIN#2)/ */ Context_RadioTrackTrainHeader__Set_T_TRAIN_2;
  outC_Clock__GetSeconds_RBC_Time_Pkg /* IfBlock1:then:_L39=(RBC_Time_Pkg::Clock__GetSeconds#2)/ */ Context_Clock__GetSeconds_2;
  outC_RadioTrackTrainMessage__G_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* IfBlock1:then:_L37=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__GetHeader#2)/ */ _1_Context_RadioTrackTrainMessage__GetHeader_2;
  outC__148_RadioTrackTrainMessa_RBC_Collections_Pkg /* IfBlock1:then:_L36=(RBC_Collections_Pkg::RadioTrackTrainMessageQueueEntry__GetEntry#2)/ */ Context_RadioTrackTrainMessageQueueEntry__GetEntry_2;
  outC__147_RadioTrackTrainMessa_RBC_Collections_Pkg /* IfBlock1:then:_L34=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__Take#2)/ */ _2_Context_RadioTrackTrainMessageQueue__Take_2;
  outC__144_RadioTrackTrainFacto_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg /* IfBlock1:else:_L3=(RBC_Messaging_Pkg::RBC_RadioTrackTrainFactory_Pkg::RadioTrackTrainFactory__CreateDefaultMsg_BSL2#2)/ */ Context_RadioTrackTrainFactory__CreateDefaultMsg_BSL2_2;
  outC__48_RadioTrackTrainMessageQue_RBC_Collections_Pkg /* _L5=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__GetRemainingCapacity#2)/ */ _3_Context_RadioTrackTrainMessageQueue__GetRemainingCapacity_2;
  ...
  _2_RadioTrackTrainMessageQueue_T /* IfBlock1:then:_L43/ */ _L43_then_IfBlock1;
  ...
  _2_RadioTrackTrainMessageQueue_T /* IfBlock1:then:_L34/ */ _L34_then_IfBlock1;
  ...
  _2_RadioTrackTrainMessageQueue_T /* IfBlock1:else:_L5/ */ _L5_else_IfBlock1;
  ...
  kcg_int32 /* _L5/ */ _L5;
  _2_RadioTrackTrainMessageQueue_T /* _L6/ */ _L6;
