  ...
  outC_SendRadioPackets_LRBG_200_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  ...
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L4.PacketHeaders[idx6].nid_packet = kcg_lit_int32(0);
    outC->_L4.PacketHeaders[idx6].q_dir = Q_DIR_Reverse;
    outC->_L4.PacketHeaders[idx6].valid = kcg_true;
    outC->_L4.PacketHeaders[idx6].startAddress = kcg_lit_int32(0);
    outC->_L4.PacketHeaders[idx6].endAddress = kcg_lit_int32(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->_L4.PacketData[idx7] = kcg_lit_int32(0);
  }
  ...
  for (idx10 = 0; idx10 < 30; idx10++) {
    outC->_L2.PacketHeaders[idx10].nid_packet = kcg_lit_int32(0);
    outC->_L2.PacketHeaders[idx10].q_dir = Q_DIR_Reverse;
    outC->_L2.PacketHeaders[idx10].valid = kcg_true;
    outC->_L2.PacketHeaders[idx10].startAddress = kcg_lit_int32(0);
    outC->_L2.PacketHeaders[idx10].endAddress = kcg_lit_int32(0);
  }
  for (idx11 = 0; idx11 < 500; idx11++) {
    outC->_L2.PacketData[idx11] = kcg_lit_int32(0);
  }
  for (idx12 = 0; idx12 < 30; idx12++) {
    outC->Radio_packets_out.PacketHeaders[idx12].nid_packet = kcg_lit_int32(0);
    outC->Radio_packets_out.PacketHeaders[idx12].q_dir = Q_DIR_Reverse;
    outC->Radio_packets_out.PacketHeaders[idx12].valid = kcg_true;
    outC->Radio_packets_out.PacketHeaders[idx12].startAddress = kcg_lit_int32(0);
    outC->Radio_packets_out.PacketHeaders[idx12].endAddress = kcg_lit_int32(0);
  }
  for (idx13 = 0; idx13 < 500; idx13++) {
    outC->Radio_packets_out.PacketData[idx13] = kcg_lit_int32(0);
  }
  /* _L33=(MessageLibBaseline2::Send_P041#1)/ */
