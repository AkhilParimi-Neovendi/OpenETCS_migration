...
{
  outC->_L5 = kcg_lit_int64(7);
  outC->_L3 = i;
  outC->_L154 = outC->_L3 / outC->_L5;
  outC->_L6 = outC->_L3 % outC->_L5;
  kcg_copy_P005_OBU_sectionlist_array_T_TM(&outC->_L2, section_arrays);
  if ((kcg_lit_int64(0) <= outC->_L154) & (outC->_L154 < kcg_lit_int64(33)) &
    ((kcg_lit_int64(0) <= outC->_L6) & (outC->_L6 < kcg_lit_int64(7)))) {
  ...
  if ((kcg_lit_int64(0) <= outC->_L8) & (outC->_L8 < kcg_lit_int64(95))) {
