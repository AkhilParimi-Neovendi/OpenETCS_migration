  ...
  outC_C_P015_flatten_sections_TM_lib_internal *outC)
{
  ...
  for (idx8 = 0; idx8 < 32; idx8++) {
    outC->_L75[idx8].L_SECTION = kcg_lit_int32(0);
    outC->_L75[idx8].Q_SECTIONTIMER = kcg_lit_int32(0);
    outC->_L75[idx8].T_SECTIONTIMER = kcg_lit_int32(0);
    outC->_L75[idx8].D_SECTIONTIMERSTOPLOC = kcg_lit_int32(0);
  }
