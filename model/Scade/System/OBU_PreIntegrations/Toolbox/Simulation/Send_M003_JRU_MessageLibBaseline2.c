  ...
  outC_Send_M003_JRU_MessageLibBaseline2 *outC)
{
  ...
  /* _L2=(TM_RBC_conversions::C_M003_int__to_header#1)/ */
  C_M003_int__to_header_TM_RBC_conversions(
    &outC->_L1,
    &outC->Context_C_M003_int__to_header_1);
  kcg_copy_M_TrackTrain_Radio_T_TM_radio_messages(
    &outC->_L2,
    &outC->Context_C_M003_int__to_header_1.Message_Header_Out);
  kcg_copy_M_TrackTrain_Radio_T_TM_radio_messages(&outC->Message_Out, &outC->_L2);
}

#ifndef KCG_USER_DEFINED_INIT
void Send_M003_JRU_init_MessageLibBaseline2(
  outC_Send_M003_JRU_MessageLibBaseline2 *outC)
{
  ...
  /* _L2=(TM_RBC_conversions::C_M003_int__to_header#1)/ */
  C_M003_int__to_header_init_TM_RBC_conversions(
    &outC->Context_C_M003_int__to_header_1);
}
...
{
  /* _L2=(TM_RBC_conversions::C_M003_int__to_header#1)/ */
  C_M003_int__to_header_reset_TM_RBC_conversions(
    &outC->Context_C_M003_int__to_header_1);
}
