...
#include "_99_RadioTrackTrainFactory__C_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg.h"

/* RBC_Messaging_Pkg::RBC_RadioTrackTrainFactory_Pkg::RadioTrackTrainFactory__CreateMsg008_BSL2/ */
void _99_RadioTrackTrainFactory__C_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg(
  /* in_T_TRAIN/ */
  T_TRAIN in_T_TRAIN,
  /* in_M_ACK/ */
  M_ACK in_M_ACK,
...
void _99_RadioTrackTrainFactory__C_init_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg(
  outC__99_RadioTrackTrainFactory__C_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  outC->_L102.Header.radioDevice = kcg_lit_int64(0);
  outC->_L102.Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L102.Header.nid_message = kcg_lit_int64(0);
  outC->_L102.Header.t_train = kcg_lit_int64(0);
  outC->_L102.Header.m_ack = kcg_lit_int64(0);
  outC->_L102.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L102.Header.t_train_reference = kcg_lit_int64(0);
  outC->_L102.Header.nid_em = kcg_lit_int64(0);
  outC->_L102.Header.q_scale = kcg_lit_int64(0);
  outC->_L102.Header.d_sr = kcg_lit_int64(0);
  outC->_L102.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L102.Header.d_ref = kcg_lit_int64(0);
  outC->_L102.Header.q_dir = kcg_lit_int64(0);
  outC->_L102.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L102.Header.m_version = kcg_lit_int64(0);
  for (idx = 0; idx < 30; idx++) {
    outC->_L102.Messages.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L102.Messages.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L102.Messages.PacketHeaders[idx].valid = kcg_true;
    outC->_L102.Messages.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L102.Messages.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L102.Messages.PacketData[idx1] = kcg_lit_int64(0);
  }
  ...
  outC->_L89.Q_DIR = kcg_lit_int64(0);
  outC->_L89.L_PACKET = kcg_lit_int64(0);
  outC->_L89.T_MAR = kcg_lit_int64(0);
  outC->_L89.T_TIMEOUTRQST = kcg_lit_int64(0);
  outC->_L89.T_CYCRQST = kcg_lit_int64(0);
  ...
  outC->_L90.D_GRADIENT = kcg_lit_int64(0);
  outC->_L90.Q_GDIR = kcg_lit_int64(0);
  outC->_L90.G_A = kcg_lit_int64(0);
  outC->_L90.N_ITER = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L90.SECTIONS[idx2].D_GRADIENT = kcg_lit_int64(0);
    outC->_L90.SECTIONS[idx2].Q_GDIR = kcg_lit_int64(0);
    outC->_L90.SECTIONS[idx2].G_A = kcg_lit_int64(0);
  }
  ...
  outC->_L91.D_STATIC = kcg_lit_int64(0);
  outC->_L91.V_STATIC = kcg_lit_int64(0);
  outC->_L91.Q_FRONT = kcg_lit_int64(0);
  outC->_L91.N_ITER_n = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 32; idx3++) {
    outC->_L91.SECTIONS_q_diff[idx3].NC_DIFF = kcg_lit_int64(0);
    outC->_L91.SECTIONS_q_diff[idx3].V_DIFF = kcg_lit_int64(0);
  }
  outC->_L91.N_ITER_k = kcg_lit_int64(0);
  for (idx5 = 0; idx5 < 32; idx5++) {
    outC->_L91.SECTIONS_SSP[idx5].D_STATIC = kcg_lit_int64(0);
    outC->_L91.SECTIONS_SSP[idx5].V_STATIC = kcg_lit_int64(0);
    outC->_L91.SECTIONS_SSP[idx5].Q_FRONT = kcg_lit_int64(0);
    outC->_L91.SECTIONS_SSP[idx5].N_ITER = kcg_lit_int64(0);
    for (idx4 = 0; idx4 < 32; idx4++) {
      outC->_L91.SECTIONS_SSP[idx5].SECTIONS_q_diff[idx4].NC_DIFF = kcg_lit_int64(0);
      outC->_L91.SECTIONS_SSP[idx5].SECTIONS_q_diff[idx4].V_DIFF = kcg_lit_int64(0);
    }
  }
  ...
  outC->_L92.T_CYCLOC = kcg_lit_int64(0);
  outC->_L92.D_CYCLOC = kcg_lit_int64(0);
  outC->_L92.M_LOC = kcg_lit_int64(0);
  outC->_L92.N_ITER = kcg_lit_int64(0);
  for (idx6 = 0; idx6 < 32; idx6++) {
    outC->_L92.SECTIONS[idx6].D_LOC = kcg_lit_int64(0);
    outC->_L92.SECTIONS[idx6].Q_LGTLOC = kcg_lit_int64(0);
  }
...
void _99_RadioTrackTrainFactory__C_reset_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg(
  outC__99_RadioTrackTrainFactory__C_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg *outC)
{
  /* _L102=(RBC_SendMergeRadio_Pkg::SEND_MergeRadioPackets#2)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _99_RadioTrackTrainFactory__C_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
