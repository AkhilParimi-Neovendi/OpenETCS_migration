...
void C_compr_P009_init_TM_TrainToTrack(outC_C_compr_P009_TM_TrainToTrack *outC)
{
  ...
  outC->_L72.nid_ltrbg = kcg_lit_int64(0);
  ...
  outC->P009_out.nid_packet = kcg_lit_int64(0);
  outC->P009_out.l_packet = kcg_lit_int64(0);
  outC->P009_out.nid_ltrbg = kcg_lit_int64(0);
  /* _L71=(TM_conversions::CAST_Int_to_NID_LTRBG#1)/ */
