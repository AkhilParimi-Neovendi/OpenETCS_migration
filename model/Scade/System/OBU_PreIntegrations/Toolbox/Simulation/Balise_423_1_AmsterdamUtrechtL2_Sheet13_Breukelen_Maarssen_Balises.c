...
void Balise_423_1_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises(
  ...
  /* PIG_nom/ */
  kcg_int32 PIG_nom,
  outC_Balise_423_1_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_Balises::Packets_BG423#1)/ */
    Packets_BG423_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG423_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG423_1.Balise_data_out);
...
void Balise_423_1_init_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises(
  outC_Balise_423_1_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_Balises::Packets_BG423#1)/ */
  Packets_BG423_init_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises(
    &outC->Context_Packets_BG423_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_423_1_reset_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises(
  outC_Balise_423_1_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_Balises::Packets_BG423#1)/ */
  Packets_BG423_reset_AmsterdamUtrechtL2_Sheet13_Breukelen_Maarssen_Balises(
    &outC->Context_Packets_BG423_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
