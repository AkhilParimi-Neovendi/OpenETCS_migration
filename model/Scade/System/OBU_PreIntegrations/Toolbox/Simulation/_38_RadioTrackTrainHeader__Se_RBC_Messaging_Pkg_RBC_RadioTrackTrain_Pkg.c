...
void _38_RadioTrackTrainHeader__Se_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg(
...
{
  outC->_L2 = in_T_TRAIN_Ref;
  /* _L4=(TM_conversions::CAST_T_TRAIN_to_int#1)/ */
  CAST_T_TRAIN_to_int_TM_conversions(
    outC->_L2,
    &outC->Context_CAST_T_TRAIN_to_int_1);
  outC->_L4 = outC->Context_CAST_T_TRAIN_to_int_1.t_train_int;
  ...
  if (kcg_true) {
    outC->_L3.t_train_reference = outC->_L4;
  }
...
void _38_RadioTrackTrainHeader__Se_init_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg(
  outC__38_RadioTrackTrainHeader__Se_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg *outC)
{
...
void _38_RadioTrackTrainHeader__Se_reset_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg(
  outC__38_RadioTrackTrainHeader__Se_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg *outC)
{
  /* _L4=(TM_conversions::CAST_T_TRAIN_to_int#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _38_RadioTrackTrainHeader__Se_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
