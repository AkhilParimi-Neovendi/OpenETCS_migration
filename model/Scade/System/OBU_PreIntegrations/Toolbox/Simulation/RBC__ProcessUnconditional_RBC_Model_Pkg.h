...
*************************************************************$ */
#ifndef _RBC__ProcessUnconditional_RBC_Model_Pkg_H_
#define _RBC__ProcessUnconditional_RBC_Model_Pkg_H_
...
typedef struct {
  ...
  kcg_bool /* UNCONDITIONAL_EMERGENCY_STOP_SM: */ _1_UNCONDITIONAL_EMERGENCY_STOP_SM_reset_act;
  kcg_bool /* UNCONDITIONAL_EMERGENCY_STOP_SM: */ _2_UNCONDITIONAL_EMERGENCY_STOP_SM_reset_nxt;
  NID_EM /* radioTrackTrainMessageWasSentEmergencyStopId/ */ radioTrackTrainMessageWasSentEmergencyStopId;
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC__101_RadioTrackTrainHeade_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* UNCONDITIONAL_EMERGENCY_STOP_SM:SEND_UNCONDITIONAL_EMERGENCY_STOP:_L54=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_NID_EM#1)/ */ Context_RadioTrackTrainHeader__Get_NID_EM_1;
  outC_RadioTrackTrainMessage__G_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* UNCONDITIONAL_EMERGENCY_STOP_SM:SEND_UNCONDITIONAL_EMERGENCY_STOP:_L56=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__GetHeader#3)/ */ Context_RadioTrackTrainMessage__GetHeader_3;
  ...
  outC__103_RadioTrainTrackHeade_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* UNCONDITIONAL_EMERGENCY_STOP_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L27=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__Get_NID_EM#1)/ */ Context_RadioTrainTrackHeader__Get_NID_EM_1;
  outC__102_RadioTrainTrackHeade_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* UNCONDITIONAL_EMERGENCY_STOP_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L38=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__Get_Q_EMERGENCYSTOP#1)/ */ _3_Context_RadioTrainTrackHeader__Get_Q_EMERGENCYSTOP_1;
  outC_RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* UNCONDITIONAL_EMERGENCY_STOP_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L26=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__GetHeader#3)/ */ Context_RadioTrainTrackMessage__GetHeader_3;
  outC__50_RadioTrackTrainMessageQue_RBC_Collections_Pkg /* UNCONDITIONAL_EMERGENCY_STOP_SM:SEND_UNCONDITIONAL_EMERGENCY_STOP:_L57=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__TryPut#3)/ */ Context_RadioTrackTrainMessageQueue__TryPut_3;
  outC__51_RadioTrackTrainMessageQue_RBC_Collections_Pkg /* UNCONDITIONAL_EMERGENCY_STOP_SM:SEND_UNCONDITIONAL_EMERGENCY_STOP:_L59=(RBC_Collections_Pkg::RadioTrackTrainMessageQueueEntry__Create#3)/ */ _4_Context_RadioTrackTrainMessageQueueEntry__Create_3;
  outC_RadioTrackTrainHeader__Ge_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* _L63=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_NID_MESSAGE#1)/ */ _5_Context_RadioTrackTrainHeader__Get_NID_MESSAGE_1;
  outC_RadioTrackTrainMessage__G_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* _L65=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__GetHeader#1)/ */ _6_Context_RadioTrackTrainMessage__GetHeader_1;
  outC__100_RadioTrainTrackHeade_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* _L67=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__Get_NID_MESSAGE#1)/ */ _7_Context_RadioTrainTrackHeader__Get_NID_MESSAGE_1;
  outC_RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* _L66=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__GetHeader#1)/ */ _8_Context_RadioTrainTrackMessage__GetHeader_1;
  ...
  SSM_ST_UNCONDITIONAL_EMERGENCY_STOP_SM /* UNCONDITIONAL_EMERGENCY_STOP_SM: */ _9_UNCONDITIONAL_EMERGENCY_STOP_SM_state_act;
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  SessionManagement_T /* UNCONDITIONAL_EMERGENCY_STOP_SM:IDLE:_L3/ */ _L3_IDLE_UNCONDITIONAL_EMERGENCY_STOP_SM;
  _2_RadioTrackTrainMessageQueue_T /* UNCONDITIONAL_EMERGENCY_STOP_SM:IDLE:_L4/ */ _L4_IDLE_UNCONDITIONAL_EMERGENCY_STOP_SM;
  ...
  _2_RadioTrackTrainMessageQueue_T /* UNCONDITIONAL_EMERGENCY_STOP_SM:SEND_UNCONDITIONAL_EMERGENCY_STOP:_L62/ */ _L62_SEND_UNCONDITIONAL_EMERGENCY_STOP_UNCONDITIONAL_EMERGENCY_STOP_SM;
  ...
  _2_RadioTrackTrainMessageQueue_T /* UNCONDITIONAL_EMERGENCY_STOP_SM:SEND_UNCONDITIONAL_EMERGENCY_STOP:_L57/ */ _L57_SEND_UNCONDITIONAL_EMERGENCY_STOP_UNCONDITIONAL_EMERGENCY_STOP_SM;
  ...
  _2_RadioTrackTrainMessageQueue_T /* UNCONDITIONAL_EMERGENCY_STOP_SM:AWAIT_ACKNOWLEDGEMENT:_L3/ */ _L3_AWAIT_ACKNOWLEDGEMENT_UNCONDITIONAL_EMERGENCY_STOP_SM;
  ...
  _2_RadioTrackTrainMessageQueue_T /* UNCONDITIONAL_EMERGENCY_STOP_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L40/ */ _L40_TRY_PROCESS_ACKNOWLEDGEMENT_UNCONDITIONAL_EMERGENCY_STOP_SM;
  ...
  SSM_ST_UNCONDITIONAL_EMERGENCY_STOP_SM /* UNCONDITIONAL_EMERGENCY_STOP_SM: */ _10_UNCONDITIONAL_EMERGENCY_STOP_SM_state_sel;
  SSM_TR_UNCONDITIONAL_EMERGENCY_STOP_SM /* UNCONDITIONAL_EMERGENCY_STOP_SM: */ _11_UNCONDITIONAL_EMERGENCY_STOP_SM_fired_strong;
  SSM_TR_UNCONDITIONAL_EMERGENCY_STOP_SM /* UNCONDITIONAL_EMERGENCY_STOP_SM: */ _12_UNCONDITIONAL_EMERGENCY_STOP_SM_fired;
  ...
  _2_RadioTrackTrainMessageQueue_T /* _L80/ */ _L80;
...
} outC_RBC__ProcessUnconditional_RBC_Model_Pkg;

/* ===========  node initialization and cycle functions  =========== */
/* RBC_Model_Pkg::RBC__ProcessUnconditionalEmergencyStop/ */
extern void RBC__ProcessUnconditional_RBC_Model_Pkg(
  /* inDataBus/ */
...
extern void RBC__ProcessUnconditional_reset_RBC_Model_Pkg(
  outC_RBC__ProcessUnconditional_RBC_Model_Pkg *outC);

#ifndef KCG_USER_DEFINED_INIT
extern void RBC__ProcessUnconditional_init_RBC_Model_Pkg(
  outC_RBC__ProcessUnconditional_RBC_Model_Pkg *outC);
#endif /* KCG_USER_DEFINED_INIT */



#endif /* _RBC__ProcessUnconditional_RBC_Model_Pkg_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** RBC__ProcessUnconditional_RBC_Model_Pkg.h
** Generation date: 2023-09-12T13:45:50
*************************************************************$ */
