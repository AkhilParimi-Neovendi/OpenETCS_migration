...
void TrainData__SetNumberOfOnb_RBC_Session_Pkg(
  /* inTrainData/ */
...
{
  outC->_L2 = inNumberOfOnboardPhoneNumbers;
  kcg_copy_TrainData_T(&outC->_L1, inTrainData);
  kcg_copy_TrainData_T(&outC->_L3, &outC->_L1);
  if (kcg_true) {
    outC->_L3.m_NumberOfOnboardPhoneNumbers = outC->_L2;
  }
  kcg_copy_TrainData_T(&outC->outTrainData, &outC->_L3);
}

#ifndef KCG_USER_DEFINED_INIT
void TrainData__SetNumberOfOnb_init_RBC_Session_Pkg(
  outC_TrainData__SetNumberOfOnb_RBC_Session_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void TrainData__SetNumberOfOnb_reset_RBC_Session_Pkg(
  outC_TrainData__SetNumberOfOnb_RBC_Session_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** TrainData__SetNumberOfOnb_RBC_Session_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
