...
void C_P255_tracksim_compr_TM_conversions(
  /* P255_from_track/ */
  P255_trackside_int_T_TM *P255_from_track,
  outC_C_P255_tracksim_compr_TM_conversions *outC)
{
  ...
  outC->q_dir_int_CAST_Int_to_Q_DIR_1 = outC->_L389;
  ...
  /* _L390=(TM_lib_internal::T_Build_Metadata_Packet_ID#1)/ */
  ...
  outC->_L390 = outC->Context_T_Build_Metadata_Packet_ID_1.nid_packet_meta;
  ...
  outC->_L383[0] = outC->_L373[0];
  kcg_copy_array_int64_499(&outC->_L383[1], &outC->_L209);
...
void C_P255_tracksim_compr_init_TM_conversions(
  outC_C_P255_tracksim_compr_TM_conversions *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
/*
  Expanded instances for: TM_conversions::C_P255_tracksim_compr/
