...
void _34_UtrechtAmsterdamScenarioS_RBC_Scenario_Pkg(
  /* inSessionManagement/ */
  ...
  outC__34_UtrechtAmsterdamScenarioS_RBC_Scenario_Pkg *outC)
{
  ...
  LRBGDistanceToMeterConver_RBC_Converter_Pkg(
    outC->_L9,
    outC->_L11,
  ...
  _33_UtrechtAmsterdamScenarioS_RBC_Scenario_Pkg(
    outC->_L16,
    outC->_L12,
    outC->_L14,
...
void _34_UtrechtAmsterdamScenarioS_init_RBC_Scenario_Pkg(
  outC__34_UtrechtAmsterdamScenarioS_RBC_Scenario_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L12=(RBC_Converter_Pkg::LRBGDistanceToMeterConverter__Convert#1)/ */
  LRBGDistanceToMeterConver_init_RBC_Converter_Pkg(
    &outC->Context_LRBGDistanceToMeterConverter__Convert_1);
  /* _L11=(RBC_Session_Pkg::PosData__Get_Q_SCALE#1)/ */
...
void _34_UtrechtAmsterdamScenarioS_reset_RBC_Scenario_Pkg(
  outC__34_UtrechtAmsterdamScenarioS_RBC_Scenario_Pkg *outC)
{
  /* _L13=(RBC_Scenario_Pkg::UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages#1)/ */
  _33_UtrechtAmsterdamScenarioS_reset_RBC_Scenario_Pkg(
    &outC->Context_UtrechtAmsterdamScenarioStory00AWrapper__TriggerRadioTrackTrainMessages_1);
  /* _L14=(RBC_Time_Pkg::Clock__GetSeconds#1)/ */
  Clock__GetSeconds_reset_RBC_Time_Pkg(&outC->Context_Clock__GetSeconds_1);
  /* _L12=(RBC_Converter_Pkg::LRBGDistanceToMeterConverter__Convert#1)/ */
  LRBGDistanceToMeterConver_reset_RBC_Converter_Pkg(
    &outC->Context_LRBGDistanceToMeterConverter__Convert_1);
  /* _L11=(RBC_Session_Pkg::PosData__Get_Q_SCALE#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _34_UtrechtAmsterdamScenarioS_RBC_Scenario_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
