...
#include "kcg_types.h"
#include "RadioTrackTrainMessage__I_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg.h"
#include "DynamicConfig__GetNationa_RBC_Config_Pkg.h"
#include "NationalParams__Get_T_NVC_RBC_Config_Pkg.h"
...
typedef struct {
  ...
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC__50_RadioTrackTrainMessageQue_RBC_Collections_Pkg /* IfBlock1:then:_L14=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__TryPut#2)/ */ Context_RadioTrackTrainMessageQueue__TryPut_2;
  outC__51_RadioTrackTrainMessageQue_RBC_Collections_Pkg /* IfBlock1:then:_L15=(RBC_Collections_Pkg::RadioTrackTrainMessageQueueEntry__Create#2)/ */ _1_Context_RadioTrackTrainMessageQueueEntry__Create_2;
  outC__104_RadioTrackTrainFacto_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg /* IfBlock1:then:_L1=(RBC_Messaging_Pkg::RBC_RadioTrackTrainFactory_Pkg::RadioTrackTrainFactory__CreateMsg024_BSL2#1)/ */ Context_RadioTrackTrainFactory__CreateMsg024_BSL2_1;
  ...
  outC_SessionManagement__GetPosData_RBC_Session_Pkg /* IfBlock1:then:_L21=(RBC_Session_Pkg::SessionManagement__GetPosData#3)/ */ _2_Context_SessionManagement__GetPosData_3;
  outC__48_RadioTrackTrainMessageQue_RBC_Collections_Pkg /* _L74=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__GetRemainingCapacity#1)/ */ _3_Context_RadioTrackTrainMessageQueue__GetRemainingCapacity_1;
  outC_Clock__GetSeconds_RBC_Time_Pkg /* _L124=(RBC_Time_Pkg::Clock__GetSeconds#1)/ */ Context_Clock__GetSeconds_1;
  outC_RadioTrackTrainMessage__I_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* _L115=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__IsValid#2)/ */ Context_RadioTrackTrainMessage__IsValid_2;
  outC__55_RadioTrackTrainHeader__Ge_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* _L112=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_T_TRAIN#2)/ */ Context_RadioTrackTrainHeader__Get_T_TRAIN_2;
  outC_RadioTrackTrainMessage__G_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* _L114=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__GetHeader#2)/ */ _4_Context_RadioTrackTrainMessage__GetHeader_2;
  outC_NationalParams__Get_T_NVC_RBC_Config_Pkg /* _L75=(RBC_Config_Pkg::NationalParams__Get_T_NVCONTACT#1)/ */ Context_NationalParams__Get_T_NVCONTACT_1;
  outC_DynamicConfig__GetNationa_RBC_Config_Pkg /* _L76=(RBC_Config_Pkg::DynamicConfig__GetNationalParams#1)/ */ Context_DynamicConfig__GetNationalParams_1;
  ...
  _2_RadioTrackTrainMessageQueue_T /* IfBlock1:then:_L28/ */ _L28_then_IfBlock1;
  ...
  _2_RadioTrackTrainMessageQueue_T /* IfBlock1:then:_L14/ */ _L14_then_IfBlock1;
  ...
  _2_RadioTrackTrainMessageQueue_T /* IfBlock1:else:_L4/ */ _L4_else_IfBlock1;
  ...
  _2_RadioTrackTrainMessageQueue_T /* _L131/ */ _L131;
  ...
  _2_RadioTrackTrainMessageQueue_T /* _L140/ */ _L140;
