  ...
  outC_C_P041_tracksim_compr_TM_conversions *outC)
{
  ...
  kcg_copy_array_int32_5(&outC->_L381[0], &outC->_L373);
  outC->_L381[5] = outC->_L376[0];
  kcg_copy_array_int32_6(&outC->_L384[0], &outC->_L381);
  ...
  kcg_copy_array_int32_105(&outC->_L383[0], &outC->_L384);
  kcg_copy_array_int32_395(&outC->_L383[105], &outC->_L209);
  /* _L379=(TM_lib_internal::T_DeterminePacketSizeInt#1)/ */
  T_DeterminePacketSizeInt_TM_lib_internal(
    outC->_L369,
    kcg_lit_int32(5) + kcg_lit_int32(1) + kcg_lit_int32(3),
    kcg_lit_int32(3),
  ...
  outC_C_P041_tracksim_compr_TM_conversions *outC)
{
  ...
  for (idx = 0; idx < 33; idx++) {
    outC->_L385[idx].M_LEVELTR = kcg_lit_int32(0);
    outC->_L385[idx].NID_NTC = kcg_lit_int32(0);
    outC->_L385[idx].L_ACKLEVELTR = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 1; idx1++) {
    outC->_L386[idx1].M_LEVELTR = kcg_lit_int32(0);
    outC->_L386[idx1].NID_NTC = kcg_lit_int32(0);
    outC->_L386[idx1].L_ACKLEVELTR = kcg_lit_int32(0);
  }
  ...
  outC->_L375.M_LEVELTR = kcg_lit_int32(0);
  outC->_L375.NID_NTC = kcg_lit_int32(0);
  outC->_L375.L_ACKLEVELTR = kcg_lit_int32(0);
  for (idx7 = 0; idx7 < 5; idx7++) {
    outC->_L373[idx7] = kcg_lit_int32(0);
  }
  for (idx8 = 0; idx8 < 32; idx8++) {
    outC->_L368[idx8].M_LEVELTR = kcg_lit_int32(0);
    outC->_L368[idx8].NID_NTC = kcg_lit_int32(0);
    outC->_L368[idx8].L_ACKLEVELTR = kcg_lit_int32(0);
  }
  ...
  for (idx10 = 0; idx10 < 32; idx10++) {
    outC->_L1.SECTIONS[idx10].M_LEVELTR = kcg_lit_int32(0);
    outC->_L1.SECTIONS[idx10].NID_NTC = kcg_lit_int32(0);
    outC->_L1.SECTIONS[idx10].L_ACKLEVELTR = kcg_lit_int32(0);
  }
