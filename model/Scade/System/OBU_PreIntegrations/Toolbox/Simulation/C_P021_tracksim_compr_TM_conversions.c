  ...
  outC_C_P021_tracksim_compr_TM_conversions *outC)
{
  ...
  kcg_copy_array_int64_104(&outC->_L383[0], &outC->_L384);
  kcg_copy_array_int64_396(&outC->_L383[104], &outC->_L209);
  /* _L379=(TM_lib_internal::T_DeterminePacketSizeInt#1)/ */
  T_DeterminePacketSizeInt_TM_lib_internal(
    outC->_L370,
    kcg_lit_int64(4) + kcg_lit_int64(1) + kcg_lit_int64(3),
    kcg_lit_int64(3),
  ...
  outC_C_P021_tracksim_compr_TM_conversions *outC)
{
  ...
  for (idx = 0; idx < 1; idx++) {
    outC->_L386[idx].D_GRADIENT = kcg_lit_int64(0);
    outC->_L386[idx].Q_GDIR = kcg_lit_int64(0);
    outC->_L386[idx].G_A = kcg_lit_int64(0);
  }
  outC->_L387 = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 33; idx1++) {
    outC->_L385[idx1].D_GRADIENT = kcg_lit_int64(0);
    outC->_L385[idx1].Q_GDIR = kcg_lit_int64(0);
    outC->_L385[idx1].G_A = kcg_lit_int64(0);
  }
  ...
  outC->_L375.D_GRADIENT = kcg_lit_int64(0);
  outC->_L375.Q_GDIR = kcg_lit_int64(0);
  outC->_L375.G_A = kcg_lit_int64(0);
  for (idx7 = 0; idx7 < 4; idx7++) {
    outC->_L373[idx7] = kcg_lit_int64(0);
  }
  for (idx8 = 0; idx8 < 32; idx8++) {
    outC->_L369[idx8].D_GRADIENT = kcg_lit_int64(0);
    outC->_L369[idx8].Q_GDIR = kcg_lit_int64(0);
    outC->_L369[idx8].G_A = kcg_lit_int64(0);
  }
  ...
  for (idx10 = 0; idx10 < 32; idx10++) {
    outC->_L1.SECTIONS[idx10].D_GRADIENT = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx10].Q_GDIR = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx10].G_A = kcg_lit_int64(0);
  }
