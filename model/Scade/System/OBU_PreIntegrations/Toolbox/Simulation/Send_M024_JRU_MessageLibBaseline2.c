...
void Send_M024_JRU_MessageLibBaseline2(
  /* M024/ */
  M_024_int_T_TM_radio_messages *M024,
  outC_Send_M024_JRU_MessageLibBaseline2 *outC)
{
  kcg_copy_M_024_int_T_TM_radio_messages(&outC->_L1, M024);
  /* _L2=(TM_RBC_conversions::C_M024_int_to_header#1)/ */
  C_M024_int_to_header_TM_RBC_conversions(
    &outC->_L1,
    &outC->Context_C_M024_int_to_header_1);
  kcg_copy_M_TrackTrain_Radio_T_TM_radio_messages(
    &outC->_L2,
    &outC->Context_C_M024_int_to_header_1.Message_Header_Out);
  kcg_copy_M_TrackTrain_Radio_T_TM_radio_messages(&outC->Message_Out, &outC->_L2);
}

#ifndef KCG_USER_DEFINED_INIT
void Send_M024_JRU_init_MessageLibBaseline2(
  outC_Send_M024_JRU_MessageLibBaseline2 *outC)
{
  ...
  /* _L2=(TM_RBC_conversions::C_M024_int_to_header#1)/ */
  C_M024_int_to_header_init_TM_RBC_conversions(
    &outC->Context_C_M024_int_to_header_1);
}
...
{
  /* _L2=(TM_RBC_conversions::C_M024_int_to_header#1)/ */
  C_M024_int_to_header_reset_TM_RBC_conversions(
    &outC->Context_C_M024_int_to_header_1);
}
