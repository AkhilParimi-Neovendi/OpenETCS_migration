...
{
  /* m_version_int/ */
  kcg_int32 m_version_int_partial;
  /* error/ */
  kcg_bool error_partial;
  /* m_version_int/ */
  kcg_int32 _1_m_version_int_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* m_version_int/ */
  kcg_int32 _3_m_version_int_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* m_version_int/ */
  kcg_int32 _5_m_version_int_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* error/ */
  kcg_bool _7_error_partial;
  /* m_version_int/ */
  kcg_int32 _8_m_version_int_partial;
  /* error/ */
  kcg_bool _9_error_partial;
  /* m_version_int/ */
  kcg_int32 _10_m_version_int_partial;
  /* error/ */
  kcg_bool _11_error_partial;
  /* m_version_int/ */
  kcg_int32 _12_m_version_int_partial;
  /* error/ */
  kcg_bool _13_error_partial;
  /* m_version_int/ */
  kcg_int32 _14_m_version_int_partial;
  kcg_bool noname;
