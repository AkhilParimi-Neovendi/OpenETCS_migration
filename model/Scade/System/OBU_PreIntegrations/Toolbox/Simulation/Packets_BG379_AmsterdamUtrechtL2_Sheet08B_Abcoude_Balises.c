  ...
  outC_Packets_BG379_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises *outC)
{
  ...
  for (idx20 = 0; idx20 < 30; idx20++) {
    outC->_L1_No_Packet_10.PacketHeaders[idx20].nid_packet = kcg_lit_int32(0);
    outC->_L1_No_Packet_10.PacketHeaders[idx20].q_dir = Q_DIR_Reverse;
    outC->_L1_No_Packet_10.PacketHeaders[idx20].valid = kcg_true;
    outC->_L1_No_Packet_10.PacketHeaders[idx20].startAddress = kcg_lit_int32(0);
    outC->_L1_No_Packet_10.PacketHeaders[idx20].endAddress = kcg_lit_int32(0);
  }
  for (idx21 = 0; idx21 < 500; idx21++) {
    outC->_L1_No_Packet_10.PacketData[idx21] = kcg_lit_int32(0);
  }
  for (idx22 = 0; idx22 < 30; idx22++) {
    outC->B_data_in_No_Packet_10.PacketHeaders[idx22].nid_packet = kcg_lit_int32(0);
    ...
    outC->B_data_in_No_Packet_10.PacketHeaders[idx22].startAddress =
      kcg_lit_int32(0);
    outC->B_data_in_No_Packet_10.PacketHeaders[idx22].endAddress = kcg_lit_int32(0);
  }
  for (idx23 = 0; idx23 < 500; idx23++) {
    outC->B_data_in_No_Packet_10.PacketData[idx23] = kcg_lit_int32(0);
  }
  ...
  for (idx25 = 0; idx25 < 500; idx25++) {
    outC->B_data_out_No_Packet_10.PacketData[idx25] = kcg_lit_int32(0);
  }
  ...
  for (idx27 = 0; idx27 < 500; idx27++) {
    outC->Balise_data_out.packets.PacketData[idx27] = kcg_lit_int32(0);
  }
