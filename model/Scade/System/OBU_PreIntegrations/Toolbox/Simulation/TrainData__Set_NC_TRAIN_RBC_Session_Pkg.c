  ...
  outC_TrainData__Set_NC_TRAIN_RBC_Session_Pkg *outC)
{
  ...
  outC->out_TrainData.nid_engine = kcg_lit_int32(0);
  outC->out_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int32(0);
  ...
  outC->out_TrainData.t_train_ref = kcg_lit_int32(0);
  outC->out_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->out_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->out_TrainData.l_train = kcg_lit_int32(0);
  outC->out_TrainData.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->out_TrainData.n_axle = kcg_lit_int32(0);
  ...
  for (idx11 = 0; idx11 < 5; idx11++) {
    outC->out_TrainData.m_NationalSystemIdentities[idx11] = kcg_lit_int32(0);
  }
  outC->out_TrainData.nid_operational = kcg_lit_int32(0);
}
