  ...
  outC_Send_P027V1_MessageLibBaseline2 *outC)
{
  ...
  outC->_L4.Q_FRONT = kcg_lit_int64(0);
  outC->_L4.N_ITER_n = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L4.SECTIONS_q_diff[idx2].NC_DIFF = kcg_lit_int64(0);
    outC->_L4.SECTIONS_q_diff[idx2].V_DIFF = kcg_lit_int64(0);
  }
  outC->_L4.N_ITER_k = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->_L4.SECTIONS_SSP[idx4].D_STATIC = kcg_lit_int64(0);
    outC->_L4.SECTIONS_SSP[idx4].V_STATIC = kcg_lit_int64(0);
    outC->_L4.SECTIONS_SSP[idx4].Q_FRONT = kcg_lit_int64(0);
    outC->_L4.SECTIONS_SSP[idx4].N_ITER = kcg_lit_int64(0);
    for (idx3 = 0; idx3 < 32; idx3++) {
      outC->_L4.SECTIONS_SSP[idx4].SECTIONS_q_diff[idx3].NC_DIFF = kcg_lit_int64(0);
      outC->_L4.SECTIONS_SSP[idx4].SECTIONS_q_diff[idx3].V_DIFF = kcg_lit_int64(0);
    }
  }
  for (idx5 = 0; idx5 < 30; idx5++) {
    outC->_L3.PacketHeaders[idx5].nid_packet = kcg_lit_int64(0);
    outC->_L3.PacketHeaders[idx5].q_dir = Q_DIR_Reverse;
    outC->_L3.PacketHeaders[idx5].valid = kcg_true;
    outC->_L3.PacketHeaders[idx5].startAddress = kcg_lit_int64(0);
    outC->_L3.PacketHeaders[idx5].endAddress = kcg_lit_int64(0);
  }
  for (idx6 = 0; idx6 < 500; idx6++) {
    outC->_L3.PacketData[idx6] = kcg_lit_int64(0);
  }
  outC->every = kcg_true;
  for (idx7 = 0; idx7 < 30; idx7++) {
    outC->B_data_out.PacketHeaders[idx7].nid_packet = kcg_lit_int64(0);
    outC->B_data_out.PacketHeaders[idx7].q_dir = Q_DIR_Reverse;
    outC->B_data_out.PacketHeaders[idx7].valid = kcg_true;
    outC->B_data_out.PacketHeaders[idx7].startAddress = kcg_lit_int64(0);
    outC->B_data_out.PacketHeaders[idx7].endAddress = kcg_lit_int64(0);
  }
  for (idx8 = 0; idx8 < 500; idx8++) {
    outC->B_data_out.PacketData[idx8] = kcg_lit_int64(0);
  }
  /* _L6=(TM_trackside_baseline2::Write_P027V1#1)/ */
