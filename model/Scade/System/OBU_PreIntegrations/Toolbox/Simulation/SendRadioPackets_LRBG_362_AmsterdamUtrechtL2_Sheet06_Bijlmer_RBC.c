...
#include "SendRadioPackets_LRBG_362_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC.h"

/* AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::SendRadioPackets_LRBG_362_D_00230_7_M003/ */
void SendRadioPackets_LRBG_362_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
  /* Radio_packets_in/ */
  CompressedPackets_T_Common_Types_Pkg *Radio_packets_in,
  outC_SendRadioPackets_LRBG_362_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC *outC)
{
...
void SendRadioPackets_LRBG_362_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
  outC_SendRadioPackets_LRBG_362_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L5.PacketHeaders[idx6].nid_packet = kcg_lit_int64(0);
    outC->_L5.PacketHeaders[idx6].q_dir = Q_DIR_Reverse;
    outC->_L5.PacketHeaders[idx6].valid = kcg_true;
    outC->_L5.PacketHeaders[idx6].startAddress = kcg_lit_int64(0);
    outC->_L5.PacketHeaders[idx6].endAddress = kcg_lit_int64(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->_L5.PacketData[idx7] = kcg_lit_int64(0);
  }
...
void SendRadioPackets_LRBG_362_reset_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
  outC_SendRadioPackets_LRBG_362_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC *outC)
{
  /* _L7=(MessageLibBaseline2::Send_P065#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** SendRadioPackets_LRBG_362_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC.c
** Generation date: 2023-09-12T13:45:52
*************************************************************$ */
