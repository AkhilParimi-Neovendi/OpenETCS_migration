...
#include "DynamicConfig__GetPosRepP_RBC_Config_Pkg.h"

/* RBC_Config_Pkg::DynamicConfig__GetPosRepParams/ */
void DynamicConfig__GetPosRepP_RBC_Config_Pkg(
  /* inDynamicConfig/ */
  DynamicConfig_T *inDynamicConfig,
  outC_DynamicConfig__GetPosRepP_RBC_Config_Pkg *outC)
{
...
void DynamicConfig__GetPosRepP_init_RBC_Config_Pkg(
  outC_DynamicConfig__GetPosRepP_RBC_Config_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  outC->_L2.m_NumberOfIncrementalDistancesAndQualifiers = kcg_lit_int64(0);
  for (idx = 0; idx < 32; idx++) {
    outC->_L2.m_IncrementalDistancesAndQualifiers[idx].d_loc = kcg_lit_int64(0);
  ...
  outC->outPosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->outPosRepParams.d_cycloc = kcg_lit_int64(0);
...
void DynamicConfig__GetPosRepP_reset_RBC_Config_Pkg(
  outC_DynamicConfig__GetPosRepP_RBC_Config_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** DynamicConfig__GetPosRepP_RBC_Config_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
