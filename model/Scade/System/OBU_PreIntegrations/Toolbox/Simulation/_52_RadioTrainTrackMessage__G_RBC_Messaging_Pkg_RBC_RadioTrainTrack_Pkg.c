...
void _52_RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
  /* inRadioTrainTrackMessage/ */
  Radio_TrainTrack_Message_T_Radio_Types_Pkg *inRadioTrainTrackMessage,
  outC__52_RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
...
void _52_RadioTrainTrackMessage__G_init_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
  outC__52_RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  outC->outRadioTrainTrackPackets.p0.packet0.NID_PACKET = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p0.packet0.L_PACKET = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->outRadioTrainTrackPackets.p0.packet0.NID_LRBG = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p0.packet0.D_LRBG = kcg_lit_int64(0);
  ...
  outC->outRadioTrainTrackPackets.p0.packet0.L_DOUBTOVER = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p0.packet0.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->outRadioTrainTrackPackets.p0.packet0.L_TRAININT = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p0.packet0.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->outRadioTrainTrackPackets.p0.packet0.NID_NTC = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p1.valid = kcg_true;
  outC->outRadioTrainTrackPackets.p1.packet1.NID_PACKET = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p1.packet1.L_PACKET = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->outRadioTrainTrackPackets.p1.packet1.NID_LRBG = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p1.packet1.NID_PRVLRBG = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p1.packet1.D_LRBG = kcg_lit_int64(0);
  ...
  outC->outRadioTrainTrackPackets.p1.packet1.L_DOUBTOVER = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p1.packet1.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->outRadioTrainTrackPackets.p1.packet1.L_TRAININT = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p1.packet1.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->outRadioTrainTrackPackets.p1.packet1.NID_NTC = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p3.valid = kcg_true;
  outC->outRadioTrainTrackPackets.p3.number = kcg_lit_int64(0);
  ...
  outC->outRadioTrainTrackPackets.p5.TrainRunningNumber = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p9.valid = kcg_true;
  outC->outRadioTrainTrackPackets.p9.transitionInformation = kcg_lit_int64(0);
  ...
  outC->outRadioTrainTrackPackets.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->outRadioTrainTrackPackets.p11.l_train = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p11.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->outRadioTrainTrackPackets.p11.n_axle = kcg_lit_int64(0);
  outC->outRadioTrainTrackPackets.p11.nIter_tractionIdentity = kcg_lit_int64(0);
  ...
  outC->outRadioTrainTrackPackets.p11.nIter_ntc = kcg_lit_int64(0);
  for (idx11 = 0; idx11 < 5; idx11++) {
    outC->outRadioTrainTrackPackets.p11.nid_ntc[idx11] = kcg_lit_int64(0);
  }
}
#endif /* KCG_USER_DEFINED_INIT */


void _52_RadioTrainTrackMessage__G_reset_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
  outC__52_RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _52_RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
