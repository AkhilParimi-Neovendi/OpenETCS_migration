...
void Balise_366_0_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
  ...
  /* PIG_nom/ */
  kcg_int64 PIG_nom,
  outC_Balise_366_0_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet06_Bijlmer_Balises::Packets_BG366#1)/ */
    Packets_BG366_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG366_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG366_1.Balise_data_out);
...
void Balise_366_0_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
  outC_Balise_366_0_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet06_Bijlmer_Balises::Packets_BG366#1)/ */
  Packets_BG366_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
    &outC->Context_Packets_BG366_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_366_0_reset_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
  outC_Balise_366_0_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet06_Bijlmer_Balises::Packets_BG366#1)/ */
  Packets_BG366_reset_AmsterdamUtrechtL2_Sheet06_Bijlmer_Balises(
    &outC->Context_Packets_BG366_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
