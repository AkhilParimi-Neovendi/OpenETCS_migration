...
void Balise_Group_381_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
  ...
  outC_Balise_Group_381_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises *outC)
{
  kcg_bool noname;
  ...
  /* _L8=(AmsterdamUtrechtL2::Sheet08B_Abcoude_Balises::Balise_381_1#1)/ */
  Balise_381_1_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
    &outC->_L9,
    (BaliseTelegramHeader_int_T_TM *) &BG381_header_B1_Balises426,
    outC->_L20,
    &outC->Context_Balise_381_1_1);
  kcg_copy_B_data_internal_T_InfraLib(
    &outC->_L8,
    &outC->Context_Balise_381_1_1.B_data_out);
  outC->_L21 = kcg_lit_int32(1);
  /* _L7=(AmsterdamUtrechtL2::Sheet08B_Abcoude_Balises::Balise_381_0#1)/ */
  Balise_381_0_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
    &outC->_L8,
    (BaliseTelegramHeader_int_T_TM *) &BG381_header_B0_Balises426,
    outC->_L21,
    &outC->Context_Balise_381_0_1);
  kcg_copy_B_data_internal_T_InfraLib(
    &outC->_L7,
    &outC->Context_Balise_381_0_1.B_data_out);
...
void Balise_Group_381_init_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
  outC_Balise_Group_381_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L7=(AmsterdamUtrechtL2::Sheet08B_Abcoude_Balises::Balise_381_0#1)/ */
  Balise_381_0_init_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
    &outC->Context_Balise_381_0_1);
  /* _L8=(AmsterdamUtrechtL2::Sheet08B_Abcoude_Balises::Balise_381_1#1)/ */
  Balise_381_1_init_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
    &outC->Context_Balise_381_1_1);
  /* _L11=(InfraLib::Balise_Group_Init#1)/ */
...
void Balise_Group_381_reset_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
  outC_Balise_Group_381_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises *outC)
{
  /* _L14=(InfraLib::Balise_Group_Close#1)/ */
  Balise_Group_Close_reset_InfraLib(&outC->Context_Balise_Group_Close_1);
  /* _L7=(AmsterdamUtrechtL2::Sheet08B_Abcoude_Balises::Balise_381_0#1)/ */
  Balise_381_0_reset_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
    &outC->Context_Balise_381_0_1);
  /* _L8=(AmsterdamUtrechtL2::Sheet08B_Abcoude_Balises::Balise_381_1#1)/ */
  Balise_381_1_reset_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
    &outC->Context_Balise_381_1_1);
  /* _L11=(InfraLib::Balise_Group_Init#1)/ */
