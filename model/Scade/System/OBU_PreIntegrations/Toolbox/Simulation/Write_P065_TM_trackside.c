...
void Write_P065_TM_trackside(
  /* Packet65/ */
  P065_trackside_int_T_TM *Packet65,
  /* Packets/ */
  CompressedPackets_T_Common_Types_Pkg *Packets,
  outC_Write_P065_TM_trackside *outC)
{
  kcg_copy_P065_trackside_int_T_TM(&outC->_L1, Packet65);
  /* _L43=(TM_conversions::C_P065_tracksim_compr#1)/ */
  C_P065_tracksim_compr_TM_conversions(
    &outC->_L1,
    &outC->Context_C_P065_tracksim_compr_1);
  kcg_copy_MetadataElement_T_Common_Types_Pkg(
    &outC->_L43,
    &outC->Context_C_P065_tracksim_compr_1.Header);
  kcg_copy_CompressedPacketData_T_Common_Types_Pkg(
    &outC->_L44,
    &outC->Context_C_P065_tracksim_compr_1.P065_compressed);
...
void Write_P065_init_TM_trackside(outC_Write_P065_TM_trackside *outC)
{
  kcg_size idx;
  kcg_size idx1;
  kcg_size idx2;
  ...
  outC->_L1.NID_TSR = kcg_lit_int64(0);
  outC->_L1.D_TSR = kcg_lit_int64(0);
  outC->_L1.L_TSR = kcg_lit_int64(0);
  outC->_L1.Q_FRONT = kcg_lit_int64(0);
  outC->_L1.V_TSR = kcg_lit_int64(0);
  ...
  SEND_WriteBaliseMessageHeader_init_TM_lib_internal(
    &outC->Context_SEND_WriteBaliseMessageHeader_1);
  /* _L43=(TM_conversions::C_P065_tracksim_compr#1)/ */
  C_P065_tracksim_compr_init_TM_conversions(
    &outC->Context_C_P065_tracksim_compr_1);
}
...
void Write_P065_reset_TM_trackside(outC_Write_P065_TM_trackside *outC)
{
  ...
  SEND_WriteBaliseMessageHeader_reset_TM_lib_internal(
    &outC->Context_SEND_WriteBaliseMessageHeader_1);
  /* _L43=(TM_conversions::C_P065_tracksim_compr#1)/ */
  C_P065_tracksim_compr_reset_TM_conversions(
    &outC->Context_C_P065_tracksim_compr_1);
}
