...
#include "Send_RBC_LRBG_100_D_00110_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone.h"

/* AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Send_RBC_LRBG_100_D_00110_0_M024/ */
void Send_RBC_LRBG_100_D_00110_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  /* RadiaDataIn/ */
  R_data_internal_T_InfraLib *RadiaDataIn,
  /* TriggerValue/ */
  kcg_int64 TriggerValue,
  outC_Send_RBC_LRBG_100_D_00110_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Build_RBC_Message_LRBG_100_D_00110_0_M024#1)/ */
    _152_Build_RBC_Message_LR_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
      &outC->_L53,
      &outC->Context_Build_RBC_Message_LRBG_100_D_00110_0_M024_1);
    kcg_copy_R_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Build_RBC_Message_LRBG_100_D_00110_0_M024_1.R_data_out);
...
void Send_RBC_LRBG_100_D_00110_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  outC_Send_RBC_LRBG_100_D_00110_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L53.packets.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L53.packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L53.packets.PacketHeaders[idx].valid = kcg_true;
    outC->_L53.packets.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L53.packets.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L53.packets.PacketData[idx1] = kcg_lit_int64(0);
  }
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Build_RBC_Message_LRBG_100_D_00110_0_M024#1)/ */
  _152_Build_RBC_Message_LR_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->Context_Build_RBC_Message_LRBG_100_D_00110_0_M024_1);
}
...
void Send_RBC_LRBG_100_D_00110_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  outC_Send_RBC_LRBG_100_D_00110_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Build_RBC_Message_LRBG_100_D_00110_0_M024#1)/ */
  _152_Build_RBC_Message_LR_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->Context_Build_RBC_Message_LRBG_100_D_00110_0_M024_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Send_RBC_LRBG_100_D_00110_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone.c
** Generation date: 2023-09-12T13:45:52
*************************************************************$ */
