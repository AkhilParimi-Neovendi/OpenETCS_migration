  ...
  outC_Write_P027V1_TM_trackside_baseline2 *outC)
{
  ...
  kcg_size idx1;
  kcg_size idx2;
  CompressedPackets_T_Common_Types_Pkg acc;
  kcg_size idx3;
  kcg_int32 noname;
  ...
  if (outC->_L52) {
    ...
    for (idx3 = 0; idx3 < 33; idx3++) {
      ...
      outC->_L50 = /* _L50= */(kcg_int32) (idx3 + 1);
      /* _L50= */
  ...
  outC_Write_P027V1_TM_trackside_baseline2 *outC)
{
  ...
  for (idx2 = 0; idx2 < 33; idx2++) {
    outC->_L55[idx2] = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 33; idx3++) {
    outC->_L54[idx3] = kcg_lit_int32(0);
  }
  outC->_L52 = kcg_true;
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L51.PacketHeaders[idx4].nid_packet = kcg_lit_int32(0);
    outC->_L51.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L51.PacketHeaders[idx4].valid = kcg_true;
    outC->_L51.PacketHeaders[idx4].startAddress = kcg_lit_int32(0);
    outC->_L51.PacketHeaders[idx4].endAddress = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L51.PacketData[idx5] = kcg_lit_int32(0);
  }
  outC->_L50 = kcg_lit_int32(0);
  outC->_L46 = kcg_lit_int32(0);
  for (idx7 = 0; idx7 < 33; idx7++) {
    outC->_L45[idx7].D_STATIC = kcg_lit_int32(0);
    outC->_L45[idx7].V_STATIC = kcg_lit_int32(0);
    outC->_L45[idx7].Q_FRONT = kcg_lit_int32(0);
    outC->_L45[idx7].N_ITER = kcg_lit_int32(0);
    for (idx6 = 0; idx6 < 32; idx6++) {
      outC->_L45[idx7].SECTIONS_q_diff[idx6].NC_DIFF = kcg_lit_int32(0);
      outC->_L45[idx7].SECTIONS_q_diff[idx6].V_DIFF = kcg_lit_int32(0);
    }
  }
  ...
  for (idx8 = 0; idx8 < 500; idx8++) {
    outC->_L44[idx8] = kcg_lit_int32(0);
  }
  for (idx9 = 0; idx9 < 30; idx9++) {
    outC->_L41[idx9].nid_packet = kcg_lit_int32(0);
    outC->_L41[idx9].q_dir = Q_DIR_Reverse;
    outC->_L41[idx9].valid = kcg_true;
    outC->_L41[idx9].startAddress = kcg_lit_int32(0);
    outC->_L41[idx9].endAddress = kcg_lit_int32(0);
  }
  for (idx10 = 0; idx10 < 500; idx10++) {
    outC->_L42[idx10] = kcg_lit_int32(0);
  }
  for (idx11 = 0; idx11 < 30; idx11++) {
    outC->_L40.PacketHeaders[idx11].nid_packet = kcg_lit_int32(0);
    outC->_L40.PacketHeaders[idx11].q_dir = Q_DIR_Reverse;
    outC->_L40.PacketHeaders[idx11].valid = kcg_true;
    outC->_L40.PacketHeaders[idx11].startAddress = kcg_lit_int32(0);
    outC->_L40.PacketHeaders[idx11].endAddress = kcg_lit_int32(0);
  }
  for (idx12 = 0; idx12 < 500; idx12++) {
    outC->_L40.PacketData[idx12] = kcg_lit_int32(0);
  }
  for (idx13 = 0; idx13 < 30; idx13++) {
    outC->_L39.PacketHeaders[idx13].nid_packet = kcg_lit_int32(0);
    outC->_L39.PacketHeaders[idx13].q_dir = Q_DIR_Reverse;
    outC->_L39.PacketHeaders[idx13].valid = kcg_true;
    outC->_L39.PacketHeaders[idx13].startAddress = kcg_lit_int32(0);
    outC->_L39.PacketHeaders[idx13].endAddress = kcg_lit_int32(0);
  }
  for (idx14 = 0; idx14 < 500; idx14++) {
    outC->_L39.PacketData[idx14] = kcg_lit_int32(0);
  }
  outC->_L22 = kcg_lit_int32(0);
  outC->_L21 = kcg_lit_int32(0);
  outC->_L18 = kcg_true;
  for (idx15 = 0; idx15 < 500; idx15++) {
    outC->_L10[idx15] = kcg_lit_int32(0);
  }
  for (idx16 = 0; idx16 < 30; idx16++) {
    outC->_L4[idx16].nid_packet = kcg_lit_int32(0);
    outC->_L4[idx16].q_dir = Q_DIR_Reverse;
    outC->_L4[idx16].valid = kcg_true;
    outC->_L4[idx16].startAddress = kcg_lit_int32(0);
    outC->_L4[idx16].endAddress = kcg_lit_int32(0);
  }
  ...
  for (idx17 = 0; idx17 < 32; idx17++) {
    outC->_L1.SECTIONS_q_diff[idx17].NC_DIFF = kcg_lit_int32(0);
    outC->_L1.SECTIONS_q_diff[idx17].V_DIFF = kcg_lit_int32(0);
  }
  outC->_L1.N_ITER_k = kcg_lit_int32(0);
  for (idx19 = 0; idx19 < 32; idx19++) {
    outC->_L1.SECTIONS_SSP[idx19].D_STATIC = kcg_lit_int32(0);
    outC->_L1.SECTIONS_SSP[idx19].V_STATIC = kcg_lit_int32(0);
    outC->_L1.SECTIONS_SSP[idx19].Q_FRONT = kcg_lit_int32(0);
    outC->_L1.SECTIONS_SSP[idx19].N_ITER = kcg_lit_int32(0);
    for (idx18 = 0; idx18 < 32; idx18++) {
      outC->_L1.SECTIONS_SSP[idx19].SECTIONS_q_diff[idx18].NC_DIFF = kcg_lit_int32(0);
      outC->_L1.SECTIONS_SSP[idx19].SECTIONS_q_diff[idx18].V_DIFF = kcg_lit_int32(0);
    }
  }
  for (idx20 = 0; idx20 < 30; idx20++) {
    outC->PacketsOut.PacketHeaders[idx20].nid_packet = kcg_lit_int32(0);
    outC->PacketsOut.PacketHeaders[idx20].q_dir = Q_DIR_Reverse;
    outC->PacketsOut.PacketHeaders[idx20].valid = kcg_true;
    outC->PacketsOut.PacketHeaders[idx20].startAddress = kcg_lit_int32(0);
    outC->PacketsOut.PacketHeaders[idx20].endAddress = kcg_lit_int32(0);
  }
  for (idx21 = 0; idx21 < 500; idx21++) {
    outC->PacketsOut.PacketData[idx21] = kcg_lit_int32(0);
  }
  outC->Error = kcg_true;
  for (idx = 0; idx < 33; idx++) {
    /* _L50=(TM_conversions_baseline2::C_P027V1_tracksim_merge_sections#1)/ */
