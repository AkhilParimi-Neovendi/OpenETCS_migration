...
typedef struct {
  ...
  M_VOLTAGE /* IfBlock1:then:_L4/ */ _L4_then_IfBlock1;
  kcg_bool /* IfBlock1:else:else:then:_L4/ */ _L4_then_else_else_IfBlock1;
  M_VOLTAGE /* IfBlock1:else:else:then:_L2/ */ _L2_then_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:then:_L4/ */ _L4_then_else_else_else_else_IfBlock1;
  M_VOLTAGE /* IfBlock1:else:else:else:else:then:_L2/ */ _L2_then_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:_L2/ */ _L2_else_else_else_else_else_else_IfBlock1;
  M_VOLTAGE /* IfBlock1:else:else:else:else:else:else:_L1/ */ _L1_else_else_else_else_else_else_IfBlock1;
  M_VOLTAGE /* IfBlock1:else:else:else:else:else:then:_L2/ */ _L2_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L4/ */ _L4_then_else_else_else_else_else_IfBlock1;
  M_VOLTAGE /* IfBlock1:else:else:else:then:_L2/ */ _L2_then_else_else_else_IfBlock1;
...
extern void CAST_Int_to_M_VOLTAGE_reset_TM_conversions(
  outC_CAST_Int_to_M_VOLTAGE_TM_conversions *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CAST_Int_to_M_VOLTAGE_init_TM_conversions(
  outC_CAST_Int_to_M_VOLTAGE_TM_conversions *outC);
