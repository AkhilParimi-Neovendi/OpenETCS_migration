...
void C_compr_P005_init_TM_TrainToTrack(outC_C_compr_P005_TM_TrainToTrack *outC)
{
  ...
  outC->_L72.nid_opeartional = kcg_lit_int64(0);
  ...
  outC->P005_out.nid_packet = kcg_lit_int64(0);
  outC->P005_out.l_packet = kcg_lit_int64(0);
  outC->P005_out.nid_opeartional = kcg_lit_int64(0);
  /* _L71=(TM_conversions::CAST_Int_to_NID_OPERATIONAL#1)/ */
