...
static void _SCSIM_RestoreInterface(void) {
    ...
    init_kcg_float64(&inputs_ctx.GUI_targetSpeed);
    init_kcg_float64(&inputs_ctx_execute.GUI_targetSpeed);
    init_kcg_float64(&inputs_ctx.GUI_traction);
    init_kcg_float64(&inputs_ctx_execute.GUI_traction);
    init_kcg_float64(&inputs_ctx.GUI_brake);
    init_kcg_float64(&inputs_ctx_execute.GUI_brake);
    init_kcg_float64(&inputs_ctx.GUI_initialPosition);
    init_kcg_float64(&inputs_ctx_execute.GUI_initialPosition);
    init_kcg_float64(&inputs_ctx.GUI_initialVelocity);
    init_kcg_float64(&inputs_ctx_execute.GUI_initialVelocity);
    init_kcg_int64(&inputs_ctx.GUI_level);
    init_kcg_int64(&inputs_ctx_execute.GUI_level);
    init_kcg_int64(&inputs_ctx.GUI_mode);
    init_kcg_int64(&inputs_ctx_execute.GUI_mode);
    init_kcg_int64(&inputs_ctx.GUI_mobileHWStatus);
    init_kcg_int64(&inputs_ctx_execute.GUI_mobileHWStatus);
    ...
    init_kcg_int64(&inputs_ctx.deltaSimulationTime);
    init_kcg_int64(&inputs_ctx_execute.deltaSimulationTime);
