...
{
  kcg_float64 op_call;
  kcg_float64 _1_op_call;
  /* finalAccelerationInPercent/ */
  kcg_float64 finalAccelerationInPercent_partial;
  /* finalAccelerationInPercent/ */
  kcg_float64 _2_finalAccelerationInPercent_partial;
  /* finalAccelerationInPercent/ */
  kcg_float64 _3_finalAccelerationInPercent_partial;
  /* finalAccelerationInPercent/ */
  kcg_float64 _4_finalAccelerationInPercent_partial;
  /* finalAccelerationInPercent/ */
  kcg_float64 _5_finalAccelerationInPercent_partial;
  /* finalAccelerationInPercent/ */
  kcg_float64 _6_finalAccelerationInPercent_partial;
  /* position/ */
  kcg_float64 position_partial;
  /* velocity/ */
  kcg_float64 velocity_partial;
  /* tmpVelocity/ */
  kcg_float64 tmpVelocity_partial;
  /* tmpPosition/ */
  kcg_float64 tmpPosition_partial;
  /* tmpAcceleration/ */
  kcg_float64 tmpAcceleration_partial;
  /* SM1: */
  ...
  /* position/ */
  kcg_float64 _7_position_partial;
  /* velocity/ */
  kcg_float64 _8_velocity_partial;
  /* tmpVelocity/ */
  kcg_float64 _9_tmpVelocity_partial;
  /* tmpPosition/ */
  kcg_float64 _10_tmpPosition_partial;
  /* tmpAcceleration/ */
  kcg_float64 _11_tmpAcceleration_partial;
  /* SM1: */
  ...
  /* SM1:Reset:<1> */
  kcg_bool tr_1_guard_Reset_SM1;
  /* SM1: */
  SSM_ST_SM1 _15_SM1_state_act_partial;
  /* SM1: */
  kcg_bool _16_SM1_reset_act_partial;
  /* SM1: */
  SSM_TR_SM1 _17_SM1_fired_strong_partial;
  /* SM1:Driving:<1> */
  kcg_bool tr_1_guard_Driving_SM1;
  /* SM1: */
  ...
  switch (outC->SM1_state_act) {
    case SSM_st_Driving_SM1 :
      if (outC->SM1_reset_act) {
        ...
        PHYSICS_simulateAccelerat_reset_Toolbox_Physics_Basic(
  ...
  outC_PHYSICS_MovementSimulation_Toolbox_Physics *outC)
{
  ...
  PHYSICS_simulateAirResistance_init_Toolbox_Physics_Basic(
    &outC->Context_PHYSICS_simulateAirResistance_1);
  /* SM1:Driving:_L30=(Toolbox::Physics::Basic::PHYSICS_simulateAccelerationBuildupTime#1)/ */
  PHYSICS_simulateAccelerat_init_Toolbox_Physics_Basic(
    &outC->Context_PHYSICS_simulateAccelerationBuildupTime_1);
