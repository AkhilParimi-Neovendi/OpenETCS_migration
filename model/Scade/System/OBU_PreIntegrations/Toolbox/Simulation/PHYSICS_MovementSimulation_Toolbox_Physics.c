...
{
  kcg_float32 op_call;
  kcg_float32 _1_op_call;
  /* finalAccelerationInPercent/ */
  kcg_float32 finalAccelerationInPercent_partial;
  /* finalAccelerationInPercent/ */
  kcg_float32 _2_finalAccelerationInPercent_partial;
  /* finalAccelerationInPercent/ */
  kcg_float32 _3_finalAccelerationInPercent_partial;
  /* finalAccelerationInPercent/ */
  kcg_float32 _4_finalAccelerationInPercent_partial;
  /* finalAccelerationInPercent/ */
  kcg_float32 _5_finalAccelerationInPercent_partial;
  /* finalAccelerationInPercent/ */
  kcg_float32 _6_finalAccelerationInPercent_partial;
  /* position/ */
  kcg_float32 position_partial;
  /* velocity/ */
  kcg_float32 velocity_partial;
  /* tmpVelocity/ */
  kcg_float32 tmpVelocity_partial;
  /* tmpPosition/ */
  kcg_float32 tmpPosition_partial;
  /* tmpAcceleration/ */
  kcg_float32 tmpAcceleration_partial;
  /* SM1: */
  ...
  /* position/ */
  kcg_float32 _7_position_partial;
  /* velocity/ */
  kcg_float32 _8_velocity_partial;
  /* tmpVelocity/ */
  kcg_float32 _9_tmpVelocity_partial;
  /* tmpPosition/ */
  kcg_float32 _10_tmpPosition_partial;
  /* tmpAcceleration/ */
  kcg_float32 _11_tmpAcceleration_partial;
  /* SM1: */
