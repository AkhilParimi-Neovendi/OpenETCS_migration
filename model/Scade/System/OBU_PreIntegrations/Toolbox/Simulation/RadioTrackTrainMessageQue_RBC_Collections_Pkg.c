...
void RadioTrackTrainMessageQue_RBC_Collections_Pkg(
...
void RadioTrackTrainMessageQue_init_RBC_Collections_Pkg(
  outC_RadioTrackTrainMessageQue_RBC_Collections_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx2 = 0; idx2 < 8; idx2++) {
    ...
    outC->_L2[idx2].m_Entry.Header.radioDevice = kcg_lit_int64(0);
    outC->_L2[idx2].m_Entry.Header.receivedSystemTime = kcg_lit_int64(0);
    outC->_L2[idx2].m_Entry.Header.nid_message = kcg_lit_int64(0);
    outC->_L2[idx2].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L2[idx2].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L2[idx2].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L2[idx2].m_Entry.Header.t_train_reference = kcg_lit_int64(0);
    outC->_L2[idx2].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L2[idx2].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L2[idx2].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L2[idx2].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L2[idx2].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L2[idx2].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L2[idx2].m_Entry.Header.d_emergencystop = kcg_lit_int64(0);
    outC->_L2[idx2].m_Entry.Header.m_version = kcg_lit_int64(0);
    ...
    for (idx1 = 0; idx1 < 500; idx1++) {
      outC->_L2[idx2].m_Entry.Messages.PacketData[idx1] = kcg_lit_int64(0);
    }
  }
  for (idx5 = 0; idx5 < 8; idx5++) {
    outC->_L1.m_Entries[idx5].m_IsValid = kcg_true;
    outC->_L1.m_Entries[idx5].m_Entry.Header.radioDevice = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx5].m_Entry.Header.receivedSystemTime = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx5].m_Entry.Header.nid_message = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx5].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx5].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx5].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx5].m_Entry.Header.t_train_reference = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx5].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx5].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx5].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx5].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx5].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx5].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx5].m_Entry.Header.d_emergencystop = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx5].m_Entry.Header.m_version = kcg_lit_int64(0);
    ...
    for (idx4 = 0; idx4 < 500; idx4++) {
      outC->_L1.m_Entries[idx5].m_Entry.Messages.PacketData[idx4] = kcg_lit_int64(0);
    }
  }
...
void RadioTrackTrainMessageQue_reset_RBC_Collections_Pkg(
  outC_RadioTrackTrainMessageQue_RBC_Collections_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** RadioTrackTrainMessageQue_RBC_Collections_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
