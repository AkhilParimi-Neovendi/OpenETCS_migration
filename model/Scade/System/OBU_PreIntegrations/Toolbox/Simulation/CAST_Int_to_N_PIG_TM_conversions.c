        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              outC->_L44_then_else_else_else_else_else_IfBlock1 = kcg_false;
              _21_error_partial = outC->_L44_then_else_else_else_else_else_IfBlock1;
  ...
  outC_CAST_Int_to_N_PIG_TM_conversions *outC)
{
  ...
  outC->_L44_then_else_else_else_else_else_IfBlock1 = kcg_true;
