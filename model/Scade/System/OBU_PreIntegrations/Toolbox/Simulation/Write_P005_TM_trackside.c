...
void Write_P005_init_TM_trackside(outC_Write_P005_TM_trackside *outC)
{
  ...
  for (idx9 = 0; idx9 < 32; idx9++) {
    outC->_L1.SECTIONS[idx9].D_LINK = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx9].Q_NEWCOUNTRY = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx9].NID_C = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx9].NID_BG = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx9].Q_LINKORIENTATION = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx9].Q_LINKREACTION = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx9].Q_LOCACC = kcg_lit_int64(0);
  }
