  ...
  outC_C_P015_tracksim_compr_TM_conversions *outC)
{
  ...
  kcg_copy_array_int64_6(&outC->_L381[0], &outC->_L373);
  kcg_copy_telephoneNumber_T_Packet_TrainTypes_Pkg(&outC->_L381[6], &outC->_L399);
  kcg_copy_array_int64_21(&outC->_L400[0], &outC->_L381);
  ...
  kcg_copy_array_int64_22(&outC->_L384[0], &outC->_L400);
  ...
  kcg_copy_array_int64_150(&outC->_L383[0], &outC->_L384);
  kcg_copy_array_int64_350(&outC->_L383[150], &outC->_L209);
  /* _L379=(TM_lib_internal::T_DeterminePacketSizeInt#1)/ */
  T_DeterminePacketSizeInt_TM_lib_internal(
    outC->_L396,
    kcg_lit_int64(6) + kcg_lit_int64(1) + kcg_lit_int64(15),
    kcg_lit_int64(4),
  ...
  outC_C_P015_tracksim_compr_TM_conversions *outC)
{
  ...
  for (idx = 0; idx < 1; idx++) {
    outC->_L403[idx] = kcg_lit_int64(0);
  }
  outC->_L402 = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 22; idx1++) {
    outC->_L400[idx1] = kcg_lit_int64(0);
  }
  for (idx2 = 0; idx2 < 15; idx2++) {
    outC->_L399[idx2] = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 32; idx3++) {
    outC->_L398[idx3].L_SECTION = kcg_lit_int64(0);
    outC->_L398[idx3].Q_SECTIONTIMER = kcg_lit_int64(0);
    outC->_L398[idx3].T_SECTIONTIMER = kcg_lit_int64(0);
    outC->_L398[idx3].D_SECTIONTIMERSTOPLOC = kcg_lit_int64(0);
  }
  ...
  for (idx9 = 0; idx9 < 32; idx9++) {
    outC->_L371[idx9].L_SECTION = kcg_lit_int64(0);
    outC->_L371[idx9].Q_SECTIONTIMER = kcg_lit_int64(0);
    outC->_L371[idx9].T_SECTIONTIMER = kcg_lit_int64(0);
    outC->_L371[idx9].D_SECTIONTIMERSTOPLOC = kcg_lit_int64(0);
  }
  ...
  for (idx11 = 0; idx11 < 32; idx11++) {
    outC->_L1.SECTIONS[idx11].L_SECTION = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx11].Q_SECTIONTIMER = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx11].T_SECTIONTIMER = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx11].D_SECTIONTIMERSTOPLOC = kcg_lit_int64(0);
  }
  ...
  for (idx12 = 0; idx12 < 32; idx12++) {
    outC->sections[idx12].L_SECTION = kcg_lit_int64(0);
    outC->sections[idx12].Q_SECTIONTIMER = kcg_lit_int64(0);
    outC->sections[idx12].T_SECTIONTIMER = kcg_lit_int64(0);
    outC->sections[idx12].D_SECTIONTIMERSTOPLOC = kcg_lit_int64(0);
  }
  ...
  for (idx13 = 0; idx13 < 500; idx13++) {
    outC->P015_compressed[idx13] = kcg_lit_int64(0);
  }
