...
{
  /* nc_cdtrain/ */
  NC_CDTRAIN nc_cdtrain_partial;
  /* error/ */
  kcg_bool error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _1_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _3_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _5_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _7_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _8_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _9_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _10_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _11_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _12_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _13_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _14_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _15_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _16_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _17_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _18_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _19_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _20_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _21_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _22_error_partial;
  /* error/ */
  kcg_bool _23_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _24_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _25_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _26_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _27_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _28_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _29_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _30_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _31_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _32_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _33_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _34_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _35_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _36_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _37_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _38_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _39_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _40_nc_cdtrain_partial;
  /* error/ */
  kcg_bool _41_error_partial;
  /* nc_cdtrain/ */
  NC_CDTRAIN _42_nc_cdtrain_partial;
  kcg_bool noname;
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              ...
              _34_nc_cdtrain_partial = outC->_L211_then_else_else_else_else_else_IfBlock1;
  ...
  outC_CAST_Int_to_NC_CDTRAIN_TM_conversions *outC)
{
  ...
  outC->error = kcg_true;
  outC->nc_cdtrain_in = kcg_lit_int32(0);
