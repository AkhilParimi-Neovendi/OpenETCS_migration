...
void _120_RadioTrackTrainPacke_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTrainPacket058_Pkg(
...
void _120_RadioTrackTrainPacke_init_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTrainPacket058_Pkg(
  outC__120_RadioTrackTrainPacke_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTrainPacket058_Pkg *outC)
{
  outC->_L9 = Q_LGTLOC_Min_safe_rear_end;
  outC->_L7.d_loc = kcg_lit_int32(0);
  outC->_L7.q_lgtloc = Q_LGTLOC_Min_safe_rear_end;
  outC->_L8 = kcg_lit_int32(0);
  outC->_L6.D_LOC = kcg_lit_int32(0);
  outC->_L6.Q_LGTLOC = kcg_lit_int32(0);
  outC->_L5.D_LOC = kcg_lit_int32(0);
  outC->_L5.Q_LGTLOC = kcg_lit_int32(0);
  outC->_L4.D_LOC = kcg_lit_int32(0);
  outC->_L4.Q_LGTLOC = kcg_lit_int32(0);
  outC->_L3 = kcg_lit_int32(0);
  outC->outIncrementalDistanceAndQualifier.D_LOC = kcg_lit_int32(0);
  outC->outIncrementalDistanceAndQualifier.Q_LGTLOC = kcg_lit_int32(0);
  /* _L3=(TM_conversions::CAST_Q_LGTLOC_to_int#1)/ */
...
void _120_RadioTrackTrainPacke_reset_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTrainPacket058_Pkg(
  outC__120_RadioTrackTrainPacke_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTrainPacket058_Pkg *outC)
{
  /* _L3=(TM_conversions::CAST_Q_LGTLOC_to_int#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _120_RadioTrackTrainPacke_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTrainPacket058_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
