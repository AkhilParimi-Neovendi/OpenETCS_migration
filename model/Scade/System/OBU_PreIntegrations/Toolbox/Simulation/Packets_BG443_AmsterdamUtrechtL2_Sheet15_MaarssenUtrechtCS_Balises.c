  ...
  outC_Packets_BG443_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L35.PacketHeaders[idx].nid_packet = kcg_lit_int32(0);
    outC->_L35.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L35.PacketHeaders[idx].valid = kcg_true;
    outC->_L35.PacketHeaders[idx].startAddress = kcg_lit_int32(0);
    outC->_L35.PacketHeaders[idx].endAddress = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L35.PacketData[idx1] = kcg_lit_int32(0);
  }
  outC->_L33 = kcg_true;
