...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P005_sections_array_flat_T_TM /* Flattened/ */ Flattened;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P005_fs_flatten_array_TM_lib_internal /* _L78=(TM_lib_internal::C_P005_fs_flatten_array#2)/ */ Context_C_P005_fs_flatten_array_2[231];
  outC_C_P005_fs_struct_to_array_TM_lib_internal /* _L74=(TM_lib_internal::C_P005_fs_struct_to_array#2)/ */ Context_C_P005_fs_struct_to_array_2[33];
  /* ----------------- no clocks of observable data ------------------ */
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  P005_sections_array_flat_T_TM /* _L76/ */ _L76;
  P005_OBU_sectionlist_int_T_TM /* _L75/ */ _L75;
  P005_OBU_sectionlist_array_T_TM /* _L74/ */ _L74;
  P005_sections_array_flat_T_TM /* _L78/ */ _L78;
  array_int64_7_33_231 /* _L80/ */ _L80;
...
extern void C_P005_flatten_sections_init_TM_lib_internal(
  outC_C_P005_flatten_sections_TM_lib_internal *outC);
