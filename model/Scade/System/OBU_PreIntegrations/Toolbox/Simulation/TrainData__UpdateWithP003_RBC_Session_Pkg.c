  ...
  outC_TrainData__UpdateWithP003_RBC_Session_Pkg *outC)
{
  ...
  _54_RadioTrainTrackPacket003__RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg_RBC_RadioTrainTrackPacket003_Pkg(
    &outC->_L5,
    &outC->_1_Context_RadioTrainTrackPacket003__CountOnboardNumbers_1);
  outC->_L3 =
    outC->_1_Context_RadioTrainTrackPacket003__CountOnboardNumbers_1.outCount;
  /* _L7=(RBC_Session_Pkg::TrainData__SetNumberOfOnboardPhoneNumbers#1)/ */
  TrainData__SetNumberOfOnb_RBC_Session_Pkg(
    &outC->_L9,
    outC->_L3,
  ...
  _53_RadioTrainTrackPacket003__RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg_RBC_RadioTrainTrackPacket003_Pkg(
    &outC->_L5,
  ...
  TrainData__SetOnboardPhon_RBC_Session_Pkg(
    &outC->_L7,
    &outC->_L2,
  ...
  outC_TrainData__UpdateWithP003_RBC_Session_Pkg *outC)
{
  ...
  outC->_L9.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 1; idx1++) {
    outC->_L9.m_OnboardPhoneNumbers[idx1].valid = kcg_true;
    for (idx = 0; idx < 15; idx++) {
      outC->_L9.m_OnboardPhoneNumbers[idx1].telephoneNumber[idx] = kcg_lit_int64(0);
    }
  }
  outC->_L9.t_train_ref = kcg_lit_int64(0);
  outC->_L9.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L9.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L9.l_train = kcg_lit_int64(0);
  outC->_L9.v_maxtrain = kcg_lit_int64(0);
  outC->_L9.m_loadinggauge =
    M_LOADINGGAUGE_The_train_does_not_fit_to_any_of_the_interoperable_loading_gauge_profiles;
  outC->_L9.m_axleloadcat = M_AXLELOADCAT_A;
  outC->_L9.m_airtight = M_AIRTIGHT_Not_fitted;
  outC->_L9.n_axle = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 4; idx2++) {
    outC->_L9.m_TractionIdentities[idx2].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L9.m_TractionIdentities[idx2].nid_ctraction = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L9.m_NationalSystemIdentities[idx3] = kcg_lit_int64(0);
  }
  ...
  for (idx5 = 0; idx5 < 1; idx5++) {
    ...
    for (idx4 = 0; idx4 < 15; idx4++) {
      outC->_L1.p3.aNID_RADIO[idx5].telephoneNumber[idx4] = kcg_lit_int64(0);
    }
  }
  ...
  for (idx6 = 0; idx6 < 4; idx6++) {
    outC->_L1.p11.tractionIdentity[idx6].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L1.p11.tractionIdentity[idx6].nid_ctraction = kcg_lit_int64(0);
  }
  outC->_L1.p11.nIter_ntc = kcg_lit_int64(0);
  for (idx7 = 0; idx7 < 5; idx7++) {
    outC->_L1.p11.nid_ntc[idx7] = kcg_lit_int64(0);
  }
  for (idx9 = 0; idx9 < 1; idx9++) {
    outC->_L2[idx9].valid = kcg_true;
    for (idx8 = 0; idx8 < 15; idx8++) {
      outC->_L2[idx9].telephoneNumber[idx8] = kcg_lit_int64(0);
    }
  }
  ...
  for (idx12 = 0; idx12 < 4; idx12++) {
    outC->_L4.m_TractionIdentities[idx12].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L4.m_TractionIdentities[idx12].nid_ctraction = kcg_lit_int64(0);
  }
  for (idx13 = 0; idx13 < 5; idx13++) {
    outC->_L4.m_NationalSystemIdentities[idx13] = kcg_lit_int64(0);
  }
  ...
  for (idx15 = 0; idx15 < 1; idx15++) {
    ...
    for (idx14 = 0; idx14 < 15; idx14++) {
      outC->_L5.aNID_RADIO[idx15].telephoneNumber[idx14] = kcg_lit_int64(0);
    }
  }
  ...
  for (idx18 = 0; idx18 < 4; idx18++) {
    outC->_L6.packets.p11.tractionIdentity[idx18].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L6.packets.p11.tractionIdentity[idx18].nid_ctraction = kcg_lit_int64(0);
  }
  outC->_L6.packets.p11.nIter_ntc = kcg_lit_int64(0);
  for (idx19 = 0; idx19 < 5; idx19++) {
    outC->_L6.packets.p11.nid_ntc[idx19] = kcg_lit_int64(0);
  }
  ...
  for (idx22 = 0; idx22 < 4; idx22++) {
    outC->_L7.m_TractionIdentities[idx22].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L7.m_TractionIdentities[idx22].nid_ctraction = kcg_lit_int64(0);
  }
  for (idx23 = 0; idx23 < 5; idx23++) {
    outC->_L7.m_NationalSystemIdentities[idx23] = kcg_lit_int64(0);
  }
  ...
  for (idx26 = 0; idx26 < 4; idx26++) {
    outC->outTrainData.m_TractionIdentities[idx26].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->outTrainData.m_TractionIdentities[idx26].nid_ctraction = kcg_lit_int64(0);
  }
  for (idx27 = 0; idx27 < 5; idx27++) {
    outC->outTrainData.m_NationalSystemIdentities[idx27] = kcg_lit_int64(0);
  }
  outC->outTrainData.nid_operational = kcg_lit_int64(0);
  /* _L4=(RBC_Session_Pkg::TrainData__SetOnboardPhoneNumbers#1)/ */
  TrainData__SetOnboardPhon_init_RBC_Session_Pkg(
    &outC->Context_TrainData__SetOnboardPhoneNumbers_1);
  /* _L2=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RBC_RadioTrainTrackPacket003_Pkg::RadioTrainTrackPacket003__GetOnboardNumbers#1)/ */
  _53_RadioTrainTrackPacket003__init_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg_RBC_RadioTrainTrackPacket003_Pkg(
    &outC->Context_RadioTrainTrackPacket003__GetOnboardNumbers_1);
  /* _L7=(RBC_Session_Pkg::TrainData__SetNumberOfOnboardPhoneNumbers#1)/ */
  TrainData__SetNumberOfOnb_init_RBC_Session_Pkg(
    &outC->Context_TrainData__SetNumberOfOnboardPhoneNumbers_1);
  /* _L3=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RBC_RadioTrainTrackPacket003_Pkg::RadioTrainTrackPacket003__CountOnboardNumbers#1)/ */
  _54_RadioTrainTrackPacket003__init_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg_RBC_RadioTrainTrackPacket003_Pkg(
    &outC->_1_Context_RadioTrainTrackPacket003__CountOnboardNumbers_1);
  /* _L5=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackPackets__GetP003#1)/ */
...
{
  /* _L4=(RBC_Session_Pkg::TrainData__SetOnboardPhoneNumbers#1)/ */
  TrainData__SetOnboardPhon_reset_RBC_Session_Pkg(
    &outC->Context_TrainData__SetOnboardPhoneNumbers_1);
  /* _L2=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RBC_RadioTrainTrackPacket003_Pkg::RadioTrainTrackPacket003__GetOnboardNumbers#1)/ */
  _53_RadioTrainTrackPacket003__reset_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg_RBC_RadioTrainTrackPacket003_Pkg(
    &outC->Context_RadioTrainTrackPacket003__GetOnboardNumbers_1);
  /* _L7=(RBC_Session_Pkg::TrainData__SetNumberOfOnboardPhoneNumbers#1)/ */
  TrainData__SetNumberOfOnb_reset_RBC_Session_Pkg(
    &outC->Context_TrainData__SetNumberOfOnboardPhoneNumbers_1);
  /* _L3=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RBC_RadioTrainTrackPacket003_Pkg::RadioTrainTrackPacket003__CountOnboardNumbers#1)/ */
  _54_RadioTrainTrackPacket003__reset_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg_RBC_RadioTrainTrackPacket003_Pkg(
    &outC->_1_Context_RadioTrainTrackPacket003__CountOnboardNumbers_1);
  /* _L5=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackPackets__GetP003#1)/ */
