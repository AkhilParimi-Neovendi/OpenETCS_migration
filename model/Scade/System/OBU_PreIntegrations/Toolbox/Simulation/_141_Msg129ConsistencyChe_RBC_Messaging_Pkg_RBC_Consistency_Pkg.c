...
void _141_Msg129ConsistencyChe_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
...
{
  outC->_L8 = T_TRAIN_MIN;
  outC->_L1 = Q_MARQSTREASON_DEFAULT;
  ...
  outC->_L2 = outC->_L5 & outC->_L7;
  outC->outIsConsistent = outC->_L2;
}

#ifndef KCG_USER_DEFINED_INIT
void _141_Msg129ConsistencyChe_init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
  outC__141_Msg129ConsistencyChe_RBC_Messaging_Pkg_RBC_Consistency_Pkg *outC)
{
...
void _141_Msg129ConsistencyChe_reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
  outC__141_Msg129ConsistencyChe_RBC_Messaging_Pkg_RBC_Consistency_Pkg *outC)
{
  /* _L6=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__Get_T_TRAIN_Ref#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _141_Msg129ConsistencyChe_RBC_Messaging_Pkg_RBC_Consistency_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
