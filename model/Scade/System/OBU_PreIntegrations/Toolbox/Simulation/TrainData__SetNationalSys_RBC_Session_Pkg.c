...
void TrainData__SetNationalSys_init_RBC_Session_Pkg(
  outC_TrainData__SetNationalSys_RBC_Session_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void TrainData__SetNationalSys_reset_RBC_Session_Pkg(
  outC_TrainData__SetNationalSys_RBC_Session_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** TrainData__SetNationalSys_RBC_Session_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
