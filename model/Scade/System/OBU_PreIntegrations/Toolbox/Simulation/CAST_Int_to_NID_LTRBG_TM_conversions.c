...
void CAST_Int_to_NID_LTRBG_TM_conversions(
  /* nid_ltrbg_int/ */
  kcg_int64 nid_ltrbg_int,
  outC_CAST_Int_to_NID_LTRBG_TM_conversions *outC)
{
  ...
  outC->_L1 = nid_ltrbg_int;
  outC->_L4 = outC->_L1 < outC->_L5;
  outC->_L3 = kcg_lit_int64(16777215);
  outC->_L2 = outC->_L1 > outC->_L3;
  _1_noname = outC->_L2;
  noname = outC->_L4;
  outC->nid_ltrbg = outC->_L1;
}

#ifndef KCG_USER_DEFINED_INIT
void CAST_Int_to_NID_LTRBG_init_TM_conversions(
  outC_CAST_Int_to_NID_LTRBG_TM_conversions *outC)
{
  outC->_L2 = kcg_true;
  ...
  outC->nid_ltrbg = kcg_lit_int64(0);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void CAST_Int_to_NID_LTRBG_reset_TM_conversions(
  outC_CAST_Int_to_NID_LTRBG_TM_conversions *outC)
{
}
