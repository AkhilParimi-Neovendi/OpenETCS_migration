...
void _144_RadioTrackTrainFacto_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg(
...
void _144_RadioTrackTrainFacto_init_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg(
  outC__144_RadioTrackTrainFacto_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->outRadioTrackTrainMessage.Messages.PacketData[idx3] = kcg_lit_int64(0);
  }
}
...
void _144_RadioTrackTrainFacto_reset_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg(
  outC__144_RadioTrackTrainFacto_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _144_RadioTrackTrainFacto_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
