...
#include "_126_RadioTrackTrainFacto_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg.h"

/* RBC_Messaging_Pkg::RBC_RadioTrackTrainFactory_Pkg::RadioTrackTrainFactory__CreateP058/ */
void _126_RadioTrackTrainFacto_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg(
  /* in_Q_DIR/ */
  Q_DIR in_Q_DIR,
  /* in_Q_SCALE/ */
  Q_SCALE in_Q_SCALE,
  ...
  outC__126_RadioTrackTrainFacto_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg *outC)
{
  outC->_L19 = in_D_CYCLOC;
  kcg_copy__22_array(&outC->_L18, inIncrementalDistancesAndQualifiers);
  ...
  _125_RadioTrackTrainPacke_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTrainPacket058_Pkg(
    outC->_L13,
    outC->_L14,
    outC->_L15,
    outC->_L19,
...
void _126_RadioTrackTrainFacto_init_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg(
  outC__126_RadioTrackTrainFacto_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx = 0; idx < 32; idx++) {
    outC->_L18[idx].d_loc = kcg_lit_int64(0);
  ...
  outC->_L12.Q_DIR = kcg_lit_int64(0);
  outC->_L12.L_PACKET = kcg_lit_int64(0);
  outC->_L12.Q_SCALE = kcg_lit_int64(0);
  outC->_L12.T_CYCLOC = kcg_lit_int64(0);
  outC->_L12.D_CYCLOC = kcg_lit_int64(0);
  outC->_L12.M_LOC = kcg_lit_int64(0);
  outC->_L12.N_ITER = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 32; idx1++) {
    outC->_L12.SECTIONS[idx1].D_LOC = kcg_lit_int64(0);
    outC->_L12.SECTIONS[idx1].Q_LGTLOC = kcg_lit_int64(0);
  }
  ...
  /* _L12=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RBC_RadioTrackTrainPacket058_Pkg::RadioTrackTrainPacket058__Create#1)/ */
  _125_RadioTrackTrainPacke_init_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTrainPacket058_Pkg(
    &outC->Context_RadioTrackTrainPacket058__Create_1);
}
...
void _126_RadioTrackTrainFacto_reset_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg(
  outC__126_RadioTrackTrainFacto_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg *outC)
{
  /* _L12=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RBC_RadioTrackTrainPacket058_Pkg::RadioTrackTrainPacket058__Create#1)/ */
  _125_RadioTrackTrainPacke_reset_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTrainPacket058_Pkg(
    &outC->Context_RadioTrackTrainPacket058__Create_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _126_RadioTrackTrainFacto_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
