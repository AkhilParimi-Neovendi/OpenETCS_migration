  ...
  outC_C_P027V1_tracksim_compr_o_TM_conversions_baseline2 *outC)
{
  ...
  outC->_L438 = kcg_true;
  outC->_L445 = kcg_lit_int32(0);
  outC->_L440 = kcg_lit_int32(1);
  ...
  kcg_copy_P015_section_array_T_TM(&outC->_L437[0], &outC->_L444);
  kcg_copy_P027V1_sections_array_flat_qdiff_T_TM_baseline2(
    &outC->_L437[4],
    &outC->_L439);
  kcg_copy_array_int32_68(&outC->_L442[0], &outC->_L437);
  kcg_copy_array_int32_432(&outC->_L442[68], &outC->_L448);
  ...
  outC_C_P027V1_tracksim_compr_o_TM_conversions_baseline2 *outC)
{
  ...
  outC->_L433 = kcg_lit_int32(0);
  outC->_L434 = kcg_lit_int32(0);
  outC->_L435 = kcg_lit_int32(0);
  for (idx = 0; idx < 68; idx++) {
    outC->_L437[idx] = kcg_lit_int32(0);
  }
  outC->_L438 = kcg_true;
  for (idx1 = 0; idx1 < 64; idx1++) {
    outC->_L439[idx1] = kcg_lit_int32(0);
  }
  outC->_L440 = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 500; idx2++) {
    outC->_L442[idx2] = kcg_lit_int32(0);
  }
  outC->_L443 = kcg_lit_int32(0);
  for (idx3 = 0; idx3 < 4; idx3++) {
    outC->_L444[idx3] = kcg_lit_int32(0);
  }
  outC->_L445 = kcg_lit_int32(0);
  outC->_L446 = kcg_lit_int32(0);
  outC->_L447.D_STATIC = kcg_lit_int32(0);
  outC->_L447.V_STATIC = kcg_lit_int32(0);
  outC->_L447.Q_FRONT = kcg_lit_int32(0);
  outC->_L447.N_ITER = kcg_lit_int32(0);
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->_L447.SECTIONS_q_diff[idx4].NC_DIFF = kcg_lit_int32(0);
    outC->_L447.SECTIONS_q_diff[idx4].V_DIFF = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 432; idx5++) {
    outC->_L448[idx5] = kcg_lit_int32(0);
  }
  for (idx6 = 0; idx6 < 32; idx6++) {
    outC->_L453[idx6].NC_DIFF = kcg_lit_int32(0);
    outC->_L453[idx6].V_DIFF = kcg_lit_int32(0);
  }
  outC->_L452 = kcg_lit_int32(0);
  outC->_L451 = kcg_lit_int32(0);
  outC->_L450 = kcg_lit_int32(0);
  outC->_L449 = kcg_lit_int32(0);
  outC->_L454.nid_packet = kcg_lit_int32(0);
  outC->_L454.q_dir = Q_DIR_Reverse;
  outC->_L454.valid = kcg_true;
  outC->_L454.startAddress = kcg_lit_int32(0);
  outC->_L454.endAddress = kcg_lit_int32(0);
  outC->_L455 = kcg_lit_int32(0);
  outC->_L456 = kcg_lit_int32(0);
  outC->p_size = kcg_lit_int32(0);
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->P027V1_sections_compressed[idx7] = kcg_lit_int32(0);
  }
