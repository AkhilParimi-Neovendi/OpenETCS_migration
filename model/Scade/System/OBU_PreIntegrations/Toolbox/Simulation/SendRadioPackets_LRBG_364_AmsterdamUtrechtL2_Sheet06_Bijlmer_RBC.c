  ...
  outC_SendRadioPackets_LRBG_364_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC *outC)
{
  ...
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L5.PacketHeaders[idx6].nid_packet = kcg_lit_int32(0);
    outC->_L5.PacketHeaders[idx6].q_dir = Q_DIR_Reverse;
    outC->_L5.PacketHeaders[idx6].valid = kcg_true;
    outC->_L5.PacketHeaders[idx6].startAddress = kcg_lit_int32(0);
    outC->_L5.PacketHeaders[idx6].endAddress = kcg_lit_int32(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->_L5.PacketData[idx7] = kcg_lit_int32(0);
  }
