  ...
  outC_Triggers_Sheet08B_RBC_Scenario_Pkg *outC)
{
  ...
  RadioTrackTrainMessageTri_RBC_Scenario_Pkg(
    ...
    kcg_lit_float32(0.0),
    &outC->_3_Context_RadioTrackTrainMessageTrigger__Trigger_3);
  outC->_L7 =
    outC->_3_Context_RadioTrackTrainMessageTrigger__Trigger_3.outTriggerId;
  ...
  RadioTrackTrainMessageTri_RBC_Scenario_Pkg(
    ...
    kcg_lit_float32(0.0),
    &outC->_2_Context_RadioTrackTrainMessageTrigger__Trigger_4);
  outC->_L8 =
    outC->_2_Context_RadioTrackTrainMessageTrigger__Trigger_4.outTriggerId;
  ...
  RadioTrackTrainMessageTri_RBC_Scenario_Pkg(
    ...
    kcg_lit_float32(0.0),
    &outC->_1_Context_RadioTrackTrainMessageTrigger__Trigger_5);
  outC->_L9 =
    outC->_1_Context_RadioTrackTrainMessageTrigger__Trigger_5.outTriggerId;
