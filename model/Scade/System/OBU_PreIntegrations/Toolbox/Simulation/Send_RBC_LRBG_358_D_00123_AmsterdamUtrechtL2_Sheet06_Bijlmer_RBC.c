...
#include "Send_RBC_LRBG_358_D_00123_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC.h"

/* AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Send_RBC_LRBG_358_D_00123_1_M015/ */
void Send_RBC_LRBG_358_D_00123_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
  /* RadiaDataIn/ */
  R_data_internal_T_InfraLib *RadiaDataIn,
  /* TriggerValue/ */
  kcg_int64 TriggerValue,
  outC_Send_RBC_LRBG_358_D_00123_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Build_RBC_LRBG_358_D_00123_1_M015#1)/ */
    Build_RBC_LRBG_358_D_0012_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
      &outC->_L53,
      &outC->Context_Build_RBC_LRBG_358_D_00123_1_M015_1);
    kcg_copy_R_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Build_RBC_LRBG_358_D_00123_1_M015_1.R_data_out);
...
void Send_RBC_LRBG_358_D_00123_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
  outC_Send_RBC_LRBG_358_D_00123_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Build_RBC_LRBG_358_D_00123_1_M015#1)/ */
  Build_RBC_LRBG_358_D_0012_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Build_RBC_LRBG_358_D_00123_1_M015_1);
}
...
void Send_RBC_LRBG_358_D_00123_reset_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
  outC_Send_RBC_LRBG_358_D_00123_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Build_RBC_LRBG_358_D_00123_1_M015#1)/ */
  Build_RBC_LRBG_358_D_0012_reset_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Build_RBC_LRBG_358_D_00123_1_M015_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Send_RBC_LRBG_358_D_00123_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC.c
** Generation date: 2023-09-12T13:45:52
*************************************************************$ */
