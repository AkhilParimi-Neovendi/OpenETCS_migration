        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              ...
              _54_m_mode_partial = outC->_L226_then_else_else_else_else_else_IfBlock1;
  ...
  outC_CAST_Int_to_M_MODE_TM_conversions *outC)
{
  ...
  outC->error = kcg_true;
  outC->m_mode_in = kcg_lit_int32(0);
  ...
  outC->_L226_then_else_else_else_else_else_IfBlock1 = M_MODE_Full_Supervision;
