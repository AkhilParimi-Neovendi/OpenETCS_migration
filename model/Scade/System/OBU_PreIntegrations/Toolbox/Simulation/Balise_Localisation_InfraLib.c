...
void Balise_Localisation_init_InfraLib(outC_Balise_Localisation_InfraLib *outC)
{
  ...
  outC->_L91 = kcg_lit_float32(0.0);
  outC->_L90 = kcg_lit_float32(0.0);
  ...
  outC->_L71.header.q_updown = kcg_lit_int32(0);
  outC->_L71.header.m_version = kcg_lit_int32(0);
  outC->_L71.header.q_media = kcg_lit_int32(0);
  outC->_L71.header.n_pig = kcg_lit_int32(0);
  outC->_L71.header.n_total = kcg_lit_int32(0);
  outC->_L71.header.m_dup = kcg_lit_int32(0);
  outC->_L71.header.m_mcount = kcg_lit_int32(0);
  outC->_L71.header.nid_c = kcg_lit_int32(0);
  outC->_L71.header.nid_bg = kcg_lit_int32(0);
  outC->_L71.header.q_link = kcg_lit_int32(0);
  for (idx = 0; idx < 30; idx++) {
    outC->_L71.packets.PacketHeaders[idx].nid_packet = kcg_lit_int32(0);
    outC->_L71.packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L71.packets.PacketHeaders[idx].valid = kcg_true;
    outC->_L71.packets.PacketHeaders[idx].startAddress = kcg_lit_int32(0);
    outC->_L71.packets.PacketHeaders[idx].endAddress = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L71.packets.PacketData[idx1] = kcg_lit_int32(0);
  }
  outC->_L71.engineering_BG_location = kcg_lit_int32(0);
  outC->_L71.TrainPos = kcg_lit_float32(0.0);
  outC->_L71.pig_nom_0 = kcg_lit_int32(0);
  outC->_L71.balise_passed = kcg_true;
  outC->_L73 = kcg_lit_float32(0.0);
  outC->_L66 = kcg_lit_int32(0);
  outC->_L65.header.q_updown = kcg_lit_int32(0);
  outC->_L65.header.m_version = kcg_lit_int32(0);
  outC->_L65.header.q_media = kcg_lit_int32(0);
  outC->_L65.header.n_pig = kcg_lit_int32(0);
  outC->_L65.header.n_total = kcg_lit_int32(0);
  outC->_L65.header.m_dup = kcg_lit_int32(0);
  outC->_L65.header.m_mcount = kcg_lit_int32(0);
  outC->_L65.header.nid_c = kcg_lit_int32(0);
  outC->_L65.header.nid_bg = kcg_lit_int32(0);
  outC->_L65.header.q_link = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L65.packets.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    outC->_L65.packets.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L65.packets.PacketHeaders[idx2].valid = kcg_true;
    outC->_L65.packets.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L65.packets.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L65.packets.PacketData[idx3] = kcg_lit_int32(0);
  }
  outC->_L65.engineering_BG_location = kcg_lit_int32(0);
  outC->_L65.TrainPos = kcg_lit_float32(0.0);
  outC->_L65.pig_nom_0 = kcg_lit_int32(0);
  ...
  outC->_L16.q_updown = kcg_lit_int32(0);
  outC->_L16.m_version = kcg_lit_int32(0);
  outC->_L16.q_media = kcg_lit_int32(0);
  outC->_L16.n_pig = kcg_lit_int32(0);
  outC->_L16.n_total = kcg_lit_int32(0);
  outC->_L16.m_dup = kcg_lit_int32(0);
  outC->_L16.m_mcount = kcg_lit_int32(0);
  outC->_L16.nid_c = kcg_lit_int32(0);
  outC->_L16.nid_bg = kcg_lit_int32(0);
  outC->_L16.q_link = kcg_lit_int32(0);
  outC->_L15 = kcg_lit_int32(0);
  ...
  outC->PIG_0_out = kcg_lit_int32(0);
  /* _L75=(InfraLib::Balise_Interdistance#1)/ */
  Balise_Interdistance_init_InfraLib(&outC->Context_Balise_Interdistance_1);
  /* _L77=(TM_conversions::TOOLS_convert_engineering_location#1)/ */
  TOOLS_convert_engineering_init_TM_conversions(
    &outC->Context_TOOLS_convert_engineering_location_1);
}
...
void Balise_Localisation_reset_InfraLib(outC_Balise_Localisation_InfraLib *outC)
{
  ...
  /* _L77=(TM_conversions::TOOLS_convert_engineering_location#1)/ */
  TOOLS_convert_engineering_reset_TM_conversions(
    &outC->Context_TOOLS_convert_engineering_location_1);
}
