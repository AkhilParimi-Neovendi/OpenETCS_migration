...
#include "Build_RBC_Message_LRBG_20_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone.h"

/* AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Build_RBC_Message_LRBG_200_D_00054_9_M003/ */
void Build_RBC_Message_LRBG_20_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  /* RadiaDataIn/ */
  R_data_internal_T_InfraLib *RadiaDataIn,
  outC_Build_RBC_Message_LRBG_20_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  outC->_L44 = kcg_true;
  ...
  /* _L3=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::SendRadioPackets_LRBG_200_D_00054_9_M003#1)/ */
  SendRadioPackets_LRBG_200_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->_L38,
    &outC->Context_SendRadioPackets_LRBG_200_D_00054_9_M003_1);
  kcg_copy_CompressedPackets_T_Common_Types_Pkg(
    &outC->_L3,
    &outC->Context_SendRadioPackets_LRBG_200_D_00054_9_M003_1.Radio_packets_out);
...
void Build_RBC_Message_LRBG_20_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  outC_Build_RBC_Message_LRBG_20_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L3=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::SendRadioPackets_LRBG_200_D_00054_9_M003#1)/ */
  SendRadioPackets_LRBG_200_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->Context_SendRadioPackets_LRBG_200_D_00054_9_M003_1);
  /* _L42=(MessageLibBaseline2::Send_M003_JRU#1)/ */
...
void Build_RBC_Message_LRBG_20_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  outC_Build_RBC_Message_LRBG_20_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  /* _L3=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::SendRadioPackets_LRBG_200_D_00054_9_M003#1)/ */
  SendRadioPackets_LRBG_200_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->Context_SendRadioPackets_LRBG_200_D_00054_9_M003_1);
  /* _L42=(MessageLibBaseline2::Send_M003_JRU#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Build_RBC_Message_LRBG_20_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone.c
** Generation date: 2023-09-12T13:45:52
*************************************************************$ */
