  ...
  outC_RBC__ProcessPositionReport_RBC_Model_Pkg *outC)
{
  ...
  /* POSITION_REPORT_SM: */
  SSM_ST_POSITION_REPORT_SM POSITION_REPORT_SM_state_nxt_partial;
  /* POSITION_REPORT_SM: */
  kcg_bool POSITION_REPORT_SM_reset_nxt_partial;
  /* POSITION_REPORT_SM: */
  SSM_TR_POSITION_REPORT_SM POSITION_REPORT_SM_fired_partial;
  /* session/ */
  SessionManagement_T _1_session_partial;
  /* POSITION_REPORT_SM: */
  SSM_ST_POSITION_REPORT_SM _2_POSITION_REPORT_SM_state_nxt_partial;
  /* POSITION_REPORT_SM: */
  kcg_bool _3_POSITION_REPORT_SM_reset_nxt_partial;
  /* POSITION_REPORT_SM: */
  SSM_TR_POSITION_REPORT_SM _4_POSITION_REPORT_SM_fired_partial;
  /* POSITION_REPORT_SM: */
  SSM_ST_POSITION_REPORT_SM POSITION_REPORT_SM_state_act_partial;
  /* POSITION_REPORT_SM: */
  kcg_bool POSITION_REPORT_SM_reset_act_partial;
  /* POSITION_REPORT_SM: */
  SSM_TR_POSITION_REPORT_SM POSITION_REPORT_SM_fired_strong_partial;
  /* POSITION_REPORT_SM:IDLE:<1> */
  kcg_bool tr_1_guard_IDLE_POSITION_REPORT_SM;
  /* POSITION_REPORT_SM: */
  SSM_ST_POSITION_REPORT_SM _5_POSITION_REPORT_SM_state_act_partial;
  /* POSITION_REPORT_SM: */
  kcg_bool _6_POSITION_REPORT_SM_reset_act_partial;
  /* POSITION_REPORT_SM: */
  SSM_TR_POSITION_REPORT_SM _7_POSITION_REPORT_SM_fired_strong_partial;
  /* POSITION_REPORT_SM:PROCESS_POSITION_REPORT:<2> */
  kcg_bool tr_2_guard_PROCESS_POSITION_REPORT_POSITION_REPORT_SM;
  /* POSITION_REPORT_SM:PROCESS_POSITION_REPORT:<1> */
  kcg_bool tr_1_guard_PROCESS_POSITION_REPORT_POSITION_REPORT_SM;
  /* POSITION_REPORT_SM: */
  kcg_bool POSITION_REPORT_SM_reset_sel;
  /* POSITION_REPORT_SM: */
  kcg_bool POSITION_REPORT_SM_reset_prv;
  ...
  outC_RBC__ProcessPositionReport_RBC_Model_Pkg *outC)
{
  ...
  outC->_L25.header.nid_message = kcg_lit_int64(0);
  outC->_L25.header.t_train = kcg_lit_int64(0);
  outC->_L25.header.nid_engine = kcg_lit_int64(0);
  outC->_L25.header.xQ_MARQSTREASON = Q_MARQSTREASON_Start_selected_by_driver;
  outC->_L25.header.xT_TRAIN = kcg_lit_int64(0);
  outC->_L25.header.xNID_EM = kcg_lit_int64(0);
  outC->_L25.header.xQ_EMERGENCYSTOP =
    _12_Q_EMERGENCYSTOP_Conditional_Emergency_Stop_accepted_with_update_of_EOA;
  outC->_L25.header.xNID_TEXTMESSAGE = kcg_lit_int64(0);
  outC->_L25.packets.p0.valid = kcg_true;
  outC->_L25.packets.p0.packet0.NID_PACKET = kcg_lit_int64(0);
  outC->_L25.packets.p0.packet0.L_PACKET = kcg_lit_int64(0);
  outC->_L25.packets.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L25.packets.p0.packet0.NID_LRBG = kcg_lit_int64(0);
  outC->_L25.packets.p0.packet0.D_LRBG = kcg_lit_int64(0);
  outC->_L25.packets.p0.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L25.packets.p0.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->_L25.packets.p0.packet0.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L25.packets.p0.packet0.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L25.packets.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L25.packets.p0.packet0.L_TRAININT = kcg_lit_int64(0);
  outC->_L25.packets.p0.packet0.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L25.packets.p0.packet0.NID_NTC = kcg_lit_int64(0);
  outC->_L25.packets.p1.valid = kcg_true;
  outC->_L25.packets.p1.packet1.NID_PACKET = kcg_lit_int64(0);
  outC->_L25.packets.p1.packet1.L_PACKET = kcg_lit_int64(0);
  outC->_L25.packets.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L25.packets.p1.packet1.NID_LRBG = kcg_lit_int64(0);
  outC->_L25.packets.p1.packet1.NID_PRVLRBG = kcg_lit_int64(0);
  outC->_L25.packets.p1.packet1.D_LRBG = kcg_lit_int64(0);
  outC->_L25.packets.p1.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L25.packets.p1.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L25.packets.p1.packet1.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L25.packets.p1.packet1.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L25.packets.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L25.packets.p1.packet1.L_TRAININT = kcg_lit_int64(0);
  outC->_L25.packets.p1.packet1.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L25.packets.p1.packet1.NID_NTC = kcg_lit_int64(0);
  outC->_L25.packets.p3.valid = kcg_true;
  outC->_L25.packets.p3.number = kcg_lit_int64(0);
  for (idx1 = 0; idx1 < 1; idx1++) {
    outC->_L25.packets.p3.aNID_RADIO[idx1].valid = kcg_true;
    for (idx = 0; idx < 15; idx++) {
      outC->_L25.packets.p3.aNID_RADIO[idx1].telephoneNumber[idx] = kcg_lit_int64(0);
    }
  }
  ...
  outC->_L25.packets.p5.TrainRunningNumber = kcg_lit_int64(0);
  outC->_L25.packets.p9.valid = kcg_true;
  outC->_L25.packets.p9.transitionInformation = kcg_lit_int64(0);
  ...
  outC->_L25.packets.p11.l_train = kcg_lit_int64(0);
  outC->_L25.packets.p11.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L25.packets.p11.n_axle = kcg_lit_int64(0);
  outC->_L25.packets.p11.nIter_tractionIdentity = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 4; idx2++) {
    outC->_L25.packets.p11.tractionIdentity[idx2].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L25.packets.p11.tractionIdentity[idx2].nid_ctraction = kcg_lit_int64(0);
  }
  outC->_L25.packets.p11.nIter_ntc = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L25.packets.p11.nid_ntc[idx3] = kcg_lit_int64(0);
  }
  outC->_L27.Header.radioDevice = kcg_lit_int64(0);
  outC->_L27.Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L27.Header.nid_message = kcg_lit_int64(0);
  outC->_L27.Header.t_train = kcg_lit_int64(0);
  outC->_L27.Header.m_ack = kcg_lit_int64(0);
  outC->_L27.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L27.Header.t_train_reference = kcg_lit_int64(0);
  outC->_L27.Header.nid_em = kcg_lit_int64(0);
  outC->_L27.Header.q_scale = kcg_lit_int64(0);
  outC->_L27.Header.d_sr = kcg_lit_int64(0);
  outC->_L27.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L27.Header.d_ref = kcg_lit_int64(0);
  outC->_L27.Header.q_dir = kcg_lit_int64(0);
  outC->_L27.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L27.Header.m_version = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L27.Messages.PacketHeaders[idx4].nid_packet = kcg_lit_int64(0);
    outC->_L27.Messages.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L27.Messages.PacketHeaders[idx4].valid = kcg_true;
    outC->_L27.Messages.PacketHeaders[idx4].startAddress = kcg_lit_int64(0);
    outC->_L27.Messages.PacketHeaders[idx4].endAddress = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L27.Messages.PacketData[idx5] = kcg_lit_int64(0);
  }
  outC->_L29.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  outC->_L29.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(0);
  ...
  outC->_L29.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L29.session.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L29.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L29.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L29.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L29.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L29.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L29.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L29.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L29.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L29.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L29.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L29.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L29.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L29.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L29.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L29.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L29.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L29.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L29.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L29.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L29.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L29.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L29.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L29.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L29.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L29.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L29.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L29.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L29.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L29.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  outC->_L29.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L29.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L29.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L29.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx11 = 0; idx11 < 16; idx11++) {
    ...
    outC->_L29.diagnostic[idx11].count = kcg_lit_int64(0);
    outC->_L29.diagnostic[idx11].timestamp = kcg_lit_int64(0);
  ...
  for (idx14 = 0; idx14 < 8; idx14++) {
    ...
    outC->_L29.messageQueue.m_Entries[idx14].m_Entry.Header.q_scale =
      kcg_lit_int64(0);
    outC->_L29.messageQueue.m_Entries[idx14].m_Entry.Header.d_sr = kcg_lit_int64(0);
  ...
  outC->_L29.clockk.m_Value = kcg_lit_int64(0);
  outC->_L29.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int64(0);
  outC->_L29.lastSentTrackTrainMessage.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L29.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int64(0);
  outC->_L29.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int64(0);
  outC->_L29.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int64(0);
  outC->_L29.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L29.lastSentTrackTrainMessage.Header.t_train_reference = kcg_lit_int64(
      0);
  outC->_L29.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int64(0);
  outC->_L29.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int64(0);
  outC->_L29.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int64(0);
  outC->_L29.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L29.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int64(0);
  outC->_L29.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int64(0);
  outC->_L29.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L29.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L30.session.m_TrainData.nid_engine = kcg_lit_int64(0);
  outC->_L30.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(0);
  ...
  outC->_L30.session.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L30.session.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L30.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L30.session.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L30.session.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L30.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L30.session.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L30.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L30.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L30.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L30.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L30.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L30.session.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L30.session.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L30.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L30.session.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L30.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L30.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L30.session.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L30.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L30.config.m_NationalParams.nid_c = kcg_lit_int64(0);
  outC->_L30.config.m_NationalParams.v_nvshunt = kcg_lit_int64(0);
  outC->_L30.config.m_NationalParams.v_nvstff = kcg_lit_int64(0);
  outC->_L30.config.m_NationalParams.v_nvonsight = kcg_lit_int64(0);
  outC->_L30.config.m_NationalParams.v_nvunfit = kcg_lit_int64(0);
  outC->_L30.config.m_NationalParams.v_nvrel = kcg_lit_int64(0);
  outC->_L30.config.m_NationalParams.t_nvcontact = kcg_lit_int64(0);
  outC->_L30.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L30.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  outC->_L30.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int64(0);
  outC->_L30.config.m_MAReqParams.t_cycrqst = kcg_lit_int64(0);
  outC->_L30.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L30.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L30.config.m_PosRepParams.t_cycloc = kcg_lit_int64(0);
  outC->_L30.config.m_PosRepParams.d_cycloc = kcg_lit_int64(0);
  ...
  for (idx22 = 0; idx22 < 16; idx22++) {
    ...
    outC->_L30.diagnostic[idx22].count = kcg_lit_int64(0);
    outC->_L30.diagnostic[idx22].timestamp = kcg_lit_int64(0);
  ...
  for (idx25 = 0; idx25 < 8; idx25++) {
    ...
    outC->_L30.messageQueue.m_Entries[idx25].m_Entry.Header.q_scale =
      kcg_lit_int64(0);
    outC->_L30.messageQueue.m_Entries[idx25].m_Entry.Header.d_sr = kcg_lit_int64(0);
  ...
  outC->_L30.clockk.m_Value = kcg_lit_int64(0);
  outC->_L30.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int64(0);
  outC->_L30.lastSentTrackTrainMessage.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L30.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int64(0);
  outC->_L30.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int64(0);
  outC->_L30.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int64(0);
  outC->_L30.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L30.lastSentTrackTrainMessage.Header.t_train_reference = kcg_lit_int64(
      0);
  outC->_L30.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int64(0);
  outC->_L30.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int64(0);
  outC->_L30.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int64(0);
  outC->_L30.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L30.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int64(0);
  outC->_L30.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int64(0);
  outC->_L30.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L30.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L32.m_TrainData.nid_engine = kcg_lit_int64(0);
  outC->_L32.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int64(0);
  ...
  outC->_L32.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L32.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L32.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L32.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L32.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L32.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  for (idx31 = 0; idx31 < 5; idx31++) {
    outC->_L32.m_TrainData.m_NationalSystemIdentities[idx31] = kcg_lit_int64(0);
  }
  outC->_L32.m_TrainData.nid_operational = kcg_lit_int64(0);
  outC->_L32.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L32.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L32.m_PosData.d_lrbg = kcg_lit_int64(0);
  outC->_L32.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L32.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L32.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L32.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L32.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L32.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L32.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L32.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L32.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  outC->_L16.present = kcg_true;
  outC->_L16.nid_message = kcg_lit_int64(0);
  outC->_L16.t_train = kcg_lit_int64(0);
  outC->_L16.nid_engine = kcg_lit_int64(0);
  outC->_L16.xQ_MARQSTREASON = Q_MARQSTREASON_Start_selected_by_driver;
  outC->_L16.xT_TRAIN = kcg_lit_int64(0);
  outC->_L16.xNID_EM = kcg_lit_int64(0);
  outC->_L16.xQ_EMERGENCYSTOP =
    _12_Q_EMERGENCYSTOP_Conditional_Emergency_Stop_accepted_with_update_of_EOA;
  outC->_L16.xNID_TEXTMESSAGE = kcg_lit_int64(0);
  outC->_L17.present = kcg_true;
  outC->_L17.header.present = kcg_true;
  outC->_L17.header.nid_message = kcg_lit_int64(0);
  outC->_L17.header.t_train = kcg_lit_int64(0);
  outC->_L17.header.nid_engine = kcg_lit_int64(0);
  outC->_L17.header.xQ_MARQSTREASON = Q_MARQSTREASON_Start_selected_by_driver;
  outC->_L17.header.xT_TRAIN = kcg_lit_int64(0);
  outC->_L17.header.xNID_EM = kcg_lit_int64(0);
  outC->_L17.header.xQ_EMERGENCYSTOP =
    _12_Q_EMERGENCYSTOP_Conditional_Emergency_Stop_accepted_with_update_of_EOA;
  outC->_L17.header.xNID_TEXTMESSAGE = kcg_lit_int64(0);
  outC->_L17.packets.p0.valid = kcg_true;
  outC->_L17.packets.p0.packet0.NID_PACKET = kcg_lit_int64(0);
  outC->_L17.packets.p0.packet0.L_PACKET = kcg_lit_int64(0);
  outC->_L17.packets.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L17.packets.p0.packet0.NID_LRBG = kcg_lit_int64(0);
  outC->_L17.packets.p0.packet0.D_LRBG = kcg_lit_int64(0);
  outC->_L17.packets.p0.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L17.packets.p0.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->_L17.packets.p0.packet0.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L17.packets.p0.packet0.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L17.packets.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L17.packets.p0.packet0.L_TRAININT = kcg_lit_int64(0);
  outC->_L17.packets.p0.packet0.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L17.packets.p0.packet0.NID_NTC = kcg_lit_int64(0);
  outC->_L17.packets.p1.valid = kcg_true;
  outC->_L17.packets.p1.packet1.NID_PACKET = kcg_lit_int64(0);
  outC->_L17.packets.p1.packet1.L_PACKET = kcg_lit_int64(0);
  outC->_L17.packets.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L17.packets.p1.packet1.NID_LRBG = kcg_lit_int64(0);
  outC->_L17.packets.p1.packet1.NID_PRVLRBG = kcg_lit_int64(0);
  outC->_L17.packets.p1.packet1.D_LRBG = kcg_lit_int64(0);
  outC->_L17.packets.p1.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L17.packets.p1.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L17.packets.p1.packet1.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L17.packets.p1.packet1.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L17.packets.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L17.packets.p1.packet1.L_TRAININT = kcg_lit_int64(0);
  outC->_L17.packets.p1.packet1.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->_L17.packets.p1.packet1.NID_NTC = kcg_lit_int64(0);
  outC->_L17.packets.p3.valid = kcg_true;
  outC->_L17.packets.p3.number = kcg_lit_int64(0);
  ...
  outC->_L17.packets.p5.TrainRunningNumber = kcg_lit_int64(0);
  outC->_L17.packets.p9.valid = kcg_true;
  outC->_L17.packets.p9.transitionInformation = kcg_lit_int64(0);
  ...
  outC->_L17.packets.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L17.packets.p11.l_train = kcg_lit_int64(0);
  outC->_L17.packets.p11.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L17.packets.p11.n_axle = kcg_lit_int64(0);
  outC->_L17.packets.p11.nIter_tractionIdentity = kcg_lit_int64(0);
  for (idx34 = 0; idx34 < 4; idx34++) {
    outC->_L17.packets.p11.tractionIdentity[idx34].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L17.packets.p11.tractionIdentity[idx34].nid_ctraction = kcg_lit_int64(0);
  }
  outC->_L17.packets.p11.nIter_ntc = kcg_lit_int64(0);
  for (idx35 = 0; idx35 < 5; idx35++) {
    outC->_L17.packets.p11.nid_ntc[idx35] = kcg_lit_int64(0);
  }
  ...
  for (idx39 = 0; idx39 < 5; idx39++) {
    outC->session.m_TrainData.m_NationalSystemIdentities[idx39] = kcg_lit_int64(0);
  }
  ...
  outC->_L4_PROCESS_POSITION_REPORT_POSITION_REPORT_SM.nid_lrbg = kcg_lit_int64(
      0);
  outC->_L4_PROCESS_POSITION_REPORT_POSITION_REPORT_SM.q_scale =
    Q_SCALE_10_cm_scale;
  outC->_L4_PROCESS_POSITION_REPORT_POSITION_REPORT_SM.d_lrbg = kcg_lit_int64(0);
  ...
  outC->_L4_PROCESS_POSITION_REPORT_POSITION_REPORT_SM.l_trainint =
    kcg_lit_int64(0);
  outC->_L4_PROCESS_POSITION_REPORT_POSITION_REPORT_SM.v_train = kcg_lit_int64(0);
  ...
  outC->_L4_PROCESS_POSITION_REPORT_POSITION_REPORT_SM.nid_ntc = kcg_lit_int64(0);
  outC->_L4_PROCESS_POSITION_REPORT_POSITION_REPORT_SM.nid_prvlrbg =
    kcg_lit_int64(0);
  outC->_L3_PROCESS_POSITION_REPORT_POSITION_REPORT_SM.nid_lrbg = kcg_lit_int64(
      0);
  outC->_L3_PROCESS_POSITION_REPORT_POSITION_REPORT_SM.q_scale =
    Q_SCALE_10_cm_scale;
  outC->_L3_PROCESS_POSITION_REPORT_POSITION_REPORT_SM.d_lrbg = kcg_lit_int64(0);
  ...
  outC->_L3_PROCESS_POSITION_REPORT_POSITION_REPORT_SM.l_trainint =
    kcg_lit_int64(0);
  outC->_L3_PROCESS_POSITION_REPORT_POSITION_REPORT_SM.v_train = kcg_lit_int64(0);
  ...
  outC->_L3_PROCESS_POSITION_REPORT_POSITION_REPORT_SM.nid_ntc = kcg_lit_int64(0);
  ...
  outC->_L3_IDLE_POSITION_REPORT_SM.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L3_IDLE_POSITION_REPORT_SM.session.m_TrainData.l_train = kcg_lit_int64(
      0);
  ...
  outC->_L3_IDLE_POSITION_REPORT_SM.session.m_TrainData.m_airtight =
    M_AIRTIGHT_Not_fitted;
  outC->_L3_IDLE_POSITION_REPORT_SM.session.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L3_IDLE_POSITION_REPORT_SM.session.m_TrainData.nid_operational =
    kcg_lit_int64(0);
  outC->_L3_IDLE_POSITION_REPORT_SM.session.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L3_IDLE_POSITION_REPORT_SM.session.m_PosData.q_scale =
    Q_SCALE_10_cm_scale;
  outC->_L3_IDLE_POSITION_REPORT_SM.session.m_PosData.d_lrbg = kcg_lit_int64(0);
  ...
  outC->_L3_IDLE_POSITION_REPORT_SM.session.m_PosData.l_trainint =
    kcg_lit_int64(0);
  outC->_L3_IDLE_POSITION_REPORT_SM.session.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L3_IDLE_POSITION_REPORT_SM.session.m_PosData.nid_ntc = kcg_lit_int64(0);
  ...
  outC->_L3_IDLE_POSITION_REPORT_SM.config.m_MAReqParams.t_mar = kcg_lit_int64(0);
  ...
  for (idx68 = 0; idx68 < 16; idx68++) {
    ...
    outC->_L3_IDLE_POSITION_REPORT_SM.diagnostic[idx68].count = kcg_lit_int64(0);
  ...
  outC->_L3_IDLE_POSITION_REPORT_SM.clockk.m_Value = kcg_lit_int64(0);
  ...
  outC->_L2_IDLE_POSITION_REPORT_SM.m_TrainData.nid_engine = kcg_lit_int64(0);
  ...
  outC->_L2_IDLE_POSITION_REPORT_SM.m_TrainData.t_train_ref = kcg_lit_int64(0);
  outC->_L2_IDLE_POSITION_REPORT_SM.m_TrainData.nc_cdtrain =
    NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L2_IDLE_POSITION_REPORT_SM.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L2_IDLE_POSITION_REPORT_SM.m_TrainData.l_train = kcg_lit_int64(0);
  outC->_L2_IDLE_POSITION_REPORT_SM.m_TrainData.v_maxtrain = kcg_lit_int64(0);
  ...
  outC->_L2_IDLE_POSITION_REPORT_SM.m_TrainData.m_airtight =
    M_AIRTIGHT_Not_fitted;
  outC->_L2_IDLE_POSITION_REPORT_SM.m_TrainData.n_axle = kcg_lit_int64(0);
  ...
  outC->_L2_IDLE_POSITION_REPORT_SM.m_TrainData.nid_operational = kcg_lit_int64(
      0);
  outC->_L2_IDLE_POSITION_REPORT_SM.m_PosData.nid_lrbg = kcg_lit_int64(0);
  outC->_L2_IDLE_POSITION_REPORT_SM.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L2_IDLE_POSITION_REPORT_SM.m_PosData.d_lrbg = kcg_lit_int64(0);
  ...
  outC->_L2_IDLE_POSITION_REPORT_SM.m_PosData.l_doubtover = kcg_lit_int64(0);
  outC->_L2_IDLE_POSITION_REPORT_SM.m_PosData.l_doubtunder = kcg_lit_int64(0);
  outC->_L2_IDLE_POSITION_REPORT_SM.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L2_IDLE_POSITION_REPORT_SM.m_PosData.l_trainint = kcg_lit_int64(0);
  outC->_L2_IDLE_POSITION_REPORT_SM.m_PosData.v_train = kcg_lit_int64(0);
  ...
  outC->_L2_IDLE_POSITION_REPORT_SM.m_PosData.nid_ntc = kcg_lit_int64(0);
  outC->_L2_IDLE_POSITION_REPORT_SM.m_PosData.nid_prvlrbg = kcg_lit_int64(0);
  ...
  for (idx83 = 0; idx83 < 5; idx83++) {
    outC->outRadioTrainTrackMessage.packets.p11.nid_ntc[idx83] = kcg_lit_int64(0);
  }
  ...
  for (idx89 = 0; idx89 < 16; idx89++) {
    ...
    outC->outDataBus.diagnostic[idx89].count = kcg_lit_int64(0);
    outC->outDataBus.diagnostic[idx89].timestamp = kcg_lit_int64(0);
