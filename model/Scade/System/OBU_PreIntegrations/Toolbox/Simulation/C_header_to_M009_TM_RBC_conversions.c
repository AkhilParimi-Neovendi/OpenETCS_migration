  ...
  outC_C_header_to_M009_TM_RBC_conversions *outC)
{
  ...
  /* _L31=(TM_conversions::CAST_Int_to_T_TRAIN#1)/ */
  CAST_Int_to_T_TRAIN_TM_conversions(
    outC->_L5,
    &outC->Context_CAST_Int_to_T_TRAIN_1);
  outC->_L31 = outC->Context_CAST_Int_to_T_TRAIN_1.t_train;
  outC->_L4 = outC->_L1.l_message;
  /* _L30=(TM_conversions::CAST_Int_to_L_MESSAGE#1)/ */
  CAST_Int_to_L_MESSAGE_TM_conversions(
    outC->_L4,
    &outC->Context_CAST_Int_to_L_MESSAGE_1);
  outC->_L30 = outC->Context_CAST_Int_to_L_MESSAGE_1.l_message;
...
void C_header_to_M009_init_TM_RBC_conversions(
  outC_C_header_to_M009_TM_RBC_conversions *outC)
{
