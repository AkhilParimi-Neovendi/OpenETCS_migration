  ...
  outC_C_P046_tracksim_compr_TM_conversions *outC)
{
  ...
  kcg_copy_array_int32_3(&outC->_L381[0], &outC->_L373);
  ...
  kcg_copy_array_int32_70(&outC->_L383[0], &outC->_L384);
  kcg_copy_array_int32_430(&outC->_L383[70], &outC->_L209);
  /* _L379=(TM_lib_internal::T_DeterminePacketSizeInt#1)/ */
  T_DeterminePacketSizeInt_TM_lib_internal(
    outC->_L219,
    kcg_lit_int32(3) + kcg_lit_int32(1) + kcg_lit_int32(2),
    kcg_lit_int32(2),
  ...
  outC_C_P046_tracksim_compr_TM_conversions *outC)
{
  ...
  outC->_L388.M_LEVELTR = kcg_lit_int32(0);
  outC->_L388.NID_NTC = kcg_lit_int32(0);
  ...
  for (idx8 = 0; idx8 < 32; idx8++) {
    outC->_L371[idx8].M_LEVELTR = kcg_lit_int32(0);
    outC->_L371[idx8].NID_NTC = kcg_lit_int32(0);
  }
