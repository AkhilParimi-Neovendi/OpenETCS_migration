  ...
  outC_C_P046_tracksim_compr_TM_conversions *outC)
{
  ...
  /* _L390=(TM_lib_internal::T_Build_Metadata_Packet_ID#2)/ */
  ...
  outC->_L390 = outC->Context_T_Build_Metadata_Packet_ID_2.nid_packet_meta;
  ...
  /* _L386/ */
  for (idx = 0; idx < 1; idx++) {
    kcg_copy_P046_section_int_T_TM(&outC->_L386[idx], &outC->_L388);
  }
  kcg_copy_P046_trackide_sectionlist_T_TM(&outC->_L371, &outC->_L1.SECTIONS);
  kcg_copy_P046_section_int_T_TM(&outC->_L385[0], &outC->_L386[0]);
  kcg_copy_P046_trackide_sectionlist_T_TM(&outC->_L385[1], &outC->_L371);
  /* _L380=(TM_lib_internal::C_P046_flatten_sections#1)/ */
  C_P046_flatten_sections_TM_lib_internal(
    &outC->_L385,
    &outC->Context_C_P046_flatten_sections_1);
  kcg_copy_P046_sections_array_flat_T_TM(
    &outC->_L380,
    &outC->Context_C_P046_flatten_sections_1.Flattened);
  outC->_L219 = outC->_L1.N_ITER;
  /* _L376/ */
  for (idx1 = 0; idx1 < 1; idx1++) {
    outC->_L376[idx1] = outC->_L219;
  }
  outC->_L216 = outC->_L1.L_PACKET;
  outC->_L373[0] = outC->_L387;
  outC->_L373[1] = outC->_L215;
  outC->_L373[2] = outC->_L216;
  kcg_copy_array_int64_3(&outC->_L381[0], &outC->_L373);
  outC->_L381[3] = outC->_L376[0];
  kcg_copy_P015_section_array_T_TM(&outC->_L384[0], &outC->_L381);
  kcg_copy_P046_sections_array_flat_T_TM(&outC->_L384[4], &outC->_L380);
  outC->_L336 = kcg_lit_int64(0);
  /* _L209/ */
  for (idx2 = 0; idx2 < 430; idx2++) {
    outC->_L209[idx2] = outC->_L336;
  }
  kcg_copy_array_int64_70(&outC->_L383[0], &outC->_L384);
  kcg_copy_array_int64_430(&outC->_L383[70], &outC->_L209);
  /* _L379=(TM_lib_internal::T_DeterminePacketSizeInt#1)/ */
  T_DeterminePacketSizeInt_TM_lib_internal(
    outC->_L219,
    kcg_lit_int64(3) + kcg_lit_int64(1) + kcg_lit_int64(2),
    kcg_lit_int64(2),
...
void C_P046_tracksim_compr_init_TM_conversions(
  outC_C_P046_tracksim_compr_TM_conversions *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  outC->_L388.M_LEVELTR = kcg_lit_int64(0);
  outC->_L388.NID_NTC = kcg_lit_int64(0);
  ...
  for (idx8 = 0; idx8 < 32; idx8++) {
    outC->_L371[idx8].M_LEVELTR = kcg_lit_int64(0);
    outC->_L371[idx8].NID_NTC = kcg_lit_int64(0);
  }
  ...
  T_DeterminePacketSizeInt_init_TM_lib_internal(
    &outC->Context_T_DeterminePacketSizeInt_1);
  /* _L380=(TM_lib_internal::C_P046_flatten_sections#1)/ */
  C_P046_flatten_sections_init_TM_lib_internal(
    &outC->Context_C_P046_flatten_sections_1);
  /* _L390=(TM_lib_internal::T_Build_Metadata_Packet_ID#2)/ */
  ...
  outC_C_P046_tracksim_compr_TM_conversions *outC)
{
  ...
  T_DeterminePacketSizeInt_reset_TM_lib_internal(
    &outC->Context_T_DeterminePacketSizeInt_1);
  /* _L380=(TM_lib_internal::C_P046_flatten_sections#1)/ */
  C_P046_flatten_sections_reset_TM_lib_internal(
    &outC->Context_C_P046_flatten_sections_1);
  /* _L390=(TM_lib_internal::T_Build_Metadata_Packet_ID#2)/ */
