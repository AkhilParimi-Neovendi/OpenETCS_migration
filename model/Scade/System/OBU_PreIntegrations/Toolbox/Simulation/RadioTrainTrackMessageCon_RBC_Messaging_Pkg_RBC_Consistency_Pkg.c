  ...
  outC_RadioTrainTrackMessageCon_RBC_Messaging_Pkg_RBC_Consistency_Pkg *outC)
{
  ...
  outC->_L39_then_else_else_else_else_else_IfBlock1.p3.number = kcg_lit_int64(0);
  ...
  outC->_L39_then_else_else_else_else_else_IfBlock1.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p11.l_train = kcg_lit_int64(
      0);
  ...
  outC->_L39_then_else_else_else_else_else_IfBlock1.p11.n_axle = kcg_lit_int64(0);
