...
void RadioTrainTrackMessageCon_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
...
{
  /* outIsConsistent/ */
  kcg_bool outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _1_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _2_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _3_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _4_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _5_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _6_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _7_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _8_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _9_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _10_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _11_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _12_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _13_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _14_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _15_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _16_outIsConsistent_partial;
  /* outIsConsistent/ */
  kcg_bool _17_outIsConsistent_partial;
  ...
  RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->_L5,
    &outC->_1_Context_RadioTrainTrackMessage__GetHeader_1);
  kcg_copy_Radio_TrainTrack_Header_T_Radio_Types_Pkg(
    &outC->_L3,
    &outC->_1_Context_RadioTrainTrackMessage__GetHeader_1.outRadioTrainTrackHeader);
  ...
  _52_RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->_L5,
  ...
  if (outC->IfBlock1_clock) {
    ...
    Msg129ConsistencyChecker__RBC_Messaging_Pkg_RBC_Consistency_Pkg(
      &outC->_L2_then_IfBlock1,
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      Msg132ConsistencyChecker__RBC_Messaging_Pkg_RBC_Consistency_Pkg(
        &outC->_L2_then_else_IfBlock1,
      ...
      if (outC->else_clock_else_IfBlock1) {
        ...
        Msg136ConsistencyChecker__RBC_Messaging_Pkg_RBC_Consistency_Pkg(
          &outC->_L2_then_else_else_IfBlock1,
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          Msg146ConsistencyChecker__RBC_Messaging_Pkg_RBC_Consistency_Pkg(
            &outC->_L4_then_else_else_else_IfBlock1,
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            Msg154ConsistencyChecker__RBC_Messaging_Pkg_RBC_Consistency_Pkg(
              &outC->_L2_then_else_else_else_else_IfBlock1,
            ...
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              kcg_copy_outPackets_T_Common_Types_Pkg(
                &outC->_L39_then_else_else_else_else_else_IfBlock1,
                &outC->radioTrainTrackPackets);
              ...
              Msg155ConsistencyChecker__RBC_Messaging_Pkg_RBC_Consistency_Pkg(
                &outC->_L39_then_else_else_else_else_else_IfBlock1,
                &outC->Context_Msg155ConsistencyChecker__HasConsistentPackets_1);
              outC->_L28_then_else_else_else_else_else_IfBlock1 =
                outC->Context_Msg155ConsistencyChecker__HasConsistentPackets_1.outIsConsistent;
              _13_outIsConsistent_partial = outC->_L28_then_else_else_else_else_else_IfBlock1;
              _5_outIsConsistent_partial = _13_outIsConsistent_partial;
            }
            else {
              outC->_4_else_clock_else_else_else_else_else_IfBlock1 =
                outC->radioTrainTrackmessageId == kcg_lit_int32(159);
              /* IfBlock1:else:else:else:else:else:else: */
              if (outC->_4_else_clock_else_else_else_else_else_IfBlock1) {
                kcg_copy_outPackets_T_Common_Types_Pkg(
                ...
                Msg159ConsistencyChecker__RBC_Messaging_Pkg_RBC_Consistency_Pkg(
                  &outC->_L2_then_else_else_else_else_else_else_IfBlock1,
                ...
                if (outC->_2_else_clock_else_else_else_else_else_else_IfBlock1) {
                  kcg_copy_outPackets_T_Common_Types_Pkg(
                    &outC->_L27_then_else_else_else_else_else_else_else_IfBlock1,
                    &outC->radioTrainTrackPackets);
                  ...
                  Msg156ConsistencyChecker__RBC_Messaging_Pkg_RBC_Consistency_Pkg(
                    &outC->_L27_then_else_else_else_else_else_else_else_IfBlock1,
                  ...
                  outC->_3_else_clock_else_else_else_else_else_else_else_IfBlock1 =
                    outC->radioTrainTrackmessageId == kcg_lit_int32(147);
                  /* IfBlock1:else:else:else:else:else:else:else:else: */
                  if (outC->_3_else_clock_else_else_else_else_else_else_else_IfBlock1) {
                    kcg_copy_outPackets_T_Common_Types_Pkg(
                    ...
                    Msg147ConsistencyChecker__RBC_Messaging_Pkg_RBC_Consistency_Pkg(
                      &outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1,
                      &outC->Context_Msg147ConsistencyChecker__HasConsistentPackets_1);
                    outC->_L25_then_else_else_else_else_else_else_else_else_IfBlock1 =
...
void RadioTrainTrackMessageCon_init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
  outC_RadioTrainTrackMessageCon_RBC_Messaging_Pkg_RBC_Consistency_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  outC->_L5.header.nid_message = kcg_lit_int32(0);
  outC->_L5.header.t_train = kcg_lit_int32(0);
  outC->_L5.header.nid_engine = kcg_lit_int32(0);
  outC->_L5.header.xQ_MARQSTREASON = Q_MARQSTREASON_Start_selected_by_driver;
  outC->_L5.header.xT_TRAIN = kcg_lit_int32(0);
  outC->_L5.header.xNID_EM = kcg_lit_int32(0);
  outC->_L5.header.xQ_EMERGENCYSTOP =
    _12_Q_EMERGENCYSTOP_Conditional_Emergency_Stop_accepted_with_update_of_EOA;
  outC->_L5.header.xNID_TEXTMESSAGE = kcg_lit_int32(0);
  outC->_L5.packets.p0.valid = kcg_true;
  outC->_L5.packets.p0.packet0.NID_PACKET = kcg_lit_int32(0);
  outC->_L5.packets.p0.packet0.L_PACKET = kcg_lit_int32(0);
  outC->_L5.packets.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L5.packets.p0.packet0.NID_LRBG = kcg_lit_int32(0);
  outC->_L5.packets.p0.packet0.D_LRBG = kcg_lit_int32(0);
  outC->_L5.packets.p0.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L5.packets.p0.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->_L5.packets.p0.packet0.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L5.packets.p0.packet0.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L5.packets.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L5.packets.p0.packet0.L_TRAININT = kcg_lit_int32(0);
  outC->_L5.packets.p0.packet0.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L5.packets.p0.packet0.NID_NTC = kcg_lit_int32(0);
  outC->_L5.packets.p1.valid = kcg_true;
  outC->_L5.packets.p1.packet1.NID_PACKET = kcg_lit_int32(0);
  outC->_L5.packets.p1.packet1.L_PACKET = kcg_lit_int32(0);
  outC->_L5.packets.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L5.packets.p1.packet1.NID_LRBG = kcg_lit_int32(0);
  outC->_L5.packets.p1.packet1.NID_PRVLRBG = kcg_lit_int32(0);
  outC->_L5.packets.p1.packet1.D_LRBG = kcg_lit_int32(0);
  outC->_L5.packets.p1.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L5.packets.p1.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L5.packets.p1.packet1.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L5.packets.p1.packet1.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L5.packets.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L5.packets.p1.packet1.L_TRAININT = kcg_lit_int32(0);
  outC->_L5.packets.p1.packet1.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L5.packets.p1.packet1.NID_NTC = kcg_lit_int32(0);
  outC->_L5.packets.p3.valid = kcg_true;
  outC->_L5.packets.p3.number = kcg_lit_int32(0);
  for (idx5 = 0; idx5 < 1; idx5++) {
    outC->_L5.packets.p3.aNID_RADIO[idx5].valid = kcg_true;
    for (idx4 = 0; idx4 < 15; idx4++) {
      outC->_L5.packets.p3.aNID_RADIO[idx5].telephoneNumber[idx4] = kcg_lit_int32(0);
    }
  }
  ...
  outC->_L5.packets.p5.TrainRunningNumber = kcg_lit_int32(0);
  outC->_L5.packets.p9.valid = kcg_true;
  outC->_L5.packets.p9.transitionInformation = kcg_lit_int32(0);
  ...
  outC->_L5.packets.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L5.packets.p11.l_train = kcg_lit_int32(0);
  outC->_L5.packets.p11.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L5.packets.p11.n_axle = kcg_lit_int32(0);
  outC->_L5.packets.p11.nIter_tractionIdentity = kcg_lit_int32(0);
  for (idx6 = 0; idx6 < 4; idx6++) {
    outC->_L5.packets.p11.tractionIdentity[idx6].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L5.packets.p11.tractionIdentity[idx6].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L5.packets.p11.nIter_ntc = kcg_lit_int32(0);
  for (idx7 = 0; idx7 < 5; idx7++) {
    outC->_L5.packets.p11.nid_ntc[idx7] = kcg_lit_int32(0);
  }
  ...
  outC->_L3.xT_TRAIN = kcg_lit_int32(0);
  outC->_L3.xNID_EM = kcg_lit_int32(0);
  outC->_L3.xQ_EMERGENCYSTOP =
    _12_Q_EMERGENCYSTOP_Conditional_Emergency_Stop_accepted_with_update_of_EOA;
  outC->_L3.xNID_TEXTMESSAGE = kcg_lit_int32(0);
  outC->_L4 = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p0.valid = kcg_true;
  outC->radioTrainTrackPackets.p0.packet0.NID_PACKET = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p0.packet0.L_PACKET = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->radioTrainTrackPackets.p0.packet0.NID_LRBG = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p0.packet0.D_LRBG = kcg_lit_int32(0);
  ...
  outC->radioTrainTrackPackets.p0.packet0.L_DOUBTOVER = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p0.packet0.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->radioTrainTrackPackets.p0.packet0.L_TRAININT = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p0.packet0.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->radioTrainTrackPackets.p0.packet0.NID_NTC = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p1.valid = kcg_true;
  outC->radioTrainTrackPackets.p1.packet1.NID_PACKET = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p1.packet1.L_PACKET = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->radioTrainTrackPackets.p1.packet1.NID_LRBG = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p1.packet1.NID_PRVLRBG = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p1.packet1.D_LRBG = kcg_lit_int32(0);
  ...
  outC->radioTrainTrackPackets.p1.packet1.L_DOUBTOVER = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p1.packet1.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->radioTrainTrackPackets.p1.packet1.L_TRAININT = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p1.packet1.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->radioTrainTrackPackets.p1.packet1.NID_NTC = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p3.valid = kcg_true;
  outC->radioTrainTrackPackets.p3.number = kcg_lit_int32(0);
  ...
  outC->radioTrainTrackPackets.p5.TrainRunningNumber = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p9.valid = kcg_true;
  outC->radioTrainTrackPackets.p9.transitionInformation = kcg_lit_int32(0);
  ...
  outC->radioTrainTrackPackets.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->radioTrainTrackPackets.p11.l_train = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p11.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->radioTrainTrackPackets.p11.n_axle = kcg_lit_int32(0);
  outC->radioTrainTrackPackets.p11.nIter_tractionIdentity = kcg_lit_int32(0);
  ...
  outC->radioTrainTrackPackets.p11.nIter_ntc = kcg_lit_int32(0);
  for (idx11 = 0; idx11 < 5; idx11++) {
    outC->radioTrainTrackPackets.p11.nid_ntc[idx11] = kcg_lit_int32(0);
  }
  outC->radioTrainTrackmessageId = kcg_lit_int32(0);
  outC->IfBlock1_clock = kcg_true;
  outC->_L2_then_else_IfBlock1.p0.valid = kcg_true;
  outC->_L2_then_else_IfBlock1.p0.packet0.NID_PACKET = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p0.packet0.L_PACKET = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L2_then_else_IfBlock1.p0.packet0.NID_LRBG = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p0.packet0.D_LRBG = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_IfBlock1.p0.packet0.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p0.packet0.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L2_then_else_IfBlock1.p0.packet0.L_TRAININT = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p0.packet0.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_IfBlock1.p0.packet0.NID_NTC = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p1.valid = kcg_true;
  outC->_L2_then_else_IfBlock1.p1.packet1.NID_PACKET = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p1.packet1.L_PACKET = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L2_then_else_IfBlock1.p1.packet1.NID_LRBG = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p1.packet1.NID_PRVLRBG = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p1.packet1.D_LRBG = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_IfBlock1.p1.packet1.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p1.packet1.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L2_then_else_IfBlock1.p1.packet1.L_TRAININT = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p1.packet1.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_IfBlock1.p1.packet1.NID_NTC = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p3.valid = kcg_true;
  outC->_L2_then_else_IfBlock1.p3.number = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_IfBlock1.p5.TrainRunningNumber = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p9.valid = kcg_true;
  outC->_L2_then_else_IfBlock1.p9.transitionInformation = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_IfBlock1.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L2_then_else_IfBlock1.p11.l_train = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p11.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_IfBlock1.p11.n_axle = kcg_lit_int32(0);
  outC->_L2_then_else_IfBlock1.p11.nIter_tractionIdentity = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_IfBlock1.p11.nIter_ntc = kcg_lit_int32(0);
  for (idx15 = 0; idx15 < 5; idx15++) {
    outC->_L2_then_else_IfBlock1.p11.nid_ntc[idx15] = kcg_lit_int32(0);
  }
  outC->_L1_then_else_IfBlock1 = kcg_true;
  outC->else_clock_else_IfBlock1 = kcg_true;
  outC->_L4_then_else_else_else_IfBlock1.p0.valid = kcg_true;
  outC->_L4_then_else_else_else_IfBlock1.p0.packet0.NID_PACKET = kcg_lit_int32(0);
  outC->_L4_then_else_else_else_IfBlock1.p0.packet0.L_PACKET = kcg_lit_int32(0);
  outC->_L4_then_else_else_else_IfBlock1.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L4_then_else_else_else_IfBlock1.p0.packet0.NID_LRBG = kcg_lit_int32(0);
  outC->_L4_then_else_else_else_IfBlock1.p0.packet0.D_LRBG = kcg_lit_int32(0);
  ...
  outC->_L4_then_else_else_else_IfBlock1.p0.packet0.L_DOUBTOVER = kcg_lit_int32(
      0);
  outC->_L4_then_else_else_else_IfBlock1.p0.packet0.L_DOUBTUNDER =
    kcg_lit_int32(0);
  outC->_L4_then_else_else_else_IfBlock1.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L4_then_else_else_else_IfBlock1.p0.packet0.L_TRAININT = kcg_lit_int32(0);
  outC->_L4_then_else_else_else_IfBlock1.p0.packet0.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L4_then_else_else_else_IfBlock1.p0.packet0.NID_NTC = kcg_lit_int32(0);
  outC->_L4_then_else_else_else_IfBlock1.p1.valid = kcg_true;
  outC->_L4_then_else_else_else_IfBlock1.p1.packet1.NID_PACKET = kcg_lit_int32(0);
  outC->_L4_then_else_else_else_IfBlock1.p1.packet1.L_PACKET = kcg_lit_int32(0);
  outC->_L4_then_else_else_else_IfBlock1.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L4_then_else_else_else_IfBlock1.p1.packet1.NID_LRBG = kcg_lit_int32(0);
  outC->_L4_then_else_else_else_IfBlock1.p1.packet1.NID_PRVLRBG = kcg_lit_int32(
      0);
  outC->_L4_then_else_else_else_IfBlock1.p1.packet1.D_LRBG = kcg_lit_int32(0);
  ...
  outC->_L4_then_else_else_else_IfBlock1.p1.packet1.L_DOUBTOVER = kcg_lit_int32(
      0);
  outC->_L4_then_else_else_else_IfBlock1.p1.packet1.L_DOUBTUNDER =
    kcg_lit_int32(0);
  outC->_L4_then_else_else_else_IfBlock1.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L4_then_else_else_else_IfBlock1.p1.packet1.L_TRAININT = kcg_lit_int32(0);
  outC->_L4_then_else_else_else_IfBlock1.p1.packet1.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L4_then_else_else_else_IfBlock1.p1.packet1.NID_NTC = kcg_lit_int32(0);
  outC->_L4_then_else_else_else_IfBlock1.p3.valid = kcg_true;
  outC->_L4_then_else_else_else_IfBlock1.p3.number = kcg_lit_int32(0);
  ...
  outC->_L4_then_else_else_else_IfBlock1.p5.TrainRunningNumber = kcg_lit_int32(0);
  ...
  outC->_L4_then_else_else_else_IfBlock1.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L4_then_else_else_else_IfBlock1.p11.l_train = kcg_lit_int32(0);
  outC->_L4_then_else_else_else_IfBlock1.p11.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L4_then_else_else_else_IfBlock1.p11.n_axle = kcg_lit_int32(0);
  ...
  outC->_L4_then_else_else_else_IfBlock1.p11.nIter_ntc = kcg_lit_int32(0);
  for (idx19 = 0; idx19 < 5; idx19++) {
    outC->_L4_then_else_else_else_IfBlock1.p11.nid_ntc[idx19] = kcg_lit_int32(0);
  }
  outC->_L3_then_else_else_else_IfBlock1 = kcg_true;
  outC->else_clock_else_else_else_IfBlock1 = kcg_true;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.valid = kcg_true;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.NID_PACKET =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.L_PACKET =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.qscale =
    Q_SCALE_10_cm_scale;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.NID_LRBG =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.D_LRBG =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.dirlrbg =
    Q_DIRLRBG_Reverse;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.dlrbg =
    Q_DLRBG_Reverse;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.L_DOUBTOVER =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.L_DOUBTUNDER =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.L_TRAININT =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.V_TRAIN =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.dirtrain =
    Q_DIRTRAIN_Reverse;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.mode =
    M_MODE_Full_Supervision;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.level =
    M_LEVEL_Level_0;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p0.packet0.NID_NTC =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.valid = kcg_true;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.NID_PACKET =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.L_PACKET =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.qscale =
    Q_SCALE_10_cm_scale;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.NID_LRBG =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.NID_PRVLRBG =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.D_LRBG =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.dirlrbg =
    Q_DIRLRBG_Reverse;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.dlrbg =
    Q_DLRBG_Reverse;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.L_DOUBTOVER =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.L_DOUBTUNDER =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.L_TRAININT =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.V_TRAIN =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.dirtrain =
    Q_DIRTRAIN_Reverse;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.mode =
    M_MODE_Full_Supervision;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.level =
    M_LEVEL_Level_0;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p1.packet1.NID_NTC =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p3.valid = kcg_true;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p3.number = kcg_lit_int32(0);
  for (idx21 = 0; idx21 < 1; idx21++) {
    outC->_L39_then_else_else_else_else_else_IfBlock1.p3.aNID_RADIO[idx21].valid =
      kcg_true;
    for (idx20 = 0; idx20 < 15; idx20++) {
      outC->_L39_then_else_else_else_else_else_IfBlock1.p3.aNID_RADIO[idx21].telephoneNumber[idx20] =
        kcg_lit_int32(0);
    }
  }
  outC->_L39_then_else_else_else_else_else_IfBlock1.p4.valid = kcg_true;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p4.m_error =
    M_ERROR_Balise_group_linking_consistency_error;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p5.valid = kcg_true;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p5.TrainRunningNumber =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p9.valid = kcg_true;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p9.transitionInformation =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p11.valid = kcg_true;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p11.nc_cdtrain =
    NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p11.l_train = kcg_lit_int32(
      0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p11.v_maxtrain =
    kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p11.m_loadinggoage =
    M_LOADINGGAUGE_The_train_does_not_fit_to_any_of_the_interoperable_loading_gauge_profiles;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p11.m_axleloadcat =
    M_AXLELOADCAT_A;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p11.m_airtight =
    M_AIRTIGHT_Not_fitted;
  outC->_L39_then_else_else_else_else_else_IfBlock1.p11.n_axle = kcg_lit_int32(0);
  outC->_L39_then_else_else_else_else_else_IfBlock1.p11.nIter_tractionIdentity =
    kcg_lit_int32(0);
  for (idx22 = 0; idx22 < 4; idx22++) {
    outC->_L39_then_else_else_else_else_else_IfBlock1.p11.tractionIdentity[idx22].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L39_then_else_else_else_else_else_IfBlock1.p11.tractionIdentity[idx22].nid_ctraction =
      kcg_lit_int32(0);
  }
  outC->_L39_then_else_else_else_else_else_IfBlock1.p11.nIter_ntc =
    kcg_lit_int32(0);
  for (idx23 = 0; idx23 < 5; idx23++) {
    outC->_L39_then_else_else_else_else_else_IfBlock1.p11.nid_ntc[idx23] =
      kcg_lit_int32(0);
  }
  outC->_L28_then_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_4_else_clock_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.valid = kcg_true;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.NID_PACKET =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.L_PACKET =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.qscale =
    Q_SCALE_10_cm_scale;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.NID_LRBG =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.D_LRBG =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.dirlrbg =
    Q_DIRLRBG_Reverse;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.dlrbg =
    Q_DLRBG_Reverse;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.L_DOUBTOVER =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.L_DOUBTUNDER =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.L_TRAININT =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.V_TRAIN =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.dirtrain =
    Q_DIRTRAIN_Reverse;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.mode =
    M_MODE_Full_Supervision;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.level =
    M_LEVEL_Level_0;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p0.packet0.NID_NTC =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.valid = kcg_true;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.NID_PACKET =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.L_PACKET =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.qscale =
    Q_SCALE_10_cm_scale;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.NID_LRBG =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.NID_PRVLRBG =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.D_LRBG =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.dirlrbg =
    Q_DIRLRBG_Reverse;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.dlrbg =
    Q_DLRBG_Reverse;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.L_DOUBTOVER =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.L_DOUBTUNDER =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.L_TRAININT =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.V_TRAIN =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.dirtrain =
    Q_DIRTRAIN_Reverse;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.mode =
    M_MODE_Full_Supervision;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.level =
    M_LEVEL_Level_0;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p1.packet1.NID_NTC =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p3.valid = kcg_true;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p3.number =
    kcg_lit_int32(0);
  for (idx25 = 0; idx25 < 1; idx25++) {
    outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p3.aNID_RADIO[idx25].valid =
      kcg_true;
    for (idx24 = 0; idx24 < 15; idx24++) {
      outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p3.aNID_RADIO[idx25].telephoneNumber[idx24] =
        kcg_lit_int32(0);
    }
  }
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p4.valid = kcg_true;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p4.m_error =
    M_ERROR_Balise_group_linking_consistency_error;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p5.valid = kcg_true;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p5.TrainRunningNumber =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p9.valid = kcg_true;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p9.transitionInformation =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p11.valid =
    kcg_true;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p11.nc_cdtrain =
    NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p11.l_train =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p11.v_maxtrain =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p11.m_loadinggoage =
    M_LOADINGGAUGE_The_train_does_not_fit_to_any_of_the_interoperable_loading_gauge_profiles;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p11.m_axleloadcat =
    M_AXLELOADCAT_A;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p11.m_airtight =
    M_AIRTIGHT_Not_fitted;
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p11.n_axle =
    kcg_lit_int32(0);
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p11.nIter_tractionIdentity =
    kcg_lit_int32(0);
  for (idx26 = 0; idx26 < 4; idx26++) {
    outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p11.tractionIdentity[idx26].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p11.tractionIdentity[idx26].nid_ctraction =
      kcg_lit_int32(0);
  }
  outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p11.nIter_ntc =
    kcg_lit_int32(0);
  for (idx27 = 0; idx27 < 5; idx27++) {
    outC->_L27_then_else_else_else_else_else_else_else_IfBlock1.p11.nid_ntc[idx27] =
      kcg_lit_int32(0);
  }
  outC->_L3_then_else_else_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_3_else_clock_else_else_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_L1_else_else_else_else_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.valid =
    kcg_true;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.NID_PACKET =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.L_PACKET =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.qscale =
    Q_SCALE_10_cm_scale;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.NID_LRBG =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.D_LRBG =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.dirlrbg =
    Q_DIRLRBG_Reverse;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.dlrbg =
    Q_DLRBG_Reverse;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.L_DOUBTOVER =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.L_DOUBTUNDER =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.L_TRAININT =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.V_TRAIN =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.dirtrain =
    Q_DIRTRAIN_Reverse;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.mode =
    M_MODE_Full_Supervision;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.level =
    M_LEVEL_Level_0;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p0.packet0.NID_NTC =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.valid =
    kcg_true;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.NID_PACKET =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.L_PACKET =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.qscale =
    Q_SCALE_10_cm_scale;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.NID_LRBG =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.NID_PRVLRBG =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.D_LRBG =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.dirlrbg =
    Q_DIRLRBG_Reverse;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.dlrbg =
    Q_DLRBG_Reverse;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.L_DOUBTOVER =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.L_DOUBTUNDER =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.L_TRAININT =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.V_TRAIN =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.dirtrain =
    Q_DIRTRAIN_Reverse;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.mode =
    M_MODE_Full_Supervision;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.level =
    M_LEVEL_Level_0;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p1.packet1.NID_NTC =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p3.valid =
    kcg_true;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p3.number =
    kcg_lit_int32(0);
  for (idx29 = 0; idx29 < 1; idx29++) {
    outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p3.aNID_RADIO[idx29].valid =
      kcg_true;
    for (idx28 = 0; idx28 < 15; idx28++) {
      outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p3.aNID_RADIO[idx29].telephoneNumber[idx28] =
        kcg_lit_int32(0);
    }
  }
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p4.valid =
    kcg_true;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p4.m_error =
    M_ERROR_Balise_group_linking_consistency_error;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p5.valid =
    kcg_true;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p5.TrainRunningNumber =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p9.valid =
    kcg_true;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p9.transitionInformation =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p11.valid =
    kcg_true;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p11.nc_cdtrain =
    NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p11.l_train =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p11.v_maxtrain =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p11.m_loadinggoage =
    M_LOADINGGAUGE_The_train_does_not_fit_to_any_of_the_interoperable_loading_gauge_profiles;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p11.m_axleloadcat =
    M_AXLELOADCAT_A;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p11.m_airtight =
    M_AIRTIGHT_Not_fitted;
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p11.n_axle =
    kcg_lit_int32(0);
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p11.nIter_tractionIdentity =
    kcg_lit_int32(0);
  for (idx30 = 0; idx30 < 4; idx30++) {
    outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p11.tractionIdentity[idx30].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p11.tractionIdentity[idx30].nid_ctraction =
      kcg_lit_int32(0);
  }
  outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p11.nIter_ntc =
    kcg_lit_int32(0);
  for (idx31 = 0; idx31 < 5; idx31++) {
    outC->_L16_then_else_else_else_else_else_else_else_else_IfBlock1.p11.nid_ntc[idx31] =
      kcg_lit_int32(0);
  }
  outC->_L25_then_else_else_else_else_else_else_else_else_IfBlock1 = kcg_true;
  ...
  outC->_L2_then_else_else_else_else_IfBlock1.p0.packet0.NID_LRBG =
    kcg_lit_int32(0);
  outC->_L2_then_else_else_else_else_IfBlock1.p0.packet0.D_LRBG = kcg_lit_int32(
      0);
  ...
  outC->_L2_then_else_else_else_else_IfBlock1.p1.packet1.NID_PRVLRBG =
    kcg_lit_int32(0);
  outC->_L2_then_else_else_else_else_IfBlock1.p1.packet1.D_LRBG = kcg_lit_int32(
      0);
  ...
  outC->_L2_then_else_else_else_else_IfBlock1.p3.number = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_else_else_else_IfBlock1.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L2_then_else_else_else_else_IfBlock1.p11.l_train = kcg_lit_int32(0);
  outC->_L2_then_else_else_else_else_IfBlock1.p11.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_else_else_else_IfBlock1.p11.m_airtight =
    M_AIRTIGHT_Not_fitted;
  outC->_L2_then_else_else_else_else_IfBlock1.p11.n_axle = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_else_else_else_IfBlock1.p11.nIter_ntc = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_else_IfBlock1.p0.packet0.NID_PACKET = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p0.packet0.L_PACKET = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L2_then_else_else_IfBlock1.p0.packet0.NID_LRBG = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p0.packet0.D_LRBG = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_else_IfBlock1.p0.packet0.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p0.packet0.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L2_then_else_else_IfBlock1.p0.packet0.L_TRAININT = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p0.packet0.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_else_IfBlock1.p0.packet0.NID_NTC = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p1.valid = kcg_true;
  outC->_L2_then_else_else_IfBlock1.p1.packet1.NID_PACKET = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p1.packet1.L_PACKET = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L2_then_else_else_IfBlock1.p1.packet1.NID_LRBG = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p1.packet1.NID_PRVLRBG = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p1.packet1.D_LRBG = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_else_IfBlock1.p1.packet1.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p1.packet1.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L2_then_else_else_IfBlock1.p1.packet1.L_TRAININT = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p1.packet1.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_else_IfBlock1.p1.packet1.NID_NTC = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p3.valid = kcg_true;
  outC->_L2_then_else_else_IfBlock1.p3.number = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_else_IfBlock1.p5.TrainRunningNumber = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p9.valid = kcg_true;
  outC->_L2_then_else_else_IfBlock1.p9.transitionInformation = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_else_IfBlock1.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L2_then_else_else_IfBlock1.p11.l_train = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p11.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_else_IfBlock1.p11.n_axle = kcg_lit_int32(0);
  outC->_L2_then_else_else_IfBlock1.p11.nIter_tractionIdentity = kcg_lit_int32(0);
  ...
  outC->_L2_then_else_else_IfBlock1.p11.nIter_ntc = kcg_lit_int32(0);
  for (idx43 = 0; idx43 < 5; idx43++) {
    outC->_L2_then_else_else_IfBlock1.p11.nid_ntc[idx43] = kcg_lit_int32(0);
  }
  outC->else_clock_IfBlock1 = kcg_true;
  outC->_L1_then_IfBlock1 = kcg_true;
  outC->_L2_then_IfBlock1.p0.valid = kcg_true;
  outC->_L2_then_IfBlock1.p0.packet0.NID_PACKET = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p0.packet0.L_PACKET = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p0.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L2_then_IfBlock1.p0.packet0.NID_LRBG = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p0.packet0.D_LRBG = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p0.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L2_then_IfBlock1.p0.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->_L2_then_IfBlock1.p0.packet0.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p0.packet0.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p0.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L2_then_IfBlock1.p0.packet0.L_TRAININT = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p0.packet0.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L2_then_IfBlock1.p0.packet0.NID_NTC = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p1.valid = kcg_true;
  outC->_L2_then_IfBlock1.p1.packet1.NID_PACKET = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p1.packet1.L_PACKET = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p1.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L2_then_IfBlock1.p1.packet1.NID_LRBG = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p1.packet1.NID_PRVLRBG = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p1.packet1.D_LRBG = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p1.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L2_then_IfBlock1.p1.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L2_then_IfBlock1.p1.packet1.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p1.packet1.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p1.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L2_then_IfBlock1.p1.packet1.L_TRAININT = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p1.packet1.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L2_then_IfBlock1.p1.packet1.NID_NTC = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p3.valid = kcg_true;
  outC->_L2_then_IfBlock1.p3.number = kcg_lit_int32(0);
  ...
  outC->_L2_then_IfBlock1.p5.TrainRunningNumber = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p9.valid = kcg_true;
  outC->_L2_then_IfBlock1.p9.transitionInformation = kcg_lit_int32(0);
  ...
  outC->_L2_then_IfBlock1.p11.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L2_then_IfBlock1.p11.l_train = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p11.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L2_then_IfBlock1.p11.n_axle = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.p11.nIter_tractionIdentity = kcg_lit_int32(0);
  ...
  outC->_L2_then_IfBlock1.p11.nIter_ntc = kcg_lit_int32(0);
  for (idx47 = 0; idx47 < 5; idx47++) {
    outC->_L2_then_IfBlock1.p11.nid_ntc[idx47] = kcg_lit_int32(0);
  }
  outC->outIsConsistent = kcg_true;
  /* IfBlock1:then:_L1=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg129ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg129ConsistencyChecker__init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg129ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:then:_L1=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg132ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg132ConsistencyChecker__init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg132ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:else:then:_L1=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg136ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg136ConsistencyChecker__init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg136ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:else:else:then:_L3=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg146ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg146ConsistencyChecker__init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg146ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:else:else:else:then:_L1=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg154ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg154ConsistencyChecker__init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg154ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:else:else:else:else:then:_L2=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg155ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg155ConsistencyChecker__init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg155ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:else:else:else:else:else:then:_L1=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg159ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg159ConsistencyChecker__init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg159ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:else:else:else:else:else:else:then:_L3=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg156ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg156ConsistencyChecker__init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg156ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:else:else:else:else:else:else:else:then:_L2=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg147ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg147ConsistencyChecker__init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg147ConsistencyChecker__HasConsistentPackets_1);
  /* _L6=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__GetPackets#1)/ */
  _52_RadioTrainTrackMessage__G_init_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->Context_RadioTrainTrackMessage__GetPackets_1);
  /* _L4=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__Get_NID_MESSAGE#1)/ */
...
void RadioTrainTrackMessageCon_reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
  outC_RadioTrainTrackMessageCon_RBC_Messaging_Pkg_RBC_Consistency_Pkg *outC)
{
  /* IfBlock1:then:_L1=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg129ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg129ConsistencyChecker__reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg129ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:then:_L1=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg132ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg132ConsistencyChecker__reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg132ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:else:then:_L1=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg136ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg136ConsistencyChecker__reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg136ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:else:else:then:_L3=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg146ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg146ConsistencyChecker__reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg146ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:else:else:else:then:_L1=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg154ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg154ConsistencyChecker__reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg154ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:else:else:else:else:then:_L2=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg155ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg155ConsistencyChecker__reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg155ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:else:else:else:else:else:then:_L1=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg159ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg159ConsistencyChecker__reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg159ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:else:else:else:else:else:else:then:_L3=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg156ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg156ConsistencyChecker__reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg156ConsistencyChecker__HasConsistentPackets_1);
  /* IfBlock1:else:else:else:else:else:else:else:else:then:_L2=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg147ConsistencyChecker__HasConsistentPackets#1)/ */
  Msg147ConsistencyChecker__reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_Msg147ConsistencyChecker__HasConsistentPackets_1);
  /* _L6=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__GetPackets#1)/ */
  _52_RadioTrainTrackMessage__G_reset_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->Context_RadioTrainTrackMessage__GetPackets_1);
  /* _L4=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__Get_NID_MESSAGE#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** RadioTrainTrackMessageCon_RBC_Messaging_Pkg_RBC_Consistency_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
