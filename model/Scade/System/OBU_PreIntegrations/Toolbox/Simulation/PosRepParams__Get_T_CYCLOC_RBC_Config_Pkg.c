...
void PosRepParams__Get_T_CYCLOC_RBC_Config_Pkg(
  /* inPosRepParams/ */
  ...
  outC_PosRepParams__Get_T_CYCLOC_RBC_Config_Pkg *outC)
{
  ...
  outC->_L2 = outC->_L1.t_cycloc;
  outC->out_T_CYCLOC = outC->_L2;
}

#ifndef KCG_USER_DEFINED_INIT
void PosRepParams__Get_T_CYCLOC_init_RBC_Config_Pkg(
  outC_PosRepParams__Get_T_CYCLOC_RBC_Config_Pkg *outC)
{
  kcg_size idx;
  ...
  outC->out_T_CYCLOC = kcg_lit_int32(0);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void PosRepParams__Get_T_CYCLOC_reset_RBC_Config_Pkg(
  outC_PosRepParams__Get_T_CYCLOC_RBC_Config_Pkg *outC)
{
}
