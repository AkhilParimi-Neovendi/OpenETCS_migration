...
void Balise_441_1_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
  ...
  /* PIG_nom/ */
  kcg_int32 PIG_nom,
  outC_Balise_441_1_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet15_MaarssenUtrechtCS_Balises::Packets_BG441#1)/ */
    Packets_BG441_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG441_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG441_1.Balise_data_out);
...
void Balise_441_1_init_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
  outC_Balise_441_1_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet15_MaarssenUtrechtCS_Balises::Packets_BG441#1)/ */
  Packets_BG441_init_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
    &outC->Context_Packets_BG441_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_441_1_reset_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
  outC_Balise_441_1_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet15_MaarssenUtrechtCS_Balises::Packets_BG441#1)/ */
  Packets_BG441_reset_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises(
    &outC->Context_Packets_BG441_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
