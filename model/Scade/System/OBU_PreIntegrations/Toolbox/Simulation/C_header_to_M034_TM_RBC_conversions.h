...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  M_034_T_TM_radio_messages /* message_out/ */ message_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  outC_CAST_Int_to_L_TAFDISPLAY_TM_conversions /* _L32=(TM_conversions::CAST_Int_to_L_TAFDISPLAY#1)/ */ Context_CAST_Int_to_L_TAFDISPLAY_1;
  outC_CAST_Int_to_D_TAFDISPLAY_TM_conversions /* _L33=(TM_conversions::CAST_Int_to_D_TAFDISPLAY#1)/ */ Context_CAST_Int_to_D_TAFDISPLAY_1;
  outC_CAST_Int_to_NID_MESSAGE_TM_conversions /* _L35=(TM_conversions::CAST_Int_to_NID_MESSAGE#1)/ */ Context_CAST_Int_to_NID_MESSAGE_1;
  outC_CAST_Int_to_L_MESSAGE_TM_conversions /* _L36=(TM_conversions::CAST_Int_to_L_MESSAGE#1)/ */ Context_CAST_Int_to_L_MESSAGE_1;
  outC_CAST_Int_to_T_TRAIN_TM_conversions /* _L37=(TM_conversions::CAST_Int_to_T_TRAIN#1)/ */ Context_CAST_Int_to_T_TRAIN_1;
  ...
  kcg_bool /* @1/IfBlock1:else: */ _1_else_clock_CAST_Int_to_Q_SCALE_1_IfBlock1;
  ...
  kcg_bool /* @2/IfBlock1:else: */ _2_else_clock_CAST_Int_to_Q_DIR_1_IfBlock1;
  /* -------------------- (-debug) no assertions  -------------------- */
  ...
  Q_SCALE /* @1/IfBlock1:else:else:then:_L1/ */ _3__L1_CAST_Int_to_Q_SCALE_1_then_else_else_IfBlock1;
  ...
  kcg_bool /* @1/IfBlock1:then:_L3/ */ _4__L3_CAST_Int_to_Q_SCALE_1_then_IfBlock1;
  Q_DIR /* @2/q_dir/ */ q_dir_CAST_Int_to_Q_DIR_1;
  kcg_int64 /* @2/q_dir_int/ */ q_dir_int_CAST_Int_to_Q_DIR_1;
  kcg_int64 /* @2/_L12/ */ _L12_CAST_Int_to_Q_DIR_1;
  kcg_bool /* @2/_L13/ */ _L13_CAST_Int_to_Q_DIR_1;
  kcg_int64 /* @2/q_dir_in/ */ q_dir_in_CAST_Int_to_Q_DIR_1;
  ...
  kcg_int64 /* _L3/ */ _L3;
  kcg_bool /* _L2/ */ _L2;
  M_034_T_TM_radio_messages /* _L26/ */ _L26;
  M_ACK /* _L27/ */ _L27;
  NID_LRBG /* _L28/ */ _L28;
  Q_SCALE /* _L29/ */ _L29;
  D_REF /* _L30/ */ _L30;
  Q_DIR /* _L31/ */ _L31;
  L_TAFDISPLAY /* _L32/ */ _L32;
  D_TAFDISPLAY /* _L33/ */ _L33;
  T_TRAIN /* _L37/ */ _L37;
  L_MESSAGE /* _L36/ */ _L36;
  NID_MESSAGE /* _L35/ */ _L35;
...
extern void C_header_to_M034_init_TM_RBC_conversions(
  outC_C_header_to_M034_TM_RBC_conversions *outC);
