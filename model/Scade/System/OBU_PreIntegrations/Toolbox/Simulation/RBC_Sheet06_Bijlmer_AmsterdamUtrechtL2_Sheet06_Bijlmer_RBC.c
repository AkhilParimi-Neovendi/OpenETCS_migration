  ...
  outC_RBC_Sheet06_Bijlmer_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC *outC)
{
  ...
  _157_Send_RBC_LRBG_354_D__AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->_L13,
  ...
  _160_Send_RBC_LRBG_351_D__AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->_L1,
  ...
  Send_RBC_LRBG_362_D_00230_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    ...
    &outC->_1_Context_Send_RBC_LRBG_362_D_00230_6_M003_1);
  kcg_copy_R_data_internal_T_InfraLib(
    &outC->_L8,
    &outC->_1_Context_Send_RBC_LRBG_362_D_00230_6_M003_1.R_data_out);
  ...
  outC_RBC_Sheet06_Bijlmer_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC *outC)
{
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L12.packets.PacketHeaders[idx2].nid_packet = kcg_lit_int64(0);
    outC->_L12.packets.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L12.packets.PacketHeaders[idx2].valid = kcg_true;
    outC->_L12.packets.PacketHeaders[idx2].startAddress = kcg_lit_int64(0);
    outC->_L12.packets.PacketHeaders[idx2].endAddress = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L12.packets.PacketData[idx3] = kcg_lit_int64(0);
  }
  outC->_L12.trigger = kcg_lit_int64(0);
  outC->_L12.message_sent = kcg_true;
  outC->_L11.message.valid = kcg_true;
  outC->_L11.message.nid_message = kcg_lit_int64(0);
  outC->_L11.message.l_message = kcg_lit_int64(0);
  outC->_L11.message.t_train = kcg_lit_int64(0);
  outC->_L11.message.field1 = kcg_lit_int64(0);
  outC->_L11.message.field2 = kcg_lit_int64(0);
  outC->_L11.message.field3 = kcg_lit_int64(0);
  outC->_L11.message.field4 = kcg_lit_int64(0);
  outC->_L11.message.field5 = kcg_lit_int64(0);
  outC->_L11.message.field6 = kcg_lit_int64(0);
  outC->_L11.message.field7 = kcg_lit_int64(0);
  outC->_L11.message.field8 = kcg_lit_int64(0);
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L11.packets.PacketHeaders[idx4].nid_packet = kcg_lit_int64(0);
    outC->_L11.packets.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L11.packets.PacketHeaders[idx4].valid = kcg_true;
    outC->_L11.packets.PacketHeaders[idx4].startAddress = kcg_lit_int64(0);
    outC->_L11.packets.PacketHeaders[idx4].endAddress = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L11.packets.PacketData[idx5] = kcg_lit_int64(0);
  }
  outC->_L11.trigger = kcg_lit_int64(0);
  ...
  for (idx10 = 0; idx10 < 30; idx10++) {
    outC->_L8.packets.PacketHeaders[idx10].nid_packet = kcg_lit_int64(0);
    outC->_L8.packets.PacketHeaders[idx10].q_dir = Q_DIR_Reverse;
    outC->_L8.packets.PacketHeaders[idx10].valid = kcg_true;
    outC->_L8.packets.PacketHeaders[idx10].startAddress = kcg_lit_int64(0);
    outC->_L8.packets.PacketHeaders[idx10].endAddress = kcg_lit_int64(0);
  }
  for (idx11 = 0; idx11 < 500; idx11++) {
    outC->_L8.packets.PacketData[idx11] = kcg_lit_int64(0);
  }
  ...
  for (idx14 = 0; idx14 < 30; idx14++) {
    outC->_L6.packets.PacketHeaders[idx14].nid_packet = kcg_lit_int64(0);
    outC->_L6.packets.PacketHeaders[idx14].q_dir = Q_DIR_Reverse;
    outC->_L6.packets.PacketHeaders[idx14].valid = kcg_true;
    outC->_L6.packets.PacketHeaders[idx14].startAddress = kcg_lit_int64(0);
    outC->_L6.packets.PacketHeaders[idx14].endAddress = kcg_lit_int64(0);
  }
  for (idx15 = 0; idx15 < 500; idx15++) {
    outC->_L6.packets.PacketData[idx15] = kcg_lit_int64(0);
  }
  ...
  for (idx16 = 0; idx16 < 30; idx16++) {
    outC->_L5.packets.PacketHeaders[idx16].nid_packet = kcg_lit_int64(0);
    outC->_L5.packets.PacketHeaders[idx16].q_dir = Q_DIR_Reverse;
    outC->_L5.packets.PacketHeaders[idx16].valid = kcg_true;
    outC->_L5.packets.PacketHeaders[idx16].startAddress = kcg_lit_int64(0);
    outC->_L5.packets.PacketHeaders[idx16].endAddress = kcg_lit_int64(0);
  }
  for (idx17 = 0; idx17 < 500; idx17++) {
    outC->_L5.packets.PacketData[idx17] = kcg_lit_int64(0);
  }
  ...
  for (idx18 = 0; idx18 < 30; idx18++) {
    outC->_L4.packets.PacketHeaders[idx18].nid_packet = kcg_lit_int64(0);
    outC->_L4.packets.PacketHeaders[idx18].q_dir = Q_DIR_Reverse;
    outC->_L4.packets.PacketHeaders[idx18].valid = kcg_true;
    outC->_L4.packets.PacketHeaders[idx18].startAddress = kcg_lit_int64(0);
    outC->_L4.packets.PacketHeaders[idx18].endAddress = kcg_lit_int64(0);
  }
  for (idx19 = 0; idx19 < 500; idx19++) {
    outC->_L4.packets.PacketData[idx19] = kcg_lit_int64(0);
  }
  ...
  for (idx20 = 0; idx20 < 30; idx20++) {
    outC->_L3.packets.PacketHeaders[idx20].nid_packet = kcg_lit_int64(0);
    outC->_L3.packets.PacketHeaders[idx20].q_dir = Q_DIR_Reverse;
    outC->_L3.packets.PacketHeaders[idx20].valid = kcg_true;
    outC->_L3.packets.PacketHeaders[idx20].startAddress = kcg_lit_int64(0);
    outC->_L3.packets.PacketHeaders[idx20].endAddress = kcg_lit_int64(0);
  }
  for (idx21 = 0; idx21 < 500; idx21++) {
    outC->_L3.packets.PacketData[idx21] = kcg_lit_int64(0);
  }
  ...
  for (idx22 = 0; idx22 < 30; idx22++) {
    outC->_L2.packets.PacketHeaders[idx22].nid_packet = kcg_lit_int64(0);
    outC->_L2.packets.PacketHeaders[idx22].q_dir = Q_DIR_Reverse;
    outC->_L2.packets.PacketHeaders[idx22].valid = kcg_true;
    outC->_L2.packets.PacketHeaders[idx22].startAddress = kcg_lit_int64(0);
    outC->_L2.packets.PacketHeaders[idx22].endAddress = kcg_lit_int64(0);
  }
  for (idx23 = 0; idx23 < 500; idx23++) {
    outC->_L2.packets.PacketData[idx23] = kcg_lit_int64(0);
  }
  ...
  for (idx24 = 0; idx24 < 30; idx24++) {
    outC->_L1.packets.PacketHeaders[idx24].nid_packet = kcg_lit_int64(0);
    outC->_L1.packets.PacketHeaders[idx24].q_dir = Q_DIR_Reverse;
    outC->_L1.packets.PacketHeaders[idx24].valid = kcg_true;
    outC->_L1.packets.PacketHeaders[idx24].startAddress = kcg_lit_int64(0);
    outC->_L1.packets.PacketHeaders[idx24].endAddress = kcg_lit_int64(0);
  }
  for (idx25 = 0; idx25 < 500; idx25++) {
    outC->_L1.packets.PacketData[idx25] = kcg_lit_int64(0);
  }
  ...
  for (idx26 = 0; idx26 < 30; idx26++) {
    outC->R_data_out.packets.PacketHeaders[idx26].nid_packet = kcg_lit_int64(0);
    ...
    outC->R_data_out.packets.PacketHeaders[idx26].startAddress = kcg_lit_int64(0);
    outC->R_data_out.packets.PacketHeaders[idx26].endAddress = kcg_lit_int64(0);
  }
  for (idx27 = 0; idx27 < 500; idx27++) {
    outC->R_data_out.packets.PacketData[idx27] = kcg_lit_int64(0);
  }
  outC->R_data_out.trigger = kcg_lit_int64(0);
  outC->R_data_out.message_sent = kcg_true;
  /* _L12=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Send_RBC_LRBG_341_D_00134_4_M015#1)/ */
  Send_RBC_LRBG_341_D_00134_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Send_RBC_LRBG_341_D_00134_4_M015_1);
  /* _L11=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Send_RBC_LRBG_369_D_00231_3_M015#1)/ */
  Send_RBC_LRBG_369_D_00231_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Send_RBC_LRBG_369_D_00231_3_M015_1);
  /* _L10=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Send_RBC_LRBG_364_D_00091_1_M003#1)/ */
  Send_RBC_LRBG_364_D_00091_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Send_RBC_LRBG_364_D_00091_1_M003_1);
  /* _L9=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Send_RBC_LRBG_362_D_00238_9_M003#1)/ */
  Send_RBC_LRBG_362_D_00238_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Send_RBC_LRBG_362_D_00238_9_M003_1);
  /* _L8=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Send_RBC_LRBG_362_D_00230_6_M003#1)/ */
  Send_RBC_LRBG_362_D_00230_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->_1_Context_Send_RBC_LRBG_362_D_00230_6_M003_1);
  /* _L7=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Send_RBC_LRBG_362_D_00124_9_M015#1)/ */
  Send_RBC_LRBG_362_D_00124_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Send_RBC_LRBG_362_D_00124_9_M015_1);
  /* _L6=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Send_RBC_LRBG_360_D_00249_2_M015#1)/ */
  Send_RBC_LRBG_360_D_00249_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Send_RBC_LRBG_360_D_00249_2_M015_1);
  /* _L5=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Send_RBC_LRBG_358_D_00123_1_M015#1)/ */
  Send_RBC_LRBG_358_D_00123_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Send_RBC_LRBG_358_D_00123_1_M015_1);
  /* _L4=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Send_RBC_LRBG_356_D_00048_5_M015#1)/ */
  Send_RBC_LRBG_356_D_00048_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Send_RBC_LRBG_356_D_00048_5_M015_1);
  /* _L3=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Send_RBC_LRBG_355_D_00089_4_M015#1)/ */
  Send_RBC_LRBG_355_D_00089_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Send_RBC_LRBG_355_D_00089_4_M015_1);
  /* _L2=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Send_RBC_LRBG_351_D_00054_9_M003#1)/ */
  _160_Send_RBC_LRBG_351_D__init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Send_RBC_LRBG_351_D_00054_9_M003_1);
  /* _L1=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Send_RBC_LRBG_354_D_00275_3_M003#1)/ */
  _157_Send_RBC_LRBG_354_D__init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Send_RBC_LRBG_354_D_00275_3_M003_1);
}
  ...
  outC_RBC_Sheet06_Bijlmer_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC *outC)
{
  ...
  Send_RBC_LRBG_355_D_00089_reset_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Send_RBC_LRBG_355_D_00089_4_M015_1);
  /* _L2=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Send_RBC_LRBG_351_D_00054_9_M003#1)/ */
  _160_Send_RBC_LRBG_351_D__reset_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Send_RBC_LRBG_351_D_00054_9_M003_1);
  /* _L1=(AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::Send_RBC_LRBG_354_D_00275_3_M003#1)/ */
  _157_Send_RBC_LRBG_354_D__reset_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
    &outC->Context_Send_RBC_LRBG_354_D_00275_3_M003_1);
}
