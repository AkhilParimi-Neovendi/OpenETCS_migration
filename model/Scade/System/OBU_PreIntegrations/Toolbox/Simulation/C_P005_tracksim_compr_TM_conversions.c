  ...
  outC_C_P005_tracksim_compr_TM_conversions *outC)
{
  ...
  /* @1/q_dir/ */
  Q_DIR _3_q_dir_partial_CAST_Int_to_Q_DIR_1;
  /* @1/error/ */
  ...
  /* @1/error/ */
  kcg_bool _11_error_partial_CAST_Int_to_Q_DIR_1;
  /* @1/q_dir/ */
  ...
  /* _L386/ */
  for (idx = 0; idx < 1; idx++) {
    kcg_copy_P005_section_int_T_TM(&outC->_L386[idx], &outC->_L375);
  }
  kcg_copy_P005_trackide_sectionlist_T_TM(&outC->_L365, &outC->_L1.SECTIONS);
  kcg_copy_P005_section_int_T_TM(&outC->_L385[0], &outC->_L386[0]);
  kcg_copy_P005_trackide_sectionlist_T_TM(&outC->_L385[1], &outC->_L365);
  /* _L380=(TM_lib_internal::C_P005_flatten_sections#1)/ */
  C_P005_flatten_sections_TM_lib_internal(
    &outC->_L385,
    &outC->Context_C_P005_flatten_sections_1);
  kcg_copy_P005_sections_array_flat_T_TM(
    &outC->_L380,
    &outC->Context_C_P005_flatten_sections_1.Flattened);
  outC->_L366 = outC->_L1.N_ITER;
  /* _L376/ */
  for (idx1 = 0; idx1 < 1; idx1++) {
    outC->_L376[idx1] = outC->_L366;
  }
  ...
  kcg_copy_P015_section_array_T_TM(&outC->_L381[0], &outC->_L373);
  outC->_L381[4] = outC->_L376[0];
  kcg_copy_array_int64_5(&outC->_L384[0], &outC->_L381);
  kcg_copy_P005_sections_array_flat_T_TM(&outC->_L384[5], &outC->_L380);
  outC->_L336 = kcg_lit_int64(0);
  /* _L209/ */
  for (idx2 = 0; idx2 < 400; idx2++) {
    outC->_L209[idx2] = outC->_L336;
  }
  kcg_copy_array_int64_100(&outC->_L383[0], &outC->_L384);
  kcg_copy_array_int64_400(&outC->_L383[100], &outC->_L209);
  /* _L379=(TM_lib_internal::T_DeterminePacketSizeInt#1)/ */
  T_DeterminePacketSizeInt_TM_lib_internal(
    outC->_L366,
    kcg_lit_int64(4) + kcg_lit_int64(1) + kcg_lit_int64(7),
    kcg_lit_int64(7),
...
void C_P005_tracksim_compr_init_TM_conversions(
  outC_C_P005_tracksim_compr_TM_conversions *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx = 0; idx < 33; idx++) {
    outC->_L385[idx].D_LINK = kcg_lit_int64(0);
    outC->_L385[idx].Q_NEWCOUNTRY = kcg_lit_int64(0);
    outC->_L385[idx].NID_C = kcg_lit_int64(0);
    outC->_L385[idx].NID_BG = kcg_lit_int64(0);
    outC->_L385[idx].Q_LINKORIENTATION = kcg_lit_int64(0);
    outC->_L385[idx].Q_LINKREACTION = kcg_lit_int64(0);
    outC->_L385[idx].Q_LOCACC = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 1; idx1++) {
    outC->_L386[idx1].D_LINK = kcg_lit_int64(0);
    outC->_L386[idx1].Q_NEWCOUNTRY = kcg_lit_int64(0);
    outC->_L386[idx1].NID_C = kcg_lit_int64(0);
    outC->_L386[idx1].NID_BG = kcg_lit_int64(0);
    outC->_L386[idx1].Q_LINKORIENTATION = kcg_lit_int64(0);
    outC->_L386[idx1].Q_LINKREACTION = kcg_lit_int64(0);
    outC->_L386[idx1].Q_LOCACC = kcg_lit_int64(0);
  }
  for (idx2 = 0; idx2 < 100; idx2++) {
    outC->_L384[idx2] = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L383[idx3] = kcg_lit_int64(0);
  }
  for (idx4 = 0; idx4 < 5; idx4++) {
    outC->_L381[idx4] = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 95; idx5++) {
    outC->_L380[idx5] = kcg_lit_int64(0);
  }
  outC->_L379 = kcg_lit_int64(0);
  outC->_L378 = kcg_lit_int64(0);
  for (idx6 = 0; idx6 < 1; idx6++) {
    outC->_L376[idx6] = kcg_lit_int64(0);
  }
  outC->_L375.D_LINK = kcg_lit_int64(0);
  outC->_L375.Q_NEWCOUNTRY = kcg_lit_int64(0);
  outC->_L375.NID_C = kcg_lit_int64(0);
  outC->_L375.NID_BG = kcg_lit_int64(0);
  outC->_L375.Q_LINKORIENTATION = kcg_lit_int64(0);
  outC->_L375.Q_LINKREACTION = kcg_lit_int64(0);
  outC->_L375.Q_LOCACC = kcg_lit_int64(0);
  for (idx7 = 0; idx7 < 4; idx7++) {
    outC->_L373[idx7] = kcg_lit_int64(0);
  }
  for (idx8 = 0; idx8 < 32; idx8++) {
    outC->_L365[idx8].D_LINK = kcg_lit_int64(0);
    outC->_L365[idx8].Q_NEWCOUNTRY = kcg_lit_int64(0);
    outC->_L365[idx8].NID_C = kcg_lit_int64(0);
    outC->_L365[idx8].NID_BG = kcg_lit_int64(0);
    outC->_L365[idx8].Q_LINKORIENTATION = kcg_lit_int64(0);
    outC->_L365[idx8].Q_LINKREACTION = kcg_lit_int64(0);
    outC->_L365[idx8].Q_LOCACC = kcg_lit_int64(0);
  }
  ...
  for (idx9 = 0; idx9 < 400; idx9++) {
    outC->_L209[idx9] = kcg_lit_int64(0);
  }
  outC->_L206 = kcg_lit_int64(0);
  ...
  for (idx10 = 0; idx10 < 32; idx10++) {
    outC->_L1.SECTIONS[idx10].D_LINK = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx10].Q_NEWCOUNTRY = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx10].NID_C = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx10].NID_BG = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx10].Q_LINKORIENTATION = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx10].Q_LINKREACTION = kcg_lit_int64(0);
    outC->_L1.SECTIONS[idx10].Q_LOCACC = kcg_lit_int64(0);
  }
  ...
  for (idx11 = 0; idx11 < 500; idx11++) {
    outC->P005_compressed[idx11] = kcg_lit_int64(0);
  }
  ...
  T_DeterminePacketSizeInt_init_TM_lib_internal(
    &outC->Context_T_DeterminePacketSizeInt_1);
  /* _L380=(TM_lib_internal::C_P005_flatten_sections#1)/ */
  C_P005_flatten_sections_init_TM_lib_internal(
    &outC->Context_C_P005_flatten_sections_1);
  /* _L388=(TM_lib_internal::T_Build_Metadata_Packet_ID#1)/ */
  ...
  outC_C_P005_tracksim_compr_TM_conversions *outC)
{
  ...
  T_DeterminePacketSizeInt_reset_TM_lib_internal(
    &outC->Context_T_DeterminePacketSizeInt_1);
  /* _L380=(TM_lib_internal::C_P005_flatten_sections#1)/ */
  C_P005_flatten_sections_reset_TM_lib_internal(
    &outC->Context_C_P005_flatten_sections_1);
  /* _L388=(TM_lib_internal::T_Build_Metadata_Packet_ID#1)/ */
