  ...
  outC_C_P005_tracksim_compr_TM_conversions *outC)
{
  ...
  kcg_copy_array_int32_100(&outC->_L383[0], &outC->_L384);
  kcg_copy_array_int32_400(&outC->_L383[100], &outC->_L209);
  /* _L379=(TM_lib_internal::T_DeterminePacketSizeInt#1)/ */
  T_DeterminePacketSizeInt_TM_lib_internal(
    outC->_L366,
    kcg_lit_int32(4) + kcg_lit_int32(1) + kcg_lit_int32(7),
    kcg_lit_int32(7),
  ...
  outC_C_P005_tracksim_compr_TM_conversions *outC)
{
  ...
  for (idx = 0; idx < 33; idx++) {
    outC->_L385[idx].D_LINK = kcg_lit_int32(0);
    outC->_L385[idx].Q_NEWCOUNTRY = kcg_lit_int32(0);
    outC->_L385[idx].NID_C = kcg_lit_int32(0);
    outC->_L385[idx].NID_BG = kcg_lit_int32(0);
    outC->_L385[idx].Q_LINKORIENTATION = kcg_lit_int32(0);
    outC->_L385[idx].Q_LINKREACTION = kcg_lit_int32(0);
    outC->_L385[idx].Q_LOCACC = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 1; idx1++) {
    outC->_L386[idx1].D_LINK = kcg_lit_int32(0);
    outC->_L386[idx1].Q_NEWCOUNTRY = kcg_lit_int32(0);
    outC->_L386[idx1].NID_C = kcg_lit_int32(0);
    outC->_L386[idx1].NID_BG = kcg_lit_int32(0);
    outC->_L386[idx1].Q_LINKORIENTATION = kcg_lit_int32(0);
    outC->_L386[idx1].Q_LINKREACTION = kcg_lit_int32(0);
    outC->_L386[idx1].Q_LOCACC = kcg_lit_int32(0);
  }
  ...
  outC->_L375.D_LINK = kcg_lit_int32(0);
  outC->_L375.Q_NEWCOUNTRY = kcg_lit_int32(0);
  outC->_L375.NID_C = kcg_lit_int32(0);
  outC->_L375.NID_BG = kcg_lit_int32(0);
  outC->_L375.Q_LINKORIENTATION = kcg_lit_int32(0);
  outC->_L375.Q_LINKREACTION = kcg_lit_int32(0);
  outC->_L375.Q_LOCACC = kcg_lit_int32(0);
  for (idx7 = 0; idx7 < 4; idx7++) {
    outC->_L373[idx7] = kcg_lit_int32(0);
  }
  for (idx8 = 0; idx8 < 32; idx8++) {
    outC->_L365[idx8].D_LINK = kcg_lit_int32(0);
    outC->_L365[idx8].Q_NEWCOUNTRY = kcg_lit_int32(0);
    outC->_L365[idx8].NID_C = kcg_lit_int32(0);
    outC->_L365[idx8].NID_BG = kcg_lit_int32(0);
    outC->_L365[idx8].Q_LINKORIENTATION = kcg_lit_int32(0);
    outC->_L365[idx8].Q_LINKREACTION = kcg_lit_int32(0);
    outC->_L365[idx8].Q_LOCACC = kcg_lit_int32(0);
  }
  ...
  for (idx10 = 0; idx10 < 32; idx10++) {
    outC->_L1.SECTIONS[idx10].D_LINK = kcg_lit_int32(0);
    outC->_L1.SECTIONS[idx10].Q_NEWCOUNTRY = kcg_lit_int32(0);
    outC->_L1.SECTIONS[idx10].NID_C = kcg_lit_int32(0);
    outC->_L1.SECTIONS[idx10].NID_BG = kcg_lit_int32(0);
    outC->_L1.SECTIONS[idx10].Q_LINKORIENTATION = kcg_lit_int32(0);
    outC->_L1.SECTIONS[idx10].Q_LINKREACTION = kcg_lit_int32(0);
    outC->_L1.SECTIONS[idx10].Q_LOCACC = kcg_lit_int32(0);
  }
