...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  M_024_T_TM_radio_messages /* message_out/ */ message_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  outC_CAST_Int_to_NID_MESSAGE_TM_conversions /* _L30=(TM_conversions::CAST_Int_to_NID_MESSAGE#1)/ */ Context_CAST_Int_to_NID_MESSAGE_1;
  ...
  kcg_int32 /* _L3/ */ _L3;
  kcg_bool /* _L2/ */ _L2;
  M_024_T_TM_radio_messages /* _L26/ */ _L26;
  M_ACK /* _L27/ */ _L27;
  NID_LRBG /* _L28/ */ _L28;
  T_TRAIN /* _L32/ */ _L32;
  L_MESSAGE /* _L31/ */ _L31;
  NID_MESSAGE /* _L30/ */ _L30;
...
extern void C_header_to_M024_init_TM_RBC_conversions(
  outC_C_header_to_M024_TM_RBC_conversions *outC);
