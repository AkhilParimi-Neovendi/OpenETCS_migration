...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  M_002_T_TM_radio_messages /* message_out/ */ message_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  outC_CAST_Int_to_D_SR_TM_conversions /* _L30=(TM_conversions::CAST_Int_to_D_SR#1)/ */ Context_CAST_Int_to_D_SR_1;
  outC_CAST_Int_to_NID_MESSAGE_TM_conversions /* _L32=(TM_conversions::CAST_Int_to_NID_MESSAGE#1)/ */ Context_CAST_Int_to_NID_MESSAGE_1;
  outC_CAST_Int_to_L_MESSAGE_TM_conversions /* _L33=(TM_conversions::CAST_Int_to_L_MESSAGE#1)/ */ Context_CAST_Int_to_L_MESSAGE_1;
  outC_CAST_Int_to_T_TRAIN_TM_conversions /* _L34=(TM_conversions::CAST_Int_to_T_TRAIN#1)/ */ Context_CAST_Int_to_T_TRAIN_1;
  ...
  Q_SCALE /* @1/IfBlock1:else:else:then:_L1/ */ _2__L1_CAST_Int_to_Q_SCALE_1_then_else_else_IfBlock1;
  ...
  kcg_bool /* @1/IfBlock1:then:_L3/ */ _3__L3_CAST_Int_to_Q_SCALE_1_then_IfBlock1;
  ...
  kcg_int64 /* _L3/ */ _L3;
  kcg_bool /* _L2/ */ _L2;
  M_002_T_TM_radio_messages /* _L26/ */ _L26;
  M_ACK /* _L27/ */ _L27;
  NID_LRBG /* _L28/ */ _L28;
  Q_SCALE /* _L29/ */ _L29;
  D_SR /* _L30/ */ _L30;
...
extern void C_header_to_M002_init_TM_RBC_conversions(
  outC_C_header_to_M002_TM_RBC_conversions *outC);
