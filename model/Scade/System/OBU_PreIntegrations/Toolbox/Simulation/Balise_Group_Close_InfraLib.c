...
void Balise_Group_Close_init_InfraLib(outC_Balise_Group_Close_InfraLib *outC)
{
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L23.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    outC->_L23.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L23.PacketHeaders[idx2].valid = kcg_true;
    outC->_L23.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L23.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L23.PacketData[idx3] = kcg_lit_int32(0);
  }
  outC->_L22.q_updown = kcg_lit_int32(0);
  outC->_L22.m_version = kcg_lit_int32(0);
  outC->_L22.q_media = kcg_lit_int32(0);
  outC->_L22.n_pig = kcg_lit_int32(0);
  outC->_L22.n_total = kcg_lit_int32(0);
  outC->_L22.m_dup = kcg_lit_int32(0);
  outC->_L22.m_mcount = kcg_lit_int32(0);
  outC->_L22.nid_c = kcg_lit_int32(0);
  outC->_L22.nid_bg = kcg_lit_int32(0);
  outC->_L22.q_link = kcg_lit_int32(0);
  ...
  outC->_L21.engineering_BG_location = kcg_lit_int32(0);
  outC->_L21.TrainPos = kcg_lit_float32(0.0);
  outC->_L21.pig_nom_0 = kcg_lit_int32(0);
  ...
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L20.Messages.PacketHeaders[idx6].nid_packet = kcg_lit_int32(0);
    outC->_L20.Messages.PacketHeaders[idx6].q_dir = Q_DIR_Reverse;
    outC->_L20.Messages.PacketHeaders[idx6].valid = kcg_true;
    outC->_L20.Messages.PacketHeaders[idx6].startAddress = kcg_lit_int32(0);
    outC->_L20.Messages.PacketHeaders[idx6].endAddress = kcg_lit_int32(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->_L20.Messages.PacketData[idx7] = kcg_lit_int32(0);
  }
  outC->_L2.Header.q_updown = kcg_lit_int32(0);
  outC->_L2.Header.m_version = kcg_lit_int32(0);
  outC->_L2.Header.q_media = kcg_lit_int32(0);
  outC->_L2.Header.n_pig = kcg_lit_int32(0);
  outC->_L2.Header.n_total = kcg_lit_int32(0);
  outC->_L2.Header.m_dup = kcg_lit_int32(0);
  outC->_L2.Header.m_mcount = kcg_lit_int32(0);
  outC->_L2.Header.nid_c = kcg_lit_int32(0);
  outC->_L2.Header.nid_bg = kcg_lit_int32(0);
  outC->_L2.Header.q_link = kcg_lit_int32(0);
  for (idx8 = 0; idx8 < 30; idx8++) {
    outC->_L2.Messages.PacketHeaders[idx8].nid_packet = kcg_lit_int32(0);
    outC->_L2.Messages.PacketHeaders[idx8].q_dir = Q_DIR_Reverse;
    outC->_L2.Messages.PacketHeaders[idx8].valid = kcg_true;
    outC->_L2.Messages.PacketHeaders[idx8].startAddress = kcg_lit_int32(0);
    outC->_L2.Messages.PacketHeaders[idx8].endAddress = kcg_lit_int32(0);
  }
  for (idx9 = 0; idx9 < 500; idx9++) {
    outC->_L2.Messages.PacketData[idx9] = kcg_lit_int32(0);
  }
  ...
  for (idx11 = 0; idx11 < 500; idx11++) {
    outC->BG_message_out.Messages.PacketData[idx11] = kcg_lit_int32(0);
  }
