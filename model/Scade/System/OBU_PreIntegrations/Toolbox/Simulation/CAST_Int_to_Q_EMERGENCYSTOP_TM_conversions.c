  ...
  outC_CAST_Int_to_Q_EMERGENCYSTOP_TM_conversions *outC)
{
  ...
  /* q_emergencystop/ */
  Q_EMERGENCYSTOP _1_q_emergencystop_partial;
  /* error/ */
  ...
  /* q_emergencystop/ */
  Q_EMERGENCYSTOP _5_q_emergencystop_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* error/ */
  kcg_bool _7_error_partial;
  /* q_emergencystop/ */
  Q_EMERGENCYSTOP _8_q_emergencystop_partial;
  /* error/ */
  kcg_bool _9_error_partial;
  /* q_emergencystop/ */
  Q_EMERGENCYSTOP _10_q_emergencystop_partial;
  /* error/ */
  kcg_bool _11_error_partial;
  /* q_emergencystop/ */
  Q_EMERGENCYSTOP _12_q_emergencystop_partial;
  /* error/ */
  kcg_bool _13_error_partial;
  /* q_emergencystop/ */
  Q_EMERGENCYSTOP _14_q_emergencystop_partial;
  kcg_bool noname;
  ...
  outC_CAST_Int_to_Q_EMERGENCYSTOP_TM_conversions *outC)
{
  ...
  outC->_L13 = kcg_true;
  outC->q_emergencystop_in = kcg_lit_int64(0);
  outC->error = kcg_true;
