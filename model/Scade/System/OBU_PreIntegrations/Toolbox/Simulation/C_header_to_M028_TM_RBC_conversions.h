...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  M_028_T_TM_radio_messages /* message_out/ */ message_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  outC_CAST_Int_to_T_TRAIN_TM_conversions /* _L29=(TM_conversions::CAST_Int_to_T_TRAIN#1)/ */ Context_CAST_Int_to_T_TRAIN_1;
  outC_CAST_Int_to_NID_MESSAGE_TM_conversions /* _L31=(TM_conversions::CAST_Int_to_NID_MESSAGE#1)/ */ Context_CAST_Int_to_NID_MESSAGE_1;
  outC_CAST_Int_to_L_MESSAGE_TM_conversions /* _L32=(TM_conversions::CAST_Int_to_L_MESSAGE#1)/ */ Context_CAST_Int_to_L_MESSAGE_1;
  outC_CAST_Int_to_T_TRAIN_TM_conversions /* _L33=(TM_conversions::CAST_Int_to_T_TRAIN#2)/ */ Context_CAST_Int_to_T_TRAIN_2;
  ...
  kcg_int64 /* _L3/ */ _L3;
  kcg_bool /* _L2/ */ _L2;
  M_028_T_TM_radio_messages /* _L26/ */ _L26;
  M_ACK /* _L27/ */ _L27;
  NID_LRBG /* _L28/ */ _L28;
  T_TRAIN /* _L29/ */ _L29;
  T_TRAIN /* _L33/ */ _L33;
...
extern void C_header_to_M028_init_TM_RBC_conversions(
  outC_C_header_to_M028_TM_RBC_conversions *outC);
