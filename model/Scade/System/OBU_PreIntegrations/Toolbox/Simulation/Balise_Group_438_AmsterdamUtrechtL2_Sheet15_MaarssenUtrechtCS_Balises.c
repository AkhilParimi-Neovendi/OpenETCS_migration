  ...
  outC_Balise_Group_438_AmsterdamUtrechtL2_Sheet15_MaarssenUtrechtCS_Balises *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L16.packets.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L16.packets.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L16.packets.PacketHeaders[idx].valid = kcg_true;
    outC->_L16.packets.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L16.packets.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L16.packets.PacketData[idx1] = kcg_lit_int64(0);
  }
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L29.Messages.PacketHeaders[idx2].nid_packet = kcg_lit_int64(0);
    outC->_L29.Messages.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L29.Messages.PacketHeaders[idx2].valid = kcg_true;
    outC->_L29.Messages.PacketHeaders[idx2].startAddress = kcg_lit_int64(0);
    outC->_L29.Messages.PacketHeaders[idx2].endAddress = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L29.Messages.PacketData[idx3] = kcg_lit_int64(0);
  }
  ...
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L8.packets.PacketHeaders[idx4].nid_packet = kcg_lit_int64(0);
    outC->_L8.packets.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L8.packets.PacketHeaders[idx4].valid = kcg_true;
    outC->_L8.packets.PacketHeaders[idx4].startAddress = kcg_lit_int64(0);
    outC->_L8.packets.PacketHeaders[idx4].endAddress = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L8.packets.PacketData[idx5] = kcg_lit_int64(0);
  }
