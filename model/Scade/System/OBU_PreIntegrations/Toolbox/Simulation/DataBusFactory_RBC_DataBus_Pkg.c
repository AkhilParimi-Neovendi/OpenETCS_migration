  ...
  outC_DataBusFactory_RBC_DataBus_Pkg *outC)
{
  ...
  kcg_copy__25_array(
    &outC->_L38,
    (_25_array *) &DIAG_MSG_DEFAULT_ARRAY_RBC_Diagnostic_Pkg);
  kcg_copy_RBC_Data_T_RBC_DataBus_Pkg(&outC->_L8, inDataBus);
  kcg_copy__25_array(&outC->_L16, &outC->_L8.diagnostic);
  outC->_L3 = outC->o_times_1_int32;
  /* _L28= */
  if (outC->_L3) {
    kcg_copy__25_array(&outC->_L28, &outC->_L38);
  }
  else {
    kcg_copy__25_array(&outC->_L28, &outC->_L16);
  }
  ...
  kcg_copy__2_RadioTrackTrainMessageQueue_T(&outC->_L13, &outC->_L8.messageQueue);
  /* _L7= */
  if (outC->_L3) {
    kcg_copy__2_RadioTrackTrainMessageQueue_T(&outC->_L7, &outC->_L24);
  }
  else {
    kcg_copy__2_RadioTrackTrainMessageQueue_T(&outC->_L7, &outC->_L13);
  }
  /* _L6= */
  if (outC->_L3) {
  ...
  kcg_copy__25_array(&outC->_L17.diagnostic, &outC->_L28);
  kcg_copy__2_RadioTrackTrainMessageQueue_T(&outC->_L17.messageQueue, &outC->_L7);
  ...
  outC_DataBusFactory_RBC_DataBus_Pkg *outC)
{
  ...
  for (idx = 0; idx < 16; idx++) {
    ...
    outC->_L38[idx].count = kcg_lit_int32(0);
    outC->_L38[idx].timestamp = kcg_lit_int32(0);
  ...
  for (idx1 = 0; idx1 < 16; idx1++) {
    ...
    outC->_L28[idx1].count = kcg_lit_int32(0);
    outC->_L28[idx1].timestamp = kcg_lit_int32(0);
  ...
  outC->_L26.Header.radioDevice = kcg_lit_int32(0);
  outC->_L26.Header.receivedSystemTime = kcg_lit_int32(0);
  outC->_L26.Header.nid_message = kcg_lit_int32(0);
  outC->_L26.Header.t_train = kcg_lit_int32(0);
  outC->_L26.Header.m_ack = kcg_lit_int32(0);
  outC->_L26.Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L26.Header.t_train_reference = kcg_lit_int32(0);
  outC->_L26.Header.nid_em = kcg_lit_int32(0);
  outC->_L26.Header.q_scale = kcg_lit_int32(0);
  outC->_L26.Header.d_sr = kcg_lit_int32(0);
  outC->_L26.Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L26.Header.d_ref = kcg_lit_int32(0);
  outC->_L26.Header.q_dir = kcg_lit_int32(0);
  outC->_L26.Header.d_emergencystop = kcg_lit_int32(0);
  outC->_L26.Header.m_version = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L26.Messages.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    outC->_L26.Messages.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L26.Messages.PacketHeaders[idx2].valid = kcg_true;
    outC->_L26.Messages.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L26.Messages.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L26.Messages.PacketData[idx3] = kcg_lit_int32(0);
  }
  outC->_L25.m_Value = kcg_lit_int32(0);
  for (idx6 = 0; idx6 < 8; idx6++) {
    outC->_L24.m_Entries[idx6].m_IsValid = kcg_true;
    outC->_L24.m_Entries[idx6].m_Entry.Header.radioDevice = kcg_lit_int32(0);
    outC->_L24.m_Entries[idx6].m_Entry.Header.receivedSystemTime = kcg_lit_int32(0);
    outC->_L24.m_Entries[idx6].m_Entry.Header.nid_message = kcg_lit_int32(0);
    outC->_L24.m_Entries[idx6].m_Entry.Header.t_train = kcg_lit_int32(0);
    outC->_L24.m_Entries[idx6].m_Entry.Header.m_ack = kcg_lit_int32(0);
    outC->_L24.m_Entries[idx6].m_Entry.Header.nid_lrbg = kcg_lit_int32(0);
    outC->_L24.m_Entries[idx6].m_Entry.Header.t_train_reference = kcg_lit_int32(0);
    outC->_L24.m_Entries[idx6].m_Entry.Header.nid_em = kcg_lit_int32(0);
    outC->_L24.m_Entries[idx6].m_Entry.Header.q_scale = kcg_lit_int32(0);
    outC->_L24.m_Entries[idx6].m_Entry.Header.d_sr = kcg_lit_int32(0);
    outC->_L24.m_Entries[idx6].m_Entry.Header.t_sh_rqst = kcg_lit_int32(0);
    outC->_L24.m_Entries[idx6].m_Entry.Header.d_ref = kcg_lit_int32(0);
    outC->_L24.m_Entries[idx6].m_Entry.Header.q_dir = kcg_lit_int32(0);
    outC->_L24.m_Entries[idx6].m_Entry.Header.d_emergencystop = kcg_lit_int32(0);
    outC->_L24.m_Entries[idx6].m_Entry.Header.m_version = kcg_lit_int32(0);
    ...
    for (idx5 = 0; idx5 < 500; idx5++) {
      outC->_L24.m_Entries[idx6].m_Entry.Messages.PacketData[idx5] = kcg_lit_int32(0);
    }
  }
  outC->_L23.m_TrainData.nid_engine = kcg_lit_int32(0);
  outC->_L23.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int32(0);
  ...
  outC->_L23.m_TrainData.t_train_ref = kcg_lit_int32(0);
  outC->_L23.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L23.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L23.m_TrainData.l_train = kcg_lit_int32(0);
  outC->_L23.m_TrainData.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L23.m_TrainData.n_axle = kcg_lit_int32(0);
  ...
  for (idx10 = 0; idx10 < 5; idx10++) {
    outC->_L23.m_TrainData.m_NationalSystemIdentities[idx10] = kcg_lit_int32(0);
  }
  outC->_L23.m_TrainData.nid_operational = kcg_lit_int32(0);
  outC->_L23.m_PosData.nid_lrbg = kcg_lit_int32(0);
  outC->_L23.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L23.m_PosData.d_lrbg = kcg_lit_int32(0);
  outC->_L23.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L23.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L23.m_PosData.l_doubtover = kcg_lit_int32(0);
  outC->_L23.m_PosData.l_doubtunder = kcg_lit_int32(0);
  outC->_L23.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L23.m_PosData.l_trainint = kcg_lit_int32(0);
  outC->_L23.m_PosData.v_train = kcg_lit_int32(0);
  ...
  outC->_L23.m_PosData.nid_ntc = kcg_lit_int32(0);
  outC->_L23.m_PosData.nid_prvlrbg = kcg_lit_int32(0);
  outC->_L22.Header.radioDevice = kcg_lit_int32(0);
  outC->_L22.Header.receivedSystemTime = kcg_lit_int32(0);
  outC->_L22.Header.nid_message = kcg_lit_int32(0);
  outC->_L22.Header.t_train = kcg_lit_int32(0);
  outC->_L22.Header.m_ack = kcg_lit_int32(0);
  outC->_L22.Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L22.Header.t_train_reference = kcg_lit_int32(0);
  outC->_L22.Header.nid_em = kcg_lit_int32(0);
  outC->_L22.Header.q_scale = kcg_lit_int32(0);
  outC->_L22.Header.d_sr = kcg_lit_int32(0);
  outC->_L22.Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L22.Header.d_ref = kcg_lit_int32(0);
  outC->_L22.Header.q_dir = kcg_lit_int32(0);
  outC->_L22.Header.d_emergencystop = kcg_lit_int32(0);
  outC->_L22.Header.m_version = kcg_lit_int32(0);
  for (idx11 = 0; idx11 < 30; idx11++) {
    outC->_L22.Messages.PacketHeaders[idx11].nid_packet = kcg_lit_int32(0);
    outC->_L22.Messages.PacketHeaders[idx11].q_dir = Q_DIR_Reverse;
    outC->_L22.Messages.PacketHeaders[idx11].valid = kcg_true;
    outC->_L22.Messages.PacketHeaders[idx11].startAddress = kcg_lit_int32(0);
    outC->_L22.Messages.PacketHeaders[idx11].endAddress = kcg_lit_int32(0);
  }
  for (idx12 = 0; idx12 < 500; idx12++) {
    outC->_L22.Messages.PacketData[idx12] = kcg_lit_int32(0);
  }
  outC->_L21.Header.radioDevice = kcg_lit_int32(0);
  outC->_L21.Header.receivedSystemTime = kcg_lit_int32(0);
  outC->_L21.Header.nid_message = kcg_lit_int32(0);
  outC->_L21.Header.t_train = kcg_lit_int32(0);
  outC->_L21.Header.m_ack = kcg_lit_int32(0);
  outC->_L21.Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L21.Header.t_train_reference = kcg_lit_int32(0);
  outC->_L21.Header.nid_em = kcg_lit_int32(0);
  outC->_L21.Header.q_scale = kcg_lit_int32(0);
  outC->_L21.Header.d_sr = kcg_lit_int32(0);
  outC->_L21.Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L21.Header.d_ref = kcg_lit_int32(0);
  outC->_L21.Header.q_dir = kcg_lit_int32(0);
  outC->_L21.Header.d_emergencystop = kcg_lit_int32(0);
  outC->_L21.Header.m_version = kcg_lit_int32(0);
  for (idx13 = 0; idx13 < 30; idx13++) {
    outC->_L21.Messages.PacketHeaders[idx13].nid_packet = kcg_lit_int32(0);
    outC->_L21.Messages.PacketHeaders[idx13].q_dir = Q_DIR_Reverse;
    outC->_L21.Messages.PacketHeaders[idx13].valid = kcg_true;
    outC->_L21.Messages.PacketHeaders[idx13].startAddress = kcg_lit_int32(0);
    outC->_L21.Messages.PacketHeaders[idx13].endAddress = kcg_lit_int32(0);
  }
  for (idx14 = 0; idx14 < 500; idx14++) {
    outC->_L21.Messages.PacketData[idx14] = kcg_lit_int32(0);
  }
  outC->_L19.m_Value = kcg_lit_int32(0);
  outC->_L18.m_Value = kcg_lit_int32(0);
  outC->_L17.session.m_TrainData.nid_engine = kcg_lit_int32(0);
  outC->_L17.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int32(0);
  ...
  outC->_L17.session.m_TrainData.t_train_ref = kcg_lit_int32(0);
  outC->_L17.session.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L17.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L17.session.m_TrainData.l_train = kcg_lit_int32(0);
  outC->_L17.session.m_TrainData.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L17.session.m_TrainData.n_axle = kcg_lit_int32(0);
  ...
  outC->_L17.session.m_TrainData.nid_operational = kcg_lit_int32(0);
  outC->_L17.session.m_PosData.nid_lrbg = kcg_lit_int32(0);
  outC->_L17.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L17.session.m_PosData.d_lrbg = kcg_lit_int32(0);
  outC->_L17.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L17.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L17.session.m_PosData.l_doubtover = kcg_lit_int32(0);
  outC->_L17.session.m_PosData.l_doubtunder = kcg_lit_int32(0);
  outC->_L17.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L17.session.m_PosData.l_trainint = kcg_lit_int32(0);
  outC->_L17.session.m_PosData.v_train = kcg_lit_int32(0);
  ...
  outC->_L17.session.m_PosData.nid_ntc = kcg_lit_int32(0);
  outC->_L17.session.m_PosData.nid_prvlrbg = kcg_lit_int32(0);
  outC->_L17.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L17.config.m_NationalParams.nid_c = kcg_lit_int32(0);
  outC->_L17.config.m_NationalParams.v_nvshunt = kcg_lit_int32(0);
  outC->_L17.config.m_NationalParams.v_nvstff = kcg_lit_int32(0);
  outC->_L17.config.m_NationalParams.v_nvonsight = kcg_lit_int32(0);
  outC->_L17.config.m_NationalParams.v_nvunfit = kcg_lit_int32(0);
  outC->_L17.config.m_NationalParams.v_nvrel = kcg_lit_int32(0);
  outC->_L17.config.m_NationalParams.t_nvcontact = kcg_lit_int32(0);
  outC->_L17.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L17.config.m_MAReqParams.t_mar = kcg_lit_int32(0);
  outC->_L17.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int32(0);
  outC->_L17.config.m_MAReqParams.t_cycrqst = kcg_lit_int32(0);
  outC->_L17.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L17.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L17.config.m_PosRepParams.t_cycloc = kcg_lit_int32(0);
  outC->_L17.config.m_PosRepParams.d_cycloc = kcg_lit_int32(0);
  ...
  for (idx20 = 0; idx20 < 16; idx20++) {
    ...
    outC->_L17.diagnostic[idx20].count = kcg_lit_int32(0);
    outC->_L17.diagnostic[idx20].timestamp = kcg_lit_int32(0);
  ...
  for (idx23 = 0; idx23 < 8; idx23++) {
    ...
    outC->_L17.messageQueue.m_Entries[idx23].m_Entry.Header.q_scale =
      kcg_lit_int32(0);
    outC->_L17.messageQueue.m_Entries[idx23].m_Entry.Header.d_sr = kcg_lit_int32(0);
  ...
  outC->_L17.clockk.m_Value = kcg_lit_int32(0);
  outC->_L17.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int32(0);
  outC->_L17.lastSentTrackTrainMessage.Header.receivedSystemTime =
    kcg_lit_int32(0);
  outC->_L17.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int32(0);
  outC->_L17.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int32(0);
  outC->_L17.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int32(0);
  outC->_L17.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L17.lastSentTrackTrainMessage.Header.t_train_reference = kcg_lit_int32(
      0);
  outC->_L17.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int32(0);
  outC->_L17.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int32(0);
  outC->_L17.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int32(0);
  outC->_L17.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L17.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int32(0);
  outC->_L17.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int32(0);
  outC->_L17.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int32(0);
  outC->_L17.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int32(0);
  ...
  for (idx28 = 0; idx28 < 8; idx28++) {
    ...
    outC->_L13.m_Entries[idx28].m_Entry.Header.radioDevice = kcg_lit_int32(0);
    outC->_L13.m_Entries[idx28].m_Entry.Header.receivedSystemTime =
      kcg_lit_int32(0);
    outC->_L13.m_Entries[idx28].m_Entry.Header.nid_message = kcg_lit_int32(0);
    outC->_L13.m_Entries[idx28].m_Entry.Header.t_train = kcg_lit_int32(0);
    outC->_L13.m_Entries[idx28].m_Entry.Header.m_ack = kcg_lit_int32(0);
    outC->_L13.m_Entries[idx28].m_Entry.Header.nid_lrbg = kcg_lit_int32(0);
    outC->_L13.m_Entries[idx28].m_Entry.Header.t_train_reference = kcg_lit_int32(0);
    outC->_L13.m_Entries[idx28].m_Entry.Header.nid_em = kcg_lit_int32(0);
    outC->_L13.m_Entries[idx28].m_Entry.Header.q_scale = kcg_lit_int32(0);
    outC->_L13.m_Entries[idx28].m_Entry.Header.d_sr = kcg_lit_int32(0);
    outC->_L13.m_Entries[idx28].m_Entry.Header.t_sh_rqst = kcg_lit_int32(0);
    outC->_L13.m_Entries[idx28].m_Entry.Header.d_ref = kcg_lit_int32(0);
    outC->_L13.m_Entries[idx28].m_Entry.Header.q_dir = kcg_lit_int32(0);
    outC->_L13.m_Entries[idx28].m_Entry.Header.d_emergencystop = kcg_lit_int32(0);
    outC->_L13.m_Entries[idx28].m_Entry.Header.m_version = kcg_lit_int32(0);
  ...
  outC->_L14.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L14.m_NationalParams.nid_c = kcg_lit_int32(0);
  outC->_L14.m_NationalParams.v_nvshunt = kcg_lit_int32(0);
  outC->_L14.m_NationalParams.v_nvstff = kcg_lit_int32(0);
  outC->_L14.m_NationalParams.v_nvonsight = kcg_lit_int32(0);
  outC->_L14.m_NationalParams.v_nvunfit = kcg_lit_int32(0);
  outC->_L14.m_NationalParams.v_nvrel = kcg_lit_int32(0);
  outC->_L14.m_NationalParams.t_nvcontact = kcg_lit_int32(0);
  outC->_L14.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L14.m_MAReqParams.t_mar = kcg_lit_int32(0);
  outC->_L14.m_MAReqParams.t_timeoutrqst = kcg_lit_int32(0);
  outC->_L14.m_MAReqParams.t_cycrqst = kcg_lit_int32(0);
  outC->_L14.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L14.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L14.m_PosRepParams.t_cycloc = kcg_lit_int32(0);
  outC->_L14.m_PosRepParams.d_cycloc = kcg_lit_int32(0);
  ...
  outC->_L15.m_TrainData.nid_engine = kcg_lit_int32(0);
  outC->_L15.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int32(0);
  ...
  outC->_L15.m_TrainData.t_train_ref = kcg_lit_int32(0);
  outC->_L15.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L15.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L15.m_TrainData.l_train = kcg_lit_int32(0);
  outC->_L15.m_TrainData.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L15.m_TrainData.n_axle = kcg_lit_int32(0);
  ...
  for (idx33 = 0; idx33 < 5; idx33++) {
    outC->_L15.m_TrainData.m_NationalSystemIdentities[idx33] = kcg_lit_int32(0);
  }
  outC->_L15.m_TrainData.nid_operational = kcg_lit_int32(0);
  outC->_L15.m_PosData.nid_lrbg = kcg_lit_int32(0);
  outC->_L15.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L15.m_PosData.d_lrbg = kcg_lit_int32(0);
  outC->_L15.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L15.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L15.m_PosData.l_doubtover = kcg_lit_int32(0);
  outC->_L15.m_PosData.l_doubtunder = kcg_lit_int32(0);
  outC->_L15.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L15.m_PosData.l_trainint = kcg_lit_int32(0);
  outC->_L15.m_PosData.v_train = kcg_lit_int32(0);
  ...
  outC->_L15.m_PosData.nid_ntc = kcg_lit_int32(0);
  outC->_L15.m_PosData.nid_prvlrbg = kcg_lit_int32(0);
  for (idx34 = 0; idx34 < 16; idx34++) {
    outC->_L16[idx34].valid = kcg_true;
    outC->_L16[idx34].count = kcg_lit_int32(0);
    outC->_L16[idx34].timestamp = kcg_lit_int32(0);
  ...
  outC->_L10.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L10.m_NationalParams.nid_c = kcg_lit_int32(0);
  outC->_L10.m_NationalParams.v_nvshunt = kcg_lit_int32(0);
  outC->_L10.m_NationalParams.v_nvstff = kcg_lit_int32(0);
  outC->_L10.m_NationalParams.v_nvonsight = kcg_lit_int32(0);
  outC->_L10.m_NationalParams.v_nvunfit = kcg_lit_int32(0);
  outC->_L10.m_NationalParams.v_nvrel = kcg_lit_int32(0);
  outC->_L10.m_NationalParams.t_nvcontact = kcg_lit_int32(0);
  outC->_L10.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L10.m_MAReqParams.t_mar = kcg_lit_int32(0);
  outC->_L10.m_MAReqParams.t_timeoutrqst = kcg_lit_int32(0);
  outC->_L10.m_MAReqParams.t_cycrqst = kcg_lit_int32(0);
  outC->_L10.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L10.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L10.m_PosRepParams.t_cycloc = kcg_lit_int32(0);
  outC->_L10.m_PosRepParams.d_cycloc = kcg_lit_int32(0);
  ...
  outC->_L8.session.m_TrainData.nid_engine = kcg_lit_int32(0);
  outC->_L8.session.m_TrainData.m_NumberOfOnboardPhoneNumbers = kcg_lit_int32(0);
  ...
  outC->_L8.session.m_TrainData.t_train_ref = kcg_lit_int32(0);
  outC->_L8.session.m_TrainData.nc_cdtrain = NC_CDTRAIN_Cant_Deficiency_80_mm;
  outC->_L8.session.m_TrainData.nc_train =
    NC_TRAIN_Train_does_not_belong_to_any_of_the_Other_International_Train_Category;
  outC->_L8.session.m_TrainData.l_train = kcg_lit_int32(0);
  outC->_L8.session.m_TrainData.v_maxtrain = kcg_lit_int32(0);
  ...
  outC->_L8.session.m_TrainData.n_axle = kcg_lit_int32(0);
  ...
  outC->_L8.session.m_TrainData.nid_operational = kcg_lit_int32(0);
  outC->_L8.session.m_PosData.nid_lrbg = kcg_lit_int32(0);
  outC->_L8.session.m_PosData.q_scale = Q_SCALE_10_cm_scale;
  outC->_L8.session.m_PosData.d_lrbg = kcg_lit_int32(0);
  outC->_L8.session.m_PosData.q_dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L8.session.m_PosData.q_dlrbg = Q_DLRBG_Reverse;
  outC->_L8.session.m_PosData.l_doubtover = kcg_lit_int32(0);
  outC->_L8.session.m_PosData.l_doubtunder = kcg_lit_int32(0);
  outC->_L8.session.m_PosData.q_length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->_L8.session.m_PosData.l_trainint = kcg_lit_int32(0);
  outC->_L8.session.m_PosData.v_train = kcg_lit_int32(0);
  ...
  outC->_L8.session.m_PosData.nid_ntc = kcg_lit_int32(0);
  outC->_L8.session.m_PosData.nid_prvlrbg = kcg_lit_int32(0);
  outC->_L8.config.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L8.config.m_NationalParams.nid_c = kcg_lit_int32(0);
  outC->_L8.config.m_NationalParams.v_nvshunt = kcg_lit_int32(0);
  outC->_L8.config.m_NationalParams.v_nvstff = kcg_lit_int32(0);
  outC->_L8.config.m_NationalParams.v_nvonsight = kcg_lit_int32(0);
  outC->_L8.config.m_NationalParams.v_nvunfit = kcg_lit_int32(0);
  outC->_L8.config.m_NationalParams.v_nvrel = kcg_lit_int32(0);
  outC->_L8.config.m_NationalParams.t_nvcontact = kcg_lit_int32(0);
  outC->_L8.config.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L8.config.m_MAReqParams.t_mar = kcg_lit_int32(0);
  outC->_L8.config.m_MAReqParams.t_timeoutrqst = kcg_lit_int32(0);
  outC->_L8.config.m_MAReqParams.t_cycrqst = kcg_lit_int32(0);
  outC->_L8.config.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L8.config.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L8.config.m_PosRepParams.t_cycloc = kcg_lit_int32(0);
  outC->_L8.config.m_PosRepParams.d_cycloc = kcg_lit_int32(0);
  ...
  for (idx41 = 0; idx41 < 16; idx41++) {
    ...
    outC->_L8.diagnostic[idx41].count = kcg_lit_int32(0);
    outC->_L8.diagnostic[idx41].timestamp = kcg_lit_int32(0);
  ...
  for (idx44 = 0; idx44 < 8; idx44++) {
    ...
    outC->_L8.messageQueue.m_Entries[idx44].m_Entry.Header.t_train =
      kcg_lit_int32(0);
    outC->_L8.messageQueue.m_Entries[idx44].m_Entry.Header.m_ack = kcg_lit_int32(0);
    ...
    outC->_L8.messageQueue.m_Entries[idx44].m_Entry.Header.q_scale =
      kcg_lit_int32(0);
    outC->_L8.messageQueue.m_Entries[idx44].m_Entry.Header.d_sr = kcg_lit_int32(0);
    outC->_L8.messageQueue.m_Entries[idx44].m_Entry.Header.t_sh_rqst =
      kcg_lit_int32(0);
    outC->_L8.messageQueue.m_Entries[idx44].m_Entry.Header.d_ref = kcg_lit_int32(0);
    outC->_L8.messageQueue.m_Entries[idx44].m_Entry.Header.q_dir = kcg_lit_int32(0);
  ...
  outC->_L8.clockk.m_Value = kcg_lit_int32(0);
  outC->_L8.lastSentTrackTrainMessage.Header.radioDevice = kcg_lit_int32(0);
  outC->_L8.lastSentTrackTrainMessage.Header.receivedSystemTime = kcg_lit_int32(
      0);
  outC->_L8.lastSentTrackTrainMessage.Header.nid_message = kcg_lit_int32(0);
  outC->_L8.lastSentTrackTrainMessage.Header.t_train = kcg_lit_int32(0);
  outC->_L8.lastSentTrackTrainMessage.Header.m_ack = kcg_lit_int32(0);
  outC->_L8.lastSentTrackTrainMessage.Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L8.lastSentTrackTrainMessage.Header.t_train_reference = kcg_lit_int32(0);
  outC->_L8.lastSentTrackTrainMessage.Header.nid_em = kcg_lit_int32(0);
  outC->_L8.lastSentTrackTrainMessage.Header.q_scale = kcg_lit_int32(0);
  outC->_L8.lastSentTrackTrainMessage.Header.d_sr = kcg_lit_int32(0);
  outC->_L8.lastSentTrackTrainMessage.Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L8.lastSentTrackTrainMessage.Header.d_ref = kcg_lit_int32(0);
  outC->_L8.lastSentTrackTrainMessage.Header.q_dir = kcg_lit_int32(0);
  outC->_L8.lastSentTrackTrainMessage.Header.d_emergencystop = kcg_lit_int32(0);
  outC->_L8.lastSentTrackTrainMessage.Header.m_version = kcg_lit_int32(0);
  ...
  outC->_L6.m_Value = kcg_lit_int32(0);
  for (idx49 = 0; idx49 < 8; idx49++) {
    outC->_L7.m_Entries[idx49].m_IsValid = kcg_true;
    outC->_L7.m_Entries[idx49].m_Entry.Header.radioDevice = kcg_lit_int32(0);
    outC->_L7.m_Entries[idx49].m_Entry.Header.receivedSystemTime = kcg_lit_int32(0);
    outC->_L7.m_Entries[idx49].m_Entry.Header.nid_message = kcg_lit_int32(0);
    outC->_L7.m_Entries[idx49].m_Entry.Header.t_train = kcg_lit_int32(0);
    outC->_L7.m_Entries[idx49].m_Entry.Header.m_ack = kcg_lit_int32(0);
    outC->_L7.m_Entries[idx49].m_Entry.Header.nid_lrbg = kcg_lit_int32(0);
    outC->_L7.m_Entries[idx49].m_Entry.Header.t_train_reference = kcg_lit_int32(0);
    outC->_L7.m_Entries[idx49].m_Entry.Header.nid_em = kcg_lit_int32(0);
    outC->_L7.m_Entries[idx49].m_Entry.Header.q_scale = kcg_lit_int32(0);
    outC->_L7.m_Entries[idx49].m_Entry.Header.d_sr = kcg_lit_int32(0);
    outC->_L7.m_Entries[idx49].m_Entry.Header.t_sh_rqst = kcg_lit_int32(0);
    outC->_L7.m_Entries[idx49].m_Entry.Header.d_ref = kcg_lit_int32(0);
    outC->_L7.m_Entries[idx49].m_Entry.Header.q_dir = kcg_lit_int32(0);
    outC->_L7.m_Entries[idx49].m_Entry.Header.d_emergencystop = kcg_lit_int32(0);
    outC->_L7.m_Entries[idx49].m_Entry.Header.m_version = kcg_lit_int32(0);
  ...
  outC->_L5.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L5.m_NationalParams.nid_c = kcg_lit_int32(0);
  outC->_L5.m_NationalParams.v_nvshunt = kcg_lit_int32(0);
  outC->_L5.m_NationalParams.v_nvstff = kcg_lit_int32(0);
  outC->_L5.m_NationalParams.v_nvonsight = kcg_lit_int32(0);
  outC->_L5.m_NationalParams.v_nvunfit = kcg_lit_int32(0);
  outC->_L5.m_NationalParams.v_nvrel = kcg_lit_int32(0);
  outC->_L5.m_NationalParams.t_nvcontact = kcg_lit_int32(0);
  outC->_L5.m_MAReqParams.q_dir = Q_DIR_Reverse;
  outC->_L5.m_MAReqParams.t_mar = kcg_lit_int32(0);
  outC->_L5.m_MAReqParams.t_timeoutrqst = kcg_lit_int32(0);
  outC->_L5.m_MAReqParams.t_cycrqst = kcg_lit_int32(0);
  outC->_L5.m_PosRepParams.q_dir = Q_DIR_Reverse;
  outC->_L5.m_PosRepParams.q_scale = Q_SCALE_10_cm_scale;
  outC->_L5.m_PosRepParams.t_cycloc = kcg_lit_int32(0);
  outC->_L5.m_PosRepParams.d_cycloc = kcg_lit_int32(0);
  ...
  for (idx54 = 0; idx54 < 5; idx54++) {
    outC->_L2.m_TrainData.m_NationalSystemIdentities[idx54] = kcg_lit_int32(0);
  }
  ...
  for (idx60 = 0; idx60 < 16; idx60++) {
    ...
    outC->outDataBus.diagnostic[idx60].count = kcg_lit_int32(0);
    outC->outDataBus.diagnostic[idx60].timestamp = kcg_lit_int32(0);
