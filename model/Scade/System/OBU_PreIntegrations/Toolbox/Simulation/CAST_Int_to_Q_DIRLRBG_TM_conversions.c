...
{
  /* q_dirlrbg/ */
  Q_DIRLRBG q_dirlrbg_partial;
  /* error/ */
  kcg_bool error_partial;
  /* q_dirlrbg/ */
  Q_DIRLRBG _1_q_dirlrbg_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* q_dirlrbg/ */
  Q_DIRLRBG _3_q_dirlrbg_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* q_dirlrbg/ */
  Q_DIRLRBG _5_q_dirlrbg_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* error/ */
  kcg_bool _7_error_partial;
  /* q_dirlrbg/ */
  Q_DIRLRBG _8_q_dirlrbg_partial;
  /* error/ */
  kcg_bool _9_error_partial;
  /* q_dirlrbg/ */
  Q_DIRLRBG _10_q_dirlrbg_partial;
  kcg_bool noname;
  ...
  outC_CAST_Int_to_Q_DIRLRBG_TM_conversions *outC)
{
  ...
  outC->_L13 = kcg_true;
  outC->q_dirlrbg_in = kcg_lit_int64(0);
  outC->error = kcg_true;
