...
#include "Send_RBC_LRBG_100_D_00100_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone.h"

/* AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Send_RBC_LRBG_100_D_00100_0_M008/ */
void Send_RBC_LRBG_100_D_00100_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  /* RadiaDataIn/ */
  ...
  outC_Send_RBC_LRBG_100_D_00100_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Build_RBC_Message_LRBG_100_D_00100_0_M008#1)/ */
    _151_Build_RBC_Message_LR_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
      &outC->_L53,
      &outC->Context_Build_RBC_Message_LRBG_100_D_00100_0_M008_1);
    kcg_copy_R_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Build_RBC_Message_LRBG_100_D_00100_0_M008_1.R_data_out);
...
void Send_RBC_LRBG_100_D_00100_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  outC_Send_RBC_LRBG_100_D_00100_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Build_RBC_Message_LRBG_100_D_00100_0_M008#1)/ */
  _151_Build_RBC_Message_LR_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->Context_Build_RBC_Message_LRBG_100_D_00100_0_M008_1);
}
...
void Send_RBC_LRBG_100_D_00100_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  outC_Send_RBC_LRBG_100_D_00100_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Build_RBC_Message_LRBG_100_D_00100_0_M008#1)/ */
  _151_Build_RBC_Message_LR_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->Context_Build_RBC_Message_LRBG_100_D_00100_0_M008_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Send_RBC_LRBG_100_D_00100_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone.c
** Generation date: 2023-09-12T13:45:52
*************************************************************$ */
