  ...
  outC_C_header_to_M033_TM_RBC_conversions *outC)
{
  ...
  kcg_int64 noname;
  kcg_int64 _11_noname;
  kcg_int64 _12_noname;
  kcg_int64 _13_noname;
  ...
  /* _L34=(TM_conversions::CAST_Int_to_NID_MESSAGE#1)/ */
  CAST_Int_to_NID_MESSAGE_TM_conversions(
    outC->_L3,
    &outC->Context_CAST_Int_to_NID_MESSAGE_1);
  outC->_L34 = outC->Context_CAST_Int_to_NID_MESSAGE_1.nid_message;
  outC->_L5 = outC->_L1.t_train;
  /* _L33=(TM_conversions::CAST_Int_to_T_TRAIN#1)/ */
  CAST_Int_to_T_TRAIN_TM_conversions(
    outC->_L5,
    &outC->Context_CAST_Int_to_T_TRAIN_1);
  outC->_L33 = outC->Context_CAST_Int_to_T_TRAIN_1.t_train;
...
void C_header_to_M033_init_TM_RBC_conversions(
  outC_C_header_to_M033_TM_RBC_conversions *outC)
{
