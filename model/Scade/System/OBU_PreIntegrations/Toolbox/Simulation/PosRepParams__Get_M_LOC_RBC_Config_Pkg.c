...
void PosRepParams__Get_M_LOC_RBC_Config_Pkg(
  /* inPosRepParams/ */
  ...
  outC_PosRepParams__Get_M_LOC_RBC_Config_Pkg *outC)
{
  ...
  outC->_L2 = outC->_L1.m_loc;
  outC->out_M_LOC = outC->_L2;
}

#ifndef KCG_USER_DEFINED_INIT
void PosRepParams__Get_M_LOC_init_RBC_Config_Pkg(
  outC_PosRepParams__Get_M_LOC_RBC_Config_Pkg *outC)
{
  kcg_size idx;
  ...
  outC->out_M_LOC = M_LOC_Now;
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void PosRepParams__Get_M_LOC_reset_RBC_Config_Pkg(
  outC_PosRepParams__Get_M_LOC_RBC_Config_Pkg *outC)
{
}
