...
{
  /* q_dlrbg/ */
  Q_DLRBG q_dlrbg_partial;
  /* error/ */
  kcg_bool error_partial;
  /* q_dlrbg/ */
  Q_DLRBG _1_q_dlrbg_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* q_dlrbg/ */
  Q_DLRBG _3_q_dlrbg_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* q_dlrbg/ */
  Q_DLRBG _5_q_dlrbg_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* error/ */
  kcg_bool _7_error_partial;
  /* q_dlrbg/ */
  Q_DLRBG _8_q_dlrbg_partial;
  /* error/ */
  kcg_bool _9_error_partial;
  /* q_dlrbg/ */
  Q_DLRBG _10_q_dlrbg_partial;
  kcg_bool noname;
