...
typedef struct {
  ...
  outC_PHYSICS_simulateAccelerat_Toolbox_Physics_Basic /* SM1:Driving:_L30=(Toolbox::Physics::Basic::PHYSICS_simulateAccelerationBuildupTime#1)/ */ Context_PHYSICS_simulateAccelerationBuildupTime_1;
