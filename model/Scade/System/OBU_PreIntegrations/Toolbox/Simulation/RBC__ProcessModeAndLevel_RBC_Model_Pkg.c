  ...
  outC_RBC__ProcessModeAndLevel_RBC_Model_Pkg *outC)
{
  ...
  M_MODE mode_partial;
  /* level/ */
  M_LEVEL level_partial;
  /* mode/ */
  M_MODE _1_mode_partial;
  /* level/ */
  M_LEVEL _2_level_partial;
  /* level/ */
  M_LEVEL _3_level_partial;
  /* mode/ */
  M_MODE _4_mode_partial;
  /* level/ */
  M_LEVEL _5_level_partial;
  /* mode/ */
  M_MODE _6_mode_partial;
  /* level/ */
  M_LEVEL last_level;
  /* mode/ */
  M_MODE last_mode;
  ...
  _72_RadioTrainTrackPackets__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->_L2,
    &outC->_1_Context_RadioTrainTrackPackets__GetP000_1);
  kcg_copy_PT0_PositionReport_T_Packet_TrainTypes_Pkg(
    &outC->_L3,
    &outC->_1_Context_RadioTrainTrackPackets__GetP000_1.outRadioTrainTrackPacket);
  ...
  outC_RBC__ProcessModeAndLevel_RBC_Model_Pkg *outC)
{
  ...
  outC->_L28.NID_PACKET = kcg_lit_int64(0);
  outC->_L28.L_PACKET = kcg_lit_int64(0);
  outC->_L28.qscale = Q_SCALE_10_cm_scale;
  outC->_L28.NID_LRBG = kcg_lit_int64(0);
  outC->_L28.NID_PRVLRBG = kcg_lit_int64(0);
  outC->_L28.D_LRBG = kcg_lit_int64(0);
  outC->_L28.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L28.dlrbg = Q_DLRBG_Reverse;
  outC->_L28.L_DOUBTOVER = kcg_lit_int64(0);
  outC->_L28.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->_L28.length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L28.L_TRAININT = kcg_lit_int64(0);
  outC->_L28.V_TRAIN = kcg_lit_int64(0);
  outC->_L28.dirtrain = Q_DIRTRAIN_Reverse;
  outC->_L28.mode = M_MODE_Full_Supervision;
  outC->_L28.level = M_LEVEL_Level_0;
  outC->_L28.NID_NTC = kcg_lit_int64(0);
