  ...
  outC_Balises0005_Abcoude_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises *outC)
{
  ...
  /* _L1=(AmsterdamUtrechtL2::Sheet08A_Abcoude_Balises::Balise_Group_374#1)/ */
  Balise_Group_374_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises(
    &outC->_L3,
    outC->_L2,
    (BaliseGroupData_TM *) &BG374_Balises426,
    &outC->Context_Balise_Group_374_1);
  kcg_copy_CompressedBaliseMessage_TM(
    &outC->_L1,
    &outC->Context_Balise_Group_374_1.BG_message_out);
  /* _L7=(AmsterdamUtrechtL2::Sheet08A_Abcoude_Balises::Balise_Group_375#1)/ */
  Balise_Group_375_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises(
    &outC->_L1,
    outC->_L2,
    (BaliseGroupData_TM *) &BG375_Balises426,
    &outC->Context_Balise_Group_375_1);
  kcg_copy_CompressedBaliseMessage_TM(
    &outC->_L7,
    &outC->Context_Balise_Group_375_1.BG_message_out);
  /* _L8=(AmsterdamUtrechtL2::Sheet08A_Abcoude_Balises::Balise_Group_376#1)/ */
  Balise_Group_376_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises(
    &outC->_L7,
    outC->_L2,
    (BaliseGroupData_TM *) &BG376_Balises426,
    &outC->Context_Balise_Group_376_1);
  kcg_copy_CompressedBaliseMessage_TM(
    &outC->_L8,
    &outC->Context_Balise_Group_376_1.BG_message_out);
  /* _L9=(AmsterdamUtrechtL2::Sheet08A_Abcoude_Balises::Balise_Group_377#1)/ */
  Balise_Group_377_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises(
    &outC->_L8,
    outC->_L2,
    (BaliseGroupData_TM *) &BG377_Balises426,
    &outC->Context_Balise_Group_377_1);
  kcg_copy_CompressedBaliseMessage_TM(
    &outC->_L9,
    &outC->Context_Balise_Group_377_1.BG_message_out);
...
void Balises0005_Abcoude_init_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises(
  outC_Balises0005_Abcoude_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L9.Messages.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L9.Messages.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L9.Messages.PacketHeaders[idx].valid = kcg_true;
    outC->_L9.Messages.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L9.Messages.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L9.Messages.PacketData[idx1] = kcg_lit_int64(0);
  }
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L8.Messages.PacketHeaders[idx2].nid_packet = kcg_lit_int64(0);
    outC->_L8.Messages.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L8.Messages.PacketHeaders[idx2].valid = kcg_true;
    outC->_L8.Messages.PacketHeaders[idx2].startAddress = kcg_lit_int64(0);
    outC->_L8.Messages.PacketHeaders[idx2].endAddress = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L8.Messages.PacketData[idx3] = kcg_lit_int64(0);
  }
  ...
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L7.Messages.PacketHeaders[idx4].nid_packet = kcg_lit_int64(0);
    outC->_L7.Messages.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L7.Messages.PacketHeaders[idx4].valid = kcg_true;
    outC->_L7.Messages.PacketHeaders[idx4].startAddress = kcg_lit_int64(0);
    outC->_L7.Messages.PacketHeaders[idx4].endAddress = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L7.Messages.PacketData[idx5] = kcg_lit_int64(0);
  }
  ...
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L6.BG_Message.Messages.PacketHeaders[idx6].nid_packet = kcg_lit_int64(0);
    ...
    outC->_L6.BG_Message.Messages.PacketHeaders[idx6].startAddress =
      kcg_lit_int64(0);
    outC->_L6.BG_Message.Messages.PacketHeaders[idx6].endAddress = kcg_lit_int64(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->_L6.BG_Message.Messages.PacketData[idx7] = kcg_lit_int64(0);
  }
  ...
  for (idx8 = 0; idx8 < 30; idx8++) {
    outC->_L1.Messages.PacketHeaders[idx8].nid_packet = kcg_lit_int64(0);
    outC->_L1.Messages.PacketHeaders[idx8].q_dir = Q_DIR_Reverse;
    outC->_L1.Messages.PacketHeaders[idx8].valid = kcg_true;
    outC->_L1.Messages.PacketHeaders[idx8].startAddress = kcg_lit_int64(0);
    outC->_L1.Messages.PacketHeaders[idx8].endAddress = kcg_lit_int64(0);
  }
  for (idx9 = 0; idx9 < 500; idx9++) {
    outC->_L1.Messages.PacketData[idx9] = kcg_lit_int64(0);
  }
  ...
  for (idx10 = 0; idx10 < 30; idx10++) {
    outC->_L3.Messages.PacketHeaders[idx10].nid_packet = kcg_lit_int64(0);
    outC->_L3.Messages.PacketHeaders[idx10].q_dir = Q_DIR_Reverse;
    outC->_L3.Messages.PacketHeaders[idx10].valid = kcg_true;
    outC->_L3.Messages.PacketHeaders[idx10].startAddress = kcg_lit_int64(0);
    outC->_L3.Messages.PacketHeaders[idx10].endAddress = kcg_lit_int64(0);
  }
  for (idx11 = 0; idx11 < 500; idx11++) {
    outC->_L3.Messages.PacketData[idx11] = kcg_lit_int64(0);
  }
  ...
  for (idx13 = 0; idx13 < 500; idx13++) {
    outC->_L4.BG_Message.Messages.PacketData[idx13] = kcg_lit_int64(0);
  }
  ...
  for (idx15 = 0; idx15 < 500; idx15++) {
    outC->SectionData_out.BG_Message.Messages.PacketData[idx15] = kcg_lit_int64(0);
  }
  /* _L9=(AmsterdamUtrechtL2::Sheet08A_Abcoude_Balises::Balise_Group_377#1)/ */
  Balise_Group_377_init_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises(
    &outC->Context_Balise_Group_377_1);
  /* _L8=(AmsterdamUtrechtL2::Sheet08A_Abcoude_Balises::Balise_Group_376#1)/ */
  Balise_Group_376_init_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises(
    &outC->Context_Balise_Group_376_1);
  /* _L7=(AmsterdamUtrechtL2::Sheet08A_Abcoude_Balises::Balise_Group_375#1)/ */
  Balise_Group_375_init_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises(
    &outC->Context_Balise_Group_375_1);
  /* _L1=(AmsterdamUtrechtL2::Sheet08A_Abcoude_Balises::Balise_Group_374#1)/ */
  Balise_Group_374_init_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises(
    &outC->Context_Balise_Group_374_1);
}
