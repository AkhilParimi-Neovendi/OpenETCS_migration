...
void _143_RadioTrainTrackMessa_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
  ...
  outC__143_RadioTrainTrackMessa_RBC_Messaging_Pkg_RBC_Consistency_Pkg *outC)
{
  ...
  T_TRAIN lastReceivedRadioTrainTrackMessageTimestamp_partial;
  /* outIsConsistent/ */
  kcg_bool _1_outIsConsistent_partial;
  /* lastReceivedRadioTrainTrackMessageTimestamp/ */
  T_TRAIN _2_lastReceivedRadioTrainTrackMessageTimestamp_partial;
  /* lastReceivedRadioTrainTrackMessageTimestamp/ */
  T_TRAIN last_lastReceivedRadioTrainTrackMessageTimestamp;
  ...
  RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->_L1,
    &outC->_3_Context_RadioTrainTrackMessage__GetHeader_1);
  kcg_copy_Radio_TrainTrack_Header_T_Radio_Types_Pkg(
    &outC->_L2,
    &outC->_3_Context_RadioTrainTrackMessage__GetHeader_1.outRadioTrainTrackHeader);
  /* _L6=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__Get_T_TRAIN#1)/ */
  _98_RadioTrainTrackHeader__Ge_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->_L2,
    &outC->_2_Context_RadioTrainTrackHeader__Get_T_TRAIN_1);
  outC->_L6 = outC->_2_Context_RadioTrainTrackHeader__Get_T_TRAIN_1.out_T_TRAIN;
  ...
  RadioTrainTrackHeader__Is_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->_L2,
  ...
  RadioTrainTrackMessage__I_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->_L1,
  ...
  if (outC->IfBlock1_clock) {
    ...
    RadioTrainTrackMessageCon_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
      &outC->_L2_then_IfBlock1,
      &outC->_1_Context_RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets_1);
    outC->_L1_then_IfBlock1 =
      outC->_1_Context_RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets_1.outIsConsistent;
    /* IfBlock1:then:_L4=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::RadioTrainTrackMessageConsistencyChecker__HasConsistentHeader#1)/ */
    _142_RadioTrainTrackMessa_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
      &outC->_L2_then_IfBlock1,
...
void _143_RadioTrainTrackMessa_init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
  outC__143_RadioTrainTrackMessa_RBC_Messaging_Pkg_RBC_Consistency_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  outC->currentRecivedRadioTrainTrackMessageTimestamp = kcg_lit_int64(0);
  ...
  for (idx7 = 0; idx7 < 5; idx7++) {
    outC->_L2_then_IfBlock1.packets.p11.nid_ntc[idx7] = kcg_lit_int64(0);
  }
  ...
  /* IfBlock1:then:_L4=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::RadioTrainTrackMessageConsistencyChecker__HasConsistentHeader#1)/ */
  _142_RadioTrainTrackMessa_init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_RadioTrainTrackMessageConsistencyChecker__HasConsistentHeader_1);
  /* IfBlock1:then:_L1=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets#1)/ */
  RadioTrainTrackMessageCon_init_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->_1_Context_RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets_1);
  /* _L5=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__IsPresent#1)/ */
  RadioTrainTrackMessage__I_init_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->Context_RadioTrainTrackMessage__IsPresent_1);
  /* _L4=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__IsPresent#1)/ */
  RadioTrainTrackHeader__Is_init_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->Context_RadioTrainTrackHeader__IsPresent_1);
  /* _L6=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__Get_T_TRAIN#1)/ */
  _98_RadioTrainTrackHeader__Ge_init_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->_2_Context_RadioTrainTrackHeader__Get_T_TRAIN_1);
  /* _L2=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__GetHeader#1)/ */
  RadioTrainTrackMessage__G_init_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->_3_Context_RadioTrainTrackMessage__GetHeader_1);
  outC->lastReceivedRadioTrainTrackMessageTimestamp = kcg_lit_int64(-1);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void _143_RadioTrainTrackMessa_reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
  outC__143_RadioTrainTrackMessa_RBC_Messaging_Pkg_RBC_Consistency_Pkg *outC)
{
  /* IfBlock1:then:_L4=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::RadioTrainTrackMessageConsistencyChecker__HasConsistentHeader#1)/ */
  _142_RadioTrainTrackMessa_reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->Context_RadioTrainTrackMessageConsistencyChecker__HasConsistentHeader_1);
  /* IfBlock1:then:_L1=(RBC_Messaging_Pkg::RBC_Consistency_Pkg::RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets#1)/ */
  RadioTrainTrackMessageCon_reset_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
    &outC->_1_Context_RadioTrainTrackMessageConsistencyChecker__HasConsistentPackets_1);
  /* _L5=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__IsPresent#1)/ */
  RadioTrainTrackMessage__I_reset_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->Context_RadioTrainTrackMessage__IsPresent_1);
  /* _L4=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__IsPresent#1)/ */
  RadioTrainTrackHeader__Is_reset_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->Context_RadioTrainTrackHeader__IsPresent_1);
  /* _L6=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__Get_T_TRAIN#1)/ */
  _98_RadioTrainTrackHeader__Ge_reset_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
    &outC->_2_Context_RadioTrainTrackHeader__Get_T_TRAIN_1);
  /* _L2=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__GetHeader#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _143_RadioTrainTrackMessa_RBC_Messaging_Pkg_RBC_Consistency_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
