...
void _50_RadioTrackTrainMessageQue_RBC_Collections_Pkg(
  ...
  outC__50_RadioTrackTrainMessageQue_RBC_Collections_Pkg *outC)
{
  ...
  /* outRadioTrackTrainMessageQueue/ */
  _2_RadioTrackTrainMessageQueue_T _1_outRadioTrackTrainMessageQueue_partial;
  ...
  _48_RadioTrackTrainMessageQue_RBC_Collections_Pkg(
    &outC->_L1,
    &outC->_2_Context_RadioTrackTrainMessageQueue__GetRemainingCapacity_1);
  outC->_L4 =
    outC->_2_Context_RadioTrackTrainMessageQueue__GetRemainingCapacity_1.outRemainingCapacity;
  ...
  if (outC->IfBlock1_clock) {
    ...
    RadioTrackTrainMessageQue_RBC_Collections_Pkg(
      &outC->_L3_then_IfBlock1,
      &outC->_1_Context_RadioTrackTrainMessageQueue__GetEntries_1);
    kcg_copy__3_RadioTrackTrainMessageQueueEntries_T(
      &outC->_L5_then_IfBlock1,
      &outC->_1_Context_RadioTrackTrainMessageQueue__GetEntries_1.outRadioTrackTrainMessageQueueEntries);
...
void _50_RadioTrackTrainMessageQue_init_RBC_Collections_Pkg(
  outC__50_RadioTrackTrainMessageQue_RBC_Collections_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx2 = 0; idx2 < 8; idx2++) {
    ...
    outC->_L1.m_Entries[idx2].m_Entry.Header.radioDevice = kcg_lit_int32(0);
    outC->_L1.m_Entries[idx2].m_Entry.Header.receivedSystemTime = kcg_lit_int32(0);
    outC->_L1.m_Entries[idx2].m_Entry.Header.nid_message = kcg_lit_int32(0);
    outC->_L1.m_Entries[idx2].m_Entry.Header.t_train = kcg_lit_int32(0);
    outC->_L1.m_Entries[idx2].m_Entry.Header.m_ack = kcg_lit_int32(0);
    outC->_L1.m_Entries[idx2].m_Entry.Header.nid_lrbg = kcg_lit_int32(0);
    outC->_L1.m_Entries[idx2].m_Entry.Header.t_train_reference = kcg_lit_int32(0);
    outC->_L1.m_Entries[idx2].m_Entry.Header.nid_em = kcg_lit_int32(0);
    outC->_L1.m_Entries[idx2].m_Entry.Header.q_scale = kcg_lit_int32(0);
    outC->_L1.m_Entries[idx2].m_Entry.Header.d_sr = kcg_lit_int32(0);
    outC->_L1.m_Entries[idx2].m_Entry.Header.t_sh_rqst = kcg_lit_int32(0);
    outC->_L1.m_Entries[idx2].m_Entry.Header.d_ref = kcg_lit_int32(0);
    outC->_L1.m_Entries[idx2].m_Entry.Header.q_dir = kcg_lit_int32(0);
    outC->_L1.m_Entries[idx2].m_Entry.Header.d_emergencystop = kcg_lit_int32(0);
    outC->_L1.m_Entries[idx2].m_Entry.Header.m_version = kcg_lit_int32(0);
    ...
    for (idx1 = 0; idx1 < 500; idx1++) {
      outC->_L1.m_Entries[idx2].m_Entry.Messages.PacketData[idx1] = kcg_lit_int32(0);
    }
  }
  ...
  for (idx5 = 0; idx5 < 8; idx5++) {
    ...
    outC->_L1_else_IfBlock1.m_Entries[idx5].m_Entry.Header.t_train =
      kcg_lit_int32(0);
    outC->_L1_else_IfBlock1.m_Entries[idx5].m_Entry.Header.m_ack = kcg_lit_int32(0);
    ...
    outC->_L1_else_IfBlock1.m_Entries[idx5].m_Entry.Header.q_scale =
      kcg_lit_int32(0);
    outC->_L1_else_IfBlock1.m_Entries[idx5].m_Entry.Header.d_sr = kcg_lit_int32(0);
    outC->_L1_else_IfBlock1.m_Entries[idx5].m_Entry.Header.t_sh_rqst =
      kcg_lit_int32(0);
    outC->_L1_else_IfBlock1.m_Entries[idx5].m_Entry.Header.d_ref = kcg_lit_int32(0);
    outC->_L1_else_IfBlock1.m_Entries[idx5].m_Entry.Header.q_dir = kcg_lit_int32(0);
  ...
  for (idx8 = 0; idx8 < 7; idx8++) {
    ...
    outC->_L1_then_IfBlock1[idx8].m_Entry.Header.radioDevice = kcg_lit_int32(0);
    outC->_L1_then_IfBlock1[idx8].m_Entry.Header.receivedSystemTime =
      kcg_lit_int32(0);
    outC->_L1_then_IfBlock1[idx8].m_Entry.Header.nid_message = kcg_lit_int32(0);
    outC->_L1_then_IfBlock1[idx8].m_Entry.Header.t_train = kcg_lit_int32(0);
    outC->_L1_then_IfBlock1[idx8].m_Entry.Header.m_ack = kcg_lit_int32(0);
    outC->_L1_then_IfBlock1[idx8].m_Entry.Header.nid_lrbg = kcg_lit_int32(0);
    outC->_L1_then_IfBlock1[idx8].m_Entry.Header.t_train_reference =
      kcg_lit_int32(0);
    outC->_L1_then_IfBlock1[idx8].m_Entry.Header.nid_em = kcg_lit_int32(0);
    outC->_L1_then_IfBlock1[idx8].m_Entry.Header.q_scale = kcg_lit_int32(0);
    outC->_L1_then_IfBlock1[idx8].m_Entry.Header.d_sr = kcg_lit_int32(0);
    outC->_L1_then_IfBlock1[idx8].m_Entry.Header.t_sh_rqst = kcg_lit_int32(0);
    outC->_L1_then_IfBlock1[idx8].m_Entry.Header.d_ref = kcg_lit_int32(0);
    outC->_L1_then_IfBlock1[idx8].m_Entry.Header.q_dir = kcg_lit_int32(0);
    outC->_L1_then_IfBlock1[idx8].m_Entry.Header.d_emergencystop = kcg_lit_int32(0);
    outC->_L1_then_IfBlock1[idx8].m_Entry.Header.m_version = kcg_lit_int32(0);
  ...
  outC->_L2_then_IfBlock1.m_Entry.Header.radioDevice = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.m_Entry.Header.receivedSystemTime = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.m_Entry.Header.nid_message = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.m_Entry.Header.t_train = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.m_Entry.Header.m_ack = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.m_Entry.Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.m_Entry.Header.t_train_reference = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.m_Entry.Header.nid_em = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.m_Entry.Header.q_scale = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.m_Entry.Header.d_sr = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.m_Entry.Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.m_Entry.Header.d_ref = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.m_Entry.Header.q_dir = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.m_Entry.Header.d_emergencystop = kcg_lit_int32(0);
  outC->_L2_then_IfBlock1.m_Entry.Header.m_version = kcg_lit_int32(0);
  ...
  for (idx10 = 0; idx10 < 500; idx10++) {
    outC->_L2_then_IfBlock1.m_Entry.Messages.PacketData[idx10] = kcg_lit_int32(0);
  }
  for (idx13 = 0; idx13 < 8; idx13++) {
    ...
    outC->_L3_then_IfBlock1.m_Entries[idx13].m_Entry.Header.q_scale =
      kcg_lit_int32(0);
    outC->_L3_then_IfBlock1.m_Entries[idx13].m_Entry.Header.d_sr = kcg_lit_int32(0);
  ...
  for (idx16 = 0; idx16 < 8; idx16++) {
    ...
    outC->_L4_then_IfBlock1[idx16].m_Entry.Header.radioDevice = kcg_lit_int32(0);
    outC->_L4_then_IfBlock1[idx16].m_Entry.Header.receivedSystemTime =
      kcg_lit_int32(0);
    outC->_L4_then_IfBlock1[idx16].m_Entry.Header.nid_message = kcg_lit_int32(0);
    outC->_L4_then_IfBlock1[idx16].m_Entry.Header.t_train = kcg_lit_int32(0);
    outC->_L4_then_IfBlock1[idx16].m_Entry.Header.m_ack = kcg_lit_int32(0);
    outC->_L4_then_IfBlock1[idx16].m_Entry.Header.nid_lrbg = kcg_lit_int32(0);
    outC->_L4_then_IfBlock1[idx16].m_Entry.Header.t_train_reference =
      kcg_lit_int32(0);
    outC->_L4_then_IfBlock1[idx16].m_Entry.Header.nid_em = kcg_lit_int32(0);
    outC->_L4_then_IfBlock1[idx16].m_Entry.Header.q_scale = kcg_lit_int32(0);
    outC->_L4_then_IfBlock1[idx16].m_Entry.Header.d_sr = kcg_lit_int32(0);
    outC->_L4_then_IfBlock1[idx16].m_Entry.Header.t_sh_rqst = kcg_lit_int32(0);
    outC->_L4_then_IfBlock1[idx16].m_Entry.Header.d_ref = kcg_lit_int32(0);
    outC->_L4_then_IfBlock1[idx16].m_Entry.Header.q_dir = kcg_lit_int32(0);
    outC->_L4_then_IfBlock1[idx16].m_Entry.Header.d_emergencystop =
      kcg_lit_int32(0);
    outC->_L4_then_IfBlock1[idx16].m_Entry.Header.m_version = kcg_lit_int32(0);
  ...
  for (idx19 = 0; idx19 < 8; idx19++) {
    ...
    outC->_L5_then_IfBlock1[idx19].m_Entry.Header.radioDevice = kcg_lit_int32(0);
    outC->_L5_then_IfBlock1[idx19].m_Entry.Header.receivedSystemTime =
      kcg_lit_int32(0);
    outC->_L5_then_IfBlock1[idx19].m_Entry.Header.nid_message = kcg_lit_int32(0);
    outC->_L5_then_IfBlock1[idx19].m_Entry.Header.t_train = kcg_lit_int32(0);
    outC->_L5_then_IfBlock1[idx19].m_Entry.Header.m_ack = kcg_lit_int32(0);
    outC->_L5_then_IfBlock1[idx19].m_Entry.Header.nid_lrbg = kcg_lit_int32(0);
    outC->_L5_then_IfBlock1[idx19].m_Entry.Header.t_train_reference =
      kcg_lit_int32(0);
    outC->_L5_then_IfBlock1[idx19].m_Entry.Header.nid_em = kcg_lit_int32(0);
    outC->_L5_then_IfBlock1[idx19].m_Entry.Header.q_scale = kcg_lit_int32(0);
    outC->_L5_then_IfBlock1[idx19].m_Entry.Header.d_sr = kcg_lit_int32(0);
    outC->_L5_then_IfBlock1[idx19].m_Entry.Header.t_sh_rqst = kcg_lit_int32(0);
    outC->_L5_then_IfBlock1[idx19].m_Entry.Header.d_ref = kcg_lit_int32(0);
    outC->_L5_then_IfBlock1[idx19].m_Entry.Header.q_dir = kcg_lit_int32(0);
    outC->_L5_then_IfBlock1[idx19].m_Entry.Header.d_emergencystop =
      kcg_lit_int32(0);
    outC->_L5_then_IfBlock1[idx19].m_Entry.Header.m_version = kcg_lit_int32(0);
  ...
  for (idx22 = 0; idx22 < 8; idx22++) {
    ...
    outC->_L6_then_IfBlock1.m_Entries[idx22].m_Entry.Header.q_scale =
      kcg_lit_int32(0);
    outC->_L6_then_IfBlock1.m_Entries[idx22].m_Entry.Header.d_sr = kcg_lit_int32(0);
  ...
  for (idx25 = 0; idx25 < 1; idx25++) {
    ...
    outC->_L8_then_IfBlock1[idx25].m_Entry.Header.radioDevice = kcg_lit_int32(0);
    outC->_L8_then_IfBlock1[idx25].m_Entry.Header.receivedSystemTime =
      kcg_lit_int32(0);
    outC->_L8_then_IfBlock1[idx25].m_Entry.Header.nid_message = kcg_lit_int32(0);
    outC->_L8_then_IfBlock1[idx25].m_Entry.Header.t_train = kcg_lit_int32(0);
    outC->_L8_then_IfBlock1[idx25].m_Entry.Header.m_ack = kcg_lit_int32(0);
    outC->_L8_then_IfBlock1[idx25].m_Entry.Header.nid_lrbg = kcg_lit_int32(0);
    outC->_L8_then_IfBlock1[idx25].m_Entry.Header.t_train_reference =
      kcg_lit_int32(0);
    outC->_L8_then_IfBlock1[idx25].m_Entry.Header.nid_em = kcg_lit_int32(0);
    outC->_L8_then_IfBlock1[idx25].m_Entry.Header.q_scale = kcg_lit_int32(0);
    outC->_L8_then_IfBlock1[idx25].m_Entry.Header.d_sr = kcg_lit_int32(0);
    outC->_L8_then_IfBlock1[idx25].m_Entry.Header.t_sh_rqst = kcg_lit_int32(0);
    outC->_L8_then_IfBlock1[idx25].m_Entry.Header.d_ref = kcg_lit_int32(0);
    outC->_L8_then_IfBlock1[idx25].m_Entry.Header.q_dir = kcg_lit_int32(0);
    outC->_L8_then_IfBlock1[idx25].m_Entry.Header.d_emergencystop =
      kcg_lit_int32(0);
    outC->_L8_then_IfBlock1[idx25].m_Entry.Header.m_version = kcg_lit_int32(0);
...
void _50_RadioTrackTrainMessageQue_reset_RBC_Collections_Pkg(
  outC__50_RadioTrackTrainMessageQue_RBC_Collections_Pkg *outC)
{
  /* IfBlock1:then:_L6=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__SetEntries#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _50_RadioTrackTrainMessageQue_RBC_Collections_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
