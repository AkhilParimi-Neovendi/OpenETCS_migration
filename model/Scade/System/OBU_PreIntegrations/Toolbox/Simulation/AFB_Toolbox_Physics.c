  ...
  outC_AFB_Toolbox_Physics *outC)
{
  ...
  kcg_float64 calculatedAcceleration_partial;
  /* calculatedAcceleration/ */
  kcg_float64 _1_calculatedAcceleration_partial;
  /* calculatedAcceleration/ */
  kcg_float64 _2_calculatedAcceleration_partial;
  /* calculatedAcceleration/ */
  kcg_float64 _3_calculatedAcceleration_partial;
  /* calculatedAcceleration/ */
  kcg_float64 _4_calculatedAcceleration_partial;
  /* calculatedAcceleration/ */
  kcg_float64 _5_calculatedAcceleration_partial;
