  ...
  outC_AFB_Toolbox_Physics *outC)
{
  ...
  kcg_float32 calculatedAcceleration_partial;
  /* calculatedAcceleration/ */
  kcg_float32 _1_calculatedAcceleration_partial;
  /* calculatedAcceleration/ */
  kcg_float32 _2_calculatedAcceleration_partial;
  /* calculatedAcceleration/ */
  kcg_float32 _3_calculatedAcceleration_partial;
  /* calculatedAcceleration/ */
  kcg_float32 _4_calculatedAcceleration_partial;
  /* calculatedAcceleration/ */
  kcg_float32 _5_calculatedAcceleration_partial;
