...
void RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
...
void RadioTrainTrackMessage__G_init_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
  outC_RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  outC->outRadioTrainTrackHeader.nid_message = kcg_lit_int32(0);
  outC->outRadioTrainTrackHeader.t_train = kcg_lit_int32(0);
  outC->outRadioTrainTrackHeader.nid_engine = kcg_lit_int32(0);
  outC->outRadioTrainTrackHeader.xQ_MARQSTREASON =
    Q_MARQSTREASON_Start_selected_by_driver;
  outC->outRadioTrainTrackHeader.xT_TRAIN = kcg_lit_int32(0);
  outC->outRadioTrainTrackHeader.xNID_EM = kcg_lit_int32(0);
  outC->outRadioTrainTrackHeader.xQ_EMERGENCYSTOP =
    _12_Q_EMERGENCYSTOP_Conditional_Emergency_Stop_accepted_with_update_of_EOA;
  outC->outRadioTrainTrackHeader.xNID_TEXTMESSAGE = kcg_lit_int32(0);
}
#endif /* KCG_USER_DEFINED_INIT */


void RadioTrainTrackMessage__G_reset_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
  outC_RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
