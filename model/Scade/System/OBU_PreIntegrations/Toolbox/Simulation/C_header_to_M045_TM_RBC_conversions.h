...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  M_045_T_TM_radio_messages /* message_out/ */ message_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  outC_CAST_Int_to_Q_ORIENTATION_TM_conversions /* _L29=(TM_conversions::CAST_Int_to_Q_ORIENTATION#1)/ */ Context_CAST_Int_to_Q_ORIENTATION_1;
  ...
  kcg_int64 /* _L3/ */ _L3;
  kcg_bool /* _L2/ */ _L2;
  M_045_T_TM_radio_messages /* _L26/ */ _L26;
  M_ACK /* _L27/ */ _L27;
  NID_LRBG /* _L28/ */ _L28;
  Q_ORIENTATION /* _L29/ */ _L29;
...
extern void C_header_to_M045_init_TM_RBC_conversions(
  outC_C_header_to_M045_TM_RBC_conversions *outC);
