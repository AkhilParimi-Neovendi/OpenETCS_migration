...
void SendRadioPackets_LRBG_383_AmsterdamUtrechtL2_Sheet08B_Abcoude_RBC(
  /* Radio_packets_in/ */
  ...
  outC_SendRadioPackets_LRBG_383_AmsterdamUtrechtL2_Sheet08B_Abcoude_RBC *outC)
{
  ...
  /* _L4=(MessageLibBaseline2::Send_P005#2)/ */
  Send_P005_MessageLibBaseline2(
    &outC->_L3,
    (P005_trackside_int_T_TM *) &LRBG383_P005_Packets426,
    &outC->Context_Send_P005_2);
  kcg_copy_CompressedPackets_T_Common_Types_Pkg(
    &outC->_L4,
    &outC->Context_Send_P005_2.B_data_out);
  kcg_copy_CompressedPackets_T_Common_Types_Pkg(
...
void SendRadioPackets_LRBG_383_init_AmsterdamUtrechtL2_Sheet08B_Abcoude_RBC(
  outC_SendRadioPackets_LRBG_383_AmsterdamUtrechtL2_Sheet08B_Abcoude_RBC *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L4=(MessageLibBaseline2::Send_P005#2)/ */
  Send_P005_init_MessageLibBaseline2(&outC->Context_Send_P005_2);
  /* _L3=(MessageLibBaseline2::Send_P027V1#1)/ */
...
void SendRadioPackets_LRBG_383_reset_AmsterdamUtrechtL2_Sheet08B_Abcoude_RBC(
  outC_SendRadioPackets_LRBG_383_AmsterdamUtrechtL2_Sheet08B_Abcoude_RBC *outC)
{
  /* _L4=(MessageLibBaseline2::Send_P005#2)/ */
  Send_P005_reset_MessageLibBaseline2(&outC->Context_Send_P005_2);
  /* _L3=(MessageLibBaseline2::Send_P027V1#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** SendRadioPackets_LRBG_383_AmsterdamUtrechtL2_Sheet08B_Abcoude_RBC.c
** Generation date: 2023-09-12T13:45:52
*************************************************************$ */
