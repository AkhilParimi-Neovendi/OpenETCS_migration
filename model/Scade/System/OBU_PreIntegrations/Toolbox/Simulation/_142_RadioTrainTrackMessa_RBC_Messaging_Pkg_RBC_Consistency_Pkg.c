  ...
  outC__142_RadioTrainTrackMessa_RBC_Messaging_Pkg_RBC_Consistency_Pkg *outC)
{
  ...
  outC->_L38_then_else_else_else_else_else_IfBlock1.nid_message = kcg_lit_int32(
      0);
  outC->_L38_then_else_else_else_else_else_IfBlock1.t_train = kcg_lit_int32(0);
  outC->_L38_then_else_else_else_else_else_IfBlock1.nid_engine = kcg_lit_int32(0);
  outC->_L38_then_else_else_else_else_else_IfBlock1.xQ_MARQSTREASON =
    Q_MARQSTREASON_Start_selected_by_driver;
  outC->_L38_then_else_else_else_else_else_IfBlock1.xT_TRAIN = kcg_lit_int32(0);
  outC->_L38_then_else_else_else_else_else_IfBlock1.xNID_EM = kcg_lit_int32(0);
