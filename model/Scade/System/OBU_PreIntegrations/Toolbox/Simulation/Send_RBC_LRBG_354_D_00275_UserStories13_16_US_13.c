  ...
  outC_Send_RBC_LRBG_354_D_00275_UserStories13_16_US_13 *outC)
{
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L53.packets.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    outC->_L53.packets.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L53.packets.PacketHeaders[idx2].valid = kcg_true;
    outC->_L53.packets.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L53.packets.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L53.packets.PacketData[idx3] = kcg_lit_int32(0);
  }
  ...
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L23.packets.PacketHeaders[idx4].nid_packet = kcg_lit_int32(0);
    outC->_L23.packets.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L23.packets.PacketHeaders[idx4].valid = kcg_true;
    outC->_L23.packets.PacketHeaders[idx4].startAddress = kcg_lit_int32(0);
    outC->_L23.packets.PacketHeaders[idx4].endAddress = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L23.packets.PacketData[idx5] = kcg_lit_int32(0);
  }
