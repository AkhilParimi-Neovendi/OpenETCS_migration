...
#include "Send_RBC_LRBG_354_D_00275_UserStories13_16_US_13.h"

/* UserStories13_16::US_13::Send_RBC_LRBG_354_D_00275_3_M003/ */
void Send_RBC_LRBG_354_D_00275_UserStories13_16_US_13(
  /* RadiaDataIn/ */
...
{
  R_data_internal_T_InfraLib op_call;
  ...
  if (outC->every) {
    /* _L4=(UserStories13_16::US_13::Build_RBC_LRBG_354_D_00275_3_M003#1)/ */
    Build_RBC_LRBG_354_D_0027_UserStories13_16_US_13(
      &outC->_L53,
      &outC->Context_Build_RBC_LRBG_354_D_00275_3_M003_1);
    kcg_copy_R_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Build_RBC_LRBG_354_D_00275_3_M003_1.R_data_out);
...
void Send_RBC_LRBG_354_D_00275_init_UserStories13_16_US_13(
  outC_Send_RBC_LRBG_354_D_00275_UserStories13_16_US_13 *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  outC->_L53.message.nid_message = kcg_lit_int64(0);
  outC->_L53.message.l_message = kcg_lit_int64(0);
  outC->_L53.message.t_train = kcg_lit_int64(0);
  outC->_L53.message.field1 = kcg_lit_int64(0);
  outC->_L53.message.field2 = kcg_lit_int64(0);
  outC->_L53.message.field3 = kcg_lit_int64(0);
  outC->_L53.message.field4 = kcg_lit_int64(0);
  outC->_L53.message.field5 = kcg_lit_int64(0);
  outC->_L53.message.field6 = kcg_lit_int64(0);
  outC->_L53.message.field7 = kcg_lit_int64(0);
  outC->_L53.message.field8 = kcg_lit_int64(0);
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L53.packets.PacketHeaders[idx2].nid_packet = kcg_lit_int64(0);
    outC->_L53.packets.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L53.packets.PacketHeaders[idx2].valid = kcg_true;
    outC->_L53.packets.PacketHeaders[idx2].startAddress = kcg_lit_int64(0);
    outC->_L53.packets.PacketHeaders[idx2].endAddress = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L53.packets.PacketData[idx3] = kcg_lit_int64(0);
  }
  outC->_L53.trigger = kcg_lit_int64(0);
  ...
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L23.packets.PacketHeaders[idx4].nid_packet = kcg_lit_int64(0);
    outC->_L23.packets.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L23.packets.PacketHeaders[idx4].valid = kcg_true;
    outC->_L23.packets.PacketHeaders[idx4].startAddress = kcg_lit_int64(0);
    outC->_L23.packets.PacketHeaders[idx4].endAddress = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L23.packets.PacketData[idx5] = kcg_lit_int64(0);
  }
  ...
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->R_data_out.packets.PacketHeaders[idx6].nid_packet = kcg_lit_int64(0);
    outC->R_data_out.packets.PacketHeaders[idx6].q_dir = Q_DIR_Reverse;
    outC->R_data_out.packets.PacketHeaders[idx6].valid = kcg_true;
    outC->R_data_out.packets.PacketHeaders[idx6].startAddress = kcg_lit_int64(0);
    outC->R_data_out.packets.PacketHeaders[idx6].endAddress = kcg_lit_int64(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->R_data_out.packets.PacketData[idx7] = kcg_lit_int64(0);
  }
  outC->R_data_out.trigger = kcg_lit_int64(0);
  outC->R_data_out.message_sent = kcg_true;
  /* _L4=(UserStories13_16::US_13::Build_RBC_LRBG_354_D_00275_3_M003#1)/ */
  Build_RBC_LRBG_354_D_0027_init_UserStories13_16_US_13(
    &outC->Context_Build_RBC_LRBG_354_D_00275_3_M003_1);
}
...
void Send_RBC_LRBG_354_D_00275_reset_UserStories13_16_US_13(
  outC_Send_RBC_LRBG_354_D_00275_UserStories13_16_US_13 *outC)
{
  /* _L4=(UserStories13_16::US_13::Build_RBC_LRBG_354_D_00275_3_M003#1)/ */
  Build_RBC_LRBG_354_D_0027_reset_UserStories13_16_US_13(
    &outC->Context_Build_RBC_LRBG_354_D_00275_3_M003_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Send_RBC_LRBG_354_D_00275_UserStories13_16_US_13.c
** Generation date: 2023-09-12T13:45:52
*************************************************************$ */
