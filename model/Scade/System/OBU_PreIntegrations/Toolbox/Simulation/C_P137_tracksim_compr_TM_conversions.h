...
typedef struct {
  ...
  CompressedPacketData_T_Common_Types_Pkg /* P137_compressed/ */ P137_compressed;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_T_Build_Metadata_Packet_ID_TM_lib_internal /* _L389=(TM_lib_internal::T_Build_Metadata_Packet_ID#1)/ */ Context_T_Build_Metadata_Packet_ID_1;
  ...
  Q_DIR /* _L356/ */ _L356;
  P015_section_array_T_TM /* _L373/ */ _L373;
  CompressedPacketData_T_Common_Types_Pkg /* _L383/ */ _L383;
  kcg_int32 /* _L387/ */ _L387;
  kcg_int32 /* _L388/ */ _L388;
  nid_packet_meta_TM /* _L389/ */ _L389;
} outC_C_P137_tracksim_compr_TM_conversions;
...
extern void C_P137_tracksim_compr_reset_TM_conversions(
  outC_C_P137_tracksim_compr_TM_conversions *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void C_P137_tracksim_compr_init_TM_conversions(
  outC_C_P137_tracksim_compr_TM_conversions *outC);
