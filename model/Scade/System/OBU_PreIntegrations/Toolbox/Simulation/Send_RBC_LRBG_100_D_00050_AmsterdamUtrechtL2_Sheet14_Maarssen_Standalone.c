...
#include "Send_RBC_LRBG_100_D_00050_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone.h"

/* AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Send_RBC_LRBG_100_D_00050_0_M032/ */
void Send_RBC_LRBG_100_D_00050_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  /* RadiaDataIn/ */
  R_data_internal_T_InfraLib *RadiaDataIn,
  /* TriggerValue/ */
  kcg_int64 TriggerValue,
  outC_Send_RBC_LRBG_100_D_00050_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Build_RBC_Message_LRBG_100_D_00050_0_M032#1)/ */
    Build_RBC_Message_LRBG_10_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
      &outC->_L53,
      &outC->Context_Build_RBC_Message_LRBG_100_D_00050_0_M032_1);
    kcg_copy_R_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Build_RBC_Message_LRBG_100_D_00050_0_M032_1.R_data_out);
...
void Send_RBC_LRBG_100_D_00050_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  outC_Send_RBC_LRBG_100_D_00050_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Build_RBC_Message_LRBG_100_D_00050_0_M032#1)/ */
  Build_RBC_Message_LRBG_10_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->Context_Build_RBC_Message_LRBG_100_D_00050_0_M032_1);
}
...
void Send_RBC_LRBG_100_D_00050_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  outC_Send_RBC_LRBG_100_D_00050_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet14_Maarssen_Standalone::Build_RBC_Message_LRBG_100_D_00050_0_M032#1)/ */
  Build_RBC_Message_LRBG_10_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
    &outC->Context_Build_RBC_Message_LRBG_100_D_00050_0_M032_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Send_RBC_LRBG_100_D_00050_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone.c
** Generation date: 2023-09-12T13:45:52
*************************************************************$ */
