...
#include "_161_SendRadioPackets_LRB_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC.h"

/* AmsterdamUtrechtL2::Sheet06_Bijlmer_RBC::SendRadioPackets_LRBG_362_D_00238_9_M003/ */
void _161_SendRadioPackets_LRB_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
  /* Radio_packets_in/ */
  CompressedPackets_T_Common_Types_Pkg *Radio_packets_in,
  outC__161_SendRadioPackets_LRB_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC *outC)
{
...
void _161_SendRadioPackets_LRB_init_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
  outC__161_SendRadioPackets_LRB_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L33.PacketHeaders[idx].nid_packet = kcg_lit_int64(0);
    outC->_L33.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L33.PacketHeaders[idx].valid = kcg_true;
    outC->_L33.PacketHeaders[idx].startAddress = kcg_lit_int64(0);
    outC->_L33.PacketHeaders[idx].endAddress = kcg_lit_int64(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L33.PacketData[idx1] = kcg_lit_int64(0);
  }
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L32.PacketHeaders[idx2].nid_packet = kcg_lit_int64(0);
    outC->_L32.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L32.PacketHeaders[idx2].valid = kcg_true;
    outC->_L32.PacketHeaders[idx2].startAddress = kcg_lit_int64(0);
    outC->_L32.PacketHeaders[idx2].endAddress = kcg_lit_int64(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L32.PacketData[idx3] = kcg_lit_int64(0);
  }
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L11.PacketHeaders[idx4].nid_packet = kcg_lit_int64(0);
    outC->_L11.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L11.PacketHeaders[idx4].valid = kcg_true;
    outC->_L11.PacketHeaders[idx4].startAddress = kcg_lit_int64(0);
    outC->_L11.PacketHeaders[idx4].endAddress = kcg_lit_int64(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L11.PacketData[idx5] = kcg_lit_int64(0);
  }
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L7.PacketHeaders[idx6].nid_packet = kcg_lit_int64(0);
    outC->_L7.PacketHeaders[idx6].q_dir = Q_DIR_Reverse;
    outC->_L7.PacketHeaders[idx6].valid = kcg_true;
    outC->_L7.PacketHeaders[idx6].startAddress = kcg_lit_int64(0);
    outC->_L7.PacketHeaders[idx6].endAddress = kcg_lit_int64(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->_L7.PacketData[idx7] = kcg_lit_int64(0);
  }
  for (idx8 = 0; idx8 < 30; idx8++) {
    outC->_L5.PacketHeaders[idx8].nid_packet = kcg_lit_int64(0);
    outC->_L5.PacketHeaders[idx8].q_dir = Q_DIR_Reverse;
    outC->_L5.PacketHeaders[idx8].valid = kcg_true;
    outC->_L5.PacketHeaders[idx8].startAddress = kcg_lit_int64(0);
    outC->_L5.PacketHeaders[idx8].endAddress = kcg_lit_int64(0);
  }
  for (idx9 = 0; idx9 < 500; idx9++) {
    outC->_L5.PacketData[idx9] = kcg_lit_int64(0);
  }
  for (idx10 = 0; idx10 < 30; idx10++) {
    outC->_L3.PacketHeaders[idx10].nid_packet = kcg_lit_int64(0);
    outC->_L3.PacketHeaders[idx10].q_dir = Q_DIR_Reverse;
    outC->_L3.PacketHeaders[idx10].valid = kcg_true;
    outC->_L3.PacketHeaders[idx10].startAddress = kcg_lit_int64(0);
    outC->_L3.PacketHeaders[idx10].endAddress = kcg_lit_int64(0);
  }
  for (idx11 = 0; idx11 < 500; idx11++) {
    outC->_L3.PacketData[idx11] = kcg_lit_int64(0);
  }
  for (idx12 = 0; idx12 < 30; idx12++) {
    outC->_L2.PacketHeaders[idx12].nid_packet = kcg_lit_int64(0);
    outC->_L2.PacketHeaders[idx12].q_dir = Q_DIR_Reverse;
    outC->_L2.PacketHeaders[idx12].valid = kcg_true;
    outC->_L2.PacketHeaders[idx12].startAddress = kcg_lit_int64(0);
    outC->_L2.PacketHeaders[idx12].endAddress = kcg_lit_int64(0);
  }
  for (idx13 = 0; idx13 < 500; idx13++) {
    outC->_L2.PacketData[idx13] = kcg_lit_int64(0);
  }
  for (idx14 = 0; idx14 < 30; idx14++) {
    outC->Radio_packets_out.PacketHeaders[idx14].nid_packet = kcg_lit_int64(0);
    outC->Radio_packets_out.PacketHeaders[idx14].q_dir = Q_DIR_Reverse;
    outC->Radio_packets_out.PacketHeaders[idx14].valid = kcg_true;
    outC->Radio_packets_out.PacketHeaders[idx14].startAddress = kcg_lit_int64(0);
    outC->Radio_packets_out.PacketHeaders[idx14].endAddress = kcg_lit_int64(0);
  }
  for (idx15 = 0; idx15 < 500; idx15++) {
    outC->Radio_packets_out.PacketData[idx15] = kcg_lit_int64(0);
  }
  /* _L33=(MessageLibBaseline2::Send_P065#2)/ */
...
void _161_SendRadioPackets_LRB_reset_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC(
  outC__161_SendRadioPackets_LRB_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC *outC)
{
  /* _L33=(MessageLibBaseline2::Send_P065#2)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _161_SendRadioPackets_LRB_AmsterdamUtrechtL2_Sheet06_Bijlmer_RBC.c
** Generation date: 2023-09-12T13:45:52
*************************************************************$ */
