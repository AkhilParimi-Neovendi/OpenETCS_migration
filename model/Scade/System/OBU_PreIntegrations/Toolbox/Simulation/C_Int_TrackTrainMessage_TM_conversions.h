...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  _5_Radio_TrackTrain_Header_T_TM_transitional /* Message_Out/ */ Message_Out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  kcg_bool /* @2/IfBlock1:else: */ _2_else_clock_CAST_Int_to_Q_SCALE_1_IfBlock1;
  /* -------------------- (-debug) no assertions  -------------------- */
  ...
  Q_SCALE /* _L31/ */ _L31;
  _5_Radio_TrackTrain_Header_T_TM_transitional /* _L30/ */ _L30;
  T_TRAIN /* _L29/ */ _L29;
