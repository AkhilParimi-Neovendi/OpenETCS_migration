...
{
  /* m_loadinggauge/ */
  M_LOADINGGAUGE m_loadinggauge_partial;
  /* error/ */
  kcg_bool error_partial;
  /* m_loadinggauge/ */
  M_LOADINGGAUGE _1_m_loadinggauge_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* m_loadinggauge/ */
  M_LOADINGGAUGE _3_m_loadinggauge_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* m_loadinggauge/ */
  M_LOADINGGAUGE _5_m_loadinggauge_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* m_loadinggauge/ */
  M_LOADINGGAUGE _7_m_loadinggauge_partial;
  /* error/ */
  kcg_bool _8_error_partial;
  /* m_loadinggauge/ */
  M_LOADINGGAUGE _9_m_loadinggauge_partial;
  /* error/ */
  kcg_bool _10_error_partial;
  /* error/ */
  kcg_bool _11_error_partial;
  /* m_loadinggauge/ */
  M_LOADINGGAUGE _12_m_loadinggauge_partial;
  /* error/ */
  kcg_bool _13_error_partial;
  /* m_loadinggauge/ */
  M_LOADINGGAUGE _14_m_loadinggauge_partial;
  /* error/ */
  kcg_bool _15_error_partial;
  /* m_loadinggauge/ */
  M_LOADINGGAUGE _16_m_loadinggauge_partial;
  /* error/ */
  kcg_bool _17_error_partial;
  /* m_loadinggauge/ */
  M_LOADINGGAUGE _18_m_loadinggauge_partial;
  kcg_bool noname;
