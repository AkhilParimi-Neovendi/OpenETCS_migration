  ...
  outC_C_M032_int_to_header_TM_RBC_conversions *outC)
{
  ...
  kcg_copy_M_032_int_T_TM_radio_messages(&outC->_L1, Message_Data_in);
...
void C_M032_int_to_header_init_TM_RBC_conversions(
  outC_C_M032_int_to_header_TM_RBC_conversions *outC)
{
...
void C_M032_int_to_header_reset_TM_RBC_conversions(
  outC_C_M032_int_to_header_TM_RBC_conversions *outC)
{
}
