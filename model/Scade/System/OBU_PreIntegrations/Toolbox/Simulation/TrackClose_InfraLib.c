...
void TrackClose_init_InfraLib(outC_TrackClose_InfraLib *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    outC->_L6.Messages.PacketHeaders[idx].nid_packet = kcg_lit_int32(0);
    outC->_L6.Messages.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L6.Messages.PacketHeaders[idx].valid = kcg_true;
    outC->_L6.Messages.PacketHeaders[idx].startAddress = kcg_lit_int32(0);
    outC->_L6.Messages.PacketHeaders[idx].endAddress = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L6.Messages.PacketData[idx1] = kcg_lit_int32(0);
  }
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L1.BG_Message.Messages.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    ...
    outC->_L1.BG_Message.Messages.PacketHeaders[idx2].startAddress =
      kcg_lit_int32(0);
    outC->_L1.BG_Message.Messages.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L1.BG_Message.Messages.PacketData[idx3] = kcg_lit_int32(0);
  }
