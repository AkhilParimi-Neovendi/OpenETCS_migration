...
typedef struct {
  ...
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_RadioTrackTrainHeader__Ge_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* MOVEMENT_AUTHORITY_SM:AWAIT_ACKNOWLEDGEMENT:_L4=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_NID_MESSAGE#3)/ */ Context_RadioTrackTrainHeader__Get_NID_MESSAGE_3;
  outC__55_RadioTrackTrainHeader__Ge_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* MOVEMENT_AUTHORITY_SM:AWAIT_ACKNOWLEDGEMENT:_L9=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_T_TRAIN#2)/ */ _1_Context_RadioTrackTrainHeader__Get_T_TRAIN_2;
  outC_RadioTrackTrainMessage__G_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* MOVEMENT_AUTHORITY_SM:AWAIT_ACKNOWLEDGEMENT:_L3=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__GetHeader#4)/ */ Context_RadioTrackTrainMessage__GetHeader_4;
  outC__55_RadioTrackTrainHeader__Ge_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* MOVEMENT_AUTHORITY_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L20=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_T_TRAIN#3)/ */ _2_Context_RadioTrackTrainHeader__Get_T_TRAIN_3;
  outC_RadioTrackTrainHeader__Ge_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* MOVEMENT_AUTHORITY_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L22=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_NID_MESSAGE#4)/ */ _3_Context_RadioTrackTrainHeader__Get_NID_MESSAGE_4;
  outC_RadioTrackTrainMessage__G_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* MOVEMENT_AUTHORITY_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L19=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__GetHeader#5)/ */ _4_Context_RadioTrackTrainMessage__GetHeader_5;
  outC__56_RadioTrainTrackHeader__Ge_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* MOVEMENT_AUTHORITY_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L29=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__Get_T_TRAIN_Ref#2)/ */ Context_RadioTrainTrackHeader__Get_T_TRAIN_Ref_2;
  outC_RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* MOVEMENT_AUTHORITY_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L27=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__GetHeader#4)/ */ Context_RadioTrainTrackMessage__GetHeader_4;
  outC__50_RadioTrackTrainMessageQue_RBC_Collections_Pkg /* MOVEMENT_AUTHORITY_SM:SEND_MA:_L29=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__TryPut#2)/ */ Context_RadioTrackTrainMessageQueue__TryPut_2;
  outC__51_RadioTrackTrainMessageQue_RBC_Collections_Pkg /* MOVEMENT_AUTHORITY_SM:SEND_MA:_L30=(RBC_Collections_Pkg::RadioTrackTrainMessageQueueEntry__Create#2)/ */ _5_Context_RadioTrackTrainMessageQueueEntry__Create_2;
  ...
  outC_SessionManagement__SetPosData_RBC_Session_Pkg /* MOVEMENT_AUTHORITY_SM:UPDATE_POSITION:_L4=(RBC_Session_Pkg::SessionManagement__SetPosData#1)/ */ _6_Context_SessionManagement__SetPosData_1;
  ...
  outC_SessionManagement__GetPosData_RBC_Session_Pkg /* MOVEMENT_AUTHORITY_SM:UPDATE_POSITION:_L3=(RBC_Session_Pkg::SessionManagement__GetPosData#1)/ */ _7_Context_SessionManagement__GetPosData_1;
  outC__100_RadioTrainTrackHeade_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* _L94=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackHeader__Get_NID_MESSAGE#2)/ */ _8_Context_RadioTrainTrackHeader__Get_NID_MESSAGE_2;
  outC_RadioTrainTrackMessage__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg /* _L93=(RBC_Messaging_Pkg::RBC_RadioTrainTrack_Pkg::RadioTrainTrackMessage__GetHeader#5)/ */ _9_Context_RadioTrainTrackMessage__GetHeader_5;
  outC_RadioTrackTrainHeader__Ge_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* _L89=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_NID_MESSAGE#5)/ */ _10_Context_RadioTrackTrainHeader__Get_NID_MESSAGE_5;
  outC_RadioTrackTrainMessage__G_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg /* _L90=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainMessage__GetHeader#6)/ */ _11_Context_RadioTrackTrainMessage__GetHeader_6;
  ...
  _2_RadioTrackTrainMessageQueue_T /* MOVEMENT_AUTHORITY_SM:IDLE:_L3/ */ _L3_IDLE_MOVEMENT_AUTHORITY_SM;
  ...
  _2_RadioTrackTrainMessageQueue_T /* MOVEMENT_AUTHORITY_SM:SEND_MA:_L33/ */ _L33_SEND_MA_MOVEMENT_AUTHORITY_SM;
  CompressedRadioMessage_TM /* MOVEMENT_AUTHORITY_SM:SEND_MA:_L32/ */ _L32_SEND_MA_MOVEMENT_AUTHORITY_SM;
  _2_RadioTrackTrainMessageQueue_T /* MOVEMENT_AUTHORITY_SM:SEND_MA:_L29/ */ _L29_SEND_MA_MOVEMENT_AUTHORITY_SM;
  ...
  _2_RadioTrackTrainMessageQueue_T /* MOVEMENT_AUTHORITY_SM:AWAIT_ACKNOWLEDGEMENT:_L17/ */ _L17_AWAIT_ACKNOWLEDGEMENT_MOVEMENT_AUTHORITY_SM;
  ...
  _2_RadioTrackTrainMessageQueue_T /* MOVEMENT_AUTHORITY_SM:TRY_PROCESS_ACKNOWLEDGEMENT:_L33/ */ _L33_TRY_PROCESS_ACKNOWLEDGEMENT_MOVEMENT_AUTHORITY_SM;
  ...
  _2_RadioTrackTrainMessageQueue_T /* MOVEMENT_AUTHORITY_SM:AWAIT_MA:_L5/ */ _L5_AWAIT_MA_MOVEMENT_AUTHORITY_SM;
  ...
  _2_RadioTrackTrainMessageQueue_T /* MOVEMENT_AUTHORITY_SM:UPDATE_POSITION:_L9/ */ _L9_UPDATE_POSITION_MOVEMENT_AUTHORITY_SM;
  ...
  _2_RadioTrackTrainMessageQueue_T /* _L107/ */ _L107;
