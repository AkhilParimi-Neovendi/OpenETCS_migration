...
{
  /* q_length/ */
  Q_LENGTH q_length_partial;
  /* error/ */
  kcg_bool error_partial;
  /* q_length/ */
  Q_LENGTH _1_q_length_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* q_length/ */
  Q_LENGTH _3_q_length_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* q_length/ */
  Q_LENGTH _5_q_length_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* error/ */
  kcg_bool _7_error_partial;
  /* q_length/ */
  Q_LENGTH _8_q_length_partial;
  /* error/ */
  kcg_bool _9_error_partial;
  /* q_length/ */
  Q_LENGTH _10_q_length_partial;
  /* error/ */
  kcg_bool _11_error_partial;
  /* q_length/ */
  Q_LENGTH _12_q_length_partial;
  /* error/ */
  kcg_bool _13_error_partial;
  /* q_length/ */
  Q_LENGTH _14_q_length_partial;
  kcg_bool noname;
