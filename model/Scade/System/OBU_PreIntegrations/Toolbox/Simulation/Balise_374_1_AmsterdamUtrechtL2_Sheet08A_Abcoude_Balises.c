...
void Balise_374_1_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises(
  ...
  /* PIG_nom/ */
  kcg_int32 PIG_nom,
  outC_Balise_374_1_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises *outC)
{
  ...
  if (outC->every) {
    /* _L4=(AmsterdamUtrechtL2::Sheet08A_Abcoude_Balises::Packets_BG374#1)/ */
    Packets_BG374_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises(
      &outC->_L23,
      &outC->_L5,
      &outC->Context_Packets_BG374_1);
    kcg_copy_B_data_internal_T_InfraLib(
      &op_call,
      &outC->Context_Packets_BG374_1.Balise_data_out);
...
void Balise_374_1_init_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises(
  outC_Balise_374_1_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L4=(AmsterdamUtrechtL2::Sheet08A_Abcoude_Balises::Packets_BG374#1)/ */
  Packets_BG374_init_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises(
    &outC->Context_Packets_BG374_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
...
void Balise_374_1_reset_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises(
  outC_Balise_374_1_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises *outC)
{
  /* _L4=(AmsterdamUtrechtL2::Sheet08A_Abcoude_Balises::Packets_BG374#1)/ */
  Packets_BG374_reset_AmsterdamUtrechtL2_Sheet08A_Abcoude_Balises(
    &outC->Context_Packets_BG374_1);
  /* _L21=(InfraLib::Balise_Localisation#1)/ */
