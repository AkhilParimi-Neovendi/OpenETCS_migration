...
#include "_147_RadioTrackTrainMessa_RBC_Collections_Pkg.h"

/* RBC_Collections_Pkg::RadioTrackTrainMessageQueue__Take/ */
void _147_RadioTrackTrainMessa_RBC_Collections_Pkg(
  ...
  outC__147_RadioTrackTrainMessa_RBC_Collections_Pkg *outC)
{
  ...
  _2_RadioTrackTrainMessageQueue_T outRadioTrackTrainMessageQueue_partial;
  /* outRadioTrackTrainMessageQueueEntry/ */
  RadioTrackTrainMessageQueueEntry_T outRadioTrackTrainMessageQueueEntry_partial;
  /* outRadioTrackTrainMessageQueue/ */
  _2_RadioTrackTrainMessageQueue_T _5_outRadioTrackTrainMessageQueue_partial;
  /* outRadioTrackTrainMessageQueueEntry/ */
  RadioTrackTrainMessageQueueEntry_T _6_outRadioTrackTrainMessageQueueEntry_partial;
  kcg_int64 noname;
  /* outRadioTrackTrainMessageQueueEntry/ */
  RadioTrackTrainMessageQueueEntry_T _7_outRadioTrackTrainMessageQueueEntry_partial;
  /* outRadioTrackTrainMessageQueue/ */
  _2_RadioTrackTrainMessageQueue_T _8_outRadioTrackTrainMessageQueue_partial;
  /* outRadioTrackTrainMessageQueueEntry/ */
  RadioTrackTrainMessageQueueEntry_T _9_outRadioTrackTrainMessageQueueEntry_partial;
  /* outRadioTrackTrainMessageQueue/ */
  _2_RadioTrackTrainMessageQueue_T _10_outRadioTrackTrainMessageQueue_partial;
  ...
  _48_RadioTrackTrainMessageQue_RBC_Collections_Pkg(
    &outC->_L1,
    &outC->_6_Context_RadioTrackTrainMessageQueue__GetRemainingCapacity_1);
  outC->_L2 =
    outC->_6_Context_RadioTrackTrainMessageQueue__GetRemainingCapacity_1.outRemainingCapacity;
  outC->remainingCapacity = outC->_L2;
  outC->IfBlock1_clock = outC->remainingCapacity == kcg_lit_int64(0);
  /* IfBlock1: */
  if (outC->IfBlock1_clock) {
    ...
    RadioTrackTrainMessageQue_RBC_Collections_Pkg(
      &outC->_L1_then_IfBlock1,
      &outC->_1_Context_RadioTrackTrainMessageQueue__GetEntries_2);
    kcg_copy__3_RadioTrackTrainMessageQueueEntries_T(
      &outC->_L2_then_IfBlock1,
      &outC->_1_Context_RadioTrackTrainMessageQueue__GetEntries_2.outRadioTrackTrainMessageQueueEntries);
    ...
    _49_RadioTrackTrainMessageQue_RBC_Collections_Pkg(
    ...
    outC->_L5_then_IfBlock1 = RADIO_TRACK_TRAIN_MESSAGE_QUEUE_CAPACITY -
      kcg_lit_int64(1);
    if ((kcg_lit_int64(0) <= outC->_L5_then_IfBlock1) &
      (outC->_L5_then_IfBlock1 < kcg_lit_int64(8))) {
      kcg_copy_RadioTrackTrainMessageQueueEntry_T(
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      RadioTrackTrainMessageQue_RBC_Collections_Pkg(
        &outC->_L7_else_else_IfBlock1,
        &outC->_5_Context_RadioTrackTrainMessageQueue__GetEntries_4);
      kcg_copy__3_RadioTrackTrainMessageQueueEntries_T(
        &outC->_L3_else_else_IfBlock1,
        &outC->_5_Context_RadioTrackTrainMessageQueue__GetEntries_4.outRadioTrackTrainMessageQueueEntries);
      for (idx = 0; idx < 8; idx++) {
        kcg_copy_RadioTrackTrainMessageQueueEntry_T(
      ...
      if (outC->_L6_else_else_IfBlock1) {
        ...
        for (idx1 = 0; idx1 < 8; idx1++) {
          ...
          _146_RadioTrackTrainMessa_RBC_Collections_Pkg(
            /* IfBlock1:else:else:_L14= */(kcg_int64) idx1,
            acc,
            &outC->_L1_else_else_IfBlock1[idx1],
            &outC->_4_Context_RadioTrackTrainMessageQueue__Take_Iterable_2[idx1]);
          outC->_L15_else_else_IfBlock1 =
            outC->_4_Context_RadioTrackTrainMessageQueue__Take_Iterable_2[idx1].outAccumulator;
          outC->_L14_else_else_IfBlock1 =
            /* IfBlock1:else:else:_L14= */(kcg_int64) (idx1 + 1);
          /* IfBlock1:else:else:_L14= */
          if (!outC->_4_Context_RadioTrackTrainMessageQueue__Take_Iterable_2[idx1].outContinueIteration) {
            break;
          }
        }
      }
      else {
        outC->_L14_else_else_IfBlock1 = kcg_lit_int64(0);
      }
      ...
      for (idx3 = 0; idx3 < 8; idx3++) {
        ...
        _145_RadioTrackTrainMessa_RBC_Collections_Pkg(
          /* IfBlock1:else:else:_L9= */(kcg_int64) idx3,
          outC->_L4_else_else_IfBlock1[idx3],
          &outC->_L1_else_else_IfBlock1[idx3],
          &outC->_3_Context_RadioTrackTrainMessageQueue__Take_Iterable2_2[idx3]);
        kcg_copy_RadioTrackTrainMessageQueueEntry_T(
          &outC->_L9_else_else_IfBlock1[idx3],
          &outC->_3_Context_RadioTrackTrainMessageQueue__Take_Iterable2_2[idx3].outRadioTrackTrainMessageQueueEntry);
      }
      ...
      _49_RadioTrackTrainMessageQue_RBC_Collections_Pkg(
        ...
        &outC->_2_Context_RadioTrackTrainMessageQueue__SetEntries_3);
      kcg_copy__2_RadioTrackTrainMessageQueue_T(
        &outC->_L11_else_else_IfBlock1,
        &outC->_2_Context_RadioTrackTrainMessageQueue__SetEntries_3.out_RadioTrackTrainMessageQueue);
      outC->_L2_else_else_IfBlock1 = outC->foundIndex_else_else_IfBlock1;
      if ((kcg_lit_int64(0) <= outC->_L2_else_else_IfBlock1) &
        (outC->_L2_else_else_IfBlock1 < kcg_lit_int64(8))) {
        kcg_copy_RadioTrackTrainMessageQueueEntry_T(
...
void _147_RadioTrackTrainMessa_init_RBC_Collections_Pkg(
  outC__147_RadioTrackTrainMessa_RBC_Collections_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx4 = 0; idx4 < 8; idx4++) {
    ...
    outC->_L1.m_Entries[idx4].m_Entry.Header.radioDevice = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx4].m_Entry.Header.receivedSystemTime = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx4].m_Entry.Header.nid_message = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx4].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx4].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx4].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx4].m_Entry.Header.t_train_reference = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx4].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx4].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx4].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx4].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx4].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx4].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx4].m_Entry.Header.d_emergencystop = kcg_lit_int64(0);
    outC->_L1.m_Entries[idx4].m_Entry.Header.m_version = kcg_lit_int64(0);
    ...
    for (idx3 = 0; idx3 < 500; idx3++) {
      outC->_L1.m_Entries[idx4].m_Entry.Messages.PacketData[idx3] = kcg_lit_int64(0);
    }
  }
  outC->remainingCapacity = kcg_lit_int64(0);
  outC->IfBlock1_clock = kcg_true;
  outC->_L24_then_else_IfBlock1.m_IsValid = kcg_true;
  outC->_L24_then_else_IfBlock1.m_Entry.Header.radioDevice = kcg_lit_int64(0);
  outC->_L24_then_else_IfBlock1.m_Entry.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L24_then_else_IfBlock1.m_Entry.Header.nid_message = kcg_lit_int64(0);
  outC->_L24_then_else_IfBlock1.m_Entry.Header.t_train = kcg_lit_int64(0);
  outC->_L24_then_else_IfBlock1.m_Entry.Header.m_ack = kcg_lit_int64(0);
  outC->_L24_then_else_IfBlock1.m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L24_then_else_IfBlock1.m_Entry.Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L24_then_else_IfBlock1.m_Entry.Header.nid_em = kcg_lit_int64(0);
  outC->_L24_then_else_IfBlock1.m_Entry.Header.q_scale = kcg_lit_int64(0);
  outC->_L24_then_else_IfBlock1.m_Entry.Header.d_sr = kcg_lit_int64(0);
  outC->_L24_then_else_IfBlock1.m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L24_then_else_IfBlock1.m_Entry.Header.d_ref = kcg_lit_int64(0);
  outC->_L24_then_else_IfBlock1.m_Entry.Header.q_dir = kcg_lit_int64(0);
  outC->_L24_then_else_IfBlock1.m_Entry.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L24_then_else_IfBlock1.m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  for (idx12 = 0; idx12 < 8; idx12++) {
    ...
    outC->_L1_else_else_IfBlock1[idx12].m_Entry.Header.nid_message =
      kcg_lit_int64(0);
    outC->_L1_else_else_IfBlock1[idx12].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L1_else_else_IfBlock1[idx12].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L1_else_else_IfBlock1[idx12].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L1_else_else_IfBlock1[idx12].m_Entry.Header.t_train_reference =
      kcg_lit_int64(0);
    outC->_L1_else_else_IfBlock1[idx12].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L1_else_else_IfBlock1[idx12].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L1_else_else_IfBlock1[idx12].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L1_else_else_IfBlock1[idx12].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L1_else_else_IfBlock1[idx12].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L1_else_else_IfBlock1[idx12].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L1_else_else_IfBlock1[idx12].m_Entry.Header.d_emergencystop =
      kcg_lit_int64(0);
    outC->_L1_else_else_IfBlock1[idx12].m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  for (idx15 = 0; idx15 < 8; idx15++) {
    ...
    outC->_L3_else_else_IfBlock1[idx15].m_Entry.Header.nid_message =
      kcg_lit_int64(0);
    outC->_L3_else_else_IfBlock1[idx15].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L3_else_else_IfBlock1[idx15].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L3_else_else_IfBlock1[idx15].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L3_else_else_IfBlock1[idx15].m_Entry.Header.t_train_reference =
      kcg_lit_int64(0);
    outC->_L3_else_else_IfBlock1[idx15].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L3_else_else_IfBlock1[idx15].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L3_else_else_IfBlock1[idx15].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L3_else_else_IfBlock1[idx15].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L3_else_else_IfBlock1[idx15].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L3_else_else_IfBlock1[idx15].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L3_else_else_IfBlock1[idx15].m_Entry.Header.d_emergencystop =
      kcg_lit_int64(0);
    outC->_L3_else_else_IfBlock1[idx15].m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  for (idx16 = 0; idx16 < 8; idx16++) {
    outC->_L4_else_else_IfBlock1[idx16] = kcg_lit_int64(0);
  }
  outC->_L5_else_else_IfBlock1 = kcg_lit_int64(0);
  outC->_L6_else_else_IfBlock1 = kcg_true;
  ...
  for (idx22 = 0; idx22 < 8; idx22++) {
    ...
    outC->_L8_else_else_IfBlock1[idx22].m_Entry.Header.nid_message =
      kcg_lit_int64(0);
    outC->_L8_else_else_IfBlock1[idx22].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L8_else_else_IfBlock1[idx22].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L8_else_else_IfBlock1[idx22].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L8_else_else_IfBlock1[idx22].m_Entry.Header.t_train_reference =
      kcg_lit_int64(0);
    outC->_L8_else_else_IfBlock1[idx22].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L8_else_else_IfBlock1[idx22].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L8_else_else_IfBlock1[idx22].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L8_else_else_IfBlock1[idx22].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L8_else_else_IfBlock1[idx22].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L8_else_else_IfBlock1[idx22].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L8_else_else_IfBlock1[idx22].m_Entry.Header.d_emergencystop =
      kcg_lit_int64(0);
    outC->_L8_else_else_IfBlock1[idx22].m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  for (idx25 = 0; idx25 < 8; idx25++) {
    ...
    outC->_L9_else_else_IfBlock1[idx25].m_Entry.Header.nid_message =
      kcg_lit_int64(0);
    outC->_L9_else_else_IfBlock1[idx25].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L9_else_else_IfBlock1[idx25].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L9_else_else_IfBlock1[idx25].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L9_else_else_IfBlock1[idx25].m_Entry.Header.t_train_reference =
      kcg_lit_int64(0);
    outC->_L9_else_else_IfBlock1[idx25].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L9_else_else_IfBlock1[idx25].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L9_else_else_IfBlock1[idx25].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L9_else_else_IfBlock1[idx25].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L9_else_else_IfBlock1[idx25].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L9_else_else_IfBlock1[idx25].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L9_else_else_IfBlock1[idx25].m_Entry.Header.d_emergencystop =
      kcg_lit_int64(0);
    outC->_L9_else_else_IfBlock1[idx25].m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L10_else_else_IfBlock1.m_Entry.Header.radioDevice = kcg_lit_int64(0);
  outC->_L10_else_else_IfBlock1.m_Entry.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L10_else_else_IfBlock1.m_Entry.Header.nid_message = kcg_lit_int64(0);
  outC->_L10_else_else_IfBlock1.m_Entry.Header.t_train = kcg_lit_int64(0);
  outC->_L10_else_else_IfBlock1.m_Entry.Header.m_ack = kcg_lit_int64(0);
  outC->_L10_else_else_IfBlock1.m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L10_else_else_IfBlock1.m_Entry.Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L10_else_else_IfBlock1.m_Entry.Header.nid_em = kcg_lit_int64(0);
  outC->_L10_else_else_IfBlock1.m_Entry.Header.q_scale = kcg_lit_int64(0);
  outC->_L10_else_else_IfBlock1.m_Entry.Header.d_sr = kcg_lit_int64(0);
  outC->_L10_else_else_IfBlock1.m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L10_else_else_IfBlock1.m_Entry.Header.d_ref = kcg_lit_int64(0);
  outC->_L10_else_else_IfBlock1.m_Entry.Header.q_dir = kcg_lit_int64(0);
  outC->_L10_else_else_IfBlock1.m_Entry.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L10_else_else_IfBlock1.m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L12_else_else_IfBlock1.m_Entry.Header.radioDevice = kcg_lit_int64(0);
  outC->_L12_else_else_IfBlock1.m_Entry.Header.receivedSystemTime =
    kcg_lit_int64(0);
  outC->_L12_else_else_IfBlock1.m_Entry.Header.nid_message = kcg_lit_int64(0);
  outC->_L12_else_else_IfBlock1.m_Entry.Header.t_train = kcg_lit_int64(0);
  outC->_L12_else_else_IfBlock1.m_Entry.Header.m_ack = kcg_lit_int64(0);
  outC->_L12_else_else_IfBlock1.m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L12_else_else_IfBlock1.m_Entry.Header.t_train_reference =
    kcg_lit_int64(0);
  outC->_L12_else_else_IfBlock1.m_Entry.Header.nid_em = kcg_lit_int64(0);
  outC->_L12_else_else_IfBlock1.m_Entry.Header.q_scale = kcg_lit_int64(0);
  outC->_L12_else_else_IfBlock1.m_Entry.Header.d_sr = kcg_lit_int64(0);
  outC->_L12_else_else_IfBlock1.m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L12_else_else_IfBlock1.m_Entry.Header.d_ref = kcg_lit_int64(0);
  outC->_L12_else_else_IfBlock1.m_Entry.Header.q_dir = kcg_lit_int64(0);
  outC->_L12_else_else_IfBlock1.m_Entry.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L12_else_else_IfBlock1.m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L15_else_else_IfBlock1 = kcg_lit_int64(0);
  outC->_L14_else_else_IfBlock1 = kcg_lit_int64(0);
  outC->foundIndex_else_else_IfBlock1 = kcg_lit_int64(0);
  ...
  for (idx35 = 0; idx35 < 8; idx35++) {
    ...
    outC->_L1_then_IfBlock1.m_Entries[idx35].m_Entry.Header.q_scale =
      kcg_lit_int64(0);
    outC->_L1_then_IfBlock1.m_Entries[idx35].m_Entry.Header.d_sr = kcg_lit_int64(0);
  ...
  for (idx38 = 0; idx38 < 8; idx38++) {
    ...
    outC->_L2_then_IfBlock1[idx38].m_Entry.Header.radioDevice = kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx38].m_Entry.Header.receivedSystemTime =
      kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx38].m_Entry.Header.nid_message = kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx38].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx38].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx38].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx38].m_Entry.Header.t_train_reference =
      kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx38].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx38].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx38].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx38].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx38].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx38].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx38].m_Entry.Header.d_emergencystop =
      kcg_lit_int64(0);
    outC->_L2_then_IfBlock1[idx38].m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  for (idx41 = 0; idx41 < 7; idx41++) {
    ...
    outC->_L3_then_IfBlock1[idx41].m_Entry.Header.radioDevice = kcg_lit_int64(0);
    outC->_L3_then_IfBlock1[idx41].m_Entry.Header.receivedSystemTime =
      kcg_lit_int64(0);
    outC->_L3_then_IfBlock1[idx41].m_Entry.Header.nid_message = kcg_lit_int64(0);
    outC->_L3_then_IfBlock1[idx41].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L3_then_IfBlock1[idx41].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L3_then_IfBlock1[idx41].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L3_then_IfBlock1[idx41].m_Entry.Header.t_train_reference =
      kcg_lit_int64(0);
    outC->_L3_then_IfBlock1[idx41].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L3_then_IfBlock1[idx41].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L3_then_IfBlock1[idx41].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L3_then_IfBlock1[idx41].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L3_then_IfBlock1[idx41].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L3_then_IfBlock1[idx41].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L3_then_IfBlock1[idx41].m_Entry.Header.d_emergencystop =
      kcg_lit_int64(0);
    outC->_L3_then_IfBlock1[idx41].m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L4_then_IfBlock1.m_Entry.Header.radioDevice = kcg_lit_int64(0);
  outC->_L4_then_IfBlock1.m_Entry.Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L4_then_IfBlock1.m_Entry.Header.nid_message = kcg_lit_int64(0);
  outC->_L4_then_IfBlock1.m_Entry.Header.t_train = kcg_lit_int64(0);
  outC->_L4_then_IfBlock1.m_Entry.Header.m_ack = kcg_lit_int64(0);
  outC->_L4_then_IfBlock1.m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L4_then_IfBlock1.m_Entry.Header.t_train_reference = kcg_lit_int64(0);
  outC->_L4_then_IfBlock1.m_Entry.Header.nid_em = kcg_lit_int64(0);
  outC->_L4_then_IfBlock1.m_Entry.Header.q_scale = kcg_lit_int64(0);
  outC->_L4_then_IfBlock1.m_Entry.Header.d_sr = kcg_lit_int64(0);
  outC->_L4_then_IfBlock1.m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L4_then_IfBlock1.m_Entry.Header.d_ref = kcg_lit_int64(0);
  outC->_L4_then_IfBlock1.m_Entry.Header.q_dir = kcg_lit_int64(0);
  outC->_L4_then_IfBlock1.m_Entry.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L4_then_IfBlock1.m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  for (idx43 = 0; idx43 < 500; idx43++) {
    outC->_L4_then_IfBlock1.m_Entry.Messages.PacketData[idx43] = kcg_lit_int64(0);
  }
  outC->_L5_then_IfBlock1 = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.m_IsValid = kcg_true;
  outC->_L6_then_IfBlock1.m_Entry.Header.radioDevice = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.m_Entry.Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.m_Entry.Header.nid_message = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.m_Entry.Header.t_train = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.m_Entry.Header.m_ack = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.m_Entry.Header.t_train_reference = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.m_Entry.Header.nid_em = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.m_Entry.Header.q_scale = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.m_Entry.Header.d_sr = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.m_Entry.Header.d_ref = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.m_Entry.Header.q_dir = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.m_Entry.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L6_then_IfBlock1.m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  for (idx45 = 0; idx45 < 500; idx45++) {
    outC->_L6_then_IfBlock1.m_Entry.Messages.PacketData[idx45] = kcg_lit_int64(0);
  }
  for (idx48 = 0; idx48 < 8; idx48++) {
    outC->_L7_then_IfBlock1[idx48].m_IsValid = kcg_true;
    outC->_L7_then_IfBlock1[idx48].m_Entry.Header.radioDevice = kcg_lit_int64(0);
    outC->_L7_then_IfBlock1[idx48].m_Entry.Header.receivedSystemTime =
      kcg_lit_int64(0);
    outC->_L7_then_IfBlock1[idx48].m_Entry.Header.nid_message = kcg_lit_int64(0);
    outC->_L7_then_IfBlock1[idx48].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L7_then_IfBlock1[idx48].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L7_then_IfBlock1[idx48].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L7_then_IfBlock1[idx48].m_Entry.Header.t_train_reference =
      kcg_lit_int64(0);
    outC->_L7_then_IfBlock1[idx48].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L7_then_IfBlock1[idx48].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L7_then_IfBlock1[idx48].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L7_then_IfBlock1[idx48].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L7_then_IfBlock1[idx48].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L7_then_IfBlock1[idx48].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L7_then_IfBlock1[idx48].m_Entry.Header.d_emergencystop =
      kcg_lit_int64(0);
    outC->_L7_then_IfBlock1[idx48].m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  outC->_L8_then_IfBlock1.m_Entry.Header.radioDevice = kcg_lit_int64(0);
  outC->_L8_then_IfBlock1.m_Entry.Header.receivedSystemTime = kcg_lit_int64(0);
  outC->_L8_then_IfBlock1.m_Entry.Header.nid_message = kcg_lit_int64(0);
  outC->_L8_then_IfBlock1.m_Entry.Header.t_train = kcg_lit_int64(0);
  outC->_L8_then_IfBlock1.m_Entry.Header.m_ack = kcg_lit_int64(0);
  outC->_L8_then_IfBlock1.m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
  outC->_L8_then_IfBlock1.m_Entry.Header.t_train_reference = kcg_lit_int64(0);
  outC->_L8_then_IfBlock1.m_Entry.Header.nid_em = kcg_lit_int64(0);
  outC->_L8_then_IfBlock1.m_Entry.Header.q_scale = kcg_lit_int64(0);
  outC->_L8_then_IfBlock1.m_Entry.Header.d_sr = kcg_lit_int64(0);
  outC->_L8_then_IfBlock1.m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
  outC->_L8_then_IfBlock1.m_Entry.Header.d_ref = kcg_lit_int64(0);
  outC->_L8_then_IfBlock1.m_Entry.Header.q_dir = kcg_lit_int64(0);
  outC->_L8_then_IfBlock1.m_Entry.Header.d_emergencystop = kcg_lit_int64(0);
  outC->_L8_then_IfBlock1.m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  for (idx50 = 0; idx50 < 500; idx50++) {
    outC->_L8_then_IfBlock1.m_Entry.Messages.PacketData[idx50] = kcg_lit_int64(0);
  }
  for (idx53 = 0; idx53 < 1; idx53++) {
    outC->_L9_then_IfBlock1[idx53].m_IsValid = kcg_true;
    outC->_L9_then_IfBlock1[idx53].m_Entry.Header.radioDevice = kcg_lit_int64(0);
    outC->_L9_then_IfBlock1[idx53].m_Entry.Header.receivedSystemTime =
      kcg_lit_int64(0);
    outC->_L9_then_IfBlock1[idx53].m_Entry.Header.nid_message = kcg_lit_int64(0);
    outC->_L9_then_IfBlock1[idx53].m_Entry.Header.t_train = kcg_lit_int64(0);
    outC->_L9_then_IfBlock1[idx53].m_Entry.Header.m_ack = kcg_lit_int64(0);
    outC->_L9_then_IfBlock1[idx53].m_Entry.Header.nid_lrbg = kcg_lit_int64(0);
    outC->_L9_then_IfBlock1[idx53].m_Entry.Header.t_train_reference =
      kcg_lit_int64(0);
    outC->_L9_then_IfBlock1[idx53].m_Entry.Header.nid_em = kcg_lit_int64(0);
    outC->_L9_then_IfBlock1[idx53].m_Entry.Header.q_scale = kcg_lit_int64(0);
    outC->_L9_then_IfBlock1[idx53].m_Entry.Header.d_sr = kcg_lit_int64(0);
    outC->_L9_then_IfBlock1[idx53].m_Entry.Header.t_sh_rqst = kcg_lit_int64(0);
    outC->_L9_then_IfBlock1[idx53].m_Entry.Header.d_ref = kcg_lit_int64(0);
    outC->_L9_then_IfBlock1[idx53].m_Entry.Header.q_dir = kcg_lit_int64(0);
    outC->_L9_then_IfBlock1[idx53].m_Entry.Header.d_emergencystop =
      kcg_lit_int64(0);
    outC->_L9_then_IfBlock1[idx53].m_Entry.Header.m_version = kcg_lit_int64(0);
  ...
  /* IfBlock1:then:_L10=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__SetEntries#1)/ */
  _49_RadioTrackTrainMessageQue_init_RBC_Collections_Pkg(
    &outC->Context_RadioTrackTrainMessageQueue__SetEntries_1);
  /* IfBlock1:then:_L2=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__GetEntries#2)/ */
  ...
  for (idx1 = 0; idx1 < 8; idx1++) {
    /* IfBlock1:else:else:_L9=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__Take_Iterable2#2)/ */
    _145_RadioTrackTrainMessa_init_RBC_Collections_Pkg(
      &outC->_3_Context_RadioTrackTrainMessageQueue__Take_Iterable2_2[idx1]);
  }
  for (idx = 0; idx < 8; idx++) {
    /* IfBlock1:else:else:_L14=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__Take_Iterable#2)/ */
    _146_RadioTrackTrainMessa_init_RBC_Collections_Pkg(
      &outC->_4_Context_RadioTrackTrainMessageQueue__Take_Iterable_2[idx]);
  }
  /* IfBlock1:else:else:_L3=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__GetEntries#4)/ */
  RadioTrackTrainMessageQue_init_RBC_Collections_Pkg(
    &outC->_5_Context_RadioTrackTrainMessageQueue__GetEntries_4);
...
void _147_RadioTrackTrainMessa_reset_RBC_Collections_Pkg(
  outC__147_RadioTrackTrainMessa_RBC_Collections_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* IfBlock1:then:_L10=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__SetEntries#1)/ */
  _49_RadioTrackTrainMessageQue_reset_RBC_Collections_Pkg(
    &outC->Context_RadioTrackTrainMessageQueue__SetEntries_1);
  /* IfBlock1:then:_L2=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__GetEntries#2)/ */
  ...
  for (idx1 = 0; idx1 < 8; idx1++) {
    /* IfBlock1:else:else:_L9=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__Take_Iterable2#2)/ */
    _145_RadioTrackTrainMessa_reset_RBC_Collections_Pkg(
      &outC->_3_Context_RadioTrackTrainMessageQueue__Take_Iterable2_2[idx1]);
  }
  for (idx = 0; idx < 8; idx++) {
    /* IfBlock1:else:else:_L14=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__Take_Iterable#2)/ */
    _146_RadioTrackTrainMessa_reset_RBC_Collections_Pkg(
      &outC->_4_Context_RadioTrackTrainMessageQueue__Take_Iterable_2[idx]);
  }
  /* IfBlock1:else:else:_L3=(RBC_Collections_Pkg::RadioTrackTrainMessageQueue__GetEntries#4)/ */
  RadioTrackTrainMessageQue_reset_RBC_Collections_Pkg(
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _147_RadioTrackTrainMessa_RBC_Collections_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
