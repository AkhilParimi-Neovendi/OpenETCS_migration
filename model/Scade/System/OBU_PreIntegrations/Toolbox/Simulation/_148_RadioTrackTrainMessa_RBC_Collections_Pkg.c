...
void _148_RadioTrackTrainMessa_RBC_Collections_Pkg(
...
void _148_RadioTrackTrainMessa_init_RBC_Collections_Pkg(
  outC__148_RadioTrackTrainMessa_RBC_Collections_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L1.m_Entry.Messages.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    ...
    outC->_L1.m_Entry.Messages.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L1.m_Entry.Messages.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L1.m_Entry.Messages.PacketData[idx3] = kcg_lit_int32(0);
  }
...
void _148_RadioTrackTrainMessa_reset_RBC_Collections_Pkg(
  outC__148_RadioTrackTrainMessa_RBC_Collections_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _148_RadioTrackTrainMessa_RBC_Collections_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
