...
void RadioTrackTrainMessage__I_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg(
...
void RadioTrackTrainMessage__I_init_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg(
  outC_RadioTrackTrainMessage__I_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  outC->_L2.radioDevice = kcg_lit_int64(0);
  outC->_L2.receivedSystemTime = kcg_lit_int64(0);
  outC->_L2.nid_message = kcg_lit_int64(0);
  outC->_L2.t_train = kcg_lit_int64(0);
  outC->_L2.m_ack = kcg_lit_int64(0);
  outC->_L2.nid_lrbg = kcg_lit_int64(0);
  outC->_L2.t_train_reference = kcg_lit_int64(0);
  outC->_L2.nid_em = kcg_lit_int64(0);
  outC->_L2.q_scale = kcg_lit_int64(0);
  outC->_L2.d_sr = kcg_lit_int64(0);
  outC->_L2.t_sh_rqst = kcg_lit_int64(0);
  outC->_L2.d_ref = kcg_lit_int64(0);
  outC->_L2.q_dir = kcg_lit_int64(0);
  outC->_L2.d_emergencystop = kcg_lit_int64(0);
  outC->_L2.m_version = kcg_lit_int64(0);
...
void RadioTrackTrainMessage__I_reset_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg(
  outC_RadioTrackTrainMessage__I_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg *outC)
{
  /* _L3=(RBC_Messaging_Pkg::RBC_RadioTrackTrain_Pkg::RadioTrackTrainHeader__Get_NID_MESSAGE#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** RadioTrackTrainMessage__I_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
