...
typedef struct {
  ...
  kcg_int64 /* n_iter_k_out/ */ n_iter_k_out;
  kcg_int64 /* meta_first_section/ */ meta_first_section;
  Q_DIR /* q_dir/ */ q_dir;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  outC_T_Build_Metadata_Packet_ID_TM_lib_internal /* _L405=(TM_lib_internal::T_Build_Metadata_Packet_ID#3)/ */ _1_Context_T_Build_Metadata_Packet_ID_3;
  ...
  kcg_bool /* @1/IfBlock1:else: */ _2_else_clock_CAST_Int_to_Q_DIR_1_IfBlock1;
  /* -------------------- (-debug) no assertions  -------------------- */
