...
{
  /* m_loc_int/ */
  kcg_int64 m_loc_int_partial;
  /* error/ */
  kcg_bool error_partial;
  /* m_loc_int/ */
  kcg_int64 _1_m_loc_int_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* m_loc_int/ */
  kcg_int64 _3_m_loc_int_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* m_loc_int/ */
  kcg_int64 _5_m_loc_int_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* error/ */
  kcg_bool _7_error_partial;
  /* m_loc_int/ */
  kcg_int64 _8_m_loc_int_partial;
  /* error/ */
  kcg_bool _9_error_partial;
  /* m_loc_int/ */
  kcg_int64 _10_m_loc_int_partial;
  kcg_bool noname;
