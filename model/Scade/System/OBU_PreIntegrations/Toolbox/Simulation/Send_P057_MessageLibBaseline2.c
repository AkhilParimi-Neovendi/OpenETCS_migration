...
void Send_P057_init_MessageLibBaseline2(
  outC_Send_P057_MessageLibBaseline2 *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void Send_P057_reset_MessageLibBaseline2(
  outC_Send_P057_MessageLibBaseline2 *outC)
{
  /* _L6=(TM_trackside::Write_P057#1)/ */
