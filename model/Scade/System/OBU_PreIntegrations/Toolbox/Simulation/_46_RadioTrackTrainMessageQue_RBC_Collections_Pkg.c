...
void _46_RadioTrackTrainMessageQue_RBC_Collections_Pkg(
...
void _46_RadioTrackTrainMessageQue_init_RBC_Collections_Pkg(
  outC__46_RadioTrackTrainMessageQue_RBC_Collections_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void _46_RadioTrackTrainMessageQue_reset_RBC_Collections_Pkg(
  outC__46_RadioTrackTrainMessageQue_RBC_Collections_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _46_RadioTrackTrainMessageQue_RBC_Collections_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
