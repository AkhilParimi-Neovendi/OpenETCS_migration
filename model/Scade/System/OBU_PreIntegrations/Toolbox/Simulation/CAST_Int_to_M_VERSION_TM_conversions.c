...
{
  /* m_version/ */
  M_VERSION m_version_partial;
  /* error/ */
  kcg_bool error_partial;
  /* m_version/ */
  M_VERSION _1_m_version_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* m_version/ */
  M_VERSION _3_m_version_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* m_version/ */
  M_VERSION _5_m_version_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* error/ */
  kcg_bool _7_error_partial;
  /* m_version/ */
  M_VERSION _8_m_version_partial;
  /* error/ */
  kcg_bool _9_error_partial;
  /* m_version/ */
  M_VERSION _10_m_version_partial;
  /* error/ */
  kcg_bool _11_error_partial;
  /* m_version/ */
  M_VERSION _12_m_version_partial;
  /* error/ */
  kcg_bool _13_error_partial;
  /* m_version/ */
  M_VERSION _14_m_version_partial;
  kcg_bool noname;
  ...
  outC_CAST_Int_to_M_VERSION_TM_conversions *outC)
{
  ...
  outC->error = kcg_true;
  outC->m_version_in = kcg_lit_int64(0);
