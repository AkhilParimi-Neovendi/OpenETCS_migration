...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P027V1_fs_flatten_array_TM_lib_internal /* _L83=(TM_lib_internal::C_P027V1_fs_flatten_array_qdiff#1)/ */ Context_C_P027V1_fs_flatten_array_qdiff_1[32];
  outC_C_P027V1_fs_struct_to_arr_TM_lib_internal /* _L74=(TM_lib_internal::C_P027V1_fs_struct_to_array_qdiff#1)/ */ Context_C_P027V1_fs_struct_to_array_qdiff_1[32];
  /* ----------------- no clocks of observable data ------------------ */
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  P027V1_sections_array_flat_qdiff_T_TM_baseline2 /* _L76/ */ _L76;
  _6_P027V1_OBU_sectionlist_int_qdiff_T_TM_baseline2 /* _L75/ */ _L75;
