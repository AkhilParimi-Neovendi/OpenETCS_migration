  ...
  outC__57_RadioTrainTrackPackets__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
  ...
  outC->outRadioTrainTrackPacket.packet1.NID_PACKET = kcg_lit_int64(0);
  outC->outRadioTrainTrackPacket.packet1.L_PACKET = kcg_lit_int64(0);
  outC->outRadioTrainTrackPacket.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->outRadioTrainTrackPacket.packet1.NID_LRBG = kcg_lit_int64(0);
  outC->outRadioTrainTrackPacket.packet1.NID_PRVLRBG = kcg_lit_int64(0);
  outC->outRadioTrainTrackPacket.packet1.D_LRBG = kcg_lit_int64(0);
  ...
  outC->outRadioTrainTrackPacket.packet1.L_DOUBTOVER = kcg_lit_int64(0);
  outC->outRadioTrainTrackPacket.packet1.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->outRadioTrainTrackPacket.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->outRadioTrainTrackPacket.packet1.L_TRAININT = kcg_lit_int64(0);
  outC->outRadioTrainTrackPacket.packet1.V_TRAIN = kcg_lit_int64(0);
  ...
  outC->outRadioTrainTrackPacket.packet1.NID_NTC = kcg_lit_int64(0);
}
