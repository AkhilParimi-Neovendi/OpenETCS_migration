...
void _57_RadioTrainTrackPackets__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
  /* inRadioTrainTrackPackets/ */
  outPackets_T_Common_Types_Pkg *inRadioTrainTrackPackets,
  outC__57_RadioTrainTrackPackets__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
...
void _57_RadioTrainTrackPackets__G_init_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
  outC__57_RadioTrainTrackPackets__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  outC->outRadioTrainTrackPacket.packet1.NID_PACKET = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.packet1.L_PACKET = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->outRadioTrainTrackPacket.packet1.NID_LRBG = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.packet1.NID_PRVLRBG = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.packet1.D_LRBG = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->outRadioTrainTrackPacket.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->outRadioTrainTrackPacket.packet1.L_DOUBTOVER = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.packet1.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.packet1.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->outRadioTrainTrackPacket.packet1.L_TRAININT = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.packet1.V_TRAIN = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.packet1.dirtrain = Q_DIRTRAIN_Reverse;
  outC->outRadioTrainTrackPacket.packet1.mode = M_MODE_Full_Supervision;
  outC->outRadioTrainTrackPacket.packet1.level = M_LEVEL_Level_0;
  outC->outRadioTrainTrackPacket.packet1.NID_NTC = kcg_lit_int32(0);
}
#endif /* KCG_USER_DEFINED_INIT */


void _57_RadioTrainTrackPackets__G_reset_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
  outC__57_RadioTrainTrackPackets__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _57_RadioTrainTrackPackets__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
