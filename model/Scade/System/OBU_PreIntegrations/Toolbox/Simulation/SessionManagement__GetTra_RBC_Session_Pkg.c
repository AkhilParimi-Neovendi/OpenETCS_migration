...
#include "SessionManagement__GetTra_RBC_Session_Pkg.h"

/* RBC_Session_Pkg::SessionManagement__GetTrainData/ */
void SessionManagement__GetTra_RBC_Session_Pkg(
  /* inSessionManagement/ */
...
void SessionManagement__GetTra_init_RBC_Session_Pkg(
  outC_SessionManagement__GetTra_RBC_Session_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void SessionManagement__GetTra_reset_RBC_Session_Pkg(
  outC_SessionManagement__GetTra_RBC_Session_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** SessionManagement__GetTra_RBC_Session_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
