...
void Build_RBC_Message_LRBG_10_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  /* RadiaDataIn/ */
  R_data_internal_T_InfraLib *RadiaDataIn,
  outC_Build_RBC_Message_LRBG_10_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  outC->_L44 = kcg_true;
  /* _L42=(MessageLibBaseline2::Send_M032_JRU#1)/ */
  Send_M032_JRU_MessageLibBaseline2(
    (M_032_int_T_TM_radio_messages *) &LRBG_100_D_00050_0_M032_Messages_Sim,
    &outC->Context_Send_M032_JRU_1);
  kcg_copy_M_TrackTrain_Radio_T_TM_radio_messages(
    &outC->_L42,
    &outC->Context_Send_M032_JRU_1.Message_Out);
...
void Build_RBC_Message_LRBG_10_init_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  outC_Build_RBC_Message_LRBG_10_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L42=(MessageLibBaseline2::Send_M032_JRU#1)/ */
  Send_M032_JRU_init_MessageLibBaseline2(&outC->Context_Send_M032_JRU_1);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void Build_RBC_Message_LRBG_10_reset_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone(
  outC_Build_RBC_Message_LRBG_10_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone *outC)
{
  /* _L3=(RadioLib::No_Radio_Packets#1)/ */
  No_Radio_Packets_reset_RadioLib(&outC->Context_No_Radio_Packets_1);
  /* _L42=(MessageLibBaseline2::Send_M032_JRU#1)/ */
  Send_M032_JRU_reset_MessageLibBaseline2(&outC->Context_Send_M032_JRU_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Build_RBC_Message_LRBG_10_AmsterdamUtrechtL2_Sheet14_Maarssen_Standalone.c
** Generation date: 2023-09-12T13:45:52
*************************************************************$ */
