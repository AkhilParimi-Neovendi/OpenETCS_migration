...
void NationalParams__Get_T_NVC_RBC_Config_Pkg(
  /* inNationalParams/ */
...
void NationalParams__Get_T_NVC_init_RBC_Config_Pkg(
  outC_NationalParams__Get_T_NVC_RBC_Config_Pkg *outC)
{
  ...
  outC->out_T_NVCONTACT = kcg_lit_int32(0);
}
#endif /* KCG_USER_DEFINED_INIT */


void NationalParams__Get_T_NVC_reset_RBC_Config_Pkg(
  outC_NationalParams__Get_T_NVC_RBC_Config_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** NationalParams__Get_T_NVC_RBC_Config_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
