  ...
  outC__72_RadioTrainTrackPackets__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
  ...
  outC->outRadioTrainTrackPacket.packet0.NID_PACKET = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.packet0.L_PACKET = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->outRadioTrainTrackPacket.packet0.NID_LRBG = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.packet0.D_LRBG = kcg_lit_int32(0);
  ...
  outC->outRadioTrainTrackPacket.packet0.L_DOUBTOVER = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.packet0.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->outRadioTrainTrackPacket.packet0.L_TRAININT = kcg_lit_int32(0);
  outC->outRadioTrainTrackPacket.packet0.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->outRadioTrainTrackPacket.packet0.NID_NTC = kcg_lit_int32(0);
}
