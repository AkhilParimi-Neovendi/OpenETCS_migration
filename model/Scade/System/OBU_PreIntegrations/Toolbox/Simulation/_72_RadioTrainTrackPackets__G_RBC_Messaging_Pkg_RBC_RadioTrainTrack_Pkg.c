...
void _72_RadioTrainTrackPackets__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
  /* inRadioTrainTrackPackets/ */
  outPackets_T_Common_Types_Pkg *inRadioTrainTrackPackets,
  outC__72_RadioTrainTrackPackets__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
  kcg_copy_outPackets_T_Common_Types_Pkg(&outC->_L1, inRadioTrainTrackPackets);
  kcg_copy_PT0_PositionReport_T_Packet_TrainTypes_Pkg(&outC->_L3, &outC->_L1.p0);
...
void _72_RadioTrainTrackPackets__G_init_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
  outC__72_RadioTrainTrackPackets__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx1 = 0; idx1 < 1; idx1++) {
    ...
    for (idx = 0; idx < 15; idx++) {
      outC->_L1.p3.aNID_RADIO[idx1].telephoneNumber[idx] = kcg_lit_int64(0);
    }
  }
  ...
  for (idx2 = 0; idx2 < 4; idx2++) {
    ...
    outC->_L1.p11.tractionIdentity[idx2].nid_ctraction = kcg_lit_int64(0);
  }
  outC->_L1.p11.nIter_ntc = kcg_lit_int64(0);
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L1.p11.nid_ntc[idx3] = kcg_lit_int64(0);
  }
  outC->outRadioTrainTrackPacket.valid = kcg_true;
  outC->outRadioTrainTrackPacket.packet0.NID_PACKET = kcg_lit_int64(0);
  outC->outRadioTrainTrackPacket.packet0.L_PACKET = kcg_lit_int64(0);
  outC->outRadioTrainTrackPacket.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->outRadioTrainTrackPacket.packet0.NID_LRBG = kcg_lit_int64(0);
  outC->outRadioTrainTrackPacket.packet0.D_LRBG = kcg_lit_int64(0);
  outC->outRadioTrainTrackPacket.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->outRadioTrainTrackPacket.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->outRadioTrainTrackPacket.packet0.L_DOUBTOVER = kcg_lit_int64(0);
  outC->outRadioTrainTrackPacket.packet0.L_DOUBTUNDER = kcg_lit_int64(0);
  outC->outRadioTrainTrackPacket.packet0.length =
    Q_LENGTH_No_train_integrity_information_available;
  outC->outRadioTrainTrackPacket.packet0.L_TRAININT = kcg_lit_int64(0);
  outC->outRadioTrainTrackPacket.packet0.V_TRAIN = kcg_lit_int64(0);
  outC->outRadioTrainTrackPacket.packet0.dirtrain = Q_DIRTRAIN_Reverse;
  outC->outRadioTrainTrackPacket.packet0.mode = M_MODE_Full_Supervision;
  outC->outRadioTrainTrackPacket.packet0.level = M_LEVEL_Level_0;
  outC->outRadioTrainTrackPacket.packet0.NID_NTC = kcg_lit_int64(0);
}
#endif /* KCG_USER_DEFINED_INIT */


void _72_RadioTrainTrackPackets__G_reset_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
  outC__72_RadioTrainTrackPackets__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _72_RadioTrainTrackPackets__G_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg.c
** Generation date: 2023-09-12T13:45:51
*************************************************************$ */
