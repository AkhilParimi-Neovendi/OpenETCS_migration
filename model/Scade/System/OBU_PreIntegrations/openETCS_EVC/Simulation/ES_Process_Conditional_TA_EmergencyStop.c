...
{
  /* cesAccepted/ */
  kcg_bool cesAccepted_partial;
  /* updateEOA/ */
  kcg_bool updateEOA_partial;
  /* newEOA/ */
  L_internal_Type_Obu_BasicTypes_Pkg newEOA_partial;
  /* cesRevoked/ */
  kcg_bool cesRevoked_partial;
  /* store/ */
  NID_EM_Store_T_TA_EmergencyStop_NID_EM_Store store_partial;
  /* cesAccepted/ */
  kcg_bool _1_cesAccepted_partial;
  /* updateEOA/ */
  kcg_bool _2_updateEOA_partial;
  /* newEOA/ */
  L_internal_Type_Obu_BasicTypes_Pkg _3_newEOA_partial;
  /* cesRevoked/ */
  kcg_bool _4_cesRevoked_partial;
  /* store/ */
  NID_EM_Store_T_TA_EmergencyStop_NID_EM_Store _5_store_partial;
  /* store/ */
  NID_EM_Store_T_TA_EmergencyStop_NID_EM_Store _6_store_partial;
  /* cesRevoked/ */
  kcg_bool _7_cesRevoked_partial;
  /* newEOA/ */
  L_internal_Type_Obu_BasicTypes_Pkg _8_newEOA_partial;
  /* updateEOA/ */
  kcg_bool _9_updateEOA_partial;
  /* cesAccepted/ */
  kcg_bool _10_cesAccepted_partial;
  /* store/ */
  NID_EM_Store_T_TA_EmergencyStop_NID_EM_Store _11_store_partial;
  /* cesRevoked/ */
  kcg_bool _12_cesRevoked_partial;
  /* newEOA/ */
  L_internal_Type_Obu_BasicTypes_Pkg _13_newEOA_partial;
  /* updateEOA/ */
  kcg_bool _14_updateEOA_partial;
  /* cesAccepted/ */
  kcg_bool _15_cesAccepted_partial;
  /* store/ */
  NID_EM_Store_T_TA_EmergencyStop_NID_EM_Store last_store;
