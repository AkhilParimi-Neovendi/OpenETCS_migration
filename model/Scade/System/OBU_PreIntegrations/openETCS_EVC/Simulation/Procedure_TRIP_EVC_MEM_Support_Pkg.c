...
{
  /* TIU_driverWindow/ */
  kcg_bool TIU_driverWindow_partial;
  /* revokeEB/ */
  kcg_bool revokeEB_partial;
  /* Revoke_Procedure: */
  SSM_ST_Revoke_Procedure Revoke_Procedure_state_nxt_partial;
  /* Revoke_Procedure: */
  kcg_bool Revoke_Procedure_reset_nxt_partial;
  /* Revoke_Procedure: */
  SSM_TR_Revoke_Procedure Revoke_Procedure_fired_partial;
  /* TIU_driverWindow/ */
  kcg_bool _1_TIU_driverWindow_partial;
  /* revokeEB/ */
  kcg_bool _2_revokeEB_partial;
  /* Revoke_Procedure: */
  SSM_ST_Revoke_Procedure _3_Revoke_Procedure_state_nxt_partial;
  /* Revoke_Procedure: */
  kcg_bool _4_Revoke_Procedure_reset_nxt_partial;
  /* Revoke_Procedure: */
  SSM_TR_Revoke_Procedure _5_Revoke_Procedure_fired_partial;
  /* TIU_driverWindow/ */
  kcg_bool _6_TIU_driverWindow_partial;
  /* revokeEB/ */
  kcg_bool _7_revokeEB_partial;
  /* Revoke_Procedure: */
  SSM_ST_Revoke_Procedure _8_Revoke_Procedure_state_nxt_partial;
  /* Revoke_Procedure: */
  kcg_bool _9_Revoke_Procedure_reset_nxt_partial;
  /* Revoke_Procedure: */
  SSM_TR_Revoke_Procedure _10_Revoke_Procedure_fired_partial;
  /* TIU_driverWindow/ */
  kcg_bool _11_TIU_driverWindow_partial;
  /* revokeEB/ */
  kcg_bool _12_revokeEB_partial;
  /* Revoke_Procedure: */
  SSM_ST_Revoke_Procedure _13_Revoke_Procedure_state_nxt_partial;
  /* Revoke_Procedure: */
  kcg_bool _14_Revoke_Procedure_reset_nxt_partial;
  /* Revoke_Procedure: */
  SSM_TR_Revoke_Procedure _15_Revoke_Procedure_fired_partial;
  /* Revoke_Procedure: */
  SSM_ST_Revoke_Procedure Revoke_Procedure_state_act_partial;
  /* Revoke_Procedure: */
  kcg_bool Revoke_Procedure_reset_act_partial;
  /* Revoke_Procedure: */
  SSM_TR_Revoke_Procedure Revoke_Procedure_fired_strong_partial;
  /* Revoke_Procedure:no_PostTrip:<1> */
  kcg_bool tr_1_guard_no_PostTrip_Revoke_Procedure;
  /* Revoke_Procedure: */
  SSM_ST_Revoke_Procedure _16_Revoke_Procedure_state_act_partial;
  /* Revoke_Procedure: */
  kcg_bool _17_Revoke_Procedure_reset_act_partial;
  /* Revoke_Procedure: */
  SSM_TR_Revoke_Procedure _18_Revoke_Procedure_fired_strong_partial;
  /* Revoke_Procedure:waitingRBC_Msg18:<2> */
  kcg_bool tr_2_guard_waitingRBC_Msg18_Revoke_Procedure;
  /* Revoke_Procedure:waitingRBC_Msg18:<1> */
  kcg_bool tr_1_guard_waitingRBC_Msg18_Revoke_Procedure;
  /* Revoke_Procedure: */
  SSM_ST_Revoke_Procedure _19_Revoke_Procedure_state_act_partial;
  /* Revoke_Procedure: */
  kcg_bool _20_Revoke_Procedure_reset_act_partial;
  /* Revoke_Procedure: */
  SSM_TR_Revoke_Procedure _21_Revoke_Procedure_fired_strong_partial;
  /* Revoke_Procedure:waitingDriverRevoke:<2> */
  kcg_bool tr_2_guard_waitingDriverRevoke_Revoke_Procedure;
  /* Revoke_Procedure:waitingDriverRevoke:<1> */
  kcg_bool tr_1_guard_waitingDriverRevoke_Revoke_Procedure;
  /* Revoke_Procedure: */
  SSM_ST_Revoke_Procedure _22_Revoke_Procedure_state_act_partial;
  /* Revoke_Procedure: */
  kcg_bool _23_Revoke_Procedure_reset_act_partial;
  /* Revoke_Procedure: */
  SSM_TR_Revoke_Procedure _24_Revoke_Procedure_fired_strong_partial;
  /* Revoke_Procedure:waitingModeChange:<1> */
  kcg_bool tr_1_guard_waitingModeChange_Revoke_Procedure;
  /* revokeEB/ */
  kcg_bool last_revokeEB;
  /* Revoke_Procedure: */
  kcg_bool Revoke_Procedure_reset_sel;
  /* Revoke_Procedure: */
  kcg_bool Revoke_Procedure_reset_prv;
