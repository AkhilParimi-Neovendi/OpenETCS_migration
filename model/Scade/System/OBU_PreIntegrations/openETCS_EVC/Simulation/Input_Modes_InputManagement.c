  ...
  outC_Input_Modes_InputManagement *outC)
{
  ...
  kcg_size idx1;
  Q_DIR noname;
  _6_P15_Level23MovementAuthorities_T_Packet_Types_Pkg _2_noname;
  P21_GradientProfiles_T_Packet_Types_Pkg _3_noname;
  P27_InternationalStaticSpeedProfile_T_Packet_Types_Pkg _4_noname;
  P41_LevelTransistionOrders_T_Packet_Types_Pkg _5_noname;
  _8_P46_ConditionalLevelTransitionOrders_T_Packet_Types_Pkg _6_noname;
  NID_LRBG _7_noname;
