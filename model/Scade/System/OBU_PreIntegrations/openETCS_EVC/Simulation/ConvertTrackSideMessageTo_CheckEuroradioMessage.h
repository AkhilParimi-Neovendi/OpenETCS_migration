...
*************************************************************$ */
#ifndef _ConvertTrackSideMessageTo_CheckEuroradioMessage_H_
#define _ConvertTrackSideMessageTo_CheckEuroradioMessage_H_
...
} outC_ConvertTrackSideMessageTo_CheckEuroradioMessage;

/* ===========  node initialization and cycle functions  =========== */
/* CheckEuroradioMessage::ConvertTrackSideMessageToRadioMessage/ */
extern void ConvertTrackSideMessageTo_CheckEuroradioMessage(
  /* TrackSideMessage/ */
  TrackSide_ForCheck_T_Common_Types_Pkg *TrackSideMessage,
  outC_ConvertTrackSideMessageTo_CheckEuroradioMessage *outC);

#ifndef KCG_NO_EXTERN_CALL_TO_RESET
extern void ConvertTrackSideMessageTo_reset_CheckEuroradioMessage(
  outC_ConvertTrackSideMessageTo_CheckEuroradioMessage *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void ConvertTrackSideMessageTo_init_CheckEuroradioMessage(
  outC_ConvertTrackSideMessageTo_CheckEuroradioMessage *outC);
#endif /* KCG_USER_DEFINED_INIT */



#endif /* _ConvertTrackSideMessageTo_CheckEuroradioMessage_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** ConvertTrackSideMessageTo_CheckEuroradioMessage.h
** Generation date: 2023-11-06T13:54:28
*************************************************************$ */
