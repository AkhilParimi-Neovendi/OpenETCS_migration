...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  _6_P15_Level23MovementAuthorities_T_Packet_Types_Pkg /* P015_legacy_out/ */ P015_legacy_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  _6_P15_Level23MovementAuthorities_T_Packet_Types_Pkg /* _L20/ */ _L20;
  _156_array /* _L23/ */ _L23;
  _199_array /* _L26/ */ _L26;
