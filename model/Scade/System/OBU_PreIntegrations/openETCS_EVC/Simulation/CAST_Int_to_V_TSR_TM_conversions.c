...
void CAST_Int_to_V_TSR_TM_conversions(
  /* v_tsr_int/ */
  kcg_int32 v_tsr_int,
  outC_CAST_Int_to_V_TSR_TM_conversions *outC)
{
  ...
  _1_noname = outC->_L8;
  noname = outC->_L9;
  outC->v_tsr = outC->_L11;
}

#ifndef KCG_USER_DEFINED_INIT
void CAST_Int_to_V_TSR_init_TM_conversions(
  outC_CAST_Int_to_V_TSR_TM_conversions *outC)
{
  ...
  outC->v_tsr = kcg_lit_int32(0);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void CAST_Int_to_V_TSR_reset_TM_conversions(
  outC_CAST_Int_to_V_TSR_TM_conversions *outC)
{
}
