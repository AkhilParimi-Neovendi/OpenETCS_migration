...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_CheckIfSinglePacketIsAllo_CheckEuroradioMessage_SubFunctions /* _L14=(CheckEuroradioMessage::SubFunctions::CheckIfSinglePacketIsAllowedForRadioMessage#1)/ */ Context_CheckIfSinglePacketIsAllowedForRadioMessage_1[30];
