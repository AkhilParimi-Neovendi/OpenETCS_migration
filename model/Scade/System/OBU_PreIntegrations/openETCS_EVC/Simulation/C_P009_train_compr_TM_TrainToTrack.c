...
{
  kcg_copy_P009_TM_TrainToTrack(&outC->_L1, P009_in);
  ...
  outC->_L5 = outC->_L1.nid_ltrbg;
  /* _L71=(TM_conversions::CAST_NID_LTRBG_to_int#1)/ */
  CAST_NID_LTRBG_to_int_TM_conversions(
    outC->_L5,
    &outC->Context_CAST_NID_LTRBG_to_int_1);
  outC->_L71 = outC->Context_CAST_NID_LTRBG_to_int_1.nid_ltrbg_int;
  ...
  kcg_copy_P009_TrainTrack_int_TM_TrainToTrack(&outC->P009_int, &outC->_L68);
}

#ifndef KCG_USER_DEFINED_INIT
void C_P009_train_compr_init_TM_TrainToTrack(
  outC_C_P009_train_compr_TM_TrainToTrack *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx1 = 0; idx1 < 3; idx1++) {
    outC->P009_int[idx1] = kcg_lit_int32(0);
  }
  /* _L70=(TM_conversions::CAST_L_PACKET_to_int#1)/ */
  CAST_L_PACKET_to_int_init_TM_conversions(
    &outC->Context_CAST_L_PACKET_to_int_1);
  /* _L71=(TM_conversions::CAST_NID_LTRBG_to_int#1)/ */
  CAST_NID_LTRBG_to_int_init_TM_conversions(
    &outC->Context_CAST_NID_LTRBG_to_int_1);
  /* _L89=(TM_TrainToTrack::Encode_NID_PACKET#1)/ */
...
void C_P009_train_compr_reset_TM_TrainToTrack(
  outC_C_P009_train_compr_TM_TrainToTrack *outC)
{
  /* _L70=(TM_conversions::CAST_L_PACKET_to_int#1)/ */
  CAST_L_PACKET_to_int_reset_TM_conversions(
    &outC->Context_CAST_L_PACKET_to_int_1);
  /* _L71=(TM_conversions::CAST_NID_LTRBG_to_int#1)/ */
  CAST_NID_LTRBG_to_int_reset_TM_conversions(
    &outC->Context_CAST_NID_LTRBG_to_int_1);
  /* _L89=(TM_TrainToTrack::Encode_NID_PACKET#1)/ */
