...
{
  NID_EM_STORE_Acc_T_TA_EmergencyStop_NID_EM_Store acc;
  kcg_size idx;
  NID_EM_STORE_Acc_T_TA_EmergencyStop_NID_EM_Store acc1;
  kcg_size idx2;
  NID_EM_STORE_Acc_T_TA_EmergencyStop_NID_EM_Store acc3;
  kcg_size idx4;
  /* handled/ */
  kcg_bool handled_partial;
  /* outStore/ */
  NID_EM_Store_T_TA_EmergencyStop_NID_EM_Store outStore_partial;
  NID_EM noname;
  /* handled/ */
  kcg_bool _5_handled_partial;
  /* outStore/ */
  NID_EM_Store_T_TA_EmergencyStop_NID_EM_Store _6_outStore_partial;
  /* outStore/ */
  NID_EM_Store_T_TA_EmergencyStop_NID_EM_Store _7_outStore_partial;
  /* handled/ */
  kcg_bool _8_handled_partial;
  NID_EM _9_noname;
  /* outStore/ */
  NID_EM_Store_T_TA_EmergencyStop_NID_EM_Store _10_outStore_partial;
  /* handled/ */
  kcg_bool _11_handled_partial;

  outC->IfBlock1_clock = add & ((*inStore).nfree > kcg_lit_int32(0));
  /* IfBlock1: */
  if (outC->IfBlock1_clock) {
    kcg_copy__151_array(&outC->_L16_then_IfBlock1, &(*inStore).items);
    ...
    kcg_copy__151_array(&outC->_L5_then_IfBlock1, &(*inStore).items);
    kcg_copy_NID_EM_STORE_Acc_T_TA_EmergencyStop_NID_EM_Store(
    ...
    kcg_copy__151_array(&outC->_L4_then_IfBlock1.items, &outC->_L2_then_IfBlock1);
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      kcg_copy__151_array(&outC->_L4_then_else_IfBlock1, &(*inStore).items);
      kcg_copy_NID_EM_STORE_Acc_T_TA_EmergencyStop_NID_EM_Store(
