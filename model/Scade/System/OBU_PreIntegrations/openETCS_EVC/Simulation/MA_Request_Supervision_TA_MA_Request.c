  ...
  outC_MA_Request_Supervision_TA_MA_Request *outC)
{
  ...
  kcg_bool _2_op_call;
  /* pendingReq/ */
  kcg_bool pendingReq_partial;
  /* SM1: */
  _211_SSM_ST_SM1 SM1_state_nxt_partial;
  /* SM1: */
  kcg_bool SM1_reset_nxt_partial;
  /* SM1: */
  _212_SSM_TR_SM1 SM1_fired_partial;
  /* pendingReq/ */
  kcg_bool _3_pendingReq_partial;
  /* SM1: */
  _211_SSM_ST_SM1 _4_SM1_state_nxt_partial;
  /* SM1: */
  kcg_bool _5_SM1_reset_nxt_partial;
  /* SM1: */
  _212_SSM_TR_SM1 _6_SM1_fired_partial;
  /* pendingReq/ */
  kcg_bool _7_pendingReq_partial;
  /* SM1: */
  _211_SSM_ST_SM1 _8_SM1_state_nxt_partial;
  /* SM1: */
  kcg_bool _9_SM1_reset_nxt_partial;
  /* SM1: */
  _212_SSM_TR_SM1 _10_SM1_fired_partial;
  /* SM1: */
  _211_SSM_ST_SM1 SM1_state_act_partial;
  /* SM1: */
  kcg_bool SM1_reset_act_partial;
  /* SM1: */
  _212_SSM_TR_SM1 SM1_fired_strong_partial;
  /* SM1:init:<1> */
  kcg_bool tr_1_guard_init_SM1;
  /* SM1: */
  _211_SSM_ST_SM1 _11_SM1_state_act_partial;
  /* SM1: */
  kcg_bool _12_SM1_reset_act_partial;
  /* SM1: */
  _212_SSM_TR_SM1 _13_SM1_fired_strong_partial;
  /* SM1:NoReqPending:<1> */
  kcg_bool tr_1_guard_NoReqPending_SM1;
  /* SM1: */
  _211_SSM_ST_SM1 _14_SM1_state_act_partial;
  /* SM1: */
  kcg_bool _15_SM1_reset_act_partial;
  /* SM1: */
  _212_SSM_TR_SM1 _16_SM1_fired_strong_partial;
  /* SM1:ReqPending:<1> */
  kcg_bool tr_1_guard_ReqPending_SM1;
  kcg_bool noname;
  /* pendingReq/ */
  kcg_bool last_pendingReq;
  /* triggerMA/ */
  kcg_bool last_triggerMA;
  /* in_triggerMA/ */
  kcg_bool last_in_triggerMA;
  /* SM1: */
  ...
  switch (outC->SM1_state_sel) {
    case SSM_st_ReqPending_SM1 :
      if (tr_1_guard_ReqPending_SM1) {
        ...
        _16_SM1_fired_strong_partial = _259_SSM_TR_no_trans_SM1;
      }
    ...
    case SSM_st_NoReqPending_SM1 :
      if (tr_1_guard_NoReqPending_SM1) {
        ...
        _13_SM1_fired_strong_partial = _259_SSM_TR_no_trans_SM1;
      }
    ...
    case SSM_st_init_SM1 :
      if (tr_1_guard_init_SM1) {
        ...
        SM1_fired_strong_partial = _259_SSM_TR_no_trans_SM1;
      }
  ...
  outC_MA_Request_Supervision_TA_MA_Request *outC)
{
  ...
  outC->SM1_fired = _259_SSM_TR_no_trans_SM1;
  outC->SM1_fired_strong = _259_SSM_TR_no_trans_SM1;
