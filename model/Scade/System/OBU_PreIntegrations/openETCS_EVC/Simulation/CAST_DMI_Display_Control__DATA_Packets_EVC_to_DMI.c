...
void CAST_DMI_Display_Control__DATA_Packets_EVC_to_DMI(
...
void CAST_DMI_Display_Control__init_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_Display_Control__DATA_Packets_EVC_to_DMI *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx1 = 0; idx1 < 3; idx1++) {
    outC->dmi_display_control_int[idx1] = kcg_lit_int32(0);
  }
  /* _L6=(Utilities::Bool_to_Int#1)/ */
...
void CAST_DMI_Display_Control__reset_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_Display_Control__DATA_Packets_EVC_to_DMI *outC)
{
  /* _L6=(Utilities::Bool_to_Int#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_Display_Control__DATA_Packets_EVC_to_DMI.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
