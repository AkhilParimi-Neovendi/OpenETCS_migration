...
{
  /* Condition_59/ */
  kcg_bool Condition_59_partial;
  /* Ack_RV_Req_To_Driver/ */
  kcg_bool Ack_RV_Req_To_Driver_partial;
  /* SM_Train_Reversing: */
  SSM_ST_SM_Train_Reversing SM_Train_Reversing_state_nxt_partial;
  /* SM_Train_Reversing: */
  kcg_bool SM_Train_Reversing_reset_nxt_partial;
  /* SM_Train_Reversing: */
  SSM_TR_SM_Train_Reversing SM_Train_Reversing_fired_partial;
  /* Condition_59/ */
  kcg_bool _1_Condition_59_partial;
  /* Ack_RV_Req_To_Driver/ */
  kcg_bool _2_Ack_RV_Req_To_Driver_partial;
  /* SM_Train_Reversing: */
  SSM_ST_SM_Train_Reversing _3_SM_Train_Reversing_state_nxt_partial;
  /* SM_Train_Reversing: */
  kcg_bool _4_SM_Train_Reversing_reset_nxt_partial;
  /* SM_Train_Reversing: */
  SSM_TR_SM_Train_Reversing _5_SM_Train_Reversing_fired_partial;
  /* Condition_59/ */
  kcg_bool _6_Condition_59_partial;
  /* Ack_RV_Req_To_Driver/ */
  kcg_bool _7_Ack_RV_Req_To_Driver_partial;
  /* SM_Train_Reversing: */
  SSM_ST_SM_Train_Reversing _8_SM_Train_Reversing_state_nxt_partial;
  /* SM_Train_Reversing: */
  kcg_bool _9_SM_Train_Reversing_reset_nxt_partial;
  /* SM_Train_Reversing: */
  SSM_TR_SM_Train_Reversing _10_SM_Train_Reversing_fired_partial;
  /* Condition_59/ */
  kcg_bool _11_Condition_59_partial;
  /* Ack_RV_Req_To_Driver/ */
  kcg_bool _12_Ack_RV_Req_To_Driver_partial;
  /* SM_Train_Reversing: */
  SSM_ST_SM_Train_Reversing _13_SM_Train_Reversing_state_nxt_partial;
  /* SM_Train_Reversing: */
  kcg_bool _14_SM_Train_Reversing_reset_nxt_partial;
  /* SM_Train_Reversing: */
  SSM_TR_SM_Train_Reversing _15_SM_Train_Reversing_fired_partial;
  /* SM_Train_Reversing: */
  SSM_ST_SM_Train_Reversing SM_Train_Reversing_state_act_partial;
  /* SM_Train_Reversing: */
  kcg_bool SM_Train_Reversing_reset_act_partial;
  /* SM_Train_Reversing: */
  SSM_TR_SM_Train_Reversing SM_Train_Reversing_fired_strong_partial;
  /* SM_Train_Reversing:Reversing_Procedure_Off:<1> */
  kcg_bool tr_1_guard_Reversing_Procedure_Off_SM_Train_Reversing;
  /* SM_Train_Reversing: */
  SSM_ST_SM_Train_Reversing _16_SM_Train_Reversing_state_act_partial;
  /* SM_Train_Reversing: */
  kcg_bool _17_SM_Train_Reversing_reset_act_partial;
  /* SM_Train_Reversing: */
  SSM_TR_SM_Train_Reversing _18_SM_Train_Reversing_fired_strong_partial;
  /* SM_Train_Reversing:Reversing_Condition:<3> */
  kcg_bool tr_3_guard_Reversing_Condition_SM_Train_Reversing;
  /* SM_Train_Reversing:Reversing_Condition:<2> */
  kcg_bool tr_2_guard_Reversing_Condition_SM_Train_Reversing;
  /* SM_Train_Reversing:Reversing_Condition:<1> */
  kcg_bool tr_1_guard_Reversing_Condition_SM_Train_Reversing;
  /* SM_Train_Reversing: */
  SSM_ST_SM_Train_Reversing _19_SM_Train_Reversing_state_act_partial;
  /* SM_Train_Reversing: */
  kcg_bool _20_SM_Train_Reversing_reset_act_partial;
  /* SM_Train_Reversing: */
  SSM_TR_SM_Train_Reversing _21_SM_Train_Reversing_fired_strong_partial;
  /* SM_Train_Reversing: */
  SSM_ST_SM_Train_Reversing _22_SM_Train_Reversing_state_act_partial;
  /* SM_Train_Reversing: */
  kcg_bool _23_SM_Train_Reversing_reset_act_partial;
  /* SM_Train_Reversing: */
  SSM_TR_SM_Train_Reversing _24_SM_Train_Reversing_fired_strong_partial;
  /* SM_Train_Reversing:Reversing_Data_Available:<2> */
  kcg_bool tr_2_guard_Reversing_Data_Available_SM_Train_Reversing;
  /* SM_Train_Reversing:Reversing_Data_Available:<1> */
  kcg_bool tr_1_guard_Reversing_Data_Available_SM_Train_Reversing;
  /* SM_Train_Reversing: */
  kcg_bool SM_Train_Reversing_reset_sel;
  /* SM_Train_Reversing: */
  kcg_bool SM_Train_Reversing_reset_prv;
