  ...
  outC_calcBec_TargetLimits_Pkg *outC)
{
  ...
  outC->I2_Max_1_float32 = outC->_L24;
  outC->_L2_Max_1_float32 = outC->I2_Max_1_float32;
  outC->_L25 = V_target;
  outC->I1_Max_1_float32 = outC->_L25;
  ...
  outC->I2_Max_2_float32 = outC->_L39;
  outC->_L2_Max_2_float32 = outC->I2_Max_2_float32;
  outC->_L38 = V_target;
  outC->I1_Max_2_float32 = outC->_L38;
  ...
  outC->_L23 = outC->Ma_Output_Max_1_float32;
  ...
  outC->_L34 = outC->Ma_Output_Max_2_float32;
...
void calcBec_init_TargetLimits_Pkg(outC_calcBec_TargetLimits_Pkg *outC)
{
  ...
  outC->_L113.v = kcg_lit_float32(0.0);
  outC->_L113.d = kcg_lit_float32(0.0);
  outC->_L109 = kcg_lit_float32(0.0);
  outC->_L108 = kcg_lit_float32(0.0);
  outC->_L107 = kcg_lit_float32(0.0);
  for (idx = 0; idx < 3; idx++) {
    outC->_L110[idx] = kcg_lit_float32(0.0);
  }
  outC->_L100 = kcg_lit_float32(0.0);
  outC->_L101 = kcg_lit_float32(0.0);
  outC->_L102 = kcg_lit_float32(0.0);
  for (idx1 = 0; idx1 < 3; idx1++) {
    outC->_L94[idx1] = kcg_lit_float32(0.0);
  }
  outC->_L92 = kcg_lit_float32(0.0);
  outC->_L91 = kcg_lit_float32(0.0);
  outC->_L83.Traction = kcg_lit_float32(0.0);
  outC->_L83.berem = kcg_lit_float32(0.0);
  outC->_L83.bs = kcg_lit_float32(0.0);
  outC->_L83.bs1 = kcg_lit_float32(0.0);
  outC->_L83.bs2 = kcg_lit_float32(0.0);
  outC->_L83.inhComp = kcg_true;
  outC->_L83.indication = kcg_lit_float32(0.0);
  ...
  outC->v_bec = kcg_lit_float32(0.0);
