...
void SSP_Convert_P27V1_to_Dist_TA_SSP_new(
  /* i/ */
  kcg_int32 i,
  /* ProfileAccu/ */
  ...
  /* q_scale/ */
  Q_SCALE q_scale,
  outC_SSP_Convert_P27V1_to_Dist_TA_SSP_new *outC)
{
  outC->_L134 = i;
...
void SSP_Convert_P27V1_to_Dist_init_TA_SSP_new(
  outC_SSP_Convert_P27V1_to_Dist_TA_SSP_new *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  outC->_L143.d_static_abs = kcg_lit_int32(0);
  outC->_L143.d_static_LRBG = kcg_lit_int32(0);
  outC->_L143.q_train_length_corr = kcg_true;
  outC->_L143.v_static = kcg_lit_int32(0);
  for (idx = 0; idx < 50; idx++) {
    outC->_L142[idx].valid = kcg_true;
    outC->_L142[idx].d_static_abs = kcg_lit_int32(0);
    outC->_L142[idx].d_static_LRBG = kcg_lit_int32(0);
    outC->_L142[idx].q_train_length_corr = kcg_true;
    outC->_L142[idx].v_static = kcg_lit_int32(0);
  }
  for (idx2 = 0; idx2 < 33; idx2++) {
    outC->_L121[idx2].valid = kcg_true;
    outC->_L121[idx2].d_static = kcg_lit_int32(0);
    outC->_L121[idx2].v_static = kcg_lit_int32(0);
    outC->_L121[idx2].q_front =
      Q_FRONT_Train_length_delay_on_validity_end_point_of_profile_element;
    outC->_L121[idx2].n_iter = kcg_lit_int32(0);
    for (idx1 = 0; idx1 < 32; idx1++) {
      outC->_L121[idx2].SECTIONS_q_diff[idx1].valid = kcg_true;
      outC->_L121[idx2].SECTIONS_q_diff[idx1].nc_diff = kcg_lit_int32(0);
      outC->_L121[idx2].SECTIONS_q_diff[idx1].v_diff = kcg_lit_int32(0);
    }
  }
  ...
  outC->_L123.q_front =
    Q_FRONT_Train_length_delay_on_validity_end_point_of_profile_element;
  outC->_L123.n_iter = kcg_lit_int32(0);
  for (idx3 = 0; idx3 < 32; idx3++) {
    outC->_L123.SECTIONS_q_diff[idx3].valid = kcg_true;
    outC->_L123.SECTIONS_q_diff[idx3].nc_diff = kcg_lit_int32(0);
    outC->_L123.SECTIONS_q_diff[idx3].v_diff = kcg_lit_int32(0);
  }
  for (idx4 = 0; idx4 < 50; idx4++) {
    outC->_L125[idx4].valid = kcg_true;
    outC->_L125[idx4].d_static_abs = kcg_lit_int32(0);
    outC->_L125[idx4].d_static_LRBG = kcg_lit_int32(0);
    outC->_L125[idx4].q_train_length_corr = kcg_true;
    outC->_L125[idx4].v_static = kcg_lit_int32(0);
  }
  outC->_L130 = kcg_true;
  outC->_L131 = kcg_lit_int32(0);
  for (idx5 = 0; idx5 < 50; idx5++) {
    outC->_L133[idx5].valid = kcg_true;
    outC->_L133[idx5].d_static_abs = kcg_lit_int32(0);
    outC->_L133[idx5].d_static_LRBG = kcg_lit_int32(0);
    outC->_L133[idx5].q_train_length_corr = kcg_true;
    outC->_L133[idx5].v_static = kcg_lit_int32(0);
  }
  outC->_L134 = kcg_lit_int32(0);
  outC->_L135 = kcg_lit_int32(0);
  outC->_L136.valid = kcg_true;
  outC->_L136.d_static_abs = kcg_lit_int32(0);
  outC->_L136.d_static_LRBG = kcg_lit_int32(0);
  outC->_L136.q_train_length_corr = kcg_true;
  outC->_L136.v_static = kcg_lit_int32(0);
  ...
  for (idx6 = 0; idx6 < 50; idx6++) {
    ...
    outC->SpeedtProfile[idx6].d_static_abs = kcg_lit_int32(0);
    outC->SpeedtProfile[idx6].d_static_LRBG = kcg_lit_int32(0);
    outC->SpeedtProfile[idx6].q_train_length_corr = kcg_true;
    outC->SpeedtProfile[idx6].v_static = kcg_lit_int32(0);
  }
  /* _L135=(TA_Lib_internal::Normalize_Distance_d_internal_t#2)/ */
...
void SSP_Convert_P27V1_to_Dist_reset_TA_SSP_new(
  outC_SSP_Convert_P27V1_to_Dist_TA_SSP_new *outC)
{
  /* _L135=(TA_Lib_internal::Normalize_Distance_d_internal_t#2)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** SSP_Convert_P27V1_to_Dist_TA_SSP_new.c
** Generation date: 2023-11-06T13:54:30
*************************************************************$ */
