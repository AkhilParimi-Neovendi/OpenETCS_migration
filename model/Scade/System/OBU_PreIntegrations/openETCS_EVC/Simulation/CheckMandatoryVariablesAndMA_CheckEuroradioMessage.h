...
typedef struct {
  ...
  outC_CheckIfPacket15IsPresent_CheckEuroradioMessage_SubFunctions /* IfBlock1:else:else:then:_L7=(CheckEuroradioMessage::SubFunctions::CheckIfPacket15IsPresent#3)/ */ _1_Context_CheckIfPacket15IsPresent_3;
  outC_CheckIfPacket15IsPresent_CheckEuroradioMessage_SubFunctions /* IfBlock1:else:else:else:else:else:else:else:else:then:_L11=(CheckEuroradioMessage::SubFunctions::CheckIfPacket15IsPresent#5)/ */ _2_Context_CheckIfPacket15IsPresent_5;
  ...
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else: */ _3_else_clock_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:else: */ _4_else_clock_else_else_else_else_else_else_else_else_IfBlock1;
  ...
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:then:_L20/ */ _L208_then_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:then:_L17/ */ _L179_then_else_else_else_else_else_else_else_else_IfBlock1;
  ...
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:then:_L11/ */ _L1110_then_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:then:_L12/ */ _L1211_then_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:then:_L13/ */ _L1312_then_else_else_else_else_else_else_else_else_IfBlock1;
  ReceivedMessage_T_Common_Types_Pkg /* IfBlock1:else:else:else:else:else:else:else:else:then:_L14/ */ _L1413_then_else_else_else_else_else_else_else_else_IfBlock1;
  RadioMetadata_T_Common_Types_Pkg /* IfBlock1:else:else:else:else:else:else:else:else:then:_L15/ */ _L1514_then_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:then:_L16/ */ _L1615_then_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:else:else:then:_L7/ */ _L716_then_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:else:else:then:_L8/ */ _L817_then_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:else:else:then:_L17/ */ _L1718_then_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:else:else:then:_L16/ */ _L1619_then_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:else:else:then:_L15/ */ _L1520_then_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:else:else:then:_L14/ */ _L1421_then_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:else:else:then:_L13/ */ _L1322_then_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:else:else:then:_L12/ */ _L1223_then_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:else:else:then:_L11/ */ _L1124_then_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:else:else:then:_L10/ */ _L1025_then_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:else:else:then:_L9/ */ _L926_then_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  RadioMetadata_T_Common_Types_Pkg /* IfBlock1:else:else:else:else:else:else:else:else:else:else:then:_L18/ */ _L1827_then_else_else_else_else_else_else_else_else_else_else_IfBlock1;
  ...
  ReceivedMessage_T_Common_Types_Pkg /* IfBlock1:else:else:else:else:else:else:else:else:else:then:_L2/ */ _L228_then_else_else_else_else_else_else_else_else_else_IfBlock1;
  M_ACK /* IfBlock1:else:else:else:else:else:else:else:else:else:then:_L3/ */ _L329_then_else_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:else:else:then:_L4/ */ _L430_then_else_else_else_else_else_else_else_else_else_IfBlock1;
  M_ACK /* IfBlock1:else:else:else:else:else:else:else:else:else:then:_L5/ */ _L531_then_else_else_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L14/ */ _L1432_then_else_else_else_else_else_else_else_IfBlock1;
  RadioMetadata_T_Common_Types_Pkg /* IfBlock1:else:else:else:else:else:else:else:then:_L13/ */ _L1333_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L4/ */ _L434_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L5/ */ _L535_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L6/ */ _L636_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L7/ */ _L737_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L8/ */ _L838_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L9/ */ _L939_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L10/ */ _L1040_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L11/ */ _L1141_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L12/ */ _L1242_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L2/ */ _L243_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L15/ */ _L1544_then_else_else_else_else_else_else_else_IfBlock1;
  RadioMetadata_T_Common_Types_Pkg /* IfBlock1:else:else:else:else:else:then:_L14/ */ _L1445_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L13/ */ _L1346_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L4/ */ _L447_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L5/ */ _L548_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L6/ */ _L649_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L7/ */ _L750_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L8/ */ _L851_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L9/ */ _L952_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L10/ */ _L1053_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L11/ */ _L1154_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L12/ */ _L1255_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L3/ */ _L356_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L2/ */ _L257_then_else_else_else_else_else_IfBlock1;
