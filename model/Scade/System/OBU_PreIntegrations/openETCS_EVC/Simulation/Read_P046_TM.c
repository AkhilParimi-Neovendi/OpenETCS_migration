  ...
  outC_Read_P046_TM *outC)
{
  ...
  /* _L166=(TM_conversions::C_P046_compr_onboard#1)/ */
  C_P046_compr_onboard_TM_conversions(
    &outC->_L5,
    &outC->_L30,
    &outC->Context_C_P046_compr_onboard_1);
  kcg_copy_P046_OBU_T_TM(
    &outC->_L166,
    &outC->Context_C_P046_compr_onboard_1.P046_onboard);
  kcg_copy_P046_OBU_T_TM(&outC->P046_OBU_out, &outC->_L166);
}

#ifndef KCG_USER_DEFINED_INIT
void Read_P046_init_TM(outC_Read_P046_TM *outC)
{
  kcg_size idx;
  kcg_size idx1;
  kcg_size idx2;
  ...
  outC->P046_OBU_out.valid = kcg_true;
  outC->P046_OBU_out.q_dir = Q_DIR_Reverse;
  outC->P046_OBU_out.n_iter = kcg_lit_int32(0);
  for (idx4 = 0; idx4 < 33; idx4++) {
    outC->P046_OBU_out.sections[idx4].valid = kcg_true;
    outC->P046_OBU_out.sections[idx4].m_leveltr = M_LEVELTR_Level_0;
    outC->P046_OBU_out.sections[idx4].nid_ntc = kcg_lit_int32(0);
  }
  outC->received = kcg_true;
  /* _L166=(TM_conversions::C_P046_compr_onboard#1)/ */
  C_P046_compr_onboard_init_TM_conversions(
    &outC->Context_C_P046_compr_onboard_1);
  /* _L5=(TM_lib_internal::RECV_ReadPackets#1)/ */
...
{
  /* _L166=(TM_conversions::C_P046_compr_onboard#1)/ */
  C_P046_compr_onboard_reset_TM_conversions(
    &outC->Context_C_P046_compr_onboard_1);
  /* _L5=(TM_lib_internal::RECV_ReadPackets#1)/ */
