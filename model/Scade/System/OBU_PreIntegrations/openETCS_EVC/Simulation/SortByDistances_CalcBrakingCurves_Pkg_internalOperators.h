...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_deleteLeadingUndefinedEle_CalcBrakingCurves_Pkg_internalOperators /* _L21=(CalcBrakingCurves_Pkg::internalOperators::deleteLeadingUndefinedElements#1)/ */ Context_deleteLeadingUndefinedElements_1[114];
