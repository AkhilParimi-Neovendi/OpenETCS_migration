...
{
  /* outMessageComplete/ */
  kcg_bool outMessageComplete_partial;
  /* outBGIsChangedEarly/ */
  kcg_bool outBGIsChangedEarly_partial;
  /* outCollector/ */
  BGCollector_T_Receive_TrackSide_Msg_Pkg outCollector_partial;
  /* outMessageComplete/ */
  kcg_bool _1_outMessageComplete_partial;
  /* outBGIsChangedEarly/ */
  kcg_bool _2_outBGIsChangedEarly_partial;
  /* outCollector/ */
  BGCollector_T_Receive_TrackSide_Msg_Pkg _3_outCollector_partial;
  ...
  outC_checkOdometry_Receive_TrackSide_Msg_Pkg *outC)
{
  ...
  outC->_L30.C_ID = kcg_lit_int32(0);
  outC->_L30.BG_ID = kcg_lit_int32(0);
  outC->_L30.balisePosition.odometerOfBaliseDetection.valid = kcg_true;
  outC->_L30.balisePosition.odometerOfBaliseDetection.timestamp = kcg_lit_int32(
      0);
  outC->_L30.balisePosition.odometerOfBaliseDetection.odo.o_nominal =
    kcg_lit_int32(0);
  outC->_L30.balisePosition.odometerOfBaliseDetection.odo.o_min = kcg_lit_int32(
      0);
  outC->_L30.balisePosition.odometerOfBaliseDetection.odo.o_max = kcg_lit_int32(
      0);
  ...
  outC->_L30.positionFirstContact.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int32(0);
  outC->_L30.collectedTelegrams = kcg_lit_int32(0);
  outC->_L30.totalTelegrams = kcg_lit_int32(0);
  outC->_L22 = kcg_true;
  outC->_L21 = kcg_lit_int32(0);
  outC->_L20 = kcg_true;
  ...
  outC->_L11.odo.o_nominal = kcg_lit_int32(0);
  outC->_L11.odo.o_min = kcg_lit_int32(0);
  outC->_L11.odo.o_max = kcg_lit_int32(0);
  outC->_L11.speed.v_safeNominal = kcg_lit_int32(0);
  outC->_L11.speed.v_rawNominal = kcg_lit_int32(0);
  outC->_L11.speed.v_lower = kcg_lit_int32(0);
  outC->_L11.speed.v_upper = kcg_lit_int32(0);
  outC->_L11.acceleration = kcg_lit_int32(0);
  ...
  outC->_L3_else_IfBlock1.C_ID = kcg_lit_int32(0);
  outC->_L3_else_IfBlock1.BG_ID = kcg_lit_int32(0);
  ...
  outC->_L3_else_IfBlock1.positionFirstContact.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int32(0);
  outC->_L3_else_IfBlock1.collectedTelegrams = kcg_lit_int32(0);
  outC->_L3_else_IfBlock1.totalTelegrams = kcg_lit_int32(0);
  outC->_L7_then_IfBlock1.valid = kcg_true;
  outC->_L7_then_IfBlock1.timestamp = kcg_lit_int32(0);
  outC->_L7_then_IfBlock1.odo.o_nominal = kcg_lit_int32(0);
  outC->_L7_then_IfBlock1.odo.o_min = kcg_lit_int32(0);
  outC->_L7_then_IfBlock1.odo.o_max = kcg_lit_int32(0);
  outC->_L7_then_IfBlock1.speed.v_safeNominal = kcg_lit_int32(0);
  outC->_L7_then_IfBlock1.speed.v_rawNominal = kcg_lit_int32(0);
  outC->_L7_then_IfBlock1.speed.v_lower = kcg_lit_int32(0);
  outC->_L7_then_IfBlock1.speed.v_upper = kcg_lit_int32(0);
  outC->_L7_then_IfBlock1.acceleration = kcg_lit_int32(0);
  ...
  outC->_L6_then_IfBlock1.o_nominal = kcg_lit_int32(0);
  outC->_L6_then_IfBlock1.o_min = kcg_lit_int32(0);
  outC->_L6_then_IfBlock1.o_max = kcg_lit_int32(0);
  outC->_L5_then_IfBlock1 = kcg_true;
  outC->_L3_then_IfBlock1 = kcg_true;
  outC->_L10_then_IfBlock1.o_nominal = kcg_lit_int32(0);
  outC->_L10_then_IfBlock1.o_min = kcg_lit_int32(0);
  outC->_L10_then_IfBlock1.o_max = kcg_lit_int32(0);
  ...
  outC->_L11_then_IfBlock1.o_nominal = kcg_lit_int32(0);
  outC->_L11_then_IfBlock1.o_min = kcg_lit_int32(0);
  outC->_L11_then_IfBlock1.o_max = kcg_lit_int32(0);
  ...
  outC->_L18_then_IfBlock1.C_ID = kcg_lit_int32(0);
  outC->_L18_then_IfBlock1.BG_ID = kcg_lit_int32(0);
  ...
  outC->_L18_then_IfBlock1.positionFirstContact.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int32(0);
  outC->_L18_then_IfBlock1.collectedTelegrams = kcg_lit_int32(0);
  outC->_L18_then_IfBlock1.totalTelegrams = kcg_lit_int32(0);
  ...
  outC->_L20_then_IfBlock1.C_ID = kcg_lit_int32(0);
  outC->_L20_then_IfBlock1.BG_ID = kcg_lit_int32(0);
  ...
  outC->_L20_then_IfBlock1.positionFirstContact.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int32(0);
  outC->_L20_then_IfBlock1.collectedTelegrams = kcg_lit_int32(0);
  outC->_L20_then_IfBlock1.totalTelegrams = kcg_lit_int32(0);
