...
void CAST_DMI_brakeModel_id_to_int_DATA_Variables(
  ...
  outC_CAST_DMI_brakeModel_id_to_int_DATA_Variables *outC)
{
  ...
  kcg_copy_DMI_brakeModel_id_T_DMI_Types_Pkg(&outC->_L1, dmi_brakeModel_id_ct);
  ...
  outC->dmi_brakeModel_id_int = outC->_L22;
}

#ifndef KCG_USER_DEFINED_INIT
void CAST_DMI_brakeModel_id_to_int_init_DATA_Variables(
  outC_CAST_DMI_brakeModel_id_to_int_DATA_Variables *outC)
{
  outC->_L41 = kcg_true;
  ...
  outC->error = kcg_true;
  outC->dmi_brakeModel_id_int = kcg_lit_int32(0);
  /* _L23=(Utilities::BCD_to_Int#1)/ */
...
void CAST_DMI_brakeModel_id_to_int_reset_DATA_Variables(
  outC_CAST_DMI_brakeModel_id_to_int_DATA_Variables *outC)
{
  /* _L23=(Utilities::BCD_to_Int#1)/ */
