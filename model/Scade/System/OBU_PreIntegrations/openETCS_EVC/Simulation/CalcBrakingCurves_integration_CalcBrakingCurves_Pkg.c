  ...
  outC_CalcBrakingCurves_integration_CalcBrakingCurves_Pkg *outC)
{
  ...
  kcg_size idx3;
  kcg_bool tmp;
  ParabolaCurve_T_CalcBrakingCurves_types tmp4;
  kcg_bool tmp5;
  ParabolaCurve_T_CalcBrakingCurves_types tmp6;
  ParabolaCurve_T_CalcBrakingCurves_types op_call;
  kcg_bool _7_op_call;
  ParabolaCurve_T_CalcBrakingCurves_types _8_op_call;
  kcg_bool _9_op_call;
  kcg_bool noname;
  kcg_int32 _10_noname;
  kcg_bool _11_noname;
  /* MRSPCurves/ */
  ParabolaCurve_list_MRSP_T_CalcBrakingCurves_types last_MRSPCurves;
