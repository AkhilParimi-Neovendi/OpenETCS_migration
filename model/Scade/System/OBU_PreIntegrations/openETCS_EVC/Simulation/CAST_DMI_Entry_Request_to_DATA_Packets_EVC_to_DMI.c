...
void CAST_DMI_Entry_Request_to_DATA_Packets_EVC_to_DMI(
  ...
  outC_CAST_DMI_Entry_Request_to_DATA_Packets_EVC_to_DMI *outC)
{
  ...
  CAST_DMI_List_Entry_Reque_DATA_Variables(
    outC->_L3,
    &outC->Context_CAST_DMI_List_Entry_Request_to_int_1);
  outC->_L7 =
    outC->Context_CAST_DMI_List_Entry_Request_to_int_1.dmi_list_entry_request_int;
  outC->_L2[0] = outC->_L6;
  outC->_L2[1] = outC->_L4;
  outC->_L2[2] = outC->_L7;
...
void CAST_DMI_Entry_Request_to_init_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_Entry_Request_to_DATA_Packets_EVC_to_DMI *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L7=(DATA::Variables::CAST_DMI_List_Entry_Request_to_int#1)/ */
  CAST_DMI_List_Entry_Reque_init_DATA_Variables(
    &outC->Context_CAST_DMI_List_Entry_Request_to_int_1);
  /* _L6=(Utilities::Bool_to_Int#1)/ */
...
void CAST_DMI_Entry_Request_to_reset_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_Entry_Request_to_DATA_Packets_EVC_to_DMI *outC)
{
  /* _L7=(DATA::Variables::CAST_DMI_List_Entry_Request_to_int#1)/ */
  CAST_DMI_List_Entry_Reque_reset_DATA_Variables(
    &outC->Context_CAST_DMI_List_Entry_Request_to_int_1);
  /* _L6=(Utilities::Bool_to_Int#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_Entry_Request_to_DATA_Packets_EVC_to_DMI.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
