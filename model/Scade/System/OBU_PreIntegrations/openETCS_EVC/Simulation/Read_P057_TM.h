...
typedef struct {
  ...
  P57_MovementAuthorityRequestParameters_T_Packet_Types_Pkg /* P057_OBU_out/ */ P057_OBU_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P057_compr_onboard_TM_conversions /* _L166=(TM_conversions::C_P057_compr_onboard#1)/ */ Context_C_P057_compr_onboard_1;
  ...
  P57_MovementAuthorityRequestParameters_T_Packet_Types_Pkg /* _L166/ */ _L166;
...
extern void Read_P057_init_TM(outC_Read_P057_TM *outC);
