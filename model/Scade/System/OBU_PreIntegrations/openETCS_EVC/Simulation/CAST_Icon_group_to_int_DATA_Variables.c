...
{
  /* Output1/ */
  Icon_group_INT_T_DATA Output1_partial;
  /* error/ */
  kcg_bool error_partial;
  /* Output1/ */
  Icon_group_INT_T_DATA _1_Output1_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* Output1/ */
  Icon_group_INT_T_DATA _3_Output1_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* Output1/ */
  Icon_group_INT_T_DATA _5_Output1_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* Output1/ */
  Icon_group_INT_T_DATA _7_Output1_partial;
  /* error/ */
  kcg_bool _8_error_partial;
  /* Output1/ */
  Icon_group_INT_T_DATA _9_Output1_partial;
  /* error/ */
  kcg_bool _10_error_partial;
  /* Output1/ */
  Icon_group_INT_T_DATA _11_Output1_partial;
  /* error/ */
  kcg_bool _12_error_partial;
  /* Output1/ */
  Icon_group_INT_T_DATA _13_Output1_partial;
  /* error/ */
  kcg_bool _14_error_partial;
  /* error/ */
  kcg_bool _15_error_partial;
  /* Output1/ */
  Icon_group_INT_T_DATA _16_Output1_partial;
  /* error/ */
  kcg_bool _17_error_partial;
  /* Output1/ */
  Icon_group_INT_T_DATA _18_Output1_partial;
  /* error/ */
  kcg_bool _19_error_partial;
  /* Output1/ */
  Icon_group_INT_T_DATA _20_Output1_partial;
  /* error/ */
  kcg_bool _21_error_partial;
  /* Output1/ */
  Icon_group_INT_T_DATA _22_Output1_partial;
  /* error/ */
  kcg_bool _23_error_partial;
  /* Output1/ */
  Icon_group_INT_T_DATA _24_Output1_partial;
  /* error/ */
  kcg_bool _25_error_partial;
  /* Output1/ */
  Icon_group_INT_T_DATA _26_Output1_partial;
  kcg_bool noname;
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              ...
              outC->_1_else_clock_else_else_else_else_else_IfBlock1 = Input1 ==
      ...
      if (outC->else_clock_else_IfBlock1) {
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            /* IfBlock1:else:else:else:else:else: */
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              outC->_L22_then_else_else_else_else_else_IfBlock1 =
                INT_Icon_group_T_settings_symbols;
              _18_Output1_partial = outC->_L22_then_else_else_else_else_else_IfBlock1;
  ...
  outC_CAST_Icon_group_to_int_DATA_Variables *outC)
{
  ...
  outC->_L22_then_else_else_else_else_else_IfBlock1 = kcg_lit_int32(0);
  outC->_1_else_clock_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_L3_else_else_else_else_else_else_else_IfBlock1 = kcg_lit_int32(0);
  outC->_L4_else_else_else_else_else_else_else_IfBlock1 = kcg_true;
