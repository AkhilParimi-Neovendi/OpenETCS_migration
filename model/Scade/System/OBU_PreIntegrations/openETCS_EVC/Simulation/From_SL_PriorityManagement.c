...
{
  /* FromSL_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg FromSL_To_NewMode_partial;
  /* FromSL_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _1_FromSL_To_NewMode_partial;
  /* FromSL_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _2_FromSL_To_NewMode_partial;
  /* FromSL_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _3_FromSL_To_NewMode_partial;
  /* FromSL_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _4_FromSL_To_NewMode_partial;
  /* FromSL_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _5_FromSL_To_NewMode_partial;
  /* FromSL_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _6_FromSL_To_NewMode_partial;
  /* FromSL_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _7_FromSL_To_NewMode_partial;
