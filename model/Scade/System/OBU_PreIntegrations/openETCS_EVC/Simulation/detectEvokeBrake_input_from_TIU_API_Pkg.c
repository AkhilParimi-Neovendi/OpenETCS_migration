...
{
  /* EB_RevokedByDriver/ */
  kcg_bool EB_RevokedByDriver_partial;
  /* brake_Management: */
  SSM_ST_brake_Management brake_Management_state_nxt_partial;
  /* brake_Management: */
  kcg_bool brake_Management_reset_nxt_partial;
  /* brake_Management: */
  SSM_TR_brake_Management brake_Management_fired_partial;
  /* brake_Management:TrainOperation:<1> */
  kcg_bool tr_1_guard_TrainOperation_brake_Management;
  /* EB_RevokedByDriver/ */
  kcg_bool _1_EB_RevokedByDriver_partial;
  /* brake_Management: */
  SSM_ST_brake_Management _2_brake_Management_state_nxt_partial;
  /* brake_Management: */
  kcg_bool _3_brake_Management_reset_nxt_partial;
  /* brake_Management: */
  SSM_TR_brake_Management _4_brake_Management_fired_partial;
  /* brake_Management:WatchBrakeMax:<2> */
  kcg_bool tr_2_guard_WatchBrakeMax_brake_Management;
  /* brake_Management:WatchBrakeMax:<1> */
  kcg_bool tr_1_guard_WatchBrakeMax_brake_Management;
  /* EB_RevokedByDriver/ */
  kcg_bool _5_EB_RevokedByDriver_partial;
  /* brake_Management: */
  SSM_ST_brake_Management _6_brake_Management_state_nxt_partial;
  /* brake_Management: */
  kcg_bool _7_brake_Management_reset_nxt_partial;
  /* brake_Management: */
  SSM_TR_brake_Management _8_brake_Management_fired_partial;
  /* brake_Management:BrakeMaxDone:<2> */
  kcg_bool tr_2_guard_BrakeMaxDone_brake_Management;
  /* brake_Management:BrakeMaxDone:<1> */
  kcg_bool tr_1_guard_BrakeMaxDone_brake_Management;
  /* EB_RevokedByDriver/ */
  kcg_bool _9_EB_RevokedByDriver_partial;
  /* brake_Management: */
  SSM_ST_brake_Management _10_brake_Management_state_nxt_partial;
  /* brake_Management: */
  kcg_bool _11_brake_Management_reset_nxt_partial;
  /* brake_Management: */
  SSM_TR_brake_Management _12_brake_Management_fired_partial;
  /* brake_Management:BrakeMinDone:<1> */
  kcg_bool tr_1_guard_BrakeMinDone_brake_Management;
  /* EB_RevokedByDriver/ */
  kcg_bool _13_EB_RevokedByDriver_partial;
  /* brake_Management: */
  SSM_ST_brake_Management _14_brake_Management_state_nxt_partial;
  /* brake_Management: */
  kcg_bool _15_brake_Management_reset_nxt_partial;
  /* brake_Management: */
  SSM_TR_brake_Management _16_brake_Management_fired_partial;
  /* brake_Management:Wait_forStartWindow:<2> */
  kcg_bool tr_2_guard_Wait_forStartWindow_brake_Management;
  /* brake_Management:Wait_forStartWindow:<1> */
  kcg_bool tr_1_guard_Wait_forStartWindow_brake_Management;
  /* EB_RevokedByDriver/ */
  kcg_bool last_EB_RevokedByDriver;
  /* brake_Management: */
  kcg_bool brake_Management_reset_sel;
  /* brake_Management: */
  kcg_bool brake_Management_reset_prv;
