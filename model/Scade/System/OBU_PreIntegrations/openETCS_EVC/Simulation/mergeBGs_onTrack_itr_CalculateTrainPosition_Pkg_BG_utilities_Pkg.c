  ...
  outC_mergeBGs_onTrack_itr_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  ...
  for (idx3 = 0; idx3 < 41; idx3++) {
    ...
    outC->_L14.BGs[idx3].nid_c = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].nid_bg = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].q_link = Q_LINK_Unlinked;
    outC->_L14.BGs[idx3].location.nominal = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].location.d_min = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].location.d_max = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].infoFromLinking.valid = kcg_true;
    outC->_L14.BGs[idx3].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].infoFromLinking.expectedLocation.nominal =
      kcg_lit_int32(0);
    outC->_L14.BGs[idx3].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L14.BGs[idx3].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L14.BGs[idx3].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L14.BGs[idx3].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L14.BGs[idx3].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L14.BGs[idx3].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L14.BGs[idx3].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L14.BGs[idx3].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L14.BGs[idx3].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L14.BGs[idx3].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L14.BGs[idx3].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx2 = 0; idx2 < 33; idx2++) {
      ...
      outC->_L14.BGs[idx3].infoFromPassing.linkedBGs[idx2].q_scale =
        Q_SCALE_10_cm_scale;
      outC->_L14.BGs[idx3].infoFromPassing.linkedBGs[idx2].d_link = kcg_lit_int32(0);
      outC->_L14.BGs[idx3].infoFromPassing.linkedBGs[idx2].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L14.BGs[idx3].infoFromPassing.linkedBGs[idx2].nid_c = kcg_lit_int32(0);
      outC->_L14.BGs[idx3].infoFromPassing.linkedBGs[idx2].nid_bg = kcg_lit_int32(0);
  ...
  for (idx5 = 0; idx5 < 41; idx5++) {
    ...
    outC->_L12[idx5].nid_c = kcg_lit_int32(0);
    outC->_L12[idx5].nid_bg = kcg_lit_int32(0);
    outC->_L12[idx5].q_link = Q_LINK_Unlinked;
    outC->_L12[idx5].location.nominal = kcg_lit_int32(0);
    outC->_L12[idx5].location.d_min = kcg_lit_int32(0);
    outC->_L12[idx5].location.d_max = kcg_lit_int32(0);
    outC->_L12[idx5].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L12[idx5].infoFromLinking.valid = kcg_true;
    outC->_L12[idx5].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L12[idx5].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L12[idx5].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L12[idx5].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L12[idx5].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L12[idx5].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L12[idx5].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L12[idx5].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L12[idx5].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L12[idx5].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L12[idx5].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L12[idx5].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L12[idx5].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L12[idx5].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    outC->_L12[idx5].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L12[idx5].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L12[idx5].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L12[idx5].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L12[idx5].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L12[idx5].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L12[idx5].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L12[idx5].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L12[idx5].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx4 = 0; idx4 < 33; idx4++) {
      ...
      outC->_L12[idx5].infoFromPassing.linkedBGs[idx4].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L12[idx5].infoFromPassing.linkedBGs[idx4].d_link = kcg_lit_int32(0);
      outC->_L12[idx5].infoFromPassing.linkedBGs[idx4].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L12[idx5].infoFromPassing.linkedBGs[idx4].nid_c = kcg_lit_int32(0);
      outC->_L12[idx5].infoFromPassing.linkedBGs[idx4].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L12[idx5].infoFromPassing.linkedBGs[idx4].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L12[idx5].infoFromPassing.linkedBGs[idx4].q_locacc = kcg_lit_int32(0);
    }
  ...
  for (idx7 = 0; idx7 < 41; idx7++) {
    ...
    outC->_L2.BGs[idx7].nid_c = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].nid_bg = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].q_link = Q_LINK_Unlinked;
    outC->_L2.BGs[idx7].location.nominal = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].location.d_min = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].location.d_max = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].infoFromLinking.valid = kcg_true;
    outC->_L2.BGs[idx7].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L2.BGs[idx7].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L2.BGs[idx7].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L2.BGs[idx7].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L2.BGs[idx7].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L2.BGs[idx7].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L2.BGs[idx7].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L2.BGs[idx7].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L2.BGs[idx7].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L2.BGs[idx7].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L2.BGs[idx7].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx6 = 0; idx6 < 33; idx6++) {
      ...
      outC->_L2.BGs[idx7].infoFromPassing.linkedBGs[idx6].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L2.BGs[idx7].infoFromPassing.linkedBGs[idx6].q_scale =
        Q_SCALE_10_cm_scale;
      outC->_L2.BGs[idx7].infoFromPassing.linkedBGs[idx6].d_link = kcg_lit_int32(0);
      outC->_L2.BGs[idx7].infoFromPassing.linkedBGs[idx6].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L2.BGs[idx7].infoFromPassing.linkedBGs[idx6].nid_c = kcg_lit_int32(0);
      outC->_L2.BGs[idx7].infoFromPassing.linkedBGs[idx6].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L2.BGs[idx7].infoFromPassing.linkedBGs[idx6].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L2.BGs[idx7].infoFromPassing.linkedBGs[idx6].q_locacc = kcg_lit_int32(0);
    }
  ...
  for (idx8 = 0; idx8 < 33; idx8++) {
    ...
    outC->_L1.infoFromPassing.linkedBGs[idx8].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L1.infoFromPassing.linkedBGs[idx8].d_link = kcg_lit_int32(0);
    outC->_L1.infoFromPassing.linkedBGs[idx8].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L1.infoFromPassing.linkedBGs[idx8].nid_c = kcg_lit_int32(0);
    outC->_L1.infoFromPassing.linkedBGs[idx8].nid_bg = kcg_lit_int32(0);
    outC->_L1.infoFromPassing.linkedBGs[idx8].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L1.infoFromPassing.linkedBGs[idx8].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L1.infoFromPassing.linkedBGs[idx8].q_locacc = kcg_lit_int32(0);
  }
  outC->_L1.missed = kcg_true;
  for (idx10 = 0; idx10 < 41; idx10++) {
    outC->BGs_out.BGs[idx10].valid = kcg_true;
    outC->BGs_out.BGs[idx10].nid_c = kcg_lit_int32(0);
    outC->BGs_out.BGs[idx10].nid_bg = kcg_lit_int32(0);
    outC->BGs_out.BGs[idx10].q_link = Q_LINK_Unlinked;
    outC->BGs_out.BGs[idx10].location.nominal = kcg_lit_int32(0);
    outC->BGs_out.BGs[idx10].location.d_min = kcg_lit_int32(0);
    outC->BGs_out.BGs[idx10].location.d_max = kcg_lit_int32(0);
    outC->BGs_out.BGs[idx10].seqNoOnTrack = kcg_lit_int32(0);
    outC->BGs_out.BGs[idx10].infoFromLinking.valid = kcg_true;
    outC->BGs_out.BGs[idx10].infoFromLinking.nid_bg_fromLinkingBG =
      kcg_lit_int32(0);
    outC->BGs_out.BGs[idx10].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    ...
    outC->BGs_out.BGs[idx10].infoFromLinking.expectedLocation.d_max =
      kcg_lit_int32(0);
    outC->BGs_out.BGs[idx10].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->BGs_out.BGs[idx10].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->BGs_out.BGs[idx10].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    ...
    outC->BGs_out.BGs[idx10].infoFromLinking.linkingInfo.q_scale =
      Q_SCALE_10_cm_scale;
    outC->BGs_out.BGs[idx10].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->BGs_out.BGs[idx10].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->BGs_out.BGs[idx10].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->BGs_out.BGs[idx10].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    ...
    outC->BGs_out.BGs[idx10].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->BGs_out.BGs[idx10].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->BGs_out.BGs[idx10].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->BGs_out.BGs[idx10].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
