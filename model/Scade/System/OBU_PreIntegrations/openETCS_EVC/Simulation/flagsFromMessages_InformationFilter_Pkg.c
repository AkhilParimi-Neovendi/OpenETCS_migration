  ...
  outC_flagsFromMessages_InformationFilter_Pkg *outC)
{
  ...
  kcg_bool L2L3_transitionPending_partial;
  /* L1_transitionPending/ */
  kcg_bool L1_transitionPending_partial;
  /* NTC_transitionPending/ */
  kcg_bool NTC_transitionPending_partial;
  /* L2L3_transitionPending/ */
  kcg_bool _1_L2L3_transitionPending_partial;
  /* L1_transitionPending/ */
  kcg_bool _2_L1_transitionPending_partial;
  /* NTC_transitionPending/ */
  kcg_bool _3_NTC_transitionPending_partial;
  /* NTC_transitionPending/ */
  kcg_bool _4_NTC_transitionPending_partial;
  /* L1_transitionPending/ */
  kcg_bool _5_L1_transitionPending_partial;
  /* L2L3_transitionPending/ */
  kcg_bool _6_L2L3_transitionPending_partial;
  /* NTC_transitionPending/ */
  kcg_bool _7_NTC_transitionPending_partial;
  /* L1_transitionPending/ */
  kcg_bool _8_L1_transitionPending_partial;
  /* L2L3_transitionPending/ */
  kcg_bool _9_L2L3_transitionPending_partial;
  P012_OBU_T_TM noname;
  P015_OBU_T_TM _10_noname;
  P021_OBU_T_TM _11_noname;
  kcg_bool _12_noname;
  kcg_bool _13_noname;
  /* NTC_transitionPending/ */
  kcg_bool last_NTC_transitionPending;
  /* p27valid/ */
  kcg_bool last_p27valid;
  /* p21valid/ */
  kcg_bool last_p21valid;
  /* p15valid/ */
  kcg_bool last_p15valid;
  /* p12valid/ */
  kcg_bool last_p12valid;
  /* L1_transitionPending/ */
  kcg_bool last_L1_transitionPending;
  /* L2L3_transitionPending/ */
  kcg_bool last_L2L3_transitionPending;
