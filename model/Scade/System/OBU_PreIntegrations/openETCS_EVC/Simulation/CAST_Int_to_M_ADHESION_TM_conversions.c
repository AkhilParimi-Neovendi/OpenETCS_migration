...
{
  /* m_adhesion/ */
  M_ADHESION m_adhesion_partial;
  /* error/ */
  kcg_bool error_partial;
  /* m_adhesion/ */
  M_ADHESION _1_m_adhesion_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* error/ */
  kcg_bool _3_error_partial;
  /* m_adhesion/ */
  M_ADHESION _4_m_adhesion_partial;
  /* error/ */
  kcg_bool _5_error_partial;
  /* m_adhesion/ */
  M_ADHESION _6_m_adhesion_partial;
  kcg_bool noname;
  ...
  outC_CAST_Int_to_M_ADHESION_TM_conversions *outC)
{
  ...
  outC->m_adhesion_in = kcg_lit_int32(0);
  outC->error = kcg_true;
