...
typedef struct {
  ...
  outC_WriteDirection2PassedBG_CheckBGConsistency_Pkg_SubFunction /* IfBlock1:else:then:_L23=(CheckBGConsistency_Pkg::SubFunction::WriteDirection2PassedBG#2)/ */ _1_Context_WriteDirection2PassedBG_2;
