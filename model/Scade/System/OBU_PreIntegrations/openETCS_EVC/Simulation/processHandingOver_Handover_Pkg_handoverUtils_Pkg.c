...
{
  msgFromTrack_T_RCM_MsgTypes_Pkg noname;
  msgFromTrack_T_RCM_MsgTypes_Pkg _1_noname;
  kcg_bool _2_noname;
  kcg_bool _3_noname;
  kcg_bool _4_noname;
  /* handoverFinished/ */
  ...
  kcg_bool last_useInformationFromAcceptingRBC_loc;
  /* handoverInprogress/ */
  kcg_bool last_handoverInprogress;
  ...
  kcg_copy_msgFromTrack_T_RCM_MsgTypes_Pkg(
    &outC->_L246,
    &outC->Context_handOverSequencer_1._1_p45_radioNetworkRegistrationOrder_for_acceptingRBC);
  outC->_L3 =
  ...
  kcg_copy_msgFromTrack_T_RCM_MsgTypes_Pkg(
    &outC->_L38,
    &outC->Context_mobileCtrlCmdRouter_out_1._1_p45_radioNetworkRegistrationOrder_2);
  kcg_copy_msgFromTrack_T_RCM_MsgTypes_Pkg(
    &outC->_L36,
    &outC->Context_mobileCtrlCmdRouter_out_1.p42_sessionCmd_for_RBC_2);
  kcg_copy_msgFromTrack_T_RCM_MsgTypes_Pkg(
    &outC->_L229,
    &outC->Context_mobileCtrlCmdRouter_out_1._2_additionalSessionCmdsFromTrack_for_RBC_2);
  ...
  processRadioCtrlCmds_v2_Handover_Pkg_handoverUtils_Pkg(
    ...
    &outC->_L43,
    outC->_L128,
    &outC->_1_Context_processRadioCtrlCmds_v2_1);
  kcg_copy_msgFromTrack_T_RCM_MsgTypes_Pkg(
    &outC->_L245,
    &outC->_1_Context_processRadioCtrlCmds_v2_1.sessionCmds_2_MoRC);
  kcg_copy_msgFromTrack_T_RCM_MsgTypes_Pkg(
