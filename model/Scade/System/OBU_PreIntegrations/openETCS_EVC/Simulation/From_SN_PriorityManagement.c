...
{
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _1_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _2_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _3_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _4_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _5_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _6_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _7_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _8_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _9_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _10_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _11_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _12_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _13_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _14_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _15_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _16_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _17_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _18_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _19_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _20_FromSN_To_NewMode_partial;
  /* FromSN_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _21_FromSN_To_NewMode_partial;
            ...
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              ...
              if (outC->_5_else_clock_else_else_else_else_else_IfBlock1) {
                ...
                if (outC->_1_else_clock_else_else_else_else_else_else_IfBlock1) {
                  ...
                  outC->_4_else_clock_else_else_else_else_else_else_else_IfBlock1 = Condition21;
