...
{
  /* Trip_Requested/ */
  kcg_bool Trip_Requested_partial;
  /* Trip_Requested/ */
  kcg_bool _1_Trip_Requested_partial;
  /* Trip_Requested/ */
  kcg_bool _2_Trip_Requested_partial;
  /* Trip_Requested/ */
  kcg_bool _3_Trip_Requested_partial;
  /* Trip_Requested/ */
  kcg_bool _4_Trip_Requested_partial;
  /* Trip_Requested/ */
  kcg_bool _5_Trip_Requested_partial;
  T_LevelTransition_PriorityTable_Level_And_Mode_Types_Pkg noname;
  T_LevelTransition_PriorityTable_Level_And_Mode_Types_Pkg _6_noname;
