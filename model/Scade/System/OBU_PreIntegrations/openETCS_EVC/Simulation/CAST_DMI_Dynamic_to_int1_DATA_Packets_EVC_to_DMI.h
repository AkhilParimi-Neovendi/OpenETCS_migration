...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_CAST_connectionStatusRadi_DATA_Variables /* _L32=(DATA::Variables::CAST_connectionStatusRadioUnit_to_int#1)/ */ Context_CAST_connectionStatusRadioUnit_to_int_1;
  outC_CAST_M_SUPERVISION_STATUS_DATA_Variables /* _L31=(DATA::Variables::CAST_M_SUPERVISION_STATUS_to_int#1)/ */ Context_CAST_M_SUPERVISION_STATUS_to_int_1;
  outC_CAST_M_SupervisionDisplay_DATA_Variables /* _L29=(DATA::Variables::CAST_M_SupervisionDisplay_to_int#1)/ */ Context_CAST_M_SupervisionDisplay_to_int_1;
