...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  kcg_bool /* cont/ */ cont;
  P012_section_enum_T_TM /* sections/ */ sections;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_CAST_Int_to_L_SECTION_TM_conversions /* _L25=(TM_conversions::CAST_Int_to_L_SECTION#1)/ */ Context_CAST_Int_to_L_SECTION_1;
  outC_C_P012_extract_el_section_TM_lib_internal /* _L15=(TM_lib_internal::C_P012_extract_el_section#1)/ */ Context_C_P012_extract_el_section_1;
  ...
  outC_C_P012_extract_el_section_TM_lib_internal /* _L20=(TM_lib_internal::C_P012_extract_el_section#3)/ */ _1_Context_C_P012_extract_el_section_3;
  ...
  outC_C_P012_extract_el_section_TM_lib_internal /* _L19=(TM_lib_internal::C_P012_extract_el_section#2)/ */ _2_Context_C_P012_extract_el_section_2;
  outC_CAST_Int_to_D_SECTIONTIME_TM_conversions /* _L27=(TM_conversions::CAST_Int_to_D_SECTIONTIMERSTOPLOC#1)/ */ Context_CAST_Int_to_D_SECTIONTIMERSTOPLOC_1;
  outC_C_P012_extract_el_section_TM_lib_internal /* _L21=(TM_lib_internal::C_P012_extract_el_section#4)/ */ _3_Context_C_P012_extract_el_section_4;
...
extern void C_P012_us_array_init_TM_lib_internal(
  outC_C_P012_us_array_TM_lib_internal *outC);
