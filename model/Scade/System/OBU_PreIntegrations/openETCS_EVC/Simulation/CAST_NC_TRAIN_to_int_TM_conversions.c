...
{
  /* nc_train_int/ */
  kcg_int32 nc_train_int_partial;
  /* error/ */
  kcg_bool error_partial;
  /* nc_train_int/ */
  kcg_int32 _1_nc_train_int_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* nc_train_int/ */
  kcg_int32 _3_nc_train_int_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* nc_train_int/ */
  kcg_int32 _5_nc_train_int_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* error/ */
  kcg_bool _7_error_partial;
  /* nc_train_int/ */
  kcg_int32 _8_nc_train_int_partial;
  /* error/ */
  kcg_bool _9_error_partial;
  /* nc_train_int/ */
  kcg_int32 _10_nc_train_int_partial;
  /* error/ */
  kcg_bool _11_error_partial;
  /* nc_train_int/ */
  kcg_int32 _12_nc_train_int_partial;
  /* error/ */
  kcg_bool _13_error_partial;
  /* nc_train_int/ */
  kcg_int32 _14_nc_train_int_partial;
  kcg_bool noname;
