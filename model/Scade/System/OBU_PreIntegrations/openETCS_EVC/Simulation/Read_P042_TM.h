...
typedef struct {
  ...
  P42_SessionManagement_T_Packet_Types_Pkg /* P042_OBU_out/ */ P042_OBU_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P042_compr_onboard_TM_conversions /* _L166=(TM_conversions::C_P042_compr_onboard#2)/ */ Context_C_P042_compr_onboard_2;
  ...
  P42_SessionManagement_T_Packet_Types_Pkg /* _L166/ */ _L166;
...
extern void Read_P042_init_TM(outC_Read_P042_TM *outC);
