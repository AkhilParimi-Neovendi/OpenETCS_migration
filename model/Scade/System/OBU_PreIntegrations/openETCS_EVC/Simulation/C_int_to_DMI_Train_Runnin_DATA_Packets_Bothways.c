...
void C_int_to_DMI_Train_Runnin_DATA_Packets_Bothways(
...
void C_int_to_DMI_Train_Runnin_init_DATA_Packets_Bothways(
  outC_C_int_to_DMI_Train_Runnin_DATA_Packets_Bothways *outC)
{
  kcg_size idx;
...
void C_int_to_DMI_Train_Runnin_reset_DATA_Packets_Bothways(
  outC_C_int_to_DMI_Train_Runnin_DATA_Packets_Bothways *outC)
{
  /* _L6=(TM_conversions::CAST_Int_to_NID_OPERATIONAL#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** C_int_to_DMI_Train_Runnin_DATA_Packets_Bothways.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
