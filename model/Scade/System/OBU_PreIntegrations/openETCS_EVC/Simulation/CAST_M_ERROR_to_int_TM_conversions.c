...
{
  /* m_error_int/ */
  kcg_int32 m_error_int_partial;
  /* error/ */
  kcg_bool error_partial;
  /* m_error_int/ */
  kcg_int32 _1_m_error_int_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* m_error_int/ */
  kcg_int32 _3_m_error_int_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* m_error_int/ */
  kcg_int32 _5_m_error_int_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* m_error_int/ */
  kcg_int32 _7_m_error_int_partial;
  /* error/ */
  kcg_bool _8_error_partial;
  /* m_error_int/ */
  kcg_int32 _9_m_error_int_partial;
  /* error/ */
  kcg_bool _10_error_partial;
  /* m_error_int/ */
  kcg_int32 _11_m_error_int_partial;
  /* error/ */
  kcg_bool _12_error_partial;
  /* m_error_int/ */
  kcg_int32 _13_m_error_int_partial;
  /* error/ */
  kcg_bool _14_error_partial;
  /* m_error_int/ */
  kcg_int32 _15_m_error_int_partial;
  /* error/ */
  kcg_bool _16_error_partial;
  /* m_error_int/ */
  kcg_int32 _17_m_error_int_partial;
  /* error/ */
  kcg_bool _18_error_partial;
  /* error/ */
  kcg_bool _19_error_partial;
  /* m_error_int/ */
  kcg_int32 _20_m_error_int_partial;
  /* error/ */
  kcg_bool _21_error_partial;
  /* m_error_int/ */
  kcg_int32 _22_m_error_int_partial;
  /* error/ */
  kcg_bool _23_error_partial;
  /* m_error_int/ */
  kcg_int32 _24_m_error_int_partial;
  /* error/ */
  kcg_bool _25_error_partial;
  /* m_error_int/ */
  kcg_int32 _26_m_error_int_partial;
  /* error/ */
  kcg_bool _27_error_partial;
  /* m_error_int/ */
  kcg_int32 _28_m_error_int_partial;
  /* error/ */
  kcg_bool _29_error_partial;
  /* m_error_int/ */
  kcg_int32 _30_m_error_int_partial;
  /* error/ */
  kcg_bool _31_error_partial;
  /* m_error_int/ */
  kcg_int32 _32_m_error_int_partial;
  /* error/ */
  kcg_bool _33_error_partial;
  /* m_error_int/ */
  kcg_int32 _34_m_error_int_partial;
  kcg_bool noname;
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              outC->_L29_then_else_else_else_else_else_IfBlock1 =
                INT_M_ERROR_Radio_safe_radio_connection_error_TM_conversions;
              _26_m_error_int_partial = outC->_L29_then_else_else_else_else_else_IfBlock1;
              outC->_L18_then_else_else_else_else_else_IfBlock1 = kcg_false;
              _25_error_partial = outC->_L18_then_else_else_else_else_else_IfBlock1;
              ...
              if (outC->_3_else_clock_else_else_else_else_else_IfBlock1) {
                ...
                if (outC->_1_else_clock_else_else_else_else_else_else_IfBlock1) {
                  outC->_L26_then_else_else_else_else_else_else_else_IfBlock1 = kcg_false;
                  outC->_L17_then_else_else_else_else_else_else_else_IfBlock1 =
                    INT_M_ERROR_Safety_critical_failure_TM_conversions;
                  _22_m_error_int_partial =
                    outC->_L17_then_else_else_else_else_else_else_else_IfBlock1;
                  _21_error_partial = outC->_L26_then_else_else_else_else_else_else_else_IfBlock1;
                  ...
                  if (outC->_2_else_clock_else_else_else_else_else_else_else_IfBlock1) {
                    outC->_L25_then_else_else_else_else_else_else_else_else_IfBlock1 = kcg_false;
                    _16_error_partial =
  ...
  outC_CAST_M_ERROR_to_int_TM_conversions *outC)
{
  ...
  outC->_L29_then_else_else_else_else_else_IfBlock1 = kcg_lit_int32(0);
  outC->_L18_then_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_3_else_clock_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_L17_then_else_else_else_else_else_else_else_IfBlock1 = kcg_lit_int32(0);
