  ...
  outC_v_SBI2_TargetLimits_Pkg *outC)
{
  ...
  kcg_bool _1_op_call;
  V_internal_real_Type_SDM_Types_Pkg _2_op_call;
  kcg_bool _3_op_call;
  L_internal_real_Type_SDM_Types_Pkg _4_op_call;
  kcg_bool _5_op_call;
  kcg_bool noname;
  kcg_bool _6_noname;
...
void v_SBI2_init_TargetLimits_Pkg(outC_v_SBI2_TargetLimits_Pkg *outC)
{
  ...
  for (idx = 0; idx < 114; idx++) {
    outC->_L56.distances[idx] = kcg_lit_float32(0.0);
  }
  for (idx1 = 0; idx1 < 114; idx1++) {
    outC->_L56.speeds[idx1] = kcg_lit_float32(0.0);
  }
  for (idx2 = 0; idx2 < 114; idx2++) {
    outC->_L56.accelerations[idx2] = kcg_lit_float32(0.0);
  }
  ...
  for (idx4 = 0; idx4 < 114; idx4++) {
    outC->_L42.distances[idx4] = kcg_lit_float32(0.0);
  }
  for (idx5 = 0; idx5 < 114; idx5++) {
    outC->_L42.speeds[idx5] = kcg_lit_float32(0.0);
  }
  for (idx6 = 0; idx6 < 114; idx6++) {
    outC->_L42.accelerations[idx6] = kcg_lit_float32(0.0);
  }
  ...
  for (idx8 = 0; idx8 < 114; idx8++) {
    outC->_L20.distances[idx8] = kcg_lit_float32(0.0);
  }
  for (idx9 = 0; idx9 < 114; idx9++) {
    outC->_L20.speeds[idx9] = kcg_lit_float32(0.0);
  }
  for (idx10 = 0; idx10 < 114; idx10++) {
    outC->_L20.accelerations[idx10] = kcg_lit_float32(0.0);
  }
  ...
  for (idx12 = 0; idx12 < 114; idx12++) {
    outC->_L17.distances[idx12] = kcg_lit_float32(0.0);
  }
  for (idx13 = 0; idx13 < 114; idx13++) {
    outC->_L17.speeds[idx13] = kcg_lit_float32(0.0);
  }
  for (idx14 = 0; idx14 < 114; idx14++) {
    outC->_L17.accelerations[idx14] = kcg_lit_float32(0.0);
  }
  for (idx15 = 0; idx15 < 114; idx15++) {
    outC->_L17.valid[idx15] = kcg_true;
  }
  outC->_L16 = kcg_lit_float32(0.0);
  outC->_L15.v = kcg_lit_float32(0.0);
  outC->_L15.d = kcg_lit_float32(0.0);
  outC->_L14 = kcg_lit_float32(0.0);
  outC->_L13 = kcg_lit_float32(0.0);
  outC->_L11 = kcg_true;
  outC->_L8 = kcg_lit_float32(0.0);
  outC->_L7.Traction = kcg_lit_float32(0.0);
  outC->_L7.berem = kcg_lit_float32(0.0);
  outC->_L7.bs = kcg_lit_float32(0.0);
  outC->_L7.bs1 = kcg_lit_float32(0.0);
  outC->_L7.bs2 = kcg_lit_float32(0.0);
  outC->_L7.inhComp = kcg_true;
  outC->_L7.indication = kcg_lit_float32(0.0);
  ...
  outC->every = kcg_true;
  outC->V_SBI2 = kcg_lit_float32(0.0);
  outC->valid = kcg_true;
  /* _L47=(TargetLimits_Pkg::selectLEValid#1)/ */
