...
void Write_int_to_DMI_Text_Mes_DATA_Packets_DMI_to_EVC(
  /* dmi_text_message_ack_int/ */
  DMI_Text_Message_Ack_int_array_T_DATA *dmi_text_message_ack_int,
  outC_Write_int_to_DMI_Text_Mes_DATA_Packets_DMI_to_EVC *outC)
{
  DMI_Text_Message_Ack_T_DMI_Messages_DMI_to_EVC_Pkg op_call;
...
void Write_int_to_DMI_Text_Mes_init_DATA_Packets_DMI_to_EVC(
  outC_Write_int_to_DMI_Text_Mes_DATA_Packets_DMI_to_EVC *outC)
{
  kcg_size idx;
  ...
  outC->_L12.textMessage_ID = kcg_lit_int32(0);
  ...
  outC->dmi_text_message_ack_ct.systemTime = kcg_lit_int32(0);
  outC->dmi_text_message_ack_ct.textMessage_ID = kcg_lit_int32(0);
...
void Write_int_to_DMI_Text_Mes_reset_DATA_Packets_DMI_to_EVC(
  outC_Write_int_to_DMI_Text_Mes_DATA_Packets_DMI_to_EVC *outC)
{
  /* _L12=(DATA::Packets::DMI_to_EVC::C_int_to_DMI_Text_Message_Ack#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Write_int_to_DMI_Text_Mes_DATA_Packets_DMI_to_EVC.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
