...
{
  /* preindicationLoc/ */
  L_internal_Type_Obu_BasicTypes_Pkg last_preindicationLoc;
  ...
  outC->_L10 = /* _L10= */(kcg_float32) outC->_L8;
  ...
  outC->_L11 = /* _L11= */(kcg_float32) outC->_L19;
  ...
  outC->_L2 = t_mar;
  outC->_L17 = /* _L17= */(kcg_float32) outC->_L2;
...
void op_3_8_2_3_a_init_TA_MA_Request(outC_op_3_8_2_3_a_TA_MA_Request *outC)
{
  ...
  outC->_L9.v_safeNominal = kcg_lit_int32(0);
  outC->_L9.v_rawNominal = kcg_lit_int32(0);
  outC->_L9.v_lower = kcg_lit_int32(0);
  outC->_L9.v_upper = kcg_lit_int32(0);
