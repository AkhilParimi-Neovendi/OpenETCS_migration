...
{
  /* m_mode_int/ */
  kcg_int32 m_mode_int_partial;
  /* error/ */
  kcg_bool error_partial;
  /* m_mode_int/ */
  kcg_int32 _1_m_mode_int_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* m_mode_int/ */
  kcg_int32 _3_m_mode_int_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* m_mode_int/ */
  kcg_int32 _5_m_mode_int_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* m_mode_int/ */
  kcg_int32 _7_m_mode_int_partial;
  /* error/ */
  kcg_bool _8_error_partial;
  /* m_mode_int/ */
  kcg_int32 _9_m_mode_int_partial;
  /* error/ */
  kcg_bool _10_error_partial;
  /* m_mode_int/ */
  kcg_int32 _11_m_mode_int_partial;
  /* error/ */
  kcg_bool _12_error_partial;
  /* m_mode_int/ */
  kcg_int32 _13_m_mode_int_partial;
  /* error/ */
  kcg_bool _14_error_partial;
  /* m_mode_int/ */
  kcg_int32 _15_m_mode_int_partial;
  /* error/ */
  kcg_bool _16_error_partial;
  /* m_mode_int/ */
  kcg_int32 _17_m_mode_int_partial;
  /* error/ */
  kcg_bool _18_error_partial;
  /* m_mode_int/ */
  kcg_int32 _19_m_mode_int_partial;
  /* error/ */
  kcg_bool _20_error_partial;
  /* m_mode_int/ */
  kcg_int32 _21_m_mode_int_partial;
  /* error/ */
  kcg_bool _22_error_partial;
  /* m_mode_int/ */
  kcg_int32 _23_m_mode_int_partial;
  /* error/ */
  kcg_bool _24_error_partial;
  /* m_mode_int/ */
  kcg_int32 _25_m_mode_int_partial;
  /* error/ */
  kcg_bool _26_error_partial;
  /* m_mode_int/ */
  kcg_int32 _27_m_mode_int_partial;
  /* error/ */
  kcg_bool _28_error_partial;
  /* m_mode_int/ */
  kcg_int32 _29_m_mode_int_partial;
  /* error/ */
  kcg_bool _30_error_partial;
  /* error/ */
  kcg_bool _31_error_partial;
  /* m_mode_int/ */
  kcg_int32 _32_m_mode_int_partial;
  /* error/ */
  kcg_bool _33_error_partial;
  /* m_mode_int/ */
  kcg_int32 _34_m_mode_int_partial;
  /* error/ */
  kcg_bool _35_error_partial;
  /* m_mode_int/ */
  kcg_int32 _36_m_mode_int_partial;
  /* error/ */
  kcg_bool _37_error_partial;
  /* m_mode_int/ */
  kcg_int32 _38_m_mode_int_partial;
  /* error/ */
  kcg_bool _39_error_partial;
  /* m_mode_int/ */
  kcg_int32 _40_m_mode_int_partial;
  /* error/ */
  kcg_bool _41_error_partial;
  /* m_mode_int/ */
  kcg_int32 _42_m_mode_int_partial;
  /* error/ */
  kcg_bool _43_error_partial;
  /* m_mode_int/ */
  kcg_int32 _44_m_mode_int_partial;
  /* error/ */
  kcg_bool _45_error_partial;
  /* m_mode_int/ */
  kcg_int32 _46_m_mode_int_partial;
  /* error/ */
  kcg_bool _47_error_partial;
  /* m_mode_int/ */
  kcg_int32 _48_m_mode_int_partial;
  /* error/ */
  kcg_bool _49_error_partial;
  /* m_mode_int/ */
  kcg_int32 _50_m_mode_int_partial;
  /* error/ */
  kcg_bool _51_error_partial;
  /* m_mode_int/ */
  kcg_int32 _52_m_mode_int_partial;
  /* error/ */
  kcg_bool _53_error_partial;
  /* m_mode_int/ */
  kcg_int32 _54_m_mode_int_partial;
  /* error/ */
  kcg_bool _55_error_partial;
  /* m_mode_int/ */
  kcg_int32 _56_m_mode_int_partial;
  /* error/ */
  kcg_bool _57_error_partial;
  /* m_mode_int/ */
  kcg_int32 _58_m_mode_int_partial;
  /* error/ */
  kcg_bool _59_error_partial;
  /* m_mode_int/ */
  kcg_int32 _60_m_mode_int_partial;
  /* error/ */
  kcg_bool _61_error_partial;
  /* m_mode_int/ */
  kcg_int32 _62_m_mode_int_partial;
  kcg_bool noname;
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              outC->_L427_then_else_else_else_else_else_IfBlock1 = kcg_false;
              _53_error_partial = outC->_L427_then_else_else_else_else_else_IfBlock1;
              ...
              if (outC->_10_else_clock_else_else_else_else_else_IfBlock1) {
                ...
                if (outC->_1_else_clock_else_else_else_else_else_else_IfBlock1) {
                  outC->_L425_then_else_else_else_else_else_else_else_IfBlock1 = kcg_false;
                  _49_error_partial =
                    outC->_L425_then_else_else_else_else_else_else_else_IfBlock1;
                  ...
                  if (outC->_9_else_clock_else_else_else_else_else_else_else_IfBlock1) {
                    ...
                    if (outC->_2_else_clock_else_else_else_else_else_else_else_else_IfBlock1) {
                      outC->_L423_then_else_else_else_else_else_else_else_else_else_IfBlock1 =
                        kcg_false;
                      _45_error_partial =
                        outC->_L423_then_else_else_else_else_else_else_else_else_else_IfBlock1;
                      ...
                      if (outC->_8_else_clock_else_else_else_else_else_else_else_else_else_IfBlock1) {
                        ...
                        if (outC->_3_else_clock_else_else_else_else_else_else_else_else_else_else_IfBlock1) {
                          outC->_L420_then_else_else_else_else_else_else_else_else_else_else_else_IfBlock1 =
                            kcg_false;
                          _41_error_partial =
                            outC->_L420_then_else_else_else_else_else_else_else_else_else_else_else_IfBlock1;
                          ...
                          if (outC->_7_else_clock_else_else_else_else_else_else_else_else_else_else_else_IfBlock1) {
                            ...
                            if (outC->_4_else_clock_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1) {
                              ...
                              if (outC->_6_else_clock_else_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1) {
                                outC->_L214_then_else_else_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1 =
                                  kcg_false;
                                _28_error_partial =
                                  outC->_L214_then_else_else_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1;
                                ...
                                if (outC->_5_else_clock_else_else_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1) {
                                  outC->_L217_then_else_else_else_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1 =
                                    kcg_false;
                                  _33_error_partial =
                                    outC->_L217_then_else_else_else_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1;
      ...
      if (outC->else_clock_else_IfBlock1) {
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            /* IfBlock1:else:else:else:else:else: */
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              outC->_L226_then_else_else_else_else_else_IfBlock1 =
                INT_M_MODE_On_Sight_TM_conversions;
              _54_m_mode_int_partial = outC->_L226_then_else_else_else_else_else_IfBlock1;
              ...
              if (outC->_10_else_clock_else_else_else_else_else_IfBlock1) {
                ...
                /* IfBlock1:else:else:else:else:else:else:else: */
                if (outC->_1_else_clock_else_else_else_else_else_else_IfBlock1) {
                  outC->_L224_then_else_else_else_else_else_else_else_IfBlock1 =
                  ...
                  if (outC->_9_else_clock_else_else_else_else_else_else_else_IfBlock1) {
                    ...
                    /* IfBlock1:else:else:else:else:else:else:else:else:else: */
                    if (outC->_2_else_clock_else_else_else_else_else_else_else_else_IfBlock1) {
                      outC->_L222_then_else_else_else_else_else_else_else_else_else_IfBlock1 =
                      ...
                      if (outC->_8_else_clock_else_else_else_else_else_else_else_else_else_IfBlock1) {
                        ...
                        /* IfBlock1:else:else:else:else:else:else:else:else:else:else:else: */
                        if (outC->_3_else_clock_else_else_else_else_else_else_else_else_else_else_IfBlock1) {
                          outC->_L321_then_else_else_else_else_else_else_else_else_else_else_else_IfBlock1 =
                          ...
                          if (outC->_7_else_clock_else_else_else_else_else_else_else_else_else_else_else_IfBlock1) {
                            ...
                            /* IfBlock1:else:else:else:else:else:else:else:else:else:else:else:else:else: */
                            if (outC->_4_else_clock_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1) {
                              outC->_L318_then_else_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1 =
                              ...
                              /* IfBlock1:else:else:else:else:else:else:else:else:else:else:else:else:else:else: */
                              if (outC->_6_else_clock_else_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1) {
                                outC->_L315_then_else_else_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1 =
                                ...
                                /* IfBlock1:else:else:else:else:else:else:else:else:else:else:else:else:else:else:else: */
                                if (outC->_5_else_clock_else_else_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1) {
                                  outC->_L116_then_else_else_else_else_else_else_else_else_else_else_else_else_else_else_else_IfBlock1 =
  ...
  outC_CAST_M_MODE_to_int_TM_conversions *outC)
{
  ...
  outC->_L427_then_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_L226_then_else_else_else_else_else_IfBlock1 = kcg_lit_int32(0);
  outC->_10_else_clock_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_L425_then_else_else_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_L224_then_else_else_else_else_else_else_else_IfBlock1 = kcg_lit_int32(0);
