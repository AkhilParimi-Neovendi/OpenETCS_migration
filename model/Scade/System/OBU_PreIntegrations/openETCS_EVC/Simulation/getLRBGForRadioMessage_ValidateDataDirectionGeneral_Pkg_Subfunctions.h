...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_getLRBGForRadioMessageIte_ValidateDataDirectionGeneral_Pkg_Subfunctions /* _L5=(ValidateDataDirectionGeneral_Pkg::Subfunctions::getLRBGForRadioMessageIterator#1)/ */ Context_getLRBGForRadioMessageIterator_1[41];
  ...
  array_int32_41 /* _L6/ */ _L6;
  positionedBG_T_TrainPosition_Types_Pck /* _L8/ */ _L8;
  NID_BG /* _L10/ */ _L10;
  NID_C /* _L9/ */ _L9;
  array_int32_41 /* _L12/ */ _L12;
