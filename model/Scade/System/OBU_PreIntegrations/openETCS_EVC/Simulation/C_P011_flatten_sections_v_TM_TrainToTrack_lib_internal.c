...
#include "C_P011_flatten_sections_v_TM_TrainToTrack_lib_internal.h"

/* TM_TrainToTrack_lib_internal::C_P011_flatten_sections_voltage/ */
void C_P011_flatten_sections_v_TM_TrainToTrack_lib_internal(
  /* MergedSections/ */
  ...
  outC_C_P011_flatten_sections_v_TM_TrainToTrack_lib_internal *outC)
{
  ...
  for (idx = 0; idx < 4; idx++) {
    ...
    C_P011_fs_struct_to_array_TM_TrainToTrack_lib_internal(
      &outC->_L75[idx],
  ...
  for (idx2 = 0; idx2 < 8; idx2++) {
    ...
    C_P011_fs_flatten_array_v_TM_TrainToTrack_lib_internal(
      /* _L78= */(kcg_int32) idx2,
      &acc,
      &outC->_L80[idx2],
...
void C_P011_flatten_sections_v_init_TM_TrainToTrack_lib_internal(
  outC_C_P011_flatten_sections_v_TM_TrainToTrack_lib_internal *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx1 = 0; idx1 < 8; idx1++) {
    /* _L78=(TM_TrainToTrack_lib_internal::C_P011_fs_flatten_array_voltage#1)/ */
    C_P011_fs_flatten_array_v_init_TM_TrainToTrack_lib_internal(
      &outC->Context_C_P011_fs_flatten_array_voltage_1[idx1]);
  }
  for (idx = 0; idx < 4; idx++) {
    /* _L74=(TM_TrainToTrack_lib_internal::C_P011_fs_struct_to_array_voltage#1)/ */
    C_P011_fs_struct_to_array_init_TM_TrainToTrack_lib_internal(
      &outC->Context_C_P011_fs_struct_to_array_voltage_1[idx]);
  }
}
...
void C_P011_flatten_sections_v_reset_TM_TrainToTrack_lib_internal(
  outC_C_P011_flatten_sections_v_TM_TrainToTrack_lib_internal *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx1 = 0; idx1 < 8; idx1++) {
    /* _L78=(TM_TrainToTrack_lib_internal::C_P011_fs_flatten_array_voltage#1)/ */
    C_P011_fs_flatten_array_v_reset_TM_TrainToTrack_lib_internal(
      &outC->Context_C_P011_fs_flatten_array_voltage_1[idx1]);
  }
  for (idx = 0; idx < 4; idx++) {
    /* _L74=(TM_TrainToTrack_lib_internal::C_P011_fs_struct_to_array_voltage#1)/ */
    C_P011_fs_struct_to_array_reset_TM_TrainToTrack_lib_internal(
      &outC->Context_C_P011_fs_struct_to_array_voltage_1[idx]);
  }
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** C_P011_flatten_sections_v_TM_TrainToTrack_lib_internal.c
** Generation date: 2023-11-06T13:54:30
*************************************************************$ */
