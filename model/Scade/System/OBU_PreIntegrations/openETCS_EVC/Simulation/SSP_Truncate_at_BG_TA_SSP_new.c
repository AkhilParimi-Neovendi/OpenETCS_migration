  ...
  outC_SSP_Truncate_at_BG_TA_SSP_new *outC)
{
  ...
  kcg_size idx1;
  kcg_size idx2;
  StaticSpeedProfile_t_TrackAtlasTypes acc3;
  kcg_size idx4;
  kcg_int32 noname;
  kcg_int32 _5_noname;
  ...
  if (outC->_L14) {
    ...
    for (idx1 = 0; idx1 < 50; idx1++) {
      ...
      SSP_Find_First_Speed_Sect_TA_SSP_new(
        /* _L4= */(kcg_int32) idx1,
        acc,
        &outC->_L6[idx1],
  ...
  outC_SSP_Truncate_at_BG_TA_SSP_new *outC)
{
  ...
  for (idx3 = 0; idx3 < 50; idx3++) {
    ...
    outC->_L13[idx3].d_static_abs = kcg_lit_int32(0);
    outC->_L13[idx3].d_static_LRBG = kcg_lit_int32(0);
    outC->_L13[idx3].q_train_length_corr = kcg_true;
    outC->_L13[idx3].v_static = kcg_lit_int32(0);
  }
  for (idx4 = 0; idx4 < 50; idx4++) {
    outC->_L12[idx4].valid = kcg_true;
    outC->_L12[idx4].d_static_abs = kcg_lit_int32(0);
    outC->_L12[idx4].d_static_LRBG = kcg_lit_int32(0);
    outC->_L12[idx4].q_train_length_corr = kcg_true;
    outC->_L12[idx4].v_static = kcg_lit_int32(0);
  }
  outC->_L11 = kcg_true;
  outC->_L10 = kcg_lit_int32(0);
  outC->_L4 = kcg_lit_int32(0);
  ...
  for (idx6 = 0; idx6 < 50; idx6++) {
    for (idx5 = 0; idx5 < 50; idx5++) {
      ...
      outC->_L6[idx6][idx5].d_static_abs = kcg_lit_int32(0);
      outC->_L6[idx6][idx5].d_static_LRBG = kcg_lit_int32(0);
      outC->_L6[idx6][idx5].q_train_length_corr = kcg_true;
      outC->_L6[idx6][idx5].v_static = kcg_lit_int32(0);
    }
  }
  outC->_L8 = kcg_lit_int32(0);
  for (idx7 = 0; idx7 < 50; idx7++) {
    outC->_L1[idx7].valid = kcg_true;
    outC->_L1[idx7].d_static_abs = kcg_lit_int32(0);
    outC->_L1[idx7].d_static_LRBG = kcg_lit_int32(0);
    outC->_L1[idx7].q_train_length_corr = kcg_true;
    outC->_L1[idx7].v_static = kcg_lit_int32(0);
  }
  for (idx8 = 0; idx8 < 50; idx8++) {
    outC->Profile_out[idx8].valid = kcg_true;
    outC->Profile_out[idx8].d_static_abs = kcg_lit_int32(0);
    outC->Profile_out[idx8].d_static_LRBG = kcg_lit_int32(0);
    outC->Profile_out[idx8].q_train_length_corr = kcg_true;
    outC->Profile_out[idx8].v_static = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 50; idx1++) {
    /* _L10=(TA_SSP_new::SSP_Truncate_at_BG_loop#1)/ */
  ...
  for (idx = 0; idx < 50; idx++) {
    /* _L4=(TA_SSP_new::SSP_Find_First_Speed_Section_After_BG_loop#1)/ */
    SSP_Find_First_Speed_Sect_init_TA_SSP_new(
  ...
  outC_SSP_Truncate_at_BG_TA_SSP_new *outC)
{
  ...
  for (idx = 0; idx < 50; idx++) {
    /* _L4=(TA_SSP_new::SSP_Find_First_Speed_Section_After_BG_loop#1)/ */
    SSP_Find_First_Speed_Sect_reset_TA_SSP_new(
      &outC->Context_SSP_Find_First_Speed_Section_After_BG_loop_1[idx]);
  }
}
