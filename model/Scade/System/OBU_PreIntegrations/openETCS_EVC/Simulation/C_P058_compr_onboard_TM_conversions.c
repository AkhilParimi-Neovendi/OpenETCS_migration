  ...
  outC_C_P058_compr_onboard_TM_conversions *outC)
{
  ...
  kcg_copy_array_int32_8(&outC->_L1, (array_int32_8 *) &outC->_L9[0]);
  ...
  kcg_copy_array_int32_64(&outC->_L13, (array_int32_64 *) &outC->_L9[8]);
  ...
  outC_C_P058_compr_onboard_TM_conversions *outC)
{
  ...
  for (idx1 = 0; idx1 < 32; idx1++) {
    ...
    outC->_L5[idx1].d_loc = kcg_lit_int32(0);
  ...
  outC->_L10.t_cycloc = kcg_lit_int32(0);
  outC->_L10.d_cycloc = kcg_lit_int32(0);
  outC->_L10.m_loc = M_LOC_Now;
  outC->_L10.n_iter = kcg_lit_int32(0);
  for (idx3 = 0; idx3 < 32; idx3++) {
    outC->_L10.sections[idx3].valid = kcg_true;
    outC->_L10.sections[idx3].d_loc = kcg_lit_int32(0);
  ...
  outC->P058_onboard.t_cycloc = kcg_lit_int32(0);
  outC->P058_onboard.d_cycloc = kcg_lit_int32(0);
  outC->P058_onboard.m_loc = M_LOC_Now;
  outC->P058_onboard.n_iter = kcg_lit_int32(0);
  for (idx5 = 0; idx5 < 32; idx5++) {
    outC->P058_onboard.sections[idx5].valid = kcg_true;
    outC->P058_onboard.sections[idx5].d_loc = kcg_lit_int32(0);
