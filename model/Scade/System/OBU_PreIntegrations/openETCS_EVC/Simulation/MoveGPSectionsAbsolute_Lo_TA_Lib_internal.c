...
#include "MoveGPSectionsAbsolute_Lo_TA_Lib_internal.h"

/* TA_Lib_internal::MoveGPSectionsAbsolute_Loop_new/ */
void MoveGPSectionsAbsolute_Lo_TA_Lib_internal(
  /* i/ */
  kcg_int32 i,
  /* ProfileIn/ */
...
void MoveGPSectionsAbsolute_Lo_init_TA_Lib_internal(
  outC_MoveGPSectionsAbsolute_Lo_TA_Lib_internal *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  outC->_L259 = kcg_lit_int32(0);
  outC->_L257 = kcg_lit_int32(0);
  outC->_L256.valid = kcg_true;
  outC->_L256.Loc_Absolute = kcg_lit_int32(0);
  outC->_L256.Loc_LRBG = kcg_lit_int32(0);
  outC->_L256.Gradient = kcg_lit_int32(0);
  outC->_L256.L_Gradient = kcg_lit_int32(0);
  outC->_L255 = kcg_lit_int32(0);
  ...
  outC->_L6.Loc_Absolute = kcg_lit_int32(0);
  outC->_L6.Loc_LRBG = kcg_lit_int32(0);
  outC->_L6.Gradient = kcg_lit_int32(0);
  outC->_L6.L_Gradient = kcg_lit_int32(0);
  for (idx1 = 0; idx1 < 50; idx1++) {
    outC->_L2[idx1].valid = kcg_true;
    outC->_L2[idx1].Loc_Absolute = kcg_lit_int32(0);
    outC->_L2[idx1].Loc_LRBG = kcg_lit_int32(0);
    outC->_L2[idx1].Gradient = kcg_lit_int32(0);
    outC->_L2[idx1].L_Gradient = kcg_lit_int32(0);
  }
  outC->_L1 = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 50; idx2++) {
    outC->ProfileOut[idx2].valid = kcg_true;
    outC->ProfileOut[idx2].Loc_Absolute = kcg_lit_int32(0);
    outC->ProfileOut[idx2].Loc_LRBG = kcg_lit_int32(0);
    outC->ProfileOut[idx2].Gradient = kcg_lit_int32(0);
    outC->ProfileOut[idx2].L_Gradient = kcg_lit_int32(0);
  }
}
...
void MoveGPSectionsAbsolute_Lo_reset_TA_Lib_internal(
  outC_MoveGPSectionsAbsolute_Lo_TA_Lib_internal *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** MoveGPSectionsAbsolute_Lo_TA_Lib_internal.c
** Generation date: 2023-11-06T13:54:30
*************************************************************$ */
