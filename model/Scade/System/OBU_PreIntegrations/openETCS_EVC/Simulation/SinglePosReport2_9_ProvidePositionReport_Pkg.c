...
{
  PT5_TrainRunningNumber_Packet_TrainTypes_Pkg op_call;
  PT4_ErrorReporting_T_Packet_TrainTypes_Pkg _1_op_call;
  PT1_PositionReport_2BG_T_Packet_TrainTypes_Pkg _2_op_call;
  PT0_PositionReport_T_Packet_TrainTypes_Pkg _3_op_call;
  Radio_TrainTrack_Header_T_Radio_Types_Pkg _4_op_call;
  Radio_TrainTrack_Header_T_Radio_Types_Pkg noname;
  PT0_PositionReport_T_Packet_TrainTypes_Pkg _5_noname;
  PT1_PositionReport_2BG_T_Packet_TrainTypes_Pkg _6_noname;
  PT4_ErrorReporting_T_Packet_TrainTypes_Pkg _7_noname;
  PT5_TrainRunningNumber_Packet_TrainTypes_Pkg _8_noname;
