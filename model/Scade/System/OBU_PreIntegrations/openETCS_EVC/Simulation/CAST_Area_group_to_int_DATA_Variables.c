...
{
  /* area_group_int/ */
  Area_group_INT_T_DATA area_group_int_partial;
  /* error/ */
  kcg_bool error_partial;
  /* area_group_int/ */
  Area_group_INT_T_DATA _1_area_group_int_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* area_group_int/ */
  Area_group_INT_T_DATA _3_area_group_int_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* area_group_int/ */
  Area_group_INT_T_DATA _5_area_group_int_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* area_group_int/ */
  Area_group_INT_T_DATA _7_area_group_int_partial;
  /* error/ */
  kcg_bool _8_error_partial;
  /* area_group_int/ */
  Area_group_INT_T_DATA _9_area_group_int_partial;
  /* error/ */
  kcg_bool _10_error_partial;
  /* area_group_int/ */
  Area_group_INT_T_DATA _11_area_group_int_partial;
  /* error/ */
  kcg_bool _12_error_partial;
  /* area_group_int/ */
  Area_group_INT_T_DATA _13_area_group_int_partial;
  /* error/ */
  kcg_bool _14_error_partial;
  /* error/ */
  kcg_bool _15_error_partial;
  /* area_group_int/ */
  Area_group_INT_T_DATA _16_area_group_int_partial;
  /* error/ */
  kcg_bool _17_error_partial;
  /* area_group_int/ */
  Area_group_INT_T_DATA _18_area_group_int_partial;
  /* error/ */
  kcg_bool _19_error_partial;
  /* area_group_int/ */
  Area_group_INT_T_DATA _20_area_group_int_partial;
  /* error/ */
  kcg_bool _21_error_partial;
  /* area_group_int/ */
  Area_group_INT_T_DATA _22_area_group_int_partial;
  /* error/ */
  kcg_bool _23_error_partial;
  /* area_group_int/ */
  Area_group_INT_T_DATA _24_area_group_int_partial;
  /* error/ */
  kcg_bool _25_error_partial;
  /* area_group_int/ */
  Area_group_INT_T_DATA _26_area_group_int_partial;
  /* error/ */
  kcg_bool _27_error_partial;
  /* area_group_int/ */
  Area_group_INT_T_DATA _28_area_group_int_partial;
  /* error/ */
  kcg_bool _29_error_partial;
  /* area_group_int/ */
  Area_group_INT_T_DATA _30_area_group_int_partial;
  kcg_bool noname;
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              outC->_L26_then_else_else_else_else_else_IfBlock1 = kcg_false;
              _21_error_partial = outC->_L26_then_else_else_else_else_else_IfBlock1;
              ...
              if (outC->_2_else_clock_else_else_else_else_else_IfBlock1) {
                ...
                if (outC->_1_else_clock_else_else_else_else_else_else_IfBlock1) {
                  outC->_L24_then_else_else_else_else_else_else_else_IfBlock1 = kcg_false;
                  _17_error_partial = outC->_L24_then_else_else_else_else_else_else_else_IfBlock1;
      ...
      if (outC->else_clock_else_IfBlock1) {
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            /* IfBlock1:else:else:else:else:else: */
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              outC->_L15_then_else_else_else_else_else_IfBlock1 = INT_Area_group_T_F;
              _22_area_group_int_partial = outC->_L15_then_else_else_else_else_else_IfBlock1;
  ...
  outC_CAST_Area_group_to_int_DATA_Variables *outC)
{
  ...
  outC->_L26_then_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_L15_then_else_else_else_else_else_IfBlock1 = kcg_lit_int32(0);
  outC->_2_else_clock_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_L24_then_else_else_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_L13_then_else_else_else_else_else_else_else_IfBlock1 = kcg_lit_int32(0);
