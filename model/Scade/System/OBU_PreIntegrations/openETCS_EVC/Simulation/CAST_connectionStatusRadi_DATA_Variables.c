...
#include "CAST_connectionStatusRadi_DATA_Variables.h"

/* DATA::Variables::CAST_connectionStatusRadioUnit_to_int/ */
void CAST_connectionStatusRadi_DATA_Variables(
  ...
  outC_CAST_connectionStatusRadi_DATA_Variables *outC)
{
  ...
  connectionStatusRadioUnit_INT_T_DATA connectionStatusRadioUnit_int_partial;
  /* error/ */
  kcg_bool error_partial;
  /* connectionStatusRadioUnit_int/ */
  connectionStatusRadioUnit_INT_T_DATA _1_connectionStatusRadioUnit_int_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* connectionStatusRadioUnit_int/ */
  connectionStatusRadioUnit_INT_T_DATA _3_connectionStatusRadioUnit_int_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* connectionStatusRadioUnit_int/ */
  connectionStatusRadioUnit_INT_T_DATA _5_connectionStatusRadioUnit_int_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* error/ */
  kcg_bool _7_error_partial;
  /* connectionStatusRadioUnit_int/ */
  connectionStatusRadioUnit_INT_T_DATA _8_connectionStatusRadioUnit_int_partial;
  /* error/ */
  kcg_bool _9_error_partial;
  /* connectionStatusRadioUnit_int/ */
  connectionStatusRadioUnit_INT_T_DATA _10_connectionStatusRadioUnit_int_partial;
  /* error/ */
  kcg_bool _11_error_partial;
  /* connectionStatusRadioUnit_int/ */
  connectionStatusRadioUnit_INT_T_DATA _12_connectionStatusRadioUnit_int_partial;
  /* error/ */
  kcg_bool _13_error_partial;
  /* connectionStatusRadioUnit_int/ */
  connectionStatusRadioUnit_INT_T_DATA _14_connectionStatusRadioUnit_int_partial;
  kcg_bool noname;
  ...
  if (outC->IfBlock1_clock) {
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      outC->else_clock_else_IfBlock1 = connectionStatusRadioUnit_ct ==
        _28_ENUM_connectionStatusRadioUnit_T_conn_ConnectionUp;
      /* IfBlock1:else:else: */
      if (outC->else_clock_else_IfBlock1) {
        ...
        outC->_L1_then_else_else_IfBlock1 =
          _31_INT_connectionStatusRadioUnit_T_conn_ConnectionUp;
        ...
        outC->else_clock_else_else_IfBlock1 = connectionStatusRadioUnit_ct ==
          _29_ENUM_connectionStatusRadioUnit_T_conn_SetupFailed;
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          outC->_L1_then_else_else_else_IfBlock1 =
            _30_INT_connectionStatusRadioUnit_T_conn_SetupFailed;
...
void CAST_connectionStatusRadi_init_DATA_Variables(
  outC_CAST_connectionStatusRadi_DATA_Variables *outC)
{
  outC->_L1 = kcg_true;
  outC->error = kcg_true;
  ...
  outC->connectionStatusRadioUnit_int = kcg_lit_int32(0);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void CAST_connectionStatusRadi_reset_DATA_Variables(
  outC_CAST_connectionStatusRadi_DATA_Variables *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_connectionStatusRadi_DATA_Variables.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
