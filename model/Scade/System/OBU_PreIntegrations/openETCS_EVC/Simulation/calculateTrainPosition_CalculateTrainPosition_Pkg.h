...
typedef struct {
  ...
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_calculateTrainpositionAtt_CalculateTrainPosition_Pkg /* _L200=(CalculateTrainPosition_Pkg::calculateTrainpositionAttributes#1)/ */ Context_calculateTrainpositionAttributes_1;
  outC_twoConsecutiveLinkedBGs_m_CalculateTrainPosition_Pkg_Linking_Pkg /* _L334=(CalculateTrainPosition_Pkg::Linking_Pkg::twoConsecutiveLinkedBGs_missed#1)/ */ Context_twoConsecutiveLinkedBGs_missed_1;
