...
typedef struct {
  ...
  outC_CAST_Int_to_D_ENDTIMERSTA_TM_conversions /* _L133=(TM_conversions::CAST_Int_to_D_ENDTIMERSTARTLOC#2)/ */ Context_CAST_Int_to_D_ENDTIMERSTARTLOC_2;
  outC_CAST_Int_to_D_STARTOL_TM_conversions /* _L134=(TM_conversions::CAST_Int_to_D_STARTOL#2)/ */ Context_CAST_Int_to_D_STARTOL_2;
  outC_CAST_Int_to_D_SECTIONTIME_TM_conversions /* _L137=(TM_conversions::CAST_Int_to_D_SECTIONTIMERSTOPLOC#2)/ */ Context_CAST_Int_to_D_SECTIONTIMERSTOPLOC_2;
  ...
  kcg_bool /* @2/IfBlock1:else: */ _1_else_clock_CAST_Int_to_Q_SCALE_2_IfBlock1;
  ...
  kcg_bool /* @4/IfBlock1:else: */ _2_else_clock_CAST_Int_to_Q_DIR_2_IfBlock1;
  /* -------------------- (-debug) no assertions  -------------------- */
  ...
  Q_SCALE /* @2/IfBlock1:else:else:then:_L1/ */ _3__L1_CAST_Int_to_Q_SCALE_2_then_else_else_IfBlock1;
  ...
  kcg_bool /* @2/IfBlock1:then:_L3/ */ _4__L3_CAST_Int_to_Q_SCALE_2_then_IfBlock1;
