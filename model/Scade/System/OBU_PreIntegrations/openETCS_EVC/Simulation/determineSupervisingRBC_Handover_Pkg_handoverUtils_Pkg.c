  ...
  outC_determineSupervisingRBC_Handover_Pkg_handoverUtils_Pkg *outC)
{
  ...
  kcg_bool supervising_isMobile_1_partial;
  /* supervising_isMobile_2/ */
  kcg_bool supervising_isMobile_2_partial;
  /* supervisingStatusFromMobile/ */
  morcStatus_T_RCM_Session_Types_Pkg supervisingStatusFromMobile_partial;
  /* supervising_isMobile_1/ */
  kcg_bool _1_supervising_isMobile_1_partial;
  /* supervising_isMobile_2/ */
  kcg_bool _2_supervising_isMobile_2_partial;
  /* supervisingStatusFromMobile/ */
  morcStatus_T_RCM_Session_Types_Pkg _3_supervisingStatusFromMobile_partial;
