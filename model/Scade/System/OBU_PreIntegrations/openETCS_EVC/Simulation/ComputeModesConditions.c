...
{
  /* On_Going_Mission/ */
  kcg_bool last_On_Going_Mission;
  /* End_Of_Mission_Procedure_Req/ */
  kcg_bool last_End_Of_Mission_Procedure_Req;
  /* Failure_Occured/ */
  kcg_bool last_Failure_Occured;
  /* Train_Overpass_EOA_Antenna/ */
  kcg_bool last_Train_Overpass_EOA_Antenna;
  /* Override_Function_Active/ */
  kcg_bool last_Override_Function_Active;
  /* Current_Level/ */
  ...
  outC->_1_Loc_End_Of_Mission_Procedure_Req_SB = outC->_L299;
  outC->_L405 = outC->_1_Loc_End_Of_Mission_Procedure_Req_SB;
  outC->Loc_End_Of_Mission_Procedure_Req_SH = outC->_L207;
  outC->_L406 = outC->Loc_End_Of_Mission_Procedure_Req_SH;
  outC->_3_Loc_End_Of_Mission_Procedure_Req_SoM = outC->_L240;
  outC->_L407 = outC->_3_Loc_End_Of_Mission_Procedure_Req_SoM;
  outC->_2_Loc_End_Of_Mission_Procedure_Req_TR = outC->_L303;
  outC->_L408 = outC->_2_Loc_End_Of_Mission_Procedure_Req_TR;
...
void ComputeModesConditions_init(outC_ComputeModesConditions *outC)
{
  ...
  outC->_3_Loc_End_Of_Mission_Procedure_Req_SoM = kcg_true;
  outC->Loc_Clean_BG_List_SH_Area_TR = kcg_true;
  outC->_2_Loc_End_Of_Mission_Procedure_Req_TR = kcg_true;
  outC->_1_Loc_End_Of_Mission_Procedure_Req_SB = kcg_true;
