  ...
  outC_improve_BG_locations_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  ...
  _230_recalculate_BG_locat_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
    &outC->_L2,
    &outC->_L1,
    &outC->_L39,
    &outC->_1_Context_recalculate_BG_locations_ahead_1);
  kcg_copy_positionedBGs_T_TrainPosition_Types_Pck(
    &outC->_L33,
    &outC->_1_Context_recalculate_BG_locations_ahead_1.BGs_out);
  /* _L34=(CalculateTrainPosition_Pkg::BG_relocation_Pkg::recalculate_BG_locations_astern#1)/ */
  _232_recalculate_BG_locat_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
    &outC->_L2,
    &outC->_L33,
    &outC->_L39,
  ...
  outC_improve_BG_locations_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  ...
  outC->_L39.nid_engine = kcg_lit_int32(0);
  outC->_L39.nid_operational = kcg_lit_int32(0);
  outC->_L39.l_train = kcg_lit_int32(0);
  outC->_L39.d_baliseAntenna_2_frontend.nominal = kcg_lit_int32(0);
  outC->_L39.d_baliseAntenna_2_frontend.d_min = kcg_lit_int32(0);
  outC->_L39.d_baliseAntenna_2_frontend.d_max = kcg_lit_int32(0);
  outC->_L39.d_frontend_2_rearend.nominal = kcg_lit_int32(0);
  outC->_L39.d_frontend_2_rearend.d_min = kcg_lit_int32(0);
  outC->_L39.d_frontend_2_rearend.d_max = kcg_lit_int32(0);
  outC->_L39.locationAccuracy_DefaultValue.nominal = kcg_lit_int32(0);
  outC->_L39.locationAccuracy_DefaultValue.d_min = kcg_lit_int32(0);
  outC->_L39.locationAccuracy_DefaultValue.d_max = kcg_lit_int32(0);
  outC->_L39.centerDetectionAcc_DefaultValue.nominal = kcg_lit_int32(0);
  outC->_L39.centerDetectionAcc_DefaultValue.d_min = kcg_lit_int32(0);
  outC->_L39.centerDetectionAcc_DefaultValue.d_max = kcg_lit_int32(0);
  for (idx1 = 0; idx1 < 41; idx1++) {
    outC->_L38[idx1].valid = kcg_true;
    outC->_L38[idx1].nid_c = kcg_lit_int32(0);
    outC->_L38[idx1].nid_bg = kcg_lit_int32(0);
    outC->_L38[idx1].q_link = Q_LINK_Unlinked;
    outC->_L38[idx1].location.nominal = kcg_lit_int32(0);
    outC->_L38[idx1].location.d_min = kcg_lit_int32(0);
    outC->_L38[idx1].location.d_max = kcg_lit_int32(0);
    outC->_L38[idx1].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L38[idx1].infoFromLinking.valid = kcg_true;
    outC->_L38[idx1].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L38[idx1].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L38[idx1].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L38[idx1].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L38[idx1].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L38[idx1].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L38[idx1].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L38[idx1].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L38[idx1].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L38[idx1].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L38[idx1].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L38[idx1].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L38[idx1].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L38[idx1].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L38[idx1].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L38[idx1].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L38[idx1].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L38[idx1].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L38[idx1].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L38[idx1].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx = 0; idx < 33; idx++) {
      ...
      outC->_L38[idx1].infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L38[idx1].infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int32(0);
      outC->_L38[idx1].infoFromPassing.linkedBGs[idx].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L38[idx1].infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int32(0);
      outC->_L38[idx1].infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L38[idx1].infoFromPassing.linkedBGs[idx].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L38[idx1].infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int32(0);
    }
    outC->_L38[idx1].missed = kcg_true;
  }
  for (idx3 = 0; idx3 < 41; idx3++) {
    outC->_L34[idx3].valid = kcg_true;
    outC->_L34[idx3].nid_c = kcg_lit_int32(0);
    outC->_L34[idx3].nid_bg = kcg_lit_int32(0);
    outC->_L34[idx3].q_link = Q_LINK_Unlinked;
    outC->_L34[idx3].location.nominal = kcg_lit_int32(0);
    outC->_L34[idx3].location.d_min = kcg_lit_int32(0);
    outC->_L34[idx3].location.d_max = kcg_lit_int32(0);
    outC->_L34[idx3].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L34[idx3].infoFromLinking.valid = kcg_true;
    outC->_L34[idx3].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L34[idx3].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L34[idx3].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L34[idx3].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L34[idx3].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L34[idx3].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L34[idx3].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L34[idx3].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L34[idx3].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L34[idx3].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L34[idx3].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L34[idx3].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L34[idx3].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L34[idx3].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    outC->_L34[idx3].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L34[idx3].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L34[idx3].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L34[idx3].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L34[idx3].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L34[idx3].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L34[idx3].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L34[idx3].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L34[idx3].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx2 = 0; idx2 < 33; idx2++) {
      ...
      outC->_L34[idx3].infoFromPassing.linkedBGs[idx2].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L34[idx3].infoFromPassing.linkedBGs[idx2].d_link = kcg_lit_int32(0);
      outC->_L34[idx3].infoFromPassing.linkedBGs[idx2].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L34[idx3].infoFromPassing.linkedBGs[idx2].nid_c = kcg_lit_int32(0);
      outC->_L34[idx3].infoFromPassing.linkedBGs[idx2].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L34[idx3].infoFromPassing.linkedBGs[idx2].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L34[idx3].infoFromPassing.linkedBGs[idx2].q_locacc = kcg_lit_int32(0);
    }
    outC->_L34[idx3].missed = kcg_true;
  }
  for (idx5 = 0; idx5 < 41; idx5++) {
    outC->_L33[idx5].valid = kcg_true;
    outC->_L33[idx5].nid_c = kcg_lit_int32(0);
    outC->_L33[idx5].nid_bg = kcg_lit_int32(0);
    outC->_L33[idx5].q_link = Q_LINK_Unlinked;
    outC->_L33[idx5].location.nominal = kcg_lit_int32(0);
    outC->_L33[idx5].location.d_min = kcg_lit_int32(0);
    outC->_L33[idx5].location.d_max = kcg_lit_int32(0);
    outC->_L33[idx5].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L33[idx5].infoFromLinking.valid = kcg_true;
    outC->_L33[idx5].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L33[idx5].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L33[idx5].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L33[idx5].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L33[idx5].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L33[idx5].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L33[idx5].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L33[idx5].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L33[idx5].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L33[idx5].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L33[idx5].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L33[idx5].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L33[idx5].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L33[idx5].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    outC->_L33[idx5].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L33[idx5].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L33[idx5].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L33[idx5].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L33[idx5].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L33[idx5].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L33[idx5].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L33[idx5].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L33[idx5].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx4 = 0; idx4 < 33; idx4++) {
      ...
      outC->_L33[idx5].infoFromPassing.linkedBGs[idx4].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L33[idx5].infoFromPassing.linkedBGs[idx4].d_link = kcg_lit_int32(0);
      outC->_L33[idx5].infoFromPassing.linkedBGs[idx4].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L33[idx5].infoFromPassing.linkedBGs[idx4].nid_c = kcg_lit_int32(0);
      outC->_L33[idx5].infoFromPassing.linkedBGs[idx4].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L33[idx5].infoFromPassing.linkedBGs[idx4].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L33[idx5].infoFromPassing.linkedBGs[idx4].q_locacc = kcg_lit_int32(0);
    }
  ...
  for (idx6 = 0; idx6 < 33; idx6++) {
    ...
    outC->_L2.infoFromPassing.linkedBGs[idx6].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L2.infoFromPassing.linkedBGs[idx6].d_link = kcg_lit_int32(0);
    outC->_L2.infoFromPassing.linkedBGs[idx6].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L2.infoFromPassing.linkedBGs[idx6].nid_c = kcg_lit_int32(0);
    outC->_L2.infoFromPassing.linkedBGs[idx6].nid_bg = kcg_lit_int32(0);
    outC->_L2.infoFromPassing.linkedBGs[idx6].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L2.infoFromPassing.linkedBGs[idx6].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L2.infoFromPassing.linkedBGs[idx6].q_locacc = kcg_lit_int32(0);
  }
  outC->_L2.missed = kcg_true;
  for (idx8 = 0; idx8 < 41; idx8++) {
    outC->_L1[idx8].valid = kcg_true;
    outC->_L1[idx8].nid_c = kcg_lit_int32(0);
    outC->_L1[idx8].nid_bg = kcg_lit_int32(0);
    outC->_L1[idx8].q_link = Q_LINK_Unlinked;
    outC->_L1[idx8].location.nominal = kcg_lit_int32(0);
    outC->_L1[idx8].location.d_min = kcg_lit_int32(0);
    outC->_L1[idx8].location.d_max = kcg_lit_int32(0);
    outC->_L1[idx8].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L1[idx8].infoFromLinking.valid = kcg_true;
    outC->_L1[idx8].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L1[idx8].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L1[idx8].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L1[idx8].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L1[idx8].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L1[idx8].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L1[idx8].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L1[idx8].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L1[idx8].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L1[idx8].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L1[idx8].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L1[idx8].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L1[idx8].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L1[idx8].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    outC->_L1[idx8].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L1[idx8].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L1[idx8].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L1[idx8].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L1[idx8].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L1[idx8].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L1[idx8].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L1[idx8].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L1[idx8].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx7 = 0; idx7 < 33; idx7++) {
      ...
      outC->_L1[idx8].infoFromPassing.linkedBGs[idx7].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L1[idx8].infoFromPassing.linkedBGs[idx7].d_link = kcg_lit_int32(0);
      outC->_L1[idx8].infoFromPassing.linkedBGs[idx7].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L1[idx8].infoFromPassing.linkedBGs[idx7].nid_c = kcg_lit_int32(0);
      outC->_L1[idx8].infoFromPassing.linkedBGs[idx7].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L1[idx8].infoFromPassing.linkedBGs[idx7].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L1[idx8].infoFromPassing.linkedBGs[idx7].q_locacc = kcg_lit_int32(0);
    }
  ...
  improveUnlinkedBGLocations_init_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
    &outC->Context_improveUnlinkedBGLocations_1);
  /* _L34=(CalculateTrainPosition_Pkg::BG_relocation_Pkg::recalculate_BG_locations_astern#1)/ */
  _232_recalculate_BG_locat_init_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
    &outC->Context_recalculate_BG_locations_astern_1);
  /* _L33=(CalculateTrainPosition_Pkg::BG_relocation_Pkg::recalculate_BG_locations_ahead#1)/ */
  _230_recalculate_BG_locat_init_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
    &outC->_1_Context_recalculate_BG_locations_ahead_1);
}
  ...
  outC_improve_BG_locations_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  ...
  improveUnlinkedBGLocations_reset_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
    &outC->Context_improveUnlinkedBGLocations_1);
  /* _L34=(CalculateTrainPosition_Pkg::BG_relocation_Pkg::recalculate_BG_locations_astern#1)/ */
  _232_recalculate_BG_locat_reset_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
    &outC->Context_recalculate_BG_locations_astern_1);
  /* _L33=(CalculateTrainPosition_Pkg::BG_relocation_Pkg::recalculate_BG_locations_ahead#1)/ */
  _230_recalculate_BG_locat_reset_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
    &outC->_1_Context_recalculate_BG_locations_ahead_1);
}
