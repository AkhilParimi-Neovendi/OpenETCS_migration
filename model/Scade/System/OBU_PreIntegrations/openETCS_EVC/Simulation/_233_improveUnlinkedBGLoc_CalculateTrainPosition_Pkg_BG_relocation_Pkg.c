...
#include "_233_improveUnlinkedBGLoc_CalculateTrainPosition_Pkg_BG_relocation_Pkg.h"

/* CalculateTrainPosition_Pkg::BG_relocation_Pkg::improveUnlinkedBGLocations_itr/ */
void _233_improveUnlinkedBGLoc_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
  /* BG_index_in/ */
...
void _233_improveUnlinkedBGLoc_init_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
  outC__233_improveUnlinkedBGLoc_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void _233_improveUnlinkedBGLoc_reset_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
  outC__233_improveUnlinkedBGLoc_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  /* _L15=(CalculateTrainPosition_Pkg::BG_relocation_Pkg::improveUnlinkedBGLocation#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _233_improveUnlinkedBGLoc_CalculateTrainPosition_Pkg_BG_relocation_Pkg.c
** Generation date: 2023-11-06T13:54:30
*************************************************************$ */
