  ...
  outC_MEM_locationOfReferenceLRBG_EVC_MEM_Support_Pkg *outC)
{
  ...
  outC->_L20.d_baliseAntenna_2_frontend.nominal = kcg_lit_int32(0);
  outC->_L20.d_baliseAntenna_2_frontend.d_min = kcg_lit_int32(0);
  outC->_L20.d_baliseAntenna_2_frontend.d_max = kcg_lit_int32(0);
  outC->_L20.d_frontend_2_rearend.nominal = kcg_lit_int32(0);
  outC->_L20.d_frontend_2_rearend.d_min = kcg_lit_int32(0);
  outC->_L20.d_frontend_2_rearend.d_max = kcg_lit_int32(0);
  outC->_L20.locationAccuracy_DefaultValue.nominal = kcg_lit_int32(0);
  outC->_L20.locationAccuracy_DefaultValue.d_min = kcg_lit_int32(0);
  outC->_L20.locationAccuracy_DefaultValue.d_max = kcg_lit_int32(0);
  outC->_L20.centerDetectionAcc_DefaultValue.nominal = kcg_lit_int32(0);
  outC->_L20.centerDetectionAcc_DefaultValue.d_min = kcg_lit_int32(0);
  outC->_L20.centerDetectionAcc_DefaultValue.d_max = kcg_lit_int32(0);
  ...
  for (idx = 0; idx < 33; idx++) {
    ...
    outC->_L3.infoFromPassing.linkedBGs[idx].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L3.infoFromPassing.linkedBGs[idx].d_link = kcg_lit_int32(0);
    outC->_L3.infoFromPassing.linkedBGs[idx].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L3.infoFromPassing.linkedBGs[idx].nid_c = kcg_lit_int32(0);
    outC->_L3.infoFromPassing.linkedBGs[idx].nid_bg = kcg_lit_int32(0);
    outC->_L3.infoFromPassing.linkedBGs[idx].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L3.infoFromPassing.linkedBGs[idx].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L3.infoFromPassing.linkedBGs[idx].q_locacc = kcg_lit_int32(0);
  }
