  ...
  outC_updateDMIStatus_manage_DMI_Input_Pkg *outC)
{
  ...
  outC->_L20.l_name = kcg_lit_int32(0);
  ...
  outC->_L15.DMI_Identifier.systemTime = kcg_lit_int32(0);
  ...
  outC->_L15.DMI_Identifier.l_name = kcg_lit_int32(0);
  ...
  outC->newStatus.DMI_Identifier.systemTime = kcg_lit_int32(0);
  ...
  outC->newStatus.DMI_Identifier.l_name = kcg_lit_int32(0);
