  ...
  outC_MRSPPreindicationSelector_TargetLimits_Pkg *outC)
{
  ...
  kcg_size idx2;
  kcg_size idx3;
  MRSP_internal_section_T_TargetManagement_types acc;
  kcg_size idx4;
  kcg_int32 noname;
  ...
  outC_MRSPPreindicationSelector_TargetLimits_Pkg *outC)
{
  ...
  outC->_L84 = kcg_lit_float32(0.0);
  outC->_L85 = kcg_lit_float32(0.0);
  outC->_L83 = kcg_lit_float32(0.0);
  outC->_L81.Traction = kcg_lit_float32(0.0);
  outC->_L81.berem = kcg_lit_float32(0.0);
  outC->_L81.bs = kcg_lit_float32(0.0);
  outC->_L81.bs1 = kcg_lit_float32(0.0);
  outC->_L81.bs2 = kcg_lit_float32(0.0);
  outC->_L81.inhComp = kcg_true;
  outC->_L81.indication = kcg_lit_float32(0.0);
  outC->_L77 = kcg_true;
  outC->_L76.Traction = kcg_lit_float32(0.0);
  outC->_L76.berem = kcg_lit_float32(0.0);
  outC->_L76.bs = kcg_lit_float32(0.0);
  outC->_L76.bs1 = kcg_lit_float32(0.0);
  outC->_L76.bs2 = kcg_lit_float32(0.0);
  outC->_L76.inhComp = kcg_true;
  outC->_L76.indication = kcg_lit_float32(0.0);
  outC->_L75.Traction = kcg_lit_float32(0.0);
  outC->_L75.berem = kcg_lit_float32(0.0);
  outC->_L75.bs = kcg_lit_float32(0.0);
  outC->_L75.bs1 = kcg_lit_float32(0.0);
  outC->_L75.bs2 = kcg_lit_float32(0.0);
  outC->_L75.inhComp = kcg_true;
  outC->_L75.indication = kcg_lit_float32(0.0);
  outC->_L74 = kcg_lit_float32(0.0);
  outC->_L73 = kcg_lit_float32(0.0);
  outC->_L72.Traction = kcg_lit_float32(0.0);
  outC->_L72.berem = kcg_lit_float32(0.0);
  outC->_L72.bs = kcg_lit_float32(0.0);
  outC->_L72.bs1 = kcg_lit_float32(0.0);
  outC->_L72.bs2 = kcg_lit_float32(0.0);
  outC->_L72.inhComp = kcg_true;
  outC->_L72.indication = kcg_lit_float32(0.0);
  outC->_L71.Traction = kcg_lit_float32(0.0);
  outC->_L71.berem = kcg_lit_float32(0.0);
  outC->_L71.bs = kcg_lit_float32(0.0);
  outC->_L71.bs1 = kcg_lit_float32(0.0);
  outC->_L71.bs2 = kcg_lit_float32(0.0);
  outC->_L71.inhComp = kcg_true;
  outC->_L71.indication = kcg_lit_float32(0.0);
  outC->_L70.Traction = kcg_lit_float32(0.0);
  outC->_L70.berem = kcg_lit_float32(0.0);
  outC->_L70.bs = kcg_lit_float32(0.0);
  outC->_L70.bs1 = kcg_lit_float32(0.0);
  outC->_L70.bs2 = kcg_lit_float32(0.0);
  outC->_L70.inhComp = kcg_true;
  outC->_L70.indication = kcg_lit_float32(0.0);
  for (idx1 = 0; idx1 < 114; idx1++) {
    outC->_L69.distances[idx1] = kcg_lit_float32(0.0);
  }
  for (idx2 = 0; idx2 < 114; idx2++) {
    outC->_L69.speeds[idx2] = kcg_lit_float32(0.0);
  }
  for (idx3 = 0; idx3 < 114; idx3++) {
    outC->_L69.accelerations[idx3] = kcg_lit_float32(0.0);
  }
  for (idx4 = 0; idx4 < 114; idx4++) {
    outC->_L69.valid[idx4] = kcg_true;
  }
  for (idx5 = 0; idx5 < 114; idx5++) {
    outC->_L68.distances[idx5] = kcg_lit_float32(0.0);
  }
  for (idx6 = 0; idx6 < 114; idx6++) {
    outC->_L68.speeds[idx6] = kcg_lit_float32(0.0);
  }
  for (idx7 = 0; idx7 < 114; idx7++) {
    outC->_L68.accelerations[idx7] = kcg_lit_float32(0.0);
  }
  ...
  outC->_L41 = kcg_lit_float32(0.0);
  outC->_L40 = kcg_true;
  outC->_L39.Loc_Abs = kcg_lit_float32(0.0);
  outC->_L39.MRS = kcg_lit_float32(0.0);
  outC->_L39.valid = kcg_true;
  for (idx9 = 0; idx9 < 110; idx9++) {
    outC->_L28[idx9].Traction = kcg_lit_float32(0.0);
    outC->_L28[idx9].berem = kcg_lit_float32(0.0);
    outC->_L28[idx9].bs = kcg_lit_float32(0.0);
    outC->_L28[idx9].bs1 = kcg_lit_float32(0.0);
    outC->_L28[idx9].bs2 = kcg_lit_float32(0.0);
    outC->_L28[idx9].inhComp = kcg_true;
    outC->_L28[idx9].indication = kcg_lit_float32(0.0);
  }
  for (idx14 = 0; idx14 < 110; idx14++) {
    for (idx10 = 0; idx10 < 114; idx10++) {
      outC->_L27[idx14].distances[idx10] = kcg_lit_float32(0.0);
    }
    for (idx11 = 0; idx11 < 114; idx11++) {
      outC->_L27[idx14].speeds[idx11] = kcg_lit_float32(0.0);
    }
    for (idx12 = 0; idx12 < 114; idx12++) {
      outC->_L27[idx14].accelerations[idx12] = kcg_lit_float32(0.0);
    }
  ...
  for (idx20 = 0; idx20 < 110; idx20++) {
    for (idx16 = 0; idx16 < 114; idx16++) {
      outC->_L18[idx20].distances[idx16] = kcg_lit_float32(0.0);
    }
    for (idx17 = 0; idx17 < 114; idx17++) {
      outC->_L18[idx20].speeds[idx17] = kcg_lit_float32(0.0);
    }
    for (idx18 = 0; idx18 < 114; idx18++) {
      outC->_L18[idx20].accelerations[idx18] = kcg_lit_float32(0.0);
    }
    for (idx19 = 0; idx19 < 114; idx19++) {
      outC->_L18[idx20].valid[idx19] = kcg_true;
    }
  }
  outC->_L17.Traction = kcg_lit_float32(0.0);
  outC->_L17.berem = kcg_lit_float32(0.0);
  outC->_L17.bs = kcg_lit_float32(0.0);
  outC->_L17.bs1 = kcg_lit_float32(0.0);
  outC->_L17.bs2 = kcg_lit_float32(0.0);
  outC->_L17.inhComp = kcg_true;
  outC->_L17.indication = kcg_lit_float32(0.0);
  for (idx21 = 0; idx21 < 114; idx21++) {
    outC->_L16.distances[idx21] = kcg_lit_float32(0.0);
  }
  for (idx22 = 0; idx22 < 114; idx22++) {
    outC->_L16.speeds[idx22] = kcg_lit_float32(0.0);
  }
  for (idx23 = 0; idx23 < 114; idx23++) {
    outC->_L16.accelerations[idx23] = kcg_lit_float32(0.0);
  }
  ...
  for (idx25 = 0; idx25 < 114; idx25++) {
    outC->_L12.distances[idx25] = kcg_lit_float32(0.0);
  }
  for (idx26 = 0; idx26 < 114; idx26++) {
    outC->_L12.speeds[idx26] = kcg_lit_float32(0.0);
  }
  for (idx27 = 0; idx27 < 114; idx27++) {
    outC->_L12.accelerations[idx27] = kcg_lit_float32(0.0);
  }
  for (idx28 = 0; idx28 < 114; idx28++) {
    outC->_L12.valid[idx28] = kcg_true;
  }
  for (idx29 = 0; idx29 < 110; idx29++) {
    outC->_L11[idx29].Loc_Abs = kcg_lit_float32(0.0);
    outC->_L11[idx29].MRS = kcg_lit_float32(0.0);
  ...
  outC->_L4 = kcg_true;
  outC->_L3 = kcg_lit_int32(0);
  outC->_L1.Loc_Abs = kcg_lit_float32(0.0);
  outC->_L1.MRS = kcg_lit_float32(0.0);
  outC->_L1.valid = kcg_true;
  outC->valid = kcg_true;
  outC->D_I_V_MRSP = kcg_lit_float32(0.0);
  outC->D_preindication = kcg_lit_float32(0.0);
  for (idx = 0; idx < 110; idx++) {
    /* _L3=(TargetLimits_Pkg::MRSPPreindicationIterator#1)/ */
