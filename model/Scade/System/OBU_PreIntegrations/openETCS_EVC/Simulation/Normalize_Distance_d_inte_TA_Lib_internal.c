...
{
  /* d_internal/ */
  L_internal_Type_Obu_BasicTypes_Pkg d_internal_partial;
  /* d_internal/ */
  L_internal_Type_Obu_BasicTypes_Pkg _1_d_internal_partial;
  /* d_internal/ */
  L_internal_Type_Obu_BasicTypes_Pkg _2_d_internal_partial;
  /* d_internal/ */
  L_internal_Type_Obu_BasicTypes_Pkg _3_d_internal_partial;
...
void Normalize_Distance_d_inte_init_TA_Lib_internal(
  outC_Normalize_Distance_d_inte_TA_Lib_internal *outC)
{
