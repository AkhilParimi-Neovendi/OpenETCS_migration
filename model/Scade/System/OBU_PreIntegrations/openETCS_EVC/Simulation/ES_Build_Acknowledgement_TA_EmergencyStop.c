  ...
  outC_ES_Build_Acknowledgement_TA_EmergencyStop *outC)
{
  ...
  kcg_copy__17_Radio_TrainTrack_Header_T_TM_transitional(
    &outC->_L6.header,
    &outC->_L8);
  ...
  outC_ES_Build_Acknowledgement_TA_EmergencyStop *outC)
{
  ...
  outC->_L32.transitionInformation = kcg_lit_int32(0);
  outC->_L31.valid = kcg_true;
  outC->_L31.TrainRunningNumber = kcg_lit_int32(0);
  outC->_L30.valid = kcg_true;
  outC->_L30.m_error = M_ERROR_Balise_group_linking_consistency_error;
  outC->_L29.valid = kcg_true;
  outC->_L29.number = kcg_lit_int32(0);
  for (idx1 = 0; idx1 < 1; idx1++) {
    outC->_L29.aNID_RADIO[idx1].valid = kcg_true;
    for (idx = 0; idx < 15; idx++) {
      outC->_L29.aNID_RADIO[idx1].telephoneNumber[idx] = kcg_lit_int32(0);
    }
  }
  ...
  for (idx2 = 0; idx2 < 4; idx2++) {
    ...
    outC->_L28.tractionIdentity[idx2].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L28.nIter_ntc = kcg_lit_int32(0);
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L28.nid_ntc[idx3] = kcg_lit_int32(0);
  }
  ...
  for (idx5 = 0; idx5 < 1; idx5++) {
    ...
    for (idx4 = 0; idx4 < 15; idx4++) {
      outC->_L27.p3.aNID_RADIO[idx5].telephoneNumber[idx4] = kcg_lit_int32(0);
    }
  }
  ...
  for (idx6 = 0; idx6 < 4; idx6++) {
    outC->_L27.p11.tractionIdentity[idx6].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L27.p11.tractionIdentity[idx6].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L27.p11.nIter_ntc = kcg_lit_int32(0);
  for (idx7 = 0; idx7 < 5; idx7++) {
    outC->_L27.p11.nid_ntc[idx7] = kcg_lit_int32(0);
  }
  ...
  outC->_L26.packet1.NID_PACKET = kcg_lit_int32(0);
  outC->_L26.packet1.L_PACKET = kcg_lit_int32(0);
  outC->_L26.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L26.packet1.NID_LRBG = kcg_lit_int32(0);
  outC->_L26.packet1.NID_PRVLRBG = kcg_lit_int32(0);
  outC->_L26.packet1.D_LRBG = kcg_lit_int32(0);
  outC->_L26.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L26.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L26.packet1.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L26.packet1.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L26.packet1.length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L26.packet1.L_TRAININT = kcg_lit_int32(0);
  outC->_L26.packet1.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L26.packet1.NID_NTC = kcg_lit_int32(0);
  ...
  for (idx9 = 0; idx9 < 1; idx9++) {
    ...
    for (idx8 = 0; idx8 < 15; idx8++) {
      outC->_L6.packets.p3.aNID_RADIO[idx9].telephoneNumber[idx8] = kcg_lit_int32(0);
    }
  }
  ...
  for (idx10 = 0; idx10 < 4; idx10++) {
    outC->_L6.packets.p11.tractionIdentity[idx10].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L6.packets.p11.tractionIdentity[idx10].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L6.packets.p11.nIter_ntc = kcg_lit_int32(0);
  for (idx11 = 0; idx11 < 5; idx11++) {
    outC->_L6.packets.p11.nid_ntc[idx11] = kcg_lit_int32(0);
  }
  ...
  for (idx15 = 0; idx15 < 5; idx15++) {
    outC->message147.packets.p11.nid_ntc[idx15] = kcg_lit_int32(0);
  }
}
