...
typedef struct {
  ...
  outC_processRadioCtrlCmds_v2_Handover_Pkg_handoverUtils_Pkg /* _L245=(Handover_Pkg::handoverUtils_Pkg::processRadioCtrlCmds_v2#1)/ */ _1_Context_processRadioCtrlCmds_v2_1;
