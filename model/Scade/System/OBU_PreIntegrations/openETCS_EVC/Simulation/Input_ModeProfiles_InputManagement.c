...
{
  /* Loc_Mode_Profile/ */
  T_MA_Level_And_Mode_Types_Pkg Loc_Mode_Profile_partial;
  /* Loc_Mode_Profile/ */
  T_MA_Level_And_Mode_Types_Pkg _1_Loc_Mode_Profile_partial;
  Q_DIR noname;
  Q_MAMODE _2_noname;
  ...
  scaledDistance_2_distance_InputManagement(
    outC->_L7,
    outC->_L11,
    &outC->_2_Context_scaledDistance_2_distance_4);
  outC->_L22 = outC->_2_Context_scaledDistance_2_distance_4.distance;
  outC->_L12 = outC->_L15.l_ackmamode;
  /* _L21=(InputManagement::scaledDistance_2_distance#3)/ */
  scaledDistance_2_distance_InputManagement(
    outC->_L7,
    outC->_L12,
    &outC->_1_Context_scaledDistance_2_distance_3);
  outC->_L21 = outC->_1_Context_scaledDistance_2_distance_3.distance;
