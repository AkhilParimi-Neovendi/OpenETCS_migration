  ...
  outC_C_P046_us_array_TM_lib_internal *outC)
{
  ...
  /* _L19=(TM_lib_internal::C_P046_extract_el_section#2)/ */
  C_P046_extract_el_section_TM_lib_internal(
    outC->_L16,
    &outC->_L1,
    kcg_lit_int32(1),
    &outC->_1_Context_C_P046_extract_el_section_2);
  outC->_L19 = outC->_1_Context_C_P046_extract_el_section_2.element;
  ...
  /* _L15=(TM_lib_internal::C_P046_extract_el_section#1)/ */
  C_P046_extract_el_section_TM_lib_internal(
    outC->_L16,
    &outC->_L1,
    kcg_lit_int32(0),
...
void C_P046_us_array_init_TM_lib_internal(
  outC_C_P046_us_array_TM_lib_internal *outC)
{
  kcg_size idx;
  ...
  CAST_Int_to_M_LEVELTR_init_TM_conversions(
    &outC->Context_CAST_Int_to_M_LEVELTR_1);
  /* _L15=(TM_lib_internal::C_P046_extract_el_section#1)/ */
  C_P046_extract_el_section_init_TM_lib_internal(
    &outC->Context_C_P046_extract_el_section_1);
  /* _L28=(TM_conversions::CAST_Int_to_NID_NTC#1)/ */
  ...
  outC_C_P046_us_array_TM_lib_internal *outC)
{
  ...
  CAST_Int_to_M_LEVELTR_reset_TM_conversions(
    &outC->Context_CAST_Int_to_M_LEVELTR_1);
  /* _L15=(TM_lib_internal::C_P046_extract_el_section#1)/ */
  C_P046_extract_el_section_reset_TM_lib_internal(
    &outC->Context_C_P046_extract_el_section_1);
  /* _L28=(TM_conversions::CAST_Int_to_NID_NTC#1)/ */
