...
*************************************************************$ */
#ifndef _CAST_DMI_trackConditionEl_DATA_Variables_H_
#define _CAST_DMI_trackConditionEl_DATA_Variables_H_
...
typedef struct {
  ...
  kcg_int32 /* _L4/ */ _L4;
  kcg_int32 /* _L5/ */ _L5;
} outC_CAST_DMI_trackConditionEl_DATA_Variables;

/* ===========  node initialization and cycle functions  =========== */
/* DATA::Variables::CAST_DMI_trackConditionElement_to_int/ */
extern void CAST_DMI_trackConditionEl_DATA_Variables(
  /* dmi_trackConditionElement/ */
  DMI_trackConditionElement_T_DMI_Types_Pkg *dmi_trackConditionElement,
  outC_CAST_DMI_trackConditionEl_DATA_Variables *outC);

#ifndef KCG_NO_EXTERN_CALL_TO_RESET
extern void CAST_DMI_trackConditionEl_reset_DATA_Variables(
  outC_CAST_DMI_trackConditionEl_DATA_Variables *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CAST_DMI_trackConditionEl_init_DATA_Variables(
  outC_CAST_DMI_trackConditionEl_DATA_Variables *outC);
#endif /* KCG_USER_DEFINED_INIT */



#endif /* _CAST_DMI_trackConditionEl_DATA_Variables_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_trackConditionEl_DATA_Variables.h
** Generation date: 2023-11-06T13:54:28
*************************************************************$ */
