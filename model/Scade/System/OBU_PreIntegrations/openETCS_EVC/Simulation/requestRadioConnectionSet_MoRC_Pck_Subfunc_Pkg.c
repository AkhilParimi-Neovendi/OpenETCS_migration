...
{
  /* connectionCmd/ */
  mobileConnectionCmd_T_RCM_Types_Pkg connectionCmd_partial;
  /* connectionCmd/ */
  mobileConnectionCmd_T_RCM_Types_Pkg _1_connectionCmd_partial;
  /* connectionCmd/ */
  mobileConnectionCmd_T_RCM_Types_Pkg _2_connectionCmd_partial;
  /* connectionCmd/ */
  mobileConnectionCmd_T_RCM_Types_Pkg _3_connectionCmd_partial;
  /* connectionCmd/ */
  mobileConnectionCmd_T_RCM_Types_Pkg _4_connectionCmd_partial;
  /* connectionCmd/ */
  mobileConnectionCmd_T_RCM_Types_Pkg _5_connectionCmd_partial;
  /* connectionCmd/ */
  mobileConnectionCmd_T_RCM_Types_Pkg _6_connectionCmd_partial;
  /* connectionCmd/ */
  mobileConnectionCmd_T_RCM_Types_Pkg _7_connectionCmd_partial;
  /* repeat_SM: */
  SSM_ST_repeat_SM repeat_SM_state_nxt_partial;
  /* repeat_SM: */
  kcg_bool repeat_SM_reset_nxt_partial;
  /* repeat_SM: */
  SSM_TR_repeat_SM repeat_SM_fired_partial;
  /* repeat_SM: */
  SSM_ST_repeat_SM _8_repeat_SM_state_nxt_partial;
  /* repeat_SM: */
  kcg_bool _9_repeat_SM_reset_nxt_partial;
  /* repeat_SM: */
  SSM_TR_repeat_SM _10_repeat_SM_fired_partial;
  /* repeat_SM: */
  SSM_ST_repeat_SM _11_repeat_SM_state_nxt_partial;
  /* repeat_SM: */
  kcg_bool _12_repeat_SM_reset_nxt_partial;
  /* repeat_SM: */
  SSM_TR_repeat_SM _13_repeat_SM_fired_partial;
  /* repeat_SM: */
  SSM_ST_repeat_SM repeat_SM_state_act_partial;
  /* repeat_SM: */
  kcg_bool repeat_SM_reset_act_partial;
  /* repeat_SM: */
  SSM_TR_repeat_SM repeat_SM_fired_strong_partial;
  /* repeat_SM:rep_inactive:<2> */
  kcg_bool tr_2_guard_rep_inactive_repeat_SM;
  /* repeat_SM:rep_inactive:<1> */
  kcg_bool tr_1_guard_rep_inactive_repeat_SM;
  /* repeat_SM: */
  SSM_ST_repeat_SM _14_repeat_SM_state_act_partial;
  /* repeat_SM: */
  kcg_bool _15_repeat_SM_reset_act_partial;
  /* repeat_SM: */
  SSM_TR_repeat_SM _16_repeat_SM_fired_strong_partial;
  /* repeat_SM:rep_repeatUntilSuccessfulOrADefinedNumberOfTimes:<2> */
  kcg_bool tr_2_guard_rep_repeatUntilSuccessfulOrADefinedNumberOfTimes_repeat_SM;
  /* repeat_SM:rep_repeatUntilSuccessfulOrADefinedNumberOfTimes:<1> */
  kcg_bool tr_1_guard_rep_repeatUntilSuccessfulOrADefinedNumberOfTimes_repeat_SM;
  /* repeat_SM: */
  SSM_ST_repeat_SM _17_repeat_SM_state_act_partial;
  /* repeat_SM: */
  kcg_bool _18_repeat_SM_reset_act_partial;
  /* repeat_SM: */
  SSM_TR_repeat_SM _19_repeat_SM_fired_strong_partial;
  /* repeat_SM:rep_repeatUntilStopConditionMet:<2> */
  kcg_bool tr_2_guard_rep_repeatUntilStopConditionMet_repeat_SM;
  /* repeat_SM:rep_repeatUntilStopConditionMet:<1> */
  kcg_bool tr_1_guard_rep_repeatUntilStopConditionMet_repeat_SM;
  kcg_int32 noname;
  kcg_bool _20_noname;
  /* repeat_SM: */
  kcg_bool repeat_SM_reset_sel;
  /* repeat_SM: */
  kcg_bool repeat_SM_reset_prv;
  ...
  outC_requestRadioConnectionSet_MoRC_Pck_Subfunc_Pkg *outC)
{
  ...
  outC->_L405.origin.rbc_id = kcg_lit_int32(0);
  outC->_L405.origin.device_id = kcg_lit_int32(0);
  outC->_L404 = kcg_true;
  ...
  outC->_L403.origin.rbc_id = kcg_lit_int32(0);
  outC->_L403.origin.device_id = kcg_lit_int32(0);
  outC->_L402 = kcg_true;
  outC->_L401 = kcg_true;
  ...
  outC->_L345.origin.rbc_id = kcg_lit_int32(0);
  outC->_L345.origin.device_id = kcg_lit_int32(0);
  ...
  outC->p42_sessionManagement_mem.origin.nid_c = kcg_lit_int32(0);
  outC->p42_sessionManagement_mem.origin.rbc_id = kcg_lit_int32(0);
  outC->p42_sessionManagement_mem.origin.device_id = kcg_lit_int32(0);
  ...
  outC->_L12_then_else_IfBlock1.origin.nid_c = kcg_lit_int32(0);
  outC->_L12_then_else_IfBlock1.origin.rbc_id = kcg_lit_int32(0);
