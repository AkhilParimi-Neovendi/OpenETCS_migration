...
{
  /* reportedBGs/ */
  ReportedBGList_T_ProvidePositionReport_Pkg last_reportedBGs;
  ...
  outC_CheckValidityPacket58_ProvidePositionReport_Pkg *outC)
{
  ...
  outC->_L50.o_nominal = kcg_lit_int32(0);
  outC->_L50.o_min = kcg_lit_int32(0);
  outC->_L50.o_max = kcg_lit_int32(0);
  ...
  for (idx = 0; idx < 8; idx++) {
    ...
    outC->_L33[idx].nidBG = kcg_lit_int32(0);
    outC->_L33[idx].location.nominal = kcg_lit_int32(0);
    outC->_L33[idx].location.d_min = kcg_lit_int32(0);
    outC->_L33[idx].location.d_max = kcg_lit_int32(0);
  }
  outC->_L32 = kcg_lit_int32(0);
  outC->_L31.valid = kcg_true;
  outC->_L31.timestamp = kcg_lit_int32(0);
  outC->_L31.odo.o_nominal = kcg_lit_int32(0);
  outC->_L31.odo.o_min = kcg_lit_int32(0);
  outC->_L31.odo.o_max = kcg_lit_int32(0);
  outC->_L31.speed.v_safeNominal = kcg_lit_int32(0);
  outC->_L31.speed.v_rawNominal = kcg_lit_int32(0);
  outC->_L31.speed.v_lower = kcg_lit_int32(0);
  outC->_L31.speed.v_upper = kcg_lit_int32(0);
  outC->_L31.acceleration = kcg_lit_int32(0);
  ...
  for (idx1 = 0; idx1 < 8; idx1++) {
    ...
    outC->_L5[idx1].nidBG = kcg_lit_int32(0);
    outC->_L5[idx1].location.nominal = kcg_lit_int32(0);
    outC->_L5[idx1].location.d_min = kcg_lit_int32(0);
    outC->_L5[idx1].location.d_max = kcg_lit_int32(0);
  }
  for (idx2 = 0; idx2 < 8; idx2++) {
    outC->updatedBGs[idx2].valid = kcg_true;
    outC->updatedBGs[idx2].nidBG = kcg_lit_int32(0);
    outC->updatedBGs[idx2].location.nominal = kcg_lit_int32(0);
    outC->updatedBGs[idx2].location.d_min = kcg_lit_int32(0);
    outC->updatedBGs[idx2].location.d_max = kcg_lit_int32(0);
  }
  outC->found = kcg_true;
  /* _L35=(ProvidePositionReport_Pkg::BG_hasBeenReported#1)/ */
