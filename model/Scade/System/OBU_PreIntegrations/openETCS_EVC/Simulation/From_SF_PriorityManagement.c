...
{
  /* FromSF_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg FromSF_To_NewMode_partial;
  /* FromSF_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _1_FromSF_To_NewMode_partial;
  /* FromSF_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _2_FromSF_To_NewMode_partial;
  /* FromSF_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _3_FromSF_To_NewMode_partial;
