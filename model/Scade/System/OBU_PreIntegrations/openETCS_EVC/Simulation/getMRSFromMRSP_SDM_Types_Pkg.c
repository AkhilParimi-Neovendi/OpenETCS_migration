...
void getMRSFromMRSP_init_SDM_Types_Pkg(outC_getMRSFromMRSP_SDM_Types_Pkg *outC)
{
  ...
  for (idx = 0; idx < 110; idx++) {
    outC->_L6[idx] = kcg_lit_float32(0.0);
  }
  outC->_L5.Loc_Abs = kcg_lit_float32(0.0);
  outC->_L5.MRS = kcg_lit_float32(0.0);
  outC->_L5.valid = kcg_true;
  outC->_L4 = kcg_lit_float32(0.0);
  for (idx1 = 0; idx1 < 110; idx1++) {
    outC->_L1[idx1].Loc_Abs = kcg_lit_float32(0.0);
    outC->_L1[idx1].MRS = kcg_lit_float32(0.0);
    outC->_L1[idx1].valid = kcg_true;
  }
  for (idx2 = 0; idx2 < 110; idx2++) {
    outC->_L8_searchMRSP_2[idx2].Loc_Abs = kcg_lit_float32(0.0);
    outC->_L8_searchMRSP_2[idx2].MRS = kcg_lit_float32(0.0);
    outC->_L8_searchMRSP_2[idx2].valid = kcg_true;
  }
  for (idx3 = 0; idx3 < 110; idx3++) {
    outC->_L40_searchMRSP_2[idx3].Loc_Abs = kcg_lit_float32(0.0);
    outC->_L40_searchMRSP_2[idx3].MRS = kcg_lit_float32(0.0);
  ...
  for (idx5 = 0; idx5 < 110; idx5++) {
    outC->_L84_searchMRSP_2[idx5].Loc_Abs = kcg_lit_float32(0.0);
    outC->_L84_searchMRSP_2[idx5].MRS = kcg_lit_float32(0.0);
    outC->_L84_searchMRSP_2[idx5].valid = kcg_true;
  }
  for (idx6 = 0; idx6 < 110; idx6++) {
    outC->_L74_searchMRSP_2[idx6] = kcg_lit_float32(0.0);
  }
  ...
  for (idx9 = 0; idx9 < 110; idx9++) {
    outC->_L90_searchMRSP_2[idx9] = kcg_lit_float32(0.0);
  }
  for (idx10 = 0; idx10 < 110; idx10++) {
    outC->_L91_searchMRSP_2[idx10].Loc_Abs = kcg_lit_float32(0.0);
    outC->_L91_searchMRSP_2[idx10].MRS = kcg_lit_float32(0.0);
    outC->_L91_searchMRSP_2[idx10].valid = kcg_true;
  }
  outC->V_MRSP = kcg_lit_float32(0.0);
}
