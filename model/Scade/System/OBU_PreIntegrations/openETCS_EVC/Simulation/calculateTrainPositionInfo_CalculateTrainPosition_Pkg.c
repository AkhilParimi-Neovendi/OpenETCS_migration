  ...
  outC_calculateTrainPositionInfo_CalculateTrainPosition_Pkg *outC)
{
  ...
  positionedBG_T_TrainPosition_Types_Pck _4_op_call;
  positionedBG_T_TrainPosition_Types_Pck _5_op_call;
  positionedBG_T_TrainPosition_Types_Pck _6_op_call;
  positionedBG_T_TrainPosition_Types_Pck noname;

  outC->_L66 = recalculateBGs;
  outC->every2 = outC->_L66;
  ...
  positionDerivedFromPassedBG_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
    &outC->_L13,
    &outC->_L62,
    &outC->_1_Context_positionDerivedFromPassedBG_1);
  kcg_copy_LocWithInAcc_T_Obu_BasicTypes_Pkg(
    &outC->_L7,
    &outC->_1_Context_positionDerivedFromPassedBG_1.position);
