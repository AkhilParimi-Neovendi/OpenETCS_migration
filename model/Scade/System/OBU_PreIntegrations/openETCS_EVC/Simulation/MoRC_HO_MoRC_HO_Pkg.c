...
{
  safeRadioConnectionIndication_T_RCM_Session_Types_Pkg noname;
  kcg_bool _1_noname;
  msgToTrack_T_RCM_MsgTypes_Pkg _2_noname;
  msgToTrack_T_RCM_MsgTypes_Pkg _3_noname;
  /* morcStatus_2/ */
  morcStatus_T_RCM_Session_Types_Pkg last_morcStatus_2;
  /* morcStatus_1/ */
  morcStatus_T_RCM_Session_Types_Pkg last_morcStatus_1;
  ...
  kcg_copy_m39_AckOfTerminationOfACommunicationSession_T_RCM_MsgTypes_Pkg(
    &outC->_2_m39_AckOfTerminationOfACommunicationSession_p,
    &outC->_L173);
  ...
  kcg_copy_m38_initiationOfACommunicationSession_T_RCM_MsgTypes_Pkg(
    &outC->_1_m38_initiationOfACommunicationSessionMsg_p,
    &outC->_L174);
  outC->_L171 = kcg_true;
...
void MoRC_HO_init_MoRC_HO_Pkg(outC_MoRC_HO_MoRC_HO_Pkg *outC)
{
  ...
  outC->_2_m39_AckOfTerminationOfACommunicationSession_p.valid = kcg_true;
  outC->_2_m39_AckOfTerminationOfACommunicationSession_p.msgSrc =
    msrc_undefined_Common_Types_Pkg;
  outC->_2_m39_AckOfTerminationOfACommunicationSession_p.origin.valid = kcg_true;
  outC->_2_m39_AckOfTerminationOfACommunicationSession_p.origin.nid_c =
    kcg_lit_int32(0);
  outC->_2_m39_AckOfTerminationOfACommunicationSession_p.origin.rbc_id =
    kcg_lit_int32(0);
  outC->_2_m39_AckOfTerminationOfACommunicationSession_p.origin.device_id =
    kcg_lit_int32(0);
  outC->_2_m39_AckOfTerminationOfACommunicationSession_p.lrbg = kcg_lit_int32(0);
  outC->_1_m38_initiationOfACommunicationSessionMsg_p.valid = kcg_true;
  outC->_1_m38_initiationOfACommunicationSessionMsg_p.msgSrc =
    msrc_undefined_Common_Types_Pkg;
  outC->_1_m38_initiationOfACommunicationSessionMsg_p.origin.valid = kcg_true;
  outC->_1_m38_initiationOfACommunicationSessionMsg_p.origin.nid_c =
    kcg_lit_int32(0);
  outC->_1_m38_initiationOfACommunicationSessionMsg_p.origin.rbc_id =
    kcg_lit_int32(0);
  outC->_1_m38_initiationOfACommunicationSessionMsg_p.origin.device_id =
    kcg_lit_int32(0);
