  ...
  outC_C_P011_train_compr_TM_TrainToTrack *outC)
{
  ...
  C_P011_flatten_sections_ntc_TM_TrainToTrack_lib_internal(
    &outC->_L89,
    &outC->_1_Context_C_P011_flatten_sections_ntc_1);
  kcg_copy_P011_ntc_list_array_T_TM_TrainToTrack(
    &outC->_L114,
    &outC->_1_Context_C_P011_flatten_sections_ntc_1.Flattened);
  ...
  C_P011_flatten_sections_v_TM_TrainToTrack_lib_internal(
    &outC->_L91,
  ...
  kcg_copy_DMI_Driver_Identifier_int_array_T_DATA(&outC->_L110[0], &outC->_L68);
  ...
  outC_C_P011_train_compr_TM_TrainToTrack *outC)
{
  ...
  /* _L113=(TM_TrainToTrack_lib_internal::C_P011_flatten_sections_voltage#1)/ */
  C_P011_flatten_sections_v_init_TM_TrainToTrack_lib_internal(
    &outC->Context_C_P011_flatten_sections_voltage_1);
  /* _L114=(TM_TrainToTrack_lib_internal::C_P011_flatten_sections_ntc#1)/ */
  ...
  outC_C_P011_train_compr_TM_TrainToTrack *outC)
{
  ...
  /* _L113=(TM_TrainToTrack_lib_internal::C_P011_flatten_sections_voltage#1)/ */
  C_P011_flatten_sections_v_reset_TM_TrainToTrack_lib_internal(
    &outC->Context_C_P011_flatten_sections_voltage_1);
  /* _L114=(TM_TrainToTrack_lib_internal::C_P011_flatten_sections_ntc#1)/ */
