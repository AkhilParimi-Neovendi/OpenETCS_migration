...
typedef struct {
  ...
  outC_GP_Find_First_Gsection_Af_TA_Gradient_new /* _L4=(TA_Gradient_new::GP_Find_First_Gsection_After_BG_loop#1)/ */ Context_GP_Find_First_Gsection_After_BG_loop_1[50];
