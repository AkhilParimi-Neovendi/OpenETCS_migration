...
void CAST_Q_TEXTCONFIRM_to_int_TM_conversions(
  /* q_textconfirm/ */
  Q_TEXTCONFIRM q_textconfirm,
  outC_CAST_Q_TEXTCONFIRM_to_int_TM_conversions *outC)
{
  /* q_textconfirm_int/ */
  kcg_int32 q_textconfirm_int_partial;
  /* error/ */
  kcg_bool error_partial;
  /* q_textconfirm_int/ */
  kcg_int32 _1_q_textconfirm_int_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* q_textconfirm_int/ */
  kcg_int32 _3_q_textconfirm_int_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* q_textconfirm_int/ */
  kcg_int32 _5_q_textconfirm_int_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* error/ */
  kcg_bool _7_error_partial;
  /* q_textconfirm_int/ */
  kcg_int32 _8_q_textconfirm_int_partial;
  /* error/ */
  kcg_bool _9_error_partial;
  /* q_textconfirm_int/ */
  kcg_int32 _10_q_textconfirm_int_partial;
  /* error/ */
  kcg_bool _11_error_partial;
  /* q_textconfirm_int/ */
  kcg_int32 _12_q_textconfirm_int_partial;
  /* error/ */
  kcg_bool _13_error_partial;
  /* q_textconfirm_int/ */
  kcg_int32 _14_q_textconfirm_int_partial;
  kcg_bool noname;
  ...
  if (outC->IfBlock1_clock) {
    ...
    outC->else_clock_IfBlock1 = outC->q_textconfirm_in ==
      _55_ENUM_Q_TEXTCONFIRM_confirmation_EB_TM_conversions;
    /* IfBlock1:else: */
    if (outC->else_clock_IfBlock1) {
      ...
      outC->else_clock_else_IfBlock1 = outC->q_textconfirm_in ==
        _57_ENUM_Q_TEXTCONFIRM_confirmation_SB_TM_conversions;
      /* IfBlock1:else:else: */
  ...
  /* IfBlock1: */
  if (outC->IfBlock1_clock) {
    outC->_L2_then_IfBlock1 = INT_Q_TEXTCONFIRM_confirmation_TM_conversions;
    q_textconfirm_int_partial = outC->_L2_then_IfBlock1;
    outC->q_textconfirm_int = q_textconfirm_int_partial;
  }
  else {
    /* IfBlock1:else: */
    if (outC->else_clock_IfBlock1) {
      outC->_L1_then_else_IfBlock1 =
        _60_INT_Q_TEXTCONFIRM_confirmation_EB_TM_conversions;
      _14_q_textconfirm_int_partial = outC->_L1_then_else_IfBlock1;
      _1_q_textconfirm_int_partial = _14_q_textconfirm_int_partial;
    }
    else {
      /* IfBlock1:else:else: */
      if (outC->else_clock_else_IfBlock1) {
        outC->_L1_then_else_else_IfBlock1 =
          _59_INT_Q_TEXTCONFIRM_confirmation_SB_TM_conversions;
        _3_q_textconfirm_int_partial = outC->_L1_then_else_else_IfBlock1;
        _12_q_textconfirm_int_partial = _3_q_textconfirm_int_partial;
      }
      else {
        /* IfBlock1:else:else:else: */
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          _10_q_textconfirm_int_partial = outC->_L2_then_else_else_else_IfBlock1;
          _5_q_textconfirm_int_partial = _10_q_textconfirm_int_partial;
        }
        else {
          outC->_L2_else_else_else_else_IfBlock1 =
            INT_Q_TEXTCONFIRM_confirmation_TM_conversions;
          _8_q_textconfirm_int_partial = outC->_L2_else_else_else_else_IfBlock1;
          _5_q_textconfirm_int_partial = _8_q_textconfirm_int_partial;
        }
        _12_q_textconfirm_int_partial = _5_q_textconfirm_int_partial;
      }
      _1_q_textconfirm_int_partial = _12_q_textconfirm_int_partial;
    }
    outC->q_textconfirm_int = _1_q_textconfirm_int_partial;
  }
}

#ifndef KCG_USER_DEFINED_INIT
void CAST_Q_TEXTCONFIRM_to_int_init_TM_conversions(
  outC_CAST_Q_TEXTCONFIRM_to_int_TM_conversions *outC)
{
  outC->_L4 = kcg_true;
...
void CAST_Q_TEXTCONFIRM_to_int_reset_TM_conversions(
  outC_CAST_Q_TEXTCONFIRM_to_int_TM_conversions *outC)
{
}
