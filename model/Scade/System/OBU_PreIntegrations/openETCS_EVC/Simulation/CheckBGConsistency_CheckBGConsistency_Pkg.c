  ...
  outC_CheckBGConsistency_CheckBGConsistency_Pkg *outC)
{
  ...
  /* applyServiceBrake/ */
  kcg_bool _2_applyServiceBrake_partial;
  /* badBaliseMessageToDMI/ */
  kcg_bool _3_badBaliseMessageToDMI_partial;
  /* errorLinkedBG/ */
  kcg_bool _4_errorLinkedBG_partial;
  /* errorUnlinkedBG/ */
  kcg_bool _5_errorUnlinkedBG_partial;
  /* nid_errorBG/ */
  NID_ERRORBG_BG_Types_Pkg _6_nid_errorBG_partial;
  /* nid_c/ */
  NID_C _7_nid_c_partial;
  /* nid_c/ */
  NID_C _8_nid_c_partial;
  /* nid_errorBG/ */
  NID_ERRORBG_BG_Types_Pkg _9_nid_errorBG_partial;
  /* errorUnlinkedBG/ */
  kcg_bool _10_errorUnlinkedBG_partial;
  /* badBaliseMessageToDMI/ */
  kcg_bool _11_badBaliseMessageToDMI_partial;
  /* applyServiceBrake/ */
  kcg_bool _12_applyServiceBrake_partial;
  /* passedBG_out/ */
  ReceivedMessage_T_Common_Types_Pkg _13_passedBG_out_partial;
  /* nid_c/ */
  NID_C _14_nid_c_partial;
  /* nid_errorBG/ */
  NID_ERRORBG_BG_Types_Pkg _15_nid_errorBG_partial;
  /* errorUnlinkedBG/ */
  kcg_bool _16_errorUnlinkedBG_partial;
  /* badBaliseMessageToDMI/ */
  kcg_bool _17_badBaliseMessageToDMI_partial;
  /* applyServiceBrake/ */
  kcg_bool _18_applyServiceBrake_partial;
  /* passedBG_out/ */
  ReceivedMessage_T_Common_Types_Pkg _19_passedBG_out_partial;
  kcg_bool noname;
