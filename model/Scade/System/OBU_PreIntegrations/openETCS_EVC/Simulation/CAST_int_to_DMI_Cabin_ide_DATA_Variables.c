...
#include "CAST_int_to_DMI_Cabin_ide_DATA_Variables.h"

/* DATA::Variables::CAST_int_to_DMI_Cabin_identifier/ */
void CAST_int_to_DMI_Cabin_ide_DATA_Variables(
  /* dmi_cabin_identifier_int/ */
  kcg_int32 dmi_cabin_identifier_int,
  outC_CAST_int_to_DMI_Cabin_ide_DATA_Variables *outC)
{
  /* dmi_cabin_identifier_ct/ */
  DMI_Cabin_Identifier_T_DMI_Types_Pkg dmi_cabin_identifier_ct_partial;
  /* error/ */
  kcg_bool error_partial;
  /* dmi_cabin_identifier_ct/ */
  DMI_Cabin_Identifier_T_DMI_Types_Pkg _1_dmi_cabin_identifier_ct_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* error/ */
  kcg_bool _3_error_partial;
  /* dmi_cabin_identifier_ct/ */
  DMI_Cabin_Identifier_T_DMI_Types_Pkg _4_dmi_cabin_identifier_ct_partial;
  /* error/ */
  kcg_bool _5_error_partial;
  /* dmi_cabin_identifier_ct/ */
  DMI_Cabin_Identifier_T_DMI_Types_Pkg _6_dmi_cabin_identifier_ct_partial;
  kcg_bool noname;
  ...
  if (outC->IfBlock1_clock) {
    ...
    outC->else_clock_IfBlock1 = dmi_cabin_identifier_int ==
      _71_INT_DMI_Cabin_Identifier_T_cabin_B;
    /* IfBlock1:else: */
  ...
  if (outC->IfBlock1_clock) {
    ...
    /* IfBlock1:else: */
    if (outC->else_clock_IfBlock1) {
      outC->_L4_then_else_IfBlock1 = _72_ENUM_DMI_Cabin_Identifier_T_cabin_B;
...
void CAST_int_to_DMI_Cabin_ide_init_DATA_Variables(
  outC_CAST_int_to_DMI_Cabin_ide_DATA_Variables *outC)
{
  outC->_L22 = kcg_true;
  outC->error = kcg_true;
...
void CAST_int_to_DMI_Cabin_ide_reset_DATA_Variables(
  outC_CAST_int_to_DMI_Cabin_ide_DATA_Variables *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_int_to_DMI_Cabin_ide_DATA_Variables.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
