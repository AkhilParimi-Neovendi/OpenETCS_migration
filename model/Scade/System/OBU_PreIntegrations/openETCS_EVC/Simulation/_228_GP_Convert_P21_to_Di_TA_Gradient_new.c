...
#include "_228_GP_Convert_P21_to_Di_TA_Gradient_new.h"

/* TA_Gradient_new::GP_Convert_P21_to_DistanceProfile/ */
void _228_GP_Convert_P21_to_Di_TA_Gradient_new(
  /* Packet21_in/ */
  ...
  outC__228_GP_Convert_P21_to_Di_TA_Gradient_new *outC)
{
  ...
  for (idx2 = 0; idx2 < 50; idx2++) {
    ...
    GP_Convert_P21_to_Distanc_TA_Gradient_new(
      /* _L77= */(kcg_int32) idx2,
      &acc,
      &outC->_L74[idx2],
      outC->_L76[idx2],
...
void _228_GP_Convert_P21_to_Di_init_TA_Gradient_new(
  outC__228_GP_Convert_P21_to_Di_TA_Gradient_new *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx1 = 0; idx1 < 50; idx1++) {
    ...
    outC->_L83[idx1].Loc_Absolute = kcg_lit_int32(0);
    outC->_L83[idx1].Loc_LRBG = kcg_lit_int32(0);
    outC->_L83[idx1].Gradient = kcg_lit_int32(0);
    outC->_L83[idx1].L_Gradient = kcg_lit_int32(0);
  }
  for (idx2 = 0; idx2 < 50; idx2++) {
    outC->_L77[idx2].valid = kcg_true;
    outC->_L77[idx2].Loc_Absolute = kcg_lit_int32(0);
    outC->_L77[idx2].Loc_LRBG = kcg_lit_int32(0);
    outC->_L77[idx2].Gradient = kcg_lit_int32(0);
    outC->_L77[idx2].L_Gradient = kcg_lit_int32(0);
  }
  ...
  for (idx5 = 0; idx5 < 50; idx5++) {
    for (idx4 = 0; idx4 < 33; idx4++) {
      ...
      outC->_L74[idx5][idx4].d_gradient = kcg_lit_int32(0);
      outC->_L74[idx5][idx4].q_gdir = Q_GDIR_downhill;
      outC->_L74[idx5][idx4].g_a = kcg_lit_int32(0);
    }
  }
  outC->_L63.valid = kcg_true;
  outC->_L63.q_dir = Q_DIR_Reverse;
  outC->_L63.q_scale = Q_SCALE_10_cm_scale;
  outC->_L63.n_iter = kcg_lit_int32(0);
  for (idx6 = 0; idx6 < 33; idx6++) {
    outC->_L63.sections[idx6].valid = kcg_true;
    outC->_L63.sections[idx6].d_gradient = kcg_lit_int32(0);
    outC->_L63.sections[idx6].q_gdir = Q_GDIR_downhill;
    outC->_L63.sections[idx6].g_a = kcg_lit_int32(0);
  }
  outC->_L65 = Q_SCALE_10_cm_scale;
  for (idx7 = 0; idx7 < 33; idx7++) {
    outC->_L71[idx7].valid = kcg_true;
    outC->_L71[idx7].d_gradient = kcg_lit_int32(0);
    outC->_L71[idx7].q_gdir = Q_GDIR_downhill;
    outC->_L71[idx7].g_a = kcg_lit_int32(0);
  }
  outC->_L73.valid = kcg_true;
  outC->_L73.q_dir = Q_DIR_Reverse;
  outC->_L73.q_scale = Q_SCALE_10_cm_scale;
  outC->_L73.n_iter = kcg_lit_int32(0);
  for (idx8 = 0; idx8 < 33; idx8++) {
    outC->_L73.sections[idx8].valid = kcg_true;
    outC->_L73.sections[idx8].d_gradient = kcg_lit_int32(0);
    outC->_L73.sections[idx8].q_gdir = Q_GDIR_downhill;
    outC->_L73.sections[idx8].g_a = kcg_lit_int32(0);
  }
  for (idx9 = 0; idx9 < 50; idx9++) {
    outC->GradientProfile[idx9].valid = kcg_true;
    outC->GradientProfile[idx9].Loc_Absolute = kcg_lit_int32(0);
    outC->GradientProfile[idx9].Loc_LRBG = kcg_lit_int32(0);
    outC->GradientProfile[idx9].Gradient = kcg_lit_int32(0);
    outC->GradientProfile[idx9].L_Gradient = kcg_lit_int32(0);
  }
  for (idx = 0; idx < 50; idx++) {
    /* _L77=(TA_Gradient_new::GP_Convert_P21_to_DistanceProfile_loop#1)/ */
    GP_Convert_P21_to_Distanc_init_TA_Gradient_new(
...
void _228_GP_Convert_P21_to_Di_reset_TA_Gradient_new(
  outC__228_GP_Convert_P21_to_Di_TA_Gradient_new *outC)
{
  kcg_size idx;
  ...
  for (idx = 0; idx < 50; idx++) {
    /* _L77=(TA_Gradient_new::GP_Convert_P21_to_DistanceProfile_loop#1)/ */
    GP_Convert_P21_to_Distanc_reset_TA_Gradient_new(
      &outC->Context_GP_Convert_P21_to_DistanceProfile_loop_1[idx]);
  }
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _228_GP_Convert_P21_to_Di_TA_Gradient_new.c
** Generation date: 2023-11-06T13:54:30
*************************************************************$ */
