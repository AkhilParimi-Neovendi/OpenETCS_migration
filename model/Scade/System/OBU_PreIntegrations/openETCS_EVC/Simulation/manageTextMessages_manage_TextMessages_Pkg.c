  ...
  outC_manageTextMessages_manage_TextMessages_Pkg *outC)
{
  kcg_bool op_call;
  /* textMessageToSend/ */
  DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg textMessageToSend_partial;
  /* msgContext/ */
  DMI_context_TXT_MSG_T_DMI_Types_Pkg msgContext_partial;
  /* textMessageToSend/ */
  DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg _1_textMessageToSend_partial;
  /* msgContext/ */
  DMI_context_TXT_MSG_T_DMI_Types_Pkg _2_msgContext_partial;
  /* textMessageToSend/ */
  DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg _3_textMessageToSend_partial;
  /* msgContext/ */
  DMI_context_TXT_MSG_T_DMI_Types_Pkg _4_msgContext_partial;
  /* textMessageToSend/ */
  DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg _5_textMessageToSend_partial;
  /* msgContext/ */
  DMI_context_TXT_MSG_T_DMI_Types_Pkg _6_msgContext_partial;
  /* msgContext/ */
  DMI_context_TXT_MSG_T_DMI_Types_Pkg _7_msgContext_partial;
  /* textMessageToSend/ */
  DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg _8_textMessageToSend_partial;
  /* msgContext/ */
  DMI_context_TXT_MSG_T_DMI_Types_Pkg _9_msgContext_partial;
  /* textMessageToSend/ */
  DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg _10_textMessageToSend_partial;
