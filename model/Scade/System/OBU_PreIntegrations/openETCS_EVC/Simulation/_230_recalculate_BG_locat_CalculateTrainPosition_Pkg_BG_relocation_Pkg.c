...
void _230_recalculate_BG_locat_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
  /* referenceBG/ */
...
void _230_recalculate_BG_locat_init_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
  outC__230_recalculate_BG_locat_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx = 0; idx < 41; idx++) {
    /* _L3=(CalculateTrainPosition_Pkg::BG_relocation_Pkg::recalculate_BG_locations_ahead_itr#1)/ */
    recalculate_BG_locations__init_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
...
void _230_recalculate_BG_locat_reset_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
  outC__230_recalculate_BG_locat_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  kcg_size idx;
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _230_recalculate_BG_locat_CalculateTrainPosition_Pkg_BG_relocation_Pkg.c
** Generation date: 2023-11-06T13:54:30
*************************************************************$ */
