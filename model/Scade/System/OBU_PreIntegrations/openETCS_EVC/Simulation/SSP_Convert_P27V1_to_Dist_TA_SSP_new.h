...
*************************************************************$ */
#ifndef _SSP_Convert_P27V1_to_Dist_TA_SSP_new_H_
#define _SSP_Convert_P27V1_to_Dist_TA_SSP_new_H_
...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_Normalize_Distance_d_inte_TA_Lib_internal /* _L135=(TA_Lib_internal::Normalize_Distance_d_internal_t#2)/ */ Context_Normalize_Distance_d_internal_t_2;
...
} outC_SSP_Convert_P27V1_to_Dist_TA_SSP_new;

/* ===========  node initialization and cycle functions  =========== */
/* TA_SSP_new::SSP_Convert_P27V1_to_DistanceProfile_loop/ */
extern void SSP_Convert_P27V1_to_Dist_TA_SSP_new(
  /* i/ */
  kcg_int32 i,
  /* ProfileAccu/ */
...
extern void SSP_Convert_P27V1_to_Dist_reset_TA_SSP_new(
  outC_SSP_Convert_P27V1_to_Dist_TA_SSP_new *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void SSP_Convert_P27V1_to_Dist_init_TA_SSP_new(
  outC_SSP_Convert_P27V1_to_Dist_TA_SSP_new *outC);
#endif /* KCG_USER_DEFINED_INIT */



#endif /* _SSP_Convert_P27V1_to_Dist_TA_SSP_new_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** SSP_Convert_P27V1_to_Dist_TA_SSP_new.h
** Generation date: 2023-11-06T13:54:28
*************************************************************$ */
