  ...
  outC_Procedure_SH_Initiated_By_Procedures *outC)
{
  ...
  SSM_ST_SH_Initiated_By_Driver SH_Initiated_By_Driver_state_nxt_partial;
  /* SH_Initiated_By_Driver: */
  kcg_bool SH_Initiated_By_Driver_reset_nxt_partial;
  /* SH_Initiated_By_Driver: */
  SSM_TR_SH_Initiated_By_Driver SH_Initiated_By_Driver_fired_partial;
  /* Condition5/ */
  kcg_bool _1_Condition5_partial;
  /* Condition6/ */
  kcg_bool _2_Condition6_partial;
  /* Clean_BG_List_SH_Area/ */
  kcg_bool _3_Clean_BG_List_SH_Area_partial;
  /* End_Of_Mission_Procedure_Req/ */
  kcg_bool _4_End_Of_Mission_Procedure_Req_partial;
  /* Request_For_SH_To_RBC/ */
  kcg_bool _5_Request_For_SH_To_RBC_partial;
  /* SH_Refused_By_RBC_To_DMI/ */
  kcg_bool _6_SH_Refused_By_RBC_To_DMI_partial;
  /* SH_Initiated_By_Driver: */
  SSM_ST_SH_Initiated_By_Driver _7_SH_Initiated_By_Driver_state_nxt_partial;
  /* SH_Initiated_By_Driver: */
  kcg_bool _8_SH_Initiated_By_Driver_reset_nxt_partial;
  /* SH_Initiated_By_Driver: */
  SSM_TR_SH_Initiated_By_Driver _9_SH_Initiated_By_Driver_fired_partial;
  /* SH_Initiated_By_Driver: */
  SSM_ST_SH_Initiated_By_Driver SH_Initiated_By_Driver_state_act_partial;
  /* SH_Initiated_By_Driver: */
  kcg_bool SH_Initiated_By_Driver_reset_act_partial;
  /* SH_Initiated_By_Driver: */
  SSM_TR_SH_Initiated_By_Driver SH_Initiated_By_Driver_fired_strong_partial;
  /* SH_Initiated_By_Driver:SH_initiated_by_driver_procedure_off:<1> */
  kcg_bool tr_1_guard_SH_initiated_by_driver_procedure_off_SH_Initiated_By_Driver;
  /* SH_Initiated_By_Driver: */
  SSM_ST_SH_Initiated_By_Driver _10_SH_Initiated_By_Driver_state_act_partial;
  /* SH_Initiated_By_Driver: */
  kcg_bool _11_SH_Initiated_By_Driver_reset_act_partial;
  /* SH_Initiated_By_Driver: */
  SSM_TR_SH_Initiated_By_Driver _12_SH_Initiated_By_Driver_fired_strong_partial;
  /* SH_Initiated_By_Driver:S0_SH_initiated_by_driver_procedure_on:<1> */
  kcg_bool tr_1_guard_S0_SH_initiated_by_driver_procedure_on_SH_Initiated_By_Driver;
  /* SH_Initiated_By_Driver: */
  kcg_bool SH_Initiated_By_Driver_reset_sel;
  /* SH_Initiated_By_Driver: */
  kcg_bool SH_Initiated_By_Driver_reset_prv;
