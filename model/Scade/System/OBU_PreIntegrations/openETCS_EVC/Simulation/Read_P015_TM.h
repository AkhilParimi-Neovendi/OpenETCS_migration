...
typedef struct {
  ...
  P015_OBU_T_TM /* P015_OBU_out/ */ P015_OBU_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P015_compr_onboard_TM_conversions /* _L166=(TM_conversions::C_P015_compr_onboard#1)/ */ Context_C_P015_compr_onboard_1;
...
extern void Read_P015_init_TM(outC_Read_P015_TM *outC);
