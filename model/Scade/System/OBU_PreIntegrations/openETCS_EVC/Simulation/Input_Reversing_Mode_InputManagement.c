  ...
  outC_Input_Reversing_Mode_InputManagement *outC)
{
  ...
  scaledDistance_2_distance_InputManagement(
    outC->_L9,
    outC->_L11,
    &outC->_2_Context_scaledDistance_2_distance_3);
  outC->_L20 = outC->_2_Context_scaledDistance_2_distance_3.distance;
  ...
  scaledDistance_2_distance_InputManagement(
    outC->_L4,
    outC->_L5,
    &outC->_1_Context_scaledDistance_2_distance_2);
  outC->_L19 = outC->_1_Context_scaledDistance_2_distance_2.distance;
