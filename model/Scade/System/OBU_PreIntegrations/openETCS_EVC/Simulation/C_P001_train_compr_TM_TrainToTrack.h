...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P001_TrainTrack_int_TM_TrainToTrack /* P001_int/ */ P001_int;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  outC_CAST_Q_DRLRBG_to_int_TM_conversions /* _L75=(TM_conversions::CAST_Q_DRLRBG_to_int#1)/ */ Context_CAST_Q_DRLRBG_to_int_1;
  outC_CAST_L_DOUBTOVER_to_int_TM_conversions /* _L77=(TM_conversions::CAST_L_DOUBTOVER_to_int#1)/ */ Context_CAST_L_DOUBTOVER_to_int_1;
  ...
  outC_CAST_D_LRBG_to_int_TM_conversions /* _L91=(TM_conversions::CAST_D_LRBG_to_int#1)/ */ Context_CAST_D_LRBG_to_int_1;
  outC_CAST_NID_PRVLRBG_to_int_TM_conversions /* _L93=(TM_conversions::CAST_NID_PRVLRBG_to_int#1)/ */ Context_CAST_NID_PRVLRBG_to_int_1;
...
extern void C_P001_train_compr_init_TM_TrainToTrack(
  outC_C_P001_train_compr_TM_TrainToTrack *outC);
