  ...
  outC_frontendToLRBG_CalculateTrainPosition_Pkg_Pos_Pkg *outC)
{
  ...
  Q_DLRBG nominalOrReverseToLRBG_partial;
  /* nominalOrReverseToLRBG/ */
  Q_DLRBG _1_nominalOrReverseToLRBG_partial;
  /* nominalOrReverseToLRBG/ */
  Q_DLRBG _2_nominalOrReverseToLRBG_partial;
  /* nominalOrReverseToLRBG/ */
  Q_DLRBG _3_nominalOrReverseToLRBG_partial;
