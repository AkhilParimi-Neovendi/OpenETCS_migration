...
#include "MoveSSPSectionsAbsolute_L_TA_Lib_internal.h"

/* TA_Lib_internal::MoveSSPSectionsAbsolute_Loop_new/ */
void MoveSSPSectionsAbsolute_L_TA_Lib_internal(
  /* i/ */
  kcg_int32 i,
  /* ProfileIn/ */
...
void MoveSSPSectionsAbsolute_L_init_TA_Lib_internal(
  outC_MoveSSPSectionsAbsolute_L_TA_Lib_internal *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void MoveSSPSectionsAbsolute_L_reset_TA_Lib_internal(
  outC_MoveSSPSectionsAbsolute_L_TA_Lib_internal *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** MoveSSPSectionsAbsolute_L_TA_Lib_internal.c
** Generation date: 2023-11-06T13:54:30
*************************************************************$ */
