...
#include "_225_MA_Convert_P15_to_Di_TA_MA_new.h"

/* TA_MA_new::MA_Convert_P15_to_DistanceProfile/ */
void _225_MA_Convert_P15_to_Di_TA_MA_new(
  /* Packet15_in/ */
  ...
  outC__225_MA_Convert_P15_to_Di_TA_MA_new *outC)
{
  ...
  kcg_size idx1;
  kcg_size idx2;
  AccuDistanceProfileMA_TA_MA_new acc;
  kcg_size idx3;
  ...
  for (idx3 = 0; idx3 < 10; idx3++) {
    ...
    MA_Convert_P15_to_Distanc_TA_MA_new(
      /* _L77= */(kcg_int32) idx3,
      &acc,
      &outC->_L74[idx3],
      outC->_L167[idx3],
...
void _225_MA_Convert_P15_to_Di_init_TA_MA_new(
  outC__225_MA_Convert_P15_to_Di_TA_MA_new *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx = 0; idx < 10; idx++) {
    /* _L77=(TA_MA_new::MA_Convert_P15_to_DistanceProfile_loop#1)/ */
    MA_Convert_P15_to_Distanc_init_TA_MA_new(
...
void _225_MA_Convert_P15_to_Di_reset_TA_MA_new(
  outC__225_MA_Convert_P15_to_Di_TA_MA_new *outC)
{
  kcg_size idx;
  ...
  for (idx = 0; idx < 10; idx++) {
    /* _L77=(TA_MA_new::MA_Convert_P15_to_DistanceProfile_loop#1)/ */
    MA_Convert_P15_to_Distanc_reset_TA_MA_new(
      &outC->Context_MA_Convert_P15_to_DistanceProfile_loop_1[idx]);
  }
  /* _L134=(TA_MA_new::Pack_Endsection#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** _225_MA_Convert_P15_to_Di_TA_MA_new.c
** Generation date: 2023-11-06T13:54:30
*************************************************************$ */
