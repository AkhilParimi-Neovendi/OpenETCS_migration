...
typedef struct {
  ...
  outC_BufferOutput_read_write2_TM_lib_internal /* IfBlock1:else:then:_L4=(TM_lib_internal::BufferOutput_read_write2#4)/ */ _1_Context_BufferOutput_read_write2_4;
  outC_BufferOutput_read_write3_TM_lib_internal /* IfBlock1:else:else:then:_L4=(TM_lib_internal::BufferOutput_read_write3#3)/ */ _2_Context_BufferOutput_read_write3_3;
  outC_BufferOutput_read_write4_TM_lib_internal /* IfBlock1:else:else:else:then:_L1=(TM_lib_internal::BufferOutput_read_write4#3)/ */ _3_Context_BufferOutput_read_write4_3;
  outC_BufferOutput_read_write5_TM_lib_internal /* IfBlock1:else:else:else:else:_L1=(TM_lib_internal::BufferOutput_read_write5#3)/ */ _4_Context_BufferOutput_read_write5_3;
