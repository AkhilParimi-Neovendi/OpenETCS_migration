...
{
  /* storeInBuffer2/ */
  kcg_bool storeInBuffer2_partial;
  /* outMessageForBuffer/ */
  ReceivedMessage_T_Common_Types_Pkg outMessageForBuffer_partial;
  /* messageForFilter3/ */
  ReceivedMessage_T_Common_Types_Pkg messageForFilter3_partial;
  /* messageForFilter3/ */
  ReceivedMessage_T_Common_Types_Pkg _1_messageForFilter3_partial;
  /* outMessageForBuffer/ */
  ReceivedMessage_T_Common_Types_Pkg _2_outMessageForBuffer_partial;
  /* storeInBuffer2/ */
  kcg_bool _3_storeInBuffer2_partial;
  /* storeInBuffer2/ */
  kcg_bool _4_storeInBuffer2_partial;
  /* outMessageForBuffer/ */
  ReceivedMessage_T_Common_Types_Pkg _5_outMessageForBuffer_partial;
  /* messageForFilter3/ */
  ReceivedMessage_T_Common_Types_Pkg _6_messageForFilter3_partial;
  /* messageForFilter3/ */
  ReceivedMessage_T_Common_Types_Pkg _7_messageForFilter3_partial;
  /* outMessageForBuffer/ */
  ReceivedMessage_T_Common_Types_Pkg _8_outMessageForBuffer_partial;
  /* storeInBuffer2/ */
  kcg_bool _9_storeInBuffer2_partial;
  kcg_bool noname;
  /* messageForFilter3/ */
  ReceivedMessage_T_Common_Types_Pkg _10_messageForFilter3_partial;
  /* outMessageForBuffer/ */
  ReceivedMessage_T_Common_Types_Pkg _11_outMessageForBuffer_partial;
  /* storeInBuffer2/ */
  kcg_bool _12_storeInBuffer2_partial;
  /* storeInBuffer2/ */
  kcg_bool _13_storeInBuffer2_partial;
  /* outMessageForBuffer/ */
  ReceivedMessage_T_Common_Types_Pkg _14_outMessageForBuffer_partial;
  /* messageForFilter3/ */
  ReceivedMessage_T_Common_Types_Pkg _15_messageForFilter3_partial;
  kcg_bool _16_noname;
  /* messageForFilter3/ */
  ReceivedMessage_T_Common_Types_Pkg _17_messageForFilter3_partial;
  /* outMessageForBuffer/ */
  ReceivedMessage_T_Common_Types_Pkg _18_outMessageForBuffer_partial;
  /* storeInBuffer2/ */
  kcg_bool _19_storeInBuffer2_partial;
  /* storeInBuffer2/ */
  kcg_bool _20_storeInBuffer2_partial;
  /* outMessageForBuffer/ */
  ReceivedMessage_T_Common_Types_Pkg _21_outMessageForBuffer_partial;
  /* messageForFilter3/ */
  ReceivedMessage_T_Common_Types_Pkg _22_messageForFilter3_partial;
