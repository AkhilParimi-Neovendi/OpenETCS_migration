  ...
  outC_synchWithDMI_manage_DMI_Output_Pkg *outC)
{
  ...
  outC->_L22.system_clock = kcg_lit_int32(0);
  outC->_L22.ERTMS_Version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L22.EVC_Version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L22.l_name = kcg_lit_int32(0);
  for (idx = 0; idx < 255; idx++) {
    outC->_L22.x_name[idx] = ' ';
  }
  outC->_L22.l_extra = kcg_lit_int32(0);
  ...
  outC->_L21.EVC_Version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L21.l_name = kcg_lit_int32(0);
  for (idx1 = 0; idx1 < 255; idx1++) {
    outC->_L21.x_name[idx1] = ' ';
  }
  outC->_L21.l_extra = kcg_lit_int32(0);
  outC->_L20 = kcg_true;
  outC->_L19 = kcg_true;
  ...
  outC->_L15.EVC_Version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L15.l_name = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 255; idx2++) {
    outC->_L15.x_name[idx2] = ' ';
  }
  outC->_L15.l_extra = kcg_lit_int32(0);
  outC->_L12 = kcg_true;
  ...
  outC->_L11.EVC_Version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L11.l_name = kcg_lit_int32(0);
  for (idx3 = 0; idx3 < 255; idx3++) {
    outC->_L11.x_name[idx3] = ' ';
  }
  outC->_L11.l_extra = kcg_lit_int32(0);
  outC->_L10 = kcg_true;
  outC->_L9 = kcg_true;
  outC->_L8 = kcg_true;
  outC->_L7 = kcg_true;
  ...
  outC->_L5.EVC_Version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_L5.l_name = kcg_lit_int32(0);
  for (idx4 = 0; idx4 < 255; idx4++) {
    outC->_L5.x_name[idx4] = ' ';
  }
  outC->_L5.l_extra = kcg_lit_int32(0);
  outC->_L4 = kcg_true;
  ...
  outC->_L2.l_extra = kcg_lit_int32(0);
  ...
  outC->send_dmi_identifierRequest.system_clock = kcg_lit_int32(0);
  outC->send_dmi_identifierRequest.ERTMS_Version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->send_dmi_identifierRequest.EVC_Version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->send_dmi_identifierRequest.l_name = kcg_lit_int32(0);
  for (idx6 = 0; idx6 < 255; idx6++) {
    outC->send_dmi_identifierRequest.x_name[idx6] = ' ';
  }
  outC->send_dmi_identifierRequest.l_extra = kcg_lit_int32(0);
}
