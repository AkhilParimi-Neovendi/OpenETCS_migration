...
void CAST_DMI_gradientProfile__DATA_Variables(
  /* dmi_gradientProfile/ */
  ...
  outC_CAST_DMI_gradientProfile__DATA_Variables *outC)
{
  ...
  for (idx = 0; idx < 32; idx++) {
    ...
    CAST_DMI_gradientProfileE_DATA_Variables(
      &outC->_L2[idx],
...
void CAST_DMI_gradientProfile__init_DATA_Variables(
  outC_CAST_DMI_gradientProfile__DATA_Variables *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx = 0; idx < 32; idx++) {
    /* _L6=(DATA::Variables::CAST_DMI_gradientProfileElement_to_int#1)/ */
    CAST_DMI_gradientProfileE_init_DATA_Variables(
      &outC->Context_CAST_DMI_gradientProfileElement_to_int_1[idx]);
  }
}
...
void CAST_DMI_gradientProfile__reset_DATA_Variables(
  outC_CAST_DMI_gradientProfile__DATA_Variables *outC)
{
  kcg_size idx;
  ...
  for (idx = 0; idx < 32; idx++) {
    /* _L6=(DATA::Variables::CAST_DMI_gradientProfileElement_to_int#1)/ */
    CAST_DMI_gradientProfileE_reset_DATA_Variables(
      &outC->Context_CAST_DMI_gradientProfileElement_to_int_1[idx]);
  }
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_gradientProfile__DATA_Variables.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
