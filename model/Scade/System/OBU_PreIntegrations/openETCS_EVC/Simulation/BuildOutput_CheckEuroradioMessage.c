  ...
  outC_BuildOutput_CheckEuroradioMessage *outC)
{
  ...
  outC->_L20.rbc_id = kcg_lit_int32(0);
  outC->_L20.device_id = kcg_lit_int32(0);
  for (idx = 0; idx < 30; idx++) {
    outC->_L14.PacketHeaders[idx].nid_packet = kcg_lit_int32(0);
    outC->_L14.PacketHeaders[idx].q_dir = Q_DIR_Reverse;
    outC->_L14.PacketHeaders[idx].valid = kcg_true;
    outC->_L14.PacketHeaders[idx].startAddress = kcg_lit_int32(0);
    outC->_L14.PacketHeaders[idx].endAddress = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L14.PacketData[idx1] = kcg_lit_int32(0);
  }
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L11.packets.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    outC->_L11.packets.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L11.packets.PacketHeaders[idx2].valid = kcg_true;
    outC->_L11.packets.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L11.packets.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L11.packets.PacketData[idx3] = kcg_lit_int32(0);
  }
  ...
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->ReceivedMessage.packets.PacketHeaders[idx6].nid_packet = kcg_lit_int32(0);
    ...
    outC->ReceivedMessage.packets.PacketHeaders[idx6].startAddress =
      kcg_lit_int32(0);
    outC->ReceivedMessage.packets.PacketHeaders[idx6].endAddress = kcg_lit_int32(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->ReceivedMessage.packets.PacketData[idx7] = kcg_lit_int32(0);
  }
