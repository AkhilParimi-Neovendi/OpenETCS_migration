  ...
  outC_BufferOutput_read_write4_TM_lib_internal *outC)
{
  ...
  kcg_copy__125_array(&outC->_L29, (_125_array *) &outC->_L23[0]);
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
    &outC->_L38,
    (M_TrainTrack_Message_T_TM_radio_messages *)
      &EMPTY_TrainTrackMessage_TM_lib_internal);
  ...
  kcg_copy__153_array(&outC->_L36, (_153_array *) &outC->_L23[1]);
  kcg_copy__153_array(&outC->_L39[0], &outC->_L36);
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
    &outC->_L39[3],
    &outC->_L40[0]);
  /* _L41= */
  if (outC->_L34) {
    kcg_copy__125_array(&outC->_L41, &outC->_L39);
  }
  else {
    kcg_copy__125_array(&outC->_L41, &outC->_L29);
  }
  outC->_L32 = kcg_lit_int32(3);
  outC->_L31 = outC->_L15 + outC->_L32;
  kcg_copy__155_array(&outC->_L24, (_155_array *) &outC->_L12[0]);
  kcg_copy__125_array(&outC->_L25[0], &outC->_L41);
  kcg_copy__155_array(&outC->_L25[4], &outC->_L24);
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
    &outC->Message_out,
    &outC->_L42);
