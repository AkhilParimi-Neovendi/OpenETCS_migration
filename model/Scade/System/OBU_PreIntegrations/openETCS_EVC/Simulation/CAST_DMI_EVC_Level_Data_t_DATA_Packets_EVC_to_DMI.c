...
void CAST_DMI_EVC_Level_Data_t_DATA_Packets_EVC_to_DMI(
  /* dmi_evc_level_data_ct/ */
  DMI_EVC_Level_Data_T_DMI_Messages_EVC_to_DMI_Pkg *dmi_evc_level_data_ct,
  outC_CAST_DMI_EVC_Level_Data_t_DATA_Packets_EVC_to_DMI *outC)
{
  ...
  kcg_copy_array_int32_2(&outC->_L2[0], &outC->_L9);
...
void CAST_DMI_EVC_Level_Data_t_init_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_EVC_Level_Data_t_DATA_Packets_EVC_to_DMI *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx1 = 0; idx1 < 32; idx1++) {
    ...
    outC->_L8.levelList.levelList[idx1].nid_stm = kcg_lit_int32(0);
  }
  ...
  for (idx3 = 0; idx3 < 32; idx3++) {
    ...
    outC->_L3.levelList[idx3].nid_stm = kcg_lit_int32(0);
  }
  ...
  for (idx5 = 0; idx5 < 67; idx5++) {
    outC->dmi_evc_level_data_int[idx5] = kcg_lit_int32(0);
  }
  /* _L7=(DATA::Variables::CAST_DMI_LevelList_to_int#1)/ */
...
void CAST_DMI_EVC_Level_Data_t_reset_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_EVC_Level_Data_t_DATA_Packets_EVC_to_DMI *outC)
{
  /* _L7=(DATA::Variables::CAST_DMI_LevelList_to_int#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_EVC_Level_Data_t_DATA_Packets_EVC_to_DMI.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
