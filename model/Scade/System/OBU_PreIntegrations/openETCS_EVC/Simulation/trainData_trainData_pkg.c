  ...
  outC_trainData_trainData_pkg *outC)
{
  ...
  kcg_bool _2_op_call;
  kcg_bool _3_op_call;
  trainDataStatus_T_trainData_Types_pkg _4_op_call;
  /* outMessageBus/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus outMessageBus_partial;
  /* trainDataStatus/ */
  trainDataStatus_T_trainData_Types_pkg trainDataStatus_partial;
  /* outMessageBus/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _5_outMessageBus_partial;
  /* trainDataStatus/ */
  trainDataStatus_T_trainData_Types_pkg _6_trainDataStatus_partial;
  /* outMessageBus/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _7_outMessageBus_partial;
  /* trainDataStatus/ */
  trainDataStatus_T_trainData_Types_pkg _8_trainDataStatus_partial;
  /* outMessageBus/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _9_outMessageBus_partial;
  /* trainDataStatus/ */
  trainDataStatus_T_trainData_Types_pkg _10_trainDataStatus_partial;
  /* trainDataStatus/ */
  trainDataStatus_T_trainData_Types_pkg _11_trainDataStatus_partial;
  /* outMessageBus/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _12_outMessageBus_partial;
  /* trainDataStatus/ */
  trainDataStatus_T_trainData_Types_pkg _13_trainDataStatus_partial;
  /* outMessageBus/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _14_outMessageBus_partial;
  /* trainDataStatus/ */
  trainDataStatus_T_trainData_Types_pkg last_trainDataStatus;
