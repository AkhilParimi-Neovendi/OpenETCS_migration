...
void CAST_DMI_System_Version_t_DATA_Packets_EVC_to_DMI(
...
void CAST_DMI_System_Version_t_init_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_System_Version_t_DATA_Packets_EVC_to_DMI *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void CAST_DMI_System_Version_t_reset_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_System_Version_t_DATA_Packets_EVC_to_DMI *outC)
{
  /* _L6=(Utilities::Bool_to_Int#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_System_Version_t_DATA_Packets_EVC_to_DMI.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
