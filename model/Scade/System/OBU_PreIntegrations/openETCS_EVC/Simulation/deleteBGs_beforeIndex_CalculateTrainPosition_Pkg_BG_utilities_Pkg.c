  ...
  outC_deleteBGs_beforeIndex_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  ...
  if (outC->_L8) {
    ...
    for (idx2 = 0; idx2 < 41; idx2++) {
      ...
      outC->_L21 = /* _L21= */(kcg_int32) (idx2 + 1);
      /* _L21= */
  ...
  outC_deleteBGs_beforeIndex_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  ...
  for (idx3 = 0; idx3 < 41; idx3++) {
    for (idx2 = 0; idx2 < 41; idx2++) {
      ...
      outC->_L22[idx3][idx2].nid_c = kcg_lit_int32(0);
      outC->_L22[idx3][idx2].nid_bg = kcg_lit_int32(0);
      outC->_L22[idx3][idx2].q_link = Q_LINK_Unlinked;
      outC->_L22[idx3][idx2].location.nominal = kcg_lit_int32(0);
      outC->_L22[idx3][idx2].location.d_min = kcg_lit_int32(0);
      outC->_L22[idx3][idx2].location.d_max = kcg_lit_int32(0);
      outC->_L22[idx3][idx2].seqNoOnTrack = kcg_lit_int32(0);
      outC->_L22[idx3][idx2].infoFromLinking.valid = kcg_true;
      outC->_L22[idx3][idx2].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
      outC->_L22[idx3][idx2].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
      ...
      outC->_L22[idx3][idx2].infoFromLinking.expectedLocation.d_max =
        kcg_lit_int32(0);
      outC->_L22[idx3][idx2].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
      outC->_L22[idx3][idx2].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
      outC->_L22[idx3][idx2].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
      outC->_L22[idx3][idx2].infoFromLinking.linkingInfo.valid = kcg_true;
      outC->_L22[idx3][idx2].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L22[idx3][idx2].infoFromLinking.linkingInfo.q_scale =
        Q_SCALE_10_cm_scale;
      outC->_L22[idx3][idx2].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
      outC->_L22[idx3][idx2].infoFromLinking.linkingInfo.q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L22[idx3][idx2].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
      outC->_L22[idx3][idx2].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
      ...
      outC->_L22[idx3][idx2].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
      ...
      outC->_L22[idx3][idx2].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
      outC->_L22[idx3][idx2].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
      outC->_L22[idx3][idx2].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
      ...
      outC->_L22[idx3][idx2].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
        kcg_lit_int32(0);
      outC->_L22[idx3][idx2].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
      ...
      for (idx1 = 0; idx1 < 33; idx1++) {
        ...
        outC->_L22[idx3][idx2].infoFromPassing.linkedBGs[idx1].q_newcountry =
          Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
        outC->_L22[idx3][idx2].infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int32(0);
  ...
  for (idx5 = 0; idx5 < 41; idx5++) {
    ...
    outC->_L20[idx5].nid_c = kcg_lit_int32(0);
    outC->_L20[idx5].nid_bg = kcg_lit_int32(0);
    outC->_L20[idx5].q_link = Q_LINK_Unlinked;
    outC->_L20[idx5].location.nominal = kcg_lit_int32(0);
    outC->_L20[idx5].location.d_min = kcg_lit_int32(0);
    outC->_L20[idx5].location.d_max = kcg_lit_int32(0);
    outC->_L20[idx5].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L20[idx5].infoFromLinking.valid = kcg_true;
    outC->_L20[idx5].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L20[idx5].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L20[idx5].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L20[idx5].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L20[idx5].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L20[idx5].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L20[idx5].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L20[idx5].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L20[idx5].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L20[idx5].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L20[idx5].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L20[idx5].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L20[idx5].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L20[idx5].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    outC->_L20[idx5].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L20[idx5].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L20[idx5].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L20[idx5].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L20[idx5].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L20[idx5].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L20[idx5].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L20[idx5].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L20[idx5].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx4 = 0; idx4 < 33; idx4++) {
      ...
      outC->_L20[idx5].infoFromPassing.linkedBGs[idx4].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L20[idx5].infoFromPassing.linkedBGs[idx4].d_link = kcg_lit_int32(0);
      outC->_L20[idx5].infoFromPassing.linkedBGs[idx4].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L20[idx5].infoFromPassing.linkedBGs[idx4].nid_c = kcg_lit_int32(0);
      outC->_L20[idx5].infoFromPassing.linkedBGs[idx4].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L20[idx5].infoFromPassing.linkedBGs[idx4].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L20[idx5].infoFromPassing.linkedBGs[idx4].q_locacc = kcg_lit_int32(0);
    }
    outC->_L20[idx5].missed = kcg_true;
  }
  for (idx7 = 0; idx7 < 41; idx7++) {
    outC->_L18[idx7].valid = kcg_true;
    outC->_L18[idx7].nid_c = kcg_lit_int32(0);
    outC->_L18[idx7].nid_bg = kcg_lit_int32(0);
    outC->_L18[idx7].q_link = Q_LINK_Unlinked;
    outC->_L18[idx7].location.nominal = kcg_lit_int32(0);
    outC->_L18[idx7].location.d_min = kcg_lit_int32(0);
    outC->_L18[idx7].location.d_max = kcg_lit_int32(0);
    outC->_L18[idx7].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L18[idx7].infoFromLinking.valid = kcg_true;
    outC->_L18[idx7].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L18[idx7].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L18[idx7].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L18[idx7].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L18[idx7].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L18[idx7].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L18[idx7].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L18[idx7].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L18[idx7].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L18[idx7].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L18[idx7].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L18[idx7].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L18[idx7].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L18[idx7].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    outC->_L18[idx7].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L18[idx7].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L18[idx7].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L18[idx7].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L18[idx7].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L18[idx7].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L18[idx7].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L18[idx7].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L18[idx7].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx6 = 0; idx6 < 33; idx6++) {
      ...
      outC->_L18[idx7].infoFromPassing.linkedBGs[idx6].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L18[idx7].infoFromPassing.linkedBGs[idx6].d_link = kcg_lit_int32(0);
      outC->_L18[idx7].infoFromPassing.linkedBGs[idx6].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L18[idx7].infoFromPassing.linkedBGs[idx6].nid_c = kcg_lit_int32(0);
      outC->_L18[idx7].infoFromPassing.linkedBGs[idx6].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L18[idx7].infoFromPassing.linkedBGs[idx6].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L18[idx7].infoFromPassing.linkedBGs[idx6].q_locacc = kcg_lit_int32(0);
    }
    outC->_L18[idx7].missed = kcg_true;
  }
  for (idx9 = 0; idx9 < 41; idx9++) {
    outC->_L17[idx9].valid = kcg_true;
    outC->_L17[idx9].nid_c = kcg_lit_int32(0);
    outC->_L17[idx9].nid_bg = kcg_lit_int32(0);
    outC->_L17[idx9].q_link = Q_LINK_Unlinked;
    outC->_L17[idx9].location.nominal = kcg_lit_int32(0);
    outC->_L17[idx9].location.d_min = kcg_lit_int32(0);
    outC->_L17[idx9].location.d_max = kcg_lit_int32(0);
    outC->_L17[idx9].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L17[idx9].infoFromLinking.valid = kcg_true;
    outC->_L17[idx9].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L17[idx9].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L17[idx9].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L17[idx9].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L17[idx9].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L17[idx9].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L17[idx9].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L17[idx9].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L17[idx9].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L17[idx9].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L17[idx9].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L17[idx9].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L17[idx9].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L17[idx9].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    outC->_L17[idx9].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L17[idx9].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L17[idx9].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L17[idx9].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L17[idx9].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L17[idx9].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L17[idx9].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L17[idx9].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L17[idx9].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx8 = 0; idx8 < 33; idx8++) {
      ...
      outC->_L17[idx9].infoFromPassing.linkedBGs[idx8].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L17[idx9].infoFromPassing.linkedBGs[idx8].d_link = kcg_lit_int32(0);
      outC->_L17[idx9].infoFromPassing.linkedBGs[idx8].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L17[idx9].infoFromPassing.linkedBGs[idx8].nid_c = kcg_lit_int32(0);
      outC->_L17[idx9].infoFromPassing.linkedBGs[idx8].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L17[idx9].infoFromPassing.linkedBGs[idx8].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L17[idx9].infoFromPassing.linkedBGs[idx8].q_locacc = kcg_lit_int32(0);
    }
    outC->_L17[idx9].missed = kcg_true;
  }
  for (idx10 = 0; idx10 < 41; idx10++) {
    outC->_L9[idx10] = kcg_lit_int32(0);
  }
  outC->_L8 = kcg_true;
  ...
  for (idx12 = 0; idx12 < 41; idx12++) {
    ...
    outC->_L2[idx12].nid_c = kcg_lit_int32(0);
    outC->_L2[idx12].nid_bg = kcg_lit_int32(0);
    outC->_L2[idx12].q_link = Q_LINK_Unlinked;
    outC->_L2[idx12].location.nominal = kcg_lit_int32(0);
    outC->_L2[idx12].location.d_min = kcg_lit_int32(0);
    outC->_L2[idx12].location.d_max = kcg_lit_int32(0);
    outC->_L2[idx12].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L2[idx12].infoFromLinking.valid = kcg_true;
    outC->_L2[idx12].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L2[idx12].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L2[idx12].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L2[idx12].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L2[idx12].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L2[idx12].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L2[idx12].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L2[idx12].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L2[idx12].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L2[idx12].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L2[idx12].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L2[idx12].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L2[idx12].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L2[idx12].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    outC->_L2[idx12].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L2[idx12].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L2[idx12].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L2[idx12].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L2[idx12].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L2[idx12].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L2[idx12].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L2[idx12].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L2[idx12].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx11 = 0; idx11 < 33; idx11++) {
      ...
      outC->_L2[idx12].infoFromPassing.linkedBGs[idx11].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L2[idx12].infoFromPassing.linkedBGs[idx11].d_link = kcg_lit_int32(0);
      outC->_L2[idx12].infoFromPassing.linkedBGs[idx11].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L2[idx12].infoFromPassing.linkedBGs[idx11].nid_c = kcg_lit_int32(0);
      outC->_L2[idx12].infoFromPassing.linkedBGs[idx11].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L2[idx12].infoFromPassing.linkedBGs[idx11].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L2[idx12].infoFromPassing.linkedBGs[idx11].q_locacc = kcg_lit_int32(0);
    }
  ...
  for (idx14 = 0; idx14 < 41; idx14++) {
    ...
    outC->BGs_out[idx14].nid_c = kcg_lit_int32(0);
    outC->BGs_out[idx14].nid_bg = kcg_lit_int32(0);
    outC->BGs_out[idx14].q_link = Q_LINK_Unlinked;
    outC->BGs_out[idx14].location.nominal = kcg_lit_int32(0);
    outC->BGs_out[idx14].location.d_min = kcg_lit_int32(0);
    outC->BGs_out[idx14].location.d_max = kcg_lit_int32(0);
    outC->BGs_out[idx14].seqNoOnTrack = kcg_lit_int32(0);
    outC->BGs_out[idx14].infoFromLinking.valid = kcg_true;
    outC->BGs_out[idx14].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->BGs_out[idx14].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->BGs_out[idx14].infoFromLinking.expectedLocation.nominal =
      kcg_lit_int32(0);
    outC->BGs_out[idx14].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->BGs_out[idx14].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->BGs_out[idx14].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->BGs_out[idx14].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->BGs_out[idx14].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->BGs_out[idx14].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->BGs_out[idx14].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->BGs_out[idx14].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->BGs_out[idx14].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->BGs_out[idx14].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->BGs_out[idx14].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    ...
    outC->BGs_out[idx14].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->BGs_out[idx14].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->BGs_out[idx14].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->BGs_out[idx14].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->BGs_out[idx14].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->BGs_out[idx14].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->BGs_out[idx14].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->BGs_out[idx14].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx13 = 0; idx13 < 33; idx13++) {
      ...
      outC->BGs_out[idx14].infoFromPassing.linkedBGs[idx13].q_scale =
        Q_SCALE_10_cm_scale;
      outC->BGs_out[idx14].infoFromPassing.linkedBGs[idx13].d_link = kcg_lit_int32(0);
      outC->BGs_out[idx14].infoFromPassing.linkedBGs[idx13].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->BGs_out[idx14].infoFromPassing.linkedBGs[idx13].nid_c = kcg_lit_int32(0);
      outC->BGs_out[idx14].infoFromPassing.linkedBGs[idx13].nid_bg = kcg_lit_int32(0);
