  ...
  outC_MoveMAAbsolute_new_TA_Lib_internal *outC)
{
  ...
  kcg_size idx1;
  DP_or_OL_t_TrackAtlasTypes op_call;
  DP_or_OL_t_TrackAtlasTypes _2_op_call;
  ...
  outC_MoveMAAbsolute_new_TA_Lib_internal *outC)
{
  ...
  outC->_L122.v_main = kcg_lit_int32(0);
  ...
  for (idx1 = 0; idx1 < 10; idx1++) {
    ...
    outC->_L122.sections[idx1].l_section = kcg_lit_int32(0);
    outC->_L122.sections[idx1].q_sectiontimer = kcg_true;
    outC->_L122.sections[idx1].t_sectiontimer = kcg_lit_int32(0);
    outC->_L122.sections[idx1].d_sectiontimerstoploc = kcg_lit_int32(0);
  }
  outC->_L122.q_dangerpoint = kcg_true;
  outC->_L122.dangerpoint.d_DP_or_OL = kcg_lit_int32(0);
  outC->_L122.dangerpoint.v_release = kcg_lit_int32(0);
  outC->_L122.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->_L122.q_overlap = kcg_true;
  outC->_L122.overlap.d_DP_or_OL = kcg_lit_int32(0);
  outC->_L122.overlap.v_release = kcg_lit_int32(0);
  outC->_L122.overlap.calc_v_release_onboard = kcg_true;
  outC->_L122.q_endtimer = kcg_true;
  outC->_L122.endtimer_t.t_endtimer = kcg_lit_int32(0);
  outC->_L122.endtimer_t.d_endtimerstoploc = kcg_lit_int32(0);
  outC->_L121.valid = kcg_true;
  outC->_L121.Level = MA_L1_TrackAtlasTypes;
  outC->_L121.q_dir = Q_DIR_Reverse;
  outC->_L121.v_main = kcg_lit_int32(0);
  outC->_L121.v_loa = kcg_lit_int32(0);
  outC->_L121.t_loa_unlimited = kcg_true;
  outC->_L121.t_loa = kcg_lit_int32(0);
  outC->_L121.n_iter = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 10; idx2++) {
    outC->_L121.sections[idx2].valid = kcg_true;
    outC->_L121.sections[idx2].q_endsection = kcg_true;
    outC->_L121.sections[idx2].l_section = kcg_lit_int32(0);
    outC->_L121.sections[idx2].q_sectiontimer = kcg_true;
    outC->_L121.sections[idx2].t_sectiontimer = kcg_lit_int32(0);
    outC->_L121.sections[idx2].d_sectiontimerstoploc = kcg_lit_int32(0);
  }
  outC->_L121.q_dangerpoint = kcg_true;
  outC->_L121.dangerpoint.d_DP_or_OL = kcg_lit_int32(0);
  outC->_L121.dangerpoint.v_release = kcg_lit_int32(0);
  outC->_L121.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->_L121.q_overlap = kcg_true;
  outC->_L121.overlap.d_DP_or_OL = kcg_lit_int32(0);
  outC->_L121.overlap.v_release = kcg_lit_int32(0);
  outC->_L121.overlap.calc_v_release_onboard = kcg_true;
  outC->_L121.q_endtimer = kcg_true;
  outC->_L121.endtimer_t.t_endtimer = kcg_lit_int32(0);
  outC->_L121.endtimer_t.d_endtimerstoploc = kcg_lit_int32(0);
  outC->_L119.d_DP_or_OL = kcg_lit_int32(0);
  outC->_L119.v_release = kcg_lit_int32(0);
  outC->_L119.calc_v_release_onboard = kcg_true;
  outC->_L120 = kcg_lit_int32(0);
  outC->_L115.d_DP_or_OL = kcg_lit_int32(0);
  outC->_L115.v_release = kcg_lit_int32(0);
  outC->_L115.calc_v_release_onboard = kcg_true;
  outC->_L114.d_DP_or_OL = kcg_lit_int32(0);
  outC->_L114.v_release = kcg_lit_int32(0);
  outC->_L114.calc_v_release_onboard = kcg_true;
  outC->_L109 = kcg_lit_int32(0);
  outC->_L106.d_DP_or_OL = kcg_lit_int32(0);
  outC->_L106.v_release = kcg_lit_int32(0);
  ...
  outC->_L101.v_main = kcg_lit_int32(0);
  outC->_L101.v_loa = kcg_lit_int32(0);
  outC->_L101.t_loa_unlimited = kcg_true;
  outC->_L101.t_loa = kcg_lit_int32(0);
  outC->_L101.n_iter = kcg_lit_int32(0);
  for (idx3 = 0; idx3 < 10; idx3++) {
    outC->_L101.sections[idx3].valid = kcg_true;
    outC->_L101.sections[idx3].q_endsection = kcg_true;
    outC->_L101.sections[idx3].l_section = kcg_lit_int32(0);
    outC->_L101.sections[idx3].q_sectiontimer = kcg_true;
    outC->_L101.sections[idx3].t_sectiontimer = kcg_lit_int32(0);
    outC->_L101.sections[idx3].d_sectiontimerstoploc = kcg_lit_int32(0);
  }
  outC->_L101.q_dangerpoint = kcg_true;
  outC->_L101.dangerpoint.d_DP_or_OL = kcg_lit_int32(0);
  outC->_L101.dangerpoint.v_release = kcg_lit_int32(0);
  outC->_L101.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->_L101.q_overlap = kcg_true;
  outC->_L101.overlap.d_DP_or_OL = kcg_lit_int32(0);
  outC->_L101.overlap.v_release = kcg_lit_int32(0);
  outC->_L101.overlap.calc_v_release_onboard = kcg_true;
  outC->_L101.q_endtimer = kcg_true;
  outC->_L101.endtimer_t.t_endtimer = kcg_lit_int32(0);
  outC->_L101.endtimer_t.d_endtimerstoploc = kcg_lit_int32(0);
  outC->_L103.valid = kcg_true;
  outC->_L103.Level = MA_L1_TrackAtlasTypes;
  outC->_L103.q_dir = Q_DIR_Reverse;
  outC->_L103.v_main = kcg_lit_int32(0);
  outC->_L103.v_loa = kcg_lit_int32(0);
  outC->_L103.t_loa_unlimited = kcg_true;
  outC->_L103.t_loa = kcg_lit_int32(0);
  ...
  for (idx4 = 0; idx4 < 10; idx4++) {
    ...
    outC->_L103.sections[idx4].l_section = kcg_lit_int32(0);
    outC->_L103.sections[idx4].q_sectiontimer = kcg_true;
    outC->_L103.sections[idx4].t_sectiontimer = kcg_lit_int32(0);
    outC->_L103.sections[idx4].d_sectiontimerstoploc = kcg_lit_int32(0);
  }
  outC->_L103.q_dangerpoint = kcg_true;
  outC->_L103.dangerpoint.d_DP_or_OL = kcg_lit_int32(0);
  outC->_L103.dangerpoint.v_release = kcg_lit_int32(0);
  outC->_L103.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->_L103.q_overlap = kcg_true;
  outC->_L103.overlap.d_DP_or_OL = kcg_lit_int32(0);
  outC->_L103.overlap.v_release = kcg_lit_int32(0);
  outC->_L103.overlap.calc_v_release_onboard = kcg_true;
  outC->_L103.q_endtimer = kcg_true;
  outC->_L103.endtimer_t.t_endtimer = kcg_lit_int32(0);
  outC->_L103.endtimer_t.d_endtimerstoploc = kcg_lit_int32(0);
  for (idx5 = 0; idx5 < 10; idx5++) {
    outC->_L72[idx5].valid = kcg_true;
    outC->_L72[idx5].q_endsection = kcg_true;
    outC->_L72[idx5].l_section = kcg_lit_int32(0);
    outC->_L72[idx5].q_sectiontimer = kcg_true;
    outC->_L72[idx5].t_sectiontimer = kcg_lit_int32(0);
    outC->_L72[idx5].d_sectiontimerstoploc = kcg_lit_int32(0);
  }
  for (idx6 = 0; idx6 < 10; idx6++) {
    outC->_L40[idx6] = kcg_lit_int32(0);
  }
  outC->_L37 = kcg_lit_int32(0);
  for (idx7 = 0; idx7 < 10; idx7++) {
    outC->_L4[idx7].valid = kcg_true;
    outC->_L4[idx7].q_endsection = kcg_true;
    outC->_L4[idx7].l_section = kcg_lit_int32(0);
    outC->_L4[idx7].q_sectiontimer = kcg_true;
    outC->_L4[idx7].t_sectiontimer = kcg_lit_int32(0);
    outC->_L4[idx7].d_sectiontimerstoploc = kcg_lit_int32(0);
  }
  ...
  outC->ProfileOut.v_main = kcg_lit_int32(0);
  outC->ProfileOut.v_loa = kcg_lit_int32(0);
  outC->ProfileOut.t_loa_unlimited = kcg_true;
  outC->ProfileOut.t_loa = kcg_lit_int32(0);
  outC->ProfileOut.n_iter = kcg_lit_int32(0);
  for (idx8 = 0; idx8 < 10; idx8++) {
    outC->ProfileOut.sections[idx8].valid = kcg_true;
    outC->ProfileOut.sections[idx8].q_endsection = kcg_true;
    outC->ProfileOut.sections[idx8].l_section = kcg_lit_int32(0);
    outC->ProfileOut.sections[idx8].q_sectiontimer = kcg_true;
    outC->ProfileOut.sections[idx8].t_sectiontimer = kcg_lit_int32(0);
    outC->ProfileOut.sections[idx8].d_sectiontimerstoploc = kcg_lit_int32(0);
  }
  outC->ProfileOut.q_dangerpoint = kcg_true;
  outC->ProfileOut.dangerpoint.d_DP_or_OL = kcg_lit_int32(0);
  outC->ProfileOut.dangerpoint.v_release = kcg_lit_int32(0);
  outC->ProfileOut.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->ProfileOut.q_overlap = kcg_true;
  outC->ProfileOut.overlap.d_DP_or_OL = kcg_lit_int32(0);
  outC->ProfileOut.overlap.v_release = kcg_lit_int32(0);
  outC->ProfileOut.overlap.calc_v_release_onboard = kcg_true;
  outC->ProfileOut.q_endtimer = kcg_true;
  outC->ProfileOut.endtimer_t.t_endtimer = kcg_lit_int32(0);
  outC->ProfileOut.endtimer_t.d_endtimerstoploc = kcg_lit_int32(0);
  for (idx = 0; idx < 10; idx++) {
    /* _L4=(TA_Lib_internal::MoveMAAbsolute_Loop_new#1)/ */
