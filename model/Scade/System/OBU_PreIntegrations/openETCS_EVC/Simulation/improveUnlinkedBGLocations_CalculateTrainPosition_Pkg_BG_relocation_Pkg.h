...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC__233_improveUnlinkedBGLoc_CalculateTrainPosition_Pkg_BG_relocation_Pkg /* _L6=(CalculateTrainPosition_Pkg::BG_relocation_Pkg::improveUnlinkedBGLocations_itr#1)/ */ Context_improveUnlinkedBGLocations_itr_1[41];
