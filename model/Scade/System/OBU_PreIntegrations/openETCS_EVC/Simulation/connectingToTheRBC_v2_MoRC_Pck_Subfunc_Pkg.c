...
{
  /* action/ */
  mobileConnetionAction_T_RCM_Types_Pkg action_partial;
  /* action/ */
  mobileConnetionAction_T_RCM_Types_Pkg _1_action_partial;
  /* action/ */
  mobileConnetionAction_T_RCM_Types_Pkg _2_action_partial;
  /* action/ */
  mobileConnetionAction_T_RCM_Types_Pkg _3_action_partial;
  /* action/ */
  mobileConnetionAction_T_RCM_Types_Pkg _4_action_partial;
  /* action/ */
  mobileConnetionAction_T_RCM_Types_Pkg _5_action_partial;
  /* action/ */
  mobileConnetionAction_T_RCM_Types_Pkg _6_action_partial;
  /* action/ */
  mobileConnetionAction_T_RCM_Types_Pkg _7_action_partial;
  ...
  if (outC->IfBlock1_clock) {
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      _7_action_partial = outC->_L1_then_else_IfBlock1;
      _1_action_partial = _7_action_partial;
    }
    else {
      /* IfBlock1:else:else: */
      if (outC->else_clock_else_IfBlock1) {
        outC->_L1_then_else_else_IfBlock1 = mca_expectRadioHole_RCM_Types_Pkg;
        _2_action_partial = outC->_L1_then_else_else_IfBlock1;
        _6_action_partial = _2_action_partial;
      }
      else {
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          _5_action_partial = outC->_L1_then_else_else_else_IfBlock1;
          _3_action_partial = _5_action_partial;
        }
        else {
          outC->_L1_else_else_else_else_IfBlock1 = mca_nop_RCM_Types_Pkg;
          _4_action_partial = outC->_L1_else_else_else_else_IfBlock1;
          _3_action_partial = _4_action_partial;
        }
        _6_action_partial = _3_action_partial;
      }
      _1_action_partial = _6_action_partial;
    }
    outC->action = _1_action_partial;
  }
