...
{
  /* msgToRBC/ */
  msgToTrack_T_RCM_MsgTypes_Pkg msgToRBC_partial;
  /* msgToRBC/ */
  msgToTrack_T_RCM_MsgTypes_Pkg _1_msgToRBC_partial;
  /* msgToRBC/ */
  msgToTrack_T_RCM_MsgTypes_Pkg _2_msgToRBC_partial;
  /* msgToRBC/ */
  msgToTrack_T_RCM_MsgTypes_Pkg _3_msgToRBC_partial;
  /* msgToRBC/ */
  msgToTrack_T_RCM_MsgTypes_Pkg _4_msgToRBC_partial;
  /* msgToRBC/ */
  msgToTrack_T_RCM_MsgTypes_Pkg _5_msgToRBC_partial;
  /* msgToRBC/ */
  msgToTrack_T_RCM_MsgTypes_Pkg _6_msgToRBC_partial;
  /* msgToRBC/ */
  msgToTrack_T_RCM_MsgTypes_Pkg _7_msgToRBC_partial;
  /* sessionStatus_l/ */
  sessionStatus_T_RCM_Session_Types_Pkg last_sessionStatus_l;
  /* registrationStatus_l/ */
  mobileRegistrationContext_T_RCM_Types_Pkg last_registrationStatus_l;
  /* connectionStatus_l/ */
  mobileConnectionContext_T_RCM_Types_Pkg last_connectionStatus_l;
  ...
  kcg_copy_p42_sessionManagement_T_RCM_MsgTypes_Pkg(
    ...
    &outC->p42_sessionManagement);
  kcg_copy_m38_initiationOfACommunicationSession_T_RCM_MsgTypes_Pkg(
    &outC->_1_m38_initiationOfACommunicationSessionMsg,
    &outC->_L95);
  kcg_copy_m38_initiationOfACommunicationSession_T_RCM_MsgTypes_Pkg(
    &outC->_L101,
    &outC->_1_m38_initiationOfACommunicationSessionMsg);
  ...
  kcg_copy_p42_sessionManagement_T_RCM_MsgTypes_Pkg(
    ...
    &outC->p42_sessionManagement);
  kcg_copy_m39_AckOfTerminationOfACommunicationSession_T_RCM_MsgTypes_Pkg(
    &outC->_2_m39_AckOfTerminationOfACommunicationSession,
    &outC->_L96);
  kcg_copy_m39_AckOfTerminationOfACommunicationSession_T_RCM_MsgTypes_Pkg(
    &outC->_L103,
    &outC->_2_m39_AckOfTerminationOfACommunicationSession);
...
void MoRC_Main_v2_init_MoRC_Pck(outC_MoRC_Main_v2_MoRC_Pck *outC)
{
  ...
  outC->m32_SystemVersion.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  outC->_2_m39_AckOfTerminationOfACommunicationSession.valid = kcg_true;
  outC->_2_m39_AckOfTerminationOfACommunicationSession.msgSrc =
    msrc_undefined_Common_Types_Pkg;
  outC->_2_m39_AckOfTerminationOfACommunicationSession.origin.valid = kcg_true;
  outC->_2_m39_AckOfTerminationOfACommunicationSession.origin.nid_c =
    kcg_lit_int32(0);
  outC->_2_m39_AckOfTerminationOfACommunicationSession.origin.rbc_id =
    kcg_lit_int32(0);
  outC->_2_m39_AckOfTerminationOfACommunicationSession.origin.device_id =
    kcg_lit_int32(0);
  outC->_2_m39_AckOfTerminationOfACommunicationSession.lrbg = kcg_lit_int32(0);
  outC->_1_m38_initiationOfACommunicationSessionMsg.valid = kcg_true;
  outC->_1_m38_initiationOfACommunicationSessionMsg.msgSrc =
    msrc_undefined_Common_Types_Pkg;
  outC->_1_m38_initiationOfACommunicationSessionMsg.origin.valid = kcg_true;
  outC->_1_m38_initiationOfACommunicationSessionMsg.origin.nid_c =
    kcg_lit_int32(0);
  outC->_1_m38_initiationOfACommunicationSessionMsg.origin.rbc_id =
    kcg_lit_int32(0);
  outC->_1_m38_initiationOfACommunicationSessionMsg.origin.device_id =
    kcg_lit_int32(0);
  ...
  /* _L84=(MoRC_Pck::Subfunc_Pkg::safeRadioConnectionIndication_v2#1)/ */
  safeRadioConnectionIndica_init_MoRC_Pck_Subfunc_Pkg(
    &outC->Context_safeRadioConnectionIndication_v2_1);
  /* ifMessageToRBC:then:_L6=(MoRC_Pck::Coder_Pkg::genMsgToRBC#4)/ */
  ...
  /* _L19=(MoRC_Pck::Subfunc_Pkg::registeringToTheRadioNetwork_v2#1)/ */
  registeringToTheRadioNetw_init_MoRC_Pck_Subfunc_Pkg(
    &outC->Context_registeringToTheRadioNetwork_v2_1);
  /* _L8=(MoRC_Pck::Subfunc_Pkg::connectingToTheRBC_v2#1)/ */
  connectingToTheRBC_v2_init_MoRC_Pck_Subfunc_Pkg(
    &outC->Context_connectingToTheRBC_v2_1);
  /* _L2=(MoRC_Pck::Subfunc_Pkg::requestRadioConnectionSetupFromOBU_v2#1)/ */
  requestRadioConnectionSet_init_MoRC_Pck_Subfunc_Pkg(
    &outC->Context_requestRadioConnectionSetupFromOBU_v2_1);
  /* _L56=(MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2#1)/ */
...
{
  /* _L84=(MoRC_Pck::Subfunc_Pkg::safeRadioConnectionIndication_v2#1)/ */
  safeRadioConnectionIndica_reset_MoRC_Pck_Subfunc_Pkg(
    &outC->Context_safeRadioConnectionIndication_v2_1);
  /* ifMessageToRBC:then:_L6=(MoRC_Pck::Coder_Pkg::genMsgToRBC#4)/ */
  ...
  /* _L19=(MoRC_Pck::Subfunc_Pkg::registeringToTheRadioNetwork_v2#1)/ */
  registeringToTheRadioNetw_reset_MoRC_Pck_Subfunc_Pkg(
    &outC->Context_registeringToTheRadioNetwork_v2_1);
  /* _L8=(MoRC_Pck::Subfunc_Pkg::connectingToTheRBC_v2#1)/ */
  connectingToTheRBC_v2_reset_MoRC_Pck_Subfunc_Pkg(
    &outC->Context_connectingToTheRBC_v2_1);
  /* _L2=(MoRC_Pck::Subfunc_Pkg::requestRadioConnectionSetupFromOBU_v2#1)/ */
  requestRadioConnectionSet_reset_MoRC_Pck_Subfunc_Pkg(
    &outC->Context_requestRadioConnectionSetupFromOBU_v2_1);
  /* _L56=(MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2#1)/ */
