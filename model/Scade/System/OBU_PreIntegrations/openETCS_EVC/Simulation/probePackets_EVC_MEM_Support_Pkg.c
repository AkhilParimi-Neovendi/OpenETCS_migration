  ...
  outC_probePackets_EVC_MEM_Support_Pkg *outC)
{
  kcg_bool noname;
  kcg_bool _1_noname;
  P135_OBU_T_TM _2_noname;
  P012_OBU_T_TM _3_noname;
  P137_StopIfInStaffResponsible_T_Packet_Types_Pkg _4_noname;
  P138_ReversingAreaInformation_T_Packet_Types_Pkg _5_noname;
  P139_ReversingSupervisionInformation_T_Packet_Types_Pkg _6_noname;
  _6_P15_Level23MovementAuthorities_T_Packet_Types_Pkg _7_noname;
  kcg_bool _8_noname;
  kcg_bool _9_noname;
  kcg_bool _10_noname;
  kcg_bool _11_noname;
  ...
  outC_probePackets_EVC_MEM_Support_Pkg *outC)
{
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L172.sections[idx1].d_static = kcg_lit_int32(0);
    outC->_L172.sections[idx1].v_static = kcg_lit_int32(0);
    outC->_L172.sections[idx1].q_front =
      Q_FRONT_Train_length_delay_on_validity_end_point_of_profile_element;
    outC->_L172.sections[idx1].n_iter = kcg_lit_int32(0);
    for (idx = 0; idx < 32; idx++) {
      outC->_L172.sections[idx1].SECTIONS_q_diff[idx].valid = kcg_true;
      outC->_L172.sections[idx1].SECTIONS_q_diff[idx].nc_diff = kcg_lit_int32(0);
      outC->_L172.sections[idx1].SECTIONS_q_diff[idx].v_diff = kcg_lit_int32(0);
    }
  }
  outC->_L122 = kcg_true;
  outC->_L166 = kcg_true;
  ...
  outC->_L167.nid_tsr = kcg_lit_int32(0);
  outC->_L167.d_tsr = kcg_lit_int32(0);
  outC->_L167.l_tsr = kcg_lit_int32(0);
  outC->_L167.q_front =
    Q_FRONT_Train_length_delay_on_validity_end_point_of_profile_element;
  outC->_L167.v_tsr = kcg_lit_int32(0);
  outC->_L164 = kcg_true;
  outC->_L165.valid = kcg_true;
  outC->_L165.q_dir = Q_DIR_Reverse;
  outC->_L165.l_packet = kcg_lit_int32(0);
  outC->_L165.q_scale = Q_SCALE_10_cm_scale;
  outC->_L165.n_iter = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 33; idx2++) {
    outC->_L165.sections[idx2].valid = kcg_true;
    outC->_L165.sections[idx2].d_mamode = kcg_lit_int32(0);
    outC->_L165.sections[idx2].m_mamode = M_MAMODE_On_Sight;
    outC->_L165.sections[idx2].v_mamode = kcg_lit_int32(0);
    outC->_L165.sections[idx2].l_mamode = kcg_lit_int32(0);
    outC->_L165.sections[idx2].l_ackmamode = kcg_lit_int32(0);
  ...
  outC->_L163.nid_rbc = kcg_lit_int32(0);
  ...
  outC->_L161.l_packet = kcg_lit_int32(0);
  outC->_L161.q_scale = Q_SCALE_10_cm_scale;
  outC->_L161.n_iter = kcg_lit_int32(0);
  for (idx3 = 0; idx3 < 33; idx3++) {
    outC->_L161.sections[idx3].valid = kcg_true;
    outC->_L161.sections[idx3].d_link = kcg_lit_int32(0);
    outC->_L161.sections[idx3].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L161.sections[idx3].nid_c = kcg_lit_int32(0);
    outC->_L161.sections[idx3].nid_bg = kcg_lit_int32(0);
    ...
    outC->_L161.sections[idx3].q_locacc = kcg_lit_int32(0);
  }
  for (idx4 = 0; idx4 < 7; idx4++) {
    ...
    outC->_L156[idx4].nid_ntc = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 7; idx5++) {
    ...
    outC->_L155[idx5].d_leveltr = kcg_lit_int32(0);
    outC->_L155[idx5].m_leveltr = M_LEVELTR_Level_0;
    outC->_L155[idx5].nid_ntc = kcg_lit_int32(0);
    outC->_L155[idx5].l_ackleveltr = kcg_lit_int32(0);
  }
  ...
  for (idx6 = 0; idx6 < 32; idx6++) {
    ...
    outC->_L117.sections[idx6].l_section = kcg_lit_int32(0);
    outC->_L117.sections[idx6].q_sectiontimer =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L117.sections[idx6].t_sectiontimer = kcg_lit_int32(0);
    outC->_L117.sections[idx6].d_sectiontimerstoploc = kcg_lit_int32(0);
  }
  ...
  for (idx7 = 0; idx7 < 30; idx7++) {
    outC->_L119.PacketHeaders[idx7].nid_packet = kcg_lit_int32(0);
    outC->_L119.PacketHeaders[idx7].q_dir = Q_DIR_Reverse;
    outC->_L119.PacketHeaders[idx7].valid = kcg_true;
    outC->_L119.PacketHeaders[idx7].startAddress = kcg_lit_int32(0);
    outC->_L119.PacketHeaders[idx7].endAddress = kcg_lit_int32(0);
  }
  for (idx8 = 0; idx8 < 500; idx8++) {
    outC->_L119.PacketData[idx8] = kcg_lit_int32(0);
  }
  ...
  for (idx9 = 0; idx9 < 5; idx9++) {
    ...
    outC->_L129[idx9].v_loa = kcg_lit_int32(0);
    outC->_L129[idx9].t_loa = kcg_lit_int32(0);
    outC->_L129[idx9].l_section = kcg_lit_int32(0);
    outC->_L129[idx9].q_sectiontimer_k =
      Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L129[idx9].t_sectiontimer_k = kcg_lit_int32(0);
    outC->_L129[idx9].d_sectiontimerstoploc_k = kcg_lit_int32(0);
    outC->_L129[idx9].l_endsection = kcg_lit_int32(0);
    outC->_L129[idx9].q_sectiontimer = Q_SECTIONTIMER_No_Section_Timer_information;
    outC->_L129[idx9].t_sectiontimer = kcg_lit_int32(0);
    outC->_L129[idx9].d_sectiontimerstoploc = kcg_lit_int32(0);
    outC->_L129[idx9].q_endtimer = Q_ENDTIMER_No_End_section_timer_information;
    outC->_L129[idx9].t_endtimer = kcg_lit_int32(0);
    outC->_L129[idx9].d_endtimerstartloc = kcg_lit_int32(0);
    outC->_L129[idx9].q_dangerpoint = Q_DANGERPOINT_No_danger_point_information;
    outC->_L129[idx9].d_dp = kcg_lit_int32(0);
    outC->_L129[idx9].v_releasedp = kcg_lit_int32(0);
    outC->_L129[idx9].q_overlap = Q_OVERLAP_No_overlap_information;
    outC->_L129[idx9].d_startol = kcg_lit_int32(0);
    outC->_L129[idx9].t_ol = kcg_lit_int32(0);
    outC->_L129[idx9].d_ol = kcg_lit_int32(0);
    outC->_L129[idx9].v_releaseol = kcg_lit_int32(0);
  }
  ...
  for (idx10 = 0; idx10 < 7; idx10++) {
    ...
    outC->_L136[idx10].d_gradient = kcg_lit_int32(0);
    outC->_L136[idx10].q_gdir = Q_GDIR_downhill;
    outC->_L136[idx10].g_a = kcg_lit_int32(0);
  }
  outC->_L137.valid = kcg_true;
  outC->_L137.systemTimeMsgReceived = kcg_lit_int32(0);
  ...
  outC->_L137.btm_msg.api_header.m_mcount = kcg_lit_int32(0);
  outC->_L137.btm_msg.api_header.nid_c = kcg_lit_int32(0);
  outC->_L137.btm_msg.api_header.nid_bg = kcg_lit_int32(0);
  ...
  outC->_L137.rtm_msg.Radio_Common_Header.radioDevice = kcg_lit_int32(0);
  outC->_L137.rtm_msg.Radio_Common_Header.receivedSystemTime = kcg_lit_int32(0);
  outC->_L137.rtm_msg.Radio_Common_Header.nid_message = kcg_lit_int32(0);
  outC->_L137.rtm_msg.Radio_Common_Header.t_train = kcg_lit_int32(0);
  outC->_L137.rtm_msg.Radio_Common_Header.m_ack =
    M_ACK_No_acknowledgement_required;
  outC->_L137.rtm_msg.Radio_Common_Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L137.rtm_msg.Radio_Common_Header.t_train_reference = kcg_lit_int32(0);
  outC->_L137.rtm_msg.Radio_Common_Header.nid_em = kcg_lit_int32(0);
  outC->_L137.rtm_msg.Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L137.rtm_msg.Radio_Common_Header.d_sr = kcg_lit_int32(0);
  outC->_L137.rtm_msg.Radio_Common_Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L137.rtm_msg.Radio_Common_Header.d_ref = kcg_lit_int32(0);
  outC->_L137.rtm_msg.Radio_Common_Header.q_dir = Q_DIR_Reverse;
  outC->_L137.rtm_msg.Radio_Common_Header.d_emergencystop = kcg_lit_int32(0);
  ...
  outC->_L137.rtm_msg.sendingRBC_Id.nid_c = kcg_lit_int32(0);
  outC->_L137.rtm_msg.sendingRBC_Id.rbc_id = kcg_lit_int32(0);
  outC->_L137.rtm_msg.sendingRBC_Id.device_id = kcg_lit_int32(0);
  for (idx11 = 0; idx11 < 30; idx11++) {
    outC->_L137.packets.PacketHeaders[idx11].nid_packet = kcg_lit_int32(0);
    outC->_L137.packets.PacketHeaders[idx11].q_dir = Q_DIR_Reverse;
    outC->_L137.packets.PacketHeaders[idx11].valid = kcg_true;
    outC->_L137.packets.PacketHeaders[idx11].startAddress = kcg_lit_int32(0);
    outC->_L137.packets.PacketHeaders[idx11].endAddress = kcg_lit_int32(0);
  }
  for (idx12 = 0; idx12 < 500; idx12++) {
    outC->_L137.packets.PacketData[idx12] = kcg_lit_int32(0);
  }
  outC->p65.valid = kcg_true;
  outC->p65.q_dir = Q_DIR_Reverse;
  outC->p65.q_scale = Q_SCALE_10_cm_scale;
  outC->p65.nid_tsr = kcg_lit_int32(0);
  outC->p65.d_tsr = kcg_lit_int32(0);
  outC->p65.l_tsr = kcg_lit_int32(0);
  outC->p65.q_front =
    Q_FRONT_Train_length_delay_on_validity_end_point_of_profile_element;
  outC->p65.v_tsr = kcg_lit_int32(0);
  outC->p80.valid = kcg_true;
  outC->p80.q_dir = Q_DIR_Reverse;
  outC->p80.l_packet = kcg_lit_int32(0);
  outC->p80.q_scale = Q_SCALE_10_cm_scale;
  outC->p80.n_iter = kcg_lit_int32(0);
  for (idx13 = 0; idx13 < 33; idx13++) {
    outC->p80.sections[idx13].valid = kcg_true;
    outC->p80.sections[idx13].d_mamode = kcg_lit_int32(0);
    outC->p80.sections[idx13].m_mamode = M_MAMODE_On_Sight;
    outC->p80.sections[idx13].v_mamode = kcg_lit_int32(0);
    outC->p80.sections[idx13].l_mamode = kcg_lit_int32(0);
    outC->p80.sections[idx13].l_ackmamode = kcg_lit_int32(0);
  ...
  outC->p42.nid_c = kcg_lit_int32(0);
  outC->p42.nid_rbc = kcg_lit_int32(0);
  ...
  for (idx14 = 0; idx14 < 7; idx14++) {
    ...
    outC->p21[idx14].d_gradient = kcg_lit_int32(0);
    outC->p21[idx14].q_gdir = Q_GDIR_downhill;
    outC->p21[idx14].g_a = kcg_lit_int32(0);
  }
  ...
  for (idx16 = 0; idx16 < 33; idx16++) {
    ...
    outC->p27.sections[idx16].d_static = kcg_lit_int32(0);
    outC->p27.sections[idx16].v_static = kcg_lit_int32(0);
    outC->p27.sections[idx16].q_front =
      Q_FRONT_Train_length_delay_on_validity_end_point_of_profile_element;
    outC->p27.sections[idx16].n_iter = kcg_lit_int32(0);
    for (idx15 = 0; idx15 < 32; idx15++) {
      outC->p27.sections[idx16].SECTIONS_q_diff[idx15].valid = kcg_true;
      outC->p27.sections[idx16].SECTIONS_q_diff[idx15].nc_diff = kcg_lit_int32(0);
      outC->p27.sections[idx16].SECTIONS_q_diff[idx15].v_diff = kcg_lit_int32(0);
    }
  }
  outC->p05.valid = kcg_true;
  outC->p05.q_dir = Q_DIR_Reverse;
  outC->p05.l_packet = kcg_lit_int32(0);
  outC->p05.q_scale = Q_SCALE_10_cm_scale;
  outC->p05.n_iter = kcg_lit_int32(0);
  for (idx17 = 0; idx17 < 33; idx17++) {
    outC->p05.sections[idx17].valid = kcg_true;
    outC->p05.sections[idx17].d_link = kcg_lit_int32(0);
    outC->p05.sections[idx17].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->p05.sections[idx17].nid_c = kcg_lit_int32(0);
    outC->p05.sections[idx17].nid_bg = kcg_lit_int32(0);
    outC->p05.sections[idx17].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->p05.sections[idx17].q_linkreaction = Q_LINKREACTION_Train_trip;
    outC->p05.sections[idx17].q_locacc = kcg_lit_int32(0);
  }
  for (idx18 = 0; idx18 < 7; idx18++) {
    ...
    outC->p46[idx18].nid_ntc = kcg_lit_int32(0);
  }
  for (idx19 = 0; idx19 < 7; idx19++) {
    ...
    outC->p41[idx19].d_leveltr = kcg_lit_int32(0);
    outC->p41[idx19].m_leveltr = M_LEVELTR_Level_0;
    outC->p41[idx19].nid_ntc = kcg_lit_int32(0);
    outC->p41[idx19].l_ackleveltr = kcg_lit_int32(0);
  }
