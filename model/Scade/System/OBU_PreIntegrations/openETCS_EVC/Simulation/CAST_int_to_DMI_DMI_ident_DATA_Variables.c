...
#include "CAST_int_to_DMI_DMI_ident_DATA_Variables.h"

/* DATA::Variables::CAST_int_to_DMI_DMI_identifier/ */
void CAST_int_to_DMI_DMI_ident_DATA_Variables(
  /* dmi_dmi_identifier_int/ */
  kcg_int32 dmi_dmi_identifier_int,
  outC_CAST_int_to_DMI_DMI_ident_DATA_Variables *outC)
{
  /* dmi_dmi_identifier_ct/ */
  DMI_DMI_Identifier_T_DMI_Types_Pkg dmi_dmi_identifier_ct_partial;
  /* error/ */
  kcg_bool error_partial;
  /* dmi_dmi_identifier_ct/ */
  DMI_DMI_Identifier_T_DMI_Types_Pkg _1_dmi_dmi_identifier_ct_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* error/ */
  kcg_bool _3_error_partial;
  /* dmi_dmi_identifier_ct/ */
  DMI_DMI_Identifier_T_DMI_Types_Pkg _4_dmi_dmi_identifier_ct_partial;
  /* error/ */
  kcg_bool _5_error_partial;
  /* dmi_dmi_identifier_ct/ */
  DMI_DMI_Identifier_T_DMI_Types_Pkg _6_dmi_dmi_identifier_ct_partial;
  kcg_bool noname;
...
void CAST_int_to_DMI_DMI_ident_init_DATA_Variables(
  outC_CAST_int_to_DMI_DMI_ident_DATA_Variables *outC)
{
  outC->_L22 = kcg_true;
  outC->error = kcg_true;
...
void CAST_int_to_DMI_DMI_ident_reset_DATA_Variables(
  outC_CAST_int_to_DMI_DMI_ident_DATA_Variables *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_int_to_DMI_DMI_ident_DATA_Variables.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
