...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P021_OBU_T_TM /* P021_onboard/ */ P021_onboard;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P021_unflatten_sections_TM_lib_internal /* _L5=(TM_lib_internal::C_P021_unflatten_sections#1)/ */ Context_C_P021_unflatten_sections_1;
  ...
  kcg_bool /* @3/IfBlock1:else: */ _2_else_clock_CAST_Int_to_Q_DIR_1_IfBlock1;
  /* -------------------- (-debug) no assertions  -------------------- */
  ...
  Q_DIR /* _L11/ */ _L11;
  P021_OBU_T_TM /* _L10/ */ _L10;
  CompressedPacketData_T_Common_Types_Pkg /* _L9/ */ _L9;
  N_ITER /* _L7/ */ _L7;
  P021_OBU_sectionlist_enum_T_TM /* _L5/ */ _L5;
  Q_SCALE /* _L4/ */ _L4;
  array_int32_5 /* _L1/ */ _L1;
...
extern void C_P021_compr_onboard_init_TM_conversions(
  outC_C_P021_compr_onboard_TM_conversions *outC);
