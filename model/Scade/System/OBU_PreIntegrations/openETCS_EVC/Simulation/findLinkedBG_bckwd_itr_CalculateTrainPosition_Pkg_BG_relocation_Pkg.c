  ...
  outC_findLinkedBG_bckwd_itr_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC)
{
  ...
  outC->index_acc_out.previousLinkedBG_idx = kcg_lit_int32(0);
  outC->index_acc_out.currentIndex = kcg_lit_int32(0);
  outC->index_acc_out.subsequentLinkedBG_idx = kcg_lit_int32(0);
}
