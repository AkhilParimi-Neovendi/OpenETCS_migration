...
void C_P011_fs_flatten_array_v_TM_TrainToTrack_lib_internal(
  /* i/ */
  kcg_int32 i,
  /* Acc/ */
...
void C_P011_fs_flatten_array_v_init_TM_TrainToTrack_lib_internal(
  outC_C_P011_fs_flatten_array_v_TM_TrainToTrack_lib_internal *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void C_P011_fs_flatten_array_v_reset_TM_TrainToTrack_lib_internal(
  outC_C_P011_fs_flatten_array_v_TM_TrainToTrack_lib_internal *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** C_P011_fs_flatten_array_v_TM_TrainToTrack_lib_internal.c
** Generation date: 2023-11-06T13:54:30
*************************************************************$ */
