...
typedef struct {
  ...
  CompressedPacketData_T_Common_Types_Pkg /* P042_compressed/ */ P042_compressed;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_T_Build_Metadata_Packet_ID_TM_lib_internal /* _L393=(TM_lib_internal::T_Build_Metadata_Packet_ID#1)/ */ Context_T_Build_Metadata_Packet_ID_1;
  ...
  nid_packet_meta_TM /* _L393/ */ _L393;
...
extern void C_P042_tracksim_compr_init_TM_conversions(
  outC_C_P042_tracksim_compr_TM_conversions *outC);
