...
{
  /* valid_v_est/ */
  kcg_bool valid_v_est_partial;
  /* valid_v_permitted/ */
  kcg_bool valid_v_permitted_partial;
  /* valid_v_release/ */
  kcg_bool valid_v_release_partial;
  /* v_mrdt/ */
  V_odometry_Type_Obu_BasicTypes_Pkg v_mrdt_partial;
  /* valid_v_mrdt/ */
  kcg_bool valid_v_mrdt_partial;
  /* valid_targetDistance/ */
  kcg_bool valid_targetDistance_partial;
  /* valid_v_est/ */
  kcg_bool _1_valid_v_est_partial;
  /* valid_v_permitted/ */
  kcg_bool _2_valid_v_permitted_partial;
  /* valid_v_release/ */
  kcg_bool _3_valid_v_release_partial;
  /* v_mrdt/ */
  V_odometry_Type_Obu_BasicTypes_Pkg _4_v_mrdt_partial;
  /* valid_v_mrdt/ */
  kcg_bool _5_valid_v_mrdt_partial;
  /* valid_targetDistance/ */
  kcg_bool _6_valid_targetDistance_partial;
  /* valid_v_est/ */
  kcg_bool _7_valid_v_est_partial;
  /* valid_v_permitted/ */
  kcg_bool _8_valid_v_permitted_partial;
  /* valid_v_release/ */
  kcg_bool _9_valid_v_release_partial;
  /* v_mrdt/ */
  V_odometry_Type_Obu_BasicTypes_Pkg _10_v_mrdt_partial;
  /* valid_v_mrdt/ */
  kcg_bool _11_valid_v_mrdt_partial;
  /* valid_targetDistance/ */
  kcg_bool _12_valid_targetDistance_partial;
  /* valid_v_est/ */
  kcg_bool _13_valid_v_est_partial;
  /* valid_v_permitted/ */
  kcg_bool _14_valid_v_permitted_partial;
  /* valid_v_release/ */
  kcg_bool _15_valid_v_release_partial;
  /* v_mrdt/ */
  V_odometry_Type_Obu_BasicTypes_Pkg _16_v_mrdt_partial;
  /* valid_v_mrdt/ */
  kcg_bool _17_valid_v_mrdt_partial;
  /* valid_targetDistance/ */
  kcg_bool _18_valid_targetDistance_partial;
