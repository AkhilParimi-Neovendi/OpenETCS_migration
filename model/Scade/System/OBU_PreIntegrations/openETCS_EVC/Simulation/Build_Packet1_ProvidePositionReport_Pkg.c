...
{
  /* in_dirtrain/ */
  Q_DIRTRAIN in_dirtrain_partial;
  /* in_dlrbg/ */
  Q_DLRBG in_dlrbg_partial;
  /* in_dirlrbg/ */
  Q_DIRLRBG in_dirlrbg_partial;
  /* in_dirtrain/ */
  Q_DIRTRAIN _1_in_dirtrain_partial;
  /* in_dlrbg/ */
  Q_DLRBG _2_in_dlrbg_partial;
  /* in_dirlrbg/ */
  Q_DIRLRBG _3_in_dirlrbg_partial;
  /* in_dirtrain/ */
  Q_DIRTRAIN _4_in_dirtrain_partial;
  /* in_dlrbg/ */
  Q_DLRBG _5_in_dlrbg_partial;
  /* in_dirlrbg/ */
  Q_DIRLRBG _6_in_dirlrbg_partial;
  /* in_dirtrain/ */
  Q_DIRTRAIN _7_in_dirtrain_partial;
  /* in_dlrbg/ */
  Q_DLRBG _8_in_dlrbg_partial;
  /* in_dirlrbg/ */
  Q_DIRLRBG _9_in_dirlrbg_partial;
  /* in_dirlrbg/ */
  Q_DIRLRBG _10_in_dirlrbg_partial;
  /* in_dlrbg/ */
  Q_DLRBG _11_in_dlrbg_partial;
  /* in_dirtrain/ */
  Q_DIRTRAIN _12_in_dirtrain_partial;
  /* in_dirlrbg/ */
  Q_DIRLRBG _13_in_dirlrbg_partial;
  /* in_dlrbg/ */
  Q_DLRBG _14_in_dlrbg_partial;
  /* in_dirtrain/ */
  Q_DIRTRAIN _15_in_dirtrain_partial;
  Q_DLRBG noname;
  Q_DIRTRAIN _16_noname;
  Q_DIRLRBG _17_noname;
