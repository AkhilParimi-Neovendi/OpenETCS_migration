...
*************************************************************$ */
#ifndef _CAST_M_SupervisionDisplay_DATA_Variables_H_
#define _CAST_M_SupervisionDisplay_DATA_Variables_H_
...
typedef struct {
  ...
  kcg_bool /* _L1/ */ _L1;
} outC_CAST_M_SupervisionDisplay_DATA_Variables;

/* ===========  node initialization and cycle functions  =========== */
/* DATA::Variables::CAST_M_SupervisionDisplay_to_int/ */
extern void CAST_M_SupervisionDisplay_DATA_Variables(
...
extern void CAST_M_SupervisionDisplay_reset_DATA_Variables(
  outC_CAST_M_SupervisionDisplay_DATA_Variables *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CAST_M_SupervisionDisplay_init_DATA_Variables(
  outC_CAST_M_SupervisionDisplay_DATA_Variables *outC);
#endif /* KCG_USER_DEFINED_INIT */



#endif /* _CAST_M_SupervisionDisplay_DATA_Variables_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_M_SupervisionDisplay_DATA_Variables.h
** Generation date: 2023-11-06T13:54:28
*************************************************************$ */
