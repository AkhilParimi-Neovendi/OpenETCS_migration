...
{
  /* updatedStatus/ */
  trainDataStatus_T_trainData_Types_pkg updatedStatus_partial;
  /* trainData/ */
  trainData_T_TIU_Types_Pkg trainData_partial;
  /* updatedStatus/ */
  trainDataStatus_T_trainData_Types_pkg _1_updatedStatus_partial;
  /* trainData/ */
  trainData_T_TIU_Types_Pkg _2_trainData_partial;
  /* updatedStatus/ */
  trainDataStatus_T_trainData_Types_pkg _3_updatedStatus_partial;
  /* trainData/ */
  trainData_T_TIU_Types_Pkg _4_trainData_partial;
  /* updatedStatus/ */
  trainDataStatus_T_trainData_Types_pkg _5_updatedStatus_partial;
  /* trainData/ */
  trainData_T_TIU_Types_Pkg _6_trainData_partial;
  /* trainData/ */
  trainData_T_TIU_Types_Pkg _7_trainData_partial;
  /* updatedStatus/ */
  trainDataStatus_T_trainData_Types_pkg _8_updatedStatus_partial;
  /* trainData/ */
  trainData_T_TIU_Types_Pkg _9_trainData_partial;
  /* updatedStatus/ */
  trainDataStatus_T_trainData_Types_pkg _10_updatedStatus_partial;
  kcg_bool noname;
  kcg_bool _11_noname;
  /* trainData/ */
  trainData_T_TIU_Types_Pkg last_trainData;
