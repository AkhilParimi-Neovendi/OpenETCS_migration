  ...
  outC_GP_Preprocessing_TA_Gradient_new *outC)
{
  ...
  _228_GP_Convert_P21_to_Di_TA_Gradient_new(
    &outC->_L1,
  ...
  outC_GP_Preprocessing_TA_Gradient_new *outC)
{
  ...
  for (idx = 0; idx < 50; idx++) {
    ...
    outC->_L13[idx].Loc_Absolute = kcg_lit_int32(0);
    outC->_L13[idx].Loc_LRBG = kcg_lit_int32(0);
    outC->_L13[idx].Gradient = kcg_lit_int32(0);
    outC->_L13[idx].L_Gradient = kcg_lit_int32(0);
  }
  for (idx1 = 0; idx1 < 50; idx1++) {
    outC->_L14[idx1].valid = kcg_true;
    outC->_L14[idx1].Loc_Absolute = kcg_lit_int32(0);
    outC->_L14[idx1].Loc_LRBG = kcg_lit_int32(0);
    outC->_L14[idx1].Gradient = kcg_lit_int32(0);
    outC->_L14[idx1].L_Gradient = kcg_lit_int32(0);
  }
  ...
  for (idx2 = 0; idx2 < 33; idx2++) {
    ...
    outC->_L1.sections[idx2].d_gradient = kcg_lit_int32(0);
    outC->_L1.sections[idx2].q_gdir = Q_GDIR_downhill;
    outC->_L1.sections[idx2].g_a = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 50; idx3++) {
    outC->GP[idx3].valid = kcg_true;
    outC->GP[idx3].Loc_Absolute = kcg_lit_int32(0);
    outC->GP[idx3].Loc_LRBG = kcg_lit_int32(0);
    outC->GP[idx3].Gradient = kcg_lit_int32(0);
    outC->GP[idx3].L_Gradient = kcg_lit_int32(0);
  }
  /* _L13=(TA_Lib_internal::MoveGPSectionsAbsolute_new#1)/ */
  MoveGPSectionsAbsolute_new_init_TA_Lib_internal(
    &outC->Context_MoveGPSectionsAbsolute_new_1);
  /* _L14=(TA_Gradient_new::GP_Convert_P21_to_DistanceProfile#1)/ */
  _228_GP_Convert_P21_to_Di_init_TA_Gradient_new(
    &outC->Context_GP_Convert_P21_to_DistanceProfile_1);
}
  ...
  outC_GP_Preprocessing_TA_Gradient_new *outC)
{
  ...
  MoveGPSectionsAbsolute_new_reset_TA_Lib_internal(
    &outC->Context_MoveGPSectionsAbsolute_new_1);
  /* _L14=(TA_Gradient_new::GP_Convert_P21_to_DistanceProfile#1)/ */
  _228_GP_Convert_P21_to_Di_reset_TA_Gradient_new(
    &outC->Context_GP_Convert_P21_to_DistanceProfile_1);
}
