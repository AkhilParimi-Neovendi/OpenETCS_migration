  ...
  outC_BufferOutput_write_only2_TM_lib_internal *outC)
{
  ...
  kcg_copy__171_array(&outC->_L4, (_171_array *) &outC->_L1[0]);
  kcg_copy_M_TrainTrackMessageBus_t_TM_TrainTrack_Bus(&outC->_L3, Message_In);
  kcg_copy__186_array(&outC->_L6, (_186_array *) &outC->_L3[0]);
  kcg_copy__186_array(&outC->_L5[0], &outC->_L6);
  kcg_copy__171_array(&outC->_L5[2], &outC->_L4);
  kcg_copy_M_TrainTrackRadioOutputBuffer_t_TM_lib_internal(
    &outC->Buffer_Out,
    &outC->_L5);
  outC->_L10 = DIM_FIFO_TrainTrackOutput_TM_lib_internal;
  outC->_L8 = kcg_lit_int32(2);
