...
{
  /* m_airtight/ */
  M_AIRTIGHT m_airtight_partial;
  /* error/ */
  kcg_bool error_partial;
  /* m_airtight/ */
  M_AIRTIGHT _1_m_airtight_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* error/ */
  kcg_bool _3_error_partial;
  /* m_airtight/ */
  M_AIRTIGHT _4_m_airtight_partial;
  /* error/ */
  kcg_bool _5_error_partial;
  /* m_airtight/ */
  M_AIRTIGHT _6_m_airtight_partial;
  kcg_bool noname;
  ...
  outC_CAST_Int_to_M_AIRTIGHT_TM_conversions *outC)
{
  ...
  outC->_L5 = kcg_true;
  outC->error = kcg_true;
  outC->m_airtight_in = kcg_lit_int32(0);
