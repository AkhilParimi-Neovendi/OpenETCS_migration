...
void Read_P131_init_TM(outC_Read_P131_TM *outC)
{
  ...
  outC->_L166.d_rbctr = kcg_lit_int32(0);
  ...
  outC->P131_OBU_out.d_rbctr = kcg_lit_int32(0);
  outC->P131_OBU_out.nid_c = kcg_lit_int32(0);
  outC->P131_OBU_out.nid_rbc = kcg_lit_int32(0);
