...
{
  /* msgBus_out/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus msgBus_out_partial;
  kcg_int32 noname;
  /* msgBus_out/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _1_msgBus_out_partial;
  /* msgBus_out/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _2_msgBus_out_partial;
  kcg_int32 _3_noname;
  /* msgBus_out/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _4_msgBus_out_partial;
  /* msgBus_out/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _5_msgBus_out_partial;
  kcg_int32 _6_noname;
  /* msgBus_out/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _7_msgBus_out_partial;
  /* msgBus_out/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _8_msgBus_out_partial;
  kcg_int32 _9_noname;
  /* msgBus_out/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _10_msgBus_out_partial;
