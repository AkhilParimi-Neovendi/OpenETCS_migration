...
*************************************************************$ */
#ifndef _CAST_DMI_Display_Control__DATA_Packets_EVC_to_DMI_H_
#define _CAST_DMI_Display_Control__DATA_Packets_EVC_to_DMI_H_
...
typedef struct {
  ...
  kcg_int32 /* _L6/ */ _L6;
  kcg_int32 /* _L7/ */ _L7;
} outC_CAST_DMI_Display_Control__DATA_Packets_EVC_to_DMI;

/* ===========  node initialization and cycle functions  =========== */
/* DATA::Packets::EVC_to_DMI::CAST_DMI_Display_Control_to_int1/ */
extern void CAST_DMI_Display_Control__DATA_Packets_EVC_to_DMI(
  /* dmi_display_control_ct/ */
  DMI_Display_Control_T_DMI_Messages_EVC_to_DMI_Pkg *dmi_display_control_ct,
  outC_CAST_DMI_Display_Control__DATA_Packets_EVC_to_DMI *outC);

#ifndef KCG_NO_EXTERN_CALL_TO_RESET
extern void CAST_DMI_Display_Control__reset_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_Display_Control__DATA_Packets_EVC_to_DMI *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CAST_DMI_Display_Control__init_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_Display_Control__DATA_Packets_EVC_to_DMI *outC);
#endif /* KCG_USER_DEFINED_INIT */



#endif /* _CAST_DMI_Display_Control__DATA_Packets_EVC_to_DMI_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_Display_Control__DATA_Packets_EVC_to_DMI.h
** Generation date: 2023-11-06T13:54:28
*************************************************************$ */
