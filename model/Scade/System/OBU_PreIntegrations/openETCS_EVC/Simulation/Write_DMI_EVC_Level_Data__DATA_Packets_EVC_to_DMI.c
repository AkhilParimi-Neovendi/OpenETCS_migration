...
void Write_DMI_EVC_Level_Data__DATA_Packets_EVC_to_DMI(
...
{
  DMI_EVC_Level_Data_int_array_T_DATA op_call;
  ...
  if (outC->every) {
    ...
    CAST_DMI_EVC_Level_Data_t_DATA_Packets_EVC_to_DMI(
      &outC->_L8,
...
void Write_DMI_EVC_Level_Data__init_DATA_Packets_EVC_to_DMI(
  outC_Write_DMI_EVC_Level_Data__DATA_Packets_EVC_to_DMI *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  outC->_L8.levelList.number = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 32; idx2++) {
    outC->_L8.levelList.levelList[idx2].level = M_LEVEL_Level_0;
    outC->_L8.levelList.levelList[idx2].nid_stm = kcg_lit_int32(0);
  }
  outC->every = kcg_true;
  for (idx3 = 0; idx3 < 67; idx3++) {
    outC->dmi_evc_level_data_int[idx3] = kcg_lit_int32(0);
  }
  /* _L10=(DATA::Packets::EVC_to_DMI::CAST_DMI_EVC_Level_Data_to_int1#1)/ */
  CAST_DMI_EVC_Level_Data_t_init_DATA_Packets_EVC_to_DMI(
    &outC->Context_CAST_DMI_EVC_Level_Data_to_int1_1);
}
...
void Write_DMI_EVC_Level_Data__reset_DATA_Packets_EVC_to_DMI(
  outC_Write_DMI_EVC_Level_Data__DATA_Packets_EVC_to_DMI *outC)
{
  /* _L10=(DATA::Packets::EVC_to_DMI::CAST_DMI_EVC_Level_Data_to_int1#1)/ */
  CAST_DMI_EVC_Level_Data_t_reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_CAST_DMI_EVC_Level_Data_to_int1_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Write_DMI_EVC_Level_Data__DATA_Packets_EVC_to_DMI.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
