...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  Area_group_INT_T_DATA /* area_group_int/ */ area_group_int;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  kcg_int32 /* IfBlock1:else:else:else:else:else:else:else:then:_L1/ */ _L13_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L2/ */ _L24_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_int32 /* IfBlock1:else:else:else:else:else:then:_L1/ */ _L15_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L2/ */ _L26_then_else_else_else_else_else_IfBlock1;
  ...
  kcg_bool /* _L26/ */ _L26;
} outC_CAST_Area_group_to_int_DATA_Variables;

/* ===========  node initialization and cycle functions  =========== */
/* DATA::Variables::CAST_Area_group_to_int/ */
extern void CAST_Area_group_to_int_DATA_Variables(
  /* area_group_ct/ */
  Area_group_T_DMI_Types_Pkg area_group_ct,
  outC_CAST_Area_group_to_int_DATA_Variables *outC);

#ifndef KCG_NO_EXTERN_CALL_TO_RESET
extern void CAST_Area_group_to_int_reset_DATA_Variables(
  outC_CAST_Area_group_to_int_DATA_Variables *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CAST_Area_group_to_int_init_DATA_Variables(
  outC_CAST_Area_group_to_int_DATA_Variables *outC);
