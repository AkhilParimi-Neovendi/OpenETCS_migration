...
*************************************************************$ */
#ifndef _GP_Convert_P21_to_Distanc_TA_Gradient_new_H_
#define _GP_Convert_P21_to_Distanc_TA_Gradient_new_H_
...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_Normalize_Distance_d_inte_TA_Lib_internal /* _L122=(TA_Lib_internal::Normalize_Distance_d_internal_t#4)/ */ Context_Normalize_Distance_d_internal_t_4;
  outC_EVAL_Q_GDIR_TA_Lib_internal /* _L127=(TA_Lib_internal::EVAL_Q_GDIR#2)/ */ Context_EVAL_Q_GDIR_2;
  outC_Normalize_Distance_d_inte_TA_Lib_internal /* _L135=(TA_Lib_internal::Normalize_Distance_d_internal_t#3)/ */ _1_Context_Normalize_Distance_d_internal_t_3;
...
} outC_GP_Convert_P21_to_Distanc_TA_Gradient_new;

/* ===========  node initialization and cycle functions  =========== */
/* TA_Gradient_new::GP_Convert_P21_to_DistanceProfile_loop/ */
extern void GP_Convert_P21_to_Distanc_TA_Gradient_new(
  /* i/ */
  kcg_int32 i,
  /* ProfileAccu/ */
...
extern void GP_Convert_P21_to_Distanc_reset_TA_Gradient_new(
  outC_GP_Convert_P21_to_Distanc_TA_Gradient_new *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void GP_Convert_P21_to_Distanc_init_TA_Gradient_new(
  outC_GP_Convert_P21_to_Distanc_TA_Gradient_new *outC);
#endif /* KCG_USER_DEFINED_INIT */



#endif /* _GP_Convert_P21_to_Distanc_TA_Gradient_new_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** GP_Convert_P21_to_Distanc_TA_Gradient_new.h
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
