...
void Write_DMI_Adhesion_Factor_DATA_Packets_Bothways(
...
{
  _15_DMI_Adhesion_Factor_Data_int_array_T_DATA op_call;
  ...
  if (outC->every) {
    ...
    C_DMI_Adhesion_Factor_Dat_DATA_Packets_Bothways(
      &outC->_L14,
  ...
  if (outC->every) {
    kcg_copy__15_DMI_Adhesion_Factor_Data_int_array_T_DATA(&outC->_L20, &op_call);
  }
  else {
    kcg_copy__15_DMI_Adhesion_Factor_Data_int_array_T_DATA(
      &outC->_L20,
...
void Write_DMI_Adhesion_Factor_init_DATA_Packets_Bothways(
  outC_Write_DMI_Adhesion_Factor_DATA_Packets_Bothways *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L20=(DATA::Packets::Bothways::C_DMI_Adhesion_Factor_Data_to_int#1)/ */
  C_DMI_Adhesion_Factor_Dat_init_DATA_Packets_Bothways(
    &outC->Context_C_DMI_Adhesion_Factor_Data_to_int_1);
}
...
void Write_DMI_Adhesion_Factor_reset_DATA_Packets_Bothways(
  outC_Write_DMI_Adhesion_Factor_DATA_Packets_Bothways *outC)
{
  /* _L20=(DATA::Packets::Bothways::C_DMI_Adhesion_Factor_Data_to_int#1)/ */
  C_DMI_Adhesion_Factor_Dat_reset_DATA_Packets_Bothways(
    &outC->Context_C_DMI_Adhesion_Factor_Data_to_int_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Write_DMI_Adhesion_Factor_DATA_Packets_Bothways.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
