...
{
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _1_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _2_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _3_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _4_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _5_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _6_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _7_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _8_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _9_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _10_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _11_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _12_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _13_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _14_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _15_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _16_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _17_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _18_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _19_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _20_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _21_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _22_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _23_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _24_FromSB_To_NewMode_partial;
  /* FromSB_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _25_FromSB_To_NewMode_partial;
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              ...
              if (outC->_7_else_clock_else_else_else_else_else_IfBlock1) {
                ...
                outC->_1_else_clock_else_else_else_else_else_else_IfBlock1 = Condition10;
                ...
                if (outC->_1_else_clock_else_else_else_else_else_else_IfBlock1) {
                  ...
                  outC->_6_else_clock_else_else_else_else_else_else_else_IfBlock1 = Condition70;
