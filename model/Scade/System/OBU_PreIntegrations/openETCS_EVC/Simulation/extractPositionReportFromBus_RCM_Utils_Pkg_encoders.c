  ...
  outC_extractPositionReportFromBus_RCM_Utils_Pkg_encoders *outC)
{
  ...
  if (outC->_L3) {
    ...
    for (idx1 = 0; idx1 < 5; idx1++) {
      ...
      extractPositionReportFrom_RCM_Utils_Pkg_encoders(
        /* _L2= */(kcg_int32) idx1,
        acc,
        &outC->_L6[idx1],
  ...
  outC_extractPositionReportFromBus_RCM_Utils_Pkg_encoders *outC)
{
  ...
  for (idx = 0; idx < 5; idx++) {
    /* _L2=(RCM_Utils_Pkg::encoders::extractPositionReportFromBus_itr#1)/ */
    extractPositionReportFrom_init_RCM_Utils_Pkg_encoders(
  ...
  outC_extractPositionReportFromBus_RCM_Utils_Pkg_encoders *outC)
{
  ...
  for (idx = 0; idx < 5; idx++) {
    /* _L2=(RCM_Utils_Pkg::encoders::extractPositionReportFromBus_itr#1)/ */
    extractPositionReportFrom_reset_RCM_Utils_Pkg_encoders(
      &outC->Context_extractPositionReportFromBus_itr_1[idx]);
  }
}
