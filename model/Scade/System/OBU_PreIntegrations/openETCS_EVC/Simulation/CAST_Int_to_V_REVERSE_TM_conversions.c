...
void CAST_Int_to_V_REVERSE_TM_conversions(
  /* v_reverse_int/ */
  kcg_int32 v_reverse_int,
  outC_CAST_Int_to_V_REVERSE_TM_conversions *outC)
{
  ...
  _1_noname = outC->_L8;
  noname = outC->_L9;
  outC->v_reverse = outC->_L11;
}

#ifndef KCG_USER_DEFINED_INIT
void CAST_Int_to_V_REVERSE_init_TM_conversions(
  outC_CAST_Int_to_V_REVERSE_TM_conversions *outC)
{
  ...
  outC->v_reverse = kcg_lit_int32(0);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void CAST_Int_to_V_REVERSE_reset_TM_conversions(
  outC_CAST_Int_to_V_REVERSE_TM_conversions *outC)
{
}
