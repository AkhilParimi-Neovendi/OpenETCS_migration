...
#include "CAST_DMI_Available_Menu_t_DATA_Variables.h"

/* DATA::Variables::CAST_DMI_Available_Menu_to_int/ */
void CAST_DMI_Available_Menu_t_DATA_Variables(
...
void CAST_DMI_Available_Menu_t_init_DATA_Variables(
  outC_CAST_DMI_Available_Menu_t_DATA_Variables *outC)
{
  kcg_size idx;
...
void CAST_DMI_Available_Menu_t_reset_DATA_Variables(
  outC_CAST_DMI_Available_Menu_t_DATA_Variables *outC)
{
  /* _L39=(digital::BoolVect2Int32#31)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_Available_Menu_t_DATA_Variables.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
