...
void CAST_DMI_trackCondition_t_DATA_Variables(
  ...
  outC_CAST_DMI_trackCondition_t_DATA_Variables *outC)
{
  ...
  for (idx = 0; idx < 32; idx++) {
    ...
    CAST_DMI_trackConditionEl_DATA_Variables(
      &outC->_L2[idx],
...
void CAST_DMI_trackCondition_t_init_DATA_Variables(
  outC_CAST_DMI_trackCondition_t_DATA_Variables *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx = 0; idx < 32; idx++) {
    /* _L8=(DATA::Variables::CAST_DMI_trackConditionElement_to_int#1)/ */
    CAST_DMI_trackConditionEl_init_DATA_Variables(
      &outC->Context_CAST_DMI_trackConditionElement_to_int_1[idx]);
  }
}
...
void CAST_DMI_trackCondition_t_reset_DATA_Variables(
  outC_CAST_DMI_trackCondition_t_DATA_Variables *outC)
{
  kcg_size idx;
  ...
  for (idx = 0; idx < 32; idx++) {
    /* _L8=(DATA::Variables::CAST_DMI_trackConditionElement_to_int#1)/ */
    CAST_DMI_trackConditionEl_reset_DATA_Variables(
      &outC->Context_CAST_DMI_trackConditionElement_to_int_1[idx]);
  }
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_trackCondition_t_DATA_Variables.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
