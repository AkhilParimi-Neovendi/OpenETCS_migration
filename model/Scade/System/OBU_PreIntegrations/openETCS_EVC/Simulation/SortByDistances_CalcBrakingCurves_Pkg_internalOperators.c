  ...
  outC_SortByDistances_CalcBrakingCurves_Pkg_internalOperators *outC)
{
  ...
  kcg_size idx2;
  kcg_size idx3;
  ParabolaCurve_T_CalcBrakingCurves_types acc;
  kcg_size idx4;
  kcg_int32 noname;
  ...
  if (outC->_L22) {
    ...
    for (idx4 = 0; idx4 < 114; idx4++) {
      ...
      deleteLeadingUndefinedEle_CalcBrakingCurves_Pkg_internalOperators(
        &acc,
  ...
  outC_SortByDistances_CalcBrakingCurves_Pkg_internalOperators *outC)
{
  ...
  for (idx = 0; idx < 114; idx++) {
    /* _L21=(CalcBrakingCurves_Pkg::internalOperators::deleteLeadingUndefinedElements#1)/ */
    deleteLeadingUndefinedEle_init_CalcBrakingCurves_Pkg_internalOperators(
  ...
  outC_SortByDistances_CalcBrakingCurves_Pkg_internalOperators *outC)
{
  ...
  for (idx = 0; idx < 114; idx++) {
    /* _L21=(CalcBrakingCurves_Pkg::internalOperators::deleteLeadingUndefinedElements#1)/ */
    deleteLeadingUndefinedEle_reset_CalcBrakingCurves_Pkg_internalOperators(
      &outC->Context_deleteLeadingUndefinedElements_1[idx]);
  }
}
