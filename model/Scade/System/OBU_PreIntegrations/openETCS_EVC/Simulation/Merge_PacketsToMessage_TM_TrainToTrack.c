  ...
  outC_Merge_PacketsToMessage_TM_TrainToTrack *outC)
{
  ...
  for (idx = 0; idx < 50; idx++) {
    outC->_L4.OptionalPackets[idx] = kcg_lit_int32(0);
  }
  ...
  outC->RadioMessage.Message.nid_message = kcg_lit_int32(0);
  outC->RadioMessage.Message.l_message = kcg_lit_int32(0);
  outC->RadioMessage.Message.t_train = kcg_lit_int32(0);
  outC->RadioMessage.Message.nid_engine = kcg_lit_int32(0);
  outC->RadioMessage.Message.field1 = kcg_lit_int32(0);
  outC->RadioMessage.Message.field2 = kcg_lit_int32(0);
  outC->RadioMessage.Message.field3 = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 50; idx2++) {
    outC->RadioMessage.OptionalPackets[idx2] = kcg_lit_int32(0);
  }
}
