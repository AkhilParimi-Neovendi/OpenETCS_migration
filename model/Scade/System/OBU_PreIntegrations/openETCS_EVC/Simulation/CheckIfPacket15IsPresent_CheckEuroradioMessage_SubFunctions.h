...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_CheckIfPacketRadioMetadat_CheckEuroradioMessage_SubFunctions /* _L5=(CheckEuroradioMessage::SubFunctions::CheckIfPacketRadioMetadataElementIsPacket15#1)/ */ Context_CheckIfPacketRadioMetadataElementIsPacket15_1[30];
