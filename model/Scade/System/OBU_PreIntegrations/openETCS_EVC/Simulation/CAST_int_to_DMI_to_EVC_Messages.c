  ...
  outC_CAST_int_to_DMI_to_EVC_Messages *outC)
{
  ...
  kcg_copy_DMI_Driver_Identifier_int_array_T_DATA(
    &outC->_L37,
    (DMI_Driver_Identifier_int_array_T_DATA *) &outC->_L31[269]);
  ...
  Write_int_to_DMI_Driver_R_DATA_Packets_DMI_to_EVC(
    &outC->_L36,
    &outC->_3_Context_Write_int_to_DMI_Driver_Reqest_1);
  kcg_copy_DMI_Driver_Request_T_DMI_Messages_DMI_to_EVC_Pkg(
    &outC->_L19,
    &outC->_3_Context_Write_int_to_DMI_Driver_Reqest_1.dmi_driver_request_ct);
  /* _L20=(DATA::Packets::Bothways::Write_int_to_DMI_Driver_Identifier#1)/ */
  Write_int_to_DMI_Driver_I_DATA_Packets_Bothways(
    &outC->_L37,
  ...
  Write_int_to_DMI_Train_Ru_DATA_Packets_Bothways(
    &outC->_L38,
    &outC->_2_Context_Write_int_to_DMI_Train_Running_Number_1);
  kcg_copy_DMI_Train_Running_Number_T_DMI_Messages_Bothways_Pkg(
    &outC->_L21,
    &outC->_2_Context_Write_int_to_DMI_Train_Running_Number_1.dmi_train_running_number_ct);
  /* _L22=(DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Radio_Net_Data#1)/ */
  Write_int_to_DMI_Radio_Ne_DATA_Packets_DMI_to_EVC(
    &outC->_L39,
  ...
  Write_int_to_DMI_Text_Mes_DATA_Packets_DMI_to_EVC(
    &outC->_L40,
  ...
  Write_int_to_DMI_Train_Da_DATA_Packets_DMI_to_EVC(
    &outC->_L41,
    &outC->_1_Context_Write_int_to_DMI_Train_Data_Ack_1);
  kcg_copy_DMI_Train_Data_Ack_T_DMI_Messages_DMI_to_EVC_Pkg(
    &outC->_L24,
    &outC->_1_Context_Write_int_to_DMI_Train_Data_Ack_1.dmi_train_data_ack_ct);
  ...
  Write_int_to_DMI_Adhesion_DATA_Packets_Bothways(
    &outC->_L43,
  ...
  outC_CAST_int_to_DMI_to_EVC_Messages *outC)
{
  ...
  Write_int_to_DMI_Icon_Ack_init_DATA_Packets_DMI_to_EVC(
    &outC->Context_Write_int_to_DMI_Icon_Ack_1);
  /* _L25=(DATA::Packets::Bothways::Write_int_to_DMI_Adhesion_Factor_Data#1)/ */
  Write_int_to_DMI_Adhesion_init_DATA_Packets_Bothways(
    &outC->Context_Write_int_to_DMI_Adhesion_Factor_Data_1);
  /* _L26=(DATA::Packets::Bothways::Write_int_to_DMI_Train_Data#1)/ */
  Write_int_to_DMI_Train_Data_init_DATA_Packets_Bothways(
    &outC->Context_Write_int_to_DMI_Train_Data_1);
  /* _L24=(DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Train_Data_Ack#1)/ */
  Write_int_to_DMI_Train_Da_init_DATA_Packets_DMI_to_EVC(
    &outC->_1_Context_Write_int_to_DMI_Train_Data_Ack_1);
  /* _L23=(DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Text_Message_Ack#1)/ */
  Write_int_to_DMI_Text_Mes_init_DATA_Packets_DMI_to_EVC(
    &outC->Context_Write_int_to_DMI_Text_Message_Ack_1);
  /* _L22=(DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Radio_Net_Data#1)/ */
  Write_int_to_DMI_Radio_Ne_init_DATA_Packets_DMI_to_EVC(
    &outC->Context_Write_int_to_DMI_Radio_Net_Data_1);
  /* _L21=(DATA::Packets::Bothways::Write_int_to_DMI_Train_Running_Number#1)/ */
  Write_int_to_DMI_Train_Ru_init_DATA_Packets_Bothways(
    &outC->_2_Context_Write_int_to_DMI_Train_Running_Number_1);
  /* _L20=(DATA::Packets::Bothways::Write_int_to_DMI_Driver_Identifier#1)/ */
  Write_int_to_DMI_Driver_I_init_DATA_Packets_Bothways(
    &outC->Context_Write_int_to_DMI_Driver_Identifier_1);
  /* _L19=(DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Driver_Reqest#1)/ */
  Write_int_to_DMI_Driver_R_init_DATA_Packets_DMI_to_EVC(
    &outC->_3_Context_Write_int_to_DMI_Driver_Reqest_1);
  /* _L18=(DATA::Packets::DMI_to_EVC::Write_int_to_DMI_identifier#1)/ */
  ...
  outC_CAST_int_to_DMI_to_EVC_Messages *outC)
{
  ...
  Write_int_to_DMI_Icon_Ack_reset_DATA_Packets_DMI_to_EVC(
    &outC->Context_Write_int_to_DMI_Icon_Ack_1);
  /* _L25=(DATA::Packets::Bothways::Write_int_to_DMI_Adhesion_Factor_Data#1)/ */
  Write_int_to_DMI_Adhesion_reset_DATA_Packets_Bothways(
    &outC->Context_Write_int_to_DMI_Adhesion_Factor_Data_1);
  /* _L26=(DATA::Packets::Bothways::Write_int_to_DMI_Train_Data#1)/ */
  Write_int_to_DMI_Train_Data_reset_DATA_Packets_Bothways(
    &outC->Context_Write_int_to_DMI_Train_Data_1);
  /* _L24=(DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Train_Data_Ack#1)/ */
  Write_int_to_DMI_Train_Da_reset_DATA_Packets_DMI_to_EVC(
    &outC->_1_Context_Write_int_to_DMI_Train_Data_Ack_1);
  /* _L23=(DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Text_Message_Ack#1)/ */
  Write_int_to_DMI_Text_Mes_reset_DATA_Packets_DMI_to_EVC(
    &outC->Context_Write_int_to_DMI_Text_Message_Ack_1);
  /* _L22=(DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Radio_Net_Data#1)/ */
  Write_int_to_DMI_Radio_Ne_reset_DATA_Packets_DMI_to_EVC(
    &outC->Context_Write_int_to_DMI_Radio_Net_Data_1);
  /* _L21=(DATA::Packets::Bothways::Write_int_to_DMI_Train_Running_Number#1)/ */
  Write_int_to_DMI_Train_Ru_reset_DATA_Packets_Bothways(
    &outC->_2_Context_Write_int_to_DMI_Train_Running_Number_1);
  /* _L20=(DATA::Packets::Bothways::Write_int_to_DMI_Driver_Identifier#1)/ */
  Write_int_to_DMI_Driver_I_reset_DATA_Packets_Bothways(
    &outC->Context_Write_int_to_DMI_Driver_Identifier_1);
  /* _L19=(DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Driver_Reqest#1)/ */
  Write_int_to_DMI_Driver_R_reset_DATA_Packets_DMI_to_EVC(
    &outC->_3_Context_Write_int_to_DMI_Driver_Reqest_1);
  /* _L18=(DATA::Packets::DMI_to_EVC::Write_int_to_DMI_identifier#1)/ */
