...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P139_OBU_T_TM /* P139_onboard/ */ P139_onboard;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_CAST_Int_to_D_REVERSE_TM_conversions /* _L31=(TM_conversions::CAST_Int_to_D_REVERSE#1)/ */ Context_CAST_Int_to_D_REVERSE_1;
  outC_CAST_Int_to_V_REVERSE_TM_conversions /* _L33=(TM_conversions::CAST_Int_to_V_REVERSE#1)/ */ Context_CAST_Int_to_V_REVERSE_1;
  ...
  kcg_bool /* @3/IfBlock1:else: */ _2_else_clock_CAST_Int_to_Q_SCALE_1_IfBlock1;
  /* -------------------- (-debug) no assertions  -------------------- */
  ...
  Q_SCALE /* @3/IfBlock1:else:else:then:_L1/ */ _3__L1_CAST_Int_to_Q_SCALE_1_then_else_else_IfBlock1;
  ...
  kcg_bool /* @3/IfBlock1:then:_L3/ */ _4__L3_CAST_Int_to_Q_SCALE_1_then_IfBlock1;
  NID_PACKET /* _L12/ */ _L12;
  P139_OBU_T_TM /* _L10/ */ _L10;
...
extern void C_P139_compr_onboard_init_TM_conversions(
  outC_C_P139_compr_onboard_TM_conversions *outC);
