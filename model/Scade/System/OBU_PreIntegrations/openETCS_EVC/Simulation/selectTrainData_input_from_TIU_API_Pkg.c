  ...
  outC_selectTrainData_input_from_TIU_API_Pkg *outC)
{
  ...
  for (idx = 0; idx < 5; idx++) {
    outC->_L14.nationSystems[idx] = kcg_lit_int32(0);
  }
  outC->_L14.numberTractionSystems = kcg_lit_int32(0);
  for (idx1 = 0; idx1 < 4; idx1++) {
    outC->_L14.tractionSystem[idx1].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L14.tractionSystem[idx1].nid_ctraction = kcg_lit_int32(0);
  }
  ...
  outC->_L10.trainLength = kcg_lit_int32(0);
  outC->_L10.brakePerctage = kcg_lit_int32(0);
  outC->_L10.maxTrainSpeed = kcg_lit_int32(0);
  outC->_L10.loadingGauge =
    M_LOADINGGAUGE_The_train_does_not_fit_to_any_of_the_interoperable_loading_gauge_profiles;
  outC->_L10.axleLoadCategory = M_AXLELOADCAT_A;
  outC->_L10.airtightSystem = M_AIRTIGHT_Not_fitted;
  outC->_L10.axleNumber = kcg_lit_int32(0);
  outC->_L10.numberNationalSystems = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 5; idx2++) {
    outC->_L10.nationSystems[idx2] = kcg_lit_int32(0);
  }
  outC->_L10.numberTractionSystems = kcg_lit_int32(0);
  for (idx3 = 0; idx3 < 4; idx3++) {
    outC->_L10.tractionSystem[idx3].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L10.tractionSystem[idx3].nid_ctraction = kcg_lit_int32(0);
  }
  ...
  outC->_L9.trainLength = kcg_lit_int32(0);
  outC->_L9.brakePerctage = kcg_lit_int32(0);
  outC->_L9.maxTrainSpeed = kcg_lit_int32(0);
  outC->_L9.loadingGauge =
    M_LOADINGGAUGE_The_train_does_not_fit_to_any_of_the_interoperable_loading_gauge_profiles;
  outC->_L9.axleLoadCategory = M_AXLELOADCAT_A;
  outC->_L9.airtightSystem = M_AIRTIGHT_Not_fitted;
  outC->_L9.axleNumber = kcg_lit_int32(0);
  outC->_L9.numberNationalSystems = kcg_lit_int32(0);
  for (idx4 = 0; idx4 < 5; idx4++) {
    outC->_L9.nationSystems[idx4] = kcg_lit_int32(0);
  }
  outC->_L9.numberTractionSystems = kcg_lit_int32(0);
  for (idx5 = 0; idx5 < 4; idx5++) {
    outC->_L9.tractionSystem[idx5].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->_L9.tractionSystem[idx5].nid_ctraction = kcg_lit_int32(0);
  }
  outC->_L8 = kcg_true;
  outC->_L6 = kcg_true;
  ...
  outC->outTrainData.trainLength = kcg_lit_int32(0);
  outC->outTrainData.brakePerctage = kcg_lit_int32(0);
  outC->outTrainData.maxTrainSpeed = kcg_lit_int32(0);
  ...
  outC->outTrainData.axleNumber = kcg_lit_int32(0);
  outC->outTrainData.numberNationalSystems = kcg_lit_int32(0);
  for (idx10 = 0; idx10 < 5; idx10++) {
    outC->outTrainData.nationSystems[idx10] = kcg_lit_int32(0);
  }
  outC->outTrainData.numberTractionSystems = kcg_lit_int32(0);
  for (idx11 = 0; idx11 < 4; idx11++) {
    outC->outTrainData.tractionSystem[idx11].m_voltage =
      M_VOLTAGE_Line_not_fitted_with_any_traction_system;
    outC->outTrainData.tractionSystem[idx11].nid_ctraction = kcg_lit_int32(0);
  }
}
