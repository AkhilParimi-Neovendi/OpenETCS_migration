...
*************************************************************$ */
#ifndef _MoveSSPSectionsAbsolute_L_TA_Lib_internal_H_
#define _MoveSSPSectionsAbsolute_L_TA_Lib_internal_H_
...
} outC_MoveSSPSectionsAbsolute_L_TA_Lib_internal;

/* ===========  node initialization and cycle functions  =========== */
/* TA_Lib_internal::MoveSSPSectionsAbsolute_Loop_new/ */
extern void MoveSSPSectionsAbsolute_L_TA_Lib_internal(
  /* i/ */
  kcg_int32 i,
  /* ProfileIn/ */
  ...
  outC_MoveSSPSectionsAbsolute_L_TA_Lib_internal *outC);

#ifndef KCG_NO_EXTERN_CALL_TO_RESET
extern void MoveSSPSectionsAbsolute_L_reset_TA_Lib_internal(
  outC_MoveSSPSectionsAbsolute_L_TA_Lib_internal *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void MoveSSPSectionsAbsolute_L_init_TA_Lib_internal(
  outC_MoveSSPSectionsAbsolute_L_TA_Lib_internal *outC);
#endif /* KCG_USER_DEFINED_INIT */



#endif /* _MoveSSPSectionsAbsolute_L_TA_Lib_internal_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** MoveSSPSectionsAbsolute_L_TA_Lib_internal.h
** Generation date: 2023-11-06T13:54:28
*************************************************************$ */
