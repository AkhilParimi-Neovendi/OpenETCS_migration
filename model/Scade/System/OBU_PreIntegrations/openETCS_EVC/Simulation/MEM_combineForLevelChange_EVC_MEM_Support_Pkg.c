  ...
  outC_MEM_combineForLevelChange_EVC_MEM_Support_Pkg *outC)
{
  ...
  dataCollectionForLevelTransition_T_EVC_MEM_Support_Pkg infoForLevelTransition_partial;
  /* LRBGpositionNeeded/ */
  kcg_bool LRBGpositionNeeded_partial;
  /* infoForLevelTransition/ */
  dataCollectionForLevelTransition_T_EVC_MEM_Support_Pkg _1_infoForLevelTransition_partial;
  /* LRBGpositionNeeded/ */
  kcg_bool _2_LRBGpositionNeeded_partial;
  /* LRBGpositionNeeded/ */
  kcg_bool _3_LRBGpositionNeeded_partial;
  /* infoForLevelTransition/ */
  dataCollectionForLevelTransition_T_EVC_MEM_Support_Pkg _4_infoForLevelTransition_partial;
  /* LRBGpositionNeeded/ */
  kcg_bool _5_LRBGpositionNeeded_partial;
  /* infoForLevelTransition/ */
  dataCollectionForLevelTransition_T_EVC_MEM_Support_Pkg _6_infoForLevelTransition_partial;
  kcg_bool noname;
  kcg_bool _7_noname;
  P135_OBU_T_TM _8_noname;
  P012_OBU_T_TM _9_noname;
  kcg_bool _10_noname;
  /* LRBGpositionNeeded/ */
  kcg_bool last_LRBGpositionNeeded;
  /* level/ */
  M_LEVEL last_level;
  /* infoForLevelTransition/ */
  dataCollectionForLevelTransition_T_EVC_MEM_Support_Pkg last_infoForLevelTransition;
  ...
  kcg_copy__7_P12_Level1MovementAuthorities_T_Packet_Types_Pkg(
    &outC->_L130,
