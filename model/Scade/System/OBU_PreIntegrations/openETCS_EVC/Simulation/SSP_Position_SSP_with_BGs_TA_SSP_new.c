  ...
  outC_SSP_Position_SSP_with_BGs_TA_SSP_new *outC)
{
  ...
  _227_SSP_Merge_New_P27V1__TA_SSP_new(
    &outC->_L4,
    &outC->_L5,
  ...
  SSP_Correct_StartSection_TA_SSP_new(
    &outC->_L23,
    &outC->_1_Context_SSP_Correct_StartSection_2);
  kcg_copy_StaticSpeedProfile_t_TrackAtlasTypes(
    &outC->_L30,
    &outC->_1_Context_SSP_Correct_StartSection_2.Profile_out);
  outC->_L9 = pos_LRBG;
  ...
  outC_SSP_Position_SSP_with_BGs_TA_SSP_new *outC)
{
  ...
  /* _L6=(TA_SSP_new::SSP_Merge_New_P27V1_to_Profile#1)/ */
  _227_SSP_Merge_New_P27V1__init_TA_SSP_new(
    &outC->Context_SSP_Merge_New_P27V1_to_Profile_1);
}
  ...
  outC_SSP_Position_SSP_with_BGs_TA_SSP_new *outC)
{
  ...
  SSP_Normalize_Profile_reset_TA_SSP_new(
    &outC->Context_SSP_Normalize_Profile_2);
  /* _L6=(TA_SSP_new::SSP_Merge_New_P27V1_to_Profile#1)/ */
  _227_SSP_Merge_New_P27V1__reset_TA_SSP_new(
    &outC->Context_SSP_Merge_New_P27V1_to_Profile_1);
}
