...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_FindStartOfNewSpeedProfil_TA_Lib_internal /* _L94=(TA_Lib_internal::FindStartOfNewSpeedProfileAbs_LOOP#1)/ */ Context_FindStartOfNewSpeedProfileAbs_LOOP_1[50];
