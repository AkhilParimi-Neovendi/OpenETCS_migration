...
#include "CAST_DMI_m_icon_flashing__DATA_Variables.h"

/* DATA::Variables::CAST_DMI_m_icon_flashing_freq_to_int/ */
void CAST_DMI_m_icon_flashing__DATA_Variables(
...
void CAST_DMI_m_icon_flashing__init_DATA_Variables(
  outC_CAST_DMI_m_icon_flashing__DATA_Variables *outC)
{
...
void CAST_DMI_m_icon_flashing__reset_DATA_Variables(
  outC_CAST_DMI_m_icon_flashing__DATA_Variables *outC)
{
  /* _L2=(Utilities::Real_to_Int#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_m_icon_flashing__DATA_Variables.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
