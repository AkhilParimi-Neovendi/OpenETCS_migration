...
{
  /* outTotal/ */
  kcg_int32 outTotal_partial;
  /* outTotal/ */
  kcg_int32 _1_outTotal_partial;
  /* outTotal/ */
  kcg_int32 _2_outTotal_partial;
  /* outTotal/ */
  kcg_int32 _3_outTotal_partial;
  /* outTotal/ */
  kcg_int32 _4_outTotal_partial;
  /* outTotal/ */
  kcg_int32 _5_outTotal_partial;
  /* outTotal/ */
  kcg_int32 _6_outTotal_partial;
  /* outTotal/ */
  kcg_int32 _7_outTotal_partial;
  /* outTotal/ */
  kcg_int32 _8_outTotal_partial;
  /* outTotal/ */
  kcg_int32 _9_outTotal_partial;
  /* outTotal/ */
  kcg_int32 _10_outTotal_partial;
  /* outTotal/ */
  kcg_int32 _11_outTotal_partial;
  /* outTotal/ */
  kcg_int32 _12_outTotal_partial;
  /* outTotal/ */
  kcg_int32 _13_outTotal_partial;
  /* outTotal/ */
  kcg_int32 _14_outTotal_partial;
  /* outTotal/ */
  kcg_int32 _15_outTotal_partial;
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              outC->_L14_then_else_else_else_else_else_IfBlock1 = kcg_lit_int32(6);
              _11_outTotal_partial = outC->_L14_then_else_else_else_else_else_IfBlock1;
              _5_outTotal_partial = _11_outTotal_partial;
            }
            else {
              outC->_2_else_clock_else_else_else_else_else_IfBlock1 =
                inNTotal == N_TOTAL_7_balises_in_the_group;
              ...
              if (outC->_2_else_clock_else_else_else_else_else_IfBlock1) {
                ...
                if (outC->_1_else_clock_else_else_else_else_else_else_IfBlock1) {
                  outC->_L13_then_else_else_else_else_else_else_else_IfBlock1 = kcg_lit_int32(8);
                  _9_outTotal_partial =
  ...
  outC_convNTotal_Receive_TrackSide_Msg_Pkg_BaliseSupport *outC)
{
  ...
  outC->_L14_then_else_else_else_else_else_IfBlock1 = kcg_lit_int32(0);
