...
{
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _1_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _2_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _3_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _4_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _5_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _6_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _7_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _8_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _9_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _10_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _11_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _12_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _13_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _14_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _15_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _16_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _17_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _18_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _19_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _20_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _21_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _22_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _23_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _24_FromSR_To_NewMode_partial;
  /* FromSR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _25_FromSR_To_NewMode_partial;
  ...
  if (outC->IfBlock1_clock) {
    ...
    if (outC->_7_else_clock_else_else_else_else_else_IfBlock1) {
      ...
      if (outC->_1_else_clock_else_else_else_else_else_else_IfBlock1) {
        ...
        outC->_6_else_clock_else_else_else_else_else_else_else_IfBlock1 = Condition72;
      }
    }
  }
