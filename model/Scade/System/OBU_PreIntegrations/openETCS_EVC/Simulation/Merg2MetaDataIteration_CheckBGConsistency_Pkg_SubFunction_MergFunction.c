  ...
  outC_Merg2MetaDataIteration_CheckBGConsistency_Pkg_SubFunction_MergFunction *outC)
{
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L18.packets.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    outC->_L18.packets.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L18.packets.PacketHeaders[idx2].valid = kcg_true;
    outC->_L18.packets.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L18.packets.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L18.packets.PacketData[idx3] = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 30; idx5++) {
    for (idx4 = 0; idx4 < 30; idx4++) {
      outC->_L17[idx5][idx4].nid_packet = kcg_lit_int32(0);
      outC->_L17[idx5][idx4].q_dir = Q_DIR_Reverse;
      outC->_L17[idx5][idx4].valid = kcg_true;
      outC->_L17[idx5][idx4].startAddress = kcg_lit_int32(0);
      outC->_L17[idx5][idx4].endAddress = kcg_lit_int32(0);
    }
  }
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L12[idx6].nid_packet = kcg_lit_int32(0);
    outC->_L12[idx6].q_dir = Q_DIR_Reverse;
    outC->_L12[idx6].valid = kcg_true;
    outC->_L12[idx6].startAddress = kcg_lit_int32(0);
    outC->_L12[idx6].endAddress = kcg_lit_int32(0);
  }
  for (idx7 = 0; idx7 < 30; idx7++) {
    outC->_L11[idx7].nid_packet = kcg_lit_int32(0);
    outC->_L11[idx7].q_dir = Q_DIR_Reverse;
    outC->_L11[idx7].valid = kcg_true;
    outC->_L11[idx7].startAddress = kcg_lit_int32(0);
    outC->_L11[idx7].endAddress = kcg_lit_int32(0);
  }
  for (idx8 = 0; idx8 < 30; idx8++) {
    outC->mergedMetaData[idx8].nid_packet = kcg_lit_int32(0);
    outC->mergedMetaData[idx8].q_dir = Q_DIR_Reverse;
    outC->mergedMetaData[idx8].valid = kcg_true;
    outC->mergedMetaData[idx8].startAddress = kcg_lit_int32(0);
    outC->mergedMetaData[idx8].endAddress = kcg_lit_int32(0);
  }
  for (idx = 0; idx < 30; idx++) {
    /* _L11=(CheckBGConsistency_Pkg::SubFunction::MergFunction::Merg2MetaData#1)/ */
