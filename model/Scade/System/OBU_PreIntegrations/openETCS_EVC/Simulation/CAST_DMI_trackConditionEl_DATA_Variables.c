...
void CAST_DMI_trackConditionEl_DATA_Variables(
...
void CAST_DMI_trackConditionEl_init_DATA_Variables(
  outC_CAST_DMI_trackConditionEl_DATA_Variables *outC)
{
...
void CAST_DMI_trackConditionEl_reset_DATA_Variables(
  outC_CAST_DMI_trackConditionEl_DATA_Variables *outC)
{
  /* _L4=(TM_conversions::CAST_D_TRACKCOND_to_int#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_trackConditionEl_DATA_Variables.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
