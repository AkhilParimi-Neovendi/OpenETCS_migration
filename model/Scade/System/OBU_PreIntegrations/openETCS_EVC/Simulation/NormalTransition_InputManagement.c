  ...
  outC_NormalTransition_InputManagement *outC)
{
  ...
  scaledDistance_2_distance_InputManagement(
    outC->_L12,
    outC->_L13,
    &outC->_1_Context_scaledDistance_2_distance_1);
  outC->_L19 = outC->_1_Context_scaledDistance_2_distance_1.distance;
  ...
  outC_NormalTransition_InputManagement *outC)
{
  ...
  outC->_L29.position = kcg_lit_int32(0);
  outC->_L29.transitionType =
    M_TransitionType_Conditional_Level_And_Mode_Types_Pkg;
  outC->_L29.immediateAck = kcg_true;
  outC->_L29.AckLength = kcg_lit_int32(0);
  ...
  outC->One_Iter.transition.position = kcg_lit_int32(0);
  outC->One_Iter.transition.transitionType =
    M_TransitionType_Conditional_Level_And_Mode_Types_Pkg;
  outC->One_Iter.transition.immediateAck = kcg_true;
  outC->One_Iter.transition.AckLength = kcg_lit_int32(0);
  outC->One_Iter.LRBG = kcg_lit_int32(0);
  outC->One_Iter.referenceLocation = kcg_lit_int32(0);
  /* _L18=(InputManagement::LevelTR2Level#1)/ */
