  ...
  outC_indexOfBG_onTrack_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  ...
  if (outC->_L3) {
    ...
    for (idx1 = 0; idx1 < 41; idx1++) {
      acc = outC->_L6;
      /* _L8=(CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_onTrack_itr#1)/ */
      indexOfBG_onTrack_itr_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
        /* _L8= */(kcg_int32) idx1,
        acc,
        &outC->_L11[idx1],
        &outC->_L2[idx1],
        &outC->Context_indexOfBG_onTrack_itr_1[idx1]);
      outC->_L6 = outC->Context_indexOfBG_onTrack_itr_1[idx1].indexOfBG;
      outC->_L8 = /* _L8= */(kcg_int32) (idx1 + 1);
      /* _L8= */
      if (!outC->Context_indexOfBG_onTrack_itr_1[idx1].cont) {
        break;
      }
    }
  }
  ...
  /* _L20=(CalculateTrainPosition_Pkg::BG_utilities_Pkg::positionedBGs_ids_equal#1)/ */
  positionedBGs_ids_equal_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
    &outC->_L1,
    &outC->_L12,
    &outC->Context_positionedBGs_ids_equal_1);
  outC->_L20 = outC->Context_positionedBGs_ids_equal_1.idsEqual;
...
void indexOfBG_onTrack_init_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
  outC_indexOfBG_onTrack_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx1 = 0; idx1 < 33; idx1++) {
    ...
    outC->_L12.infoFromPassing.linkedBGs[idx1].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L12.infoFromPassing.linkedBGs[idx1].d_link = kcg_lit_int32(0);
    outC->_L12.infoFromPassing.linkedBGs[idx1].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L12.infoFromPassing.linkedBGs[idx1].nid_c = kcg_lit_int32(0);
    outC->_L12.infoFromPassing.linkedBGs[idx1].nid_bg = kcg_lit_int32(0);
    outC->_L12.infoFromPassing.linkedBGs[idx1].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L12.infoFromPassing.linkedBGs[idx1].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L12.infoFromPassing.linkedBGs[idx1].q_locacc = kcg_lit_int32(0);
  }
  ...
  for (idx5 = 0; idx5 < 41; idx5++) {
    ...
    outC->_L2[idx5].nid_c = kcg_lit_int32(0);
    outC->_L2[idx5].nid_bg = kcg_lit_int32(0);
    outC->_L2[idx5].q_link = Q_LINK_Unlinked;
    outC->_L2[idx5].location.nominal = kcg_lit_int32(0);
    outC->_L2[idx5].location.d_min = kcg_lit_int32(0);
    outC->_L2[idx5].location.d_max = kcg_lit_int32(0);
    outC->_L2[idx5].seqNoOnTrack = kcg_lit_int32(0);
    outC->_L2[idx5].infoFromLinking.valid = kcg_true;
    outC->_L2[idx5].infoFromLinking.nid_bg_fromLinkingBG = kcg_lit_int32(0);
    outC->_L2[idx5].infoFromLinking.nid_c_fromLinkingBG = kcg_lit_int32(0);
    outC->_L2[idx5].infoFromLinking.expectedLocation.nominal = kcg_lit_int32(0);
    outC->_L2[idx5].infoFromLinking.expectedLocation.d_min = kcg_lit_int32(0);
    outC->_L2[idx5].infoFromLinking.expectedLocation.d_max = kcg_lit_int32(0);
    outC->_L2[idx5].infoFromLinking.d_link.nominal = kcg_lit_int32(0);
    outC->_L2[idx5].infoFromLinking.d_link.d_min = kcg_lit_int32(0);
    outC->_L2[idx5].infoFromLinking.d_link.d_max = kcg_lit_int32(0);
    outC->_L2[idx5].infoFromLinking.linkingInfo.valid = kcg_true;
    outC->_L2[idx5].infoFromLinking.linkingInfo.nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L2[idx5].infoFromLinking.linkingInfo.d_link = kcg_lit_int32(0);
    outC->_L2[idx5].infoFromLinking.linkingInfo.q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L2[idx5].infoFromLinking.linkingInfo.nid_c = kcg_lit_int32(0);
    outC->_L2[idx5].infoFromLinking.linkingInfo.nid_bg = kcg_lit_int32(0);
    outC->_L2[idx5].infoFromLinking.linkingInfo.q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L2[idx5].infoFromLinking.linkingInfo.q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L2[idx5].infoFromLinking.linkingInfo.q_locacc = kcg_lit_int32(0);
    ...
    outC->_L2[idx5].infoFromPassing.BG_Header.n_total =
      N_TOTAL_1_balise_in_the_group;
    outC->_L2[idx5].infoFromPassing.BG_Header.m_mcount = kcg_lit_int32(0);
    outC->_L2[idx5].infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
    outC->_L2[idx5].infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(0);
    ...
    outC->_L2[idx5].infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
      kcg_lit_int32(0);
    outC->_L2[idx5].infoFromPassing.BG_Header.q_nvlocacc = kcg_lit_int32(0);
    ...
    for (idx4 = 0; idx4 < 33; idx4++) {
      ...
      outC->_L2[idx5].infoFromPassing.linkedBGs[idx4].nid_LRBG = kcg_lit_int32(0);
      ...
      outC->_L2[idx5].infoFromPassing.linkedBGs[idx4].d_link = kcg_lit_int32(0);
      outC->_L2[idx5].infoFromPassing.linkedBGs[idx4].q_newcountry =
        Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
      outC->_L2[idx5].infoFromPassing.linkedBGs[idx4].nid_c = kcg_lit_int32(0);
      outC->_L2[idx5].infoFromPassing.linkedBGs[idx4].nid_bg = kcg_lit_int32(0);
      ...
      outC->_L2[idx5].infoFromPassing.linkedBGs[idx4].q_linkreaction =
        Q_LINKREACTION_Train_trip;
      outC->_L2[idx5].infoFromPassing.linkedBGs[idx4].q_locacc = kcg_lit_int32(0);
    }
  ...
  for (idx6 = 0; idx6 < 33; idx6++) {
    ...
    outC->_L1.infoFromPassing.linkedBGs[idx6].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L1.infoFromPassing.linkedBGs[idx6].d_link = kcg_lit_int32(0);
    outC->_L1.infoFromPassing.linkedBGs[idx6].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L1.infoFromPassing.linkedBGs[idx6].nid_c = kcg_lit_int32(0);
    outC->_L1.infoFromPassing.linkedBGs[idx6].nid_bg = kcg_lit_int32(0);
    outC->_L1.infoFromPassing.linkedBGs[idx6].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    outC->_L1.infoFromPassing.linkedBGs[idx6].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L1.infoFromPassing.linkedBGs[idx6].q_locacc = kcg_lit_int32(0);
  }
  ...
  for (idx = 0; idx < 41; idx++) {
    /* _L8=(CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_onTrack_itr#1)/ */
    indexOfBG_onTrack_itr_init_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
      &outC->Context_indexOfBG_onTrack_itr_1[idx]);
  }
}
