  ...
  outC_BufferMsg_write_only_TM_lib_internal *outC)
{
  ...
  kcg_copy__125_array(&outC->_L4, (_125_array *) &outC->_L1[0]);
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(&outC->_L5[0], &outC->_L6[0]);
  kcg_copy__125_array(&outC->_L5[1], &outC->_L4);
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
    &outC->Message_out,
    &outC->_L9);
  ...
  outC_BufferMsg_write_only_TM_lib_internal *outC)
{
  ...
  for (idx7 = 0; idx7 < 50; idx7++) {
    outC->_L3.OptionalPackets[idx7] = kcg_lit_int32(0);
  }
  outC->_L2 = kcg_lit_int32(0);
  for (idx9 = 0; idx9 < 5; idx9++) {
    outC->_L1[idx9].Message.valid = kcg_true;
    outC->_L1[idx9].Message.nid_message = kcg_lit_int32(0);
    outC->_L1[idx9].Message.l_message = kcg_lit_int32(0);
    outC->_L1[idx9].Message.t_train = kcg_lit_int32(0);
    outC->_L1[idx9].Message.nid_engine = kcg_lit_int32(0);
    outC->_L1[idx9].Message.field1 = kcg_lit_int32(0);
    outC->_L1[idx9].Message.field2 = kcg_lit_int32(0);
    outC->_L1[idx9].Message.field3 = kcg_lit_int32(0);
    for (idx8 = 0; idx8 < 50; idx8++) {
      outC->_L1[idx9].OptionalPackets[idx8] = kcg_lit_int32(0);
    }
  }
  ...
  for (idx10 = 0; idx10 < 50; idx10++) {
    outC->Message_out.OptionalPackets[idx10] = kcg_lit_int32(0);
  }
  outC->Stacksize_new = kcg_lit_int32(0);
  for (idx12 = 0; idx12 < 5; idx12++) {
    outC->Buffer_Out[idx12].Message.valid = kcg_true;
    outC->Buffer_Out[idx12].Message.nid_message = kcg_lit_int32(0);
    outC->Buffer_Out[idx12].Message.l_message = kcg_lit_int32(0);
    outC->Buffer_Out[idx12].Message.t_train = kcg_lit_int32(0);
    outC->Buffer_Out[idx12].Message.nid_engine = kcg_lit_int32(0);
    outC->Buffer_Out[idx12].Message.field1 = kcg_lit_int32(0);
    outC->Buffer_Out[idx12].Message.field2 = kcg_lit_int32(0);
    outC->Buffer_Out[idx12].Message.field3 = kcg_lit_int32(0);
    for (idx11 = 0; idx11 < 50; idx11++) {
      outC->Buffer_Out[idx12].OptionalPackets[idx11] = kcg_lit_int32(0);
    }
  }
}
