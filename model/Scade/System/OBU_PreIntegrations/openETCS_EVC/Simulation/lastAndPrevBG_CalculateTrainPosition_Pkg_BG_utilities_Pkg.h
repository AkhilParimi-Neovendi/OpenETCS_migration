...
typedef struct {
  ...
  outC_positionedBGs_ids_equal_CalculateTrainPosition_Pkg_BG_utilities_Pkg /* _L19=(CalculateTrainPosition_Pkg::BG_utilities_Pkg::positionedBGs_ids_equal#2)/ */ _1_Context_positionedBGs_ids_equal_2;
