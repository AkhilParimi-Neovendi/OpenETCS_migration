...
{
  /* registrationStatus/ */
  mobileRegistrationStatus_T_RCM_Types_Pkg registrationStatus_partial;
  /* Register_SM: */
  SSM_ST_Register_SM Register_SM_state_nxt_partial;
  /* Register_SM: */
  kcg_bool Register_SM_reset_nxt_partial;
  /* Register_SM: */
  SSM_TR_Register_SM Register_SM_fired_partial;
  /* registrationStatus/ */
  mobileRegistrationStatus_T_RCM_Types_Pkg _1_registrationStatus_partial;
  /* Register_SM: */
  SSM_ST_Register_SM _2_Register_SM_state_nxt_partial;
  /* Register_SM: */
  kcg_bool _3_Register_SM_reset_nxt_partial;
  /* Register_SM: */
  SSM_TR_Register_SM _4_Register_SM_fired_partial;
  /* registrationStatus/ */
  mobileRegistrationStatus_T_RCM_Types_Pkg _5_registrationStatus_partial;
  /* Register_SM: */
  SSM_ST_Register_SM _6_Register_SM_state_nxt_partial;
  /* Register_SM: */
  kcg_bool _7_Register_SM_reset_nxt_partial;
  /* Register_SM: */
  SSM_TR_Register_SM _8_Register_SM_fired_partial;
  /* registrationStatus/ */
  mobileRegistrationStatus_T_RCM_Types_Pkg _9_registrationStatus_partial;
  /* Register_SM: */
  SSM_ST_Register_SM _10_Register_SM_state_nxt_partial;
  /* Register_SM: */
  kcg_bool _11_Register_SM_reset_nxt_partial;
  /* Register_SM: */
  SSM_TR_Register_SM _12_Register_SM_fired_partial;
  /* Register_SM: */
  SSM_ST_Register_SM Register_SM_state_act_partial;
  /* Register_SM: */
  kcg_bool Register_SM_reset_act_partial;
  /* Register_SM: */
  SSM_TR_Register_SM Register_SM_fired_strong_partial;
  /* Register_SM:Unregistered:<3> */
  kcg_bool tr_3_guard_Unregistered_Register_SM;
  /* Register_SM:Unregistered:<2> */
  kcg_bool tr_2_guard_Unregistered_Register_SM;
  /* Register_SM:Unregistered:<1> */
  kcg_bool tr_1_guard_Unregistered_Register_SM;
  /* Register_SM: */
  SSM_ST_Register_SM _13_Register_SM_state_act_partial;
  /* Register_SM: */
  kcg_bool _14_Register_SM_reset_act_partial;
  /* Register_SM: */
  SSM_TR_Register_SM _15_Register_SM_fired_strong_partial;
  /* Register_SM:Registering:<2> */
  kcg_bool tr_2_guard_Registering_Register_SM;
  /* Register_SM:Registering:<1> */
  kcg_bool tr_1_guard_Registering_Register_SM;
  /* Register_SM: */
  SSM_ST_Register_SM _16_Register_SM_state_act_partial;
  /* Register_SM: */
  kcg_bool _17_Register_SM_reset_act_partial;
  /* Register_SM: */
  SSM_TR_Register_SM _18_Register_SM_fired_strong_partial;
  /* Register_SM:Registered:<3> */
  kcg_bool tr_3_guard_Registered_Register_SM;
  /* Register_SM:Registered:<2> */
  kcg_bool tr_2_guard_Registered_Register_SM;
  /* Register_SM:Registered:<1> */
  kcg_bool tr_1_guard_Registered_Register_SM;
  /* Register_SM: */
  SSM_ST_Register_SM _19_Register_SM_state_act_partial;
  /* Register_SM: */
  kcg_bool _20_Register_SM_reset_act_partial;
  /* Register_SM: */
  SSM_TR_Register_SM _21_Register_SM_fired_strong_partial;
  /* Register_SM:Reregistering:<1> */
  kcg_bool tr_1_guard_Reregistering_Register_SM;
  /* resetDelayedOrderFlag/ */
  kcg_bool last_resetDelayedOrderFlag;
  /* Register_SM: */
  kcg_bool Register_SM_reset_sel;
  /* Register_SM: */
  kcg_bool Register_SM_reset_prv;
