...
typedef struct {
  ...
  P138_OBU_T_TM /* P138_OBU_out/ */ P138_OBU_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P138_compr_onboard_TM_conversions /* _L166=(TM_conversions::C_P138_compr_onboard#1)/ */ Context_C_P138_compr_onboard_1;
...
extern void Read_P138_reset_TM(outC_Read_P138_TM *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void Read_P138_init_TM(outC_Read_P138_TM *outC);
