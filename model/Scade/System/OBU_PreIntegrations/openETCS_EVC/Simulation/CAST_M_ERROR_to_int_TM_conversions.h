...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  kcg_int32 /* m_error_int/ */ m_error_int;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  kcg_int32 /* IfBlock1:else:else:else:else:else:else:else:else:then:_L1/ */ _L14_then_else_else_else_else_else_else_else_else_IfBlock1;
  ...
  kcg_int32 /* IfBlock1:else:else:else:else:else:else:else:else:else:_L1/ */ _L1_else_else_else_else_else_else_else_else_else_IfBlock1;
  ...
  kcg_int32 /* IfBlock1:else:else:else:else:else:else:else:then:_L1/ */ _L17_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L1/ */ _L18_then_else_else_else_else_else_IfBlock1;
  kcg_int32 /* IfBlock1:else:else:else:else:else:then:_L2/ */ _L29_then_else_else_else_else_else_IfBlock1;
...
extern void CAST_M_ERROR_to_int_init_TM_conversions(
  outC_CAST_M_ERROR_to_int_TM_conversions *outC);
