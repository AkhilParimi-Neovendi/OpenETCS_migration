  ...
  outC_ExitLevel2or3_OutputToRBC *outC)
{
  ...
  kcg_bool PositionReportNeeded_partial;
  /* Loc_Position/ */
  M_POSITION Loc_Position_partial;
  /* SM1: */
  _215_SSM_ST_SM1 SM1_state_nxt_partial;
  /* SM1: */
  kcg_bool SM1_reset_nxt_partial;
  /* SM1: */
  _216_SSM_TR_SM1 SM1_fired_partial;
  /* SM1:BeforeChange:<1> */
  kcg_bool tr_1_guard_BeforeChange_SM1;
  /* PositionReportNeeded/ */
  kcg_bool _1_PositionReportNeeded_partial;
  /* Loc_Position/ */
  M_POSITION _2_Loc_Position_partial;
  /* SM1: */
  _215_SSM_ST_SM1 _3_SM1_state_nxt_partial;
  /* SM1: */
  kcg_bool _4_SM1_reset_nxt_partial;
  /* SM1: */
  _216_SSM_TR_SM1 _5_SM1_fired_partial;
  /* SM1:State2:<1> */
  kcg_bool tr_1_guard_State2_SM1;
  /* PositionReportNeeded/ */
  kcg_bool _6_PositionReportNeeded_partial;
  /* PositionReportNeeded/ */
  kcg_bool _7_PositionReportNeeded_partial;
  /* Loc_Position/ */
  M_POSITION last_Loc_Position;
  /* SM1: */
  ...
  switch (outC->SM1_state_act) {
    case _257_SSM_st_State2_SM1 :
      ...
      if (tr_1_guard_State2_SM1) {
        ...
        _5_SM1_fired_partial = _256_SSM_TR_no_trans_SM1;
      }
      ...
      if (tr_1_guard_State2_SM1) {
        ...
        _3_SM1_state_nxt_partial = _257_SSM_st_State2_SM1;
      }
      break;
  ...
  switch (outC->SM1_state_act) {
    ...
    case SSM_st_BeforeChange_SM1 :
      ...
      if (tr_1_guard_BeforeChange_SM1) {
        ...
        SM1_fired_partial = _256_SSM_TR_no_trans_SM1;
      }
      SM1_reset_nxt_partial = tr_1_guard_BeforeChange_SM1;
      if (tr_1_guard_BeforeChange_SM1) {
        SM1_state_nxt_partial = _257_SSM_st_State2_SM1;
      }
      else {
  ...
  outC->SM1_fired_strong = _256_SSM_TR_no_trans_SM1;
...
void ExitLevel2or3_init_OutputToRBC(outC_ExitLevel2or3_OutputToRBC *outC)
{
  ...
  outC->SM1_fired = _256_SSM_TR_no_trans_SM1;
  outC->SM1_fired_strong = _256_SSM_TR_no_trans_SM1;
