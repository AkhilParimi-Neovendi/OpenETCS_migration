...
#include "Write_int_to_DMI_Adhesion_DATA_Packets_Bothways.h"
#include "Write_int_to_DMI_Train_Da_DATA_Packets_DMI_to_EVC.h"
#include "Write_int_to_DMI_Text_Mes_DATA_Packets_DMI_to_EVC.h"
#include "Write_int_to_DMI_Radio_Ne_DATA_Packets_DMI_to_EVC.h"
#include "Write_int_to_DMI_Train_Ru_DATA_Packets_Bothways.h"
#include "Write_int_to_DMI_Driver_I_DATA_Packets_Bothways.h"
...
typedef struct {
  ...
  outC_Write_int_to_DMI_Adhesion_DATA_Packets_Bothways /* _L25=(DATA::Packets::Bothways::Write_int_to_DMI_Adhesion_Factor_Data#1)/ */ Context_Write_int_to_DMI_Adhesion_Factor_Data_1;
  ...
  outC_Write_int_to_DMI_Train_Da_DATA_Packets_DMI_to_EVC /* _L24=(DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Train_Data_Ack#1)/ */ _1_Context_Write_int_to_DMI_Train_Data_Ack_1;
  outC_Write_int_to_DMI_Text_Mes_DATA_Packets_DMI_to_EVC /* _L23=(DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Text_Message_Ack#1)/ */ Context_Write_int_to_DMI_Text_Message_Ack_1;
  outC_Write_int_to_DMI_Radio_Ne_DATA_Packets_DMI_to_EVC /* _L22=(DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Radio_Net_Data#1)/ */ Context_Write_int_to_DMI_Radio_Net_Data_1;
  outC_Write_int_to_DMI_Train_Ru_DATA_Packets_Bothways /* _L21=(DATA::Packets::Bothways::Write_int_to_DMI_Train_Running_Number#1)/ */ _2_Context_Write_int_to_DMI_Train_Running_Number_1;
  outC_Write_int_to_DMI_Driver_I_DATA_Packets_Bothways /* _L20=(DATA::Packets::Bothways::Write_int_to_DMI_Driver_Identifier#1)/ */ Context_Write_int_to_DMI_Driver_Identifier_1;
  outC_Write_int_to_DMI_Driver_R_DATA_Packets_DMI_to_EVC /* _L19=(DATA::Packets::DMI_to_EVC::Write_int_to_DMI_Driver_Reqest#1)/ */ _3_Context_Write_int_to_DMI_Driver_Reqest_1;
  ...
  _5_DMI_Driver_Identifier_T_DMI_Messages_Bothways_Pkg /* _L20/ */ _L20;
  ...
  DMI_Driver_Identifier_int_array_T_DATA /* _L37/ */ _L37;
