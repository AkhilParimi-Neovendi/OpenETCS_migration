  ...
  outC_CheckAllowedPacketsRadio_CheckEuroradioMessage *outC)
{
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    ...
    CheckIfSinglePacketIsAllo_CheckEuroradioMessage_SubFunctions(
      acc,
      &outC->_L7[idx2],
      outC->_L12[idx2],
      &outC->_L13[idx2],
  ...
  outC_CheckAllowedPacketsRadio_CheckEuroradioMessage *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    /* _L14=(CheckEuroradioMessage::SubFunctions::CheckIfSinglePacketIsAllowedForRadioMessage#1)/ */
    CheckIfSinglePacketIsAllo_init_CheckEuroradioMessage_SubFunctions(
  ...
  outC_CheckAllowedPacketsRadio_CheckEuroradioMessage *outC)
{
  ...
  for (idx = 0; idx < 30; idx++) {
    /* _L14=(CheckEuroradioMessage::SubFunctions::CheckIfSinglePacketIsAllowedForRadioMessage#1)/ */
    CheckIfSinglePacketIsAllo_reset_CheckEuroradioMessage_SubFunctions(
      &outC->Context_CheckIfSinglePacketIsAllowedForRadioMessage_1[idx]);
  }
}
