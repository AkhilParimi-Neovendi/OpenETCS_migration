...
{
  /* bool_out/ */
  kcg_bool bool_out_partial;
  /* err/ */
  kcg_bool err_partial;
  /* bool_out/ */
  kcg_bool _1_bool_out_partial;
  /* err/ */
  kcg_bool _2_err_partial;
  /* err/ */
  kcg_bool _3_err_partial;
  /* bool_out/ */
  kcg_bool _4_bool_out_partial;
  /* err/ */
  kcg_bool _5_err_partial;
  /* bool_out/ */
  kcg_bool _6_bool_out_partial;
  kcg_bool noname;
