  ...
  outC_C_P015_us_array_TM_lib_internal *outC)
{
  ...
  /* _L21=(TM_lib_internal::C_P015_extract_el_section#4)/ */
  C_P015_extract_el_section_TM_lib_internal(
    outC->_L16,
    &outC->_L1,
    kcg_lit_int32(3),
    &outC->_3_Context_C_P015_extract_el_section_4);
  outC->_L21 = outC->_3_Context_C_P015_extract_el_section_4.element;
  ...
  outC->_L32 = kcg_true;
  /* _L19=(TM_lib_internal::C_P015_extract_el_section#2)/ */
  C_P015_extract_el_section_TM_lib_internal(
    outC->_L16,
    &outC->_L1,
    kcg_lit_int32(1),
    &outC->_2_Context_C_P015_extract_el_section_2);
  outC->_L19 = outC->_2_Context_C_P015_extract_el_section_2.element;
  ...
  /* _L20=(TM_lib_internal::C_P015_extract_el_section#3)/ */
  C_P015_extract_el_section_TM_lib_internal(
    outC->_L16,
    &outC->_L1,
    kcg_lit_int32(2),
    &outC->_1_Context_C_P015_extract_el_section_3);
  outC->_L20 = outC->_1_Context_C_P015_extract_el_section_3.element;
  ...
  /* _L15=(TM_lib_internal::C_P015_extract_el_section#1)/ */
  C_P015_extract_el_section_TM_lib_internal(
    outC->_L16,
    &outC->_L1,
    kcg_lit_int32(0),
...
void C_P015_us_array_init_TM_lib_internal(
  outC_C_P015_us_array_TM_lib_internal *outC)
{
  kcg_size idx;
  ...
  CAST_Int_to_L_SECTION_init_TM_conversions(
    &outC->Context_CAST_Int_to_L_SECTION_1);
  /* _L15=(TM_lib_internal::C_P015_extract_el_section#1)/ */
  C_P015_extract_el_section_init_TM_lib_internal(
    &outC->Context_C_P015_extract_el_section_1);
  /* _L26=(TM_conversions::CAST_Int_to_T_SECTIONTIMER#1)/ */
  ...
  outC_C_P015_us_array_TM_lib_internal *outC)
{
  ...
  CAST_Int_to_L_SECTION_reset_TM_conversions(
    &outC->Context_CAST_Int_to_L_SECTION_1);
  /* _L15=(TM_lib_internal::C_P015_extract_el_section#1)/ */
  C_P015_extract_el_section_reset_TM_lib_internal(
    &outC->Context_C_P015_extract_el_section_1);
  /* _L26=(TM_conversions::CAST_Int_to_T_SECTIONTIMER#1)/ */
