...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_CAST_int_to_DMI_DMI_ident_DATA_Variables /* _L10=(DATA::Variables::CAST_int_to_DMI_DMI_identifier#1)/ */ Context_CAST_int_to_DMI_DMI_identifier_1;
  outC_CAST_int_to_DMI_Cabin_ide_DATA_Variables /* _L11=(DATA::Variables::CAST_int_to_DMI_Cabin_identifier#1)/ */ Context_CAST_int_to_DMI_Cabin_identifier_1;
