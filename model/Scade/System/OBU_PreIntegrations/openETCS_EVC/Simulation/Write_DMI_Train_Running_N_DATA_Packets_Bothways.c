...
void Write_DMI_Train_Running_N_DATA_Packets_Bothways(
...
{
  _14_DMI_Train_Running_Number_int_array_T_DATA op_call;
  ...
  if (outC->every) {
    ...
    C_DMI_Train_Running_Numbe_DATA_Packets_Bothways(
      &outC->_L13,
  ...
  if (outC->every) {
    kcg_copy__14_DMI_Train_Running_Number_int_array_T_DATA(&outC->_L18, &op_call);
  }
  else {
    kcg_copy__14_DMI_Train_Running_Number_int_array_T_DATA(
      &outC->_L18,
...
void Write_DMI_Train_Running_N_init_DATA_Packets_Bothways(
  outC_Write_DMI_Train_Running_N_DATA_Packets_Bothways *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L18=(DATA::Packets::Bothways::C_DMI_Train_Running_Number_to_int#1)/ */
  C_DMI_Train_Running_Numbe_init_DATA_Packets_Bothways(
    &outC->Context_C_DMI_Train_Running_Number_to_int_1);
}
...
void Write_DMI_Train_Running_N_reset_DATA_Packets_Bothways(
  outC_Write_DMI_Train_Running_N_DATA_Packets_Bothways *outC)
{
  /* _L18=(DATA::Packets::Bothways::C_DMI_Train_Running_Number_to_int#1)/ */
  C_DMI_Train_Running_Numbe_reset_DATA_Packets_Bothways(
    &outC->Context_C_DMI_Train_Running_Number_to_int_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Write_DMI_Train_Running_N_DATA_Packets_Bothways.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
