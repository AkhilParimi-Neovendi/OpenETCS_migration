...
*************************************************************$ */
#ifndef _CheckIfSinglePacketIsAllo_CheckEuroradioMessage_SubFunctions_H_
#define _CheckIfSinglePacketIsAllo_CheckEuroradioMessage_SubFunctions_H_
...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_T_extract_nid_packet_from_TM /* _L20=(TM::T_extract_nid_packet_from_metadata_selector#1)/ */ Context_T_extract_nid_packet_from_metadata_selector_1;
  ...
  kcg_bool /* _L19/ */ _L19;
  kcg_int32 /* _L20/ */ _L20;
} outC_CheckIfSinglePacketIsAllo_CheckEuroradioMessage_SubFunctions;

/* ===========  node initialization and cycle functions  =========== */
/* CheckEuroradioMessage::SubFunctions::CheckIfSinglePacketIsAllowedForRadioMessage/ */
extern void CheckIfSinglePacketIsAllo_CheckEuroradioMessage_SubFunctions(
  /* accumulator/ */
...
extern void CheckIfSinglePacketIsAllo_reset_CheckEuroradioMessage_SubFunctions(
  outC_CheckIfSinglePacketIsAllo_CheckEuroradioMessage_SubFunctions *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CheckIfSinglePacketIsAllo_init_CheckEuroradioMessage_SubFunctions(
  outC_CheckIfSinglePacketIsAllo_CheckEuroradioMessage_SubFunctions *outC);
#endif /* KCG_USER_DEFINED_INIT */



#endif /* _CheckIfSinglePacketIsAllo_CheckEuroradioMessage_SubFunctions_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CheckIfSinglePacketIsAllo_CheckEuroradioMessage_SubFunctions.h
** Generation date: 2023-11-06T13:54:28
*************************************************************$ */
