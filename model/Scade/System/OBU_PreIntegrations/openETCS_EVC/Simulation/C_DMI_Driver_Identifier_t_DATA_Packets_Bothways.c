...
void C_DMI_Driver_Identifier_t_DATA_Packets_Bothways(
...
void C_DMI_Driver_Identifier_t_init_DATA_Packets_Bothways(
  outC_C_DMI_Driver_Identifier_t_DATA_Packets_Bothways *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void C_DMI_Driver_Identifier_t_reset_DATA_Packets_Bothways(
  outC_C_DMI_Driver_Identifier_t_DATA_Packets_Bothways *outC)
{
  /* _L15=(DATA::Variables::CAST_DriverIdentfier_to_int#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** C_DMI_Driver_Identifier_t_DATA_Packets_Bothways.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
