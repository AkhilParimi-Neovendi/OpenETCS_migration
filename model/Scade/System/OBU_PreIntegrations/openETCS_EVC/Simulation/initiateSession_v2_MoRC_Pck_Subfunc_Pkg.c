...
void initiateSession_v2_MoRC_Pck_Subfunc_Pkg(
  ...
  m38_initiationOfACommunicationSession_T_RCM_MsgTypes_Pkg *_1_m38_initiationOfACommunicationSessionMsg,
  /* registrationStatus/ */
  ...
  outC_initiateSession_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  ...
  NID_C nid_c_partial;
  /* nid_rbc/ */
  NID_RBC nid_rbc_partial;
  /* nid_radio/ */
  NID_RADIO nid_radio_partial;
  /* origin/ */
  RBC_Id_T_Common_Types_Pkg origin_partial;
  /* rbc_valid/ */
  kcg_bool rbc_valid_partial;
  /* nid_c/ */
  NID_C _2_nid_c_partial;
  /* nid_rbc/ */
  NID_RBC _3_nid_rbc_partial;
  /* nid_radio/ */
  NID_RADIO _4_nid_radio_partial;
  /* origin/ */
  RBC_Id_T_Common_Types_Pkg _5_origin_partial;
  /* rbc_valid/ */
  kcg_bool _6_rbc_valid_partial;
  /* nid_c/ */
  NID_C _7_nid_c_partial;
  /* nid_rbc/ */
  NID_RBC _8_nid_rbc_partial;
  /* nid_radio/ */
  NID_RADIO _9_nid_radio_partial;
  /* origin/ */
  RBC_Id_T_Common_Types_Pkg _10_origin_partial;
  /* rbc_valid/ */
  kcg_bool _11_rbc_valid_partial;
  kcg_int32 noname;
  /* nid_c/ */
  NID_C _12_nid_c_partial;
  /* nid_rbc/ */
  NID_RBC _13_nid_rbc_partial;
  /* nid_radio/ */
  NID_RADIO _14_nid_radio_partial;
  /* origin/ */
  RBC_Id_T_Common_Types_Pkg _15_origin_partial;
  /* rbc_valid/ */
  kcg_bool _16_rbc_valid_partial;
  /* rbc_valid/ */
  kcg_bool _17_rbc_valid_partial;
  /* origin/ */
  RBC_Id_T_Common_Types_Pkg _18_origin_partial;
  /* nid_radio/ */
  NID_RADIO _19_nid_radio_partial;
  /* nid_rbc/ */
  NID_RBC _20_nid_rbc_partial;
  /* nid_c/ */
  NID_C _21_nid_c_partial;
  sessionPhase_T_RCM_Session_Types_Pkg _22_noname;
  /* rbc_valid/ */
  kcg_bool _23_rbc_valid_partial;
  /* origin/ */
  RBC_Id_T_Common_Types_Pkg _24_origin_partial;
  /* nid_radio/ */
  NID_RADIO _25_nid_radio_partial;
  /* nid_rbc/ */
  NID_RBC _26_nid_rbc_partial;
  /* nid_c/ */
  NID_C _27_nid_c_partial;
  kcg_bool _28_noname;
  ...
  kcg_copy_m38_initiationOfACommunicationSession_T_RCM_MsgTypes_Pkg(
    &outC->_L97,
    _1_m38_initiationOfACommunicationSessionMsg);
  ...
  if (outC->IfBlock1_clock) {
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      _23_rbc_valid_partial = outC->_L3_then_else_IfBlock1;
      _6_rbc_valid_partial = _23_rbc_valid_partial;
    }
    else {
      outC->else_clock_else_IfBlock1 = outC->initiateSessionFromRBC &
        (*_1_m38_initiationOfACommunicationSessionMsg).valid;
      /* IfBlock1:else:else: */
      if (outC->else_clock_else_IfBlock1) {
        ...
        _11_rbc_valid_partial = outC->_L9_then_else_else_IfBlock1;
        _17_rbc_valid_partial = _11_rbc_valid_partial;
      }
      else {
        outC->_L1_else_else_else_IfBlock1 = kcg_false;
        _16_rbc_valid_partial = outC->_L1_else_else_else_IfBlock1;
        _17_rbc_valid_partial = _16_rbc_valid_partial;
      }
      _6_rbc_valid_partial = _17_rbc_valid_partial;
    }
    outC->rbc_valid = _6_rbc_valid_partial;
  }
  ...
  if (outC->IfBlock1_clock) {
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      kcg_copy_RBC_Id_T_Common_Types_Pkg(
        &_24_origin_partial,
        &outC->_L13_then_else_IfBlock1);
      kcg_copy_RBC_Id_T_Common_Types_Pkg(&_5_origin_partial, &_24_origin_partial);
    }
    else {
      /* IfBlock1:else:else: */
      if (outC->else_clock_else_IfBlock1) {
        kcg_copy_RBC_Id_T_Common_Types_Pkg(
          &_10_origin_partial,
          &outC->_L8_then_else_else_IfBlock1);
        kcg_copy_RBC_Id_T_Common_Types_Pkg(&_18_origin_partial, &_10_origin_partial);
      }
      else {
        kcg_copy_RBC_Id_T_Common_Types_Pkg(
        ...
        kcg_copy_RBC_Id_T_Common_Types_Pkg(
          &_15_origin_partial,
          &outC->_L6_else_else_else_IfBlock1);
        kcg_copy_RBC_Id_T_Common_Types_Pkg(&_18_origin_partial, &_15_origin_partial);
      }
      kcg_copy_RBC_Id_T_Common_Types_Pkg(&_5_origin_partial, &_18_origin_partial);
    }
    kcg_copy_RBC_Id_T_Common_Types_Pkg(&outC->origin, &_5_origin_partial);
  }
  ...
  if (outC->IfBlock1_clock) {
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      _26_nid_rbc_partial = outC->_L6_then_else_IfBlock1;
      _3_nid_rbc_partial = _26_nid_rbc_partial;
    }
    else {
      /* IfBlock1:else:else: */
      if (outC->else_clock_else_IfBlock1) {
        outC->_L11_then_else_else_IfBlock1 = outC->_L8_then_else_else_IfBlock1.rbc_id;
        _8_nid_rbc_partial = outC->_L11_then_else_else_IfBlock1;
        _20_nid_rbc_partial = _8_nid_rbc_partial;
      }
      else {
        outC->_L7_else_else_else_IfBlock1 = kcg_lit_int32(0);
        _13_nid_rbc_partial = outC->_L7_else_else_else_IfBlock1;
        _20_nid_rbc_partial = _13_nid_rbc_partial;
      }
      _3_nid_rbc_partial = _20_nid_rbc_partial;
    }
    outC->nid_rbc = _3_nid_rbc_partial;
  }
  ...
  if (outC->IfBlock1_clock) {
    ...
    outC->_L11_then_IfBlock1 =
      _93_cNID_RADIO_useTheShortNumberStoredOnboard_RCM_MsgTypes_Pkg;
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      _25_nid_radio_partial = outC->_L7_then_else_IfBlock1;
      _4_nid_radio_partial = _25_nid_radio_partial;
    }
    else {
      /* IfBlock1:else:else: */
      if (outC->else_clock_else_IfBlock1) {
        ...
        _9_nid_radio_partial = outC->_L14_then_else_else_IfBlock1;
        _19_nid_radio_partial = _9_nid_radio_partial;
      }
      else {
        outC->_L8_else_else_else_IfBlock1 = kcg_lit_int64(0);
        _14_nid_radio_partial = outC->_L8_else_else_else_IfBlock1;
        _19_nid_radio_partial = _14_nid_radio_partial;
      }
      _4_nid_radio_partial = _19_nid_radio_partial;
    }
    outC->nid_radio = _4_nid_radio_partial;
  }
  ...
  if (outC->IfBlock1_clock) {
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      _27_nid_c_partial = outC->_L5_then_else_IfBlock1;
      _2_nid_c_partial = _27_nid_c_partial;
    }
    else {
      /* IfBlock1:else:else: */
      if (outC->else_clock_else_IfBlock1) {
        outC->_L10_then_else_else_IfBlock1 = outC->_L8_then_else_else_IfBlock1.nid_c;
        _7_nid_c_partial = outC->_L10_then_else_else_IfBlock1;
        _21_nid_c_partial = _7_nid_c_partial;
      }
      else {
        _12_nid_c_partial = outC->_L7_else_else_else_IfBlock1;
        _21_nid_c_partial = _12_nid_c_partial;
      }
      _2_nid_c_partial = _21_nid_c_partial;
    }
    outC->nid_c = _2_nid_c_partial;
  }
  ...
  if (outC->IfBlock1_clock) {
    ...
    _22_noname = outC->_L4_then_else_IfBlock1;
  }
