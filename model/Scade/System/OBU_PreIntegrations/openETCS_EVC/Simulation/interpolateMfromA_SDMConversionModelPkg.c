...
{
  /* m/ */
  A_internal_Type_Obu_BasicTypes_Pkg m_partial;
  /* m/ */
  A_internal_Type_Obu_BasicTypes_Pkg _1_m_partial;
  /* m/ */
  A_internal_Type_Obu_BasicTypes_Pkg _2_m_partial;
  /* m/ */
  A_internal_Type_Obu_BasicTypes_Pkg _3_m_partial;
