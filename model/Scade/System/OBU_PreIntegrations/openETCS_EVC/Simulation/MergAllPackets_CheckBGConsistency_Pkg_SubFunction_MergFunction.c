  ...
  outC_MergAllPackets_CheckBGConsistency_Pkg_SubFunction_MergFunction *outC)
{
  kcg_size idx;
  /* telegram_out/ */
  Telegram_T_BG_Types_Pkg telegram_out_partial;
  /* telegram_out/ */
  Telegram_T_BG_Types_Pkg _1_telegram_out_partial;
  /* telegram_out/ */
  Telegram_T_BG_Types_Pkg _2_telegram_out_partial;
  kcg_int32 noname;
  /* telegram_out/ */
  Telegram_T_BG_Types_Pkg _3_telegram_out_partial;
  /* telegram_out/ */
  Telegram_T_BG_Types_Pkg _4_telegram_out_partial;
  /* telegram_out/ */
  Telegram_T_BG_Types_Pkg _5_telegram_out_partial;
  ...
  outC->_L41 = _94_M_DUP_This_balise_is_a_duplicate_of_the_next_balise;
  ...
  outC->IfBlock1_clock = (outC->diff == kcg_lit_int32(-1)) & outC->nominal &
    outC->go_on;
  outC->_L46 = _94_M_DUP_This_balise_is_a_duplicate_of_the_next_balise;
