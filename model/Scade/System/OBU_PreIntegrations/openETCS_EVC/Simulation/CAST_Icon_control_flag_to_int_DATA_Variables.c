...
{
  /* Output1/ */
  Icon_control_flag_INT_T_DATA Output1_partial;
  /* error/ */
  kcg_bool error_partial;
  /* Output1/ */
  Icon_control_flag_INT_T_DATA _1_Output1_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* Output1/ */
  Icon_control_flag_INT_T_DATA _3_Output1_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* Output1/ */
  Icon_control_flag_INT_T_DATA _5_Output1_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* error/ */
  kcg_bool _7_error_partial;
  /* Output1/ */
  Icon_control_flag_INT_T_DATA _8_Output1_partial;
  /* error/ */
  kcg_bool _9_error_partial;
  /* Output1/ */
  Icon_control_flag_INT_T_DATA _10_Output1_partial;
  /* error/ */
  kcg_bool _11_error_partial;
  /* Output1/ */
  Icon_control_flag_INT_T_DATA _12_Output1_partial;
  /* error/ */
  kcg_bool _13_error_partial;
  /* Output1/ */
  Icon_control_flag_INT_T_DATA _14_Output1_partial;
  kcg_bool noname;
  ...
  if (outC->IfBlock1_clock) {
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      outC->else_clock_else_IfBlock1 = Input1 ==
        _66_ENUM_Icon_control_flag_T_show_icon_flashing_in_area;
      /* IfBlock1:else:else: */
      if (outC->else_clock_else_IfBlock1) {
        ...
        outC->else_clock_else_else_IfBlock1 = Input1 ==
          _67_ENUM_Icon_control_flag_T_show_icon_with_yellow_flashing_frame_in_area;
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      if (outC->else_clock_else_IfBlock1) {
        outC->_L1_then_else_else_IfBlock1 =
          _69_INT_Icon_control_flag_T_show_icon_flashing_in_area;
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          outC->_L1_then_else_else_else_IfBlock1 =
            _68_INT_Icon_control_flag_T_show_icon_with_yellow_flashing_frame_in_area;
