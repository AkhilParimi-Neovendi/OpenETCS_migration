...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P027V1_compr_onboard_se_TM_conversions_baseline2 /* _L177=(TM_conversions_baseline2::C_P027V1_compr_onboard_sections_level2#1)/ */ Context_C_P027V1_compr_onboard_sections_level2_1;
