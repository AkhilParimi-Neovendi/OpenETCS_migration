...
void Write_int_to_DMI_Adhesion_DATA_Packets_Bothways(
...
{
  DMI_Adhesion_Factor_Data_T_DMI_Messages_Bothways_Pkg op_call;
  ...
  if (outC->every) {
    ...
    C_int_to_DMI_Adhesion_Fac_DATA_Packets_Bothways(
      &outC->_L8,
...
void Write_int_to_DMI_Adhesion_init_DATA_Packets_Bothways(
  outC_Write_int_to_DMI_Adhesion_DATA_Packets_Bothways *outC)
{
  kcg_size idx;
  ...
  /* _L11=(DATA::Packets::Bothways::C_int_to_DMI_Adhesion_Factor_Data#1)/ */
  C_int_to_DMI_Adhesion_Fac_init_DATA_Packets_Bothways(
    &outC->Context_C_int_to_DMI_Adhesion_Factor_Data_1);
}
...
void Write_int_to_DMI_Adhesion_reset_DATA_Packets_Bothways(
  outC_Write_int_to_DMI_Adhesion_DATA_Packets_Bothways *outC)
{
  /* _L11=(DATA::Packets::Bothways::C_int_to_DMI_Adhesion_Factor_Data#1)/ */
  C_int_to_DMI_Adhesion_Fac_reset_DATA_Packets_Bothways(
    &outC->Context_C_int_to_DMI_Adhesion_Factor_Data_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Write_int_to_DMI_Adhesion_DATA_Packets_Bothways.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
