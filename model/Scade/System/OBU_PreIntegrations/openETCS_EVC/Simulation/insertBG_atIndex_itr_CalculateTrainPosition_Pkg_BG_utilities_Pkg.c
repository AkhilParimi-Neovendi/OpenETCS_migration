  ...
  outC_insertBG_atIndex_itr_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  ...
  outC->_L3_then_else_IfBlock1.nid_c = kcg_lit_int32(0);
  outC->_L3_then_else_IfBlock1.nid_bg = kcg_lit_int32(0);
  outC->_L3_then_else_IfBlock1.q_link = Q_LINK_Unlinked;
  outC->_L3_then_else_IfBlock1.location.nominal = kcg_lit_int32(0);
  outC->_L3_then_else_IfBlock1.location.d_min = kcg_lit_int32(0);
  outC->_L3_then_else_IfBlock1.location.d_max = kcg_lit_int32(0);
  outC->_L3_then_else_IfBlock1.seqNoOnTrack = kcg_lit_int32(0);
  ...
  outC->_L3_then_else_IfBlock1.infoFromLinking.expectedLocation.d_max =
    kcg_lit_int32(0);
  outC->_L3_then_else_IfBlock1.infoFromLinking.d_link.nominal = kcg_lit_int32(0);
  outC->_L3_then_else_IfBlock1.infoFromLinking.d_link.d_min = kcg_lit_int32(0);
  outC->_L3_then_else_IfBlock1.infoFromLinking.d_link.d_max = kcg_lit_int32(0);
  ...
  outC->_L3_then_else_IfBlock1.infoFromPassing.BG_Header.m_mcount =
    kcg_lit_int32(0);
  outC->_L3_then_else_IfBlock1.infoFromPassing.BG_Header.nid_c = kcg_lit_int32(0);
  outC->_L3_then_else_IfBlock1.infoFromPassing.BG_Header.nid_bg = kcg_lit_int32(
      0);
