...
{
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus op_call;
  kcg_bool noname;
  /* triggerMA/ */
  kcg_bool last_triggerMA;
  ...
  outC_Manage_MA_Request_TA_MA_Request *outC)
{
  ...
  for (idx1 = 0; idx1 < 5; idx1++) {
    ...
    outC->_L33[idx1].Message.nid_message = kcg_lit_int32(0);
    outC->_L33[idx1].Message.l_message = kcg_lit_int32(0);
    outC->_L33[idx1].Message.t_train = kcg_lit_int32(0);
    outC->_L33[idx1].Message.nid_engine = kcg_lit_int32(0);
    outC->_L33[idx1].Message.field1 = kcg_lit_int32(0);
    outC->_L33[idx1].Message.field2 = kcg_lit_int32(0);
    outC->_L33[idx1].Message.field3 = kcg_lit_int32(0);
    for (idx = 0; idx < 50; idx++) {
      outC->_L33[idx1].OptionalPackets[idx] = kcg_lit_int32(0);
    }
  }
  for (idx3 = 0; idx3 < 5; idx3++) {
    outC->_L32[idx3].Message.valid = kcg_true;
    outC->_L32[idx3].Message.nid_message = kcg_lit_int32(0);
    outC->_L32[idx3].Message.l_message = kcg_lit_int32(0);
    outC->_L32[idx3].Message.t_train = kcg_lit_int32(0);
    outC->_L32[idx3].Message.nid_engine = kcg_lit_int32(0);
    outC->_L32[idx3].Message.field1 = kcg_lit_int32(0);
    outC->_L32[idx3].Message.field2 = kcg_lit_int32(0);
    outC->_L32[idx3].Message.field3 = kcg_lit_int32(0);
    for (idx2 = 0; idx2 < 50; idx2++) {
      outC->_L32[idx3].OptionalPackets[idx2] = kcg_lit_int32(0);
    }
  }
  outC->_L31 = kcg_true;
  outC->_L30 = kcg_lit_int32(0);
  outC->_L29.valid = kcg_true;
  outC->_L29.packet1.NID_PACKET = kcg_lit_int32(0);
  outC->_L29.packet1.L_PACKET = kcg_lit_int32(0);
  outC->_L29.packet1.qscale = Q_SCALE_10_cm_scale;
  outC->_L29.packet1.NID_LRBG = kcg_lit_int32(0);
  outC->_L29.packet1.NID_PRVLRBG = kcg_lit_int32(0);
  outC->_L29.packet1.D_LRBG = kcg_lit_int32(0);
  outC->_L29.packet1.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L29.packet1.dlrbg = Q_DLRBG_Reverse;
  outC->_L29.packet1.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L29.packet1.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L29.packet1.length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L29.packet1.L_TRAININT = kcg_lit_int32(0);
  outC->_L29.packet1.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L29.packet1.NID_NTC = kcg_lit_int32(0);
  outC->_L28.valid = kcg_true;
  outC->_L28.packet0.NID_PACKET = kcg_lit_int32(0);
  outC->_L28.packet0.L_PACKET = kcg_lit_int32(0);
  outC->_L28.packet0.qscale = Q_SCALE_10_cm_scale;
  outC->_L28.packet0.NID_LRBG = kcg_lit_int32(0);
  outC->_L28.packet0.D_LRBG = kcg_lit_int32(0);
  outC->_L28.packet0.dirlrbg = Q_DIRLRBG_Reverse;
  outC->_L28.packet0.dlrbg = Q_DLRBG_Reverse;
  outC->_L28.packet0.L_DOUBTOVER = kcg_lit_int32(0);
  outC->_L28.packet0.L_DOUBTUNDER = kcg_lit_int32(0);
  outC->_L28.packet0.length = Q_LENGTH_No_train_integrity_information_available;
  outC->_L28.packet0.L_TRAININT = kcg_lit_int32(0);
  outC->_L28.packet0.V_TRAIN = kcg_lit_int32(0);
  ...
  outC->_L28.packet0.NID_NTC = kcg_lit_int32(0);
  ...
  outC->_L18.v_main = kcg_lit_int32(0);
  outC->_L18.v_loa = kcg_lit_int32(0);
  outC->_L18.t_loa_unlimited = kcg_true;
  outC->_L18.t_loa = kcg_lit_int32(0);
  outC->_L18.n_iter = kcg_lit_int32(0);
  for (idx4 = 0; idx4 < 10; idx4++) {
    outC->_L18.sections[idx4].valid = kcg_true;
    outC->_L18.sections[idx4].q_endsection = kcg_true;
    outC->_L18.sections[idx4].l_section = kcg_lit_int32(0);
    outC->_L18.sections[idx4].q_sectiontimer = kcg_true;
    outC->_L18.sections[idx4].t_sectiontimer = kcg_lit_int32(0);
    outC->_L18.sections[idx4].d_sectiontimerstoploc = kcg_lit_int32(0);
  }
  outC->_L18.q_dangerpoint = kcg_true;
  outC->_L18.dangerpoint.d_DP_or_OL = kcg_lit_int32(0);
  outC->_L18.dangerpoint.v_release = kcg_lit_int32(0);
  outC->_L18.dangerpoint.calc_v_release_onboard = kcg_true;
  outC->_L18.q_overlap = kcg_true;
  outC->_L18.overlap.d_DP_or_OL = kcg_lit_int32(0);
  outC->_L18.overlap.v_release = kcg_lit_int32(0);
  outC->_L18.overlap.calc_v_release_onboard = kcg_true;
  outC->_L18.q_endtimer = kcg_true;
  outC->_L18.endtimer_t.t_endtimer = kcg_lit_int32(0);
  outC->_L18.endtimer_t.d_endtimerstoploc = kcg_lit_int32(0);
  outC->_L26 = kcg_true;
  outC->_L24.nid_engine = kcg_lit_int32(0);
  outC->_L24.nid_operational = kcg_lit_int32(0);
  outC->_L24.l_train = kcg_lit_int32(0);
  outC->_L24.d_baliseAntenna_2_frontend.nominal = kcg_lit_int32(0);
  outC->_L24.d_baliseAntenna_2_frontend.d_min = kcg_lit_int32(0);
  outC->_L24.d_baliseAntenna_2_frontend.d_max = kcg_lit_int32(0);
  outC->_L24.d_frontend_2_rearend.nominal = kcg_lit_int32(0);
  outC->_L24.d_frontend_2_rearend.d_min = kcg_lit_int32(0);
  outC->_L24.d_frontend_2_rearend.d_max = kcg_lit_int32(0);
  outC->_L24.locationAccuracy_DefaultValue.nominal = kcg_lit_int32(0);
  outC->_L24.locationAccuracy_DefaultValue.d_min = kcg_lit_int32(0);
  outC->_L24.locationAccuracy_DefaultValue.d_max = kcg_lit_int32(0);
  outC->_L24.centerDetectionAcc_DefaultValue.nominal = kcg_lit_int32(0);
  outC->_L24.centerDetectionAcc_DefaultValue.d_min = kcg_lit_int32(0);
  outC->_L24.centerDetectionAcc_DefaultValue.d_max = kcg_lit_int32(0);
  outC->_L21 = kcg_true;
  outC->_L17.valid = kcg_true;
  outC->_L17.timestamp = kcg_lit_int32(0);
  outC->_L17.odo.o_nominal = kcg_lit_int32(0);
  outC->_L17.odo.o_min = kcg_lit_int32(0);
  outC->_L17.odo.o_max = kcg_lit_int32(0);
  outC->_L17.speed.v_safeNominal = kcg_lit_int32(0);
  outC->_L17.speed.v_rawNominal = kcg_lit_int32(0);
  outC->_L17.speed.v_lower = kcg_lit_int32(0);
  outC->_L17.speed.v_upper = kcg_lit_int32(0);
  outC->_L17.acceleration = kcg_lit_int32(0);
  ...
  for (idx5 = 0; idx5 < 30; idx5++) {
    outC->_L5.packets.PacketHeaders[idx5].nid_packet = kcg_lit_int32(0);
    outC->_L5.packets.PacketHeaders[idx5].q_dir = Q_DIR_Reverse;
    outC->_L5.packets.PacketHeaders[idx5].valid = kcg_true;
    outC->_L5.packets.PacketHeaders[idx5].startAddress = kcg_lit_int32(0);
    outC->_L5.packets.PacketHeaders[idx5].endAddress = kcg_lit_int32(0);
  }
  for (idx6 = 0; idx6 < 500; idx6++) {
    outC->_L5.packets.PacketData[idx6] = kcg_lit_int32(0);
  }
  ...
  for (idx7 = 0; idx7 < 33; idx7++) {
    ...
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx7].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx7].d_link = kcg_lit_int32(0);
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx7].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx7].nid_c = kcg_lit_int32(0);
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx7].nid_bg = kcg_lit_int32(0);
    ...
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx7].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L2.LRBG.infoFromPassing.linkedBGs[idx7].q_locacc = kcg_lit_int32(0);
  }
  ...
  for (idx8 = 0; idx8 < 33; idx8++) {
    ...
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx8].nid_LRBG = kcg_lit_int32(0);
    ...
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx8].d_link = kcg_lit_int32(0);
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx8].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx8].nid_c = kcg_lit_int32(0);
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx8].nid_bg = kcg_lit_int32(0);
    ...
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx8].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    outC->_L2.prvLRBG.infoFromPassing.linkedBGs[idx8].q_locacc = kcg_lit_int32(0);
  }
  ...
  for (idx10 = 0; idx10 < 5; idx10++) {
    ...
    outC->bus_out[idx10].Message.nid_message = kcg_lit_int32(0);
    outC->bus_out[idx10].Message.l_message = kcg_lit_int32(0);
    outC->bus_out[idx10].Message.t_train = kcg_lit_int32(0);
    outC->bus_out[idx10].Message.nid_engine = kcg_lit_int32(0);
    outC->bus_out[idx10].Message.field1 = kcg_lit_int32(0);
    outC->bus_out[idx10].Message.field2 = kcg_lit_int32(0);
    outC->bus_out[idx10].Message.field3 = kcg_lit_int32(0);
    for (idx9 = 0; idx9 < 50; idx9++) {
      outC->bus_out[idx10].OptionalPackets[idx9] = kcg_lit_int32(0);
    }
  }
  /* _L32=(TA_MA_Request::Build_MA_request#1)/ */
