...
void Write_DMI_Identifier_Requ_DATA_Packets_EVC_to_DMI(
  /* dmi_id_ct/ */
...
{
  _12_DMI_Identifier_Request_int_array_T_DATA op_call;
  ...
  if (outC->every) {
    ...
    CAST_DMI_Identifier_Reque_DATA_Packets_EVC_to_DMI(
      &outC->_L1,
  ...
  if (outC->every) {
    kcg_copy__12_DMI_Identifier_Request_int_array_T_DATA(&outC->_L18, &op_call);
  }
  else {
    kcg_copy__12_DMI_Identifier_Request_int_array_T_DATA(&outC->_L18, &outC->_L19);
  }
  kcg_copy__12_DMI_Identifier_Request_int_array_T_DATA(
    &outC->dmi_id_int,
    &outC->_L18);
...
void Write_DMI_Identifier_Requ_init_DATA_Packets_EVC_to_DMI(
  outC_Write_DMI_Identifier_Requ_DATA_Packets_EVC_to_DMI *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L18=(DATA::Packets::EVC_to_DMI::CAST_DMI_Identifier_Request_to_int1#1)/ */
  CAST_DMI_Identifier_Reque_init_DATA_Packets_EVC_to_DMI(
    &outC->Context_CAST_DMI_Identifier_Request_to_int1_1);
}
...
void Write_DMI_Identifier_Requ_reset_DATA_Packets_EVC_to_DMI(
  outC_Write_DMI_Identifier_Requ_DATA_Packets_EVC_to_DMI *outC)
{
  /* _L18=(DATA::Packets::EVC_to_DMI::CAST_DMI_Identifier_Request_to_int1#1)/ */
  CAST_DMI_Identifier_Reque_reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_CAST_DMI_Identifier_Request_to_int1_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Write_DMI_Identifier_Requ_DATA_Packets_EVC_to_DMI.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
