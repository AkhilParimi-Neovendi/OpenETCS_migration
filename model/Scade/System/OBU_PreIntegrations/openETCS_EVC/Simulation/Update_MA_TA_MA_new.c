...
{
  /* MA_in_force/ */
  MovementAuthority_t_TrackAtlasTypes MA_in_force_partial;
  /* MA_in_force/ */
  MovementAuthority_t_TrackAtlasTypes _1_MA_in_force_partial;
  /* MA_in_force/ */
  MovementAuthority_t_TrackAtlasTypes _2_MA_in_force_partial;
  /* MA_in_force/ */
  MovementAuthority_t_TrackAtlasTypes _3_MA_in_force_partial;
  /* MA_in_force/ */
  MovementAuthority_t_TrackAtlasTypes last_MA_in_force;
