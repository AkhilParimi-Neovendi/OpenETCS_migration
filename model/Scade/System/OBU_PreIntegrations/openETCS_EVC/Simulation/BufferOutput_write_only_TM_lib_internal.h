...
typedef struct {
  ...
  outC_BufferOutput_write_only2_TM_lib_internal /* IfBlock1:else:then:_L7=(TM_lib_internal::BufferOutput_write_only2#1)/ */ _1_Context_BufferOutput_write_only2_1;
  outC_BufferOutput_write_only3_TM_lib_internal /* IfBlock1:else:else:then:_L4=(TM_lib_internal::BufferOutput_write_only3#1)/ */ _2_Context_BufferOutput_write_only3_1;
  outC_BufferOutput_write_only4_TM_lib_internal /* IfBlock1:else:else:else:then:_L1=(TM_lib_internal::BufferOutput_write_only4#1)/ */ _3_Context_BufferOutput_write_only4_1;
  outC_BufferOutput_write_only5_TM_lib_internal /* IfBlock1:else:else:else:else:_L1=(TM_lib_internal::BufferOutput_write_only5#1)/ */ _4_Context_BufferOutput_write_only5_1;
