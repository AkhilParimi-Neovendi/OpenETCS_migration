  ...
  outC_initiateTerminatingSession_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  ...
  kcg_bool definedNumberOfRepetitionsHasBeenReached_partial;
  /* TrainExitedFromRBCArea_SM: */
  SSM_ST_TrainExitedFromRBCArea_SM TrainExitedFromRBCArea_SM_state_nxt_partial;
  /* TrainExitedFromRBCArea_SM: */
  kcg_bool TrainExitedFromRBCArea_SM_reset_nxt_partial;
  /* TrainExitedFromRBCArea_SM: */
  SSM_TR_TrainExitedFromRBCArea_SM TrainExitedFromRBCArea_SM_fired_partial;
  /* definedNumberOfRepetitionsHasBeenReached/ */
  kcg_bool _1_definedNumberOfRepetitionsHasBeenReached_partial;
  /* TrainExitedFromRBCArea_SM: */
  SSM_ST_TrainExitedFromRBCArea_SM _2_TrainExitedFromRBCArea_SM_state_nxt_partial;
  /* TrainExitedFromRBCArea_SM: */
  kcg_bool _3_TrainExitedFromRBCArea_SM_reset_nxt_partial;
  /* TrainExitedFromRBCArea_SM: */
  SSM_TR_TrainExitedFromRBCArea_SM _4_TrainExitedFromRBCArea_SM_fired_partial;
  /* TrainExitedFromRBCArea_SM:WaitForOrderToTerminateTheSession:<2> */
  kcg_bool tr_2_guard_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM;
  /* TrainExitedFromRBCArea_SM: */
  SSM_TR_TrainExitedFromRBCArea_SM _5_TrainExitedFromRBCArea_SM_fired_partial;
  /* TrainExitedFromRBCArea_SM: */
  kcg_bool _6_TrainExitedFromRBCArea_SM_reset_nxt_partial;
  /* TrainExitedFromRBCArea_SM: */
  SSM_ST_TrainExitedFromRBCArea_SM _7_TrainExitedFromRBCArea_SM_state_nxt_partial;
  /* TrainExitedFromRBCArea_SM: */
  SSM_TR_TrainExitedFromRBCArea_SM _8_TrainExitedFromRBCArea_SM_fired_partial;
  /* TrainExitedFromRBCArea_SM: */
  kcg_bool _9_TrainExitedFromRBCArea_SM_reset_nxt_partial;
  /* TrainExitedFromRBCArea_SM: */
  SSM_ST_TrainExitedFromRBCArea_SM _10_TrainExitedFromRBCArea_SM_state_nxt_partial;
  /* TrainExitedFromRBCArea_SM: */
  SSM_ST_TrainExitedFromRBCArea_SM _11_TrainExitedFromRBCArea_SM_state_act_partial;
  /* TrainExitedFromRBCArea_SM: */
  kcg_bool _12_TrainExitedFromRBCArea_SM_reset_act_partial;
  /* TrainExitedFromRBCArea_SM: */
  SSM_TR_TrainExitedFromRBCArea_SM _13_TrainExitedFromRBCArea_SM_fired_strong_partial;
  /* TrainExitedFromRBCArea_SM:Idle:<2> */
  kcg_bool tr_2_guard_Idle_TrainExitedFromRBCArea_SM;
  /* TrainExitedFromRBCArea_SM:Idle:<1> */
  kcg_bool tr_1_guard_Idle_TrainExitedFromRBCArea_SM;
  /* TrainExitedFromRBCArea_SM: */
  SSM_ST_TrainExitedFromRBCArea_SM _14_TrainExitedFromRBCArea_SM_state_act_partial;
  /* TrainExitedFromRBCArea_SM: */
  kcg_bool _15_TrainExitedFromRBCArea_SM_reset_act_partial;
  /* TrainExitedFromRBCArea_SM: */
  SSM_TR_TrainExitedFromRBCArea_SM _16_TrainExitedFromRBCArea_SM_fired_strong_partial;
  /* TrainExitedFromRBCArea_SM:WaitForOrderToTerminateTheSession:<1> */
  kcg_bool tr_1_guard_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM;
  kcg_bool noname;
  /* TrainExitedFromRBCArea_SM: */
  kcg_bool _17_TrainExitedFromRBCArea_SM_reset_sel;
  /* TrainExitedFromRBCArea_SM: */
  kcg_bool _18_TrainExitedFromRBCArea_SM_reset_prv;
  ...
  outC->_3_TrainExitedFromRBCArea_SM_state_sel =
    outC->TrainExitedFromRBCArea_SM_state_nxt;
  /* TrainExitedFromRBCArea_SM: */
  switch (outC->_3_TrainExitedFromRBCArea_SM_state_sel) {
    case SSM_st_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM :
      tr_1_guard_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM =
        outC->orderToTerminateTheSessionIsReceived | reset;
      if (tr_1_guard_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM) {
        _14_TrainExitedFromRBCArea_SM_state_act_partial =
      ...
      outC->_2_TrainExitedFromRBCArea_SM_state_act =
        _14_TrainExitedFromRBCArea_SM_state_act_partial;
      if (tr_1_guard_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM) {
        _16_TrainExitedFromRBCArea_SM_fired_strong_partial =
    ...
    case SSM_st_Idle_TrainExitedFromRBCArea_SM :
      ...
      tr_1_guard_Idle_TrainExitedFromRBCArea_SM = reset;
      if (tr_1_guard_Idle_TrainExitedFromRBCArea_SM) {
        _11_TrainExitedFromRBCArea_SM_state_act_partial =
          SSM_st_Idle_TrainExitedFromRBCArea_SM;
      }
      ...
      outC->_2_TrainExitedFromRBCArea_SM_state_act =
        _11_TrainExitedFromRBCArea_SM_state_act_partial;
      if (tr_1_guard_Idle_TrainExitedFromRBCArea_SM) {
        _13_TrainExitedFromRBCArea_SM_fired_strong_partial =
  ...
  switch (outC->_2_TrainExitedFromRBCArea_SM_state_act) {
    case SSM_st_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM :
  ...
  _18_TrainExitedFromRBCArea_SM_reset_prv =
    outC->TrainExitedFromRBCArea_SM_reset_act;
  /* TrainExitedFromRBCArea_SM: */
  switch (outC->_3_TrainExitedFromRBCArea_SM_state_sel) {
    case SSM_st_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM :
      _15_TrainExitedFromRBCArea_SM_reset_act_partial =
        tr_1_guard_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM;
      outC->TrainExitedFromRBCArea_SM_reset_act =
        _15_TrainExitedFromRBCArea_SM_reset_act_partial;
      break;
    case SSM_st_Idle_TrainExitedFromRBCArea_SM :
      if (tr_1_guard_Idle_TrainExitedFromRBCArea_SM) {
        _12_TrainExitedFromRBCArea_SM_reset_act_partial = kcg_true;
      }
      else {
        _12_TrainExitedFromRBCArea_SM_reset_act_partial =
  ...
  switch (outC->_2_TrainExitedFromRBCArea_SM_state_act) {
    case SSM_st_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM :
      ...
      _1_definedNumberOfRepetitionsHasBeenReached_partial =
        outC->_L26_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM;
    ...
    case SSM_st_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM :
      ...
      if (outC->WaitForOrderToTerminateTheSession_weakb_clock_TrainExitedFromRBCArea_SM) {
        _8_TrainExitedFromRBCArea_SM_fired_partial =
          outC->TrainExitedFromRBCArea_SM_fired_strong;
        _9_TrainExitedFromRBCArea_SM_reset_nxt_partial = kcg_false;
        _10_TrainExitedFromRBCArea_SM_state_nxt_partial =
          SSM_st_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM;
        _2_TrainExitedFromRBCArea_SM_state_nxt_partial =
          _10_TrainExitedFromRBCArea_SM_state_nxt_partial;
        _3_TrainExitedFromRBCArea_SM_reset_nxt_partial =
          _9_TrainExitedFromRBCArea_SM_reset_nxt_partial;
        _4_TrainExitedFromRBCArea_SM_fired_partial =
          _8_TrainExitedFromRBCArea_SM_fired_partial;
      }
      else {
        if (tr_2_guard_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM) {
          _5_TrainExitedFromRBCArea_SM_fired_partial =
        ...
        _6_TrainExitedFromRBCArea_SM_reset_nxt_partial =
          tr_2_guard_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM;
        if (tr_2_guard_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM) {
          _7_TrainExitedFromRBCArea_SM_state_nxt_partial =
            SSM_st_Idle_TrainExitedFromRBCArea_SM;
        }
        else {
          _7_TrainExitedFromRBCArea_SM_state_nxt_partial =
  ...
  _17_TrainExitedFromRBCArea_SM_reset_sel =
    outC->_1_TrainExitedFromRBCArea_SM_reset_nxt;
  /* TrainExitedFromRBCArea_SM: */
  switch (outC->_2_TrainExitedFromRBCArea_SM_state_act) {
    case SSM_st_WaitForOrderToTerminateTheSession_TrainExitedFromRBCArea_SM :
      outC->_1_TrainExitedFromRBCArea_SM_reset_nxt =
        _3_TrainExitedFromRBCArea_SM_reset_nxt_partial;
      outC->_4_TrainExitedFromRBCArea_SM_fired =
        _4_TrainExitedFromRBCArea_SM_fired_partial;
      break;
    case SSM_st_Idle_TrainExitedFromRBCArea_SM :
      outC->_1_TrainExitedFromRBCArea_SM_reset_nxt =
  ...
  outC_initiateTerminatingSession_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  ...
  validate_q_sleepsession_v2_init_MoRC_Pck_Subfunc_Pkg(
    &outC->Context_validate_q_sleepsession_v2_2);
  outC->_1_TrainExitedFromRBCArea_SM_reset_nxt = kcg_false;
