...
void Write_DMI_Driver_Identifi_DATA_Packets_Bothways(
...
{
  DMI_Driver_Identifier_int_array_T_DATA op_call;
  ...
  if (outC->every) {
    ...
    C_DMI_Driver_Identifier_t_DATA_Packets_Bothways(
      &outC->_L13,
...
void Write_DMI_Driver_Identifi_init_DATA_Packets_Bothways(
  outC_Write_DMI_Driver_Identifi_DATA_Packets_Bothways *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L23=(DATA::Packets::Bothways::C_DMI_Driver_Identifier_to_int#1)/ */
  C_DMI_Driver_Identifier_t_init_DATA_Packets_Bothways(
    &outC->Context_C_DMI_Driver_Identifier_to_int_1);
}
...
void Write_DMI_Driver_Identifi_reset_DATA_Packets_Bothways(
  outC_Write_DMI_Driver_Identifi_DATA_Packets_Bothways *outC)
{
  /* _L23=(DATA::Packets::Bothways::C_DMI_Driver_Identifier_to_int#1)/ */
  C_DMI_Driver_Identifier_t_reset_DATA_Packets_Bothways(
    &outC->Context_C_DMI_Driver_Identifier_to_int_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Write_DMI_Driver_Identifi_DATA_Packets_Bothways.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
