...
{
  /* q_sleepsession/ */
  Q_SLEEPSESSION q_sleepsession_partial;
  /* error/ */
  kcg_bool error_partial;
  /* q_sleepsession/ */
  Q_SLEEPSESSION _1_q_sleepsession_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* error/ */
  kcg_bool _3_error_partial;
  /* q_sleepsession/ */
  Q_SLEEPSESSION _4_q_sleepsession_partial;
  /* error/ */
  kcg_bool _5_error_partial;
  /* q_sleepsession/ */
  Q_SLEEPSESSION _6_q_sleepsession_partial;
  kcg_bool noname;
