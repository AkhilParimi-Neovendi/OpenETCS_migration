...
void SSP_Merge_New_P27V1_to_Pr_TA_SSP_new(
  /* i/ */
  kcg_int32 i,
  /* SP/ */
...
void SSP_Merge_New_P27V1_to_Pr_init_TA_SSP_new(
  outC_SSP_Merge_New_P27V1_to_Pr_TA_SSP_new *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void SSP_Merge_New_P27V1_to_Pr_reset_TA_SSP_new(
  outC_SSP_Merge_New_P27V1_to_Pr_TA_SSP_new *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** SSP_Merge_New_P27V1_to_Pr_TA_SSP_new.c
** Generation date: 2023-11-06T13:54:30
*************************************************************$ */
