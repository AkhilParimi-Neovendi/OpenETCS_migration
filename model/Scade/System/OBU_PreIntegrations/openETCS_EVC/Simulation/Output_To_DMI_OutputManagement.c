  ...
  outC_Output_To_DMI_OutputManagement *outC)
{
  ...
  M_MODE Loc_Selected_Mode_For_Ack_partial;
  /* Loc_Valid/ */
  kcg_bool Loc_Valid_partial;
  /* Loc_Selected_Mode_For_Ack/ */
  M_MODE _1_Loc_Selected_Mode_For_Ack_partial;
  /* Loc_Valid/ */
  kcg_bool _2_Loc_Valid_partial;
  /* Loc_Selected_Mode_For_Ack/ */
  M_MODE _3_Loc_Selected_Mode_For_Ack_partial;
  /* Loc_Valid/ */
  kcg_bool _4_Loc_Valid_partial;
  /* Loc_Selected_Mode_For_Ack/ */
  M_MODE _5_Loc_Selected_Mode_For_Ack_partial;
  /* Loc_Valid/ */
  kcg_bool _6_Loc_Valid_partial;
  /* Loc_Selected_Mode_For_Ack/ */
  M_MODE _7_Loc_Selected_Mode_For_Ack_partial;
  /* Loc_Valid/ */
  kcg_bool _8_Loc_Valid_partial;
  /* Loc_Selected_Mode_For_Ack/ */
  M_MODE _9_Loc_Selected_Mode_For_Ack_partial;
  /* Loc_Valid/ */
  kcg_bool _10_Loc_Valid_partial;
  /* Loc_Selected_Mode_For_Ack/ */
  M_MODE _11_Loc_Selected_Mode_For_Ack_partial;
  /* Loc_Valid/ */
  kcg_bool _12_Loc_Valid_partial;
  /* Loc_Selected_Mode_For_Ack/ */
  M_MODE _13_Loc_Selected_Mode_For_Ack_partial;
  /* Loc_Valid/ */
  kcg_bool _14_Loc_Valid_partial;
  /* Loc_Valid/ */
  kcg_bool _15_Loc_Valid_partial;
  /* Loc_Selected_Mode_For_Ack/ */
  M_MODE _16_Loc_Selected_Mode_For_Ack_partial;
  /* Loc_Valid/ */
  kcg_bool _17_Loc_Valid_partial;
  /* Loc_Selected_Mode_For_Ack/ */
  M_MODE _18_Loc_Selected_Mode_For_Ack_partial;
  /* Loc_Valid/ */
  kcg_bool _19_Loc_Valid_partial;
  /* Loc_Selected_Mode_For_Ack/ */
  M_MODE _20_Loc_Selected_Mode_For_Ack_partial;
  /* Loc_Valid/ */
  kcg_bool _21_Loc_Valid_partial;
  /* Loc_Selected_Mode_For_Ack/ */
  M_MODE _22_Loc_Selected_Mode_For_Ack_partial;
  /* Loc_Valid/ */
  kcg_bool _23_Loc_Valid_partial;
  /* Loc_Selected_Mode_For_Ack/ */
  M_MODE _24_Loc_Selected_Mode_For_Ack_partial;
  /* Loc_Valid/ */
  kcg_bool _25_Loc_Valid_partial;
  /* Loc_Selected_Mode_For_Ack/ */
  M_MODE _26_Loc_Selected_Mode_For_Ack_partial;
  /* Loc_Valid/ */
  kcg_bool _27_Loc_Valid_partial;
  /* Loc_Selected_Mode_For_Ack/ */
  M_MODE _28_Loc_Selected_Mode_For_Ack_partial;
  /* Loc_Valid/ */
  kcg_bool _29_Loc_Valid_partial;
  /* Loc_Selected_Mode_For_Ack/ */
  M_MODE _30_Loc_Selected_Mode_For_Ack_partial;
  /* needsAckFromDriver/ */
  kcg_bool last_needsAckFromDriver;
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              outC->_L35_then_else_else_else_else_else_IfBlock1 = kcg_true;
              _21_Loc_Valid_partial = outC->_L35_then_else_else_else_else_else_IfBlock1;
      ...
      if (outC->else_clock_else_IfBlock1) {
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            /* IfBlock1:else:else:else:else:else: */
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              outC->_L14_then_else_else_else_else_else_IfBlock1 = M_MODE_Staff_Responsible;
              ...
              if (outC->_2_else_clock_else_else_else_else_else_IfBlock1) {
                ...
                /* IfBlock1:else:else:else:else:else:else:else: */
                if (outC->_1_else_clock_else_else_else_else_else_else_IfBlock1) {
                  outC->_L13_then_else_else_else_else_else_else_else_IfBlock1 = M_MODE_Unfitted;
  ...
  outC_Output_To_DMI_OutputManagement *outC)
{
  ...
  outC->_L40.transition.position = kcg_lit_int32(0);
  outC->_L40.transition.transitionType =
    M_TransitionType_Conditional_Level_And_Mode_Types_Pkg;
  outC->_L40.transition.immediateAck = kcg_true;
  outC->_L40.transition.AckLength = kcg_lit_int32(0);
  ...
  outC->_L35_then_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_L14_then_else_else_else_else_else_IfBlock1 = M_MODE_Full_Supervision;
