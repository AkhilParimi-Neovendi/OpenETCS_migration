...
void ConvertTrackSideMessageTo_init_CheckEuroradioMessage(
  outC_ConvertTrackSideMessageTo_CheckEuroradioMessage *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void ConvertTrackSideMessageTo_reset_CheckEuroradioMessage(
  outC_ConvertTrackSideMessageTo_CheckEuroradioMessage *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** ConvertTrackSideMessageTo_CheckEuroradioMessage.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
