...
typedef struct {
  ...
  kcg_bool /* TrainExitedFromRBCArea_SM: */ _1_TrainExitedFromRBCArea_SM_reset_nxt;
  /* ---------------------  sub nodes' contexts  --------------------- */
  ...
  SSM_ST_TrainExitedFromRBCArea_SM /* TrainExitedFromRBCArea_SM: */ _2_TrainExitedFromRBCArea_SM_state_act;
  /* -------------------- (-debug) no assertions  -------------------- */
  ...
  SSM_ST_TrainExitedFromRBCArea_SM /* TrainExitedFromRBCArea_SM: */ _3_TrainExitedFromRBCArea_SM_state_sel;
  SSM_TR_TrainExitedFromRBCArea_SM /* TrainExitedFromRBCArea_SM: */ TrainExitedFromRBCArea_SM_fired_strong;
  SSM_TR_TrainExitedFromRBCArea_SM /* TrainExitedFromRBCArea_SM: */ _4_TrainExitedFromRBCArea_SM_fired;
