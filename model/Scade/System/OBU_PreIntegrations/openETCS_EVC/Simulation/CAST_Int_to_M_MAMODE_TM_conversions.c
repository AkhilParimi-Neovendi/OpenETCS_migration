...
{
  /* m_mamode/ */
  M_MAMODE m_mamode_partial;
  /* error/ */
  kcg_bool error_partial;
  /* m_mamode/ */
  M_MAMODE _1_m_mamode_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* m_mamode/ */
  M_MAMODE _3_m_mamode_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* m_mamode/ */
  M_MAMODE _5_m_mamode_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* error/ */
  kcg_bool _7_error_partial;
  /* m_mamode/ */
  M_MAMODE _8_m_mamode_partial;
  /* error/ */
  kcg_bool _9_error_partial;
  /* m_mamode/ */
  M_MAMODE _10_m_mamode_partial;
  kcg_bool noname;
