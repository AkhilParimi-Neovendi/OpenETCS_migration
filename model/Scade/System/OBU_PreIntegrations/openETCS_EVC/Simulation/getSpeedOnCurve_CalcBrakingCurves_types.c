  ...
  outC_getSpeedOnCurve_CalcBrakingCurves_types *outC)
{
  ...
  if (outC->_L22) {
    ...
    for (idx1 = 0; idx1 < 114; idx1++) {
      acc = outC->_L20;
      outC->_L90_searchIdxFloor_1[idx1] = kcg_lit_float32(0.0);
      ...
      outC->_L86_searchIdxFloor_1[idx1] = /* _L21= */(kcg_int32) idx1;
      ...
      outC->_L21 = /* _L21= */(kcg_int32) (idx1 + 1);
      /* _L21= */
  ...
  outC->idx = outC->_L20;
  outC->_L14 = outC->idx;
  if ((kcg_lit_int32(0) <= outC->_L14) & (outC->_L14 < kcg_lit_int32(114))) {
  ...
  outC_getSpeedOnCurve_CalcBrakingCurves_types *outC)
{
  ...
  for (idx1 = 0; idx1 < 114; idx1++) {
    outC->_L9[idx1] = kcg_lit_float32(0.0);
  }
  for (idx2 = 0; idx2 < 114; idx2++) {
    outC->_L8[idx2] = kcg_lit_float32(0.0);
  }
  for (idx3 = 0; idx3 < 114; idx3++) {
    outC->_L7[idx3] = kcg_lit_float32(0.0);
  }
  outC->_L11 = kcg_lit_float32(0.0);
  outC->_L12 = kcg_true;
  ...
  for (idx8 = 0; idx8 < 114; idx8++) {
    outC->_L16[idx8] = kcg_lit_float32(0.0);
  }
  outC->_L17.distance = kcg_lit_float32(0.0);
  outC->_L17.speed = kcg_lit_float32(0.0);
  outC->_L17.acceleration = kcg_lit_float32(0.0);
  outC->idx = kcg_lit_int32(0);
  outC->every = kcg_true;
  for (idx9 = 0; idx9 < 114; idx9++) {
    outC->_L8_searchIdxFloor_1[idx9] = kcg_lit_int32(0);
  }
  for (idx10 = 0; idx10 < 114; idx10++) {
    outC->_L40_searchIdxFloor_1[idx10] = kcg_lit_float32(0.0);
  }
  for (idx11 = 0; idx11 < 114; idx11++) {
    outC->_L77_searchIdxFloor_1[idx11] = kcg_true;
  }
  for (idx12 = 0; idx12 < 114; idx12++) {
    outC->_L84_searchIdxFloor_1[idx12] = kcg_lit_int32(0);
  }
  for (idx13 = 0; idx13 < 114; idx13++) {
    outC->_L74_searchIdxFloor_1[idx13] = kcg_lit_float32(0.0);
  }
  for (idx14 = 0; idx14 < 114; idx14++) {
    outC->_L86_searchIdxFloor_1[idx14] = kcg_lit_int32(0);
  }
  for (idx15 = 0; idx15 < 114; idx15++) {
    outC->_L88_searchIdxFloor_1[idx15] = kcg_true;
  }
  for (idx16 = 0; idx16 < 114; idx16++) {
    outC->_L89_searchIdxFloor_1[idx16] = kcg_lit_float32(0.0);
  }
  for (idx17 = 0; idx17 < 114; idx17++) {
    outC->_L90_searchIdxFloor_1[idx17] = kcg_lit_float32(0.0);
  }
