...
{
  /* indicator_l/ */
  safeRadioConnnectionIndicator_T_RCM_Session_Types_Pkg indicator_l_partial;
  /* connectionStatus_SM: */
  SSM_ST_connectionStatus_SM connectionStatus_SM_state_nxt_partial;
  /* connectionStatus_SM: */
  kcg_bool connectionStatus_SM_reset_nxt_partial;
  /* connectionStatus_SM: */
  SSM_TR_connectionStatus_SM connectionStatus_SM_fired_partial;
  /* indicator_l/ */
  safeRadioConnnectionIndicator_T_RCM_Session_Types_Pkg _1_indicator_l_partial;
  /* connectionStatus_SM: */
  SSM_ST_connectionStatus_SM _2_connectionStatus_SM_state_nxt_partial;
  /* connectionStatus_SM: */
  kcg_bool _3_connectionStatus_SM_reset_nxt_partial;
  /* connectionStatus_SM: */
  SSM_TR_connectionStatus_SM _4_connectionStatus_SM_fired_partial;
  /* indicator_l/ */
  safeRadioConnnectionIndicator_T_RCM_Session_Types_Pkg _5_indicator_l_partial;
  /* connectionStatus_SM: */
  SSM_ST_connectionStatus_SM _6_connectionStatus_SM_state_nxt_partial;
  /* connectionStatus_SM: */
  kcg_bool _7_connectionStatus_SM_reset_nxt_partial;
  /* connectionStatus_SM: */
  SSM_TR_connectionStatus_SM _8_connectionStatus_SM_fired_partial;
  /* connectionStatus_SM: */
  SSM_ST_connectionStatus_SM connectionStatus_SM_state_act_partial;
  /* connectionStatus_SM: */
  kcg_bool connectionStatus_SM_reset_act_partial;
  /* connectionStatus_SM: */
  SSM_TR_connectionStatus_SM connectionStatus_SM_fired_strong_partial;
  /* connectionStatus_SM:NoConnection:<2> */
  kcg_bool tr_2_guard_NoConnection_connectionStatus_SM;
  /* connectionStatus_SM:NoConnection:<1> */
  kcg_bool tr_1_guard_NoConnection_connectionStatus_SM;
  /* connectionStatus_SM: */
  SSM_ST_connectionStatus_SM _9_connectionStatus_SM_state_act_partial;
  /* connectionStatus_SM: */
  kcg_bool _10_connectionStatus_SM_reset_act_partial;
  /* connectionStatus_SM: */
  SSM_TR_connectionStatus_SM _11_connectionStatus_SM_fired_strong_partial;
  /* connectionStatus_SM:ConnectionLost_SetupFailed:<2> */
  kcg_bool tr_2_guard_ConnectionLost_SetupFailed_connectionStatus_SM;
  /* connectionStatus_SM:ConnectionLost_SetupFailed:<1> */
  kcg_bool tr_1_guard_ConnectionLost_SetupFailed_connectionStatus_SM;
  /* connectionStatus_SM: */
  SSM_ST_connectionStatus_SM _12_connectionStatus_SM_state_act_partial;
  /* connectionStatus_SM: */
  kcg_bool _13_connectionStatus_SM_reset_act_partial;
  /* connectionStatus_SM: */
  SSM_TR_connectionStatus_SM _14_connectionStatus_SM_fired_strong_partial;
  /* connectionStatus_SM:ConnectionUp:<2> */
  kcg_bool tr_2_guard_ConnectionUp_connectionStatus_SM;
  /* connectionStatus_SM:ConnectionUp:<1> */
  kcg_bool tr_1_guard_ConnectionUp_connectionStatus_SM;
  kcg_bool noname;
  /* connectionStatus_SM: */
  kcg_bool connectionStatus_SM_reset_sel;
  /* connectionStatus_SM: */
  kcg_bool connectionStatus_SM_reset_prv;
  ...
  outC->_1_requestsToSetupASafeRadioConnectionAreStopped = outC->_L101;
  outC->_L91 = outC->_1_requestsToSetupASafeRadioConnectionAreStopped;
  ...
  outC_safeRadioConnectionIndica_MoRC_Pck_Subfunc_Pkg *outC)
{
  ...
  outC->_1_requestsToSetupASafeRadioConnectionAreStopped = kcg_true;
