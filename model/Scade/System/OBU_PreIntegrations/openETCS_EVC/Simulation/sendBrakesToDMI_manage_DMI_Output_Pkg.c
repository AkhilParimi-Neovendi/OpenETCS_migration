...
{
  /* dmi_iconRequest/ */
  DMI_Icons_T_DMI_Messages_EVC_to_DMI_Pkg dmi_iconRequest_partial;
  /* dmi_iconRequest/ */
  DMI_Icons_T_DMI_Messages_EVC_to_DMI_Pkg _1_dmi_iconRequest_partial;
  /* dmi_iconRequest/ */
  DMI_Icons_T_DMI_Messages_EVC_to_DMI_Pkg _2_dmi_iconRequest_partial;
  /* dmi_iconRequest/ */
  DMI_Icons_T_DMI_Messages_EVC_to_DMI_Pkg _3_dmi_iconRequest_partial;
  /* brakeCommand/ */
  Brake_command_T_TIU_Types_Pkg last_brakeCommand;
