...
{
  /* q_sectiontimer/ */
  Q_SECTIONTIMER q_sectiontimer_partial;
  /* error/ */
  kcg_bool error_partial;
  /* q_sectiontimer/ */
  Q_SECTIONTIMER _1_q_sectiontimer_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* error/ */
  kcg_bool _3_error_partial;
  /* q_sectiontimer/ */
  Q_SECTIONTIMER _4_q_sectiontimer_partial;
  /* error/ */
  kcg_bool _5_error_partial;
  /* q_sectiontimer/ */
  Q_SECTIONTIMER _6_q_sectiontimer_partial;
  kcg_bool noname;
