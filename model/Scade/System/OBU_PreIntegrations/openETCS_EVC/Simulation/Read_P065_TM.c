...
void Read_P065_init_TM(outC_Read_P065_TM *outC)
{
  ...
  outC->_L166.nid_tsr = kcg_lit_int32(0);
  outC->_L166.d_tsr = kcg_lit_int32(0);
  outC->_L166.l_tsr = kcg_lit_int32(0);
  outC->_L166.q_front =
    Q_FRONT_Train_length_delay_on_validity_end_point_of_profile_element;
  outC->_L166.v_tsr = kcg_lit_int32(0);
  ...
  outC->P065_OBU_out.nid_tsr = kcg_lit_int32(0);
  outC->P065_OBU_out.d_tsr = kcg_lit_int32(0);
  outC->P065_OBU_out.l_tsr = kcg_lit_int32(0);
  outC->P065_OBU_out.q_front =
    Q_FRONT_Train_length_delay_on_validity_end_point_of_profile_element;
  outC->P065_OBU_out.v_tsr = kcg_lit_int32(0);
