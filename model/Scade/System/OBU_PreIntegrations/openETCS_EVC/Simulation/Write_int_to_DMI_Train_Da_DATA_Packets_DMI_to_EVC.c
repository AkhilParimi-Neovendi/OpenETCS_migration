...
void Write_int_to_DMI_Train_Da_DATA_Packets_DMI_to_EVC(
...
{
  DMI_Train_Data_Ack_T_DMI_Messages_DMI_to_EVC_Pkg op_call;
...
void Write_int_to_DMI_Train_Da_init_DATA_Packets_DMI_to_EVC(
  outC_Write_int_to_DMI_Train_Da_DATA_Packets_DMI_to_EVC *outC)
{
  kcg_size idx;
...
void Write_int_to_DMI_Train_Da_reset_DATA_Packets_DMI_to_EVC(
  outC_Write_int_to_DMI_Train_Da_DATA_Packets_DMI_to_EVC *outC)
{
  /* _L15=(DATA::Packets::DMI_to_EVC::C_int_to_DMI_Train_Data_Ack1#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Write_int_to_DMI_Train_Da_DATA_Packets_DMI_to_EVC.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
