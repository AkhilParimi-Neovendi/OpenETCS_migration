  ...
  outC_countDownTimer_MoRC_Pck_Utils *outC)
{
  ...
  kcg_bool tmp1;
  /* expired/ */
  kcg_bool expired_partial;
  /* expired_loc/ */
  kcg_bool expired_loc_partial;
  /* TimerStatus_SM: */
  SSM_ST_TimerStatus_SM TimerStatus_SM_state_nxt_partial;
  /* TimerStatus_SM: */
  kcg_bool TimerStatus_SM_reset_nxt_partial;
  /* TimerStatus_SM: */
  SSM_TR_TimerStatus_SM TimerStatus_SM_fired_partial;
  /* expired/ */
  kcg_bool _2_expired_partial;
  /* expired_loc/ */
  kcg_bool _3_expired_loc_partial;
  /* TimerStatus_SM: */
  SSM_ST_TimerStatus_SM _4_TimerStatus_SM_state_nxt_partial;
  /* TimerStatus_SM: */
  kcg_bool _5_TimerStatus_SM_reset_nxt_partial;
  /* TimerStatus_SM: */
  SSM_TR_TimerStatus_SM _6_TimerStatus_SM_fired_partial;
  /* TimerStatus_SM:Counting:<2> */
  kcg_bool tr_2_guard_Counting_TimerStatus_SM;
  /* TimerStatus_SM:Counting:<3> */
  kcg_bool tr_3_guard_Counting_TimerStatus_SM;
  /* TimerStatus_SM:Counting:<4> */
  kcg_bool tr_4_guard_Counting_TimerStatus_SM;
  /* TimerStatus_SM: */
  SSM_TR_TimerStatus_SM _7_TimerStatus_SM_fired_partial;
  /* TimerStatus_SM: */
  kcg_bool _8_TimerStatus_SM_reset_nxt_partial;
  /* TimerStatus_SM: */
  SSM_ST_TimerStatus_SM _9_TimerStatus_SM_state_nxt_partial;
  /* TimerStatus_SM: */
  SSM_TR_TimerStatus_SM _10_TimerStatus_SM_fired_partial;
  /* TimerStatus_SM: */
  kcg_bool _11_TimerStatus_SM_reset_nxt_partial;
  /* TimerStatus_SM: */
  SSM_ST_TimerStatus_SM _12_TimerStatus_SM_state_nxt_partial;
  /* expired/ */
  kcg_bool _13_expired_partial;
  /* expired_loc/ */
  kcg_bool _14_expired_loc_partial;
  /* TimerStatus_SM: */
  SSM_ST_TimerStatus_SM _15_TimerStatus_SM_state_nxt_partial;
  /* TimerStatus_SM: */
  kcg_bool _16_TimerStatus_SM_reset_nxt_partial;
  /* TimerStatus_SM: */
  SSM_TR_TimerStatus_SM _17_TimerStatus_SM_fired_partial;
  /* TimerStatus_SM:Expired:<2> */
  kcg_bool tr_2_guard_Expired_TimerStatus_SM;
  /* TimerStatus_SM: */
  SSM_ST_TimerStatus_SM TimerStatus_SM_state_act_partial;
  /* TimerStatus_SM: */
  kcg_bool TimerStatus_SM_reset_act_partial;
  /* TimerStatus_SM: */
  SSM_TR_TimerStatus_SM TimerStatus_SM_fired_strong_partial;
  /* TimerStatus_SM:Stopped:<2> */
  kcg_bool tr_2_guard_Stopped_TimerStatus_SM;
  /* TimerStatus_SM:Stopped:<1> */
  kcg_bool tr_1_guard_Stopped_TimerStatus_SM;
  /* TimerStatus_SM: */
  SSM_ST_TimerStatus_SM _18_TimerStatus_SM_state_act_partial;
  /* TimerStatus_SM: */
  kcg_bool _19_TimerStatus_SM_reset_act_partial;
  /* TimerStatus_SM: */
  SSM_TR_TimerStatus_SM _20_TimerStatus_SM_fired_strong_partial;
  /* TimerStatus_SM:Counting:<1> */
  kcg_bool tr_1_guard_Counting_TimerStatus_SM;
  /* TimerStatus_SM: */
  SSM_ST_TimerStatus_SM _21_TimerStatus_SM_state_act_partial;
  /* TimerStatus_SM: */
  kcg_bool _22_TimerStatus_SM_reset_act_partial;
  /* TimerStatus_SM: */
  SSM_TR_TimerStatus_SM _23_TimerStatus_SM_fired_strong_partial;
  /* TimerStatus_SM:Expired:<1> */
  kcg_bool tr_1_guard_Expired_TimerStatus_SM;
  /* TimerStatus_SM: */
  kcg_bool TimerStatus_SM_reset_sel;
  /* TimerStatus_SM: */
  kcg_bool TimerStatus_SM_reset_prv;
