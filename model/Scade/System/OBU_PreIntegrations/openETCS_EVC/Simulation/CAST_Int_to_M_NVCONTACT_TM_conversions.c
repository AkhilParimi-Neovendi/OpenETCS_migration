...
{
  /* m_nvcontact/ */
  M_NVCONTACT m_nvcontact_partial;
  /* error/ */
  kcg_bool error_partial;
  /* m_nvcontact/ */
  M_NVCONTACT _1_m_nvcontact_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* m_nvcontact/ */
  M_NVCONTACT _3_m_nvcontact_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* m_nvcontact/ */
  M_NVCONTACT _5_m_nvcontact_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* error/ */
  kcg_bool _7_error_partial;
  /* m_nvcontact/ */
  M_NVCONTACT _8_m_nvcontact_partial;
  /* error/ */
  kcg_bool _9_error_partial;
  /* m_nvcontact/ */
  M_NVCONTACT _10_m_nvcontact_partial;
  kcg_bool noname;
