...
{
  /* distance/ */
  kcg_float32 distance_partial;
  /* BG_ID/ */
  NID_BG BG_ID_partial;
  /* BGLocation/ */
  L_internal_Type_Obu_BasicTypes_Pkg BGLocation_partial;
  /* distance/ */
  kcg_float32 _1_distance_partial;
  /* BG_ID/ */
  NID_BG _2_BG_ID_partial;
  /* BGLocation/ */
  L_internal_Type_Obu_BasicTypes_Pkg _3_BGLocation_partial;
  /* BGLocation/ */
  L_internal_Type_Obu_BasicTypes_Pkg last_BGLocation;
  /* BG_ID/ */
  NID_BG last_BG_ID;
  /* distance/ */
  kcg_float32 last_distance;
