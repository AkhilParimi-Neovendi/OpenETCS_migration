...
#include "CAST_M_SUPERVISION_STATUS_DATA_Variables.h"

/* DATA::Variables::CAST_M_SUPERVISION_STATUS_to_int/ */
void CAST_M_SUPERVISION_STATUS_DATA_Variables(
  /* m_supervision_status_ct/ */
  M_SUPERVISION_STATUS_DMI_Types_Pkg m_supervision_status_ct,
  outC_CAST_M_SUPERVISION_STATUS_DATA_Variables *outC)
{
  /* m_supervision_status_int/ */
  M_SUPERVISION_STATUS_INT_T_DATA m_supervision_status_int_partial;
  /* error/ */
  kcg_bool error_partial;
  /* m_supervision_status_int/ */
  M_SUPERVISION_STATUS_INT_T_DATA _1_m_supervision_status_int_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* m_supervision_status_int/ */
  M_SUPERVISION_STATUS_INT_T_DATA _3_m_supervision_status_int_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* m_supervision_status_int/ */
  M_SUPERVISION_STATUS_INT_T_DATA _5_m_supervision_status_int_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* m_supervision_status_int/ */
  M_SUPERVISION_STATUS_INT_T_DATA _7_m_supervision_status_int_partial;
  /* error/ */
  kcg_bool _8_error_partial;
  /* m_supervision_status_int/ */
  M_SUPERVISION_STATUS_INT_T_DATA _9_m_supervision_status_int_partial;
  /* error/ */
  kcg_bool _10_error_partial;
  /* error/ */
  kcg_bool _11_error_partial;
  /* m_supervision_status_int/ */
  M_SUPERVISION_STATUS_INT_T_DATA _12_m_supervision_status_int_partial;
  /* error/ */
  kcg_bool _13_error_partial;
  /* m_supervision_status_int/ */
  M_SUPERVISION_STATUS_INT_T_DATA _14_m_supervision_status_int_partial;
  /* error/ */
  kcg_bool _15_error_partial;
  /* m_supervision_status_int/ */
  M_SUPERVISION_STATUS_INT_T_DATA _16_m_supervision_status_int_partial;
  /* error/ */
  kcg_bool _17_error_partial;
  /* m_supervision_status_int/ */
  M_SUPERVISION_STATUS_INT_T_DATA _18_m_supervision_status_int_partial;
  kcg_bool noname;
...
void CAST_M_SUPERVISION_STATUS_init_DATA_Variables(
  outC_CAST_M_SUPERVISION_STATUS_DATA_Variables *outC)
{
  outC->_L1 = kcg_true;
  outC->error = kcg_true;
...
void CAST_M_SUPERVISION_STATUS_reset_DATA_Variables(
  outC_CAST_M_SUPERVISION_STATUS_DATA_Variables *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_M_SUPERVISION_STATUS_DATA_Variables.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
