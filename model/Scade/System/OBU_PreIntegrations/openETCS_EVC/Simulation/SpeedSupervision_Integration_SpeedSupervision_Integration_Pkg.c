...
{
  kcg_bool noname;
  DataForSupervision_nextGen_t_TrackAtlasTypes _1_noname;
  TargetCollection_T_TargetManagement_types _2_noname;
  Target_T_TargetManagement_types _3_noname;
  speedSupervisionForDMI_T_DMI_Types_Pkg _4_noname;
  CurveCollection_T_CalcBrakingCurves_types _5_noname;
