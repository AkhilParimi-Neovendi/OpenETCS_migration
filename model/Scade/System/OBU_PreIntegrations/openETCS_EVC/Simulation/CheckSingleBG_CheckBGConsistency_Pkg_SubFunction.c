  ...
  outC_CheckSingleBG_CheckBGConsistency_Pkg_SubFunction *outC)
{
  ...
  /* isSingleBG/ */
  kcg_bool _1_isSingleBG_partial;
  /* isSingleBG/ */
  kcg_bool _2_isSingleBG_partial;
  /* isSingleBG/ */
  kcg_bool _3_isSingleBG_partial;
  ...
  outC_CheckSingleBG_CheckBGConsistency_Pkg_SubFunction *outC)
{
  ...
  outC->_L13_then_else_IfBlock1.telegramheader.m_mcount = kcg_lit_int32(0);
  outC->_L13_then_else_IfBlock1.telegramheader.nid_c = kcg_lit_int32(0);
  outC->_L13_then_else_IfBlock1.telegramheader.nid_bg = kcg_lit_int32(0);
  ...
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L13_then_else_IfBlock1.packets.PacketData[idx3] = kcg_lit_int32(0);
  }
  outC->_L14_then_else_IfBlock1 = N_PIG_I_am_the_1st;
