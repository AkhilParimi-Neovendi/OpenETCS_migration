...
{
  array_int32_990 tmp;
  array_int32_987 tmp1;
  array_int32_978 tmp2;
  array_int32_975 tmp3;
  array_int32_964 tmp4;
  array_int32_961 tmp5;
  array_int32_894 tmp6;
  array_int32_891 tmp7;
  array_int32_888 tmp8;
  array_int32_627 tmp9;
  array_int32_302 tmp10;
  array_int32_40 tmp11;
  array_int32_31 tmp12;
  array_int32_28 tmp13;
  array_int32_25 tmp14;
  ...
  Write_DMI_Driver_Identifi_DATA_Packets_Bothways(
    &outC->_L2,
  ...
  Write_DMI_Adhesion_Factor_DATA_Packets_Bothways(
    &outC->_L33,
    &outC->Context_Write_DMI_Adhesion_Factor_Data_to_int_2);
  kcg_copy__15_DMI_Adhesion_Factor_Data_int_array_T_DATA(
    &outC->_L49,
  ...
  Write_DMI_Train_Running_N_DATA_Packets_Bothways(
    &outC->_L35,
  ...
  Write_DMI_EVC_Radio_Net_D_DATA_Packets_EVC_to_DMI(
    &outC->_L3,
  ...
  Write_DMI_EVC_Level_Data__DATA_Packets_EVC_to_DMI(
    &outC->_L4,
  ...
  Write_DMI_Display_Control_DATA_Packets_EVC_to_DMI(
    &outC->_L5,
  ...
  Write_DMI_System_Version__DATA_Packets_EVC_to_DMI(
    &outC->_L6,
  ...
  Write_DMI_Identifier_Requ_DATA_Packets_EVC_to_DMI(
    &outC->_L7,
    &outC->Context_Write_DMI_Identifier_Request_to_int_1);
  kcg_copy__12_DMI_Identifier_Request_int_array_T_DATA(
    &outC->_L42,
  ...
  Write_DMI_Track_Descripti_DATA_Packets_EVC_to_DMI(
    &outC->_L8,
  ...
  Write_DMI_EVC_Coded_Train_DATA_Packets_EVC_to_DMI(
    &outC->_L10,
  ...
  Write_DMI_Entry_Request_t_DATA_Packets_EVC_to_DMI(
    &outC->_L11,
  ...
  kcg_copy__11_DMI_EVC_Coded_Train_Data_int_array_T_DATA(&tmp11[31], &outC->_L39);
  ...
  kcg_copy__12_DMI_Identifier_Request_int_array_T_DATA(&tmp8[627], &outC->_L42);
  ...
  kcg_copy__13_DMI_EVC_Radio_Net_Data_int_array_T_DATA(&tmp4[961], &outC->_L46);
  ...
  kcg_copy__14_DMI_Train_Running_Number_int_array_T_DATA(&tmp2[975], &outC->_L47);
  ...
  kcg_copy__15_DMI_Adhesion_Factor_Data_int_array_T_DATA(&tmp[987], &outC->_L49);
  ...
  outC_CAST_EVC_to_DMI_to_int_Messages *outC)
{
  ...
  Write_DMI_Menu_Request_to_int_init_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_Menu_Request_to_int_1);
  /* _L38=(DATA::Packets::EVC_to_DMI::Write_DMI_Entry_Request_to_int#1)/ */
  Write_DMI_Entry_Request_t_init_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_Entry_Request_to_int_1);
  /* _L39=(DATA::Packets::EVC_to_DMI::Write_DMI_EVC_Coded_Train_Data_to_int#1)/ */
  Write_DMI_EVC_Coded_Train_init_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_EVC_Coded_Train_Data_to_int_1);
  /* _L40=(DATA::Packets::EVC_to_DMI::Write_DMI_Text_Message_to_int#1)/ */
  Write_DMI_Text_Message_to_int_init_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_Text_Message_to_int_1);
  /* _L41=(DATA::Packets::EVC_to_DMI::Write_DMI_Track_Description_to_int#1)/ */
  Write_DMI_Track_Descripti_init_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_Track_Description_to_int_1);
  /* _L42=(DATA::Packets::EVC_to_DMI::Write_DMI_Identifier_Request_to_int#1)/ */
  Write_DMI_Identifier_Requ_init_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_Identifier_Request_to_int_1);
  /* _L43=(DATA::Packets::EVC_to_DMI::Write_DMI_System_Version_to_int#1)/ */
  Write_DMI_System_Version__init_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_System_Version_to_int_1);
  /* _L44=(DATA::Packets::EVC_to_DMI::Write_DMI_Display_Control_to_int#1)/ */
  Write_DMI_Display_Control_init_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_Display_Control_to_int_1);
  /* _L45=(DATA::Packets::EVC_to_DMI::Write_DMI_EVC_Level_Data_to_int#1)/ */
  Write_DMI_EVC_Level_Data__init_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_EVC_Level_Data_to_int_1);
  /* _L46=(DATA::Packets::EVC_to_DMI::Write_DMI_EVC_Radio_Net_Data_to_int#1)/ */
  Write_DMI_EVC_Radio_Net_D_init_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_EVC_Radio_Net_Data_to_int_1);
  /* _L47=(DATA::Packets::Bothways::Write_DMI_Train_Running_Number_to_int#2)/ */
  Write_DMI_Train_Running_N_init_DATA_Packets_Bothways(
    &outC->Context_Write_DMI_Train_Running_Number_to_int_2);
  /* _L48=(DATA::Packets::Bothways::Write_DMI_Train_Data_to_int#2)/ */
  Write_DMI_Train_Data_to_int_init_DATA_Packets_Bothways(
    &outC->Context_Write_DMI_Train_Data_to_int_2);
  /* _L49=(DATA::Packets::Bothways::Write_DMI_Adhesion_Factor_Data_to_int#2)/ */
  Write_DMI_Adhesion_Factor_init_DATA_Packets_Bothways(
    &outC->Context_Write_DMI_Adhesion_Factor_Data_to_int_2);
  /* _L50=(DATA::Packets::EVC_to_DMI::Write_DMI_Icons_to_int#1)/ */
  Write_DMI_Icons_to_int_init_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_Icons_to_int_1);
  /* _L51=(DATA::Packets::Bothways::Write_DMI_Driver_Identifier_to_int#2)/ */
  Write_DMI_Driver_Identifi_init_DATA_Packets_Bothways(
    &outC->Context_Write_DMI_Driver_Identifier_to_int_2);
}
  ...
  outC_CAST_EVC_to_DMI_to_int_Messages *outC)
{
  ...
  Write_DMI_Menu_Request_to_int_reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_Menu_Request_to_int_1);
  /* _L38=(DATA::Packets::EVC_to_DMI::Write_DMI_Entry_Request_to_int#1)/ */
  Write_DMI_Entry_Request_t_reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_Entry_Request_to_int_1);
  /* _L39=(DATA::Packets::EVC_to_DMI::Write_DMI_EVC_Coded_Train_Data_to_int#1)/ */
  Write_DMI_EVC_Coded_Train_reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_EVC_Coded_Train_Data_to_int_1);
  /* _L40=(DATA::Packets::EVC_to_DMI::Write_DMI_Text_Message_to_int#1)/ */
  Write_DMI_Text_Message_to_int_reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_Text_Message_to_int_1);
  /* _L41=(DATA::Packets::EVC_to_DMI::Write_DMI_Track_Description_to_int#1)/ */
  Write_DMI_Track_Descripti_reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_Track_Description_to_int_1);
  /* _L42=(DATA::Packets::EVC_to_DMI::Write_DMI_Identifier_Request_to_int#1)/ */
  Write_DMI_Identifier_Requ_reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_Identifier_Request_to_int_1);
  /* _L43=(DATA::Packets::EVC_to_DMI::Write_DMI_System_Version_to_int#1)/ */
  Write_DMI_System_Version__reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_System_Version_to_int_1);
  /* _L44=(DATA::Packets::EVC_to_DMI::Write_DMI_Display_Control_to_int#1)/ */
  Write_DMI_Display_Control_reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_Display_Control_to_int_1);
  /* _L45=(DATA::Packets::EVC_to_DMI::Write_DMI_EVC_Level_Data_to_int#1)/ */
  Write_DMI_EVC_Level_Data__reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_EVC_Level_Data_to_int_1);
  /* _L46=(DATA::Packets::EVC_to_DMI::Write_DMI_EVC_Radio_Net_Data_to_int#1)/ */
  Write_DMI_EVC_Radio_Net_D_reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_EVC_Radio_Net_Data_to_int_1);
  /* _L47=(DATA::Packets::Bothways::Write_DMI_Train_Running_Number_to_int#2)/ */
  Write_DMI_Train_Running_N_reset_DATA_Packets_Bothways(
    &outC->Context_Write_DMI_Train_Running_Number_to_int_2);
  /* _L48=(DATA::Packets::Bothways::Write_DMI_Train_Data_to_int#2)/ */
  Write_DMI_Train_Data_to_int_reset_DATA_Packets_Bothways(
    &outC->Context_Write_DMI_Train_Data_to_int_2);
  /* _L49=(DATA::Packets::Bothways::Write_DMI_Adhesion_Factor_Data_to_int#2)/ */
  Write_DMI_Adhesion_Factor_reset_DATA_Packets_Bothways(
    &outC->Context_Write_DMI_Adhesion_Factor_Data_to_int_2);
  /* _L50=(DATA::Packets::EVC_to_DMI::Write_DMI_Icons_to_int#1)/ */
  Write_DMI_Icons_to_int_reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_Write_DMI_Icons_to_int_1);
  /* _L51=(DATA::Packets::Bothways::Write_DMI_Driver_Identifier_to_int#2)/ */
  Write_DMI_Driver_Identifi_reset_DATA_Packets_Bothways(
    &outC->Context_Write_DMI_Driver_Identifier_to_int_2);
}
