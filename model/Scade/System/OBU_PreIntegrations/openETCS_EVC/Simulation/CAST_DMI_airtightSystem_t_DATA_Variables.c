...
void CAST_DMI_airtightSystem_t_DATA_Variables(
...
void CAST_DMI_airtightSystem_t_init_DATA_Variables(
  outC_CAST_DMI_airtightSystem_t_DATA_Variables *outC)
{
  outC->_L41 = kcg_true;
...
void CAST_DMI_airtightSystem_t_reset_DATA_Variables(
  outC_CAST_DMI_airtightSystem_t_DATA_Variables *outC)
{
  /* _L23=(Utilities::BCD_to_Int#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_airtightSystem_t_DATA_Variables.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
