...
void Write_int_to_DMI_Train_Ru_DATA_Packets_Bothways(
...
{
  DMI_Train_Running_Number_T_DMI_Messages_Bothways_Pkg op_call;
  ...
  if (outC->every) {
    ...
    C_int_to_DMI_Train_Runnin_DATA_Packets_Bothways(
      &outC->_L8,
...
void Write_int_to_DMI_Train_Ru_init_DATA_Packets_Bothways(
  outC_Write_int_to_DMI_Train_Ru_DATA_Packets_Bothways *outC)
{
  kcg_size idx;
  ...
  /* _L10=(DATA::Packets::Bothways::C_int_to_DMI_Train_Running_Number#1)/ */
  C_int_to_DMI_Train_Runnin_init_DATA_Packets_Bothways(
    &outC->Context_C_int_to_DMI_Train_Running_Number_1);
}
...
void Write_int_to_DMI_Train_Ru_reset_DATA_Packets_Bothways(
  outC_Write_int_to_DMI_Train_Ru_DATA_Packets_Bothways *outC)
{
  /* _L10=(DATA::Packets::Bothways::C_int_to_DMI_Train_Running_Number#1)/ */
  C_int_to_DMI_Train_Runnin_reset_DATA_Packets_Bothways(
    &outC->Context_C_int_to_DMI_Train_Running_Number_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Write_int_to_DMI_Train_Ru_DATA_Packets_Bothways.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
