...
typedef struct {
  ...
  outC_validateDataDirection_General_ValidateDataDirectionGeneral_Pkg /* IfBlock1:else:then:IfBlock2:else:_L55=(ValidateDataDirectionGeneral_Pkg::validateDataDirection_General#6)/ */ _1_Context_validateDataDirection_General_6;
  ...
  outC_getLRBGForRadioMessage_ValidateDataDirectionGeneral_Pkg_Subfunctions /* IfBlock1:else:then:_L22=(ValidateDataDirectionGeneral_Pkg::Subfunctions::getLRBGForRadioMessage#10)/ */ _2_Context_getLRBGForRadioMessage_10;
