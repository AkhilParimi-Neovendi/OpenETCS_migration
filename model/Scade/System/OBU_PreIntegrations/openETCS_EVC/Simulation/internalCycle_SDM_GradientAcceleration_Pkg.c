  ...
  outC_internalCycle_SDM_GradientAcceleration_Pkg *outC)
{
  ...
  kcg_size idx1;
  kcg_size idx2;
  Gradient_real_t_SDM_GradientAcceleration_types acc;
  kcg_size idx3;
  kcg_int32 noname;
  ...
  if (outC->_L48) {
    ...
    for (idx3 = 0; idx3 < 50; idx3++) {
      ...
      outC->_L46 = /* _L46= */(kcg_int32) (idx3 + 1);
      /* _L46= */
  ...
  outC_internalCycle_SDM_GradientAcceleration_Pkg *outC)
{
  ...
  outC->_L117 = kcg_lit_int32(0);
  outC->_L116.location = kcg_lit_float32(0.0);
  outC->_L116.gradient = kcg_lit_float32(0.0);
  outC->_L116.valid = kcg_true;
  for (idx1 = 0; idx1 < 100; idx1++) {
    outC->_L115[idx1].location = kcg_lit_float32(0.0);
    outC->_L115[idx1].gradient = kcg_lit_float32(0.0);
    outC->_L115[idx1].valid = kcg_true;
  }
  outC->_L112 = kcg_lit_int32(0);
  outC->_L108 = kcg_lit_int32(0);
  outC->_L109.frontPos = kcg_lit_float32(0.0);
  outC->_L109.frontIndex = kcg_lit_int32(0);
  outC->_L109.rearPos = kcg_lit_float32(0.0);
  outC->_L109.rearIndex = kcg_lit_int32(0);
  for (idx2 = 0; idx2 < 100; idx2++) {
    outC->_L109.compensatedGradientProfile[idx2].location = kcg_lit_float32(0.0);
    outC->_L109.compensatedGradientProfile[idx2].gradient = kcg_lit_float32(0.0);
    outC->_L109.compensatedGradientProfile[idx2].valid = kcg_true;
  }
  outC->_L105 = kcg_lit_int32(0);
  outC->_L104.frontPos = kcg_lit_float32(0.0);
  outC->_L104.frontIndex = kcg_lit_int32(0);
  outC->_L104.rearPos = kcg_lit_float32(0.0);
  outC->_L104.rearIndex = kcg_lit_int32(0);
  for (idx3 = 0; idx3 < 100; idx3++) {
    outC->_L104.compensatedGradientProfile[idx3].location = kcg_lit_float32(0.0);
    outC->_L104.compensatedGradientProfile[idx3].gradient = kcg_lit_float32(0.0);
    outC->_L104.compensatedGradientProfile[idx3].valid = kcg_true;
  }
  outC->_L99 = kcg_true;
  outC->_L94 = kcg_lit_float32(0.0);
  for (idx4 = 0; idx4 < 50; idx4++) {
    outC->_L92[idx4].location = kcg_lit_float32(0.0);
    outC->_L92[idx4].gradient = kcg_lit_float32(0.0);
    outC->_L92[idx4].valid = kcg_true;
  }
  outC->_L88 = kcg_true;
  outC->_L83 = kcg_lit_int32(0);
  outC->_L80.frontPos = kcg_lit_float32(0.0);
  outC->_L80.frontIndex = kcg_lit_int32(0);
  outC->_L80.rearPos = kcg_lit_float32(0.0);
  outC->_L80.rearIndex = kcg_lit_int32(0);
  for (idx5 = 0; idx5 < 100; idx5++) {
    outC->_L80.compensatedGradientProfile[idx5].location = kcg_lit_float32(0.0);
    outC->_L80.compensatedGradientProfile[idx5].gradient = kcg_lit_float32(0.0);
    outC->_L80.compensatedGradientProfile[idx5].valid = kcg_true;
  }
  outC->_L78 = kcg_lit_float32(0.0);
  outC->_L79 = kcg_lit_float32(0.0);
  outC->_L75 = kcg_true;
  outC->_L76 = kcg_lit_float32(0.0);
  outC->_L77 = kcg_true;
  outC->_L73 = kcg_lit_int32(0);
  outC->_L74 = kcg_lit_int32(0);
  outC->_L60.frontPos = kcg_lit_float32(0.0);
  outC->_L60.frontIndex = kcg_lit_int32(0);
  outC->_L60.rearPos = kcg_lit_float32(0.0);
  outC->_L60.rearIndex = kcg_lit_int32(0);
  for (idx6 = 0; idx6 < 100; idx6++) {
    outC->_L60.compensatedGradientProfile[idx6].location = kcg_lit_float32(0.0);
    outC->_L60.compensatedGradientProfile[idx6].gradient = kcg_lit_float32(0.0);
    outC->_L60.compensatedGradientProfile[idx6].valid = kcg_true;
  }
  outC->_L53.frontPos = kcg_lit_float32(0.0);
  outC->_L53.frontIndex = kcg_lit_int32(0);
  outC->_L53.rearPos = kcg_lit_float32(0.0);
  outC->_L53.rearIndex = kcg_lit_int32(0);
  for (idx7 = 0; idx7 < 100; idx7++) {
    outC->_L53.compensatedGradientProfile[idx7].location = kcg_lit_float32(0.0);
    outC->_L53.compensatedGradientProfile[idx7].gradient = kcg_lit_float32(0.0);
    outC->_L53.compensatedGradientProfile[idx7].valid = kcg_true;
  }
  for (idx8 = 0; idx8 < 50; idx8++) {
    outC->_L52[idx8] = kcg_lit_int32(0);
  }
  ...
  for (idx11 = 0; idx11 < 50; idx11++) {
    for (idx10 = 0; idx10 < 50; idx10++) {
      outC->_L50[idx11][idx10].location = kcg_lit_float32(0.0);
      outC->_L50[idx11][idx10].gradient = kcg_lit_float32(0.0);
      outC->_L50[idx11][idx10].valid = kcg_true;
    }
  }
  for (idx12 = 0; idx12 < 50; idx12++) {
    outC->_L49[idx12].location = kcg_lit_float32(0.0);
    outC->_L49[idx12].gradient = kcg_lit_float32(0.0);
    outC->_L49[idx12].valid = kcg_true;
  }
  outC->_L48 = kcg_true;
  outC->_L46 = kcg_lit_int32(0);
  outC->_L45 = kcg_lit_float32(0.0);
  outC->_L41.frontPos = kcg_lit_float32(0.0);
  outC->_L41.frontIndex = kcg_lit_int32(0);
  outC->_L41.rearPos = kcg_lit_float32(0.0);
  outC->_L41.rearIndex = kcg_lit_int32(0);
  for (idx13 = 0; idx13 < 100; idx13++) {
    outC->_L41.compensatedGradientProfile[idx13].location = kcg_lit_float32(0.0);
    outC->_L41.compensatedGradientProfile[idx13].gradient = kcg_lit_float32(0.0);
    outC->_L41.compensatedGradientProfile[idx13].valid = kcg_true;
  }
  outC->_L26.frontPos = kcg_lit_float32(0.0);
  outC->_L26.frontIndex = kcg_lit_int32(0);
  outC->_L26.rearPos = kcg_lit_float32(0.0);
  outC->_L26.rearIndex = kcg_lit_int32(0);
  for (idx14 = 0; idx14 < 100; idx14++) {
    outC->_L26.compensatedGradientProfile[idx14].location = kcg_lit_float32(0.0);
    outC->_L26.compensatedGradientProfile[idx14].gradient = kcg_lit_float32(0.0);
    outC->_L26.compensatedGradientProfile[idx14].valid = kcg_true;
  }
  for (idx15 = 0; idx15 < 50; idx15++) {
    outC->_L13[idx15].location = kcg_lit_float32(0.0);
    outC->_L13[idx15].gradient = kcg_lit_float32(0.0);
    outC->_L13[idx15].valid = kcg_true;
  }
  outC->_L9 = kcg_lit_float32(0.0);
  outC->AccuOut.frontPos = kcg_lit_float32(0.0);
  outC->AccuOut.frontIndex = kcg_lit_int32(0);
  outC->AccuOut.rearPos = kcg_lit_float32(0.0);
  outC->AccuOut.rearIndex = kcg_lit_int32(0);
  for (idx16 = 0; idx16 < 100; idx16++) {
    outC->AccuOut.compensatedGradientProfile[idx16].location = kcg_lit_float32(0.0);
    outC->AccuOut.compensatedGradientProfile[idx16].gradient = kcg_lit_float32(0.0);
