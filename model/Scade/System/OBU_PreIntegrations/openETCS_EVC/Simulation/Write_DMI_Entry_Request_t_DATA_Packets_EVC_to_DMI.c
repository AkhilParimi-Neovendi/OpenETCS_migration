...
void Write_DMI_Entry_Request_t_DATA_Packets_EVC_to_DMI(
...
{
  DMI_Entry_Request_int_array_T_DATA op_call;
  ...
  if (outC->every) {
    ...
    CAST_DMI_Entry_Request_to_DATA_Packets_EVC_to_DMI(
      &outC->_L1,
...
void Write_DMI_Entry_Request_t_init_DATA_Packets_EVC_to_DMI(
  outC_Write_DMI_Entry_Request_t_DATA_Packets_EVC_to_DMI *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx2 = 0; idx2 < 3; idx2++) {
    outC->dmi_entry_request_int[idx2] = kcg_lit_int32(0);
  }
  /* _L8=(DATA::Packets::EVC_to_DMI::CAST_DMI_Entry_Request_to_int1#1)/ */
  CAST_DMI_Entry_Request_to_init_DATA_Packets_EVC_to_DMI(
    &outC->Context_CAST_DMI_Entry_Request_to_int1_1);
}
...
void Write_DMI_Entry_Request_t_reset_DATA_Packets_EVC_to_DMI(
  outC_Write_DMI_Entry_Request_t_DATA_Packets_EVC_to_DMI *outC)
{
  /* _L8=(DATA::Packets::EVC_to_DMI::CAST_DMI_Entry_Request_to_int1#1)/ */
  CAST_DMI_Entry_Request_to_reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_CAST_DMI_Entry_Request_to_int1_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Write_DMI_Entry_Request_t_DATA_Packets_EVC_to_DMI.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
