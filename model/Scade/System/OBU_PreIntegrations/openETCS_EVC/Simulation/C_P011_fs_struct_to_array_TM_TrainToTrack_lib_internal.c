...
void C_P011_fs_struct_to_array_TM_TrainToTrack_lib_internal(
  /* section/ */
...
void C_P011_fs_struct_to_array_init_TM_TrainToTrack_lib_internal(
  outC_C_P011_fs_struct_to_array_TM_TrainToTrack_lib_internal *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void C_P011_fs_struct_to_array_reset_TM_TrainToTrack_lib_internal(
  outC_C_P011_fs_struct_to_array_TM_TrainToTrack_lib_internal *outC)
{
  /* _L13=(TM_conversions::CAST_M_VOLTAGE_to_int#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** C_P011_fs_struct_to_array_TM_TrainToTrack_lib_internal.c
** Generation date: 2023-11-06T13:54:30
*************************************************************$ */
