...
void Exception0102StoreOnboard_InformationFilter_Pkg_FirstFilter(
...
void Exception0102StoreOnboard_init_InformationFilter_Pkg_FirstFilter(
  outC_Exception0102StoreOnboard_InformationFilter_Pkg_FirstFilter *outC)
{
  outC->_L8 = kcg_true;
  outC->_L7 = kcg_true;
...
void Exception0102StoreOnboard_reset_InformationFilter_Pkg_FirstFilter(
  outC_Exception0102StoreOnboard_InformationFilter_Pkg_FirstFilter *outC)
{
  /* _L1=(InformationFilter_Pkg::FirstFilter::Exception01StoreOnboardIfPendingL1Transition#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Exception0102StoreOnboard_InformationFilter_Pkg_FirstFilter.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
