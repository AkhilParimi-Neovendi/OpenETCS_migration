  ...
  outC_SearchIndexInGradientProfile_SDM_GradientAcceleration_Pkg *outC)
{
  ...
  if (outC->_L6) {
    ...
    for (idx2 = 0; idx2 < 50; idx2++) {
      ...
      SearchIndexInGradientprof_SDM_GradientAcceleration_Pkg(
        /* _L3= */(kcg_int32) idx2,
        acc,
        outC->_L8[idx2],
        &outC->_L9[idx2],
  ...
  outC_SearchIndexInGradientProfile_SDM_GradientAcceleration_Pkg *outC)
{
  ...
  for (idx = 0; idx < 50; idx++) {
    /* _L3=(SDM_GradientAcceleration_Pkg::SearchIndexInGradientprofileInternal#1)/ */
    SearchIndexInGradientprof_init_SDM_GradientAcceleration_Pkg(
  ...
  outC_SearchIndexInGradientProfile_SDM_GradientAcceleration_Pkg *outC)
{
  ...
  for (idx = 0; idx < 50; idx++) {
    /* _L3=(SDM_GradientAcceleration_Pkg::SearchIndexInGradientprofileInternal#1)/ */
    SearchIndexInGradientprof_reset_SDM_GradientAcceleration_Pkg(
      &outC->Context_SearchIndexInGradientprofileInternal_1[idx]);
  }
}
