...
#include "extractPositionReportFrom_RCM_Utils_Pkg_encoders.h"

/* RCM_Utils_Pkg::encoders::extractPositionReportFromBus_itr/ */
void extractPositionReportFrom_RCM_Utils_Pkg_encoders(
  /* i/ */
  kcg_int32 i,
  /* acc_in/ */
  kcg_int32 acc_in,
...
void extractPositionReportFrom_init_RCM_Utils_Pkg_encoders(
  outC_extractPositionReportFrom_RCM_Utils_Pkg_encoders *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void extractPositionReportFrom_reset_RCM_Utils_Pkg_encoders(
  outC_extractPositionReportFrom_RCM_Utils_Pkg_encoders *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** extractPositionReportFrom_RCM_Utils_Pkg_encoders.c
** Generation date: 2023-11-06T13:54:31
*************************************************************$ */
