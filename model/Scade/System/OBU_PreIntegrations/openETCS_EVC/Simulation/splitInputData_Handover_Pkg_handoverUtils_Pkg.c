  ...
  outC_splitInputData_Handover_Pkg_handoverUtils_Pkg *outC)
{
  ...
  msgFromTrack_T_RCM_MsgTypes_Pkg dataFromHandingOverMobile_partial;
  /* dataFromAcceptingMobile/ */
  msgFromTrack_T_RCM_MsgTypes_Pkg dataFromAcceptingMobile_partial;
  /* dataFromBalise/ */
  msgFromTrack_T_RCM_MsgTypes_Pkg dataFromBalise_partial;
  /* dataFromTrack_out/ */
  msgFromTrack_T_RCM_MsgTypes_Pkg dataFromTrack_out_partial;
  /* morcStatusFromHandingOverMobile/ */
  morcStatus_T_RCM_Session_Types_Pkg morcStatusFromHandingOverMobile_partial;
  /* morcStatusFromAcceptingMobile/ */
  morcStatus_T_RCM_Session_Types_Pkg morcStatusFromAcceptingMobile_partial;
  /* dataFromHandingOverMobile/ */
  msgFromTrack_T_RCM_MsgTypes_Pkg _1_dataFromHandingOverMobile_partial;
  /* dataFromAcceptingMobile/ */
  msgFromTrack_T_RCM_MsgTypes_Pkg _2_dataFromAcceptingMobile_partial;
  /* dataFromBalise/ */
  msgFromTrack_T_RCM_MsgTypes_Pkg _3_dataFromBalise_partial;
  /* dataFromTrack_out/ */
  msgFromTrack_T_RCM_MsgTypes_Pkg _4_dataFromTrack_out_partial;
  /* morcStatusFromHandingOverMobile/ */
  morcStatus_T_RCM_Session_Types_Pkg _5_morcStatusFromHandingOverMobile_partial;
  /* morcStatusFromAcceptingMobile/ */
  morcStatus_T_RCM_Session_Types_Pkg _6_morcStatusFromAcceptingMobile_partial;
