  ...
  outC_checkInit_Receive_TrackSide_Msg_Pkg *outC)
{
  ...
  /* outCollector/ */
  BGCollector_T_Receive_TrackSide_Msg_Pkg _1_outCollector_partial;
  ...
  outC_checkInit_Receive_TrackSide_Msg_Pkg *outC)
{
  ...
  outC->_L8.C_ID = kcg_lit_int32(0);
  outC->_L8.BG_ID = kcg_lit_int32(0);
  outC->_L8.balisePosition.odometerOfBaliseDetection.valid = kcg_true;
  outC->_L8.balisePosition.odometerOfBaliseDetection.timestamp = kcg_lit_int32(0);
  outC->_L8.balisePosition.odometerOfBaliseDetection.odo.o_nominal =
    kcg_lit_int32(0);
  outC->_L8.balisePosition.odometerOfBaliseDetection.odo.o_min = kcg_lit_int32(0);
  outC->_L8.balisePosition.odometerOfBaliseDetection.odo.o_max = kcg_lit_int32(0);
  ...
  outC->_L8.positionFirstContact.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int32(0);
  outC->_L8.collectedTelegrams = kcg_lit_int32(0);
  outC->_L8.totalTelegrams = kcg_lit_int32(0);
  outC->_L6 = kcg_true;
  outC->_L4 = kcg_lit_int32(0);
  ...
  outC->_L19_else_IfBlock1.telegramheader.m_mcount = kcg_lit_int32(0);
  outC->_L19_else_IfBlock1.telegramheader.nid_c = kcg_lit_int32(0);
  outC->_L19_else_IfBlock1.telegramheader.nid_bg = kcg_lit_int32(0);
  ...
  for (idx1 = 0; idx1 < 500; idx1++) {
    outC->_L19_else_IfBlock1.packets.PacketData[idx1] = kcg_lit_int32(0);
  }
  outC->_L20_else_IfBlock1.badBaliseFlag = kcg_true;
  outC->_L20_else_IfBlock1.BGMessageSent = kcg_true;
  outC->_L20_else_IfBlock1.C_ID = kcg_lit_int32(0);
  outC->_L20_else_IfBlock1.BG_ID = kcg_lit_int32(0);
  ...
  outC->_L20_else_IfBlock1.positionFirstContact.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int32(0);
  outC->_L20_else_IfBlock1.collectedTelegrams = kcg_lit_int32(0);
  outC->_L20_else_IfBlock1.totalTelegrams = kcg_lit_int32(0);
  outC->_L1_then_IfBlock1.badBaliseFlag = kcg_true;
  outC->_L1_then_IfBlock1.BGMessageSent = kcg_true;
  outC->_L1_then_IfBlock1.C_ID = kcg_lit_int32(0);
  outC->_L1_then_IfBlock1.BG_ID = kcg_lit_int32(0);
  ...
  outC->_L1_then_IfBlock1.positionFirstContact.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int32(0);
  outC->_L1_then_IfBlock1.collectedTelegrams = kcg_lit_int32(0);
  outC->_L1_then_IfBlock1.totalTelegrams = kcg_lit_int32(0);
