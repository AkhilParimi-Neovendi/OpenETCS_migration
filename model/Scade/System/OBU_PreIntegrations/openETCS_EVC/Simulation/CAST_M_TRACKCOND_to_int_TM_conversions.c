...
{
  /* m_trackcond_int/ */
  kcg_int32 m_trackcond_int_partial;
  /* error/ */
  kcg_bool error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _1_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _3_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _5_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _7_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _8_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _9_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _10_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _11_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _12_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _13_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _14_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _15_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _16_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _17_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _18_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _19_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _20_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _21_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _22_error_partial;
  /* error/ */
  kcg_bool _23_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _24_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _25_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _26_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _27_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _28_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _29_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _30_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _31_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _32_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _33_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _34_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _35_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _36_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _37_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _38_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _39_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _40_m_trackcond_int_partial;
  /* error/ */
  kcg_bool _41_error_partial;
  /* m_trackcond_int/ */
  kcg_int32 _42_m_trackcond_int_partial;
  kcg_bool noname;
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      if (outC->else_clock_else_IfBlock1) {
        ...
        outC->else_clock_else_else_IfBlock1 = outC->m_trackcond_in ==
          _61_ENUM_M_TRACKCOND_Powerless_section_switch_off_the_main_power_switch_TM_conversions;
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              outC->_L412_then_else_else_else_else_else_IfBlock1 = kcg_false;
              _33_error_partial = outC->_L412_then_else_else_else_else_else_IfBlock1;
              _10_error_partial = _33_error_partial;
            }
            else {
              outC->_5_else_clock_else_else_else_else_else_IfBlock1 =
                outC->m_trackcond_in ==
              ...
              if (outC->_5_else_clock_else_else_else_else_else_IfBlock1) {
                ...
                outC->_1_else_clock_else_else_else_else_else_else_IfBlock1 =
                  outC->m_trackcond_in ==
                  _62_ENUM_M_TRACKCOND_Switch_off_eddy_current_brake_for_service_brake_TM_conversions;
                /* IfBlock1:else:else:else:else:else:else:else: */
                if (outC->_1_else_clock_else_else_else_else_else_else_IfBlock1) {
                  outC->_L410_then_else_else_else_else_else_else_else_IfBlock1 = kcg_false;
                  _29_error_partial =
                    outC->_L410_then_else_else_else_else_else_else_else_IfBlock1;
                  _14_error_partial = _29_error_partial;
                }
                else {
                  outC->_4_else_clock_else_else_else_else_else_else_else_IfBlock1 =
                    outC->m_trackcond_in ==
                  ...
                  if (outC->_4_else_clock_else_else_else_else_else_else_else_IfBlock1) {
                    ...
                    if (outC->_2_else_clock_else_else_else_else_else_else_else_else_IfBlock1) {
                      outC->_L48_then_else_else_else_else_else_else_else_else_else_IfBlock1 =
                        kcg_false;
                      _25_error_partial =
                        outC->_L48_then_else_else_else_else_else_else_else_else_else_IfBlock1;
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      if (outC->else_clock_else_IfBlock1) {
        outC->_L2_then_else_else_IfBlock1 =
          _65_INT_M_TRACKCOND_Powerless_section_Lower_pantograph_TM_conversions;
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            /* IfBlock1:else:else:else:else:else: */
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              outC->_L211_then_else_else_else_else_else_IfBlock1 =
                INT_M_TRACKCOND_Sound_horn_TM_conversions;
              _34_m_trackcond_int_partial =
                outC->_L211_then_else_else_else_else_else_IfBlock1;
              ...
              if (outC->_5_else_clock_else_else_else_else_else_IfBlock1) {
                outC->_L2_then_else_else_else_else_else_else_IfBlock1 =
                  _64_INT_M_TRACKCOND_Switch_off_eddy_current_brake_for_emergency_brake_TM_conversions;
                ...
                /* IfBlock1:else:else:else:else:else:else:else: */
                if (outC->_1_else_clock_else_else_else_else_else_else_IfBlock1) {
                  outC->_L29_then_else_else_else_else_else_else_else_IfBlock1 =
                  ...
                  if (outC->_4_else_clock_else_else_else_else_else_else_else_IfBlock1) {
                    ...
                    /* IfBlock1:else:else:else:else:else:else:else:else:else: */
                    if (outC->_2_else_clock_else_else_else_else_else_else_else_else_IfBlock1) {
                      outC->_L27_then_else_else_else_else_else_else_else_else_else_IfBlock1 =
                      ...
                      /* IfBlock1:else:else:else:else:else:else:else:else:else:else: */
                      if (outC->_3_else_clock_else_else_else_else_else_else_else_else_else_IfBlock1) {
                        outC->_L26_then_else_else_else_else_else_else_else_else_else_else_IfBlock1 =
  ...
  outC_CAST_M_TRACKCOND_to_int_TM_conversions *outC)
{
  ...
  outC->_L412_then_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_L211_then_else_else_else_else_else_IfBlock1 = kcg_lit_int32(0);
  outC->_5_else_clock_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_L410_then_else_else_else_else_else_else_else_IfBlock1 = kcg_true;
  outC->_L29_then_else_else_else_else_else_else_else_IfBlock1 = kcg_lit_int32(0);
