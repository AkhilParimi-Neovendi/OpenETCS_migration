  ...
  outC_lastAndPrevBG_CalculateTrainPosition_Pkg_BG_utilities_Pkg *outC)
{
  kcg_bool noname;
  /* storedBG_loc/ */
  positionedBG_T_TrainPosition_Types_Pck last_storedBG_loc;
  /* prvBG_loc/ */
  positionedBG_T_TrainPosition_Types_Pck last_prvBG_loc;
  /* BG/ */
  positionedBG_T_TrainPosition_Types_Pck last_BG;
  ...
  positionedBGs_ids_equal_CalculateTrainPosition_Pkg_BG_utilities_Pkg(
    &outC->_L18,
    &outC->_L17,
    &outC->_1_Context_positionedBGs_ids_equal_2);
  outC->_L19 = outC->_1_Context_positionedBGs_ids_equal_2.idsEqual;
  outC->_L20 = !outC->_L19;
  kcg_copy_positionedBG_T_TrainPosition_Types_Pck(
    &last_prvBG_loc,
    &outC->prvBG_loc);
