...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  _10_GradientProfile_for_DMI_section_t_TrackAtlasTypes /* Gradiient_section_for_DMI_out/ */ Gradiient_section_for_DMI_out;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  ...
  kcg_int32 /* _L27/ */ _L27;
  kcg_int32 /* _L28/ */ _L28;
  _10_GradientProfile_for_DMI_section_t_TrackAtlasTypes /* _L40/ */ _L40;
