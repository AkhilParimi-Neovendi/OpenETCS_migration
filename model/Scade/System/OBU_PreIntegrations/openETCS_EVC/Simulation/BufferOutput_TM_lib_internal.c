  ...
  outC_BufferOutput_TM_lib_internal *outC)
{
  ...
  /* buffer/ */
  M_TrainTrackRadioOutputBuffer_t_TM_lib_internal buffer_partial;
  /* stacksize/ */
  kcg_int32 stacksize_partial;
  /* Out/ */
  M_TrainTrack_Message_T_TM_radio_messages _1_Out_partial;
  /* buffer/ */
  M_TrainTrackRadioOutputBuffer_t_TM_lib_internal _2_buffer_partial;
  /* stacksize/ */
  kcg_int32 _3_stacksize_partial;
  /* Out/ */
  M_TrainTrack_Message_T_TM_radio_messages _4_Out_partial;
  /* buffer/ */
  M_TrainTrackRadioOutputBuffer_t_TM_lib_internal _5_buffer_partial;
  /* stacksize/ */
  kcg_int32 _6_stacksize_partial;
  /* Out/ */
  M_TrainTrack_Message_T_TM_radio_messages _7_Out_partial;
  /* buffer/ */
  M_TrainTrackRadioOutputBuffer_t_TM_lib_internal _8_buffer_partial;
  /* stacksize/ */
  ...
  /* buffer/ */
  M_TrainTrackRadioOutputBuffer_t_TM_lib_internal _11_buffer_partial;
  /* Out/ */
  M_TrainTrack_Message_T_TM_radio_messages _12_Out_partial;
  /* stacksize/ */
  kcg_int32 _13_stacksize_partial;
  /* buffer/ */
  M_TrainTrackRadioOutputBuffer_t_TM_lib_internal _14_buffer_partial;
  /* Out/ */
  ...
  /* buffer/ */
  M_TrainTrackRadioOutputBuffer_t_TM_lib_internal last_buffer;
