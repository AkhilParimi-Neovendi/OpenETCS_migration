...
typedef struct {
  ...
  _5_DMI_Driver_Identifier_T_DMI_Messages_Bothways_Pkg /* fromDMI_DriverIdentifier/ */ fromDMI_DriverIdentifier;
  ...
  _5_DMI_Driver_Identifier_T_DMI_Messages_Bothways_Pkg /* IfBlock1:then:_L5/ */ _L5_then_IfBlock1;
