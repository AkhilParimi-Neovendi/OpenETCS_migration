...
void Exception04RejectIfSPPAnd_InformationFilter_Pkg_FirstFilter(
...
void Exception04RejectIfSPPAnd_init_InformationFilter_Pkg_FirstFilter(
  outC_Exception04RejectIfSPPAnd_InformationFilter_Pkg_FirstFilter *outC)
{
  outC->_L5 = kcg_true;
  outC->_L4 = kcg_true;
...
void Exception04RejectIfSPPAnd_reset_InformationFilter_Pkg_FirstFilter(
  outC_Exception04RejectIfSPPAnd_InformationFilter_Pkg_FirstFilter *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Exception04RejectIfSPPAnd_InformationFilter_Pkg_FirstFilter.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
