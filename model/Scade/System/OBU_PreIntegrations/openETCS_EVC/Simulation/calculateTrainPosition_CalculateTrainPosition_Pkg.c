...
{
  /* errors_loc/ */
  positionErrors_T_TrainPosition_Types_Pck errors_loc_partial;
  /* passedBG_asPositionedBG/ */
  positionedBG_T_TrainPosition_Types_Pck passedBG_asPositionedBG_partial;
  /* BGs_preloc/ */
  positionedBGs_T_TrainPosition_Types_Pck BGs_preloc_partial;
  /* errors_loc/ */
  positionErrors_T_TrainPosition_Types_Pck _1_errors_loc_partial;
  /* passedBG_asPositionedBG/ */
  positionedBG_T_TrainPosition_Types_Pck _2_passedBG_asPositionedBG_partial;
  /* BGs_preloc/ */
  positionedBGs_T_TrainPosition_Types_Pck _3_BGs_preloc_partial;
  /* BGs_preloc/ */
  positionedBGs_T_TrainPosition_Types_Pck _4_BGs_preloc_partial;
  /* errors_loc/ */
  positionErrors_T_TrainPosition_Types_Pck _5_errors_loc_partial;
  /* BGs_preloc/ */
  positionedBGs_T_TrainPosition_Types_Pck _6_BGs_preloc_partial;
  /* errors_loc/ */
  positionErrors_T_TrainPosition_Types_Pck _7_errors_loc_partial;
  kcg_int32 noname;
  /* BGs_loc/ */
  positionedBGs_T_TrainPosition_Types_Pck last_BGs_loc;
  ...
  outC_calculateTrainPosition_CalculateTrainPosition_Pkg *outC)
{
  ...
  /* _L200=(CalculateTrainPosition_Pkg::calculateTrainpositionAttributes#1)/ */
  calculateTrainpositionAtt_init_CalculateTrainPosition_Pkg(
    &outC->Context_calculateTrainpositionAttributes_1);
  /* _L334=(CalculateTrainPosition_Pkg::Linking_Pkg::twoConsecutiveLinkedBGs_missed#1)/ */
  twoConsecutiveLinkedBGs_m_init_CalculateTrainPosition_Pkg_Linking_Pkg(
    &outC->Context_twoConsecutiveLinkedBGs_missed_1);
  /* _L322=(CalculateTrainPosition_Pkg::Linking_Pkg::linkedBG_missed#2)/ */
