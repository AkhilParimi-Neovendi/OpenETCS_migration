...
typedef struct {
  ...
  M_MODE /* IfBlock1:else:else:else:else:else:else:else:then:_L1/ */ _L13_then_else_else_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:else:else:then:_L3/ */ _L3_then_else_else_else_else_else_else_else_IfBlock1;
  M_MODE /* IfBlock1:else:else:else:else:else:then:_L1/ */ _L14_then_else_else_else_else_else_IfBlock1;
  kcg_bool /* IfBlock1:else:else:else:else:else:then:_L3/ */ _L35_then_else_else_else_else_else_IfBlock1;
