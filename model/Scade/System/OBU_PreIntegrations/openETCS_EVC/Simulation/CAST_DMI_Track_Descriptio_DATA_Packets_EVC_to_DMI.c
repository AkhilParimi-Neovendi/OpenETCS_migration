  ...
  outC_CAST_DMI_Track_Descriptio_DATA_Packets_EVC_to_DMI *outC)
{
  ...
  CAST_DMI_trackCondition_t_DATA_Variables(
    &outC->_L2,
  ...
  CAST_DMI_gradientProfile__DATA_Variables(
    &outC->_L3,
...
void CAST_DMI_Track_Descriptio_init_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_Track_Descriptio_DATA_Packets_EVC_to_DMI *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  CAST_DMI_speedProfile_to_int_init_DATA_Variables(
    &outC->Context_CAST_DMI_speedProfile_to_int_1);
  /* _L9=(DATA::Variables::CAST_DMI_gradientProfile_to_int#1)/ */
  CAST_DMI_gradientProfile__init_DATA_Variables(
    &outC->Context_CAST_DMI_gradientProfile_to_int_1);
  /* _L8=(DATA::Variables::CAST_DMI_trackCondition_to_int#1)/ */
  CAST_DMI_trackCondition_t_init_DATA_Variables(
    &outC->Context_CAST_DMI_trackCondition_to_int_1);
}
...
void CAST_DMI_Track_Descriptio_reset_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_Track_Descriptio_DATA_Packets_EVC_to_DMI *outC)
{
  /* _L11=(Utilities::Bool_to_Int#1)/ */
  ...
  CAST_DMI_speedProfile_to_int_reset_DATA_Variables(
    &outC->Context_CAST_DMI_speedProfile_to_int_1);
  /* _L9=(DATA::Variables::CAST_DMI_gradientProfile_to_int#1)/ */
  CAST_DMI_gradientProfile__reset_DATA_Variables(
    &outC->Context_CAST_DMI_gradientProfile_to_int_1);
  /* _L8=(DATA::Variables::CAST_DMI_trackCondition_to_int#1)/ */
  CAST_DMI_trackCondition_t_reset_DATA_Variables(
    &outC->Context_CAST_DMI_trackCondition_to_int_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_Track_Descriptio_DATA_Packets_EVC_to_DMI.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
