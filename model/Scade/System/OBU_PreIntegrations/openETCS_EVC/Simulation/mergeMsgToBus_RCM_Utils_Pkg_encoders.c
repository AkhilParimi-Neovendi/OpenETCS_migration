...
{
  kcg_int32 op_call;
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _1_op_call;
  /* SM1: */
  ...
  /* SM1:notRequested:<2> */
  kcg_bool tr_2_guard_notRequested_SM1;
  /* SM1:notRequested:<1> */
  kcg_bool tr_1_guard_notRequested_SM1;
  /* SM1: */
  ...
  /* SM1:requested:<1> */
  kcg_bool tr_1_guard_requested_SM1;
  kcg_bool noname;
  /* SM1: */
  ...
  switch (outC->SM1_state_sel) {
    case SSM_st_requested_SM1 :
      ...
      if (tr_1_guard_requested_SM1) {
        ...
        _7_SM1_fired_strong_partial = _307_SSM_TR_no_trans_SM1;
      }
    ...
    case SSM_st_notRequested_SM1 :
      ...
      if (tr_1_guard_notRequested_SM1) {
        ...
        SM1_fired_strong_partial = _307_SSM_TR_no_trans_SM1;
      }
  ...
  outC_mergeMsgToBus_RCM_Utils_Pkg_encoders *outC)
{
  ...
  outC->SM1_fired = _307_SSM_TR_no_trans_SM1;
  outC->SM1_fired_strong = _307_SSM_TR_no_trans_SM1;
