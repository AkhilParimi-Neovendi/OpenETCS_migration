...
void CAST_DMI_Identifier_Reque_DATA_Packets_EVC_to_DMI(
  /* dmi_id_ct/ */
  ...
  outC_CAST_DMI_Identifier_Reque_DATA_Packets_EVC_to_DMI *outC)
{
  ...
  kcg_copy_array_int32_5(&tmp[0], &outC->_L9);
...
void CAST_DMI_Identifier_Reque_init_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_Identifier_Reque_DATA_Packets_EVC_to_DMI *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  for (idx6 = 0; idx6 < 261; idx6++) {
    outC->dmi_id_int[idx6] = kcg_lit_int32(0);
  }
  /* _L13=(TM_conversions::CAST_L_TEXT_to_int#1)/ */
...
void CAST_DMI_Identifier_Reque_reset_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_Identifier_Reque_DATA_Packets_EVC_to_DMI *outC)
{
  /* _L13=(TM_conversions::CAST_L_TEXT_to_int#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_Identifier_Reque_DATA_Packets_EVC_to_DMI.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
