...
void Write_int_to_DMI_Driver_I_DATA_Packets_Bothways(
...
void Write_int_to_DMI_Driver_I_init_DATA_Packets_Bothways(
  outC_Write_int_to_DMI_Driver_I_DATA_Packets_Bothways *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L24=(DATA::Packets::Bothways::C_int_to_DMI_Driver_Identifier#1)/ */
  C_int_to_DMI_Driver_Ident_init_DATA_Packets_Bothways(
    &outC->Context_C_int_to_DMI_Driver_Identifier_1);
}
...
void Write_int_to_DMI_Driver_I_reset_DATA_Packets_Bothways(
  outC_Write_int_to_DMI_Driver_I_DATA_Packets_Bothways *outC)
{
  /* _L24=(DATA::Packets::Bothways::C_int_to_DMI_Driver_Identifier#1)/ */
  C_int_to_DMI_Driver_Ident_reset_DATA_Packets_Bothways(
    &outC->Context_C_int_to_DMI_Driver_Identifier_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Write_int_to_DMI_Driver_I_DATA_Packets_Bothways.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
