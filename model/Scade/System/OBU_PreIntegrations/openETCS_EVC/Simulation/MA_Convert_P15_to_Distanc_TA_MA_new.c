...
void MA_Convert_P15_to_Distanc_TA_MA_new(
  /* i/ */
  kcg_int32 i,
  /* ProfileAccu/ */
  ...
  outC_MA_Convert_P15_to_Distanc_TA_MA_new *outC)
{
  ...
  Normalize_Distance_d_inte_TA_Lib_internal(
    outC->_L139,
    outC->_L239,
    &outC->_1_Context_Normalize_Distance_d_internal_t_1);
  outC->_L241 = outC->_1_Context_Normalize_Distance_d_internal_t_1.d_internal;
...
void MA_Convert_P15_to_Distanc_init_TA_MA_new(
  outC_MA_Convert_P15_to_Distanc_TA_MA_new *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void MA_Convert_P15_to_Distanc_reset_TA_MA_new(
  outC_MA_Convert_P15_to_Distanc_TA_MA_new *outC)
{
  /* _L242=(TA_Lib_internal::Normalize_Distance_d_internal_t#2)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** MA_Convert_P15_to_Distanc_TA_MA_new.c
** Generation date: 2023-11-06T13:54:30
*************************************************************$ */
