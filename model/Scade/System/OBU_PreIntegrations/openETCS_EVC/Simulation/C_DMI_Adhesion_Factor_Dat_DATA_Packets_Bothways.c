...
void C_DMI_Adhesion_Factor_Dat_DATA_Packets_Bothways(
...
void C_DMI_Adhesion_Factor_Dat_init_DATA_Packets_Bothways(
  outC_C_DMI_Adhesion_Factor_Dat_DATA_Packets_Bothways *outC)
{
  kcg_size idx;
  kcg_size idx1;
...
void C_DMI_Adhesion_Factor_Dat_reset_DATA_Packets_Bothways(
  outC_C_DMI_Adhesion_Factor_Dat_DATA_Packets_Bothways *outC)
{
  /* _L6=(TM_conversions::CAST_M_ADHESION_to_int#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** C_DMI_Adhesion_Factor_Dat_DATA_Packets_Bothways.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
