...
{
  DataForModeAndLevel_t_TrackAtlasTypes op_call;
  /* EVC_PersistentData/ */
  ps_dataForStartOfMission_T_API_PersistanceStorage_Pkg EVC_PersistentData_partial;
  /* EVC_ActiveLevelList/ */
  DMI_LevelList_T_DMI_Types_Pkg EVC_ActiveLevelList_partial;
  /* ML_MemorizedLevel/ */
  M_LEVEL ML_MemorizedLevel_partial;
  /* EVC_PersistentData/ */
  ps_dataForStartOfMission_T_API_PersistanceStorage_Pkg _1_EVC_PersistentData_partial;
  /* EVC_ActiveLevelList/ */
  DMI_LevelList_T_DMI_Types_Pkg _2_EVC_ActiveLevelList_partial;
  /* ML_MemorizedLevel/ */
  M_LEVEL _3_ML_MemorizedLevel_partial;
  TIU_commandStatus_T_TIU_Types_Pkg noname;
  Target_T_TargetManagement_types _4_noname;
  SDM_Commands_T_SDM_Types_Pkg _5_noname;
  kcg_bool _6_noname;
  kcg_bool _7_noname;
  DMI_Identifier_T_DMI_Messages_DMI_to_EVC_Pkg _8_noname;
  _5_DMI_Driver_Identifier_T_DMI_Messages_Bothways_Pkg _9_noname;
  DMI_Radio_Net_Data_T_DMI_Messages_DMI_to_EVC_Pkg _10_noname;
  DMI_Icon_Ack_T_DMI_Messages_DMI_to_EVC_Pkg _11_noname;
  DMI_Adhesion_Factor_Data_T_DMI_Messages_Bothways_Pkg _12_noname;
  kcg_bool _13_noname;
  trainData_Trigger_T_trainData_Types_pkg _14_noname;
  kcg_bool _15_noname;
  T_Data_To_BG_Management_Level_And_Mode_Types_Pkg _16_noname;
  MovementAuthority_t_TrackAtlasTypes _17_noname;
  P003_OBU_T_TM _18_noname;
  MRSP_Profile_t_TrackAtlasTypes _19_noname;
  DataForModeAndLevel_t_TrackAtlasTypes _20_noname;
  kcg_bool _21_noname;
  kcg_bool _22_noname;
  kcg_bool _23_noname;
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _24_noname;
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _25_noname;
  _18_Radio_TrainTrack_Message_T_TM_transitional _26_noname;
  ReportedBGList_T_ProvidePositionReport_Pkg _27_noname;
  kcg_bool _28_noname;
  M_TrainTrack_Message_T_TM_radio_messages _29_noname;
  RadioManagement_T_API_RadioCommunication_Pkg _30_noname;
  kcg_bool _31_noname;
  kcg_bool _32_noname;
  kcg_bool _33_noname;
  kcg_bool _34_noname;
  ...
  kcg_bool _36_noname;
  kcg_bool _37_noname;
  P45_RadioNetworkRegistration_T_Packet_Types_Pkg _38_noname;
  NID_RADIO _39_noname;
  NID_MN _40_noname;
  morcStatus_T_RCM_Session_Types_Pkg _41_noname;
  safeRadioConnectionIndication_T_RCM_Session_Types_Pkg _42_noname;
  kcg_bool _43_noname;
  MSG_Errors_T_Common_Types_Pkg _44_noname;
  positionErrors_T_TrainPosition_Types_Pck _45_noname;
  MSG_Errors_T_Common_Types_Pkg _46_noname;
  kcg_bool _47_noname;
  positionErrors_T_TrainPosition_Types_Pck _48_noname;
  morcStatus_T_RCM_Session_Types_Pkg _49_noname;
  /* TIU_driverWindowEB/ */
  kcg_bool last_TIU_driverWindowEB;
  /* ML_MemorizedLevel/ */
  M_LEVEL last_ML_MemorizedLevel;
  /* MoRC_MN_1/ */
  NID_MN last_MoRC_MN_1;
  /* MoRC_RadioID_1/ */
  NID_RADIO last_MoRC_RadioID_1;
  /* MoRC_RadioStatus_1/ */
  morcStatus_T_RCM_Session_Types_Pkg last_MoRC_RadioStatus_1;
  /* MoRC_ready/ */
  kcg_bool last_MoRC_ready;
  /* TA_Packets/ */
  T_Data_From_Track_Packet_Level_And_Mode_Types_Pkg last_TA_Packets;
  /* rep_P1/ */
  PT1_PositionReport_2BG_T_Packet_TrainTypes_Pkg last_rep_P1;
  /* td_status/ */
  trainDataStatus_T_trainData_Types_pkg last_td_status;
  /* rep_P0/ */
  PT0_PositionReport_T_Packet_TrainTypes_Pkg last_rep_P0;
  /* td_events/ */
  trainData_Events_T_trainData_Types_pkg last_td_events;
  /* PROC_start_ack/ */
  kcg_bool last_PROC_start_ack;
  /* EVC_TextMessageStatusList/ */
  DMI_TXT_MSGList_status_T_DMI_Types_Pkg last_EVC_TextMessageStatusList;
  /* EVC_ActiveLevelList/ */
  DMI_LevelList_T_DMI_Types_Pkg last_EVC_ActiveLevelList;
  /* EVC_PersistentData/ */
  ps_dataForStartOfMission_T_API_PersistanceStorage_Pkg last_EVC_PersistentData;
  /* MSG_EmergencyBrakeActive/ */
  kcg_bool last_MSG_EmergencyBrakeActive;
  /* ML_ModeAndLevel/ */
  T_Mode_Level_Level_And_Mode_Types_Pkg last_ML_ModeAndLevel;
  /* EVC_currentNTC/ */
  NID_NTC last_EVC_currentNTC;
  /* MSG_lastRadioMsgTimestamp/ */
  T_internal_Type_Obu_BasicTypes_Pkg last_MSG_lastRadioMsgTimestamp;
  /* MoRC_newSessionEstablished/ */
  kcg_bool last_MoRC_newSessionEstablished;
  /* TIU_trainProperties/ */
  trainProperties_T_TrainPosition_Types_Pck last_TIU_trainProperties;
  /* CALC_BGs/ */
  positionedBGs_T_TrainPosition_Types_Pck last_CALC_BGs;
  /* MoRC_supervisingRBC_Id/ */
  connection_ids_T_Handover_Pkg last_MoRC_supervisingRBC_Id;
  /* td_trainData/ */
  trainData_T_TIU_Types_Pkg last_td_trainData;
  /* DMI_sdmToDMI/ */
  speedSupervisionForDMI_T_DMI_Types_Pkg last_DMI_sdmToDMI;
  /* SDM_speedSupervisionBrakeCommand/ */
  Brake_command_T_TIU_Types_Pkg last_SDM_speedSupervisionBrakeCommand;
  /* CALC_TrainPosition/ */
  trainPosition_T_TrainPosition_Types_Pck last_CALC_TrainPosition;
  /* DMI_currentDMIStatus/ */
  DMI_EVC_status_T_DMI_Types_Pkg last_DMI_currentDMIStatus;
  /* PROC_powerOff_to_MoRC/ */
  kcg_bool last_PROC_powerOff_to_MoRC;
  /* PROC_statusstartofmissionongoing_to_MoRC/ */
  kcg_bool last_PROC_statusstartofmissionongoing_to_MoRC;
  /* PROC_powerUp_to_MoRC/ */
  kcg_bool last_PROC_powerUp_to_MoRC;
  /* PROC_radioCmdFromProcedures/ */
  radioManagementMessage_T_Common_Types_Pkg last_PROC_radioCmdFromProcedures;

  outC->_L1517 = kcg_true;
  outC->every2 = outC->_L1517;
  outC->_L777 = kcg_true;
  kcg_copy_API_TrackSideInput_T_API_Msg_Pkg(&outC->_L792, &inC->API_fromTrack);
  kcg_copy_odometry_T_Obu_BasicTypes_Pkg(&outC->_L910, &inC->API_Odometry);
  outC->_L776 = inC->EVC_reset;
  ...
  kcg_copy_TIU_Input_msg_API_TIU_Pkg(&outC->_L818, &inC->API_fromTIU);
  ...
  kcg_copy_odometry_T_Obu_BasicTypes_Pkg(&outC->_L1253, &inC->API_Odometry);
  ...
  outC->_L1338 = inC->API_SystemTime;
  ...
  kcg_copy_odometry_T_Obu_BasicTypes_Pkg(&outC->_L1339, &inC->API_Odometry);
  kcg_copy_DMI_to_EVC_Message_int_T_API_DMI_Pkg(&outC->_L735, &inC->API_fromDMI);
  outC->_L741 = inC->EVC_reset;
  ...
  kcg_copy_DMI_TXT_MSGList_status_T_DMI_Types_Pkg(
    &outC->_L1179,
    &last_EVC_TextMessageStatusList);
  outC->_L1181 = inC->API_SystemTime;
  ...
  kcg_copy_PT1_PositionReport_2BG_T_Packet_TrainTypes_Pkg(
    &outC->_L1342,
    &last_rep_P1);
  outC->_L1324 = inC->API_SystemTime;
  ...
  outC->_L1206 = inC->EVC_reset;
  kcg_copy_TIU_Input_msg_API_TIU_Pkg(&outC->_L1207, &inC->API_fromTIU);
  ...
  kcg_copy_API_TrackSideInput_T_API_Msg_Pkg(&outC->_L1593, &inC->API_fromTrack);
  if (outC->every) {
  ...
  kcg_copy_mobileHWStatus_Type_MoRC_Pck(&outC->_L1621, &inC->API_mobileHWStatus);
  ...
  kcg_copy_trainPosition_T_TrainPosition_Types_Pck(
    &outC->_L807,
    &outC->CALC_TrainPosition);
  kcg_copy_odometry_T_Obu_BasicTypes_Pkg(&outC->_L906, &inC->API_Odometry);
  kcg_copy_trainProperties_T_TrainPosition_Types_Pck(
    &outC->_L950,
    &last_TIU_trainProperties);
  kcg_copy_DMI_Train_Running_Number_T_DMI_Messages_Bothways_Pkg(
  ...
  kcg_copy_trainPosition_T_TrainPosition_Types_Pck(
    &outC->_L1039,
    &outC->CALC_TrainPosition);
  kcg_copy_odometry_T_Obu_BasicTypes_Pkg(&outC->_L1040, &inC->API_Odometry);
  ...
  if (outC->IfBlock1_clock) {
    ...
    _3_ML_MemorizedLevel_partial = outC->_L5_else_IfBlock1;
    outC->ML_MemorizedLevel = _3_ML_MemorizedLevel_partial;
  }
  ...
  outC->_L1629 = inC->API_SystemTime;
  outC->_L1657 = inC->EVC_reset;
  ...
  kcg_copy_morcStatus_T_RCM_Session_Types_Pkg(
    &outC->_L1768,
    &outC->MoRC_RadioStatus_1);
  kcg_copy_morcStatus_T_RCM_Session_Types_Pkg(&_49_noname, &outC->_L1768);
  kcg_copy_positionErrors_T_TrainPosition_Types_Pck(
    &outC->_L1767,
    &outC->CALC_positionErrors);
  kcg_copy_positionErrors_T_TrainPosition_Types_Pck(&_48_noname, &outC->_L1767);
  ...
  _47_noname = outC->_L1780;
  kcg_copy_MSG_Errors_T_Common_Types_Pkg(&outC->_L1441, &outC->MSG_errors);
  kcg_copy_MSG_Errors_T_Common_Types_Pkg(&_46_noname, &outC->_L1441);
  kcg_copy_positionErrors_T_TrainPosition_Types_Pck(
    &outC->_L1045,
    &outC->CALC_positionErrors);
  kcg_copy_positionErrors_T_TrainPosition_Types_Pck(&_45_noname, &outC->_L1045);
  kcg_copy_MSG_Errors_T_Common_Types_Pkg(&outC->_L1766, &outC->MSG_errors);
  kcg_copy_MSG_Errors_T_Common_Types_Pkg(&_44_noname, &outC->_L1766);
  ...
  kcg_copy_ReportedBGList_T_ProvidePositionReport_Pkg(&_27_noname, &outC->_L805);
  kcg_copy_connection_ids_T_Handover_Pkg(
    &outC->MoRC_supervisingRBC_Id,
    &outC->_L1640);
  ...
  kcg_copy_M_TrainTrackMessageBus_t_TM_TrainTrack_Bus(
    &outC->_L1596,
    &outC->td_out2Radio);
  kcg_copy_M_TrainTrackMessageBus_t_TM_TrainTrack_Bus(&_25_noname, &outC->_L1596);
  ...
  kcg_copy_M_TrainTrackMessageBus_t_TM_TrainTrack_Bus(
    &outC->_L1540,
    &outC->td_out2Radio);
  kcg_copy_M_TrainTrackMessageBus_t_TM_TrainTrack_Bus(&_24_noname, &outC->_L1540);
  kcg_copy_T_AnnouncedLevel_Level_And_Mode_Types_Pkg(
  ...
  kcg_copy_T_AnnouncedLevel_Level_And_Mode_Types_Pkg(
    &outC->_L1525,
    &outC->ML_AnnouncedLevelTransitions);
  kcg_copy_odometry_T_Obu_BasicTypes_Pkg(&outC->_L1495, &inC->API_Odometry);
  kcg_copy_ReceivedMessage_T_Common_Types_Pkg(
    &outC->_L1496,
    &outC->MSG_trackMessage);
  ...
  kcg_copy_odometry_T_Obu_BasicTypes_Pkg(&outC->_L1295, &inC->API_Odometry);
  ...
  if (outC->IfBlock1_clock) {
    ...
    kcg_copy_ps_dataForStartOfMission_T_API_PersistanceStorage_Pkg(
      &_1_EVC_PersistentData_partial,
      &last_EVC_PersistentData);
    kcg_copy_DMI_LevelList_T_DMI_Types_Pkg(
      &outC->_L7_else_IfBlock1,
      &last_EVC_ActiveLevelList);
    kcg_copy_DMI_LevelList_T_DMI_Types_Pkg(
      &_2_EVC_ActiveLevelList_partial,
      &outC->_L7_else_IfBlock1);
    kcg_copy_ps_dataForStartOfMission_T_API_PersistanceStorage_Pkg(
      &outC->EVC_PersistentData,
      &_1_EVC_PersistentData_partial);
  ...
  kcg_copy_trainPosition_T_TrainPosition_Types_Pck(
    &outC->_L639,
    &outC->CALC_TrainPosition);
  kcg_copy_odometry_T_Obu_BasicTypes_Pkg(&outC->_L914, &inC->API_Odometry);
  kcg_copy_trainProperties_T_TrainPosition_Types_Pck(
    &outC->_L948,
    &outC->TIU_trainProperties);
  ...
  kcg_copy_DMI_Adhesion_Factor_Data_T_DMI_Messages_Bothways_Pkg(
    &_12_noname,
    &outC->_L751);
  kcg_copy_DMI_Icon_Ack_T_DMI_Messages_DMI_to_EVC_Pkg(&_11_noname, &outC->_L748);
  kcg_copy_DMI_Radio_Net_Data_T_DMI_Messages_DMI_to_EVC_Pkg(
    &_10_noname,
    &outC->_L747);
  kcg_copy__5_DMI_Driver_Identifier_T_DMI_Messages_Bothways_Pkg(
    &_9_noname,
    &outC->_L745);
  kcg_copy_DMI_Identifier_T_DMI_Messages_DMI_to_EVC_Pkg(&_8_noname, &outC->_L743);
  outC->MSG_badBGPassedtoDMI = outC->_L765;
  outC->_L1185 = outC->MSG_badBGPassedtoDMI;
  kcg_copy_DMI_EVC_status_T_DMI_Types_Pkg(
    &outC->_L568,
    &last_DMI_currentDMIStatus);
  outC->_L889 = inC->API_SystemTime;
  kcg_copy_TIU_trainStatus_T_TIU_Types_Pkg(&outC->_L318, &outC->TIU_trainStatus);
  kcg_copy_odometry_T_Obu_BasicTypes_Pkg(&outC->_L888, &inC->API_Odometry);
  kcg_copy_trainPosition_T_TrainPosition_Types_Pck(
    &outC->_L538,
    &outC->CALC_TrainPosition);
  kcg_copy_Brake_command_T_TIU_Types_Pkg(
...
void EVC_init(outC_EVC *outC)
{
  ...
  calculateTrainPosition_init_CalculateTrainPosition_Pkg(
    &outC->Context_calculateTrainPosition_3);
  /* _L763=(Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration#2)/ */
  Manage_TrackSideInformati_init_Manage_TrackSideInformation_Integration_Pkg(
    &outC->Context_Manage_TrackSideInformation_Integration_2);
  /* _L815=(input_from_TIU_API_Pkg::manageTIU_input#5)/ */
