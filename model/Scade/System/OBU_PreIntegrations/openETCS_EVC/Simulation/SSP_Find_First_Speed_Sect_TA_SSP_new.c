...
#include "SSP_Find_First_Speed_Sect_TA_SSP_new.h"

/* TA_SSP_new::SSP_Find_First_Speed_Section_After_BG_loop/ */
void SSP_Find_First_Speed_Sect_TA_SSP_new(
  /* i/ */
  kcg_int32 i,
  /* Acc/ */
  kcg_int32 Acc,
...
void SSP_Find_First_Speed_Sect_init_TA_SSP_new(
  outC_SSP_Find_First_Speed_Sect_TA_SSP_new *outC)
{
  kcg_size idx;
...
void SSP_Find_First_Speed_Sect_reset_TA_SSP_new(
  outC_SSP_Find_First_Speed_Sect_TA_SSP_new *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** SSP_Find_First_Speed_Sect_TA_SSP_new.c
** Generation date: 2023-11-06T13:54:30
*************************************************************$ */
