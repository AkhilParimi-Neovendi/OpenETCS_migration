...
{
  _8_P46_ConditionalLevelTransitionOrders_T_Packet_Types_Pkg op_call;

  kcg_copy_CompressedPackets_T_Common_Types_Pkg(&outC->_L3, Message_IN);
  /* _L1=(TM::Read_P046#1)/ */
  Read_P046_TM(&outC->_L3, &outC->Context_Read_P046_1);
  outC->_L1 = outC->Context_Read_P046_1.received;
  kcg_copy_P046_OBU_T_TM(&outC->_L2, &outC->Context_Read_P046_1.P046_OBU_out);
  outC->every = outC->_L1;
  if (outC->every) {
    /* _L4=(TM_conversions::C_P046_to_legacy_t#1)/ */
    C_P046_to_legacy_t_TM_conversions(
      &outC->_L2,
      &outC->Context_C_P046_to_legacy_t_1);
    kcg_copy__8_P46_ConditionalLevelTransitionOrders_T_Packet_Types_Pkg(
      &op_call,
      &outC->Context_C_P046_to_legacy_t_1.P046_legacy_out);
    kcg_copy__8_P46_ConditionalLevelTransitionOrders_T_Packet_Types_Pkg(
      &outC->_L4,
      &op_call);
  }
...
void Read_P046_Legacy_init_TM_specific(outC_Read_P046_Legacy_TM_specific *outC)
{
  kcg_size idx;
  kcg_size idx1;
  kcg_size idx2;
  ...
  /* _L1=(TM::Read_P046#1)/ */ Read_P046_init_TM(&outC->Context_Read_P046_1);
}
...
{
  /* _L4=(TM_conversions::C_P046_to_legacy_t#1)/ */
  C_P046_to_legacy_t_reset_TM_conversions(&outC->Context_C_P046_to_legacy_t_1);
  /* _L1=(TM::Read_P046#1)/ */ Read_P046_reset_TM(&outC->Context_Read_P046_1);
}
