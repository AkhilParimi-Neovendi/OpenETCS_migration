...
{
  /* outMetadataElement/ */
  MetadataElement_T_Common_Types_Pkg outMetadataElement_partial;
  /* outMetadataElement/ */
  MetadataElement_T_Common_Types_Pkg _1_outMetadataElement_partial;
...
void validateDataDirectionForS_init_ValidateDataDirectionGeneral_Pkg_Subfunctions(
  outC_validateDataDirectionForS_ValidateDataDirectionGeneral_Pkg_Subfunctions *outC)
{
  kcg_size idx;
  kcg_size idx1;
