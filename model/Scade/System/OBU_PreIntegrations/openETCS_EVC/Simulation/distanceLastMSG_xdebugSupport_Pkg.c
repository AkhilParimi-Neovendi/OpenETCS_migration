  ...
  outC_distanceLastMSG_xdebugSupport_Pkg *outC)
{
  ...
  /* MSG_ID/ */
  NID_BG MSG_ID_partial;
  /* MSGLocation/ */
  L_internal_Type_Obu_BasicTypes_Pkg MSGLocation_partial;
  /* LRBG/ */
  NID_LRBG LRBG_partial;
  /* distance/ */
  kcg_float32 _1_distance_partial;
  /* MSG_ID/ */
  NID_BG _2_MSG_ID_partial;
  /* MSGLocation/ */
  L_internal_Type_Obu_BasicTypes_Pkg _3_MSGLocation_partial;
  /* LRBG/ */
  NID_LRBG _4_LRBG_partial;
  /* LRBG/ */
  NID_LRBG last_LRBG;
  /* MSGLocation/ */
  L_internal_Type_Obu_BasicTypes_Pkg last_MSGLocation;
  /* MSG_ID/ */
  NID_BG last_MSG_ID;
  /* distance/ */
  kcg_float32 last_distance;
  /* showGeneral/ */
  kcg_bool last_showGeneral;
  ...
  outC_distanceLastMSG_xdebugSupport_Pkg *outC)
{
  ...
  outC->_L10.radioDevice = kcg_lit_int32(0);
  outC->_L10.receivedSystemTime = kcg_lit_int32(0);
  ...
  outC->_L10.t_train_reference = kcg_lit_int32(0);
  outC->_L10.nid_em = kcg_lit_int32(0);
  outC->_L10.q_scale = Q_SCALE_10_cm_scale;
  outC->_L10.d_sr = kcg_lit_int32(0);
  outC->_L10.t_sh_rqst = kcg_lit_int32(0);
  outC->_L10.d_ref = kcg_lit_int32(0);
  outC->_L10.q_dir = Q_DIR_Reverse;
  outC->_L10.d_emergencystop = kcg_lit_int32(0);
  outC->_L10.m_version =
  ...
  outC->_L14_else_IfBlock1 = kcg_lit_int32(0);
  outC->_L15_else_IfBlock1 = kcg_lit_float32(0.0);
  outC->_L16_else_IfBlock1 = kcg_lit_float32(0.0);
  ...
  outC->MSG_ID = kcg_lit_int32(0);
  outC->MSGLocation = kcg_lit_int32(0);
