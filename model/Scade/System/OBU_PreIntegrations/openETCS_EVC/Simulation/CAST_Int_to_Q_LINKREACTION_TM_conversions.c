...
{
  /* q_linkreaction/ */
  Q_LINKREACTION q_linkreaction_partial;
  /* error/ */
  kcg_bool error_partial;
  /* q_linkreaction/ */
  Q_LINKREACTION _1_q_linkreaction_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* q_linkreaction/ */
  Q_LINKREACTION _3_q_linkreaction_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* q_linkreaction/ */
  Q_LINKREACTION _5_q_linkreaction_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* error/ */
  kcg_bool _7_error_partial;
  /* q_linkreaction/ */
  Q_LINKREACTION _8_q_linkreaction_partial;
  /* error/ */
  kcg_bool _9_error_partial;
  /* q_linkreaction/ */
  Q_LINKREACTION _10_q_linkreaction_partial;
  kcg_bool noname;
