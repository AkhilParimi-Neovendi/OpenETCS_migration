...
typedef struct {
  ...
  msgFromTrack_T_RCM_MsgTypes_Pkg /* p45_radioNetworkRegistrationOrder_2/ */ _1_p45_radioNetworkRegistrationOrder_2;
  msgFromTrack_T_RCM_MsgTypes_Pkg /* p42_sessionCmd_for_RBC_2/ */ p42_sessionCmd_for_RBC_2;
  msgFromTrack_T_RCM_MsgTypes_Pkg /* additionalSessionCmdsFromTrack_for_RBC_2/ */ _2_additionalSessionCmdsFromTrack_for_RBC_2;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
