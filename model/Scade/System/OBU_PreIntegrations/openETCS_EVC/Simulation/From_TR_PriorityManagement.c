...
{
  /* FromTR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg FromTR_To_NewMode_partial;
  /* FromTR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _1_FromTR_To_NewMode_partial;
  /* FromTR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _2_FromTR_To_NewMode_partial;
  /* FromTR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _3_FromTR_To_NewMode_partial;
  /* FromTR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _4_FromTR_To_NewMode_partial;
  /* FromTR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _5_FromTR_To_NewMode_partial;
  /* FromTR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _6_FromTR_To_NewMode_partial;
  /* FromTR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _7_FromTR_To_NewMode_partial;
  /* FromTR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _8_FromTR_To_NewMode_partial;
  /* FromTR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _9_FromTR_To_NewMode_partial;
  /* FromTR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _10_FromTR_To_NewMode_partial;
  /* FromTR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _11_FromTR_To_NewMode_partial;
  /* FromTR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _12_FromTR_To_NewMode_partial;
  /* FromTR_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _13_FromTR_To_NewMode_partial;
        ...
        if (outC->else_clock_else_else_IfBlock1) {
          ...
          if (outC->else_clock_else_else_else_IfBlock1) {
            ...
            if (outC->else_clock_else_else_else_else_IfBlock1) {
              outC->_L12_then_else_else_else_else_else_IfBlock1 = UN_Level_And_Mode_Types_Pkg;
              _9_FromTR_To_NewMode_partial =
                outC->_L12_then_else_else_else_else_else_IfBlock1;
              _5_FromTR_To_NewMode_partial = _9_FromTR_To_NewMode_partial;
            }
            else {
              outC->_1_else_clock_else_else_else_else_else_IfBlock1 = Condition63;
...
void From_TR_init_PriorityManagement(outC_From_TR_PriorityManagement *outC)
{
  ...
  outC->_L12_then_else_else_else_else_else_IfBlock1 = NP_Level_And_Mode_Types_Pkg;
