...
{
  /* lastMSG/ */
  NID_MESSAGE lastMSG_partial;
  /* lastTTrain/ */
  T_TRAIN lastTTrain_partial;
  /* isRelevant/ */
  kcg_bool isRelevant_partial;
  /* lastMSG/ */
  NID_MESSAGE _1_lastMSG_partial;
  /* lastTTrain/ */
  T_TRAIN _2_lastTTrain_partial;
  /* isRelevant/ */
  kcg_bool _3_isRelevant_partial;
  /* lastTTrain/ */
  T_TRAIN last_lastTTrain;
  /* lastMSG/ */
  NID_MESSAGE last_lastMSG;
