...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_add_2_Distances_BasicLocationFunctions_Pkg /* _L181=(BasicLocationFunctions_Pkg::add_2_Distances#4)/ */ Context_add_2_Distances_4;
  outC_add_2_Distances_BasicLocationFunctions_Pkg /* _L180=(BasicLocationFunctions_Pkg::add_2_Distances#3)/ */ Context_add_2_Distances_3;
  ...
  outC_add_2_Distances_BasicLocationFunctions_Pkg /* _L200=(BasicLocationFunctions_Pkg::add_2_Distances#6)/ */ Context_add_2_Distances_6;
  outC_add_2_Distances_BasicLocationFunctions_Pkg /* _L199=(BasicLocationFunctions_Pkg::add_2_Distances#5)/ */ Context_add_2_Distances_5;
  outC_sub_2_odoDistances_BasicLocationFunctions_Pkg /* _L196=(BasicLocationFunctions_Pkg::sub_2_odoDistances#2)/ */ Context_sub_2_odoDistances_2;
...
extern void recalculate_BG_location_ahead_init_CalculateTrainPosition_Pkg_BG_relocation_Pkg(
  outC_recalculate_BG_location_ahead_CalculateTrainPosition_Pkg_BG_relocation_Pkg *outC);
