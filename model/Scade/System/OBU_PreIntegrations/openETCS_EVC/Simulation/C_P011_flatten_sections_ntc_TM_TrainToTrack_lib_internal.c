  ...
  outC_C_P011_flatten_sections_ntc_TM_TrainToTrack_lib_internal *outC)
{
  ...
  for (idx = 0; idx < 5; idx++) {
    ...
    _224_C_P011_fs_struct_to__TM_TrainToTrack_lib_internal(
      outC->_L75[idx],
  ...
  outC_C_P011_flatten_sections_ntc_TM_TrainToTrack_lib_internal *outC)
{
  ...
  for (idx = 0; idx < 5; idx++) {
    /* _L74=(TM_TrainToTrack_lib_internal::C_P011_fs_struct_to_array_ntc#1)/ */
    _224_C_P011_fs_struct_to__init_TM_TrainToTrack_lib_internal(
      &outC->Context_C_P011_fs_struct_to_array_ntc_1[idx]);
  }
}
  ...
  outC_C_P011_flatten_sections_ntc_TM_TrainToTrack_lib_internal *outC)
{
  ...
  for (idx = 0; idx < 5; idx++) {
    /* _L74=(TM_TrainToTrack_lib_internal::C_P011_fs_struct_to_array_ntc#1)/ */
    _224_C_P011_fs_struct_to__reset_TM_TrainToTrack_lib_internal(
      &outC->Context_C_P011_fs_struct_to_array_ntc_1[idx]);
  }
}
