...
*************************************************************$ */
#ifndef _CAST_int_to_DMI_DMI_ident_DATA_Variables_H_
#define _CAST_int_to_DMI_DMI_ident_DATA_Variables_H_
...
typedef struct {
  ...
  kcg_bool /* _L22/ */ _L22;
} outC_CAST_int_to_DMI_DMI_ident_DATA_Variables;

/* ===========  node initialization and cycle functions  =========== */
/* DATA::Variables::CAST_int_to_DMI_DMI_identifier/ */
extern void CAST_int_to_DMI_DMI_ident_DATA_Variables(
  /* dmi_dmi_identifier_int/ */
  kcg_int32 dmi_dmi_identifier_int,
  outC_CAST_int_to_DMI_DMI_ident_DATA_Variables *outC);

#ifndef KCG_NO_EXTERN_CALL_TO_RESET
extern void CAST_int_to_DMI_DMI_ident_reset_DATA_Variables(
  outC_CAST_int_to_DMI_DMI_ident_DATA_Variables *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void CAST_int_to_DMI_DMI_ident_init_DATA_Variables(
  outC_CAST_int_to_DMI_DMI_ident_DATA_Variables *outC);
#endif /* KCG_USER_DEFINED_INIT */



#endif /* _CAST_int_to_DMI_DMI_ident_DATA_Variables_H_ */
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_int_to_DMI_DMI_ident_DATA_Variables.h
** Generation date: 2023-11-06T13:54:28
*************************************************************$ */
