...
{
  /* m_leveltr/ */
  M_LEVELTR m_leveltr_partial;
  /* error/ */
  kcg_bool error_partial;
  /* m_leveltr/ */
  M_LEVELTR _1_m_leveltr_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* m_leveltr/ */
  M_LEVELTR _3_m_leveltr_partial;
  /* error/ */
  kcg_bool _4_error_partial;
  /* m_leveltr/ */
  M_LEVELTR _5_m_leveltr_partial;
  /* error/ */
  kcg_bool _6_error_partial;
  /* m_leveltr/ */
  M_LEVELTR _7_m_leveltr_partial;
  /* error/ */
  kcg_bool _8_error_partial;
  /* m_leveltr/ */
  M_LEVELTR _9_m_leveltr_partial;
  /* error/ */
  kcg_bool _10_error_partial;
  /* error/ */
  kcg_bool _11_error_partial;
  /* m_leveltr/ */
  M_LEVELTR _12_m_leveltr_partial;
  /* error/ */
  kcg_bool _13_error_partial;
  /* m_leveltr/ */
  M_LEVELTR _14_m_leveltr_partial;
  /* error/ */
  kcg_bool _15_error_partial;
  /* m_leveltr/ */
  M_LEVELTR _16_m_leveltr_partial;
  /* error/ */
  kcg_bool _17_error_partial;
  /* m_leveltr/ */
  M_LEVELTR _18_m_leveltr_partial;
  kcg_bool noname;
