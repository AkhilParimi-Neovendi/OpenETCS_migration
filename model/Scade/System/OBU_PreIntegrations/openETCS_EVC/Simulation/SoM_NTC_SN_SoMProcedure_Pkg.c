  ...
  outC_SoM_NTC_SN_SoMProcedure_Pkg *outC)
{
  ...
  SSM_ST_Level_NTC_and_Mode_SN Level_NTC_and_Mode_SN_state_nxt_partial;
  /* Level_NTC_and_Mode_SN: */
  kcg_bool Level_NTC_and_Mode_SN_reset_nxt_partial;
  /* Level_NTC_and_Mode_SN: */
  SSM_TR_Level_NTC_and_Mode_SN Level_NTC_and_Mode_SN_fired_partial;
  /* start_ack_to_TIU/ */
  kcg_bool _1_start_ack_to_TIU_partial;
  /* Level_NTC_and_Mode_SN: */
  SSM_ST_Level_NTC_and_Mode_SN _2_Level_NTC_and_Mode_SN_state_nxt_partial;
  /* Level_NTC_and_Mode_SN: */
  kcg_bool _3_Level_NTC_and_Mode_SN_reset_nxt_partial;
  /* Level_NTC_and_Mode_SN: */
  SSM_TR_Level_NTC_and_Mode_SN _4_Level_NTC_and_Mode_SN_fired_partial;
  /* start_ack_to_TIU/ */
  kcg_bool _5_start_ack_to_TIU_partial;
  /* Level_NTC_and_Mode_SN: */
  SSM_ST_Level_NTC_and_Mode_SN _6_Level_NTC_and_Mode_SN_state_nxt_partial;
  /* Level_NTC_and_Mode_SN: */
  kcg_bool _7_Level_NTC_and_Mode_SN_reset_nxt_partial;
  /* Level_NTC_and_Mode_SN: */
  SSM_TR_Level_NTC_and_Mode_SN _8_Level_NTC_and_Mode_SN_fired_partial;
  /* Level_NTC_and_Mode_SN: */
  SSM_ST_Level_NTC_and_Mode_SN Level_NTC_and_Mode_SN_state_act_partial;
  /* Level_NTC_and_Mode_SN: */
  kcg_bool Level_NTC_and_Mode_SN_reset_act_partial;
  /* Level_NTC_and_Mode_SN: */
  SSM_TR_Level_NTC_and_Mode_SN Level_NTC_and_Mode_SN_fired_strong_partial;
  /* Level_NTC_and_Mode_SN:State1:<1> */
  kcg_bool tr_1_guard_State1_Level_NTC_and_Mode_SN;
  /* Level_NTC_and_Mode_SN: */
  SSM_ST_Level_NTC_and_Mode_SN _9_Level_NTC_and_Mode_SN_state_act_partial;
  /* Level_NTC_and_Mode_SN: */
  kcg_bool _10_Level_NTC_and_Mode_SN_reset_act_partial;
  /* Level_NTC_and_Mode_SN: */
  SSM_TR_Level_NTC_and_Mode_SN _11_Level_NTC_and_Mode_SN_fired_strong_partial;
  /* Level_NTC_and_Mode_SN:Waiting_for_Ack_of_proposed_Mode_SN_from_Driver:<1> */
  kcg_bool tr_1_guard_Waiting_for_Ack_of_proposed_Mode_SN_from_Driver_Level_NTC_and_Mode_SN;
  /* Level_NTC_and_Mode_SN: */
  SSM_ST_Level_NTC_and_Mode_SN _12_Level_NTC_and_Mode_SN_state_act_partial;
  /* Level_NTC_and_Mode_SN: */
  kcg_bool _13_Level_NTC_and_Mode_SN_reset_act_partial;
  /* Level_NTC_and_Mode_SN: */
  SSM_TR_Level_NTC_and_Mode_SN _14_Level_NTC_and_Mode_SN_fired_strong_partial;
  kcg_bool noname;
  /* Level_NTC_and_Mode_SN: */
  kcg_bool Level_NTC_and_Mode_SN_reset_sel;
  /* Level_NTC_and_Mode_SN: */
  kcg_bool Level_NTC_and_Mode_SN_reset_prv;
