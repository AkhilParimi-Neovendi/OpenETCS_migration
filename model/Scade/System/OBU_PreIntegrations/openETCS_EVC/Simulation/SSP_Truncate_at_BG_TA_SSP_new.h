...
typedef struct {
  ...
  outC_SSP_Find_First_Speed_Sect_TA_SSP_new /* _L4=(TA_SSP_new::SSP_Find_First_Speed_Section_After_BG_loop#1)/ */ Context_SSP_Find_First_Speed_Section_After_BG_loop_1[50];
