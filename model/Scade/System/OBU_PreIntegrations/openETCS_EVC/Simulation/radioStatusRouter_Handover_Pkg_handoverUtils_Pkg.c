  ...
  outC_radioStatusRouter_Handover_Pkg_handoverUtils_Pkg *outC)
{
  ...
  morcStatus_T_RCM_Session_Types_Pkg morcStatusFromAcceptingRBC_partial;
  /* morcStatusFromHandingOverRBC/ */
  morcStatus_T_RCM_Session_Types_Pkg morcStatusFromHandingOverRBC_partial;
  /* morcStatusFromAcceptingRBC/ */
  morcStatus_T_RCM_Session_Types_Pkg _1_morcStatusFromAcceptingRBC_partial;
  /* morcStatusFromHandingOverRBC/ */
  morcStatus_T_RCM_Session_Types_Pkg _2_morcStatusFromHandingOverRBC_partial;
