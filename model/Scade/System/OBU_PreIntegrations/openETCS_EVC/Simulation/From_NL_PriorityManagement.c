...
{
  /* FromNL_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg FromNL_To_NewMode_partial;
  /* FromNL_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _1_FromNL_To_NewMode_partial;
  /* FromNL_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _2_FromNL_To_NewMode_partial;
  /* FromNL_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _3_FromNL_To_NewMode_partial;
  /* FromNL_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _4_FromNL_To_NewMode_partial;
  /* FromNL_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _5_FromNL_To_NewMode_partial;
