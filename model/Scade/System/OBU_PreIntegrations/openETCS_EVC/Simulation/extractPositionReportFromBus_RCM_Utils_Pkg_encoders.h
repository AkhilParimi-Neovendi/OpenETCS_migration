...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_extractPositionReportFrom_RCM_Utils_Pkg_encoders /* _L2=(RCM_Utils_Pkg::encoders::extractPositionReportFromBus_itr#1)/ */ Context_extractPositionReportFromBus_itr_1[5];
