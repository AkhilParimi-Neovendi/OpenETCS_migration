...
#include "SearchIndexInGradientprof_SDM_GradientAcceleration_Pkg.h"

/* SDM_GradientAcceleration_Pkg::SearchIndexInGradientprofileInternal/ */
void SearchIndexInGradientprof_SDM_GradientAcceleration_Pkg(
  /* index/ */
  kcg_int32 index,
  /* indexOfPosition/ */
...
void SearchIndexInGradientprof_init_SDM_GradientAcceleration_Pkg(
  outC_SearchIndexInGradientprof_SDM_GradientAcceleration_Pkg *outC)
{
  kcg_size idx;
...
void SearchIndexInGradientprof_reset_SDM_GradientAcceleration_Pkg(
  outC_SearchIndexInGradientprof_SDM_GradientAcceleration_Pkg *outC)
{
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** SearchIndexInGradientprof_SDM_GradientAcceleration_Pkg.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
