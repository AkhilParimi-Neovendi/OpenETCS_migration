  ...
  outC_SelectLevelTransition_LevelTransitionSelection *outC)
{
  ...
  /* IsAvailableForUse/ */
  kcg_bool IsAvailableForUse_partial;
  /* selected_level_transition/ */
  T_LevelTransition_Level_And_Mode_Types_Pkg _1_selected_level_transition_partial;
  /* IsAvailableForUse/ */
  kcg_bool _2_IsAvailableForUse_partial;
  /* selected_level_transition/ */
  T_LevelTransition_Level_And_Mode_Types_Pkg _3_selected_level_transition_partial;
  /* IsAvailableForUse/ */
  kcg_bool _4_IsAvailableForUse_partial;
  /* selected_level_transition/ */
  T_LevelTransition_Level_And_Mode_Types_Pkg _5_selected_level_transition_partial;
  /* IsAvailableForUse/ */
  kcg_bool _6_IsAvailableForUse_partial;
  /* IsAvailableForUse/ */
  kcg_bool _7_IsAvailableForUse_partial;
  /* selected_level_transition/ */
  T_LevelTransition_Level_And_Mode_Types_Pkg _8_selected_level_transition_partial;
  /* IsAvailableForUse/ */
  kcg_bool _9_IsAvailableForUse_partial;
  /* selected_level_transition/ */
  T_LevelTransition_Level_And_Mode_Types_Pkg _10_selected_level_transition_partial;
  kcg_bool noname;
  kcg_bool _11_noname;
  /* IsAvailableForUse/ */
  kcg_bool last_IsAvailableForUse;
  /* selected_level_transition/ */
  T_LevelTransition_Level_And_Mode_Types_Pkg last_selected_level_transition;
