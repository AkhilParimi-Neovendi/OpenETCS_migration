...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P005_OBU_sectionlist_enum_T_TM /* sections/ */ sections;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_C_P005_us_array_TM_lib_internal /* _L7=(TM_lib_internal::C_P005_us_array#1)/ */ Context_C_P005_us_array_1[33];
  ...
  array_int32_95_33 /* _L6/ */ _L6;
  kcg_int32 /* _L7/ */ _L7;
  P005_OBU_sectionlist_enum_T_TM /* _L9/ */ _L9;
  kcg_bool /* _L11/ */ _L11;
...
extern void C_P005_unflatten_sections_init_TM_lib_internal(
  outC_C_P005_unflatten_sections_TM_lib_internal *outC);
