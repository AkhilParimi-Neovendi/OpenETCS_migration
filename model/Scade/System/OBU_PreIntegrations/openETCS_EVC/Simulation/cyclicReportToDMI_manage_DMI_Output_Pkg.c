...
{
  /* packetDynamic/ */
  DMI_Dynamic_T_DMI_Messages_EVC_to_DMI_Pkg packetDynamic_partial;
  /* packetDynamic/ */
  DMI_Dynamic_T_DMI_Messages_EVC_to_DMI_Pkg _1_packetDynamic_partial;
  /* inModeAndLevel/ */
  T_Mode_Level_Level_And_Mode_Types_Pkg last_inModeAndLevel;
