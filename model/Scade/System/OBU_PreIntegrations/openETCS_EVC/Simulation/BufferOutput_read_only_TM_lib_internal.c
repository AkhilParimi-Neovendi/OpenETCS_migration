...
{
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus noname;
  ...
  kcg_copy_M_TrainTrackRadioOutputBuffer_t_TM_lib_internal(
    &outC->_L21,
    &outC->_L1);
  if ((kcg_lit_int32(0) <= outC->_L19) & (outC->_L19 < kcg_lit_int32(100))) {
    kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
      &outC->_L21[outC->_L19],
      &outC->_L22);
  }
  outC->_L18 = outC->index;
  if ((kcg_lit_int32(0) <= outC->_L18) & (outC->_L18 < kcg_lit_int32(100))) {
    kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
      &outC->_L12,
      &outC->_L1[outC->_L18]);
  }
  ...
  outC_BufferOutput_read_only_TM_lib_internal *outC)
{
  ...
  for (idx5 = 0; idx5 < 5; idx5++) {
    ...
    outC->_L3[idx5].Message.nid_message = kcg_lit_int32(0);
    outC->_L3[idx5].Message.l_message = kcg_lit_int32(0);
    outC->_L3[idx5].Message.t_train = kcg_lit_int32(0);
    outC->_L3[idx5].Message.nid_engine = kcg_lit_int32(0);
    outC->_L3[idx5].Message.field1 = kcg_lit_int32(0);
    outC->_L3[idx5].Message.field2 = kcg_lit_int32(0);
    outC->_L3[idx5].Message.field3 = kcg_lit_int32(0);
    for (idx4 = 0; idx4 < 50; idx4++) {
      outC->_L3[idx5].OptionalPackets[idx4] = kcg_lit_int32(0);
    }
  }
  outC->_L2 = kcg_lit_int32(0);
  for (idx7 = 0; idx7 < 100; idx7++) {
    outC->_L1[idx7].Message.valid = kcg_true;
    outC->_L1[idx7].Message.nid_message = kcg_lit_int32(0);
    outC->_L1[idx7].Message.l_message = kcg_lit_int32(0);
    outC->_L1[idx7].Message.t_train = kcg_lit_int32(0);
    outC->_L1[idx7].Message.nid_engine = kcg_lit_int32(0);
    outC->_L1[idx7].Message.field1 = kcg_lit_int32(0);
    outC->_L1[idx7].Message.field2 = kcg_lit_int32(0);
    outC->_L1[idx7].Message.field3 = kcg_lit_int32(0);
    for (idx6 = 0; idx6 < 50; idx6++) {
      outC->_L1[idx7].OptionalPackets[idx6] = kcg_lit_int32(0);
    }
  }
  ...
  for (idx8 = 0; idx8 < 50; idx8++) {
    outC->Message_out.OptionalPackets[idx8] = kcg_lit_int32(0);
  }
  outC->Stacksize_new = kcg_lit_int32(0);
  for (idx10 = 0; idx10 < 100; idx10++) {
    outC->Buffer_Out[idx10].Message.valid = kcg_true;
    outC->Buffer_Out[idx10].Message.nid_message = kcg_lit_int32(0);
    outC->Buffer_Out[idx10].Message.l_message = kcg_lit_int32(0);
    outC->Buffer_Out[idx10].Message.t_train = kcg_lit_int32(0);
    outC->Buffer_Out[idx10].Message.nid_engine = kcg_lit_int32(0);
    outC->Buffer_Out[idx10].Message.field1 = kcg_lit_int32(0);
    outC->Buffer_Out[idx10].Message.field2 = kcg_lit_int32(0);
    outC->Buffer_Out[idx10].Message.field3 = kcg_lit_int32(0);
    for (idx9 = 0; idx9 < 50; idx9++) {
      outC->Buffer_Out[idx10].OptionalPackets[idx9] = kcg_lit_int32(0);
    }
  }
}
