  ...
  outC_BufferMsg_read_write_TM_lib_internal *outC)
{
  ...
  if ((kcg_lit_int32(0) <= outC->_L14) & (outC->_L14 < kcg_lit_int32(5))) {
    kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
      &outC->_L21,
      &outC->_L12[outC->_L14]);
  }
  ...
  kcg_copy__125_array(&outC->_L24, (_125_array *) &outC->_L12[0]);
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
    &outC->_L25[0],
    &outC->_L26[0]);
  kcg_copy__125_array(&outC->_L25[1], &outC->_L24);
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
    &outC->Message_out,
    &outC->_L37);
  ...
  outC_BufferMsg_read_write_TM_lib_internal *outC)
{
  ...
  outC->_L41.Message.nid_message = kcg_lit_int32(0);
  outC->_L41.Message.l_message = kcg_lit_int32(0);
  outC->_L41.Message.t_train = kcg_lit_int32(0);
  outC->_L41.Message.nid_engine = kcg_lit_int32(0);
  outC->_L41.Message.field1 = kcg_lit_int32(0);
  outC->_L41.Message.field2 = kcg_lit_int32(0);
  outC->_L41.Message.field3 = kcg_lit_int32(0);
  for (idx1 = 0; idx1 < 50; idx1++) {
    outC->_L41.OptionalPackets[idx1] = kcg_lit_int32(0);
  }
  outC->_L39 = kcg_lit_int32(0);
  outC->_L40 = kcg_true;
  ...
  for (idx2 = 0; idx2 < 50; idx2++) {
    outC->_L37.OptionalPackets[idx2] = kcg_lit_int32(0);
  }
  ...
  for (idx4 = 0; idx4 < 1; idx4++) {
    ...
    outC->_L26[idx4].Message.nid_message = kcg_lit_int32(0);
    outC->_L26[idx4].Message.l_message = kcg_lit_int32(0);
    outC->_L26[idx4].Message.t_train = kcg_lit_int32(0);
    outC->_L26[idx4].Message.nid_engine = kcg_lit_int32(0);
    outC->_L26[idx4].Message.field1 = kcg_lit_int32(0);
    outC->_L26[idx4].Message.field2 = kcg_lit_int32(0);
    outC->_L26[idx4].Message.field3 = kcg_lit_int32(0);
    for (idx3 = 0; idx3 < 50; idx3++) {
      outC->_L26[idx4].OptionalPackets[idx3] = kcg_lit_int32(0);
    }
  }
  for (idx6 = 0; idx6 < 5; idx6++) {
    outC->_L25[idx6].Message.valid = kcg_true;
    outC->_L25[idx6].Message.nid_message = kcg_lit_int32(0);
    outC->_L25[idx6].Message.l_message = kcg_lit_int32(0);
    outC->_L25[idx6].Message.t_train = kcg_lit_int32(0);
    outC->_L25[idx6].Message.nid_engine = kcg_lit_int32(0);
    outC->_L25[idx6].Message.field1 = kcg_lit_int32(0);
    outC->_L25[idx6].Message.field2 = kcg_lit_int32(0);
    outC->_L25[idx6].Message.field3 = kcg_lit_int32(0);
    for (idx5 = 0; idx5 < 50; idx5++) {
      outC->_L25[idx6].OptionalPackets[idx5] = kcg_lit_int32(0);
    }
  }
  for (idx8 = 0; idx8 < 4; idx8++) {
    outC->_L24[idx8].Message.valid = kcg_true;
    outC->_L24[idx8].Message.nid_message = kcg_lit_int32(0);
    outC->_L24[idx8].Message.l_message = kcg_lit_int32(0);
    outC->_L24[idx8].Message.t_train = kcg_lit_int32(0);
    outC->_L24[idx8].Message.nid_engine = kcg_lit_int32(0);
    outC->_L24[idx8].Message.field1 = kcg_lit_int32(0);
    outC->_L24[idx8].Message.field2 = kcg_lit_int32(0);
    outC->_L24[idx8].Message.field3 = kcg_lit_int32(0);
    for (idx7 = 0; idx7 < 50; idx7++) {
      outC->_L24[idx8].OptionalPackets[idx7] = kcg_lit_int32(0);
    }
  }
  for (idx10 = 0; idx10 < 5; idx10++) {
    outC->_L12[idx10].Message.valid = kcg_true;
    outC->_L12[idx10].Message.nid_message = kcg_lit_int32(0);
    outC->_L12[idx10].Message.l_message = kcg_lit_int32(0);
    outC->_L12[idx10].Message.t_train = kcg_lit_int32(0);
    outC->_L12[idx10].Message.nid_engine = kcg_lit_int32(0);
    outC->_L12[idx10].Message.field1 = kcg_lit_int32(0);
    outC->_L12[idx10].Message.field2 = kcg_lit_int32(0);
    outC->_L12[idx10].Message.field3 = kcg_lit_int32(0);
    for (idx9 = 0; idx9 < 50; idx9++) {
      outC->_L12[idx10].OptionalPackets[idx9] = kcg_lit_int32(0);
    }
  }
  ...
  for (idx11 = 0; idx11 < 50; idx11++) {
    outC->_L21.OptionalPackets[idx11] = kcg_lit_int32(0);
  }
  ...
  for (idx12 = 0; idx12 < 50; idx12++) {
    outC->_L23.OptionalPackets[idx12] = kcg_lit_int32(0);
  }
  ...
  for (idx13 = 0; idx13 < 50; idx13++) {
    outC->Message_out.OptionalPackets[idx13] = kcg_lit_int32(0);
  }
  outC->Stacksize_new = kcg_lit_int32(0);
  for (idx15 = 0; idx15 < 5; idx15++) {
    outC->Buffer_Out[idx15].Message.valid = kcg_true;
    outC->Buffer_Out[idx15].Message.nid_message = kcg_lit_int32(0);
    outC->Buffer_Out[idx15].Message.l_message = kcg_lit_int32(0);
    outC->Buffer_Out[idx15].Message.t_train = kcg_lit_int32(0);
    outC->Buffer_Out[idx15].Message.nid_engine = kcg_lit_int32(0);
    outC->Buffer_Out[idx15].Message.field1 = kcg_lit_int32(0);
    outC->Buffer_Out[idx15].Message.field2 = kcg_lit_int32(0);
    outC->Buffer_Out[idx15].Message.field3 = kcg_lit_int32(0);
    for (idx14 = 0; idx14 < 50; idx14++) {
      outC->Buffer_Out[idx15].OptionalPackets[idx14] = kcg_lit_int32(0);
    }
  }
}
