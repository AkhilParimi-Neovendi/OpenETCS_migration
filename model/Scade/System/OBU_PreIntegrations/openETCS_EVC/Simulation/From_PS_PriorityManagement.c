...
{
  /* FromPS_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg FromPS_To_NewMode_partial;
  /* FromPS_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _1_FromPS_To_NewMode_partial;
  /* FromPS_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _2_FromPS_To_NewMode_partial;
  /* FromPS_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _3_FromPS_To_NewMode_partial;
  /* FromPS_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _4_FromPS_To_NewMode_partial;
  /* FromPS_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _5_FromPS_To_NewMode_partial;
  /* FromPS_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _6_FromPS_To_NewMode_partial;
  /* FromPS_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _7_FromPS_To_NewMode_partial;
  /* FromPS_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _8_FromPS_To_NewMode_partial;
  /* FromPS_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _9_FromPS_To_NewMode_partial;
  /* FromPS_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _10_FromPS_To_NewMode_partial;
  /* FromPS_To_NewMode/ */
  T_Mode_Level_And_Mode_Types_Pkg _11_FromPS_To_NewMode_partial;
