  ...
  outC_manageAdditionalTelegram_Receive_TrackSide_Msg_Pkg *outC)
{
  ...
  outC->_L9.odometerOfBaliseDetection.timestamp = kcg_lit_int32(0);
  outC->_L9.odometerOfBaliseDetection.odo.o_nominal = kcg_lit_int32(0);
  outC->_L9.odometerOfBaliseDetection.odo.o_min = kcg_lit_int32(0);
  outC->_L9.odometerOfBaliseDetection.odo.o_max = kcg_lit_int32(0);
  outC->_L9.odometerOfBaliseDetection.speed.v_safeNominal = kcg_lit_int32(0);
  outC->_L9.odometerOfBaliseDetection.speed.v_rawNominal = kcg_lit_int32(0);
  outC->_L9.odometerOfBaliseDetection.speed.v_lower = kcg_lit_int32(0);
  outC->_L9.odometerOfBaliseDetection.speed.v_upper = kcg_lit_int32(0);
  outC->_L9.odometerOfBaliseDetection.acceleration = kcg_lit_int32(0);
  ...
  outC->_L19.odometerOfBaliseDetection.timestamp = kcg_lit_int32(0);
  outC->_L19.odometerOfBaliseDetection.odo.o_nominal = kcg_lit_int32(0);
  outC->_L19.odometerOfBaliseDetection.odo.o_min = kcg_lit_int32(0);
  outC->_L19.odometerOfBaliseDetection.odo.o_max = kcg_lit_int32(0);
  outC->_L19.odometerOfBaliseDetection.speed.v_safeNominal = kcg_lit_int32(0);
  outC->_L19.odometerOfBaliseDetection.speed.v_rawNominal = kcg_lit_int32(0);
  outC->_L19.odometerOfBaliseDetection.speed.v_lower = kcg_lit_int32(0);
  outC->_L19.odometerOfBaliseDetection.speed.v_upper = kcg_lit_int32(0);
  outC->_L19.odometerOfBaliseDetection.acceleration = kcg_lit_int32(0);
  ...
  outC->_L19.odometerOfBaliseDetection.motionDirection =
    unknownDirection_Obu_BasicTypes_Pkg;
  outC->_L19.BG_centerDetectionInaccuraccuracies.nominal = kcg_lit_int32(0);
  outC->_L19.BG_centerDetectionInaccuraccuracies.d_min = kcg_lit_int32(0);
  outC->_L19.BG_centerDetectionInaccuraccuracies.d_max = kcg_lit_int32(0);
  ...
  outC->_L46.telegram.telegramheader.m_mcount = kcg_lit_int32(0);
  outC->_L46.telegram.telegramheader.nid_c = kcg_lit_int32(0);
  outC->_L46.telegram.telegramheader.nid_bg = kcg_lit_int32(0);
  outC->_L46.telegram.telegramheader.q_link = Q_LINK_Unlinked;
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L46.telegram.packets.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    ...
    outC->_L46.telegram.packets.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L46.telegram.packets.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L46.telegram.packets.PacketData[idx3] = kcg_lit_int32(0);
  }
  outC->_L46.position.odometerOfBaliseDetection.valid = kcg_true;
  outC->_L46.position.odometerOfBaliseDetection.timestamp = kcg_lit_int32(0);
  outC->_L46.position.odometerOfBaliseDetection.odo.o_nominal = kcg_lit_int32(0);
  outC->_L46.position.odometerOfBaliseDetection.odo.o_min = kcg_lit_int32(0);
  outC->_L46.position.odometerOfBaliseDetection.odo.o_max = kcg_lit_int32(0);
  ...
  outC->_L46.position.odometerOfBaliseDetection.speed.v_rawNominal =
    kcg_lit_int32(0);
  outC->_L46.position.odometerOfBaliseDetection.speed.v_lower = kcg_lit_int32(0);
  outC->_L46.position.odometerOfBaliseDetection.speed.v_upper = kcg_lit_int32(0);
  outC->_L46.position.odometerOfBaliseDetection.acceleration = kcg_lit_int32(0);
  ...
  outC->_L46.position.BG_centerDetectionInaccuraccuracies.nominal =
    kcg_lit_int32(0);
  outC->_L46.position.BG_centerDetectionInaccuraccuracies.d_min = kcg_lit_int32(
      0);
  outC->_L46.position.BG_centerDetectionInaccuraccuracies.d_max = kcg_lit_int32(
      0);
  outC->_L22 = kcg_true;
  ...
  outC->_L20.telegramheader.m_mcount = kcg_lit_int32(0);
  outC->_L20.telegramheader.nid_c = kcg_lit_int32(0);
  outC->_L20.telegramheader.nid_bg = kcg_lit_int32(0);
  outC->_L20.telegramheader.q_link = Q_LINK_Unlinked;
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->_L20.packets.PacketHeaders[idx4].nid_packet = kcg_lit_int32(0);
    outC->_L20.packets.PacketHeaders[idx4].q_dir = Q_DIR_Reverse;
    outC->_L20.packets.PacketHeaders[idx4].valid = kcg_true;
    outC->_L20.packets.PacketHeaders[idx4].startAddress = kcg_lit_int32(0);
    outC->_L20.packets.PacketHeaders[idx4].endAddress = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->_L20.packets.PacketData[idx5] = kcg_lit_int32(0);
  }
  outC->_L26 = kcg_true;
  ...
  outC->_L7.telegramheader.m_mcount = kcg_lit_int32(0);
  outC->_L7.telegramheader.nid_c = kcg_lit_int32(0);
  outC->_L7.telegramheader.nid_bg = kcg_lit_int32(0);
  outC->_L7.telegramheader.q_link = Q_LINK_Unlinked;
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L7.packets.PacketHeaders[idx6].nid_packet = kcg_lit_int32(0);
    outC->_L7.packets.PacketHeaders[idx6].q_dir = Q_DIR_Reverse;
    outC->_L7.packets.PacketHeaders[idx6].valid = kcg_true;
    outC->_L7.packets.PacketHeaders[idx6].startAddress = kcg_lit_int32(0);
    outC->_L7.packets.PacketHeaders[idx6].endAddress = kcg_lit_int32(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->_L7.packets.PacketData[idx7] = kcg_lit_int32(0);
  }
  outC->_L21.odometerOfBaliseDetection.valid = kcg_true;
  outC->_L21.odometerOfBaliseDetection.timestamp = kcg_lit_int32(0);
  outC->_L21.odometerOfBaliseDetection.odo.o_nominal = kcg_lit_int32(0);
  outC->_L21.odometerOfBaliseDetection.odo.o_min = kcg_lit_int32(0);
  outC->_L21.odometerOfBaliseDetection.odo.o_max = kcg_lit_int32(0);
  outC->_L21.odometerOfBaliseDetection.speed.v_safeNominal = kcg_lit_int32(0);
  outC->_L21.odometerOfBaliseDetection.speed.v_rawNominal = kcg_lit_int32(0);
  outC->_L21.odometerOfBaliseDetection.speed.v_lower = kcg_lit_int32(0);
  outC->_L21.odometerOfBaliseDetection.speed.v_upper = kcg_lit_int32(0);
  outC->_L21.odometerOfBaliseDetection.acceleration = kcg_lit_int32(0);
  ...
  outC->outDecodedTelegram.telegramheader.m_mcount = kcg_lit_int32(0);
  outC->outDecodedTelegram.telegramheader.nid_c = kcg_lit_int32(0);
  outC->outDecodedTelegram.telegramheader.nid_bg = kcg_lit_int32(0);
  ...
  for (idx9 = 0; idx9 < 500; idx9++) {
    outC->outDecodedTelegram.packets.PacketData[idx9] = kcg_lit_int32(0);
  }
