...
typedef struct {
  ...
  outC_CAST_DMI_m_icon_flashing__DATA_Variables /* _L24=(DATA::Variables::CAST_DMI_m_icon_flashing_freq_to_int#1)/ */ Context_CAST_DMI_m_icon_flashing_freq_to_int_1;
