...
#include "CAST_DMI_EVC_Coded_Train__DATA_Packets_EVC_to_DMI.h"

/* DATA::Packets::EVC_to_DMI::CAST_DMI_EVC_Coded_Train_Data_to_int1/ */
void CAST_DMI_EVC_Coded_Train__DATA_Packets_EVC_to_DMI(
  ...
  outC_CAST_DMI_EVC_Coded_Train__DATA_Packets_EVC_to_DMI *outC)
{
  ...
  CAST_DMI_airtightSystem_t_DATA_Variables(
    &outC->_L3,
...
void CAST_DMI_EVC_Coded_Train__init_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_EVC_Coded_Train__DATA_Packets_EVC_to_DMI *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  outC->_L2.number = kcg_lit_int32(0);
  outC->_L2.dig1 = kcg_lit_int32(0);
  outC->_L2.dig2 = kcg_lit_int32(0);
  outC->_L2.dig3 = kcg_lit_int32(0);
  outC->_L3.number = kcg_lit_int32(0);
  outC->_L3.dig1 = kcg_lit_int32(0);
  outC->_L3.dig2 = kcg_lit_int32(0);
  outC->_L3.dig3 = kcg_lit_int32(0);
  outC->_L4 = M_AXLELOADCAT_A;
  outC->_L5.number = kcg_lit_int32(0);
  outC->_L5.dig1 = kcg_lit_int32(0);
  outC->_L5.dig2 = kcg_lit_int32(0);
  outC->_L5.dig3 = kcg_lit_int32(0);
  outC->_L6.number = kcg_lit_int32(0);
  outC->_L6.dig1 = kcg_lit_int32(0);
  outC->_L6.dig2 = kcg_lit_int32(0);
  outC->_L6.dig3 = kcg_lit_int32(0);
  outC->_L7.number = kcg_lit_int32(0);
  outC->_L7.dig1 = kcg_lit_int32(0);
  outC->_L7.dig2 = kcg_lit_int32(0);
  outC->_L7.dig3 = kcg_lit_int32(0);
  outC->_L7.dig4 = kcg_lit_int32(0);
  outC->_L8.number = kcg_lit_int32(0);
  outC->_L8.dig1 = kcg_lit_int32(0);
  outC->_L8.dig2 = kcg_lit_int32(0);
  outC->_L8.dig3 = kcg_lit_int32(0);
  outC->_L8.dig4 = kcg_lit_int32(0);
  outC->_L8.dig5 = kcg_lit_int32(0);
  ...
  for (idx1 = 0; idx1 < 9; idx1++) {
    outC->dmi_evc_coded_train_data_int[idx1] = kcg_lit_int32(0);
  }
  /* _L19=(DATA::Variables::CAST_DMI_loadingGauge_to_int#1)/ */
  CAST_DMI_loadingGauge_to_int_init_DATA_Variables(
    &outC->Context_CAST_DMI_loadingGauge_to_int_1);
  /* _L18=(DATA::Variables::CAST_DMI_airtightSystem_to_int#1)/ */
  CAST_DMI_airtightSystem_t_init_DATA_Variables(
    &outC->Context_CAST_DMI_airtightSystem_to_int_1);
  /* _L17=(TM_conversions::CAST_M_AXLELOADCAT_to_int#1)/ */
...
void CAST_DMI_EVC_Coded_Train__reset_DATA_Packets_EVC_to_DMI(
  outC_CAST_DMI_EVC_Coded_Train__DATA_Packets_EVC_to_DMI *outC)
{
  /* _L19=(DATA::Variables::CAST_DMI_loadingGauge_to_int#1)/ */
  CAST_DMI_loadingGauge_to_int_reset_DATA_Variables(
    &outC->Context_CAST_DMI_loadingGauge_to_int_1);
  /* _L18=(DATA::Variables::CAST_DMI_airtightSystem_to_int#1)/ */
  CAST_DMI_airtightSystem_t_reset_DATA_Variables(
    &outC->Context_CAST_DMI_airtightSystem_to_int_1);
  /* _L17=(TM_conversions::CAST_M_AXLELOADCAT_to_int#1)/ */
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** CAST_DMI_EVC_Coded_Train__DATA_Packets_EVC_to_DMI.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
