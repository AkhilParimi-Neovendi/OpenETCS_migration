...
void Write_DMI_EVC_Radio_Net_D_DATA_Packets_EVC_to_DMI(
...
{
  _13_DMI_EVC_Radio_Net_Data_int_array_T_DATA op_call;
  ...
  if (outC->every) {
    ...
    CAST_DMI_EVC_Radio_Net_Da_DATA_Packets_EVC_to_DMI(
      &outC->_L8,
  ...
  if (outC->every) {
    kcg_copy__13_DMI_EVC_Radio_Net_Data_int_array_T_DATA(&outC->_L9, &op_call);
  }
  else {
    kcg_copy__13_DMI_EVC_Radio_Net_Data_int_array_T_DATA(&outC->_L9, &outC->_L11);
  }
  kcg_copy__13_DMI_EVC_Radio_Net_Data_int_array_T_DATA(
...
void Write_DMI_EVC_Radio_Net_D_init_DATA_Packets_EVC_to_DMI(
  outC_Write_DMI_EVC_Radio_Net_D_DATA_Packets_EVC_to_DMI *outC)
{
  kcg_size idx;
  kcg_size idx1;
  ...
  /* _L9=(DATA::Packets::EVC_to_DMI::CAST_DMI_EVC_Radio_Net_Data_to_int1#1)/ */
  CAST_DMI_EVC_Radio_Net_Da_init_DATA_Packets_EVC_to_DMI(
    &outC->Context_CAST_DMI_EVC_Radio_Net_Data_to_int1_1);
}
...
void Write_DMI_EVC_Radio_Net_D_reset_DATA_Packets_EVC_to_DMI(
  outC_Write_DMI_EVC_Radio_Net_D_DATA_Packets_EVC_to_DMI *outC)
{
  /* _L9=(DATA::Packets::EVC_to_DMI::CAST_DMI_EVC_Radio_Net_Data_to_int1#1)/ */
  CAST_DMI_EVC_Radio_Net_Da_reset_DATA_Packets_EVC_to_DMI(
    &outC->Context_CAST_DMI_EVC_Radio_Net_Data_to_int1_1);
}
...
/* $********** SCADE Suite KCG 32-bit 6.6.2 (build i4) **********
** Write_DMI_EVC_Radio_Net_D_DATA_Packets_EVC_to_DMI.c
** Generation date: 2023-11-06T13:54:29
*************************************************************$ */
