...
{
  /* passedBG_out/ */
  ReceivedMessage_T_Common_Types_Pkg passedBG_out_partial;
  /* errorLinkedBG/ */
  kcg_bool errorLinkedBG_partial;
  /* nid_errorBG/ */
  NID_ERRORBG_BG_Types_Pkg nid_errorBG_partial;
  /* nid_c/ */
  NID_C nid_c_partial;
  /* passedBG_out/ */
  ReceivedMessage_T_Common_Types_Pkg _1_passedBG_out_partial;
  /* errorLinkedBG/ */
  kcg_bool _2_errorLinkedBG_partial;
  /* nid_errorBG/ */
  NID_ERRORBG_BG_Types_Pkg _3_nid_errorBG_partial;
  /* nid_c/ */
  NID_C _4_nid_c_partial;
  /* nid_c/ */
  NID_C _5_nid_c_partial;
  /* nid_errorBG/ */
  NID_ERRORBG_BG_Types_Pkg _6_nid_errorBG_partial;
  /* errorLinkedBG/ */
  kcg_bool _7_errorLinkedBG_partial;
  /* passedBG_out/ */
  ReceivedMessage_T_Common_Types_Pkg _8_passedBG_out_partial;
  /* nid_c/ */
  NID_C _9_nid_c_partial;
  /* nid_errorBG/ */
  NID_ERRORBG_BG_Types_Pkg _10_nid_errorBG_partial;
  /* errorLinkedBG/ */
  kcg_bool _11_errorLinkedBG_partial;
  /* passedBG_out/ */
  ReceivedMessage_T_Common_Types_Pkg _12_passedBG_out_partial;
  /* passedBGlocal/ */
  ReceivedMessage_T_Common_Types_Pkg last_passedBGlocal;
  ...
  if (outC->IfBlock1_clock) {
    nid_c_partial = kcg_lit_int32(0);
    nid_errorBG_partial = kcg_lit_int32(16383);
    ...
    if (outC->else_clock_IfBlock1) {
      _9_nid_c_partial = kcg_lit_int32(0);
      _10_nid_errorBG_partial = kcg_lit_int32(16383);
      ...
      WriteDirection2PassedBG_CheckBGConsistency_Pkg_SubFunction(
        ...
        &outC->_L24_then_else_IfBlock1,
        &outC->_1_Context_WriteDirection2PassedBG_2);
      kcg_copy_ReceivedMessage_T_Common_Types_Pkg(
        &outC->_L23_then_else_IfBlock1,
        &outC->_1_Context_WriteDirection2PassedBG_2.passedBG_out);
      kcg_copy_ReceivedMessage_T_Common_Types_Pkg(
  ...
  outC_CaseLinkingInUse_CheckBGConsistency_Pkg *outC)
{
  ...
  for (idx2 = 0; idx2 < 8; idx2++) {
    ...
    outC->_L27.Telegrams[idx2].telegramheader.m_mcount = kcg_lit_int32(0);
    outC->_L27.Telegrams[idx2].telegramheader.nid_c = kcg_lit_int32(0);
    outC->_L27.Telegrams[idx2].telegramheader.nid_bg = kcg_lit_int32(0);
    ...
    for (idx1 = 0; idx1 < 500; idx1++) {
      outC->_L27.Telegrams[idx2].packets.PacketData[idx1] = kcg_lit_int32(0);
    }
  }
  outC->_L27.numberBalises = kcg_lit_int32(0);
  ...
  outC->_L26.telegramHeaders.numberBalises = kcg_lit_int32(0);
  ...
  outC->_L26.radio_Msg.header.radioDevice = kcg_lit_int32(0);
  outC->_L26.radio_Msg.header.receivedSystemTime = kcg_lit_int32(0);
  outC->_L26.radio_Msg.header.nid_message = kcg_lit_int32(0);
  outC->_L26.radio_Msg.header.t_train = kcg_lit_int32(0);
  outC->_L26.radio_Msg.header.m_ack = M_ACK_No_acknowledgement_required;
  outC->_L26.radio_Msg.header.nid_lrbg = kcg_lit_int32(0);
  outC->_L26.radio_Msg.header.t_train_reference = kcg_lit_int32(0);
  outC->_L26.radio_Msg.header.nid_em = kcg_lit_int32(0);
  outC->_L26.radio_Msg.header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L26.radio_Msg.header.d_sr = kcg_lit_int32(0);
  outC->_L26.radio_Msg.header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L26.radio_Msg.header.d_ref = kcg_lit_int32(0);
  outC->_L26.radio_Msg.header.q_dir = Q_DIR_Reverse;
  outC->_L26.radio_Msg.header.d_emergencystop = kcg_lit_int32(0);
  ...
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->_L26.radio_Msg.packets.PacketHeaders[idx6].nid_packet = kcg_lit_int32(0);
    ...
    outC->_L26.radio_Msg.packets.PacketHeaders[idx6].startAddress =
      kcg_lit_int32(0);
    outC->_L26.radio_Msg.packets.PacketHeaders[idx6].endAddress = kcg_lit_int32(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->_L26.radio_Msg.packets.PacketData[idx7] = kcg_lit_int32(0);
  }
  outC->_L26.radio_Msg.sendingRBC.valid = kcg_true;
  outC->_L26.radio_Msg.sendingRBC.nid_c = kcg_lit_int32(0);
  outC->_L26.radio_Msg.sendingRBC.rbc_id = kcg_lit_int32(0);
  outC->_L26.radio_Msg.sendingRBC.device_id = kcg_lit_int32(0);
  ...
  outC->_L24.m_mcount = kcg_lit_int32(0);
  ...
  outC->_L24.bgPosition.timestamp = kcg_lit_int32(0);
  outC->_L24.bgPosition.odo.o_nominal = kcg_lit_int32(0);
  outC->_L24.bgPosition.odo.o_min = kcg_lit_int32(0);
  outC->_L24.bgPosition.odo.o_max = kcg_lit_int32(0);
  outC->_L24.bgPosition.speed.v_safeNominal = kcg_lit_int32(0);
  outC->_L24.bgPosition.speed.v_rawNominal = kcg_lit_int32(0);
  outC->_L24.bgPosition.speed.v_lower = kcg_lit_int32(0);
  outC->_L24.bgPosition.speed.v_upper = kcg_lit_int32(0);
  outC->_L24.bgPosition.acceleration = kcg_lit_int32(0);
  ...
  outC->_L24.BG_centerDetectionInaccuraccuracies.nominal = kcg_lit_int32(0);
  outC->_L24.BG_centerDetectionInaccuraccuracies.d_min = kcg_lit_int32(0);
  outC->_L24.BG_centerDetectionInaccuraccuracies.d_max = kcg_lit_int32(0);
  outC->_L24.q_nvlocacc = kcg_lit_int32(0);
  ...
  for (idx8 = 0; idx8 < 30; idx8++) {
    outC->_L19.packets.PacketHeaders[idx8].nid_packet = kcg_lit_int32(0);
    outC->_L19.packets.PacketHeaders[idx8].q_dir = Q_DIR_Reverse;
    outC->_L19.packets.PacketHeaders[idx8].valid = kcg_true;
    outC->_L19.packets.PacketHeaders[idx8].startAddress = kcg_lit_int32(0);
    outC->_L19.packets.PacketHeaders[idx8].endAddress = kcg_lit_int32(0);
  }
  for (idx9 = 0; idx9 < 500; idx9++) {
    outC->_L19.packets.PacketData[idx9] = kcg_lit_int32(0);
  }
  ...
  outC->_L13.telegramheader.m_mcount = kcg_lit_int32(0);
  outC->_L13.telegramheader.nid_c = kcg_lit_int32(0);
  outC->_L13.telegramheader.nid_bg = kcg_lit_int32(0);
  outC->_L13.telegramheader.q_link = Q_LINK_Unlinked;
  for (idx12 = 0; idx12 < 30; idx12++) {
    outC->_L13.packets.PacketHeaders[idx12].nid_packet = kcg_lit_int32(0);
    outC->_L13.packets.PacketHeaders[idx12].q_dir = Q_DIR_Reverse;
    outC->_L13.packets.PacketHeaders[idx12].valid = kcg_true;
    outC->_L13.packets.PacketHeaders[idx12].startAddress = kcg_lit_int32(0);
    outC->_L13.packets.PacketHeaders[idx12].endAddress = kcg_lit_int32(0);
  }
  for (idx13 = 0; idx13 < 500; idx13++) {
    outC->_L13.packets.PacketData[idx13] = kcg_lit_int32(0);
  }
  outC->nid_c_local = kcg_lit_int32(0);
  outC->nid_errorBG_local = kcg_lit_int32(0);
  ...
  for (idx14 = 0; idx14 < 30; idx14++) {
    outC->lastTelegram.packets.PacketHeaders[idx14].nid_packet = kcg_lit_int32(0);
    ...
    outC->lastTelegram.packets.PacketHeaders[idx14].startAddress = kcg_lit_int32(0);
    outC->lastTelegram.packets.PacketHeaders[idx14].endAddress = kcg_lit_int32(0);
  }
  for (idx15 = 0; idx15 < 500; idx15++) {
    outC->lastTelegram.packets.PacketData[idx15] = kcg_lit_int32(0);
  }
  outC->isComplete = kcg_true;
  outC->IfBlock1_clock = kcg_true;
  outC->_L57_then_else_IfBlock1.valid = kcg_true;
  outC->_L57_then_else_IfBlock1.systemTime = kcg_lit_int32(0);
  ...
  outC->_L57_then_else_IfBlock1.telegramHeaders.numberBalises = kcg_lit_int32(0);
  ...
  outC->_L57_then_else_IfBlock1.radio_Msg.header.radioDevice = kcg_lit_int32(0);
  outC->_L57_then_else_IfBlock1.radio_Msg.header.receivedSystemTime =
    kcg_lit_int32(0);
  outC->_L57_then_else_IfBlock1.radio_Msg.header.nid_message = kcg_lit_int32(0);
  outC->_L57_then_else_IfBlock1.radio_Msg.header.t_train = kcg_lit_int32(0);
  outC->_L57_then_else_IfBlock1.radio_Msg.header.m_ack =
    M_ACK_No_acknowledgement_required;
  outC->_L57_then_else_IfBlock1.radio_Msg.header.nid_lrbg = kcg_lit_int32(0);
  outC->_L57_then_else_IfBlock1.radio_Msg.header.t_train_reference =
    kcg_lit_int32(0);
  outC->_L57_then_else_IfBlock1.radio_Msg.header.nid_em = kcg_lit_int32(0);
  outC->_L57_then_else_IfBlock1.radio_Msg.header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L57_then_else_IfBlock1.radio_Msg.header.d_sr = kcg_lit_int32(0);
  outC->_L57_then_else_IfBlock1.radio_Msg.header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L57_then_else_IfBlock1.radio_Msg.header.d_ref = kcg_lit_int32(0);
  ...
  outC->_L57_then_else_IfBlock1.radio_Msg.sendingRBC.nid_c = kcg_lit_int32(0);
  outC->_L57_then_else_IfBlock1.radio_Msg.sendingRBC.rbc_id = kcg_lit_int32(0);
  outC->_L57_then_else_IfBlock1.radio_Msg.sendingRBC.device_id = kcg_lit_int32(0);
  ...
  outC->_L58_then_else_IfBlock1.numberBalises = kcg_lit_int32(0);
  ...
  outC->_L15_then_else_IfBlock1 = kcg_lit_int32(0);
  ...
  outC->_L19_then_else_IfBlock1.telegramheader.m_mcount = kcg_lit_int32(0);
  outC->_L19_then_else_IfBlock1.telegramheader.nid_c = kcg_lit_int32(0);
  outC->_L19_then_else_IfBlock1.telegramheader.nid_bg = kcg_lit_int32(0);
  ...
  for (idx25 = 0; idx25 < 500; idx25++) {
    outC->_L19_then_else_IfBlock1.packets.PacketData[idx25] = kcg_lit_int32(0);
  }
  ...
  for (idx27 = 0; idx27 < 500; idx27++) {
    outC->_L23_then_else_IfBlock1.packets.PacketData[idx27] = kcg_lit_int32(0);
  }
  ...
  outC->_L24_then_else_IfBlock1.BG_Common_Header.n_total =
    N_TOTAL_1_balise_in_the_group;
  outC->_L24_then_else_IfBlock1.BG_Common_Header.m_mcount = kcg_lit_int32(0);
  outC->_L24_then_else_IfBlock1.BG_Common_Header.nid_c = kcg_lit_int32(0);
  outC->_L24_then_else_IfBlock1.BG_Common_Header.nid_bg = kcg_lit_int32(0);
  ...
  outC->_L24_then_else_IfBlock1.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max =
    kcg_lit_int32(0);
  outC->_L24_then_else_IfBlock1.BG_Common_Header.q_nvlocacc = kcg_lit_int32(0);
  ...
  outC->_L24_then_else_IfBlock1.BG_Common_Header.trainRunningDirectionToBG =
    Q_DIRTRAIN_Reverse;
  outC->_L24_then_else_IfBlock1.Radio_Common_Header.radioDevice = kcg_lit_int32(
      0);
  outC->_L24_then_else_IfBlock1.Radio_Common_Header.receivedSystemTime =
    kcg_lit_int32(0);
  outC->_L24_then_else_IfBlock1.Radio_Common_Header.nid_message = kcg_lit_int32(
      0);
  outC->_L24_then_else_IfBlock1.Radio_Common_Header.t_train = kcg_lit_int32(0);
  outC->_L24_then_else_IfBlock1.Radio_Common_Header.m_ack =
    M_ACK_No_acknowledgement_required;
  outC->_L24_then_else_IfBlock1.Radio_Common_Header.nid_lrbg = kcg_lit_int32(0);
  outC->_L24_then_else_IfBlock1.Radio_Common_Header.t_train_reference =
    kcg_lit_int32(0);
  outC->_L24_then_else_IfBlock1.Radio_Common_Header.nid_em = kcg_lit_int32(0);
  outC->_L24_then_else_IfBlock1.Radio_Common_Header.q_scale = Q_SCALE_10_cm_scale;
  outC->_L24_then_else_IfBlock1.Radio_Common_Header.d_sr = kcg_lit_int32(0);
  outC->_L24_then_else_IfBlock1.Radio_Common_Header.t_sh_rqst = kcg_lit_int32(0);
  outC->_L24_then_else_IfBlock1.Radio_Common_Header.d_ref = kcg_lit_int32(0);
  ...
  for (idx29 = 0; idx29 < 500; idx29++) {
    outC->_L24_then_else_IfBlock1.packets.PacketData[idx29] = kcg_lit_int32(0);
  }
  outC->_L24_then_else_IfBlock1.sendingRBC.valid = kcg_true;
  outC->_L24_then_else_IfBlock1.sendingRBC.nid_c = kcg_lit_int32(0);
  outC->_L24_then_else_IfBlock1.sendingRBC.rbc_id = kcg_lit_int32(0);
  outC->_L24_then_else_IfBlock1.sendingRBC.device_id = kcg_lit_int32(0);
  outC->_L45_then_else_IfBlock1 =
    Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
  ...
  for (idx31 = 0; idx31 < 500; idx31++) {
    outC->_L14_then_IfBlock1.packets.PacketData[idx31] = kcg_lit_int32(0);
  }
  ...
  for (idx33 = 0; idx33 < 500; idx33++) {
    outC->_L16_then_IfBlock1.packets.PacketData[idx33] = kcg_lit_int32(0);
  }
  ...
  for (idx34 = 0; idx34 < 30; idx34++) {
    outC->passedBG_out.packets.PacketHeaders[idx34].nid_packet = kcg_lit_int32(0);
    ...
    outC->passedBG_out.packets.PacketHeaders[idx34].startAddress = kcg_lit_int32(0);
    outC->passedBG_out.packets.PacketHeaders[idx34].endAddress = kcg_lit_int32(0);
  }
  for (idx35 = 0; idx35 < 500; idx35++) {
    outC->passedBG_out.packets.PacketData[idx35] = kcg_lit_int32(0);
  }
