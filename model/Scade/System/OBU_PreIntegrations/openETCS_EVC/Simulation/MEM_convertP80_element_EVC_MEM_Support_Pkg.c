  ...
  outC_MEM_convertP80_element_EVC_MEM_Support_Pkg *outC)
{
  ...
  outC->_L27.d_validnv = kcg_lit_int32(0);
  outC->_L27.nid_c = kcg_lit_int32(0);
  outC->_L27.n_iter_nid_c = kcg_lit_int32(0);
  for (idx = 0; idx < 32; idx++) {
    outC->_L27.nid_c_list[idx].valid = kcg_true;
    outC->_L27.nid_c_list[idx].nid_c = kcg_lit_int32(0);
  }
  outC->_L27.v_nvshunt = kcg_lit_int32(0);
  outC->_L27.v_nvstff = kcg_lit_int32(0);
  outC->_L27.v_nvonsight = kcg_lit_int32(0);
  outC->_L27.v_nvlimsuperv = kcg_lit_int32(0);
  outC->_L27.v_nvunfit = kcg_lit_int32(0);
  outC->_L27.v_nvrel = kcg_lit_int32(0);
  outC->_L27.d_nvroll = kcg_lit_int32(0);
  ...
  outC->_L27.v_nvallowovtrp = kcg_lit_int32(0);
  outC->_L27.v_nvsupovtrp = kcg_lit_int32(0);
  outC->_L27.d_nvovtrp = kcg_lit_int32(0);
  outC->_L27.t_nvovtrp = kcg_lit_int32(0);
  outC->_L27.d_nvpotrp = kcg_lit_int32(0);
  outC->_L27.m_nvcontact = M_NVCONTACT_Train_trip;
  outC->_L27.t_nvcontact = kcg_lit_int32(0);
  outC->_L27.m_nvderun = M_NVDERUN_No;
  outC->_L27.d_nvstff = kcg_lit_int32(0);
  outC->_L27.q_nvdriver_adhes = Q_NVDRIVER_ADHES_Not_allowed;
  outC->_L27.a_nvmaxredadh1 = kcg_lit_float32(0.0);
  outC->_L27.a_nvmaxredadh2 = kcg_lit_float32(0.0);
  outC->_L27.a_nvmaxredadh3 = kcg_lit_float32(0.0);
  outC->_L27.q_nvlocacc = kcg_lit_int32(0);
  outC->_L27.m_nvavadh = kcg_lit_float32(0.0);
  ...
  outC->_L27.v_nvkvint = kcg_lit_int32(0);
  outC->_L27.m_nvkvint_12 = kcg_lit_float32(0.0);
  outC->_L27.m_nvkvint_23 = kcg_lit_float32(0.0);
  outC->_L27.n_iter_n = kcg_lit_int32(0);
  for (idx1 = 0; idx1 < 32; idx1++) {
    outC->_L27.n_iter_n_list[idx1].valid = kcg_true;
    outC->_L27.n_iter_n_list[idx1].v_nvkvint_n = kcg_lit_int32(0);
    outC->_L27.n_iter_n_list[idx1].m_nvkvint_n_12 = kcg_lit_float32(0.0);
    outC->_L27.n_iter_n_list[idx1].m_nvkvint_n_23 = kcg_lit_float32(0.0);
  }
  outC->_L27.n_iter_k = kcg_lit_int32(0);
  for (idx3 = 0; idx3 < 32; idx3++) {
    outC->_L27.n_iter_k_list[idx3].valid = kcg_true;
    outC->_L27.n_iter_k_list[idx3].q_nvkvintset_k = Q_NVKVINTSET_Freight_trains;
    outC->_L27.n_iter_k_list[idx3].a_nvp12_k = kcg_lit_float32(0.0);
    outC->_L27.n_iter_k_list[idx3].a_nvp23_k = kcg_lit_float32(0.0);
    outC->_L27.n_iter_k_list[idx3].v_nvkvint_k = kcg_lit_int32(0);
    outC->_L27.n_iter_k_list[idx3].m_nvkvint_k_12 = kcg_lit_float32(0.0);
    outC->_L27.n_iter_k_list[idx3].m_nvkvint_k_23 = kcg_lit_float32(0.0);
    outC->_L27.n_iter_k_list[idx3].n_iter_k_m = kcg_lit_int32(0);
  ...
  outC->_L27.m_nvkrint = kcg_lit_float32(0.0);
  outC->_L27.n_iter_l = kcg_lit_int32(0);
  for (idx4 = 0; idx4 < 32; idx4++) {
    outC->_L27.n_iter_l_list[idx4].valid = kcg_true;
    outC->_L27.n_iter_l_list[idx4].l_nvkrint_l = L_NVKRINT_0m;
    outC->_L27.n_iter_l_list[idx4].m_nvkrint_l = kcg_lit_float32(0.0);
  }
  outC->_L27.m_nvktint = kcg_lit_float32(0.0);
  ...
  outC->_L23.d_mamode = kcg_lit_int32(0);
  outC->_L23.m_mamode = M_MAMODE_On_Sight;
  outC->_L23.v_mamode = kcg_lit_int32(0);
  outC->_L23.l_mamode = kcg_lit_int32(0);
  outC->_L23.l_ackmamode = kcg_lit_int32(0);
  ...
  outC->_L1.d_mamode = kcg_lit_int32(0);
  outC->_L1.m_mamode = M_MAMODE_On_Sight;
  outC->_L1.v_mamode = kcg_lit_int32(0);
  outC->_L1.l_mamode = kcg_lit_int32(0);
  outC->_L1.l_ackmamode = kcg_lit_int32(0);
  ...
  outC->p80.d_mamode = kcg_lit_int32(0);
  outC->p80.m_mamode = M_MAMODE_On_Sight;
  outC->p80.v_mamode = kcg_lit_int32(0);
  outC->p80.l_mamode = kcg_lit_int32(0);
  outC->p80.l_ackmamode = kcg_lit_int32(0);
