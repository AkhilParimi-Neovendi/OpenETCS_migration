...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_SearchIndexInGradientprof_SDM_GradientAcceleration_Pkg /* _L3=(SDM_GradientAcceleration_Pkg::SearchIndexInGradientprofileInternal#1)/ */ Context_SearchIndexInGradientprofileInternal_1[50];
