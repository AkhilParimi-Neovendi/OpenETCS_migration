  ...
  outC_sendTextMessage_manage_TextMessages_Pkg *outC)
{
  ...
  /* dmi_textMessage/ */
  DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg dmi_textMessage_partial;
  /* myElement/ */
  DMI_TXT_MSG_status_T_DMI_Types_Pkg myElement_partial;
  /* outStatusList/ */
  DMI_TXT_MSGList_status_T_DMI_Types_Pkg _1_outStatusList_partial;
  /* dmi_textMessage/ */
  DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg _2_dmi_textMessage_partial;
  /* myElement/ */
  DMI_TXT_MSG_status_T_DMI_Types_Pkg _3_myElement_partial;
  /* dmi_textMessage/ */
  DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg _4_dmi_textMessage_partial;
  /* outStatusList/ */
  DMI_TXT_MSGList_status_T_DMI_Types_Pkg _5_outStatusList_partial;
  /* dmi_textMessage/ */
  DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg _6_dmi_textMessage_partial;
  /* outStatusList/ */
  DMI_TXT_MSGList_status_T_DMI_Types_Pkg _7_outStatusList_partial;
