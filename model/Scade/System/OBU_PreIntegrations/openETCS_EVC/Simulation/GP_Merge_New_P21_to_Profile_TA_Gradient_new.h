...
typedef struct {
  ...
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_GP_Merge_New_P21_to_Profi_TA_Gradient_new /* _L14=(TA_Gradient_new::GP_Merge_New_P21_to_Profile_loop#1)/ */ Context_GP_Merge_New_P21_to_Profile_loop_1[50];
  outC__229_FindStartOfNewGradie_TA_Lib_internal /* _L1=(TA_Lib_internal::FindStartOfNewGradientProfileAbs#1)/ */ Context_FindStartOfNewGradientProfileAbs_1;
