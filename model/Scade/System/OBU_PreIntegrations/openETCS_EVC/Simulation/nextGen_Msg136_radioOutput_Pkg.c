...
{
  P000_TM_TrainToTrack op_call;
  P001_TM_TrainToTrack _1_op_call;
  /* MessageBus_out/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus MessageBus_out_partial;
  kcg_int32 noname;
  /* MessageBus_out/ */
  M_TrainTrackMessageBus_t_TM_TrainTrack_Bus _2_MessageBus_out_partial;
