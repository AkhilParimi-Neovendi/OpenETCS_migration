...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P012_OBU_T_TM /* P012_onboard/ */ P012_onboard;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_CAST_Int_to_D_OL_TM_conversions /* _L91=(TM_conversions::CAST_Int_to_D_OL#1)/ */ Context_CAST_Int_to_D_OL_1;
  outC_CAST_Int_to_Q_OVERLAP_TM_conversions /* _L103=(TM_conversions::CAST_Int_to_Q_OVERLAP#1)/ */ Context_CAST_Int_to_Q_OVERLAP_1;
  outC_CAST_Int_to_D_DP_TM_conversions /* _L90=(TM_conversions::CAST_Int_to_D_DP#1)/ */ Context_CAST_Int_to_D_DP_1;
  outC_CAST_Int_to_Q_DANGERPOINT_TM_conversions /* _L119=(TM_conversions::CAST_Int_to_Q_DANGERPOINT#1)/ */ Context_CAST_Int_to_Q_DANGERPOINT_1;
  outC_CAST_Int_to_T_ENDTIMER_TM_conversions /* _L94=(TM_conversions::CAST_Int_to_T_ENDTIMER#1)/ */ Context_CAST_Int_to_T_ENDTIMER_1;
  outC_CAST_Int_to_Q_SECTIONTIMER_TM_conversions /* _L118=(TM_conversions::CAST_Int_to_Q_SECTIONTIMER#1)/ */ Context_CAST_Int_to_Q_SECTIONTIMER_1;
  outC_CAST_Int_to_T_LOA_TM_conversions /* _L121=(TM_conversions::CAST_Int_to_T_LOA#1)/ */ Context_CAST_Int_to_T_LOA_1;
  outC_CAST_Int_to_V_LOA_TM_conversions /* _L92=(TM_conversions::CAST_Int_to_V_LOA#1)/ */ Context_CAST_Int_to_V_LOA_1;
  outC_CAST_Int_to_T_OL_TM_conversions /* _L123=(TM_conversions::CAST_Int_to_T_OL#1)/ */ Context_CAST_Int_to_T_OL_1;
  outC_CAST_Int_to_Q_ENDTIMER_TM_conversions /* _L126=(TM_conversions::CAST_Int_to_Q_ENDTIMER#1)/ */ Context_CAST_Int_to_Q_ENDTIMER_1;
  outC_CAST_Int_to_V_RELEASEDP_TM_conversions /* _L127=(TM_conversions::CAST_Int_to_V_RELEASEDP#1)/ */ Context_CAST_Int_to_V_RELEASEDP_1;
  outC_CAST_Int_to_L_ENDSECTION_TM_conversions /* _L129=(TM_conversions::CAST_Int_to_L_ENDSECTION#1)/ */ Context_CAST_Int_to_L_ENDSECTION_1;
  outC_CAST_Int_to_V_RELEASEOL_TM_conversions /* _L131=(TM_conversions::CAST_Int_to_V_RELEASEOL#1)/ */ Context_CAST_Int_to_V_RELEASEOL_1;
  outC_CAST_Int_to_D_ENDTIMERSTA_TM_conversions /* _L133=(TM_conversions::CAST_Int_to_D_ENDTIMERSTARTLOC#1)/ */ Context_CAST_Int_to_D_ENDTIMERSTARTLOC_1;
  outC_CAST_Int_to_D_STARTOL_TM_conversions /* _L134=(TM_conversions::CAST_Int_to_D_STARTOL#1)/ */ Context_CAST_Int_to_D_STARTOL_1;
  outC_CAST_Int_to_D_SECTIONTIME_TM_conversions /* _L137=(TM_conversions::CAST_Int_to_D_SECTIONTIMERSTOPLOC#1)/ */ Context_CAST_Int_to_D_SECTIONTIMERSTOPLOC_1;
  outC_C_P012_unflatten_sections_TM_lib_internal /* _L102=(TM_lib_internal::C_P012_unflatten_sections#1)/ */ Context_C_P012_unflatten_sections_1;
  ...
  outC_CAST_Int_to_V_MAIN_TM_conversions /* _L145=(TM_conversions::CAST_Int_to_V_MAIN#1)/ */ Context_CAST_Int_to_V_MAIN_1;
  ...
  kcg_bool /* @2/IfBlock1:else: */ _1_else_clock_CAST_Int_to_Q_SCALE_1_IfBlock1;
  ...
  kcg_bool /* @4/IfBlock1:else: */ _2_else_clock_CAST_Int_to_Q_DIR_1_IfBlock1;
  /* -------------------- (-debug) no assertions  -------------------- */
  ...
  Q_SCALE /* @2/IfBlock1:else:else:then:_L1/ */ _3__L1_CAST_Int_to_Q_SCALE_1_then_else_else_IfBlock1;
  ...
  kcg_bool /* @2/IfBlock1:then:_L3/ */ _4__L3_CAST_Int_to_Q_SCALE_1_then_IfBlock1;
  N_ITER /* @3/n_iter/ */ n_iter_CAST_Int_to_N_ITER_1;
  kcg_int32 /* @3/n_iter_int/ */ n_iter_int_CAST_Int_to_N_ITER_1;
  kcg_int32 /* @3/_L9/ */ _L9_CAST_Int_to_N_ITER_1;
  kcg_bool /* @3/_L10/ */ _L10_CAST_Int_to_N_ITER_1;
  kcg_int32 /* @3/_L11/ */ _L11_CAST_Int_to_N_ITER_1;
  kcg_bool /* @3/_L12/ */ _L12_CAST_Int_to_N_ITER_1;
  kcg_int32 /* @3/_L1/ */ _L1_CAST_Int_to_N_ITER_1;
  ...
  array_int32_7 /* _L125/ */ _L125;
  kcg_int32 /* _L124/ */ _L124;
  T_OL /* _L123/ */ _L123;
  P012_OBU_T_TM /* _L122/ */ _L122;
  T_LOA /* _L121/ */ _L121;
  ...
  array_int32_128 /* _L144/ */ _L144;
  V_MAIN /* _L145/ */ _L145;
  kcg_int32 /* _L146/ */ _L146;
} outC_C_P012_compr_onboard_TM_conversions;
...
extern void C_P012_compr_onboard_reset_TM_conversions(
  outC_C_P012_compr_onboard_TM_conversions *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void C_P012_compr_onboard_init_TM_conversions(
  outC_C_P012_compr_onboard_TM_conversions *outC);
