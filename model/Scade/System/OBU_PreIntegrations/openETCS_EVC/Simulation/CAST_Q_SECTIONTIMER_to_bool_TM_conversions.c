...
{
  /* q_sectiontimer_bool/ */
  kcg_bool q_sectiontimer_bool_partial;
  /* error/ */
  kcg_bool error_partial;
  /* q_sectiontimer_bool/ */
  kcg_bool _1_q_sectiontimer_bool_partial;
  /* error/ */
  kcg_bool _2_error_partial;
  /* error/ */
  kcg_bool _3_error_partial;
  /* q_sectiontimer_bool/ */
  kcg_bool _4_q_sectiontimer_bool_partial;
  /* error/ */
  kcg_bool _5_error_partial;
  /* q_sectiontimer_bool/ */
  kcg_bool _6_q_sectiontimer_bool_partial;
  kcg_bool noname;
