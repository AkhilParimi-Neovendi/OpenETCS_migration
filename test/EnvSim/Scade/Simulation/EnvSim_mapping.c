...
const MappingEntry scope_9_entries[10] = {
    /* 0 */ { MAP_FIELD, ".q_updown", NULL, sizeof(kcg_int32), offsetof(BaliseTelegramHeader_int_T_TM, q_updown), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 0 },
    /* 1 */ { MAP_FIELD, ".m_version", NULL, sizeof(kcg_int32), offsetof(BaliseTelegramHeader_int_T_TM, m_version), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 1 },
    /* 2 */ { MAP_FIELD, ".q_media", NULL, sizeof(kcg_int32), offsetof(BaliseTelegramHeader_int_T_TM, q_media), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 2 },
    /* 3 */ { MAP_FIELD, ".n_pig", NULL, sizeof(kcg_int32), offsetof(BaliseTelegramHeader_int_T_TM, n_pig), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 3 },
    /* 4 */ { MAP_FIELD, ".n_total", NULL, sizeof(kcg_int32), offsetof(BaliseTelegramHeader_int_T_TM, n_total), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 4 },
    /* 5 */ { MAP_FIELD, ".m_dup", NULL, sizeof(kcg_int32), offsetof(BaliseTelegramHeader_int_T_TM, m_dup), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 5 },
    /* 6 */ { MAP_FIELD, ".m_mcount", NULL, sizeof(kcg_int32), offsetof(BaliseTelegramHeader_int_T_TM, m_mcount), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 6 },
    /* 7 */ { MAP_FIELD, ".nid_c", NULL, sizeof(kcg_int32), offsetof(BaliseTelegramHeader_int_T_TM, nid_c), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 7 },
    /* 8 */ { MAP_FIELD, ".nid_bg", NULL, sizeof(kcg_int32), offsetof(BaliseTelegramHeader_int_T_TM, nid_bg), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 8 },
    /* 9 */ { MAP_FIELD, ".q_link", NULL, sizeof(kcg_int32), offsetof(BaliseTelegramHeader_int_T_TM, q_link), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 9 }
};
...
const MappingEntry scope_3_entries[15] = {
    /* 0 */ { MAP_FIELD, ".radioDevice", NULL, sizeof(kcg_int32), offsetof(Radio_TrackTrain_Header_T_TM, radioDevice), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 0 },
    /* 1 */ { MAP_FIELD, ".receivedSystemTime", NULL, sizeof(kcg_int32), offsetof(Radio_TrackTrain_Header_T_TM, receivedSystemTime), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 1 },
    /* 2 */ { MAP_FIELD, ".nid_message", NULL, sizeof(kcg_int32), offsetof(Radio_TrackTrain_Header_T_TM, nid_message), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 2 },
    /* 3 */ { MAP_FIELD, ".t_train", NULL, sizeof(kcg_int32), offsetof(Radio_TrackTrain_Header_T_TM, t_train), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 3 },
    /* 4 */ { MAP_FIELD, ".m_ack", NULL, sizeof(kcg_int32), offsetof(Radio_TrackTrain_Header_T_TM, m_ack), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 4 },
    /* 5 */ { MAP_FIELD, ".nid_lrbg", NULL, sizeof(kcg_int32), offsetof(Radio_TrackTrain_Header_T_TM, nid_lrbg), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 5 },
    /* 6 */ { MAP_FIELD, ".t_train_reference", NULL, sizeof(kcg_int32), offsetof(Radio_TrackTrain_Header_T_TM, t_train_reference), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 6 },
    /* 7 */ { MAP_FIELD, ".nid_em", NULL, sizeof(kcg_int32), offsetof(Radio_TrackTrain_Header_T_TM, nid_em), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 7 },
    /* 8 */ { MAP_FIELD, ".q_scale", NULL, sizeof(kcg_int32), offsetof(Radio_TrackTrain_Header_T_TM, q_scale), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 8 },
    /* 9 */ { MAP_FIELD, ".d_sr", NULL, sizeof(kcg_int32), offsetof(Radio_TrackTrain_Header_T_TM, d_sr), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 9 },
    /* 10 */ { MAP_FIELD, ".t_sh_rqst", NULL, sizeof(kcg_int32), offsetof(Radio_TrackTrain_Header_T_TM, t_sh_rqst), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 10 },
    /* 11 */ { MAP_FIELD, ".d_ref", NULL, sizeof(kcg_int32), offsetof(Radio_TrackTrain_Header_T_TM, d_ref), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 11 },
    /* 12 */ { MAP_FIELD, ".q_dir", NULL, sizeof(kcg_int32), offsetof(Radio_TrackTrain_Header_T_TM, q_dir), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 12 },
    /* 13 */ { MAP_FIELD, ".d_emergencystop", NULL, sizeof(kcg_int32), offsetof(Radio_TrackTrain_Header_T_TM, d_emergencystop), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 13 },
    /* 14 */ { MAP_FIELD, ".m_version", NULL, sizeof(kcg_int32), offsetof(Radio_TrackTrain_Header_T_TM, m_version), &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 14 }
};
...
const MappingEntry scope_1_entries[8] = {
    ...
    /* 2 */ { MAP_INPUT, "actualTrainPos", NULL, sizeof(kcg_float32), (size_t)&inputs_ctx.actualTrainPos, &_Type_kcg_float32_Utils, NULL, NULL, NULL, 1, 2 },
    /* 3 */ { MAP_INPUT, "radioTrainPos", NULL, sizeof(kcg_float32), (size_t)&inputs_ctx.radioTrainPos, &_Type_kcg_float32_Utils, NULL, NULL, NULL, 1, 3 },
    ...
    /* 6 */ { MAP_LOCAL, "_L3", NULL, sizeof(kcg_float32), (size_t)&outputs_ctx._L3, &_Type_kcg_float32_Utils, NULL, NULL, NULL, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_float32), (size_t)&outputs_ctx._L4, &_Type_kcg_float32_Utils, NULL, NULL, NULL, 1, 7 }
};
