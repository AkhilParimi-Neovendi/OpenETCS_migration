  ...
  outC_ScriptedTrackTest_EnvSim_Internal *outC)
{
  ...
  for (idx2 = 0; idx2 < 30; idx2++) {
    outC->_L2.Messages.PacketHeaders[idx2].nid_packet = kcg_lit_int32(0);
    outC->_L2.Messages.PacketHeaders[idx2].q_dir = Q_DIR_Reverse;
    outC->_L2.Messages.PacketHeaders[idx2].valid = kcg_true;
    outC->_L2.Messages.PacketHeaders[idx2].startAddress = kcg_lit_int32(0);
    outC->_L2.Messages.PacketHeaders[idx2].endAddress = kcg_lit_int32(0);
  }
  for (idx3 = 0; idx3 < 500; idx3++) {
    outC->_L2.Messages.PacketData[idx3] = kcg_lit_int32(0);
  }
  ...
  for (idx4 = 0; idx4 < 30; idx4++) {
    outC->baliseMessage.Messages.PacketHeaders[idx4].nid_packet = kcg_lit_int32(0);
    ...
    outC->baliseMessage.Messages.PacketHeaders[idx4].startAddress =
      kcg_lit_int32(0);
    outC->baliseMessage.Messages.PacketHeaders[idx4].endAddress = kcg_lit_int32(0);
  }
  for (idx5 = 0; idx5 < 500; idx5++) {
    outC->baliseMessage.Messages.PacketData[idx5] = kcg_lit_int32(0);
  }
  outC->radioMessage.Header.radioDevice = kcg_lit_int32(0);
  outC->radioMessage.Header.receivedSystemTime = kcg_lit_int32(0);
  outC->radioMessage.Header.nid_message = kcg_lit_int32(0);
  outC->radioMessage.Header.t_train = kcg_lit_int32(0);
  outC->radioMessage.Header.m_ack = kcg_lit_int32(0);
  outC->radioMessage.Header.nid_lrbg = kcg_lit_int32(0);
  outC->radioMessage.Header.t_train_reference = kcg_lit_int32(0);
  outC->radioMessage.Header.nid_em = kcg_lit_int32(0);
  outC->radioMessage.Header.q_scale = kcg_lit_int32(0);
  outC->radioMessage.Header.d_sr = kcg_lit_int32(0);
  outC->radioMessage.Header.t_sh_rqst = kcg_lit_int32(0);
  outC->radioMessage.Header.d_ref = kcg_lit_int32(0);
  outC->radioMessage.Header.q_dir = kcg_lit_int32(0);
  outC->radioMessage.Header.d_emergencystop = kcg_lit_int32(0);
  outC->radioMessage.Header.m_version = kcg_lit_int32(0);
  for (idx6 = 0; idx6 < 30; idx6++) {
    outC->radioMessage.Messages.PacketHeaders[idx6].nid_packet = kcg_lit_int32(0);
    ...
    outC->radioMessage.Messages.PacketHeaders[idx6].startAddress = kcg_lit_int32(0);
    outC->radioMessage.Messages.PacketHeaders[idx6].endAddress = kcg_lit_int32(0);
  }
  for (idx7 = 0; idx7 < 500; idx7++) {
    outC->radioMessage.Messages.PacketData[idx7] = kcg_lit_int32(0);
  }
}
